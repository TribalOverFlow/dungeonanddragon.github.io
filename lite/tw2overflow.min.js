...
[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},M={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},z={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3},C={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(x,C,z,M,P,N,L,O,y,k,I);const U=function(){S=[];const e=i.getPresetList().getPresets();h[t.PRESET].forEach((function(t){S.push(e[t])}))},D={init:function(){A=!0,w=new e({settingsMap:n,storageKey:R}),w.onChange((function(e,t){h=w.getAll(),t[l.PRESETS]&&U()})),h=w.getAll(),console.log('battleCalculator settings',h),_((function(){U()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,U),a.$on(s.ARMY_PRESET_DELETED,U)},calculateB:function(){
const e=h[t.BASHPOINTS_SPEAR],a=h[t.BASHPOINTS_SWORD],n=h[t.BASHPOINTS_AXE],i=h[t.BASHPOINTS_ARCHER],l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m,b,T=[1,2,4,2,13,12,15,8,10,20,200,0,25],E=[4,5,1,5,5,6,23,4,12,40,200,25,10];m=e*T[0]+a*T[1]+n*T[2]+i*T[3]+l*T[4]+o*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+u*T[10]+p*T[11]+d*T[12],b=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],console.log(m,b)}},G=function(){const e=h[t.BASHPOINTS_SPEAR],a=h[t.BASHPOINTS_SWORD],n=h[t.BASHPOINTS_AXE],i=h[t.BASHPOINTS_ARCHER],l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT]
;var m,b,T=[1,2,4,2,13,12,15,8,10,20,200,0,25],E=[4,5,1,5,5,6,23,4,12,40,200,25,10];m=e*T[0]+a*T[1]+n*T[2]+i*T[3]+l*T[4]+o*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+u*T[10]+p*T[11]+d*T[12],b=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],console.log(m,b),this.attack=b,this.defense=m};return D.simulate=function(){},D.calculateT=function(){const e=h[t.TROOPS_SPEAR],a=h[t.TROOPS_SWORD],n=h[t.TROOPS_AXE],i=h[t.TROOPS_ARCHER],l=h[t.TROOPS_LC],o=h[t.TROOPS_MA],s=h[t.TROOPS_HC],r=h[t.TROOPS_RAM],c=h[t.TROOPS_CATAPULT],d=h[t.TROOPS_DOPPELSOLDNER],p=h[t.TROOPS_TREBUCHET],u=h[t.TROOPS_SNOB],g=h[t.TROOPS_KNIGHT],m=h[t.TROOPS_BARRACKS],b=h[t.TROOPS_PRECEPTORY],T=h[t.TROOPS_ORDER]
...
total:L},I.calculated={total:$},B.calculated={total:Q}}()},D.start=function(){v=!0,f.trigger(s.BATTLE_CALCULATOR_START)},D.stop=function(){v=!1,f.trigger(s.BATTLE_CALCULATOR_STOP)},D.getSettings=function(){return w},D.isInitialized=function(){return A},D.isRunning=function(){return v},G.prototype.totalAtt=function(){return this.attack},G.prototype.totalDef=function(){return this.defense},D})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p,u,g,m,b,T,E,_,f,w,h){let A,v,S,R=i.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){A.selectedTab=e},I=function(){t.isRunning()?t.stop():t.start()},x=function(){v.setAll(v.decode(A.settings)),h.notif('success','Bashpoints Settings saved')},O=function(){A.presets=f.encodeList(R.getPresets(),{disabled:!1,type:'presets'})
},L=function(){A.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),h.notif('success','battleCalculator started')},N=function(){A.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),h.notif('success','battleCalculator stopped')},P=function(){A=a.$new(),A.SETTINGS=n,A.TAB_TYPES=y,A.running=t.isRunning(),A.selectedTab=y.BATTLE,A.settingsMap=l,A.catapulttarget=f.encodeList(d,{textObject:'battle_calculator',disabled:!0}),A.knightitem=f.encodeList(o,{textObject:'battle_calculator',disabled:!0}),A.itemlevel=f.encodeList(r,{textObject:'battle_calculator',disabled:!0}),A.order=f.encodeList(p,{textObject:'battle_calculator',disabled:!0}),A.wall=f.encodeList(u,{textObject:'battle_calculator',disabled:!0}),A.church=f.encodeList(g,{textObject:'battle_calculator',disabled:!0}),A.weaponmaster=f.encodeList(m,{textObject:'battle_calculator',disabled:!0}),A.ironwalls=f.encodeList(b,{textObject:'battle_calculator',disabled:!0}),A.clinique=f.encodeList(T,{
