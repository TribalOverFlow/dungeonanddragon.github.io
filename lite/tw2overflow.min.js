...
const e=w.get(t.BASHPOINTS_SPEAR),a=h.get[t.BASHPOINTS_SWORD],i=h[t.BASHPOINTS_AXE].value,n=w.get(t.BASHPOINTS_ARCHER).value,l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m,b,T=[1,2,4,2,13,12,15,8,10,20,200,0,25],E=[4,5,1,5,5,6,23,4,12,40,200,25,10];console.log(e,a,i,n),m=e*T[0]+a*T[1]+i*T[2]+n*T[3]+l*T[4]+o*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+u*T[10]+p*T[11]+d*T[12],b=e*E[0]+a*E[1]+i*E[2]+n*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],console.log(m,b),(void 0).html(m),(void 0).html(b)},simulate:function(){}};return G.calculateT=function(){
