...
define('two/recruitQueue',['two/Settings','two/recruitQueue/types/errors','two/recruitQueue/types/status','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/farmOverflow/types/logs','two/ready','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,u,p,g,m,T,f){let _,b,h,A=!1,E=!1,w=null,v=[],S=Math.max(R,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3);const R=1;let y=null,k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],q=[],F=[],Y=[],j=[],H=[],K=[],Q=[],X=[];const Z='recruit_queue_settings',J='recruit_queue_log',$={[u.SPEAR]:'spear',[u.SWORD]:'sword',[u.AXE]:'axe',[u.ARCHER]:'archer',[u.LIGHT_CAVALRY]:'light_cavalry',[u.MOUNTED_ARCHER]:'mounted_archer',[u.HEAVT_CAVALRY]:'heavy_cavalry',[u.RAM]:'ram',[u.CATAPULT]:'catapult'};console.log($);const ee=function(){k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],q=[],F=[],Y=[],j=[],H=[],K=[],Q=[],X=[]
;const e=i.getGroupList().getGroups(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],o=b[r.GROUP4],l=b[r.GROUP5],s=b[r.GROUP6],c=b[r.GROUP7],d=b[r.GROUP8],u=b[r.GROUP9],p=b[r.GROUP10],g=b[r.GROUP11],m=b[r.GROUP12],T=b[r.GROUP13],f=b[r.GROUP14],_=b[r.GROUP15],h=b[r.GROUP16],A=b[r.GROUP17],E=b[r.GROUP18],w=b[r.GROUP19],v=b[r.GROUP20],S=b[r.GROUP21],R=b[r.GROUP22],y=b[r.GROUP23],Z=b[r.GROUP24];t.forEach((function(t){k.push(e[t])})),a.forEach((function(t){M.push(e[t])})),n.forEach((function(t){I.push(e[t])})),o.forEach((function(t){N.push(e[t])})),l.forEach((function(t){x.push(e[t])})),s.forEach((function(t){O.push(e[t])})),c.forEach((function(t){L.push(e[t])})),d.forEach((function(t){P.push(e[t])})),u.forEach((function(t){U.push(e[t])})),p.forEach((function(t){C.push(e[t])})),g.forEach((function(t){z.push(e[t])})),m.forEach((function(t){D.push(e[t])})),T.forEach((function(t){G.push(e[t])})),f.forEach((function(t){B.push(e[t])})),_.forEach((function(t){V.push(e[t])})),h.forEach((function(t){
W.push(e[t])})),A.forEach((function(t){q.push(e[t])})),E.forEach((function(t){F.push(e[t])})),w.forEach((function(t){Y.push(e[t])})),v.forEach((function(t){j.push(e[t])})),S.forEach((function(t){H.push(e[t])})),R.forEach((function(t){K.push(e[t])})),y.forEach((function(t){Q.push(e[t])})),Z.forEach((function(t){X.push(e[t])}))},te=function(){return Math.max(R,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3)},ae=function(e,t,a){let n={time:f.gameTime(),villageId:e,unit:t,amount:a};return h.unshift(n),h.length>500&&h.splice(h.length-500,h.length),T.set(J,h),!0},ne={init:function(){A=!0,h=T.get(J,[],!0),_=new e({settingsMap:c,storageKey:Z}),_.onChange((function(e,t){b=_.getAll(),t[d.GROUPS]&&ee()})),b=_.getAll(),console.log('recruitQueue settings',b),a.$on(s.GROUPS_CREATED,ee),a.$on(s.GROUPS_DESTROYED,ee),a.$on(s.GROUPS_UPDATED,ee)},ownRecrutation:function(){}};return ne.presetRecrutation=function(){m.trigger(s.RECRUIT_QUEUE_CYCLE_BEGIN),w=f.gameTime()+te()
...
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,na)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){at>=3&&(sa>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:sa}),v=[lt='sword',sa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,sa)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){at>=5&&(Tt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:Tt}),v=[lt='axe',Tt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Tt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){at>=9&&(ut>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:ut}),v=[lt='archer',ut],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
ae(Ca,lt,ut)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){at>=11&&(qt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:qt}),v=[lt='light_cavalry',qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,qt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){at>=13&&(Ht>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Ht}),v=[lt='mounted_archer',Ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Ht)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){at>=15&&(Zt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:Zt}),v=[lt='ram',Zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Zt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){at>=17&&(ht>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:ht}),v=[lt='catapult',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,ht)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){at>=21&&(Ut>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Ut}),v=[lt='heavy_cavalry',Ut],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Ut)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,i,r,c,d,u,p,g,f,_,b,h,A,w,O,L}()}()}function ln(){ba=a>0?Da.length>=2?1:1==Da.length?.5:.25:0,function(){_a=fa.length>0?fa.reduce((function(e,t){return e+t})):0;!function(){
...
ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Bt>Mt&&St>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ia>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:ia}),v=[lt='spear',ia],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,ia)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){za>=3&&(ra>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:ra}),v=[lt='sword',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,ra)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){za>=5&&(ft>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:ft}),v=[lt='axe',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,ft)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){za>=9&&(pt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:pt}),v=[lt='archer',pt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,pt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){za>=11&&(Ft>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:Ft}),v=[lt='light_cavalry',Ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Ft)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){za>=13&&(Kt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Kt}),
v=[lt='mounted_archer',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Kt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){za>=15&&(Jt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:Jt}),v=[lt='ram',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Jt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){za>=17&&(At>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:At}),v=[lt='catapult',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,At)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){za>=21&&(Ct>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Ct}),v=[lt='heavy_cavalry',Ct],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
...
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Fa>=3&&(ca>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:ca}),v=[lt='sword',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,ca)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Fa>=5&&(_t>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:_t}),v=[lt='axe',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,_t)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Fa>=9&&(gt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:gt}),v=[lt='archer',gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
ae(Ca,lt,gt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Fa>=11&&(Yt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:Yt}),v=[lt='light_cavalry',Yt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Yt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Fa>=13&&(Qt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Qt}),v=[lt='mounted_archer',Qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Qt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Fa>=15&&($t>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:$t}),v=[lt='ram',$t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,$t)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){Fa>=17&&(Et>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:Et}),v=[lt='catapult',Et],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Et)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Fa>=21&&(zt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:zt}),v=[lt='heavy_cavalry',zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,zt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,a,i,r,c,d,u,p,g,T,f,_,b,A,E,w,S,R,y,k,M}()}()}function rn(){ya=c>0?Ja.length>=2?1:1==Ja.length?.5:.25:0,function(){Ra=Sa.length>0?Sa.reduce((function(e,t){return e+t})):0;!function(){
ka=c>0?Ra>=936e5?0:Ra<936e5&&Ra>=864e5?.1:Ra<864e5&&Ra>=72e6?.25:Ra<72e6&&Ra>=576e5?.4:Ra<576e5&&Ra>=432e5?.55:Ra<432e5&&Ra>=288e5?.7:Ra<288e5&&Ra>=144e5?.85:Ra<144e5&&Ra>=72e5?.925:Ra<72e5&&Ra>=36e5?.9625:1:0;e=Ve-He,t=We-Ke,a=Ue-Qe,n=Pe-Xe,i=De-Ze,r=Ge-Je,d=Be-$e,u=Ce-et,p=ze-tt,g=Math.floor(oe*ka*ya),T=Math.floor(le*ka*ya),f=Math.floor(Z*ka*ya),_=Math.floor(X*ka*ya),b=Math.floor(ee*ka*ya),h=Math.floor(ne*ka*ya),E=Math.floor(ie*ka*ya),w=Math.floor(J*ka*ya),S=Math.floor($*ka*ya),R=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+h*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+h*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+h*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||i<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k<=nn&&M<=en?(la=g,da=T,bt=f,
...
da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>Nt&&yt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){la>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:la}),v=[lt='spear',la],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,la)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Za>=3&&(da>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:da}),v=[lt='sword',da],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,da)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){Za>=5&&(bt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:bt}),v=[lt='axe',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,bt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Za>=9&&(mt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:mt}),v=[lt='archer',mt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,mt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Za>=11&&(jt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:jt}),v=[lt='light_cavalry',jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,jt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Za>=13&&(Xt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Xt}),
v=[lt='mounted_archer',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,Xt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Za>=15&&(ea>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:ea}),v=[lt='ram',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,ea)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Za>=17&&(wt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:wt}),v=[lt='catapult',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),ae(Ca,lt,wt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Za>=21&&(Dt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Dt}),v=[lt='heavy_cavalry',Dt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
ae(Ca,lt,Dt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,t,a,n,i,r,d,u,p,g,T,f,_,b,h,E,w,S,R,y,k,M}()}()}!function(){var e=i.getSelectedCharacter().getVillageList();console.log(e);var o=6e4*e.length,l=6e4*e.length+6e4*e.length,s=6e4*e.length+6e4*e.length+6e4*e.length;e.forEach((function(e,i){t&&setTimeout((function(){d.forEach((function(t){if(e.data.villageId==t){console.log('wioska:'+e.data.villageId),Ca=e.getId(),He=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Ke=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Qe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Xe=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Ze=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,Je=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,$e=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,
...
m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},ne.getLogs=function(){return h},ne.clearLogs=function(){return h=[],T.set(J,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},ne.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START),ae(p.RECRUIT_START,'start',''),y=setInterval((function(){ne.presetRecrutation()}),S)},ne.stop=function(e=n.USER_STOP){w?(e!==n.USER_STOP&&(w=f.gameTime()+te()),m.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):w=null,E=!1,clearInterval(y),m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&ae(p.RECRUIT_STOP,'stop','')},ne.getSettings=function(){return _},ne.isInitialized=function(){return A},ne.isRunning=function(){return E},ne.getNextCycleDate=function(){return w},ne.getCycleInterval=te,ne})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop',
