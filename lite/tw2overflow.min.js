...
const e=h[t.BASHPOINTS_SPEAR],a=h[t.BASHPOINTS_SWORD],n=h[t.BASHPOINTS_AXE],i=h[t.BASHPOINTS_ARCHER],l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m,b,T,E=[1,2,4,2,13,12,15,8,10,20,200,0,25],_=[4,5,1,5,5,6,23,4,12,40,200,25,10];m=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],b=e*_[0]+a*_[1]+n*_[2]+i*_[3]+l*_[4]+o*_[5]+s*_[6]+r*_[7]+c*_[8]+g*_[9]+u*_[10]+p*_[11]+d*_[12],console.log(m,b),T={totalAtt:b,totalDef:m},console.log(T)},simulate:function(){}};return G.calculateT=function(){
