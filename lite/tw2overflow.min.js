 ...
 */
!function(e,t){const a=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),i=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),f=function(){},_=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||f,this.listeners=[];const n=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,i){i?this.listeners.push(a.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
waiting:"Oczekujące",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",activate:"Aktywuj",deactivate:"Wyłącz",units:"Jednostki",officers:"Oficerowie",origin:"Źródło",target:["Cel","Cele"],save:"Zapisz",logs:"Logi","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas",points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",
spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},i='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=_.call(o,t)?o[t]:t,e.setJSON(n[t]||n[i])}let s={init:function(){if(t)return!1;t=!0,l(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&l(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,n){const o=function(e,t){let a={};for(let n in e)_.call(t,n)?angular.equals(e[n],t[n])||(a[n]=t[n]):a[n]=e[n];return!angular.equals({},a)&&a},l=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let n in t)(e[n].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,
this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,n.get(this.storageKey,{})),this.events={settingsChange:e.onChange||f},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return _.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){n.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!_.call(this.settingsMap,e))return!1;const n=this.settingsMap[e];'number'===n.inputType&&(t=parseInt(t,10),_.call(n,'min')&&(t=Math.max(n.min,t)),_.call(n,'max')&&(t=Math.min(n.max,t)));const i=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(i,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),
this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(_.call(this.settingsMap,t)){const a=this.settingsMap[t];let n=e[t];'number'===a.inputType&&(n=parseInt(n,10),_.call(a,'min')&&(n=Math.max(a.min,n)),_.call(a,'max')&&(n=Math.min(a.max,n))),this.settings[t]=n}const n=angular.copy(this.settings),i=o(a,n);if(!i)return!1;const l=s(this.settingsMap,i);return this.store(),this.updateScope(),this.events.settingsChange.call(this,i,l,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!_.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},
r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(n){e.multiSelect?n.length||(t.settings[a]=[l()]):n||(t.settings[a]=l())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const n=i.getPresetList().getPresets(),o=i.getGroupList().getGroups();return e=e||{},this.each((function(i,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[i]=r.multiSelect?[l()]:l());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){n[t]&&e.push({name:n[t].name,value:t})})),t[i]=e.length?e:[l()]}else{if(!n[s]&&r.disabledOption)return void(t[i]=l());t[i]={name:n[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,
leftIcon:o[t].icon})})),t[i]=e.length?e:[l()]}else{if(!o[s]&&r.disabledOption)return void(t[i]=l());t[i]={name:o[s].name,value:s}}break;default:t[i]={name:e.textObject?g('i18n')(s,a.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[i]=[t[i]])}}else t[i]=s})),t},r.prototype.decode=function(e){let t={};for(let a in e){let n=this.settingsMap[a];if('select'===n.inputType)if(n.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let n=[];e[a].forEach((function(e){n.push(e.value)})),t[a]=n}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let n=[];switch((t=t||{}).disabled&&n.push(l()),t.type){case'keys':for(let t in e)n.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];n.push({name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){let a=e[t];n.push({name:a.name,value:a.id})}break;case'values':default:for(let i in e){let o=e[i];n.push({name:t.textObject?g('i18n')(o,a.loc.ale,t.textObject):o,value:o})}}return n},
r.disabledOption=l,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],n=[],i=!1,r=!1,c=[];angular.extend(s,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=f,d){if(d)r=!1;else{if(i)return c.push(e);if(r)return e(t)}c.push(e),i=!0;let u=[];for(let e=0;e<n.length;e++)for(let t=0;t<n[e].length;t++)u.push(n[e][t]);let p=[];return u.forEach((function(e){let a=new Promise((function(a,n){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return n(e.message);e.villages.length&&(t=t.concat(e.villages)),a()}))}));p.push(a)})),Promise.all(p).then((function(){i=!1,r=!0,a.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),a=Math.ceil(e.MAP_SIZE/306);for(let i=0;i<t;i++){n.push([]);let t=306*i,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<a;l++){
let a=306*l,s=306..bound(0,a+306).bound(0,e.MAP_SIZE-a);a=a.bound(0,e.MAP_SIZE),n[i].push({x:t,y:a,width:o,height:s})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,n){let i,o,l,r,c={},d={},u=!1,p=document.querySelector('head'),g=injector.get('httpService'),m=injector.get('templateManagerService'),T=injector.get('$templateCache');return m.load=function(n,i,o){let l;const s=function(e,t,n,o){T.put(l.substr(1),e),angular.isFunction(i)&&i(e,t,n,o),a.$$phase||a.$apply()},r=function(e,t,a,n){angular.isFunction(o)&&o(e,t,a,n)};l=0!==n.indexOf('!')?e.TEMPLATE_PATH_EXT.join(n):n.substr(1),T.get(l.substr(1))?s(T.get(l.substr(1)),304):t.versionMap[l]?g.get(l,s,r):s(d[l],304)},c.init=function(){if(u)return!1
;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div'),s=document.createElement('div'),d=document.createElement('div'),p=document.createElement('div'),g=document.createElement('div'),m=document.createElement('div'),T=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-menu-container2',e.appendChild(a),s.className='two-menu-container3',e.appendChild(s),d.className='two-menu-container4',e.appendChild(d),p.className='two-main-button',p.style.display='none',g.className='two-economy-button',g.style.display='none',m.className='two-intrigue-button',m.style.display='none',T.className='two-other-button',T.style.display='none',t.appendChild(p),a.appendChild(g),s.appendChild(m),d.appendChild(T),i=document.createElement('div'),i.className='two-menu',t.appendChild(i),o=document.createElement('div'),o.className='two-menu2',a.appendChild(o),l=document.createElement('div'),l.className='two-menu3',
s.appendChild(l),r=document.createElement('div'),r.className='two-menu4',d.appendChild(r),u=!0,
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['two/utils','queues/EventQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,n){let r;var c=injector.get('overviewService'),d=!1,u=!1,p=i.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=i.getSelectedCharacter(),T=m.tribeById[0],f=m.getVillageList(),_=[],b=m.data.character_id,h=m.data.character_name,A=[],E=[],w=[n.LIGHT_CAVALRY,n.HEAVY_CAVALRY,n.AXE,n.SWORD,n.RAM,n.SNOB,n.TREBUCHET];var v=function(){o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:T},(function(e){for(var t=e.members,a=0;a<t.length;a++)E.push(t[a].id)})),f.forEach((function(e){_.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:_},S),setTimeout(v,6e4)},S=function(e){
...
let w,v,S=!1,R=!1,y=[],k=null,M=null,I=null,N=null,x=null,O=null,L=null,P=null,U=null,C=null,z=null,D=null,G=null,B=null,V=null,W=null,q=null,F=null,Y=null,j=null,H=null,K=null,Q=null,X=null,Z=null,J=null,$=null,ee=null,te=null,ae=null,ne=null,ie=null,oe=null,le=null,se=null,re=null,ce=null,de=null,ue=null,pe=null,ge=null,me=null,Te=null,fe=null,_e=null,be=null,he=null,Ae=null,Ee=null,we=null,ve=null,Se=null,Re=null,ye=null,ke=null,Me=null,Ie=null,Ne=null,xe=null,Oe=null,Le=null,Pe=null,Ue=null,Ce=null,ze=null,De=null,Ge=null,Be=null,Ve=null,We=null,qe=null,Fe=null,Ye=null,je=null,He=null,Ke=null,Qe=null,Xe=null,Ze=null,Je=null,$e=null,et=null,tt=null,at=null,nt=null,it=null,ot=null,lt=null,st=null,rt=null,ct=null,dt=null,ut=null,pt=null,gt=null,mt=null,Tt=null,ft=null,_t=null,bt=null,ht=null,At=null,Et=null,wt=null,vt=null,St=null,Rt=null,yt=null,kt=null,Mt=null,It=null,Nt=null,xt=null,Ot=null,Lt=null,Pt=null,Ut=null,Ct=null,zt=null,Dt=null,Gt=null,Bt=null,Vt=null,Wt=null,qt=null,Ft=null,Yt=null,jt=null,Ht=null,Kt=null,Qt=null,Xt=null,Zt=null,Jt=null,$t=null,ea=null,ta=null,aa=null,na=null,ia=null,oa=null,la=null,sa=null,ra=null,ca=null,da=null,ua=null,pa=null,ga=null,ma=null,Ta=null,fa=null,_a=null,ba=null,ha=null,Aa=null,Ea=null,wa=null,va=null,Sa=null,Ra=null,ya=null,ka=null,Ma=null,Ia=null,Na=null,xa=null
...
[b.LEVEL_2]:'level_2',[b.LEVEL_3]:'level_3',[b.LEVEL_4]:'level_4',[b.LEVEL_5]:'level_5',[b.LEVEL_6]:'level_6',[b.LEVEL_7]:'level_7',[b.LEVEL_8]:'level_8',[b.LEVEL_9]:'level_9',[b.LEVEL_10]:'level_10'};console.log(Va,Ba,Ga,Da,za,Ca,La,Pa,Ua);const Wa=function(){y=[];const e=i.getPresetList().getPresets();v[t.PRESET].forEach((function(t){y.push(e[t])}))},qa={init:function(){S=!0,w=new e({settingsMap:n,storageKey:Oa}),w.onChange((function(e,t){v=w.getAll(),t[r.PRESETS]&&Wa()})),v=w.getAll(),console.log('battleCalculator settings',v),A((function(){Wa()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,Wa),a.$on(s.ARMY_PRESET_DELETED,Wa)},getPresetUnits:function(){y=v[t.PRESET],o.emit(l.GET_PRESETS,{},(function(e){for(xa=0;xa<e.presets.length;xa++)e.presets[xa].id==y&&(ia=e.presets[xa].units.spear,oa=e.presets[xa].units.sword,la=e.presets[xa].units.axe,sa=e.presets[xa].units.archer,ra=e.presets[xa].units.light_cavalry,ca=e.presets[xa].units.mounted_archer,da=e.presets[xa].units.heavy_cavalry,
ua=e.presets[xa].units.ram,pa=e.presets[xa].units.catapult,ga=e.presets[xa].units.snob,ma=e.presets[xa].units.knight,Ta=e.presets[xa].units.trebuchet,fa=e.presets[xa].units.doppelsoldner)}))},getVillageUnits:function(){Na=v[t.BATTLE_VILLAGE_ID],o.emit(l.VILLAGE_UNIT_INFO,{village_id:Na},(function(e){ba=e.available_units.axe.total,_a=e.available_units.archer.total,ha=e.available_units.catapult.total,Aa=e.available_units.doppelsoldner.total,Ea=e.available_units.heavy_cavalry.total,wa=e.available_units.knight.total,va=e.available_units.light_cavalry.total,Sa=e.available_units.mounted_archer.total,Ra=e.available_units.ram.total,ya=e.available_units.snob.total,ka=e.available_units.spear.total,Ma=e.available_units.sword.total,Ia=e.available_units.trebuchet.total}))},calculateB:function(){
const e=v[t.BASHPOINTS_SPEAR],a=v[t.BASHPOINTS_SWORD],n=v[t.BASHPOINTS_AXE],i=v[t.BASHPOINTS_ARCHER],o=v[t.BASHPOINTS_LC],l=v[t.BASHPOINTS_MA],s=v[t.BASHPOINTS_HC],r=v[t.BASHPOINTS_RAM],c=v[t.BASHPOINTS_CATAPULT],d=v[t.BASHPOINTS_DOPPELSOLDNER],u=v[t.BASHPOINTS_TREBUCHET],p=v[t.BASHPOINTS_SNOB],g=v[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],T=[4,5,1,5,5,6,23,4,12,40,200,25,10];k=e*m[0]+a*m[1]+n*m[2]+i*m[3]+o*m[4]+l*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],M=e*T[0]+a*T[1]+n*T[2]+i*T[3]+o*T[4]+l*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+p*T[10]+u*T[11]+d*T[12]}};return qa.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],o=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=0,c=0,d=0,u=0,p=0,g=0,m=0,T=0,f=0,_=0,b=0,h=0,A=0,E=0,w=0,S=0,R=0,y=0,k=0,M=0,I=0,N=0,x=0,O=0,L=0,P=0,U=0,C=0,z=0,D=0,G=0,B=0,V=0,W=0,q=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=0,Ta=0,fa=0,_a=0,ba=0,ha=0,Aa=0,Ea=0,wa=0,va=0,Sa=0,Ra=0,ya=0,ka=0,Ma=0,Ia=0,Na=0,xa=0,Oa=0,La=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,qa=0,Fa=0,Ya=0,ja=0,Ha=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,Tn=0,fn=0,_n=0,bn=0,hn=0,An=0,En=0,wn=0,vn=[1,1],Sn=[1,1],Rn=[1,1],yn=[1,1],kn=[1,1],Mn=[1,1],In=[1,1],Nn=[1,1],xn=[1,1],On=[1,1],Ln=[1,1],Pn=[1,1],Un=[1,1],Cn=[1,1],zn=[1,1],Dn=[1,1],Gn=[1,1],Bn=[1,1],Vn=[1,1],Wn=[1,1],qn=[1,1],Fn=[1,1],Yn=[1,1],jn=[1,1],Hn=[1,1],Kn=[1,1],Qn=[1,1],Xn=[1,1],Zn=[1,1],Jn=[1,1],$n=[1,1],ei=[1,1],ti=[1,1],ai=[1,1],ni=[1,1],ii=[1,1],oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,Ti=0,fi=0,_i=0,bi=0,hi=0,Ai=0,Ei=0,wi=0,vi=0,Si=0,Ri=0,yi=0,ki=0,Mi=0,Ii=0,Ni=[1,1],xi=0,Oi=0,Li=0,Pi=0,Ui=0,Ci=0,zi=0,Di=0,Gi=0,Bi=0,Vi=0,Wi=0,qi=0,Fi=0,Yi=0,ji=0,Hi=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,To=[1,1],fo=[1,1],_o=[1,1],bo=[1,1],ho=[1,1],Ao=[1,1],Eo=[1,1],wo=[1,1],vo=[1,1],So=0,Ro=0,yo=0,ko=0,Mo=0,Io=0,No=0,xo=0,Oo=0,Lo=0,Po=0,Uo=0,Co=0,zo=0,Do=0,Go=0,Bo=0,Vo=0,Wo=0,qo=0,Fo=0,Yo=0,jo=0,Ho=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,Tl=0,fl=0,_l=0,bl=0,hl=0,Al=0,El=0,wl=0,vl=0,Sl=0,Rl=0,yl=0,kl=0,Ml=0,Il=0,Nl=0,xl=0,Ol=0,Ll=0,Pl=0,Ul=0,Cl=0,zl=0,Dl=0,Gl=0,Bl=0,Vl=0,Wl=0,ql=0,Fl=0,Yl=0,jl=1,Hl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,Ts=0,fs=0,_s=0,bs=0,hs=0,As=0,Es=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Ms=0,Is=0,Ns=0,xs=0,Os=0,Ls=0,Ps=0,Us=0,Cs=0,zs=0,Ds=0,Gs=0,Bs=0,Vs=0,Ws=0,qs=0,Fs=0,Ys=0,js=0,Hs=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,Tr=0,fr=0,_r=0,br=0,hr=0,Ar=0,Er=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Mr=0,Ir=0,Nr=0,xr=0,Or=0,Lr=0,Pr=0,Ur=0,Cr=0,zr=0,Dr=0,Gr=0,Br=0,Vr=0,Wr=0,qr=0,Fr=0,Yr=0,jr=0,Hr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,Tc=0,fc=0,_c=0,bc=0,hc=0,Ac=0,Ec=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Mc=0,Ic=0,Nc=0,xc=0,Oc=0,Lc=0,Pc=0,Uc=0,Cc=0,zc=0,Dc=0,Gc=0,Bc=0,Vc=0,Wc=0,qc=0,Fc=0,Yc=0,jc=0,Hc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,Td=0,fd=0,_d=0,bd=0,hd=0,Ad=0,Ed=0,wd=0,vd=0,Sd=0
;console.log(aa,Ht),r=v[t.BATTLE_CHURCH_A],c=v[t.BATTLE_CHURCH_D],d=v[t.BATTLE_NIGHT_BONUS],u=v[t.BATTLE_OFFICER_LEADER],p=v[t.BATTLE_OFFICER_MEDIC],g=v[t.BATTLE_SKILL_MEDIC],m=v[t.BATTLE_SKILL_WEAPON_MASTER],T=v[t.BATTLE_WALL],f=v[t.BATTLE_SKILL_IRON_WALLS],_=v[t.BATTLE_SKILL_CLINIQUE],b=v[t.BATTLE_HOSPITAL],Pt=v[t.BATTLE_CATAPULT_TARGET],h=v[t.BATTLE_CATAPULT_TARGET],A=v[t.BATTLE_KNIGHT_ITEM_D1],E=v[t.BATTLE_KNIGHT_ITEM_D2],w=v[t.BATTLE_KNIGHT_ITEM_D3],S=v[t.BATTLE_KNIGHT_ITEM_A],R=v[t.BATTLE_ITEM_LEVEL_D1],y=v[t.BATTLE_ITEM_LEVEL_D2],k=v[t.BATTLE_ITEM_LEVEL_D3],M=v[t.BATTLE_ITEM_LEVEL_A],Ge=v[t.BATTLE_ARCHER_A],H=v[t.BATTLE_ARCHER_D],De=v[t.BATTLE_AXE_A],j=v[t.BATTLE_AXE_D],Ke=v[t.BATTLE_DOPPELSOLDNER_A],ae=v[t.BATTLE_DOPPELSOLDNER_D],qe=v[t.BATTLE_CATAPULT_A],Z=v[t.BATTLE_CATAPULT_D],He=v[t.BATTLE_HC_A],te=v[t.BATTLE_HC_D],Ve=v[t.BATTLE_KNIGHT_A],Q=v[t.BATTLE_KNIGHT_D],Ye=v[t.BATTLE_LC_A],$=v[t.BATTLE_LC_D],je=v[t.BATTLE_MA_A],ee=v[t.BATTLE_MA_D],We=v[t.BATTLE_RAM_A],
X=v[t.BATTLE_RAM_D],Be=v[t.BATTLE_SNOB_A],K=v[t.BATTLE_SNOB_D],Ce=v[t.BATTLE_SPEAR_A],F=v[t.BATTLE_SPEAR_D],ze=v[t.BATTLE_SWORD_A],Y=v[t.BATTLE_SWORD_D],Fe=v[t.BATTLE_TREBUCHET_A],J=v[t.BATTLE_TREBUCHET_D],I=v[t.BATTLE_MORALE],N=v[t.BATTLE_LUCK],console.log(Pt),vd='level_1'==r?100:'level_2'==r?105:'level_3'==r?110:50,console.log(vd),Sd='level_1'==c?100:'level_2'==c?105:'level_3'==c?110:50,console.log(Sd),jl=d?2:1,console.log(jl),rl=u?.1:0,console.log(rl),Fl=p?.1:0,console.log(Fl),Js=g?.1:0,console.log(Js),Xs='level_1'==m?2:'level_2'==m?4:'level_3'==m?6:'level_4'==m?8:'level_5'==m?10:0,console.log(Xs),$s='level_1'==f?1:'level_2'==f?2:'level_3'==f?3:'level_4'==f?4:'level_5'==f?5:0,console.log($s),Zs='level_1'==_?100:'level_2'==_?200:'level_3'==_?300:'level_4'==_?400:'level_5'==_?500:'level_6'==_?600:'level_7'==_?700:'level_8'==_?800:'level_9'==_?900:'level_10'==_?1e3:0,console.log(Zs),
Ii='level_1'==b?100:'level_2'==b?129:'level_3'==b?167:'level_4'==b?215:'level_5'==b?278:'level_6'==b?359:'level_7'==b?464:'level_8'==b?599:'level_9'==b?774:'level_10'==b?1e3:0,console.log(Ii),Gt='level_1'==T?1:'level_2'==T?2:'level_3'==T?3:'level_4'==T?4:'level_5'==T?5:'level_6'==T?6:'level_7'==T?7:'level_8'==T?8:'level_9'==T?9:'level_10'==T?10:'level_11'==T?11:'level_12'==T?12:'level_13'==T?13:'level_14'==T?14:'level_15'==T?15:'level_16'==T?16:'level_17'==T?17:'level_18'==T?18:'level_19'==T?19:'level_20'==T?20:0,console.log(Gt),Bn='battle.lance'==A&'level_1'==R?[1.05,1.1]:'battle.lance'==A&'level_2'==R?[1.1,1.2]:'battle.lance'==A&'level_3'==R?[1.2,1.3]:[1,1],console.log(Bn),Mn='battle.battleaxe'==A&'level_1'==R?[1.05,1.1]:'battle.battleaxe'==A&'level_2'==R?[1.1,1.2]:'battle.battleaxe'==A&'level_3'==R?[1.2,1.3]:[1,1],console.log(Mn),Fn='battle.compositebow'==A&'level_1'==R?[1.05,1.1]:'battle.compositebow'==A&'level_2'==R?[1.1,1.2]:'battle.compositebow'==A&'level_3'==R?[1.2,1.3]:[1,1],
console.log(Fn),Jn='battle.halberd'==A&'level_1'==R?[1.1,1.05]:'battle.halberd'==A&'level_2'==R?[1.2,1.1]:'battle.halberd'==A&'level_3'==R?[1.3,1.2]:[1,1],console.log(Jn),ai='battle.longsword'==A&'level_1'==R?[1.1,1.05]:'battle.longsword'==A&'level_2'==R?[1.2,1.1]:'battle.longsword'==A&'level_3'==R?[1.3,1.2]:[1,1],Sn='battle.longbow'==A&'level_1'==R?[1.1,1.05]:'battle.longbow'==A&'level_2'==R?[1.2,1.1]:'battle.longbow'==A&'level_3'==R?[1.3,1.2]:[1,1],Cn='battle.banner'==A&'level_1'==R?[1.1,1.1]:'battle.banner'==A&'level_2'==R?[1.2,1.2]:'battle.banner'==A&'level_3'==R?[1.3,1.3]:[1,1],Kn='battle.star'==A&'level_1'==R?[1.05,1.25]:'battle.star'==A&'level_2'==R?[1.1,1.5]:'battle.star'==A&'level_3'==R?[1.2,2]:[1,1],On='battle.bonfire'==A&'level_1'==R?[1.05,1.25]:'battle.bonfire'==A&'level_2'==R?[1.1,1.5]:'battle.bonfire'==A&'level_3'==R?[1.2,2]:[1,1],Vn='battle.lance'==E&'level_1'==y?[1.05,1.1]:'battle.lance'==E&'level_2'==y?[1.1,1.2]:'battle.lance'==E&'level_3'==y?[1.2,1.3]:[1,1],
...
Ln='battle.bonfire'==E&'level_1'==y?[1.05,1.25]:'battle.bonfire'==E&'level_2'==y?[1.1,1.5]:'battle.bonfire'==E&'level_3'==y?[1.2,2]:[1,1],Wn='battle.lance'==w&'level_1'==k?[1.05,1.1]:'battle.lance'==w&'level_2'==k?[1.1,1.2]:'battle.lance'==w&'level_3'==k?[1.2,1.3]:[1,1],Nn='battle.battleaxe'==w&'level_1'==k?[1.05,1.1]:'battle.battleaxe'==w&'level_2'==k?[1.1,1.2]:'battle.battleaxe'==w&'level_3'==k?[1.2,1.3]:[1,1],jn='battle.compositebow'==w&'level_1'==k?[1.05,1.1]:'battle.compositebow'==w&'level_2'==k?[1.1,1.2]:'battle.compositebow'==w&'level_3'==k?[1.2,1.3]:[1,1],ei='battle.halberd'==w&'level_1'==k?[1.1,1.05]:'battle.halberd'==w&'level_2'==k?[1.2,1.1]:'battle.halberd'==w&'level_3'==k?[1.3,1.2]:[1,1],ii='battle.longsword'==w&'level_1'==k?[1.1,1.05]:'battle.longsword'==w&'level_2'==k?[1.2,1.1]:'battle.longsword'==w&'level_3'==k?[1.3,1.2]:[1,1],yn='battle.longbow'==w&'level_1'==k?[1.1,1.05]:'battle.longbow'==w&'level_2'==k?[1.2,1.1]:'battle.longbow'==w&'level_3'==k?[1.3,1.2]:[1,1],
Dn='battle.banner'==w&'level_1'==k?[1.1,1.1]:'battle.banner'==w&'level_2'==k?[1.2,1.2]:'battle.banner'==w&'level_3'==k?[1.3,1.3]:[1,1],Xn='battle.star'==w&'level_1'==k?[1.05,1.25]:'battle.star'==w&'level_2'==k?[1.1,1.5]:'battle.star'==w&'level_3'==k?[1.2,2]:[1,1],Pn='battle.bonfire'==w&'level_1'==k?[1.05,1.25]:'battle.bonfire'==w&'level_2'==k?[1.1,1.5]:'battle.bonfire'==w&'level_3'==k?[1.2,2]:[1,1],Gn=Bn[0]>=Vn[0]&&Bn[0]>=Wn[0]?Bn:Vn[0]>=Bn[0]&&Vn[0]>=Wn[0]?Vn:Wn[0]>=Bn[0]&&Wn[0]>=Vn[0]?Wn:[1,1],kn=Mn[0]>=In[0]&&Mn[0]>=Nn[0]?Mn:In[0]>=Mn[0]&&In[0]>=Nn[0]?In:Nn[0]>=Mn[0]&&Nn[0]>=In[0]?Nn:[1,1],qn=Fn[0]>=Yn[0]&&Fn[0]>=jn[0]?Fn:Yn[0]>=Fn[0]&&Yn[0]>=jn[0]?Yn:jn[0]>=Fn[0]&&jn[0]>=Yn[0]?jn:[1,1],Un=Cn[0]>=zn[0]&&Cn[0]>=Dn[0]?Cn:zn[0]>=Cn[0]&&zn[0]>=Dn[0]?zn:Dn[0]>=Cn[0]&&Dn[0]>=zn[0]?Dn:[1,1],Hn=Kn[0]>=Qn[0]&&Kn[0]>=Xn[0]?Kn:Qn[0]>=Kn[0]&&Qn[0]>=Xn[0]?Qn:Xn[0]>=Kn[0]&&Xn[0]>=Qn[0]?Xn:[1,1],xn=On[0]>=Ln[0]&&On[0]>=Pn[0]?On:Ln[0]>=On[0]&&Ln[0]>=Pn[0]?Ln:Pn[0]>=On[0]&&Pn[0]>=Ln[0]?Pn:[1,1],
Zn=Jn[0]>=$n[0]&&Jn[0]>=ei[0]?Jn:$n[0]>=Jn[0]&&$n[0]>=ei[0]?$n:ei[0]>=Jn[0]&&ei[0]>=$n[0]?ei:[1,1],ti=ai[0]>=ni[0]&&ai[0]>=ii[0]?ai:ni[0]>=ai[0]&&ni[0]>=ii[0]?ni:ii[0]>=ai[0]&&ii[0]>=ni[0]?ii:[1,1],vn=Sn[0]>=Rn[0]&&Sn[0]>=yn[0]?Sn:Rn[0]>=Sn[0]&&Rn[0]>=yn[0]?Rn:yn[0]>=Sn[0]&&yn[0]>=Rn[0]?yn:[1,1],ho='battle.lance'==S&'level_1'==M?[1.05,1.1]:'battle.lance'==S&'level_2'==M?[1.1,1.2]:'battle.lance'==S&'level_3'==M?[1.2,1.3]:[1,1],fo='battle.battleaxe'==S&'level_1'==M?[1.05,1.1]:'battle.battleaxe'==S&'level_2'==M?[1.1,1.2]:'battle.battleaxe'==S&'level_3'==M?[1.2,1.3]:[1,1],Ao='battle.compositebow'==S&'level_1'==M?[1.05,1.1]:'battle.compositebow'==S&'level_2'==M?[1.1,1.2]:'battle.compositebow'==S&'level_3'==M?[1.2,1.3]:[1,1],wo='battle.halberd'==S&'level_1'==M?[1.1,1.05]:'battle.halberd'==S&'level_2'==M?[1.2,1.1]:'battle.halberd'==S&'level_3'==M?[1.3,1.2]:[1,1],
vo='battle.longsword'==S&'level_1'==M?[1.1,1.05]:'battle.longsword'==S&'level_2'==M?[1.2,1.1]:'battle.longsword'==S&'level_3'==M?[1.3,1.2]:[1,1],To='battle.longbow'==S&'level_1'==M?[1.1,1.05]:'battle.longbow'==S&'level_2'==M?[1.2,1.1]:'battle.longbow'==S&'level_3'==M?[1.3,1.2]:[1,1],bo='battle.banner'==S&'level_1'==M?[1.1,1.1]:'battle.banner'==S&'level_2'==M?[1.2,1.2]:'battle.banner'==S&'level_3'==M?[1.3,1.3]:[1,1],Eo='battle.star'==S&'level_1'==M?[1.05,1.25]:'battle.star'==S&'level_2'==M?[1.1,1.5]:'battle.star'==S&'level_3'==M?[1.2,2]:[1,1],_o='battle.bonfire'==S&'level_1'==M?[1.05,1.25]:'battle.bonfire'==S&'level_2'==M?[1.1,1.5]:'battle.bonfire'==S&'level_3'==M?[1.2,2]:[1,1],Xt=Ce*s[0]+ze*s[1]+De*s[2]+Ge*s[3]+Ye*s[4]+je*s[5]+He*s[6]+We*s[7]+qe*s[8]+Ve*s[9]+Be*s[10]+Fe*s[11]+Ke*s[12],Vt=F*s[0]+Y*s[1]+j*s[2]+H*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log('Prowiant:'+Xt,Vt),na=2*Xt<=Vt?2:1,Hl=Xt-5*We,
Kl=0==Gt?0:Math.round(20*Math.pow(1.2515,Gt-1)),wn=Vt+(Kl+100*K),hs=0==Hl||0==wn?0:Hl/wn>1?1:Hl/wn,console.log(hs),Yl=I/100,Sl=N/100,Qt=Math.round(1e3*(vd/100*Yl*(1+Sl)+Xs/100+rl))/1e3,Ad=qe/(hd=We+qe),Ed=We/hd,ed=Math.round(J*Ad),Td=Math.round(J*Ed),Vs=(qs=We-(0==We?0:We<Td?We:Td))*hs*Qt*(Ni='battle.star'==S?'level_1'==M?[1.05,1.25]:'level_2'==M?[1.1,1.5]:'level_3'==M?[1.2,2]:[1,1]:[1,1])[1],ki=20==Gt?18:19==Gt?17:18==Gt?15:17==Gt?14:16==Gt?13:15==Gt?11:14==Gt?10:13==Gt||12==Gt?9:11==Gt?8:10==Gt?7:9==Gt||8==Gt?6:7==Gt||6==Gt?5:5==Gt||4==Gt||3==Gt?4:2==Gt||1==Gt?3:0,_d=0==Gt?0:2*ki,fd=0==Gt?0:Vs/_d,bd=Gt<=$s?Gt:Gt-$s<fd?Gt<$s?Gt:$s:Gt-fd,Oa=Math.round(bd),xa=Math.round(.05*Oa*1e3)/1e3,Bt=Math.round(Sd/100*(1+xa)*jl*1e3)/1e3,En=qe-(0==qe?0:qe<ed?qe:ed),zt=Math.round(bd),Na=0==zt?0:Math.round(20*Math.pow(1.2515,zt-1)),Wo=Ce+ze+De+Ke>Ye+He&&Ce+ze+De+Ke>Ge+je?'inf':Ye+He>Ce+ze+De+Ke&&Ye+He>Ge+je?'cav':'arc',
is=Ce*s[0]+ze*s[1]+De*s[2]+Ge*s[3]+Ye*s[4]+je*s[5]+He*s[6]+qs*s[7]+En*s[8]+Ve*s[9]+Be*s[10]+Fe*s[11]+Ke*s[12],fs=F*s[0]+Y*s[1]+j*s[2]+H*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log(is,fs),Ys=qs*s[7]+En*s[8]+Fe*s[11]+Ve*s[9]+Be*s[10],'cav'==Wo?(Jl=Ye*s[4]+He*s[6]+Ys,ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Ql=Ge*s[3]+je*s[5]):'inf'==Wo?(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12]+Ys,Jl=Ye*s[4]+He*s[6],Ql=Ge*s[3]+je*s[5]):'arc'==Wo?(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Jl=Ye*s[4]+He*s[6],Ql=Ge*s[3]+je*s[5]+Ys):(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Jl=Ye*s[4]+He*s[6],Ql=Ge*s[3]+je*s[5]),_l=0==ts?0:Math.round(ts/is*1e4)/1e4,fl=0==Jl?0:Math.round(Jl/is*1e4)/1e4,Tl=0==Ql?0:Math.round(Ql/is*1e4)/1e4,console.log(Tl),Nr=Math.round(F*_l),Ir=Math.round(F*fl),Mr=F-Ir-Nr,Vc=Math.round(Y*_l),Bc=Math.round(Y*fl),Gc=Y-Bc-Vc,wa=Math.round(j*_l),Ea=Math.round(j*fl),Aa=j-Ea-wa,W=Math.round(H*_l),V=Math.round(H*fl),B=H-V-W,el=Math.round($*_l),$o=Math.round($*fl),Jo=$-$o-el,
Cl=Math.round(ee*_l),Ul=Math.round(ee*fl),Pl=ee-Ul-Cl,bi=Math.round(te*_l),_i=Math.round(te*fl),fi=te-_i-bi,xs=Math.round(X*_l),Ns=Math.round(X*fl),Is=X-Ns-xs,dn=Math.round(Z*_l),cn=Math.round(Z*fl),rn=Z-cn-dn,ur=Math.round(K*_l),dr=Math.round(K*fl),cr=K-dr-ur,sd=Math.round(J*_l),ld=Math.round(J*fl),od=J-ld-sd,Fa=Math.round(ae*_l),qa=Math.round(ae*fl),Wa=ae-qa-Fa,lo=Math.round(Q*_l),oo=Math.round(Q*fl),io=Q-oo-lo,gs=Nr*s[0]+Vc*s[1]+wa*s[2]+Fa*s[12]+ur*s[10]+el*s[4]+bi*s[6]+W*s[3]+Cl*s[5]+xs*s[7]+dn*s[8]+sd*s[11]+lo*s[9],ds=Ir*s[0]+Bc*s[1]+Ea*s[2]+qa*s[12]+dr*s[10]+$o*s[4]+_i*s[6]+V*s[3]+Ul*s[5]+Ns*s[7]+cn*s[8]+ld*s[11]+oo*s[9],ss=Mr*s[0]+Gc*s[1]+Aa*s[2]+Wa*s[12]+cr*s[10]+Jo*s[4]+fi*s[6]+B*s[3]+Pl*s[5]+Is*s[7]+rn*s[8]+od*s[11]+io*s[9],console.log(ss,ds,gs),dc=Nr*n[0]*Zn[0]+Vc*n[1]*ti[0]+wa*n[2]*kn[0]+Fa*n[12]+ur*n[10]+el*n[4]*Gn[0]+bi*n[6]*Un[0]+W*n[3]*vn[0]+Cl*n[5]*qn[0]+xs*n[7]*Hn[0]+dn*n[8]*xn[0]+sd*n[11]+lo*n[9],
sc=Ir*i[0]*Zn[0]+Bc*i[1]*ti[0]+Ea*i[2]*kn[0]+qa*i[12]+dr*i[10]+$o*i[4]*Gn[0]+_i*i[6]*Un[0]+V*i[3]*vn[0]+Ul*i[5]*qn[0]+Ns*i[7]*Hn[0]+cn*i[8]*xn[0]+ld*i[11]+oo*i[9],ic=Mr*o[0]*Zn[0]+Gc*o[1]*ti[0]+Aa*o[2]*kn[0]+Wa*o[12]+cr*o[10]+Jo*o[4]*Gn[0]+fi*o[6]*Un[0]+B*o[3]*vn[0]+Pl*o[5]*qn[0]+Is*o[7]*Hn[0]+rn*o[8]*xn[0]+od*o[11]+io*o[9],Ks=qs*l[7]*Eo[1]+En*l[8]*_o[1]+Fe*l[11]+Ve*l[9]+Be*l[10],'cav'==Wo?(Jr=Ye*l[4]*ho[1]+He*l[6]*bo[1]+Ks,tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*fo[1]+Ke*l[12]*na,Qr=Ge*l[3]*To[1]+je*l[5]*Ao[1]):'inf'==Wo?(tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*fo[1]+Ke*l[12]*na+Ks,Jr=Ye*l[4]*ho[1]+He*l[6]*bo[1],Qr=Ge*l[3]*To[1]+je*l[5]*Ao[1]):'arc'==Wo?(tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*fo[1]+Ke*l[12]*na,Jr=Ye*l[4]*ho[1]+He*l[6]*bo[1],Qr=Ge*l[3]*To[1]+je*l[5]*Ao[1]+Ks):(tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*fo[1]+Ke*l[12]*na,Jr=Ye*l[4]*ho[1]+He*l[6]*bo[1],Qr=Ge*l[3]*To[1]+je*l[5]*Ao[1]),Zt=(Fr=tc*Qt)+(Vr=Jr*Qt)+(Dr=Qr*Qt),Wt=(hc=dc*Bt+Na)+(fc=sc*Bt+Na)+(gc=ic*Bt+Na),
console.log(Zt,Wt),Bo=0==Fr||0==hc?0:hc<=Fr?1:Math.pow(Fr/hc,.5)/(hc/Fr),zo=0==Vr||0==fc?0:fc<=Vr?1:Math.pow(Vr/fc,.5)/(fc/Vr),Po=0==Dr||0==gc?0:gc<=Dr?1:Math.pow(Dr/gc,.5)/(gc/Dr),xo=0==Fr||0==hc?0:Fr<=hc?1:Math.pow(hc/Fr,.5)/(Fr/hc),Mo=0==Vr||0==fc?0:Vr<=fc?1:Math.pow(fc/Vr,.5)/(Vr/fc),Ro=0==Dr||0==gc?0:Dr<=gc?1:Math.pow(gc/Dr,.5)/(Dr/gc),Li=Math.round(1e6*xo)/1e6,Oi=Math.round(1e6*Mo)/1e6,xi=Math.round(1e6*Ro)/1e6,Ci=Math.round(1e6*Bo)/1e6,Ui=Math.round(1e6*zo)/1e6,Pi=Math.round(1e6*Po)/1e6,Sr=Math.round(-Nr*Ci+1e-6)+Math.round(-Ir*Ui+1e-6)+Math.round(-Mr*Pi+1e-6),Uc=Math.round(-Vc*Ci+1e-6)+Math.round(-Bc*Ui+1e-6)+Math.round(-Gc*Pi+1e-6),fa=Math.round(-wa*Ci+1e-6)+Math.round(-Ea*Ui+1e-6)+Math.round(-Aa*Pi+1e-6),C=Math.round(-W*Ci+1e-6)+Math.round(-V*Ui+1e-6)+Math.round(-B*Pi+1e-6),Ko=Math.round(-el*Ci+1e-6)+Math.round(-$o*Ui+1e-6)+Math.round(-Jo*Pi+1e-6),Nl=Math.round(-Cl*Ci+1e-6)+Math.round(-Ul*Ui+1e-6)+Math.round(-Pl*Pi+1e-6),
pi=Math.round(-bi*Ci+1e-6)+Math.round(-_i*Ui+1e-6)+Math.round(-fi*Pi+1e-6),Rs=Math.round(-xs*Ci+1e-6)+Math.round(-Ns*Ui+1e-6)+Math.round(-Is*Pi+1e-6),nn=Math.round(-dn*Ci+1e-6)+Math.round(-cn*Ui+1e-6)+Math.round(-rn*Pi+1e-6),td=Math.round(-sd*Ci+1e-6)+Math.round(-ld*Ui+1e-6)+Math.round(-od*Pi+1e-6),Da=Math.round(-Fa*Ci+1e-6)+Math.round(-qa*Ui+1e-6)+Math.round(-Wa*Pi+1e-6),eo=Math.round(-lo*Ci+1e-6)+Math.round(-oo*Ui+1e-6)+Math.round(-io*Pi+1e-6),or=Math.round(-ur*Ci+1e-6)+Math.round(-dr*Ui+1e-6)+Math.round(-cr*Pi+1e-6),hr=Math.round(-Ce*Li+1e-6),Nc=Math.round(-ze*Li+1e-6),ua=Math.round(-De*Li+1e-6),La=Math.round(-Ke*Li+1e-6),x=Math.round(-Ge*xi+1e-6),Rl=Math.round(-je*xi+1e-6),qo=Math.round(-Ye*Oi+1e-6),si=Math.round(-He*Oi+1e-6),'cav'==Wo?(As=Math.round(-qs*Oi+1e-6),Ja=Math.round(-En*Oi+1e-6),Qc=Math.round(-Fe*Oi+1e-6),Qi=Math.round(-Ve*Oi+1e-6),er=Math.round(-Be*Oi+1e-6)):'inf'==Wo?(As=Math.round(-qs*Li+1e-6),Ja=Math.round(-En*Li+1e-6),Qc=Math.round(-Fe*Li+1e-6),
Qi=Math.round(-Ve*Li+1e-6),er=Math.round(-Be*Li+1e-6)):'arc'==Wo&&(As=Math.round(-qs*xi+1e-6),Ja=Math.round(-En*xi+1e-6),Qc=Math.round(-Fe*xi+1e-6),Qi=Math.round(-Ve*xi+1e-6),er=Math.round(-Be*xi+1e-6)),wr=Ce+hr,Lc=ze+Nc,ma=De+ua,P=Ge+x,jo=Ye+qo,Ml=je+Rl,di=He+si,vs=qs+As,tn=En+Ja,Jc=Fe+Qc,Ca=Ke+La,nr=Be+er,Ji=Ve+Qi,kr=F+Sr,Dc=Y+Uc,ha=j+fa,G=H+C,Zo=$+Ko,Ll=ee+Nl,Ti=te+pi,Ms=X+Rs,sn=Z+nn,id=J+td,Va=ae+Da,rr=K+or,no=Q+eo,cl=hr*s[0]+Nc*s[1]+ua*s[2]+x*s[3]+qo*s[4]+Rl*s[5]+si*s[6]+As*s[7]+Ja*s[8]+Qi*s[9]+er*s[10]+Qc*s[11]+La*s[12],pl=Sr*s[0]+Uc*s[1]+fa*s[2]+C*s[3]+Ko*s[4]+Nl*s[5]+pi*s[6]+Rs*s[7]+nn*s[8]+eo*s[9]+or*s[10]+td*s[11]+Da*s[12],console.log(cl,pl),Sc=wr*s[0]+Lc*s[1]+ma*s[2]+P*s[3]+jo*s[4]+Ml*s[5]+di*s[6]+vs*s[7]+tn*s[8]+Jc*s[11]+Ca*s[12]+nr*s[10]+Ji*s[9],kc=kr*s[0]+Dc*s[1]+ha*s[2]+G*s[3]+Zo*s[4]+Ll*s[5]+Ti*s[6]+Ms*s[7]+sn*s[8]+id*s[11]+Va*s[12]+rr*s[10]+no*s[9],console.log(kc,Sc),da=0==Zt||0==Wt?0:Wt<=Zt?1:Math.pow(Zt/Wt,.5/(Wt/Zt)),console.log(da),
os=wr*s[0]+Lc*s[1]+ma*s[2]+P*s[3]+jo*s[4]+Ml*s[5]+di*s[6]+vs*s[7]+tn*s[8]+Ji*s[9]+nr*s[10]+Jc*s[11]+Ca*s[12],_s=kr*s[0]+Dc*s[1]+ha*s[2]+G*s[3]+Zo*s[4]+Ll*s[5]+Ti*s[6]+Ms*s[7]+sn*s[8]+no*s[9]+rr*s[10]+id*s[11]+Va*s[12],console.log(os,_s),js=vs*s[7]+tn*s[8]+Jc*s[11]+Ji*s[9],'cav'==Wo?($l=jo*s[4]+di*s[6]+js,as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],Xl=P*s[3]+Ml*s[5]):'inf'==Wo?(as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10]+js,$l=jo*s[4]+di*s[6],Xl=P*s[3]+Ml*s[5]):'arc'==Wo?(as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],$l=jo*s[4]+di*s[6],Xl=P*s[3]+Ml*s[5]+js):(as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],$l=jo*s[4]+di*s[6],Xl=P*s[3]+Ml*s[5]),Al=0==as?0:Math.round(as/os*1e4)/1e4,hl=0==$l?0:Math.round($l/os*1e4)/1e4,bl=0==Xl?0:Math.round(Xl/os*1e4)/1e4,console.log(bl),Pr=Math.round(kr*Al),Lr=Math.round(kr*hl),Or=kr-Lr-Pr,Yc=Math.round(Dc*Al),Fc=Math.round(Dc*hl),qc=Dc-Fc-Yc,ya=Math.round(ha*Al),Ra=Math.round(ha*hl),Sa=ha-Ra-ya,la=Math.round(G*Al),oa=Math.round(G*hl),ia=G-oa-la,
il=Math.round(Zo*Al),nl=Math.round(Zo*hl),al=Zo-nl-il,Bl=Math.round(Ll*Al),Gl=Math.round(Ll*hl),Dl=Ll-Gl-Bl,wi=Math.round(Ti*Al),Ei=Math.round(Ti*hl),Ai=Ti-Ei-wi,Us=Math.round(Ms*Al),Ps=Math.round(Ms*hl),Ls=Ms-Ps-Us,mn=Math.round(sn*Al),gn=Math.round(sn*hl),pn=sn-gn-mn,Tr=Math.round(rr*Al),mr=Math.round(rr*hl),gr=rr-mr-Tr,ud=Math.round(id*Al),dd=Math.round(id*hl),cd=id-dd-ud,Ka=Math.round(Va*Al),Ha=Math.round(Va*hl),ja=Va-Ha-Ka,uo=Math.round(no*Al),co=Math.round(no*hl),ro=no-co-uo,ms=Pr*s[0]+Yc*s[1]+ya*s[2]+Ka*s[12]+Tr*s[10]+il*s[4]+wi*s[6]+la*s[3]+Bl*s[5]+Us*s[7]+mn*s[8]+ud*s[11]+uo*s[9],us=Lr*s[0]+Fc*s[1]+Ra*s[2]+Ha*s[12]+mr*s[10]+nl*s[4]+Ei*s[6]+oa*s[3]+Gl*s[5]+Ps*s[7]+gn*s[8]+dd*s[11]+co*s[9],rs=Or*s[0]+qc*s[1]+Sa*s[2]+ja*s[12]+gr*s[10]+al*s[4]+Ai*s[6]+ia*s[3]+Dl*s[5]+Ls*s[7]+pn*s[8]+cd*s[11]+ro*s[9],console.log(rs,us,ms),
uc=Pr*n[0]*Zn[0]+Yc*n[1]*ti[0]+ya*n[2]*kn[0]+Ka*n[12]+Tr*n[10]+il*n[4]*Gn[0]+wi*n[6]*Un[0]+la*n[3]*vn[0]+Bl*n[5]*qn[0]+Us*n[7]*Hn[0]+mn*n[8]*xn[0]+ud*n[11]+uo*n[9],rc=Lr*i[0]*Zn[0]+Fc*i[1]*ti[0]+Ra*i[2]*kn[0]+Ha*i[12]+mr*i[10]+nl*i[4]*Gn[0]+Ei*i[6]*Un[0]+oa*i[3]*vn[0]+Gl*i[5]*qn[0]+Ps*i[7]*Hn[0]+gn*i[8]*xn[0]+dd*i[11]+co*i[9],oc=Or*o[0]*Zn[0]+qc*o[1]*ti[0]+Sa*o[2]*kn[0]+ja*o[12]+gr*o[10]+al*o[4]*Gn[0]+Ai*o[6]*Un[0]+ia*o[3]*vn[0]+Dl*o[5]*qn[0]+Ls*o[7]*Hn[0]+pn*o[8]*xn[0]+cd*o[11]+ro*o[9],Qs=vs*l[7]*Eo[1]+tn*l[8]*_o[1]+Jc*l[11]+Ji*l[9],'cav'==Wo?($r=jo*l[4]*ho[1]+di*l[6]*bo[1]+Qs,ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*fo[1]+Ca*l[12]*na+nr*l[10],Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]):'inf'==Wo?(ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*fo[1]+Ca*l[12]*na+nr*l[10]+Qs,$r=jo*l[4]*ho[1]+di*l[6]*bo[1],Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]):'arc'==Wo?(ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*fo[1]+Ca*l[12]*na+nr*l[10],$r=jo*l[4]*ho[1]+di*l[6]*bo[1],
Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]+Qs):(ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*fo[1]+Ca*l[12]*na+nr*l[10],$r=jo*l[4]*ho[1]+di*l[6]*bo[1],Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]),Hr=(Yr=ac*Qt)+(Wr=$r*Qt)+(Gr=Xr*Qt),wc=(Ac=uc*Bt)+(_c=rc*Bt)+(mc=oc*Bt),console.log(Hr,wc),Vo=0==Yr||0==Ac?0:Ac<=Yr?1:Math.pow(Yr/Ac,.5)/(Ac/Yr),Do=0==Wr||0==_c?0:_c<=Wr?1:Math.pow(Wr/_c,.5)/(_c/Wr),Uo=0==Gr||0==mc?0:mc<=Gr?1:Math.pow(Gr/mc,.5)/(mc/Gr),Oo=0==Yr||0==Ac?0:Yr<=Ac?1:Math.pow(Ac/Yr,.5)/(Yr/Ac),Io=0==Wr||0==_c?0:Wr<=_c?1:Math.pow(_c/Wr,.5)/(Wr/_c),yo=0==Gr||0==mc?0:Gr<=mc?1:Math.pow(mc/Gr,.5)/(Gr/mc),Gi=Math.round(1e6*Oo)/1e6,Di=Math.round(1e6*Io)/1e6,zi=Math.round(1e6*yo)/1e6,Wi=Math.round(1e6*Vo)/1e6,Vi=Math.round(1e6*Do)/1e6,Bi=Math.round(1e6*Uo)/1e6,Rr=Math.round(-Pr*Wi+1e-6)+Math.round(-Lr*Vi+1e-6)+Math.round(-Or*Bi+1e-6),Cc=Math.round(-Yc*Wi+1e-6)+Math.round(-Fc*Vi+1e-6)+Math.round(-qc*Bi+1e-6),_a=Math.round(-ya*Wi+1e-6)+Math.round(-Ra*Vi+1e-6)+Math.round(-Sa*Bi+1e-6),
z=Math.round(-la*Wi+1e-6)+Math.round(-oa*Vi+1e-6)+Math.round(-ia*Bi+1e-6),Qo=Math.round(-il*Wi+1e-6)+Math.round(-nl*Vi+1e-6)+Math.round(-al*Bi+1e-6),xl=Math.round(-Bl*Wi+1e-6)+Math.round(-Gl*Vi+1e-6)+Math.round(-Dl*Bi+1e-6),gi=Math.round(-wi*Wi+1e-6)+Math.round(-Ei*Vi+1e-6)+Math.round(-Ai*Bi+1e-6),ys=Math.round(-Us*Wi+1e-6)+Math.round(-Ps*Vi+1e-6)+Math.round(-Ls*Bi+1e-6),on=Math.round(-mn*Wi+1e-6)+Math.round(-gn*Vi+1e-6)+Math.round(-pn*Bi+1e-6),ad=Math.round(-ud*Wi+1e-6)+Math.round(-dd*Vi+1e-6)+Math.round(-cd*Bi+1e-6),Ga=Math.round(-Ka*Wi+1e-6)+Math.round(-Ha*Vi+1e-6)+Math.round(-ja*Bi+1e-6),to=Math.round(-uo*Wi+1e-6)+Math.round(-co*Vi+1e-6)+Math.round(-ro*Bi+1e-6),lr=Math.round(-Tr*Wi+1e-6)+Math.round(-mr*Vi+1e-6)+Math.round(-gr*Bi+1e-6),Ar=Math.round(-wr*Gi+1e-6),xc=Math.round(-Lc*Gi+1e-6),pa=Math.round(-ma*Gi+1e-6),Pa=Math.round(-Ca*Gi+1e-6),O=Math.round(-P*zi+1e-6),yl=Math.round(-Ml*zi+1e-6),Fo=Math.round(-jo*Di+1e-6),ri=Math.round(-di*Di+1e-6),
'cav'==Wo?(Es=Math.round(-vs*Di+1e-6),$a=Math.round(-tn*Di+1e-6),Xc=Math.round(-Jc*Di+1e-6),Xi=Math.round(-Ji*Di+1e-6)):'inf'==Wo?(Es=Math.round(-vs*Gi+1e-6),$a=Math.round(-tn*Gi+1e-6),Xc=Math.round(-Jc*Gi+1e-6),Xi=Math.round(-Ji*Gi+1e-6)):'arc'==Wo&&(Es=Math.round(-vs*zi+1e-6),$a=Math.round(-tn*zi+1e-6),Xc=Math.round(-Jc*zi+1e-6),Xi=Math.round(-Ji*zi+1e-6)),tr=100*nr==as?0:Math.round(-nr*Gi+1e-6),vr=wr+Ar,Pc=Lc+xc,Ta=ma+pa,U=P+O,Ho=jo+Fo,Il=Ml+yl,ui=di+ri,Ss=vs+Es,an=tn+$a,$c=Jc+Xc,za=Ca+Pa,ir=nr+tr,$i=Ji+Xi,xr=kr+Rr,Wc=Dc+Cc,va=ha+_a,q=G+z,tl=Zo+Qo,zl=Ll+xl,hi=Ti+gi,Os=Ms+ys,un=sn+on,rd=id+ad,Ya=Va+Ga,pr=rr+lr,so=no+to,dl=Ar*s[0]+xc*s[1]+pa*s[2]+O*s[3]+Fo*s[4]+yl*s[5]+ri*s[6]+Es*s[7]+$a*s[8]+Xi*s[9]+tr*s[10]+Xc*s[11]+Pa*s[12],gl=Rr*s[0]+Cc*s[1]+_a*s[2]+z*s[3]+Qo*s[4]+xl*s[5]+gi*s[6]+ys*s[7]+on*s[8]+to*s[9]+lr*s[10]+ad*s[11]+Ga*s[12],console.log(dl,gl),Rc=vr*s[0]+Pc*s[1]+Ta*s[2]+U*s[3]+Ho*s[4]+Il*s[5]+ui*s[6]+Ss*s[7]+an*s[8]+$c*s[11]+za*s[12]+ir*s[10]+$i*s[9],
Mc=xr*s[0]+Wc*s[1]+va*s[2]+q*s[3]+tl*s[4]+zl*s[5]+hi*s[6]+Os*s[7]+un*s[8]+rd*s[11]+Ya*s[12]+pr*s[10]+so*s[9],console.log(Mc,Rc),ls=vr*s[0]+Pc*s[1]+Ta*s[2]+U*s[3]+Ho*s[4]+Il*s[5]+ui*s[6]+Ss*s[7]+an*s[8]+$i*s[9]+ir*s[10]+$c*s[11]+za*s[12],bs=xr*s[0]+Wc*s[1]+va*s[2]+q*s[3]+tl*s[4]+zl*s[5]+hi*s[6]+Os*s[7]+un*s[8]+so*s[9]+pr*s[10]+rd*s[11]+Ya*s[12],console.log(ls,bs),Fs=Ss*s[7]+an*s[8]+$c*s[11]+$i*s[9],'cav'==Wo?(es=Ho*s[4]+ui*s[6]+Fs,ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10],Zl=U*s[3]+Il*s[5]):'inf'==Wo?(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10]+Fs,es=Ho*s[4]+ui*s[6],Zl=U*s[3]+Il*s[5]):'arc'==Wo?(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10],es=Ho*s[4]+ui*s[6],Zl=U*s[3]+Il*s[5]+Fs):(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10],es=Ho*s[4]+ui*s[6],Zl=U*s[3]+Il*s[5]),vl=0==ns?0:Math.round(ns/ls*1e4)/1e4,wl=0==es?0:Math.round(es/ls*1e4)/1e4,El=0==Zl?0:Math.round(Zl/ls*1e4)/1e4,console.log(El),zr=Math.round(xr*vl),Cr=Math.round(xr*wl),Ur=xr-Cr-zr,Kc=Math.round(Wc*vl),Hc=Math.round(Wc*wl),
jc=Wc-Hc-Kc,Ia=Math.round(va*vl),Ma=Math.round(va*wl),ka=va-Ma-Ia,ca=Math.round(q*vl),ra=Math.round(q*wl),sa=q-ra-ca,sl=Math.round(tl*vl),ll=Math.round(tl*wl),ol=tl-ll-sl,ql=Math.round(zl*vl),Wl=Math.round(zl*wl),Vl=zl-Wl-ql,Ri=Math.round(hi*vl),Si=Math.round(hi*wl),vi=hi-Si-Ri,Ds=Math.round(Os*vl),zs=Math.round(Os*wl),Cs=Os-zs-Ds,_n=Math.round(un*vl),fn=Math.round(un*wl),Tn=un-fn-_n,br=Math.round(pr*vl),_r=Math.round(pr*wl),fr=pr-_r-br,md=Math.round(rd*vl),gd=Math.round(rd*wl),pd=rd-gd-md,Za=Math.round(Ya*vl),Xa=Math.round(Ya*wl),Qa=Ya-Xa-Za,mo=Math.round(so*vl),go=Math.round(so*wl),po=so-go-mo,Ts=zr*s[0]+Kc*s[1]+Ia*s[2]+Za*s[12]+br*s[10]+sl*s[4]+Ri*s[6]+ca*s[3]+ql*s[5]+Ds*s[7]+_n*s[8]+md*s[11]+mo*s[9],ps=Cr*s[0]+Hc*s[1]+Ma*s[2]+Xa*s[12]+_r*s[10]+ll*s[4]+Si*s[6]+ra*s[3]+Wl*s[5]+zs*s[7]+fn*s[8]+gd*s[11]+go*s[9],cs=Ur*s[0]+jc*s[1]+ka*s[2]+Qa*s[12]+fr*s[10]+ol*s[4]+vi*s[6]+sa*s[3]+Vl*s[5]+Cs*s[7]+Tn*s[8]+pd*s[11]+po*s[9],console.log(cs,ps,Ts),
pc=zr*n[0]*Zn[0]+Kc*n[1]*ti[0]+Ia*n[2]*kn[0]+Za*n[12]+br*n[10]+sl*n[4]*Gn[0]+Ri*n[6]*Un[0]+ca*n[3]*vn[0]+ql*n[5]*qn[0]+Ds*n[7]*Hn[0]+_n*n[8]*xn[0]+md*n[11]+mo*n[9],cc=Cr*i[0]*Zn[0]+Hc*i[1]*ti[0]+Ma*i[2]*kn[0]+Xa*i[12]+_r*i[10]+ll*i[4]*Gn[0]+Si*i[6]*Un[0]+ra*i[3]*vn[0]+Wl*i[5]*qn[0]+zs*i[7]*Hn[0]+fn*i[8]*xn[0]+gd*i[11]+go*i[9],lc=Ur*o[0]*Zn[0]+jc*o[1]*ti[0]+ka*o[2]*kn[0]+Qa*o[12]+fr*o[10]+ol*o[4]*Gn[0]+vi*o[6]*Un[0]+sa*o[3]*vn[0]+Vl*o[5]*qn[0]+Cs*o[7]*Hn[0]+Tn*o[8]*xn[0]+pd*o[11]+po*o[9],Hs=Ss*l[7]*Eo[1]+an*l[8]*_o[1]+$c*l[11]+$i*l[9],'cav'==Wo?(ec=Ho*l[4]*ho[1]+ui*l[6]*bo[1]+Hs,nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*fo[1]+za*l[12]*na+ir*l[10],Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]):'inf'==Wo?(nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*fo[1]+za*l[12]*na+ir*l[10]+Hs,ec=Ho*l[4]*ho[1]+ui*l[6]*bo[1],Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]):'arc'==Wo?(nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*fo[1]+za*l[12]*na+ir*l[10],ec=Ho*l[4]*ho[1]+ui*l[6]*bo[1],
Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]+Hs):(nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*fo[1]+za*l[12]*na+ir*l[10],ec=Ho*l[4]*ho[1]+ui*l[6]*bo[1],Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]),Kr=(jr=nc*Qt)+(qr=ec*Qt)+(Br=Zr*Qt),vc=(Ec=pc*Bt)+(bc=cc*Bt)+(Tc=lc*Bt),console.log(Kr,vc),Go=0==jr||0==Ec?0:Ec<=jr?1:Math.pow(jr/Ec,.5)/(Ec/jr),Co=0==qr||0==bc?0:bc<=qr?1:Math.pow(qr/bc,.5)/(bc/qr),Lo=0==Br||0==Tc?0:Tc<=Br?1:Math.pow(Br/Tc,.5)/(Tc/Br),No=0==jr||0==Ec?0:jr<=Ec?1:Math.pow(Ec/jr,.5)/(jr/Ec),ko=0==qr||0==bc?0:qr<=bc?1:Math.pow(bc/qr,.5)/(qr/bc),So=0==Br||0==Tc?0:Br<=Tc?1:Math.pow(Tc/Br,.5)/(Br/Tc),Yi=Math.round(1e6*No)/1e6,Fi=Math.round(1e6*ko)/1e6,qi=Math.round(1e6*So)/1e6,Ki=Math.round(1e6*Go)/1e6,Hi=Math.round(1e6*Co)/1e6,ji=Math.round(1e6*Lo)/1e6,yr=Math.round(-zr*Ki+1e-6)+Math.round(-Cr*Hi+1e-6)+Math.round(-Ur*ji+1e-6),zc=Math.round(-Kc*Ki+1e-6)+Math.round(-Hc*Hi+1e-6)+Math.round(-jc*ji+1e-6),ba=Math.round(-Ia*Ki+1e-6)+Math.round(-Ma*Hi+1e-6)+Math.round(-ka*ji+1e-6),
D=Math.round(-ca*Ki+1e-6)+Math.round(-ra*Hi+1e-6)+Math.round(-sa*ji+1e-6),Xo=Math.round(-sl*Ki+1e-6)+Math.round(-ll*Hi+1e-6)+Math.round(-ol*ji+1e-6),Ol=Math.round(-ql*Ki+1e-6)+Math.round(-Wl*Hi+1e-6)+Math.round(-Vl*ji+1e-6),mi=Math.round(-Ri*Ki+1e-6)+Math.round(-Si*Hi+1e-6)+Math.round(-vi*ji+1e-6),ks=Math.round(-Ds*Ki+1e-6)+Math.round(-zs*Hi+1e-6)+Math.round(-Cs*ji+1e-6),ln=Math.round(-_n*Ki+1e-6)+Math.round(-fn*Hi+1e-6)+Math.round(-Tn*ji+1e-6),nd=Math.round(-md*Ki+1e-6)+Math.round(-gd*Hi+1e-6)+Math.round(-pd*ji+1e-6),Ba=Math.round(-Za*Ki+1e-6)+Math.round(-Xa*Hi+1e-6)+Math.round(-Qa*ji+1e-6),ao=Math.round(-mo*Ki+1e-6)+Math.round(-go*Hi+1e-6)+Math.round(-po*ji+1e-6),sr=Math.round(-br*Ki+1e-6)+Math.round(-_r*Hi+1e-6)+Math.round(-fr*ji+1e-6),Er=Math.round(-vr*Yi+1e-6),Oc=Math.round(-Pc*Yi+1e-6),ga=Math.round(-Ta*Yi+1e-6),Ua=Math.round(-za*Yi+1e-6),L=Math.round(-U*qi+1e-6),kl=Math.round(-Il*qi+1e-6),Yo=Math.round(-Ho*Fi+1e-6),ci=Math.round(-ui*Fi+1e-6),
'cav'==Wo?(ws=Math.round(-Ss*Fi+1e-6),en=Math.round(-an*Fi+1e-6),Zc=Math.round(-$c*Fi+1e-6),Zi=Math.round(-$i*Fi+1e-6)):'inf'==Wo?(ws=Math.round(-Ss*Yi+1e-6),en=Math.round(-an*Yi+1e-6),Zc=Math.round(-$c*Yi+1e-6),Zi=Math.round(-$i*Yi+1e-6)):'arc'==Wo&&(ws=Math.round(-Ss*qi+1e-6),en=Math.round(-an*qi+1e-6),Zc=Math.round(-$c*qi+1e-6),Zi=Math.round(-$i*qi+1e-6)),ar=100*ir==ns?0:Math.round(-ir*Yi+1e-6),Et=vr+Er,wt=Pc+Oc,vt=Ta+ga,St=U+L,Nt=Ho+Yo,xt=Il+kl,Ot=ui+ci,kt=Ss+ws,Mt=an+en,It=$c+Zc,Lt=za+Ua,Rt=ir+ar,yt=$i+Zi,ve=xr+yr,Se=Wc+zc,Re=va+ba,ye=q+D,Oe=tl+Xo,Le=zl+Ol,Pe=hi+mi,Ie=Os+ks,Ne=un+ln,xe=rd+nd,Ue=Ya+Ba,ke=pr+sr,Me=so+ao,ul=Er*s[0]+Oc*s[1]+ga*s[2]+L*s[3]+Yo*s[4]+kl*s[5]+ci*s[6]+ws*s[7]+en*s[8]+Zi*s[9]+ar*s[10]+Zc*s[11]+Ua*s[12],ml=yr*s[0]+zc*s[1]+ba*s[2]+D*s[3]+Xo*s[4]+Ol*s[5]+mi*s[6]+ks*s[7]+ln*s[8]+ao*s[9]+sr*s[10]+nd*s[11]+Ba*s[12],console.log(ul,ml),yc=Et*s[0]+wt*s[1]+vt*s[2]+St*s[3]+Nt*s[4]+xt*s[5]+Ot*s[6]+kt*s[7]+Mt*s[8]+It*s[11]+Lt*s[12]+Rt*s[10]+yt*s[9],
Ic=ve*s[0]+Se*s[1]+Re*s[2]+ye*s[3]+Oe*s[4]+Le*s[5]+Pe*s[6]+Ie*s[7]+Ne*s[8]+xe*s[11]+Ue*s[12]+ke*s[10]+Me*s[9],console.log(Ic,yc),Qe=-Ce+Et,Xe=-ze+wt,Ze=-De+vt,Je=-Ge+St,it=-Ye+Nt,ot=-je+xt,lt=-He+Ot,tt=-We+kt,at=-qe+Mt,nt=-Fe+It,st=-Ke+Lt,$e=-Be+Rt,et=-Ve+yt,ne=-F+ve,ie=-Y+Se,oe=-j+Re,le=-H+ye,pe=-$+Oe,ge=-ee+Le,me=-te+Pe,ce=-X+Ie,de=-Z+Ne,ue=-J+xe,Te=-ae+Ue,se=-K+ke,re=-Q+Me,Ws=0==kt?0:kt*Qt*Ni[1],Mi=20==zt?18:19==zt?17:18==zt?15:17==zt?14:16==zt?13:15==zt?11:14==zt?10:13==zt||12==zt?9:11==zt?8:10==zt?7:9==zt||8==zt?6:7==zt||6==zt?5:5==zt||4==zt||3==zt?4:2==zt||1==zt?3:0,Gs=0==xa?0:2*Mi,Bs=0==Ws||0==Gs?0:-Ws/Gs,li=zt<=$s?zt:zt-$s<-Bs?zt<$s?zt:$s:zt+Bs,Dt=Math.round(li),Ut='wall'==h?Dt:v[t.BATTLE_TARGET_LEVEL],An=0==Mt||0==Ut?0:Mt*Qt*_o[1],
...
bn=0==Ut?0:yi*Bt,hn=0==An||0==bn?0:-An/bn,oi='wall'==h?li<=$s?li:li-$s<-hn?li<$s?li:$s:li+hn:hn+Ut<=0?0:hn+Ut,Ct=Math.round(oi),console.log(Ct),$t=Qe*s[0]+Xe*s[1]+Ze*s[2]+Je*s[3]+it*s[4]+ot*s[5]+lt*s[6]+tt*s[7]+at*s[8]+et*s[9]+$e*s[10]+nt*s[11]+st*s[12],Ft=ne*s[0]+ie*s[1]+oe*s[2]+le*s[3]+pe*s[4]+ge*s[5]+me*s[6]+ce*s[7]+de*s[8]+re*s[9]+se*s[10]+ue*s[11]+Te*s[12],Jt=ne*a[0]+ie*a[1]+oe*a[2]+le*a[3]+pe*a[4]+ge*a[5]+me*a[6]+ce*a[7]+de*a[8]+re*a[9]+se*a[10]+ue*a[11]+Te*a[12],qt=Qe*e[0]+Xe*e[1]+Ze*e[2]+Je*e[3]+it*e[4]+ot*e[5]+lt*e[6]+tt*e[7]+at*e[8]+et*e[9]+$e*e[10]+nt*e[11]+st*e[12],console.log(Jt,qt),ta=0==Xt||0==$t?0:Math.round(-$t/Xt*1e3)/1e3,console.log(ta),wd=F+Y+j+ae>$+te&&F+Y+j+ae>H+ee?'inf':$+te>F+Y+j+ae&&$+te>H+ee?'cav':'arc',ea='inf'==Wo?'piechota':'cav'==Wo?'kawaleria':'łucznicy',console.log(ea),Yt='inf'==wd?'piechota':'cav'==wd?'kawaleria':'łucznicy',console.log(Yt),jt=0==Vt||0==Ft?0:Math.round(-Ft/Vt*1e3)/1e3,console.log(jt),rt=Math.round(Qe*(Fl+Js)),ct=Math.round(Xe*(Fl+Js)),
dt=Math.round(Ze*(Fl+Js)),ut=Math.round(Je*(Fl+Js)),_t=Math.round(it*(Fl+Js)),bt=Math.round(ot*(Fl+Js)),ht=Math.round(lt*(Fl+Js)),mt=Math.round(tt*(Fl+Js)),Tt=Math.round(at*(Fl+Js)),pt=Math.round($e*(Fl+Js)),gt=Math.round(et*(Fl+Js)),ft=Math.round(nt*(Fl+Js)),At=Math.round(st*(Fl+Js)),console.log(rt,ct,dt,ut,_t,bt,ht,mt,Tt,pt,gt,ft,At),Kt=Ii+Zs,0==Ii?(fe=0,_e=0,be=0,he=0,Ae=0,Ee=0,we=0):Ii<1e3?Kt<=(le+ne+ie+oe)/2?(fe=Math.round(ne/2),_e=Math.round(ie/2),be=Math.round(oe/2),he=Math.round(le/2),Ae=0,Ee=0,we=0):(fe=Math.round(ne*Kt/(le+ne+ie+oe)),_e=Math.round(ie*Kt/(le+ne+ie+oe)),be=Math.round(oe*Kt/(le+ne+ie+oe)),he=Math.round(le*Kt/(le+ne+ie+oe)),Ae=0,Ee=0,we=0):Kt<=(le+ne+ie+oe+4*pe+5*ge+6*me)/2?(fe=Math.round(ne/2),_e=Math.round(ie/2),be=Math.round(oe/2),he=Math.round(le/2),Ae=Math.round(pe/2),Ee=Math.round(ge/2),we=Math.round(me/2)):(fe=Math.round(ne*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),_e=Math.round(ie*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),be=Math.round(oe*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),
he=Math.round(le*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),Ae=Math.round(pe*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),Ee=Math.round(ge*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),we=Math.round(me*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me))),console.log(fe,_e,be,he,Ae,Ee,we),aa=Xt+$t,Ht=Vt+Ft},qa.calculateT=function(){const e=v[t.TROOPS_SPEAR],a=v[t.TROOPS_SWORD],n=v[t.TROOPS_AXE],i=v[t.TROOPS_ARCHER],o=v[t.TROOPS_LC],l=v[t.TROOPS_MA],s=v[t.TROOPS_HC],r=v[t.TROOPS_RAM],c=v[t.TROOPS_CATAPULT],d=v[t.TROOPS_DOPPELSOLDNER],u=v[t.TROOPS_TREBUCHET],p=v[t.TROOPS_SNOB],g=v[t.TROOPS_KNIGHT],m=v[t.TROOPS_BARRACKS],T=v[t.TROOPS_PRECEPTORY],f=v[t.TROOPS_ORDER],_=v[t.TROOPS_TRAINING]
;var b=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],h=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],A=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],E=[1,1,1,1,4,5,6,5,8,1,100,10,6],w=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],S=[10,25,45,25,130,150,150,2,100,150,30,30,300],R=[25,55,10,10,30,40,200,20,100,250,100,200,100],y=[45,5,5,30,40,30,160,50,50,400,50,250,100],k=[10,30,10,60,30,50,180,20,100,150,100,200,50],M=[8,9,14,18,24,35,50,0],F=[25,15,10,10,80,50,50,0,0,100,0,0,10],Y=[0,33,66,99];let j=0,H=1,K=1,Q=1,X=1,Z=1,J=1,$=1,ee=1,te=0;var ae,ne,ie,oe;K=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,te='level_1'==_?1.04:'level_2'==_?1.08:'level_3'==_?1.12:'level_4'==_?1.16:'level_5'==_?1.2:1,X=1==T?1.01:2==T?1.02:3==T?1.03:4==T?1.04:5==T?1.05:6==T?1.06:7==T?1.07:8==T?1.08:9==T?1.09:10==T?1.1:1,Q=v[t.TROOPS_DOMINATION]?1.1:1,
W=u>0?M[6]+' minut':p>0?M[5]+' minut':r>0||c>0?M[4]+' minuty':a>0?M[3]+' minut':e>0||n>0||i>0||d>0?M[2]+' minut':s>0?M[1]+' minut':o>0||l>0||g>0?M[0]+' minut':M[7]+' minut',V=m>=7&&m<14?Y[1]:m>=14&&m<23?Y[2]:m>=23?Y[3]:Y[0],J=H/(Q*te),Z=J/K,$=Z/X,ee=H/X,j='troops.teutonic'==f?$*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+ee*(u*w[11])+Z*(n*w[2]+o*w[4]+l*w[5]+r*w[7]+c*w[8])+d*w[12]+g*w[9]+p*w[10]:'troops.templars'==f?Z*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+u*w[11]+$*(n*w[2]+o*w[4]+l*w[5]+r*w[7]+c*w[8])+ee*(d*w[12])+g*w[9]+p*w[10]:Z*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+u*w[11]+Z*(n*w[2]+o*w[4]+l*w[5]+r*w[7]+c*w[8])+d*w[12]+g*w[9]+p*w[10],I=e*b[0]+a*b[1]+n*b[2]+i*b[3]+o*b[4]+l*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+p*b[10]+u*b[11]+d*b[12],N=e*h[0]+a*h[1]+n*h[2]+i*h[3]+o*h[4]+l*h[5]+s*h[6]+r*h[7]+c*h[8]+g*h[9]+p*h[10]+u*h[11]+d*h[12],x=e*A[0]+a*A[1]+n*A[2]+i*A[3]+o*A[4]+l*A[5]+s*A[6]+r*A[7]+c*A[8]+g*A[9]+p*A[10]+u*A[11]+d*A[12],O=e*E[0]+a*E[1]+n*E[2]+i*E[3]+o*E[4]+l*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+p*E[10]+u*E[11]+d*E[12],
B=e*S[0]+a*S[1]+n*S[2]+i*S[3]+o*S[4]+l*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+p*S[10]+u*S[11]+d*S[12],z=e*R[0]+a*R[1]+n*R[2]+i*R[3]+o*R[4]+l*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+p*R[10]+u*R[11]+d*R[12],D=e*y[0]+a*y[1]+n*y[2]+i*y[3]+o*y[4]+l*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+p*y[10]+u*y[11]+d*y[12],G=e*k[0]+a*k[1]+n*k[2]+i*k[3]+o*k[4]+l*k[5]+s*k[6]+r*k[7]+c*k[8]+g*k[9]+p*k[10]+u*k[11]+d*k[12],L=e*F[0]+a*F[1]+n*F[2]+i*F[3]+o*F[4]+l*F[5]+s*F[6]+r*F[7]+c*F[8]+g*F[9]+p*F[10]+u*F[11]+d*F[12],ae=j,ne='',ie=new Date(1e3*ae).toISOString().substr(11,8),(oe=Math.floor(ae/86400))>1?ne=oe+' dni i ':oe>0&&(ne='1 dzień i '),q=ne+=ie,P=e*S[0]+a*S[1]+n*S[2]+r*S[7]+c*S[8]+u*S[11]+d*S[12],U=o*S[4]+s*S[6]+g*S[9],C=i*S[3]+l*S[5]},qa.start=function(){R=!0,E.trigger(s.BATTLE_CALCULATOR_START)},qa.stop=function(){R=!1,E.trigger(s.BATTLE_CALCULATOR_STOP)},qa.getSettings=function(){return w},qa.isInitialized=function(){return S},qa.isRunning=function(){return R},qa.getBashpointsAtt=function(){return M},
qa.getBashpointsDef=function(){return k},qa.getWoodAmount=function(){return I},qa.getClayAmount=function(){return N},qa.getIronAmount=function(){return x},qa.getLoadAmount=function(){return L},qa.getFoodAmount=function(){return O},qa.getDefInf=function(){return z},qa.getDefCav=function(){return D},qa.getDefArc=function(){return G},qa.getAttInf=function(){return P},qa.getAttCav=function(){return U},qa.getAttArc=function(){return C},qa.getSpeed=function(){return W},qa.getBuildTime=function(){return q},qa.getDiscipline=function(){return V},qa.getPower=function(){return B},qa.getTarget=function(){return Pt},qa.getBuildingfrom=function(){return Ut},qa.getBuildingto=function(){return Ct},qa.getWallfrom=function(){return zt},qa.getWallto=function(){return Dt},qa.getWallfrompre=function(){return Gt},qa.getWalltopre=function(){return zt},qa.getDefencemodifier=function(){return Bt},qa.getDefenceprovisions=function(){return Vt},qa.getStrentghdefend=function(){return Wt},
qa.getDefencebashpoint=function(){return qt},qa.getDefencekilledprovisions=function(){return Ft},qa.getStrongesttypedef=function(){return Yt},qa.getKillrated=function(){return jt},qa.getDefencesurvivedprovisions=function(){return Ht},qa.getAvailablebeds=function(){return Kt},qa.getAttackmodifier=function(){return Qt},qa.getAttackprovisions=function(){return Xt},qa.getStrentghattack=function(){return Zt},qa.getAttackbashpoint=function(){return Jt},qa.getAttackkilledprovisions=function(){return $t},qa.getStrongesttypeoff=function(){return ea},qa.getKillratea=function(){return ta},qa.getAttacksurvivedprovisions=function(){return aa},qa.getDoublestrength=function(){return na},qa.getSpeardAmount=function(){return F},qa.getSpeardLosses=function(){return ne},qa.getSpeardRevived=function(){return fe},qa.getSpeardSurvived=function(){return ve},qa.getSworddAmount=function(){return Y},qa.getSworddLosses=function(){return ie},qa.getSworddRevived=function(){return _e},
qa.getSworddSurvived=function(){return Se},qa.getAxedAmount=function(){return j},qa.getAxedLosses=function(){return oe},qa.getAxedRevived=function(){return be},qa.getAxedSurvived=function(){return Re},qa.getArcherdAmount=function(){return H},qa.getArcherdLosses=function(){return le},qa.getArcherdRevived=function(){return he},qa.getArcherdSurvived=function(){return ye},qa.getSnobdAmount=function(){return K},qa.getSnobdLosses=function(){return se},qa.getSnobdSurvived=function(){return ke},qa.getKnightdAmount=function(){return Q},qa.getKnightdLosses=function(){return re},qa.getKnightdSurvived=function(){return Me},qa.getRamdAmount=function(){return X},qa.getRamdLosses=function(){return ce},qa.getRamdSurvived=function(){return Ie},qa.getCatapultdAmount=function(){return Z},qa.getCatapultdLosses=function(){return de},qa.getCatapultdSurvived=function(){return Ne},qa.getTrebuchetdAmount=function(){return J},qa.getTrebuchetdLosses=function(){return ue},qa.getTrebuchetdSurvived=function(){
return xe},qa.getLcdAmount=function(){return $},qa.getLcdLosses=function(){return pe},qa.getLcdRevived=function(){return Ae},qa.getLcdSurvived=function(){return Oe},qa.getMadAmount=function(){return ee},qa.getMadLosses=function(){return ge},qa.getMadRevived=function(){return Ee},qa.getMadSurvived=function(){return Le},qa.getHcdAmount=function(){return te},qa.getHcdLosses=function(){return me},qa.getHcdRevived=function(){return we},qa.getHcdSurvived=function(){return Pe},qa.getBerserkerdAmount=function(){return ae},qa.getBerserkerdLosses=function(){return Te},qa.getBerserkerdSurvived=function(){return Ue},qa.getSpearaAmount=function(){return Ce},qa.getSpearaLosses=function(){return Qe},qa.getSpearaRevived=function(){return rt},qa.getSpearaSurvived=function(){return Et},qa.getSwordaAmount=function(){return ze},qa.getSwordaLosses=function(){return Xe},qa.getSwordaRevived=function(){return ct},qa.getSwordaSurvived=function(){return wt},qa.getAxeaAmount=function(){return De},
qa.getAxeaLosses=function(){return Ze},qa.getAxeaRevived=function(){return dt},qa.getAxeaSurvived=function(){return vt},qa.getArcheraAmount=function(){return Ge},qa.getArcheraLosses=function(){return Je},qa.getArcheraRevived=function(){return ut},qa.getArcheraSurvived=function(){return St},qa.getSnobaAmount=function(){return Be},qa.getSnobaLosses=function(){return $e},qa.getSnobaRevived=function(){return pt},qa.getSnobaSurvived=function(){return Rt},qa.getKnightaAmount=function(){return Ve},qa.getKnightaLosses=function(){return et},qa.getKnightaRevived=function(){return gt},qa.getKnightaSurvived=function(){return yt},qa.getRamaAmount=function(){return We},qa.getRamaLosses=function(){return tt},qa.getRamaRevived=function(){return mt},qa.getRamaSurvived=function(){return kt},qa.getCatapultaAmount=function(){return qe},qa.getCatapultaLosses=function(){return at},qa.getCatapultaRevived=function(){return Tt},qa.getCatapultaSurvived=function(){return Mt},qa.getTrebuchetaAmount=function(){
return Fe},qa.getTrebuchetaLosses=function(){return nt},qa.getTrebuchetaRevived=function(){return ft},qa.getTrebuchetaSurvived=function(){return It},qa.getLcaAmount=function(){return Ye},qa.getLcaLosses=function(){return it},qa.getLcaRevived=function(){return _t},qa.getLcaSurvived=function(){return Nt},qa.getMaaAmount=function(){return je},qa.getMaaLosses=function(){return ot},qa.getMaaRevived=function(){return bt},qa.getMaaSurvived=function(){return xt},qa.getHcaAmount=function(){return He},qa.getHcaLosses=function(){return lt},qa.getHcaRevived=function(){return ht},qa.getHcaSurvived=function(){return Ot},qa.getBerserkeraAmount=function(){return Ke},qa.getBerserkeraLosses=function(){return st},qa.getBerserkeraRevived=function(){return At},qa.getBerserkeraSurvived=function(){return Lt},qa.getPresetBerserker=function(){return fa},qa.getPresetAxe=function(){return la},qa.getPresetArcher=function(){return sa},qa.getPresetSnob=function(){return ga},qa.getPresetKnight=function(){return ma},
qa.getPresetHc=function(){return da},qa.getPresetLc=function(){return ra},qa.getPresetMa=function(){return ca},qa.getPresetRam=function(){return ua},qa.getPresetCatapult=function(){return pa},qa.getPresetSpear=function(){return ia},qa.getPresetSword=function(){return oa},qa.getPresetTrebuchet=function(){return Ta},qa.getVillageBerserker=function(){return Aa},qa.getVillageAxe=function(){return ba},qa.getVillageArcher=function(){return _a},qa.getVillageSnob=function(){return ya},qa.getVillageKnight=function(){return wa},qa.getVillageHc=function(){return Ea},qa.getVillageLc=function(){return va},qa.getVillageMa=function(){return Sa},qa.getVillageRam=function(){return Ra},qa.getVillageCatapult=function(){return ha},qa.getVillageSpear=function(){return ka},qa.getVillageSword=function(){return Ma},qa.getVillageTrebuchet=function(){return Ia},qa})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',
BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','struct/MapData','two/utils'],(function(e,t,n,o,l,r,d,u,p,m,T,f,_,b,h,A,E,w,v){let S,R,y,k,M=i.getPresetList(),I=!1;const N={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},x=function(e,t){I=t.data},O=function(){I=!1},L=function(e){S.selectedTab=e},P=function(){t.isRunning()?t.stop():t.start()},U=function(){
...
S.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},D=function(){const e=O[r.GROUP_VILLAGES];let a=[];return e?(a=M.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},G=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(k);const i=O[r.BUILDING_SEQUENCES][O[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),q(t))return!1;i.some((function(a){if(++n[a]>t[a])return w.compute(e),B(e,a,(function(t,a){t&&a.job&&(f.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),F(e.getId(),a.job))})),!0}))},B=function(e,t,a){const n=W(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&O[r.PRIORIZE_FARM]){const t=E[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-O[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-O[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-O[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},q=function(e){for(let t in e)if(e[t]<E[t])return!1;return!0},F=function(e,t){let a={time:b.gameTime(),villageId:e,building:t.building,level:t.level};return N.unshift(a),N.length>500&&N.splice(N.length-500,N.length),_.set(P,N),!0};let Y={};return Y.start=function(){if(!L)return f.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,h=setInterval(C,6e4),A=setInterval(z,6e3),e((function(){D().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),C(),z()}),['all_villages_ready']),f.trigger(s.BUILDER_QUEUE_START)},Y.stop=function(){y=!1,clearInterval(h),
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,l,d,u,p,m,T,f,_,b,h,A){let E,w,v,S,R,y=i.getGameData(),k=y.getOrderedUnitNames(),M=y.getOrderedOfficerNames(),I=i.getPresetList(),N=!1;const x={ADD:'add',WAITING:'waiting',LOGS:'logs'},O=x.ADD;let L,P,U,C=[],z={},D={};const G={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){N=t.data},W=function(){N=!1},q=function(e){
const t=new Date(e||b.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),n=b.zerofill(a-a%100,3),i=b.zerofill(t.getSeconds(),2),l=b.zerofill(t.getMinutes(),2);return b.zerofill(t.getHours(),2)+':'+l+':'+i+':'+n+' '+b.zerofill(t.getDate(),2)+'/'+b.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},F=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),q(e+=t)):''},Y=function(){if(E.isValidDate=o.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!E.isValidDate&&o.getTimeFromString(R.date),t=E.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(G,(function(n,i){const l=o.getTravelTime(R.origin,R.target,n,a,R.officers,!0);E.travelTimes[a][i].travelTime=g('readableMillisecondsFilter')(l),E.travelTimes[a][i].status=e?j(t?e-l:e):'neutral'}))}))},j=function(e){return e&&E.isValidDate?b.gameTime()+L<e?'valid':'invalid':'neutral'},H=function(){R.dateType=E.selectedDateType.value,A.set(m.LAST_DATE_TYPE,E.selectedDateType.value),Y()},K=function(){
...
[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},v={[r.ATTACK]:'attack',[r.SUPPORT]:'support',[r.QUATTRO]:'four',[r.FULL]:'full'},S={[l.ARRIVE]:'date_type_arrive',[l.OUT]:'date_type_out'};console.log(w,v,S);const R=function(){f=[],_=[],b=[],h=[],A=[];const e=i.getGroupList().getGroups(),a=g[t.GROUP],n=g[t.GROUPP],o=g[t.GROUPT],l=g[t.GROUPG],s=g[t.GROUP_TARGET];a.forEach((function(t){f.push(e[t])})),n.forEach((function(t){_.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){h.push(e[t])})),s.forEach((function(t){A.push(e[t])}))},y={init:function(){m=!0,p=new e({settingsMap:n,storageKey:E}),p.onChange((function(e,t){g=p.getAll(),t[o.GROUPS]&&R()})),g=p.getAll(),console.log('fakeSender settings',g),a.$on(s.GROUPS_CREATED,R),a.$on(s.GROUPS_DESTROYED,R),
a.$on(s.GROUPS_UPDATED,R)},start:function(){T=!0,u.trigger(s.FAKE_SENDER_START)},stop:function(){T=!1,u.trigger(s.FAKE_SENDER_STOP)},getSettings:function(){return p},isInitialized:function(){return m},isRunning:function(){return T}};return y})),define('two/fakeSender/events',[],(function(){angular.extend(s,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u,p,m){let T,f,_,b=i.getGroupList();const h={FAKE:'fake',LOGS:'logs'},A=function(e){T.selectedTab=e},E=function(){f.setAll(f.decode(T.settings)),m.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},w=function(){t.isRunning()?t.stop():t.start()},v=function(){T.groups=u.encodeList(b.getGroups(),{disabled:!1,type:'groups'})
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,p,g,m,T,b,h,A,E,w,v,S,R,y){let k,M,I,N,x,O=!1,L=!1,P=[],U=[],C=[],z=[],D=[],G=[],B=!1,V=!1,W=!1,q=0,F=null,Y=null,j=null,H={},K=A.gameTime(),Q=null,X=null;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(M[r.MIN_DISTANCE],M[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===N.getId()},included:function(e){return e.character_id&&!C.includes(e.id)},ignored:function(e){return z.includes(e.id)},points:function(e){
...
const a=M[r.GROUP_INCLUDE],n=M[r.GROUP_IGNORE],i=M[r.GROUP_ONLY],o=N.getVillage(t.village_id);let l=!1;if(ie(),n===t.group_id&&(o?(ke(t.village_id),l=!0):(Ne(t.village_id),fe(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(xe(),fe(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),i.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){L&&e.start()})),l=!0}l&&E.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=M[r.GROUP_INCLUDE],n=M[r.GROUP_IGNORE],i=M[r.GROUP_ONLY],o=N.getVillage(t.village_id);let l=!1;if(ie(),n===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){L&&e.start()})),l=!0}else xe(),fe(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(xe(),fe(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),i.includes(t.group_id)&&o&&(ke(t.village_id),l=!0),l&&E.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=i.getGroupList().getGroups(),a=M[r.GROUP_IGNORE],n=M[r.GROUP_ONLY],o=M[r.GROUP_INCLUDE],l=_.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=n.filter(e=>_.call(t,e)),c=o.filter(e=>_.call(t,e));k.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ie(),ye(),xe(),Re()},ce=function(){G=[];const e=i.getPresetList().getPresets();M[r.PRESETS].forEach((function(t){if(!_.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),G.push(a)})),G=G.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),G.length||(E.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),L&&Oe.stop())},ue=function(e,t){M[r.IGNORE_ON_LOSS]&&M[r.GROUP_IGNORE]&&L&&t.type===w.TYPES.ATTACK&&1!==t.result&&Ie(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=M[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===l.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=x[a].load*e)})),t},Te=function(e){I[e]={time:A.gameTime(),report:H[e]||!1},delete H[e],y.set($,I),E.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},fe=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=A.gameTime(),t.type=e,U.unshift(t),_e(),!0)},_e=function(){const e=M[r.LOGS_LIMIT];U.length>e&&U.splice(U.length-e,U.length),y.set(Z,U),E.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},be=function(e,t,a){const n=M[r.TARGET_MULTIPLE_FARMERS],i=M[r.TARGET_SINGLE_ATTACK];if(n&&a){if(i&&e)return!0}else if(i){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=A.gameTime()},Ae=function(){clearTimeout(F),clearTimeout(Y),clearTimeout(j),F=null,Y=null,j=null
...
barbarian:!a.character_id,officers:!0,effects:!0}),f=d.getTravelTimeForDistance(g,T,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+f-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const i=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=i.some(e=>e.start_village_id!==this.villageId),l=i.some(e=>e.start_village_id===this.villageId);if(be(l,o,!0))return t(n.BUSY_TARGET);e()})});let U=new Promise((e,t)=>{f().then(b).then(S).then(y).then(k).then(I).then(x).then(O).then(L).then(P).then(e).catch(t)}),z=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([U,z]).then(()=>{if(!this.running)return!1
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,u,f,_,b,h,A,E){let w,v,S,R=i.getPresetList(),y=i.getGroupList(),k={},M={},I=null;const N={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},x=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&O(e.villageId),e.targetId&&O(e.targetId)}))},O=function(e){if(k[e])return k[e];k[e]=!0,M[e]='ładowanie...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},M[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},L=function(){
w.exceptionVillages.included.forEach((function(e){O(e)})),w.exceptionVillages.ignored.forEach((function(e){O(e)}))},P=function(){t.isRunning()?t.stop():t.start()},U=function(e){w.selectedTab=e},C=function(){v.setAll(v.decode(w.settings)),w.saveButtonColor='orange',h.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},z=function(e){const t=v.get(f.GROUP_IGNORE);if(!i.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},D=function(e){v.get(f.GROUP_INCLUDE).forEach((function(t){i.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},G=function(){w.presets=_.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},B=function(){w.groups=_.encodeList(y.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=_.encodeList(y.getGroups(),{disabled:!0,type:'groups'})},V=function(){w.running=!0,
h.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},W=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(I),t.reason){case d.NO_PRESETS:h.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},q=function(){w.logs=angular.copy(t.getLogs()),x(),w.logs.length||h.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){w.farmers=t.getFarmers()},Y=function(){w.exceptionVillages=t.getExceptionVillages(),L()},j=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(I)},K=function(e,a){a!==n.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),I=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=f,w.TAB_TYPES=N,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=N.SETTINGS,w.farmers=t.getFarmers(),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,r,c,d,u,g,m,T,f,b,h,A,E,w,v){let S,R,y,k,M,I,N,x,O,L,P,U,C,z,D,G,B,V,W,q,F,Y,j,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/R)%2&&(t+=k),t-=t%R,a-=a%R,{x:Math.ceil((t-O.width/2)/R),y:Math.ceil((a-O.height/2)/R)}},fe=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},_e=function(){ve(M)},be=function(){if(H){const e={x:ee.x-O.width/2,y:ee.y-O.height/2};L.clearRect(0,0,O.width,O.height),z.clearRect(0,0,C.width,C.height),function(e){L.drawImage(P,-e.x,-e.y)}(e),j[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*R-e.x,n=(t.y-2)*R-e.y;z.fillStyle=j[o.COLOR_VIEW_REFERENCE],z.fillRect(a,0,1,y),z.fillRect(0,n,y,1);const i=G.getBoundingClientRect(),l=i.width/w.TILESIZE.x/v.view.z*R,s=i.height/w.TILESIZE.y/v.view.z*R,r=a-l/2,c=n-s/2;z.clearRect(r,c,l,s),z.beginPath(),z.lineWidth=1,z.strokeStyle=j[o.COLOR_VIEW_REFERENCE],z.rect(r,c,l,s),z.stroke()}(e)}e.requestAnimationFrame(be)},he=function(){if(!ne)return!1;const e=Q.village[N][x];Ee(e?Q.character[e]:[[N,x]]),ne=!1,
m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:N,y:x})},Ae=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t,j[o.COLOR_QUICK_HIGHLIGHT])},Ee=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t)},we=function(e){if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!j[o.SHOW_BARBARIANS]&&q.barbarian;if(e.character_id===V){if(e.id===I.getId()&&j[o.HIGHLIGHT_SELECTED])return q.selected;if(e.character_id in K.character)return K.character[e.character_id];if(j[o.HIGHLIGHT_OWN])return q.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&j[o.HIGHLIGHT_DIPLOMACY])return q.tribe;if(F&&j[o.HIGHLIGHT_DIPLOMACY]){if(F.isAlly(e.tribe_id))return q.ally;if(F.isEnemy(e.tribe_id))return q.enemy
;if(F.isNAP(e.tribe_id))return q.friendly}}return q.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||we(n);if(!i)continue;const o=n.x*R+(n.y%2?k:0),l=n.y*R;U.fillStyle=i,U.fillRect(o,l,S,S)}},Se=function(){S=oe[j[o.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,P.width=1e3*R,P.height=1e3*R,U.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;O.width=686,O.height=e,C.width=686,C.height=e,L.imageSmoothingEnabled=!1,z.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[N,x,e]),3===e.which&&(a=N,n=x,f.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(j[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id},A.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({
type:'tribe',id:e.tribe_id},A.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Me=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!j[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(N===e.x&&x===e.y)return!1;he()}ne=!0,N=e.x,x=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:N,y:x,event:t});const a=Q.village[N][x];Ae(a?Q.character[a]:[[N,x]])}(pe,e)}he()},Ie=function(){ne&&he(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},Ne=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
...
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),_e(),!0},getHighlight:function(e,t){return!!_.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){O=e,O.style.background=j[o.COLOR_BACKGROUND],L=O.getContext('2d')},setViewportRef:function(e){C=e,z=C.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!D.width||!D.height)return!1;let e=f.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=fe(e[0]*t,e[1]*t),n=fe(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,D.width/2,D.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return Y},Pe.drawMinimap=function(){ge&&(ge=!1),O.style.background=j[o.COLOR_BACKGROUND],U.clearRect(0,0,P.width,P.height),d((function(){!function(){
const e=h.getPath(w.getMapPath()),t=j[o.SHOW_CONTINENT_DEMARCATIONS],a=j[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){U.fillStyle=j[o.COLOR_CONTINENT],U.fillRect(e*R+k-1,t*R+k-1,3,1),U.fillRect(e*R+k,t*R+k-2,1,3)},i=function(e,t){U.fillStyle=j[o.COLOR_PROVINCE],U.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=b.toTile(o,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&i(e,l))}const r=l.a*R,c=s.a*R,d=(l.b-l.a)*R,u=(s.b-s.a)*R;U.beginPath(),U.lineWidth=2,U.strokeStyle="#2B4700",U.rect(r,c,d,u),U.stroke()}))}(),_e()}),'minimap_data')},Pe.enableRendering=function(){H=!0},Pe.disableRendering=function(){H=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),U=P.getContext('2d'),re=se.make('hover'),Y=new u({settingsMap:l,storageKey:ie}),Y.onChange((function(e,t){j=Y.getAll(),
Se(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),j=Y.getAll(),K.tribe=le.getCustomColorsByGroup(E.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(E.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){G=document.getElementById('map'),D=document.getElementById('main-canvas'),B=i.getSelectedCharacter(),F=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),q=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),Re(),I=B.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*R,ee.y=I.getY()*R,e.addEventListener('resize',Re,!1),C.addEventListener('mousedown',ye),C.addEventListener('mouseup',ke),C.addEventListener('mousemove',Me),C.addEventListener('mouseleave',Ie),C.addEventListener('click',Ne),C.addEventListener('contextmenu',xe),g.load((function(){M=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,T,f,_,b,h,A,E){let w,v,S,R,y,k,M,I,N,x,O,L={},P=!1,U={character:{},tribe:{}};const C={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=C.MINIMAP,D=function(e){w.selectedTab=e,e===C.MINIMAP?i.enableRendering():i.disableRendering()},G=function(){Object.keys(w.highlights.character).forEach((function(e){e in U.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
;const a=N.getBoundingClientRect(),n=M.getBoundingClientRect(),i=a.width+50,o=a.height+50,l=k.tt.position.y+o>n.top+n.height,s=k.tt.position.x+i>n.width;l&&(k.tt.position.y-=50),N.classList.toggle('left',s),N.classList.toggle('top',l)}))},W=function(e,t){if(!N)return;let a=t?B(t):x;L[a]=!1,P=!1,k.tt.visible=!1,N.classList.add('ng-hide'),I.appendChild(N)},q=function(e,t,n){let o,l,s=a.$new(),r=!0;s.colorPalettes=E.palette,'setting'===e?(l=t,o=O.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=O.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][n],s.submit=function(){i.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},F=function(){i.addHighlight(w.selectedHighlight,w.addHighlightColor)},Y=function(){O.setAll(O.decode(w.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},j=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){O.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){G()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+A.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=C,w.selectedTab=z,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=i.getHighlights(),w.highlightNames=U,w.mapSizes=_.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=_.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=D,w.openColorPalette=q,w.addCustomHighlight=F,w.removeHighlight=i.removeHighlight,w.saveSettings=Y,w.resetSettings=j,w.highlightsCount=H,w.openProfile=K,O.injectScope(w,{textObject:'minimap'});let e=new f('twoverflow_minimap_window',(function(){i.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
...
[o.LEVEL_10]:50,[o.LEVEL_11]:55,[o.LEVEL_12]:60,[o.LEVEL_13]:65,[o.LEVEL_14]:70,[o.LEVEL_15]:75,[o.LEVEL_16]:80,[o.LEVEL_17]:85,[o.LEVEL_18]:90,[o.LEVEL_19]:95,[o.LEVEL_20]:100};console.log(m,T);const f={init:function(){u=!0,c=new e({settingsMap:a,storageKey:g}),c.onChange((function(){d=c.getAll()})),d=c.getAll(),console.log('powerHelper settings',d)},start:function(){p=!0,r.trigger(s.POWER_HELPER_START)},stop:function(){p=!1,console.log('powerHelper stop'),r.trigger(s.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/powerHelper/events',[],(function(){angular.extend(s,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r){let c,d,u=!1,p=!1,g=[],m=[],T=[],f=[];const _='preset_asigner_settings',b=function(){g=[],m=[];const e=i.getPresetList().getPresets(),a=d[t.PRESETS1],n=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),n.forEach((function(t){m.push(e[t])}))},h=function(){T=[],f=[];const e=i.getGroupList().getGroups(),a=d[t.GROUP1],n=d[t.GROUP2];a.forEach((function(t){T.push(e[t])})),n.forEach((function(t){f.push(e[t])}))},A={init:function(){u=!0,c=new e({settingsMap:n,storageKey:_}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&h()})),d=c.getAll(),console.log('presetAsigner settings',d),l((function(){b()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,b),a.$on(s.ARMY_PRESET_DELETED,b),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){p=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return A})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d){let u,p,g,m=i.getPresetList(),T=i.getGroupList();const f={PRESETS:'presets',LOGS:'logs'},_=function(e){u.selectedTab=e},b=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()
},A=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},E=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=f,u.running=t.isRunning(),u.selectedTab=f.PRESETS,u.settingsMap=o,p.injectScope(u),A(),E(),u.selectTab=_,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,E,!0),e.register(s.GROUPS_DESTROYED,E,!0),e.register(s.GROUPS_UPDATED,E,!0),e.register(s.PRESET_ASIGNER_START,w),e.register(s.PRESET_ASIGNER_STOP,v),
...
define('two/recruitQueue',['two/Settings','two/recruitQueue/types/errors','two/recruitQueue/types/status','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/farmOverflow/types/logs','two/ready','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,u,p,g,m,T,f){let _,b,h,A=!1,E=!1,w=null,v=[];let S=null,R=Math.max(1,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3),y=[],k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],q=[],F=[],Y=[],j=[],H=[],K=[],Q=[];const X='recruit_queue_settings',Z='recruit_queue_log',J={[u.SPEAR]:'spear',[u.SWORD]:'sword',[u.AXE]:'axe',[u.ARCHER]:'archer',[u.LIGHT_CAVALRY]:'light_cavalry',[u.MOUNTED_ARCHER]:'mounted_archer',[u.HEAVT_CAVALRY]:'heavy_cavalry',[u.RAM]:'ram',[u.CATAPULT]:'catapult'};console.log(J);const $=function(){y=[],k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],q=[],F=[],Y=[],j=[],H=[],K=[],Q=[]
;const e=i.getGroupList().getGroups(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],o=b[r.GROUP4],l=b[r.GROUP5],s=b[r.GROUP6],c=b[r.GROUP7],d=b[r.GROUP8],u=b[r.GROUP9],p=b[r.GROUP10],g=b[r.GROUP11],m=b[r.GROUP12],T=b[r.GROUP13],f=b[r.GROUP14],_=b[r.GROUP15],h=b[r.GROUP16],A=b[r.GROUP17],E=b[r.GROUP18],w=b[r.GROUP19],v=b[r.GROUP20],S=b[r.GROUP21],R=b[r.GROUP22],X=b[r.GROUP23],Z=b[r.GROUP24];t.forEach((function(t){y.push(e[t])})),a.forEach((function(t){k.push(e[t])})),n.forEach((function(t){M.push(e[t])})),o.forEach((function(t){I.push(e[t])})),l.forEach((function(t){N.push(e[t])})),s.forEach((function(t){x.push(e[t])})),c.forEach((function(t){O.push(e[t])})),d.forEach((function(t){L.push(e[t])})),u.forEach((function(t){P.push(e[t])})),p.forEach((function(t){U.push(e[t])})),g.forEach((function(t){C.push(e[t])})),m.forEach((function(t){z.push(e[t])})),T.forEach((function(t){D.push(e[t])})),f.forEach((function(t){G.push(e[t])})),_.forEach((function(t){B.push(e[t])})),h.forEach((function(t){
V.push(e[t])})),A.forEach((function(t){W.push(e[t])})),E.forEach((function(t){q.push(e[t])})),w.forEach((function(t){F.push(e[t])})),v.forEach((function(t){Y.push(e[t])})),S.forEach((function(t){j.push(e[t])})),R.forEach((function(t){H.push(e[t])})),X.forEach((function(t){K.push(e[t])})),Z.forEach((function(t){Q.push(e[t])}))},ee=function(){return Math.max(1,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3)},te=function(e,t,a){let n={time:f.gameTime(),villageId:e,unit:t,amount:a};return h.unshift(n),h.length>500&&h.splice(h.length-500,h.length),T.set(Z,h),!0},ae={init:function(){A=!0,h=T.get(Z,[],!0),_=new e({settingsMap:c,storageKey:X}),_.onChange((function(e,t){b=_.getAll(),t[d.GROUPS]&&$()})),b=_.getAll(),console.log('recruitQueue settings',b),a.$on(s.GROUPS_CREATED,$),a.$on(s.GROUPS_DESTROYED,$),a.$on(s.GROUPS_UPDATED,$)},ownRecrutation:function(){}};return ae.presetRecrutation=function(){m.trigger(s.RECRUIT_QUEUE_CYCLE_BEGIN),w=f.gameTime()+ee()
...
;const T=b[r.MIN_PACK1],_=b[r.MIN_PACK2],h=b[r.MIN_PACK3],A=b[r.MIN_PACK4],E=b[r.START_AMOUNT4],S=b[r.START_AMOUNT3],R=b[r.START_AMOUNT9],y=b[r.START_AMOUNT7],k=b[r.START_AMOUNT5],M=b[r.START_AMOUNT6],I=b[r.START_AMOUNT8],N=b[r.START_AMOUNT1],x=b[r.START_AMOUNT2],O=b[r.START_AMOUNT14],L=b[r.START_AMOUNT13],P=b[r.START_AMOUNT19],U=b[r.START_AMOUNT17],C=b[r.START_AMOUNT15],z=b[r.START_AMOUNT16],D=b[r.START_AMOUNT18],G=b[r.START_AMOUNT11],B=b[r.START_AMOUNT12],V=b[r.START_AMOUNT24],W=b[r.START_AMOUNT23],q=b[r.START_AMOUNT29],F=b[r.START_AMOUNT27],Y=b[r.START_AMOUNT25],j=b[r.START_AMOUNT26],H=b[r.START_AMOUNT28],K=b[r.START_AMOUNT21],Q=b[r.START_AMOUNT22],X=b[r.START_AMOUNT34],Z=b[r.START_AMOUNT33],J=b[r.START_AMOUNT39],$=b[r.START_AMOUNT37],ae=b[r.START_AMOUNT35],ne=b[r.START_AMOUNT36],ie=b[r.START_AMOUNT38],oe=b[r.START_AMOUNT31],le=b[r.START_AMOUNT32],se=b[r.FINAL_AMOUNT4],re=b[r.FINAL_AMOUNT3],ce=b[r.FINAL_AMOUNT9],de=b[r.FINAL_AMOUNT7],ue=b[r.FINAL_AMOUNT5],pe=b[r.FINAL_AMOUNT6],ge=b[r.FINAL_AMOUNT8],me=b[r.FINAL_AMOUNT1],Te=b[r.FINAL_AMOUNT2],fe=b[r.FINAL_AMOUNT14],_e=b[r.FINAL_AMOUNT13],be=b[r.FINAL_AMOUNT19],he=b[r.FINAL_AMOUNT17],Ae=b[r.FINAL_AMOUNT15],Ee=b[r.FINAL_AMOUNT16],we=b[r.FINAL_AMOUNT18],ve=b[r.FINAL_AMOUNT11],Se=b[r.FINAL_AMOUNT12],Re=b[r.FINAL_AMOUNT24],ye=b[r.FINAL_AMOUNT23],ke=b[r.FINAL_AMOUNT29],Me=b[r.FINAL_AMOUNT27],Ie=b[r.FINAL_AMOUNT25],Ne=b[r.FINAL_AMOUNT26],xe=b[r.FINAL_AMOUNT28],Oe=b[r.FINAL_AMOUNT21],Le=b[r.FINAL_AMOUNT22],Pe=b[r.FINAL_AMOUNT34],Ue=b[r.FINAL_AMOUNT33],Ce=b[r.FINAL_AMOUNT39],ze=b[r.FINAL_AMOUNT37],De=b[r.FINAL_AMOUNT35],Ge=b[r.FINAL_AMOUNT36],Be=b[r.FINAL_AMOUNT38],Ve=b[r.FINAL_AMOUNT31],We=b[r.FINAL_AMOUNT32]
;var qe=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],Fe=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],Ye=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],je=[1,1,1,1,4,5,6,5,8,1,100,10,6],He=0,Ke=0,Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,ot=0,lt='',st=0,rt=0,ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,ft=0,_t=0,bt=0,ht=0,At=0,Et=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,Mt=0,It=0,Nt=0,xt=0,Ot=0,Lt=0,Pt=0,Ut=0,Ct=0,zt=0,Dt=0,Gt=0,Bt=0,Vt=0,Wt=0,qt=0,Ft=0,Yt=0,jt=0,Ht=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=[],ga=0,ma=0,Ta=0,fa=[],_a=0,ba=0,ha=0,Aa=[],Ea=0,wa=0,va=0,Sa=[],Ra=0,ya=0,ka=0,Ma=0,Ia=0,Na=0,xa=0,Oa=0,La=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,qa=0,Fa=0,Ya=0,ja=0,Ha=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0;function on(){ma=t>0?nt.length>=2?1:1==nt.length?.5:.25:0,function(){ga=pa.length>0?pa.reduce((function(e,t){return e+t})):0;!function(){
Ta=t>0?ga>=936e5?0:ga<936e5&&ga>=864e5?.1:ga<864e5&&ga>=72e6?.25:ga<72e6&&ga>=576e5?.4:ga<576e5&&ga>=432e5?.55:ga<432e5&&ga>=288e5?.7:ga<288e5&&ga>=144e5?.85:ga<144e5&&ga>=72e5?.925:ga<72e5&&ga>=36e5?.9625:1:0;e=me-He,a=Te-Ke,n=re-Qe,i=se-Xe,r=ue-Ze,c=pe-Je,d=ge-$e,u=ce-et,p=de-tt,g=Math.floor(N*Ta*ma),f=Math.floor(x*Ta*ma),_=Math.floor(S*Ta*ma),b=Math.floor(E*Ta*ma),h=Math.floor(k*Ta*ma),A=Math.floor(M*Ta*ma),w=Math.floor(I*Ta*ma),O=Math.floor(R*Ta*ma),L=Math.floor(y*Ta*ma),console.log(g,f,_,b,h,A,w,L,O),Ma=g*qe[0]+f*qe[1]+_*qe[2]+b*qe[3]+h*qe[4]+A*qe[5]+w*qe[7]+O*qe[8]+L*qe[6],Ia=g*Fe[0]+f*Fe[1]+_*Fe[2]+b*Fe[3]+h*Fe[4]+A*Fe[5]+w*Fe[7]+O*Fe[8]+L*Fe[6],xa=g*Ye[0]+f*Ye[1]+_*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+w*Ye[7]+O*Ye[8]+L*Ye[6],Na=g*je[0]+f*je[1]+_*je[2]+b*je[3]+h*je[4]+A*je[5]+w*je[7]+O*je[8]+L*je[6],console.log(Ma,Ia,xa,Na),e>0||p>0||u>0||a>0||n>0||i>0||r>0||c>0||d>0?(Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa<=Ua&&Na<=Oa?(na=g,sa=f,Tt=_,ut=b,qt=h,Ht=A,
Zt=w,ht=O,Ut=L):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa<=Ua&&Na<=Oa?(xt=La/Ma,na=Math.floor(xt*g)-1,sa=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,ut=Math.floor(xt*b)-1,qt=Math.floor(xt*h)-1,Ht=Math.floor(xt*A)-1,Zt=Math.floor(xt*w)-1,ht=Math.floor(xt*O)-1,Ut=Math.floor(xt*L)-1):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa<=Ua&&Na<=Oa?(xt=Pa/Ia,na=Math.floor(xt*g)-1,sa=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,ut=Math.floor(xt*b)-1,qt=Math.floor(xt*h)-1,Ht=Math.floor(xt*A)-1,Zt=Math.floor(xt*w)-1,ht=Math.floor(xt*O)-1,Ut=Math.floor(xt*L)-1):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa>=Ua&&Na<=Oa?(xt=Ua/xa,na=Math.floor(xt*g)-1,sa=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,ut=Math.floor(xt*b)-1,qt=Math.floor(xt*h)-1,Ht=Math.floor(xt*A)-1,Zt=Math.floor(xt*w)-1,ht=Math.floor(xt*O)-1,
Ut=Math.floor(xt*L)-1):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa<=Ua&&Na>=Oa?(xt=Oa/Na,na=Math.floor(xt*g)-1,sa=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,ut=Math.floor(xt*b)-1,qt=Math.floor(xt*h)-1,Ht=Math.floor(xt*A)-1,Zt=Math.floor(xt*w)-1,ht=Math.floor(xt*O)-1,Ut=Math.floor(xt*L)-1):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa<=Ua&&Na<=Oa?(vt=Pa/Ia)>(st=La/Ma)?(na=Math.floor(st*g)-1,sa=Math.floor(st*f)-1,Tt=Math.floor(st*_)-1,ut=Math.floor(st*b)-1,qt=Math.floor(st*h)-1,Ht=Math.floor(st*A)-1,Zt=Math.floor(st*w)-1,ht=Math.floor(st*O)-1,Ut=Math.floor(st*L)-1):(na=Math.floor(vt*g)-1,sa=Math.floor(vt*f)-1,Tt=Math.floor(vt*_)-1,ut=Math.floor(vt*b)-1,qt=Math.floor(vt*h)-1,Ht=Math.floor(vt*A)-1,Zt=Math.floor(vt*w)-1,ht=Math.floor(vt*O)-1,Ut=Math.floor(vt*L)-1):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa>=Ua&&Na<=Oa?(vt=Pa/Ia)>(Gt=Ua/xa)?(na=Math.floor(Gt*g)-1,sa=Math.floor(Gt*f)-1,
Tt=Math.floor(Gt*_)-1,ut=Math.floor(Gt*b)-1,qt=Math.floor(Gt*h)-1,Ht=Math.floor(Gt*A)-1,Zt=Math.floor(Gt*w)-1,ht=Math.floor(Gt*O)-1,Ut=Math.floor(Gt*L)-1):(na=Math.floor(vt*g)-1,sa=Math.floor(vt*f)-1,Tt=Math.floor(vt*_)-1,ut=Math.floor(vt*b)-1,qt=Math.floor(vt*h)-1,Ht=Math.floor(vt*A)-1,Zt=Math.floor(vt*w)-1,ht=Math.floor(vt*O)-1,Ut=Math.floor(vt*L)-1):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa<=Ua&&Na>=Oa?(vt=Pa/Ia)>(kt=Oa/Na)?(na=Math.floor(kt*g)-1,sa=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,ut=Math.floor(kt*b)-1,qt=Math.floor(kt*h)-1,Ht=Math.floor(kt*A)-1,Zt=Math.floor(kt*w)-1,ht=Math.floor(kt*O)-1,Ut=Math.floor(kt*L)-1):(na=Math.floor(vt*g)-1,sa=Math.floor(vt*f)-1,Tt=Math.floor(vt*_)-1,ut=Math.floor(vt*b)-1,qt=Math.floor(vt*h)-1,Ht=Math.floor(vt*A)-1,Zt=Math.floor(vt*w)-1,ht=Math.floor(vt*O)-1,Ut=Math.floor(vt*L)-1):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa>=Ua&&Na<=Oa?(Gt=Ua/xa)>(st=La/Ma)?(na=Math.floor(st*g)-1,
sa=Math.floor(st*f)-1,Tt=Math.floor(st*_)-1,ut=Math.floor(st*b)-1,qt=Math.floor(st*h)-1,Ht=Math.floor(st*A)-1,Zt=Math.floor(st*w)-1,ht=Math.floor(st*O)-1,Ut=Math.floor(st*L)-1):(na=Math.floor(Gt*g)-1,sa=Math.floor(Gt*f)-1,Tt=Math.floor(Gt*_)-1,ut=Math.floor(Gt*b)-1,qt=Math.floor(Gt*h)-1,Ht=Math.floor(Gt*A)-1,Zt=Math.floor(Gt*w)-1,ht=Math.floor(Gt*O)-1,Ut=Math.floor(Gt*L)-1):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa>=Ua&&Na>=Oa?(Gt=Ua/xa)>(kt=Oa/Na)?(na=Math.floor(kt*g)-1,sa=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,ut=Math.floor(kt*b)-1,qt=Math.floor(kt*h)-1,Ht=Math.floor(kt*A)-1,Zt=Math.floor(kt*w)-1,ht=Math.floor(kt*O)-1,Ut=Math.floor(kt*L)-1):(na=Math.floor(Gt*g)-1,sa=Math.floor(Gt*f)-1,Tt=Math.floor(Gt*_)-1,ut=Math.floor(Gt*b)-1,qt=Math.floor(Gt*h)-1,Ht=Math.floor(Gt*A)-1,Zt=Math.floor(Gt*w)-1,ht=Math.floor(Gt*O)-1,
Ut=Math.floor(Gt*L)-1):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa<=Ua&&Na>=Oa?(kt=Oa/Na)>(st=La/Ma)?(na=Math.floor(st*g)-1,sa=Math.floor(st*f)-1,Tt=Math.floor(st*_)-1,ut=Math.floor(st*b)-1,qt=Math.floor(st*h)-1,Ht=Math.floor(st*A)-1,Zt=Math.floor(st*w)-1,ht=Math.floor(st*O)-1,Ut=Math.floor(st*L)-1):(na=Math.floor(kt*g)-1,sa=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,ut=Math.floor(kt*b)-1,qt=Math.floor(kt*h)-1,Ht=Math.floor(kt*A)-1,Zt=Math.floor(kt*w)-1,ht=Math.floor(kt*O)-1,Ut=Math.floor(kt*L)-1):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa>=Ua&&Na<=Oa?(st=La/Ma,(vt=Pa/Ia)>(Gt=Ua/xa)&&st>Gt?(na=Math.floor(Gt*g)-1,sa=Math.floor(Gt*f)-1,Tt=Math.floor(Gt*_)-1,ut=Math.floor(Gt*b)-1,qt=Math.floor(Gt*h)-1,Ht=Math.floor(Gt*A)-1,Zt=Math.floor(Gt*w)-1,ht=Math.floor(Gt*O)-1,Ut=Math.floor(Gt*L)-1):Gt>vt&&st>vt?(na=Math.floor(vt*g)-1,sa=Math.floor(vt*f)-1,Tt=Math.floor(vt*_)-1,ut=Math.floor(vt*b)-1,qt=Math.floor(vt*h)-1,
Ht=Math.floor(vt*A)-1,Zt=Math.floor(vt*w)-1,ht=Math.floor(vt*O)-1,Ut=Math.floor(vt*L)-1):Gt>st&&vt>st?(na=Math.floor(st*g)-1,sa=Math.floor(st*f)-1,Tt=Math.floor(st*_)-1,ut=Math.floor(st*b)-1,qt=Math.floor(st*h)-1,Ht=Math.floor(st*A)-1,Zt=Math.floor(st*w)-1,ht=Math.floor(st*O)-1,Ut=Math.floor(st*L)-1):console.log('Nie znam przyczyny :P')):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa<=Ua&&Na>=Oa?(st=La/Ma,(vt=Pa/Ia)>(kt=Oa/Na)&&st>kt?(na=Math.floor(kt*g)-1,sa=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,ut=Math.floor(kt*b)-1,qt=Math.floor(kt*h)-1,Ht=Math.floor(kt*A)-1,Zt=Math.floor(kt*w)-1,ht=Math.floor(kt*O)-1,Ut=Math.floor(kt*L)-1):kt>vt&&st>vt?(na=Math.floor(vt*g)-1,sa=Math.floor(vt*f)-1,Tt=Math.floor(vt*_)-1,ut=Math.floor(vt*b)-1,qt=Math.floor(vt*h)-1,Ht=Math.floor(vt*A)-1,Zt=Math.floor(vt*w)-1,ht=Math.floor(vt*O)-1,Ut=Math.floor(vt*L)-1):kt>st&&vt>st?(na=Math.floor(st*g)-1,sa=Math.floor(st*f)-1,Tt=Math.floor(st*_)-1,ut=Math.floor(st*b)-1,
qt=Math.floor(st*h)-1,Ht=Math.floor(st*A)-1,Zt=Math.floor(st*w)-1,ht=Math.floor(st*O)-1,Ut=Math.floor(st*L)-1):console.log('Nie znam przyczyny :P')):Ma>=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia<=Pa&&xa>=Ua&&Na>=Oa?(st=La/Ma,(kt=Oa/Na)>(Gt=Ua/xa)&&st>Gt?(na=Math.floor(Gt*g)-1,sa=Math.floor(Gt*f)-1,Tt=Math.floor(Gt*_)-1,ut=Math.floor(Gt*b)-1,qt=Math.floor(Gt*h)-1,Ht=Math.floor(Gt*A)-1,Zt=Math.floor(Gt*w)-1,ht=Math.floor(Gt*O)-1,Ut=Math.floor(Gt*L)-1):Gt>kt&&st>kt?(na=Math.floor(kt*g)-1,sa=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,ut=Math.floor(kt*b)-1,qt=Math.floor(kt*h)-1,Ht=Math.floor(kt*A)-1,Zt=Math.floor(kt*w)-1,ht=Math.floor(kt*O)-1,Ut=Math.floor(kt*L)-1):Gt>st&&kt>st?(na=Math.floor(st*g)-1,sa=Math.floor(st*f)-1,Tt=Math.floor(st*_)-1,ut=Math.floor(st*b)-1,qt=Math.floor(st*h)-1,Ht=Math.floor(st*A)-1,Zt=Math.floor(st*w)-1,ht=Math.floor(st*O)-1,
Ut=Math.floor(st*L)-1):console.log('Nie znam przyczyny :P')):Ma<=La&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Ia>=Pa&&xa>=Ua&&Na>=Oa&&(kt=Oa/Na,(vt=Pa/Ia)>(Gt=Ua/xa)&&kt>Gt?(na=Math.floor(Gt*g)-1,sa=Math.floor(Gt*f)-1,Tt=Math.floor(Gt*_)-1,ut=Math.floor(Gt*b)-1,qt=Math.floor(Gt*h)-1,Ht=Math.floor(Gt*A)-1,Zt=Math.floor(Gt*w)-1,ht=Math.floor(Gt*O)-1,Ut=Math.floor(Gt*L)-1):Gt>vt&&kt>vt?(na=Math.floor(vt*g)-1,sa=Math.floor(vt*f)-1,Tt=Math.floor(vt*_)-1,ut=Math.floor(vt*b)-1,qt=Math.floor(vt*h)-1,Ht=Math.floor(vt*A)-1,Zt=Math.floor(vt*w)-1,ht=Math.floor(vt*O)-1,Ut=Math.floor(vt*L)-1):Gt>kt&&vt>kt?(na=Math.floor(kt*g)-1,sa=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,ut=Math.floor(kt*b)-1,qt=Math.floor(kt*h)-1,Ht=Math.floor(kt*A)-1,Zt=Math.floor(kt*w)-1,ht=Math.floor(kt*O)-1,Ut=Math.floor(kt*L)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){na>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:na}),v=[lt='spear',na],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,na)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){at>=3&&(sa>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:sa}),v=[lt='sword',sa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,sa)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){at>=5&&(Tt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:Tt}),v=[lt='axe',Tt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Tt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){at>=9&&(ut>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:ut}),v=[lt='archer',ut],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
te(Ca,lt,ut)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){at>=11&&(qt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:qt}),v=[lt='light_cavalry',qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,qt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){at>=13&&(Ht>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Ht}),v=[lt='mounted_archer',Ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Ht)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){at>=15&&(Zt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:Zt}),v=[lt='ram',Zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Zt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){at>=17&&(ht>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:ht}),v=[lt='catapult',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,ht)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){at>=21&&(Ut>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Ut}),v=[lt='heavy_cavalry',Ut],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Ut)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,i,r,c,d,u,p,g,f,_,b,h,A,w,O,L}()}()}function ln(){ba=a>0?Da.length>=2?1:1==Da.length?.5:.25:0,function(){_a=fa.length>0?fa.reduce((function(e,t){return e+t})):0;!function(){
ha=a>0?_a>=936e5?0:_a<936e5&&_a>=864e5?.1:_a<864e5&&_a>=72e6?.25:_a<72e6&&_a>=576e5?.4:_a<576e5&&_a>=432e5?.55:_a<432e5&&_a>=288e5?.7:_a<288e5&&_a>=144e5?.85:_a<144e5&&_a>=72e5?.925:_a<72e5&&_a>=36e5?.9625:1:0;e=ve-He,t=Se-Ke,n=_e-Qe,i=fe-Xe,r=Ae-Ze,c=Ee-Je,d=we-$e,u=be-et,p=he-tt,g=Math.floor(G*ha*ba),T=Math.floor(B*ha*ba),f=Math.floor(L*ha*ba),b=Math.floor(O*ha*ba),h=Math.floor(C*ha*ba),A=Math.floor(z*ha*ba),E=Math.floor(D*ha*ba),w=Math.floor(P*ha*ba),S=Math.floor(U*ha*ba),R=g*qe[0]+T*qe[1]+f*qe[2]+b*qe[3]+h*qe[4]+A*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Fe[0]+T*Fe[1]+f*Fe[2]+b*Fe[3]+h*Fe[4]+A*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],k=g*Ye[0]+T*Ye[1]+f*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*je[0]+T*je[1]+f*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||n>0||i>0||r>0||c>0||d>0?(R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k<=qa&&M<=Ba?(ia=g,ra=T,ft=f,pt=b,Ft=h,Kt=A,Jt=E,At=w,
Ct=S):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k<=qa&&M<=Ba?(Ot=Va/R,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k<=qa&&M<=Ba?(Ot=Wa/y,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k>=qa&&M<=Ba?(Ot=qa/k,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k<=qa&&M>=Ba?(Ot=Ba/M,ia=Math.floor(Ot*g)-1,
ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k<=qa&&M<=Ba?(St=Wa/y)>(rt=Va/R)?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):(ia=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k>=qa&&M<=Ba?(St=Wa/y)>(Bt=qa/k)?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,
Ct=Math.floor(Bt*S)-1):(ia=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k<=qa&&M>=Ba?(St=Wa/y)>(Mt=Ba/M)?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):(ia=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k>=qa&&M<=Ba?(Bt=qa/k)>(rt=Va/R)?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,
At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k>=qa&&M>=Ba?(Bt=qa/k)>(Mt=Ba/M)?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k<=qa&&M>=Ba?(Mt=Ba/M)>(rt=Va/R)?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,
Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k>=qa&&M<=Ba?(rt=Va/R,(St=Wa/y)>(Bt=qa/k)&&rt>Bt?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):Bt>St&&rt>St?(ia=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Bt>rt&&St>rt?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,
Ct=Math.floor(rt*S)-1):console.log('Nie znam przyczyny :P')):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k<=qa&&M>=Ba?(rt=Va/R,(St=Wa/y)>(Mt=Ba/M)&&rt>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):Mt>St&&rt>St?(ia=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Mt>rt&&St>rt?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):console.log('Nie znam przyczyny :P')):R>=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Wa&&k>=qa&&M>=Ba?(rt=Va/R,(Mt=Ba/M)>(Bt=qa/k)&&rt>Bt?(ia=Math.floor(Bt*g)-1,
ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):Bt>Mt&&rt>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):Bt>rt&&Mt>rt?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):console.log('Nie znam przyczyny :P')):R<=Va&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Wa&&k>=qa&&M>=Ba&&(Mt=Ba/M,(St=Wa/y)>(Bt=qa/k)&&Mt>Bt?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):Bt>St&&Mt>St?(ia=Math.floor(St*g)-1,
ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Bt>Mt&&St>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ia>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:ia}),v=[lt='spear',ia],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,ia)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){za>=3&&(ra>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:ra}),v=[lt='sword',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,ra)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){za>=5&&(ft>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:ft}),v=[lt='axe',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,ft)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){za>=9&&(pt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:pt}),v=[lt='archer',pt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,pt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){za>=11&&(Ft>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:Ft}),v=[lt='light_cavalry',Ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Ft)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){za>=13&&(Kt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Kt}),
v=[lt='mounted_archer',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Kt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){za>=15&&(Jt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:Jt}),v=[lt='ram',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Jt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){za>=17&&(At>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:At}),v=[lt='catapult',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,At)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){za>=21&&(Ct>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Ct}),v=[lt='heavy_cavalry',Ct],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
te(Ca,lt,Ct)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,n,i,r,c,d,u,p,g,T,f,b,h,A,E,w,S,R,y,k,M}()}()}function sn(){wa=n>0?Ya.length>=2?1:1==Ya.length?.5:.25:0,function(){Ea=Aa.length>0?Aa.reduce((function(e,t){return e+t})):0;!function(){va=n>0?Ea>=936e5?0:Ea<936e5&&Ea>=864e5?.1:Ea<864e5&&Ea>=72e6?.25:Ea<72e6&&Ea>=576e5?.4:Ea<576e5&&Ea>=432e5?.55:Ea<432e5&&Ea>=288e5?.7:Ea<288e5&&Ea>=144e5?.85:Ea<144e5&&Ea>=72e5?.925:Ea<72e5&&Ea>=36e5?.9625:1:0;e=Oe-He,t=Le-Ke,a=ye-Qe,i=Re-Xe,r=Ie-Ze,c=Ne-Je,d=xe-$e,u=ke-et,p=Me-tt,g=Math.floor(K*va*wa),T=Math.floor(Q*va*wa),f=Math.floor(W*va*wa),_=Math.floor(V*va*wa),b=Math.floor(Y*va*wa),A=Math.floor(j*va*wa),E=Math.floor(H*va*wa),w=Math.floor(q*va*wa),S=Math.floor(F*va*wa),R=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+A*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+A*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],
k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||a>0||i>0||r>0||c>0||d>0?(R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k<=Xa&&M<=Ha?(oa=g,ca=T,_t=f,gt=_,Yt=b,Qt=A,$t=E,Et=w,zt=S):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k<=Xa&&M<=Ha?(Lt=Ka/R,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k<=Xa&&M<=Ha?(Lt=Qa/y,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,
zt=Math.floor(Lt*S)-1):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k>=Xa&&M<=Ha?(Lt=Xa/k,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k<=Xa&&M>=Ha?(Lt=Ha/M,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k<=Xa&&M<=Ha?(Rt=Qa/y)>(ct=Ka/R)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,
Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k>=Xa&&M<=Ha?(Rt=Qa/y)>(Vt=Xa/k)?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k<=Xa&&M>=Ha?(Rt=Qa/y)>(It=Ha/M)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,
gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k>=Xa&&M<=Ha?(Vt=Xa/k)>(ct=Ka/R)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k>=Xa&&M>=Ha?(Vt=Xa/k)>(It=Ha/M)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,
_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k<=Xa&&M>=Ha?(It=Ha/M)>(ct=Ka/R)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k>=Xa&&M<=Ha?(ct=Ka/R,(Rt=Qa/y)>(Vt=Xa/k)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,
zt=Math.floor(Vt*S)-1):Vt>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k<=Xa&&M>=Ha?(ct=Ka/R,(Rt=Qa/y)>(It=Ha/M)&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):It>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,
zt=Math.floor(Rt*S)-1):It>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Qa&&k>=Xa&&M>=Ha?(ct=Ka/R,(It=Ha/M)>(Vt=Xa/k)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>It&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):Vt>ct&&It>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,
zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R<=Ka&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Qa&&k>=Xa&&M>=Ha&&(It=Ha/M,(Rt=Qa/y)>(Vt=Xa/k)&&It>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>Rt&&It>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>It&&Rt>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){oa>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:oa}),v=[lt='spear',oa],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Fa>=3&&(ca>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:ca}),v=[lt='sword',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,ca)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Fa>=5&&(_t>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:_t}),v=[lt='axe',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,_t)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Fa>=9&&(gt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:gt}),v=[lt='archer',gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
te(Ca,lt,gt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Fa>=11&&(Yt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:Yt}),v=[lt='light_cavalry',Yt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Yt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Fa>=13&&(Qt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Qt}),v=[lt='mounted_archer',Qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Qt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Fa>=15&&($t>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:$t}),v=[lt='ram',$t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,$t)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){Fa>=17&&(Et>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:Et}),v=[lt='catapult',Et],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Et)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Fa>=21&&(zt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:zt}),v=[lt='heavy_cavalry',zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,zt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,a,i,r,c,d,u,p,g,T,f,_,b,A,E,w,S,R,y,k,M}()}()}function rn(){ya=c>0?Ja.length>=2?1:1==Ja.length?.5:.25:0,function(){Ra=Sa.length>0?Sa.reduce((function(e,t){return e+t})):0;!function(){
ka=c>0?Ra>=936e5?0:Ra<936e5&&Ra>=864e5?.1:Ra<864e5&&Ra>=72e6?.25:Ra<72e6&&Ra>=576e5?.4:Ra<576e5&&Ra>=432e5?.55:Ra<432e5&&Ra>=288e5?.7:Ra<288e5&&Ra>=144e5?.85:Ra<144e5&&Ra>=72e5?.925:Ra<72e5&&Ra>=36e5?.9625:1:0;e=Ve-He,t=We-Ke,a=Ue-Qe,n=Pe-Xe,i=De-Ze,r=Ge-Je,d=Be-$e,u=Ce-et,p=ze-tt,g=Math.floor(oe*ka*ya),T=Math.floor(le*ka*ya),f=Math.floor(Z*ka*ya),_=Math.floor(X*ka*ya),b=Math.floor(ae*ka*ya),h=Math.floor(ne*ka*ya),E=Math.floor(ie*ka*ya),w=Math.floor(J*ka*ya),S=Math.floor($*ka*ya),R=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+h*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+h*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+h*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||i<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k<=nn&&M<=en?(la=g,da=T,bt=f,
mt=_,jt=b,Xt=h,ea=E,wt=w,Dt=S):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k<=nn&&M<=en?(Pt=tn/R,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*h)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k<=nn&&M<=en?(Pt=an/y,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*h)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k>=nn&&M<=en?(Pt=nn/k,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*h)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k<=nn&&M>=en?(Pt=en/M,
la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*h)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k<=nn&&M<=en?(yt=an/y)>(dt=tn/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*h)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k>=nn&&M<=en?(yt=an/y)>(Wt=nn/k)?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*h)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,
Dt=Math.floor(Wt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k<=nn&&M>=en?(yt=an/y)>(Nt=en/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k>=nn&&M<=en?(Wt=nn/k)>(dt=tn/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*h)-1,ea=Math.floor(dt*E)-1,
wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*h)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k>=nn&&M>=en?(Wt=nn/k)>(Nt=en/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*h)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k<=nn&&M>=en?(Nt=en/M)>(dt=tn/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*h)-1,
ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k>=nn&&M<=en?(dt=tn/R,(yt=an/y)>(Wt=nn/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*h)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*h)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,
Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k<=nn&&M>=en?(dt=tn/R,(yt=an/y)>(Nt=en/M)&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Nt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Nt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*h)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=an&&k>=nn&&M>=en?(dt=tn/R,(Nt=en/M)>(Wt=nn/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,
da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*h)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>Nt&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Wt>dt&&Nt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*h)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R<=tn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=an&&k>=nn&&M>=en&&(Nt=en/M,(yt=an/y)>(Wt=nn/k)&&Nt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*h)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&Nt>yt?(la=Math.floor(yt*g)-1,
da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*h)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>Nt&&yt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*h)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){la>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:la}),v=[lt='spear',la],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,la)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Za>=3&&(da>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:da}),v=[lt='sword',da],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,da)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){Za>=5&&(bt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:bt}),v=[lt='axe',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,bt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Za>=9&&(mt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:mt}),v=[lt='archer',mt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,mt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Za>=11&&(jt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:jt}),v=[lt='light_cavalry',jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,jt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Za>=13&&(Xt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Xt}),
v=[lt='mounted_archer',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,Xt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Za>=15&&(ea>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:ea}),v=[lt='ram',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,ea)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Za>=17&&(wt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:wt}),v=[lt='catapult',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),te(Ca,lt,wt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Za>=21&&(Dt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Dt}),v=[lt='heavy_cavalry',Dt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
te(Ca,lt,Dt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,t,a,n,i,r,d,u,p,g,T,f,_,b,h,E,w,S,R,y,k,M}()}()}!function(){var e=i.getSelectedCharacter().getVillageList();console.log(e);var o=6e4*e.length,l=6e4*e.length+6e4*e.length,s=6e4*e.length+6e4*e.length+6e4*e.length;e.forEach((function(e,i){t&&setTimeout((function(){d.forEach((function(t){if(e.data.villageId==t){console.log('wioska:'+e.data.villageId),Ca=e.getId(),He=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Ke=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Qe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Xe=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Ze=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,Je=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,$e=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,
et=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,tt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,at=e.buildingData.data.barracks.level,nt=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),ot=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Oa=l.currentStock,La=n.currentStock,Pa=i.currentStock,Ua=o.currentStock,ot.forEach((function(e){ta=e.clientRecruitingTime,ua=1e3*(e.data.time_completed-e.data.start_time),aa=ua-ta,pa.push(aa)})),on()}}))}),6e4*i),a&&setTimeout((function(){u.forEach((function(t){if(e.data.villageId==t){He=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Ke=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Qe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Xe=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Ze=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,
Je=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,$e=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,et=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,tt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,za=e.buildingData.data.barracks.level,Da=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),Ga=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Ba=l.currentStock,Va=n.currentStock,Wa=i.currentStock,qa=o.currentStock,Ga.forEach((function(e){ta=e.clientRecruitingTime,ua=1e3*(e.data.time_completed-e.data.start_time),aa=ua-ta,fa.push(aa)})),ln()}}))}),6e4*(i+1)+o),n&&setTimeout((function(){p.forEach((function(t){if(e.data.villageId==t){He=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Ke=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Qe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,
Xe=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Ze=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,Je=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,$e=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,et=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,tt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Fa=e.buildingData.data.barracks.level,Ya=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),ja=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Ha=l.currentStock,Ka=n.currentStock,Qa=i.currentStock,Xa=o.currentStock,ja.forEach((function(e){ta=e.clientRecruitingTime,ua=1e3*(e.data.time_completed-e.data.start_time),aa=ua-ta,Aa.push(aa)})),sn()}}))}),6e4*(i+2)+l),c&&setTimeout((function(){g.forEach((function(t){if(e.data.villageId==t){He=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,
Ke=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Qe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Xe=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Ze=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,Je=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,$e=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,et=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,tt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Za=e.buildingData.data.barracks.level,Ja=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),$a=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;en=l.currentStock,tn=n.currentStock,an=i.currentStock,nn=o.currentStock,$a.forEach((function(e){ta=e.clientRecruitingTime,ua=1e3*(e.data.time_completed-e.data.start_time),aa=ua-ta,Sa.push(aa)})),rn()}}))}),6e4*(i+3)+s)}))}(),
m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},ae.getLogs=function(){return h},ae.clearLogs=function(){return h=[],T.set(Z,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},ae.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START),te(p.RECRUIT_START,'start',''),S=setInterval((function(){ae.presetRecrutation()}),R)},ae.stop=function(e=n.USER_STOP){w?(e!==n.USER_STOP&&(w=f.gameTime()+ee()),m.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):w=null,E=!1,clearInterval(S),m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&te(p.RECRUIT_STOP,'stop','')},ae.getSettings=function(){return _},ae.isInitialized=function(){return A},ae.isRunning=function(){return E},ae.getNextCycleDate=function(){return w},ae.getCycleInterval=ee,ae})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop',
RECRUIT_QUEUE_CLEAR_LOGS:'recruit_queue_clear_logs',RECRUIT_QUEUE_CYCLE_BEGIN:'recruit_queue_cycle_begin',RECRUIT_QUEUE_CYCLE_END:'recruit_queue_cycle_end'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/recruitQueue/types/status','two/recruitQueue/types/errors','two/Settings','queues/EventQueue','two/EventScope','helper/time','two/utils'],(function(e,t,n,d,u,p,T,f,_,b,h,A){let E,w,v,S=i.getGroupList(),R=!1,y=null,k={},M={},I={};const N={PRESETS:'presets',OWN:'own',LOGS:'logs'},x=function(e){E.selectedTab=e},O=function(){w.setAll(w.decode(E.settings)),A.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.presetRecrutation())},P=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.ownRecrutation())},U=function(){E.settings[n.GROUP1]=!1,E.settings[n.GROUP2]=!1,E.settings[n.GROUP3]=!1,
...
E.settings[n.START_AMOUNT16]=0,E.settings[n.START_AMOUNT17]=0,E.settings[n.START_AMOUNT18]=0,E.settings[n.START_AMOUNT19]=0,E.settings[n.FINAL_AMOUNT21]=0,E.settings[n.FINAL_AMOUNT22]=0,E.settings[n.FINAL_AMOUNT23]=0,E.settings[n.FINAL_AMOUNT24]=0,E.settings[n.FINAL_AMOUNT25]=0,E.settings[n.FINAL_AMOUNT26]=0,E.settings[n.FINAL_AMOUNT27]=0,E.settings[n.FINAL_AMOUNT28]=0,E.settings[n.FINAL_AMOUNT29]=0,E.settings[n.START_AMOUNT21]=0,E.settings[n.START_AMOUNT22]=0,E.settings[n.START_AMOUNT23]=0,E.settings[n.START_AMOUNT24]=0,E.settings[n.START_AMOUNT25]=0,E.settings[n.START_AMOUNT26]=0,E.settings[n.START_AMOUNT27]=0,E.settings[n.START_AMOUNT28]=0,E.settings[n.START_AMOUNT29]=0,E.settings[n.FINAL_AMOUNT31]=0,E.settings[n.FINAL_AMOUNT32]=0,E.settings[n.FINAL_AMOUNT33]=0,E.settings[n.FINAL_AMOUNT34]=0,E.settings[n.FINAL_AMOUNT35]=0,E.settings[n.FINAL_AMOUNT36]=0,E.settings[n.FINAL_AMOUNT37]=0,E.settings[n.FINAL_AMOUNT38]=0,E.settings[n.FINAL_AMOUNT39]=0,E.settings[n.START_AMOUNT31]=0,
E.settings[n.START_AMOUNT32]=0,E.settings[n.START_AMOUNT33]=0,E.settings[n.START_AMOUNT34]=0,E.settings[n.START_AMOUNT35]=0,E.settings[n.START_AMOUNT36]=0,E.settings[n.START_AMOUNT37]=0,E.settings[n.START_AMOUNT38]=0,E.settings[n.START_AMOUNT39]=0,w.setAll(w.decode(E.settings))},C=function(){E.settings[n.GROUP5]=!1,E.settings[n.GROUP6]=!1,E.settings[n.GROUP7]=!1,E.settings[n.GROUP8]=!1,E.settings[n.GROUP9]=!1,E.settings[n.GROUP10]=!1,E.settings[n.GROUP11]=!1,E.settings[n.GROUP12]=!1,E.settings[n.GROUP13]=!1,E.settings[n.GROUP14]=!1,E.settings[n.GROUP15]=!1,E.settings[n.GROUP16]=!1,E.settings[n.GROUP17]=!1,E.settings[n.GROUP18]=!1,E.settings[n.GROUP19]=!1,E.settings[n.GROUP20]=!1,E.settings[n.GROUP21]=!1,E.settings[n.GROUP22]=!1,E.settings[n.GROUP23]=!1,E.settings[n.GROUP24]=!1,E.settings[n.UNIT1]=!1,E.settings[n.UNIT2]=!1,E.settings[n.UNIT3]=!1,E.settings[n.UNIT4]=!1,E.settings[n.UNIT5]=!1,E.settings[n.UNIT6]=!1,E.settings[n.UNIT7]=!1,E.settings[n.UNIT8]=!1,E.settings[n.UNIT9]=!1,
E.settings[n.UNIT10]=!1,E.settings[n.UNIT11]=!1,E.settings[n.UNIT12]=!1,E.settings[n.UNIT13]=!1,E.settings[n.UNIT14]=!1,E.settings[n.UNIT15]=!1,E.settings[n.UNIT16]=!1,E.settings[n.UNIT17]=!1,E.settings[n.UNIT18]=!1,E.settings[n.UNIT19]=!1,E.settings[n.UNIT20]=!1,E.settings[n.AMOUNT1]=1,E.settings[n.AMOUNT2]=1,E.settings[n.AMOUNT3]=1,E.settings[n.AMOUNT4]=1,E.settings[n.AMOUNT5]=1,E.settings[n.AMOUNT6]=1,E.settings[n.AMOUNT7]=1,E.settings[n.AMOUNT8]=1,E.settings[n.AMOUNT9]=1,E.settings[n.AMOUNT10]=1,E.settings[n.AMOUNT11]=1,E.settings[n.AMOUNT12]=1,E.settings[n.AMOUNT13]=1,E.settings[n.AMOUNT14]=1,E.settings[n.AMOUNT15]=1,E.settings[n.AMOUNT16]=1,E.settings[n.AMOUNT17]=1,E.settings[n.AMOUNT18]=1,E.settings[n.AMOUNT19]=1,E.settings[n.AMOUNT20]=1,w.setAll(w.decode(E.settings))};k.updateVisibleLogs=function(){const e=E.pagination.logs.offset,t=E.pagination.logs.limit;k.visibleLogs=k.logs.slice(e,e+t),E.pagination.logs.count=k.logs.length,k.visibleLogs.forEach((function(e){
e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,I[e]='ŁADOWANIE...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},k.clearLogs=function(){t.clearLogs()};const z={updateGroups:function(){E.groups=f.encodeList(S.getGroups(),{disabled:!1,type:'groups'})},updateLogs:function(){E.logs=t.getLogs(),k.updateVisibleLogs(),E.logs.length||A.notif('success',g('i18n')('reseted_logs',a.loc.ale,'recruit_queue'))},clearLogs:function(){A.notif('success',g('i18n')('logs.cleared',a.loc.ale,'recruit_queue')),z.updateLogs()},start:function(){E.running=!0},stop:function(e,t){switch(E.running=!1,E.showCycleTimer=!1,clearInterval(y),t.reason){case T.USER_STOP:A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))}},onCycleBegin:function(){
E.showCycleTimer=!1,clearInterval(y)},onCycleEnd:function(e,a){a!==p.USER_STOP&&(E.showCycleTimer=!0,E.nextCycleCountdown=t.getCycleInterval(),y=setInterval((function(){E.nextCycleCountdown-=1e3}),1e3))}},D=function(){E=a.$new(),E.SETTINGS=n,E.TAB_TYPES=N,E.running=R,E.selectedTab=N.PRESETS,E.settingsMap=d,E.pagination={},E.clearP=U,E.clearO=C,E.units=f.encodeList(u,{textObject:'recruit_queue',disabled:!0}),w.injectScope(E),z.updateGroups(),function(){let e=t.getNextCycleDate(),a=e-h.gameTime();e&&(E.showCycleTimer=!0,E.nextCycleCountdown=a,y=setInterval((function(){E.nextCycleCountdown-=1e3,a<0&&(clearInterval(y),E.nextCycleCountdown='Cykl zakończony')}),1e3))}(),E.selectTab=x,E.saveSettings=O,E.switchRecruiterO=P,E.switchRecruiterP=L,E.logsView=k,E.logsView.logs=t.getLogs(),E.villagesInfo=M,E.villagesLabel=I,E.openVillageInfo=r.openVillageInfo,E.pagination.logs={count:k.logs.length,offset:0,loader:k.updateVisibleLogs,limit:m.getPaginationLimit()},k.updateVisibleLogs()
...
v.classList.add('btn-orange'),A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))})),
...
;var w=A.join(),v=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),y=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,M=d.defCharacterName,I=d.defVillageId,N=d.defVillageName,x=(100*d.defFaith).toFixed([0]),O=Math.round(100*d.defModifier).toFixed([0]),L=(100*d.wallBonus).toFixed([0]),P=d.night,U=d.loyaltyAfter,C=d.loyaltyBefore,z=d.wallAfter,D=d.wallBefore,G=d.officers,B=d.leader,V='',W='',q='',F='',Y='',j='',H='',K='',Q='',X=Date.now(),Z=s.split('.').join('_');null!=C&&(j='Lojalność przed atakiem: '+Math.floor(C)+' '),null!=U&&(H='Lojalność po ataku: '+Math.floor(U)+' '),null!=D&&(K='Mury przed ataku: '+D+' '),null!=z&&(Q='Mury po ataku: '+z+' '),null==G&&1==B?Y='Brak':null==G&&1.1==B&&(Y=' Wielki Mistrz '),F=0==P?'Nie':'Tak',2==i?V=' [color=d96a19]Częściowy sukces[/color]':1==i?V=' [color=0a8028]Sukces[/color]':3==i&&(V=' [color=e21f1f]Porażka[/color]'),q=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',
W=null==T&&null==m?'Brak danych':'[village='+m+']'+T+'[/village]',t=Math.floor(X/1e3-r),a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+N+'[/village][b] Gracz cel: [/b][player='+k+']'+M+'[/player][br]Modyfikator obrony: [b]'+O+'[/b] Bonus za mury: [b]'+L+'[/b][br]Wiara: [b]'+x+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+v+'[/b] Szczęście: [b]'+y+'[/b][br]Pozostałe bonusy: [b]'+E+'[/b][br]Oficerowie: [b]'+Y+'[/b][br]'+j+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},_=function(e){
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',f=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},_=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},b={init:function(){u=!0,c=new e({settingsMap:n,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&f(),t[o.GROUPS]&&_()})),d=c.getAll(),console.log('supportSender settings',d),l((function(){f()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,f),a.$on(s.ARMY_PRESET_DELETED,f),a.$on(s.GROUPS_CREATED,_),a.$on(s.GROUPS_DESTROYED,_),a.$on(s.GROUPS_UPDATED,_)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.SUPPORT_SENDER_START)},stop:function(){p=!1,
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return b})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d){let u,p,g,m=i.getPresetList(),T=i.getGroupList();const f={SUPPORT:'support',LOGS:'logs'},_=function(e){u.selectedTab=e},b=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},E=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=f,u.running=t.isRunning(),u.selectedTab=f.SUPPORT,u.settingsMap=o,p.injectScope(u),A(),E(),u.selectTab=_,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,E,!0),e.register(s.GROUPS_DESTROYED,E,!0),e.register(s.GROUPS_UPDATED,E,!0),e.register(s.SUPPORT_SENDER_START,w),e.register(s.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',S),
