...
;const a=h[t.BASHPOINTS_SWORD],i=h[t.BASHPOINTS_AXE],n=h[t.BASHPOINTS_ARCHER],l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],b=[4,5,1,5,5,6,23,4,12,40,200,25,10],T=0,E=0;function _(){console.log(T,E),A.html(T),v.html(E)}e=h[t.BASHPOINTS_SPEAR].value,console.log(e),T=e*m[0]+a*m[1]+i*m[2]+n*m[3]+l*m[4]+o*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+u*m[10]+p*m[11]+d*m[12],E=e*b[0]+a*b[1]+i*b[2]+n*b[3]+l*b[4]+o*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+u*b[10]+p*b[11]+d*b[12],setTimeout(_,500)},simulate:function(){}};return B.calculateT=function(){
