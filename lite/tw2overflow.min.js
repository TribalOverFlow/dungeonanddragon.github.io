...
[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},we={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},ve={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},Se={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},Re={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},ye={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},ke={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,
[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3};console.log(ke,ye,Re,Se,ve,we,he,fe,Ae);const Ie=function(){S=[];const e=i.getPresetList().getPresets();A[t.PRESET].forEach((function(t){S.push(e[t])}))},xe={init:function(){w=!0,f=new e({settingsMap:n,storageKey:_e}),f.onChange((function(e,t){A=f.getAll(),t[o.PRESETS]&&Ie()})),A=f.getAll(),console.log('battleCalculator settings',A),_((function(){Ie()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,Ie),a.$on(s.ARMY_PRESET_DELETED,Ie)},calculateB:function(){const e=A[t.BASHPOINTS_SPEAR],a=A[t.BASHPOINTS_SWORD],n=A[t.BASHPOINTS_AXE],i=A[t.BASHPOINTS_ARCHER],o=A[t.BASHPOINTS_LC],l=A[t.BASHPOINTS_MA],s=A[t.BASHPOINTS_HC],r=A[t.BASHPOINTS_RAM],c=A[t.BASHPOINTS_CATAPULT],d=A[t.BASHPOINTS_DOPPELSOLDNER],u=A[t.BASHPOINTS_TREBUCHET],p=A[t.BASHPOINTS_SNOB],g=A[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],T=[4,5,1,5,5,6,23,4,12,40,200,25,10];R=e*m[0]+a*m[1]+n*m[2]+i*m[3]+o*m[4]+l*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],
y=e*T[0]+a*T[1]+n*T[2]+i*T[3]+o*T[4]+l*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+p*T[10]+u*T[11]+d*T[12]}};return xe.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],o=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=A[t.BATTLE_ARCHER_A],c=A[t.BATTLE_ARCHER_D],d=A[t.BATTLE_AXE_A],u=A[t.BATTLE_AXE_D],p=A[t.BATTLE_DOPPELSOLDNER_A],g=A[t.BATTLE_DOPPELSOLDNER_D],m=A[t.BATTLE_CATAPULT_A],T=A[t.BATTLE_CATAPULT_D],b=A[t.BATTLE_TARGET_LEVEL],E=A[t.BATTLE_HC_A],_=A[t.BATTLE_HC_D],h=A[t.BATTLE_KNIGHT_A],f=A[t.BATTLE_KNIGHT_D],w=A[t.BATTLE_LC_A],v=A[t.BATTLE_LC_D],S=A[t.BATTLE_LUCK],R=A[t.BATTLE_MA_A],y=A[t.BATTLE_MA_D],k=A[t.BATTLE_MORALE],I=A[t.BATTLE_RAM_A],x=A[t.BATTLE_RAM_D],L=A[t.BATTLE_SNOB_A],O=A[t.BATTLE_SNOB_D],N=A[t.BATTLE_SPEAR_A],M=A[t.BATTLE_SPEAR_D],P=A[t.BATTLE_SWORD_A],C=A[t.BATTLE_SWORD_D],z=A[t.BATTLE_TREBUCHET_A],D=A[t.BATTLE_TREBUCHET_D],U=A[t.BATTLE_WALL],G=0,B=0,V=0,_e=0,he=0,fe=0,Ae=0,we=0,ve=0,Se=0,Re=0,ye=0,ke=0,Ie=0,xe=0,Le=0,Oe=0,Ne=0,Me=0,Pe=0,Ce=0,ze=0,De=0,Ue=0,Ge=0,Be=0,Ve=0,We=0,qe=0,Ye=0,Fe=0,He=0,je=0,Ke=0,Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,ot=0,lt=0,st=0,rt=0,ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,bt=0,Et=0,_t=0,ht=0,ft=0,At=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,It=0,xt=0,Lt=0,Ot=0,Nt=0,Mt=0,Pt=0,Ct=0,zt=0,Dt=0,Ut=0,Gt=0,Bt=0,Vt=0,Wt=0,qt=0,Yt=0,Ft=0,Ht=0,jt=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=[1,1],ga=[1,1],ma=[1,1],Ta=[1,1],ba=[1,1],Ea=[1,1],_a=[1,1],ha=[1,1],fa=[1,1],Aa=[1,1],wa=[1,1],va=[1,1],Sa=[1,1],Ra=[1,1],ya=[1,1],ka=[1,1],Ia=[1,1],xa=[1,1],La=[1,1],Oa=[1,1],Na=[1,1],Ma=[1,1],Pa=[1,1],Ca=[1,1],za=[1,1],Da=[1,1],Ua=[1,1],Ga=[1,1],Ba=[1,1],Va=[1,1],Wa=[1,1],qa=[1,1],Ya=[1,1],Fa=[1,1],Ha=[1,1],ja=[1,1],Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,Tn=0,bn=0,En=0,_n=0,hn=0,fn=0,An=0,wn=0,vn=0,Sn=0,Rn=0,yn=0,kn=0,In=0,xn=0,Ln=0,On=[1,1],Nn=0,Mn=0,Pn=0,Cn=0,zn=0,Dn=0,Un=0,Gn=0,Bn=0,Vn=0,Wn=0,qn=0,Yn=0,Fn=0,Hn=0,jn=0,Kn=0,Qn=0,Xn=0,Zn=0,Jn=0,$n=0,ei=0,ti=0,ai=0,ni=0,ii=0,oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,Ti=0,bi=0,Ei=0,_i=0,hi=[1,1],fi=[1,1],Ai=[1,1],wi=[1,1],vi=[1,1],Si=[1,1],Ri=[1,1],yi=[1,1],ki=[1,1],Ii=0,xi=0,Li=0,Oi=0,Ni=0,Mi=0,Pi=0,Ci=0,zi=0,Di=0,Ui=0,Gi=0,Bi=0,Vi=0,Wi=0,qi=0,Yi=0,Fi=0,Hi=0,ji=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,To=0,bo=0,Eo=0,_o=0,ho=0,fo=0,Ao=0,wo=0,vo=0,So=0,Ro=0,yo=0,ko=0,Io=0,xo=0,Lo=0,Oo=0,No=0,Mo=0,Po=0,Co=0,zo=0,Do=0,Uo=0,Go=0,Bo=0,Vo=0,Wo=0,qo=0,Yo=0,Fo=0,Ho=0,jo=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=1,pl=0,gl=0,ml=0,Tl=0,bl=0,El=0,_l=0,hl=0,fl=0,Al=0,wl=0,vl=0,Sl=0,Rl=0,yl=0,kl=0,Il=0,xl=0,Ll=0,Ol=0,Nl=0,Ml=0,Pl=0,Cl=0,zl=0,Dl=0,Ul=0,Gl=0,Bl=0,Vl=0,Wl=0,ql=0,Yl=0,Fl=0,Hl=0,jl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,Ts=0,bs=0,Es=0,_s=0,hs=0,fs=0,As=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Is=0,xs=0,Ls=0,Os=0,Ns=0,Ms=0,Ps=0,Cs=0,zs=0,Ds=0,Us=0,Gs=0,Bs=0,Vs=0,Ws=0,qs=0,Ys=0,Fs=0,Hs=0,js=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,Tr=0,br=0,Er=0,_r=0,hr=0,fr=0,Ar=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Ir=0,xr=0,Lr=0,Or=0,Nr=0,Mr=0,Pr=0,Cr=0,zr=0,Dr=0,Ur=0,Gr=0,Br=0,Vr=0,Wr=0,qr=0,Yr=0,Fr=0,Hr=0,jr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,Tc=0,bc=0,Ec=0,_c=0,hc=0,fc=0,Ac=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Ic=0,xc=0,Lc=0,Oc=0,Nc=0,Mc=0,Pc=0,Cc=0,zc=0,Dc=0,Uc=0,Gc=0,Bc=0,Vc=0,Wc=0,qc=0,Yc=0,Fc=0,Hc=0,jc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0
;Qa=A[t.BATTLE_CHURCH_A],Xa=A[t.BATTLE_CHURCH_D],ul=A[t.BATTLE_NIGHT_BONUS].checked?2:1,Eo=A[t.BATTLE_OFFICER_LEADER].checked?.1:0,cl=A[t.BATTLE_OFFICER_MEDIC].checked?.1:0,vs=A[t.BATTLE_SKILL_MEDIC].checked?.1:0,As=A[t.BATTLE_SKILL_WEAPON_MASTER],Ss=A[t.BATTLE_SKILL_IRON_WALLS],ws=A[t.BATTLE_SKILL_CLINIQUE],yn=A[t.BATTLE_HOSPITAL],ca=A[t.BATTLE_CATAPULT_TARGET],ce=A[t.BATTLE_CATAPULT_TARGET],kn=A[t.BATTLE_KNIGHT_ITEM_D1],In=A[t.BATTLE_KNIGHT_ITEM_D2],xn=A[t.BATTLE_KNIGHT_ITEM_D3],Ln=A[t.BATTLE_KNIGHT_ITEM_A],_o=A[t.BATTLE_ITEM_LEVEL_D1],ho=A[t.BATTLE_ITEM_LEVEL_D2],fo=A[t.BATTLE_ITEM_LEVEL_D3],Ao=A[t.BATTLE_ITEM_LEVEL_A],Ea='axe'==kn&1==_o?[1.05,1.1]:'axe'==kn&2==_o?[1.1,1.2]:'axe'==kn&3==_o?[1.2,1.3]:[1,1],Ma='ma'==kn&1==_o?[1.05,1.1]:'ma'==kn&2==_o?[1.1,1.2]:'ma'==kn&3==_o?[1.2,1.3]:[1,1],Va='spear'==kn&1==_o?[1.1,1.05]:'spear'==kn&2==_o?[1.2,1.1]:'spear'==kn&3==_o?[1.3,1.2]:[1,1],Fa='sword'==kn&1==_o?[1.1,1.05]:'sword'==kn&2==_o?[1.2,1.1]:'sword'==kn&3==_o?[1.3,1.2]:[1,1],
ga='archer'==kn&1==_o?[1.1,1.05]:'archer'==kn&2==_o?[1.2,1.1]:'archer'==kn&3==_o?[1.3,1.2]:[1,1],Ra='hc'==kn&1==_o?[1.1,1.1]:'hc'==kn&2==_o?[1.2,1.2]:'hc'==kn&3==_o?[1.3,1.3]:[1,1],Da='ram'==kn&1==_o?[1.05,1.25]:'ram'==kn&2==_o?[1.1,1.5]:'ram'==kn&3==_o?[1.2,2]:[1,1],Aa='catapult'==kn&1==_o?[1.05,1.25]:'catapult'==kn&2==_o?[1.1,1.5]:'catapult'==kn&3==_o?[1.2,2]:[1,1],_a='axe'==In&1==ho?[1.05,1.1]:'axe'==In&2==ho?[1.1,1.2]:'axe'==In&3==ho?[1.2,1.3]:[1,1],Pa='ma'==In&1==ho?[1.05,1.1]:'ma'==In&2==ho?[1.1,1.2]:'ma'==In&3==ho?[1.2,1.3]:[1,1],Wa='spear'==In&1==ho?[1.1,1.05]:'spear'==In&2==ho?[1.2,1.1]:'spear'==In&3==ho?[1.3,1.2]:[1,1],Ha='sword'==In&1==ho?[1.1,1.05]:'sword'==In&2==ho?[1.2,1.1]:'sword'==In&3==ho?[1.3,1.2]:[1,1],ma='archer'==In&1==ho?[1.1,1.05]:'archer'==In&2==ho?[1.2,1.1]:'archer'==In&3==ho?[1.3,1.2]:[1,1],ya='hc'==In&1==ho?[1.1,1.1]:'hc'==In&2==ho?[1.2,1.2]:'hc'==In&3==ho?[1.3,1.3]:[1,1],Ua='ram'==In&1==ho?[1.05,1.25]:'ram'==In&2==ho?[1.1,1.5]:'ram'==In&3==ho?[1.2,2]:[1,1],
...
Be=N*s[0]+P*s[1]+d*s[2]+r*s[3]+w*s[4]+R*s[5]+E*s[6]+I*s[7]+m*s[8]+h*s[9]+L*s[10]+z*s[11]+p*s[12],da=M*s[0]+C*s[1]+u*s[2]+c*s[3]+v*s[4]+y*s[5]+_*s[6]+x*s[7]+T*s[8]+f*s[9]+O*s[10]+D*s[11]+g*s[12],Ka=2*Be<=da?2:1,pl=Be-5*I,Tl=0==U?0:Math.round(20*Math.pow(1.2515,U-1)),ua=da+(Tl+100*O),Bl=0==pl||0==ua?0:pl/ua>1?1:pl/ua,dl=k/100,Go=S/100,ml=Math.round(1e3*(Qa/100*dl*(1+Go)+As/100+Eo))/1e3,dd=m/(cd=I+m),ud=I/cd,Vc=Math.round(D*dd),id=Math.round(D*ud),ps=(ms=I-(0==I?0:I<id?I:id))*Bl*ml*(On='ram'==Ln?1==Ao?[1.05,1.25]:2==Ao?[1.1,1.5]:3==Ao?[1.2,2]:[1,1]:[1,1])[1],Sn=20==U?18:19==U?17:18==U?15:17==U?14:16==U?13:15==U?11:14==U?10:13==U||12==U?9:11==U?8:10==U?7:9==U||8==U?6:7==U||6==U?5:5==U||4==U||3==U?4:2==U||1==U?3:0,sd=0==U?0:2*Sn,od=0==U?0:ps/sd,rd=U<=Ss?U:U-Ss<od?U<Ss?U:Ss:U-od,pt=Math.round(rd),ut=Math.round(.05*pt*1e3)/1e3,gl=Math.round(Xa/100*(1+ut)*ul*1e3)/1e3,ra=m-(0==m?0:m<Vc?m:Vc),dt=0==(ld=Math.round(rd))?0:Math.round(20*Math.pow(1.2515,ld-1)),
Hi=N+P+d+p>w+E&&N+P+d+p>r+R?'inf':w+E>N+P+d+p&&w+E>r+R?'cav':'arc',Rl=N*s[0]+P*s[1]+d*s[2]+r*s[3]+w*s[4]+R*s[5]+E*s[6]+ms*s[7]+ra*s[8]+h*s[9]+L*s[10]+z*s[11]+p*s[12],Dl=M*s[0]+C*s[1]+u*s[2]+c*s[3]+v*s[4]+y*s[5]+_*s[6]+x*s[7]+T*s[8]+f*s[9]+O*s[10]+D*s[11]+g*s[12],console.log(Dl,Rl),bs=ms*s[7]+ra*s[8]+z*s[11]+h*s[9]+L*s[10],'cav'==Hi?(hl=w*s[4]+E*s[6]+bs,wl=N*s[0]+P*s[1]+d*s[2]+p*s[12],bl=r*s[3]+R*s[5]):'inf'==Hi?(wl=N*s[0]+P*s[1]+d*s[2]+p*s[12]+bs,hl=w*s[4]+E*s[6],bl=r*s[3]+R*s[5]):'arc'==Hi?(wl=N*s[0]+P*s[1]+d*s[2]+p*s[12],hl=w*s[4]+E*s[6],bl=r*s[3]+R*s[5]+bs):(wl=N*s[0]+P*s[1]+d*s[2]+p*s[12],hl=w*s[4]+E*s[6],bl=r*s[3]+R*s[5]),Lo=0==wl?0:Math.round(wl/Rl*1e4)/1e4,xo=0==hl?0:Math.round(hl/Rl*1e4)/1e4,Io=0==bl?0:Math.round(bl/Rl*1e4)/1e4,console.log(Io),rr=Math.round(M*Lo),sr=Math.round(M*xo),lr=M-sr-rr,Rc=Math.round(C*Lo),Sc=Math.round(C*xo),vc=C-Sc-Rc,tt=Math.round(u*Lo),et=Math.round(u*xo),$e=u-et-tt,Le=Math.round(c*Lo),xe=Math.round(c*xo),Ie=c-xe-Le,so=Math.round(v*Lo),
lo=Math.round(v*xo),oo=v-lo-so,el=Math.round(y*Lo),$o=Math.round(y*xo),Jo=y-$o-el,mn=Math.round(_*Lo),gn=Math.round(_*xo),pn=_-gn-mn,ts=Math.round(x*Lo),es=Math.round(x*xo),$l=x-es-ts,Xt=Math.round(T*Lo),Qt=Math.round(T*xo),Kt=T-Qt-Xt,Gs=Math.round(O*Lo),Us=Math.round(O*xo),Ds=O-Us-Gs,Qc=Math.round(D*Lo),Kc=Math.round(D*xo),jc=D-Kc-Qc,kt=Math.round(g*Lo),yt=Math.round(g*xo),Rt=g-yt-kt,di=Math.round(f*Lo),ci=Math.round(f*xo),ri=f-ci-di,Pl=rr*s[0]+Rc*s[1]+tt*s[2]+kt*s[12]+Gs*s[10]+so*s[4]+mn*s[6]+Le*s[3]+el*s[5]+ts*s[7]+Xt*s[8]+Qc*s[11]+di*s[9],Ol=sr*s[0]+Sc*s[1]+et*s[2]+yt*s[12]+Us*s[10]+lo*s[4]+gn*s[6]+xe*s[3]+$o*s[5]+es*s[7]+Qt*s[8]+Kc*s[11]+ci*s[9],Il=lr*s[0]+vc*s[1]+$e*s[2]+Rt*s[12]+Ds*s[10]+oo*s[4]+pn*s[6]+Ie*s[3]+Jo*s[5]+$l*s[7]+Kt*s[8]+jc*s[11]+ri*s[9],console.log(Il,Ol,Pl),Yr=rr*n[0]*Ba[0]+Rc*n[1]*Ya[0]+tt*n[2]*ba[0]+kt*n[12]+Gs*n[10]+so*n[4]*Ia[0]+mn*n[6]*Sa[0]+Le*n[3]*pa[0]+el*n[5]*Na[0]+ts*n[7]*za[0]+Xt*n[8]*fa[0]+Qc*n[11]+di*n[9],
Vr=sr*i[0]*Ba[0]+Sc*i[1]*Ya[0]+et*i[2]*ba[0]+yt*i[12]+Us*i[10]+lo*i[4]*Ia[0]+gn*i[6]*Sa[0]+xe*i[3]*pa[0]+$o*i[5]*Na[0]+es*i[7]*za[0]+Qt*i[8]*fa[0]+Kc*i[11]+ci*i[9],Ur=lr*o[0]*Ba[0]+vc*o[1]*Ya[0]+$e*o[2]*ba[0]+Rt*o[12]+Ds*o[10]+oo*o[4]*Ia[0]+pn*o[6]*Sa[0]+Ie*o[3]*pa[0]+Jo*o[5]*Na[0]+$l*o[7]*za[0]+Kt*o[8]*fa[0]+jc*o[11]+ri*o[9],hs=ms*l[7]*Ri[1]+ra*l[8]*Ai[1]+z*l[11]+h*l[9]+L*l[10],'cav'==Hi?(Nr=w*l[4]*vi[1]+E*l[6]*wi[1]+hs,Cr=N*l[0]*yi[1]+P*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka,xr=r*l[3]*hi[1]+R*l[5]*Si[1]):'inf'==Hi?(Cr=N*l[0]*yi[1]+P*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka+hs,Nr=w*l[4]*vi[1]+E*l[6]*wi[1],xr=r*l[3]*hi[1]+R*l[5]*Si[1]):'arc'==Hi?(Cr=N*l[0]*yi[1]+P*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka,Nr=w*l[4]*vi[1]+E*l[6]*wi[1],xr=r*l[3]*hi[1]+R*l[5]*Si[1]+hs):(Cr=N*l[0]*yi[1]+P*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka,Nr=w*l[4]*vi[1]+E*l[6]*wi[1],xr=r*l[3]*hi[1]+R*l[5]*Si[1]),yr=(vr=Cr*ml)+(fr=Nr*ml)+(Er=xr*ml),ac=($r=Yr*gl+dt)+(Xr=Vr*gl+dt)+(jr=Ur*gl+dt),
Fi=0==vr||0==$r?0:$r<=vr?1:Math.pow(vr/$r,.5)/($r/vr),Yi=0==fr||0==Xr?0:Xr<=fr?1:Math.pow(fr/Xr,.5)/(Xr/fr),qi=0==Er||0==jr?0:jr<=Er?1:Math.pow(Er/jr,.5)/(jr/Er),Wi=0==vr||0==$r?0:vr<=$r?1:Math.pow($r/vr,.5)/(vr/$r),Vi=0==fr||0==Xr?0:fr<=Xr?1:Math.pow(Xr/fr,.5)/(fr/Xr),Bi=0==Er||0==jr?0:Er<=jr?1:Math.pow(jr/Er,.5)/(Er/jr),Pn=Math.round(1e6*Wi)/1e6,Mn=Math.round(1e6*Vi)/1e6,Nn=Math.round(1e6*Bi)/1e6,Dn=Math.round(1e6*Fi)/1e6,zn=Math.round(1e6*Yi)/1e6,Cn=Math.round(1e6*qi)/1e6,ar=Math.round(-rr*Dn+1e-6)+Math.round(-sr*zn+1e-6)+Math.round(-lr*Cn+1e-6),hc=Math.round(-Rc*Dn+1e-6)+Math.round(-Sc*zn+1e-6)+Math.round(-vc*Cn+1e-6),Qe=Math.round(-tt*Dn+1e-6)+Math.round(-et*zn+1e-6)+Math.round(-$e*Cn+1e-6),Se=Math.round(-Le*Dn+1e-6)+Math.round(-xe*zn+1e-6)+Math.round(-Ie*Cn+1e-6),to=Math.round(-so*Dn+1e-6)+Math.round(-lo*zn+1e-6)+Math.round(-oo*Cn+1e-6),Ko=Math.round(-el*Dn+1e-6)+Math.round(-$o*zn+1e-6)+Math.round(-Jo*Cn+1e-6),
rn=Math.round(-mn*Dn+1e-6)+Math.round(-gn*zn+1e-6)+Math.round(-pn*Cn+1e-6),Ql=Math.round(-ts*Dn+1e-6)+Math.round(-es*zn+1e-6)+Math.round(-$l*Cn+1e-6),Yt=Math.round(-Xt*Dn+1e-6)+Math.round(-Qt*zn+1e-6)+Math.round(-Kt*Cn+1e-6),qc=Math.round(-Qc*Dn+1e-6)+Math.round(-Kc*zn+1e-6)+Math.round(-jc*Cn+1e-6),At=Math.round(-kt*Dn+1e-6)+Math.round(-yt*zn+1e-6)+Math.round(-Rt*Cn+1e-6),ii=Math.round(-di*Dn+1e-6)+Math.round(-ci*zn+1e-6)+Math.round(-ri*Cn+1e-6),Ms=Math.round(-Gs*Dn+1e-6)+Math.round(-Us*zn+1e-6)+Math.round(-Ds*Cn+1e-6),Qs=Math.round(-N*Pn+1e-6),pc=Math.round(-P*Pn+1e-6),We=Math.round(-d*Pn+1e-6),mt=Math.round(-p*Pn+1e-6),V=Math.round(-r*Nn+1e-6),Vo=Math.round(-R*Nn+1e-6),Ki=Math.round(-w*Mn+1e-6),en=Math.round(-E*Mn+1e-6),'cav'==Hi?(Wl=Math.round(-ms*Mn+1e-6),Dt=Math.round(-ra*Mn+1e-6),Cc=Math.round(-z*Mn+1e-6),Zn=Math.round(-h*Mn+1e-6),ys=Math.round(-L*Mn+1e-6)):'inf'==Hi?(Wl=Math.round(-ms*Pn+1e-6),Dt=Math.round(-ra*Pn+1e-6),Cc=Math.round(-z*Pn+1e-6),Zn=Math.round(-h*Pn+1e-6),
ys=Math.round(-L*Pn+1e-6)):'arc'==Hi&&(Wl=Math.round(-ms*Nn+1e-6),Dt=Math.round(-ra*Nn+1e-6),Cc=Math.round(-z*Nn+1e-6),Zn=Math.round(-h*Nn+1e-6),ys=Math.round(-L*Nn+1e-6)),Js=N+Qs,Tc=P+pc,Fe=d+We,fe=r+V,Zi=w+Ki,Yo=R+Vo,nn=E+en,Fl=ms+Wl,Bt=ra+Dt,Uc=z+Cc,Et=p+mt,xs=L+ys,ei=h+Zn,or=M+ar,wc=C+hc,Je=u+Qe,ke=c+Se,io=v+to,Zo=y+Ko,un=_+rn,Jl=x+Ql,jt=T+Yt,Hc=D+qc,St=g+At,zs=O+Ms,si=f+ii,wo=Qs*s[0]+pc*s[1]+We*s[2]+V*s[3]+Ki*s[4]+Vo*s[5]+en*s[6]+Wl*s[7]+Dt*s[8]+Zn*s[9]+ys*s[10]+Cc*s[11]+mt*s[12],Ro=ar*s[0]+hc*s[1]+Qe*s[2]+Se*s[3]+to*s[4]+Ko*s[5]+rn*s[6]+Ql*s[7]+Yt*s[8]+ii*s[9]+Ms*s[10]+qc*s[11]+At*s[12],console.log(wo,Ro),oc=Js*s[0]+Tc*s[1]+Fe*s[2]+fe*s[3]+Zi*s[4]+Yo*s[5]+nn*s[6]+Fl*s[7]+Bt*s[8]+Uc*s[11]+Et*s[12]+xs*s[10]+ei*s[9],rc=or*s[0]+wc*s[1]+Je*s[2]+ke*s[3]+io*s[4]+Zo*s[5]+un*s[6]+Jl*s[7]+jt*s[8]+Hc*s[11]+St*s[12]+zs*s[10]+si*s[9],console.log(oc,rc),Ge=0==yr||0==ac?0:ac<=yr?1:Math.pow(yr/ac,.5/(ac/yr)),console.log(Ge),
yl=Js*s[0]+Tc*s[1]+Fe*s[2]+fe*s[3]+Zi*s[4]+Yo*s[5]+nn*s[6]+Fl*s[7]+Bt*s[8]+ei*s[9]+xs*s[10]+Uc*s[11]+Et*s[12],Ul=or*s[0]+wc*s[1]+Je*s[2]+ke*s[3]+io*s[4]+Zo*s[5]+un*s[6]+Jl*s[7]+jt*s[8]+si*s[9]+zs*s[10]+Hc*s[11]+St*s[12],console.log(Ul,yl),Es=Fl*s[7]+Bt*s[8]+Uc*s[11]+ei*s[9],'cav'==Hi?(fl=Zi*s[4]+nn*s[6]+Es,vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10],El=fe*s[3]+Yo*s[5]):'inf'==Hi?(vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10]+Es,fl=Zi*s[4]+nn*s[6],El=fe*s[3]+Yo*s[5]):'arc'==Hi?(vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10],fl=Zi*s[4]+nn*s[6],El=fe*s[3]+Yo*s[5]+Es):(vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10],fl=Zi*s[4]+nn*s[6],El=fe*s[3]+Yo*s[5]),Mo=0==vl?0:Math.round(vl/yl*1e4)/1e4,No=0==fl?0:Math.round(fl/yl*1e4)/1e4,Oo=0==El?0:Math.round(El/yl*1e4)/1e4,console.log(Oo),pr=Math.round(or*Mo),ur=Math.round(or*No),dr=or-ur-pr,xc=Math.round(wc*Mo),Ic=Math.round(wc*No),kc=wc-Ic-xc,ot=Math.round(Je*Mo),it=Math.round(Je*No),nt=Je-it-ot,Pe=Math.round(ke*Mo),Me=Math.round(ke*No),Ne=ke-Me-Pe,
po=Math.round(io*Mo),uo=Math.round(io*No),co=io-uo-po,il=Math.round(Zo*Mo),nl=Math.round(Zo*No),al=Zo-nl-il,_n=Math.round(un*Mo),En=Math.round(un*No),bn=un-En-_n,os=Math.round(Jl*Mo),is=Math.round(Jl*No),ns=Jl-is-os,ea=Math.round(jt*Mo),$t=Math.round(jt*No),Jt=jt-$t-ea,qs=Math.round(zs*Mo),Ws=Math.round(zs*No),Vs=zs-Ws-qs,$c=Math.round(Hc*Mo),Jc=Math.round(Hc*No),Zc=Hc-Jc-$c,Ot=Math.round(St*Mo),Lt=Math.round(St*No),xt=St-Lt-Ot,mi=Math.round(si*Mo),gi=Math.round(si*No),pi=si-gi-mi,Cl=pr*s[0]+xc*s[1]+ot*s[2]+Ot*s[12]+qs*s[10]+po*s[4]+_n*s[6]+Pe*s[3]+il*s[5]+os*s[7]+ea*s[8]+$c*s[11]+mi*s[9],Nl=ur*s[0]+Ic*s[1]+it*s[2]+Lt*s[12]+Ws*s[10]+uo*s[4]+En*s[6]+Me*s[3]+nl*s[5]+is*s[7]+$t*s[8]+Jc*s[11]+gi*s[9],xl=dr*s[0]+kc*s[1]+nt*s[2]+xt*s[12]+Vs*s[10]+co*s[4]+bn*s[6]+Ne*s[3]+al*s[5]+ns*s[7]+Jt*s[8]+Zc*s[11]+pi*s[9],console.log(xl,Nl,Cl),
Fr=pr*n[0]*Ba[0]+xc*n[1]*Ya[0]+ot*n[2]*ba[0]+Ot*n[12]+qs*n[10]+po*n[4]*Ia[0]+_n*n[6]*Sa[0]+Pe*n[3]*pa[0]+il*n[5]*Na[0]+os*n[7]*za[0]+ea*n[8]*fa[0]+$c*n[11]+mi*n[9],Wr=ur*i[0]*Ba[0]+Ic*i[1]*Ya[0]+it*i[2]*ba[0]+Lt*i[12]+Ws*i[10]+uo*i[4]*Ia[0]+En*i[6]*Sa[0]+Me*i[3]*pa[0]+nl*i[5]*Na[0]+is*i[7]*za[0]+$t*i[8]*fa[0]+Jc*i[11]+gi*i[9],Gr=dr*o[0]*Ba[0]+kc*o[1]*Ya[0]+nt*o[2]*ba[0]+xt*o[12]+Vs*o[10]+co*o[4]*Ia[0]+bn*o[6]*Sa[0]+Ne*o[3]*pa[0]+al*o[5]*Na[0]+ns*o[7]*za[0]+Jt*o[8]*fa[0]+Zc*o[11]+pi*o[9],fs=Fl*l[7]*Ri[1]+Bt*l[8]*Ai[1]+Uc*l[11]+ei*l[9],'cav'==Hi?(Mr=Zi*l[4]*vi[1]+nn*l[6]*wi[1]+fs,zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]):'inf'==Hi?(zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10]+fs,Mr=Zi*l[4]*vi[1]+nn*l[6]*wi[1],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]):'arc'==Hi?(zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10],Mr=Zi*l[4]*vi[1]+nn*l[6]*wi[1],
Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]+fs):(zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10],Mr=Zi*l[4]*vi[1]+nn*l[6]*wi[1],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]),kr=(Sr=zr*ml)+(Ar=Mr*ml)+(_r=Lr*ml),nc=(ec=Fr*gl)+(Zr=Wr*gl)+(Kr=Gr*gl),console.log(kr,nc),Mi=0==Sr||0==ec?0:ec<=Sr?1:Math.pow(Sr/ec,.5)/(ec/Sr),Ni=0==Ar||0==Zr?0:Zr<=Ar?1:Math.pow(Ar/Zr,.5)/(Zr/Ar),Oi=0==_r||0==Kr?0:Kr<=_r?1:Math.pow(_r/Kr,.5)/(Kr/_r),Li=0==Sr||0==ec?0:Sr<=ec?1:Math.pow(ec/Sr,.5)/(Sr/ec),xi=0==Ar||0==Zr?0:Ar<=Zr?1:Math.pow(Zr/Ar,.5)/(Ar/Zr),Ii=0==_r||0==Kr?0:_r<=Kr?1:Math.pow(Kr/_r,.5)/(_r/Kr),Bn=Math.round(1e6*Li)/1e6,Gn=Math.round(1e6*xi)/1e6,Un=Math.round(1e6*Ii)/1e6,qn=Math.round(1e6*Mi)/1e6,Wn=Math.round(1e6*Ni)/1e6,Vn=Math.round(1e6*Oi)/1e6,nr=Math.round(-pr*qn+1e-6)+Math.round(-ur*Wn+1e-6)+Math.round(-dr*Vn+1e-6),fc=Math.round(-xc*qn+1e-6)+Math.round(-Ic*Wn+1e-6)+Math.round(-kc*Vn+1e-6),Xe=Math.round(-ot*qn+1e-6)+Math.round(-it*Wn+1e-6)+Math.round(-nt*Vn+1e-6),
Re=Math.round(-Pe*qn+1e-6)+Math.round(-Me*Wn+1e-6)+Math.round(-Ne*Vn+1e-6),ao=Math.round(-po*qn+1e-6)+Math.round(-uo*Wn+1e-6)+Math.round(-co*Vn+1e-6),Qo=Math.round(-il*qn+1e-6)+Math.round(-nl*Wn+1e-6)+Math.round(-al*Vn+1e-6),cn=Math.round(-_n*qn+1e-6)+Math.round(-En*Wn+1e-6)+Math.round(-bn*Vn+1e-6),Xl=Math.round(-os*qn+1e-6)+Math.round(-is*Wn+1e-6)+Math.round(-ns*Vn+1e-6),Ft=Math.round(-ea*qn+1e-6)+Math.round(-$t*Wn+1e-6)+Math.round(-Jt*Vn+1e-6),Yc=Math.round(-$c*qn+1e-6)+Math.round(-Jc*Wn+1e-6)+Math.round(-Zc*Vn+1e-6),wt=Math.round(-Ot*qn+1e-6)+Math.round(-Lt*Wn+1e-6)+Math.round(-xt*Vn+1e-6),oi=Math.round(-mi*qn+1e-6)+Math.round(-gi*Wn+1e-6)+Math.round(-pi*Vn+1e-6),Ps=Math.round(-qs*qn+1e-6)+Math.round(-Ws*Wn+1e-6)+Math.round(-Vs*Vn+1e-6),Xs=Math.round(-Js*Bn+1e-6),gc=Math.round(-Tc*Bn+1e-6),qe=Math.round(-Fe*Bn+1e-6),Tt=Math.round(-Et*Bn+1e-6),_e=Math.round(-fe*Un+1e-6),Wo=Math.round(-Yo*Un+1e-6),Qi=Math.round(-Zi*Gn+1e-6),tn=Math.round(-nn*Gn+1e-6),
'cav'==Hi?(ql=Math.round(-Fl*Gn+1e-6),Ut=Math.round(-Bt*Gn+1e-6),zc=Math.round(-Uc*Gn+1e-6),Jn=Math.round(-ei*Gn+1e-6)):'inf'==Hi?(ql=Math.round(-Fl*Bn+1e-6),Ut=Math.round(-Bt*Bn+1e-6),zc=Math.round(-Uc*Bn+1e-6),Jn=Math.round(-ei*Bn+1e-6)):'arc'==Hi&&(ql=Math.round(-Fl*Un+1e-6),Ut=Math.round(-Bt*Un+1e-6),zc=Math.round(-Uc*Un+1e-6),Jn=Math.round(-ei*Un+1e-6)),ks=100*xs==vl?0:Math.round(-xs*Bn+1e-6),$s=Js+Xs,bc=Tc+gc,He=Fe+qe,Ae=fe+_e,Ji=Zi+Qi,Fo=Yo+Wo,on=nn+tn,Hl=Fl+ql,Vt=Bt+Ut,Gc=Uc+zc,_t=Et+Tt,Ls=xs+ks,ti=ei+Jn,cr=or+nr,yc=wc+fc,at=Je+Xe,Oe=ke+Re,ro=io+ao,tl=Zo+Qo,Tn=un+cn,as=Jl+Xl,Zt=jt+Ft,Xc=Hc+Yc,It=St+wt,Bs=zs+Ps,ui=si+oi,vo=Xs*s[0]+gc*s[1]+qe*s[2]+_e*s[3]+Qi*s[4]+Wo*s[5]+tn*s[6]+ql*s[7]+Ut*s[8]+Jn*s[9]+ks*s[10]+zc*s[11]+Tt*s[12],yo=nr*s[0]+fc*s[1]+Xe*s[2]+Re*s[3]+ao*s[4]+Qo*s[5]+cn*s[6]+Xl*s[7]+Ft*s[8]+oi*s[9]+Ps*s[10]+Yc*s[11]+wt*s[12],console.log(vo,yo),lc=$s*s[0]+bc*s[1]+He*s[2]+Ae*s[3]+Ji*s[4]+Fo*s[5]+on*s[6]+Hl*s[7]+Vt*s[8]+Gc*s[11]+_t*s[12]+Ls*s[10]+ti*s[9],
cc=cr*s[0]+yc*s[1]+at*s[2]+Oe*s[3]+ro*s[4]+tl*s[5]+Tn*s[6]+as*s[7]+Zt*s[8]+Xc*s[11]+It*s[12]+Bs*s[10]+ui*s[9],console.log(lc,cc),kl=$s*s[0]+bc*s[1]+He*s[2]+Ae*s[3]+Ji*s[4]+Fo*s[5]+on*s[6]+Hl*s[7]+Vt*s[8]+ti*s[9]+Ls*s[10]+Gc*s[11]+_t*s[12],Gl=cr*s[0]+yc*s[1]+at*s[2]+Oe*s[3]+ro*s[4]+tl*s[5]+Tn*s[6]+as*s[7]+Zt*s[8]+ui*s[9]+Bs*s[10]+Xc*s[11]+It*s[12],console.log(Gl,kl),Ts=Hl*s[7]+Vt*s[8]+Gc*s[11]+ti*s[9],'cav'==Hi?(Al=Ji*s[4]+on*s[6]+Ts,Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10],_l=Ae*s[3]+Fo*s[5]):'inf'==Hi?(Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10]+Ts,Al=Ji*s[4]+on*s[6],_l=Ae*s[3]+Fo*s[5]):'arc'==Hi?(Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10],Al=Ji*s[4]+on*s[6],_l=Ae*s[3]+Fo*s[5]+Ts):(Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10],Al=Ji*s[4]+on*s[6],_l=Ae*s[3]+Fo*s[5]),zo=0==Sl?0:Math.round(Sl/kl*1e4)/1e4,Co=0==Al?0:Math.round(Al/kl*1e4)/1e4,Po=0==_l?0:Math.round(_l/kl*1e4)/1e4,console.log(Po),br=Math.round(cr*zo),Tr=Math.round(cr*Co),mr=cr-Tr-br,Mc=Math.round(yc*zo),
Nc=Math.round(yc*Co),Oc=yc-Nc-Mc,ct=Math.round(at*zo),rt=Math.round(at*Co),st=at-rt-ct,Ue=Math.round(Oe*zo),De=Math.round(Oe*Co),ze=Oe-De-Ue,bo=Math.round(ro*zo),To=Math.round(ro*Co),mo=ro-To-bo,rl=Math.round(tl*zo),sl=Math.round(tl*Co),ll=tl-sl-rl,wn=Math.round(Tn*zo),An=Math.round(Tn*Co),fn=Tn-An-wn,cs=Math.round(as*zo),rs=Math.round(as*Co),ss=as-rs-cs,ia=Math.round(Zt*zo),na=Math.round(Zt*Co),aa=Zt-na-ia,js=Math.round(Bs*zo),Hs=Math.round(Bs*Co),Fs=Bs-Hs-js,nd=Math.round(Xc*zo),ad=Math.round(Xc*Co),td=Xc-ad-nd,Ct=Math.round(It*zo),Pt=Math.round(It*Co),Mt=It-Pt-Ct,_i=Math.round(ui*zo),Ei=Math.round(ui*Co),bi=ui-Ei-_i,zl=br*s[0]+Mc*s[1]+ct*s[2]+Ct*s[12]+js*s[10]+bo*s[4]+wn*s[6]+Ue*s[3]+rl*s[5]+cs*s[7]+ia*s[8]+nd*s[11]+_i*s[9],Ml=Tr*s[0]+Nc*s[1]+rt*s[2]+Pt*s[12]+Hs*s[10]+To*s[4]+An*s[6]+De*s[3]+sl*s[5]+rs*s[7]+na*s[8]+ad*s[11]+Ei*s[9],Ll=mr*s[0]+Oc*s[1]+st*s[2]+Mt*s[12]+Fs*s[10]+mo*s[4]+fn*s[6]+ze*s[3]+ll*s[5]+ss*s[7]+aa*s[8]+td*s[11]+bi*s[9],console.log(Ll,Ml,zl),
Hr=br*n[0]*Ba[0]+Mc*n[1]*Ya[0]+ct*n[2]*ba[0]+Ct*n[12]+js*n[10]+bo*n[4]*Ia[0]+wn*n[6]*Sa[0]+Ue*n[3]*pa[0]+rl*n[5]*Na[0]+cs*n[7]*za[0]+ia*n[8]*fa[0]+nd*n[11]+_i*n[9],qr=Tr*i[0]*Ba[0]+Nc*i[1]*Ya[0]+rt*i[2]*ba[0]+Pt*i[12]+Hs*i[10]+To*i[4]*Ia[0]+An*i[6]*Sa[0]+De*i[3]*pa[0]+sl*i[5]*Na[0]+rs*i[7]*za[0]+na*i[8]*fa[0]+ad*i[11]+Ei*i[9],Br=mr*o[0]*Ba[0]+Oc*o[1]*Ya[0]+st*o[2]*ba[0]+Mt*o[12]+Fs*o[10]+mo*o[4]*Ia[0]+fn*o[6]*Sa[0]+ze*o[3]*pa[0]+ll*o[5]*Na[0]+ss*o[7]*za[0]+aa*o[8]*fa[0]+td*o[11]+bi*o[9],_s=Hl*l[7]*Ri[1]+Vt*l[8]*Ai[1]+Gc*l[11]+ti*l[9],'cav'==Hi?(Pr=Ji*l[4]*vi[1]+on*l[6]*wi[1]+_s,Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10],Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]):'inf'==Hi?(Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10]+_s,Pr=Ji*l[4]*vi[1]+on*l[6]*wi[1],Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]):'arc'==Hi?(Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10],Pr=Ji*l[4]*vi[1]+on*l[6]*wi[1],
Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]+_s):(Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10],Pr=Ji*l[4]*vi[1]+on*l[6]*wi[1],Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]),Ir=(Rr=Dr*ml)+(wr=Pr*ml)+(hr=Or*ml),ic=(tc=Hr*gl)+(Jr=qr*gl)+(Qr=Br*gl),console.log(ic,Ir),Gi=0==Rr||0==tc?0:tc<=Rr?1:Math.pow(Rr/tc,.5)/(tc/Rr),Ui=0==wr||0==Jr?0:Jr<=wr?1:Math.pow(wr/Jr,.5)/(Jr/wr),Di=0==hr||0==Qr?0:Qr<=hr?1:Math.pow(hr/Qr,.5)/(Qr/hr),zi=0==Rr||0==tc?0:Rr<=tc?1:Math.pow(tc/Rr,.5)/(Rr/tc),Ci=0==wr||0==Jr?0:wr<=Jr?1:Math.pow(Jr/wr,.5)/(wr/Jr),Pi=0==hr||0==Qr?0:hr<=Qr?1:Math.pow(Qr/hr,.5)/(hr/Qr),Hn=Math.round(1e6*zi)/1e6,Fn=Math.round(1e6*Ci)/1e6,Yn=Math.round(1e6*Pi)/1e6,Qn=Math.round(1e6*Gi)/1e6,Kn=Math.round(1e6*Ui)/1e6,jn=Math.round(1e6*Di)/1e6,ir=Math.round(-br*Qn+1e-6)+Math.round(-Tr*Kn+1e-6)+Math.round(-mr*jn+1e-6),Ac=Math.round(-Mc*Qn+1e-6)+Math.round(-Nc*Kn+1e-6)+Math.round(-Oc*jn+1e-6),Ze=Math.round(-ct*Qn+1e-6)+Math.round(-rt*Kn+1e-6)+Math.round(-st*jn+1e-6),
ye=Math.round(-Ue*Qn+1e-6)+Math.round(-De*Kn+1e-6)+Math.round(-ze*jn+1e-6),no=Math.round(-bo*Qn+1e-6)+Math.round(-To*Kn+1e-6)+Math.round(-mo*jn+1e-6),Xo=Math.round(-rl*Qn+1e-6)+Math.round(-sl*Kn+1e-6)+Math.round(-ll*jn+1e-6),dn=Math.round(-wn*Qn+1e-6)+Math.round(-An*Kn+1e-6)+Math.round(-fn*jn+1e-6),Zl=Math.round(-cs*Qn+1e-6)+Math.round(-rs*Kn+1e-6)+Math.round(-ss*jn+1e-6),Ht=Math.round(-ia*Qn+1e-6)+Math.round(-na*Kn+1e-6)+Math.round(-aa*jn+1e-6),Fc=Math.round(-nd*Qn+1e-6)+Math.round(-ad*Kn+1e-6)+Math.round(-td*jn+1e-6),vt=Math.round(-Ct*Qn+1e-6)+Math.round(-Pt*Kn+1e-6)+Math.round(-Mt*jn+1e-6),li=Math.round(-_i*Qn+1e-6)+Math.round(-Ei*Kn+1e-6)+Math.round(-bi*jn+1e-6),Cs=Math.round(-js*Qn+1e-6)+Math.round(-Hs*Kn+1e-6)+Math.round(-Fs*jn+1e-6),Zs=Math.round(-$s*Hn+1e-6),mc=Math.round(-bc*Hn+1e-6),Ye=Math.round(-He*Hn+1e-6),bt=Math.round(-_t*Hn+1e-6),he=Math.round(-Ae*Yn+1e-6),qo=Math.round(-Fo*Yn+1e-6),Xi=Math.round(-Ji*Fn+1e-6),an=Math.round(-on*Fn+1e-6),
'cav'==Hi?(Yl=Math.round(-Hl*Fn+1e-6),Gt=Math.round(-Vt*Fn+1e-6),Dc=Math.round(-Gc*Fn+1e-6),$n=Math.round(-ti*Fn+1e-6)):'inf'==Hi?(Yl=Math.round(-Hl*Hn+1e-6),Gt=Math.round(-Vt*Hn+1e-6),Dc=Math.round(-Gc*Hn+1e-6),$n=Math.round(-ti*Hn+1e-6)):'arc'==Hi&&(Yl=Math.round(-Hl*Yn+1e-6),Gt=Math.round(-Vt*Yn+1e-6),Dc=Math.round(-Gc*Yn+1e-6),$n=Math.round(-ti*Yn+1e-6)),Is=100*Ls==Sl?0:Math.round(-Ls*Hn+1e-6),er=$s+Zs,Ec=bc+mc,je=He+Ye,we=Ae+he,$i=Ji+Xi,Ho=Fo+qo,ln=on+an,jl=Hl+Yl,Wt=Vt+Gt,Bc=Gc+Dc,ht=_t+bt,Os=Ls+Is,ai=ti+$n,gr=cr+ir,Lc=yc+Ac,lt=at+Ze,Ce=Oe+ye,go=ro+no,ol=tl+Xo,hn=Tn+dn,ls=as+Zl,ta=Zt+Ht,ed=Xc+Fc,Nt=It+vt,Ys=Bs+Cs,Ti=ui+li,So=Zs*s[0]+mc*s[1]+Ye*s[2]+he*s[3]+Xi*s[4]+qo*s[5]+an*s[6]+Yl*s[7]+Gt*s[8]+$n*s[9]+Is*s[10]+Dc*s[11]+bt*s[12],ko=ir*s[0]+Ac*s[1]+Ze*s[2]+ye*s[3]+no*s[4]+Xo*s[5]+dn*s[6]+Zl*s[7]+Ht*s[8]+li*s[9]+Cs*s[10]+Fc*s[11]+vt*s[12],console.log(So,ko),sc=er*s[0]+Ec*s[1]+je*s[2]+we*s[3]+$i*s[4]+Ho*s[5]+ln*s[6]+jl*s[7]+Wt*s[8]+Bc*s[11]+ht*s[12]+Os*s[10]+ai*s[9],
dc=gr*s[0]+Lc*s[1]+lt*s[2]+Ce*s[3]+go*s[4]+ol*s[5]+hn*s[6]+ls*s[7]+ta*s[8]+ed*s[11]+Nt*s[12]+Ys*s[10]+Ti*s[9],console.log(sc,dc),Ks=-N+er,uc=-P+Ec,Ve=-d+je,B=-r+we,ji=-w+$i,Bo=-R+Ho,$a=-E+ln,Vl=-I+jl,zt=-m+Wt,Pc=-z+Bc,gt=-p+ht,Rs=-L+Os,Xn=-h+ai,tr=-M+gr,_c=-C+Lc,Ke=-u+lt,ve=-c+Ce,eo=-v+go,jo=-y+ol,sn=-_+hn,Kl=-x+ls,qt=-T+ta,Wc=-D+ed,ft=-g+Nt,Ns=-O+Ys,ni=-f+Ti,gs=0==jl?0:jl*ml*On[1],Rn=20==ld?18:19==ld?17:18==ld?15:17==ld?14:16==ld?13:15==ld?11:14==ld?10:13==ld||12==ld?9:11==ld?8:10==ld?7:9==ld||8==ld?6:7==ld||6==ld?5:5==ld||4==ld||3==ld?4:2==ld||1==ld?3:0,ds=0==ut?0:2*Rn,us=0==gs||0==ds?0:-gs/ds,Ja=ld<=Ss?ld:ld-Ss<-us?ld<Ss?ld:Ss:ld+us,G=Math.round(Ja),b='wall'==ca?G:parseInt(document.getElementById('buildingLevel').value),sa=0==Wt||0==b?0:Wt*ml*Ai[1],
...
return null},xe.getLcaRevived=function(){return ie},xe.getLcaSurvived=function(){return null},xe.getMaaAmount=function(){return null},xe.getMaaLosses=function(){return null},xe.getMaaRevived=function(){return oe},xe.getMaaSurvived=function(){return null},xe.getHcaAmount=function(){return null},xe.getHcaLosses=function(){return null},xe.getHcaRevived=function(){return le},xe.getHcaSurvived=function(){return null},xe.getBerserkeraAmount=function(){return null},xe.getBerserkeraLosses=function(){return null},xe.getBerserkeraRevived=function(){return se},xe.getBerserkeraSurvived=function(){return null},xe})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
...
const t=new Date(e||_.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),n=_.zerofill(a-a%100,3),i=_.zerofill(t.getSeconds(),2),l=_.zerofill(t.getMinutes(),2);return _.zerofill(t.getHours(),2)+':'+l+':'+i+':'+n+' '+_.zerofill(t.getDate(),2)+'/'+_.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),q(e+=t)):''},F=function(){if(A.isValidDate=o.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!A.isValidDate&&o.getTimeFromString(R.date),t=A.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(G,(function(n,i){const l=o.getTravelTime(R.origin,R.target,n,a,R.officers,!0);A.travelTimes[a][i].travelTime=g('readableMillisecondsFilter')(l),A.travelTimes[a][i].status=e?H(t?e-l:e):'neutral'}))}))},H=function(e){return e&&A.isValidDate?_.gameTime()+M<e?'valid':'invalid':'neutral'},j=function(){R.dateType=A.selectedDateType.value,f.set(m.LAST_DATE_TYPE,A.selectedDateType.value),F()},K=function(){
...
A.$watch('selectedTab',(function(){A.selectedTab===O.ADD?T=setInterval((function(){F()}),2500):clearInterval(T)})),A.waitingCommands.forEach(e=>{X(e)});let b=new n('twoverflow_queue_window',(function(){clearInterval(T),Ee.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,Ee.updatePresets,!0),b.register(s.SELECT_SELECTED,Ee.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,Ee.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,Ee.sendCommand),b.register(s.COMMAND_QUEUE_START,Ee.start),b.register(s.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',A)};return function(){v=i.getSelectedCharacter(),M=o.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){D[e]=0})),I.forEach((function(e){U[e]=!1})),R={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(U),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},C={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',10),w.addEventListener('click',_e),b.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,W),
...
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),N=()=>new Promise((e,i)=>{c=!1,p=L.getVillageList();const o=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),_e(u,c,o))return i(n.BUSY_TARGET);o&&(m=!0),e()}),M=()=>new Promise((e,t)=>{if(!u&&!c)return e();const i=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(f.gameTime()/1e3),l=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),T=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,T,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const i=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=i.some(e=>e.start_village_id!==this.villageId),l=i.some(e=>e.start_village_id===this.villageId);if(_e(l,o,!0))return t(n.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{b().then(_).then(S).then(y).then(k).then(x).then(O).then(N).then(M).then(P).then(e).catch(t)}),D=new Promise((e,t)=>{H=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([C,D]).then(()=>{if(!this.running)return!1
...
;if(Y.isNAP(e.tribe_id))return q.friendly}}return q.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||we(n);if(!i)continue;const o=n.x*R+(n.y%2?k:0),l=n.y*R;C.fillStyle=i,C.fillRect(o,l,S,S)}},Se=function(){S=oe[H[o.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,P.width=1e3*R,P.height=1e3*R,C.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,M.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,n=O,b.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(H[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id},f.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({
...
},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(A.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(A.PLAYER_COLORS)||{},Ee()},Me=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?A.PLAYER_COLORS:A.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t];const n='character'===e?A.PLAYER_COLORS:A.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e]),
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=H[o.COLOR_BACKGROUND],M=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),n=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return F},Pe.drawMinimap=function(){ge&&(ge=!1),N.style.background=H[o.COLOR_BACKGROUND],C.clearRect(0,0,P.width,P.height),d((function(){!function(){
const e=h.getPath(w.getMapPath()),t=H[o.SHOW_CONTINENT_DEMARCATIONS],a=H[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){C.fillStyle=H[o.COLOR_CONTINENT],C.fillRect(e*R+k-1,t*R+k-1,3,1),C.fillRect(e*R+k,t*R+k-2,1,3)},i=function(e,t){C.fillStyle=H[o.COLOR_PROVINCE],C.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=_.toTile(o,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&i(e,l))}const r=l.a*R,c=s.a*R,d=(l.b-l.a)*R,u=(s.b-s.a)*R;C.beginPath(),C.lineWidth=2,C.strokeStyle="#2B4700",C.rect(r,c,d,u),C.stroke()}))}(),Ee()}),'minimap_data')},Pe.enableRendering=function(){j=!0},Pe.disableRendering=function(){j=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),C=P.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ie}),F.onChange((function(e,t){H=F.getAll(),
Se(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),H=F.getAll(),K.tribe=le.getCustomColorsByGroup(A.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(A.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){G=document.getElementById('map'),U=document.getElementById('main-canvas'),B=i.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),q=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),Re(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*R,ee.y=x.getY()*R,e.addEventListener('resize',Re,!1),z.addEventListener('mousedown',ye),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),_e(),a.$on(s.VILLAGE_SELECTED_CHANGED,Me),a.$on(s.TRIBE_RELATION_CHANGED,Ee),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,T,b,E,_,h,f,A){let w,v,S,R,y,k,I,x,L,O,N,M={},P=!1,C={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,U=function(e){w.selectedTab=e,e===z.MINIMAP?i.enableRendering():i.disableRendering()},G=function(){Object.keys(w.highlights.character).forEach((function(e){e in C.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
let d,u,p=!1,g=!1,m=[],T=[],b=[],E=[],_=[],h=[],f=[],A=[],w=[],v=[],S=[],R=[],y=[],k=[],I=[],x=[],L=[],O=[],N=[],M=[],P=[],C=[],z=[],D=[],U=[],G=[],B=[],V=[],W=[],q=[],Y=[],F=[];const H='recruit_queue_settings',j={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(j);const K=function(){m=[],T=[],b=[],E=[],_=[],h=[],f=[],A=[];const e=i.getPresetList().getPresets(),a=u[t.PRESET1],n=u[t.PRESET2],o=u[t.PRESET3],l=u[t.PRESET4],s=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){T.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){E.push(e[t])})),s.forEach((function(t){_.push(e[t])})),r.forEach((function(t){
h.push(e[t])})),c.forEach((function(t){f.push(e[t])})),d.forEach((function(t){A.push(e[t])}))},Q=function(){w=[],v=[],S=[],R=[],y=[],k=[],I=[],x=[],L=[],O=[],N=[],M=[],P=[],C=[],z=[],D=[],U=[],G=[],B=[],V=[],W=[],q=[],Y=[],F=[];const e=i.getGroupList().getGroups(),a=u[t.GROUP1],n=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4],s=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],b=u[t.GROUP13],E=u[t.GROUP14],_=u[t.GROUP15],h=u[t.GROUP16],f=u[t.GROUP17],A=u[t.GROUP18],H=u[t.GROUP19],j=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){w.push(e[t])})),n.forEach((function(t){v.push(e[t])})),o.forEach((function(t){S.push(e[t])})),l.forEach((function(t){R.push(e[t])})),s.forEach((function(t){y.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){x.push(e[t])})),p.forEach((function(t){L.push(e[t])})),g.forEach((function(t){
O.push(e[t])})),m.forEach((function(t){N.push(e[t])})),T.forEach((function(t){M.push(e[t])})),b.forEach((function(t){P.push(e[t])})),E.forEach((function(t){C.push(e[t])})),_.forEach((function(t){z.push(e[t])})),h.forEach((function(t){D.push(e[t])})),f.forEach((function(t){U.push(e[t])})),A.forEach((function(t){G.push(e[t])})),H.forEach((function(t){B.push(e[t])})),j.forEach((function(t){V.push(e[t])})),K.forEach((function(t){W.push(e[t])})),Q.forEach((function(t){q.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:n,storageKey:H}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('recruitQueue settings',u),r((function(){K()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,K),a.$on(s.ARMY_PRESET_DELETED,K),a.$on(s.GROUPS_CREATED,Q),a.$on(s.GROUPS_DESTROYED,Q),a.$on(s.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(s.recruit_queue_START)},stop:function(){
...
offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},E))})),setTimeout(m,3e4)},T=function(e){var t,i,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,T=g(m),b=e.ReportScouting,E=b.attCharacterId,_=b.attCharacterName,h=b.attScouts,f=b.attLosses,A=b.attVillageId,w=b.attVillageName,v=b.defCharacterId,S=b.defCharacterName,R=b.defLosses,y=b.defScouts,k=b.defVillageId,I=b.defVillageName,x=b.commandType,L='',O='',N='',M='',P=Date.now(),C=p.split('.').join('_');2==u?L=' [color=d96a19]Częściowy sukces[/color]':1==u?L=' [color=0a8028]Sukces[/color]':3==u&&(L=' [color=e21f1f]Porażka[/color]'),
O='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',i=null==y?'nieznana':y,s=null==h?'nieznana':h,r=null==R?'nieznana':R,c=null==f?'nieznana':f,M=null==_&&null==E?'Brak danych':'[player='+E+']'+_+'[/player]',N=null==w&&null==A?'Brak danych':'[village='+A+']'+w+'[/village]',t=Math.floor(P/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+C+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+I+'[/village][b] Gracz cel: [/b][player='+v+']'+S+'[/player][br]Liczba szpiegów: [b]'+i+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+M+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();v!=a?t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),
