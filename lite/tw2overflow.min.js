...
let f,A,w=!1,v=!1,S=[],R=null,y=null,k=null,I=null,x=null,L=null,O=null,N=null,M=null,P=null,C=null,z=null,D=null,U=null,G=null,B=null,V=null,W=null,q=null,Y=null,F=null,H=null,j=null,K=null,Q=null,X=null,Z=null,J=null,$=null,ee=null,te=null,ae=null,ne=null,ie=null,le=null,oe=null,se=null,re=null,ce=null,de=null,ue=null,pe=null,ge=null,me=null,be=null,Te=null,_e=null;const Ee='battle_calculator_settings',he={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},fe={[o.HALBERD_OF_GUAN_YU]:'spear',[o.PARACELSUS_LONGSWORD]:'sword',[o.THORGARDS_BATTLE_AXE]:'axe',[o.NIMRODS_LONGBOW]:'archer',[o.MIESZKOS_LANCE]:'lc',[o.NIMRODS_COMPOSITE_BOW]:'ma',[o.BAPTISTES_BANNER]:'hc',[o.CAROLS_MORNING_STAR]:'ram',[o.ALETHEIAS_BONFIRE]:'catapult',[o.VASCOS_SCEPTER]:'snob'},Ae={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',
[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},we={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},ve={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},Se={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},Re={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},ye={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},ke={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,
[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3};console.log(ke,ye,Re,Se,ve,we,he,fe,Ae);const Ie=function(){S=[];const e=i.getPresetList().getPresets();A[t.PRESET].forEach((function(t){S.push(e[t])}))},xe={init:function(){w=!0,f=new e({settingsMap:n,storageKey:Ee}),f.onChange((function(e,t){A=f.getAll(),t[l.PRESETS]&&Ie()})),A=f.getAll(),console.log('battleCalculator settings',A),E((function(){Ie()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,Ie),a.$on(s.ARMY_PRESET_DELETED,Ie)},calculateB:function(){const e=A[t.BASHPOINTS_SPEAR],a=A[t.BASHPOINTS_SWORD],n=A[t.BASHPOINTS_AXE],i=A[t.BASHPOINTS_ARCHER],l=A[t.BASHPOINTS_LC],o=A[t.BASHPOINTS_MA],s=A[t.BASHPOINTS_HC],r=A[t.BASHPOINTS_RAM],c=A[t.BASHPOINTS_CATAPULT],d=A[t.BASHPOINTS_DOPPELSOLDNER],u=A[t.BASHPOINTS_TREBUCHET],p=A[t.BASHPOINTS_SNOB],g=A[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],b=[4,5,1,5,5,6,23,4,12,40,200,25,10];R=e*m[0]+a*m[1]+n*m[2]+i*m[3]+l*m[4]+o*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],
y=e*b[0]+a*b[1]+n*b[2]+i*b[3]+l*b[4]+o*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+p*b[10]+u*b[11]+d*b[12]}};return xe.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],l=[10,30,10,60,30,50,180,20,100,150,100,200,50],o=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=A[t.BATTLE_ARCHER_A],c=A[t.BATTLE_ARCHER_D],d=A[t.BATTLE_AXE_A],u=A[t.BATTLE_AXE_D],p=A[t.BATTLE_DOPPELSOLDNER_A],g=A[t.BATTLE_DOPPELSOLDNER_D],m=A[t.BATTLE_CATAPULT_A],b=A[t.BATTLE_CATAPULT_D],T=A[t.BATTLE_TARGET_LEVEL],_=A[t.BATTLE_HC_A],E=A[t.BATTLE_HC_D],h=A[t.BATTLE_KNIGHT_A],f=A[t.BATTLE_KNIGHT_D],w=A[t.BATTLE_LC_A],v=A[t.BATTLE_LC_D],S=A[t.BATTLE_LUCK],R=A[t.BATTLE_MA_A],y=A[t.BATTLE_MA_D],k=A[t.BATTLE_MORALE],I=A[t.BATTLE_RAM_A],x=A[t.BATTLE_RAM_D],L=A[t.BATTLE_SNOB_A],O=A[t.BATTLE_SNOB_D],N=A[t.BATTLE_SPEAR_A],M=A[t.BATTLE_SPEAR_D],P=A[t.BATTLE_SWORD_A],C=A[t.BATTLE_SWORD_D],z=A[t.BATTLE_TREBUCHET_A],D=A[t.BATTLE_TREBUCHET_D],U=0,G=0,B=0,V=0,Ee=0,he=0,fe=0,Ae=0,we=0,ve=0,Se=0,Re=0,ye=0,ke=0,Ie=0,xe=0,Le=0,Oe=0,Ne=0,Me=0,Pe=0,Ce=0,ze=0,De=0,Ue=0,Ge=0,Be=0,Ve=0,We=0,qe=0,Ye=0,Fe=0,He=0,je=0,Ke=0,Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,lt=0,ot=0,st=0,rt=0,ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,bt=0,Tt=0,_t=0,Et=0,ht=0,ft=0,At=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,It=0,xt=0,Lt=0,Ot=0,Nt=0,Mt=0,Pt=0,Ct=0,zt=0,Dt=0,Ut=0,Gt=0,Bt=0,Vt=0,Wt=0,qt=0,Yt=0,Ft=0,Ht=0,jt=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,la=0,oa=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=[1,1],ga=[1,1],ma=[1,1],ba=[1,1],Ta=[1,1],_a=[1,1],Ea=[1,1],ha=[1,1],fa=[1,1],Aa=[1,1],wa=[1,1],va=[1,1],Sa=[1,1],Ra=[1,1],ya=[1,1],ka=[1,1],Ia=[1,1],xa=[1,1],La=[1,1],Oa=[1,1],Na=[1,1],Ma=[1,1],Pa=[1,1],Ca=[1,1],za=[1,1],Da=[1,1],Ua=[1,1],Ga=[1,1],Ba=[1,1],Va=[1,1],Wa=[1,1],qa=[1,1],Ya=[1,1],Fa=[1,1],Ha=[1,1],ja=[1,1],Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,ln=0,on=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,bn=0,Tn=0,_n=0,En=0,hn=0,fn=0,An=0,wn=0,vn=0,Sn=0,Rn=0,yn=0,kn=0,In=0,xn=0,Ln=0,On=[1,1],Nn=0,Mn=0,Pn=0,Cn=0,zn=0,Dn=0,Un=0,Gn=0,Bn=0,Vn=0,Wn=0,qn=0,Yn=0,Fn=0,Hn=0,jn=0,Kn=0,Qn=0,Xn=0,Zn=0,Jn=0,$n=0,ei=0,ti=0,ai=0,ni=0,ii=0,li=0,oi=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,bi=0,Ti=0,_i=0,Ei=0,hi=[1,1],fi=[1,1],Ai=[1,1],wi=[1,1],vi=[1,1],Si=[1,1],Ri=[1,1],yi=[1,1],ki=[1,1],Ii=0,xi=0,Li=0,Oi=0,Ni=0,Mi=0,Pi=0,Ci=0,zi=0,Di=0,Ui=0,Gi=0,Bi=0,Vi=0,Wi=0,qi=0,Yi=0,Fi=0,Hi=0,ji=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,el=0,tl=0,al=0,nl=0,il=0,ll=0,ol=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,bl=0,Tl=0,_l=0,El=0,hl=0,fl=0,Al=0,wl=0,vl=0,Sl=0,Rl=0,yl=0,kl=0,Il=0,xl=0,Ll=0,Ol=0,Nl=0,Ml=0,Pl=0,Cl=0,zl=0,Dl=0,Ul=0,Gl=0,Bl=0,Vl=0,Wl=0,ql=0,Yl=0,Fl=0,Hl=0,jl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,eo=0,to=0,ao=0,no=0,io=0,lo=0,oo=0,so=0,ro=0,co=0,uo=1,po=0,go=0,mo=0,bo=0,To=0,_o=0,Eo=0,ho=0,fo=0,Ao=0,wo=0,vo=0,So=0,Ro=0,yo=0,ko=0,Io=0,xo=0,Lo=0,Oo=0,No=0,Mo=0,Po=0,Co=0,zo=0,Do=0,Uo=0,Go=0,Bo=0,Vo=0,Wo=0,qo=0,Yo=0,Fo=0,Ho=0,jo=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,es=0,ts=0,as=0,ns=0,is=0,ls=0,os=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,bs=0,Ts=0,_s=0,Es=0,hs=0,fs=0,As=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Is=0,xs=0,Ls=0,Os=0,Ns=0,Ms=0,Ps=0,Cs=0,zs=0,Ds=0,Us=0,Gs=0,Bs=0,Vs=0,Ws=0,qs=0,Ys=0,Fs=0,Hs=0,js=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,lr=0,or=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,br=0,Tr=0,_r=0,Er=0,hr=0,fr=0,Ar=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Ir=0,xr=0,Lr=0,Or=0,Nr=0,Mr=0,Pr=0,Cr=0,zr=0,Dr=0,Ur=0,Gr=0,Br=0,Vr=0,Wr=0,qr=0,Yr=0,Fr=0,Hr=0,jr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,lc=0,oc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,bc=0,Tc=0,_c=0,Ec=0,hc=0,fc=0,Ac=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Ic=0,xc=0,Lc=0,Oc=0,Nc=0,Mc=0,Pc=0,Cc=0,zc=0,Dc=0,Uc=0,Gc=0,Bc=0,Vc=0,Wc=0,qc=0,Yc=0,Fc=0,Hc=0,jc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,ld=0,od=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,bd=0
;Qa=A[t.BATTLE_CHURCH_A],md='level_1'==Qa?100:'level_2'==Qa?105:'level_3'==Qa?110:50,bd='level_1'==(Xa=A[t.BATTLE_CHURCH_D])?100:'level_2'==Xa?105:'level_3'==Xa?110:50,uo=A[t.BATTLE_NIGHT_BONUS]?2:1,Tl=A[t.BATTLE_OFFICER_LEADER]?.1:0,ro=A[t.BATTLE_OFFICER_MEDIC]?.1:0,vs=A[t.BATTLE_SKILL_MEDIC]?.1:0,function(){const Qa=A[t.BATTLE_SKILL_WEAPON_MASTER];As='level_1'==Qa?2:'level_2'==Qa?4:'level_3'==Qa?6:'level_4'==Qa?8:'level_5'==Qa?10:0,function(){const Qa=A[t.BATTLE_SKILL_IRON_WALLS];Ss='level_1'==Qa?1:'level_2'==Qa?2:'level_3'==Qa?3:'level_4'==Qa?4:'level_5'==Qa?5:0,function(){const Qa=A[t.BATTLE_SKILL_CLINIQUE];ws='level_1'==Qa?100:'level_2'==Qa?200:'level_3'==Qa?300:'level_4'==Qa?400:'level_5'==Qa?500:'level_6'==Qa?600:'level_7'==Qa?700:'level_8'==Qa?800:'level_9'==Qa?900:'level_10'==Qa?1e3:0,function(){const Qa=A[t.BATTLE_HOSPITAL];var Xa
;yn='level_1'==Qa?100:'level_2'==Qa?129:'level_3'==Qa?167:'level_4'==Qa?215:'level_5'==Qa?278:'level_6'==Qa?359:'level_7'==Qa?464:'level_8'==Qa?599:'level_9'==Qa?774:'level_10'==Qa?1e3:0,Xa=A[t.BATTLE_WALL],U='level_1'==Xa?1:'level_2'==Xa?2:'level_3'==Xa?3:'level_4'==Xa?4:'level_5'==Xa?5:'level_6'==Xa?6:'level_7'==Xa?7:'level_8'==Xa?8:'level_9'==Xa?9:'level_10'==Xa?10:'level_11'==Xa?11:'level_12'==Xa?12:'level_13'==Xa?13:'level_14'==Xa?14:'level_15'==Xa?15:'level_16'==Xa?16:'level_17'==Xa?17:'level_18'==Xa?18:'level_19'==Xa?19:'level_20'==Xa?20:0,ca=A[t.BATTLE_CATAPULT_TARGET],ce=A[t.BATTLE_CATAPULT_TARGET],kn=A[t.BATTLE_KNIGHT_ITEM_D1],In=A[t.BATTLE_KNIGHT_ITEM_D2],xn=A[t.BATTLE_KNIGHT_ITEM_D3],Ln=A[t.BATTLE_KNIGHT_ITEM_A],_l=A[t.BATTLE_ITEM_LEVEL_D1],El=A[t.BATTLE_ITEM_LEVEL_D2],hl=A[t.BATTLE_ITEM_LEVEL_D3],fl=A[t.BATTLE_ITEM_LEVEL_A],_a='battle.battleaxe'==kn&'level_1'==_l?[1.05,1.1]:'battle.battleaxe'==kn&'level_2'==_l?[1.1,1.2]:'battle.battleaxe'==kn&'level_3'==_l?[1.2,1.3]:[1,1],
Ma='battle.compositebow'==kn&'level_1'==_l?[1.05,1.1]:'battle.compositebow'==kn&'level_2'==_l?[1.1,1.2]:'battle.compositebow'==kn&'level_3'==_l?[1.2,1.3]:[1,1],Va='battle.halberd'==kn&'level_1'==_l?[1.1,1.05]:'battle.halberd'==kn&'level_2'==_l?[1.2,1.1]:'battle.halberd'==kn&'level_3'==_l?[1.3,1.2]:[1,1],Fa='battle.longsword'==kn&'level_1'==_l?[1.1,1.05]:'battle.longsword'==kn&'level_2'==_l?[1.2,1.1]:'battle.longsword'==kn&'level_3'==_l?[1.3,1.2]:[1,1],ga='battle.longbow'==kn&'level_1'==_l?[1.1,1.05]:'battle.longbow'==kn&'level_2'==_l?[1.2,1.1]:'battle.longbow'==kn&'level_3'==_l?[1.3,1.2]:[1,1],Ra='battle.banner'==kn&'level_1'==_l?[1.1,1.1]:'battle.banner'==kn&'level_2'==_l?[1.2,1.2]:'battle.banner'==kn&'level_3'==_l?[1.3,1.3]:[1,1],Da='battle.star'==kn&'level_1'==_l?[1.05,1.25]:'battle.star'==kn&'level_2'==_l?[1.1,1.5]:'battle.star'==kn&'level_3'==_l?[1.2,2]:[1,1],
Aa='battle.bonfire'==kn&'level_1'==_l?[1.05,1.25]:'battle.bonfire'==kn&'level_2'==_l?[1.1,1.5]:'battle.bonfire'==kn&'level_3'==_l?[1.2,2]:[1,1],Ea='battle.battleaxe'==In&'level_1'==El?[1.05,1.1]:'battle.battleaxe'==In&'level_2'==El?[1.1,1.2]:'battle.battleaxe'==In&'level_3'==El?[1.2,1.3]:[1,1],Pa='battle.compositebow'==In&'level_1'==El?[1.05,1.1]:'battle.compositebow'==In&'level_2'==El?[1.1,1.2]:'battle.compositebow'==In&'level_3'==El?[1.2,1.3]:[1,1],Wa='battle.halberd'==In&'level_1'==El?[1.1,1.05]:'battle.halberd'==In&'level_2'==El?[1.2,1.1]:'battle.halberd'==In&'level_3'==El?[1.3,1.2]:[1,1],Ha='battle.longsword'==In&'level_1'==El?[1.1,1.05]:'battle.longsword'==In&'level_2'==El?[1.2,1.1]:'battle.longsword'==In&'level_3'==El?[1.3,1.2]:[1,1],ma='battle.longbow'==In&'level_1'==El?[1.1,1.05]:'battle.longbow'==In&'level_2'==El?[1.2,1.1]:'battle.longbow'==In&'level_3'==El?[1.3,1.2]:[1,1],
ya='battle.banner'==In&'level_1'==El?[1.1,1.1]:'battle.banner'==In&'level_2'==El?[1.2,1.2]:'battle.banner'==In&'level_3'==El?[1.3,1.3]:[1,1],Ua='battle.star'==In&'level_1'==El?[1.05,1.25]:'battle.star'==In&'level_2'==El?[1.1,1.5]:'battle.star'==In&'level_3'==El?[1.2,2]:[1,1],wa='battle.bonfire'==In&'level_1'==El?[1.05,1.25]:'battle.bonfire'==In&'level_2'==El?[1.1,1.5]:'battle.bonfire'==In&'level_3'==El?[1.2,2]:[1,1],Oa='battle.lance'==xn&'level_1'==hl?[1.05,1.1]:'battle.lance'==xn&'level_2'==hl?[1.1,1.2]:'battle.lance'==xn&'level_3'==hl?[1.2,1.3]:[1,1],ha='battle.battleaxe'==xn&'level_1'==hl?[1.05,1.1]:'battle.battleaxe'==xn&'level_2'==hl?[1.1,1.2]:'battle.battleaxe'==xn&'level_3'==hl?[1.2,1.3]:[1,1],Ca='battle.compositebow'==xn&'level_1'==hl?[1.05,1.1]:'battle.compositebow'==xn&'level_2'==hl?[1.1,1.2]:'battle.compositebow'==xn&'level_3'==hl?[1.2,1.3]:[1,1],
qa='battle.halberd'==xn&'level_1'==hl?[1.1,1.05]:'battle.halberd'==xn&'level_2'==hl?[1.2,1.1]:'battle.halberd'==xn&'level_3'==hl?[1.3,1.2]:[1,1],ja='battle.longsword'==xn&'level_1'==hl?[1.1,1.05]:'battle.longsword'==xn&'level_2'==hl?[1.2,1.1]:'battle.longsword'==xn&'level_3'==hl?[1.3,1.2]:[1,1],ba='battle.longbow'==xn&'level_1'==hl?[1.1,1.05]:'battle.longbow'==xn&'level_2'==hl?[1.2,1.1]:'battle.longbow'==xn&'level_3'==hl?[1.3,1.2]:[1,1],ka='battle.banner'==xn&'level_1'==hl?[1.1,1.1]:'battle.banner'==xn&'level_2'==hl?[1.2,1.2]:'battle.banner'==xn&'level_3'==hl?[1.3,1.3]:[1,1],Ga='battle.star'==xn&'level_1'==hl?[1.05,1.25]:'battle.star'==xn&'level_2'==hl?[1.1,1.5]:'battle.star'==xn&'level_3'==hl?[1.2,2]:[1,1],va='battle.bonfire'==xn&'level_1'==hl?[1.05,1.25]:'battle.bonfire'==xn&'level_2'==hl?[1.1,1.5]:'battle.bonfire'==xn&'level_3'==hl?[1.2,2]:[1,1],
Ia=(xa='battle.lance'==kn&'level_1'==_l?[1.05,1.1]:'battle.lance'==kn&'level_2'==_l?[1.1,1.2]:'battle.lance'==kn&'level_3'==_l?[1.2,1.3]:[1,1])[0]>=(La='battle.lance'==In&'level_1'==El?[1.05,1.1]:'battle.lance'==In&'level_2'==El?[1.1,1.2]:'battle.lance'==In&'level_3'==El?[1.2,1.3]:[1,1])[0]&&xa[0]>=Oa[0]?xa:La[0]>=xa[0]&&La[0]>=Oa[0]?La:Oa[0]>=xa[0]&&Oa[0]>=La[0]?Oa:[1,1],Ta=_a[0]>=Ea[0]&&_a[0]>=ha[0]?_a:Ea[0]>=_a[0]&&Ea[0]>=ha[0]?Ea:ha[0]>=_a[0]&&ha[0]>=Ea[0]?ha:[1,1],Na=Ma[0]>=Pa[0]&&Ma[0]>=Ca[0]?Ma:Pa[0]>=Ma[0]&&Pa[0]>=Ca[0]?Pa:Ca[0]>=Ma[0]&&Ca[0]>=Pa[0]?Ca:[1,1],Sa=Ra[0]>=ya[0]&&Ra[0]>=ka[0]?Ra:ya[0]>=Ra[0]&&ya[0]>=ka[0]?ya:ka[0]>=Ra[0]&&ka[0]>=ya[0]?ka:[1,1],za=Da[0]>=Ua[0]&&Da[0]>=Ga[0]?Da:Ua[0]>=Da[0]&&Ua[0]>=Ga[0]?Ua:Ga[0]>=Da[0]&&Ga[0]>=Ua[0]?Ga:[1,1],fa=Aa[0]>=wa[0]&&Aa[0]>=va[0]?Aa:wa[0]>=Aa[0]&&wa[0]>=va[0]?wa:va[0]>=Aa[0]&&va[0]>=wa[0]?va:[1,1],Ba=Va[0]>=Wa[0]&&Va[0]>=qa[0]?Va:Wa[0]>=Va[0]&&Wa[0]>=qa[0]?Wa:qa[0]>=Va[0]&&qa[0]>=Wa[0]?qa:[1,1],
Ya=Fa[0]>=Ha[0]&&Fa[0]>=ja[0]?Fa:Ha[0]>=Fa[0]&&Ha[0]>=ja[0]?Ha:ja[0]>=Fa[0]&&ja[0]>=Ha[0]?ja:[1,1],pa=ga[0]>=ma[0]&&ga[0]>=ba[0]?ga:ma[0]>=ga[0]&&ma[0]>=ba[0]?ma:ba[0]>=ga[0]&&ba[0]>=ma[0]?ba:[1,1],vi='battle.lance'==Ln&'level_1'==fl?[1.05,1.1]:'battle.lance'==Ln&'level_2'==fl?[1.1,1.2]:'battle.lance'==Ln&'level_3'==fl?[1.2,1.3]:[1,1],fi='battle.battleaxe'==Ln&'level_1'==fl?[1.05,1.1]:'battle.battleaxe'==Ln&'level_2'==fl?[1.1,1.2]:'battle.battleaxe'==Ln&'level_3'==fl?[1.2,1.3]:[1,1],Si='battle.compositebow'==Ln&'level_1'==fl?[1.05,1.1]:'battle.compositebow'==Ln&'level_2'==fl?[1.1,1.2]:'battle.compositebow'==Ln&'level_3'==fl?[1.2,1.3]:[1,1],yi='battle.halberd'==Ln&'level_1'==fl?[1.1,1.05]:'battle.halberd'==Ln&'level_2'==fl?[1.2,1.1]:'battle.halberd'==Ln&'level_3'==fl?[1.3,1.2]:[1,1],ki='battle.longsword'==Ln&'level_1'==fl?[1.1,1.05]:'battle.longsword'==Ln&'level_2'==fl?[1.2,1.1]:'battle.longsword'==Ln&'level_3'==fl?[1.3,1.2]:[1,1],
hi='battle.longbow'==Ln&'level_1'==fl?[1.1,1.05]:'battle.longbow'==Ln&'level_2'==fl?[1.2,1.1]:'battle.longbow'==Ln&'level_3'==fl?[1.3,1.2]:[1,1],wi='battle.banner'==Ln&'level_1'==fl?[1.1,1.1]:'battle.banner'==Ln&'level_2'==fl?[1.2,1.2]:'battle.banner'==Ln&'level_3'==fl?[1.3,1.3]:[1,1],Ri='battle.star'==Ln&'level_1'==fl?[1.05,1.25]:'battle.star'==Ln&'level_2'==fl?[1.1,1.5]:'battle.star'==Ln&'level_3'==fl?[1.2,2]:[1,1],Ai='battle.bonfire'==Ln&'level_1'==fl?[1.05,1.25]:'battle.bonfire'==Ln&'level_2'==fl?[1.1,1.5]:'battle.bonfire'==Ln&'level_3'==fl?[1.2,2]:[1,1],Be=N*s[0]+P*s[1]+d*s[2]+r*s[3]+w*s[4]+R*s[5]+_*s[6]+I*s[7]+m*s[8]+h*s[9]+L*s[10]+z*s[11]+p*s[12],da=M*s[0]+C*s[1]+u*s[2]+c*s[3]+v*s[4]+y*s[5]+E*s[6]+x*s[7]+b*s[8]+f*s[9]+O*s[10]+D*s[11]+g*s[12],Ka=2*Be<=da?2:1,po=Be-5*I,bo=0==U?0:Math.round(20*Math.pow(1.2515,U-1)),ua=da+(bo+100*O),Bo=0==po||0==ua?0:po/ua>1?1:po/ua,co=k/100,Ul=S/100,mo=Math.round(1e3*(md/100*co*(1+Ul)+As/100+Tl))/1e3,dd=m/(cd=I+m),ud=I/cd,Vc=Math.round(D*dd),
id=Math.round(D*ud),ps=(ms=I-(0==I?0:I<id?I:id))*Bo*mo*(On='battle.star'==Ln?'level_1'==fl?[1.05,1.25]:'level_2'==fl?[1.1,1.5]:'level_3'==fl?[1.2,2]:[1,1]:[1,1])[1],Sn=20==U?18:19==U?17:18==U?15:17==U?14:16==U?13:15==U?11:14==U?10:13==U||12==U?9:11==U?8:10==U?7:9==U||8==U?6:7==U||6==U?5:5==U||4==U||3==U?4:2==U||1==U?3:0,sd=0==U?0:2*Sn,ld=0==U?0:ps/sd,rd=U<=Ss?U:U-Ss<ld?U<Ss?U:Ss:U-ld,pt=Math.round(rd),ut=Math.round(.05*pt*1e3)/1e3,go=Math.round(bd/100*(1+ut)*uo*1e3)/1e3,ra=m-(0==m?0:m<Vc?m:Vc),dt=0==(od=Math.round(rd))?0:Math.round(20*Math.pow(1.2515,od-1)),Hi=N+P+d+p>w+_&&N+P+d+p>r+R?'inf':w+_>N+P+d+p&&w+_>r+R?'cav':'arc',Ro=N*s[0]+P*s[1]+d*s[2]+r*s[3]+w*s[4]+R*s[5]+_*s[6]+ms*s[7]+ra*s[8]+h*s[9]+L*s[10]+z*s[11]+p*s[12],Do=M*s[0]+C*s[1]+u*s[2]+c*s[3]+v*s[4]+y*s[5]+E*s[6]+x*s[7]+b*s[8]+f*s[9]+O*s[10]+D*s[11]+g*s[12],console.log(Do,Ro),Ts=ms*s[7]+ra*s[8]+z*s[11]+h*s[9]+L*s[10],'cav'==Hi?(ho=w*s[4]+_*s[6]+Ts,wo=N*s[0]+P*s[1]+d*s[2]+p*s[12],
To=r*s[3]+R*s[5]):'inf'==Hi?(wo=N*s[0]+P*s[1]+d*s[2]+p*s[12]+Ts,ho=w*s[4]+_*s[6],To=r*s[3]+R*s[5]):'arc'==Hi?(wo=N*s[0]+P*s[1]+d*s[2]+p*s[12],ho=w*s[4]+_*s[6],To=r*s[3]+R*s[5]+Ts):(wo=N*s[0]+P*s[1]+d*s[2]+p*s[12],ho=w*s[4]+_*s[6],To=r*s[3]+R*s[5]),xl=0==wo?0:Math.round(wo/Ro*1e4)/1e4,Il=0==ho?0:Math.round(ho/Ro*1e4)/1e4,kl=0==To?0:Math.round(To/Ro*1e4)/1e4,console.log(kl),rr=Math.round(M*xl),sr=Math.round(M*Il),or=M-sr-rr,Rc=Math.round(C*xl),Sc=Math.round(C*Il),vc=C-Sc-Rc,tt=Math.round(u*xl),et=Math.round(u*Il),$e=u-et-tt,Le=Math.round(c*xl),xe=Math.round(c*Il),Ie=c-xe-Le,sl=Math.round(v*xl),ol=Math.round(v*Il),ll=v-ol-sl,$l=Math.round(y*xl),Jl=Math.round(y*Il),Zl=y-Jl-$l,mn=Math.round(E*xl),gn=Math.round(E*Il),pn=E-gn-mn,ts=Math.round(x*xl),es=Math.round(x*Il),$o=x-es-ts,Xt=Math.round(b*xl),Qt=Math.round(b*Il),Kt=b-Qt-Xt,Gs=Math.round(O*xl),Us=Math.round(O*Il),Ds=O-Us-Gs,Qc=Math.round(D*xl),Kc=Math.round(D*Il),jc=D-Kc-Qc,kt=Math.round(g*xl),yt=Math.round(g*Il),Rt=g-yt-kt,
di=Math.round(f*xl),ci=Math.round(f*Il),ri=f-ci-di,Po=rr*s[0]+Rc*s[1]+tt*s[2]+kt*s[12]+Gs*s[10]+sl*s[4]+mn*s[6]+Le*s[3]+$l*s[5]+ts*s[7]+Xt*s[8]+Qc*s[11]+di*s[9],Oo=sr*s[0]+Sc*s[1]+et*s[2]+yt*s[12]+Us*s[10]+ol*s[4]+gn*s[6]+xe*s[3]+Jl*s[5]+es*s[7]+Qt*s[8]+Kc*s[11]+ci*s[9],Io=or*s[0]+vc*s[1]+$e*s[2]+Rt*s[12]+Ds*s[10]+ll*s[4]+pn*s[6]+Ie*s[3]+Zl*s[5]+$o*s[7]+Kt*s[8]+jc*s[11]+ri*s[9],console.log(Io,Oo,Po),Yr=rr*n[0]*Ba[0]+Rc*n[1]*Ya[0]+tt*n[2]*Ta[0]+kt*n[12]+Gs*n[10]+sl*n[4]*Ia[0]+mn*n[6]*Sa[0]+Le*n[3]*pa[0]+$l*n[5]*Na[0]+ts*n[7]*za[0]+Xt*n[8]*fa[0]+Qc*n[11]+di*n[9],Vr=sr*i[0]*Ba[0]+Sc*i[1]*Ya[0]+et*i[2]*Ta[0]+yt*i[12]+Us*i[10]+ol*i[4]*Ia[0]+gn*i[6]*Sa[0]+xe*i[3]*pa[0]+Jl*i[5]*Na[0]+es*i[7]*za[0]+Qt*i[8]*fa[0]+Kc*i[11]+ci*i[9],Ur=or*l[0]*Ba[0]+vc*l[1]*Ya[0]+$e*l[2]*Ta[0]+Rt*l[12]+Ds*l[10]+ll*l[4]*Ia[0]+pn*l[6]*Sa[0]+Ie*l[3]*pa[0]+Zl*l[5]*Na[0]+$o*l[7]*za[0]+Kt*l[8]*fa[0]+jc*l[11]+ri*l[9],hs=ms*o[7]*Ri[1]+ra*o[8]*Ai[1]+z*o[11]+h*o[9]+L*o[10],'cav'==Hi?(Nr=w*o[4]*vi[1]+_*o[6]*wi[1]+hs,
Cr=N*o[0]*yi[1]+P*o[1]*ki[1]+d*o[2]*fi[1]+p*o[12]*Ka,xr=r*o[3]*hi[1]+R*o[5]*Si[1]):'inf'==Hi?(Cr=N*o[0]*yi[1]+P*o[1]*ki[1]+d*o[2]*fi[1]+p*o[12]*Ka+hs,Nr=w*o[4]*vi[1]+_*o[6]*wi[1],xr=r*o[3]*hi[1]+R*o[5]*Si[1]):'arc'==Hi?(Cr=N*o[0]*yi[1]+P*o[1]*ki[1]+d*o[2]*fi[1]+p*o[12]*Ka,Nr=w*o[4]*vi[1]+_*o[6]*wi[1],xr=r*o[3]*hi[1]+R*o[5]*Si[1]+hs):(Cr=N*o[0]*yi[1]+P*o[1]*ki[1]+d*o[2]*fi[1]+p*o[12]*Ka,Nr=w*o[4]*vi[1]+_*o[6]*wi[1],xr=r*o[3]*hi[1]+R*o[5]*Si[1]),yr=(vr=Cr*mo)+(fr=Nr*mo)+(_r=xr*mo),ac=($r=Yr*go+dt)+(Xr=Vr*go+dt)+(jr=Ur*go+dt),Fi=0==vr||0==$r?0:$r<=vr?1:Math.pow(vr/$r,.5)/($r/vr),Yi=0==fr||0==Xr?0:Xr<=fr?1:Math.pow(fr/Xr,.5)/(Xr/fr),qi=0==_r||0==jr?0:jr<=_r?1:Math.pow(_r/jr,.5)/(jr/_r),Wi=0==vr||0==$r?0:vr<=$r?1:Math.pow($r/vr,.5)/(vr/$r),Vi=0==fr||0==Xr?0:fr<=Xr?1:Math.pow(Xr/fr,.5)/(fr/Xr),Bi=0==_r||0==jr?0:_r<=jr?1:Math.pow(jr/_r,.5)/(_r/jr),Pn=Math.round(1e6*Wi)/1e6,Mn=Math.round(1e6*Vi)/1e6,Nn=Math.round(1e6*Bi)/1e6,Dn=Math.round(1e6*Fi)/1e6,zn=Math.round(1e6*Yi)/1e6,
Cn=Math.round(1e6*qi)/1e6,ar=Math.round(-rr*Dn+1e-6)+Math.round(-sr*zn+1e-6)+Math.round(-or*Cn+1e-6),hc=Math.round(-Rc*Dn+1e-6)+Math.round(-Sc*zn+1e-6)+Math.round(-vc*Cn+1e-6),Qe=Math.round(-tt*Dn+1e-6)+Math.round(-et*zn+1e-6)+Math.round(-$e*Cn+1e-6),Se=Math.round(-Le*Dn+1e-6)+Math.round(-xe*zn+1e-6)+Math.round(-Ie*Cn+1e-6),tl=Math.round(-sl*Dn+1e-6)+Math.round(-ol*zn+1e-6)+Math.round(-ll*Cn+1e-6),jl=Math.round(-$l*Dn+1e-6)+Math.round(-Jl*zn+1e-6)+Math.round(-Zl*Cn+1e-6),rn=Math.round(-mn*Dn+1e-6)+Math.round(-gn*zn+1e-6)+Math.round(-pn*Cn+1e-6),Qo=Math.round(-ts*Dn+1e-6)+Math.round(-es*zn+1e-6)+Math.round(-$o*Cn+1e-6),Yt=Math.round(-Xt*Dn+1e-6)+Math.round(-Qt*zn+1e-6)+Math.round(-Kt*Cn+1e-6),qc=Math.round(-Qc*Dn+1e-6)+Math.round(-Kc*zn+1e-6)+Math.round(-jc*Cn+1e-6),At=Math.round(-kt*Dn+1e-6)+Math.round(-yt*zn+1e-6)+Math.round(-Rt*Cn+1e-6),ii=Math.round(-di*Dn+1e-6)+Math.round(-ci*zn+1e-6)+Math.round(-ri*Cn+1e-6),
Ms=Math.round(-Gs*Dn+1e-6)+Math.round(-Us*zn+1e-6)+Math.round(-Ds*Cn+1e-6),Qs=Math.round(-N*Pn+1e-6),pc=Math.round(-P*Pn+1e-6),We=Math.round(-d*Pn+1e-6),mt=Math.round(-p*Pn+1e-6),V=Math.round(-r*Nn+1e-6),Bl=Math.round(-R*Nn+1e-6),Ki=Math.round(-w*Mn+1e-6),en=Math.round(-_*Mn+1e-6),'cav'==Hi?(Wo=Math.round(-ms*Mn+1e-6),Dt=Math.round(-ra*Mn+1e-6),Cc=Math.round(-z*Mn+1e-6),Zn=Math.round(-h*Mn+1e-6),ys=Math.round(-L*Mn+1e-6)):'inf'==Hi?(Wo=Math.round(-ms*Pn+1e-6),Dt=Math.round(-ra*Pn+1e-6),Cc=Math.round(-z*Pn+1e-6),Zn=Math.round(-h*Pn+1e-6),ys=Math.round(-L*Pn+1e-6)):'arc'==Hi&&(Wo=Math.round(-ms*Nn+1e-6),Dt=Math.round(-ra*Nn+1e-6),Cc=Math.round(-z*Nn+1e-6),Zn=Math.round(-h*Nn+1e-6),ys=Math.round(-L*Nn+1e-6)),Js=N+Qs,bc=P+pc,Fe=d+We,fe=r+V,Zi=w+Ki,ql=R+Bl,nn=_+en,Fo=ms+Wo,Bt=ra+Dt,Uc=z+Cc,_t=p+mt,xs=L+ys,ei=h+Zn,lr=M+ar,wc=C+hc,Je=u+Qe,ke=c+Se,il=v+tl,Xl=y+jl,un=E+rn,Jo=x+Qo,jt=b+Yt,Hc=D+qc,St=g+At,zs=O+Ms,si=f+ii,
Al=Qs*s[0]+pc*s[1]+We*s[2]+V*s[3]+Ki*s[4]+Bl*s[5]+en*s[6]+Wo*s[7]+Dt*s[8]+Zn*s[9]+ys*s[10]+Cc*s[11]+mt*s[12],Sl=ar*s[0]+hc*s[1]+Qe*s[2]+Se*s[3]+tl*s[4]+jl*s[5]+rn*s[6]+Qo*s[7]+Yt*s[8]+ii*s[9]+Ms*s[10]+qc*s[11]+At*s[12],console.log(Al,Sl),lc=Js*s[0]+bc*s[1]+Fe*s[2]+fe*s[3]+Zi*s[4]+ql*s[5]+nn*s[6]+Fo*s[7]+Bt*s[8]+Uc*s[11]+_t*s[12]+xs*s[10]+ei*s[9],rc=lr*s[0]+wc*s[1]+Je*s[2]+ke*s[3]+il*s[4]+Xl*s[5]+un*s[6]+Jo*s[7]+jt*s[8]+Hc*s[11]+St*s[12]+zs*s[10]+si*s[9],console.log(lc,rc),Ge=0==yr||0==ac?0:ac<=yr?1:Math.pow(yr/ac,.5/(ac/yr)),console.log(Ge),yo=Js*s[0]+bc*s[1]+Fe*s[2]+fe*s[3]+Zi*s[4]+ql*s[5]+nn*s[6]+Fo*s[7]+Bt*s[8]+ei*s[9]+xs*s[10]+Uc*s[11]+_t*s[12],Uo=lr*s[0]+wc*s[1]+Je*s[2]+ke*s[3]+il*s[4]+Xl*s[5]+un*s[6]+Jo*s[7]+jt*s[8]+si*s[9]+zs*s[10]+Hc*s[11]+St*s[12],console.log(Uo,yo),_s=Fo*s[7]+Bt*s[8]+Uc*s[11]+ei*s[9],'cav'==Hi?(fo=Zi*s[4]+nn*s[6]+_s,vo=Js*s[0]+bc*s[1]+Fe*s[2]+_t*s[12]+xs*s[10],_o=fe*s[3]+ql*s[5]):'inf'==Hi?(vo=Js*s[0]+bc*s[1]+Fe*s[2]+_t*s[12]+xs*s[10]+_s,fo=Zi*s[4]+nn*s[6],
_o=fe*s[3]+ql*s[5]):'arc'==Hi?(vo=Js*s[0]+bc*s[1]+Fe*s[2]+_t*s[12]+xs*s[10],fo=Zi*s[4]+nn*s[6],_o=fe*s[3]+ql*s[5]+_s):(vo=Js*s[0]+bc*s[1]+Fe*s[2]+_t*s[12]+xs*s[10],fo=Zi*s[4]+nn*s[6],_o=fe*s[3]+ql*s[5]),Nl=0==vo?0:Math.round(vo/yo*1e4)/1e4,Ol=0==fo?0:Math.round(fo/yo*1e4)/1e4,Ll=0==_o?0:Math.round(_o/yo*1e4)/1e4,console.log(Ll),pr=Math.round(lr*Nl),ur=Math.round(lr*Ol),dr=lr-ur-pr,xc=Math.round(wc*Nl),Ic=Math.round(wc*Ol),kc=wc-Ic-xc,lt=Math.round(Je*Nl),it=Math.round(Je*Ol),nt=Je-it-lt,Pe=Math.round(ke*Nl),Me=Math.round(ke*Ol),Ne=ke-Me-Pe,ul=Math.round(il*Nl),dl=Math.round(il*Ol),cl=il-dl-ul,no=Math.round(Xl*Nl),ao=Math.round(Xl*Ol),to=Xl-ao-no,En=Math.round(un*Nl),_n=Math.round(un*Ol),Tn=un-_n-En,ls=Math.round(Jo*Nl),is=Math.round(Jo*Ol),ns=Jo-is-ls,ea=Math.round(jt*Nl),$t=Math.round(jt*Ol),Jt=jt-$t-ea,qs=Math.round(zs*Nl),Ws=Math.round(zs*Ol),Vs=zs-Ws-qs,$c=Math.round(Hc*Nl),Jc=Math.round(Hc*Ol),Zc=Hc-Jc-$c,Ot=Math.round(St*Nl),Lt=Math.round(St*Ol),xt=St-Lt-Ot,mi=Math.round(si*Nl),
gi=Math.round(si*Ol),pi=si-gi-mi,Co=pr*s[0]+xc*s[1]+lt*s[2]+Ot*s[12]+qs*s[10]+ul*s[4]+En*s[6]+Pe*s[3]+no*s[5]+ls*s[7]+ea*s[8]+$c*s[11]+mi*s[9],No=ur*s[0]+Ic*s[1]+it*s[2]+Lt*s[12]+Ws*s[10]+dl*s[4]+_n*s[6]+Me*s[3]+ao*s[5]+is*s[7]+$t*s[8]+Jc*s[11]+gi*s[9],xo=dr*s[0]+kc*s[1]+nt*s[2]+xt*s[12]+Vs*s[10]+cl*s[4]+Tn*s[6]+Ne*s[3]+to*s[5]+ns*s[7]+Jt*s[8]+Zc*s[11]+pi*s[9],console.log(xo,No,Co),Fr=pr*n[0]*Ba[0]+xc*n[1]*Ya[0]+lt*n[2]*Ta[0]+Ot*n[12]+qs*n[10]+ul*n[4]*Ia[0]+En*n[6]*Sa[0]+Pe*n[3]*pa[0]+no*n[5]*Na[0]+ls*n[7]*za[0]+ea*n[8]*fa[0]+$c*n[11]+mi*n[9],Wr=ur*i[0]*Ba[0]+Ic*i[1]*Ya[0]+it*i[2]*Ta[0]+Lt*i[12]+Ws*i[10]+dl*i[4]*Ia[0]+_n*i[6]*Sa[0]+Me*i[3]*pa[0]+ao*i[5]*Na[0]+is*i[7]*za[0]+$t*i[8]*fa[0]+Jc*i[11]+gi*i[9],Gr=dr*l[0]*Ba[0]+kc*l[1]*Ya[0]+nt*l[2]*Ta[0]+xt*l[12]+Vs*l[10]+cl*l[4]*Ia[0]+Tn*l[6]*Sa[0]+Ne*l[3]*pa[0]+to*l[5]*Na[0]+ns*l[7]*za[0]+Jt*l[8]*fa[0]+Zc*l[11]+pi*l[9],fs=Fo*o[7]*Ri[1]+Bt*o[8]*Ai[1]+Uc*o[11]+ei*o[9],'cav'==Hi?(Mr=Zi*o[4]*vi[1]+nn*o[6]*wi[1]+fs,
zr=Js*o[0]*yi[1]+bc*o[1]*ki[1]+Fe*o[2]*fi[1]+_t*o[12]*Ka+xs*o[10],Lr=fe*o[3]*hi[1]+ql*o[5]*Si[1]):'inf'==Hi?(zr=Js*o[0]*yi[1]+bc*o[1]*ki[1]+Fe*o[2]*fi[1]+_t*o[12]*Ka+xs*o[10]+fs,Mr=Zi*o[4]*vi[1]+nn*o[6]*wi[1],Lr=fe*o[3]*hi[1]+ql*o[5]*Si[1]):'arc'==Hi?(zr=Js*o[0]*yi[1]+bc*o[1]*ki[1]+Fe*o[2]*fi[1]+_t*o[12]*Ka+xs*o[10],Mr=Zi*o[4]*vi[1]+nn*o[6]*wi[1],Lr=fe*o[3]*hi[1]+ql*o[5]*Si[1]+fs):(zr=Js*o[0]*yi[1]+bc*o[1]*ki[1]+Fe*o[2]*fi[1]+_t*o[12]*Ka+xs*o[10],Mr=Zi*o[4]*vi[1]+nn*o[6]*wi[1],Lr=fe*o[3]*hi[1]+ql*o[5]*Si[1]),kr=(Sr=zr*mo)+(Ar=Mr*mo)+(Er=Lr*mo),nc=(ec=Fr*go)+(Zr=Wr*go)+(Kr=Gr*go),console.log(kr,nc),Mi=0==Sr||0==ec?0:ec<=Sr?1:Math.pow(Sr/ec,.5)/(ec/Sr),Ni=0==Ar||0==Zr?0:Zr<=Ar?1:Math.pow(Ar/Zr,.5)/(Zr/Ar),Oi=0==Er||0==Kr?0:Kr<=Er?1:Math.pow(Er/Kr,.5)/(Kr/Er),Li=0==Sr||0==ec?0:Sr<=ec?1:Math.pow(ec/Sr,.5)/(Sr/ec),xi=0==Ar||0==Zr?0:Ar<=Zr?1:Math.pow(Zr/Ar,.5)/(Ar/Zr),Ii=0==Er||0==Kr?0:Er<=Kr?1:Math.pow(Kr/Er,.5)/(Er/Kr),Bn=Math.round(1e6*Li)/1e6,Gn=Math.round(1e6*xi)/1e6,
Un=Math.round(1e6*Ii)/1e6,qn=Math.round(1e6*Mi)/1e6,Wn=Math.round(1e6*Ni)/1e6,Vn=Math.round(1e6*Oi)/1e6,nr=Math.round(-pr*qn+1e-6)+Math.round(-ur*Wn+1e-6)+Math.round(-dr*Vn+1e-6),fc=Math.round(-xc*qn+1e-6)+Math.round(-Ic*Wn+1e-6)+Math.round(-kc*Vn+1e-6),Xe=Math.round(-lt*qn+1e-6)+Math.round(-it*Wn+1e-6)+Math.round(-nt*Vn+1e-6),Re=Math.round(-Pe*qn+1e-6)+Math.round(-Me*Wn+1e-6)+Math.round(-Ne*Vn+1e-6),al=Math.round(-ul*qn+1e-6)+Math.round(-dl*Wn+1e-6)+Math.round(-cl*Vn+1e-6),Kl=Math.round(-no*qn+1e-6)+Math.round(-ao*Wn+1e-6)+Math.round(-to*Vn+1e-6),cn=Math.round(-En*qn+1e-6)+Math.round(-_n*Wn+1e-6)+Math.round(-Tn*Vn+1e-6),Xo=Math.round(-ls*qn+1e-6)+Math.round(-is*Wn+1e-6)+Math.round(-ns*Vn+1e-6),Ft=Math.round(-ea*qn+1e-6)+Math.round(-$t*Wn+1e-6)+Math.round(-Jt*Vn+1e-6),Yc=Math.round(-$c*qn+1e-6)+Math.round(-Jc*Wn+1e-6)+Math.round(-Zc*Vn+1e-6),wt=Math.round(-Ot*qn+1e-6)+Math.round(-Lt*Wn+1e-6)+Math.round(-xt*Vn+1e-6),
li=Math.round(-mi*qn+1e-6)+Math.round(-gi*Wn+1e-6)+Math.round(-pi*Vn+1e-6),Ps=Math.round(-qs*qn+1e-6)+Math.round(-Ws*Wn+1e-6)+Math.round(-Vs*Vn+1e-6),Xs=Math.round(-Js*Bn+1e-6),gc=Math.round(-bc*Bn+1e-6),qe=Math.round(-Fe*Bn+1e-6),bt=Math.round(-_t*Bn+1e-6),Ee=Math.round(-fe*Un+1e-6),Vl=Math.round(-ql*Un+1e-6),Qi=Math.round(-Zi*Gn+1e-6),tn=Math.round(-nn*Gn+1e-6),'cav'==Hi?(qo=Math.round(-Fo*Gn+1e-6),Ut=Math.round(-Bt*Gn+1e-6),zc=Math.round(-Uc*Gn+1e-6),Jn=Math.round(-ei*Gn+1e-6)):'inf'==Hi?(qo=Math.round(-Fo*Bn+1e-6),Ut=Math.round(-Bt*Bn+1e-6),zc=Math.round(-Uc*Bn+1e-6),Jn=Math.round(-ei*Bn+1e-6)):'arc'==Hi&&(qo=Math.round(-Fo*Un+1e-6),Ut=Math.round(-Bt*Un+1e-6),zc=Math.round(-Uc*Un+1e-6),Jn=Math.round(-ei*Un+1e-6)),ks=100*xs==vo?0:Math.round(-xs*Bn+1e-6),$s=Js+Xs,Tc=bc+gc,He=Fe+qe,Ae=fe+Ee,Ji=Zi+Qi,Yl=ql+Vl,ln=nn+tn,Ho=Fo+qo,Vt=Bt+Ut,Gc=Uc+zc,Et=_t+bt,Ls=xs+ks,ti=ei+Jn,cr=lr+nr,yc=wc+fc,at=Je+Xe,Oe=ke+Re,rl=il+al,eo=Xl+Kl,bn=un+cn,as=Jo+Xo,Zt=jt+Ft,Xc=Hc+Yc,It=St+wt,Bs=zs+Ps,
ui=si+li,wl=Xs*s[0]+gc*s[1]+qe*s[2]+Ee*s[3]+Qi*s[4]+Vl*s[5]+tn*s[6]+qo*s[7]+Ut*s[8]+Jn*s[9]+ks*s[10]+zc*s[11]+bt*s[12],Rl=nr*s[0]+fc*s[1]+Xe*s[2]+Re*s[3]+al*s[4]+Kl*s[5]+cn*s[6]+Xo*s[7]+Ft*s[8]+li*s[9]+Ps*s[10]+Yc*s[11]+wt*s[12],console.log(wl,Rl),oc=$s*s[0]+Tc*s[1]+He*s[2]+Ae*s[3]+Ji*s[4]+Yl*s[5]+ln*s[6]+Ho*s[7]+Vt*s[8]+Gc*s[11]+Et*s[12]+Ls*s[10]+ti*s[9],cc=cr*s[0]+yc*s[1]+at*s[2]+Oe*s[3]+rl*s[4]+eo*s[5]+bn*s[6]+as*s[7]+Zt*s[8]+Xc*s[11]+It*s[12]+Bs*s[10]+ui*s[9],console.log(oc,cc),ko=$s*s[0]+Tc*s[1]+He*s[2]+Ae*s[3]+Ji*s[4]+Yl*s[5]+ln*s[6]+Ho*s[7]+Vt*s[8]+ti*s[9]+Ls*s[10]+Gc*s[11]+Et*s[12],Go=cr*s[0]+yc*s[1]+at*s[2]+Oe*s[3]+rl*s[4]+eo*s[5]+bn*s[6]+as*s[7]+Zt*s[8]+ui*s[9]+Bs*s[10]+Xc*s[11]+It*s[12],console.log(Go,ko),bs=Ho*s[7]+Vt*s[8]+Gc*s[11]+ti*s[9],'cav'==Hi?(Ao=Ji*s[4]+ln*s[6]+bs,So=$s*s[0]+Tc*s[1]+He*s[2]+Et*s[12]+Ls*s[10],Eo=Ae*s[3]+Yl*s[5]):'inf'==Hi?(So=$s*s[0]+Tc*s[1]+He*s[2]+Et*s[12]+Ls*s[10]+bs,Ao=Ji*s[4]+ln*s[6],
Eo=Ae*s[3]+Yl*s[5]):'arc'==Hi?(So=$s*s[0]+Tc*s[1]+He*s[2]+Et*s[12]+Ls*s[10],Ao=Ji*s[4]+ln*s[6],Eo=Ae*s[3]+Yl*s[5]+bs):(So=$s*s[0]+Tc*s[1]+He*s[2]+Et*s[12]+Ls*s[10],Ao=Ji*s[4]+ln*s[6],Eo=Ae*s[3]+Yl*s[5]),Cl=0==So?0:Math.round(So/ko*1e4)/1e4,Pl=0==Ao?0:Math.round(Ao/ko*1e4)/1e4,Ml=0==Eo?0:Math.round(Eo/ko*1e4)/1e4,console.log(Ml),Tr=Math.round(cr*Cl),br=Math.round(cr*Pl),mr=cr-br-Tr,Mc=Math.round(yc*Cl),Nc=Math.round(yc*Pl),Oc=yc-Nc-Mc,ct=Math.round(at*Cl),rt=Math.round(at*Pl),st=at-rt-ct,Ue=Math.round(Oe*Cl),De=Math.round(Oe*Pl),ze=Oe-De-Ue,bl=Math.round(rl*Cl),ml=Math.round(rl*Pl),gl=rl-ml-bl,so=Math.round(eo*Cl),oo=Math.round(eo*Pl),lo=eo-oo-so,wn=Math.round(bn*Cl),An=Math.round(bn*Pl),fn=bn-An-wn,cs=Math.round(as*Cl),rs=Math.round(as*Pl),ss=as-rs-cs,ia=Math.round(Zt*Cl),na=Math.round(Zt*Pl),aa=Zt-na-ia,js=Math.round(Bs*Cl),Hs=Math.round(Bs*Pl),Fs=Bs-Hs-js,nd=Math.round(Xc*Cl),ad=Math.round(Xc*Pl),td=Xc-ad-nd,Ct=Math.round(It*Cl),Pt=Math.round(It*Pl),Mt=It-Pt-Ct,Ei=Math.round(ui*Cl),
_i=Math.round(ui*Pl),Ti=ui-_i-Ei,zo=Tr*s[0]+Mc*s[1]+ct*s[2]+Ct*s[12]+js*s[10]+bl*s[4]+wn*s[6]+Ue*s[3]+so*s[5]+cs*s[7]+ia*s[8]+nd*s[11]+Ei*s[9],Mo=br*s[0]+Nc*s[1]+rt*s[2]+Pt*s[12]+Hs*s[10]+ml*s[4]+An*s[6]+De*s[3]+oo*s[5]+rs*s[7]+na*s[8]+ad*s[11]+_i*s[9],Lo=mr*s[0]+Oc*s[1]+st*s[2]+Mt*s[12]+Fs*s[10]+gl*s[4]+fn*s[6]+ze*s[3]+lo*s[5]+ss*s[7]+aa*s[8]+td*s[11]+Ti*s[9],console.log(Lo,Mo,zo),Hr=Tr*n[0]*Ba[0]+Mc*n[1]*Ya[0]+ct*n[2]*Ta[0]+Ct*n[12]+js*n[10]+bl*n[4]*Ia[0]+wn*n[6]*Sa[0]+Ue*n[3]*pa[0]+so*n[5]*Na[0]+cs*n[7]*za[0]+ia*n[8]*fa[0]+nd*n[11]+Ei*n[9],qr=br*i[0]*Ba[0]+Nc*i[1]*Ya[0]+rt*i[2]*Ta[0]+Pt*i[12]+Hs*i[10]+ml*i[4]*Ia[0]+An*i[6]*Sa[0]+De*i[3]*pa[0]+oo*i[5]*Na[0]+rs*i[7]*za[0]+na*i[8]*fa[0]+ad*i[11]+_i*i[9],Br=mr*l[0]*Ba[0]+Oc*l[1]*Ya[0]+st*l[2]*Ta[0]+Mt*l[12]+Fs*l[10]+gl*l[4]*Ia[0]+fn*l[6]*Sa[0]+ze*l[3]*pa[0]+lo*l[5]*Na[0]+ss*l[7]*za[0]+aa*l[8]*fa[0]+td*l[11]+Ti*l[9],Es=Ho*o[7]*Ri[1]+Vt*o[8]*Ai[1]+Gc*o[11]+ti*o[9],'cav'==Hi?(Pr=Ji*o[4]*vi[1]+ln*o[6]*wi[1]+Es,
Dr=$s*o[0]*yi[1]+Tc*o[1]*ki[1]+He*o[2]*fi[1]+Et*o[12]*Ka+Ls*o[10],Or=Ae*o[3]*hi[1]+Yl*o[5]*Si[1]):'inf'==Hi?(Dr=$s*o[0]*yi[1]+Tc*o[1]*ki[1]+He*o[2]*fi[1]+Et*o[12]*Ka+Ls*o[10]+Es,Pr=Ji*o[4]*vi[1]+ln*o[6]*wi[1],Or=Ae*o[3]*hi[1]+Yl*o[5]*Si[1]):'arc'==Hi?(Dr=$s*o[0]*yi[1]+Tc*o[1]*ki[1]+He*o[2]*fi[1]+Et*o[12]*Ka+Ls*o[10],Pr=Ji*o[4]*vi[1]+ln*o[6]*wi[1],Or=Ae*o[3]*hi[1]+Yl*o[5]*Si[1]+Es):(Dr=$s*o[0]*yi[1]+Tc*o[1]*ki[1]+He*o[2]*fi[1]+Et*o[12]*Ka+Ls*o[10],Pr=Ji*o[4]*vi[1]+ln*o[6]*wi[1],Or=Ae*o[3]*hi[1]+Yl*o[5]*Si[1]),Ir=(Rr=Dr*mo)+(wr=Pr*mo)+(hr=Or*mo),ic=(tc=Hr*go)+(Jr=qr*go)+(Qr=Br*go),console.log(ic,Ir),Gi=0==Rr||0==tc?0:tc<=Rr?1:Math.pow(Rr/tc,.5)/(tc/Rr),Ui=0==wr||0==Jr?0:Jr<=wr?1:Math.pow(wr/Jr,.5)/(Jr/wr),Di=0==hr||0==Qr?0:Qr<=hr?1:Math.pow(hr/Qr,.5)/(Qr/hr),zi=0==Rr||0==tc?0:Rr<=tc?1:Math.pow(tc/Rr,.5)/(Rr/tc),Ci=0==wr||0==Jr?0:wr<=Jr?1:Math.pow(Jr/wr,.5)/(wr/Jr),Pi=0==hr||0==Qr?0:hr<=Qr?1:Math.pow(Qr/hr,.5)/(hr/Qr),Hn=Math.round(1e6*zi)/1e6,Fn=Math.round(1e6*Ci)/1e6,
Yn=Math.round(1e6*Pi)/1e6,Qn=Math.round(1e6*Gi)/1e6,Kn=Math.round(1e6*Ui)/1e6,jn=Math.round(1e6*Di)/1e6,ir=Math.round(-Tr*Qn+1e-6)+Math.round(-br*Kn+1e-6)+Math.round(-mr*jn+1e-6),Ac=Math.round(-Mc*Qn+1e-6)+Math.round(-Nc*Kn+1e-6)+Math.round(-Oc*jn+1e-6),Ze=Math.round(-ct*Qn+1e-6)+Math.round(-rt*Kn+1e-6)+Math.round(-st*jn+1e-6),ye=Math.round(-Ue*Qn+1e-6)+Math.round(-De*Kn+1e-6)+Math.round(-ze*jn+1e-6),nl=Math.round(-bl*Qn+1e-6)+Math.round(-ml*Kn+1e-6)+Math.round(-gl*jn+1e-6),Ql=Math.round(-so*Qn+1e-6)+Math.round(-oo*Kn+1e-6)+Math.round(-lo*jn+1e-6),dn=Math.round(-wn*Qn+1e-6)+Math.round(-An*Kn+1e-6)+Math.round(-fn*jn+1e-6),Zo=Math.round(-cs*Qn+1e-6)+Math.round(-rs*Kn+1e-6)+Math.round(-ss*jn+1e-6),Ht=Math.round(-ia*Qn+1e-6)+Math.round(-na*Kn+1e-6)+Math.round(-aa*jn+1e-6),Fc=Math.round(-nd*Qn+1e-6)+Math.round(-ad*Kn+1e-6)+Math.round(-td*jn+1e-6),vt=Math.round(-Ct*Qn+1e-6)+Math.round(-Pt*Kn+1e-6)+Math.round(-Mt*jn+1e-6),
oi=Math.round(-Ei*Qn+1e-6)+Math.round(-_i*Kn+1e-6)+Math.round(-Ti*jn+1e-6),Cs=Math.round(-js*Qn+1e-6)+Math.round(-Hs*Kn+1e-6)+Math.round(-Fs*jn+1e-6),Zs=Math.round(-$s*Hn+1e-6),mc=Math.round(-Tc*Hn+1e-6),Ye=Math.round(-He*Hn+1e-6),Tt=Math.round(-Et*Hn+1e-6),he=Math.round(-Ae*Yn+1e-6),Wl=Math.round(-Yl*Yn+1e-6),Xi=Math.round(-Ji*Fn+1e-6),an=Math.round(-ln*Fn+1e-6),'cav'==Hi?(Yo=Math.round(-Ho*Fn+1e-6),Gt=Math.round(-Vt*Fn+1e-6),Dc=Math.round(-Gc*Fn+1e-6),$n=Math.round(-ti*Fn+1e-6)):'inf'==Hi?(Yo=Math.round(-Ho*Hn+1e-6),Gt=Math.round(-Vt*Hn+1e-6),Dc=Math.round(-Gc*Hn+1e-6),$n=Math.round(-ti*Hn+1e-6)):'arc'==Hi&&(Yo=Math.round(-Ho*Yn+1e-6),Gt=Math.round(-Vt*Yn+1e-6),Dc=Math.round(-Gc*Yn+1e-6),$n=Math.round(-ti*Yn+1e-6)),Is=100*Ls==So?0:Math.round(-Ls*Hn+1e-6),er=$s+Zs,_c=Tc+mc,je=He+Ye,we=Ae+he,$i=Ji+Xi,Fl=Yl+Wl,on=ln+an,jo=Ho+Yo,Wt=Vt+Gt,Bc=Gc+Dc,ht=Et+Tt,Os=Ls+Is,ai=ti+$n,gr=cr+ir,Lc=yc+Ac,ot=at+Ze,Ce=Oe+ye,pl=rl+nl,io=eo+Ql,hn=bn+dn,os=as+Zo,ta=Zt+Ht,ed=Xc+Fc,Nt=It+vt,Ys=Bs+Cs,
bi=ui+oi,vl=Zs*s[0]+mc*s[1]+Ye*s[2]+he*s[3]+Xi*s[4]+Wl*s[5]+an*s[6]+Yo*s[7]+Gt*s[8]+$n*s[9]+Is*s[10]+Dc*s[11]+Tt*s[12],yl=ir*s[0]+Ac*s[1]+Ze*s[2]+ye*s[3]+nl*s[4]+Ql*s[5]+dn*s[6]+Zo*s[7]+Ht*s[8]+oi*s[9]+Cs*s[10]+Fc*s[11]+vt*s[12],console.log(vl,yl),sc=er*s[0]+_c*s[1]+je*s[2]+we*s[3]+$i*s[4]+Fl*s[5]+on*s[6]+jo*s[7]+Wt*s[8]+Bc*s[11]+ht*s[12]+Os*s[10]+ai*s[9],dc=gr*s[0]+Lc*s[1]+ot*s[2]+Ce*s[3]+pl*s[4]+io*s[5]+hn*s[6]+os*s[7]+ta*s[8]+ed*s[11]+Nt*s[12]+Ys*s[10]+bi*s[9],console.log(sc,dc),Ks=-N+er,uc=-P+_c,Ve=-d+je,B=-r+we,ji=-w+$i,Gl=-R+Fl,$a=-_+on,Vo=-I+jo,zt=-m+Wt,Pc=-z+Bc,gt=-p+ht,Rs=-L+Os,Xn=-h+ai,tr=-M+gr,Ec=-C+Lc,Ke=-u+ot,ve=-c+Ce,el=-v+pl,Hl=-y+io,sn=-E+hn,Ko=-x+os,qt=-b+ta,Wc=-D+ed,ft=-g+Nt,Ns=-O+Ys,ni=-f+bi,gs=0==jo?0:jo*mo*On[1],Rn=20==od?18:19==od?17:18==od?15:17==od?14:16==od?13:15==od?11:14==od?10:13==od||12==od?9:11==od?8:10==od?7:9==od||8==od?6:7==od||6==od?5:5==od||4==od||3==od?4:2==od||1==od?3:0,ds=0==ut?0:2*Rn,us=0==gs||0==ds?0:-gs/ds,
Ja=od<=Ss?od:od-Ss<-us?od<Ss?od:Ss:od+us,G=Math.round(Ja),T='wall'==ca?G:A[t.BATTLE_TARGET_LEVEL],sa=0==Wt||0==T?0:Wt*mo*Ai[1],
vn='headquarter'==ca?30==T?72:29==T?65:28==T?59:27==T?54:26==T?50:25==T?45:24==T?41:23==T?36:22==T?33:21==T?30:20==T?27:19==T?26:18==T?23:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'wall'==ca?20==G?18:19==G?17:18==G?15:17==G?14:16==G?13:15==G?11:14==G?10:13==G||12==G?9:11==G?8:10==G?7:9==G||8==G?6:7==G||6==G?5:5==G||4==G||3==G?4:2==G||1==G?3:0:'tavern'==ca?15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'hospital'==ca?10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'satue'==ca?5==T||4==T||3==T?4:2==T||1==T?3:0:'rally_point'==ca?5==T||4==T||3==T?4:2==T||1==T?3:0:'church'==ca?3==T||2==T||1==T?800:0:'academy'==ca?1==T?500:0:'preceptory'==ca?10==T?71:9==T?43:8==T?39:7==T?35:6==T?32:5==T?29:4==T?27:3==T?24:2==T?22:1==T?20:0:'barracks'==ca?25==T?30:24==T?27:23==T?24:22==T?22:21==T?20:20==T?18:19==T?17:18==T?15:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'market'==ca?25==T?30:24==T?27:23==T?24:22==T?22:21==T?20:20==T?18:19==T?17:18==T?15:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'warehouse'==ca?30==T?48:29==T?43:28==T?39:27==T?36:26==T?33:25==T?30:24==T?27:23==T?24:22==T?22:21==T?20:20==T?18:19==T?17:18==T?15:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'timber_camp'==ca?30==T?48:29==T?43:28==T?39:27==T?36:26==T?33:25==T?30:24==T?27:23==T?24:22==T?22:21==T?20:20==T?18:19==T?17:18==T?15:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'clay_pit'==ca?30==T?48:29==T?43:28==T?39:27==T?36:26==T?33:25==T?30:24==T?27:23==T?24:22==T?22:21==T?20:20==T?18:19==T?17:18==T?15:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'iron_mine'==ca?30==T?48:29==T?43:28==T?39:27==T?36:26==T?33:25==T?30:24==T?27:23==T?24:22==T?22:21==T?20:20==T?18:19==T?17:18==T?15:17==T?14:16==T?13:15==T?11:14==T?10:13==T||12==T?9:11==T?8:10==T?7:9==T||8==T?6:7==T||6==T?5:5==T||4==T||3==T?4:2==T||1==T?3:0:'farm'==ca?30==T?79:29==T?72:28==T?66:27==T?60:26==T?54:25==T?49:24==T?45:23==T?41:22==T?37:21==T?34:20==T?31:19==T?28:18==T?25:17==T?23:16==T?21:15==T?19:14==T?17:13==T?16:12==T?14:11==T?13:10==T?12:9==T?11:8==T?10:7==T?9:6==T?8:5==T||4==T?7:2==T||3==T?6:1==T?5:0:0,
la=0==T?0:vn*go,oa=0==sa||0==la?0:-sa/la,Za='wall'==ca?Ja<=Ss?Ja:Ja-Ss<-oa?Ja<Ss?Ja:Ss:Ja+oa:oa+T<=0?0:oa+T,re=Math.round(Za),zl=Ks*s[0]+uc*s[1]+Ve*s[2]+B*s[3]+ji*s[4]+Gl*s[5]+$a*s[6]+Vo*s[7]+zt*s[8]+Xn*s[9]+Rs*s[10]+Pc*s[11]+gt*s[12],Dl=tr*s[0]+Ec*s[1]+Ke*s[2]+ve*s[3]+el*s[4]+Hl*s[5]+sn*s[6]+Ko*s[7]+qt*s[8]+ni*s[9]+Ns*s[10]+Wc*s[11]+ft*s[12],ue=tr*a[0]+Ec*a[1]+Ke*a[2]+ve*a[3]+el*a[4]+Hl*a[5]+sn*a[6]+Ko*a[7]+qt*a[8]+ni*a[9]+Ns*a[10]+Wc*a[11]+ft*a[12],de=Ks*e[0]+uc*e[1]+Ve*e[2]+B*e[3]+ji*e[4]+Gl*e[5]+$a*e[6]+Vo*e[7]+zt*e[8]+Xn*e[9]+Rs*e[10]+Pc*e[11]+gt*e[12],me=0==Be||0==zl?0:Math.round(-zl/Be*1e3)/1e3,ge='inf'==Hi?'piechota':'cav'==Hi?'kawaleria':'łucznicy',pe='inf'==(pd=M+C+u+g>v+E&&M+C+u+g>c+y?'inf':v+E>M+C+u+g&&v+E>c+y?'cav':'arc')?'piechota':'cav'==pd?'kawaleria':'łucznicy',be=0==da||0==Dl?0:Math.round(-Dl/da*1e3)/1e3,Q=Math.round(Ks*(ro+vs)),X=Math.round(uc*(ro+vs)),Z=Math.round(Ve*(ro+vs)),J=Math.round(B*(ro+vs)),ie=Math.round(ji*(ro+vs)),le=Math.round(Gl*(ro+vs)),
oe=Math.round($a*(ro+vs)),te=Math.round(Vo*(ro+vs)),ae=Math.round(zt*(ro+vs)),$=Math.round(Rs*(ro+vs)),ee=Math.round(Xn*(ro+vs)),ne=Math.round(Pc*(ro+vs)),se=Math.round(gt*(ro+vs)),gd=yn+ws,0==yn?(W=0,q=0,Y=0,F=0,H=0,j=0,K=0):yn<1e3?gd<=(ve+tr+Ec+Ke)/2?(W=Math.round(tr/2),q=Math.round(Ec/2),Y=Math.round(Ke/2),F=Math.round(ve/2),H=0,j=0,K=0):(W=Math.round(tr*gd/(ve+tr+Ec+Ke)),q=Math.round(Ec*gd/(ve+tr+Ec+Ke)),Y=Math.round(Ke*gd/(ve+tr+Ec+Ke)),F=Math.round(ve*gd/(ve+tr+Ec+Ke)),H=0,j=0,K=0):gd<=(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)/2?(W=Math.round(tr/2),q=Math.round(Ec/2),Y=Math.round(Ke/2),F=Math.round(ve/2),H=Math.round(el/2),j=Math.round(Hl/2),K=Math.round(sn/2)):(W=Math.round(tr*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)),q=Math.round(Ec*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)),Y=Math.round(Ke*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)),F=Math.round(ve*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)),H=Math.round(el*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)),j=Math.round(Hl*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn)),
K=Math.round(sn*gd/(ve+tr+Ec+Ke+4*el+5*Hl+6*sn))),_e=Be+zl,Te=da+Dl}()}()}()}()},xe.calculateT=function(){const e=A[t.TROOPS_SPEAR],a=A[t.TROOPS_SWORD],n=A[t.TROOPS_AXE],i=A[t.TROOPS_ARCHER],l=A[t.TROOPS_LC],o=A[t.TROOPS_MA],s=A[t.TROOPS_HC],r=A[t.TROOPS_RAM],c=A[t.TROOPS_CATAPULT],d=A[t.TROOPS_DOPPELSOLDNER],u=A[t.TROOPS_TREBUCHET],p=A[t.TROOPS_SNOB],g=A[t.TROOPS_KNIGHT],m=A[t.TROOPS_BARRACKS],b=A[t.TROOPS_PRECEPTORY],T=A[t.TROOPS_ORDER],_=A[t.TROOPS_TRAINING];var E=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],h=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],f=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],w=[1,1,1,1,4,5,6,5,8,1,100,10,6],v=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],S=[10,25,45,25,130,150,150,2,100,150,30,30,300],R=[25,55,10,10,30,40,200,20,100,250,100,200,100],y=[45,5,5,30,40,30,160,50,50,400,50,250,100],W=[10,30,10,60,30,50,180,20,100,150,100,200,50],q=[8,9,14,18,24,35,50,0],Y=[25,15,10,10,80,50,50,0,0,100,0,0,10],F=[0,33,66,99]
;let H=0,j=1,K=1,Q=1,X=1,Z=1,J=1,$=1,ee=1,te=0;var ae,ne,ie,le;K=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,te='level_1'==_?1.04:'level_2'==_?1.08:'level_3'==_?1.12:'level_4'==_?1.16:'level_5'==_?1.2:1,X=1==b?1.01:2==b?1.02:3==b?1.03:4==b?1.04:5==b?1.05:6==b?1.06:7==b?1.07:8==b?1.08:9==b?1.09:10==b?1.1:1,Q=A[t.TROOPS_DOMINATION]?1.1:1,B=u>0?q[6]+' minut':p>0?q[5]+' minut':r>0||c>0?q[4]+' minuty':a>0?q[3]+' minut':e>0||n>0||i>0||d>0?q[2]+' minut':s>0?q[1]+' minut':l>0||o>0||g>0?q[0]+' minut':q[7]+' minut',G=m>=7&&m<14?F[1]:m>=14&&m<23?F[2]:m>=23?F[3]:F[0],J=j/(Q*te),Z=J/K,$=Z/X,ee=j/X,H='troops.teutonic'==T?$*(e*v[0]+a*v[1]+i*v[3]+s*v[6])+ee*(u*v[11])+Z*(n*v[2]+l*v[4]+o*v[5]+r*v[7]+c*v[8])+d*v[12]+g*v[9]+p*v[10]:'troops.templars'==T?Z*(e*v[0]+a*v[1]+i*v[3]+s*v[6])+u*v[11]+$*(n*v[2]+l*v[4]+o*v[5]+r*v[7]+c*v[8])+ee*(d*v[12])+g*v[9]+p*v[10]:Z*(e*v[0]+a*v[1]+i*v[3]+s*v[6])+u*v[11]+Z*(n*v[2]+l*v[4]+o*v[5]+r*v[7]+c*v[8])+d*v[12]+g*v[9]+p*v[10],
k=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+p*E[10]+u*E[11]+d*E[12],I=e*h[0]+a*h[1]+n*h[2]+i*h[3]+l*h[4]+o*h[5]+s*h[6]+r*h[7]+c*h[8]+g*h[9]+p*h[10]+u*h[11]+d*h[12],x=e*f[0]+a*f[1]+n*f[2]+i*f[3]+l*f[4]+o*f[5]+s*f[6]+r*f[7]+c*f[8]+g*f[9]+p*f[10]+u*f[11]+d*f[12],L=e*w[0]+a*w[1]+n*w[2]+i*w[3]+l*w[4]+o*w[5]+s*w[6]+r*w[7]+c*w[8]+g*w[9]+p*w[10]+u*w[11]+d*w[12],U=e*S[0]+a*S[1]+n*S[2]+i*S[3]+l*S[4]+o*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+p*S[10]+u*S[11]+d*S[12],C=e*R[0]+a*R[1]+n*R[2]+i*R[3]+l*R[4]+o*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+p*R[10]+u*R[11]+d*R[12],z=e*y[0]+a*y[1]+n*y[2]+i*y[3]+l*y[4]+o*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+p*y[10]+u*y[11]+d*y[12],D=e*W[0]+a*W[1]+n*W[2]+i*W[3]+l*W[4]+o*W[5]+s*W[6]+r*W[7]+c*W[8]+g*W[9]+p*W[10]+u*W[11]+d*W[12],O=e*Y[0]+a*Y[1]+n*Y[2]+i*Y[3]+l*Y[4]+o*Y[5]+s*Y[6]+r*Y[7]+c*Y[8]+g*Y[9]+p*Y[10]+u*Y[11]+d*Y[12],ae=H,ne='',ie=new Date(1e3*ae).toISOString().substr(11,8),(le=Math.floor(ae/86400))>1?ne=le+' dni i ':le>0&&(ne='1 dzień i '),V=ne+=ie,
N=e*S[0]+a*S[1]+n*S[2]+r*S[7]+c*S[8]+u*S[11]+d*S[12],M=l*S[4]+s*S[6]+g*S[9],P=i*S[3]+o*S[5]},xe.start=function(){v=!0,h.trigger(s.BATTLE_CALCULATOR_START)},xe.stop=function(){v=!1,h.trigger(s.BATTLE_CALCULATOR_STOP)},xe.getSettings=function(){return f},xe.isInitialized=function(){return w},xe.isRunning=function(){return v},xe.getBashpointsAtt=function(){return y},xe.getBashpointsDef=function(){return R},xe.getWoodAmount=function(){return k},xe.getClayAmount=function(){return I},xe.getIronAmount=function(){return x},xe.getLoadAmount=function(){return O},xe.getFoodAmount=function(){return L},xe.getDefInf=function(){return C},xe.getDefCav=function(){return z},xe.getDefArc=function(){return D},xe.getAttInf=function(){return N},xe.getAttCav=function(){return M},xe.getAttArc=function(){return P},xe.getSpeed=function(){return B},xe.getBuildTime=function(){return V},xe.getDiscipline=function(){return G},xe.getPower=function(){return U},xe.getTarget=function(){return ce},
xe.getBuildingfrom=function(){return null},xe.getBuildingto=function(){return re},xe.getWallfrom=function(){return null},xe.getWallto=function(){return null},xe.getWallfrompre=function(){return null},xe.getWalltopre=function(){return null},xe.getDefencemodifier=function(){return null},xe.getDefenceprovisions=function(){return null},xe.getStrentghdefend=function(){return null},xe.getDefencebashpoint=function(){return de},xe.getDefencekilledprovisions=function(){return null},xe.getStrongesttypedef=function(){return pe},xe.getKillrated=function(){return be},xe.getDefencesurvivedprovisions=function(){return Te},xe.getAvailablebeds=function(){return null},xe.getAttackmodifier=function(){return null},xe.getAttackprovisions=function(){return null},xe.getStrentghattack=function(){return null},xe.getAttackbashpoint=function(){return ue},xe.getAttackkilledprovisions=function(){return null},xe.getStrongesttypeoff=function(){return ge},xe.getKillratea=function(){return me},
xe.getAttacksurvivedprovisions=function(){return _e},xe.getDoublestrength=function(){return null},xe.getSpeardAmount=function(){return null},xe.getSpeardLosses=function(){return null},xe.getSpeardRevived=function(){return W},xe.getSpeardSurvived=function(){return null},xe.getSworddAmount=function(){return null},xe.getSworddLosses=function(){return null},xe.getSworddRevived=function(){return q},xe.getSworddSurvived=function(){return null},xe.getAxedAmount=function(){return null},xe.getAxedLosses=function(){return null},xe.getAxedRevived=function(){return Y},xe.getAxedSurvived=function(){return null},xe.getArcherdAmount=function(){return null},xe.getArcherdLosses=function(){return null},xe.getArcherdRevived=function(){return F},xe.getArcherdSurvived=function(){return null},xe.getSnobdAmount=function(){return null},xe.getSnobdLosses=function(){return null},xe.getSnobdRevived=function(){return null},xe.getSnobdSurvived=function(){return null},xe.getKnightdAmount=function(){return null},
xe.getKnightdLosses=function(){return null},xe.getKnightdRevived=function(){return null},xe.getKnightdSurvived=function(){return null},xe.getRamdAmount=function(){return null},xe.getRamdLosses=function(){return null},xe.getRamdRevived=function(){return null},xe.getRamdSurvived=function(){return null},xe.getCatapultdAmount=function(){return null},xe.getCatapultdLosses=function(){return null},xe.getCatapultdRevived=function(){return null},xe.getCatapultdSurvived=function(){return null},xe.getTrebuchetdAmount=function(){return null},xe.getTrebuchetdLosses=function(){return null},xe.getTrebuchetdRevived=function(){return null},xe.getTrebuchetdSurvived=function(){return null},xe.getLcdAmount=function(){return null},xe.getLcdLosses=function(){return null},xe.getLcdRevived=function(){return H},xe.getLcdSurvived=function(){return null},xe.getMadAmount=function(){return null},xe.getMadLosses=function(){return null},xe.getMadRevived=function(){return j},xe.getMadSurvived=function(){return null},
xe.getHcdAmount=function(){return null},xe.getHcdLosses=function(){return null},xe.getHcdRevived=function(){return K},xe.getHcdSurvived=function(){return null},xe.getBerserkerdAmount=function(){return null},xe.getBerserkerdLosses=function(){return null},xe.getBerserkerdRevived=function(){return null},xe.getBerserkerdSurvived=function(){return null},xe.getSpearaAmount=function(){return null},xe.getSpearaLosses=function(){return null},xe.getSpearaRevived=function(){return Q},xe.getSpearaSurvived=function(){return null},xe.getSwordaAmount=function(){return null},xe.getSwordaLosses=function(){return null},xe.getSwordaRevived=function(){return X},xe.getSwordaSurvived=function(){return null},xe.getAxeaAmount=function(){return null},xe.getAxeaLosses=function(){return null},xe.getAxeaRevived=function(){return Z},xe.getAxeaSurvived=function(){return null},xe.getArcheraAmount=function(){return null},xe.getArcheraLosses=function(){return null},xe.getArcheraRevived=function(){return J},
xe.getArcheraSurvived=function(){return null},xe.getSnobaAmount=function(){return null},xe.getSnobaLosses=function(){return null},xe.getSnobaRevived=function(){return $},xe.getSnobaSurvived=function(){return null},xe.getKnightaAmount=function(){return null},xe.getKnightaLosses=function(){return null},xe.getKnightaRevived=function(){return ee},xe.getKnightaSurvived=function(){return null},xe.getRamaAmount=function(){return null},xe.getRamaLosses=function(){return null},xe.getRamaRevived=function(){return te},xe.getRamaSurvived=function(){return null},xe.getCatapultaAmount=function(){return null},xe.getCatapultaLosses=function(){return null},xe.getCatapultaRevived=function(){return ae},xe.getCatapultaSurvived=function(){return null},xe.getTrebuchetaAmount=function(){return null},xe.getTrebuchetaLosses=function(){return null},xe.getTrebuchetaRevived=function(){return ne},xe.getTrebuchetaSurvived=function(){return null},xe.getLcaAmount=function(){return null},xe.getLcaLosses=function(){
return null},xe.getLcaRevived=function(){return ie},xe.getLcaSurvived=function(){return null},xe.getMaaAmount=function(){return null},xe.getMaaLosses=function(){return null},xe.getMaaRevived=function(){return le},xe.getMaaSurvived=function(){return null},xe.getHcaAmount=function(){return null},xe.getHcaLosses=function(){return null},xe.getHcaRevived=function(){return oe},xe.getHcaSurvived=function(){return null},xe.getBerserkeraAmount=function(){return null},xe.getBerserkeraLosses=function(){return null},xe.getBerserkeraRevived=function(){return se},xe.getBerserkeraSurvived=function(){return null},xe})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,u,p,g,m,b,T,_,E,h,f,A){let w,v,S,R=i.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){w.selectedTab=e},I=function(){t.isRunning()?t.stop():t.start()},x=function(){v.setAll(v.decode(w.settings)),t.calculateB();let e=t.getBashpointsAtt(),a=t.getBashpointsDef();e&&(w.totalAtt=e),a&&(w.totalDef=a)},L=function(){
v.setAll(v.decode(w.settings)),t.simulate()
;let e=t.getTarget(),a=t.getBuildingfrom(),n=t.getBuildingto(),i=t.getWallfrom(),l=t.getWallto(),o=t.getWallfrompre(),s=t.getWalltopre(),r=t.getDefencemodifier(),c=t.getDefenceprovisions(),d=t.getStrentghdefend(),u=t.getDefencebashpoint(),p=t.getDefencekilledprovisions(),g=t.getStrongesttypedef(),m=t.getKillrated(),b=t.getDefencesurvivedprovisions(),T=t.getAvailablebeds(),_=t.getAttackmodifier(),E=t.getAttackprovisions(),h=t.getStrentghattack(),f=t.getAttackbashpoint(),A=t.getAttackkilledprovisions(),S=t.getStrongesttypeoff(),R=t.getKillratea(),y=t.getAttacksurvivedprovisions(),k=t.getDoublestrength(),I=t.getSpeardAmount(),x=t.getSpeardLosses(),L=t.getSpeardRevived(),O=t.getSpeardSurvived(),N=t.getSworddAmount(),M=t.getSworddLosses(),P=t.getSworddRevived(),C=t.getSworddSurvived(),z=t.getAxedAmount(),D=t.getAxedLosses(),U=t.getAxedRevived(),G=t.getAxedSurvived(),B=t.getArcherdAmount(),V=t.getArcherdLosses(),W=t.getArcherdRevived(),q=t.getArcherdSurvived(),Y=t.getSnobdAmount(),F=t.getSnobdLosses(),H=t.getSnobdRevived(),j=t.getSnobdSurvived(),K=t.getKnightdAmount(),Q=t.getKnightdLosses(),X=t.getKnightdRevived(),Z=t.getKnightdSurvived(),J=t.getRamdAmount(),$=t.getRamdLosses(),ee=t.getRamdRevived(),te=t.getRamdSurvived(),ae=t.getCatapultdAmount(),ne=t.getCatapultdLosses(),ie=t.getCatapultdRevived(),le=t.getCatapultdSurvived(),oe=t.getTrebuchetdAmount(),se=t.getTrebuchetdLosses(),re=t.getTrebuchetdRevived(),ce=t.getTrebuchetdSurvived(),de=t.getLcdAmount(),ue=t.getLcdLosses(),pe=t.getLcdRevived(),ge=t.getLcdSurvived(),me=t.getMadAmount(),be=t.getMadLosses(),Te=t.getMadRevived(),_e=t.getMadSurvived(),Ee=t.getHcdAmount(),he=t.getHcdLosses(),fe=t.getHcdRevived(),Ae=t.getHcdSurvived(),we=t.getBerserkerdAmount(),ve=t.getBerserkerdLosses(),Se=t.getBerserkerdRevived(),Re=t.getBerserkerdSurvived(),ye=t.getSpearaAmount(),ke=t.getSpearaLosses(),Ie=t.getSpearaRevived(),xe=t.getSpearaSurvived(),Le=t.getSwordaAmount(),Oe=t.getSwordaLosses(),Ne=t.getSwordaRevived(),Me=t.getSwordaSurvived(),Pe=t.getAxeaAmount(),Ce=t.getAxeaLosses(),ze=t.getAxeaRevived(),De=t.getAxeaSurvived(),Ue=t.getArcheraAmount(),Ge=t.getArcheraLosses(),Be=t.getArcheraRevived(),Ve=t.getArcheraSurvived(),We=t.getSnobaAmount(),qe=t.getSnobaLosses(),Ye=t.getSnobaRevived(),Fe=t.getSnobaSurvived(),He=t.getKnightaAmount(),je=t.getKnightaLosses(),Ke=t.getKnightaRevived(),Qe=t.getKnightaSurvived(),Xe=t.getRamaAmount(),Ze=t.getRamaLosses(),Je=t.getRamaRevived(),$e=t.getRamaSurvived(),et=t.getCatapultaAmount(),tt=t.getCatapultaLosses(),at=t.getCatapultaRevived(),nt=t.getCatapultaSurvived(),it=t.getTrebuchetaAmount(),lt=t.getTrebuchetaLosses(),ot=t.getTrebuchetaRevived(),st=t.getTrebuchetaSurvived(),rt=t.getLcaAmount(),ct=t.getLcaLosses(),dt=t.getLcaRevived(),ut=t.getLcaSurvived(),pt=t.getMaaAmount(),gt=t.getMaaLosses(),mt=t.getMaaRevived(),bt=t.getMaaSurvived(),Tt=t.getHcaAmount(),_t=t.getHcaLosses(),Et=t.getHcaRevived(),ht=t.getHcaSurvived(),ft=t.getBerserkeraAmount(),At=t.getBerserkeraLosses(),wt=t.getBerserkeraRevived(),vt=t.getBerserkeraSurvived()
;w.spearDamount=I,w.spearDlosses=x,w.spearDrevived=L,w.spearDsurvived=O,w.swordDamount=N,w.swordDlosses=M,w.swordDrevived=P,w.swordDsurvived=C,w.axeDamount=z,w.axeDlosses=D,w.axeDrevived=U,w.axeDsurvived=G,w.archerDamount=B,w.archerDlosses=V,w.archerDrevived=W,w.archerDsurvived=q,w.snobDamount=Y,w.snobDlosses=F,w.snobDrevived=H,w.snobDsurvived=j,w.knightDamount=K,w.knightDlosses=Q,w.knightDrevived=X,w.knightDsurvived=Z,w.ramDamount=J,w.ramDlosses=$,w.ramDrevived=ee,w.ramDsurvived=te,w.catapultDamount=ae,w.catapultDlosses=ne,w.catapultDrevived=ie,w.catapultDsurvived=le,w.trebuchetDamount=oe,w.trebuchetDlosses=se,w.trebuchetDrevived=re,w.trebuchetDsurvived=ce,w.lcDamount=de,w.lcDlosses=ue,w.lcDrevived=pe,w.lcDsurvived=ge,w.maDamount=me,w.maDlosses=be,w.maDrevived=Te,w.maDsurvived=_e,w.hcDamount=Ee,w.hcDlosses=he,w.hcDrevived=fe,w.hcDsurvived=Ae,w.berserkerDamount=we,w.berserkerDlosses=ve,w.berserkerDrevived=Se,w.berserkerDsurvived=Re,w.spearAamount=ye,w.spearAlosses=ke,
w.spearArevived=Ie,w.spearAsurvived=xe,w.swordAamount=Le,w.swordAlosses=Oe,w.swordArevived=Ne,w.swordAsurvived=Me,w.axeAamount=Pe,w.axeAlosses=Ce,w.axeArevived=ze,w.axeAsurvived=De,w.archerAamount=Ue,w.archerAlosses=Ge,w.archerArevived=Be,w.archerAsurvived=Ve,w.snobAamount=We,w.snobAlosses=qe,w.snobArevived=Ye,w.snobAsurvived=Fe,w.knightAamount=He,w.knightAlosses=je,w.knightArevived=Ke,w.knightAsurvived=Qe,w.ramAamount=Xe,w.ramAlosses=Ze,w.ramArevived=Je,w.ramAsurvived=$e,w.catapultAamount=et,w.catapultAlosses=tt,w.catapultArevived=at,w.catapultAsurvived=nt,w.trebuchetAamount=it,w.trebuchetAlosses=lt,w.trebuchetArevived=ot,w.trebuchetAsurvived=st,w.lcAamount=rt,w.lcAlosses=ct,w.lcArevived=dt,w.lcAsurvived=ut,w.maAamount=pt,w.maAlosses=gt,w.maArevived=mt,w.maAsurvived=bt,w.hcAamount=Tt,w.hcAlosses=_t,w.hcArevived=Et,w.hcAsurvived=ht,w.berserkerAamount=ft,w.berserkerAlosses=At,w.berserkerArevived=wt,w.berserkerAsurvived=vt,e&&(w.target=e,w.buildingfrom=a,w.buildingto=n),i&&(w.wallfrom=i,
w.wallto=l),o&&(w.wallfrompre=o,w.walltopre=s),r&&(w.defenceModifier=r,w.defenceProvisions=c,w.strentghDefend=d,w.defenceBashpoint=u,w.defenceKilledProvisions=p,w.strongestTypeDef=g,w.killrateD=m,w.defenceSurvivedProvisions=b),_&&(w.attackModifier=_,w.attackProvisions=E,w.strentghAttack=h,w.attackBashpoint=f,w.attackKilledProvisions=A,w.strongestTypeOff=S,w.killrateA=R,w.attackSurvivedProvisions=y),k&&(w.doubleStrength=k),T&&(w.availableBeds=T)},O=function(){v.setAll(v.decode(w.settings)),t.calculateT();let e=t.getWoodAmount(),a=t.getClayAmount(),n=t.getIronAmount(),i=t.getLoadAmount(),l=t.getFoodAmount(),o=t.getDefInf(),s=t.getDefCav(),r=t.getDefArc(),c=t.getAttInf(),d=t.getAttCav(),u=t.getAttArc(),p=t.getSpeed(),g=t.getBuildTime(),m=t.getDiscipline(),b=t.getPower();e&&(w.woodTotal=e,w.speedTotal=p,w.attackTotal=b,w.clayTotal=a,w.disciplineTotal=m,w.definfTotal=o,w.ironTotal=n,w.loadTotal=i,w.defcavTotal=s,w.foodTotal=l,w.buildtimeTotal=g,w.defarcTotal=r,w.attackinfTotal=c,
w.attackcavTotal=d,w.attackarcTotal=u)},N=function(){w.presets=h.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},M=function(){w.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),A.notif('success','battleCalculator started')},P=function(){w.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),A.notif('success','battleCalculator stopped')},C=function(){w=a.$new(),w.SETTINGS=n,w.TAB_TYPES=y,w.running=t.isRunning(),w.selectedTab=y.BATTLE,w.settingsMap=l,w.catapulttarget=h.encodeList(d,{textObject:'battle_calculator',disabled:!0}),w.knightitem=h.encodeList(o,{textObject:'battle_calculator',disabled:!0}),w.itemlevel=h.encodeList(r,{textObject:'battle_calculator',disabled:!0}),w.order=h.encodeList(u,{textObject:'battle_calculator',disabled:!0}),w.wall=h.encodeList(p,{textObject:'battle_calculator',disabled:!0}),w.church=h.encodeList(g,{textObject:'battle_calculator',disabled:!0}),w.weaponmaster=h.encodeList(m,{textObject:'battle_calculator',
disabled:!0}),w.ironwalls=h.encodeList(b,{textObject:'battle_calculator',disabled:!0}),w.clinique=h.encodeList(T,{textObject:'battle_calculator',disabled:!0}),w.hospital=h.encodeList(_,{textObject:'battle_calculator',disabled:!0}),w.training=h.encodeList(E,{textObject:'battle_calculator',disabled:!0}),v.injectScope(w),N(),w.selectTab=k,w.calculateB=x,w.totalDef=0,w.totalAtt=0,w.calculateT=O,w.woodTotal=0,w.speedTotal=0,w.attackTotal=0,w.clayTotal=0,w.disciplineTotal=0,w.definfTotal=0,w.ironTotal=0,w.loadTotal=0,w.defcavTotal=0,w.foodTotal=0,w.buildtimeTotal=0,w.defarcTotal=0,w.attackinfTotal=0,w.attackcavTotal=0,w.attackarcTotal=0,w.simulate=L,w.target=0,w.buildingfrom=0,w.buildingto=0,w.wallfrom=0,w.wallto=0,w.wallfrompre=0,w.walltopre=0,w.defenceModifier=0,w.defenceProvisions=0,w.strentghDefend=0,w.defenceBashpoint=0,w.defenceKilledProvisions=0,w.strongestTypeDef=0,w.killrateD=0,w.defenceSurvivedProvisions=0,w.availableBeds=0,w.attackModifier=0,w.attackProvisions=0,
w.strentghAttack=0,w.attackBashpoint=0,w.attackKilledProvisions=0,w.strongestTypeOff=0,w.killrateA=0,w.attackSurvivedProvisions=0,w.doubleStrength=0,w.spearDamount=0,w.spearDlosses=0,w.spearDrevived=0,w.spearDsurvived=0,w.swordDamount=0,w.swordDlosses=0,w.swordDrevived=0,w.swordDsurvived=0,w.axeDamount=0,w.axeDlosses=0,w.axeDrevived=0,w.axeDsurvived=0,w.archerDamount=0,w.archerDlosses=0,w.archerDrevived=0,w.archerDsurvived=0,w.snobDamount=0,w.snobDlosses=0,w.snobDrevived=0,w.snobDsurvived=0,w.knightDamount=0,w.knightDlosses=0,w.knightDrevived=0,w.knightDsurvived=0,w.ramDamount=0,w.ramDlosses=0,w.ramDrevived=0,w.ramDsurvived=0,w.catapultDamount=0,w.catapultDlosses=0,w.catapultDrevived=0,w.catapultDsurvived=0,w.trebuchetDamount=0,w.trebuchetDlosses=0,w.trebuchetDrevived=0,w.trebuchetDsurvived=0,w.lcDamount=0,w.lcDlosses=0,w.lcDrevived=0,w.lcDsurvived=0,w.maDamount=0,w.maDlosses=0,w.maDrevived=0,w.maDsurvived=0,w.hcDamount=0,w.hcDlosses=0,w.hcDrevived=0,w.hcDsurvived=0,
w.berserkerDamount=0,w.berserkerDlosses=0,w.berserkerDrevived=0,w.berserkerDsurvived=0,w.spearAamount=0,w.spearAlosses=0,w.spearArevived=0,w.spearAsurvived=0,w.swordAamount=0,w.swordAlosses=0,w.swordArevived=0,w.swordAsurvived=0,w.axeAamount=0,w.axeAlosses=0,w.axeArevived=0,w.axeAsurvived=0,w.archerAamount=0,w.archerAlosses=0,w.archerArevived=0,w.archerAsurvived=0,w.snobAamount=0,w.snobAlosses=0,w.snobArevived=0,w.snobAsurvived=0,w.knightAamount=0,w.knightAlosses=0,w.knightArevived=0,w.knightAsurvived=0,w.ramAamount=0,w.ramAlosses=0,w.ramArevived=0,w.ramAsurvived=0,w.catapultAamount=0,w.catapultAlosses=0,w.catapultArevived=0,w.catapultAsurvived=0,w.trebuchetAamount=0,w.trebuchetAlosses=0,w.trebuchetArevived=0,w.trebuchetAsurvived=0,w.lcAamount=0,w.lcAlosses=0,w.lcArevived=0,w.lcAsurvived=0,w.maAamount=0,w.maAlosses=0,w.maArevived=0,w.maAsurvived=0,w.hcAamount=0,w.hcAlosses=0,w.hcArevived=0,w.hcAsurvived=0,w.berserkerAamount=0,w.berserkerAlosses=0,w.berserkerArevived=0,
w.berserkerAsurvived=0,w.switchState=I;let e=new f('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,N,!0),e.register(s.ARMY_PRESET_DELETED,N,!0),e.register(s.BATTLE_CALCULATOR_START,M),e.register(s.BATTLE_CALCULATOR_STOP,P),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',w)};return function(){v=t.getSettings(),S=e.addMenuButton4('Kalkulator',10),S.addEventListener('click',C),
