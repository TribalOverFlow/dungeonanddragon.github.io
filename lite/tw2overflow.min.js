...
define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c,d,p,u,g,m,b,T,E,_,f){let w,h,A,v,S=!1,R=!1,y=[];const k='battle_calculator_settings',I={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},x={[o.HALBERD_OF_GUAN_YU]:'spear',[o.PARACELSUS_LONGSWORD]:'sword',[o.THORGARDS_BATTLE_AXE]:'axe',[o.NIMRODS_LONGBOW]:'archer',[o.MIESZKOS_LANCE]:'lc',[o.NIMRODS_COMPOSITE_BOW]:'ma',[o.BAPTISTES_BANNER]:'hc',[o.CAROLS_MORNING_STAR]:'ram',
[o.ALETHEIAS_BONFIRE]:'catapult',[o.VASCOS_SCEPTER]:'snob'},O={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},L={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},N={[u.NO_CHURCH]:50,[u.LEVEL_1]:100,[u.LEVEL_2]:105,[u.LEVEL_3]:110},P={[p.NO_WALL]:0,[p.LEVEL_1]:5,[p.LEVEL_2]:10,[p.LEVEL_3]:15,[p.LEVEL_4]:20,[p.LEVEL_5]:25,[p.LEVEL_6]:30,[p.LEVEL_7]:35,[p.LEVEL_8]:40,[p.LEVEL_9]:45,[p.LEVEL_10]:50,[p.LEVEL_11]:55,[p.LEVEL_12]:60,[p.LEVEL_13]:65,[p.LEVEL_14]:70,[p.LEVEL_15]:75,[p.LEVEL_16]:80,[p.LEVEL_17]:85,[p.LEVEL_18]:90,[p.LEVEL_19]:95,[p.LEVEL_20]:100},M={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},z={
[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},C={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},U={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3},G={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(L,G,U,C,z,M,P,N,I,x,O);const D=function(){y=[];const e=n.getPresetList().getPresets();h[t.PRESET].forEach((function(t){y.push(e[t])}))},B={init:function(){S=!0,w=new e({settingsMap:i,storageKey:k}),w.onChange((function(e,t){h=w.getAll(),t[l.PRESETS]&&D()})),h=w.getAll(),console.log('battleCalculator settings',h),_((function(){D()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,D),a.$on(s.ARMY_PRESET_DELETED,D)},calculateB:function(){
const e=h[t.BASHPOINTS_SPEAR],a=h[t.BASHPOINTS_SWORD],i=h[t.BASHPOINTS_AXE],n=h[t.BASHPOINTS_ARCHER],l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],b=[4,5,1,5,5,6,23,4,12,40,200,25,10],T=0,E=0;function _(){console.log(T,E),A.html(T),v.html(E)}console.log(e),T=e*m[0]+a*m[1]+i*m[2]+n*m[3]+l*m[4]+o*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+u*m[10]+p*m[11]+d*m[12],E=e*b[0]+a*b[1]+i*b[2]+n*b[3]+l*b[4]+o*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+u*b[10]+p*b[11]+d*b[12],setTimeout(_,500)},simulate:function(){}};return B.calculateT=function(){
...
E.calculated={total:V},_.calculated={total:W},f.calculated={total:q},w.calculated={total:Y},v.calculated={total:F},ee.calculated={total:X},te.calculated={total:Z},ae.calculated={total:J},j.calculated={total:j},H.calculated={total:H},K.calculated={total:K},k.calculated={total:O},x.calculated={total:L},I.calculated={total:$},B.calculated={total:Q}}()},B.start=function(){R=!0,f.trigger(s.BATTLE_CALCULATOR_START)},B.stop=function(){R=!1,f.trigger(s.BATTLE_CALCULATOR_STOP)},B.getSettings=function(){return w},B.isInitialized=function(){return S},B.isRunning=function(){return R},B})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
