...
define('two/recruitQueue',['two/Settings','two/recruitQueue/types/errors','two/recruitQueue/types/status','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/farmOverflow/types/logs','two/ready','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,u,p,g,m,T,f){let _,b,h,A=!1,E=!1,w=null,v=[];let S=[],R=[],y=[],k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],F=[];const q='recruit_queue_settings',Y='recruit_queue_log',H={[u.SPEAR]:'spear',[u.SWORD]:'sword',[u.AXE]:'axe',[u.ARCHER]:'archer',[u.LIGHT_CAVALRY]:'light_cavalry',[u.MOUNTED_ARCHER]:'mounted_archer',[u.HEAVT_CAVALRY]:'heavy_cavalry',[u.RAM]:'ram',[u.CATAPULT]:'catapult'};console.log(H);const j=function(){S=[],R=[],y=[],k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],F=[]
;const e=o.getGroupList().getGroups(),t=b[r.GROUP5],a=b[r.GROUP6],n=b[r.GROUP7],i=b[r.GROUP8],l=b[r.GROUP9],s=b[r.GROUP10],c=b[r.GROUP11],d=b[r.GROUP12],u=b[r.GROUP13],p=b[r.GROUP14],g=b[r.GROUP15],m=b[r.GROUP16],T=b[r.GROUP17],f=b[r.GROUP18],_=b[r.GROUP19],h=b[r.GROUP20],A=b[r.GROUP21],E=b[r.GROUP22],w=b[r.GROUP23],v=b[r.GROUP24];t.forEach((function(t){S.push(e[t])})),a.forEach((function(t){R.push(e[t])})),n.forEach((function(t){y.push(e[t])})),i.forEach((function(t){k.push(e[t])})),l.forEach((function(t){M.push(e[t])})),s.forEach((function(t){I.push(e[t])})),c.forEach((function(t){N.push(e[t])})),d.forEach((function(t){x.push(e[t])})),u.forEach((function(t){O.push(e[t])})),p.forEach((function(t){L.push(e[t])})),g.forEach((function(t){P.push(e[t])})),m.forEach((function(t){U.push(e[t])})),T.forEach((function(t){C.push(e[t])})),f.forEach((function(t){z.push(e[t])})),_.forEach((function(t){D.push(e[t])})),h.forEach((function(t){G.push(e[t])})),A.forEach((function(t){B.push(e[t])})),
E.forEach((function(t){V.push(e[t])})),w.forEach((function(t){W.push(e[t])})),v.forEach((function(t){F.push(e[t])}))},K=function(e,t,a){let n={time:f.gameTime(),villageId:e,unit:t,amount:a};return h.unshift(n),h.length>500&&h.splice(h.length-500,h.length),T.set(Y,h),!0},Q={init:function(){A=!0,h=T.get(Y,[],!0),_=new e({settingsMap:c,storageKey:q}),_.onChange((function(e,t){b=_.getAll(),t[d.GROUPS]&&j()})),b=_.getAll(),console.log('recruitQueue settings',b),a.$on(s.GROUPS_CREATED,j),a.$on(s.GROUPS_DESTROYED,j),a.$on(s.GROUPS_UPDATED,j)},ownRecrutation:function(){}};return Q.presetRecrutation=function(){m.trigger(s.RECRUIT_QUEUE_CYCLE_BEGIN),w=f.gameTime()+66e3,K(p.RECRUIT_START,'start','');const e=o.getGroupList(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],c=b[r.GROUP4];var d=e.getGroupVillageIds(t),u=e.getGroupVillageIds(a),g=e.getGroupVillageIds(n),T=e.getGroupVillageIds(c)
;const _=b[r.MIN_PACK1],h=b[r.MIN_PACK2],A=b[r.MIN_PACK3],E=b[r.MIN_PACK4],S=b[r.START_AMOUNT4],R=b[r.START_AMOUNT3],y=b[r.START_AMOUNT9],k=b[r.START_AMOUNT7],M=b[r.START_AMOUNT5],I=b[r.START_AMOUNT6],N=b[r.START_AMOUNT8],x=b[r.START_AMOUNT1],O=b[r.START_AMOUNT2],L=b[r.START_AMOUNT14],P=b[r.START_AMOUNT13],U=b[r.START_AMOUNT19],C=b[r.START_AMOUNT17],z=b[r.START_AMOUNT15],D=b[r.START_AMOUNT16],G=b[r.START_AMOUNT18],B=b[r.START_AMOUNT11],V=b[r.START_AMOUNT12],W=b[r.START_AMOUNT24],F=b[r.START_AMOUNT23],q=b[r.START_AMOUNT29],Y=b[r.START_AMOUNT27],H=b[r.START_AMOUNT25],j=b[r.START_AMOUNT26],Q=b[r.START_AMOUNT28],X=b[r.START_AMOUNT21],Z=b[r.START_AMOUNT22],J=b[r.START_AMOUNT34],$=b[r.START_AMOUNT33],ee=b[r.START_AMOUNT39],te=b[r.START_AMOUNT37],ae=b[r.START_AMOUNT35],ne=b[r.START_AMOUNT36],oe=b[r.START_AMOUNT38],ie=b[r.START_AMOUNT31],le=b[r.START_AMOUNT32],se=b[r.FINAL_AMOUNT4],re=b[r.FINAL_AMOUNT3],ce=b[r.FINAL_AMOUNT9],de=b[r.FINAL_AMOUNT7],ue=b[r.FINAL_AMOUNT5],pe=b[r.FINAL_AMOUNT6],ge=b[r.FINAL_AMOUNT8],me=b[r.FINAL_AMOUNT1],Te=b[r.FINAL_AMOUNT2],fe=b[r.FINAL_AMOUNT14],_e=b[r.FINAL_AMOUNT13],be=b[r.FINAL_AMOUNT19],he=b[r.FINAL_AMOUNT17],Ae=b[r.FINAL_AMOUNT15],Ee=b[r.FINAL_AMOUNT16],we=b[r.FINAL_AMOUNT18],ve=b[r.FINAL_AMOUNT11],Se=b[r.FINAL_AMOUNT12],Re=b[r.FINAL_AMOUNT24],ye=b[r.FINAL_AMOUNT23],ke=b[r.FINAL_AMOUNT29],Me=b[r.FINAL_AMOUNT27],Ie=b[r.FINAL_AMOUNT25],Ne=b[r.FINAL_AMOUNT26],xe=b[r.FINAL_AMOUNT28],Oe=b[r.FINAL_AMOUNT21],Le=b[r.FINAL_AMOUNT22],Pe=b[r.FINAL_AMOUNT34],Ue=b[r.FINAL_AMOUNT33],Ce=b[r.FINAL_AMOUNT39],ze=b[r.FINAL_AMOUNT37],De=b[r.FINAL_AMOUNT35],Ge=b[r.FINAL_AMOUNT36],Be=b[r.FINAL_AMOUNT38],Ve=b[r.FINAL_AMOUNT31],We=b[r.FINAL_AMOUNT32]
...
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,ra)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){st>=3&&(pa>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'sword',amount:pa}),v=[ut='sword',pa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,pa)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){st>=5&&(At>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'axe',amount:At}),v=[ut='axe',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,At)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){st>=9&&(ft>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'archer',amount:ft}),v=[ut='archer',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
K(Va,ut,ft)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){st>=11&&(Kt>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'light_cavalry',amount:Kt}),v=[ut='light_cavalry',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Kt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){st>=13&&(Jt>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'mounted_archer',amount:Jt}),v=[ut='mounted_archer',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Jt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){st>=15&&(aa>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'ram',amount:aa}),v=[ut='ram',aa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,aa)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){st>=17&&(St>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'catapult',amount:St}),v=[ut='catapult',St],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,St)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){st>=21&&(Bt>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'heavy_cavalry',amount:Bt}),v=[ut='heavy_cavalry',Bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Bt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,a,n,o,r,c,d,u,p,g,T,f,b,h,A,E,w,L}()}()}function un(){va=a>0?Fa.length>=2?1:1==Fa.length?.5:.25:0,function(){wa=Ea.length>0?Ea.reduce((function(e,t){return e+t})):0;!function(){Sa=a>0?wa>=936e5?0:wa<936e5&&wa>=864e5?.1:wa<864e5&&wa>=72e6?.25:wa<72e6&&wa>=576e5?.4:wa<576e5&&wa>=432e5?.55:wa<432e5&&wa>=288e5?.7:wa<288e5&&wa>=144e5?.85:wa<144e5&&wa>=72e5?.925:wa<72e5&&wa>=36e5?.9625:1:0
...
Vt=Math.floor(It*S)-1):Yt>Lt&&It>Lt?(ca=Math.floor(Lt*g)-1,ga=Math.floor(Lt*T)-1,Et=Math.floor(Lt*f)-1,_t=Math.floor(Lt*_)-1,Qt=Math.floor(Lt*b)-1,$t=Math.floor(Lt*A)-1,na=Math.floor(Lt*E)-1,Rt=Math.floor(Lt*w)-1,Vt=Math.floor(Lt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ca>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'spear',amount:ca}),v=[ut='spear',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,ca)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Wa>=3&&(ga>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'sword',amount:ga}),v=[ut='sword',ga],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,ga)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Wa>=5&&(Et>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'axe',amount:Et}),v=[ut='axe',Et],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Et)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Wa>=9&&(_t>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'archer',amount:_t}),v=[ut='archer',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,_t)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Wa>=11&&(Qt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'light_cavalry',amount:Qt}),v=[ut='light_cavalry',Qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Qt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Wa>=13&&($t>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'mounted_archer',amount:$t}),v=[ut='mounted_archer',$t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
K(Va,ut,$t)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Wa>=15&&(na>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'ram',amount:na}),v=[ut='ram',na],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,na)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Wa>=17&&(Rt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'catapult',amount:Rt}),v=[ut='catapult',Rt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Rt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Wa>=21&&(Vt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'heavy_cavalry',amount:Vt}),v=[ut='heavy_cavalry',Vt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Vt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3))
;var e,t,n,o,r,c,d,u,p,g,T,f,_,b,A,E,w,S,R,y,k,M}()}()}function pn(){ka=n>0?Xa.length>=2?1:1==Xa.length?.5:.25:0,function(){ya=Ra.length>0?Ra.reduce((function(e,t){return e+t})):0;!function(){Ma=n>0?ya>=936e5?0:ya<936e5&&ya>=864e5?.1:ya<864e5&&ya>=72e6?.25:ya<72e6&&ya>=576e5?.4:ya<576e5&&ya>=432e5?.55:ya<432e5&&ya>=288e5?.7:ya<288e5&&ya>=144e5?.85:ya<144e5&&ya>=72e5?.925:ya<72e5&&ya>=36e5?.9625:1:0;e=Oe-Je,t=Le-$e,a=ye-et,o=Re-tt,r=Ie-at,c=Ne-nt,d=xe-ot,u=ke-it,p=Me-lt,g=Math.floor(X*Ma*ka),T=Math.floor(Z*Ma*ka),f=Math.floor(F*Ma*ka),_=Math.floor(W*Ma*ka),b=Math.floor(H*Ma*ka),h=Math.floor(j*Ma*ka),E=Math.floor(Q*Ma*ka),w=Math.floor(q*Ma*ka),S=Math.floor(Y*Ma*ka),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+h*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],y=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+h*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+h*He[5]+E*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),
...
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,da)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Qa>=3&&(ma>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'sword',amount:ma}),v=[ut='sword',ma],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,ma)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Qa>=5&&(wt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'axe',amount:wt}),v=[ut='axe',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,wt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Qa>=9&&(bt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'archer',amount:bt}),v=[ut='archer',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
K(Va,ut,bt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Qa>=11&&(Xt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'light_cavalry',amount:Xt}),v=[ut='light_cavalry',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Xt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Qa>=13&&(ea>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'mounted_archer',amount:ea}),v=[ut='mounted_archer',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,ea)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Qa>=15&&(oa>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'ram',amount:oa}),v=[ut='ram',oa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,oa)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){Qa>=17&&(yt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'catapult',amount:yt}),v=[ut='catapult',yt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,yt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Qa>=21&&(Wt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:Va,unit_type:'heavy_cavalry',amount:Wt}),v=[ut='heavy_cavalry',Wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),K(Va,ut,Wt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,t,a,o,r,c,d,u,p,g,T,f,_,b,h,E,w,S,R,y,k,M}()}()}function gn(){xa=c>0?nn.length>=2?1:1==nn.length?.5:.25:0,function(){Na=Ia.length>0?Ia.reduce((function(e,t){return e+t})):0;!function(){
Oa=c>0?Na>=936e5?0:Na<936e5&&Na>=864e5?.1:Na<864e5&&Na>=72e6?.25:Na<72e6&&Na>=576e5?.4:Na<576e5&&Na>=432e5?.55:Na<432e5&&Na>=288e5?.7:Na<288e5&&Na>=144e5?.85:Na<144e5&&Na>=72e5?.925:Na<72e5&&Na>=36e5?.9625:1:0;e=Ve-Je,t=We-$e,a=Ue-et,n=Pe-tt,o=De-at,r=Ge-nt,d=Be-ot,u=Ce-it,p=ze-lt,g=Math.floor(ie*Oa*xa),T=Math.floor(le*Oa*xa),f=Math.floor($*Oa*xa),_=Math.floor(J*Oa*xa),b=Math.floor(ae*Oa*xa),h=Math.floor(ne*Oa*xa),A=Math.floor(oe*Oa*xa),w=Math.floor(ee*Oa*xa),S=Math.floor(te*Oa*xa),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+h*Fe[5]+A*Fe[7]+w*Fe[8]+S*Fe[6],y=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+h*qe[5]+A*qe[7]+w*qe[8]+S*qe[6],k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+A*Ye[7]+w*Ye[8]+S*Ye[6],M=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+h*He[5]+A*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||o<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=sn&&(e>=E||p>=E||u>=E||t>=E||a>=E||n>=E||o>=E||r>=E||d>=E)&&y<=rn&&k<=cn&&M<=ln?(ua=g,Ta=T,
...
m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},Q.getLogs=function(){return h},Q.clearLogs=function(){return h=[],T.set(Y,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},Q.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START)},Q.stop=function(e=n.USER_STOP){E=!1,m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&K(p.RECRUIT_STOP,'stop','')},Q.getSettings=function(){return _},Q.isInitialized=function(){return A},Q.isRunning=function(){return E},Q.getNextCycleDate=function(){return w},Q})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop',RECRUIT_QUEUE_CLEAR_LOGS:'recruit_queue_clear_logs',RECRUIT_QUEUE_CYCLE_BEGIN:'recruit_queue_cycle_begin',RECRUIT_QUEUE_CYCLE_END:'recruit_queue_cycle_end'})})),
