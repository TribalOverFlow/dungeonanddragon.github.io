 ...
 */
!function(e,t){const a=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),i=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),_=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||_,this.listeners=[];const n=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,i){i?this.listeners.push(a.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},i='en_us',o={
en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=f.call(o,t)?o[t]:t,e.setJSON(n[t]||n[i])}let s={init:function(){if(t)return!1;t=!0,l(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&l(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,n){const o=function(e,t){let a={};for(let n in e)f.call(t,n)?angular.equals(e[n],t[n])||(a[n]=t[n]):a[n]=e[n];return!angular.equals({},a)&&a},l=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let n in t)(e[n].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,n.get(this.storageKey,{})),this.events={settingsChange:e.onChange||_},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},
r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return f.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){n.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!f.call(this.settingsMap,e))return!1;const n=this.settingsMap[e];'number'===n.inputType&&(t=parseInt(t,10),f.call(n,'min')&&(t=Math.max(n.min,t)),f.call(n,'max')&&(t=Math.min(n.max,t)));const i=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(i,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(f.call(this.settingsMap,t)){const a=this.settingsMap[t];let n=e[t];'number'===a.inputType&&(n=parseInt(n,10),f.call(a,'min')&&(n=Math.max(a.min,n)),f.call(a,'max')&&(n=Math.min(a.max,n))),this.settings[t]=n}
const n=angular.copy(this.settings),i=o(a,n);if(!i)return!1;const l=s(this.settingsMap,i);return this.store(),this.updateScope(),this.events.settingsChange.call(this,i,l,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!f.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(n){e.multiSelect?n.length||(t.settings[a]=[l()]):n||(t.settings[a]=l())}),!0)}))},r.prototype.updateScope=function(){
if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const n=i.getPresetList().getPresets(),o=i.getGroupList().getGroups();return e=e||{},this.each((function(i,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[i]=r.multiSelect?[l()]:l());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){n[t]&&e.push({name:n[t].name,value:t})})),t[i]=e.length?e:[l()]}else{if(!n[s]&&r.disabledOption)return void(t[i]=l());t[i]={name:n[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[i]=e.length?e:[l()]}else{if(!o[s]&&r.disabledOption)return void(t[i]=l());t[i]={name:o[s].name,value:s}}break;default:t[i]={name:e.textObject?g('i18n')(s,a.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[i]=[t[i]])}}else t[i]=s})),t},r.prototype.decode=function(e){let t={};for(let a in e){
let n=this.settingsMap[a];if('select'===n.inputType)if(n.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let n=[];e[a].forEach((function(e){n.push(e.value)})),t[a]=n}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let n=[];switch((t=t||{}).disabled&&n.push(l()),t.type){case'keys':for(let t in e)n.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];n.push({name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){let a=e[t];n.push({name:a.name,value:a.id})}break;case'values':default:for(let i in e){let o=e[i];n.push({name:t.textObject?g('i18n')(o,a.loc.ale,t.textObject):o,value:o})}}return n},r.disabledOption=l,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],n=[],i=!1,r=!1,c=[];angular.extend(s,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=_,d){if(d)r=!1;else{if(i)return c.push(e);if(r)return e(t)}c.push(e),i=!0;let u=[]
;for(let e=0;e<n.length;e++)for(let t=0;t<n[e].length;t++)u.push(n[e][t]);let p=[];return u.forEach((function(e){let a=new Promise((function(a,n){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return n(e.message);e.villages.length&&(t=t.concat(e.villages)),a()}))}));p.push(a)})),Promise.all(p).then((function(){i=!1,r=!0,a.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),a=Math.ceil(e.MAP_SIZE/306);for(let i=0;i<t;i++){n.push([]);let t=306*i,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<a;l++){let a=306*l,s=306..bound(0,a+306).bound(0,e.MAP_SIZE-a);a=a.bound(0,e.MAP_SIZE),n[i].push({x:t,y:a,width:o,height:s})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,n){
let i,o,l,r,c={},d={},u=!1,p=document.querySelector('head'),g=injector.get('httpService'),m=injector.get('templateManagerService'),T=injector.get('$templateCache');return m.load=function(n,i,o){let l;const s=function(e,t,n,o){T.put(l.substr(1),e),angular.isFunction(i)&&i(e,t,n,o),a.$$phase||a.$apply()},r=function(e,t,a,n){angular.isFunction(o)&&o(e,t,a,n)};l=0!==n.indexOf('!')?e.TEMPLATE_PATH_EXT.join(n):n.substr(1),T.get(l.substr(1))?s(T.get(l.substr(1)),304):t.versionMap[l]?g.get(l,s,r):s(d[l],304)},c.init=function(){if(u)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div'),s=document.createElement('div'),d=document.createElement('div'),p=document.createElement('div'),g=document.createElement('div'),m=document.createElement('div'),T=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-menu-container2',e.appendChild(a),s.className='two-menu-container3',e.appendChild(s),
d.className='two-menu-container4',e.appendChild(d),p.className='two-main-button',p.style.display='none',g.className='two-economy-button',g.style.display='none',m.className='two-intrigue-button',m.style.display='none',T.className='two-other-button',T.style.display='none',t.appendChild(p),a.appendChild(g),s.appendChild(m),d.appendChild(T),i=document.createElement('div'),i.className='two-menu',t.appendChild(i),o=document.createElement('div'),o.className='two-menu2',a.appendChild(o),l=document.createElement('div'),l.className='two-menu3',s.appendChild(l),r=document.createElement('div'),r.className='two-menu4',d.appendChild(r),u=!0,
...
n((function(){p.style.display='block',g.style.display='block',m.style.display='block',T.style.display='block'}),['map'])},c.addTemplate=function(e,t){d[e]=t},c.addStyle=function(e){let t=document.createElement('style');t.type='text/css',t.appendChild(document.createTextNode(e)),p.appendChild(t)},c.addMenuButton=function(e,t,n){let o=document.createElement('div');return o.className='btn-border btn-orange button',o.innerHTML=e,o.style.order=t,i.appendChild(o),'string'==typeof n&&(o.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',n,!0,e)})),o.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),i.appendChild(o)},c.addMenuButton2=function(e,t,n){let i=document.createElement('div');return i.className='btn-border btn-orange button',i.innerHTML=e,i.style.order=t,o.appendChild(i),'string'==typeof n&&(i.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',n,!0,e)})),
i.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),o.appendChild(i)},c.addMenuButton3=function(e,t,n){let i=document.createElement('div');return i.className='btn-border btn-orange button',i.innerHTML=e,i.style.order=t,l.appendChild(i),'string'==typeof n&&(i.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',n,!0,e)})),i.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),l.appendChild(i)},c.addMenuButton4=function(e,t,n){let i=document.createElement('div');return i.className='btn-border btn-orange button',i.innerHTML=e,i.style.order=t,r.appendChild(i),'string'==typeof n&&(i.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',n,!0,e)})),i.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),r.appendChild(i)},c.addDivisor=function(e){let t=document.createElement('div')
;t.className='divisor',t.style.order=e,i.appendChild(t)},c.addDivisor2=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,o.appendChild(t)},c.addDivisor3=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,l.appendChild(t)},c.addDivisor4=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,r.appendChild(t)},c.isInitialized=function(){return u},c})),require(['two/ui'],(function(e){if(e.isInitialized())return!1;e.init()})),require(['two/language','two/ready','Lockr'],(function(e,t,n){t((function(){e.init(),function(){const e=n.get('twoverflow_version','1.0.0');if("2.0.0".endsWith('dev'))return!1;const t=function(e){if(/\d+\.\d+\.\d+/.test(e))return parseInt(e.split('.').reduce((e,t)=>e+t),10)};if(t("2.0.0")>t(e)){
const e='https://gitlab.com/relaxeaza/twoverflow/blob/master/CHANGELOG.md',t=g('i18n')('check_changes',a.loc.ale,'common'),i=g('i18n')('firefox_shill',a.loc.ale,'common'),o=g('i18n')('new_version',a.loc.ale,'common',"2.0.0");a.$broadcast(s.NOTIFICATION_NEW,{message:`[b]${o}[/b]\n[url=${e}]${t}[/url]\n\n${i}`}),n.set('twoverflow_version',"2.0.0")}}()}))})),define('Lockr',(function(e,t){'use strict';return t.prefix='',t._getPrefixedKey=function(e,t){return(t=t||{}).noPrefix?e:this.prefix+e},t.set=function(e,t,a){const n=this._getPrefixedKey(e,a);try{localStorage.setItem(n,JSON.stringify({data:t}))}catch(e){}},t.get=function(e,t,a){const n=this._getPrefixedKey(e,a);let i;try{i=JSON.parse(localStorage.getItem(n))}catch(e){i=localStorage[n]?{data:localStorage.getItem(n)}:null}return null===i?t:'object'==typeof i&&void 0!==i.data?i.data:t},t})),define('two/about',[],(function(){let e=!1,t={isInitialized:function(){return e},init:function(){e=!0}};return t})),
define('two/about/ui',['two/ui'],(function(e){let t;const n=function(e){t.selectedTab=e},i=function(){t=a.$new(),t.selectTab=n,c.getModal('!twoverflow_about_window',t)};return function(){e.addDivisor4(189),e.addMenuButton4('O mnie',190).addEventListener('click',(function(){i()})),
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['two/utils','queues/EventQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,n){let r;var c=injector.get('overviewService'),d=!1,u=!1,p=i.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=i.getSelectedCharacter(),T=m.tribeById[0],_=m.getVillageList(),f=[],b=m.data.character_id,h=m.data.character_name,A=[],E=[],w=[n.LIGHT_CAVALRY,n.HEAVY_CAVALRY,n.AXE,n.SWORD,n.RAM,n.SNOB,n.TREBUCHET];var v=function(){o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:T},(function(e){for(var t=e.members,a=0;a<t.length;a++)E.push(t[a].id)})),_.forEach((function(e){f.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:f},S),setTimeout(v,6e4)},S=function(e){
for(var t,a=[],n=e.commands,i=0;i<n.length;i++)if(c.formatCommand(n[i]),E.includes(n[i].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+n[i].origin_character_id+' Rodzaj '+n[i].command_type);else if('attack'==n[i].command_type)if(A.includes(n[i].command_id))console.log('Już wysłano powiadomienie');else{A.push(n[i].command_id),n[i].slowestUnit=R(n[i]);var s=n[i].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',p='';'sword'==n[i].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',u='sword'):'axe'==n[i].slowestUnit?(p=' [color=e21f1f]TOPORNIK[/color]',u='axe'):'ram'==n[i].slowestUnit?(p=' [color=730202]TARAN[/color]',u='ram'):'snob'==n[i].slowestUnit?(p=' [color=ffee00]SZLACHCIC[/color]',u='snob'):'trebuchet'==n[i].slowestUnit?(p=' [color=494500]TREBUSZ[/color]',u='trebuchet'):'light_cavalry'==n[i].slowestUnit?(p=' [color=d96a19]LEKKA KAWALERIA[/color]',
u='light_cavalry'):'heavy_cavalry'==n[i].slowestUnit&&(p=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+p+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+n[i].target_village_id+']'+n[i].target_village_name+'[/village][b] Gracz cel: [/b][player='+b+']'+h+'[/player][b] [br]Wioska pochodzenia: [/b][village='+n[i].origin_village_id+']'+n[i].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+n[i].origin_character_id+']'+n[i].origin_character_name+'[/player][/size]');var g=a.join();'snob'==u||'trebuchet'==u?(o.emit(l.MESSAGE_REPLY,{message_id:7749,message:g}),a=[]):(o.emit(l.MESSAGE_REPLY,{message_id:7750,message:g}),a=[])}},R=function(t){const a={x:t.origin_x,y:t.origin_y},n={x:t.target_x,y:t.target_y};return w.map((function(i){const o=e.getTravelTime(a,n,{[i]:1},t.command_type,{},!1);return{unit:i,
diff:Math.abs(o-t.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},y={init:function(){d=!0},start:function(){t.trigger(s.ALERT_SENDER_STARTED),u=!0,v()},stop:function(){t.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return y})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton('Wartownik',60,g('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'alert_sender')))})),i.register(s.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),
o.classList.add('btn-red')})),i.register(s.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,a,n,i){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.ALERT_SENDER_STARTED,(function(){n.set(o,!0)})),i.register(s.ALERT_SENDER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c){let d,u,p=!1,g=!1,m=[],T=[];const _='army_helper_settings',f={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',
[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(f);const b=function(){m=[],T=[];const e=i.getGroupList().getGroups(),a=u[t.GROUP3],n=u[t.GROUP4];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){T.push(e[t])}))},h={init:function(){p=!0,d=new e({settingsMap:n,storageKey:_}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&b()})),u=d.getAll(),console.log('armyHelper settings',u),a.$on(s.GROUPS_CREATED,b),a.$on(s.GROUPS_DESTROYED,b),a.$on(s.GROUPS_UPDATED,b)},start:function(){g=!0,c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return h})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'
})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u){let p,m,T,_=i.getGroupList();const f={ARMY:'army',BALANCER:'balancer',LOGS:'logs'},b=function(e){p.selectedTab=e},h=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()},E=function(){p.groups=r.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},w=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},v=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=f,p.running=t.isRunning(),p.selectedTab=f.ARMY,p.settingsMap=o,p.unit=r.encodeList(l,{
...
KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,r,c,d,u,p,g,m,T,_,f){let b,h,A=!1,E=injector.get('overviewService'),w=[],v=!1,S={},R={},y={reverse:!1,column:n.TIME_COMPLETED};const k='attack_view_filters',M={},I={},N=function(){const e=[c.COMMAND_TYPES],t=i.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let n in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?a[e[t]].push(r.ATTACK):n===r.SUPPORT?a[e[t]].push(r.SUPPORT):n===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}R=a,
R.village=S[c.VILLAGE]?[t]:[]},x=function(){B.loadCommands()},O=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},L=function(e,t){for(let e=0;e<w.length;e++)w[e].command_id===t.command_id&&w.splice(e,1);f.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},P=function(e,t){for(let e=0;e<w.length;e++)w[e].target_village_id===t.village_id?(w[e].target_village_name=t.name,w[e].targetVillage.name=t.name):w[e].origin_village_id===t.village_id&&(w[e].origin_village_name=t.name,w[e].originVillage.name=t.name);f.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},U=function(e,t){R[c.VILLAGE].length&&(R[c.VILLAGE]=[t],B.loadCommands())},C=function(e){const a={x:e.origin_x,y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(i){const o=t.getTravelTime(a,n,{[i]:1},e.command_type,{},!1);return{unit:i,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},z=function(e,t){return e.sort((function(e,a){
return m.actualDistance(t,e)-m.actualDistance(t,a)}))},D=function(e,t){let a=0;if(_.hasTownDataInChunk(e.x,e.y)){const a=_.loadTownData(e.x,e.y,25,25,25),n=i.getSelectedCharacter().getTribeId(),o=i.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=z(r,e);else if(c.length)l=z(c,e);else{if(!n)return t(!1);{const a=s.filter((function(e){return e.tribe_id===n}));if(!a.length)return t(!1);l=z(a,e)}}return t(l[0])}const n=T.scaledGridCoordinates(e.x,e.y,25,25,25);_.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===n.length&&D(e,t)}))},G=function(e){w=e.commands;for(let e=0;e<w.length;e++)E.formatCommand(w[e]),w[e].slowestUnit=C(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[w])};let B={
loadCommands:function(){const e=b.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:R[c.COMMAND_TYPES],villages:R[c.VILLAGE]},G)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return y},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],N(),g.set(k,S),B.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),B.loadCommands()},setCommander:function(e,a){D(e.targetVillage,(function(n){const i=e.targetVillage,o=n,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),v.addCommand(i,o,a,h.OUT,s,{},l,p.WALL),v.isRunning()||v.start()}))},commandQueueEnabled:function(){return!!v},isInitialized:function(){return A},init:function(){for(let e=0;e<d.length;e++)M[d[e]]=!0;for(let e in r)I[r[e]]=!0;try{v=require('two/commandQueue'),
h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(I),[c.INCOMING_UNITS]:angular.copy(M),[c.VILLAGE]:!1};A=!0,b=i.getSelectedCharacter().getGlobalInfo(),S=g.get(k,t,!0),e((function(){N(),a.$on(s.COMMAND_INCOMING,x),a.$on(s.COMMAND_CANCELLED,O),a.$on(s.MAP_SELECTED_VILLAGE,U),a.$on(s.VILLAGE_NAME_CHANGED,P),a.$on(s.COMMAND_IGNORED,L),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,o,l,d,u,T,_,f,b,h){let A,E;const w=function(){return Date.now()/1e3},v=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setCommander(e,n)},R=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=A.pagination.offset,t=A.pagination.limit
;A.visibleCommands=A.commands.slice(e,e+t),A.pagination.count=A.commands.length},k=function(){const e=Date.now();for(let t=0;t<A.commands.length;t++)100===A.commands[t].model.percent(e)&&A.commands.splice(t,1);y()},M=function(e,a){t.toggleFilter(e,a),A.filters=t.getFilters()},I=function(e){t.toggleSorting(e),A.sorting=t.getSortings()},N=function(){A.commands=t.getCommands()},x=function(){A.selectedVillageId=i.getSelectedVillage().getId()},O=function(){A=a.$new(),A.commandQueueEnabled=t.commandQueueEnabled(),A.commands=t.getCommands(),A.selectedVillageId=i.getSelectedVillage().getId(),A.filters=t.getFilters(),A.sorting=t.getSortings(),A.UNIT_TYPES=_,A.FILTER_TYPES=u,A.COMMAND_TYPES=d,A.UNIT_SPEED_ORDER=T,A.COLUMN_TYPES=l,A.pagination={count:A.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},A.openCharacterProfile=r.openCharacterProfile,A.openVillageInfo=r.openVillageInfo,A.jumpToVillage=p.jumpToVillage,A.now=w,A.copyTimeModal=v,A.removeTroops=S,A.switchWindowSize=R,
...
g.isInitialized=function(){return t},g})),define('two/autoCollector/events',[],(function(){angular.extend(s,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton2('Kolekcjoner',40,g('i18n')('description',a.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'auto_collector')))})),i.register(s.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
i.register(s.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,n,r,c){let d=!1,u=!1,p=!1,g=injector.get('secondVillageService');const m=function(){var e;e=T,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(g.hasFinishedLastJob(t.jobs))p=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),_.stop();else{let a=new c(t);i.getSelectedCharacter().setSecondVillage(a),e()}}))},T=function(){let e=i.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const a=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t<r.server2ClientTime(e[a].time_completed))return e[a];return!1}(e.data.jobs);if(a){const e=r.server2ClientTime(a.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const n=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t>=r.server2ClientTime(e[a].time_completed)&&!e[a].collected)return a;return!1}(e.data.jobs);if(n)return s=n,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:i.getSelectedVillage().getId(),job_id:s});var s;const c=g.getCurrentDayJobs(e.data.jobs,e.data.day),d=g.getCollectedJobs(e.data.jobs),p=i.getSelectedVillage().getResources().getResources(),T=g.getAvailableJobs(c,d,p,[]);if(T){const e=function(e){let a=!1;return t.each(e,(function(e){return a=e,!1})),a}(T);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:i.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=T[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let _={start:function(){if(!d||p)return!1;n.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,m()},stop:function(){if(!d)return!1;n.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!g.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){g.hasFinishedLastJob(e.jobs)?(p=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(a.$on(s.SECOND_VILLAGE_VILLAGE_CREATED,m),a.$on(s.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=_})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,a,n,i){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),a(),e((function(){n.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),i.register(s.AUTO_COLLECTOR_STARTED,(function(){n.set(o,!0)})),i.register(s.AUTO_COLLECTOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/autoFoundator',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,n=!1;const r=function(){if(!n)return!1;console.log('Fundator uruchomiony'),
i.getSelectedCharacter().getVillageList().forEach((function(e,t){var a=e.getResources().getComputed(),n=a.wood,i=a.clay,s=a.iron,r=n.currentStock,c=i.currentStock,d=s.currentStock,u=Math.round(.02*r)+1,p=Math.round(.02*d)+1,g=Math.round(.02*c)+1;setTimeout((function(){o.emit(l.TRIBE_SKILL_DONATE,{village_id:e.getId(),crowns:0,resources:{wood:u,clay:g,iron:p}})}),t*Math.random()*3e3),console.log('Wykonano darowizne na plemię: '+e.getName()+' drewno: '+u+', glina: '+g+', żelazo: '+p)})),setTimeout(c,1e3)};function c(){setTimeout(r,36e5)}let d={init:function(){a=!0},start:function(){t.trigger(s.AUTO_FOUNDATOR_STARTED),n=!0,r()},stop:function(){t.trigger(s.AUTO_FOUNDATOR_STOPPED),n=!1},isRunning:function(){return n},isInitialized:function(){return a}};return d})),define('two/autoFoundator/events',[],(function(){angular.extend(s,{AUTO_FOUNDATOR_STARTED:'auto_foundator_started',AUTO_FOUNDATOR_STOPPED:'auto_foundator_stopped'})})),
define('two/autoFoundator/ui',['two/ui','two/autoFoundator','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return e.addDivisor3(71),o=e.addMenuButton3('Fundator',70,g('i18n')('description',a.loc.ale,'auto_foundator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_foundator'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'auto_foundator')))})),i.register(s.AUTO_FOUNDATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.AUTO_FOUNDATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.AUTO_FOUNDATOR_STARTED),opener}})),require(['two/ready','two/autoFoundator','two/autoFoundator/ui','Lockr','queues/EventQueue','two/autoFoundator/events'],(function(e,t,a,n,i){const o='auto_foundator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){
n.get(o,!1,!0)&&t.start(),i.register(s.AUTO_FOUNDATOR_STARTED,(function(){n.set(o,!0)})),i.register(s.AUTO_FOUNDATOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,n=!1;let r={init:function(){a=!0}};return r.start=function(){t.trigger(s.AUTO_HEALER_STARTED),n=!0,function(){if(!n)return!1;console.log('Medyk uruchomiony'),i.getSelectedCharacter().getVillageList().forEach((function(e,t){let a=e.hospital.patients.healed;0==a.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia'):setTimeout((function(){a.forEach((function(t,n){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),3e3*n),console.log('W wiosce: '+e.getName()+' wyleczono: '+a.units)}))}),5e3*t)})),console.log('Medyk zatrzymany'),r.stop()}()},r.stop=function(){t.trigger(s.AUTO_HEALER_STOPPED),n=!1},r.isRunning=function(){return n},r.isInitialized=function(){return a
},r})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton('Medyk',120,g('i18n')('description',a.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'auto_healer')))})),i.register(s.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,a,n,i){
const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.AUTO_HEALER_STARTED,(function(){n.set(o,!0)})),i.register(s.AUTO_HEALER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/autoWithdraw',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,n=!1,i={init:function(){a=!0},start:function(){t.trigger(s.AUTO_WITHDRAW_STARTED),n=!0},stop:function(){t.trigger(s.AUTO_WITHDRAW_STOPPED),n=!1},isRunning:function(){return n},isInitialized:function(){return a}};return i})),define('two/autoWithdraw/events',[],(function(){angular.extend(s,{AUTO_WITHDRAW_STARTED:'auto_withdraw_started',AUTO_WITHDRAW_STOPPED:'auto_withdraw_stopped'})})),define('two/autoWithdraw/ui',['two/ui','two/autoWithdraw','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton('Dezerter',40,g('i18n')('description',a.loc.ale,'auto_withdraw')),
o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_withdraw'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'auto_withdraw')))})),i.register(s.AUTO_WITHDRAW_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.AUTO_WITHDRAW_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.AUTO_WITHDRAW_STARTED),opener}})),require(['two/ready','two/autoWithdraw','two/autoWithdraw/ui','Lockr','queues/EventQueue','two/autoWithdraw/events'],(function(e,t,a,n,i){const o='auto_withdraw_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.AUTO_WITHDRAW_STARTED,(function(){n.set(o,!0)})),i.register(s.AUTO_WITHDRAW_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
...
let w,v,S=!1,R=!1,y=[],k=null,M=null,I=null,N=null,x=null,O=null,L=null,P=null,U=null,C=null,z=null,D=null,G=null,B=null,V=null,W=null,F=null,q=null,Y=null,H=null,j=null,K=null,Q=null,X=null,Z=null,J=null,$=null,ee=null,te=null,ae=null,ne=null,ie=null,oe=null,le=null,se=null,re=null,ce=null,de=null,ue=null,pe=null,ge=null,me=null,Te=null,_e=null,fe=null,be=null,he=null,Ae=null,Ee=null,we=null,ve=null,Se=null,Re=null,ye=null,ke=null,Me=null,Ie=null,Ne=null,xe=null,Oe=null,Le=null,Pe=null,Ue=null,Ce=null,ze=null,De=null,Ge=null,Be=null,Ve=null,We=null,Fe=null,qe=null,Ye=null,He=null,je=null,Ke=null,Qe=null,Xe=null,Ze=null,Je=null,$e=null,et=null,tt=null,at=null,nt=null,it=null,ot=null,lt=null,st=null,rt=null,ct=null,dt=null,ut=null,pt=null,gt=null,mt=null,Tt=null,_t=null,ft=null,bt=null,ht=null,At=null,Et=null,wt=null,vt=null,St=null,Rt=null,yt=null,kt=null,Mt=null,It=null,Nt=null,xt=null,Ot=null,Lt=null,Pt=null,Ut=null,Ct=null,zt=null,Dt=null,Gt=null,Bt=null,Vt=null,Wt=null,Ft=null,qt=null,Yt=null,Ht=null,jt=null,Kt=null,Qt=null,Xt=null,Zt=null,Jt=null,$t=null,ea=null,ta=null,aa=null,na=null,ia=null,oa=null,la=null,sa=null,ra=null,ca=null,da=null,ua=null,pa=null,ga=null,ma=null,Ta=null,_a=null,fa=null,ba=null,ha=null,Aa=null,Ea=null,wa=null,va=null,Sa=null,Ra=null,ya=null,ka=null,Ma=null,Ia=null,Na=null,xa=null
...
[b.LEVEL_2]:'level_2',[b.LEVEL_3]:'level_3',[b.LEVEL_4]:'level_4',[b.LEVEL_5]:'level_5',[b.LEVEL_6]:'level_6',[b.LEVEL_7]:'level_7',[b.LEVEL_8]:'level_8',[b.LEVEL_9]:'level_9',[b.LEVEL_10]:'level_10'};console.log(Va,Ba,Ga,Da,za,Ca,La,Pa,Ua);const Wa=function(){y=[];const e=i.getPresetList().getPresets();v[t.PRESET].forEach((function(t){y.push(e[t])}))},Fa={init:function(){S=!0,w=new e({settingsMap:n,storageKey:Oa}),w.onChange((function(e,t){v=w.getAll(),t[r.PRESETS]&&Wa()})),v=w.getAll(),console.log('battleCalculator settings',v),A((function(){Wa()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,Wa),a.$on(s.ARMY_PRESET_DELETED,Wa)},getPresetUnits:function(){y=v[t.PRESET],o.emit(l.GET_PRESETS,{},(function(e){for(xa=0;xa<e.presets.length;xa++)e.presets[xa].id==y&&(ia=e.presets[xa].units.spear,oa=e.presets[xa].units.sword,la=e.presets[xa].units.axe,sa=e.presets[xa].units.archer,ra=e.presets[xa].units.light_cavalry,ca=e.presets[xa].units.mounted_archer,da=e.presets[xa].units.heavy_cavalry,
ua=e.presets[xa].units.ram,pa=e.presets[xa].units.catapult,ga=e.presets[xa].units.snob,ma=e.presets[xa].units.knight,Ta=e.presets[xa].units.trebuchet,_a=e.presets[xa].units.doppelsoldner)}))},getVillageUnits:function(){Na=v[t.BATTLE_VILLAGE_ID],o.emit(l.VILLAGE_UNIT_INFO,{village_id:Na},(function(e){ba=e.available_units.axe.total,fa=e.available_units.archer.total,ha=e.available_units.catapult.total,Aa=e.available_units.doppelsoldner.total,Ea=e.available_units.heavy_cavalry.total,wa=e.available_units.knight.total,va=e.available_units.light_cavalry.total,Sa=e.available_units.mounted_archer.total,Ra=e.available_units.ram.total,ya=e.available_units.snob.total,ka=e.available_units.spear.total,Ma=e.available_units.sword.total,Ia=e.available_units.trebuchet.total}))},calculateB:function(){
const e=v[t.BASHPOINTS_SPEAR],a=v[t.BASHPOINTS_SWORD],n=v[t.BASHPOINTS_AXE],i=v[t.BASHPOINTS_ARCHER],o=v[t.BASHPOINTS_LC],l=v[t.BASHPOINTS_MA],s=v[t.BASHPOINTS_HC],r=v[t.BASHPOINTS_RAM],c=v[t.BASHPOINTS_CATAPULT],d=v[t.BASHPOINTS_DOPPELSOLDNER],u=v[t.BASHPOINTS_TREBUCHET],p=v[t.BASHPOINTS_SNOB],g=v[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],T=[4,5,1,5,5,6,23,4,12,40,200,25,10];k=e*m[0]+a*m[1]+n*m[2]+i*m[3]+o*m[4]+l*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],M=e*T[0]+a*T[1]+n*T[2]+i*T[3]+o*T[4]+l*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+p*T[10]+u*T[11]+d*T[12]}};return Fa.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],o=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=0,c=0,d=0,u=0,p=0,g=0,m=0,T=0,_=0,f=0,b=0,h=0,A=0,E=0,w=0,S=0,R=0,y=0,k=0,M=0,I=0,N=0,x=0,O=0,L=0,P=0,U=0,C=0,z=0,D=0,G=0,B=0,V=0,W=0,F=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=0,Ta=0,_a=0,fa=0,ba=0,ha=0,Aa=0,Ea=0,wa=0,va=0,Sa=0,Ra=0,ya=0,ka=0,Ma=0,Ia=0,Na=0,xa=0,Oa=0,La=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,Fa=0,qa=0,Ya=0,Ha=0,ja=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,Tn=0,_n=0,fn=0,bn=0,hn=0,An=0,En=0,wn=0,vn=[1,1],Sn=[1,1],Rn=[1,1],yn=[1,1],kn=[1,1],Mn=[1,1],In=[1,1],Nn=[1,1],xn=[1,1],On=[1,1],Ln=[1,1],Pn=[1,1],Un=[1,1],Cn=[1,1],zn=[1,1],Dn=[1,1],Gn=[1,1],Bn=[1,1],Vn=[1,1],Wn=[1,1],Fn=[1,1],qn=[1,1],Yn=[1,1],Hn=[1,1],jn=[1,1],Kn=[1,1],Qn=[1,1],Xn=[1,1],Zn=[1,1],Jn=[1,1],$n=[1,1],ei=[1,1],ti=[1,1],ai=[1,1],ni=[1,1],ii=[1,1],oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,Ti=0,_i=0,fi=0,bi=0,hi=0,Ai=0,Ei=0,wi=0,vi=0,Si=0,Ri=0,yi=0,ki=0,Mi=0,Ii=0,Ni=[1,1],xi=0,Oi=0,Li=0,Pi=0,Ui=0,Ci=0,zi=0,Di=0,Gi=0,Bi=0,Vi=0,Wi=0,Fi=0,qi=0,Yi=0,Hi=0,ji=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,To=[1,1],_o=[1,1],fo=[1,1],bo=[1,1],ho=[1,1],Ao=[1,1],Eo=[1,1],wo=[1,1],vo=[1,1],So=0,Ro=0,yo=0,ko=0,Mo=0,Io=0,No=0,xo=0,Oo=0,Lo=0,Po=0,Uo=0,Co=0,zo=0,Do=0,Go=0,Bo=0,Vo=0,Wo=0,Fo=0,qo=0,Yo=0,Ho=0,jo=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,Tl=0,_l=0,fl=0,bl=0,hl=0,Al=0,El=0,wl=0,vl=0,Sl=0,Rl=0,yl=0,kl=0,Ml=0,Il=0,Nl=0,xl=0,Ol=0,Ll=0,Pl=0,Ul=0,Cl=0,zl=0,Dl=0,Gl=0,Bl=0,Vl=0,Wl=0,Fl=0,ql=0,Yl=0,Hl=1,jl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,Ts=0,_s=0,fs=0,bs=0,hs=0,As=0,Es=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Ms=0,Is=0,Ns=0,xs=0,Os=0,Ls=0,Ps=0,Us=0,Cs=0,zs=0,Ds=0,Gs=0,Bs=0,Vs=0,Ws=0,Fs=0,qs=0,Ys=0,Hs=0,js=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,Tr=0,_r=0,fr=0,br=0,hr=0,Ar=0,Er=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Mr=0,Ir=0,Nr=0,xr=0,Or=0,Lr=0,Pr=0,Ur=0,Cr=0,zr=0,Dr=0,Gr=0,Br=0,Vr=0,Wr=0,Fr=0,qr=0,Yr=0,Hr=0,jr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,Tc=0,_c=0,fc=0,bc=0,hc=0,Ac=0,Ec=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Mc=0,Ic=0,Nc=0,xc=0,Oc=0,Lc=0,Pc=0,Uc=0,Cc=0,zc=0,Dc=0,Gc=0,Bc=0,Vc=0,Wc=0,Fc=0,qc=0,Yc=0,Hc=0,jc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,Td=0,_d=0,fd=0,bd=0,hd=0,Ad=0,Ed=0,wd=0,vd=0,Sd=0
...
Ii='level_1'==b?100:'level_2'==b?129:'level_3'==b?167:'level_4'==b?215:'level_5'==b?278:'level_6'==b?359:'level_7'==b?464:'level_8'==b?599:'level_9'==b?774:'level_10'==b?1e3:0,console.log(Ii),Gt='level_1'==T?1:'level_2'==T?2:'level_3'==T?3:'level_4'==T?4:'level_5'==T?5:'level_6'==T?6:'level_7'==T?7:'level_8'==T?8:'level_9'==T?9:'level_10'==T?10:'level_11'==T?11:'level_12'==T?12:'level_13'==T?13:'level_14'==T?14:'level_15'==T?15:'level_16'==T?16:'level_17'==T?17:'level_18'==T?18:'level_19'==T?19:'level_20'==T?20:0,console.log(Gt),Bn='battle.lance'==A&'level_1'==R?[1.05,1.1]:'battle.lance'==A&'level_2'==R?[1.1,1.2]:'battle.lance'==A&'level_3'==R?[1.2,1.3]:[1,1],console.log(Bn),Mn='battle.battleaxe'==A&'level_1'==R?[1.05,1.1]:'battle.battleaxe'==A&'level_2'==R?[1.1,1.2]:'battle.battleaxe'==A&'level_3'==R?[1.2,1.3]:[1,1],console.log(Mn),qn='battle.compositebow'==A&'level_1'==R?[1.05,1.1]:'battle.compositebow'==A&'level_2'==R?[1.1,1.2]:'battle.compositebow'==A&'level_3'==R?[1.2,1.3]:[1,1],
console.log(qn),Jn='battle.halberd'==A&'level_1'==R?[1.1,1.05]:'battle.halberd'==A&'level_2'==R?[1.2,1.1]:'battle.halberd'==A&'level_3'==R?[1.3,1.2]:[1,1],console.log(Jn),ai='battle.longsword'==A&'level_1'==R?[1.1,1.05]:'battle.longsword'==A&'level_2'==R?[1.2,1.1]:'battle.longsword'==A&'level_3'==R?[1.3,1.2]:[1,1],Sn='battle.longbow'==A&'level_1'==R?[1.1,1.05]:'battle.longbow'==A&'level_2'==R?[1.2,1.1]:'battle.longbow'==A&'level_3'==R?[1.3,1.2]:[1,1],Cn='battle.banner'==A&'level_1'==R?[1.1,1.1]:'battle.banner'==A&'level_2'==R?[1.2,1.2]:'battle.banner'==A&'level_3'==R?[1.3,1.3]:[1,1],Kn='battle.star'==A&'level_1'==R?[1.05,1.25]:'battle.star'==A&'level_2'==R?[1.1,1.5]:'battle.star'==A&'level_3'==R?[1.2,2]:[1,1],On='battle.bonfire'==A&'level_1'==R?[1.05,1.25]:'battle.bonfire'==A&'level_2'==R?[1.1,1.5]:'battle.bonfire'==A&'level_3'==R?[1.2,2]:[1,1],Vn='battle.lance'==E&'level_1'==y?[1.05,1.1]:'battle.lance'==E&'level_2'==y?[1.1,1.2]:'battle.lance'==E&'level_3'==y?[1.2,1.3]:[1,1],
In='battle.battleaxe'==E&'level_1'==y?[1.05,1.1]:'battle.battleaxe'==E&'level_2'==y?[1.1,1.2]:'battle.battleaxe'==E&'level_3'==y?[1.2,1.3]:[1,1],Yn='battle.compositebow'==E&'level_1'==y?[1.05,1.1]:'battle.compositebow'==E&'level_2'==y?[1.1,1.2]:'battle.compositebow'==E&'level_3'==y?[1.2,1.3]:[1,1],$n='battle.halberd'==E&'level_1'==y?[1.1,1.05]:'battle.halberd'==E&'level_2'==y?[1.2,1.1]:'battle.halberd'==E&'level_3'==y?[1.3,1.2]:[1,1],ni='battle.longsword'==E&'level_1'==y?[1.1,1.05]:'battle.longsword'==E&'level_2'==y?[1.2,1.1]:'battle.longsword'==E&'level_3'==y?[1.3,1.2]:[1,1],Rn='battle.longbow'==E&'level_1'==y?[1.1,1.05]:'battle.longbow'==E&'level_2'==y?[1.2,1.1]:'battle.longbow'==E&'level_3'==y?[1.3,1.2]:[1,1],zn='battle.banner'==E&'level_1'==y?[1.1,1.1]:'battle.banner'==E&'level_2'==y?[1.2,1.2]:'battle.banner'==E&'level_3'==y?[1.3,1.3]:[1,1],Qn='battle.star'==E&'level_1'==y?[1.05,1.25]:'battle.star'==E&'level_2'==y?[1.1,1.5]:'battle.star'==E&'level_3'==y?[1.2,2]:[1,1],
Ln='battle.bonfire'==E&'level_1'==y?[1.05,1.25]:'battle.bonfire'==E&'level_2'==y?[1.1,1.5]:'battle.bonfire'==E&'level_3'==y?[1.2,2]:[1,1],Wn='battle.lance'==w&'level_1'==k?[1.05,1.1]:'battle.lance'==w&'level_2'==k?[1.1,1.2]:'battle.lance'==w&'level_3'==k?[1.2,1.3]:[1,1],Nn='battle.battleaxe'==w&'level_1'==k?[1.05,1.1]:'battle.battleaxe'==w&'level_2'==k?[1.1,1.2]:'battle.battleaxe'==w&'level_3'==k?[1.2,1.3]:[1,1],Hn='battle.compositebow'==w&'level_1'==k?[1.05,1.1]:'battle.compositebow'==w&'level_2'==k?[1.1,1.2]:'battle.compositebow'==w&'level_3'==k?[1.2,1.3]:[1,1],ei='battle.halberd'==w&'level_1'==k?[1.1,1.05]:'battle.halberd'==w&'level_2'==k?[1.2,1.1]:'battle.halberd'==w&'level_3'==k?[1.3,1.2]:[1,1],ii='battle.longsword'==w&'level_1'==k?[1.1,1.05]:'battle.longsword'==w&'level_2'==k?[1.2,1.1]:'battle.longsword'==w&'level_3'==k?[1.3,1.2]:[1,1],yn='battle.longbow'==w&'level_1'==k?[1.1,1.05]:'battle.longbow'==w&'level_2'==k?[1.2,1.1]:'battle.longbow'==w&'level_3'==k?[1.3,1.2]:[1,1],
...
Zn=Jn[0]>=$n[0]&&Jn[0]>=ei[0]?Jn:$n[0]>=Jn[0]&&$n[0]>=ei[0]?$n:ei[0]>=Jn[0]&&ei[0]>=$n[0]?ei:[1,1],ti=ai[0]>=ni[0]&&ai[0]>=ii[0]?ai:ni[0]>=ai[0]&&ni[0]>=ii[0]?ni:ii[0]>=ai[0]&&ii[0]>=ni[0]?ii:[1,1],vn=Sn[0]>=Rn[0]&&Sn[0]>=yn[0]?Sn:Rn[0]>=Sn[0]&&Rn[0]>=yn[0]?Rn:yn[0]>=Sn[0]&&yn[0]>=Rn[0]?yn:[1,1],ho='battle.lance'==S&'level_1'==M?[1.05,1.1]:'battle.lance'==S&'level_2'==M?[1.1,1.2]:'battle.lance'==S&'level_3'==M?[1.2,1.3]:[1,1],_o='battle.battleaxe'==S&'level_1'==M?[1.05,1.1]:'battle.battleaxe'==S&'level_2'==M?[1.1,1.2]:'battle.battleaxe'==S&'level_3'==M?[1.2,1.3]:[1,1],Ao='battle.compositebow'==S&'level_1'==M?[1.05,1.1]:'battle.compositebow'==S&'level_2'==M?[1.1,1.2]:'battle.compositebow'==S&'level_3'==M?[1.2,1.3]:[1,1],wo='battle.halberd'==S&'level_1'==M?[1.1,1.05]:'battle.halberd'==S&'level_2'==M?[1.2,1.1]:'battle.halberd'==S&'level_3'==M?[1.3,1.2]:[1,1],
vo='battle.longsword'==S&'level_1'==M?[1.1,1.05]:'battle.longsword'==S&'level_2'==M?[1.2,1.1]:'battle.longsword'==S&'level_3'==M?[1.3,1.2]:[1,1],To='battle.longbow'==S&'level_1'==M?[1.1,1.05]:'battle.longbow'==S&'level_2'==M?[1.2,1.1]:'battle.longbow'==S&'level_3'==M?[1.3,1.2]:[1,1],bo='battle.banner'==S&'level_1'==M?[1.1,1.1]:'battle.banner'==S&'level_2'==M?[1.2,1.2]:'battle.banner'==S&'level_3'==M?[1.3,1.3]:[1,1],Eo='battle.star'==S&'level_1'==M?[1.05,1.25]:'battle.star'==S&'level_2'==M?[1.1,1.5]:'battle.star'==S&'level_3'==M?[1.2,2]:[1,1],fo='battle.bonfire'==S&'level_1'==M?[1.05,1.25]:'battle.bonfire'==S&'level_2'==M?[1.1,1.5]:'battle.bonfire'==S&'level_3'==M?[1.2,2]:[1,1],Xt=Ce*s[0]+ze*s[1]+De*s[2]+Ge*s[3]+Ye*s[4]+He*s[5]+je*s[6]+We*s[7]+Fe*s[8]+Ve*s[9]+Be*s[10]+qe*s[11]+Ke*s[12],Vt=q*s[0]+Y*s[1]+H*s[2]+j*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log('Prowiant:'+Xt,Vt),na=2*Xt<=Vt?2:1,jl=Xt-5*We,
Kl=0==Gt?0:Math.round(20*Math.pow(1.2515,Gt-1)),wn=Vt+(Kl+100*K),hs=0==jl||0==wn?0:jl/wn>1?1:jl/wn,console.log(hs),Yl=I/100,Sl=N/100,Qt=Math.round(1e3*(vd/100*Yl*(1+Sl)+Xs/100+rl))/1e3,Ad=Fe/(hd=We+Fe),Ed=We/hd,ed=Math.round(J*Ad),Td=Math.round(J*Ed),Vs=(Fs=We-(0==We?0:We<Td?We:Td))*hs*Qt*(Ni='battle.star'==S?'level_1'==M?[1.05,1.25]:'level_2'==M?[1.1,1.5]:'level_3'==M?[1.2,2]:[1,1]:[1,1])[1],ki=20==Gt?18:19==Gt?17:18==Gt?15:17==Gt?14:16==Gt?13:15==Gt?11:14==Gt?10:13==Gt||12==Gt?9:11==Gt?8:10==Gt?7:9==Gt||8==Gt?6:7==Gt||6==Gt?5:5==Gt||4==Gt||3==Gt?4:2==Gt||1==Gt?3:0,fd=0==Gt?0:2*ki,_d=0==Gt?0:Vs/fd,bd=Gt<=$s?Gt:Gt-$s<_d?Gt<$s?Gt:$s:Gt-_d,Oa=Math.round(bd),xa=Math.round(.05*Oa*1e3)/1e3,Bt=Math.round(Sd/100*(1+xa)*Hl*1e3)/1e3,En=Fe-(0==Fe?0:Fe<ed?Fe:ed),zt=Math.round(bd),Na=0==zt?0:Math.round(20*Math.pow(1.2515,zt-1)),Wo=Ce+ze+De+Ke>Ye+je&&Ce+ze+De+Ke>Ge+He?'inf':Ye+je>Ce+ze+De+Ke&&Ye+je>Ge+He?'cav':'arc',
is=Ce*s[0]+ze*s[1]+De*s[2]+Ge*s[3]+Ye*s[4]+He*s[5]+je*s[6]+Fs*s[7]+En*s[8]+Ve*s[9]+Be*s[10]+qe*s[11]+Ke*s[12],_s=q*s[0]+Y*s[1]+H*s[2]+j*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log(is,_s),Ys=Fs*s[7]+En*s[8]+qe*s[11]+Ve*s[9]+Be*s[10],'cav'==Wo?(Jl=Ye*s[4]+je*s[6]+Ys,ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Ql=Ge*s[3]+He*s[5]):'inf'==Wo?(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12]+Ys,Jl=Ye*s[4]+je*s[6],Ql=Ge*s[3]+He*s[5]):'arc'==Wo?(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Jl=Ye*s[4]+je*s[6],Ql=Ge*s[3]+He*s[5]+Ys):(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Jl=Ye*s[4]+je*s[6],Ql=Ge*s[3]+He*s[5]),fl=0==ts?0:Math.round(ts/is*1e4)/1e4,_l=0==Jl?0:Math.round(Jl/is*1e4)/1e4,Tl=0==Ql?0:Math.round(Ql/is*1e4)/1e4,console.log(Tl),Nr=Math.round(q*fl),Ir=Math.round(q*_l),Mr=q-Ir-Nr,Vc=Math.round(Y*fl),Bc=Math.round(Y*_l),Gc=Y-Bc-Vc,wa=Math.round(H*fl),Ea=Math.round(H*_l),Aa=H-Ea-wa,W=Math.round(j*fl),V=Math.round(j*_l),B=j-V-W,el=Math.round($*fl),$o=Math.round($*_l),Jo=$-$o-el,
Cl=Math.round(ee*fl),Ul=Math.round(ee*_l),Pl=ee-Ul-Cl,bi=Math.round(te*fl),fi=Math.round(te*_l),_i=te-fi-bi,xs=Math.round(X*fl),Ns=Math.round(X*_l),Is=X-Ns-xs,dn=Math.round(Z*fl),cn=Math.round(Z*_l),rn=Z-cn-dn,ur=Math.round(K*fl),dr=Math.round(K*_l),cr=K-dr-ur,sd=Math.round(J*fl),ld=Math.round(J*_l),od=J-ld-sd,qa=Math.round(ae*fl),Fa=Math.round(ae*_l),Wa=ae-Fa-qa,lo=Math.round(Q*fl),oo=Math.round(Q*_l),io=Q-oo-lo,gs=Nr*s[0]+Vc*s[1]+wa*s[2]+qa*s[12]+ur*s[10]+el*s[4]+bi*s[6]+W*s[3]+Cl*s[5]+xs*s[7]+dn*s[8]+sd*s[11]+lo*s[9],ds=Ir*s[0]+Bc*s[1]+Ea*s[2]+Fa*s[12]+dr*s[10]+$o*s[4]+fi*s[6]+V*s[3]+Ul*s[5]+Ns*s[7]+cn*s[8]+ld*s[11]+oo*s[9],ss=Mr*s[0]+Gc*s[1]+Aa*s[2]+Wa*s[12]+cr*s[10]+Jo*s[4]+_i*s[6]+B*s[3]+Pl*s[5]+Is*s[7]+rn*s[8]+od*s[11]+io*s[9],console.log(ss,ds,gs),dc=Nr*n[0]*Zn[0]+Vc*n[1]*ti[0]+wa*n[2]*kn[0]+qa*n[12]+ur*n[10]+el*n[4]*Gn[0]+bi*n[6]*Un[0]+W*n[3]*vn[0]+Cl*n[5]*Fn[0]+xs*n[7]*jn[0]+dn*n[8]*xn[0]+sd*n[11]+lo*n[9],
sc=Ir*i[0]*Zn[0]+Bc*i[1]*ti[0]+Ea*i[2]*kn[0]+Fa*i[12]+dr*i[10]+$o*i[4]*Gn[0]+fi*i[6]*Un[0]+V*i[3]*vn[0]+Ul*i[5]*Fn[0]+Ns*i[7]*jn[0]+cn*i[8]*xn[0]+ld*i[11]+oo*i[9],ic=Mr*o[0]*Zn[0]+Gc*o[1]*ti[0]+Aa*o[2]*kn[0]+Wa*o[12]+cr*o[10]+Jo*o[4]*Gn[0]+_i*o[6]*Un[0]+B*o[3]*vn[0]+Pl*o[5]*Fn[0]+Is*o[7]*jn[0]+rn*o[8]*xn[0]+od*o[11]+io*o[9],Ks=Fs*l[7]*Eo[1]+En*l[8]*fo[1]+qe*l[11]+Ve*l[9]+Be*l[10],'cav'==Wo?(Jr=Ye*l[4]*ho[1]+je*l[6]*bo[1]+Ks,tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*_o[1]+Ke*l[12]*na,Qr=Ge*l[3]*To[1]+He*l[5]*Ao[1]):'inf'==Wo?(tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*_o[1]+Ke*l[12]*na+Ks,Jr=Ye*l[4]*ho[1]+je*l[6]*bo[1],Qr=Ge*l[3]*To[1]+He*l[5]*Ao[1]):'arc'==Wo?(tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*_o[1]+Ke*l[12]*na,Jr=Ye*l[4]*ho[1]+je*l[6]*bo[1],Qr=Ge*l[3]*To[1]+He*l[5]*Ao[1]+Ks):(tc=Ce*l[0]*wo[1]+ze*l[1]*vo[1]+De*l[2]*_o[1]+Ke*l[12]*na,Jr=Ye*l[4]*ho[1]+je*l[6]*bo[1],Qr=Ge*l[3]*To[1]+He*l[5]*Ao[1]),Zt=(qr=tc*Qt)+(Vr=Jr*Qt)+(Dr=Qr*Qt),Wt=(hc=dc*Bt+Na)+(_c=sc*Bt+Na)+(gc=ic*Bt+Na),
console.log(Zt,Wt),Bo=0==qr||0==hc?0:hc<=qr?1:Math.pow(qr/hc,.5)/(hc/qr),zo=0==Vr||0==_c?0:_c<=Vr?1:Math.pow(Vr/_c,.5)/(_c/Vr),Po=0==Dr||0==gc?0:gc<=Dr?1:Math.pow(Dr/gc,.5)/(gc/Dr),xo=0==qr||0==hc?0:qr<=hc?1:Math.pow(hc/qr,.5)/(qr/hc),Mo=0==Vr||0==_c?0:Vr<=_c?1:Math.pow(_c/Vr,.5)/(Vr/_c),Ro=0==Dr||0==gc?0:Dr<=gc?1:Math.pow(gc/Dr,.5)/(Dr/gc),Li=Math.round(1e6*xo)/1e6,Oi=Math.round(1e6*Mo)/1e6,xi=Math.round(1e6*Ro)/1e6,Ci=Math.round(1e6*Bo)/1e6,Ui=Math.round(1e6*zo)/1e6,Pi=Math.round(1e6*Po)/1e6,Sr=Math.round(-Nr*Ci+1e-6)+Math.round(-Ir*Ui+1e-6)+Math.round(-Mr*Pi+1e-6),Uc=Math.round(-Vc*Ci+1e-6)+Math.round(-Bc*Ui+1e-6)+Math.round(-Gc*Pi+1e-6),_a=Math.round(-wa*Ci+1e-6)+Math.round(-Ea*Ui+1e-6)+Math.round(-Aa*Pi+1e-6),C=Math.round(-W*Ci+1e-6)+Math.round(-V*Ui+1e-6)+Math.round(-B*Pi+1e-6),Ko=Math.round(-el*Ci+1e-6)+Math.round(-$o*Ui+1e-6)+Math.round(-Jo*Pi+1e-6),Nl=Math.round(-Cl*Ci+1e-6)+Math.round(-Ul*Ui+1e-6)+Math.round(-Pl*Pi+1e-6),
pi=Math.round(-bi*Ci+1e-6)+Math.round(-fi*Ui+1e-6)+Math.round(-_i*Pi+1e-6),Rs=Math.round(-xs*Ci+1e-6)+Math.round(-Ns*Ui+1e-6)+Math.round(-Is*Pi+1e-6),nn=Math.round(-dn*Ci+1e-6)+Math.round(-cn*Ui+1e-6)+Math.round(-rn*Pi+1e-6),td=Math.round(-sd*Ci+1e-6)+Math.round(-ld*Ui+1e-6)+Math.round(-od*Pi+1e-6),Da=Math.round(-qa*Ci+1e-6)+Math.round(-Fa*Ui+1e-6)+Math.round(-Wa*Pi+1e-6),eo=Math.round(-lo*Ci+1e-6)+Math.round(-oo*Ui+1e-6)+Math.round(-io*Pi+1e-6),or=Math.round(-ur*Ci+1e-6)+Math.round(-dr*Ui+1e-6)+Math.round(-cr*Pi+1e-6),hr=Math.round(-Ce*Li+1e-6),Nc=Math.round(-ze*Li+1e-6),ua=Math.round(-De*Li+1e-6),La=Math.round(-Ke*Li+1e-6),x=Math.round(-Ge*xi+1e-6),Rl=Math.round(-He*xi+1e-6),Fo=Math.round(-Ye*Oi+1e-6),si=Math.round(-je*Oi+1e-6),'cav'==Wo?(As=Math.round(-Fs*Oi+1e-6),Ja=Math.round(-En*Oi+1e-6),Qc=Math.round(-qe*Oi+1e-6),Qi=Math.round(-Ve*Oi+1e-6),er=Math.round(-Be*Oi+1e-6)):'inf'==Wo?(As=Math.round(-Fs*Li+1e-6),Ja=Math.round(-En*Li+1e-6),Qc=Math.round(-qe*Li+1e-6),
Qi=Math.round(-Ve*Li+1e-6),er=Math.round(-Be*Li+1e-6)):'arc'==Wo&&(As=Math.round(-Fs*xi+1e-6),Ja=Math.round(-En*xi+1e-6),Qc=Math.round(-qe*xi+1e-6),Qi=Math.round(-Ve*xi+1e-6),er=Math.round(-Be*xi+1e-6)),wr=Ce+hr,Lc=ze+Nc,ma=De+ua,P=Ge+x,Ho=Ye+Fo,Ml=He+Rl,di=je+si,vs=Fs+As,tn=En+Ja,Jc=qe+Qc,Ca=Ke+La,nr=Be+er,Ji=Ve+Qi,kr=q+Sr,Dc=Y+Uc,ha=H+_a,G=j+C,Zo=$+Ko,Ll=ee+Nl,Ti=te+pi,Ms=X+Rs,sn=Z+nn,id=J+td,Va=ae+Da,rr=K+or,no=Q+eo,cl=hr*s[0]+Nc*s[1]+ua*s[2]+x*s[3]+Fo*s[4]+Rl*s[5]+si*s[6]+As*s[7]+Ja*s[8]+Qi*s[9]+er*s[10]+Qc*s[11]+La*s[12],pl=Sr*s[0]+Uc*s[1]+_a*s[2]+C*s[3]+Ko*s[4]+Nl*s[5]+pi*s[6]+Rs*s[7]+nn*s[8]+eo*s[9]+or*s[10]+td*s[11]+Da*s[12],console.log(cl,pl),Sc=wr*s[0]+Lc*s[1]+ma*s[2]+P*s[3]+Ho*s[4]+Ml*s[5]+di*s[6]+vs*s[7]+tn*s[8]+Jc*s[11]+Ca*s[12]+nr*s[10]+Ji*s[9],kc=kr*s[0]+Dc*s[1]+ha*s[2]+G*s[3]+Zo*s[4]+Ll*s[5]+Ti*s[6]+Ms*s[7]+sn*s[8]+id*s[11]+Va*s[12]+rr*s[10]+no*s[9],console.log(kc,Sc),da=0==Zt||0==Wt?0:Wt<=Zt?1:Math.pow(Zt/Wt,.5/(Wt/Zt)),console.log(da),
os=wr*s[0]+Lc*s[1]+ma*s[2]+P*s[3]+Ho*s[4]+Ml*s[5]+di*s[6]+vs*s[7]+tn*s[8]+Ji*s[9]+nr*s[10]+Jc*s[11]+Ca*s[12],fs=kr*s[0]+Dc*s[1]+ha*s[2]+G*s[3]+Zo*s[4]+Ll*s[5]+Ti*s[6]+Ms*s[7]+sn*s[8]+no*s[9]+rr*s[10]+id*s[11]+Va*s[12],console.log(os,fs),Hs=vs*s[7]+tn*s[8]+Jc*s[11]+Ji*s[9],'cav'==Wo?($l=Ho*s[4]+di*s[6]+Hs,as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],Xl=P*s[3]+Ml*s[5]):'inf'==Wo?(as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10]+Hs,$l=Ho*s[4]+di*s[6],Xl=P*s[3]+Ml*s[5]):'arc'==Wo?(as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],$l=Ho*s[4]+di*s[6],Xl=P*s[3]+Ml*s[5]+Hs):(as=wr*s[0]+Lc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],$l=Ho*s[4]+di*s[6],Xl=P*s[3]+Ml*s[5]),Al=0==as?0:Math.round(as/os*1e4)/1e4,hl=0==$l?0:Math.round($l/os*1e4)/1e4,bl=0==Xl?0:Math.round(Xl/os*1e4)/1e4,console.log(bl),Pr=Math.round(kr*Al),Lr=Math.round(kr*hl),Or=kr-Lr-Pr,Yc=Math.round(Dc*Al),qc=Math.round(Dc*hl),Fc=Dc-qc-Yc,ya=Math.round(ha*Al),Ra=Math.round(ha*hl),Sa=ha-Ra-ya,la=Math.round(G*Al),oa=Math.round(G*hl),ia=G-oa-la,
il=Math.round(Zo*Al),nl=Math.round(Zo*hl),al=Zo-nl-il,Bl=Math.round(Ll*Al),Gl=Math.round(Ll*hl),Dl=Ll-Gl-Bl,wi=Math.round(Ti*Al),Ei=Math.round(Ti*hl),Ai=Ti-Ei-wi,Us=Math.round(Ms*Al),Ps=Math.round(Ms*hl),Ls=Ms-Ps-Us,mn=Math.round(sn*Al),gn=Math.round(sn*hl),pn=sn-gn-mn,Tr=Math.round(rr*Al),mr=Math.round(rr*hl),gr=rr-mr-Tr,ud=Math.round(id*Al),dd=Math.round(id*hl),cd=id-dd-ud,Ka=Math.round(Va*Al),ja=Math.round(Va*hl),Ha=Va-ja-Ka,uo=Math.round(no*Al),co=Math.round(no*hl),ro=no-co-uo,ms=Pr*s[0]+Yc*s[1]+ya*s[2]+Ka*s[12]+Tr*s[10]+il*s[4]+wi*s[6]+la*s[3]+Bl*s[5]+Us*s[7]+mn*s[8]+ud*s[11]+uo*s[9],us=Lr*s[0]+qc*s[1]+Ra*s[2]+ja*s[12]+mr*s[10]+nl*s[4]+Ei*s[6]+oa*s[3]+Gl*s[5]+Ps*s[7]+gn*s[8]+dd*s[11]+co*s[9],rs=Or*s[0]+Fc*s[1]+Sa*s[2]+Ha*s[12]+gr*s[10]+al*s[4]+Ai*s[6]+ia*s[3]+Dl*s[5]+Ls*s[7]+pn*s[8]+cd*s[11]+ro*s[9],console.log(rs,us,ms),
uc=Pr*n[0]*Zn[0]+Yc*n[1]*ti[0]+ya*n[2]*kn[0]+Ka*n[12]+Tr*n[10]+il*n[4]*Gn[0]+wi*n[6]*Un[0]+la*n[3]*vn[0]+Bl*n[5]*Fn[0]+Us*n[7]*jn[0]+mn*n[8]*xn[0]+ud*n[11]+uo*n[9],rc=Lr*i[0]*Zn[0]+qc*i[1]*ti[0]+Ra*i[2]*kn[0]+ja*i[12]+mr*i[10]+nl*i[4]*Gn[0]+Ei*i[6]*Un[0]+oa*i[3]*vn[0]+Gl*i[5]*Fn[0]+Ps*i[7]*jn[0]+gn*i[8]*xn[0]+dd*i[11]+co*i[9],oc=Or*o[0]*Zn[0]+Fc*o[1]*ti[0]+Sa*o[2]*kn[0]+Ha*o[12]+gr*o[10]+al*o[4]*Gn[0]+Ai*o[6]*Un[0]+ia*o[3]*vn[0]+Dl*o[5]*Fn[0]+Ls*o[7]*jn[0]+pn*o[8]*xn[0]+cd*o[11]+ro*o[9],Qs=vs*l[7]*Eo[1]+tn*l[8]*fo[1]+Jc*l[11]+Ji*l[9],'cav'==Wo?($r=Ho*l[4]*ho[1]+di*l[6]*bo[1]+Qs,ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*_o[1]+Ca*l[12]*na+nr*l[10],Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]):'inf'==Wo?(ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*_o[1]+Ca*l[12]*na+nr*l[10]+Qs,$r=Ho*l[4]*ho[1]+di*l[6]*bo[1],Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]):'arc'==Wo?(ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*_o[1]+Ca*l[12]*na+nr*l[10],$r=Ho*l[4]*ho[1]+di*l[6]*bo[1],
Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]+Qs):(ac=wr*l[0]*wo[1]+Lc*l[1]*vo[1]+ma*l[2]*_o[1]+Ca*l[12]*na+nr*l[10],$r=Ho*l[4]*ho[1]+di*l[6]*bo[1],Xr=P*l[3]*To[1]+Ml*l[5]*Ao[1]),jr=(Yr=ac*Qt)+(Wr=$r*Qt)+(Gr=Xr*Qt),wc=(Ac=uc*Bt)+(fc=rc*Bt)+(mc=oc*Bt),console.log(jr,wc),Vo=0==Yr||0==Ac?0:Ac<=Yr?1:Math.pow(Yr/Ac,.5)/(Ac/Yr),Do=0==Wr||0==fc?0:fc<=Wr?1:Math.pow(Wr/fc,.5)/(fc/Wr),Uo=0==Gr||0==mc?0:mc<=Gr?1:Math.pow(Gr/mc,.5)/(mc/Gr),Oo=0==Yr||0==Ac?0:Yr<=Ac?1:Math.pow(Ac/Yr,.5)/(Yr/Ac),Io=0==Wr||0==fc?0:Wr<=fc?1:Math.pow(fc/Wr,.5)/(Wr/fc),yo=0==Gr||0==mc?0:Gr<=mc?1:Math.pow(mc/Gr,.5)/(Gr/mc),Gi=Math.round(1e6*Oo)/1e6,Di=Math.round(1e6*Io)/1e6,zi=Math.round(1e6*yo)/1e6,Wi=Math.round(1e6*Vo)/1e6,Vi=Math.round(1e6*Do)/1e6,Bi=Math.round(1e6*Uo)/1e6,Rr=Math.round(-Pr*Wi+1e-6)+Math.round(-Lr*Vi+1e-6)+Math.round(-Or*Bi+1e-6),Cc=Math.round(-Yc*Wi+1e-6)+Math.round(-qc*Vi+1e-6)+Math.round(-Fc*Bi+1e-6),fa=Math.round(-ya*Wi+1e-6)+Math.round(-Ra*Vi+1e-6)+Math.round(-Sa*Bi+1e-6),
z=Math.round(-la*Wi+1e-6)+Math.round(-oa*Vi+1e-6)+Math.round(-ia*Bi+1e-6),Qo=Math.round(-il*Wi+1e-6)+Math.round(-nl*Vi+1e-6)+Math.round(-al*Bi+1e-6),xl=Math.round(-Bl*Wi+1e-6)+Math.round(-Gl*Vi+1e-6)+Math.round(-Dl*Bi+1e-6),gi=Math.round(-wi*Wi+1e-6)+Math.round(-Ei*Vi+1e-6)+Math.round(-Ai*Bi+1e-6),ys=Math.round(-Us*Wi+1e-6)+Math.round(-Ps*Vi+1e-6)+Math.round(-Ls*Bi+1e-6),on=Math.round(-mn*Wi+1e-6)+Math.round(-gn*Vi+1e-6)+Math.round(-pn*Bi+1e-6),ad=Math.round(-ud*Wi+1e-6)+Math.round(-dd*Vi+1e-6)+Math.round(-cd*Bi+1e-6),Ga=Math.round(-Ka*Wi+1e-6)+Math.round(-ja*Vi+1e-6)+Math.round(-Ha*Bi+1e-6),to=Math.round(-uo*Wi+1e-6)+Math.round(-co*Vi+1e-6)+Math.round(-ro*Bi+1e-6),lr=Math.round(-Tr*Wi+1e-6)+Math.round(-mr*Vi+1e-6)+Math.round(-gr*Bi+1e-6),Ar=Math.round(-wr*Gi+1e-6),xc=Math.round(-Lc*Gi+1e-6),pa=Math.round(-ma*Gi+1e-6),Pa=Math.round(-Ca*Gi+1e-6),O=Math.round(-P*zi+1e-6),yl=Math.round(-Ml*zi+1e-6),qo=Math.round(-Ho*Di+1e-6),ri=Math.round(-di*Di+1e-6),
'cav'==Wo?(Es=Math.round(-vs*Di+1e-6),$a=Math.round(-tn*Di+1e-6),Xc=Math.round(-Jc*Di+1e-6),Xi=Math.round(-Ji*Di+1e-6)):'inf'==Wo?(Es=Math.round(-vs*Gi+1e-6),$a=Math.round(-tn*Gi+1e-6),Xc=Math.round(-Jc*Gi+1e-6),Xi=Math.round(-Ji*Gi+1e-6)):'arc'==Wo&&(Es=Math.round(-vs*zi+1e-6),$a=Math.round(-tn*zi+1e-6),Xc=Math.round(-Jc*zi+1e-6),Xi=Math.round(-Ji*zi+1e-6)),tr=100*nr==as?0:Math.round(-nr*Gi+1e-6),vr=wr+Ar,Pc=Lc+xc,Ta=ma+pa,U=P+O,jo=Ho+qo,Il=Ml+yl,ui=di+ri,Ss=vs+Es,an=tn+$a,$c=Jc+Xc,za=Ca+Pa,ir=nr+tr,$i=Ji+Xi,xr=kr+Rr,Wc=Dc+Cc,va=ha+fa,F=G+z,tl=Zo+Qo,zl=Ll+xl,hi=Ti+gi,Os=Ms+ys,un=sn+on,rd=id+ad,Ya=Va+Ga,pr=rr+lr,so=no+to,dl=Ar*s[0]+xc*s[1]+pa*s[2]+O*s[3]+qo*s[4]+yl*s[5]+ri*s[6]+Es*s[7]+$a*s[8]+Xi*s[9]+tr*s[10]+Xc*s[11]+Pa*s[12],gl=Rr*s[0]+Cc*s[1]+fa*s[2]+z*s[3]+Qo*s[4]+xl*s[5]+gi*s[6]+ys*s[7]+on*s[8]+to*s[9]+lr*s[10]+ad*s[11]+Ga*s[12],console.log(dl,gl),Rc=vr*s[0]+Pc*s[1]+Ta*s[2]+U*s[3]+jo*s[4]+Il*s[5]+ui*s[6]+Ss*s[7]+an*s[8]+$c*s[11]+za*s[12]+ir*s[10]+$i*s[9],
Mc=xr*s[0]+Wc*s[1]+va*s[2]+F*s[3]+tl*s[4]+zl*s[5]+hi*s[6]+Os*s[7]+un*s[8]+rd*s[11]+Ya*s[12]+pr*s[10]+so*s[9],console.log(Mc,Rc),ls=vr*s[0]+Pc*s[1]+Ta*s[2]+U*s[3]+jo*s[4]+Il*s[5]+ui*s[6]+Ss*s[7]+an*s[8]+$i*s[9]+ir*s[10]+$c*s[11]+za*s[12],bs=xr*s[0]+Wc*s[1]+va*s[2]+F*s[3]+tl*s[4]+zl*s[5]+hi*s[6]+Os*s[7]+un*s[8]+so*s[9]+pr*s[10]+rd*s[11]+Ya*s[12],console.log(ls,bs),qs=Ss*s[7]+an*s[8]+$c*s[11]+$i*s[9],'cav'==Wo?(es=jo*s[4]+ui*s[6]+qs,ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10],Zl=U*s[3]+Il*s[5]):'inf'==Wo?(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10]+qs,es=jo*s[4]+ui*s[6],Zl=U*s[3]+Il*s[5]):'arc'==Wo?(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10],es=jo*s[4]+ui*s[6],Zl=U*s[3]+Il*s[5]+qs):(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+ir*s[10],es=jo*s[4]+ui*s[6],Zl=U*s[3]+Il*s[5]),vl=0==ns?0:Math.round(ns/ls*1e4)/1e4,wl=0==es?0:Math.round(es/ls*1e4)/1e4,El=0==Zl?0:Math.round(Zl/ls*1e4)/1e4,console.log(El),zr=Math.round(xr*vl),Cr=Math.round(xr*wl),Ur=xr-Cr-zr,Kc=Math.round(Wc*vl),jc=Math.round(Wc*wl),
Hc=Wc-jc-Kc,Ia=Math.round(va*vl),Ma=Math.round(va*wl),ka=va-Ma-Ia,ca=Math.round(F*vl),ra=Math.round(F*wl),sa=F-ra-ca,sl=Math.round(tl*vl),ll=Math.round(tl*wl),ol=tl-ll-sl,Fl=Math.round(zl*vl),Wl=Math.round(zl*wl),Vl=zl-Wl-Fl,Ri=Math.round(hi*vl),Si=Math.round(hi*wl),vi=hi-Si-Ri,Ds=Math.round(Os*vl),zs=Math.round(Os*wl),Cs=Os-zs-Ds,fn=Math.round(un*vl),_n=Math.round(un*wl),Tn=un-_n-fn,br=Math.round(pr*vl),fr=Math.round(pr*wl),_r=pr-fr-br,md=Math.round(rd*vl),gd=Math.round(rd*wl),pd=rd-gd-md,Za=Math.round(Ya*vl),Xa=Math.round(Ya*wl),Qa=Ya-Xa-Za,mo=Math.round(so*vl),go=Math.round(so*wl),po=so-go-mo,Ts=zr*s[0]+Kc*s[1]+Ia*s[2]+Za*s[12]+br*s[10]+sl*s[4]+Ri*s[6]+ca*s[3]+Fl*s[5]+Ds*s[7]+fn*s[8]+md*s[11]+mo*s[9],ps=Cr*s[0]+jc*s[1]+Ma*s[2]+Xa*s[12]+fr*s[10]+ll*s[4]+Si*s[6]+ra*s[3]+Wl*s[5]+zs*s[7]+_n*s[8]+gd*s[11]+go*s[9],cs=Ur*s[0]+Hc*s[1]+ka*s[2]+Qa*s[12]+_r*s[10]+ol*s[4]+vi*s[6]+sa*s[3]+Vl*s[5]+Cs*s[7]+Tn*s[8]+pd*s[11]+po*s[9],console.log(cs,ps,Ts),
pc=zr*n[0]*Zn[0]+Kc*n[1]*ti[0]+Ia*n[2]*kn[0]+Za*n[12]+br*n[10]+sl*n[4]*Gn[0]+Ri*n[6]*Un[0]+ca*n[3]*vn[0]+Fl*n[5]*Fn[0]+Ds*n[7]*jn[0]+fn*n[8]*xn[0]+md*n[11]+mo*n[9],cc=Cr*i[0]*Zn[0]+jc*i[1]*ti[0]+Ma*i[2]*kn[0]+Xa*i[12]+fr*i[10]+ll*i[4]*Gn[0]+Si*i[6]*Un[0]+ra*i[3]*vn[0]+Wl*i[5]*Fn[0]+zs*i[7]*jn[0]+_n*i[8]*xn[0]+gd*i[11]+go*i[9],lc=Ur*o[0]*Zn[0]+Hc*o[1]*ti[0]+ka*o[2]*kn[0]+Qa*o[12]+_r*o[10]+ol*o[4]*Gn[0]+vi*o[6]*Un[0]+sa*o[3]*vn[0]+Vl*o[5]*Fn[0]+Cs*o[7]*jn[0]+Tn*o[8]*xn[0]+pd*o[11]+po*o[9],js=Ss*l[7]*Eo[1]+an*l[8]*fo[1]+$c*l[11]+$i*l[9],'cav'==Wo?(ec=jo*l[4]*ho[1]+ui*l[6]*bo[1]+js,nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*_o[1]+za*l[12]*na+ir*l[10],Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]):'inf'==Wo?(nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*_o[1]+za*l[12]*na+ir*l[10]+js,ec=jo*l[4]*ho[1]+ui*l[6]*bo[1],Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]):'arc'==Wo?(nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*_o[1]+za*l[12]*na+ir*l[10],ec=jo*l[4]*ho[1]+ui*l[6]*bo[1],
Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]+js):(nc=vr*l[0]*wo[1]+Pc*l[1]*vo[1]+Ta*l[2]*_o[1]+za*l[12]*na+ir*l[10],ec=jo*l[4]*ho[1]+ui*l[6]*bo[1],Zr=U*l[3]*To[1]+Il*l[5]*Ao[1]),Kr=(Hr=nc*Qt)+(Fr=ec*Qt)+(Br=Zr*Qt),vc=(Ec=pc*Bt)+(bc=cc*Bt)+(Tc=lc*Bt),console.log(Kr,vc),Go=0==Hr||0==Ec?0:Ec<=Hr?1:Math.pow(Hr/Ec,.5)/(Ec/Hr),Co=0==Fr||0==bc?0:bc<=Fr?1:Math.pow(Fr/bc,.5)/(bc/Fr),Lo=0==Br||0==Tc?0:Tc<=Br?1:Math.pow(Br/Tc,.5)/(Tc/Br),No=0==Hr||0==Ec?0:Hr<=Ec?1:Math.pow(Ec/Hr,.5)/(Hr/Ec),ko=0==Fr||0==bc?0:Fr<=bc?1:Math.pow(bc/Fr,.5)/(Fr/bc),So=0==Br||0==Tc?0:Br<=Tc?1:Math.pow(Tc/Br,.5)/(Br/Tc),Yi=Math.round(1e6*No)/1e6,qi=Math.round(1e6*ko)/1e6,Fi=Math.round(1e6*So)/1e6,Ki=Math.round(1e6*Go)/1e6,ji=Math.round(1e6*Co)/1e6,Hi=Math.round(1e6*Lo)/1e6,yr=Math.round(-zr*Ki+1e-6)+Math.round(-Cr*ji+1e-6)+Math.round(-Ur*Hi+1e-6),zc=Math.round(-Kc*Ki+1e-6)+Math.round(-jc*ji+1e-6)+Math.round(-Hc*Hi+1e-6),ba=Math.round(-Ia*Ki+1e-6)+Math.round(-Ma*ji+1e-6)+Math.round(-ka*Hi+1e-6),
D=Math.round(-ca*Ki+1e-6)+Math.round(-ra*ji+1e-6)+Math.round(-sa*Hi+1e-6),Xo=Math.round(-sl*Ki+1e-6)+Math.round(-ll*ji+1e-6)+Math.round(-ol*Hi+1e-6),Ol=Math.round(-Fl*Ki+1e-6)+Math.round(-Wl*ji+1e-6)+Math.round(-Vl*Hi+1e-6),mi=Math.round(-Ri*Ki+1e-6)+Math.round(-Si*ji+1e-6)+Math.round(-vi*Hi+1e-6),ks=Math.round(-Ds*Ki+1e-6)+Math.round(-zs*ji+1e-6)+Math.round(-Cs*Hi+1e-6),ln=Math.round(-fn*Ki+1e-6)+Math.round(-_n*ji+1e-6)+Math.round(-Tn*Hi+1e-6),nd=Math.round(-md*Ki+1e-6)+Math.round(-gd*ji+1e-6)+Math.round(-pd*Hi+1e-6),Ba=Math.round(-Za*Ki+1e-6)+Math.round(-Xa*ji+1e-6)+Math.round(-Qa*Hi+1e-6),ao=Math.round(-mo*Ki+1e-6)+Math.round(-go*ji+1e-6)+Math.round(-po*Hi+1e-6),sr=Math.round(-br*Ki+1e-6)+Math.round(-fr*ji+1e-6)+Math.round(-_r*Hi+1e-6),Er=Math.round(-vr*Yi+1e-6),Oc=Math.round(-Pc*Yi+1e-6),ga=Math.round(-Ta*Yi+1e-6),Ua=Math.round(-za*Yi+1e-6),L=Math.round(-U*Fi+1e-6),kl=Math.round(-Il*Fi+1e-6),Yo=Math.round(-jo*qi+1e-6),ci=Math.round(-ui*qi+1e-6),
'cav'==Wo?(ws=Math.round(-Ss*qi+1e-6),en=Math.round(-an*qi+1e-6),Zc=Math.round(-$c*qi+1e-6),Zi=Math.round(-$i*qi+1e-6)):'inf'==Wo?(ws=Math.round(-Ss*Yi+1e-6),en=Math.round(-an*Yi+1e-6),Zc=Math.round(-$c*Yi+1e-6),Zi=Math.round(-$i*Yi+1e-6)):'arc'==Wo&&(ws=Math.round(-Ss*Fi+1e-6),en=Math.round(-an*Fi+1e-6),Zc=Math.round(-$c*Fi+1e-6),Zi=Math.round(-$i*Fi+1e-6)),ar=100*ir==ns?0:Math.round(-ir*Yi+1e-6),Et=vr+Er,wt=Pc+Oc,vt=Ta+ga,St=U+L,Nt=jo+Yo,xt=Il+kl,Ot=ui+ci,kt=Ss+ws,Mt=an+en,It=$c+Zc,Lt=za+Ua,Rt=ir+ar,yt=$i+Zi,ve=xr+yr,Se=Wc+zc,Re=va+ba,ye=F+D,Oe=tl+Xo,Le=zl+Ol,Pe=hi+mi,Ie=Os+ks,Ne=un+ln,xe=rd+nd,Ue=Ya+Ba,ke=pr+sr,Me=so+ao,ul=Er*s[0]+Oc*s[1]+ga*s[2]+L*s[3]+Yo*s[4]+kl*s[5]+ci*s[6]+ws*s[7]+en*s[8]+Zi*s[9]+ar*s[10]+Zc*s[11]+Ua*s[12],ml=yr*s[0]+zc*s[1]+ba*s[2]+D*s[3]+Xo*s[4]+Ol*s[5]+mi*s[6]+ks*s[7]+ln*s[8]+ao*s[9]+sr*s[10]+nd*s[11]+Ba*s[12],console.log(ul,ml),yc=Et*s[0]+wt*s[1]+vt*s[2]+St*s[3]+Nt*s[4]+xt*s[5]+Ot*s[6]+kt*s[7]+Mt*s[8]+It*s[11]+Lt*s[12]+Rt*s[10]+yt*s[9],
Ic=ve*s[0]+Se*s[1]+Re*s[2]+ye*s[3]+Oe*s[4]+Le*s[5]+Pe*s[6]+Ie*s[7]+Ne*s[8]+xe*s[11]+Ue*s[12]+ke*s[10]+Me*s[9],console.log(Ic,yc),Qe=-Ce+Et,Xe=-ze+wt,Ze=-De+vt,Je=-Ge+St,it=-Ye+Nt,ot=-He+xt,lt=-je+Ot,tt=-We+kt,at=-Fe+Mt,nt=-qe+It,st=-Ke+Lt,$e=-Be+Rt,et=-Ve+yt,ne=-q+ve,ie=-Y+Se,oe=-H+Re,le=-j+ye,pe=-$+Oe,ge=-ee+Le,me=-te+Pe,ce=-X+Ie,de=-Z+Ne,ue=-J+xe,Te=-ae+Ue,se=-K+ke,re=-Q+Me,Ws=0==kt?0:kt*Qt*Ni[1],Mi=20==zt?18:19==zt?17:18==zt?15:17==zt?14:16==zt?13:15==zt?11:14==zt?10:13==zt||12==zt?9:11==zt?8:10==zt?7:9==zt||8==zt?6:7==zt||6==zt?5:5==zt||4==zt||3==zt?4:2==zt||1==zt?3:0,Gs=0==xa?0:2*Mi,Bs=0==Ws||0==Gs?0:-Ws/Gs,li=zt<=$s?zt:zt-$s<-Bs?zt<$s?zt:$s:zt+Bs,Dt=Math.round(li),Ut='wall'==h?Dt:v[t.BATTLE_TARGET_LEVEL],An=0==Mt||0==Ut?0:Mt*Qt*fo[1],
...
bn=0==Ut?0:yi*Bt,hn=0==An||0==bn?0:-An/bn,oi='wall'==h?li<=$s?li:li-$s<-hn?li<$s?li:$s:li+hn:hn+Ut<=0?0:hn+Ut,Ct=Math.round(oi),console.log(Ct),$t=Qe*s[0]+Xe*s[1]+Ze*s[2]+Je*s[3]+it*s[4]+ot*s[5]+lt*s[6]+tt*s[7]+at*s[8]+et*s[9]+$e*s[10]+nt*s[11]+st*s[12],qt=ne*s[0]+ie*s[1]+oe*s[2]+le*s[3]+pe*s[4]+ge*s[5]+me*s[6]+ce*s[7]+de*s[8]+re*s[9]+se*s[10]+ue*s[11]+Te*s[12],Jt=ne*a[0]+ie*a[1]+oe*a[2]+le*a[3]+pe*a[4]+ge*a[5]+me*a[6]+ce*a[7]+de*a[8]+re*a[9]+se*a[10]+ue*a[11]+Te*a[12],Ft=Qe*e[0]+Xe*e[1]+Ze*e[2]+Je*e[3]+it*e[4]+ot*e[5]+lt*e[6]+tt*e[7]+at*e[8]+et*e[9]+$e*e[10]+nt*e[11]+st*e[12],console.log(Jt,Ft),ta=0==Xt||0==$t?0:Math.round(-$t/Xt*1e3)/1e3,console.log(ta),wd=q+Y+H+ae>$+te&&q+Y+H+ae>j+ee?'inf':$+te>q+Y+H+ae&&$+te>j+ee?'cav':'arc',ea='inf'==Wo?'piechota':'cav'==Wo?'kawaleria':'łucznicy',console.log(ea),Yt='inf'==wd?'piechota':'cav'==wd?'kawaleria':'łucznicy',console.log(Yt),Ht=0==Vt||0==qt?0:Math.round(-qt/Vt*1e3)/1e3,console.log(Ht),rt=Math.round(Qe*(ql+Js)),ct=Math.round(Xe*(ql+Js)),
dt=Math.round(Ze*(ql+Js)),ut=Math.round(Je*(ql+Js)),ft=Math.round(it*(ql+Js)),bt=Math.round(ot*(ql+Js)),ht=Math.round(lt*(ql+Js)),mt=Math.round(tt*(ql+Js)),Tt=Math.round(at*(ql+Js)),pt=Math.round($e*(ql+Js)),gt=Math.round(et*(ql+Js)),_t=Math.round(nt*(ql+Js)),At=Math.round(st*(ql+Js)),console.log(rt,ct,dt,ut,ft,bt,ht,mt,Tt,pt,gt,_t,At),Kt=Ii+Zs,0==Ii?(_e=0,fe=0,be=0,he=0,Ae=0,Ee=0,we=0):Ii<1e3?Kt<=(le+ne+ie+oe)/2?(_e=Math.round(ne/2),fe=Math.round(ie/2),be=Math.round(oe/2),he=Math.round(le/2),Ae=0,Ee=0,we=0):(_e=Math.round(ne*Kt/(le+ne+ie+oe)),fe=Math.round(ie*Kt/(le+ne+ie+oe)),be=Math.round(oe*Kt/(le+ne+ie+oe)),he=Math.round(le*Kt/(le+ne+ie+oe)),Ae=0,Ee=0,we=0):Kt<=(le+ne+ie+oe+4*pe+5*ge+6*me)/2?(_e=Math.round(ne/2),fe=Math.round(ie/2),be=Math.round(oe/2),he=Math.round(le/2),Ae=Math.round(pe/2),Ee=Math.round(ge/2),we=Math.round(me/2)):(_e=Math.round(ne*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),fe=Math.round(ie*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),be=Math.round(oe*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),
he=Math.round(le*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),Ae=Math.round(pe*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),Ee=Math.round(ge*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me)),we=Math.round(me*Kt/(le+ne+ie+oe+4*pe+5*ge+6*me))),console.log(_e,fe,be,he,Ae,Ee,we),aa=Xt+$t,jt=Vt+qt},Fa.calculateT=function(){const e=v[t.TROOPS_SPEAR],a=v[t.TROOPS_SWORD],n=v[t.TROOPS_AXE],i=v[t.TROOPS_ARCHER],o=v[t.TROOPS_LC],l=v[t.TROOPS_MA],s=v[t.TROOPS_HC],r=v[t.TROOPS_RAM],c=v[t.TROOPS_CATAPULT],d=v[t.TROOPS_DOPPELSOLDNER],u=v[t.TROOPS_TREBUCHET],p=v[t.TROOPS_SNOB],g=v[t.TROOPS_KNIGHT],m=v[t.TROOPS_BARRACKS],T=v[t.TROOPS_PRECEPTORY],_=v[t.TROOPS_ORDER],f=v[t.TROOPS_TRAINING]
;var b=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],h=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],A=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],E=[1,1,1,1,4,5,6,5,8,1,100,10,6],w=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],S=[10,25,45,25,130,150,150,2,100,150,30,30,300],R=[25,55,10,10,30,40,200,20,100,250,100,200,100],y=[45,5,5,30,40,30,160,50,50,400,50,250,100],k=[10,30,10,60,30,50,180,20,100,150,100,200,50],M=[8,9,14,18,24,35,50,0],q=[25,15,10,10,80,50,50,0,0,100,0,0,10],Y=[0,33,66,99];let H=0,j=1,K=1,Q=1,X=1,Z=1,J=1,$=1,ee=1,te=0;var ae,ne,ie,oe;K=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,te='level_1'==f?1.04:'level_2'==f?1.08:'level_3'==f?1.12:'level_4'==f?1.16:'level_5'==f?1.2:1,X=1==T?1.01:2==T?1.02:3==T?1.03:4==T?1.04:5==T?1.05:6==T?1.06:7==T?1.07:8==T?1.08:9==T?1.09:10==T?1.1:1,Q=v[t.TROOPS_DOMINATION]?1.1:1,
W=u>0?M[6]+' minut':p>0?M[5]+' minut':r>0||c>0?M[4]+' minuty':a>0?M[3]+' minut':e>0||n>0||i>0||d>0?M[2]+' minut':s>0?M[1]+' minut':o>0||l>0||g>0?M[0]+' minut':M[7]+' minut',V=m>=7&&m<14?Y[1]:m>=14&&m<23?Y[2]:m>=23?Y[3]:Y[0],J=j/(Q*te),Z=J/K,$=Z/X,ee=j/X,H='troops.teutonic'==_?$*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+ee*(u*w[11])+Z*(n*w[2]+o*w[4]+l*w[5]+r*w[7]+c*w[8])+d*w[12]+g*w[9]+p*w[10]:'troops.templars'==_?Z*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+u*w[11]+$*(n*w[2]+o*w[4]+l*w[5]+r*w[7]+c*w[8])+ee*(d*w[12])+g*w[9]+p*w[10]:Z*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+u*w[11]+Z*(n*w[2]+o*w[4]+l*w[5]+r*w[7]+c*w[8])+d*w[12]+g*w[9]+p*w[10],I=e*b[0]+a*b[1]+n*b[2]+i*b[3]+o*b[4]+l*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+p*b[10]+u*b[11]+d*b[12],N=e*h[0]+a*h[1]+n*h[2]+i*h[3]+o*h[4]+l*h[5]+s*h[6]+r*h[7]+c*h[8]+g*h[9]+p*h[10]+u*h[11]+d*h[12],x=e*A[0]+a*A[1]+n*A[2]+i*A[3]+o*A[4]+l*A[5]+s*A[6]+r*A[7]+c*A[8]+g*A[9]+p*A[10]+u*A[11]+d*A[12],O=e*E[0]+a*E[1]+n*E[2]+i*E[3]+o*E[4]+l*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+p*E[10]+u*E[11]+d*E[12],
B=e*S[0]+a*S[1]+n*S[2]+i*S[3]+o*S[4]+l*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+p*S[10]+u*S[11]+d*S[12],z=e*R[0]+a*R[1]+n*R[2]+i*R[3]+o*R[4]+l*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+p*R[10]+u*R[11]+d*R[12],D=e*y[0]+a*y[1]+n*y[2]+i*y[3]+o*y[4]+l*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+p*y[10]+u*y[11]+d*y[12],G=e*k[0]+a*k[1]+n*k[2]+i*k[3]+o*k[4]+l*k[5]+s*k[6]+r*k[7]+c*k[8]+g*k[9]+p*k[10]+u*k[11]+d*k[12],L=e*q[0]+a*q[1]+n*q[2]+i*q[3]+o*q[4]+l*q[5]+s*q[6]+r*q[7]+c*q[8]+g*q[9]+p*q[10]+u*q[11]+d*q[12],ae=H,ne='',ie=new Date(1e3*ae).toISOString().substr(11,8),(oe=Math.floor(ae/86400))>1?ne=oe+' dni i ':oe>0&&(ne='1 dzień i '),F=ne+=ie,P=e*S[0]+a*S[1]+n*S[2]+r*S[7]+c*S[8]+u*S[11]+d*S[12],U=o*S[4]+s*S[6]+g*S[9],C=i*S[3]+l*S[5]},Fa.start=function(){R=!0,E.trigger(s.BATTLE_CALCULATOR_START)},Fa.stop=function(){R=!1,E.trigger(s.BATTLE_CALCULATOR_STOP)},Fa.getSettings=function(){return w},Fa.isInitialized=function(){return S},Fa.isRunning=function(){return R},Fa.getBashpointsAtt=function(){return M},
...
S.settings[n.BATTLE_RAM_D]=t.getPresetRam(),S.settings[n.BATTLE_CATAPULT_D]=t.getPresetCatapult(),S.settings[n.BATTLE_SNOB_D]=t.getPresetSnob(),S.settings[n.BATTLE_KNIGHT_D]=t.getPresetKnight(),S.settings[n.BATTLE_TREBUCHET_D]=t.getPresetTrebuchet(),S.settings[n.BATTLE_DOPPELSOLDNER_D]=t.getPresetBerserker(),S.settings[n.BATTLE_LC_D]=t.getPresetLc(),S.settings[n.BATTLE_MA_D]=t.getPresetMa(),S.settings[n.BATTLE_HC_D]=t.getPresetHc(),R.setAll(R.decode(S.settings))},G=function(){t.getVillageUnits(),R.setAll(R.decode(S.settings));let e=t.getVillageSpear(),a=t.getVillageSword(),i=t.getVillageAxe(),o=t.getVillageArcher(),l=t.getVillageRam(),s=t.getVillageCatapult(),r=t.getVillageSnob(),c=t.getVillageKnight(),d=t.getVillageTrebuchet(),u=t.getVillageBerserker(),p=t.getVillageLc(),g=t.getVillageMa(),m=t.getVillageHc();S.settings[n.BATTLE_SPEAR_A]=e,S.settings[n.BATTLE_SWORD_A]=a,S.settings[n.BATTLE_AXE_A]=i,S.settings[n.BATTLE_ARCHER_A]=o,S.settings[n.BATTLE_RAM_A]=l,
S.settings[n.BATTLE_CATAPULT_A]=s,S.settings[n.BATTLE_SNOB_A]=r,S.settings[n.BATTLE_KNIGHT_A]=c,S.settings[n.BATTLE_TREBUCHET_A]=d,S.settings[n.BATTLE_DOPPELSOLDNER_A]=u,S.settings[n.BATTLE_LC_A]=p,S.settings[n.BATTLE_MA_A]=g,S.settings[n.BATTLE_HC_A]=m,R.setAll(R.decode(S.settings))},B=function(){t.getVillageUnits(),R.setAll(R.decode(S.settings));let e=t.getVillageSpear(),a=t.getVillageSword(),i=t.getVillageAxe(),o=t.getVillageArcher(),l=t.getVillageRam(),s=t.getVillageCatapult(),r=t.getVillageSnob(),c=t.getVillageKnight(),d=t.getVillageTrebuchet(),u=t.getVillageBerserker(),p=t.getVillageLc(),g=t.getVillageMa(),m=t.getVillageHc();S.settings[n.BATTLE_SPEAR_D]=e,S.settings[n.BATTLE_SWORD_D]=a,S.settings[n.BATTLE_AXE_D]=i,S.settings[n.BATTLE_ARCHER_D]=o,S.settings[n.BATTLE_RAM_D]=l,S.settings[n.BATTLE_CATAPULT_D]=s,S.settings[n.BATTLE_SNOB_D]=r,S.settings[n.BATTLE_KNIGHT_D]=c,S.settings[n.BATTLE_TREBUCHET_D]=d,S.settings[n.BATTLE_DOPPELSOLDNER_D]=u,S.settings[n.BATTLE_LC_D]=p,
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,p,g,m,T,_,f,b){let h,A,E,w=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),R=!1,y=!1;const k={};let M,I,N,x,O,L=!0;const P='builder_queue_log',U='builder_queue_settings',C=function(){const e=D();if(!L)return Y.stop(),!1;e.forEach((function(e){const t=I.getVillage(e),a=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void G(t))}))},z=function(){D().forEach((function(e){const t=I.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},D=function(){const e=O[r.GROUP_VILLAGES];let a=[];return e?(a=M.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},G=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(k);const i=O[r.BUILDING_SEQUENCES][O[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),F(t))return!1;i.some((function(a){if(++n[a]>t[a])return w.compute(e),B(e,a,(function(t,a){t&&a.job&&(_.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),q(e.getId(),a.job))})),!0}))},B=function(e,t,a){const n=W(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&O[r.PRIORIZE_FARM]){const t=E[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-O[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-O[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-O[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},F=function(e){for(let t in e)if(e[t]<E[t])return!1;return!0},q=function(e,t){let a={time:b.gameTime(),villageId:e,building:t.building,level:t.level};return N.unshift(a),N.length>500&&N.splice(N.length-500,N.length),f.set(P,N),!0};let Y={};return Y.start=function(){if(!L)return _.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,h=setInterval(C,6e4),A=setInterval(z,6e3),e((function(){D().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),C(),z()}),['all_villages_ready']),_.trigger(s.BUILDER_QUEUE_START)},Y.stop=function(){y=!1,clearInterval(h),
clearInterval(A),_.trigger(s.BUILDER_QUEUE_STOP)},Y.isRunning=function(){return y},Y.isInitialized=function(){return R},Y.getSettings=function(){return x},Y.getLogs=function(){return N},Y.clearLogs=function(){N=[],f.set(P,N),_.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},Y.addBuildingSequence=function(e,t){let a=O[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,x.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},Y.updateBuildingSequence=function(e,t){let a=O[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=i.getGameData().getBuildings();for(let a=0;a<e.length;a++){let n=e[a];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(a[e]=t,x.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},Y.removeSequence=function(e){let t=O[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],x.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},Y.init=function(){R=!0,N=f.get(P,[],!0),I=i.getSelectedCharacter(),M=i.getGroupList(),x=new n({settingsMap:c,storageKey:U}),x.onChange((function(e,t,a){O=x.getAll(),y&&t[d.ANALYSE]&&C(),a.quiet||_.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),O=x.getAll();for(let e in m)k[m[e]]=0;L=Object.keys(O[r.BUILDING_SEQUENCES]).length,E=!!L&&function(e){const t=O[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(O[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=I.getVillage(t.village_id);G(e)}),1e3)}))},Y})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a];Array.isArray(n)?(n.sort(()=>Math.random()-.5),t=t.concat(n)):t.push(n)}return t}
...
define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,n,d,u,p,T,_,b,h,A,E,w){let v,S,R,y,k=i.getGroupList(),M={},I=!1,N={sequencesAvail:!0,modal:{}},x={sequencesAvail:!0},O={};const L={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,U={},C={},z=!1,D=!1;const G=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,n){if(n>=e.length){let a=n-e.length+1;for(;a--;)e.push(t)}e.splice(n,0,e.splice(a,1)[0])},V=function(e,t){switch(n.addBuildingSequence(e,t)){case b.SEQUENCE_SAVED:return!0;case b.SEQUENCE_EXISTS:return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case b.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}}
;x.generateSequences=function(){const e=y.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;x.generateBuildingSequence(),x.generateBuildingSequenceFinal(),x.updateVisibleBuildingSequence()},x.generateBuildingSequence=function(){const e=v.settings[T.ACTIVE_SEQUENCE].value,t=v.settings[T.BUILDING_SEQUENCES][e],a=i.getGameData().getBuildings();let n={};if(x.sequencesAvail=!!t,!x.sequencesAvail)return!1;for(let e in h)n[h[e]]=0;x.buildingSequence=t.map((function(e){let t=++n[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return i.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=i.getSelectedVillage().getBuildingQueue().getQueue();let n=!1;return a.some((function(a){if(a.building===e&&a.level===t)return n=!0})),n}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:w.readableSeconds(o.build_time),levelPoints:M[e][t-1],state:l}}))},
x.generateBuildingSequenceFinal=function(e){const t=v.settings[T.ACTIVE_SEQUENCE].value,a=v.settings[T.BUILDING_SEQUENCES][e||t];let n={},i=[];for(let e in R)n[e]={level:0,order:R[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++n[e].level,a=R[e].individual_level_costs[t];n[e].resources.wood+=parseInt(a.wood,10),n[e].resources.clay+=parseInt(a.clay,10),n[e].resources.iron+=parseInt(a.iron,10),n[e].resources.food+=parseInt(a.food,10),n[e].build_time+=parseInt(a.build_time,10),n[e].points+=M[e][t-1]}));for(let e in n)0!==n[e].level&&i.push({building:e,level:n[e].level,order:n[e].order,resources:n[e].resources,points:n[e].points,build_time:n[e].build_time});x.buildingSequenceFinal=i},x.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequence.offset,t=v.pagination.buildingSequence.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),v.pagination.buildingSequence.count=x.buildingSequence.length},
x.generateBuildingsLevelPoints=function(){const e=i.getGameData();let t;for(let a in e.data.buildings){let n=e.getBuildingDataForBuilding(a);t=0,M[a]=[];for(let e=1;e<=n.max_level;e++){let i=G(n.points,n.points_factor,e)-t;t+=i,M[a].push(i)}}},N.moveUp=function(){let e=angular.copy(N.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let n=e[a];n.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===n.building&&(e[a-1].level++,n.level--,t=!0),B(e,a,a-1))))}N.buildingSequence=e,N.updateVisibleBuildingSequence(),t&&(z=!0)},N.moveDown=function(){let e=angular.copy(N.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let n=e[a];n.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===n.building&&(e[a+1].level--,n.level++,t=!0),B(e,a,a+1))))}N.buildingSequence=e,N.updateVisibleBuildingSequence(),t&&(z=!0)},N.addBuilding=function(e,t,a=1){const n=t-1;let i=N.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)i.splice(n,0,o)
;return N.buildingSequence=N.updateLevels(i,e),N.updateVisibleBuildingSequence(),z=!0,!0},N.removeBuilding=function(e){const t=N.buildingSequence[e].building;N.buildingSequence.splice(e,1),N.buildingSequence=N.updateLevels(N.buildingSequence,t),N.updateVisibleBuildingSequence(),z=!0},N.updateLevels=function(e,t){let a=0,n=[];for(let i=0;i<e.length;i++){let o=e[i];o.building===t?a<R[t].max_level&&n.push({level:++a,building:t,checked:!1}):n.push(o)}return n},N.generateBuildingSequence=function(){const e=y.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;const a=e[N.selectedSequence.value];let n={};for(let e in h)n[h[e]]=0;N.buildingSequence=a.map((function(e){return{level:++n[e],building:e,checked:!1}})),N.updateVisibleBuildingSequence()},N.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequenceEditor.offset,t=v.pagination.buildingSequenceEditor.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),
...
const E=Object.values(c),w=Object.values(a),v=Object.values(A),S=Object.values(h),R=Object.values(b);let y,k=[],M={},I=[],N=[],x=!1;const O={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===i.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),i=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!i.includes(e))return a=!1,!0})),a}},L=function(e){return e<g.gameTime()+y},P=function(e){k.push(e)},U=function(e){M[e.id]=e},C=function(){
_.set(d.QUEUE_COMMANDS,k)},z=function(e){return!isNaN(e)&&e>0&&e<1e3},D=function(e){return f.call(e,'x')&&f.call(e,'y')&&z(e.x)&&z(e.y)};let G={initialized:!1};return G.init=function(){y=t.getTimeOffset(),G.initialized=!0,I=_.get(d.QUEUE_SENT,[],!0),N=_.get(d.QUEUE_EXPIRED,[],!0),function(){const e=_.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?G.expireCommand(e,n.TIME_LIMIT):(P(e),U(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!L(e.sendTime))return!0;x?G.sendCommand(e):G.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){x&&k.length&&(e.returnValue=!0)}))},G.sendCommand=function(e){const a=function(e){const a=i.getVillages()[e.origin.id];if(!a)return n.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=n.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return G.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){I.push(e)}(e),_.set(d.QUEUE_SENT,I),G.removeCommand(e,n.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},G.expireCommand=function(e,t){!function(e){N.push(e)}(e),_.set(d.QUEUE_EXPIRED,N),G.removeCommand(e,t)},G.addCommand=function(e,n,o,l,s,r,d,p){let m={},_={};return new Promise((function(f,y){if(!D(e))return y(u.INVALID_ORIGIN);if(!D(n))return y(u.INVALID_TARGET);if(!t.isValidDateTime(o))return y(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return y(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(_[t]=!0)})))return y(u.INVALID_OFFICER_TYPE)}return E.includes(d)?d!==c.RELOCATE||i.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&_[h.SUPPORTER]&&delete _[h.SUPPORTER],'string'!=typeof p||R.includes(p)?(p=!(d!==c.ATTACK||!m[A.CATAPULT])&&(p||b.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>T.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>T.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(i){if(e=i[0],n=i[1],!e)return y(u.INVALID_ORIGIN);if(!n)return y(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,n,m,d,_,!0),c=l===a.ARRIVE?s-r:s,T=l===a.ARRIVE?s:s+r;if(L(c))return y(u.ALREADY_SENT);const b={id:t.guid(),travelTime:r,arriveTime:T,sendTime:c,origin:e,target:n,date:o,dateType:l,units:m,officers:_,type:d,catapultTarget:p,countdown:c-g.gameTime()};P(b),U(b),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,l,d,u,p,m,T,_,f,b,h,A){let E,w,v,S,R,y=i.getGameData(),k=y.getOrderedUnitNames(),M=y.getOrderedOfficerNames(),I=i.getPresetList(),N=!1;const x={ADD:'add',WAITING:'waiting',LOGS:'logs'},O=x.ADD;let L,P,U,C=[],z={},D={};const G={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){N=t.data},W=function(){N=!1},F=function(e){
const t=new Date(e||b.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),n=b.zerofill(a-a%100,3),i=b.zerofill(t.getSeconds(),2),l=b.zerofill(t.getMinutes(),2);return b.zerofill(t.getHours(),2)+':'+l+':'+i+':'+n+' '+b.zerofill(t.getDate(),2)+'/'+b.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},q=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),F(e+=t)):''},Y=function(){if(E.isValidDate=o.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!E.isValidDate&&o.getTimeFromString(R.date),t=E.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(G,(function(n,i){const l=o.getTravelTime(R.origin,R.target,n,a,R.officers,!0);E.travelTimes[a][i].travelTime=g('readableMillisecondsFilter')(l),E.travelTimes[a][i].status=e?H(t?e-l:e):'neutral'}))}))},H=function(e){return e&&E.isValidDate?b.gameTime()+L<e?'valid':'invalid':'neutral'},j=function(){R.dateType=E.selectedDateType.value,A.set(m.LAST_DATE_TYPE,E.selectedDateType.value),Y()},K=function(){
R.catapultTarget=E.catapultTarget.value},Q=function(){const e=E.selectedInsertPreset.value;if(!e)return!1;const t=i.getPresetList().getPresets()[e];E.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},R.units=angular.copy(t.units),R.officers=angular.copy(t.officers),t.catapult_target&&(R.catapultTarget=t.catapult_target,E.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},E.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=b.serverTime()+a.GAME_TIME_OFFSET,n=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=n-t}),b.timer.add(e.updateCountdown)},Z=function(){E.waitingCommands=t.getWaitingCommands()},J=function(){E.sentCommands=t.getSentCommands()},$=function(){E.expiredCommands=t.getExpiredCommands()},ee=function(){let e=E.waitingCommands;B.forEach((function(a){E.activeFilters[a]&&(e=t.filterCommands(a,E.filtersData,e))})),
E.visibleWaitingCommands=e},te=function(e){0===R.units[e]&&(R.units[e]='')},ae=function(e){''===R.units[e]&&(R.units[e]=0)},ne=function(){E.showCatapultSelect=!!R.units.catapult},ie=function(e){E.selectedTab=e},oe=function(){const e=i.getSelectedVillage().data;R.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:v.getId()}},le=function(){if(!N)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));f.loadTownDataAsync(N.x,N.y,1,1,(function(e){R.target=e}))},se=function(){R.date=F()},re=function(){if(!R.date)return!1;R.date=q(R.date,100)},ce=function(){if(!R.date)return!1;R.date=q(R.date,-100)},de=function(){R.units=angular.copy(z),R.officers=angular.copy(D),R.catapultTarget="wall",E.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},E.showCatapultSelect=!1},ue=function(e){t.addCommand(R.origin,R.target,R.date,R.dateType,R.units,R.officers,e,R.catapultTarget).then((function(e){Z(),ee(),X(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case T.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case T.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case T.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case T.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case T.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case T.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,n){return n&&(e=n+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},Te=function(e,t){E.activeFilters[e]=!E.activeFilters[e],
t&&(E.filtersData[u.ALLOWED_TYPES][e]=!E.filtersData[u.ALLOWED_TYPES][e]),ee()},_e=function(){E.activeFilters[u.TEXT_MATCH]=E.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){E.presets=o.obj2selectOptions(I.getPresets())},autoCompleteSelected:function(e,t,a,n){if('commandqueue_village_search'!==t)return!1;R[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},E.searchQuery[n]=''},removeCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(E.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){E.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){R.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){R.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{b.timer.remove(e.updateCountdown)})}},be=function(){const e=A.get(m.LAST_DATE_TYPE,l.OUT,!0);let T;E=a.$new(),E.selectedTab=O,E.inventory=i.getInventory(),E.presets=o.obj2selectOptions(I.getPresets()),E.travelTimes={},o.each(p,(function(e){E.travelTimes[e]={},o.each(G,(function(t,a){E.travelTimes[e][a]={
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,n,r,c,d){let u,p,m,T,_,f=!1,b=!1,h=0;u=function(e){let t,a,n=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>n&&(n=a);return n},p=function(e,t){let a=i.getWorldConfig().getChurchBonus(),n=0
;return e<0||!t&&e>a.length-1?0:(n=t?i.getWorldConfig().getChapelBonus():a[e],Math.floor(100*n))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let A={init:function(){f=!0}};return A.start=function(){n.trigger(s.FAITH_CHECKER_STARTED),b=!0,i.getSelectedCharacter().getVillageList().forEach((function(n){let i=n.data.villageId,s=n.data.buildings.chapel.level,r=n.buildingQueue.data.queue,c=n.getResources().getComputed(),f=c.food,b=c.wood,A=c.clay,E=c.iron,w=f.currentStock,v=b.currentStock,S=A.currentStock,R=E.currentStock,y=[0,5e3],k=[160,16e3],M=[200,2e4],I=[50,5e3];1==s&&(h=1),m(i,(function(n){T=u(n.villages),_=p(T,1===s),console.log(_),50!=_||r!==t&&0!=r.length?50==_&&r?r.forEach((function(t){let n=t.building;'chapel'==n&&'church'==n||0!=h?'chapel'==n&&'church'==n||1!=h||(v>=k[1]&&S>=M[1]&&R>=I[1]&&w>=y[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:i,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):v>=k[0]&&S>=M[0]&&R>=I[0]&&w>=y[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:i,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==h?v>=k[1]&&S>=M[1]&&R>=I[1]&&w>=y[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:i,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):v>=k[0]&&S>=M[0]&&R>=I[0]&&w>=y[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:i,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},A.stop=function(){n.trigger(s.FAITH_CHECKER_STOPPED),b=!1},A.isRunning=function(){return b},A.isInitialized=function(){return f},A})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),i.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
i.register(s.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,n,i){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.FAITH_CHECKER_STARTED,(function(){n.set(o,!0)})),i.register(s.FAITH_CHECKER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c,d,u){let p,g,m=!1,T=!1,_=[],f=[],b=[],h=[],A=[];const E='fake_sender_settings',w={[c.SPEAR]:'spear',[c.SWORD]:'sword',[c.AXE]:'axe',
[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},v={[r.ATTACK]:'attack',[r.SUPPORT]:'support',[r.QUATTRO]:'four',[r.FULL]:'full'},S={[l.ARRIVE]:'date_type_arrive',[l.OUT]:'date_type_out'};console.log(w,v,S);const R=function(){_=[],f=[],b=[],h=[],A=[];const e=i.getGroupList().getGroups(),a=g[t.GROUP],n=g[t.GROUPP],o=g[t.GROUPT],l=g[t.GROUPG],s=g[t.GROUP_TARGET];a.forEach((function(t){_.push(e[t])})),n.forEach((function(t){f.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){h.push(e[t])})),s.forEach((function(t){A.push(e[t])}))},y={init:function(){m=!0,p=new e({settingsMap:n,storageKey:E}),p.onChange((function(e,t){g=p.getAll(),t[o.GROUPS]&&R()})),g=p.getAll(),console.log('fakeSender settings',g),a.$on(s.GROUPS_CREATED,R),a.$on(s.GROUPS_DESTROYED,R),
a.$on(s.GROUPS_UPDATED,R)},start:function(){T=!0,u.trigger(s.FAKE_SENDER_START)},stop:function(){T=!1,u.trigger(s.FAKE_SENDER_STOP)},getSettings:function(){return p},isInitialized:function(){return m},isRunning:function(){return T}};return y})),define('two/fakeSender/events',[],(function(){angular.extend(s,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u,p,m){let T,_,f,b=i.getGroupList();const h={FAKE:'fake',LOGS:'logs'},A=function(e){T.selectedTab=e},E=function(){_.setAll(_.decode(T.settings)),m.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},w=function(){t.isRunning()?t.stop():t.start()},v=function(){T.groups=u.encodeList(b.getGroups(),{disabled:!1,type:'groups'})
},S=function(){T.running=!0,f.classList.remove('btn-orange'),f.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},R=function(){T.running=!1,f.classList.remove('btn-red'),f.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},y=function(){T=a.$new(),T.SETTINGS=n,T.TAB_TYPES=h,T.running=t.isRunning(),T.selectedTab=h.FAKE,T.settingsMap=o,T.datetype=u.encodeList(l,{textObject:'fake_sender',disabled:!0}),T.type=u.encodeList(r,{textObject:'fake_sender',disabled:!0}),T.units=u.encodeList(d,{textObject:'fake_sender',disabled:!0}),_.injectScope(T),v(),T.selectTab=A,T.saveSettings=E,T.switchState=w;let e=new p('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.FAKE_SENDER_START,S),e.register(s.FAKE_SENDER_STOP,R),
...
return!e.between(M[r.MIN_POINTS],M[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ie=function(){!function(){const e=M[r.GROUP_INCLUDE];C=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);C=C.concat(t)})),C=ne(C)}(),function(){const e=M[r.GROUP_IGNORE];z=i.getGroupList().getGroupVillageIds(e)}(),function(){const e=M[r.GROUP_ONLY];D=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!N.getVillage(e)})),D=D.concat(t)})),D=ne(D)}(),function(){const e=z.concat(C);let t=!1;e.forEach((function(e){f.call(I,e)||(I[e]={time:A.gameTime(),report:!1},t=!0)})),T.each(I,(function(a,n){n=parseInt(n,10),e.includes(n)||(delete I[n],t=!0)})),t&&(y.set($,I),E.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),E.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=M[r.GROUP_INCLUDE],n=M[r.GROUP_IGNORE],i=M[r.GROUP_ONLY],o=N.getVillage(t.village_id);let l=!1;if(ie(),n===t.group_id&&(o?(ke(t.village_id),l=!0):(Ne(t.village_id),_e(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(xe(),_e(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),i.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){L&&e.start()})),l=!0}l&&E.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=M[r.GROUP_INCLUDE],n=M[r.GROUP_IGNORE],i=M[r.GROUP_ONLY],o=N.getVillage(t.village_id);let l=!1;if(ie(),n===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){L&&e.start()})),l=!0}else xe(),_e(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(xe(),_e(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),i.includes(t.group_id)&&o&&(ke(t.village_id),l=!0),l&&E.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=i.getGroupList().getGroups(),a=M[r.GROUP_IGNORE],n=M[r.GROUP_ONLY],o=M[r.GROUP_INCLUDE],l=f.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=n.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));k.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ie(),ye(),xe(),Re()},ce=function(){G=[];const e=i.getPresetList().getPresets();M[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),G.push(a)})),G=G.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),G.length||(E.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),L&&Oe.stop())},ue=function(e,t){M[r.IGNORE_ON_LOSS]&&M[r.GROUP_IGNORE]&&L&&t.type===w.TYPES.ATTACK&&1!==t.result&&Ie(t.target_village_id)&&(j[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=M[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===l.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=x[a].load*e)})),t},Te=function(e){I[e]={time:A.gameTime(),report:j[e]||!1},delete j[e],y.set($,I),E.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},_e=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=A.gameTime(),t.type=e,U.unshift(t),fe(),!0)},fe=function(){const e=M[r.LOGS_LIMIT];U.length>e&&U.splice(U.length-e,U.length),y.set(Z,U),E.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},be=function(e,t,a){const n=M[r.TARGET_MULTIPLE_FARMERS],i=M[r.TARGET_SINGLE_ATTACK];if(n&&a){if(i&&e)return!0}else if(i){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=A.gameTime()},Ae=function(){clearTimeout(q),clearTimeout(Y),clearTimeout(H),q=null,Y=null,H=null
...
!0):(E.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(E.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,E.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),Ae(),this.onCycleEndFn(e),this.onCycleEndFn=_},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const _=()=>new Promise((t,a)=>{e.delay?Y=setTimeout(()=>{if(Y=null,!this.running)return a(n.USER_STOP);t()},T.randomSeconds(we())):t()}),b=()=>new Promise((e,a)=>{const i=50-M[r.PRESERVE_COMMAND_SLOTS];t.length>=i?a(n.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(M[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),i=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===i))return t(n.FULL_STORAGE)}e()
}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(n.NO_TARGETS)),k=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,i=>{if(te.points(i.points))return t(n.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},i=>{this.running?null!==a.character_id||null===i.owner_id||C.includes(a.id)?a.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),I=()=>new Promise((e,t)=>{!function(e,t){const a=i.getPresetList().getPresetsByVillageId(e);let n=[];if(G.forEach((function(e){f.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)f.call(a,e)&&n.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),x=()=>new Promise((e,t)=>{const i=this.village.getUnitInfo().getUnits(),o=60*M[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,a);T.each(G,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),O=()=>new Promise((e,i)=>{c=!1,p=N.getVillageList();const o=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),be(u,c,o))return i(n.BUSY_TARGET);o&&(m=!0),e()}),L=()=>new Promise((e,t)=>{if(!u&&!c)return e();const i=60*M[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(M[r.TARGET_SINGLE_ATTACK]&&!M[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(A.gameTime()/1e3),l=M[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),T=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),_=d.getTravelTimeForDistance(g,T,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+_-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const i=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=i.some(e=>e.start_village_id!==this.villageId),l=i.some(e=>e.start_village_id===this.villageId);if(be(l,o,!0))return t(n.BUSY_TARGET);e()})});let U=new Promise((e,t)=>{_().then(b).then(S).then(y).then(k).then(I).then(x).then(O).then(L).then(P).then(e).catch(t)}),z=new Promise((e,t)=>{H=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([U,z]).then(()=>{if(!this.running)return!1
;this.setStatus(n.ATTACKING),V=!0,W=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:w.TYPES.ATTACK})}).catch(t=>{switch(Ae(),E.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case n.TIME_LIMIT:case n.BUSY_TARGET:case n.ABANDONED_CONQUERED:case n.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case n.USER_STOP:this.setStatus(t);break;case n.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Ne(a.id),this.targetStep(e);break;case n.NO_UNITS:case n.NO_TARGETS:case n.FULL_STORAGE:case n.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case n.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case n.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(n.UNKNOWN),this.stop(n.UNKNOWN)}})},ve.prototype.setStatus=function(e){this.status=e},
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,r,c,d,u,g,m,T,_,b,h,A,E,w,v){let S,R,y,k,M,I,N,x,O,L,P,U,C,z,D,G,B,V,W,F,q,Y,H,j=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/R)%2&&(t+=k),t-=t%R,a-=a%R,{x:Math.ceil((t-O.width/2)/R),y:Math.ceil((a-O.height/2)/R)}},_e=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},fe=function(){ve(M)},be=function(){if(j){const e={x:ee.x-O.width/2,y:ee.y-O.height/2};L.clearRect(0,0,O.width,O.height),z.clearRect(0,0,C.width,C.height),function(e){L.drawImage(P,-e.x,-e.y)}(e),H[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*R-e.x,n=(t.y-2)*R-e.y;z.fillStyle=H[o.COLOR_VIEW_REFERENCE],z.fillRect(a,0,1,y),z.fillRect(0,n,y,1);const i=G.getBoundingClientRect(),l=i.width/w.TILESIZE.x/v.view.z*R,s=i.height/w.TILESIZE.y/v.view.z*R,r=a-l/2,c=n-s/2;z.clearRect(r,c,l,s),z.beginPath(),z.lineWidth=1,z.strokeStyle=H[o.COLOR_VIEW_REFERENCE],z.rect(r,c,l,s),z.stroke()}(e)}e.requestAnimationFrame(be)},he=function(){if(!ne)return!1;const e=Q.village[N][x];Ee(e?Q.character[e]:[[N,x]]),ne=!1,
m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:N,y:x})},Ae=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t,H[o.COLOR_QUICK_HIGHLIGHT])},Ee=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t)},we=function(e){if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!H[o.SHOW_BARBARIANS]&&F.barbarian;if(e.character_id===V){if(e.id===I.getId()&&H[o.HIGHLIGHT_SELECTED])return F.selected;if(e.character_id in K.character)return K.character[e.character_id];if(H[o.HIGHLIGHT_OWN])return F.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&H[o.HIGHLIGHT_DIPLOMACY])return F.tribe;if(q&&H[o.HIGHLIGHT_DIPLOMACY]){if(q.isAlly(e.tribe_id))return F.ally;if(q.isEnemy(e.tribe_id))return F.enemy
;if(q.isNAP(e.tribe_id))return F.friendly}}return F.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||we(n);if(!i)continue;const o=n.x*R+(n.y%2?k:0),l=n.y*R;U.fillStyle=i,U.fillRect(o,l,S,S)}},Se=function(){S=oe[H[o.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,P.width=1e3*R,P.height=1e3*R,U.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;O.width=686,O.height=e,C.width=686,C.height=e,L.imageSmoothingEnabled=!1,z.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[N,x,e]),3===e.which&&(a=N,n=x,_.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(H[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id},A.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({
type:'tribe',id:e.tribe_id},A.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Me=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!H[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(N===e.x&&x===e.y)return!1;he()}ne=!0,N=e.x,x=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:N,y:x,event:t});const a=Q.village[N][x];Ae(a?Q.character[a]:[[N,x]])}(pe,e)}he()},Ie=function(){ne&&he(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},Ne=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},xe=function(e){return e.preventDefault(),!1},Oe=function(){K.tribe=le.getCustomColorsByGroup(E.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(E.PLAYER_COLORS)||{},fe()},Le=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?E.PLAYER_COLORS:E.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t];const n='character'===e?E.PLAYER_COLORS:E.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e]),
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){O=e,O.style.background=H[o.COLOR_BACKGROUND],L=O.getContext('2d')},setViewportRef:function(e){C=e,z=C.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!D.width||!D.height)return!1;let e=_.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=_e(e[0]*t,e[1]*t),n=_e(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,D.width/2,D.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return Y},Pe.drawMinimap=function(){ge&&(ge=!1),O.style.background=H[o.COLOR_BACKGROUND],U.clearRect(0,0,P.width,P.height),d((function(){!function(){
const e=h.getPath(w.getMapPath()),t=H[o.SHOW_CONTINENT_DEMARCATIONS],a=H[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){U.fillStyle=H[o.COLOR_CONTINENT],U.fillRect(e*R+k-1,t*R+k-1,3,1),U.fillRect(e*R+k,t*R+k-2,1,3)},i=function(e,t){U.fillStyle=H[o.COLOR_PROVINCE],U.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=b.toTile(o,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&i(e,l))}const r=l.a*R,c=s.a*R,d=(l.b-l.a)*R,u=(s.b-s.a)*R;U.beginPath(),U.lineWidth=2,U.strokeStyle="#2B4700",U.rect(r,c,d,u),U.stroke()}))}(),fe()}),'minimap_data')},Pe.enableRendering=function(){j=!0},Pe.disableRendering=function(){j=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),U=P.getContext('2d'),re=se.make('hover'),Y=new u({settingsMap:l,storageKey:ie}),Y.onChange((function(e,t){H=Y.getAll(),
Se(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),H=Y.getAll(),K.tribe=le.getCustomColorsByGroup(E.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(E.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){G=document.getElementById('map'),D=document.getElementById('main-canvas'),B=i.getSelectedCharacter(),q=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),F=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),Re(),I=B.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*R,ee.y=I.getY()*R,e.addEventListener('resize',Re,!1),C.addEventListener('mousedown',ye),C.addEventListener('mouseup',ke),C.addEventListener('mousemove',Me),C.addEventListener('mouseleave',Ie),C.addEventListener('click',Ne),C.addEventListener('contextmenu',xe),g.load((function(){M=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(M),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),be(),a.$on(s.VILLAGE_SELECTED_CHANGED,Le),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Oe)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,T,_,f,b,h,A,E){let w,v,S,R,y,k,M,I,N,x,O,L={},P=!1,U={character:{},tribe:{}};const C={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=C.MINIMAP,D=function(e){w.selectedTab=e,e===C.MINIMAP?i.enableRendering():i.disableRendering()},G=function(){Object.keys(w.highlights.character).forEach((function(e){e in U.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
U.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in U.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){U.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!N)return;let a=B(t.x,t.y);var n,i;x=a,L[a]=!0,P=!0,(n=t.x,i=t.y,new Promise((function(e){let t=h.getTownAt(n,i);if(t)return e(t);h.loadTownDataAsync(n,i,1,1,(function(t){e(t)}))}))).then((function(e){if(!L[B(e.x,e.y)])return;if(!P)return;M.appendChild(N),N.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=N.getBoundingClientRect(),n=M.getBoundingClientRect(),i=a.width+50,o=a.height+50,l=k.tt.position.y+o>n.top+n.height,s=k.tt.position.x+i>n.width;l&&(k.tt.position.y-=50),N.classList.toggle('left',s),N.classList.toggle('top',l)}))},W=function(e,t){if(!N)return;let a=t?B(t):x;L[a]=!1,P=!1,k.tt.visible=!1,N.classList.add('ng-hide'),I.appendChild(N)},F=function(e,t,n){let o,l,s=a.$new(),r=!0;s.colorPalettes=E.palette,'setting'===e?(l=t,o=O.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=O.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][n],s.submit=function(){i.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},q=function(){i.addHighlight(w.selectedHighlight,w.addHighlightColor)},Y=function(){O.setAll(O.decode(w.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},H=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){O.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},j=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){G()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+A.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=C,w.selectedTab=z,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=i.getHighlights(),w.highlightNames=U,w.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=D,w.openColorPalette=F,w.addCustomHighlight=q,w.removeHighlight=i.removeHighlight,w.saveSettings=Y,w.resetSettings=H,w.highlightsCount=j,w.openProfile=K,O.injectScope(w,{textObject:'minimap'});let e=new _('twoverflow_minimap_window',(function(){i.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),G(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(S),y.appendChild(R),i.enableRendering(),i.isFirstDraw()&&i.drawMinimap()};return function(){O=i.getSettings(),k=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',R=document.createElement('canvas'),R.className='cross',i.setViewport(S),i.setViewportRef(R),N=document.querySelector('#map-tooltip'),M=document.querySelector('#wrapper'),I=document.querySelector('#map'),v=t.addMenuButton4('Minimapa',30,g('i18n')('general.description',a.loc.ale,'minimap')),v.addEventListener('click',(function(){const e=i.getMapPosition();if(!e)return!1;X(),i.setCurrentPosition(e.x,e.y)})),
...
e.trigger(s.MINT_HELPER_STARTED),a=!0,r()},stop:function(){e.trigger(s.MINT_HELPER_STOPPED),a=!1},isRunning:function(){return a},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(s,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton2('Mincerz',50,g('i18n')('description',a.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'mint_helper'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'mint_helper')))})),i.register(s.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),
t.isRunning()&&i.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,n,i){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.AUTO_HELPER_STARTED,(function(){n.set(o,!0)})),i.register(s.AUTO_HELPER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/powerHelper',['two/Settings','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/settings/updates','two/powerHelper/types/ironwalls','two/powerHelper/types/wall','two/ready','queues/EventQueue'],(function(e,t,a,n,i,o,l,r){let c,d,u=!1,p=!1;const g='power_helper_settings',m={[i.LEVEL_1]:1,[i.LEVEL_2]:2,[i.LEVEL_3]:3,[i.LEVEL_4]:4,[i.LEVEL_5]:5},T={[o.NO_WALL]:0,[o.LEVEL_1]:5,[o.LEVEL_2]:10,[o.LEVEL_3]:15,[o.LEVEL_4]:20,[o.LEVEL_5]:25,[o.LEVEL_6]:30,[o.LEVEL_7]:35,[o.LEVEL_8]:40,[o.LEVEL_9]:45,
[o.LEVEL_10]:50,[o.LEVEL_11]:55,[o.LEVEL_12]:60,[o.LEVEL_13]:65,[o.LEVEL_14]:70,[o.LEVEL_15]:75,[o.LEVEL_16]:80,[o.LEVEL_17]:85,[o.LEVEL_18]:90,[o.LEVEL_19]:95,[o.LEVEL_20]:100};console.log(m,T);const _={init:function(){u=!0,c=new e({settingsMap:a,storageKey:g}),c.onChange((function(){d=c.getAll()})),d=c.getAll(),console.log('powerHelper settings',d)},start:function(){p=!0,r.trigger(s.POWER_HELPER_START)},stop:function(){p=!1,console.log('powerHelper stop'),r.trigger(s.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/powerHelper/events',[],(function(){angular.extend(s,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/types/ironwalls','two/powerHelper/types/wall','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,o,l,r,d,u){let p,g,m;const T={POWERS:'powers',BUNKER:'bunker',BEATBUNKER:'beatbunker'},_=function(e){p.selectedTab=e},f=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},b=function(){t.isRunning()?t.stop():t.start()},h=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},A=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),u.notif('success','Example module stopped')},E=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.POWERS,p.settingsMap=i,p.wall=r.encodeList(l,{textObject:'battle_calculator',disabled:!0}),p.ironwalls=r.encodeList(o,{textObject:'battle_calculator',disabled:!0
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c){let d,u,p=!1,g=!1,m=[];const T='prank_helper_settings',_={[l.INCREASE]:'increase',[l.DECREASE]:'decrease',[l.RANDOM]:'random'};console.log(_);const f=function(){m=[];const e=i.getGroupList().getGroups();u[t.GROUPS].forEach((function(t){m.push(e[t])}))},b={init:function(){p=!0,d=new e({settingsMap:n,storageKey:T}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&f()})),u=d.getAll(),console.log('all settings',u),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){g=!0,c.trigger(s.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(s.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return b})),define('two/prankHelper/events',[],(function(){angular.extend(s,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u){let p,g,m,T=i.getGroupList();const _={RENAME:'rename',LOGS:'logs'},f=function(e){p.selectedTab=e},b=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},E=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},w=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
u.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=_,p.running=t.isRunning(),p.selectedTab=_.RENAME,p.settingsMap=o,p.type=r.encodeList(l,{textObject:'prank_helper',disabled:!0}),g.injectScope(p),A(),p.selectTab=f,p.saveSettings=b,p.switchState=h;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(s.GROUPS_CREATED,A,!0),e.register(s.GROUPS_DESTROYED,A,!0),e.register(s.GROUPS_UPDATED,A,!0),e.register(s.PRANK_HELPER_START,E),e.register(s.PRANK_HELPER_STOP,w),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',80),m.addEventListener('click',v),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r){let c,d,u=!1,p=!1,g=[],m=[],T=[],_=[];const f='preset_asigner_settings',b=function(){g=[],m=[];const e=i.getPresetList().getPresets(),a=d[t.PRESETS1],n=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),n.forEach((function(t){m.push(e[t])}))},h=function(){T=[],_=[];const e=i.getGroupList().getGroups(),a=d[t.GROUP1],n=d[t.GROUP2];a.forEach((function(t){T.push(e[t])})),n.forEach((function(t){_.push(e[t])}))},A={init:function(){u=!0,c=new e({settingsMap:n,storageKey:f}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&h()})),d=c.getAll(),console.log('presetAsigner settings',d),l((function(){b()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,b),a.$on(s.ARMY_PRESET_DELETED,b),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){p=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return A})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d){let u,p,g,m=i.getPresetList(),T=i.getGroupList();const _={PRESETS:'presets',LOGS:'logs'},f=function(e){u.selectedTab=e},b=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()
},A=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},E=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=_,u.running=t.isRunning(),u.selectedTab=_.PRESETS,u.settingsMap=o,p.injectScope(u),A(),E(),u.selectTab=f,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,E,!0),e.register(s.GROUPS_DESTROYED,E,!0),e.register(s.GROUPS_UPDATED,E,!0),e.register(s.PRESET_ASIGNER_START,w),e.register(s.PRESET_ASIGNER_STOP,v),
...
;const e=i.getGroupList(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],c=b[r.GROUP4];var d=e.getGroupVillageIds(t),u=e.getGroupVillageIds(a),p=e.getGroupVillageIds(n),g=e.getGroupVillageIds(c)
;const T=b[r.MIN_PACK1],f=b[r.MIN_PACK2],h=b[r.MIN_PACK3],A=b[r.MIN_PACK4],S=b[r.START_AMOUNT4],R=b[r.START_AMOUNT3],y=b[r.START_AMOUNT9],k=b[r.START_AMOUNT7],M=b[r.START_AMOUNT5],I=b[r.START_AMOUNT6],N=b[r.START_AMOUNT8],x=b[r.START_AMOUNT1],O=b[r.START_AMOUNT2],L=b[r.START_AMOUNT14],P=b[r.START_AMOUNT13],U=b[r.START_AMOUNT19],C=b[r.START_AMOUNT17],z=b[r.START_AMOUNT15],D=b[r.START_AMOUNT16],G=b[r.START_AMOUNT18],B=b[r.START_AMOUNT11],V=b[r.START_AMOUNT12],W=b[r.START_AMOUNT24],F=b[r.START_AMOUNT23],q=b[r.START_AMOUNT29],Y=b[r.START_AMOUNT27],H=b[r.START_AMOUNT25],j=b[r.START_AMOUNT26],K=b[r.START_AMOUNT28],Q=b[r.START_AMOUNT21],X=b[r.START_AMOUNT22],Z=b[r.START_AMOUNT34],te=b[r.START_AMOUNT33],ae=b[r.START_AMOUNT39],ne=b[r.START_AMOUNT37],ie=b[r.START_AMOUNT35],oe=b[r.START_AMOUNT36],le=b[r.START_AMOUNT38],se=b[r.START_AMOUNT31],re=b[r.START_AMOUNT32],ce=b[r.FINAL_AMOUNT4],de=b[r.FINAL_AMOUNT3],ue=b[r.FINAL_AMOUNT9],pe=b[r.FINAL_AMOUNT7],ge=b[r.FINAL_AMOUNT5],me=b[r.FINAL_AMOUNT6],Te=b[r.FINAL_AMOUNT8],_e=b[r.FINAL_AMOUNT1],fe=b[r.FINAL_AMOUNT2],be=b[r.FINAL_AMOUNT14],he=b[r.FINAL_AMOUNT13],Ae=b[r.FINAL_AMOUNT19],Ee=b[r.FINAL_AMOUNT17],we=b[r.FINAL_AMOUNT15],ve=b[r.FINAL_AMOUNT16],Se=b[r.FINAL_AMOUNT18],Re=b[r.FINAL_AMOUNT11],ye=b[r.FINAL_AMOUNT12],ke=b[r.FINAL_AMOUNT24],Me=b[r.FINAL_AMOUNT23],Ie=b[r.FINAL_AMOUNT29],Ne=b[r.FINAL_AMOUNT27],xe=b[r.FINAL_AMOUNT25],Oe=b[r.FINAL_AMOUNT26],Le=b[r.FINAL_AMOUNT28],Pe=b[r.FINAL_AMOUNT21],Ue=b[r.FINAL_AMOUNT22],Ce=b[r.FINAL_AMOUNT34],ze=b[r.FINAL_AMOUNT33],De=b[r.FINAL_AMOUNT39],Ge=b[r.FINAL_AMOUNT37],Be=b[r.FINAL_AMOUNT35],Ve=b[r.FINAL_AMOUNT36],We=b[r.FINAL_AMOUNT38],Fe=b[r.FINAL_AMOUNT31],qe=b[r.FINAL_AMOUNT32]
;var Ye=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],He=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],je=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],Ke=[1,1,1,1,4,5,6,5,8,1,100,10,6],Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,ot=0,lt=0,st=0,rt='',ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,_t=0,ft=0,bt=0,ht=0,At=0,Et=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,Mt=0,It=0,Nt=0,xt=0,Ot=0,Lt=0,Pt=0,Ut=0,Ct=0,zt=0,Dt=0,Gt=0,Bt=0,Vt=0,Wt=0,Ft=0,qt=0,Yt=0,Ht=0,jt=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=[],Ta=0,_a=0,fa=0,ba=[],ha=0,Aa=0,Ea=0,wa=[],va=0,Sa=0,Ra=0,ya=[],ka=0,Ma=0,Ia=0,Na=0,xa=0,Oa=0,La=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,Fa=0,qa=0,Ya=0,Ha=0,ja=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0;function sn(){_a=t>0?ot.length>=2?1:1==ot.length?.5:.25:0,function(){Ta=ma.length>0?ma.reduce((function(e,t){return e+t})):0;!function(){
fa=t>0?Ta>=936e5?0:Ta<936e5&&Ta>=864e5?.1:Ta<864e5&&Ta>=72e6?.25:Ta<72e6&&Ta>=576e5?.4:Ta<576e5&&Ta>=432e5?.55:Ta<432e5&&Ta>=288e5?.7:Ta<288e5&&Ta>=144e5?.85:Ta<144e5&&Ta>=72e5?.925:Ta<72e5&&Ta>=36e5?.9625:1:0;e=_e-Qe,a=fe-Xe,n=de-Ze,i=ce-Je,r=ge-$e,c=me-et,d=Te-tt,u=ue-at,p=pe-nt,g=Math.floor(x*fa*_a),_=Math.floor(O*fa*_a),f=Math.floor(R*fa*_a),b=Math.floor(S*fa*_a),h=Math.floor(M*fa*_a),A=Math.floor(I*fa*_a),E=Math.floor(N*fa*_a),w=Math.floor(y*fa*_a),L=Math.floor(k*fa*_a),console.log(g,_,f,b,h,A,E,L,w),Na=g*Ye[0]+_*Ye[1]+f*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+L*Ye[6],xa=g*He[0]+_*He[1]+f*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+L*He[6],La=g*je[0]+_*je[1]+f*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+L*je[6],Oa=g*Ke[0]+_*Ke[1]+f*Ke[2]+b*Ke[3]+h*Ke[4]+A*Ke[5]+E*Ke[7]+w*Ke[8]+L*Ke[6],console.log(Na,xa,La,Oa),e>0||p>0||u>0||a>0||n>0||i>0||r>0||c>0||d>0?(Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa<=Pa?(oa=g,ca=_,ft=f,gt=b,Yt=h,Qt=A,
$t=E,Et=w,zt=L):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa<=Pa?(Lt=Ua/Na,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*_)-1,ft=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa<=Pa?(Lt=Ca/xa,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*_)-1,ft=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa<=Pa?(Lt=za/La,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*_)-1,ft=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,
zt=Math.floor(Lt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa>=Pa?(Lt=Pa/Oa,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*_)-1,ft=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa<=Pa?(Rt=Ca/xa)>(ct=Ua/Na)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*_)-1,ft=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*_)-1,ft=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La>=za&&Oa<=Pa?(Rt=Ca/xa)>(Vt=za/La)?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*_)-1,
ft=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*_)-1,ft=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa>=Pa?(Rt=Ca/xa)>(It=Pa/Oa)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*_)-1,ft=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*_)-1,ft=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa<=Pa?(Vt=za/La)>(ct=Ua/Na)?(oa=Math.floor(ct*g)-1,
ca=Math.floor(ct*_)-1,ft=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*_)-1,ft=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa>=Pa?(Vt=za/La)>(It=Pa/Oa)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*_)-1,ft=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*_)-1,ft=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,
zt=Math.floor(Vt*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa>=Pa?(It=Pa/Oa)>(ct=Ua/Na)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*_)-1,ft=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):(oa=Math.floor(It*g)-1,ca=Math.floor(It*_)-1,ft=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La>=za&&Oa<=Pa?(ct=Ua/Na,(Rt=Ca/xa)>(Vt=za/La)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*_)-1,ft=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Vt>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*_)-1,ft=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,
Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Vt>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*_)-1,ft=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):console.log('Nie znam przyczyny :P')):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa>=Pa?(ct=Ua/Na,(Rt=Ca/xa)>(It=Pa/Oa)&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*_)-1,ft=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):It>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*_)-1,ft=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):It>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*_)-1,ft=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,
Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):console.log('Nie znam przyczyny :P')):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa>=Pa?(ct=Ua/Na,(It=Pa/Oa)>(Vt=za/La)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*_)-1,ft=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Vt>It&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*_)-1,ft=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):Vt>ct&&It>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*_)-1,ft=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,
zt=Math.floor(ct*L)-1):console.log('Nie znam przyczyny :P')):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La>=za&&Oa>=Pa&&(It=Pa/Oa,(Rt=Ca/xa)>(Vt=za/La)&&It>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*_)-1,ft=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Vt>Rt&&It>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*_)-1,ft=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Vt>It&&Rt>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*_)-1,ft=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){oa>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:oa}),v=[rt='spear',oa],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){it>=3&&(ca>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'sword',amount:ca}),v=[rt='sword',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ca)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){it>=5&&(ft>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:ft}),v=[rt='axe',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ft)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){it>=9&&(gt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:gt}),v=[rt='archer',gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(Da,rt,gt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){it>=11&&(Yt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:Yt}),v=[rt='light_cavalry',Yt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Yt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){it>=13&&(Qt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'mounted_archer',amount:Qt}),v=[rt='mounted_archer',Qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Qt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){it>=15&&($t>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'ram',amount:$t}),v=[rt='ram',$t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,$t)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){it>=17&&(Et>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:Et}),v=[rt='catapult',Et],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Et)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){it>=21&&(zt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:zt}),v=[rt='heavy_cavalry',zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,zt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,i,r,c,d,u,p,g,_,f,b,h,A,E,w,L}()}()}function rn(){Aa=a>0?Ba.length>=2?1:1==Ba.length?.5:.25:0,function(){ha=ba.length>0?ba.reduce((function(e,t){return e+t})):0;!function(){
Ea=a>0?ha>=936e5?0:ha<936e5&&ha>=864e5?.1:ha<864e5&&ha>=72e6?.25:ha<72e6&&ha>=576e5?.4:ha<576e5&&ha>=432e5?.55:ha<432e5&&ha>=288e5?.7:ha<288e5&&ha>=144e5?.85:ha<144e5&&ha>=72e5?.925:ha<72e5&&ha>=36e5?.9625:1:0;e=Re-Qe,t=ye-Xe,n=he-Ze,i=be-Je,r=we-$e,c=ve-et,d=Se-tt,u=Ae-at,p=Ee-nt,g=Math.floor(B*Ea*Aa),T=Math.floor(V*Ea*Aa),_=Math.floor(P*Ea*Aa),b=Math.floor(L*Ea*Aa),h=Math.floor(z*Ea*Aa),A=Math.floor(D*Ea*Aa),E=Math.floor(G*Ea*Aa),w=Math.floor(U*Ea*Aa),S=Math.floor(C*Ea*Aa),R=g*Ye[0]+T*Ye[1]+_*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],y=g*He[0]+T*He[1]+_*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],k=g*je[0]+T*je[1]+_*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],M=g*Ke[0]+T*Ke[1]+_*Ke[2]+b*Ke[3]+h*Ke[4]+A*Ke[5]+E*Ke[7]+w*Ke[8]+S*Ke[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||n>0||i>0||r>0||c>0||d>0?(R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k<=Ya&&M<=Wa?(la=g,da=T,bt=_,mt=b,Ht=h,Xt=A,ea=E,wt=w,
Dt=S):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k<=Ya&&M<=Wa?(Pt=Fa/R,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*b)-1,Ht=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k<=Ya&&M<=Wa?(Pt=qa/y,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*b)-1,Ht=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k>=Ya&&M<=Wa?(Pt=Ya/k,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*b)-1,Ht=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k<=Ya&&M>=Wa?(Pt=Wa/M,la=Math.floor(Pt*g)-1,
da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*b)-1,Ht=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k<=Ya&&M<=Wa?(yt=qa/y)>(dt=Fa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*b)-1,Ht=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*b)-1,Ht=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k>=Ya&&M<=Wa?(yt=qa/y)>(Wt=Ya/k)?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*b)-1,Ht=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,
Dt=Math.floor(Wt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*b)-1,Ht=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k<=Ya&&M>=Wa?(yt=qa/y)>(Nt=Wa/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*b)-1,Ht=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*b)-1,Ht=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k>=Ya&&M<=Wa?(Wt=Ya/k)>(dt=Fa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*b)-1,Ht=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,
wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*b)-1,Ht=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k>=Ya&&M>=Wa?(Wt=Ya/k)>(Nt=Wa/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*b)-1,Ht=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*b)-1,Ht=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k<=Ya&&M>=Wa?(Nt=Wa/M)>(dt=Fa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*b)-1,Ht=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,
ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*b)-1,Ht=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k>=Ya&&M<=Wa?(dt=Fa/R,(yt=qa/y)>(Wt=Ya/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*b)-1,Ht=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*b)-1,Ht=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*b)-1,Ht=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,
Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k<=Ya&&M>=Wa?(dt=Fa/R,(yt=qa/y)>(Nt=Wa/M)&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*b)-1,Ht=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Nt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*b)-1,Ht=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Nt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*b)-1,Ht=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y<=qa&&k>=Ya&&M>=Wa?(dt=Fa/R,(Nt=Wa/M)>(Wt=Ya/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,
da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*b)-1,Ht=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>Nt&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*b)-1,Ht=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Wt>dt&&Nt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*b)-1,Ht=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R<=Fa&&(e>=f||p>=f||u>=f||t>=f||n>=f||i>=f||r>=f||c>=f||d>=f)&&y>=qa&&k>=Ya&&M>=Wa&&(Nt=Wa/M,(yt=qa/y)>(Wt=Ya/k)&&Nt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*b)-1,Ht=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&Nt>yt?(la=Math.floor(yt*g)-1,
da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*b)-1,Ht=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>Nt&&yt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*b)-1,Ht=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){la>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:la}),v=[rt='spear',la],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,la)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ga>=3&&(da>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'sword',amount:da}),v=[rt='sword',da],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,da)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){Ga>=5&&(bt>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:bt}),v=[rt='axe',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,bt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ga>=9&&(mt>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:mt}),v=[rt='archer',mt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,mt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ga>=11&&(Ht>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:Ht}),v=[rt='light_cavalry',Ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Ht)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ga>=13&&(Xt>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'mounted_archer',amount:Xt}),
v=[rt='mounted_archer',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Xt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ga>=15&&(ea>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'ram',amount:ea}),v=[rt='ram',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ea)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Ga>=17&&(wt>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:wt}),v=[rt='catapult',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,wt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Ga>=21&&(Dt>=f?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:Dt}),v=[rt='heavy_cavalry',Dt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(Da,rt,Dt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,n,i,r,c,d,u,p,g,T,_,b,h,A,E,w,S,R,y,k,M}()}()}function cn(){Sa=n>0?ja.length>=2?1:1==ja.length?.5:.25:0,function(){va=wa.length>0?wa.reduce((function(e,t){return e+t})):0;!function(){Ra=n>0?va>=936e5?0:va<936e5&&va>=864e5?.1:va<864e5&&va>=72e6?.25:va<72e6&&va>=576e5?.4:va<576e5&&va>=432e5?.55:va<432e5&&va>=288e5?.7:va<288e5&&va>=144e5?.85:va<144e5&&va>=72e5?.925:va<72e5&&va>=36e5?.9625:1:0;e=Pe-Qe,t=Ue-Xe,a=Me-Ze,i=ke-Je,r=xe-$e,c=Oe-et,d=Le-tt,u=Ie-at,p=Ne-nt,g=Math.floor(Q*Ra*Sa),T=Math.floor(X*Ra*Sa),_=Math.floor(F*Ra*Sa),f=Math.floor(W*Ra*Sa),b=Math.floor(H*Ra*Sa),A=Math.floor(j*Ra*Sa),E=Math.floor(K*Ra*Sa),w=Math.floor(q*Ra*Sa),S=Math.floor(Y*Ra*Sa),R=g*Ye[0]+T*Ye[1]+_*Ye[2]+f*Ye[3]+b*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],y=g*He[0]+T*He[1]+_*He[2]+f*He[3]+b*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],
k=g*je[0]+T*je[1]+_*je[2]+f*je[3]+b*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],M=g*Ke[0]+T*Ke[1]+_*Ke[2]+f*Ke[3]+b*Ke[4]+A*Ke[5]+E*Ke[7]+w*Ke[8]+S*Ke[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||a>0||i>0||r>0||c>0||d>0?(R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M<=Qa?(sa=g,ua=T,ht=_,Tt=f,jt=b,Zt=A,ta=E,vt=w,Gt=S):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M<=Qa?(Ut=Xa/R,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M<=Qa?(Ut=Za/y,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,
Gt=Math.floor(Ut*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M<=Qa?(Ut=Ja/k,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M>=Qa?(Ut=Qa/M,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M<=Qa?(kt=Za/y)>(ut=Xa/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,
jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k>=Ja&&M<=Qa?(kt=Za/y)>(Ft=Ja/k)?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*A)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M>=Qa?(kt=Za/y)>(xt=Qa/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,
Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M<=Qa?(Ft=Ja/k)>(ut=Xa/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*A)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M>=Qa?(Ft=Ja/k)>(xt=Qa/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,
ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*A)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M>=Qa?(xt=Qa/M)>(ut=Xa/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k>=Ja&&M<=Qa?(ut=Xa/R,(kt=Za/y)>(Ft=Ja/k)&&ut>Ft?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*A)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,
Gt=Math.floor(Ft*S)-1):Ft>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):Ft>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M>=Qa?(ut=Xa/R,(kt=Za/y)>(xt=Qa/M)&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):xt>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,
Gt=Math.floor(kt*S)-1):xt>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M>=Qa?(ut=Xa/R,(xt=Qa/M)>(Ft=Ja/k)&&ut>Ft?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*A)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):Ft>xt&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):Ft>ut&&xt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,
Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k>=Ja&&M>=Qa&&(xt=Qa/M,(kt=Za/y)>(Ft=Ja/k)&&xt>Ft?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*A)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):Ft>kt&&xt>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):Ft>xt&&kt>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){sa>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:sa}),v=[rt='spear',sa],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,sa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ha>=3&&(ua>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'sword',amount:ua}),v=[rt='sword',ua],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ua)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Ha>=5&&(ht>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:ht}),v=[rt='axe',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ht)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ha>=9&&(Tt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:Tt}),v=[rt='archer',Tt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(Da,rt,Tt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ha>=11&&(jt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:jt}),v=[rt='light_cavalry',jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,jt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ha>=13&&(Zt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'mounted_archer',amount:Zt}),v=[rt='mounted_archer',Zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Zt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ha>=15&&(ta>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'ram',amount:ta}),v=[rt='ram',ta],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ta)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){Ha>=17&&(vt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:vt}),v=[rt='catapult',vt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,vt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Ha>=21&&(Gt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:Gt}),v=[rt='heavy_cavalry',Gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Gt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,a,i,r,c,d,u,p,g,T,_,f,b,A,E,w,S,R,y,k,M}()}()}function dn(){Ma=c>0?en.length>=2?1:1==en.length?.5:.25:0,function(){ka=ya.length>0?ya.reduce((function(e,t){return e+t})):0;!function(){
Ia=c>0?ka>=936e5?0:ka<936e5&&ka>=864e5?.1:ka<864e5&&ka>=72e6?.25:ka<72e6&&ka>=576e5?.4:ka<576e5&&ka>=432e5?.55:ka<432e5&&ka>=288e5?.7:ka<288e5&&ka>=144e5?.85:ka<144e5&&ka>=72e5?.925:ka<72e5&&ka>=36e5?.9625:1:0;e=Fe-Qe,t=qe-Xe,a=ze-Ze,n=Ce-Je,i=Be-$e,r=Ve-et,d=We-tt,u=De-at,p=Ge-nt,g=Math.floor(se*Ia*Ma),T=Math.floor(re*Ia*Ma),_=Math.floor(te*Ia*Ma),f=Math.floor(Z*Ia*Ma),b=Math.floor(ie*Ia*Ma),h=Math.floor(oe*Ia*Ma),E=Math.floor(le*Ia*Ma),w=Math.floor(ae*Ia*Ma),S=Math.floor(ne*Ia*Ma),R=g*Ye[0]+T*Ye[1]+_*Ye[2]+f*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],y=g*He[0]+T*He[1]+_*He[2]+f*He[3]+b*He[4]+h*He[5]+E*He[7]+w*He[8]+S*He[6],k=g*je[0]+T*je[1]+_*je[2]+f*je[3]+b*je[4]+h*je[5]+E*je[7]+w*je[8]+S*je[6],M=g*Ke[0]+T*Ke[1]+_*Ke[2]+f*Ke[3]+b*Ke[4]+h*Ke[5]+E*Ke[7]+w*Ke[8]+S*Ke[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||i<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M<=an?(ra=g,pa=T,
At=_,_t=f,Kt=b,Jt=h,aa=E,St=w,Bt=S):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M<=an?(Ct=nn/R,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*_)-1,_t=Math.floor(Ct*f)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,Bt=Math.floor(Ct*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M<=an?(Ct=on/y,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*_)-1,_t=Math.floor(Ct*f)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,Bt=Math.floor(Ct*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M<=an?(Ct=ln/k,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*_)-1,_t=Math.floor(Ct*f)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,
Bt=Math.floor(Ct*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M>=an?(Ct=an/M,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*_)-1,_t=Math.floor(Ct*f)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,Bt=Math.floor(Ct*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M<=an?(Mt=on/y)>(pt=nn/R)?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*_)-1,_t=Math.floor(pt*f)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k>=ln&&M<=an?(Mt=on/y)>(qt=ln/k)?(ra=Math.floor(qt*g)-1,pa=Math.floor(qt*T)-1,At=Math.floor(qt*_)-1,
_t=Math.floor(qt*f)-1,Kt=Math.floor(qt*b)-1,Jt=Math.floor(qt*h)-1,aa=Math.floor(qt*E)-1,St=Math.floor(qt*w)-1,Bt=Math.floor(qt*S)-1):(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M>=an?(Mt=on/y)>(Ot=an/M)?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*_)-1,_t=Math.floor(Ot*f)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M<=an?(qt=ln/k)>(pt=nn/R)?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,
At=Math.floor(pt*_)-1,_t=Math.floor(pt*f)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):(ra=Math.floor(qt*g)-1,pa=Math.floor(qt*T)-1,At=Math.floor(qt*_)-1,_t=Math.floor(qt*f)-1,Kt=Math.floor(qt*b)-1,Jt=Math.floor(qt*h)-1,aa=Math.floor(qt*E)-1,St=Math.floor(qt*w)-1,Bt=Math.floor(qt*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M>=an?(qt=ln/k)>(Ot=an/M)?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*_)-1,_t=Math.floor(Ot*f)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):(ra=Math.floor(qt*g)-1,pa=Math.floor(qt*T)-1,At=Math.floor(qt*_)-1,_t=Math.floor(qt*f)-1,Kt=Math.floor(qt*b)-1,Jt=Math.floor(qt*h)-1,aa=Math.floor(qt*E)-1,St=Math.floor(qt*w)-1,Bt=Math.floor(qt*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M>=an?(Ot=an/M)>(pt=nn/R)?(ra=Math.floor(pt*g)-1,
pa=Math.floor(pt*T)-1,At=Math.floor(pt*_)-1,_t=Math.floor(pt*f)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*_)-1,_t=Math.floor(Ot*f)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k>=ln&&M<=an?(pt=nn/R,(Mt=on/y)>(qt=ln/k)&&pt>qt?(ra=Math.floor(qt*g)-1,pa=Math.floor(qt*T)-1,At=Math.floor(qt*_)-1,_t=Math.floor(qt*f)-1,Kt=Math.floor(qt*b)-1,Jt=Math.floor(qt*h)-1,aa=Math.floor(qt*E)-1,St=Math.floor(qt*w)-1,Bt=Math.floor(qt*S)-1):qt>Mt&&pt>Mt?(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):qt>pt&&Mt>pt?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*_)-1,
_t=Math.floor(pt*f)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):console.log('Nie znam przyczyny :P')):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M>=an?(pt=nn/R,(Mt=on/y)>(Ot=an/M)&&pt>Ot?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*_)-1,_t=Math.floor(Ot*f)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):Ot>Mt&&pt>Mt?(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):Ot>pt&&Mt>pt?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*_)-1,_t=Math.floor(pt*f)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,
Bt=Math.floor(pt*S)-1):console.log('Nie znam przyczyny :P')):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M>=an?(pt=nn/R,(Ot=an/M)>(qt=ln/k)&&pt>qt?(ra=Math.floor(qt*g)-1,pa=Math.floor(qt*T)-1,At=Math.floor(qt*_)-1,_t=Math.floor(qt*f)-1,Kt=Math.floor(qt*b)-1,Jt=Math.floor(qt*h)-1,aa=Math.floor(qt*E)-1,St=Math.floor(qt*w)-1,Bt=Math.floor(qt*S)-1):qt>Ot&&pt>Ot?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*_)-1,_t=Math.floor(Ot*f)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):qt>pt&&Ot>pt?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*_)-1,_t=Math.floor(pt*f)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):console.log('Nie znam przyczyny :P')):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k>=ln&&M>=an&&(Ot=an/M,(Mt=on/y)>(qt=ln/k)&&Ot>qt?(ra=Math.floor(qt*g)-1,
pa=Math.floor(qt*T)-1,At=Math.floor(qt*_)-1,_t=Math.floor(qt*f)-1,Kt=Math.floor(qt*b)-1,Jt=Math.floor(qt*h)-1,aa=Math.floor(qt*E)-1,St=Math.floor(qt*w)-1,Bt=Math.floor(qt*S)-1):qt>Mt&&Ot>Mt?(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):qt>Ot&&Mt>Ot?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*_)-1,_t=Math.floor(Ot*f)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ra>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:ra}),v=[rt='spear',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ra)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){$a>=3&&(pa>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,
unit_type:'sword',amount:pa}),v=[rt='sword',pa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,pa)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){$a>=5&&(At>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:At}),v=[rt='axe',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,At)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){$a>=9&&(_t>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:_t}),v=[rt='archer',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,_t)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){$a>=11&&(Kt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:Kt}),v=[rt='light_cavalry',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(Da,rt,Kt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){$a>=13&&(Jt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'mounted_archer',amount:Jt}),v=[rt='mounted_archer',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Jt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){$a>=15&&(aa>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'ram',amount:aa}),v=[rt='ram',aa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,aa)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){$a>=17&&(St>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:St}),v=[rt='catapult',St],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,St)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),
setTimeout((function(){$a>=21&&(Bt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:Bt}),v=[rt='heavy_cavalry',Bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Bt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,t,a,n,i,r,d,u,p,g,T,_,f,b,h,E,w,S,R,y,k,M}()}()}function un(){var e=i.getSelectedCharacter().getVillageList();console.log(e);var o=6e4*e.length,l=6e4*e.length+6e4*e.length,s=6e4*e.length+6e4*e.length+6e4*e.length;e.forEach((function(e,i){t&&setTimeout((function(){d.forEach((function(t){if(e.data.villageId==t){console.log('wioska:'+e.data.villageId),Da=e.getId(),Qe=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Xe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Ze=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Je=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,
$e=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,et=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,tt=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,at=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,nt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,it=e.buildingData.data.barracks.level,ot=e.buildingQueue.data.queue,lt=e.getRecruitingQueues(),st=lt.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Pa=l.currentStock,Ua=n.currentStock,Ca=i.currentStock,za=o.currentStock,st.forEach((function(e){na=e.clientRecruitingTime,ga=1e3*(e.data.time_completed-e.data.start_time),ia=ga-na,ma.push(ia)})),sn()}}))}),6e4*i),a&&setTimeout((function(){u.forEach((function(t){if(e.data.villageId==t){Qe=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Xe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,
Ze=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Je=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,$e=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,et=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,tt=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,at=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,nt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Ga=e.buildingData.data.barracks.level,Ba=e.buildingQueue.data.queue,lt=e.getRecruitingQueues(),Va=lt.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Wa=l.currentStock,Fa=n.currentStock,qa=i.currentStock,Ya=o.currentStock,Va.forEach((function(e){na=e.clientRecruitingTime,ga=1e3*(e.data.time_completed-e.data.start_time),ia=ga-na,ba.push(ia)})),rn()}}))}),6e4*(i+1)+o),n&&setTimeout((function(){p.forEach((function(t){if(e.data.villageId==t){
Qe=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Xe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Ze=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Je=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,$e=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,et=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,tt=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,at=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,nt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Ha=e.buildingData.data.barracks.level,ja=e.buildingQueue.data.queue,lt=e.getRecruitingQueues(),Ka=lt.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Qa=l.currentStock,Xa=n.currentStock,Za=i.currentStock,Ja=o.currentStock,Ka.forEach((function(e){na=e.clientRecruitingTime,ga=1e3*(e.data.time_completed-e.data.start_time),ia=ga-na,
wa.push(ia)})),cn()}}))}),6e4*(i+2)+l),c&&setTimeout((function(){g.forEach((function(t){if(e.data.villageId==t){Qe=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Xe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Ze=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Je=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,$e=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,et=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,tt=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,at=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,nt=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,$a=e.buildingData.data.barracks.level,en=e.buildingQueue.data.queue,lt=e.getRecruitingQueues(),tn=lt.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;an=l.currentStock,nn=n.currentStock,on=i.currentStock,ln=o.currentStock,
tn.forEach((function(e){na=e.clientRecruitingTime,ga=1e3*(e.data.time_completed-e.data.start_time),ia=ga-na,ya.push(ia)})),dn()}}))}),6e4*(i+3)+s)}))}setInterval((function(){1==E&&un()}),ee.getCycleInterval),1==E&&un(),m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},ee.getLogs=function(){return h},ee.clearLogs=function(){return h=[],T.set(Q,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},ee.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START),$(p.RECRUIT_START,'start','')},ee.stop=function(e=n.USER_STOP){w?(e!==n.USER_STOP&&(w=_.gameTime()+J()),m.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):w=null,E=!1,m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&$(p.RECRUIT_STOP,'stop','')},ee.getSettings=function(){return f},ee.isInitialized=function(){return A},ee.isRunning=function(){return E},ee.getNextCycleDate=function(){return w},ee.getCycleInterval=J,ee})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{
RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop',RECRUIT_QUEUE_CLEAR_LOGS:'recruit_queue_clear_logs',RECRUIT_QUEUE_CYCLE_BEGIN:'recruit_queue_cycle_begin',RECRUIT_QUEUE_CYCLE_END:'recruit_queue_cycle_end'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/recruitQueue/types/status','two/recruitQueue/types/errors','two/Settings','queues/EventQueue','two/EventScope','helper/time','two/utils'],(function(e,t,n,d,u,p,T,_,f,b,h,A){let E,w,v,S=i.getGroupList(),R=!1,y=null,k={},M={},I={};const N={PRESETS:'presets',OWN:'own',LOGS:'logs'},x=function(e){E.selectedTab=e},O=function(){w.setAll(w.decode(E.settings)),A.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.presetRecrutation())},P=function(){t.isRunning()?t.stop():(t.start(),
...
define('two/reportHelper/types/result',[],(function(){return{WIN:'win',LOSSES:'losses',DEFEAT:'defeat'}})),define('two/reportHelper/types/sort',[],(function(){return{ALL:'all',FARM:'farm',FAKE:'fake',FAVOURITE:'favourite',WITHOUT_FAVOURITE:'without_favourite',FARM_AND_FAKE:'farm_and_fake'}})),require(['two/ready','two/reportHelper','two/reportHelper/ui','two/reportHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=i.getSelectedCharacter(),a=t.data.character_id,n=t.data.character_name,r=!1,c=!1,d=[],u=[],p=[];function g(e){var t=new Date(1e3*e);return t.toLocaleString()}var m=function(){o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},T))})),o.emit(l.REPORT_GET_LIST_REVERSE,{
offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},_))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},T=function(e){var t,i,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,T=g(m),_=e.ReportScouting,f=_.attCharacterId,b=_.attCharacterName,h=_.attScouts,A=_.attLosses,E=_.attVillageId,w=_.attVillageName,v=_.defCharacterId,S=_.defCharacterName,R=_.defLosses,y=_.defScouts,k=_.defVillageId,M=_.defVillageName,I=_.commandType,N='',x='',O='',L='',P=Date.now(),U=p.split('.').join('_');2==u?N=' [color=d96a19]Częściowy sukces[/color]':1==u?N=' [color=0a8028]Sukces[/color]':3==u&&(N=' [color=e21f1f]Porażka[/color]'),
x='units'==I?'Jednostki':'buildings'==I?'Budynki':'Sabotaż',i=null==y?'nieznana':y,s=null==h?'nieznana':h,r=null==R?'nieznana':R,c=null==A?'nieznana':A,L=null==b&&null==f?'Brak danych':'[player='+f+']'+b+'[/player]',O=null==w&&null==E?'Brak danych':'[village='+E+']'+w+'[/village]',t=Math.floor(P/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+U+'[/report][br]'+N+' --- Typ: '+x+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+M+'[/village][b] Gracz cel: [/b][player='+v+']'+S+'[/player][br]Liczba szpiegów: [b]'+i+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+O+'[b] Gracz szpiegujący: [/b]'+L+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var C=d.join();v!=a?t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:C}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:C}),
d=[]):t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:C}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:C}),d=[])},_=function(e){var t,a=[],i=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,_=d.attEffects,f=d.defEffects,b=d.attUnits;if(b.spear+b.sword+b.axe+b.archer+b.light_cavalry+b.mounted_archer+b.ram+b.catapult+b.heavy_cavalry+b.trebuchet+b.knight+b.snob+b.doppelsoldner>30){var h=[],A=[];_.forEach((function(e){var t=e.type,a=0,n=0,i=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,h.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,h.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),
'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var E=h.join();f.forEach((function(e){var t=e.type,a=0,n=0,i=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),A.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,A.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,A.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,A.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,
...
[e.AMOUNT5]:{default:0,inputType:'number',min:0,max:1e5},[e.AMOUNT6]:{default:0,inputType:'number',min:0,max:4e3},[e.AMOUNT7]:{default:0,inputType:'number',min:0,max:4e3},[e.AMOUNT8]:{default:0,inputType:'number',min:0,max:4e3},[e.UNIT1]:{default:!1,multiSelect:!0,inputType:'select'},[e.UNIT2]:{default:!1,multiSelect:!0,inputType:'select'},[e.UNIT3]:{default:!1,multiSelect:!0,inputType:'select'}}})),define('two/specialQueue/types/units',[],(function(){return{TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner'}})),require(['two/ready','two/specialQueue','two/specialQueue/ui','two/specialQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/ready','queues/EventQueue'],(function(e,t,a,n,i,o,l){let r,c,d=!1,u=!1;const p='spy_master_settings',g={[n.HEADQUARTER]:'headquarter',
[n.WAREHOUSE]:'warehouse',[n.FARM]:'farm',[n.RALLY_POINT]:'rally_point',[n.STATUE]:'statue',[n.WALL]:'wall',[n.TAVERN]:'tavern',[n.BARRACKS]:'barracks',[n.PRECEPTORY]:'preceptory',[n.HOSPITAL]:'hospital',[n.CLAY_PIT]:'clay_pit',[n.IRON_MINE]:'iron_mine',[n.TIMBER_CAMP]:'timber_camp',[n.CHAPEL]:'chapel',[n.CHURCH]:'church',[n.MARKET]:'market',[n.ACADEMY]:'academy'},m={[i.SPEAR]:'spear',[i.SWORD]:'sword',[i.AXE]:'axe',[i.ARCHER]:'archer',[i.LIGHT_CAVALRY]:'light_cavalry',[i.MOUNTED_ARCHER]:'mounted_archer',[i.HEAVT_CAVALRY]:'heavy_cavalry',[i.RAM]:'ram',[i.CATAPULT]:'catapult',[i.TREBUCHET]:'trebuchet',[i.DOPPELSOLDNER]:'doppelsoldner',[i.SNOB]:'snob',[i.KNIGHT]:'knight'};console.log(m,g);const T={init:function(){d=!0,r=new e({settingsMap:a,storageKey:p}),c=r.getAll(),console.log('spyMaster settings',c)},start:function(){u=!0,l.trigger(s.SPY_MASTER_START)},stop:function(){u=!1,l.trigger(s.SPY_MASTER_STOP)},getSettings:function(){return r},isInitialized:function(){return d},
isRunning:function(){return u}};return T})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,o,l,r,d,u){let p,m,T;const _={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},f=function(e){p.selectedTab=e},b=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},E=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},w=function(){p=a.$new(),
p.SETTINGS=n,p.TAB_TYPES=_,p.running=t.isRunning(),p.selectedTab=_.SPY,p.settingsMap=i,p.building=r.encodeList(o,{textObject:'spy_master',disabled:!0}),p.unit=r.encodeList(l,{textObject:'spy_master',disabled:!0}),m.injectScope(p),p.selectTab=f,p.saveSettings=b,p.switchState=h;let e=new d('twoverflow_spy_master_window',(function(){console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,A),e.register(s.SPY_MASTER_STOP,E),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton3('Zwiadowca',10),T.addEventListener('click',w),
...
console.log('Dodano do rekrutacji szpiega (slot 4) w wiosce:'+e.getName())):5==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[5]&&d>=g[5]&&u>=m[5]&&(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:5}),console.log('Dodano do rekrutacji szpiega (slot 5) w wiosce:'+e.getName()))}))})),e.notif('success',g('i18n')('revived',a.loc.ale,'spy_recruiter'))}),12e4)},c.stop=function(){t.trigger(s.SPY_RECRUITER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return n},c})),define('two/spyRecruiter/events',[],(function(){angular.extend(s,{SPY_RECRUITER_STARTED:'spy_recruiter_started',SPY_RECRUITER_STOPPED:'spy_recruiter_stopped'})})),define('two/spyRecruiter/ui',['two/ui','two/spyRecruiter','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return e.addDivisor3(21),o=e.addMenuButton3('Szpieg',20,g('i18n')('description',a.loc.ale,'spy_recruiter')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
n.notif('success',g('i18n')('deactivated',a.loc.ale,'spy_recruiter'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'spy_recruiter')))})),i.register(s.SPY_RECRUITER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.SPY_RECRUITER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.SPY_RECRUITER_STARTED),opener}})),require(['two/ready','two/spyRecruiter','two/spyRecruiter/ui','Lockr','queues/EventQueue','two/spyRecruiter/events'],(function(e,t,a,n,i){const o='spy_recruiter_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.SPY_RECRUITER_STARTED,(function(){n.set(o,!0)})),i.register(s.SPY_RECRUITER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',_=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},f=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},b={init:function(){u=!0,c=new e({settingsMap:n,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&_(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('supportSender settings',d),l((function(){_()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,_),a.$on(s.ARMY_PRESET_DELETED,_),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.SUPPORT_SENDER_START)},stop:function(){p=!1,
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return b})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d){let u,p,g,m=i.getPresetList(),T=i.getGroupList();const _={SUPPORT:'support',LOGS:'logs'},f=function(e){u.selectedTab=e},b=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},E=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=_,u.running=t.isRunning(),u.selectedTab=_.SUPPORT,u.settingsMap=o,p.injectScope(u),A(),E(),u.selectTab=f,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,E,!0),e.register(s.GROUPS_DESTROYED,E,!0),e.register(s.GROUPS_UPDATED,E,!0),e.register(s.SUPPORT_SENDER_START,w),e.register(s.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',S),
...
})),require(['two/ready','two/supportSender','two/supportSender/ui','two/supportSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/tutorialHelper',['queues/EventQueue'],(function(e){let t=!1,a=!1,n={init:function(){t=!0},start:function(){e.trigger(s.TUTORIAL_HELPER_STARTED),a=!0},stop:function(){e.trigger(s.TUTORIAL_HELPER_STOPPED),a=!1},isRunning:function(){return a},isInitialized:function(){return t}};return n})),define('two/tutorialHelper/events',[],(function(){angular.extend(s,{TUTORIAL_HELPER_STARTED:'tutorial_helper_started',TUTORIAL_HELPER_STOPPED:'tutorial_helper_stopped'})})),define('two/tutorialHelper/ui',['two/ui','two/tutorialHelper','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton2('Giermek',60,g('i18n')('description',a.loc.ale,'tutorial_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
n.notif('success',g('i18n')('deactivated',a.loc.ale,'tutorial_helper'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'tutorial_helper')))})),i.register(s.TUTORIAL_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.TUTORIAL_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.TUTORIAL_HELPER_STARTED),opener}})),require(['two/ready','two/tutorialHelper','two/tutorialHelper/ui','Lockr','queues/EventQueue','two/tutorialHelper/events'],(function(e,t,a,n,i){const o='tutorial_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.TUTORIAL_HELPER_STARTED,(function(){n.set(o,!0)})),i.register(s.TUTORIAL_HELPER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))}))}(this);