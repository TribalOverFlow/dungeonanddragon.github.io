...
E.calculated={total:V},_.calculated={total:W},f.calculated={total:q},w.calculated={total:Y},v.calculated={total:F},ee.calculated={total:X},te.calculated={total:Z},ae.calculated={total:J},j.calculated={total:j},H.calculated={total:H},K.calculated={total:K},k.calculated={total:O},x.calculated={total:L},I.calculated={total:$},B.calculated={total:Q}}()},G.start=function(){v=!0,f.trigger(s.BATTLE_CALCULATOR_START)},G.stop=function(){v=!1,f.trigger(s.BATTLE_CALCULATOR_STOP)},G.getSettings=function(){return w},G.isInitialized=function(){return A},G.isRunning=function(){return v},D.prototype.totalAtt=function(){return this.attack},D.prototype.totalDef=function(){return this.defense},G})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
