...
define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue','Lockr'],(function(e,t,i,l,o,r,c,d,p,u,g,m,b,T,E,_,f,w){let h,A,v=!1,S=!1,R=[];const y='battle_calculator_settings',k={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},I={[o.HALBERD_OF_GUAN_YU]:'spear',[o.PARACELSUS_LONGSWORD]:'sword',[o.THORGARDS_BATTLE_AXE]:'axe',[o.NIMRODS_LONGBOW]:'archer',[o.MIESZKOS_LANCE]:'lc',[o.NIMRODS_COMPOSITE_BOW]:'ma',[o.BAPTISTES_BANNER]:'hc',
[o.CAROLS_MORNING_STAR]:'ram',[o.ALETHEIAS_BONFIRE]:'catapult',[o.VASCOS_SCEPTER]:'snob'},x={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},O={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},L={[u.NO_CHURCH]:50,[u.LEVEL_1]:100,[u.LEVEL_2]:105,[u.LEVEL_3]:110},N={[p.NO_WALL]:0,[p.LEVEL_1]:5,[p.LEVEL_2]:10,[p.LEVEL_3]:15,[p.LEVEL_4]:20,[p.LEVEL_5]:25,[p.LEVEL_6]:30,[p.LEVEL_7]:35,[p.LEVEL_8]:40,[p.LEVEL_9]:45,[p.LEVEL_10]:50,[p.LEVEL_11]:55,[p.LEVEL_12]:60,[p.LEVEL_13]:65,[p.LEVEL_14]:70,[p.LEVEL_15]:75,[p.LEVEL_16]:80,[p.LEVEL_17]:85,[p.LEVEL_18]:90,[p.LEVEL_19]:95,[p.LEVEL_20]:100},P={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,
[g.LEVEL_4]:8,[g.LEVEL_5]:10},M={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},z={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},C={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3},U={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(O,U,C,z,M,P,N,L,k,I,x);const G=function(){R=[];const e=n.getPresetList().getPresets();A[t.PRESET].forEach((function(t){R.push(e[t])}))},D={};return D.init=function(){v=!0,h=new e({settingsMap:i,storageKey:y}),h.onChange((function(e,a){A=h.getAll(),a[l.PRESETS]&&G(),a[l.BASHPOINTS_SPEAR]&&function(){const e=A[t.BASHPOINTS_SPEAR];console.log(e),w.set(y,h)}()})),A=h.getAll(),console.log('battleCalculator settings',A),_((function(){G()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,G),a.$on(s.ARMY_PRESET_DELETED,G)},D.calculateB=function(){const e=h.getAll(),a=h.get(t.BASHPOINTS_SPEAR),i=e[t.BASHPOINTS_SWORD],n=e[t.BASHPOINTS_AXE],l=e[t.BASHPOINTS_ARCHER],o=e[t.BASHPOINTS_LC],s=e[t.BASHPOINTS_MA],r=e[t.BASHPOINTS_HC],c=e[t.BASHPOINTS_RAM],d=e[t.BASHPOINTS_CATAPULT],p=e[t.BASHPOINTS_DOPPELSOLDNER],u=e[t.BASHPOINTS_TREBUCHET],g=e[t.BASHPOINTS_SNOB],m=e[t.BASHPOINTS_KNIGHT];var b,T,E=[1,2,4,2,13,12,15,8,10,20,200,0,25],_=[4,5,1,5,5,6,23,4,12,40,200,25,10];console.log(a,i,n,l),b=a*E[0]+i*E[1]+n*E[2]+l*E[3]+o*E[4]+s*E[5]+r*E[6]+c*E[7]+d*E[8]+m*E[9]+g*E[10]+u*E[11]+p*E[12],T=a*_[0]+i*_[1]+n*_[2]+l*_[3]+o*_[4]+s*_[5]+r*_[6]+c*_[7]+d*_[8]+m*_[9]+g*_[10]+u*_[11]+p*_[12],console.log(b,T),(void 0).html(b),(void 0).html(T)},D.simulate=function(){},D.calculateT=function(){
const e=A[t.TROOPS_SPEAR],a=A[t.TROOPS_SWORD],i=A[t.TROOPS_AXE],n=A[t.TROOPS_ARCHER],l=A[t.TROOPS_LC],o=A[t.TROOPS_MA],s=A[t.TROOPS_HC],r=A[t.TROOPS_RAM],c=A[t.TROOPS_CATAPULT],d=A[t.TROOPS_DOPPELSOLDNER],p=A[t.TROOPS_TREBUCHET],u=A[t.TROOPS_SNOB],g=A[t.TROOPS_KNIGHT],m=A[t.TROOPS_BARRACKS],b=A[t.TROOPS_PRECEPTORY],T=A[t.TROOPS_ORDER];var E=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],_=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],f=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],w=[1,1,1,1,4,5,6,5,8,1,100,10,6],h=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],v=[10,25,45,25,130,150,150,2,100,150,30,30,300],S=[25,55,10,10,30,40,200,20,100,250,100,200,100],R=[45,5,5,30,40,30,160,50,50,400,50,250,100],y=[10,30,10,60,30,50,180,20,100,150,100,200,50],k=[8,9,14,18,24,35,50,0],I=[25,15,10,10,80,50,50,0,0,100,0,0,10],x=[0,33,66,99];let O=0,L=0,N=1,P=1,M=1,z=1,C=1,U=1,G=1,D=1,B=0,V=0,W=0,q=0,Y=0,F=0,j=0,H=0,K=0,Q=0,X=0,Z=0,J=0,$=0,ee=0,te=0,ae=0,ie=0
;P=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,function(){const ie=A[t.TROOPS_TRAINING];var ne,le,oe,se;console.log(ie),z=1==b?1.01:2==b?1.02:3==b?1.03:4==b?1.04:5==b?1.05:6==b?1.06:7==b?1.07:8==b?1.08:9==b?1.09:10==b?1.1:1,M=A[t.TROOPS_DOMINATION]?1.1:1,O=p>0?k[6]+' minut':u>0?k[5]+' minut':r>0||c>0?k[4]+' minuty':a>0?k[3]+' minut':e>0||i>0||n>0||d>0?k[2]+' minut':s>0?k[1]+' minut':l>0||o>0||g>0?k[0]+' minut':k[7]+' minut',L=m>=7&&m<14?x[1]:m>=14&&m<23?x[2]:m>=23?x[3]:x[0],U=N/(M*ie),C=U/P,G=C/z,D=N/z,B='deff'==T?G*(e*h[0]+a*h[1]+n*h[3]+s*h[6])+D*(p*h[11])+C*(i*h[2]+l*h[4]+o*h[5]+r*h[7]+c*h[8])+d*h[12]+g*h[9]+u*h[10]:'off'==T?C*(e*h[0]+a*h[1]+n*h[3]+s*h[6])+p*h[11]+G*(i*h[2]+l*h[4]+o*h[5]+r*h[7]+c*h[8])+D*(d*h[12])+g*h[9]+u*h[10]:C*(e*h[0]+a*h[1]+n*h[3]+s*h[6])+p*h[11]+C*(i*h[2]+l*h[4]+o*h[5]+r*h[7]+c*h[8])+d*h[12]+g*h[9]+u*h[10],V=e*E[0]+a*E[1]+i*E[2]+n*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],
...
E.calculated={total:V},_.calculated={total:W},f.calculated={total:q},w.calculated={total:Y},v.calculated={total:F},ee.calculated={total:X},te.calculated={total:Z},ae.calculated={total:J},j.calculated={total:j},H.calculated={total:H},K.calculated={total:K},k.calculated={total:O},x.calculated={total:L},I.calculated={total:$},B.calculated={total:Q}}()},D.start=function(){S=!0,f.trigger(s.BATTLE_CALCULATOR_START)},D.stop=function(){S=!1,f.trigger(s.BATTLE_CALCULATOR_STOP)},D.getSettings=function(){return h},D.isInitialized=function(){return v},D.isRunning=function(){return S},D})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p,u,g,m,b,T,E,_,f,w,h){let A,v,S,R=n.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){A.selectedTab=e},I=function(){t.isRunning()?t.stop():t.start()},x=function(){A.presets=f.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},O=function(){A.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),
h.notif('success','battleCalculator started')},L=function(){A.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),h.notif('success','battleCalculator stopped')},N=function(){A=a.$new(),A.SETTINGS=i,A.TAB_TYPES=y,A.running=t.isRunning(),A.selectedTab=y.BATTLE,A.settingsMap=l,A.catapulttarget=f.encodeList(d,{textObject:'battle_calculator',disabled:!0}),A.knightitem=f.encodeList(o,{textObject:'battle_calculator',disabled:!0}),A.itemlevel=f.encodeList(r,{textObject:'battle_calculator',disabled:!0}),A.order=f.encodeList(p,{textObject:'battle_calculator',disabled:!0}),A.wall=f.encodeList(u,{textObject:'battle_calculator',disabled:!0}),A.church=f.encodeList(g,{textObject:'battle_calculator',disabled:!0}),A.weaponmaster=f.encodeList(m,{textObject:'battle_calculator',disabled:!0}),A.ironwalls=f.encodeList(b,{textObject:'battle_calculator',disabled:!0}),A.clinique=f.encodeList(T,{textObject:'battle_calculator',disabled:!0}),A.hospital=f.encodeList(E,{
textObject:'battle_calculator',disabled:!0}),A.training=f.encodeList(_,{textObject:'battle_calculator',disabled:!0}),v.injectScope(A),x(),A.selectTab=k,A.calculateB=t.calculateB,A.calculateT=t.calculateT,A.simulate=t.simulate,A.switchState=I;let e=new w('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,x,!0),e.register(s.ARMY_PRESET_DELETED,x,!0),e.register(s.BATTLE_CALCULATOR_START,O),e.register(s.BATTLE_CALCULATOR_STOP,L),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',A)};return function(){v=t.getSettings(),S=e.addMenuButton4('Kalkulator',10),S.addEventListener('click',N),
