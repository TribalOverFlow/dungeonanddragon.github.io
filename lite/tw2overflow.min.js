...
const e=h[t.BASHPOINTS_SPEAR],a=h[t.BASHPOINTS_SWORD],n=h[t.BASHPOINTS_AXE],i=h[t.BASHPOINTS_ARCHER],l=h[t.BASHPOINTS_LC],o=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],p=h[t.BASHPOINTS_TREBUCHET],u=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m,b,T=[1,2,4,2,13,12,15,8,10,20,200,0,25],E=[4,5,1,5,5,6,23,4,12,40,200,25,10];m=e*T[0]+a*T[1]+n*T[2]+i*T[3]+l*T[4]+o*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+u*T[10]+p*T[11]+d*T[12],b=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],console.log(m,b),this.bashpointsAtt=b,this.bashpointsDef=m},simulate:function(){}};return D.calculateT=function(){
const e=h[t.TROOPS_SPEAR],a=h[t.TROOPS_SWORD],n=h[t.TROOPS_AXE],i=h[t.TROOPS_ARCHER],l=h[t.TROOPS_LC],o=h[t.TROOPS_MA],s=h[t.TROOPS_HC],r=h[t.TROOPS_RAM],c=h[t.TROOPS_CATAPULT],d=h[t.TROOPS_DOPPELSOLDNER],p=h[t.TROOPS_TREBUCHET],u=h[t.TROOPS_SNOB],g=h[t.TROOPS_KNIGHT],m=h[t.TROOPS_BARRACKS],b=h[t.TROOPS_PRECEPTORY],T=h[t.TROOPS_ORDER];var E=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],_=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],f=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],w=[1,1,1,1,4,5,6,5,8,1,100,10,6],A=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],v=[10,25,45,25,130,150,150,2,100,150,30,30,300],S=[25,55,10,10,30,40,200,20,100,250,100,200,100],R=[45,5,5,30,40,30,160,50,50,400,50,250,100],y=[10,30,10,60,30,50,180,20,100,150,100,200,50],k=[8,9,14,18,24,35,50,0],I=[25,15,10,10,80,50,50,0,0,100,0,0,10],x=[0,33,66,99];let O=0,L=0,N=1,P=1,M=1,z=1,C=1,U=1,D=1,G=1,B=0,V=0,W=0,q=0,Y=0,F=0,j=0,H=0,K=0,Q=0,X=0,Z=0,J=0,$=0,ee=0,te=0,ae=0,ne=0
;P=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,function(){const ne=h[t.TROOPS_TRAINING];var ie,le,oe,se;console.log(ne),z=1==b?1.01:2==b?1.02:3==b?1.03:4==b?1.04:5==b?1.05:6==b?1.06:7==b?1.07:8==b?1.08:9==b?1.09:10==b?1.1:1,M=h[t.TROOPS_DOMINATION]?1.1:1,O=p>0?k[6]+' minut':u>0?k[5]+' minut':r>0||c>0?k[4]+' minuty':a>0?k[3]+' minut':e>0||n>0||i>0||d>0?k[2]+' minut':s>0?k[1]+' minut':l>0||o>0||g>0?k[0]+' minut':k[7]+' minut',L=m>=7&&m<14?x[1]:m>=14&&m<23?x[2]:m>=23?x[3]:x[0],U=N/(M*ne),C=U/P,D=C/z,G=N/z,B='deff'==T?D*(e*A[0]+a*A[1]+i*A[3]+s*A[6])+G*(p*A[11])+C*(n*A[2]+l*A[4]+o*A[5]+r*A[7]+c*A[8])+d*A[12]+g*A[9]+u*A[10]:'off'==T?C*(e*A[0]+a*A[1]+i*A[3]+s*A[6])+p*A[11]+D*(n*A[2]+l*A[4]+o*A[5]+r*A[7]+c*A[8])+G*(d*A[12])+g*A[9]+u*A[10]:C*(e*A[0]+a*A[1]+i*A[3]+s*A[6])+p*A[11]+C*(n*A[2]+l*A[4]+o*A[5]+r*A[7]+c*A[8])+d*A[12]+g*A[9]+u*A[10],V=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+u*E[10]+p*E[11]+d*E[12],
W=e*_[0]+a*_[1]+n*_[2]+i*_[3]+l*_[4]+o*_[5]+s*_[6]+r*_[7]+c*_[8]+g*_[9]+u*_[10]+p*_[11]+d*_[12],q=e*f[0]+a*f[1]+n*f[2]+i*f[3]+l*f[4]+o*f[5]+s*f[6]+r*f[7]+c*f[8]+g*f[9]+u*f[10]+p*f[11]+d*f[12],Y=e*w[0]+a*w[1]+n*w[2]+i*w[3]+l*w[4]+o*w[5]+s*w[6]+r*w[7]+c*w[8]+g*w[9]+u*w[10]+p*w[11]+d*w[12],F=e*v[0]+a*v[1]+n*v[2]+i*v[3]+l*v[4]+o*v[5]+s*v[6]+r*v[7]+c*v[8]+g*v[9]+u*v[10]+p*v[11]+d*v[12],j=e*S[0]+a*S[1]+n*S[2]+i*S[3]+l*S[4]+o*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+u*S[10]+p*S[11]+d*S[12],H=e*R[0]+a*R[1]+n*R[2]+i*R[3]+l*R[4]+o*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+u*R[10]+p*R[11]+d*R[12],K=e*y[0]+a*y[1]+n*y[2]+i*y[3]+l*y[4]+o*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+u*y[10]+p*y[11]+d*y[12],$=e*I[0]+a*I[1]+n*I[2]+i*I[3]+l*I[4]+o*I[5]+s*I[6]+r*I[7]+c*I[8]+g*I[9]+u*I[10]+p*I[11]+d*I[12],ie=B,le='',oe=new Date(1e3*ie).toISOString().substr(11,8),(se=Math.floor(ie/86400))>1?le=se+' dni i ':se>0&&(le='1 dzień i '),Q=le+=oe,X=e*v[0]+a*v[1]+n*v[2]+r*v[7]+c*v[8]+p*v[11]+d*v[12],Z=l*v[4]+s*v[6]+g*v[9],J=i*v[3]+o*v[5],
E.calculated={total:V},_.calculated={total:W},f.calculated={total:q},w.calculated={total:Y},v.calculated={total:F},ee.calculated={total:X},te.calculated={total:Z},ae.calculated={total:J},j.calculated={total:j},H.calculated={total:H},K.calculated={total:K},k.calculated={total:O},x.calculated={total:L},I.calculated={total:$},B.calculated={total:Q}}()},D.start=function(){v=!0,f.trigger(s.BATTLE_CALCULATOR_START)},D.stop=function(){v=!1,f.trigger(s.BATTLE_CALCULATOR_STOP)},D.getSettings=function(){return w},D.calculateB.prototype.getBashpointsAtt=function(){return this.bashpointsAtt},D.calculateB.prototype.getBashpointsDef=function(){return this.bashpointsDef},D.isInitialized=function(){return A},D.isRunning=function(){return v},D})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p,u,g,m,b,T,E,_,f,w,h){let A,v,S,R=i.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){A.selectedTab=e},I=function(){t.isRunning()?t.stop():t.start()},x=function(){v.setAll(v.decode(A.settings)),h.notif('success','Settings saved')},O=function(){A.presets=f.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},L=function(){
