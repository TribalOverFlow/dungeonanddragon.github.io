...
}),42e3),setTimeout((function(){at>=17&&(ht>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:ht}),v=[lt='catapult',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,ht)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){at>=21&&(Ut>=_?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Ut}),v=[lt='heavy_cavalry',Ut],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,Ut)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,o,r,c,d,u,p,g,T,f,b,h,A,E,w,L}()}()}function ln(){ba=a>0?Da.length>=2?1:1==Da.length?.5:.25:0,function(){_a=fa.length>0?fa.reduce((function(e,t){return e+t})):0;!function(){
ha=a>0?_a>=936e5?0:_a<936e5&&_a>=864e5?.1:_a<864e5&&_a>=72e6?.25:_a<72e6&&_a>=576e5?.4:_a<576e5&&_a>=432e5?.55:_a<432e5&&_a>=288e5?.7:_a<288e5&&_a>=144e5?.85:_a<144e5&&_a>=72e5?.925:_a<72e5&&_a>=36e5?.9625:1:0;e=ve-je,t=Se-Ke,n=_e-Qe,o=fe-Xe,r=Ae-Ze,c=Ee-Je,d=we-$e,u=be-et,p=he-tt,g=Math.floor(B*ha*ba),T=Math.floor(V*ha*ba),f=Math.floor(P*ha*ba),_=Math.floor(L*ha*ba),b=Math.floor(z*ha*ba),A=Math.floor(D*ha*ba),E=Math.floor(G*ha*ba),w=Math.floor(U*ha*ba),S=Math.floor(C*ha*ba),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+A*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],y=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+A*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||n>0||o>0||r>0||c>0||d>0?(R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k<=Fa&&M<=Ba?(oa=g,ra=T,ft=f,pt=_,qt=b,Kt=A,Jt=E,At=w,
Ct=S):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k<=Fa&&M<=Ba?(Ot=Va/R,oa=Math.floor(Ot*g)-1,ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*_)-1,qt=Math.floor(Ot*b)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k<=Fa&&M<=Ba?(Ot=Wa/y,oa=Math.floor(Ot*g)-1,ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*_)-1,qt=Math.floor(Ot*b)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k>=Fa&&M<=Ba?(Ot=Fa/k,oa=Math.floor(Ot*g)-1,ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*_)-1,qt=Math.floor(Ot*b)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k<=Fa&&M>=Ba?(Ot=Ba/M,oa=Math.floor(Ot*g)-1,
ra=Math.floor(Ot*T)-1,ft=Math.floor(Ot*f)-1,pt=Math.floor(Ot*_)-1,qt=Math.floor(Ot*b)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*S)-1):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k<=Fa&&M<=Ba?(St=Wa/y)>(rt=Va/R)?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*_)-1,qt=Math.floor(rt*b)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):(oa=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*_)-1,qt=Math.floor(St*b)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k>=Fa&&M<=Ba?(St=Wa/y)>(Bt=Fa/k)?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*_)-1,qt=Math.floor(Bt*b)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,
Ct=Math.floor(Bt*S)-1):(oa=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*_)-1,qt=Math.floor(St*b)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k<=Fa&&M>=Ba?(St=Wa/y)>(Mt=Ba/M)?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*_)-1,qt=Math.floor(Mt*b)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):(oa=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*_)-1,qt=Math.floor(St*b)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k>=Fa&&M<=Ba?(Bt=Fa/k)>(rt=Va/R)?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*_)-1,qt=Math.floor(rt*b)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,
At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*_)-1,qt=Math.floor(Bt*b)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k>=Fa&&M>=Ba?(Bt=Fa/k)>(Mt=Ba/M)?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*_)-1,qt=Math.floor(Mt*b)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*_)-1,qt=Math.floor(Bt*b)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k<=Fa&&M>=Ba?(Mt=Ba/M)>(rt=Va/R)?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*_)-1,qt=Math.floor(rt*b)-1,Kt=Math.floor(rt*A)-1,
Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*_)-1,qt=Math.floor(Mt*b)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k>=Fa&&M<=Ba?(rt=Va/R,(St=Wa/y)>(Bt=Fa/k)&&rt>Bt?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*_)-1,qt=Math.floor(Bt*b)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):Bt>St&&rt>St?(oa=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*_)-1,qt=Math.floor(St*b)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Bt>rt&&St>rt?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*_)-1,qt=Math.floor(rt*b)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,
Ct=Math.floor(rt*S)-1):console.log('Nie znam przyczyny :P')):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k<=Fa&&M>=Ba?(rt=Va/R,(St=Wa/y)>(Mt=Ba/M)&&rt>Mt?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*_)-1,qt=Math.floor(Mt*b)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):Mt>St&&rt>St?(oa=Math.floor(St*g)-1,ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*_)-1,qt=Math.floor(St*b)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Mt>rt&&St>rt?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*_)-1,qt=Math.floor(rt*b)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):console.log('Nie znam przyczyny :P')):R>=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Wa&&k>=Fa&&M>=Ba?(rt=Va/R,(Mt=Ba/M)>(Bt=Fa/k)&&rt>Bt?(oa=Math.floor(Bt*g)-1,
ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*_)-1,qt=Math.floor(Bt*b)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):Bt>Mt&&rt>Mt?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*_)-1,qt=Math.floor(Mt*b)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):Bt>rt&&Mt>rt?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*T)-1,ft=Math.floor(rt*f)-1,pt=Math.floor(rt*_)-1,qt=Math.floor(rt*b)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*S)-1):console.log('Nie znam przyczyny :P')):R<=Va&&(e>=h||p>=h||u>=h||t>=h||n>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Wa&&k>=Fa&&M>=Ba&&(Mt=Ba/M,(St=Wa/y)>(Bt=Fa/k)&&Mt>Bt?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*T)-1,ft=Math.floor(Bt*f)-1,pt=Math.floor(Bt*_)-1,qt=Math.floor(Bt*b)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*S)-1):Bt>St&&Mt>St?(oa=Math.floor(St*g)-1,
ra=Math.floor(St*T)-1,ft=Math.floor(St*f)-1,pt=Math.floor(St*_)-1,qt=Math.floor(St*b)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*S)-1):Bt>Mt&&St>Mt?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*T)-1,ft=Math.floor(Mt*f)-1,pt=Math.floor(Mt*_)-1,qt=Math.floor(Mt*b)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){oa>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'spear',amount:oa}),v=[lt='spear',oa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){za>=3&&(ra>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'sword',amount:ra}),v=[lt='sword',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,ra)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){za>=5&&(ft>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'axe',amount:ft}),v=[lt='axe',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,ft)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){za>=9&&(pt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'archer',amount:pt}),v=[lt='archer',pt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,pt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){za>=11&&(qt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'light_cavalry',amount:qt}),v=[lt='light_cavalry',qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,qt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){za>=13&&(Kt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'mounted_archer',amount:Kt}),
v=[lt='mounted_archer',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,Kt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){za>=15&&(Jt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'ram',amount:Jt}),v=[lt='ram',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,Jt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){za>=17&&(At>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'catapult',amount:At}),v=[lt='catapult',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),J(Ca,lt,At)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){za>=21&&(Ct>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:Ca,unit_type:'heavy_cavalry',amount:Ct}),v=[lt='heavy_cavalry',Ct],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
J(Ca,lt,Ct)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,n,o,r,c,d,u,p,g,T,f,_,b,A,E,w,S,R,y,k,M}()}()}function sn(){wa=n>0?Ya.length>=2?1:1==Ya.length?.5:.25:0,function(){Ea=Aa.length>0?Aa.reduce((function(e,t){return e+t})):0;!function(){va=n>0?Ea>=936e5?0:Ea<936e5&&Ea>=864e5?.1:Ea<864e5&&Ea>=72e6?.25:Ea<72e6&&Ea>=576e5?.4:Ea<576e5&&Ea>=432e5?.55:Ea<432e5&&Ea>=288e5?.7:Ea<288e5&&Ea>=144e5?.85:Ea<144e5&&Ea>=72e5?.925:Ea<72e5&&Ea>=36e5?.9625:1:0;e=Oe-je,t=Le-Ke,a=ye-Qe,o=Re-Xe,r=Ie-Ze,c=Ne-Je,d=xe-$e,u=ke-et,p=Me-tt,g=Math.floor(Q*va*wa),T=Math.floor(X*va*wa),f=Math.floor(F*va*wa),_=Math.floor(W*va*wa),b=Math.floor(H*va*wa),h=Math.floor(j*va*wa),E=Math.floor(K*va*wa),w=Math.floor(q*va*wa),S=Math.floor(Y*va*wa),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+h*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],y=g*qe[0]+T*qe[1]+f*qe[2]+_*qe[3]+b*qe[4]+h*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],
k=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],M=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+h*He[5]+E*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||a>0||o>0||r>0||c>0||d>0?(R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k<=Xa&&M<=ja?(ia=g,ca=T,_t=f,gt=_,Yt=b,Qt=h,$t=E,Et=w,zt=S):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k<=Xa&&M<=ja?(Lt=Ka/R,ia=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*h)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y>=Qa&&k<=Xa&&M<=ja?(Lt=Qa/y,ia=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*h)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,
zt=Math.floor(Lt*S)-1):R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k>=Xa&&M<=ja?(Lt=Xa/k,ia=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*h)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k<=Xa&&M>=ja?(Lt=ja/M,ia=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*_)-1,Yt=Math.floor(Lt*b)-1,Qt=Math.floor(Lt*h)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y>=Qa&&k<=Xa&&M<=ja?(Rt=Qa/y)>(ct=Ka/R)?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*h)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,
Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*h)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y>=Qa&&k>=Xa&&M<=ja?(Rt=Qa/y)>(Vt=Xa/k)?(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*h)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*h)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y>=Qa&&k<=Xa&&M>=ja?(Rt=Qa/y)>(It=ja/M)?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*h)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,
gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*h)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k>=Xa&&M<=ja?(Vt=Xa/k)>(ct=Ka/R)?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*h)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*h)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R<=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k>=Xa&&M>=ja?(Vt=Xa/k)>(It=ja/M)?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*h)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,
_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*h)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k<=Xa&&M>=ja?(It=ja/M)>(ct=Ka/R)?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*h)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*h)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y>=Qa&&k>=Xa&&M<=ja?(ct=Ka/R,(Rt=Qa/y)>(Vt=Xa/k)&&ct>Vt?(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*h)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,
zt=Math.floor(Vt*S)-1):Vt>Rt&&ct>Rt?(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*h)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>ct&&Rt>ct?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*h)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y>=Qa&&k<=Xa&&M>=ja?(ct=Ka/R,(Rt=Qa/y)>(It=ja/M)&&ct>It?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*h)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):It>Rt&&ct>Rt?(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*_)-1,Yt=Math.floor(Rt*b)-1,Qt=Math.floor(Rt*h)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,
zt=Math.floor(Rt*S)-1):It>ct&&Rt>ct?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*h)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Ka&&(e>=A||p>=A||u>=A||t>=A||a>=A||o>=A||r>=A||c>=A||d>=A)&&y<=Qa&&k>=Xa&&M>=ja?(ct=Ka/R,(It=ja/M)>(Vt=Xa/k)&&ct>Vt?(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*_)-1,Yt=Math.floor(Vt*b)-1,Qt=Math.floor(Vt*h)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>It&&ct>It?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*_)-1,Yt=Math.floor(It*b)-1,Qt=Math.floor(It*h)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):Vt>ct&&It>ct?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*_)-1,Yt=Math.floor(ct*b)-1,Qt=Math.floor(ct*h)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,
