...
const e=w.get(t.BASHPOINTS_SPEAR),a=h[t.BASHPOINTS_AXE].value,i=w.get(t.BASHPOINTS_ARCHER).value,n=h[t.BASHPOINTS_LC],l=h[t.BASHPOINTS_MA],o=h[t.BASHPOINTS_HC],s=h[t.BASHPOINTS_RAM],r=h[t.BASHPOINTS_CATAPULT],c=h[t.BASHPOINTS_DOPPELSOLDNER],d=h[t.BASHPOINTS_TREBUCHET],p=h[t.BASHPOINTS_SNOB],u=h[t.BASHPOINTS_KNIGHT],g=h.get[t.BASHPOINTS_SWORD];var m,b,T=[1,2,4,2,13,12,15,8,10,20,200,0,25],E=[4,5,1,5,5,6,23,4,12,40,200,25,10];console.log(e,g,a,i),m=e*T[0]+g*T[1]+a*T[2]+i*T[3]+n*T[4]+l*T[5]+o*T[6]+s*T[7]+r*T[8]+u*T[9]+p*T[10]+d*T[11]+c*T[12],b=e*E[0]+g*E[1]+a*E[2]+i*E[3]+n*E[4]+l*E[5]+o*E[6]+s*E[7]+r*E[8]+u*E[9]+p*E[10]+d*E[11]+c*E[12],console.log(m,b),(void 0).html(m),(void 0).html(b)},simulate:function(){}};return G.calculateT=function(){
