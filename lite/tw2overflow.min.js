...
dc=gr*s[0]+Lc*s[1]+lt*s[2]+Ce*s[3]+go*s[4]+ol*s[5]+hn*s[6]+ls*s[7]+ta*s[8]+ed*s[11]+Nt*s[12]+Ys*s[10]+Ti*s[9],console.log(sc,dc),Ks=-N+er,uc=-P+Ec,Ve=-d+je,B=-r+we,ji=-w+$i,Bo=-R+Ho,$a=-E+ln,Vl=-I+jl,zt=-m+Wt,Pc=-z+Bc,gt=-p+ht,Rs=-L+Os,Xn=-h+ai,tr=-M+gr,_c=-C+Lc,Ke=-u+lt,ve=-c+Ce,eo=-v+go,jo=-y+ol,sn=-_+hn,Kl=-x+ls,qt=-T+ta,Wc=-D+ed,ft=-g+Nt,Ns=-O+Ys,ni=-f+Ti,gs=0==jl?0:jl*ml*On[1],Rn=20==ld?18:19==ld?17:18==ld?15:17==ld?14:16==ld?13:15==ld?11:14==ld?10:13==ld||12==ld?9:11==ld?8:10==ld?7:9==ld||8==ld?6:7==ld||6==ld?5:5==ld||4==ld||3==ld?4:2==ld||1==ld?3:0,ds=0==ut?0:2*Rn,us=0==gs||0==ds?0:-gs/ds,Ja=ld<=Ss?ld:ld-Ss<-us?ld<Ss?ld:Ss:ld+us,G=Math.round(Ja),b='wall'==ca?G:A[t.BATTLE_TARGET_LEVEL],sa=0==Wt||0==b?0:Wt*ml*Ai[1],
