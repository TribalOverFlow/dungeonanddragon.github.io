 ...
 */
!function(e,t){const a=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),i=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),b=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||b,this.listeners=[];const n=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,i){i?this.listeners.push(a.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},i='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=E.call(o,t)?o[t]:t,e.setJSON(n[t]||n[i])}let s={init:function(){if(t)return!1;t=!0,l(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&l(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,n){const o=function(e,t){let a={};for(let n in e)E.call(t,n)?angular.equals(e[n],t[n])||(a[n]=t[n]):a[n]=e[n];return!angular.equals({},a)&&a},l=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let n in t)(e[n].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={}
;for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,n.get(this.storageKey,{})),this.events={settingsChange:e.onChange||b},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return E.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){n.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!E.call(this.settingsMap,e))return!1;const n=this.settingsMap[e];'number'===n.inputType&&(t=parseInt(t,10),E.call(n,'min')&&(t=Math.max(n.min,t)),E.call(n,'max')&&(t=Math.min(n.max,t)));const i=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(i,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){
const a=angular.copy(this.settings);for(let t in e)if(E.call(this.settingsMap,t)){const a=this.settingsMap[t];let n=e[t];'number'===a.inputType&&(n=parseInt(n,10),E.call(a,'min')&&(n=Math.max(a.min,n)),E.call(a,'max')&&(n=Math.min(a.max,n))),this.settings[t]=n}const n=angular.copy(this.settings),i=o(a,n);if(!i)return!1;const l=s(this.settingsMap,i);return this.store(),this.updateScope(),this.events.settingsChange.call(this,i,l,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!E.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},
t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(n){e.multiSelect?n.length||(t.settings[a]=[l()]):n||(t.settings[a]=l())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const n=i.getPresetList().getPresets(),o=i.getGroupList().getGroups();return e=e||{},this.each((function(i,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[i]=r.multiSelect?[l()]:l());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){n[t]&&e.push({name:n[t].name,value:t})})),t[i]=e.length?e:[l()]}else{if(!n[s]&&r.disabledOption)return void(t[i]=l());t[i]={name:n[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[i]=e.length?e:[l()]}else{
if(!o[s]&&r.disabledOption)return void(t[i]=l());t[i]={name:o[s].name,value:s}}break;default:t[i]={name:e.textObject?g('i18n')(s,a.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[i]=[t[i]])}}else t[i]=s})),t},r.prototype.decode=function(e){let t={};for(let a in e){let n=this.settingsMap[a];if('select'===n.inputType)if(n.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let n=[];e[a].forEach((function(e){n.push(e.value)})),t[a]=n}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let n=[];switch((t=t||{}).disabled&&n.push(l()),t.type){case'keys':for(let t in e)n.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];n.push({name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){let a=e[t];n.push({name:a.name,value:a.id})}break;case'values':default:for(let i in e){let o=e[i];n.push({name:t.textObject?g('i18n')(o,a.loc.ale,t.textObject):o,value:o})}}return n},r.disabledOption=l,r})),
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,n){let r;var c=injector.get('overviewService'),d=!1,u=!1,p=i.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=i.getSelectedCharacter(),T=m.tribeById[0],b=m.getVillageList(),E=[],_=m.data.character_id,h=m.data.character_name,f=[],A=[],w=[n.LIGHT_CAVALRY,n.HEAVY_CAVALRY,n.AXE,n.SWORD,n.RAM,n.SNOB,n.TREBUCHET];var v=function(){o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:T},(function(e){for(var t=e.members,a=0;a<t.length;a++)A.push(t[a].id)})),b.forEach((function(e){E.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:E},S),setTimeout(v,6e4)},S=function(e){
...
u='light_cavalry'):'heavy_cavalry'==n[i].slowestUnit&&(p=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+p+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+n[i].target_village_id+']'+n[i].target_village_name+'[/village][b] Gracz cel: [/b][player='+_+']'+h+'[/player][b] [br]Wioska pochodzenia: [/b][village='+n[i].origin_village_id+']'+n[i].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+n[i].origin_character_id+']'+n[i].origin_character_name+'[/player][/size]');var g=a.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==h||'halfsack'==h||'Black Rider'==h?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:g}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:g}),a=[]):('Hajduk Split'==h||'halfsack'==h||'Black Rider'==h?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:g}):o.emit(l.MESSAGE_REPLY,{message_id:4648,
message:g}),a=[])}},R=function(e){var a=e.model.duration,n={},i={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y},l=[];return w.forEach((function(a){n[a]=1,l.push({unit:a,duration:t.getTravelTime(i,o,n,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},y={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,v()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return y})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton('Wartownik',60,g('i18n')('description',a.loc.ale,'alert_sender')),
o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'alert_sender')))})),i.register(s.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,a,n,i){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.ALERT_SENDER_STARTED,(function(){n.set(o,!0)})),i.register(s.ALERT_SENDER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c){let d,u,p=!1,g=!1,m=[],T=[];const b='army_helper_settings',E={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(E);const _=function(){m=[],T=[];const e=i.getGroupList().getGroups(),a=u[t.GROUP3],n=u[t.GROUP4];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){T.push(e[t])}))},h={init:function(){p=!0,d=new e({settingsMap:n,storageKey:b}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&_()})),u=d.getAll(),console.log('armyHelper settings',u),a.$on(s.GROUPS_CREATED,_),a.$on(s.GROUPS_DESTROYED,_),
a.$on(s.GROUPS_UPDATED,_)},start:function(){g=!0,c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return h})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u){let p,m,T,b=i.getGroupList();const E={ARMY:'army',BALANCER:'balancer',LOGS:'logs'},_=function(e){p.selectedTab=e},h=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){p.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},w=function(){p.running=!0,T.classList.remove('btn-orange'),
T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},v=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.ARMY,p.settingsMap=o,p.unit=r.encodeList(l,{textObject:'army_helper',disabled:!0}),m.injectScope(p),A(),p.selectTab=_,p.saveSettings=h,p.switchState=f;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(s.GROUPS_CREATED,A,!0),e.register(s.GROUPS_DESTROYED,A,!0),e.register(s.GROUPS_UPDATED,A,!0),e.register(s.ARMY_HELPER_START,w),e.register(s.ARMY_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Hetman',90),T.addEventListener('click',S),
...
define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c,d,u,p,g,m,T,b,E,_,h){
let f,A,w=!1,v=!1,S=[],R=null,y=null,k=null,I=null,x=null,L=null,O=null,N=null,P=null,M=null,C=null,z=null,D=null,U=null,G=null,B=null,V=null,W=null,q=null,Y=null,F=null,H=null,j=null,K=null,Q=null,X=null,Z=null,J=null,$=null,ee=null,te=null,ae=null,ne=null,ie=null,oe=null,le=null,se=null,re=null,ce=null,de=null,ue=null,pe=null,ge=null,me=null,Te=null,be=null,Ee=null;const _e='battle_calculator_settings',he={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},fe={[l.HALBERD_OF_GUAN_YU]:'spear',[l.PARACELSUS_LONGSWORD]:'sword',[l.THORGARDS_BATTLE_AXE]:'axe',[l.NIMRODS_LONGBOW]:'archer',[l.MIESZKOS_LANCE]:'lc',[l.NIMRODS_COMPOSITE_BOW]:'ma',[l.BAPTISTES_BANNER]:'hc',[l.CAROLS_MORNING_STAR]:'ram',[l.ALETHEIAS_BONFIRE]:'catapult',[l.VASCOS_SCEPTER]:'snob'},Ae={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',
[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},we={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},ve={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},Se={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},Re={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},ye={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},ke={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},Ie={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,
[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3},xe={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(we,xe,Ie,ke,ye,Re,Se,ve,he,fe,Ae);const Le=function(){S=[];const e=i.getPresetList().getPresets();A[t.PRESET].forEach((function(t){S.push(e[t])}))},Oe={init:function(){w=!0,f=new e({settingsMap:n,storageKey:_e}),f.onChange((function(e,t){A=f.getAll(),t[o.PRESETS]&&Le()})),A=f.getAll(),console.log('battleCalculator settings',A),_((function(){Le()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,Le),a.$on(s.ARMY_PRESET_DELETED,Le)},calculateB:function(){const e=A[t.BASHPOINTS_SPEAR],a=A[t.BASHPOINTS_SWORD],n=A[t.BASHPOINTS_AXE],i=A[t.BASHPOINTS_ARCHER],o=A[t.BASHPOINTS_LC],l=A[t.BASHPOINTS_MA],s=A[t.BASHPOINTS_HC],r=A[t.BASHPOINTS_RAM],c=A[t.BASHPOINTS_CATAPULT],d=A[t.BASHPOINTS_DOPPELSOLDNER],u=A[t.BASHPOINTS_TREBUCHET],p=A[t.BASHPOINTS_SNOB],g=A[t.BASHPOINTS_KNIGHT]
;var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],T=[4,5,1,5,5,6,23,4,12,40,200,25,10];R=e*m[0]+a*m[1]+n*m[2]+i*m[3]+o*m[4]+l*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],y=e*T[0]+a*T[1]+n*T[2]+i*T[3]+o*T[4]+l*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+p*T[10]+u*T[11]+d*T[12],console.log(R,y)}};return Oe.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],o=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=A[t.BATTLE_ARCHER_A],c=A[t.BATTLE_ARCHER_D],d=A[t.BATTLE_AXE_A],u=A[t.BATTLE_AXE_D],p=A[t.BATTLE_DOPPELSOLDNER_A],g=A[t.BATTLE_DOPPELSOLDNER_D],m=A[t.BATTLE_CATAPULT_A],T=A[t.BATTLE_CATAPULT_D],b=A[t.BATTLE_TARGET_LEVEL],E=A[t.BATTLE_HC_A],_=A[t.BATTLE_HC_D],h=A[t.BATTLE_KNIGHT_A],f=A[t.BATTLE_KNIGHT_D],w=A[t.BATTLE_LC_A],v=A[t.BATTLE_LC_D],S=A[t.BATTLE_LUCK],R=A[t.BATTLE_MA_A],y=A[t.BATTLE_MA_D],k=A[t.BATTLE_MORALE],I=A[t.BATTLE_RAM_A],x=A[t.BATTLE_RAM_D],L=A[t.BATTLE_SNOB_A],O=A[t.BATTLE_SNOB_D],N=A[t.BATTLE_SPEAR_A],P=A[t.BATTLE_SPEAR_D],M=A[t.BATTLE_SWORD_A],C=A[t.BATTLE_SWORD_D],z=A[t.BATTLE_TREBUCHET_A],D=A[t.BATTLE_TREBUCHET_D],U=A[t.BATTLE_WALL],G=0,B=0,V=0,_e=0,he=0,fe=0,Ae=0,we=0,ve=0,Se=0,Re=0,ye=0,ke=0,Ie=0,xe=0,Le=0,Oe=0,Ne=0,Pe=0,Me=0,Ce=0,ze=0,De=0,Ue=0,Ge=0,Be=0,Ve=0,We=0,qe=0,Ye=0,Fe=0,He=0,je=0,Ke=0,Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,ot=0,lt=0,st=0,rt=0,ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,bt=0,Et=0,_t=0,ht=0,ft=0,At=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,It=0,xt=0,Lt=0,Ot=0,Nt=0,Pt=0,Mt=0,Ct=0,zt=0,Dt=0,Ut=0,Gt=0,Bt=0,Vt=0,Wt=0,qt=0,Yt=0,Ft=0,Ht=0,jt=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=[1,1],ga=[1,1],ma=[1,1],Ta=[1,1],ba=[1,1],Ea=[1,1],_a=[1,1],ha=[1,1],fa=[1,1],Aa=[1,1],wa=[1,1],va=[1,1],Sa=[1,1],Ra=[1,1],ya=[1,1],ka=[1,1],Ia=[1,1],xa=[1,1],La=[1,1],Oa=[1,1],Na=[1,1],Pa=[1,1],Ma=[1,1],Ca=[1,1],za=[1,1],Da=[1,1],Ua=[1,1],Ga=[1,1],Ba=[1,1],Va=[1,1],Wa=[1,1],qa=[1,1],Ya=[1,1],Fa=[1,1],Ha=[1,1],ja=[1,1],Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,Tn=0,bn=0,En=0,_n=0,hn=0,fn=0,An=0,wn=0,vn=0,Sn=0,Rn=0,yn=0,kn=0,In=0,xn=0,Ln=0,On=[1,1],Nn=0,Pn=0,Mn=0,Cn=0,zn=0,Dn=0,Un=0,Gn=0,Bn=0,Vn=0,Wn=0,qn=0,Yn=0,Fn=0,Hn=0,jn=0,Kn=0,Qn=0,Xn=0,Zn=0,Jn=0,$n=0,ei=0,ti=0,ai=0,ni=0,ii=0,oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,Ti=0,bi=0,Ei=0,_i=0,hi=[1,1],fi=[1,1],Ai=[1,1],wi=[1,1],vi=[1,1],Si=[1,1],Ri=[1,1],yi=[1,1],ki=[1,1],Ii=0,xi=0,Li=0,Oi=0,Ni=0,Pi=0,Mi=0,Ci=0,zi=0,Di=0,Ui=0,Gi=0,Bi=0,Vi=0,Wi=0,qi=0,Yi=0,Fi=0,Hi=0,ji=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,To=0,bo=0,Eo=0,_o=0,ho=0,fo=0,Ao=0,wo=0,vo=0,So=0,Ro=0,yo=0,ko=0,Io=0,xo=0,Lo=0,Oo=0,No=0,Po=0,Mo=0,Co=0,zo=0,Do=0,Uo=0,Go=0,Bo=0,Vo=0,Wo=0,qo=0,Yo=0,Fo=0,Ho=0,jo=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=1,pl=0,gl=0,ml=0,Tl=0,bl=0,El=0,_l=0,hl=0,fl=0,Al=0,wl=0,vl=0,Sl=0,Rl=0,yl=0,kl=0,Il=0,xl=0,Ll=0,Ol=0,Nl=0,Pl=0,Ml=0,Cl=0,zl=0,Dl=0,Ul=0,Gl=0,Bl=0,Vl=0,Wl=0,ql=0,Yl=0,Fl=0,Hl=0,jl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,Ts=0,bs=0,Es=0,_s=0,hs=0,fs=0,As=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Is=0,xs=0,Ls=0,Os=0,Ns=0,Ps=0,Ms=0,Cs=0,zs=0,Ds=0,Us=0,Gs=0,Bs=0,Vs=0,Ws=0,qs=0,Ys=0,Fs=0,Hs=0,js=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,Tr=0,br=0,Er=0,_r=0,hr=0,fr=0,Ar=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Ir=0,xr=0,Lr=0,Or=0,Nr=0,Pr=0,Mr=0,Cr=0,zr=0,Dr=0,Ur=0,Gr=0,Br=0,Vr=0,Wr=0,qr=0,Yr=0,Fr=0,Hr=0,jr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,Tc=0,bc=0,Ec=0,_c=0,hc=0,fc=0,Ac=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Ic=0,xc=0,Lc=0,Oc=0,Nc=0,Pc=0,Mc=0,Cc=0,zc=0,Dc=0,Uc=0,Gc=0,Bc=0,Vc=0,Wc=0,qc=0,Yc=0,Fc=0,Hc=0,jc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0
;Qa=A[t.BATTLE_CHURCH_A],Xa=A[t.BATTLE_CHURCH_D],ul=A[t.BATTLE_NIGHT_BONUS].checked?2:1,Eo=A[t.BATTLE_OFFICER_LEADER].checked?.1:0,cl=A[t.BATTLE_OFFICER_MEDIC].checked?.1:0,vs=A[t.BATTLE_SKILL_MEDIC].checked?.1:0,As=A[t.BATTLE_SKILL_WEAPON_MASTER],Ss=A[t.BATTLE_SKILL_IRON_WALLS],ws=A[t.BATTLE_SKILL_CLINIQUE],yn=A[t.BATTLE_HOSPITAL],ca=A[t.BATTLE_CATAPULT_TARGET],ce=A[t.BATTLE_CATAPULT_TARGET],kn=A[t.BATTLE_KNIGHT_ITEM_D1],In=A[t.BATTLE_KNIGHT_ITEM_D2],xn=A[t.BATTLE_KNIGHT_ITEM_D3],Ln=A[t.BATTLE_KNIGHT_ITEM_A],_o=A[t.BATTLE_ITEM_LEVEL_D1],ho=A[t.BATTLE_ITEM_LEVEL_D2],fo=A[t.BATTLE_ITEM_LEVEL_D3],Ao=A[t.BATTLE_ITEM_LEVEL_A],Ea='axe'==kn&1==_o?[1.05,1.1]:'axe'==kn&2==_o?[1.1,1.2]:'axe'==kn&3==_o?[1.2,1.3]:[1,1],Pa='ma'==kn&1==_o?[1.05,1.1]:'ma'==kn&2==_o?[1.1,1.2]:'ma'==kn&3==_o?[1.2,1.3]:[1,1],Va='spear'==kn&1==_o?[1.1,1.05]:'spear'==kn&2==_o?[1.2,1.1]:'spear'==kn&3==_o?[1.3,1.2]:[1,1],Fa='sword'==kn&1==_o?[1.1,1.05]:'sword'==kn&2==_o?[1.2,1.1]:'sword'==kn&3==_o?[1.3,1.2]:[1,1],
ga='archer'==kn&1==_o?[1.1,1.05]:'archer'==kn&2==_o?[1.2,1.1]:'archer'==kn&3==_o?[1.3,1.2]:[1,1],Ra='hc'==kn&1==_o?[1.1,1.1]:'hc'==kn&2==_o?[1.2,1.2]:'hc'==kn&3==_o?[1.3,1.3]:[1,1],Da='ram'==kn&1==_o?[1.05,1.25]:'ram'==kn&2==_o?[1.1,1.5]:'ram'==kn&3==_o?[1.2,2]:[1,1],Aa='catapult'==kn&1==_o?[1.05,1.25]:'catapult'==kn&2==_o?[1.1,1.5]:'catapult'==kn&3==_o?[1.2,2]:[1,1],_a='axe'==In&1==ho?[1.05,1.1]:'axe'==In&2==ho?[1.1,1.2]:'axe'==In&3==ho?[1.2,1.3]:[1,1],Ma='ma'==In&1==ho?[1.05,1.1]:'ma'==In&2==ho?[1.1,1.2]:'ma'==In&3==ho?[1.2,1.3]:[1,1],Wa='spear'==In&1==ho?[1.1,1.05]:'spear'==In&2==ho?[1.2,1.1]:'spear'==In&3==ho?[1.3,1.2]:[1,1],Ha='sword'==In&1==ho?[1.1,1.05]:'sword'==In&2==ho?[1.2,1.1]:'sword'==In&3==ho?[1.3,1.2]:[1,1],ma='archer'==In&1==ho?[1.1,1.05]:'archer'==In&2==ho?[1.2,1.1]:'archer'==In&3==ho?[1.3,1.2]:[1,1],ya='hc'==In&1==ho?[1.1,1.1]:'hc'==In&2==ho?[1.2,1.2]:'hc'==In&3==ho?[1.3,1.3]:[1,1],Ua='ram'==In&1==ho?[1.05,1.25]:'ram'==In&2==ho?[1.1,1.5]:'ram'==In&3==ho?[1.2,2]:[1,1],
wa='catapult'==In&1==ho?[1.05,1.25]:'catapult'==In&2==ho?[1.1,1.5]:'catapult'==In&3==ho?[1.2,2]:[1,1],Oa='lc'==xn&1==fo?[1.05,1.1]:'lc'==xn&2==fo?[1.1,1.2]:'lc'==xn&3==fo?[1.2,1.3]:[1,1],ha='axe'==xn&1==fo?[1.05,1.1]:'axe'==xn&2==fo?[1.1,1.2]:'axe'==xn&3==fo?[1.2,1.3]:[1,1],Ca='ma'==xn&1==fo?[1.05,1.1]:'ma'==xn&2==fo?[1.1,1.2]:'ma'==xn&3==fo?[1.2,1.3]:[1,1],qa='spear'==xn&1==fo?[1.1,1.05]:'spear'==xn&2==fo?[1.2,1.1]:'spear'==xn&3==fo?[1.3,1.2]:[1,1],ja='sword'==xn&1==fo?[1.1,1.05]:'sword'==xn&2==fo?[1.2,1.1]:'sword'==xn&3==fo?[1.3,1.2]:[1,1],Ta='archer'==xn&1==fo?[1.1,1.05]:'archer'==xn&2==fo?[1.2,1.1]:'archer'==xn&3==fo?[1.3,1.2]:[1,1],ka='hc'==xn&1==fo?[1.1,1.1]:'hc'==xn&2==fo?[1.2,1.2]:'hc'==xn&3==fo?[1.3,1.3]:[1,1],Ga='ram'==xn&1==fo?[1.05,1.25]:'ram'==xn&2==fo?[1.1,1.5]:'ram'==xn&3==fo?[1.2,2]:[1,1],va='catapult'==xn&1==fo?[1.05,1.25]:'catapult'==xn&2==fo?[1.1,1.5]:'catapult'==xn&3==fo?[1.2,2]:[1,1],
Ia=(xa='lc'==kn&1==_o?[1.05,1.1]:'lc'==kn&2==_o?[1.1,1.2]:'lc'==kn&3==_o?[1.2,1.3]:[1,1])[0]>=(La='lc'==In&1==ho?[1.05,1.1]:'lc'==In&2==ho?[1.1,1.2]:'lc'==In&3==ho?[1.2,1.3]:[1,1])[0]&&xa[0]>=Oa[0]?xa:La[0]>=xa[0]&&La[0]>=Oa[0]?La:Oa[0]>=xa[0]&&Oa[0]>=La[0]?Oa:[1,1],ba=Ea[0]>=_a[0]&&Ea[0]>=ha[0]?Ea:_a[0]>=Ea[0]&&_a[0]>=ha[0]?_a:ha[0]>=Ea[0]&&ha[0]>=_a[0]?ha:[1,1],Na=Pa[0]>=Ma[0]&&Pa[0]>=Ca[0]?Pa:Ma[0]>=Pa[0]&&Ma[0]>=Ca[0]?Ma:Ca[0]>=Pa[0]&&Ca[0]>=Ma[0]?Ca:[1,1],Sa=Ra[0]>=ya[0]&&Ra[0]>=ka[0]?Ra:ya[0]>=Ra[0]&&ya[0]>=ka[0]?ya:ka[0]>=Ra[0]&&ka[0]>=ya[0]?ka:[1,1],za=Da[0]>=Ua[0]&&Da[0]>=Ga[0]?Da:Ua[0]>=Da[0]&&Ua[0]>=Ga[0]?Ua:Ga[0]>=Da[0]&&Ga[0]>=Ua[0]?Ga:[1,1],fa=Aa[0]>=wa[0]&&Aa[0]>=va[0]?Aa:wa[0]>=Aa[0]&&wa[0]>=va[0]?wa:va[0]>=Aa[0]&&va[0]>=wa[0]?va:[1,1],Ba=Va[0]>=Wa[0]&&Va[0]>=qa[0]?Va:Wa[0]>=Va[0]&&Wa[0]>=qa[0]?Wa:qa[0]>=Va[0]&&qa[0]>=Wa[0]?qa:[1,1],Ya=Fa[0]>=Ha[0]&&Fa[0]>=ja[0]?Fa:Ha[0]>=Fa[0]&&Ha[0]>=ja[0]?Ha:ja[0]>=Fa[0]&&ja[0]>=Ha[0]?ja:[1,1],
pa=ga[0]>=ma[0]&&ga[0]>=Ta[0]?ga:ma[0]>=ga[0]&&ma[0]>=Ta[0]?ma:Ta[0]>=ga[0]&&Ta[0]>=ma[0]?Ta:[1,1],vi='lc'==Ln&1==Ao?[1.05,1.1]:'lc'==Ln&2==Ao?[1.1,1.2]:'lc'==Ln&3==Ao?[1.2,1.3]:[1,1],fi='axe'==Ln&1==Ao?[1.05,1.1]:'axe'==Ln&2==Ao?[1.1,1.2]:'axe'==Ln&3==Ao?[1.2,1.3]:[1,1],Si='ma'==Ln&1==Ao?[1.05,1.1]:'ma'==Ln&2==Ao?[1.1,1.2]:'ma'==Ln&3==Ao?[1.2,1.3]:[1,1],yi='spear'==Ln&1==Ao?[1.1,1.05]:'spear'==Ln&2==Ao?[1.2,1.1]:'spear'==Ln&3==Ao?[1.3,1.2]:[1,1],ki='sword'==Ln&1==Ao?[1.1,1.05]:'sword'==Ln&2==Ao?[1.2,1.1]:'sword'==Ln&3==Ao?[1.3,1.2]:[1,1],hi='archer'==Ln&1==Ao?[1.1,1.05]:'archer'==Ln&2==Ao?[1.2,1.1]:'archer'==Ln&3==Ao?[1.3,1.2]:[1,1],wi='hc'==Ln&1==Ao?[1.1,1.1]:'hc'==Ln&2==Ao?[1.2,1.2]:'hc'==Ln&3==Ao?[1.3,1.3]:[1,1],Ri='ram'==Ln&1==Ao?[1.05,1.25]:'ram'==Ln&2==Ao?[1.1,1.5]:'ram'==Ln&3==Ao?[1.2,2]:[1,1],Ai='catapult'==Ln&1==Ao?[1.05,1.25]:'catapult'==Ln&2==Ao?[1.1,1.5]:'catapult'==Ln&3==Ao?[1.2,2]:[1,1],
Be=N*s[0]+M*s[1]+d*s[2]+r*s[3]+w*s[4]+R*s[5]+E*s[6]+I*s[7]+m*s[8]+h*s[9]+L*s[10]+z*s[11]+p*s[12],da=P*s[0]+C*s[1]+u*s[2]+c*s[3]+v*s[4]+y*s[5]+_*s[6]+x*s[7]+T*s[8]+f*s[9]+O*s[10]+D*s[11]+g*s[12],Ka=2*Be<=da?2:1,pl=Be-5*I,Tl=0==U?0:Math.round(20*Math.pow(1.2515,U-1)),ua=da+(Tl+100*O),Bl=0==pl||0==ua?0:pl/ua>1?1:pl/ua,dl=k/100,Go=S/100,ml=Math.round(1e3*(Qa/100*dl*(1+Go)+As/100+Eo))/1e3,dd=m/(cd=I+m),ud=I/cd,Vc=Math.round(D*dd),id=Math.round(D*ud),ps=(ms=I-(0==I?0:I<id?I:id))*Bl*ml*(On='ram'==Ln?1==Ao?[1.05,1.25]:2==Ao?[1.1,1.5]:3==Ao?[1.2,2]:[1,1]:[1,1])[1],Sn=20==U?18:19==U?17:18==U?15:17==U?14:16==U?13:15==U?11:14==U?10:13==U||12==U?9:11==U?8:10==U?7:9==U||8==U?6:7==U||6==U?5:5==U||4==U||3==U?4:2==U||1==U?3:0,sd=0==U?0:2*Sn,od=0==U?0:ps/sd,rd=U<=Ss?U:U-Ss<od?U<Ss?U:Ss:U-od,pt=Math.round(rd),ut=Math.round(.05*pt*1e3)/1e3,gl=Math.round(Xa/100*(1+ut)*ul*1e3)/1e3,ra=m-(0==m?0:m<Vc?m:Vc),dt=0==(ld=Math.round(rd))?0:Math.round(20*Math.pow(1.2515,ld-1)),
Hi=N+M+d+p>w+E&&N+M+d+p>r+R?'inf':w+E>N+M+d+p&&w+E>r+R?'cav':'arc',Rl=N*s[0]+M*s[1]+d*s[2]+r*s[3]+w*s[4]+R*s[5]+E*s[6]+ms*s[7]+ra*s[8]+h*s[9]+L*s[10]+z*s[11]+p*s[12],Dl=P*s[0]+C*s[1]+u*s[2]+c*s[3]+v*s[4]+y*s[5]+_*s[6]+x*s[7]+T*s[8]+f*s[9]+O*s[10]+D*s[11]+g*s[12],console.log('provisionDefenderRound1Total'+Dl),bs=ms*s[7]+ra*s[8]+z*s[11]+h*s[9]+L*s[10],'cav'==Hi?(hl=w*s[4]+E*s[6]+bs,wl=N*s[0]+M*s[1]+d*s[2]+p*s[12],bl=r*s[3]+R*s[5]):'inf'==Hi?(wl=N*s[0]+M*s[1]+d*s[2]+p*s[12]+bs,hl=w*s[4]+E*s[6],bl=r*s[3]+R*s[5]):'arc'==Hi?(wl=N*s[0]+M*s[1]+d*s[2]+p*s[12],hl=w*s[4]+E*s[6],bl=r*s[3]+R*s[5]+bs):(wl=N*s[0]+M*s[1]+d*s[2]+p*s[12],hl=w*s[4]+E*s[6],bl=r*s[3]+R*s[5]),Lo=0==wl?0:Math.round(wl/Rl*1e4)/1e4,xo=0==hl?0:Math.round(hl/Rl*1e4)/1e4,0==bl?(Io=0,console.log('lossesPercentRound1Arc'+Io)):(Io=Math.round(bl/Rl*1e4)/1e4,console.log('lossesPercentRound1Arc'+Io)),rr=Math.round(P*Lo),sr=Math.round(P*xo),lr=P-sr-rr,Rc=Math.round(C*Lo),Sc=Math.round(C*xo),vc=C-Sc-Rc,tt=Math.round(u*Lo),
et=Math.round(u*xo),$e=u-et-tt,Le=Math.round(c*Lo),xe=Math.round(c*xo),Ie=c-xe-Le,so=Math.round(v*Lo),lo=Math.round(v*xo),oo=v-lo-so,el=Math.round(y*Lo),$o=Math.round(y*xo),Jo=y-$o-el,mn=Math.round(_*Lo),gn=Math.round(_*xo),pn=_-gn-mn,ts=Math.round(x*Lo),es=Math.round(x*xo),$l=x-es-ts,Xt=Math.round(T*Lo),Qt=Math.round(T*xo),Kt=T-Qt-Xt,Gs=Math.round(O*Lo),Us=Math.round(O*xo),Ds=O-Us-Gs,Qc=Math.round(D*Lo),Kc=Math.round(D*xo),jc=D-Kc-Qc,kt=Math.round(g*Lo),yt=Math.round(g*xo),Rt=g-yt-kt,di=Math.round(f*Lo),ci=Math.round(f*xo),ri=f-ci-di,Ml=rr*s[0]+Rc*s[1]+tt*s[2]+kt*s[12]+Gs*s[10]+so*s[4]+mn*s[6]+Le*s[3]+el*s[5]+ts*s[7]+Xt*s[8]+Qc*s[11]+di*s[9],console.log('provisionDefenderInfRound1'+Ml),Ol=sr*s[0]+Sc*s[1]+et*s[2]+yt*s[12]+Us*s[10]+lo*s[4]+gn*s[6]+xe*s[3]+$o*s[5]+es*s[7]+Qt*s[8]+Kc*s[11]+ci*s[9],console.log('provisionDefenderCavRound1'+Ol),Il=lr*s[0]+vc*s[1]+$e*s[2]+Rt*s[12]+Ds*s[10]+oo*s[4]+pn*s[6]+Ie*s[3]+Jo*s[5]+$l*s[7]+Kt*s[8]+jc*s[11]+ri*s[9],
console.log('provisionDefenderArcRound1'+Il),Yr=rr*n[0]*Ba[0]+Rc*n[1]*Ya[0]+tt*n[2]*ba[0]+kt*n[12]+Gs*n[10]+so*n[4]*Ia[0]+mn*n[6]*Sa[0]+Le*n[3]*pa[0]+el*n[5]*Na[0]+ts*n[7]*za[0]+Xt*n[8]*fa[0]+Qc*n[11]+di*n[9],Vr=sr*i[0]*Ba[0]+Sc*i[1]*Ya[0]+et*i[2]*ba[0]+yt*i[12]+Us*i[10]+lo*i[4]*Ia[0]+gn*i[6]*Sa[0]+xe*i[3]*pa[0]+$o*i[5]*Na[0]+es*i[7]*za[0]+Qt*i[8]*fa[0]+Kc*i[11]+ci*i[9],Ur=lr*o[0]*Ba[0]+vc*o[1]*Ya[0]+$e*o[2]*ba[0]+Rt*o[12]+Ds*o[10]+oo*o[4]*Ia[0]+pn*o[6]*Sa[0]+Ie*o[3]*pa[0]+Jo*o[5]*Na[0]+$l*o[7]*za[0]+Kt*o[8]*fa[0]+jc*o[11]+ri*o[9],hs=ms*l[7]*Ri[1]+ra*l[8]*Ai[1]+z*l[11]+h*l[9]+L*l[10],'cav'==Hi?(Nr=w*l[4]*vi[1]+E*l[6]*wi[1]+hs,Cr=N*l[0]*yi[1]+M*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka,xr=r*l[3]*hi[1]+R*l[5]*Si[1]):'inf'==Hi?(Cr=N*l[0]*yi[1]+M*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka+hs,Nr=w*l[4]*vi[1]+E*l[6]*wi[1],xr=r*l[3]*hi[1]+R*l[5]*Si[1]):'arc'==Hi?(Cr=N*l[0]*yi[1]+M*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka,Nr=w*l[4]*vi[1]+E*l[6]*wi[1],
xr=r*l[3]*hi[1]+R*l[5]*Si[1]+hs):(Cr=N*l[0]*yi[1]+M*l[1]*ki[1]+d*l[2]*fi[1]+p*l[12]*Ka,Nr=w*l[4]*vi[1]+E*l[6]*wi[1],xr=r*l[3]*hi[1]+R*l[5]*Si[1]),yr=(vr=Cr*ml)+(fr=Nr*ml)+(Er=xr*ml),ac=($r=Yr*gl+dt)+(Xr=Vr*gl+dt)+(jr=Ur*gl+dt),Fi=0==vr||0==$r?0:$r<=vr?1:Math.pow(vr/$r,.5)/($r/vr),Yi=0==fr||0==Xr?0:Xr<=fr?1:Math.pow(fr/Xr,.5)/(Xr/fr),qi=0==Er||0==jr?0:jr<=Er?1:Math.pow(Er/jr,.5)/(jr/Er),Wi=0==vr||0==$r?0:vr<=$r?1:Math.pow($r/vr,.5)/(vr/$r),Vi=0==fr||0==Xr?0:fr<=Xr?1:Math.pow(Xr/fr,.5)/(fr/Xr),Bi=0==Er||0==jr?0:Er<=jr?1:Math.pow(jr/Er,.5)/(Er/jr),Mn=Math.round(1e6*Wi)/1e6,Pn=Math.round(1e6*Vi)/1e6,Nn=Math.round(1e6*Bi)/1e6,Dn=Math.round(1e6*Fi)/1e6,zn=Math.round(1e6*Yi)/1e6,Cn=Math.round(1e6*qi)/1e6,ar=Math.round(-rr*Dn+1e-6)+Math.round(-sr*zn+1e-6)+Math.round(-lr*Cn+1e-6),hc=Math.round(-Rc*Dn+1e-6)+Math.round(-Sc*zn+1e-6)+Math.round(-vc*Cn+1e-6),Qe=Math.round(-tt*Dn+1e-6)+Math.round(-et*zn+1e-6)+Math.round(-$e*Cn+1e-6),
Se=Math.round(-Le*Dn+1e-6)+Math.round(-xe*zn+1e-6)+Math.round(-Ie*Cn+1e-6),to=Math.round(-so*Dn+1e-6)+Math.round(-lo*zn+1e-6)+Math.round(-oo*Cn+1e-6),Ko=Math.round(-el*Dn+1e-6)+Math.round(-$o*zn+1e-6)+Math.round(-Jo*Cn+1e-6),rn=Math.round(-mn*Dn+1e-6)+Math.round(-gn*zn+1e-6)+Math.round(-pn*Cn+1e-6),Ql=Math.round(-ts*Dn+1e-6)+Math.round(-es*zn+1e-6)+Math.round(-$l*Cn+1e-6),Yt=Math.round(-Xt*Dn+1e-6)+Math.round(-Qt*zn+1e-6)+Math.round(-Kt*Cn+1e-6),qc=Math.round(-Qc*Dn+1e-6)+Math.round(-Kc*zn+1e-6)+Math.round(-jc*Cn+1e-6),At=Math.round(-kt*Dn+1e-6)+Math.round(-yt*zn+1e-6)+Math.round(-Rt*Cn+1e-6),ii=Math.round(-di*Dn+1e-6)+Math.round(-ci*zn+1e-6)+Math.round(-ri*Cn+1e-6),Ps=Math.round(-Gs*Dn+1e-6)+Math.round(-Us*zn+1e-6)+Math.round(-Ds*Cn+1e-6),Qs=Math.round(-N*Mn+1e-6),pc=Math.round(-M*Mn+1e-6),We=Math.round(-d*Mn+1e-6),mt=Math.round(-p*Mn+1e-6),V=Math.round(-r*Nn+1e-6),Vo=Math.round(-R*Nn+1e-6),Ki=Math.round(-w*Pn+1e-6),en=Math.round(-E*Pn+1e-6),'cav'==Hi?(Wl=Math.round(-ms*Pn+1e-6),
Dt=Math.round(-ra*Pn+1e-6),Cc=Math.round(-z*Pn+1e-6),Zn=Math.round(-h*Pn+1e-6),ys=Math.round(-L*Pn+1e-6)):'inf'==Hi?(Wl=Math.round(-ms*Mn+1e-6),Dt=Math.round(-ra*Mn+1e-6),Cc=Math.round(-z*Mn+1e-6),Zn=Math.round(-h*Mn+1e-6),ys=Math.round(-L*Mn+1e-6)):'arc'==Hi&&(Wl=Math.round(-ms*Nn+1e-6),Dt=Math.round(-ra*Nn+1e-6),Cc=Math.round(-z*Nn+1e-6),Zn=Math.round(-h*Nn+1e-6),ys=Math.round(-L*Nn+1e-6)),Js=N+Qs,Tc=M+pc,Fe=d+We,fe=r+V,Zi=w+Ki,Yo=R+Vo,nn=E+en,Fl=ms+Wl,Bt=ra+Dt,Uc=z+Cc,Et=p+mt,xs=L+ys,ei=h+Zn,or=P+ar,wc=C+hc,Je=u+Qe,ke=c+Se,io=v+to,Zo=y+Ko,un=_+rn,Jl=x+Ql,jt=T+Yt,Hc=D+qc,St=g+At,zs=O+Ps,si=f+ii,wo=Qs*s[0]+pc*s[1]+We*s[2]+V*s[3]+Ki*s[4]+Vo*s[5]+en*s[6]+Wl*s[7]+Dt*s[8]+Zn*s[9]+ys*s[10]+Cc*s[11]+mt*s[12],console.log('lossesAttackerRound1Total'+wo),Ro=ar*s[0]+hc*s[1]+Qe*s[2]+Se*s[3]+to*s[4]+Ko*s[5]+rn*s[6]+Ql*s[7]+Yt*s[8]+ii*s[9]+Ps*s[10]+qc*s[11]+At*s[12],console.log('lossesDefenderRound1Total'+Ro),
oc=Js*s[0]+Tc*s[1]+Fe*s[2]+fe*s[3]+Zi*s[4]+Yo*s[5]+nn*s[6]+Fl*s[7]+Bt*s[8]+Uc*s[11]+Et*s[12]+xs*s[10]+ei*s[9],console.log('survivorsAttackerRound1Total'+oc),rc=or*s[0]+wc*s[1]+Je*s[2]+ke*s[3]+io*s[4]+Zo*s[5]+un*s[6]+Jl*s[7]+jt*s[8]+Hc*s[11]+St*s[12]+zs*s[10]+si*s[9],console.log('survivorsDefenderRound1Total'+rc),0==yr||0==ac?(Ge=0,console.log('armyLossesPercentEachRound'+Ge)):ac<=yr?(Ge=1,console.log('armyLossesPercentEachRound'+Ge)):(Ge=Math.pow(yr/ac,.5/(ac/yr)),console.log('armyLossesPercentEachRound'+Ge)),yl=Js*s[0]+Tc*s[1]+Fe*s[2]+fe*s[3]+Zi*s[4]+Yo*s[5]+nn*s[6]+Fl*s[7]+Bt*s[8]+ei*s[9]+xs*s[10]+Uc*s[11]+Et*s[12],Ul=or*s[0]+wc*s[1]+Je*s[2]+ke*s[3]+io*s[4]+Zo*s[5]+un*s[6]+Jl*s[7]+jt*s[8]+si*s[9]+zs*s[10]+Hc*s[11]+St*s[12],console.log('provisionDefenderRound2Total'+Ul),Es=Fl*s[7]+Bt*s[8]+Uc*s[11]+ei*s[9],'cav'==Hi?(fl=Zi*s[4]+nn*s[6]+Es,vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10],El=fe*s[3]+Yo*s[5]):'inf'==Hi?(vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10]+Es,fl=Zi*s[4]+nn*s[6],
El=fe*s[3]+Yo*s[5]):'arc'==Hi?(vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10],fl=Zi*s[4]+nn*s[6],El=fe*s[3]+Yo*s[5]+Es):(vl=Js*s[0]+Tc*s[1]+Fe*s[2]+Et*s[12]+xs*s[10],fl=Zi*s[4]+nn*s[6],El=fe*s[3]+Yo*s[5]),Po=0==vl?0:Math.round(vl/yl*1e4)/1e4,No=0==fl?0:Math.round(fl/yl*1e4)/1e4,0==El?(Oo=0,console.log('lossesPercentRound2Arc'+Oo)):(Oo=Math.round(El/yl*1e4)/1e4,console.log('lossesPercentRound2Arc'+Oo)),pr=Math.round(or*Po),ur=Math.round(or*No),dr=or-ur-pr,xc=Math.round(wc*Po),Ic=Math.round(wc*No),kc=wc-Ic-xc,ot=Math.round(Je*Po),it=Math.round(Je*No),nt=Je-it-ot,Me=Math.round(ke*Po),Pe=Math.round(ke*No),Ne=ke-Pe-Me,po=Math.round(io*Po),uo=Math.round(io*No),co=io-uo-po,il=Math.round(Zo*Po),nl=Math.round(Zo*No),al=Zo-nl-il,_n=Math.round(un*Po),En=Math.round(un*No),bn=un-En-_n,os=Math.round(Jl*Po),is=Math.round(Jl*No),ns=Jl-is-os,ea=Math.round(jt*Po),$t=Math.round(jt*No),Jt=jt-$t-ea,qs=Math.round(zs*Po),Ws=Math.round(zs*No),Vs=zs-Ws-qs,$c=Math.round(Hc*Po),Jc=Math.round(Hc*No),Zc=Hc-Jc-$c,
Ot=Math.round(St*Po),Lt=Math.round(St*No),xt=St-Lt-Ot,mi=Math.round(si*Po),gi=Math.round(si*No),pi=si-gi-mi,Cl=pr*s[0]+xc*s[1]+ot*s[2]+Ot*s[12]+qs*s[10]+po*s[4]+_n*s[6]+Me*s[3]+il*s[5]+os*s[7]+ea*s[8]+$c*s[11]+mi*s[9],console.log('provisionDefenderInfRound2'+Cl),Nl=ur*s[0]+Ic*s[1]+it*s[2]+Lt*s[12]+Ws*s[10]+uo*s[4]+En*s[6]+Pe*s[3]+nl*s[5]+is*s[7]+$t*s[8]+Jc*s[11]+gi*s[9],console.log('provisionDefenderCavRound2'+Nl),xl=dr*s[0]+kc*s[1]+nt*s[2]+xt*s[12]+Vs*s[10]+co*s[4]+bn*s[6]+Ne*s[3]+al*s[5]+ns*s[7]+Jt*s[8]+Zc*s[11]+pi*s[9],console.log('provisionDefenderArcRound2'+xl),Fr=pr*n[0]*Ba[0]+xc*n[1]*Ya[0]+ot*n[2]*ba[0]+Ot*n[12]+qs*n[10]+po*n[4]*Ia[0]+_n*n[6]*Sa[0]+Me*n[3]*pa[0]+il*n[5]*Na[0]+os*n[7]*za[0]+ea*n[8]*fa[0]+$c*n[11]+mi*n[9],Wr=ur*i[0]*Ba[0]+Ic*i[1]*Ya[0]+it*i[2]*ba[0]+Lt*i[12]+Ws*i[10]+uo*i[4]*Ia[0]+En*i[6]*Sa[0]+Pe*i[3]*pa[0]+nl*i[5]*Na[0]+is*i[7]*za[0]+$t*i[8]*fa[0]+Jc*i[11]+gi*i[9],
Gr=dr*o[0]*Ba[0]+kc*o[1]*Ya[0]+nt*o[2]*ba[0]+xt*o[12]+Vs*o[10]+co*o[4]*Ia[0]+bn*o[6]*Sa[0]+Ne*o[3]*pa[0]+al*o[5]*Na[0]+ns*o[7]*za[0]+Jt*o[8]*fa[0]+Zc*o[11]+pi*o[9],fs=Fl*l[7]*Ri[1]+Bt*l[8]*Ai[1]+Uc*l[11]+ei*l[9],'cav'==Hi?(Pr=Zi*l[4]*vi[1]+nn*l[6]*wi[1]+fs,zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]):'inf'==Hi?(zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10]+fs,Pr=Zi*l[4]*vi[1]+nn*l[6]*wi[1],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]):'arc'==Hi?(zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10],Pr=Zi*l[4]*vi[1]+nn*l[6]*wi[1],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]+fs):(zr=Js*l[0]*yi[1]+Tc*l[1]*ki[1]+Fe*l[2]*fi[1]+Et*l[12]*Ka+xs*l[10],Pr=Zi*l[4]*vi[1]+nn*l[6]*wi[1],Lr=fe*l[3]*hi[1]+Yo*l[5]*Si[1]),ec=Fr*gl,Zr=Wr*gl,Kr=Gr*gl,kr=(Sr=zr*ml)+(Ar=Pr*ml)+(_r=Lr*ml),console.log('strengthAttackerRound2'+kr),nc=ec+Zr+Kr,console.log('strengthDefenderRound2'+nc),Pi=0==Sr||0==ec?0:ec<=Sr?1:Math.pow(Sr/ec,.5)/(ec/Sr),
Ni=0==Ar||0==Zr?0:Zr<=Ar?1:Math.pow(Ar/Zr,.5)/(Zr/Ar),Oi=0==_r||0==Kr?0:Kr<=_r?1:Math.pow(_r/Kr,.5)/(Kr/_r),Li=0==Sr||0==ec?0:Sr<=ec?1:Math.pow(ec/Sr,.5)/(Sr/ec),xi=0==Ar||0==Zr?0:Ar<=Zr?1:Math.pow(Zr/Ar,.5)/(Ar/Zr),Ii=0==_r||0==Kr?0:_r<=Kr?1:Math.pow(Kr/_r,.5)/(_r/Kr),Bn=Math.round(1e6*Li)/1e6,Gn=Math.round(1e6*xi)/1e6,Un=Math.round(1e6*Ii)/1e6,qn=Math.round(1e6*Pi)/1e6,Wn=Math.round(1e6*Ni)/1e6,Vn=Math.round(1e6*Oi)/1e6,nr=Math.round(-pr*qn+1e-6)+Math.round(-ur*Wn+1e-6)+Math.round(-dr*Vn+1e-6),fc=Math.round(-xc*qn+1e-6)+Math.round(-Ic*Wn+1e-6)+Math.round(-kc*Vn+1e-6),Xe=Math.round(-ot*qn+1e-6)+Math.round(-it*Wn+1e-6)+Math.round(-nt*Vn+1e-6),Re=Math.round(-Me*qn+1e-6)+Math.round(-Pe*Wn+1e-6)+Math.round(-Ne*Vn+1e-6),ao=Math.round(-po*qn+1e-6)+Math.round(-uo*Wn+1e-6)+Math.round(-co*Vn+1e-6),Qo=Math.round(-il*qn+1e-6)+Math.round(-nl*Wn+1e-6)+Math.round(-al*Vn+1e-6),cn=Math.round(-_n*qn+1e-6)+Math.round(-En*Wn+1e-6)+Math.round(-bn*Vn+1e-6),
Xl=Math.round(-os*qn+1e-6)+Math.round(-is*Wn+1e-6)+Math.round(-ns*Vn+1e-6),Ft=Math.round(-ea*qn+1e-6)+Math.round(-$t*Wn+1e-6)+Math.round(-Jt*Vn+1e-6),Yc=Math.round(-$c*qn+1e-6)+Math.round(-Jc*Wn+1e-6)+Math.round(-Zc*Vn+1e-6),wt=Math.round(-Ot*qn+1e-6)+Math.round(-Lt*Wn+1e-6)+Math.round(-xt*Vn+1e-6),oi=Math.round(-mi*qn+1e-6)+Math.round(-gi*Wn+1e-6)+Math.round(-pi*Vn+1e-6),Ms=Math.round(-qs*qn+1e-6)+Math.round(-Ws*Wn+1e-6)+Math.round(-Vs*Vn+1e-6),Xs=Math.round(-Js*Bn+1e-6),gc=Math.round(-Tc*Bn+1e-6),qe=Math.round(-Fe*Bn+1e-6),Tt=Math.round(-Et*Bn+1e-6),_e=Math.round(-fe*Un+1e-6),Wo=Math.round(-Yo*Un+1e-6),Qi=Math.round(-Zi*Gn+1e-6),tn=Math.round(-nn*Gn+1e-6),'cav'==Hi?(ql=Math.round(-Fl*Gn+1e-6),Ut=Math.round(-Bt*Gn+1e-6),zc=Math.round(-Uc*Gn+1e-6),Jn=Math.round(-ei*Gn+1e-6)):'inf'==Hi?(ql=Math.round(-Fl*Bn+1e-6),Ut=Math.round(-Bt*Bn+1e-6),zc=Math.round(-Uc*Bn+1e-6),Jn=Math.round(-ei*Bn+1e-6)):'arc'==Hi&&(ql=Math.round(-Fl*Un+1e-6),Ut=Math.round(-Bt*Un+1e-6),zc=Math.round(-Uc*Un+1e-6),
Jn=Math.round(-ei*Un+1e-6)),ks=100*xs==vl?0:Math.round(-xs*Bn+1e-6),$s=Js+Xs,bc=Tc+gc,He=Fe+qe,Ae=fe+_e,Ji=Zi+Qi,Fo=Yo+Wo,on=nn+tn,Hl=Fl+ql,Vt=Bt+Ut,Gc=Uc+zc,_t=Et+Tt,Ls=xs+ks,ti=ei+Jn,cr=or+nr,yc=wc+fc,at=Je+Xe,Oe=ke+Re,ro=io+ao,tl=Zo+Qo,Tn=un+cn,as=Jl+Xl,Zt=jt+Ft,Xc=Hc+Yc,It=St+wt,Bs=zs+Ms,ui=si+oi,vo=Xs*s[0]+gc*s[1]+qe*s[2]+_e*s[3]+Qi*s[4]+Wo*s[5]+tn*s[6]+ql*s[7]+Ut*s[8]+Jn*s[9]+ks*s[10]+zc*s[11]+Tt*s[12],console.log('lossesAttackerRound2Total'+vo),yo=nr*s[0]+fc*s[1]+Xe*s[2]+Re*s[3]+ao*s[4]+Qo*s[5]+cn*s[6]+Xl*s[7]+Ft*s[8]+oi*s[9]+Ms*s[10]+Yc*s[11]+wt*s[12],console.log('lossesDefenderRound2Total'+yo),lc=$s*s[0]+bc*s[1]+He*s[2]+Ae*s[3]+Ji*s[4]+Fo*s[5]+on*s[6]+Hl*s[7]+Vt*s[8]+Gc*s[11]+_t*s[12]+Ls*s[10]+ti*s[9],console.log('survivorsAttackerRound2Total'+lc),cc=cr*s[0]+yc*s[1]+at*s[2]+Oe*s[3]+ro*s[4]+tl*s[5]+Tn*s[6]+as*s[7]+Zt*s[8]+Xc*s[11]+It*s[12]+Bs*s[10]+ui*s[9],console.log('survivorsDefenderRound2Total'+cc),
kl=$s*s[0]+bc*s[1]+He*s[2]+Ae*s[3]+Ji*s[4]+Fo*s[5]+on*s[6]+Hl*s[7]+Vt*s[8]+ti*s[9]+Ls*s[10]+Gc*s[11]+_t*s[12],Gl=cr*s[0]+yc*s[1]+at*s[2]+Oe*s[3]+ro*s[4]+tl*s[5]+Tn*s[6]+as*s[7]+Zt*s[8]+ui*s[9]+Bs*s[10]+Xc*s[11]+It*s[12],console.log('provisionDefenderRound3Total'+Gl),Ts=Hl*s[7]+Vt*s[8]+Gc*s[11]+ti*s[9],'cav'==Hi?(Al=Ji*s[4]+on*s[6]+Ts,Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10],_l=Ae*s[3]+Fo*s[5]):'inf'==Hi?(Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10]+Ts,Al=Ji*s[4]+on*s[6],_l=Ae*s[3]+Fo*s[5]):'arc'==Hi?(Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10],Al=Ji*s[4]+on*s[6],_l=Ae*s[3]+Fo*s[5]+Ts):(Sl=$s*s[0]+bc*s[1]+He*s[2]+_t*s[12]+Ls*s[10],Al=Ji*s[4]+on*s[6],_l=Ae*s[3]+Fo*s[5]),zo=0==Sl?0:Math.round(Sl/kl*1e4)/1e4,Co=0==Al?0:Math.round(Al/kl*1e4)/1e4,0==_l?(Mo=0,console.log('lossesPercentRound3Arc'+Mo)):(Mo=Math.round(_l/kl*1e4)/1e4,console.log('lossesPercentRound3Arc'+Mo)),br=Math.round(cr*zo),Tr=Math.round(cr*Co),mr=cr-Tr-br,Pc=Math.round(yc*zo),Nc=Math.round(yc*Co),Oc=yc-Nc-Pc,
ct=Math.round(at*zo),rt=Math.round(at*Co),st=at-rt-ct,Ue=Math.round(Oe*zo),De=Math.round(Oe*Co),ze=Oe-De-Ue,bo=Math.round(ro*zo),To=Math.round(ro*Co),mo=ro-To-bo,rl=Math.round(tl*zo),sl=Math.round(tl*Co),ll=tl-sl-rl,wn=Math.round(Tn*zo),An=Math.round(Tn*Co),fn=Tn-An-wn,cs=Math.round(as*zo),rs=Math.round(as*Co),ss=as-rs-cs,ia=Math.round(Zt*zo),na=Math.round(Zt*Co),aa=Zt-na-ia,js=Math.round(Bs*zo),Hs=Math.round(Bs*Co),Fs=Bs-Hs-js,nd=Math.round(Xc*zo),ad=Math.round(Xc*Co),td=Xc-ad-nd,Ct=Math.round(It*zo),Mt=Math.round(It*Co),Pt=It-Mt-Ct,_i=Math.round(ui*zo),Ei=Math.round(ui*Co),bi=ui-Ei-_i,zl=br*s[0]+Pc*s[1]+ct*s[2]+Ct*s[12]+js*s[10]+bo*s[4]+wn*s[6]+Ue*s[3]+rl*s[5]+cs*s[7]+ia*s[8]+nd*s[11]+_i*s[9],console.log('provisionDefenderInfRound3'+zl),Pl=Tr*s[0]+Nc*s[1]+rt*s[2]+Mt*s[12]+Hs*s[10]+To*s[4]+An*s[6]+De*s[3]+sl*s[5]+rs*s[7]+na*s[8]+ad*s[11]+Ei*s[9],console.log('provisionDefenderCavRound3'+Pl),
Ll=mr*s[0]+Oc*s[1]+st*s[2]+Pt*s[12]+Fs*s[10]+mo*s[4]+fn*s[6]+ze*s[3]+ll*s[5]+ss*s[7]+aa*s[8]+td*s[11]+bi*s[9],console.log('provisionDefenderArcRound3'+Ll),Hr=br*n[0]*Ba[0]+Pc*n[1]*Ya[0]+ct*n[2]*ba[0]+Ct*n[12]+js*n[10]+bo*n[4]*Ia[0]+wn*n[6]*Sa[0]+Ue*n[3]*pa[0]+rl*n[5]*Na[0]+cs*n[7]*za[0]+ia*n[8]*fa[0]+nd*n[11]+_i*n[9],qr=Tr*i[0]*Ba[0]+Nc*i[1]*Ya[0]+rt*i[2]*ba[0]+Mt*i[12]+Hs*i[10]+To*i[4]*Ia[0]+An*i[6]*Sa[0]+De*i[3]*pa[0]+sl*i[5]*Na[0]+rs*i[7]*za[0]+na*i[8]*fa[0]+ad*i[11]+Ei*i[9],Br=mr*o[0]*Ba[0]+Oc*o[1]*Ya[0]+st*o[2]*ba[0]+Pt*o[12]+Fs*o[10]+mo*o[4]*Ia[0]+fn*o[6]*Sa[0]+ze*o[3]*pa[0]+ll*o[5]*Na[0]+ss*o[7]*za[0]+aa*o[8]*fa[0]+td*o[11]+bi*o[9],_s=Hl*l[7]*Ri[1]+Vt*l[8]*Ai[1]+Gc*l[11]+ti*l[9],'cav'==Hi?(Mr=Ji*l[4]*vi[1]+on*l[6]*wi[1]+_s,Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10],Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]):'inf'==Hi?(Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10]+_s,Mr=Ji*l[4]*vi[1]+on*l[6]*wi[1],
Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]):'arc'==Hi?(Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10],Mr=Ji*l[4]*vi[1]+on*l[6]*wi[1],Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]+_s):(Dr=$s*l[0]*yi[1]+bc*l[1]*ki[1]+He*l[2]*fi[1]+_t*l[12]*Ka+Ls*l[10],Mr=Ji*l[4]*vi[1]+on*l[6]*wi[1],Or=Ae*l[3]*hi[1]+Fo*l[5]*Si[1]),tc=Hr*gl,Jr=qr*gl,Qr=Br*gl,Ir=(Rr=Dr*ml)+(wr=Mr*ml)+(hr=Or*ml),console.log('strengthAttackerRound3'+Ir),ic=tc+Jr+Qr,console.log('strengthDefenderRound3'+ic),Gi=0==Rr||0==tc?0:tc<=Rr?1:Math.pow(Rr/tc,.5)/(tc/Rr),Ui=0==wr||0==Jr?0:Jr<=wr?1:Math.pow(wr/Jr,.5)/(Jr/wr),Di=0==hr||0==Qr?0:Qr<=hr?1:Math.pow(hr/Qr,.5)/(Qr/hr),zi=0==Rr||0==tc?0:Rr<=tc?1:Math.pow(tc/Rr,.5)/(Rr/tc),Ci=0==wr||0==Jr?0:wr<=Jr?1:Math.pow(Jr/wr,.5)/(wr/Jr),Mi=0==hr||0==Qr?0:hr<=Qr?1:Math.pow(Qr/hr,.5)/(hr/Qr),Hn=Math.round(1e6*zi)/1e6,Fn=Math.round(1e6*Ci)/1e6,Yn=Math.round(1e6*Mi)/1e6,Qn=Math.round(1e6*Gi)/1e6,Kn=Math.round(1e6*Ui)/1e6,jn=Math.round(1e6*Di)/1e6,
ir=Math.round(-br*Qn+1e-6)+Math.round(-Tr*Kn+1e-6)+Math.round(-mr*jn+1e-6),Ac=Math.round(-Pc*Qn+1e-6)+Math.round(-Nc*Kn+1e-6)+Math.round(-Oc*jn+1e-6),Ze=Math.round(-ct*Qn+1e-6)+Math.round(-rt*Kn+1e-6)+Math.round(-st*jn+1e-6),ye=Math.round(-Ue*Qn+1e-6)+Math.round(-De*Kn+1e-6)+Math.round(-ze*jn+1e-6),no=Math.round(-bo*Qn+1e-6)+Math.round(-To*Kn+1e-6)+Math.round(-mo*jn+1e-6),Xo=Math.round(-rl*Qn+1e-6)+Math.round(-sl*Kn+1e-6)+Math.round(-ll*jn+1e-6),dn=Math.round(-wn*Qn+1e-6)+Math.round(-An*Kn+1e-6)+Math.round(-fn*jn+1e-6),Zl=Math.round(-cs*Qn+1e-6)+Math.round(-rs*Kn+1e-6)+Math.round(-ss*jn+1e-6),Ht=Math.round(-ia*Qn+1e-6)+Math.round(-na*Kn+1e-6)+Math.round(-aa*jn+1e-6),Fc=Math.round(-nd*Qn+1e-6)+Math.round(-ad*Kn+1e-6)+Math.round(-td*jn+1e-6),vt=Math.round(-Ct*Qn+1e-6)+Math.round(-Mt*Kn+1e-6)+Math.round(-Pt*jn+1e-6),li=Math.round(-_i*Qn+1e-6)+Math.round(-Ei*Kn+1e-6)+Math.round(-bi*jn+1e-6),Cs=Math.round(-js*Qn+1e-6)+Math.round(-Hs*Kn+1e-6)+Math.round(-Fs*jn+1e-6),
Zs=Math.round(-$s*Hn+1e-6),mc=Math.round(-bc*Hn+1e-6),Ye=Math.round(-He*Hn+1e-6),bt=Math.round(-_t*Hn+1e-6),he=Math.round(-Ae*Yn+1e-6),qo=Math.round(-Fo*Yn+1e-6),Xi=Math.round(-Ji*Fn+1e-6),an=Math.round(-on*Fn+1e-6),'cav'==Hi?(Yl=Math.round(-Hl*Fn+1e-6),Gt=Math.round(-Vt*Fn+1e-6),Dc=Math.round(-Gc*Fn+1e-6),$n=Math.round(-ti*Fn+1e-6)):'inf'==Hi?(Yl=Math.round(-Hl*Hn+1e-6),Gt=Math.round(-Vt*Hn+1e-6),Dc=Math.round(-Gc*Hn+1e-6),$n=Math.round(-ti*Hn+1e-6)):'arc'==Hi&&(Yl=Math.round(-Hl*Yn+1e-6),Gt=Math.round(-Vt*Yn+1e-6),Dc=Math.round(-Gc*Yn+1e-6),$n=Math.round(-ti*Yn+1e-6)),Is=100*Ls==Sl?0:Math.round(-Ls*Hn+1e-6),er=$s+Zs,Ec=bc+mc,je=He+Ye,we=Ae+he,$i=Ji+Xi,Ho=Fo+qo,ln=on+an,jl=Hl+Yl,Wt=Vt+Gt,Bc=Gc+Dc,ht=_t+bt,Os=Ls+Is,ai=ti+$n,gr=cr+ir,Lc=yc+Ac,lt=at+Ze,Ce=Oe+ye,go=ro+no,ol=tl+Xo,hn=Tn+dn,ls=as+Zl,ta=Zt+Ht,ed=Xc+Fc,Nt=It+vt,Ys=Bs+Cs,Ti=ui+li,So=Zs*s[0]+mc*s[1]+Ye*s[2]+he*s[3]+Xi*s[4]+qo*s[5]+an*s[6]+Yl*s[7]+Gt*s[8]+$n*s[9]+Is*s[10]+Dc*s[11]+bt*s[12],
console.log('lossesAttackerRound3Total'+So),ko=ir*s[0]+Ac*s[1]+Ze*s[2]+ye*s[3]+no*s[4]+Xo*s[5]+dn*s[6]+Zl*s[7]+Ht*s[8]+li*s[9]+Cs*s[10]+Fc*s[11]+vt*s[12],console.log('lossesDefenderRound3Total'+ko),sc=er*s[0]+Ec*s[1]+je*s[2]+we*s[3]+$i*s[4]+Ho*s[5]+ln*s[6]+jl*s[7]+Wt*s[8]+Bc*s[11]+ht*s[12]+Os*s[10]+ai*s[9],console.log('survivorsAttackerRound3Total'+sc),dc=gr*s[0]+Lc*s[1]+lt*s[2]+Ce*s[3]+go*s[4]+ol*s[5]+hn*s[6]+ls*s[7]+ta*s[8]+ed*s[11]+Nt*s[12]+Ys*s[10]+Ti*s[9],console.log('survivorsDefenderRound3Total'+dc),Ks=-N+er,uc=-M+Ec,Ve=-d+je,B=-r+we,ji=-w+$i,Bo=-R+Ho,$a=-E+ln,Vl=-I+jl,zt=-m+Wt,Mc=-z+Bc,gt=-p+ht,Rs=-L+Os,Xn=-h+ai,tr=-P+gr,_c=-C+Lc,Ke=-u+lt,ve=-c+Ce,eo=-v+go,jo=-y+ol,sn=-_+hn,Kl=-x+ls,qt=-T+ta,Wc=-D+ed,ft=-g+Nt,Ns=-O+Ys,ni=-f+Ti,gs=0==jl?0:jl*ml*On[1],Rn=20==ld?18:19==ld?17:18==ld?15:17==ld?14:16==ld?13:15==ld?11:14==ld?10:13==ld||12==ld?9:11==ld?8:10==ld?7:9==ld||8==ld?6:7==ld||6==ld?5:5==ld||4==ld||3==ld?4:2==ld||1==ld?3:0,ds=0==ut?0:2*Rn,us=0==gs||0==ds?0:-gs/ds,
Ja=ld<=Ss?ld:ld-Ss<-us?ld<Ss?ld:Ss:ld+us,G=Math.round(Ja),b='wall'==ca?G:parseInt(document.getElementById('buildingLevel').value),sa=0==Wt||0==b?0:Wt*ml*Ai[1],
vn='headquarter'==ca?30==b?72:29==b?65:28==b?59:27==b?54:26==b?50:25==b?45:24==b?41:23==b?36:22==b?33:21==b?30:20==b?27:19==b?26:18==b?23:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'wall'==ca?20==G?18:19==G?17:18==G?15:17==G?14:16==G?13:15==G?11:14==G?10:13==G||12==G?9:11==G?8:10==G?7:9==G||8==G?6:7==G||6==G?5:5==G||4==G||3==G?4:2==G||1==G?3:0:'tavern'==ca?15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'hospital'==ca?10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'satue'==ca?5==b||4==b||3==b?4:2==b||1==b?3:0:'rally_point'==ca?5==b||4==b||3==b?4:2==b||1==b?3:0:'church'==ca?3==b||2==b||1==b?800:0:'academy'==ca?1==b?500:0:'preceptory'==ca?10==b?71:9==b?43:8==b?39:7==b?35:6==b?32:5==b?29:4==b?27:3==b?24:2==b?22:1==b?20:0:'barracks'==ca?25==b?30:24==b?27:23==b?24:22==b?22:21==b?20:20==b?18:19==b?17:18==b?15:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'market'==ca?25==b?30:24==b?27:23==b?24:22==b?22:21==b?20:20==b?18:19==b?17:18==b?15:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'warehouse'==ca?30==b?48:29==b?43:28==b?39:27==b?36:26==b?33:25==b?30:24==b?27:23==b?24:22==b?22:21==b?20:20==b?18:19==b?17:18==b?15:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'timber_camp'==ca?30==b?48:29==b?43:28==b?39:27==b?36:26==b?33:25==b?30:24==b?27:23==b?24:22==b?22:21==b?20:20==b?18:19==b?17:18==b?15:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'clay_pit'==ca?30==b?48:29==b?43:28==b?39:27==b?36:26==b?33:25==b?30:24==b?27:23==b?24:22==b?22:21==b?20:20==b?18:19==b?17:18==b?15:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'iron_mine'==ca?30==b?48:29==b?43:28==b?39:27==b?36:26==b?33:25==b?30:24==b?27:23==b?24:22==b?22:21==b?20:20==b?18:19==b?17:18==b?15:17==b?14:16==b?13:15==b?11:14==b?10:13==b||12==b?9:11==b?8:10==b?7:9==b||8==b?6:7==b||6==b?5:5==b||4==b||3==b?4:2==b||1==b?3:0:'farm'==ca?30==b?79:29==b?72:28==b?66:27==b?60:26==b?54:25==b?49:24==b?45:23==b?41:22==b?37:21==b?34:20==b?31:19==b?28:18==b?25:17==b?23:16==b?21:15==b?19:14==b?17:13==b?16:12==b?14:11==b?13:10==b?12:9==b?11:8==b?10:7==b?9:6==b?8:5==b||4==b?7:2==b||3==b?6:1==b?5:0:0,
oa=0==b?0:vn*gl,la=0==sa||0==oa?0:-sa/oa,Za='wall'==ca?Ja<=Ss?Ja:Ja-Ss<-la?Ja<Ss?Ja:Ss:Ja+la:la+b<=0?0:la+b,re=Math.round(Za),Do=Ks*s[0]+uc*s[1]+Ve*s[2]+B*s[3]+ji*s[4]+Bo*s[5]+$a*s[6]+Vl*s[7]+zt*s[8]+Xn*s[9]+Rs*s[10]+Mc*s[11]+gt*s[12],Uo=tr*s[0]+_c*s[1]+Ke*s[2]+ve*s[3]+eo*s[4]+jo*s[5]+sn*s[6]+Kl*s[7]+qt*s[8]+ni*s[9]+Ns*s[10]+Wc*s[11]+ft*s[12],ue=tr*a[0]+_c*a[1]+Ke*a[2]+ve*a[3]+eo*a[4]+jo*a[5]+sn*a[6]+Kl*a[7]+qt*a[8]+ni*a[9]+Ns*a[10]+Wc*a[11]+ft*a[12],de=Ks*e[0]+uc*e[1]+Ve*e[2]+B*e[3]+ji*e[4]+Bo*e[5]+$a*e[6]+Vl*e[7]+zt*e[8]+Xn*e[9]+Rs*e[10]+Mc*e[11]+gt*e[12],me=0==Be||0==Do?0:Math.round(-Do/Be*1e3)/1e3,ge='inf'==Hi?'piechota':'cav'==Hi?'kawaleria':'łucznicy',pe='inf'==(pd=P+C+u+g>v+_&&P+C+u+g>c+y?'inf':v+_>P+C+u+g&&v+_>c+y?'cav':'arc')?'piechota':'cav'==pd?'kawaleria':'łucznicy',Te=0==da||0==Uo?0:Math.round(-Uo/da*1e3)/1e3,Q=Math.round(Ks*(cl+vs)),X=Math.round(uc*(cl+vs)),Z=Math.round(Ve*(cl+vs)),J=Math.round(B*(cl+vs)),ie=Math.round(ji*(cl+vs)),oe=Math.round(Bo*(cl+vs)),
le=Math.round($a*(cl+vs)),te=Math.round(Vl*(cl+vs)),ae=Math.round(zt*(cl+vs)),$=Math.round(Rs*(cl+vs)),ee=Math.round(Xn*(cl+vs)),ne=Math.round(Mc*(cl+vs)),se=Math.round(gt*(cl+vs)),gd=yn+ws,0==yn?(W=0,q=0,Y=0,F=0,H=0,j=0,K=0):yn<1e3?gd<=(ve+tr+_c+Ke)/2?(W=Math.round(tr/2),q=Math.round(_c/2),Y=Math.round(Ke/2),F=Math.round(ve/2),H=0,j=0,K=0):(W=Math.round(tr*gd/(ve+tr+_c+Ke)),q=Math.round(_c*gd/(ve+tr+_c+Ke)),Y=Math.round(Ke*gd/(ve+tr+_c+Ke)),F=Math.round(ve*gd/(ve+tr+_c+Ke)),H=0,j=0,K=0):gd<=(ve+tr+_c+Ke+4*eo+5*jo+6*sn)/2?(W=Math.round(tr/2),q=Math.round(_c/2),Y=Math.round(Ke/2),F=Math.round(ve/2),H=Math.round(eo/2),j=Math.round(jo/2),K=Math.round(sn/2)):(W=Math.round(tr*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn)),q=Math.round(_c*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn)),Y=Math.round(Ke*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn)),F=Math.round(ve*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn)),H=Math.round(eo*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn)),j=Math.round(jo*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn)),
K=Math.round(sn*gd/(ve+tr+_c+Ke+4*eo+5*jo+6*sn))),Ee=Be+Do,be=da+Uo},Oe.calculateT=function(){const e=A[t.TROOPS_SPEAR],a=A[t.TROOPS_SWORD],n=A[t.TROOPS_AXE],i=A[t.TROOPS_ARCHER],o=A[t.TROOPS_LC],l=A[t.TROOPS_MA],s=A[t.TROOPS_HC],r=A[t.TROOPS_RAM],c=A[t.TROOPS_CATAPULT],d=A[t.TROOPS_DOPPELSOLDNER],u=A[t.TROOPS_TREBUCHET],p=A[t.TROOPS_SNOB],g=A[t.TROOPS_KNIGHT],m=A[t.TROOPS_BARRACKS],T=A[t.TROOPS_PRECEPTORY],b=A[t.TROOPS_ORDER],E=A[t.TROOPS_TRAINING];var _=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],h=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],f=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],w=[1,1,1,1,4,5,6,5,8,1,100,10,6],v=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],S=[10,25,45,25,130,150,150,2,100,150,30,30,300],R=[25,55,10,10,30,40,200,20,100,250,100,200,100],y=[45,5,5,30,40,30,160,50,50,400,50,250,100],W=[10,30,10,60,30,50,180,20,100,150,100,200,50],q=[8,9,14,18,24,35,50,0],Y=[25,15,10,10,80,50,50,0,0,100,0,0,10],F=[0,33,66,99]
;let H=0,j=1,K=1,Q=1,X=1,Z=1,J=1,$=1,ee=1,te=0;var ae,ne,ie,oe;K=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,te='level_1'==E?1.04:'level_2'==E?1.08:'level_3'==E?1.12:'level_4'==E?1.16:'level_5'==E?1.2:1,X=1==T?1.01:2==T?1.02:3==T?1.03:4==T?1.04:5==T?1.05:6==T?1.06:7==T?1.07:8==T?1.08:9==T?1.09:10==T?1.1:1,Q=A[t.TROOPS_DOMINATION]?1.1:1,B=u>0?q[6]+' minut':p>0?q[5]+' minut':r>0||c>0?q[4]+' minuty':a>0?q[3]+' minut':e>0||n>0||i>0||d>0?q[2]+' minut':s>0?q[1]+' minut':o>0||l>0||g>0?q[0]+' minut':q[7]+' minut',G=m>=7&&m<14?F[1]:m>=14&&m<23?F[2]:m>=23?F[3]:F[0],J=j/(Q*te),Z=J/K,$=Z/X,ee=j/X,H='deff'==b?$*(e*v[0]+a*v[1]+i*v[3]+s*v[6])+ee*(u*v[11])+Z*(n*v[2]+o*v[4]+l*v[5]+r*v[7]+c*v[8])+d*v[12]+g*v[9]+p*v[10]:'off'==b?Z*(e*v[0]+a*v[1]+i*v[3]+s*v[6])+u*v[11]+$*(n*v[2]+o*v[4]+l*v[5]+r*v[7]+c*v[8])+ee*(d*v[12])+g*v[9]+p*v[10]:Z*(e*v[0]+a*v[1]+i*v[3]+s*v[6])+u*v[11]+Z*(n*v[2]+o*v[4]+l*v[5]+r*v[7]+c*v[8])+d*v[12]+g*v[9]+p*v[10],
k=e*_[0]+a*_[1]+n*_[2]+i*_[3]+o*_[4]+l*_[5]+s*_[6]+r*_[7]+c*_[8]+g*_[9]+p*_[10]+u*_[11]+d*_[12],I=e*h[0]+a*h[1]+n*h[2]+i*h[3]+o*h[4]+l*h[5]+s*h[6]+r*h[7]+c*h[8]+g*h[9]+p*h[10]+u*h[11]+d*h[12],x=e*f[0]+a*f[1]+n*f[2]+i*f[3]+o*f[4]+l*f[5]+s*f[6]+r*f[7]+c*f[8]+g*f[9]+p*f[10]+u*f[11]+d*f[12],L=e*w[0]+a*w[1]+n*w[2]+i*w[3]+o*w[4]+l*w[5]+s*w[6]+r*w[7]+c*w[8]+g*w[9]+p*w[10]+u*w[11]+d*w[12],U=e*S[0]+a*S[1]+n*S[2]+i*S[3]+o*S[4]+l*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+p*S[10]+u*S[11]+d*S[12],C=e*R[0]+a*R[1]+n*R[2]+i*R[3]+o*R[4]+l*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+p*R[10]+u*R[11]+d*R[12],z=e*y[0]+a*y[1]+n*y[2]+i*y[3]+o*y[4]+l*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+p*y[10]+u*y[11]+d*y[12],D=e*W[0]+a*W[1]+n*W[2]+i*W[3]+o*W[4]+l*W[5]+s*W[6]+r*W[7]+c*W[8]+g*W[9]+p*W[10]+u*W[11]+d*W[12],O=e*Y[0]+a*Y[1]+n*Y[2]+i*Y[3]+o*Y[4]+l*Y[5]+s*Y[6]+r*Y[7]+c*Y[8]+g*Y[9]+p*Y[10]+u*Y[11]+d*Y[12],console.log(H),ae=H,ne='',ie=new Date(1e3*ae).toISOString().substr(11,8),
(oe=Math.floor(ae/86400))>1?ne=oe+' dni i ':oe>0&&(ne='1 dzień i '),V=ne+=ie,N=e*S[0]+a*S[1]+n*S[2]+r*S[7]+c*S[8]+u*S[11]+d*S[12],P=o*S[4]+s*S[6]+g*S[9],M=i*S[3]+l*S[5],console.log(k,I,x,L,U,C,z,D,O,V,N,P,M,G,B)},Oe.start=function(){v=!0,h.trigger(s.BATTLE_CALCULATOR_START)},Oe.stop=function(){v=!1,h.trigger(s.BATTLE_CALCULATOR_STOP)},Oe.getSettings=function(){return f},Oe.isInitialized=function(){return w},Oe.isRunning=function(){return v},Oe.getBashpointsAtt=function(){return y},Oe.getBashpointsDef=function(){return R},Oe.getWoodAmount=function(){return k},Oe.getClayAmount=function(){return I},Oe.getIronAmount=function(){return x},Oe.getLoadAmount=function(){return O},Oe.getFoodAmount=function(){return L},Oe.getDefInf=function(){return C},Oe.getDefCav=function(){return z},Oe.getDefArc=function(){return D},Oe.getAttInf=function(){return N},Oe.getAttCav=function(){return P},Oe.getAttArc=function(){return M},Oe.getSpeed=function(){return B},Oe.getBuildTime=function(){return V},
Oe.getDiscipline=function(){return G},Oe.getPower=function(){return U},Oe.getTarget=function(){return ce},Oe.getBuildingfrom=function(){return null},Oe.getBuildingto=function(){return re},Oe.getWallfrom=function(){return null},Oe.getWallto=function(){return null},Oe.getWallfrompre=function(){return null},Oe.getWalltopre=function(){return null},Oe.getDefencemodifier=function(){return null},Oe.getDefenceprovisions=function(){return null},Oe.getStrentghdefend=function(){return null},Oe.getDefencebashpoint=function(){return de},Oe.getDefencekilledprovisions=function(){return null},Oe.getStrongesttypedef=function(){return pe},Oe.getKillrated=function(){return Te},Oe.getDefencesurvivedprovisions=function(){return be},Oe.getAvailablebeds=function(){return null},Oe.getAttackmodifier=function(){return null},Oe.getAttackprovisions=function(){return null},Oe.getStrentghattack=function(){return null},Oe.getAttackbashpoint=function(){return ue},Oe.getAttackkilledprovisions=function(){return null},
Oe.getStrongesttypeoff=function(){return ge},Oe.getKillratea=function(){return me},Oe.getAttacksurvivedprovisions=function(){return Ee},Oe.getDoublestrength=function(){return null},Oe.getSpeardAmount=function(){return null},Oe.getSpeardLosses=function(){return null},Oe.getSpeardRevived=function(){return W},Oe.getSpeardSurvived=function(){return null},Oe.getSworddAmount=function(){return null},Oe.getSworddLosses=function(){return null},Oe.getSworddRevived=function(){return q},Oe.getSworddSurvived=function(){return null},Oe.getAxedAmount=function(){return null},Oe.getAxedLosses=function(){return null},Oe.getAxedRevived=function(){return Y},Oe.getAxedSurvived=function(){return null},Oe.getArcherdAmount=function(){return null},Oe.getArcherdLosses=function(){return null},Oe.getArcherdRevived=function(){return F},Oe.getArcherdSurvived=function(){return null},Oe.getSnobdAmount=function(){return null},Oe.getSnobdLosses=function(){return null},Oe.getSnobdRevived=function(){return null},
Oe.getSnobdSurvived=function(){return null},Oe.getKnightdAmount=function(){return null},Oe.getKnightdLosses=function(){return null},Oe.getKnightdRevived=function(){return null},Oe.getKnightdSurvived=function(){return null},Oe.getRamdAmount=function(){return null},Oe.getRamdLosses=function(){return null},Oe.getRamdRevived=function(){return null},Oe.getRamdSurvived=function(){return null},Oe.getCatapultdAmount=function(){return null},Oe.getCatapultdLosses=function(){return null},Oe.getCatapultdRevived=function(){return null},Oe.getCatapultdSurvived=function(){return null},Oe.getTrebuchetdAmount=function(){return null},Oe.getTrebuchetdLosses=function(){return null},Oe.getTrebuchetdRevived=function(){return null},Oe.getTrebuchetdSurvived=function(){return null},Oe.getLcdAmount=function(){return null},Oe.getLcdLosses=function(){return null},Oe.getLcdRevived=function(){return H},Oe.getLcdSurvived=function(){return null},Oe.getMadAmount=function(){return null},Oe.getMadLosses=function(){
return null},Oe.getMadRevived=function(){return j},Oe.getMadSurvived=function(){return null},Oe.getHcdAmount=function(){return null},Oe.getHcdLosses=function(){return null},Oe.getHcdRevived=function(){return K},Oe.getHcdSurvived=function(){return null},Oe.getBerserkerdAmount=function(){return null},Oe.getBerserkerdLosses=function(){return null},Oe.getBerserkerdRevived=function(){return null},Oe.getBerserkerdSurvived=function(){return null},Oe.getSpearaAmount=function(){return null},Oe.getSpearaLosses=function(){return null},Oe.getSpearaRevived=function(){return Q},Oe.getSpearaSurvived=function(){return null},Oe.getSwordaAmount=function(){return null},Oe.getSwordaLosses=function(){return null},Oe.getSwordaRevived=function(){return X},Oe.getSwordaSurvived=function(){return null},Oe.getAxeaAmount=function(){return null},Oe.getAxeaLosses=function(){return null},Oe.getAxeaRevived=function(){return Z},Oe.getAxeaSurvived=function(){return null},Oe.getArcheraAmount=function(){return null},
Oe.getArcheraLosses=function(){return null},Oe.getArcheraRevived=function(){return J},Oe.getArcheraSurvived=function(){return null},Oe.getSnobaAmount=function(){return null},Oe.getSnobaLosses=function(){return null},Oe.getSnobaRevived=function(){return $},Oe.getSnobaSurvived=function(){return null},Oe.getKnightaAmount=function(){return null},Oe.getKnightaLosses=function(){return null},Oe.getKnightaRevived=function(){return ee},Oe.getKnightaSurvived=function(){return null},Oe.getRamaAmount=function(){return null},Oe.getRamaLosses=function(){return null},Oe.getRamaRevived=function(){return te},Oe.getRamaSurvived=function(){return null},Oe.getCatapultaAmount=function(){return null},Oe.getCatapultaLosses=function(){return null},Oe.getCatapultaRevived=function(){return ae},Oe.getCatapultaSurvived=function(){return null},Oe.getTrebuchetaAmount=function(){return null},Oe.getTrebuchetaLosses=function(){return null},Oe.getTrebuchetaRevived=function(){return ne},
Oe.getTrebuchetaSurvived=function(){return null},Oe.getLcaAmount=function(){return null},Oe.getLcaLosses=function(){return null},Oe.getLcaRevived=function(){return ie},Oe.getLcaSurvived=function(){return null},Oe.getMaaAmount=function(){return null},Oe.getMaaLosses=function(){return null},Oe.getMaaRevived=function(){return oe},Oe.getMaaSurvived=function(){return null},Oe.getHcaAmount=function(){return null},Oe.getHcaLosses=function(){return null},Oe.getHcaRevived=function(){return le},Oe.getHcaSurvived=function(){return null},Oe.getBerserkeraAmount=function(){return null},Oe.getBerserkeraLosses=function(){return null},Oe.getBerserkeraRevived=function(){return se},Oe.getBerserkeraSurvived=function(){return null},Oe})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u,p,g,m,T,b,E,_,h,f,A){let w,v,S,R=i.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){w.selectedTab=e},I=function(){t.isRunning()?t.stop():t.start()},x=function(){v.setAll(v.decode(w.settings)),t.calculateB();let e=t.getBashpointsAtt(),a=t.getBashpointsDef();e&&(w.totalAtt=e),a&&(w.totalDef=a)},L=function(){
v.setAll(v.decode(w.settings)),t.simulate()
;let e=t.getTarget(),a=t.getBuildingfrom(),n=t.getBuildingto(),i=t.getWallfrom(),o=t.getWallto(),l=t.getWallfrompre(),s=t.getWalltopre(),r=t.getDefencemodifier(),c=t.getDefenceprovisions(),d=t.getStrentghdefend(),u=t.getDefencebashpoint(),p=t.getDefencekilledprovisions(),g=t.getStrongesttypedef(),m=t.getKillrated(),T=t.getDefencesurvivedprovisions(),b=t.getAvailablebeds(),E=t.getAttackmodifier(),_=t.getAttackprovisions(),h=t.getStrentghattack(),f=t.getAttackbashpoint(),A=t.getAttackkilledprovisions(),S=t.getStrongesttypeoff(),R=t.getKillratea(),y=t.getAttacksurvivedprovisions(),k=t.getDoublestrength(),I=t.getSpeardAmount(),x=t.getSpeardLosses(),L=t.getSpeardRevived(),O=t.getSpeardSurvived(),N=t.getSworddAmount(),P=t.getSworddLosses(),M=t.getSworddRevived(),C=t.getSworddSurvived(),z=t.getAxedAmount(),D=t.getAxedLosses(),U=t.getAxedRevived(),G=t.getAxedSurvived(),B=t.getArcherdAmount(),V=t.getArcherdLosses(),W=t.getArcherdRevived(),q=t.getArcherdSurvived(),Y=t.getSnobdAmount(),F=t.getSnobdLosses(),H=t.getSnobdRevived(),j=t.getSnobdSurvived(),K=t.getKnightdAmount(),Q=t.getKnightdLosses(),X=t.getKnightdRevived(),Z=t.getKnightdSurvived(),J=t.getRamdAmount(),$=t.getRamdLosses(),ee=t.getRamdRevived(),te=t.getRamdSurvived(),ae=t.getCatapultdAmount(),ne=t.getCatapultdLosses(),ie=t.getCatapultdRevived(),oe=t.getCatapultdSurvived(),le=t.getTrebuchetdAmount(),se=t.getTrebuchetdLosses(),re=t.getTrebuchetdRevived(),ce=t.getTrebuchetdSurvived(),de=t.getLcdAmount(),ue=t.getLcdLosses(),pe=t.getLcdRevived(),ge=t.getLcdSurvived(),me=t.getMadAmount(),Te=t.getMadLosses(),be=t.getMadRevived(),Ee=t.getMadSurvived(),_e=t.getHcdAmount(),he=t.getHcdLosses(),fe=t.getHcdRevived(),Ae=t.getHcdSurvived(),we=t.getBerserkerdAmount(),ve=t.getBerserkerdLosses(),Se=t.getBerserkerdRevived(),Re=t.getBerserkerdSurvived(),ye=t.getSpearaAmount(),ke=t.getSpearaLosses(),Ie=t.getSpearaRevived(),xe=t.getSpearaSurvived(),Le=t.getSwordaAmount(),Oe=t.getSwordaLosses(),Ne=t.getSwordaRevived(),Pe=t.getSwordaSurvived(),Me=t.getAxeaAmount(),Ce=t.getAxeaLosses(),ze=t.getAxeaRevived(),De=t.getAxeaSurvived(),Ue=t.getArcheraAmount(),Ge=t.getArcheraLosses(),Be=t.getArcheraRevived(),Ve=t.getArcheraSurvived(),We=t.getSnobaAmount(),qe=t.getSnobaLosses(),Ye=t.getSnobaRevived(),Fe=t.getSnobaSurvived(),He=t.getKnightaAmount(),je=t.getKnightaLosses(),Ke=t.getKnightaRevived(),Qe=t.getKnightaSurvived(),Xe=t.getRamaAmount(),Ze=t.getRamaLosses(),Je=t.getRamaRevived(),$e=t.getRamaSurvived(),et=t.getCatapultaAmount(),tt=t.getCatapultaLosses(),at=t.getCatapultaRevived(),nt=t.getCatapultaSurvived(),it=t.getTrebuchetaAmount(),ot=t.getTrebuchetaLosses(),lt=t.getTrebuchetaRevived(),st=t.getTrebuchetaSurvived(),rt=t.getLcaAmount(),ct=t.getLcaLosses(),dt=t.getLcaRevived(),ut=t.getLcaSurvived(),pt=t.getMaaAmount(),gt=t.getMaaLosses(),mt=t.getMaaRevived(),Tt=t.getMaaSurvived(),bt=t.getHcaAmount(),Et=t.getHcaLosses(),_t=t.getHcaRevived(),ht=t.getHcaSurvived(),ft=t.getBerserkeraAmount(),At=t.getBerserkeraLosses(),wt=t.getBerserkeraRevived(),vt=t.getBerserkeraSurvived()
;w.spearDamount=I,w.spearDlosses=x,w.spearDrevived=L,w.spearDsurvived=O,w.swordDamount=N,w.swordDlosses=P,w.swordDrevived=M,w.swordDsurvived=C,w.axeDamount=z,w.axeDlosses=D,w.axeDrevived=U,w.axeDsurvived=G,w.archerDamount=B,w.archerDlosses=V,w.archerDrevived=W,w.archerDsurvived=q,w.snobDamount=Y,w.snobDlosses=F,w.snobDrevived=H,w.snobDsurvived=j,w.knightDamount=K,w.knightDlosses=Q,w.knightDrevived=X,w.knightDsurvived=Z,w.ramDamount=J,w.ramDlosses=$,w.ramDrevived=ee,w.ramDsurvived=te,w.catapultDamount=ae,w.catapultDlosses=ne,w.catapultDrevived=ie,w.catapultDsurvived=oe,w.trebuchetDamount=le,w.trebuchetDlosses=se,w.trebuchetDrevived=re,w.trebuchetDsurvived=ce,w.lcDamount=de,w.lcDlosses=ue,w.lcDrevived=pe,w.lcDsurvived=ge,w.maDamount=me,w.maDlosses=Te,w.maDrevived=be,w.maDsurvived=Ee,w.hcDamount=_e,w.hcDlosses=he,w.hcDrevived=fe,w.hcDsurvived=Ae,w.berserkerDamount=we,w.berserkerDlosses=ve,w.berserkerDrevived=Se,w.berserkerDsurvived=Re,w.spearAamount=ye,w.spearAlosses=ke,
w.spearArevived=Ie,w.spearAsurvived=xe,w.swordAamount=Le,w.swordAlosses=Oe,w.swordArevived=Ne,w.swordAsurvived=Pe,w.axeAamount=Me,w.axeAlosses=Ce,w.axeArevived=ze,w.axeAsurvived=De,w.archerAamount=Ue,w.archerAlosses=Ge,w.archerArevived=Be,w.archerAsurvived=Ve,w.snobAamount=We,w.snobAlosses=qe,w.snobArevived=Ye,w.snobAsurvived=Fe,w.knightAamount=He,w.knightAlosses=je,w.knightArevived=Ke,w.knightAsurvived=Qe,w.ramAamount=Xe,w.ramAlosses=Ze,w.ramArevived=Je,w.ramAsurvived=$e,w.catapultAamount=et,w.catapultAlosses=tt,w.catapultArevived=at,w.catapultAsurvived=nt,w.trebuchetAamount=it,w.trebuchetAlosses=ot,w.trebuchetArevived=lt,w.trebuchetAsurvived=st,w.lcAamount=rt,w.lcAlosses=ct,w.lcArevived=dt,w.lcAsurvived=ut,w.maAamount=pt,w.maAlosses=gt,w.maArevived=mt,w.maAsurvived=Tt,w.hcAamount=bt,w.hcAlosses=Et,w.hcArevived=_t,w.hcAsurvived=ht,w.berserkerAamount=ft,w.berserkerAlosses=At,w.berserkerArevived=wt,w.berserkerAsurvived=vt,e&&(w.target=e,w.buildingfrom=a,w.buildingto=n),i&&(w.wallfrom=i,
w.wallto=o),l&&(w.wallfrompre=l,w.walltopre=s),r&&(w.defenceModifier=r,w.defenceProvisions=c,w.strentghDefend=d,w.defenceBashpoint=u,w.defenceKilledProvisions=p,w.strongestTypeDef=g,w.killrateD=m,w.defenceSurvivedProvisions=T),E&&(w.attackModifier=E,w.attackProvisions=_,w.strentghAttack=h,w.attackBashpoint=f,w.attackKilledProvisions=A,w.strongestTypeOff=S,w.killrateA=R,w.attackSurvivedProvisions=y),k&&(w.doubleStrength=k),b&&(w.availableBeds=b)},O=function(){v.setAll(v.decode(w.settings)),t.calculateT();let e=t.getWoodAmount(),a=t.getClayAmount(),n=t.getIronAmount(),i=t.getLoadAmount(),o=t.getFoodAmount(),l=t.getDefInf(),s=t.getDefCav(),r=t.getDefArc(),c=t.getAttInf(),d=t.getAttCav(),u=t.getAttArc(),p=t.getSpeed(),g=t.getBuildTime(),m=t.getDiscipline(),T=t.getPower();e&&(w.woodTotal=e,w.speedTotal=p,w.attackTotal=T,w.clayTotal=a,w.disciplineTotal=m,w.definfTotal=l,w.ironTotal=n,w.loadTotal=i,w.defcavTotal=s,w.foodTotal=o,w.buildtimeTotal=g,w.defarcTotal=r,w.attackinfTotal=c,
w.attackcavTotal=d,w.attackarcTotal=u)},N=function(){w.presets=h.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},P=function(){w.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),A.notif('success','battleCalculator started')},M=function(){w.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),A.notif('success','battleCalculator stopped')},C=function(){w=a.$new(),w.SETTINGS=n,w.TAB_TYPES=y,w.running=t.isRunning(),w.selectedTab=y.BATTLE,w.settingsMap=o,w.catapulttarget=h.encodeList(d,{textObject:'battle_calculator',disabled:!0}),w.knightitem=h.encodeList(l,{textObject:'battle_calculator',disabled:!0}),w.itemlevel=h.encodeList(r,{textObject:'battle_calculator',disabled:!0}),w.order=h.encodeList(u,{textObject:'battle_calculator',disabled:!0}),w.wall=h.encodeList(p,{textObject:'battle_calculator',disabled:!0}),w.church=h.encodeList(g,{textObject:'battle_calculator',disabled:!0}),w.weaponmaster=h.encodeList(m,{textObject:'battle_calculator',
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,p,g,m,T,b,E,_){let h,f,A,w=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),R=!1,y=!1;const k={};let I,x,L,O,N,P=!0;const M='builder_queue_log',C='builder_queue_settings',z=function(){const e=U();if(!P)return F.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void G(t))}))},D=function(){U().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},U=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=I.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},G=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(k);const i=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),q(t))return!1;i.some((function(a){if(++n[a]>t[a])return w.compute(e),B(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const n=W(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=A[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},q=function(e){for(let t in e)if(e[t]<A[t])return!1;return!0},Y=function(e,t){let a={time:_.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),E.set(M,L),!0};let F={};return F.start=function(){if(!P)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,h=setInterval(z,6e4),f=setInterval(D,6e3),e((function(){U().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){y=!1,clearInterval(h),
clearInterval(f),b.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return y},F.isInitialized=function(){return R},F.getSettings=function(){return O},F.getLogs=function(){return L},F.clearLogs=function(){L=[],E.set(M,L),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=i.getGameData().getBuildings();for(let a=0;a<e.length;a++){let n=e[a];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){R=!0,L=E.get(M,[],!0),x=i.getSelectedCharacter(),I=i.getGroupList(),O=new n({settingsMap:c,storageKey:C}),O.onChange((function(e,t,a){N=O.getAll(),y&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,A=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);G(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a];Array.isArray(n)?(n.sort(()=>Math.random()-.5),t=t.concat(n)):t.push(n)}return t}
...
const A=Object.values(c),w=Object.values(a),v=Object.values(f),S=Object.values(h),R=Object.values(_);let y,k=[],I={},x=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===i.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),i=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!i.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+y},M=function(e){k.push(e)},C=function(e){I[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,k)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},U=function(e){return E.call(e,'x')&&E.call(e,'y')&&D(e.x)&&D(e.y)};let G={initialized:!1};return G.init=function(){y=t.getTimeOffset(),G.initialized=!0,x=b.get(d.QUEUE_SENT,[],!0),L=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?G.expireCommand(e,n.TIME_LIMIT):(M(e),C(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!P(e.sendTime))return!0;O?G.sendCommand(e):G.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&k.length&&(e.returnValue=!0)}))},G.sendCommand=function(e){const a=function(e){const a=i.getVillages()[e.origin.id];if(!a)return n.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=n.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return G.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),b.set(d.QUEUE_SENT,x),G.removeCommand(e,n.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},G.expireCommand=function(e,t){!function(e){L.push(e)}(e),b.set(d.QUEUE_EXPIRED,L),G.removeCommand(e,t)},G.addCommand=function(e,n,o,l,s,r,d,p){let m={},b={};return new Promise((function(E,y){if(!U(e))return y(u.INVALID_ORIGIN);if(!U(n))return y(u.INVALID_TARGET);if(!t.isValidDateTime(o))return y(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return y(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(b[t]=!0)})))return y(u.INVALID_OFFICER_TYPE)}return A.includes(d)?d!==c.RELOCATE||i.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[h.SUPPORTER]&&delete b[h.SUPPORTER],'string'!=typeof p||R.includes(p)?(p=!(d!==c.ATTACK||!m[f.CATAPULT])&&(p||_.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>T.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>T.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(i){if(e=i[0],n=i[1],!e)return y(u.INVALID_ORIGIN);if(!n)return y(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,n,m,d,b,!0),c=l===a.ARRIVE?s-r:s,T=l===a.ARRIVE?s:s+r;if(P(c))return y(u.ALREADY_SENT);const _={id:t.guid(),travelTime:r,arriveTime:T,sendTime:c,origin:e,target:n,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};M(_),C(_),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),E(_)})):y(u.INVALID_DATE_TYPE)):y(u.INVALID_CATAPULT_TARGET)):y(u.RELOCATE_DISABLED):y(u.INVALID_COMMAND_TYPE)}))},G.removeCommand=function(e,t){delete I[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),z(),!0}));if(a)switch(t){case n.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},G.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),L=[],x=[]},G.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},G.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},G.isRunning=function(){return O},G.getWaitingCommands=function(){return k},G.getWaitingCommandsObject=function(){return I},G.getSentCommands=function(){return x},
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,l,d,u,p,m,T,b,E,_,h,f){let A,w,v,S,R,y=i.getGameData(),k=y.getOrderedUnitNames(),I=y.getOrderedOfficerNames(),x=i.getPresetList(),L=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let P,M,C,z=[],D={},U={};const G={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){L=t.data},W=function(){L=!1},q=function(e){
const t=new Date(e||_.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),n=_.zerofill(a-a%100,3),i=_.zerofill(t.getSeconds(),2),l=_.zerofill(t.getMinutes(),2);return _.zerofill(t.getHours(),2)+':'+l+':'+i+':'+n+' '+_.zerofill(t.getDate(),2)+'/'+_.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),q(e+=t)):''},F=function(){if(A.isValidDate=o.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!A.isValidDate&&o.getTimeFromString(R.date),t=A.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(G,(function(n,i){const l=o.getTravelTime(R.origin,R.target,n,a,R.officers,!0);A.travelTimes[a][i].travelTime=g('readableMillisecondsFilter')(l),A.travelTimes[a][i].status=e?H(t?e-l:e):'neutral'}))}))},H=function(e){return e&&A.isValidDate?_.gameTime()+P<e?'valid':'invalid':'neutral'},j=function(){R.dateType=A.selectedDateType.value,f.set(m.LAST_DATE_TYPE,A.selectedDateType.value),F()},K=function(){
R.catapultTarget=A.catapultTarget.value},Q=function(){const e=A.selectedInsertPreset.value;if(!e)return!1;const t=i.getPresetList().getPresets()[e];A.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},R.units=angular.copy(t.units),R.officers=angular.copy(t.officers),t.catapult_target&&(R.catapultTarget=t.catapult_target,A.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},A.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=_.serverTime()+a.GAME_TIME_OFFSET,n=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=n-t}),_.timer.add(e.updateCountdown)},Z=function(){A.waitingCommands=t.getWaitingCommands()},J=function(){A.sentCommands=t.getSentCommands()},$=function(){A.expiredCommands=t.getExpiredCommands()},ee=function(){let e=A.waitingCommands;B.forEach((function(a){A.activeFilters[a]&&(e=t.filterCommands(a,A.filtersData,e))})),
A.visibleWaitingCommands=e},te=function(e){0===R.units[e]&&(R.units[e]='')},ae=function(e){''===R.units[e]&&(R.units[e]=0)},ne=function(){A.showCatapultSelect=!!R.units.catapult},ie=function(e){A.selectedTab=e},oe=function(){const e=i.getSelectedVillage().data;R.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:v.getId()}},le=function(){if(!L)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(L.x,L.y,1,1,(function(e){R.target=e}))},se=function(){R.date=q()},re=function(){if(!R.date)return!1;R.date=Y(R.date,100)},ce=function(){if(!R.date)return!1;R.date=Y(R.date,-100)},de=function(){R.units=angular.copy(D),R.officers=angular.copy(U),R.catapultTarget="wall",A.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},A.showCatapultSelect=!1},ue=function(e){t.addCommand(R.origin,R.target,R.date,R.dateType,R.units,R.officers,e,R.catapultTarget).then((function(e){Z(),ee(),X(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case T.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case T.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case T.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case T.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case T.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case T.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,n){return n&&(e=n+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},Te=function(e,t){A.activeFilters[e]=!A.activeFilters[e],
t&&(A.filtersData[u.ALLOWED_TYPES][e]=!A.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){A.activeFilters[u.TEXT_MATCH]=A.filtersData[u.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){A.presets=o.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,n){if('commandqueue_village_search'!==t)return!1;R[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},A.searchQuery[n]=''},removeCommand:function(e,t){_.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){_.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(A.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){A.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){R.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){R.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{_.timer.remove(e.updateCountdown)})}},_e=function(){const e=f.get(m.LAST_DATE_TYPE,l.OUT,!0);let T;A=a.$new(),A.selectedTab=N,A.inventory=i.getInventory(),A.presets=o.obj2selectOptions(x.getPresets()),A.travelTimes={},o.each(p,(function(e){A.travelTimes[e]={},o.each(G,(function(t,a){A.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),A.unitOrder=S,A.officers=y.getOrderedOfficerNames(),A.searchQuery={origin:'',target:''},A.isValidDate=!1,A.dateTypes=h.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),A.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},A.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},A.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},A.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},A.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},A.showCatapultSelect=!!R.units.catapult,A.attackableBuildings=z,A.commandData=R,
A.activeFilters=M,A.filtersData=C,A.running=t.isRunning(),A.waitingCommands=t.getWaitingCommands(),A.visibleWaitingCommands=t.getWaitingCommands(),A.sentCommands=t.getSentCommands(),A.expiredCommands=t.getExpiredCommands(),A.EVENT_CODES=d,A.FILTER_TYPES=u,A.TAB_TYPES=O,A.COMMAND_TYPES=p,A.relocateEnabled=i.getWorldConfig().isRelocateUnitsEnabled(),A.onUnitInputFocus=te,A.onUnitInputBlur=ae,A.catapultTargetVisibility=ne,A.selectTab=ie,A.addSelected=oe,A.addMapSelected=le,A.addCurrentDate=se,A.incrementDate=re,A.reduceDate=ce,A.cleanUnitInputs=de,A.addCommand=ue,A.clearRegisters=pe,A.switchCommandQueue=ge,A.removeCommand=t.removeCommand,A.openVillageInfo=r.openVillageInfo,A.toggleFilter=Te,A.$watch('commandData.origin',F),A.$watch('commandData.target',F),A.$watch('commandData.date',F),A.$watch('commandData.officers',F),A.$watch('selectedDateType.value',j),A.$watch('selectedInsertPreset.value',Q),A.$watch('catapultTarget.value',K),A.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',be),
A.$watch('selectedTab',(function(){A.selectedTab===O.ADD?T=setInterval((function(){F()}),2500):clearInterval(T)})),A.waitingCommands.forEach(e=>{X(e)});let b=new n('twoverflow_queue_window',(function(){clearInterval(T),Ee.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,Ee.updatePresets,!0),b.register(s.SELECT_SELECTED,Ee.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,Ee.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,Ee.sendCommand),b.register(s.COMMAND_QUEUE_START,Ee.start),b.register(s.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',A)};return function(){v=i.getSelectedCharacter(),P=o.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){D[e]=0})),I.forEach((function(e){U[e]=!1})),R={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(U),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},C={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',10),w.addEventListener('click',_e),b.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,W),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,n,r,c,d){let u,p,m,T,b,E=!1,_=!1,h=0;u=function(e){let t,a,n=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>n&&(n=a);return n},p=function(e,t){let a=i.getWorldConfig().getChurchBonus(),n=0
;return e<0||!t&&e>a.length-1?0:(n=t?i.getWorldConfig().getChapelBonus():a[e],Math.floor(100*n))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let f={init:function(){E=!0}};return f.start=function(){n.trigger(s.FAITH_CHECKER_STARTED),_=!0,i.getSelectedCharacter().getVillageList().forEach((function(n){let i=n.data.villageId,s=n.data.buildings.chapel.level,r=n.buildingQueue.data.queue,c=n.getResources().getComputed(),E=c.food,_=c.wood,f=c.clay,A=c.iron,w=E.currentStock,v=_.currentStock,S=f.currentStock,R=A.currentStock,y=[0,5e3],k=[160,16e3],I=[200,2e4],x=[50,5e3];1==s&&(h=1),m(i,(function(n){T=u(n.villages),b=p(T,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let n=t.building;'chapel'==n&&'church'==n||0!=h?'chapel'==n&&'church'==n||1!=h||(v>=k[1]&&S>=I[1]&&R>=x[1]&&w>=y[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:i,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):v>=k[0]&&S>=I[0]&&R>=x[0]&&w>=y[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:i,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==h?v>=k[1]&&S>=I[1]&&R>=x[1]&&w>=y[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:i,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):v>=k[0]&&S>=I[0]&&R>=x[0]&&w>=y[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:i,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},f.stop=function(){n.trigger(s.FAITH_CHECKER_STOPPED),_=!1},f.isRunning=function(){return _},f.isInitialized=function(){return E},f})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return o=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),i.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
i.register(s.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,n,i){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.FAITH_CHECKER_STARTED,(function(){n.set(o,!0)})),i.register(s.FAITH_CHECKER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c,d,u){let p,g,m=!1,T=!1,b=[],E=[],_=[],h=[],f=[];const A='fake_sender_settings',w={[c.SPEAR]:'spear',[c.SWORD]:'sword',[c.AXE]:'axe',
[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},v={[r.ATTACK]:'attack',[r.SUPPORT]:'support',[r.QUATTRO]:'four',[r.FULL]:'full'},S={[l.ARRIVE]:'date_type_arrive',[l.OUT]:'date_type_out'};console.log(w,v,S);const R=function(){b=[],E=[],_=[],h=[],f=[];const e=i.getGroupList().getGroups(),a=g[t.GROUP],n=g[t.GROUPP],o=g[t.GROUPT],l=g[t.GROUPG],s=g[t.GROUP_TARGET];a.forEach((function(t){b.push(e[t])})),n.forEach((function(t){E.push(e[t])})),o.forEach((function(t){_.push(e[t])})),l.forEach((function(t){h.push(e[t])})),s.forEach((function(t){f.push(e[t])}))},y={init:function(){m=!0,p=new e({settingsMap:n,storageKey:A}),p.onChange((function(e,t){g=p.getAll(),t[o.GROUPS]&&R()})),g=p.getAll(),console.log('fakeSender settings',g),a.$on(s.GROUPS_CREATED,R),a.$on(s.GROUPS_DESTROYED,R),
a.$on(s.GROUPS_UPDATED,R)},start:function(){T=!0,u.trigger(s.FAKE_SENDER_START)},stop:function(){T=!1,u.trigger(s.FAKE_SENDER_STOP)},getSettings:function(){return p},isInitialized:function(){return m},isRunning:function(){return T}};return y})),define('two/fakeSender/events',[],(function(){angular.extend(s,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u,p,m){let T,b,E,_=i.getGroupList();const h={FAKE:'fake',LOGS:'logs'},f=function(e){T.selectedTab=e},A=function(){b.setAll(b.decode(T.settings)),m.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},w=function(){t.isRunning()?t.stop():t.start()},v=function(){T.groups=u.encodeList(_.getGroups(),{disabled:!1,type:'groups'})
},S=function(){T.running=!0,E.classList.remove('btn-orange'),E.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},R=function(){T.running=!1,E.classList.remove('btn-red'),E.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},y=function(){T=a.$new(),T.SETTINGS=n,T.TAB_TYPES=h,T.running=t.isRunning(),T.selectedTab=h.FAKE,T.settingsMap=o,T.datetype=u.encodeList(l,{textObject:'fake_sender',disabled:!0}),T.type=u.encodeList(r,{textObject:'fake_sender',disabled:!0}),T.units=u.encodeList(d,{textObject:'fake_sender',disabled:!0}),b.injectScope(T),v(),T.selectTab=f,T.saveSettings=A,T.switchState=w;let e=new p('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.FAKE_SENDER_START,S),e.register(s.FAKE_SENDER_STOP,R),
c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',T)};return function(){b=t.getSettings(),e.addDivisor(21),E=e.addMenuButton('Watażka',20),E.addEventListener('click',y),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,p,g,m,T,_,h,f,A,w,v,S,R,y){let k,I,x,L,O,N=!1,P=!1,M=[],C=[],z=[],D=[],U=[],G=[],B=!1,V=!1,W=!1,q=0,Y=null,F=null,H=null,j={},K=f.gameTime(),Q=null,X=null;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===L.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ie=function(){!function(){const e=I[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ne(z)}(),function(){const e=I[r.GROUP_IGNORE];D=i.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];U=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!L.getVillage(e)})),U=U.concat(t)})),U=ne(U)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){E.call(x,e)||(x[e]={time:f.gameTime(),report:!1},t=!0)})),T.each(x,(function(a,n){n=parseInt(n,10),e.includes(n)||(delete x[n],t=!0)})),t&&(y.set($,x),A.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),A.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=I[r.GROUP_INCLUDE],n=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=L.getVillage(t.village_id);let l=!1;if(ie(),n===t.group_id&&(o?(ke(t.village_id),l=!0):(Le(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),i.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}l&&A.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=I[r.GROUP_INCLUDE],n=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=L.getVillage(t.village_id);let l=!1;if(ie(),n===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}else Oe(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),i.includes(t.group_id)&&o&&(ke(t.village_id),l=!0),l&&A.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=i.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],l=E.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=n.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));k.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ie(),ye(),Oe(),Re()},ce=function(){G=[];const e=i.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),G.push(a)})),G=G.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),G.length||(A.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===w.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(j[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===l.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},Te=function(e){x[e]={time:f.gameTime(),report:j[e]||!1},delete j[e],y.set($,x),A.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=f.gameTime(),t.type=e,C.unshift(t),Ee(),!0)},Ee=function(){const e=I[r.LOGS_LIMIT];C.length>e&&C.splice(C.length-e,C.length),y.set(Z,C),A.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},_e=function(e,t,a){const n=I[r.TARGET_MULTIPLE_FARMERS],i=I[r.TARGET_SINGLE_ATTACK];if(n&&a){if(i&&e)return!0}else if(i){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=f.gameTime()},fe=function(){clearTimeout(Y),clearTimeout(F),clearTimeout(H),Y=null,F=null,H=null
},Ae=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},ve=function(e){if(this.villageId=e,this.village=L.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=n.WAITING_CYCLE};ve.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{A.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},ve.prototype.start=function(){return he(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,A.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(A.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(A.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,A.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),fe(),this.onCycleEndFn(e),this.onCycleEndFn=b},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return a(n.USER_STOP);t()},T.randomSeconds(we())):t()}),_=()=>new Promise((e,a)=>{const i=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=i?a(n.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),i=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===i))return t(n.FULL_STORAGE)}e()
}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(n.NO_TARGETS)),k=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,i=>{if(te.points(i.points))return t(n.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},i=>{this.running?null!==a.character_id||null===i.owner_id||z.includes(a.id)?a.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),x=()=>new Promise((e,t)=>{!function(e,t){const a=i.getPresetList().getPresetsByVillageId(e);let n=[];if(G.forEach((function(e){E.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)E.call(a,e)&&n.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),O=()=>new Promise((e,t)=>{const i=this.village.getUnitInfo().getUnits(),o=60*I[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,a);T.each(G,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),N=()=>new Promise((e,i)=>{c=!1,p=L.getVillageList();const o=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),_e(u,c,o))return i(n.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const i=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(f.gameTime()/1e3),l=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),T=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,T,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const i=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=i.some(e=>e.start_village_id!==this.villageId),l=i.some(e=>e.start_village_id===this.villageId);if(_e(l,o,!0))return t(n.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{b().then(_).then(S).then(y).then(k).then(x).then(O).then(N).then(P).then(M).then(e).catch(t)}),D=new Promise((e,t)=>{H=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([C,D]).then(()=>{if(!this.running)return!1
;this.setStatus(n.ATTACKING),V=!0,W=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:w.TYPES.ATTACK})}).catch(t=>{switch(fe(),A.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case n.TIME_LIMIT:case n.BUSY_TARGET:case n.ABANDONED_CONQUERED:case n.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case n.USER_STOP:this.setStatus(t);break;case n.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Le(a.id),this.targetStep(e);break;case n.NO_UNITS:case n.NO_TARGETS:case n.FULL_STORAGE:case n.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case n.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case n.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(n.UNKNOWN),this.stop(n.UNKNOWN)}})},ve.prototype.setStatus=function(e){this.status=e},
ve.prototype.getStatus=function(){return this.status||n.UNKNOWN},ve.prototype.commandSent=function(e){V=!1,W=!1,fe(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},ve.prototype.commandError=function(){V=!1,W=!1,this.stop(n.COMMAND_ERROR)},ve.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},ve.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=h.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},ve.prototype.getTargets=function(){return this.targets},ve.prototype.getIndex=function(){return this.index},ve.prototype.getVillage=function(){return this.village},
ve.prototype.isRunning=function(){return this.running},ve.prototype.isInitialized=function(){return this.initialized},ve.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},ve.prototype.getId=function(){return this.villageId};const Se=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!U.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new ve(e),M.push(a)),a},Re=function(){T.each(L.getVillages(),(function(e,t){Se(t)})),A.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ye=function(){const e=I[r.GROUP_ONLY];let t=[];M.forEach((function(a){let n=a.getId();e.length&&!U.includes(n)?t.push(n):D.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){ke(e)})),A.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1
},Ie=function(e){he(),M.length?q>=M.length?(q=0,B=!1,X=f.gameTime()+Ae(),A.trigger(s.FARM_OVERFLOW_CYCLE_END)):B=M[q]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(q++,Ie())})),"cycle_begin"===e&&(X=null,A.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,q=0,X=null,A.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Ie()}),Ae())},xe=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Le=function(e){M.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,C=y.get(Z,[]),x=y.get($,{}),L=i.getSelectedCharacter(),O=i.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){I=k.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ie(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(ye(),Re()),t[p.LOGS]&&Ee(),t[p.INTERVAL_TIMERS]&&P&&(F?(fe(),
B.targetStep({delay:!0})):Y&&(fe(),A.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),q=0,Ie())))})),I=k.getAll(),se("ignore_update"),ie(),Re(),_((function(){ce()}),'presets'),_((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!P&&(G.length?(P=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Ie("cycle_begin")})),he(),function(){let e=Ae(),t=e+e/2+we();Q=setInterval((function(){f.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),A.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(A.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=n.USER_STOP){B?(B.stop(e),
...
define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/marketHelper/types/buildings','two/marketHelper/types/level','two/marketHelper/types/units','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c,d,u){let p,g,m=!1,T=!1,b=[];const E='market_helper_settings',_={[c.SPEAR]:'spear',[c.SWORD]:'sword',[c.AXE]:'axe',[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},h={[l.HEADQUARTER]:'headquarter',[l.WAREHOUSE]:'warehouse',[l.FARM]:'farm',[l.RALLY_POINT]:'rally_point',[l.STATUE]:'statue',[l.WALL]:'wall',[l.TAVERN]:'tavern',[l.BARRACKS]:'barracks',[l.PRECEPTORY]:'preceptory',[l.HOSPITAL]:'hospital',[l.CLAY_PIT]:'clay_pit',[l.IRON_MINE]:'iron_mine',[l.TIMBER_CAMP]:'timber_camp',
[l.CHAPEL]:'chapel',[l.CHURCH]:'church',[l.MARKET]:'market',[l.ACADEMY]:'academy'},f={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3,[r.LEVEL_4]:4,[r.LEVEL_5]:5,[r.LEVEL_6]:6,[r.LEVEL_7]:7,[r.LEVEL_8]:8,[r.LEVEL_9]:9,[r.LEVEL_10]:10,[r.LEVEL_11]:11,[r.LEVEL_12]:12,[r.LEVEL_13]:13,[r.LEVEL_14]:14,[r.LEVEL_15]:15,[r.LEVEL_16]:16,[r.LEVEL_17]:17,[r.LEVEL_18]:18,[r.LEVEL_19]:19,[r.LEVEL_20]:20,[r.LEVEL_21]:21,[r.LEVEL_22]:22,[r.LEVEL_23]:23,[r.LEVEL_24]:24,[r.LEVEL_25]:25,[r.LEVEL_26]:26,[r.LEVEL_27]:27,[r.LEVEL_28]:28,[r.LEVEL_29]:29,[r.LEVEL_30]:30};console.log(f,h,_);const A=function(){b=[];const e=i.getGroupList().getGroups();g[t.GROUPS].forEach((function(t){b.push(e[t])})),console.log('selectedGroups',b)},w={init:function(){m=!0,p=new e({settingsMap:n,storageKey:E}),p.onChange((function(e,t){g=p.getAll(),t[o.GROUPS]&&A()})),g=p.getAll(),console.log('marketHelper settings',g),a.$on(s.GROUPS_CREATED,A),a.$on(s.GROUPS_DESTROYED,A),a.$on(s.GROUPS_UPDATED,A)},start:function(){T=!0,
console.log('selectedGroups',b),u.trigger(s.MARKET_HELPER_START)},stop:function(){T=!1,console.log('marketHelper stop'),u.trigger(s.MARKET_HELPER_STOP)},getSettings:function(){return p},isInitialized:function(){return m},isRunning:function(){return T}};return w})),define('two/marketHelper/events',[],(function(){angular.extend(s,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/types/buildings','two/marketHelper/types/level','two/marketHelper/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u,p,g){let m,T,b,E=i.getGroupList();const _={TRADE:'trade',INSTANT_TRADE:'instant_trade',LOGS:'logs'},h=function(e){m.selectedTab=e},f=function(){T.setAll(T.decode(m.settings)),g.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()},w=function(){
t.isRunning()?t.stop():t.start()},v=function(){m.groups=u.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},S=function(){m.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),g.notif('success','marketHelper started')},R=function(){m.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),g.notif('success','marketHelper stopped')},y=function(){m=a.$new(),m.SETTINGS=n,m.TAB_TYPES=_,m.running=t.isRunning(),m.selectedTab=_.TRADE,m.settingsMap=o,m.level=u.encodeList(r,{textObject:'market_helper',disabled:!0}),m.units=u.encodeList(d,{textObject:'market_helper',disabled:!0}),m.buildings=u.encodeList(l,{textObject:'market_helper',disabled:!0}),T.injectScope(m),v(),m.selectTab=h,m.saveSettings=f,m.switchState=A,m.switchStateI=w;let e=new p('twoverflow_market_helper_window',(function(){console.log('marketHelper closed')}));e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,r,c,d,u,g,m,T,b,_,h,f,A,w,v){let S,R,y,k,I,x,L,O,N,P,M,C,z,D,U,G,B,V,W,q,Y,F,H,j=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/R)%2&&(t+=k),t-=t%R,a-=a%R,{x:Math.ceil((t-N.width/2)/R),y:Math.ceil((a-N.height/2)/R)}},be=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},Ee=function(){ve(I)},_e=function(){if(j){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),H[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*R-e.x,n=(t.y-2)*R-e.y;D.fillStyle=H[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,y),D.fillRect(0,n,y,1);const i=G.getBoundingClientRect(),l=i.width/w.TILESIZE.x/v.view.z*R,s=i.height/w.TILESIZE.y/v.view.z*R,r=a-l/2,c=n-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=H[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(_e)},he=function(){if(!ne)return!1;const e=Q.village[L][O];Ae(e?Q.character[e]:[[L,O]]),ne=!1,
m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:L,y:O})},fe=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t,H[o.COLOR_QUICK_HIGHLIGHT])},Ae=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t)},we=function(e){if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!H[o.SHOW_BARBARIANS]&&q.barbarian;if(e.character_id===V){if(e.id===x.getId()&&H[o.HIGHLIGHT_SELECTED])return q.selected;if(e.character_id in K.character)return K.character[e.character_id];if(H[o.HIGHLIGHT_OWN])return q.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&H[o.HIGHLIGHT_DIPLOMACY])return q.tribe;if(Y&&H[o.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return q.ally;if(Y.isEnemy(e.tribe_id))return q.enemy
;if(Y.isNAP(e.tribe_id))return q.friendly}}return q.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||we(n);if(!i)continue;const o=n.x*R+(n.y%2?k:0),l=n.y*R;C.fillStyle=i,C.fillRect(o,l,S,S)}},Se=function(){S=oe[H[o.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,M.width=1e3*R,M.height=1e3*R,C.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,n=O,b.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(H[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id},f.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({
type:'tribe',id:e.tribe_id},f.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!H[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(L===e.x&&O===e.y)return!1;he()}ne=!0,L=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:L,y:O,event:t});const a=Q.village[L][O];fe(a?Q.character[a]:[[L,O]])}(pe,e)}he()},xe=function(){ne&&he(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(A.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(A.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?A.PLAYER_COLORS:A.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t];const n='character'===e?A.PLAYER_COLORS:A.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e]),
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=H[o.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),n=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return F},Me.drawMinimap=function(){ge&&(ge=!1),N.style.background=H[o.COLOR_BACKGROUND],C.clearRect(0,0,M.width,M.height),d((function(){!function(){
const e=h.getPath(w.getMapPath()),t=H[o.SHOW_CONTINENT_DEMARCATIONS],a=H[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){C.fillStyle=H[o.COLOR_CONTINENT],C.fillRect(e*R+k-1,t*R+k-1,3,1),C.fillRect(e*R+k,t*R+k-2,1,3)},i=function(e,t){C.fillStyle=H[o.COLOR_PROVINCE],C.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=_.toTile(o,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&i(e,l))}const r=l.a*R,c=s.a*R,d=(l.b-l.a)*R,u=(s.b-s.a)*R;C.beginPath(),C.lineWidth=2,C.strokeStyle="#2B4700",C.rect(r,c,d,u),C.stroke()}))}(),Ee()}),'minimap_data')},Me.enableRendering=function(){j=!0},Me.disableRendering=function(){j=!1},Me.isFirstDraw=function(){return!!ge},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),C=M.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ie}),F.onChange((function(e,t){H=F.getAll(),
Se(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),H=F.getAll(),K.tribe=le.getCustomColorsByGroup(A.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(A.PLAYER_COLORS)||{},Se()},Me.run=function(){d((function(){G=document.getElementById('map'),U=document.getElementById('main-canvas'),B=i.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),q=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),Re(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*R,ee.y=x.getY()*R,e.addEventListener('resize',Re,!1),z.addEventListener('mousedown',ye),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),_e(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,Ee),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,T,b,E,_,h,f,A){let w,v,S,R,y,k,I,x,L,O,N,P={},M=!1,C={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,U=function(e){w.selectedTab=e,e===z.MINIMAP?i.enableRendering():i.disableRendering()},G=function(){Object.keys(w.highlights.character).forEach((function(e){e in C.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
C.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in C.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){C.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!L)return;let a=B(t.x,t.y);var n,i;O=a,P[a]=!0,M=!0,(n=t.x,i=t.y,new Promise((function(e){let t=h.getTownAt(n,i);if(t)return e(t);h.loadTownDataAsync(n,i,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!M)return;I.appendChild(L),L.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=L.getBoundingClientRect(),n=I.getBoundingClientRect(),i=a.width+50,o=a.height+50,l=k.tt.position.y+o>n.top+n.height,s=k.tt.position.x+i>n.width;l&&(k.tt.position.y-=50),L.classList.toggle('left',s),L.classList.toggle('top',l)}))},W=function(e,t){if(!L)return;let a=t?B(t):O;P[a]=!1,M=!1,k.tt.visible=!1,L.classList.add('ng-hide'),x.appendChild(L)},q=function(e,t,n){let o,l,s=a.$new(),r=!0;s.colorPalettes=A.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][n],s.submit=function(){i.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},Y=function(){i.addHighlight(w.selectedHighlight,w.addHighlightColor)},F=function(){N.setAll(N.decode(w.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},H=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},j=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){G()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+f.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=z,w.selectedTab=D,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=i.getHighlights(),w.highlightNames=C,w.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=U,w.openColorPalette=q,w.addCustomHighlight=Y,w.removeHighlight=i.removeHighlight,w.saveSettings=F,w.resetSettings=H,w.highlightsCount=j,w.openProfile=K,N.injectScope(w,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){i.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
...
[o.LEVEL_10]:50,[o.LEVEL_11]:55,[o.LEVEL_12]:60,[o.LEVEL_13]:65,[o.LEVEL_14]:70,[o.LEVEL_15]:75,[o.LEVEL_16]:80,[o.LEVEL_17]:85,[o.LEVEL_18]:90,[o.LEVEL_19]:95,[o.LEVEL_20]:100};console.log(m,T);const b={init:function(){u=!0,c=new e({settingsMap:a,storageKey:g}),c.onChange((function(){d=c.getAll()})),d=c.getAll(),console.log('powerHelper settings',d)},start:function(){p=!0,r.trigger(s.POWER_HELPER_START)},stop:function(){p=!1,console.log('powerHelper stop'),r.trigger(s.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return b})),define('two/powerHelper/events',[],(function(){angular.extend(s,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/types/ironwalls','two/powerHelper/types/wall','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,o,l,r,d,u){let p,g,m;const T={POWERS:'powers',BUNKER:'bunker',BEATBUNKER:'beatbunker'},b=function(e){p.selectedTab=e},E=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},h=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},f=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),u.notif('success','Example module stopped')},A=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.POWERS,p.settingsMap=i,p.wall=r.encodeList(l,{textObject:'battle_calculator',disabled:!0}),p.ironwalls=r.encodeList(o,{textObject:'battle_calculator',disabled:!0
}),g.injectScope(p),p.selectTab=b,p.saveSettings=E,p.switchState=_;let e=new d('twoverflow_power_helper_window',(function(){console.log('powerHelper closed')}));e.register(s.POWER_HELPER_START,h),e.register(s.POWER_HELPER_STOP,f),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton4('Bunkry',20),m.addEventListener('click',A),
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c){let d,u,p=!1,g=!1,m=[];const T='prank_helper_settings',b={[l.INCREASE]:'increase',[l.DECREASE]:'decrease',[l.RANDOM]:'random'};console.log(b);const E=function(){m=[];const e=i.getGroupList().getGroups();u[t.GROUPS].forEach((function(t){m.push(e[t])}))},_={init:function(){p=!0,d=new e({settingsMap:n,storageKey:T}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&E()})),u=d.getAll(),console.log('all settings',u),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){g=!0,c.trigger(s.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(s.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return _})),define('two/prankHelper/events',[],(function(){angular.extend(s,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u){let p,g,m,T=i.getGroupList();const b={RENAME:'rename',LOGS:'logs'},E=function(e){p.selectedTab=e},_=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},f=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},w=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
u.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.RENAME,p.settingsMap=o,p.type=r.encodeList(l,{textObject:'prank_helper',disabled:!0}),g.injectScope(p),f(),p.selectTab=E,p.saveSettings=_,p.switchState=h;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(s.GROUPS_CREATED,f,!0),e.register(s.GROUPS_DESTROYED,f,!0),e.register(s.GROUPS_UPDATED,f,!0),e.register(s.PRANK_HELPER_START,A),e.register(s.PRANK_HELPER_STOP,w),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',80),m.addEventListener('click',v),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r){let c,d,u=!1,p=!1,g=[],m=[],T=[],b=[];const E='preset_asigner_settings',_=function(){g=[],m=[];const e=i.getPresetList().getPresets(),a=d[t.PRESETS1],n=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),n.forEach((function(t){m.push(e[t])}))},h=function(){T=[],b=[];const e=i.getGroupList().getGroups(),a=d[t.GROUP1],n=d[t.GROUP2];a.forEach((function(t){T.push(e[t])})),n.forEach((function(t){b.push(e[t])}))},f={init:function(){u=!0,c=new e({settingsMap:n,storageKey:E}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&_(),t[o.GROUPS]&&h()})),d=c.getAll(),console.log('presetAsigner settings',d),l((function(){_()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,_),a.$on(s.ARMY_PRESET_DELETED,_),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){p=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d){let u,p,g,m=i.getPresetList(),T=i.getGroupList();const b={PRESETS:'presets',LOGS:'logs'},E=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()
},f=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},A=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.PRESETS,u.settingsMap=o,p.injectScope(u),f(),A(),u.selectTab=E,u.saveSettings=_,u.switchState=h;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,f,!0),e.register(s.ARMY_PRESET_DELETED,f,!0),e.register(s.GROUPS_CREATED,A,!0),e.register(s.GROUPS_DESTROYED,A,!0),e.register(s.GROUPS_UPDATED,A,!0),e.register(s.PRESET_ASIGNER_START,w),e.register(s.PRESET_ASIGNER_STOP,v),
...
officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:1,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (lk)',icon:y,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:1,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (łk)',icon:k,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:1,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (ck)',icon:I,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:1,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (tar)',icon:x,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (kat)',icon:L,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (treb)',icon:O,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,
mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (tar)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (kat)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,
trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),C.stop()},C.stop=function(){e.trigger(s.PRESET_CREATOR_STOPPED),r=!1},C.isRunning=function(){return r},C.isInitialized=function(){return n},C})),define('two/presetCreator/events',[],(function(){angular.extend(s,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,n,i){let o;return function(){return e.addDivisor(41),o=e.addMenuButton3('Wojewoda',40,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'preset_creator')))})),
i.register(s.PRESET_CREATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),i.register(s.PRESET_CREATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,a,n,i){const o='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(o,!1,!0)&&t.start(),i.register(s.PRESET_CREATOR_STARTED,(function(){n.set(o,!0)})),i.register(s.PRESET_CREATOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r,c){
let d,u,p=!1,g=!1,m=[],T=[],b=[],E=[],_=[],h=[],f=[],A=[],w=[],v=[],S=[],R=[],y=[],k=[],I=[],x=[],L=[],O=[],N=[],P=[],M=[],C=[],z=[],D=[],U=[],G=[],B=[],V=[],W=[],q=[],Y=[],F=[];const H='recruit_queue_settings',j={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(j);const K=function(){m=[],T=[],b=[],E=[],_=[],h=[],f=[],A=[];const e=i.getPresetList().getPresets(),a=u[t.PRESET1],n=u[t.PRESET2],o=u[t.PRESET3],l=u[t.PRESET4],s=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){T.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){E.push(e[t])})),s.forEach((function(t){_.push(e[t])})),r.forEach((function(t){
h.push(e[t])})),c.forEach((function(t){f.push(e[t])})),d.forEach((function(t){A.push(e[t])}))},Q=function(){w=[],v=[],S=[],R=[],y=[],k=[],I=[],x=[],L=[],O=[],N=[],P=[],M=[],C=[],z=[],D=[],U=[],G=[],B=[],V=[],W=[],q=[],Y=[],F=[];const e=i.getGroupList().getGroups(),a=u[t.GROUP1],n=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4],s=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],b=u[t.GROUP13],E=u[t.GROUP14],_=u[t.GROUP15],h=u[t.GROUP16],f=u[t.GROUP17],A=u[t.GROUP18],H=u[t.GROUP19],j=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){w.push(e[t])})),n.forEach((function(t){v.push(e[t])})),o.forEach((function(t){S.push(e[t])})),l.forEach((function(t){R.push(e[t])})),s.forEach((function(t){y.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){x.push(e[t])})),p.forEach((function(t){L.push(e[t])})),g.forEach((function(t){
O.push(e[t])})),m.forEach((function(t){N.push(e[t])})),T.forEach((function(t){P.push(e[t])})),b.forEach((function(t){M.push(e[t])})),E.forEach((function(t){C.push(e[t])})),_.forEach((function(t){z.push(e[t])})),h.forEach((function(t){D.push(e[t])})),f.forEach((function(t){U.push(e[t])})),A.forEach((function(t){G.push(e[t])})),H.forEach((function(t){B.push(e[t])})),j.forEach((function(t){V.push(e[t])})),K.forEach((function(t){W.push(e[t])})),Q.forEach((function(t){q.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:n,storageKey:H}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('recruitQueue settings',u),r((function(){K()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,K),a.$on(s.ARMY_PRESET_DELETED,K),a.$on(s.GROUPS_CREATED,Q),a.$on(s.GROUPS_DESTROYED,Q),a.$on(s.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(s.recruit_queue_START)},stop:function(){
g=!1,c.trigger(s.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d,u){let p,m,T,b=i.getPresetList(),E=i.getGroupList();const _={PRESETS:'presets',OWN:'own',LOGS:'logs'},h=function(e){p.selectedTab=e},f=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()},w=function(){p.presets=r.encodeList(b.getPresets(),{disabled:!1,type:'presets'})},v=function(){p.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},S=function(){p.running=!0,
T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},R=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},y=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=_,p.running=t.isRunning(),p.selectedTab=_.PRESETS,p.settingsMap=o,p.units=r.encodeList(l,{textObject:'recruit_queue',disabled:!0}),m.injectScope(p),w(),v(),p.selectTab=h,p.saveSettings=f,p.switchState=A;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed')}));e.register(s.ARMY_PRESET_UPDATE,w,!0),e.register(s.ARMY_PRESET_DELETED,w,!0),e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.recruit_queue_START,S),e.register(s.recruit_queue_STOP,R),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',p)};return function(){
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/reportHelper/types/type','two/reportHelper/types/result','two/reportHelper/types/sort','two/ready','queues/EventQueue'],(function(e,t,a,n,i,o,l,r,c){let d,u,p=!1,g=!1;const m='report_helper_settings',T={[i.ATTACK]:'attack',[i.DEFENSE]:'defense',[i.SUPPORT_IN]:'support_in',[i.SUPPORT_OUT]:'support_out',[i.TRADE]:'trade',[i.SPY_IN]:'spy_in',[i.SPY_OUT]:'spy_out',[i.ACHIEVEMENTS]:'achievements',[i.SYSTEM]:'system'},b={[o.WIN]:'win',[o.LOSSES]:'losses',[o.DEFEAT]:'defeat'},E={[l.ALL]:'all',[l.FARM]:'farm',[l.FAKE]:'fake',[l.FAVOURITE]:'favourite',[l.WITHOUT_FAVOURITE]:'without_favourite',[l.FARM_FAKE]:'farm_fake'};console.log(b,E,T);const _={init:function(){p=!0,d=new e({settingsMap:a,storageKey:m}),d.onChange((function(){u=d.getAll()})),u=d.getAll(),
console.log('reportHelper settings',u)},start:function(){g=!0,c.trigger(s.REPORT_HELPER_START)},stop:function(){g=!1,console.log('reportHelper stop'),c.trigger(s.REPORT_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return _})),define('two/reportHelper/events',[],(function(){angular.extend(s,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/types/type','two/reportHelper/types/result','two/reportHelper/types/sort','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,o,l,r,d,u,p){let g,m,T;const b={REPORTS:'reports',LOGS:'logs'},E=function(e){g.selectedTab=e},_=function(){m.setAll(m.decode(g.settings)),p.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},f=function(){g.running=!0,
T.classList.remove('btn-orange'),T.classList.add('btn-red'),p.notif('success','Example module started')},A=function(){g.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),p.notif('success','Example module stopped')},w=function(){g=a.$new(),g.SETTINGS=n,g.TAB_TYPES=b,g.running=t.isRunning(),g.selectedTab=b.REPORTS,g.settingsMap=i,g.type=d.encodeList(o,{textObject:'report_helper',disabled:!0}),g.result=d.encodeList(l,{textObject:'report_helper',disabled:!0}),g.sort=d.encodeList(r,{textObject:'report_helper',disabled:!0}),m.injectScope(g),g.selectTab=E,g.saveSettings=_,g.switchState=h;let e=new u('twoverflow_report_helper_window',(function(){console.log('reportHelper window closed')}));e.register(s.REPORT_HELPER_START,f),e.register(s.REPORT_HELPER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',g)};return function(){m=t.getSettings(),T=e.addMenuButton3('Skryba',90),T.addEventListener('click',w),
...
offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},E))})),setTimeout(m,3e4)},T=function(e){var t,i,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,T=g(m),b=e.ReportScouting,E=b.attCharacterId,_=b.attCharacterName,h=b.attScouts,f=b.attLosses,A=b.attVillageId,w=b.attVillageName,v=b.defCharacterId,S=b.defCharacterName,R=b.defLosses,y=b.defScouts,k=b.defVillageId,I=b.defVillageName,x=b.commandType,L='',O='',N='',P='',M=Date.now(),C=p.split('.').join('_');2==u?L=' [color=d96a19]Częściowy sukces[/color]':1==u?L=' [color=0a8028]Sukces[/color]':3==u&&(L=' [color=e21f1f]Porażka[/color]'),
O='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',i=null==y?'nieznana':y,s=null==h?'nieznana':h,r=null==R?'nieznana':R,c=null==f?'nieznana':f,P=null==_&&null==E?'Brak danych':'[player='+E+']'+_+'[/player]',N=null==w&&null==A?'Brak danych':'[village='+A+']'+w+'[/village]',t=Math.floor(M/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+C+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+I+'[/village][b] Gracz cel: [/b][player='+v+']'+S+'[/player][br]Liczba szpiegów: [b]'+i+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();v!=a?t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),
d=[]):t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){var t,a=[],i=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,b=d.attEffects,E=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var h=[],f=[];b.forEach((function(e){var t=e.type,a=0,n=0,i=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,h.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,h.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),
'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var A=h.join();E.forEach((function(e){var t=e.type,a=0,n=0,i=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,f.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,f.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,
f.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}))
...
'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var A=h.join();E.forEach((function(e){var t=e.type,a=0,n=0,i=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,f.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,f.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,f.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
...
isRunning:function(){return u}};return T})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,o,l,r,d,u){let p,m,T;const b={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},E=function(e){p.selectedTab=e},_=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},f=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},A=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},w=function(){p=a.$new(),
p.SETTINGS=n,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.SPY,p.settingsMap=i,p.building=r.encodeList(o,{textObject:'spy_master',disabled:!0}),p.unit=r.encodeList(l,{textObject:'spy_master',disabled:!0}),m.injectScope(p),p.selectTab=E,p.saveSettings=_,p.switchState=h;let e=new d('twoverflow_spy_master_window',(function(){console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,f),e.register(s.SPY_MASTER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton3('Zwiadowca',10),T.addEventListener('click',w),
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,o,l,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',b=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},E=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},_={init:function(){u=!0,c=new e({settingsMap:n,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('supportSender settings',d),l((function(){b()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,b),a.$on(s.ARMY_PRESET_DELETED,b),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.SUPPORT_SENDER_START)},stop:function(){p=!1,
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,l,r,d){let u,p,g,m=i.getPresetList(),T=i.getGroupList();const b={SUPPORT:'support',LOGS:'logs'},E=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},f=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},A=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SUPPORT,u.settingsMap=o,p.injectScope(u),f(),A(),u.selectTab=E,u.saveSettings=_,u.switchState=h;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,f,!0),e.register(s.ARMY_PRESET_DELETED,f,!0),e.register(s.GROUPS_CREATED,A,!0),e.register(s.GROUPS_DESTROYED,A,!0),e.register(s.GROUPS_UPDATED,A,!0),e.register(s.SUPPORT_SENDER_START,w),e.register(s.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',S),
