...
KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,r,c,d,u,p,g,m,b,T,_){let E,A,h=!1,f=injector.get('overviewService'),w=[],v=!1,S={},R={},y={reverse:!1,column:n.TIME_COMPLETED};const k='attack_view_filters',L={},I={},x=function(){const e=[c.COMMAND_TYPES],t=i.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let n in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?a[e[t]].push(r.ATTACK):n===r.SUPPORT?a[e[t]].push(r.SUPPORT):n===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}R=a,
R.village=S[c.VILLAGE]?[t]:[]},O=function(){G.loadCommands()},N=function(e,t){_.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<w.length;e++)w[e].command_id===t.command_id&&w.splice(e,1);_.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<w.length;e++)w[e].target_village_id===t.village_id?(w[e].target_village_name=t.name,w[e].targetVillage.name=t.name):w[e].origin_village_id===t.village_id&&(w[e].origin_village_name=t.name,w[e].originVillage.name=t.name);_.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},C=function(e,t){R[c.VILLAGE].length&&(R[c.VILLAGE]=[t],G.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(i){const l=t.getTravelTime(a,n,{[i]:1},e.command_type,{},!1);return{unit:i,diff:Math.abs(l-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){
return m.actualDistance(t,e)-m.actualDistance(t,a)}))},B=function(e,t){let a=0;if(T.hasTownDataInChunk(e.x,e.y)){const a=T.loadTownData(e.x,e.y,25,25,25),n=i.getSelectedCharacter().getTribeId(),l=i.getSelectedCharacter().getId();let o,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===l&&e.id!==t.id}));if(r.length)o=D(r,e);else if(c.length)o=D(c,e);else{if(!n)return t(!1);{const a=s.filter((function(e){return e.tribe_id===n}));if(!a.length)return t(!1);o=D(a,e)}}return t(o[0])}const n=b.scaledGridCoordinates(e.x,e.y,25,25,25);T.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===n.length&&B(e,t)}))},U=function(e){w=e.commands;for(let e=0;e<w.length;e++)f.formatCommand(w[e]),w[e].slowestUnit=z(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),_.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[w])};let G={
loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;l.emit(o.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:R[c.COMMAND_TYPES],villages:R[c.VILLAGE]},U)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return y},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],x(),g.set(k,S),G.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),G.loadCommands()},setCommander:function(e,a){B(e.targetVillage,(function(n){const i=e.targetVillage,l=n,o=l.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),v.addCommand(i,l,a,A.OUT,s,{},o,p.WALL),v.isRunning()||v.start()}))},commandQueueEnabled:function(){return!!v},isInitialized:function(){return h},init:function(){for(let e=0;e<d.length;e++)L[d[e]]=!0;for(let e in r)I[r[e]]=!0;try{v=require('two/commandQueue'),
A=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(I),[c.INCOMING_UNITS]:angular.copy(L),[c.VILLAGE]:!1};h=!0,E=i.getSelectedCharacter().getGlobalInfo(),S=g.get(k,t,!0),e((function(){x(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,C),a.$on(s.VILLAGE_NAME_CHANGED,M),a.$on(s.COMMAND_IGNORED,P),G.loadCommands()}),['initial_village'])}};return G})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,l,o,d,u,b,T,_,E,A){let h,f;const w=function(){return Date.now()/1e3},v=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(n),t.setCommander(e,n)},R=function(){let e=A('#two-attack-view').parent(),t=A('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=h.pagination.offset,t=h.pagination.limit
;h.visibleCommands=h.commands.slice(e,e+t),h.pagination.count=h.commands.length},k=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);y()},L=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},I=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},x=function(){h.commands=t.getCommands()},O=function(){h.selectedVillageId=i.getSelectedVillage().getId()},N=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=i.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=T,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=b,h.COLUMN_TYPES=o,h.pagination={count:h.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=p.jumpToVillage,h.now=w,h.copyTimeModal=v,h.removeTroops=S,h.switchWindowSize=R,
h.toggleFilter=L,h.toggleSorting=I,y();let e=new n('twoverflow_queue_window',(function(){E.timer.remove(k)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,x),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,x),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,x),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,x),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),E.timer.add(k)};return function(){f=e.addMenuButton('Strażnik',30),f.addEventListener('click',N),
...
define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,n,r,c,d,u,p,g,m,b,T,_,E,A,h,f){
let w,v,S=!1,R=!1,y=[],k=null,L=null,I=null,x=null,O=null,N=null,P=null,M=null,C=null,z=null,D=null,B=null,U=null,G=null,V=null,W=null,q=null,Y=null,H=null,F=null,j=null,K=null,Q=null,X=null,Z=null,J=null,$=null,ee=null,te=null,ae=null,ne=null,ie=null,le=null,oe=null,se=null,re=null,ce=null,de=null,ue=null,pe=null,ge=null,me=null,be=null,Te=null,_e=null,Ee=null,Ae=null,he=null,fe=null,we=null,ve=null,Se=null,Re=null,ye=null,ke=null,Le=null,Ie=null,xe=null,Oe=null,Ne=null,Pe=null,Me=null,Ce=null,ze=null,De=null,Be=null,Ue=null,Ge=null,Ve=null,We=null,qe=null,Ye=null,He=null,Fe=null,je=null,Ke=null,Qe=null,Xe=null,Ze=null,Je=null,$e=null,et=null,tt=null,at=null,nt=null,it=null,lt=null,ot=null,st=null,rt=null,ct=null,dt=null,ut=null,pt=null,gt=null,mt=null,bt=null,Tt=null,_t=null,Et=null,At=null,ht=null,ft=null,wt=null,vt=null,St=null,Rt=null,yt=null,kt=null,Lt=null,It=null,xt=null,Ot=null,Nt=null,Pt=null,Mt=null,Ct=null,zt=null,Dt=null,Bt=null,Ut=null,Gt=null,Vt=null,Wt=null,qt=null,Yt=null,Ht=null,Ft=null,jt=null,Kt=null,Qt=null,Xt=null,Zt=null,Jt=null,$t=null,ea=null,ta=null,aa=null,na=null,ia=null,la=null,oa=null,sa=null,ra=null,ca=null,da=null,ua=null,pa=null,ga=null,ma=null,ba=null,Ta=null,_a=null,Ea=null,Aa=null,ha=null,fa=null,wa=null,va=null,Sa=null,Ra=null,ya=null,ka=null,La=null,Ia=null,xa=null,Oa=null
...
[m.LEVEL_3]:'level_3'},Da={[g.NO_WALL]:'without',[g.LEVEL_1]:'level_1',[g.LEVEL_2]:'level_2',[g.LEVEL_3]:'level_3',[g.LEVEL_4]:'level_4',[g.LEVEL_5]:'level_5',[g.LEVEL_6]:'level_6',[g.LEVEL_7]:'level_7',[g.LEVEL_8]:'level_8',[g.LEVEL_9]:'level_9',[g.LEVEL_10]:'level_10',[g.LEVEL_11]:'level_11',[g.LEVEL_12]:'level_12',[g.LEVEL_13]:'level_13',[g.LEVEL_14]:'level_14',[g.LEVEL_15]:'level_15',[g.LEVEL_16]:'level_16',[g.LEVEL_17]:'level_17',[g.LEVEL_18]:'level_18',[g.LEVEL_19]:'level_19',[g.LEVEL_20]:'level_20'},Ba={[b.LEVEL_1]:'level_1',[b.LEVEL_2]:'level_2',[b.LEVEL_3]:'level_3',[b.LEVEL_4]:'level_4',[b.LEVEL_5]:'level_5'},Ua={[T.LEVEL_1]:'level_1',[T.LEVEL_2]:'level_2',[T.LEVEL_3]:'level_3',[T.LEVEL_4]:'level_4',[T.LEVEL_5]:'level_5'},Ga={[_.LEVEL_1]:'level_1',[_.LEVEL_2]:'level_2',[_.LEVEL_3]:'level_3',[_.LEVEL_4]:'level_4',[_.LEVEL_5]:'level_5',[_.LEVEL_6]:'level_6',[_.LEVEL_7]:'level_7',[_.LEVEL_8]:'level_8',[_.LEVEL_9]:'level_9',[_.LEVEL_10]:'level_10'},Va={[E.LEVEL_1]:'level_1',
[E.LEVEL_2]:'level_2',[E.LEVEL_3]:'level_3',[E.LEVEL_4]:'level_4',[E.LEVEL_5]:'level_5',[E.LEVEL_6]:'level_6',[E.LEVEL_7]:'level_7',[E.LEVEL_8]:'level_8',[E.LEVEL_9]:'level_9',[E.LEVEL_10]:'level_10'};console.log(Va,Ga,Ua,Ba,Da,za,Pa,Ma,Ca);const Wa=function(){y=[];const e=i.getPresetList().getPresets();v[t.PRESET].forEach((function(t){y.push(e[t])}))},qa={init:function(){S=!0,w=new e({settingsMap:n,storageKey:Na}),w.onChange((function(e,t){v=w.getAll(),t[r.PRESETS]&&Wa()})),v=w.getAll(),console.log('battleCalculator settings',v),h((function(){Wa()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,Wa),a.$on(s.ARMY_PRESET_DELETED,Wa)},getPresetUnits:function(){y=v[t.PRESET],l.emit(o.GET_PRESETS,{},(function(e){for(Oa=0;Oa<e.presets.length;Oa++)e.presets[Oa].id==y&&(ia=e.presets[Oa].units.spear,la=e.presets[Oa].units.sword,oa=e.presets[Oa].units.axe,sa=e.presets[Oa].units.archer,ra=e.presets[Oa].units.light_cavalry,ca=e.presets[Oa].units.mounted_archer,da=e.presets[Oa].units.heavy_cavalry,
ua=e.presets[Oa].units.ram,pa=e.presets[Oa].units.catapult,ga=e.presets[Oa].units.snob,ma=e.presets[Oa].units.knight,ba=e.presets[Oa].units.trebuchet,Ta=e.presets[Oa].units.doppelsoldner)}))},getVillageUnits:function(){xa=v[t.BATTLE_VILLAGE_ID],l.emit(o.VILLAGE_UNIT_INFO,{village_id:xa},(function(e){Ea=e.available_units.axe.total,_a=e.available_units.archer.total,Aa=e.available_units.catapult.total,ha=e.available_units.doppelsoldner.total,fa=e.available_units.heavy_cavalry.total,wa=e.available_units.knight.total,va=e.available_units.light_cavalry.total,Sa=e.available_units.mounted_archer.total,Ra=e.available_units.ram.total,ya=e.available_units.snob.total,ka=e.available_units.spear.total,La=e.available_units.sword.total,Ia=e.available_units.trebuchet.total}))},calculateB:function(){
const e=v[t.BASHPOINTS_SPEAR],a=v[t.BASHPOINTS_SWORD],n=v[t.BASHPOINTS_AXE],i=v[t.BASHPOINTS_ARCHER],l=v[t.BASHPOINTS_LC],o=v[t.BASHPOINTS_MA],s=v[t.BASHPOINTS_HC],r=v[t.BASHPOINTS_RAM],c=v[t.BASHPOINTS_CATAPULT],d=v[t.BASHPOINTS_DOPPELSOLDNER],u=v[t.BASHPOINTS_TREBUCHET],p=v[t.BASHPOINTS_SNOB],g=v[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],b=[4,5,1,5,5,6,23,4,12,40,200,25,10];k=e*m[0]+a*m[1]+n*m[2]+i*m[3]+l*m[4]+o*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],L=e*b[0]+a*b[1]+n*b[2]+i*b[3]+l*b[4]+o*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+p*b[10]+u*b[11]+d*b[12]}};return qa.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],l=[10,30,10,60,30,50,180,20,100,150,100,200,50],o=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=0,c=0,d=0,u=0,p=0,g=0,m=0,b=0,T=0,_=0,E=0,A=0,h=0,f=0,w=0,S=0,R=0,y=0,k=0,L=0,I=0,x=0,O=0,N=0,P=0,M=0,C=0,z=0,D=0,B=0,U=0,G=0,V=0,W=0,q=0,ia=0,la=0,oa=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=0,ba=0,Ta=0,_a=0,Ea=0,Aa=0,ha=0,fa=0,wa=0,va=0,Sa=0,Ra=0,ya=0,ka=0,La=0,Ia=0,xa=0,Oa=0,Na=0,Pa=0,Ma=0,Ca=0,za=0,Da=0,Ba=0,Ua=0,Ga=0,Va=0,Wa=0,qa=0,Ya=0,Ha=0,Fa=0,ja=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,ln=0,on=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,bn=0,Tn=0,_n=0,En=0,An=0,hn=0,fn=0,wn=0,vn=[1,1],Sn=[1,1],Rn=[1,1],yn=[1,1],kn=[1,1],Ln=[1,1],In=[1,1],xn=[1,1],On=[1,1],Nn=[1,1],Pn=[1,1],Mn=[1,1],Cn=[1,1],zn=[1,1],Dn=[1,1],Bn=[1,1],Un=[1,1],Gn=[1,1],Vn=[1,1],Wn=[1,1],qn=[1,1],Yn=[1,1],Hn=[1,1],Fn=[1,1],jn=[1,1],Kn=[1,1],Qn=[1,1],Xn=[1,1],Zn=[1,1],Jn=[1,1],$n=[1,1],ei=[1,1],ti=[1,1],ai=[1,1],ni=[1,1],ii=[1,1],li=0,oi=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,bi=0,Ti=0,_i=0,Ei=0,Ai=0,hi=0,fi=0,wi=0,vi=0,Si=0,Ri=0,yi=0,ki=0,Li=0,Ii=0,xi=[1,1],Oi=0,Ni=0,Pi=0,Mi=0,Ci=0,zi=0,Di=0,Bi=0,Ui=0,Gi=0,Vi=0,Wi=0,qi=0,Yi=0,Hi=0,Fi=0,ji=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,el=0,tl=0,al=0,nl=0,il=0,ll=0,ol=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=[1,1],bl=[1,1],Tl=[1,1],_l=[1,1],El=[1,1],Al=[1,1],hl=[1,1],fl=[1,1],wl=[1,1],vl=0,Sl=0,Rl=0,yl=0,kl=0,Ll=0,Il=0,xl=0,Ol=0,Nl=0,Pl=0,Ml=0,Cl=0,zl=0,Dl=0,Bl=0,Ul=0,Gl=0,Vl=0,Wl=0,ql=0,Yl=0,Hl=0,Fl=0,jl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,eo=0,to=0,ao=0,no=0,io=0,lo=0,oo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,bo=0,To=0,_o=0,Eo=0,Ao=0,ho=0,fo=0,wo=0,vo=0,So=0,Ro=0,yo=0,ko=0,Lo=0,Io=0,xo=0,Oo=0,No=0,Po=0,Mo=0,Co=0,zo=0,Do=0,Bo=0,Uo=0,Go=0,Vo=0,Wo=0,qo=0,Yo=0,Ho=0,Fo=1,jo=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,es=0,ts=0,as=0,ns=0,is=0,ls=0,os=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,bs=0,Ts=0,_s=0,Es=0,As=0,hs=0,fs=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Ls=0,Is=0,xs=0,Os=0,Ns=0,Ps=0,Ms=0,Cs=0,zs=0,Ds=0,Bs=0,Us=0,Gs=0,Vs=0,Ws=0,qs=0,Ys=0,Hs=0,Fs=0,js=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,lr=0,or=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,br=0,Tr=0,_r=0,Er=0,Ar=0,hr=0,fr=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Lr=0,Ir=0,xr=0,Or=0,Nr=0,Pr=0,Mr=0,Cr=0,zr=0,Dr=0,Br=0,Ur=0,Gr=0,Vr=0,Wr=0,qr=0,Yr=0,Hr=0,Fr=0,jr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,lc=0,oc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,bc=0,Tc=0,_c=0,Ec=0,Ac=0,hc=0,fc=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Lc=0,Ic=0,xc=0,Oc=0,Nc=0,Pc=0,Mc=0,Cc=0,zc=0,Dc=0,Bc=0,Uc=0,Gc=0,Vc=0,Wc=0,qc=0,Yc=0,Hc=0,Fc=0,jc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,ld=0,od=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,bd=0,Td=0,_d=0,Ed=0,Ad=0,hd=0,fd=0,wd=0,vd=0,Sd=0
;console.log(aa,jt),r=v[t.BATTLE_CHURCH_A],c=v[t.BATTLE_CHURCH_D],d=v[t.BATTLE_NIGHT_BONUS],u=v[t.BATTLE_OFFICER_LEADER],p=v[t.BATTLE_OFFICER_MEDIC],g=v[t.BATTLE_SKILL_MEDIC],m=v[t.BATTLE_SKILL_WEAPON_MASTER],b=v[t.BATTLE_WALL],T=v[t.BATTLE_SKILL_IRON_WALLS],_=v[t.BATTLE_SKILL_CLINIQUE],E=v[t.BATTLE_HOSPITAL],Mt=v[t.BATTLE_CATAPULT_TARGET],A=v[t.BATTLE_CATAPULT_TARGET],h=v[t.BATTLE_KNIGHT_ITEM_D1],f=v[t.BATTLE_KNIGHT_ITEM_D2],w=v[t.BATTLE_KNIGHT_ITEM_D3],S=v[t.BATTLE_KNIGHT_ITEM_A],R=v[t.BATTLE_ITEM_LEVEL_D1],y=v[t.BATTLE_ITEM_LEVEL_D2],k=v[t.BATTLE_ITEM_LEVEL_D3],L=v[t.BATTLE_ITEM_LEVEL_A],Ue=v[t.BATTLE_ARCHER_A],j=v[t.BATTLE_ARCHER_D],Be=v[t.BATTLE_AXE_A],F=v[t.BATTLE_AXE_D],Ke=v[t.BATTLE_DOPPELSOLDNER_A],ae=v[t.BATTLE_DOPPELSOLDNER_D],qe=v[t.BATTLE_CATAPULT_A],Z=v[t.BATTLE_CATAPULT_D],je=v[t.BATTLE_HC_A],te=v[t.BATTLE_HC_D],Ve=v[t.BATTLE_KNIGHT_A],Q=v[t.BATTLE_KNIGHT_D],He=v[t.BATTLE_LC_A],$=v[t.BATTLE_LC_D],Fe=v[t.BATTLE_MA_A],ee=v[t.BATTLE_MA_D],We=v[t.BATTLE_RAM_A],
X=v[t.BATTLE_RAM_D],Ge=v[t.BATTLE_SNOB_A],K=v[t.BATTLE_SNOB_D],ze=v[t.BATTLE_SPEAR_A],Y=v[t.BATTLE_SPEAR_D],De=v[t.BATTLE_SWORD_A],H=v[t.BATTLE_SWORD_D],Ye=v[t.BATTLE_TREBUCHET_A],J=v[t.BATTLE_TREBUCHET_D],I=v[t.BATTLE_MORALE],x=v[t.BATTLE_LUCK],console.log(Mt),vd='level_1'==r?100:'level_2'==r?105:'level_3'==r?110:50,console.log(vd),Sd='level_1'==c?100:'level_2'==c?105:'level_3'==c?110:50,console.log(Sd),Fo=d?2:1,console.log(Fo),so=u?.1:0,console.log(so),Yo=p?.1:0,console.log(Yo),Js=g?.1:0,console.log(Js),Xs='level_1'==m?2:'level_2'==m?4:'level_3'==m?6:'level_4'==m?8:'level_5'==m?10:0,console.log(Xs),$s='level_1'==T?1:'level_2'==T?2:'level_3'==T?3:'level_4'==T?4:'level_5'==T?5:0,console.log($s),Zs='level_1'==_?100:'level_2'==_?200:'level_3'==_?300:'level_4'==_?400:'level_5'==_?500:'level_6'==_?600:'level_7'==_?700:'level_8'==_?800:'level_9'==_?900:'level_10'==_?1e3:0,console.log(Zs),
Ii='level_1'==E?100:'level_2'==E?129:'level_3'==E?167:'level_4'==E?215:'level_5'==E?278:'level_6'==E?359:'level_7'==E?464:'level_8'==E?599:'level_9'==E?774:'level_10'==E?1e3:0,console.log(Ii),Ut='level_1'==b?1:'level_2'==b?2:'level_3'==b?3:'level_4'==b?4:'level_5'==b?5:'level_6'==b?6:'level_7'==b?7:'level_8'==b?8:'level_9'==b?9:'level_10'==b?10:'level_11'==b?11:'level_12'==b?12:'level_13'==b?13:'level_14'==b?14:'level_15'==b?15:'level_16'==b?16:'level_17'==b?17:'level_18'==b?18:'level_19'==b?19:'level_20'==b?20:0,console.log(Ut),Gn='battle.lance'==h&'level_1'==R?[1.05,1.1]:'battle.lance'==h&'level_2'==R?[1.1,1.2]:'battle.lance'==h&'level_3'==R?[1.2,1.3]:[1,1],console.log(Gn),Ln='battle.battleaxe'==h&'level_1'==R?[1.05,1.1]:'battle.battleaxe'==h&'level_2'==R?[1.1,1.2]:'battle.battleaxe'==h&'level_3'==R?[1.2,1.3]:[1,1],console.log(Ln),Yn='battle.compositebow'==h&'level_1'==R?[1.05,1.1]:'battle.compositebow'==h&'level_2'==R?[1.1,1.2]:'battle.compositebow'==h&'level_3'==R?[1.2,1.3]:[1,1],
console.log(Yn),Jn='battle.halberd'==h&'level_1'==R?[1.1,1.05]:'battle.halberd'==h&'level_2'==R?[1.2,1.1]:'battle.halberd'==h&'level_3'==R?[1.3,1.2]:[1,1],console.log(Jn),ai='battle.longsword'==h&'level_1'==R?[1.1,1.05]:'battle.longsword'==h&'level_2'==R?[1.2,1.1]:'battle.longsword'==h&'level_3'==R?[1.3,1.2]:[1,1],Sn='battle.longbow'==h&'level_1'==R?[1.1,1.05]:'battle.longbow'==h&'level_2'==R?[1.2,1.1]:'battle.longbow'==h&'level_3'==R?[1.3,1.2]:[1,1],zn='battle.banner'==h&'level_1'==R?[1.1,1.1]:'battle.banner'==h&'level_2'==R?[1.2,1.2]:'battle.banner'==h&'level_3'==R?[1.3,1.3]:[1,1],Kn='battle.star'==h&'level_1'==R?[1.05,1.25]:'battle.star'==h&'level_2'==R?[1.1,1.5]:'battle.star'==h&'level_3'==R?[1.2,2]:[1,1],Nn='battle.bonfire'==h&'level_1'==R?[1.05,1.25]:'battle.bonfire'==h&'level_2'==R?[1.1,1.5]:'battle.bonfire'==h&'level_3'==R?[1.2,2]:[1,1],Vn='battle.lance'==f&'level_1'==y?[1.05,1.1]:'battle.lance'==f&'level_2'==y?[1.1,1.2]:'battle.lance'==f&'level_3'==y?[1.2,1.3]:[1,1],
In='battle.battleaxe'==f&'level_1'==y?[1.05,1.1]:'battle.battleaxe'==f&'level_2'==y?[1.1,1.2]:'battle.battleaxe'==f&'level_3'==y?[1.2,1.3]:[1,1],Hn='battle.compositebow'==f&'level_1'==y?[1.05,1.1]:'battle.compositebow'==f&'level_2'==y?[1.1,1.2]:'battle.compositebow'==f&'level_3'==y?[1.2,1.3]:[1,1],$n='battle.halberd'==f&'level_1'==y?[1.1,1.05]:'battle.halberd'==f&'level_2'==y?[1.2,1.1]:'battle.halberd'==f&'level_3'==y?[1.3,1.2]:[1,1],ni='battle.longsword'==f&'level_1'==y?[1.1,1.05]:'battle.longsword'==f&'level_2'==y?[1.2,1.1]:'battle.longsword'==f&'level_3'==y?[1.3,1.2]:[1,1],Rn='battle.longbow'==f&'level_1'==y?[1.1,1.05]:'battle.longbow'==f&'level_2'==y?[1.2,1.1]:'battle.longbow'==f&'level_3'==y?[1.3,1.2]:[1,1],Dn='battle.banner'==f&'level_1'==y?[1.1,1.1]:'battle.banner'==f&'level_2'==y?[1.2,1.2]:'battle.banner'==f&'level_3'==y?[1.3,1.3]:[1,1],Qn='battle.star'==f&'level_1'==y?[1.05,1.25]:'battle.star'==f&'level_2'==y?[1.1,1.5]:'battle.star'==f&'level_3'==y?[1.2,2]:[1,1],
...
Bn='battle.banner'==w&'level_1'==k?[1.1,1.1]:'battle.banner'==w&'level_2'==k?[1.2,1.2]:'battle.banner'==w&'level_3'==k?[1.3,1.3]:[1,1],Xn='battle.star'==w&'level_1'==k?[1.05,1.25]:'battle.star'==w&'level_2'==k?[1.1,1.5]:'battle.star'==w&'level_3'==k?[1.2,2]:[1,1],Mn='battle.bonfire'==w&'level_1'==k?[1.05,1.25]:'battle.bonfire'==w&'level_2'==k?[1.1,1.5]:'battle.bonfire'==w&'level_3'==k?[1.2,2]:[1,1],Un=Gn[0]>=Vn[0]&&Gn[0]>=Wn[0]?Gn:Vn[0]>=Gn[0]&&Vn[0]>=Wn[0]?Vn:Wn[0]>=Gn[0]&&Wn[0]>=Vn[0]?Wn:[1,1],kn=Ln[0]>=In[0]&&Ln[0]>=xn[0]?Ln:In[0]>=Ln[0]&&In[0]>=xn[0]?In:xn[0]>=Ln[0]&&xn[0]>=In[0]?xn:[1,1],qn=Yn[0]>=Hn[0]&&Yn[0]>=Fn[0]?Yn:Hn[0]>=Yn[0]&&Hn[0]>=Fn[0]?Hn:Fn[0]>=Yn[0]&&Fn[0]>=Hn[0]?Fn:[1,1],Cn=zn[0]>=Dn[0]&&zn[0]>=Bn[0]?zn:Dn[0]>=zn[0]&&Dn[0]>=Bn[0]?Dn:Bn[0]>=zn[0]&&Bn[0]>=Dn[0]?Bn:[1,1],jn=Kn[0]>=Qn[0]&&Kn[0]>=Xn[0]?Kn:Qn[0]>=Kn[0]&&Qn[0]>=Xn[0]?Qn:Xn[0]>=Kn[0]&&Xn[0]>=Qn[0]?Xn:[1,1],On=Nn[0]>=Pn[0]&&Nn[0]>=Mn[0]?Nn:Pn[0]>=Nn[0]&&Pn[0]>=Mn[0]?Pn:Mn[0]>=Nn[0]&&Mn[0]>=Pn[0]?Mn:[1,1],
Zn=Jn[0]>=$n[0]&&Jn[0]>=ei[0]?Jn:$n[0]>=Jn[0]&&$n[0]>=ei[0]?$n:ei[0]>=Jn[0]&&ei[0]>=$n[0]?ei:[1,1],ti=ai[0]>=ni[0]&&ai[0]>=ii[0]?ai:ni[0]>=ai[0]&&ni[0]>=ii[0]?ni:ii[0]>=ai[0]&&ii[0]>=ni[0]?ii:[1,1],vn=Sn[0]>=Rn[0]&&Sn[0]>=yn[0]?Sn:Rn[0]>=Sn[0]&&Rn[0]>=yn[0]?Rn:yn[0]>=Sn[0]&&yn[0]>=Rn[0]?yn:[1,1],El='battle.lance'==S&'level_1'==L?[1.05,1.1]:'battle.lance'==S&'level_2'==L?[1.1,1.2]:'battle.lance'==S&'level_3'==L?[1.2,1.3]:[1,1],bl='battle.battleaxe'==S&'level_1'==L?[1.05,1.1]:'battle.battleaxe'==S&'level_2'==L?[1.1,1.2]:'battle.battleaxe'==S&'level_3'==L?[1.2,1.3]:[1,1],Al='battle.compositebow'==S&'level_1'==L?[1.05,1.1]:'battle.compositebow'==S&'level_2'==L?[1.1,1.2]:'battle.compositebow'==S&'level_3'==L?[1.2,1.3]:[1,1],fl='battle.halberd'==S&'level_1'==L?[1.1,1.05]:'battle.halberd'==S&'level_2'==L?[1.2,1.1]:'battle.halberd'==S&'level_3'==L?[1.3,1.2]:[1,1],
wl='battle.longsword'==S&'level_1'==L?[1.1,1.05]:'battle.longsword'==S&'level_2'==L?[1.2,1.1]:'battle.longsword'==S&'level_3'==L?[1.3,1.2]:[1,1],ml='battle.longbow'==S&'level_1'==L?[1.1,1.05]:'battle.longbow'==S&'level_2'==L?[1.2,1.1]:'battle.longbow'==S&'level_3'==L?[1.3,1.2]:[1,1],_l='battle.banner'==S&'level_1'==L?[1.1,1.1]:'battle.banner'==S&'level_2'==L?[1.2,1.2]:'battle.banner'==S&'level_3'==L?[1.3,1.3]:[1,1],hl='battle.star'==S&'level_1'==L?[1.05,1.25]:'battle.star'==S&'level_2'==L?[1.1,1.5]:'battle.star'==S&'level_3'==L?[1.2,2]:[1,1],Tl='battle.bonfire'==S&'level_1'==L?[1.05,1.25]:'battle.bonfire'==S&'level_2'==L?[1.1,1.5]:'battle.bonfire'==S&'level_3'==L?[1.2,2]:[1,1],Xt=ze*s[0]+De*s[1]+Be*s[2]+Ue*s[3]+He*s[4]+Fe*s[5]+je*s[6]+We*s[7]+qe*s[8]+Ve*s[9]+Ge*s[10]+Ye*s[11]+Ke*s[12],Vt=Y*s[0]+H*s[1]+F*s[2]+j*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log('Prowiant:'+Xt,Vt),na=2*Xt<=Vt?2:1,jo=Xt-5*We,
Ko=0==Ut?0:Math.round(20*Math.pow(1.2515,Ut-1)),wn=Vt+(Ko+100*K),As=0==jo||0==wn?0:jo/wn>1?1:jo/wn,console.log(As),Ho=I/100,So=x/100,Qt=Math.round(1e3*(vd/100*Ho*(1+So)+Xs/100+so))/1e3,hd=qe/(Ad=We+qe),fd=We/Ad,ed=Math.round(J*hd),bd=Math.round(J*fd),Vs=(qs=We-(0==We?0:We<bd?We:bd))*As*Qt*(xi='battle.star'==S?'level_1'==L?[1.05,1.25]:'level_2'==L?[1.1,1.5]:'level_3'==L?[1.2,2]:[1,1]:[1,1])[1],ki=20==Ut?18:19==Ut?17:18==Ut?15:17==Ut?14:16==Ut?13:15==Ut?11:14==Ut?10:13==Ut||12==Ut?9:11==Ut?8:10==Ut?7:9==Ut||8==Ut?6:7==Ut||6==Ut?5:5==Ut||4==Ut||3==Ut?4:2==Ut||1==Ut?3:0,_d=0==Ut?0:2*ki,Td=0==Ut?0:Vs/_d,Ed=Ut<=$s?Ut:Ut-$s<Td?Ut<$s?Ut:$s:Ut-Td,Na=Math.round(Ed),Oa=Math.round(.05*Na*1e3)/1e3,Gt=Math.round(Sd/100*(1+Oa)*Fo*1e3)/1e3,fn=qe-(0==qe?0:qe<ed?qe:ed),Dt=Math.round(Ed),xa=0==Dt?0:Math.round(20*Math.pow(1.2515,Dt-1)),Vl=ze+De+Be+Ke>He+je&&ze+De+Be+Ke>Ue+Fe?'inf':He+je>ze+De+Be+Ke&&He+je>Ue+Fe?'cav':'arc',
is=ze*s[0]+De*s[1]+Be*s[2]+Ue*s[3]+He*s[4]+Fe*s[5]+je*s[6]+qs*s[7]+fn*s[8]+Ve*s[9]+Ge*s[10]+Ye*s[11]+Ke*s[12],Ts=Y*s[0]+H*s[1]+F*s[2]+j*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log(is,Ts),Hs=qs*s[7]+fn*s[8]+Ye*s[11]+Ve*s[9]+Ge*s[10],'cav'==Vl?(Jo=He*s[4]+je*s[6]+Hs,ts=ze*s[0]+De*s[1]+Be*s[2]+Ke*s[12],Qo=Ue*s[3]+Fe*s[5]):'inf'==Vl?(ts=ze*s[0]+De*s[1]+Be*s[2]+Ke*s[12]+Hs,Jo=He*s[4]+je*s[6],Qo=Ue*s[3]+Fe*s[5]):'arc'==Vl?(ts=ze*s[0]+De*s[1]+Be*s[2]+Ke*s[12],Jo=He*s[4]+je*s[6],Qo=Ue*s[3]+Fe*s[5]+Hs):(ts=ze*s[0]+De*s[1]+Be*s[2]+Ke*s[12],Jo=He*s[4]+je*s[6],Qo=Ue*s[3]+Fe*s[5]),_o=0==ts?0:Math.round(ts/is*1e4)/1e4,To=0==Jo?0:Math.round(Jo/is*1e4)/1e4,bo=0==Qo?0:Math.round(Qo/is*1e4)/1e4,console.log(bo),xr=Math.round(Y*_o),Ir=Math.round(Y*To),Lr=Y-Ir-xr,Vc=Math.round(H*_o),Gc=Math.round(H*To),Uc=H-Gc-Vc,wa=Math.round(F*_o),fa=Math.round(F*To),ha=F-fa-wa,W=Math.round(j*_o),V=Math.round(j*To),G=j-V-W,$l=Math.round($*_o),Jl=Math.round($*To),Zl=$-Jl-$l,
zo=Math.round(ee*_o),Co=Math.round(ee*To),Mo=ee-Co-zo,Ei=Math.round(te*_o),_i=Math.round(te*To),Ti=te-_i-Ei,Os=Math.round(X*_o),xs=Math.round(X*To),Is=X-xs-Os,dn=Math.round(Z*_o),cn=Math.round(Z*To),rn=Z-cn-dn,ur=Math.round(K*_o),dr=Math.round(K*To),cr=K-dr-ur,sd=Math.round(J*_o),od=Math.round(J*To),ld=J-od-sd,Ya=Math.round(ae*_o),qa=Math.round(ae*To),Wa=ae-qa-Ya,ol=Math.round(Q*_o),ll=Math.round(Q*To),il=Q-ll-ol,gs=xr*s[0]+Vc*s[1]+wa*s[2]+Ya*s[12]+ur*s[10]+$l*s[4]+Ei*s[6]+W*s[3]+zo*s[5]+Os*s[7]+dn*s[8]+sd*s[11]+ol*s[9],ds=Ir*s[0]+Gc*s[1]+fa*s[2]+qa*s[12]+dr*s[10]+Jl*s[4]+_i*s[6]+V*s[3]+Co*s[5]+xs*s[7]+cn*s[8]+od*s[11]+ll*s[9],ss=Lr*s[0]+Uc*s[1]+ha*s[2]+Wa*s[12]+cr*s[10]+Zl*s[4]+Ti*s[6]+G*s[3]+Mo*s[5]+Is*s[7]+rn*s[8]+ld*s[11]+il*s[9],console.log(ss,ds,gs),dc=xr*n[0]*Zn[0]+Vc*n[1]*ti[0]+wa*n[2]*kn[0]+Ya*n[12]+ur*n[10]+$l*n[4]*Un[0]+Ei*n[6]*Cn[0]+W*n[3]*vn[0]+zo*n[5]*qn[0]+Os*n[7]*jn[0]+dn*n[8]*On[0]+sd*n[11]+ol*n[9],
sc=Ir*i[0]*Zn[0]+Gc*i[1]*ti[0]+fa*i[2]*kn[0]+qa*i[12]+dr*i[10]+Jl*i[4]*Un[0]+_i*i[6]*Cn[0]+V*i[3]*vn[0]+Co*i[5]*qn[0]+xs*i[7]*jn[0]+cn*i[8]*On[0]+od*i[11]+ll*i[9],ic=Lr*l[0]*Zn[0]+Uc*l[1]*ti[0]+ha*l[2]*kn[0]+Wa*l[12]+cr*l[10]+Zl*l[4]*Un[0]+Ti*l[6]*Cn[0]+G*l[3]*vn[0]+Mo*l[5]*qn[0]+Is*l[7]*jn[0]+rn*l[8]*On[0]+ld*l[11]+il*l[9],Ks=qs*o[7]*hl[1]+fn*o[8]*Tl[1]+Ye*o[11]+Ve*o[9]+Ge*o[10],'cav'==Vl?(Jr=He*o[4]*El[1]+je*o[6]*_l[1]+Ks,tc=ze*o[0]*fl[1]+De*o[1]*wl[1]+Be*o[2]*bl[1]+Ke*o[12]*na,Qr=Ue*o[3]*ml[1]+Fe*o[5]*Al[1]):'inf'==Vl?(tc=ze*o[0]*fl[1]+De*o[1]*wl[1]+Be*o[2]*bl[1]+Ke*o[12]*na+Ks,Jr=He*o[4]*El[1]+je*o[6]*_l[1],Qr=Ue*o[3]*ml[1]+Fe*o[5]*Al[1]):'arc'==Vl?(tc=ze*o[0]*fl[1]+De*o[1]*wl[1]+Be*o[2]*bl[1]+Ke*o[12]*na,Jr=He*o[4]*El[1]+je*o[6]*_l[1],Qr=Ue*o[3]*ml[1]+Fe*o[5]*Al[1]+Ks):(tc=ze*o[0]*fl[1]+De*o[1]*wl[1]+Be*o[2]*bl[1]+Ke*o[12]*na,Jr=He*o[4]*El[1]+je*o[6]*_l[1],Qr=Ue*o[3]*ml[1]+Fe*o[5]*Al[1]),Zt=(Yr=tc*Qt)+(Vr=Jr*Qt)+(Br=Qr*Qt),Wt=(Ac=dc*Gt+xa)+(Tc=sc*Gt+xa)+(gc=ic*Gt+xa),
console.log(Zt,Wt),Ul=0==Yr||0==Ac?0:Ac<=Yr?1:Math.pow(Yr/Ac,.5)/(Ac/Yr),zl=0==Vr||0==Tc?0:Tc<=Vr?1:Math.pow(Vr/Tc,.5)/(Tc/Vr),Pl=0==Br||0==gc?0:gc<=Br?1:Math.pow(Br/gc,.5)/(gc/Br),xl=0==Yr||0==Ac?0:Yr<=Ac?1:Math.pow(Ac/Yr,.5)/(Yr/Ac),kl=0==Vr||0==Tc?0:Vr<=Tc?1:Math.pow(Tc/Vr,.5)/(Vr/Tc),Sl=0==Br||0==gc?0:Br<=gc?1:Math.pow(gc/Br,.5)/(Br/gc),Pi=Math.round(1e6*xl)/1e6,Ni=Math.round(1e6*kl)/1e6,Oi=Math.round(1e6*Sl)/1e6,zi=Math.round(1e6*Ul)/1e6,Ci=Math.round(1e6*zl)/1e6,Mi=Math.round(1e6*Pl)/1e6,Sr=Math.round(-xr*zi+1e-6)+Math.round(-Ir*Ci+1e-6)+Math.round(-Lr*Mi+1e-6),Cc=Math.round(-Vc*zi+1e-6)+Math.round(-Gc*Ci+1e-6)+Math.round(-Uc*Mi+1e-6),Ta=Math.round(-wa*zi+1e-6)+Math.round(-fa*Ci+1e-6)+Math.round(-ha*Mi+1e-6),z=Math.round(-W*zi+1e-6)+Math.round(-V*Ci+1e-6)+Math.round(-G*Mi+1e-6),jl=Math.round(-$l*zi+1e-6)+Math.round(-Jl*Ci+1e-6)+Math.round(-Zl*Mi+1e-6),xo=Math.round(-zo*zi+1e-6)+Math.round(-Co*Ci+1e-6)+Math.round(-Mo*Mi+1e-6),
pi=Math.round(-Ei*zi+1e-6)+Math.round(-_i*Ci+1e-6)+Math.round(-Ti*Mi+1e-6),Rs=Math.round(-Os*zi+1e-6)+Math.round(-xs*Ci+1e-6)+Math.round(-Is*Mi+1e-6),nn=Math.round(-dn*zi+1e-6)+Math.round(-cn*Ci+1e-6)+Math.round(-rn*Mi+1e-6),td=Math.round(-sd*zi+1e-6)+Math.round(-od*Ci+1e-6)+Math.round(-ld*Mi+1e-6),Ba=Math.round(-Ya*zi+1e-6)+Math.round(-qa*Ci+1e-6)+Math.round(-Wa*Mi+1e-6),el=Math.round(-ol*zi+1e-6)+Math.round(-ll*Ci+1e-6)+Math.round(-il*Mi+1e-6),lr=Math.round(-ur*zi+1e-6)+Math.round(-dr*Ci+1e-6)+Math.round(-cr*Mi+1e-6),Ar=Math.round(-ze*Pi+1e-6),xc=Math.round(-De*Pi+1e-6),ua=Math.round(-Be*Pi+1e-6),Pa=Math.round(-Ke*Pi+1e-6),O=Math.round(-Ue*Oi+1e-6),Ro=Math.round(-Fe*Oi+1e-6),Wl=Math.round(-He*Ni+1e-6),si=Math.round(-je*Ni+1e-6),'cav'==Vl?(hs=Math.round(-qs*Ni+1e-6),Ja=Math.round(-fn*Ni+1e-6),Qc=Math.round(-Ye*Ni+1e-6),Qi=Math.round(-Ve*Ni+1e-6),er=Math.round(-Ge*Ni+1e-6)):'inf'==Vl?(hs=Math.round(-qs*Pi+1e-6),Ja=Math.round(-fn*Pi+1e-6),Qc=Math.round(-Ye*Pi+1e-6),
Qi=Math.round(-Ve*Pi+1e-6),er=Math.round(-Ge*Pi+1e-6)):'arc'==Vl&&(hs=Math.round(-qs*Oi+1e-6),Ja=Math.round(-fn*Oi+1e-6),Qc=Math.round(-Ye*Oi+1e-6),Qi=Math.round(-Ve*Oi+1e-6),er=Math.round(-Ge*Oi+1e-6)),wr=ze+Ar,Pc=De+xc,ma=Be+ua,M=Ue+O,Hl=He+Wl,Lo=Fe+Ro,di=je+si,vs=qs+hs,tn=fn+Ja,Jc=Ye+Qc,za=Ke+Pa,nr=Ge+er,Ji=Ve+Qi,kr=Y+Sr,Bc=H+Cc,Aa=F+Ta,U=j+z,Xl=$+jl,Po=ee+xo,bi=te+pi,Ls=X+Rs,sn=Z+nn,id=J+td,Va=ae+Ba,rr=K+lr,nl=Q+el,ro=Ar*s[0]+xc*s[1]+ua*s[2]+O*s[3]+Wl*s[4]+Ro*s[5]+si*s[6]+hs*s[7]+Ja*s[8]+Qi*s[9]+er*s[10]+Qc*s[11]+Pa*s[12],po=Sr*s[0]+Cc*s[1]+Ta*s[2]+z*s[3]+jl*s[4]+xo*s[5]+pi*s[6]+Rs*s[7]+nn*s[8]+el*s[9]+lr*s[10]+td*s[11]+Ba*s[12],console.log(ro,po),Sc=wr*s[0]+Pc*s[1]+ma*s[2]+M*s[3]+Hl*s[4]+Lo*s[5]+di*s[6]+vs*s[7]+tn*s[8]+Jc*s[11]+za*s[12]+nr*s[10]+Ji*s[9],kc=kr*s[0]+Bc*s[1]+Aa*s[2]+U*s[3]+Xl*s[4]+Po*s[5]+bi*s[6]+Ls*s[7]+sn*s[8]+id*s[11]+Va*s[12]+rr*s[10]+nl*s[9],console.log(kc,Sc),da=0==Zt||0==Wt?0:Wt<=Zt?1:Math.pow(Zt/Wt,.5/(Wt/Zt)),console.log(da),
ls=wr*s[0]+Pc*s[1]+ma*s[2]+M*s[3]+Hl*s[4]+Lo*s[5]+di*s[6]+vs*s[7]+tn*s[8]+Ji*s[9]+nr*s[10]+Jc*s[11]+za*s[12],_s=kr*s[0]+Bc*s[1]+Aa*s[2]+U*s[3]+Xl*s[4]+Po*s[5]+bi*s[6]+Ls*s[7]+sn*s[8]+nl*s[9]+rr*s[10]+id*s[11]+Va*s[12],console.log(ls,_s),Fs=vs*s[7]+tn*s[8]+Jc*s[11]+Ji*s[9],'cav'==Vl?($o=Hl*s[4]+di*s[6]+Fs,as=wr*s[0]+Pc*s[1]+ma*s[2]+za*s[12]+nr*s[10],Xo=M*s[3]+Lo*s[5]):'inf'==Vl?(as=wr*s[0]+Pc*s[1]+ma*s[2]+za*s[12]+nr*s[10]+Fs,$o=Hl*s[4]+di*s[6],Xo=M*s[3]+Lo*s[5]):'arc'==Vl?(as=wr*s[0]+Pc*s[1]+ma*s[2]+za*s[12]+nr*s[10],$o=Hl*s[4]+di*s[6],Xo=M*s[3]+Lo*s[5]+Fs):(as=wr*s[0]+Pc*s[1]+ma*s[2]+za*s[12]+nr*s[10],$o=Hl*s[4]+di*s[6],Xo=M*s[3]+Lo*s[5]),ho=0==as?0:Math.round(as/ls*1e4)/1e4,Ao=0==$o?0:Math.round($o/ls*1e4)/1e4,Eo=0==Xo?0:Math.round(Xo/ls*1e4)/1e4,console.log(Eo),Mr=Math.round(kr*ho),Pr=Math.round(kr*Ao),Nr=kr-Pr-Mr,Hc=Math.round(Bc*ho),Yc=Math.round(Bc*Ao),qc=Bc-Yc-Hc,ya=Math.round(Aa*ho),Ra=Math.round(Aa*Ao),Sa=Aa-Ra-ya,oa=Math.round(U*ho),la=Math.round(U*Ao),ia=U-la-oa,
no=Math.round(Xl*ho),ao=Math.round(Xl*Ao),to=Xl-ao-no,Go=Math.round(Po*ho),Uo=Math.round(Po*Ao),Bo=Po-Uo-Go,wi=Math.round(bi*ho),fi=Math.round(bi*Ao),hi=bi-fi-wi,Cs=Math.round(Ls*ho),Ms=Math.round(Ls*Ao),Ps=Ls-Ms-Cs,mn=Math.round(sn*ho),gn=Math.round(sn*Ao),pn=sn-gn-mn,br=Math.round(rr*ho),mr=Math.round(rr*Ao),gr=rr-mr-br,ud=Math.round(id*ho),dd=Math.round(id*Ao),cd=id-dd-ud,Ka=Math.round(Va*ho),ja=Math.round(Va*Ao),Fa=Va-ja-Ka,dl=Math.round(nl*ho),cl=Math.round(nl*Ao),rl=nl-cl-dl,ms=Mr*s[0]+Hc*s[1]+ya*s[2]+Ka*s[12]+br*s[10]+no*s[4]+wi*s[6]+oa*s[3]+Go*s[5]+Cs*s[7]+mn*s[8]+ud*s[11]+dl*s[9],us=Pr*s[0]+Yc*s[1]+Ra*s[2]+ja*s[12]+mr*s[10]+ao*s[4]+fi*s[6]+la*s[3]+Uo*s[5]+Ms*s[7]+gn*s[8]+dd*s[11]+cl*s[9],rs=Nr*s[0]+qc*s[1]+Sa*s[2]+Fa*s[12]+gr*s[10]+to*s[4]+hi*s[6]+ia*s[3]+Bo*s[5]+Ps*s[7]+pn*s[8]+cd*s[11]+rl*s[9],console.log(rs,us,ms),
uc=Mr*n[0]*Zn[0]+Hc*n[1]*ti[0]+ya*n[2]*kn[0]+Ka*n[12]+br*n[10]+no*n[4]*Un[0]+wi*n[6]*Cn[0]+oa*n[3]*vn[0]+Go*n[5]*qn[0]+Cs*n[7]*jn[0]+mn*n[8]*On[0]+ud*n[11]+dl*n[9],rc=Pr*i[0]*Zn[0]+Yc*i[1]*ti[0]+Ra*i[2]*kn[0]+ja*i[12]+mr*i[10]+ao*i[4]*Un[0]+fi*i[6]*Cn[0]+la*i[3]*vn[0]+Uo*i[5]*qn[0]+Ms*i[7]*jn[0]+gn*i[8]*On[0]+dd*i[11]+cl*i[9],lc=Nr*l[0]*Zn[0]+qc*l[1]*ti[0]+Sa*l[2]*kn[0]+Fa*l[12]+gr*l[10]+to*l[4]*Un[0]+hi*l[6]*Cn[0]+ia*l[3]*vn[0]+Bo*l[5]*qn[0]+Ps*l[7]*jn[0]+pn*l[8]*On[0]+cd*l[11]+rl*l[9],Qs=vs*o[7]*hl[1]+tn*o[8]*Tl[1]+Jc*o[11]+Ji*o[9],'cav'==Vl?($r=Hl*o[4]*El[1]+di*o[6]*_l[1]+Qs,ac=wr*o[0]*fl[1]+Pc*o[1]*wl[1]+ma*o[2]*bl[1]+za*o[12]*na+nr*o[10],Xr=M*o[3]*ml[1]+Lo*o[5]*Al[1]):'inf'==Vl?(ac=wr*o[0]*fl[1]+Pc*o[1]*wl[1]+ma*o[2]*bl[1]+za*o[12]*na+nr*o[10]+Qs,$r=Hl*o[4]*El[1]+di*o[6]*_l[1],Xr=M*o[3]*ml[1]+Lo*o[5]*Al[1]):'arc'==Vl?(ac=wr*o[0]*fl[1]+Pc*o[1]*wl[1]+ma*o[2]*bl[1]+za*o[12]*na+nr*o[10],$r=Hl*o[4]*El[1]+di*o[6]*_l[1],
Xr=M*o[3]*ml[1]+Lo*o[5]*Al[1]+Qs):(ac=wr*o[0]*fl[1]+Pc*o[1]*wl[1]+ma*o[2]*bl[1]+za*o[12]*na+nr*o[10],$r=Hl*o[4]*El[1]+di*o[6]*_l[1],Xr=M*o[3]*ml[1]+Lo*o[5]*Al[1]),jr=(Hr=ac*Qt)+(Wr=$r*Qt)+(Ur=Xr*Qt),wc=(hc=uc*Gt)+(_c=rc*Gt)+(mc=lc*Gt),console.log(jr,wc),Gl=0==Hr||0==hc?0:hc<=Hr?1:Math.pow(Hr/hc,.5)/(hc/Hr),Dl=0==Wr||0==_c?0:_c<=Wr?1:Math.pow(Wr/_c,.5)/(_c/Wr),Ml=0==Ur||0==mc?0:mc<=Ur?1:Math.pow(Ur/mc,.5)/(mc/Ur),Ol=0==Hr||0==hc?0:Hr<=hc?1:Math.pow(hc/Hr,.5)/(Hr/hc),Ll=0==Wr||0==_c?0:Wr<=_c?1:Math.pow(_c/Wr,.5)/(Wr/_c),Rl=0==Ur||0==mc?0:Ur<=mc?1:Math.pow(mc/Ur,.5)/(Ur/mc),Ui=Math.round(1e6*Ol)/1e6,Bi=Math.round(1e6*Ll)/1e6,Di=Math.round(1e6*Rl)/1e6,Wi=Math.round(1e6*Gl)/1e6,Vi=Math.round(1e6*Dl)/1e6,Gi=Math.round(1e6*Ml)/1e6,Rr=Math.round(-Mr*Wi+1e-6)+Math.round(-Pr*Vi+1e-6)+Math.round(-Nr*Gi+1e-6),zc=Math.round(-Hc*Wi+1e-6)+Math.round(-Yc*Vi+1e-6)+Math.round(-qc*Gi+1e-6),_a=Math.round(-ya*Wi+1e-6)+Math.round(-Ra*Vi+1e-6)+Math.round(-Sa*Gi+1e-6),
D=Math.round(-oa*Wi+1e-6)+Math.round(-la*Vi+1e-6)+Math.round(-ia*Gi+1e-6),Kl=Math.round(-no*Wi+1e-6)+Math.round(-ao*Vi+1e-6)+Math.round(-to*Gi+1e-6),Oo=Math.round(-Go*Wi+1e-6)+Math.round(-Uo*Vi+1e-6)+Math.round(-Bo*Gi+1e-6),gi=Math.round(-wi*Wi+1e-6)+Math.round(-fi*Vi+1e-6)+Math.round(-hi*Gi+1e-6),ys=Math.round(-Cs*Wi+1e-6)+Math.round(-Ms*Vi+1e-6)+Math.round(-Ps*Gi+1e-6),ln=Math.round(-mn*Wi+1e-6)+Math.round(-gn*Vi+1e-6)+Math.round(-pn*Gi+1e-6),ad=Math.round(-ud*Wi+1e-6)+Math.round(-dd*Vi+1e-6)+Math.round(-cd*Gi+1e-6),Ua=Math.round(-Ka*Wi+1e-6)+Math.round(-ja*Vi+1e-6)+Math.round(-Fa*Gi+1e-6),tl=Math.round(-dl*Wi+1e-6)+Math.round(-cl*Vi+1e-6)+Math.round(-rl*Gi+1e-6),or=Math.round(-br*Wi+1e-6)+Math.round(-mr*Vi+1e-6)+Math.round(-gr*Gi+1e-6),hr=Math.round(-wr*Ui+1e-6),Oc=Math.round(-Pc*Ui+1e-6),pa=Math.round(-ma*Ui+1e-6),Ma=Math.round(-za*Ui+1e-6),N=Math.round(-M*Di+1e-6),yo=Math.round(-Lo*Di+1e-6),ql=Math.round(-Hl*Bi+1e-6),ri=Math.round(-di*Bi+1e-6),
'cav'==Vl?(fs=Math.round(-vs*Bi+1e-6),$a=Math.round(-tn*Bi+1e-6),Xc=Math.round(-Jc*Bi+1e-6),Xi=Math.round(-Ji*Bi+1e-6)):'inf'==Vl?(fs=Math.round(-vs*Ui+1e-6),$a=Math.round(-tn*Ui+1e-6),Xc=Math.round(-Jc*Ui+1e-6),Xi=Math.round(-Ji*Ui+1e-6)):'arc'==Vl&&(fs=Math.round(-vs*Di+1e-6),$a=Math.round(-tn*Di+1e-6),Xc=Math.round(-Jc*Di+1e-6),Xi=Math.round(-Ji*Di+1e-6)),tr=100*nr==as?0:Math.round(-nr*Ui+1e-6),vr=wr+hr,Mc=Pc+Oc,ba=ma+pa,C=M+N,Fl=Hl+ql,Io=Lo+yo,ui=di+ri,Ss=vs+fs,an=tn+$a,$c=Jc+Xc,Da=za+Ma,ir=nr+tr,$i=Ji+Xi,Or=kr+Rr,Wc=Bc+zc,va=Aa+_a,q=U+D,eo=Xl+Kl,Do=Po+Oo,Ai=bi+gi,Ns=Ls+ys,un=sn+ln,rd=id+ad,Ha=Va+Ua,pr=rr+or,sl=nl+tl,co=hr*s[0]+Oc*s[1]+pa*s[2]+N*s[3]+ql*s[4]+yo*s[5]+ri*s[6]+fs*s[7]+$a*s[8]+Xi*s[9]+tr*s[10]+Xc*s[11]+Ma*s[12],go=Rr*s[0]+zc*s[1]+_a*s[2]+D*s[3]+Kl*s[4]+Oo*s[5]+gi*s[6]+ys*s[7]+ln*s[8]+tl*s[9]+or*s[10]+ad*s[11]+Ua*s[12],console.log(co,go),Rc=vr*s[0]+Mc*s[1]+ba*s[2]+C*s[3]+Fl*s[4]+Io*s[5]+ui*s[6]+Ss*s[7]+an*s[8]+$c*s[11]+Da*s[12]+ir*s[10]+$i*s[9],
Lc=Or*s[0]+Wc*s[1]+va*s[2]+q*s[3]+eo*s[4]+Do*s[5]+Ai*s[6]+Ns*s[7]+un*s[8]+rd*s[11]+Ha*s[12]+pr*s[10]+sl*s[9],console.log(Lc,Rc),os=vr*s[0]+Mc*s[1]+ba*s[2]+C*s[3]+Fl*s[4]+Io*s[5]+ui*s[6]+Ss*s[7]+an*s[8]+$i*s[9]+ir*s[10]+$c*s[11]+Da*s[12],Es=Or*s[0]+Wc*s[1]+va*s[2]+q*s[3]+eo*s[4]+Do*s[5]+Ai*s[6]+Ns*s[7]+un*s[8]+sl*s[9]+pr*s[10]+rd*s[11]+Ha*s[12],console.log(os,Es),Ys=Ss*s[7]+an*s[8]+$c*s[11]+$i*s[9],'cav'==Vl?(es=Fl*s[4]+ui*s[6]+Ys,ns=vr*s[0]+Mc*s[1]+ba*s[2]+Da*s[12]+ir*s[10],Zo=C*s[3]+Io*s[5]):'inf'==Vl?(ns=vr*s[0]+Mc*s[1]+ba*s[2]+Da*s[12]+ir*s[10]+Ys,es=Fl*s[4]+ui*s[6],Zo=C*s[3]+Io*s[5]):'arc'==Vl?(ns=vr*s[0]+Mc*s[1]+ba*s[2]+Da*s[12]+ir*s[10],es=Fl*s[4]+ui*s[6],Zo=C*s[3]+Io*s[5]+Ys):(ns=vr*s[0]+Mc*s[1]+ba*s[2]+Da*s[12]+ir*s[10],es=Fl*s[4]+ui*s[6],Zo=C*s[3]+Io*s[5]),vo=0==ns?0:Math.round(ns/os*1e4)/1e4,wo=0==es?0:Math.round(es/os*1e4)/1e4,fo=0==Zo?0:Math.round(Zo/os*1e4)/1e4,console.log(fo),Dr=Math.round(Or*vo),zr=Math.round(Or*wo),Cr=Or-zr-Dr,Kc=Math.round(Wc*vo),jc=Math.round(Wc*wo),
Fc=Wc-jc-Kc,Ia=Math.round(va*vo),La=Math.round(va*wo),ka=va-La-Ia,ca=Math.round(q*vo),ra=Math.round(q*wo),sa=q-ra-ca,oo=Math.round(eo*vo),lo=Math.round(eo*wo),io=eo-lo-oo,qo=Math.round(Do*vo),Wo=Math.round(Do*wo),Vo=Do-Wo-qo,Ri=Math.round(Ai*vo),Si=Math.round(Ai*wo),vi=Ai-Si-Ri,Bs=Math.round(Ns*vo),Ds=Math.round(Ns*wo),zs=Ns-Ds-Bs,_n=Math.round(un*vo),Tn=Math.round(un*wo),bn=un-Tn-_n,Er=Math.round(pr*vo),_r=Math.round(pr*wo),Tr=pr-_r-Er,md=Math.round(rd*vo),gd=Math.round(rd*wo),pd=rd-gd-md,Za=Math.round(Ha*vo),Xa=Math.round(Ha*wo),Qa=Ha-Xa-Za,gl=Math.round(sl*vo),pl=Math.round(sl*wo),ul=sl-pl-gl,bs=Dr*s[0]+Kc*s[1]+Ia*s[2]+Za*s[12]+Er*s[10]+oo*s[4]+Ri*s[6]+ca*s[3]+qo*s[5]+Bs*s[7]+_n*s[8]+md*s[11]+gl*s[9],ps=zr*s[0]+jc*s[1]+La*s[2]+Xa*s[12]+_r*s[10]+lo*s[4]+Si*s[6]+ra*s[3]+Wo*s[5]+Ds*s[7]+Tn*s[8]+gd*s[11]+pl*s[9],cs=Cr*s[0]+Fc*s[1]+ka*s[2]+Qa*s[12]+Tr*s[10]+io*s[4]+vi*s[6]+sa*s[3]+Vo*s[5]+zs*s[7]+bn*s[8]+pd*s[11]+ul*s[9],console.log(cs,ps,bs),
pc=Dr*n[0]*Zn[0]+Kc*n[1]*ti[0]+Ia*n[2]*kn[0]+Za*n[12]+Er*n[10]+oo*n[4]*Un[0]+Ri*n[6]*Cn[0]+ca*n[3]*vn[0]+qo*n[5]*qn[0]+Bs*n[7]*jn[0]+_n*n[8]*On[0]+md*n[11]+gl*n[9],cc=zr*i[0]*Zn[0]+jc*i[1]*ti[0]+La*i[2]*kn[0]+Xa*i[12]+_r*i[10]+lo*i[4]*Un[0]+Si*i[6]*Cn[0]+ra*i[3]*vn[0]+Wo*i[5]*qn[0]+Ds*i[7]*jn[0]+Tn*i[8]*On[0]+gd*i[11]+pl*i[9],oc=Cr*l[0]*Zn[0]+Fc*l[1]*ti[0]+ka*l[2]*kn[0]+Qa*l[12]+Tr*l[10]+io*l[4]*Un[0]+vi*l[6]*Cn[0]+sa*l[3]*vn[0]+Vo*l[5]*qn[0]+zs*l[7]*jn[0]+bn*l[8]*On[0]+pd*l[11]+ul*l[9],js=Ss*o[7]*hl[1]+an*o[8]*Tl[1]+$c*o[11]+$i*o[9],'cav'==Vl?(ec=Fl*o[4]*El[1]+ui*o[6]*_l[1]+js,nc=vr*o[0]*fl[1]+Mc*o[1]*wl[1]+ba*o[2]*bl[1]+Da*o[12]*na+ir*o[10],Zr=C*o[3]*ml[1]+Io*o[5]*Al[1]):'inf'==Vl?(nc=vr*o[0]*fl[1]+Mc*o[1]*wl[1]+ba*o[2]*bl[1]+Da*o[12]*na+ir*o[10]+js,ec=Fl*o[4]*El[1]+ui*o[6]*_l[1],Zr=C*o[3]*ml[1]+Io*o[5]*Al[1]):'arc'==Vl?(nc=vr*o[0]*fl[1]+Mc*o[1]*wl[1]+ba*o[2]*bl[1]+Da*o[12]*na+ir*o[10],ec=Fl*o[4]*El[1]+ui*o[6]*_l[1],
Zr=C*o[3]*ml[1]+Io*o[5]*Al[1]+js):(nc=vr*o[0]*fl[1]+Mc*o[1]*wl[1]+ba*o[2]*bl[1]+Da*o[12]*na+ir*o[10],ec=Fl*o[4]*El[1]+ui*o[6]*_l[1],Zr=C*o[3]*ml[1]+Io*o[5]*Al[1]),Kr=(Fr=nc*Qt)+(qr=ec*Qt)+(Gr=Zr*Qt),vc=(fc=pc*Gt)+(Ec=cc*Gt)+(bc=oc*Gt),console.log(Kr,vc),Bl=0==Fr||0==fc?0:fc<=Fr?1:Math.pow(Fr/fc,.5)/(fc/Fr),Cl=0==qr||0==Ec?0:Ec<=qr?1:Math.pow(qr/Ec,.5)/(Ec/qr),Nl=0==Gr||0==bc?0:bc<=Gr?1:Math.pow(Gr/bc,.5)/(bc/Gr),Il=0==Fr||0==fc?0:Fr<=fc?1:Math.pow(fc/Fr,.5)/(Fr/fc),yl=0==qr||0==Ec?0:qr<=Ec?1:Math.pow(Ec/qr,.5)/(qr/Ec),vl=0==Gr||0==bc?0:Gr<=bc?1:Math.pow(bc/Gr,.5)/(Gr/bc),Hi=Math.round(1e6*Il)/1e6,Yi=Math.round(1e6*yl)/1e6,qi=Math.round(1e6*vl)/1e6,Ki=Math.round(1e6*Bl)/1e6,ji=Math.round(1e6*Cl)/1e6,Fi=Math.round(1e6*Nl)/1e6,yr=Math.round(-Dr*Ki+1e-6)+Math.round(-zr*ji+1e-6)+Math.round(-Cr*Fi+1e-6),Dc=Math.round(-Kc*Ki+1e-6)+Math.round(-jc*ji+1e-6)+Math.round(-Fc*Fi+1e-6),Ea=Math.round(-Ia*Ki+1e-6)+Math.round(-La*ji+1e-6)+Math.round(-ka*Fi+1e-6),
B=Math.round(-ca*Ki+1e-6)+Math.round(-ra*ji+1e-6)+Math.round(-sa*Fi+1e-6),Ql=Math.round(-oo*Ki+1e-6)+Math.round(-lo*ji+1e-6)+Math.round(-io*Fi+1e-6),No=Math.round(-qo*Ki+1e-6)+Math.round(-Wo*ji+1e-6)+Math.round(-Vo*Fi+1e-6),mi=Math.round(-Ri*Ki+1e-6)+Math.round(-Si*ji+1e-6)+Math.round(-vi*Fi+1e-6),ks=Math.round(-Bs*Ki+1e-6)+Math.round(-Ds*ji+1e-6)+Math.round(-zs*Fi+1e-6),on=Math.round(-_n*Ki+1e-6)+Math.round(-Tn*ji+1e-6)+Math.round(-bn*Fi+1e-6),nd=Math.round(-md*Ki+1e-6)+Math.round(-gd*ji+1e-6)+Math.round(-pd*Fi+1e-6),Ga=Math.round(-Za*Ki+1e-6)+Math.round(-Xa*ji+1e-6)+Math.round(-Qa*Fi+1e-6),al=Math.round(-gl*Ki+1e-6)+Math.round(-pl*ji+1e-6)+Math.round(-ul*Fi+1e-6),sr=Math.round(-Er*Ki+1e-6)+Math.round(-_r*ji+1e-6)+Math.round(-Tr*Fi+1e-6),fr=Math.round(-vr*Hi+1e-6),Nc=Math.round(-Mc*Hi+1e-6),ga=Math.round(-ba*Hi+1e-6),Ca=Math.round(-Da*Hi+1e-6),P=Math.round(-C*qi+1e-6),ko=Math.round(-Io*qi+1e-6),Yl=Math.round(-Fl*Yi+1e-6),ci=Math.round(-ui*Yi+1e-6),
'cav'==Vl?(ws=Math.round(-Ss*Yi+1e-6),en=Math.round(-an*Yi+1e-6),Zc=Math.round(-$c*Yi+1e-6),Zi=Math.round(-$i*Yi+1e-6)):'inf'==Vl?(ws=Math.round(-Ss*Hi+1e-6),en=Math.round(-an*Hi+1e-6),Zc=Math.round(-$c*Hi+1e-6),Zi=Math.round(-$i*Hi+1e-6)):'arc'==Vl&&(ws=Math.round(-Ss*qi+1e-6),en=Math.round(-an*qi+1e-6),Zc=Math.round(-$c*qi+1e-6),Zi=Math.round(-$i*qi+1e-6)),ar=100*ir==ns?0:Math.round(-ir*Hi+1e-6),ft=vr+fr,wt=Mc+Nc,vt=ba+ga,St=C+P,xt=Fl+Yl,Ot=Io+ko,Nt=ui+ci,kt=Ss+ws,Lt=an+en,It=$c+Zc,Pt=Da+Ca,Rt=ir+ar,yt=$i+Zi,ve=Or+yr,Se=Wc+Dc,Re=va+Ea,ye=q+B,Ne=eo+Ql,Pe=Do+No,Me=Ai+mi,Ie=Ns+ks,xe=un+on,Oe=rd+nd,Ce=Ha+Ga,ke=pr+sr,Le=sl+al,uo=fr*s[0]+Nc*s[1]+ga*s[2]+P*s[3]+Yl*s[4]+ko*s[5]+ci*s[6]+ws*s[7]+en*s[8]+Zi*s[9]+ar*s[10]+Zc*s[11]+Ca*s[12],mo=yr*s[0]+Dc*s[1]+Ea*s[2]+B*s[3]+Ql*s[4]+No*s[5]+mi*s[6]+ks*s[7]+on*s[8]+al*s[9]+sr*s[10]+nd*s[11]+Ga*s[12],console.log(uo,mo),yc=ft*s[0]+wt*s[1]+vt*s[2]+St*s[3]+xt*s[4]+Ot*s[5]+Nt*s[6]+kt*s[7]+Lt*s[8]+It*s[11]+Pt*s[12]+Rt*s[10]+yt*s[9],
Ic=ve*s[0]+Se*s[1]+Re*s[2]+ye*s[3]+Ne*s[4]+Pe*s[5]+Me*s[6]+Ie*s[7]+xe*s[8]+Oe*s[11]+Ce*s[12]+ke*s[10]+Le*s[9],console.log(Ic,yc),Qe=-ze+ft,Xe=-De+wt,Ze=-Be+vt,Je=-Ue+St,it=-He+xt,lt=-Fe+Ot,ot=-je+Nt,tt=-We+kt,at=-qe+Lt,nt=-Ye+It,st=-Ke+Pt,$e=-Ge+Rt,et=-Ve+yt,ne=-Y+ve,ie=-H+Se,le=-F+Re,oe=-j+ye,pe=-$+Ne,ge=-ee+Pe,me=-te+Me,ce=-X+Ie,de=-Z+xe,ue=-J+Oe,be=-ae+Ce,se=-K+ke,re=-Q+Le,Ws=0==kt?0:kt*Qt*xi[1],Li=20==Dt?18:19==Dt?17:18==Dt?15:17==Dt?14:16==Dt?13:15==Dt?11:14==Dt?10:13==Dt||12==Dt?9:11==Dt?8:10==Dt?7:9==Dt||8==Dt?6:7==Dt||6==Dt?5:5==Dt||4==Dt||3==Dt?4:2==Dt||1==Dt?3:0,Us=0==Oa?0:2*Li,Gs=0==Ws||0==Us?0:-Ws/Us,oi=Dt<=$s?Dt:Dt-$s<-Gs?Dt<$s?Dt:$s:Dt+Gs,Bt=Math.round(oi),Ct='wall'==A?Bt:v[t.BATTLE_TARGET_LEVEL],hn=0==Lt||0==Ct?0:Lt*Qt*Tl[1],
yi='headquarter'==A?30==Ct?72:29==Ct?65:28==Ct?59:27==Ct?54:26==Ct?50:25==Ct?45:24==Ct?41:23==Ct?36:22==Ct?33:21==Ct?30:20==Ct?27:19==Ct?26:18==Ct?23:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'wall'==A?20==Bt?18:19==Bt?17:18==Bt?15:17==Bt?14:16==Bt?13:15==Bt?11:14==Bt?10:13==Bt||12==Bt?9:11==Bt?8:10==Bt?7:9==Bt||8==Bt?6:7==Bt||6==Bt?5:5==Bt||4==Bt||3==Bt?4:2==Bt||1==Bt?3:0:'tavern'==A?15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'hospital'==A?10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'satue'==A?5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'rally_point'==A?5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'church'==A?3==Ct||2==Ct||1==Ct?800:0:'academy'==A?1==Ct?500:0:'preceptory'==A?10==Ct?71:9==Ct?43:8==Ct?39:7==Ct?35:6==Ct?32:5==Ct?29:4==Ct?27:3==Ct?24:2==Ct?22:1==Ct?20:0:'barracks'==A?25==Ct?30:24==Ct?27:23==Ct?24:22==Ct?22:21==Ct?20:20==Ct?18:19==Ct?17:18==Ct?15:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'market'==A?25==Ct?30:24==Ct?27:23==Ct?24:22==Ct?22:21==Ct?20:20==Ct?18:19==Ct?17:18==Ct?15:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'warehouse'==A?30==Ct?48:29==Ct?43:28==Ct?39:27==Ct?36:26==Ct?33:25==Ct?30:24==Ct?27:23==Ct?24:22==Ct?22:21==Ct?20:20==Ct?18:19==Ct?17:18==Ct?15:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'timber_camp'==A?30==Ct?48:29==Ct?43:28==Ct?39:27==Ct?36:26==Ct?33:25==Ct?30:24==Ct?27:23==Ct?24:22==Ct?22:21==Ct?20:20==Ct?18:19==Ct?17:18==Ct?15:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'clay_pit'==A?30==Ct?48:29==Ct?43:28==Ct?39:27==Ct?36:26==Ct?33:25==Ct?30:24==Ct?27:23==Ct?24:22==Ct?22:21==Ct?20:20==Ct?18:19==Ct?17:18==Ct?15:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'iron_mine'==A?30==Ct?48:29==Ct?43:28==Ct?39:27==Ct?36:26==Ct?33:25==Ct?30:24==Ct?27:23==Ct?24:22==Ct?22:21==Ct?20:20==Ct?18:19==Ct?17:18==Ct?15:17==Ct?14:16==Ct?13:15==Ct?11:14==Ct?10:13==Ct||12==Ct?9:11==Ct?8:10==Ct?7:9==Ct||8==Ct?6:7==Ct||6==Ct?5:5==Ct||4==Ct||3==Ct?4:2==Ct||1==Ct?3:0:'farm'==A?30==Ct?79:29==Ct?72:28==Ct?66:27==Ct?60:26==Ct?54:25==Ct?49:24==Ct?45:23==Ct?41:22==Ct?37:21==Ct?34:20==Ct?31:19==Ct?28:18==Ct?25:17==Ct?23:16==Ct?21:15==Ct?19:14==Ct?17:13==Ct?16:12==Ct?14:11==Ct?13:10==Ct?12:9==Ct?11:8==Ct?10:7==Ct?9:6==Ct?8:5==Ct||4==Ct?7:2==Ct||3==Ct?6:1==Ct?5:0:0,
En=0==Ct?0:yi*Gt,An=0==hn||0==En?0:-hn/En,li='wall'==A?oi<=$s?oi:oi-$s<-An?oi<$s?oi:$s:oi+An:An+Ct<=0?0:An+Ct,zt=Math.round(li),console.log(zt),$t=Qe*s[0]+Xe*s[1]+Ze*s[2]+Je*s[3]+it*s[4]+lt*s[5]+ot*s[6]+tt*s[7]+at*s[8]+et*s[9]+$e*s[10]+nt*s[11]+st*s[12],Yt=ne*s[0]+ie*s[1]+le*s[2]+oe*s[3]+pe*s[4]+ge*s[5]+me*s[6]+ce*s[7]+de*s[8]+re*s[9]+se*s[10]+ue*s[11]+be*s[12],Jt=ne*a[0]+ie*a[1]+le*a[2]+oe*a[3]+pe*a[4]+ge*a[5]+me*a[6]+ce*a[7]+de*a[8]+re*a[9]+se*a[10]+ue*a[11]+be*a[12],qt=Qe*e[0]+Xe*e[1]+Ze*e[2]+Je*e[3]+it*e[4]+lt*e[5]+ot*e[6]+tt*e[7]+at*e[8]+et*e[9]+$e*e[10]+nt*e[11]+st*e[12],console.log(Jt,qt),ta=0==Xt||0==$t?0:Math.round(-$t/Xt*1e3)/1e3,console.log(ta),wd=Y+H+F+ae>$+te&&Y+H+F+ae>j+ee?'inf':$+te>Y+H+F+ae&&$+te>j+ee?'cav':'arc',ea='inf'==Vl?'piechota':'cav'==Vl?'kawaleria':'łucznicy',console.log(ea),Ht='inf'==wd?'piechota':'cav'==wd?'kawaleria':'łucznicy',console.log(Ht),Ft=0==Vt||0==Yt?0:Math.round(-Yt/Vt*1e3)/1e3,console.log(Ft),rt=Math.round(Qe*(Yo+Js)),ct=Math.round(Xe*(Yo+Js)),
dt=Math.round(Ze*(Yo+Js)),ut=Math.round(Je*(Yo+Js)),_t=Math.round(it*(Yo+Js)),Et=Math.round(lt*(Yo+Js)),At=Math.round(ot*(Yo+Js)),mt=Math.round(tt*(Yo+Js)),bt=Math.round(at*(Yo+Js)),pt=Math.round($e*(Yo+Js)),gt=Math.round(et*(Yo+Js)),Tt=Math.round(nt*(Yo+Js)),ht=Math.round(st*(Yo+Js)),console.log(rt,ct,dt,ut,_t,Et,At,mt,bt,pt,gt,Tt,ht),Kt=Ii+Zs,0==Ii?(Te=0,_e=0,Ee=0,Ae=0,he=0,fe=0,we=0):Ii<1e3?Kt<=(oe+ne+ie+le)/2?(Te=Math.round(ne/2),_e=Math.round(ie/2),Ee=Math.round(le/2),Ae=Math.round(oe/2),he=0,fe=0,we=0):(Te=Math.round(ne*Kt/(oe+ne+ie+le)),_e=Math.round(ie*Kt/(oe+ne+ie+le)),Ee=Math.round(le*Kt/(oe+ne+ie+le)),Ae=Math.round(oe*Kt/(oe+ne+ie+le)),he=0,fe=0,we=0):Kt<=(oe+ne+ie+le+4*pe+5*ge+6*me)/2?(Te=Math.round(ne/2),_e=Math.round(ie/2),Ee=Math.round(le/2),Ae=Math.round(oe/2),he=Math.round(pe/2),fe=Math.round(ge/2),we=Math.round(me/2)):(Te=Math.round(ne*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me)),_e=Math.round(ie*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me)),Ee=Math.round(le*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me)),
Ae=Math.round(oe*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me)),he=Math.round(pe*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me)),fe=Math.round(ge*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me)),we=Math.round(me*Kt/(oe+ne+ie+le+4*pe+5*ge+6*me))),console.log(Te,_e,Ee,Ae,he,fe,we),aa=Xt+$t,jt=Vt+Yt},qa.calculateT=function(){const e=v[t.TROOPS_SPEAR],a=v[t.TROOPS_SWORD],n=v[t.TROOPS_AXE],i=v[t.TROOPS_ARCHER],l=v[t.TROOPS_LC],o=v[t.TROOPS_MA],s=v[t.TROOPS_HC],r=v[t.TROOPS_RAM],c=v[t.TROOPS_CATAPULT],d=v[t.TROOPS_DOPPELSOLDNER],u=v[t.TROOPS_TREBUCHET],p=v[t.TROOPS_SNOB],g=v[t.TROOPS_KNIGHT],m=v[t.TROOPS_BARRACKS],b=v[t.TROOPS_PRECEPTORY],T=v[t.TROOPS_ORDER],_=v[t.TROOPS_TRAINING]
;var E=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],A=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],h=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],f=[1,1,1,1,4,5,6,5,8,1,100,10,6],w=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],S=[10,25,45,25,130,150,150,2,100,150,30,30,300],R=[25,55,10,10,30,40,200,20,100,250,100,200,100],y=[45,5,5,30,40,30,160,50,50,400,50,250,100],k=[10,30,10,60,30,50,180,20,100,150,100,200,50],L=[8,9,14,18,24,35,50,0],Y=[25,15,10,10,80,50,50,0,0,100,0,0,10],H=[0,33,66,99];let F=0,j=1,K=1,Q=1,X=1,Z=1,J=1,$=1,ee=1,te=0;var ae,ne,ie,le;K=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,te='level_1'==_?1.04:'level_2'==_?1.08:'level_3'==_?1.12:'level_4'==_?1.16:'level_5'==_?1.2:1,X=1==b?1.01:2==b?1.02:3==b?1.03:4==b?1.04:5==b?1.05:6==b?1.06:7==b?1.07:8==b?1.08:9==b?1.09:10==b?1.1:1,Q=v[t.TROOPS_DOMINATION]?1.1:1,
W=u>0?L[6]+' minut':p>0?L[5]+' minut':r>0||c>0?L[4]+' minuty':a>0?L[3]+' minut':e>0||n>0||i>0||d>0?L[2]+' minut':s>0?L[1]+' minut':l>0||o>0||g>0?L[0]+' minut':L[7]+' minut',V=m>=7&&m<14?H[1]:m>=14&&m<23?H[2]:m>=23?H[3]:H[0],J=j/(Q*te),Z=J/K,$=Z/X,ee=j/X,F='troops.teutonic'==T?$*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+ee*(u*w[11])+Z*(n*w[2]+l*w[4]+o*w[5]+r*w[7]+c*w[8])+d*w[12]+g*w[9]+p*w[10]:'troops.templars'==T?Z*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+u*w[11]+$*(n*w[2]+l*w[4]+o*w[5]+r*w[7]+c*w[8])+ee*(d*w[12])+g*w[9]+p*w[10]:Z*(e*w[0]+a*w[1]+i*w[3]+s*w[6])+u*w[11]+Z*(n*w[2]+l*w[4]+o*w[5]+r*w[7]+c*w[8])+d*w[12]+g*w[9]+p*w[10],I=e*E[0]+a*E[1]+n*E[2]+i*E[3]+l*E[4]+o*E[5]+s*E[6]+r*E[7]+c*E[8]+g*E[9]+p*E[10]+u*E[11]+d*E[12],x=e*A[0]+a*A[1]+n*A[2]+i*A[3]+l*A[4]+o*A[5]+s*A[6]+r*A[7]+c*A[8]+g*A[9]+p*A[10]+u*A[11]+d*A[12],O=e*h[0]+a*h[1]+n*h[2]+i*h[3]+l*h[4]+o*h[5]+s*h[6]+r*h[7]+c*h[8]+g*h[9]+p*h[10]+u*h[11]+d*h[12],N=e*f[0]+a*f[1]+n*f[2]+i*f[3]+l*f[4]+o*f[5]+s*f[6]+r*f[7]+c*f[8]+g*f[9]+p*f[10]+u*f[11]+d*f[12],
G=e*S[0]+a*S[1]+n*S[2]+i*S[3]+l*S[4]+o*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+p*S[10]+u*S[11]+d*S[12],D=e*R[0]+a*R[1]+n*R[2]+i*R[3]+l*R[4]+o*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+p*R[10]+u*R[11]+d*R[12],B=e*y[0]+a*y[1]+n*y[2]+i*y[3]+l*y[4]+o*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+p*y[10]+u*y[11]+d*y[12],U=e*k[0]+a*k[1]+n*k[2]+i*k[3]+l*k[4]+o*k[5]+s*k[6]+r*k[7]+c*k[8]+g*k[9]+p*k[10]+u*k[11]+d*k[12],P=e*Y[0]+a*Y[1]+n*Y[2]+i*Y[3]+l*Y[4]+o*Y[5]+s*Y[6]+r*Y[7]+c*Y[8]+g*Y[9]+p*Y[10]+u*Y[11]+d*Y[12],ae=F,ne='',ie=new Date(1e3*ae).toISOString().substr(11,8),(le=Math.floor(ae/86400))>1?ne=le+' dni i ':le>0&&(ne='1 dzień i '),q=ne+=ie,M=e*S[0]+a*S[1]+n*S[2]+r*S[7]+c*S[8]+u*S[11]+d*S[12],C=l*S[4]+s*S[6]+g*S[9],z=i*S[3]+o*S[5]},qa.start=function(){R=!0,f.trigger(s.BATTLE_CALCULATOR_START)},qa.stop=function(){R=!1,f.trigger(s.BATTLE_CALCULATOR_STOP)},qa.getSettings=function(){return w},qa.isInitialized=function(){return S},qa.isRunning=function(){return R},qa.getBashpointsAtt=function(){return L},
qa.getBashpointsDef=function(){return k},qa.getWoodAmount=function(){return I},qa.getClayAmount=function(){return x},qa.getIronAmount=function(){return O},qa.getLoadAmount=function(){return P},qa.getFoodAmount=function(){return N},qa.getDefInf=function(){return D},qa.getDefCav=function(){return B},qa.getDefArc=function(){return U},qa.getAttInf=function(){return M},qa.getAttCav=function(){return C},qa.getAttArc=function(){return z},qa.getSpeed=function(){return W},qa.getBuildTime=function(){return q},qa.getDiscipline=function(){return V},qa.getPower=function(){return G},qa.getTarget=function(){return Mt},qa.getBuildingfrom=function(){return Ct},qa.getBuildingto=function(){return zt},qa.getWallfrom=function(){return Dt},qa.getWallto=function(){return Bt},qa.getWallfrompre=function(){return Ut},qa.getWalltopre=function(){return Dt},qa.getDefencemodifier=function(){return Gt},qa.getDefenceprovisions=function(){return Vt},qa.getStrentghdefend=function(){return Wt},
qa.getDefencebashpoint=function(){return qt},qa.getDefencekilledprovisions=function(){return Yt},qa.getStrongesttypedef=function(){return Ht},qa.getKillrated=function(){return Ft},qa.getDefencesurvivedprovisions=function(){return jt},qa.getAvailablebeds=function(){return Kt},qa.getAttackmodifier=function(){return Qt},qa.getAttackprovisions=function(){return Xt},qa.getStrentghattack=function(){return Zt},qa.getAttackbashpoint=function(){return Jt},qa.getAttackkilledprovisions=function(){return $t},qa.getStrongesttypeoff=function(){return ea},qa.getKillratea=function(){return ta},qa.getAttacksurvivedprovisions=function(){return aa},qa.getDoublestrength=function(){return na},qa.getSpeardAmount=function(){return Y},qa.getSpeardLosses=function(){return ne},qa.getSpeardRevived=function(){return Te},qa.getSpeardSurvived=function(){return ve},qa.getSworddAmount=function(){return H},qa.getSworddLosses=function(){return ie},qa.getSworddRevived=function(){return _e},
qa.getSworddSurvived=function(){return Se},qa.getAxedAmount=function(){return F},qa.getAxedLosses=function(){return le},qa.getAxedRevived=function(){return Ee},qa.getAxedSurvived=function(){return Re},qa.getArcherdAmount=function(){return j},qa.getArcherdLosses=function(){return oe},qa.getArcherdRevived=function(){return Ae},qa.getArcherdSurvived=function(){return ye},qa.getSnobdAmount=function(){return K},qa.getSnobdLosses=function(){return se},qa.getSnobdSurvived=function(){return ke},qa.getKnightdAmount=function(){return Q},qa.getKnightdLosses=function(){return re},qa.getKnightdSurvived=function(){return Le},qa.getRamdAmount=function(){return X},qa.getRamdLosses=function(){return ce},qa.getRamdSurvived=function(){return Ie},qa.getCatapultdAmount=function(){return Z},qa.getCatapultdLosses=function(){return de},qa.getCatapultdSurvived=function(){return xe},qa.getTrebuchetdAmount=function(){return J},qa.getTrebuchetdLosses=function(){return ue},qa.getTrebuchetdSurvived=function(){
return Oe},qa.getLcdAmount=function(){return $},qa.getLcdLosses=function(){return pe},qa.getLcdRevived=function(){return he},qa.getLcdSurvived=function(){return Ne},qa.getMadAmount=function(){return ee},qa.getMadLosses=function(){return ge},qa.getMadRevived=function(){return fe},qa.getMadSurvived=function(){return Pe},qa.getHcdAmount=function(){return te},qa.getHcdLosses=function(){return me},qa.getHcdRevived=function(){return we},qa.getHcdSurvived=function(){return Me},qa.getBerserkerdAmount=function(){return ae},qa.getBerserkerdLosses=function(){return be},qa.getBerserkerdSurvived=function(){return Ce},qa.getSpearaAmount=function(){return ze},qa.getSpearaLosses=function(){return Qe},qa.getSpearaRevived=function(){return rt},qa.getSpearaSurvived=function(){return ft},qa.getSwordaAmount=function(){return De},qa.getSwordaLosses=function(){return Xe},qa.getSwordaRevived=function(){return ct},qa.getSwordaSurvived=function(){return wt},qa.getAxeaAmount=function(){return Be},
qa.getAxeaLosses=function(){return Ze},qa.getAxeaRevived=function(){return dt},qa.getAxeaSurvived=function(){return vt},qa.getArcheraAmount=function(){return Ue},qa.getArcheraLosses=function(){return Je},qa.getArcheraRevived=function(){return ut},qa.getArcheraSurvived=function(){return St},qa.getSnobaAmount=function(){return Ge},qa.getSnobaLosses=function(){return $e},qa.getSnobaRevived=function(){return pt},qa.getSnobaSurvived=function(){return Rt},qa.getKnightaAmount=function(){return Ve},qa.getKnightaLosses=function(){return et},qa.getKnightaRevived=function(){return gt},qa.getKnightaSurvived=function(){return yt},qa.getRamaAmount=function(){return We},qa.getRamaLosses=function(){return tt},qa.getRamaRevived=function(){return mt},qa.getRamaSurvived=function(){return kt},qa.getCatapultaAmount=function(){return qe},qa.getCatapultaLosses=function(){return at},qa.getCatapultaRevived=function(){return bt},qa.getCatapultaSurvived=function(){return Lt},qa.getTrebuchetaAmount=function(){
return Ye},qa.getTrebuchetaLosses=function(){return nt},qa.getTrebuchetaRevived=function(){return Tt},qa.getTrebuchetaSurvived=function(){return It},qa.getLcaAmount=function(){return He},qa.getLcaLosses=function(){return it},qa.getLcaRevived=function(){return _t},qa.getLcaSurvived=function(){return xt},qa.getMaaAmount=function(){return Fe},qa.getMaaLosses=function(){return lt},qa.getMaaRevived=function(){return Et},qa.getMaaSurvived=function(){return Ot},qa.getHcaAmount=function(){return je},qa.getHcaLosses=function(){return ot},qa.getHcaRevived=function(){return At},qa.getHcaSurvived=function(){return Nt},qa.getBerserkeraAmount=function(){return Ke},qa.getBerserkeraLosses=function(){return st},qa.getBerserkeraRevived=function(){return ht},qa.getBerserkeraSurvived=function(){return Pt},qa.getPresetBerserker=function(){return Ta},qa.getPresetAxe=function(){return oa},qa.getPresetArcher=function(){return sa},qa.getPresetSnob=function(){return ga},qa.getPresetKnight=function(){return ma},
qa.getPresetHc=function(){return da},qa.getPresetLc=function(){return ra},qa.getPresetMa=function(){return ca},qa.getPresetRam=function(){return ua},qa.getPresetCatapult=function(){return pa},qa.getPresetSpear=function(){return ia},qa.getPresetSword=function(){return la},qa.getPresetTrebuchet=function(){return ba},qa.getVillageBerserker=function(){return ha},qa.getVillageAxe=function(){return Ea},qa.getVillageArcher=function(){return _a},qa.getVillageSnob=function(){return ya},qa.getVillageKnight=function(){return wa},qa.getVillageHc=function(){return fa},qa.getVillageLc=function(){return va},qa.getVillageMa=function(){return Sa},qa.getVillageRam=function(){return Ra},qa.getVillageCatapult=function(){return Aa},qa.getVillageSpear=function(){return ka},qa.getVillageSword=function(){return La},qa.getVillageTrebuchet=function(){return Ia},qa})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',
BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','struct/MapData','two/utils'],(function(e,t,n,l,o,r,d,u,p,m,b,T,_,E,A,h,f,w,v){let S,R,y,k,L=i.getPresetList(),I=!1;const x={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},O=function(e,t){I=t.data},N=function(){I=!1},P=function(e){S.selectedTab=e},M=function(){t.isRunning()?t.stop():t.start()},C=function(){
if(!I)return v.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'battle_calculator'));w.loadTownDataAsync(I.x,I.y,1,1,(function(e){k.origin=e}))},z=function(){S.spearDsurvived>0||S.swordDsurvived>0||S.axeDsurvived>0||S.archerDsurvived>0||S.lcDsurvived>0||S.maDsurvived>0||S.hcDsurvived>0||S.ramDsurvived>0||S.catapultDsurvived>0||S.snobDsurvived>0||S.knightDsurvived>0||S.trebuchetDsurvived>0||S.berserkerDsurvived>0?(S.settings[n.BATTLE_SPEAR_D]=t.getSpeardSurvived(),S.settings[n.BATTLE_SWORD_D]=t.getSworddSurvived(),S.settings[n.BATTLE_AXE_D]=t.getAxedSurvived(),S.settings[n.BATTLE_ARCHER_D]=t.getArcherdSurvived(),S.settings[n.BATTLE_RAM_D]=t.getRamdSurvived(),S.settings[n.BATTLE_CATAPULT_D]=t.getCatapultdSurvived(),S.settings[n.BATTLE_SNOB_D]=t.getSnobdSurvived(),S.settings[n.BATTLE_KNIGHT_D]=t.getKnightdSurvived(),S.settings[n.BATTLE_TREBUCHET_D]=t.getTrebuchetdSurvived(),S.settings[n.BATTLE_DOPPELSOLDNER_D]=t.getBerserkerdSurvived(),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,p,g,m,b,T,_,E){let A,h,f,w=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),R=!1,y=!1;const k={};let L,I,x,O,N,P=!0;const M='builder_queue_log',C='builder_queue_settings',z=function(){const e=B();if(!P)return H.stop(),!1;e.forEach((function(e){const t=I.getVillage(e),a=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){B().forEach((function(e){const t=I.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&v.instantBuild(a,b.MASS_SCREEN,!0,e)}))}}))},B=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=L.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(k);const i=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),q(t))return!1;i.some((function(a){if(++n[a]>t[a])return w.compute(e),G(e,a,(function(t,a){t&&a.job&&(T.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},G=function(e,t,a){const n=W(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=f[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:b.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},q=function(e){for(let t in e)if(e[t]<f[t])return!1;return!0},Y=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),_.set(M,x),!0};let H={};return H.start=function(){if(!P)return T.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,A=setInterval(z,6e4),h=setInterval(D,6e3),e((function(){B().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),T.trigger(s.BUILDER_QUEUE_START)},H.stop=function(){y=!1,clearInterval(A),
clearInterval(h),T.trigger(s.BUILDER_QUEUE_STOP)},H.isRunning=function(){return y},H.isInitialized=function(){return R},H.getSettings=function(){return O},H.getLogs=function(){return x},H.clearLogs=function(){x=[],_.set(M,x),T.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},H.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},H.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=i.getGameData().getBuildings();for(let a=0;a<e.length;a++){let n=e[a];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},H.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},H.init=function(){R=!0,x=_.get(M,[],!0),I=i.getSelectedCharacter(),L=i.getGroupList(),O=new n({settingsMap:c,storageKey:C}),O.onChange((function(e,t,a){N=O.getAll(),y&&t[d.ANALYSE]&&z(),a.quiet||T.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,f=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=I.getVillage(t.village_id);U(e)}),1e3)}))},H})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a];Array.isArray(n)?(n.sort(()=>Math.random()-.5),t=t.concat(n)):t.push(n)}return t}
...
define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,n,d,u,p,b,T,E,A,h,f,w){let v,S,R,y,k=i.getGroupList(),L={},I=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,C={},z={},D=!1,B=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},G=function(e,a,n){if(n>=e.length){let a=n-e.length+1;for(;a--;)e.push(t)}e.splice(n,0,e.splice(a,1)[0])},V=function(e,t){switch(n.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case E.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}}
;O.generateSequences=function(){const e=y.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=v.settings[b.ACTIVE_SEQUENCE].value,t=v.settings[b.BUILDING_SEQUENCES][e],a=i.getGameData().getBuildings();let n={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in A)n[A[e]]=0;O.buildingSequence=t.map((function(e){let t=++n[e],l=a[e].individual_level_costs[t],o='not-reached';return!function(e,t){return i.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=i.getSelectedVillage().getBuildingQueue().getQueue();let n=!1;return a.some((function(a){if(a.building===e&&a.level===t)return n=!0})),n}(e,t)&&(o='progress'):o='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:w.readableSeconds(l.build_time),levelPoints:L[e][t-1],state:o}}))},
O.generateBuildingSequenceFinal=function(e){const t=v.settings[b.ACTIVE_SEQUENCE].value,a=v.settings[b.BUILDING_SEQUENCES][e||t];let n={},i=[];for(let e in R)n[e]={level:0,order:R[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++n[e].level,a=R[e].individual_level_costs[t];n[e].resources.wood+=parseInt(a.wood,10),n[e].resources.clay+=parseInt(a.clay,10),n[e].resources.iron+=parseInt(a.iron,10),n[e].resources.food+=parseInt(a.food,10),n[e].build_time+=parseInt(a.build_time,10),n[e].points+=L[e][t-1]}));for(let e in n)0!==n[e].level&&i.push({building:e,level:n[e].level,order:n[e].order,resources:n[e].resources,points:n[e].points,build_time:n[e].build_time});O.buildingSequenceFinal=i},O.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequence.offset,t=v.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),v.pagination.buildingSequence.count=O.buildingSequence.length},
O.generateBuildingsLevelPoints=function(){const e=i.getGameData();let t;for(let a in e.data.buildings){let n=e.getBuildingDataForBuilding(a);t=0,L[a]=[];for(let e=1;e<=n.max_level;e++){let i=U(n.points,n.points_factor,e)-t;t+=i,L[a].push(i)}}},x.moveUp=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let n=e[a];n.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===n.building&&(e[a-1].level++,n.level--,t=!0),G(e,a,a-1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(D=!0)},x.moveDown=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let n=e[a];n.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===n.building&&(e[a+1].level--,n.level++,t=!0),G(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(D=!0)},x.addBuilding=function(e,t,a=1){const n=t-1;let i=x.buildingSequence.slice(),l={level:null,building:e,checked:!1};for(let e=0;e<a;e++)i.splice(n,0,l)
;return x.buildingSequence=x.updateLevels(i,e),x.updateVisibleBuildingSequence(),D=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),D=!0},x.updateLevels=function(e,t){let a=0,n=[];for(let i=0;i<e.length;i++){let l=e[i];l.building===t?a<R[t].max_level&&n.push({level:++a,building:t,checked:!1}):n.push(l)}return n},x.generateBuildingSequence=function(){const e=y.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let n={};for(let e in A)n[A[e]]=0;x.buildingSequence=a.map((function(e){return{level:++n[e],building:e,checked:!1}})),x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequenceEditor.offset,t=v.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),
v.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(n.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:D=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),n.removeSequence(x.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){
...
t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',v),M=v.closeWindow,v.closeWindow=j,v.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),v.$watch('editorView.selectedSequence.value',(function(e,t){B?B=!1:e!==t&&(D?F((function(){K.generateBuildingSequencesEditor(),D=!1}),(function(){v.editorView.selectedSequence={name:t,value:t},B=!0})):K.generateBuildingSequencesEditor())}))};return function(){R=i.getGameData().getBuildings(),O.generateBuildingsLevelPoints(),y=n.getSettings(),S=e.addMenuButton2('Budowniczy',20,g('i18n')('general.description',a.loc.ale,'builder_queue')),S.addEventListener('click',Q),f.register(s.BUILDER_QUEUE_START,(function(){I=!0,S.classList.remove('btn-orange'),
S.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),f.register(s.BUILDER_QUEUE_STOP,(function(){I=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,p,g,m,b,E,A,h,f,w,v,S,R,y){let k,L,I,x,O,N=!1,P=!1,M=[],C=[],z=[],D=[],B=[],U=[],G=!1,V=!1,W=!1,q=0,Y=null,H=null,F=null,j={},K=h.gameTime(),Q=null,X=null;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(L[r.MIN_DISTANCE],L[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===x.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(L[r.MIN_POINTS],L[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ie=function(){!function(){const e=L[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ne(z)}(),function(){const e=L[r.GROUP_IGNORE];D=i.getGroupList().getGroupVillageIds(e)}(),function(){const e=L[r.GROUP_ONLY];B=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!x.getVillage(e)})),B=B.concat(t)})),B=ne(B)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){_.call(I,e)||(I[e]={time:h.gameTime(),report:!1},t=!0)})),b.each(I,(function(a,n){n=parseInt(n,10),e.includes(n)||(delete I[n],t=!0)})),t&&(y.set($,I),f.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),f.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},le=function(e,t){
const a=L[r.GROUP_INCLUDE],n=L[r.GROUP_IGNORE],i=L[r.GROUP_ONLY],l=x.getVillage(t.village_id);let o=!1;if(ie(),n===t.group_id&&(l?(ke(t.village_id),o=!0):(xe(t.village_id),Te(g.IGNORED_VILLAGE,{villageId:t.village_id}),be(t.village_id))),a.includes(t.group_id)&&!l&&(Oe(),Te(g.INCLUDED_VILLAGE,{villageId:t.village_id}),be(t.village_id)),i.includes(t.group_id)&&l){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),o=!0}o&&f.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},oe=function(e,t){const a=L[r.GROUP_INCLUDE],n=L[r.GROUP_IGNORE],i=L[r.GROUP_ONLY],l=x.getVillage(t.village_id);let o=!1;if(ie(),n===t.group_id)if(l){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),o=!0}else Oe(),Te(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!l&&(Oe(),Te(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),i.includes(t.group_id)&&l&&(ke(t.village_id),o=!0),o&&f.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=i.getGroupList().getGroups(),a=L[r.GROUP_IGNORE],n=L[r.GROUP_ONLY],l=L[r.GROUP_INCLUDE],o=_.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=n.filter(e=>_.call(t,e)),c=l.filter(e=>_.call(t,e));k.setAll({[r.GROUP_IGNORE]:o,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ie(),ye(),Oe(),Re()},ce=function(){U=[];const e=i.getPresetList().getPresets();L[r.PRESETS].forEach((function(t){if(!_.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(f.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){L[r.IGNORE_ON_LOSS]&&L[r.GROUP_IGNORE]&&P&&t.type===w.TYPES.ATTACK&&1!==t.result&&Ie(t.target_village_id)&&(j[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=L[r.GROUP_IGNORE];!!t&&l.emit(o.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){G&&W&&t.origin.id===G.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&G.commandSent(t)},ge=function(e,t){G&&V&&W&&t.cause===o.SEND_PRESET.type&&G.commandError(t)},me=function(e){let t=0;return b.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},be=function(e){I[e]={time:h.gameTime(),report:j[e]||!1},delete j[e],y.set($,I),f.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Te=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,C.unshift(t),_e(),!0)},_e=function(){const e=L[r.LOGS_LIMIT];C.length>e&&C.splice(C.length-e,C.length),y.set(Z,C),f.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const n=L[r.TARGET_MULTIPLE_FARMERS],i=L[r.TARGET_SINGLE_ATTACK];if(n&&a){if(i&&e)return!0}else if(i){if(e||t)return!0}else if(t)return!0;return!1},Ae=function(){K=h.gameTime()},he=function(){clearTimeout(Y),clearTimeout(H),clearTimeout(F),Y=null,H=null,F=null
},fe=function(){return Math.max(1,60*L[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*L[r.ATTACK_INTERVAL])},ve=function(e){if(this.villageId=e,this.village=x.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=T,this.status=n.WAITING_CYCLE};ve.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{f.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},ve.prototype.start=function(){return Ae(),!this.running&&(this.initialized?this.targets.length?(G=this,this.running=!0,f.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(f.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(f.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,f.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=T},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;Ae();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const T=()=>new Promise((t,a)=>{e.delay?H=setTimeout(()=>{if(H=null,!this.running)return a(n.USER_STOP);t()},b.randomSeconds(we())):t()}),E=()=>new Promise((e,a)=>{const i=50-L[r.PRESERVE_COMMAND_SLOTS];t.length>=i?a(n.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(L[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),i=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===i))return t(n.FULL_STORAGE)}e()
}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(n.NO_TARGETS)),k=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,i=>{if(te.points(i.points))return t(n.NOT_ALLOWED_POINTS);l.emit(o.GET_ATTACKING_FACTOR,{target_id:a.id},i=>{this.running?null!==a.character_id||null===i.owner_id||z.includes(a.id)?a.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),I=()=>new Promise((e,t)=>{!function(e,t){const a=i.getPresetList().getPresetsByVillageId(e);let n=[];if(U.forEach((function(e){_.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)_.call(a,e)&&n.push(e);l.emit(o.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),O=()=>new Promise((e,t)=>{const i=this.village.getUnitInfo().getUnits(),l=60*L[r.MAX_TRAVEL_TIME],o=this.village.getPosition(),s=A.actualDistance(o,a);b.each(U,o=>{
if(!!Object.entries(o.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(o,{barbarian:!a.character_id,officers:!1});return l>r*s?(g=o,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),N=()=>new Promise((e,i)=>{c=!1,p=x.getVillageList();const l=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(l&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),Ee(u,c,l))return i(n.BUSY_TARGET);l&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const i=60*L[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(L[r.TARGET_SINGLE_ATTACK]&&!L[r.TARGET_MULTIPLE_FARMERS])return e();const l=Math.round(h.gameTime()/1e3),o=L[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=A.actualDistance(s,a),b=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),T=d.getTravelTimeForDistance(g,b,m,w.TYPES.ATTACK);if(o.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(l+T-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();l.emit(o.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const i=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),l=i.some(e=>e.start_village_id!==this.villageId),o=i.some(e=>e.start_village_id===this.villageId);if(Ee(o,l,!0))return t(n.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{T().then(E).then(S).then(y).then(k).then(I).then(O).then(N).then(P).then(M).then(e).catch(t)}),D=new Promise((e,t)=>{F=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([C,D]).then(()=>{if(!this.running)return!1
...
ve.prototype.getStatus=function(){return this.status||n.UNKNOWN},ve.prototype.commandSent=function(e){V=!1,W=!1,he(),Te(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},ve.prototype.commandError=function(){V=!1,W=!1,this.stop(n.COMMAND_ERROR)},ve.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},ve.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=A.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,L[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},ve.prototype.getTargets=function(){return this.targets},ve.prototype.getIndex=function(){return this.index},ve.prototype.getVillage=function(){return this.village},
ve.prototype.isRunning=function(){return this.running},ve.prototype.isInitialized=function(){return this.initialized},ve.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},ve.prototype.getId=function(){return this.villageId};const Se=function(e){const t=L[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!B.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new ve(e),M.push(a)),a},Re=function(){b.each(x.getVillages(),(function(e,t){Se(t)})),f.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ye=function(){const e=L[r.GROUP_ONLY];let t=[];M.forEach((function(a){let n=a.getId();e.length&&!B.includes(n)?t.push(n):D.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){ke(e)})),f.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1
},Le=function(e){Ae(),M.length?q>=M.length?(q=0,G=!1,X=h.gameTime()+fe(),f.trigger(s.FARM_OVERFLOW_CYCLE_END)):G=M[q]:G=!1,G?(G.onCycleEnd((function(e){e!==t.USER_STOP&&(q++,Le())})),"cycle_begin"===e&&(X=null,f.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),G.start()):Y=setTimeout((function(){Y=null,q=0,X=null,f.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Le()}),fe())},Ie=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){M.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,C=y.get(Z,[]),I=y.get($,{}),x=i.getSelectedCharacter(),O=i.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){L=k.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ie(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(ye(),Re()),t[p.LOGS]&&_e(),t[p.INTERVAL_TIMERS]&&P&&(H?(he(),
G.targetStep({delay:!0})):Y&&(he(),f.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),q=0,Le())))})),L=k.getAll(),se("ignore_update"),ie(),Re(),E((function(){ce()}),'presets'),E((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,le),a.$on(s.GROUPS_VILLAGE_UNLINKED,oe),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!P&&(U.length?(P=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Le("cycle_begin")})),Ae(),function(){let e=fe(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),f.trigger(s.FARM_OVERFLOW_START),void Te(g.FARM_START)):(P=!1,!1)):(f.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=n.USER_STOP){G?(G.stop(e),
e!==n.USER_STOP&&(X=h.gameTime()+fe()),f.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,he(),f.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===n.USER_STOP&&Te(g.FARM_STOP)},Ne.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return M},Ne.getSettings=function(){return k},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return I},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return P},Ne.getLogs=function(){return C},Ne.clearLogs=function(){return C=[],y.set(Z,C),f.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),C},Ne.getNextCycleDate=function(){return X},Ne.getCycleInterval=fe,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,u,T,_,E,A,h,f){let w,v,S,R=i.getPresetList(),y=i.getGroupList(),k={},L={},I=null;const x={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(k[e])return k[e];k[e]=!0,L[e]='ładowanie...',l.emit(o.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},L[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
w.exceptionVillages.included.forEach((function(e){N(e)})),w.exceptionVillages.ignored.forEach((function(e){N(e)}))},M=function(){t.isRunning()?t.stop():t.start()},C=function(e){w.selectedTab=e},z=function(){v.setAll(v.decode(w.settings)),w.saveButtonColor='orange',A.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=v.get(T.GROUP_IGNORE);if(!i.getGroupList().getGroupVillageIds(t).includes(e))return!1;l.emit(o.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},B=function(e){v.get(T.GROUP_INCLUDE).forEach((function(t){i.getGroupList().getGroupVillageIds(t).includes(e)&&l.emit(o.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){w.presets=_.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},G=function(){w.groups=_.encodeList(y.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=_.encodeList(y.getGroups(),{disabled:!0,type:'groups'})},V=function(){w.running=!0,
A.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},W=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(I),t.reason){case d.NO_PRESETS:A.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:A.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},q=function(){w.logs=angular.copy(t.getLogs()),O(),w.logs.length||A.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){w.farmers=t.getFarmers()},H=function(){w.exceptionVillages=t.getExceptionVillages(),P()},F=function(){w.exceptionLogs=t.getExceptionLogs()},j=function(){w.showCycleTimer=!1,clearInterval(I)},K=function(e,a){a!==n.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),I=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=T,w.TAB_TYPES=x,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=x.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=L,w.villagesInfo=k,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=v.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},v.injectScope(w),U(),G(),O(),P(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-f.gameTime(),I=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=M,w.selectTab=C,w.saveSettings=z,w.clearLogs=t.clearLogs,w.jumpToVillage=p.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=b.showReport,w.removeIgnored=D,w.removeIncluded=B;let n=new E('twoverflow_farm_overflow_window',(function(){clearInterval(I)}));n.register(s.ARMY_PRESET_UPDATE,U,!0),n.register(s.ARMY_PRESET_DELETED,U,!0),n.register(s.GROUPS_UPDATED,G,!0),n.register(s.GROUPS_CREATED,G,!0),n.register(s.GROUPS_DESTROYED,G,!0),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,l,o,r,c,d,u,g,m,b,T,E,A,h,f,w,v){let S,R,y,k,L,I,x,O,N,P,M,C,z,D,B,U,G,V,W,q,Y,H,F,j=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',le={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},oe=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,be=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/R)%2&&(t+=k),t-=t%R,a-=a%R,{x:Math.ceil((t-N.width/2)/R),y:Math.ceil((a-N.height/2)/R)}},Te=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},_e=function(){ve(L)},Ee=function(){if(j){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),F[l.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*R-e.x,n=(t.y-2)*R-e.y;D.fillStyle=F[l.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,y),D.fillRect(0,n,y,1);const i=U.getBoundingClientRect(),o=i.width/w.TILESIZE.x/v.view.z*R,s=i.height/w.TILESIZE.y/v.view.z*R,r=a-o/2,c=n-s/2;D.clearRect(r,c,o,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=F[l.COLOR_VIEW_REFERENCE],D.rect(r,c,o,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)},Ae=function(){if(!ne)return!1;const e=Q.village[x][O];fe(e?Q.character[e]:[[x,O]]),ne=!1,
m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t,F[l.COLOR_QUICK_HIGHLIGHT])},fe=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}ve(t)},we=function(e){if(F[l.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!F[l.SHOW_BARBARIANS]&&q.barbarian;if(e.character_id===V){if(e.id===I.getId()&&F[l.HIGHLIGHT_SELECTED])return q.selected;if(e.character_id in K.character)return K.character[e.character_id];if(F[l.HIGHLIGHT_OWN])return q.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&F[l.HIGHLIGHT_DIPLOMACY])return q.tribe;if(Y&&F[l.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return q.ally;if(Y.isEnemy(e.tribe_id))return q.enemy
;if(Y.isNAP(e.tribe_id))return q.friendly}}return q.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||we(n);if(!i)continue;const l=n.x*R+(n.y%2?k:0),o=n.y*R;C.fillStyle=i,C.fillRect(l,o,S,S)}},Se=function(){S=le[F[l.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,M.width=1e3*R,M.height=1e3*R,C.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[x,O,e]),3===e.which&&(a=x,n=O,T.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(F[l.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({
type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Le=function(e){if(ce=!1,pe=be(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!F[l.SHOW_BARBARIANS]&&!t.character_id)return!1;if(F[l.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(x===e.x&&O===e.y)return!1;Ae()}ne=!0,x=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:x,y:O,event:t});const a=Q.village[x][O];he(a?Q.character[a]:[[x,O]])}(pe,e)}Ae()},Ie=function(){ne&&Ae(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},xe=function(e){if(!ce)return!1;const t=be(e);p.jumpToVillage(t.x,t.y)
},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=oe.getCustomColorsByGroup(f.TRIBE_COLORS)||{},K.character=oe.getCustomColorsByGroup(f.PLAYER_COLORS)||{},_e()},Pe=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=G.getSelectedVillage(),ve([{character_id:G.getId(),id:e.id,x:e.x,y:e.y},{character_id:G.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&_.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?f.PLAYER_COLORS:f.TRIBE_COLORS;return oe.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),_e(),!0},removeHighlight:function(e,t){if(void 0===t||!_.call(K,e))return!1;if(!_.call(K[e],t))return!1;delete K[e][t];const n='character'===e?f.PLAYER_COLORS:f.TRIBE_COLORS;return oe.setCustomColorsByGroup(n,K[e]),
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),_e(),!0},getHighlight:function(e,t){return!!_.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=F[l.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!B.width||!B.height)return!1;let e=T.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Te(e[0]*t,e[1]*t),n=Te(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,B.width/2,B.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return H},Me.drawMinimap=function(){ge&&(ge=!1),N.style.background=F[l.COLOR_BACKGROUND],C.clearRect(0,0,M.width,M.height),d((function(){!function(){
...
Se(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),F=H.getAll(),K.tribe=oe.getCustomColorsByGroup(f.TRIBE_COLORS)||{},K.character=oe.getCustomColorsByGroup(f.PLAYER_COLORS)||{},Se()},Me.run=function(){d((function(){U=document.getElementById('map'),B=document.getElementById('main-canvas'),G=i.getSelectedCharacter(),Y=G.getTribeRelations(),V=G.getId(),W=G.getTribeId(),q=G.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),Re(),I=G.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*R,ee.y=I.getY()*R,e.addEventListener('resize',Re,!1),z.addEventListener('mousedown',ye),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Le),z.addEventListener('mouseleave',Ie),z.addEventListener('click',xe),z.addEventListener('contextmenu',Oe),g.load((function(){L=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(L),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),Ee(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,_e),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,b,T,_,E,A,h,f){let w,v,S,R,y,k,L,I,x,O,N,P={},M=!1,C={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,B=function(e){w.selectedTab=e,e===z.MINIMAP?i.enableRendering():i.disableRendering()},U=function(){Object.keys(w.highlights.character).forEach((function(e){e in C.character||function(e,t){l.emit(o.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
C.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in C.tribe||function(e,t){l.emit(o.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){C.tribe[e]=t.name}))}))},G=function(e,t){return String(e)+String(t)},V=function(e,t){if(!x)return;let a=G(t.x,t.y);var n,i;O=a,P[a]=!0,M=!0,(n=t.x,i=t.y,new Promise((function(e){let t=A.getTownAt(n,i);if(t)return e(t);A.loadTownDataAsync(n,i,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[G(e.x,e.y)])return;if(!M)return;L.appendChild(x),x.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=x.getBoundingClientRect(),n=L.getBoundingClientRect(),i=a.width+50,l=a.height+50,o=k.tt.position.y+l>n.top+n.height,s=k.tt.position.x+i>n.width;o&&(k.tt.position.y-=50),x.classList.toggle('left',s),x.classList.toggle('top',o)}))},W=function(e,t){if(!x)return;let a=t?G(t):O;P[a]=!1,M=!1,k.tt.visible=!1,x.classList.add('ng-hide'),I.appendChild(x)},q=function(e,t,n){let l,o,s=a.$new(),r=!0;s.colorPalettes=f.palette,'setting'===e?(o=t,l=N.get(o),r=!1,s.submit=function(){w.settings[o]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[o]=N.getDefault(o),s.closeWindow()}):'add_custom_highlight'===e?(l=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(l=w.highlights[t][n],s.submit=function(){i.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=l.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},Y=function(){i.addHighlight(w.selectedHighlight,w.addHighlightColor)},H=function(){N.setAll(N.decode(w.settings)),b.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},F=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),b.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},j=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){b.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){b.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){b.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=z,w.selectedTab=D,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=i.getHighlights(),w.highlightNames=C,w.mapSizes=_.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=_.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=B,w.openColorPalette=q,w.addCustomHighlight=Y,w.removeHighlight=i.removeHighlight,w.saveSettings=H,w.resetSettings=F,w.highlightsCount=j,w.openProfile=K,N.injectScope(w,{textObject:'minimap'});let e=new T('twoverflow_minimap_window',(function(){i.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),U(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(S),y.appendChild(R),i.enableRendering(),i.isFirstDraw()&&i.drawMinimap()};return function(){N=i.getSettings(),k=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',R=document.createElement('canvas'),R.className='cross',i.setViewport(S),i.setViewportRef(R),x=document.querySelector('#map-tooltip'),L=document.querySelector('#wrapper'),I=document.querySelector('#map'),v=t.addMenuButton4('Minimapa',30,g('i18n')('general.description',a.loc.ale,'minimap')),v.addEventListener('click',(function(){const e=i.getMapPosition();if(!e)return!1;X(),i.setCurrentPosition(e.x,e.y)})),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r){let c,d,u=!1,p=!1,g=[],m=[],b=[],T=[];const _='preset_asigner_settings',E=function(){g=[],m=[];const e=i.getPresetList().getPresets(),a=d[t.PRESETS1],n=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),n.forEach((function(t){m.push(e[t])}))},A=function(){b=[],T=[];const e=i.getGroupList().getGroups(),a=d[t.GROUP1],n=d[t.GROUP2];a.forEach((function(t){b.push(e[t])})),n.forEach((function(t){T.push(e[t])}))},h={init:function(){u=!0,c=new e({settingsMap:n,storageKey:_}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&E(),t[l.GROUPS]&&A()})),d=c.getAll(),console.log('presetAsigner settings',d),o((function(){E()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,E),a.$on(s.ARMY_PRESET_DELETED,E),a.$on(s.GROUPS_CREATED,A),a.$on(s.GROUPS_DESTROYED,A),a.$on(s.GROUPS_UPDATED,A)},start:function(){p=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return h})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let u,p,g,m=i.getPresetList(),b=i.getGroupList();const T={PRESETS:'presets',LOGS:'logs'},_=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()
},h=function(){u.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},f=function(){u.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.PRESETS,u.settingsMap=l,p.injectScope(u),h(),f(),u.selectTab=_,u.saveSettings=E,u.switchState=A;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,h,!0),e.register(s.ARMY_PRESET_DELETED,h,!0),e.register(s.GROUPS_CREATED,f,!0),e.register(s.GROUPS_DESTROYED,f,!0),e.register(s.GROUPS_UPDATED,f,!0),e.register(s.PRESET_ASIGNER_START,w),e.register(s.PRESET_ASIGNER_STOP,v),
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var n=!1,r=!1,c=i.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',b='060502',T='060501',_='060503',E='05020a',A='05030a',h='04080a',f='040a0a',w='070e04',v='070e05',S='070e0f',R='070e06',y='070e02',k='070e01',L='070e03',I='070e07',x='070e0b',O='070e0e',N='030d07',P='030d0b',M='030d0e';var C={init:function(){n=!0}};return C.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,b='string'==typeof b?parseInt(b,16):b,T='string'==typeof T?parseInt(T,16):T,_='string'==typeof _?parseInt(_,16):_,E='string'==typeof E?parseInt(E,16):E,A='string'==typeof A?parseInt(A,16):A,h='string'==typeof h?parseInt(h,16):h,f='string'==typeof f?parseInt(f,16):f,
w='string'==typeof w?parseInt(w,16):w,v='string'==typeof v?parseInt(v,16):v,S='string'==typeof S?parseInt(S,16):S,R='string'==typeof R?parseInt(R,16):R,y='string'==typeof y?parseInt(y,16):y,k='string'==typeof k?parseInt(k,16):k,L='string'==typeof L?parseInt(L,16):L,I='string'==typeof I?parseInt(I,16):I,x='string'==typeof x?parseInt(x,16):x,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,P='string'==typeof P?parseInt(P,16):P,M='string'==typeof M?parseInt(M,16):M,l.emit(o.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:20,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),l.emit(o.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (miecz)',icon:u,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:33,axe:0,
...
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let u,p,g,m=i.getPresetList(),b=i.getGroupList();const T={SUPPORT:'support',LOGS:'logs'},_=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()},h=function(){u.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},f=function(){u.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.SUPPORT,u.settingsMap=l,p.injectScope(u),h(),f(),u.selectTab=_,u.saveSettings=E,u.switchState=A;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,h,!0),e.register(s.ARMY_PRESET_DELETED,h,!0),e.register(s.GROUPS_CREATED,f,!0),e.register(s.GROUPS_DESTROYED,f,!0),e.register(s.GROUPS_UPDATED,f,!0),e.register(s.SUPPORT_SENDER_START,w),e.register(s.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',S),
