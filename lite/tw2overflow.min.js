 ...
 */
!function(e,t){const a=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),o=injector.get('modelDataService'),i=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),_=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||_,this.listeners=[];const n=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,o){o?this.listeners.push(a.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(I),[c.INCOMING_UNITS]:angular.copy(M),[c.VILLAGE]:!1};A=!0,b=o.getSelectedCharacter().getGlobalInfo(),S=g.get(k,t,!0),e((function(){N(),a.$on(s.COMMAND_INCOMING,x),a.$on(s.COMMAND_CANCELLED,L),a.$on(s.MAP_SELECTED_VILLAGE,U),a.$on(s.VILLAGE_NAME_CHANGED,P),a.$on(s.COMMAND_IGNORED,O),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,i,l,d,u,T,_,f,b,h){let A,E;const w=function(){return Date.now()/1e3},v=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setCommander(e,n)},R=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=A.pagination.offset,t=A.pagination.limit
;A.visibleCommands=A.commands.slice(e,e+t),A.pagination.count=A.commands.length},k=function(){const e=Date.now();for(let t=0;t<A.commands.length;t++)100===A.commands[t].model.percent(e)&&A.commands.splice(t,1);y()},M=function(e,a){t.toggleFilter(e,a),A.filters=t.getFilters()},I=function(e){t.toggleSorting(e),A.sorting=t.getSortings()},N=function(){A.commands=t.getCommands()},x=function(){A.selectedVillageId=o.getSelectedVillage().getId()},L=function(){A=a.$new(),A.commandQueueEnabled=t.commandQueueEnabled(),A.commands=t.getCommands(),A.selectedVillageId=o.getSelectedVillage().getId(),A.filters=t.getFilters(),A.sorting=t.getSortings(),A.UNIT_TYPES=_,A.FILTER_TYPES=u,A.COMMAND_TYPES=d,A.UNIT_SPEED_ORDER=T,A.COLUMN_TYPES=l,A.pagination={count:A.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},A.openCharacterProfile=r.openCharacterProfile,A.openVillageInfo=r.openVillageInfo,A.jumpToVillage=p.jumpToVillage,A.now=w,A.copyTimeModal=v,A.removeTroops=S,A.switchWindowSize=R,
A.toggleFilter=M,A.toggleSorting=I,y();let e=new n('twoverflow_queue_window',(function(){b.timer.remove(k)}));e.register(s.MAP_SELECTED_VILLAGE,x,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,N),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,N),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,N),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,N),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',A),b.timer.add(k)};return function(){E=e.addMenuButton('Strażnik',30,g('i18n')('description',a.loc.ale,'attack_view')),E.addEventListener('click',L),
...
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],o=[45,5,5,30,40,30,160,50,50,400,50,250,100],i=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=0,c=0,d=0,u=0,p=0,g=0,m=0,T=0,_=0,f=0,b=0,h=0,A=0,E=0,w=0,S=0,R=0,y=0,k=0,M=0,I=0,N=0,x=0,L=0,O=0,P=0,U=0,C=0,z=0,D=0,G=0,B=0,V=0,W=0,F=0,oa=0,ia=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=0,Ta=0,_a=0,fa=0,ba=0,ha=0,Aa=0,Ea=0,wa=0,va=0,Sa=0,Ra=0,ya=0,ka=0,Ma=0,Ia=0,Na=0,xa=0,La=0,Oa=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,Fa=0,qa=0,Ya=0,Ha=0,ja=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,Tn=0,_n=0,fn=0,bn=0,hn=0,An=0,En=0,wn=0,vn=[1,1],Sn=[1,1],Rn=[1,1],yn=[1,1],kn=[1,1],Mn=[1,1],In=[1,1],Nn=[1,1],xn=[1,1],Ln=[1,1],On=[1,1],Pn=[1,1],Un=[1,1],Cn=[1,1],zn=[1,1],Dn=[1,1],Gn=[1,1],Bn=[1,1],Vn=[1,1],Wn=[1,1],Fn=[1,1],qn=[1,1],Yn=[1,1],Hn=[1,1],jn=[1,1],Kn=[1,1],Qn=[1,1],Xn=[1,1],Zn=[1,1],Jn=[1,1],$n=[1,1],eo=[1,1],to=[1,1],ao=[1,1],no=[1,1],oo=[1,1],io=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,To=0,_o=0,fo=0,bo=0,ho=0,Ao=0,Eo=0,wo=0,vo=0,So=0,Ro=0,yo=0,ko=0,Mo=0,Io=0,No=0,xo=[1,1],Lo=0,Oo=0,Po=0,Uo=0,Co=0,zo=0,Do=0,Go=0,Bo=0,Vo=0,Wo=0,Fo=0,qo=0,Yo=0,Ho=0,jo=0,Ko=0,Qo=0,Xo=0,Zo=0,Jo=0,$o=0,ei=0,ti=0,ai=0,ni=0,oi=0,ii=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,Ti=[1,1],_i=[1,1],fi=[1,1],bi=[1,1],hi=[1,1],Ai=[1,1],Ei=[1,1],wi=[1,1],vi=[1,1],Si=0,Ri=0,yi=0,ki=0,Mi=0,Ii=0,Ni=0,xi=0,Li=0,Oi=0,Pi=0,Ui=0,Ci=0,zi=0,Di=0,Gi=0,Bi=0,Vi=0,Wi=0,Fi=0,qi=0,Yi=0,Hi=0,ji=0,Ki=0,Qi=0,Xi=0,Zi=0,Ji=0,$i=0,el=0,tl=0,al=0,nl=0,ol=0,il=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,Tl=0,_l=0,fl=0,bl=0,hl=0,Al=0,El=0,wl=0,vl=0,Sl=0,Rl=0,yl=0,kl=0,Ml=0,Il=0,Nl=0,xl=0,Ll=0,Ol=0,Pl=0,Ul=0,Cl=0,zl=0,Dl=0,Gl=0,Bl=0,Vl=0,Wl=0,Fl=0,ql=0,Yl=0,Hl=1,jl=0,Kl=0,Ql=0,Xl=0,Zl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,os=0,is=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,Ts=0,_s=0,fs=0,bs=0,hs=0,As=0,Es=0,ws=0,vs=0,Ss=0,Rs=0,ys=0,ks=0,Ms=0,Is=0,Ns=0,xs=0,Ls=0,Os=0,Ps=0,Us=0,Cs=0,zs=0,Ds=0,Gs=0,Bs=0,Vs=0,Ws=0,Fs=0,qs=0,Ys=0,Hs=0,js=0,Ks=0,Qs=0,Xs=0,Zs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,or=0,ir=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,Tr=0,_r=0,fr=0,br=0,hr=0,Ar=0,Er=0,wr=0,vr=0,Sr=0,Rr=0,yr=0,kr=0,Mr=0,Ir=0,Nr=0,xr=0,Lr=0,Or=0,Pr=0,Ur=0,Cr=0,zr=0,Dr=0,Gr=0,Br=0,Vr=0,Wr=0,Fr=0,qr=0,Yr=0,Hr=0,jr=0,Kr=0,Qr=0,Xr=0,Zr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,oc=0,ic=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,Tc=0,_c=0,fc=0,bc=0,hc=0,Ac=0,Ec=0,wc=0,vc=0,Sc=0,Rc=0,yc=0,kc=0,Mc=0,Ic=0,Nc=0,xc=0,Lc=0,Oc=0,Pc=0,Uc=0,Cc=0,zc=0,Dc=0,Gc=0,Bc=0,Vc=0,Wc=0,Fc=0,qc=0,Yc=0,Hc=0,jc=0,Kc=0,Qc=0,Xc=0,Zc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,od=0,id=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,Td=0,_d=0,fd=0,bd=0,hd=0,Ad=0,Ed=0,wd=0,vd=0,Sd=0
;console.log(aa,jt),r=v[t.BATTLE_CHURCH_A],c=v[t.BATTLE_CHURCH_D],d=v[t.BATTLE_NIGHT_BONUS],u=v[t.BATTLE_OFFICER_LEADER],p=v[t.BATTLE_OFFICER_MEDIC],g=v[t.BATTLE_SKILL_MEDIC],m=v[t.BATTLE_SKILL_WEAPON_MASTER],T=v[t.BATTLE_WALL],_=v[t.BATTLE_SKILL_IRON_WALLS],f=v[t.BATTLE_SKILL_CLINIQUE],b=v[t.BATTLE_HOSPITAL],Pt=v[t.BATTLE_CATAPULT_TARGET],h=v[t.BATTLE_CATAPULT_TARGET],A=v[t.BATTLE_KNIGHT_ITEM_D1],E=v[t.BATTLE_KNIGHT_ITEM_D2],w=v[t.BATTLE_KNIGHT_ITEM_D3],S=v[t.BATTLE_KNIGHT_ITEM_A],R=v[t.BATTLE_ITEM_LEVEL_D1],y=v[t.BATTLE_ITEM_LEVEL_D2],k=v[t.BATTLE_ITEM_LEVEL_D3],M=v[t.BATTLE_ITEM_LEVEL_A],Ge=v[t.BATTLE_ARCHER_A],j=v[t.BATTLE_ARCHER_D],De=v[t.BATTLE_AXE_A],H=v[t.BATTLE_AXE_D],Ke=v[t.BATTLE_DOPPELSOLDNER_A],ae=v[t.BATTLE_DOPPELSOLDNER_D],Fe=v[t.BATTLE_CATAPULT_A],Z=v[t.BATTLE_CATAPULT_D],je=v[t.BATTLE_HC_A],te=v[t.BATTLE_HC_D],Ve=v[t.BATTLE_KNIGHT_A],Q=v[t.BATTLE_KNIGHT_D],Ye=v[t.BATTLE_LC_A],$=v[t.BATTLE_LC_D],He=v[t.BATTLE_MA_A],ee=v[t.BATTLE_MA_D],We=v[t.BATTLE_RAM_A],
X=v[t.BATTLE_RAM_D],Be=v[t.BATTLE_SNOB_A],K=v[t.BATTLE_SNOB_D],Ce=v[t.BATTLE_SPEAR_A],q=v[t.BATTLE_SPEAR_D],ze=v[t.BATTLE_SWORD_A],Y=v[t.BATTLE_SWORD_D],qe=v[t.BATTLE_TREBUCHET_A],J=v[t.BATTLE_TREBUCHET_D],I=v[t.BATTLE_MORALE],N=v[t.BATTLE_LUCK],console.log(Pt),vd='level_1'==r?100:'level_2'==r?105:'level_3'==r?110:50,console.log(vd),Sd='level_1'==c?100:'level_2'==c?105:'level_3'==c?110:50,console.log(Sd),Hl=d?2:1,console.log(Hl),rl=u?.1:0,console.log(rl),ql=p?.1:0,console.log(ql),Js=g?.1:0,console.log(Js),Xs='level_1'==m?2:'level_2'==m?4:'level_3'==m?6:'level_4'==m?8:'level_5'==m?10:0,console.log(Xs),$s='level_1'==_?1:'level_2'==_?2:'level_3'==_?3:'level_4'==_?4:'level_5'==_?5:0,console.log($s),Zs='level_1'==f?100:'level_2'==f?200:'level_3'==f?300:'level_4'==f?400:'level_5'==f?500:'level_6'==f?600:'level_7'==f?700:'level_8'==f?800:'level_9'==f?900:'level_10'==f?1e3:0,console.log(Zs),
...
console.log(qn),Jn='battle.halberd'==A&'level_1'==R?[1.1,1.05]:'battle.halberd'==A&'level_2'==R?[1.2,1.1]:'battle.halberd'==A&'level_3'==R?[1.3,1.2]:[1,1],console.log(Jn),ao='battle.longsword'==A&'level_1'==R?[1.1,1.05]:'battle.longsword'==A&'level_2'==R?[1.2,1.1]:'battle.longsword'==A&'level_3'==R?[1.3,1.2]:[1,1],Sn='battle.longbow'==A&'level_1'==R?[1.1,1.05]:'battle.longbow'==A&'level_2'==R?[1.2,1.1]:'battle.longbow'==A&'level_3'==R?[1.3,1.2]:[1,1],Cn='battle.banner'==A&'level_1'==R?[1.1,1.1]:'battle.banner'==A&'level_2'==R?[1.2,1.2]:'battle.banner'==A&'level_3'==R?[1.3,1.3]:[1,1],Kn='battle.star'==A&'level_1'==R?[1.05,1.25]:'battle.star'==A&'level_2'==R?[1.1,1.5]:'battle.star'==A&'level_3'==R?[1.2,2]:[1,1],Ln='battle.bonfire'==A&'level_1'==R?[1.05,1.25]:'battle.bonfire'==A&'level_2'==R?[1.1,1.5]:'battle.bonfire'==A&'level_3'==R?[1.2,2]:[1,1],Vn='battle.lance'==E&'level_1'==y?[1.05,1.1]:'battle.lance'==E&'level_2'==y?[1.1,1.2]:'battle.lance'==E&'level_3'==y?[1.2,1.3]:[1,1],
...
Dn='battle.banner'==w&'level_1'==k?[1.1,1.1]:'battle.banner'==w&'level_2'==k?[1.2,1.2]:'battle.banner'==w&'level_3'==k?[1.3,1.3]:[1,1],Xn='battle.star'==w&'level_1'==k?[1.05,1.25]:'battle.star'==w&'level_2'==k?[1.1,1.5]:'battle.star'==w&'level_3'==k?[1.2,2]:[1,1],Pn='battle.bonfire'==w&'level_1'==k?[1.05,1.25]:'battle.bonfire'==w&'level_2'==k?[1.1,1.5]:'battle.bonfire'==w&'level_3'==k?[1.2,2]:[1,1],Gn=Bn[0]>=Vn[0]&&Bn[0]>=Wn[0]?Bn:Vn[0]>=Bn[0]&&Vn[0]>=Wn[0]?Vn:Wn[0]>=Bn[0]&&Wn[0]>=Vn[0]?Wn:[1,1],kn=Mn[0]>=In[0]&&Mn[0]>=Nn[0]?Mn:In[0]>=Mn[0]&&In[0]>=Nn[0]?In:Nn[0]>=Mn[0]&&Nn[0]>=In[0]?Nn:[1,1],Fn=qn[0]>=Yn[0]&&qn[0]>=Hn[0]?qn:Yn[0]>=qn[0]&&Yn[0]>=Hn[0]?Yn:Hn[0]>=qn[0]&&Hn[0]>=Yn[0]?Hn:[1,1],Un=Cn[0]>=zn[0]&&Cn[0]>=Dn[0]?Cn:zn[0]>=Cn[0]&&zn[0]>=Dn[0]?zn:Dn[0]>=Cn[0]&&Dn[0]>=zn[0]?Dn:[1,1],jn=Kn[0]>=Qn[0]&&Kn[0]>=Xn[0]?Kn:Qn[0]>=Kn[0]&&Qn[0]>=Xn[0]?Qn:Xn[0]>=Kn[0]&&Xn[0]>=Qn[0]?Xn:[1,1],xn=Ln[0]>=On[0]&&Ln[0]>=Pn[0]?Ln:On[0]>=Ln[0]&&On[0]>=Pn[0]?On:Pn[0]>=Ln[0]&&Pn[0]>=On[0]?Pn:[1,1],
Zn=Jn[0]>=$n[0]&&Jn[0]>=eo[0]?Jn:$n[0]>=Jn[0]&&$n[0]>=eo[0]?$n:eo[0]>=Jn[0]&&eo[0]>=$n[0]?eo:[1,1],to=ao[0]>=no[0]&&ao[0]>=oo[0]?ao:no[0]>=ao[0]&&no[0]>=oo[0]?no:oo[0]>=ao[0]&&oo[0]>=no[0]?oo:[1,1],vn=Sn[0]>=Rn[0]&&Sn[0]>=yn[0]?Sn:Rn[0]>=Sn[0]&&Rn[0]>=yn[0]?Rn:yn[0]>=Sn[0]&&yn[0]>=Rn[0]?yn:[1,1],hi='battle.lance'==S&'level_1'==M?[1.05,1.1]:'battle.lance'==S&'level_2'==M?[1.1,1.2]:'battle.lance'==S&'level_3'==M?[1.2,1.3]:[1,1],_i='battle.battleaxe'==S&'level_1'==M?[1.05,1.1]:'battle.battleaxe'==S&'level_2'==M?[1.1,1.2]:'battle.battleaxe'==S&'level_3'==M?[1.2,1.3]:[1,1],Ai='battle.compositebow'==S&'level_1'==M?[1.05,1.1]:'battle.compositebow'==S&'level_2'==M?[1.1,1.2]:'battle.compositebow'==S&'level_3'==M?[1.2,1.3]:[1,1],wi='battle.halberd'==S&'level_1'==M?[1.1,1.05]:'battle.halberd'==S&'level_2'==M?[1.2,1.1]:'battle.halberd'==S&'level_3'==M?[1.3,1.2]:[1,1],
vi='battle.longsword'==S&'level_1'==M?[1.1,1.05]:'battle.longsword'==S&'level_2'==M?[1.2,1.1]:'battle.longsword'==S&'level_3'==M?[1.3,1.2]:[1,1],Ti='battle.longbow'==S&'level_1'==M?[1.1,1.05]:'battle.longbow'==S&'level_2'==M?[1.2,1.1]:'battle.longbow'==S&'level_3'==M?[1.3,1.2]:[1,1],bi='battle.banner'==S&'level_1'==M?[1.1,1.1]:'battle.banner'==S&'level_2'==M?[1.2,1.2]:'battle.banner'==S&'level_3'==M?[1.3,1.3]:[1,1],Ei='battle.star'==S&'level_1'==M?[1.05,1.25]:'battle.star'==S&'level_2'==M?[1.1,1.5]:'battle.star'==S&'level_3'==M?[1.2,2]:[1,1],fi='battle.bonfire'==S&'level_1'==M?[1.05,1.25]:'battle.bonfire'==S&'level_2'==M?[1.1,1.5]:'battle.bonfire'==S&'level_3'==M?[1.2,2]:[1,1],Xt=Ce*s[0]+ze*s[1]+De*s[2]+Ge*s[3]+Ye*s[4]+He*s[5]+je*s[6]+We*s[7]+Fe*s[8]+Ve*s[9]+Be*s[10]+qe*s[11]+Ke*s[12],Vt=q*s[0]+Y*s[1]+H*s[2]+j*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log('Prowiant:'+Xt,Vt),na=2*Xt<=Vt?2:1,jl=Xt-5*We,
Kl=0==Gt?0:Math.round(20*Math.pow(1.2515,Gt-1)),wn=Vt+(Kl+100*K),hs=0==jl||0==wn?0:jl/wn>1?1:jl/wn,console.log(hs),Yl=I/100,Sl=N/100,Qt=Math.round(1e3*(vd/100*Yl*(1+Sl)+Xs/100+rl))/1e3,Ad=Fe/(hd=We+Fe),Ed=We/hd,ed=Math.round(J*Ad),Td=Math.round(J*Ed),Vs=(Fs=We-(0==We?0:We<Td?We:Td))*hs*Qt*(xo='battle.star'==S?'level_1'==M?[1.05,1.25]:'level_2'==M?[1.1,1.5]:'level_3'==M?[1.2,2]:[1,1]:[1,1])[1],Mo=20==Gt?18:19==Gt?17:18==Gt?15:17==Gt?14:16==Gt?13:15==Gt?11:14==Gt?10:13==Gt||12==Gt?9:11==Gt?8:10==Gt?7:9==Gt||8==Gt?6:7==Gt||6==Gt?5:5==Gt||4==Gt||3==Gt?4:2==Gt||1==Gt?3:0,fd=0==Gt?0:2*Mo,_d=0==Gt?0:Vs/fd,bd=Gt<=$s?Gt:Gt-$s<_d?Gt<$s?Gt:$s:Gt-_d,La=Math.round(bd),xa=Math.round(.05*La*1e3)/1e3,Bt=Math.round(Sd/100*(1+xa)*Hl*1e3)/1e3,En=Fe-(0==Fe?0:Fe<ed?Fe:ed),zt=Math.round(bd),Na=0==zt?0:Math.round(20*Math.pow(1.2515,zt-1)),Wi=Ce+ze+De+Ke>Ye+je&&Ce+ze+De+Ke>Ge+He?'inf':Ye+je>Ce+ze+De+Ke&&Ye+je>Ge+He?'cav':'arc',
os=Ce*s[0]+ze*s[1]+De*s[2]+Ge*s[3]+Ye*s[4]+He*s[5]+je*s[6]+Fs*s[7]+En*s[8]+Ve*s[9]+Be*s[10]+qe*s[11]+Ke*s[12],_s=q*s[0]+Y*s[1]+H*s[2]+j*s[3]+$*s[4]+ee*s[5]+te*s[6]+X*s[7]+Z*s[8]+Q*s[9]+K*s[10]+J*s[11]+ae*s[12],console.log(os,_s),Ys=Fs*s[7]+En*s[8]+qe*s[11]+Ve*s[9]+Be*s[10],'cav'==Wi?(Jl=Ye*s[4]+je*s[6]+Ys,ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Ql=Ge*s[3]+He*s[5]):'inf'==Wi?(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12]+Ys,Jl=Ye*s[4]+je*s[6],Ql=Ge*s[3]+He*s[5]):'arc'==Wi?(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Jl=Ye*s[4]+je*s[6],Ql=Ge*s[3]+He*s[5]+Ys):(ts=Ce*s[0]+ze*s[1]+De*s[2]+Ke*s[12],Jl=Ye*s[4]+je*s[6],Ql=Ge*s[3]+He*s[5]),fl=0==ts?0:Math.round(ts/os*1e4)/1e4,_l=0==Jl?0:Math.round(Jl/os*1e4)/1e4,Tl=0==Ql?0:Math.round(Ql/os*1e4)/1e4,console.log(Tl),Nr=Math.round(q*fl),Ir=Math.round(q*_l),Mr=q-Ir-Nr,Vc=Math.round(Y*fl),Bc=Math.round(Y*_l),Gc=Y-Bc-Vc,wa=Math.round(H*fl),Ea=Math.round(H*_l),Aa=H-Ea-wa,W=Math.round(j*fl),V=Math.round(j*_l),B=j-V-W,el=Math.round($*fl),$i=Math.round($*_l),Ji=$-$i-el,
Cl=Math.round(ee*fl),Ul=Math.round(ee*_l),Pl=ee-Ul-Cl,ho=Math.round(te*fl),bo=Math.round(te*_l),fo=te-bo-ho,xs=Math.round(X*fl),Ns=Math.round(X*_l),Is=X-Ns-xs,dn=Math.round(Z*fl),cn=Math.round(Z*_l),rn=Z-cn-dn,ur=Math.round(K*fl),dr=Math.round(K*_l),cr=K-dr-ur,sd=Math.round(J*fl),ld=Math.round(J*_l),id=J-ld-sd,qa=Math.round(ae*fl),Fa=Math.round(ae*_l),Wa=ae-Fa-qa,si=Math.round(Q*fl),li=Math.round(Q*_l),ii=Q-li-si,gs=Nr*s[0]+Vc*s[1]+wa*s[2]+qa*s[12]+ur*s[10]+el*s[4]+ho*s[6]+W*s[3]+Cl*s[5]+xs*s[7]+dn*s[8]+sd*s[11]+si*s[9],ds=Ir*s[0]+Bc*s[1]+Ea*s[2]+Fa*s[12]+dr*s[10]+$i*s[4]+bo*s[6]+V*s[3]+Ul*s[5]+Ns*s[7]+cn*s[8]+ld*s[11]+li*s[9],ss=Mr*s[0]+Gc*s[1]+Aa*s[2]+Wa*s[12]+cr*s[10]+Ji*s[4]+fo*s[6]+B*s[3]+Pl*s[5]+Is*s[7]+rn*s[8]+id*s[11]+ii*s[9],console.log(ss,ds,gs),dc=Nr*n[0]*Zn[0]+Vc*n[1]*to[0]+wa*n[2]*kn[0]+qa*n[12]+ur*n[10]+el*n[4]*Gn[0]+ho*n[6]*Un[0]+W*n[3]*vn[0]+Cl*n[5]*Fn[0]+xs*n[7]*jn[0]+dn*n[8]*xn[0]+sd*n[11]+si*n[9],
sc=Ir*o[0]*Zn[0]+Bc*o[1]*to[0]+Ea*o[2]*kn[0]+Fa*o[12]+dr*o[10]+$i*o[4]*Gn[0]+bo*o[6]*Un[0]+V*o[3]*vn[0]+Ul*o[5]*Fn[0]+Ns*o[7]*jn[0]+cn*o[8]*xn[0]+ld*o[11]+li*o[9],oc=Mr*i[0]*Zn[0]+Gc*i[1]*to[0]+Aa*i[2]*kn[0]+Wa*i[12]+cr*i[10]+Ji*i[4]*Gn[0]+fo*i[6]*Un[0]+B*i[3]*vn[0]+Pl*i[5]*Fn[0]+Is*i[7]*jn[0]+rn*i[8]*xn[0]+id*i[11]+ii*i[9],Ks=Fs*l[7]*Ei[1]+En*l[8]*fi[1]+qe*l[11]+Ve*l[9]+Be*l[10],'cav'==Wi?(Jr=Ye*l[4]*hi[1]+je*l[6]*bi[1]+Ks,tc=Ce*l[0]*wi[1]+ze*l[1]*vi[1]+De*l[2]*_i[1]+Ke*l[12]*na,Qr=Ge*l[3]*Ti[1]+He*l[5]*Ai[1]):'inf'==Wi?(tc=Ce*l[0]*wi[1]+ze*l[1]*vi[1]+De*l[2]*_i[1]+Ke*l[12]*na+Ks,Jr=Ye*l[4]*hi[1]+je*l[6]*bi[1],Qr=Ge*l[3]*Ti[1]+He*l[5]*Ai[1]):'arc'==Wi?(tc=Ce*l[0]*wi[1]+ze*l[1]*vi[1]+De*l[2]*_i[1]+Ke*l[12]*na,Jr=Ye*l[4]*hi[1]+je*l[6]*bi[1],Qr=Ge*l[3]*Ti[1]+He*l[5]*Ai[1]+Ks):(tc=Ce*l[0]*wi[1]+ze*l[1]*vi[1]+De*l[2]*_i[1]+Ke*l[12]*na,Jr=Ye*l[4]*hi[1]+je*l[6]*bi[1],Qr=Ge*l[3]*Ti[1]+He*l[5]*Ai[1]),Zt=(qr=tc*Qt)+(Vr=Jr*Qt)+(Dr=Qr*Qt),Wt=(hc=dc*Bt+Na)+(_c=sc*Bt+Na)+(gc=oc*Bt+Na),
console.log(Zt,Wt),Bi=0==qr||0==hc?0:hc<=qr?1:Math.pow(qr/hc,.5)/(hc/qr),zi=0==Vr||0==_c?0:_c<=Vr?1:Math.pow(Vr/_c,.5)/(_c/Vr),Pi=0==Dr||0==gc?0:gc<=Dr?1:Math.pow(Dr/gc,.5)/(gc/Dr),xi=0==qr||0==hc?0:qr<=hc?1:Math.pow(hc/qr,.5)/(qr/hc),Mi=0==Vr||0==_c?0:Vr<=_c?1:Math.pow(_c/Vr,.5)/(Vr/_c),Ri=0==Dr||0==gc?0:Dr<=gc?1:Math.pow(gc/Dr,.5)/(Dr/gc),Po=Math.round(1e6*xi)/1e6,Oo=Math.round(1e6*Mi)/1e6,Lo=Math.round(1e6*Ri)/1e6,zo=Math.round(1e6*Bi)/1e6,Co=Math.round(1e6*zi)/1e6,Uo=Math.round(1e6*Pi)/1e6,Sr=Math.round(-Nr*zo+1e-6)+Math.round(-Ir*Co+1e-6)+Math.round(-Mr*Uo+1e-6),Uc=Math.round(-Vc*zo+1e-6)+Math.round(-Bc*Co+1e-6)+Math.round(-Gc*Uo+1e-6),_a=Math.round(-wa*zo+1e-6)+Math.round(-Ea*Co+1e-6)+Math.round(-Aa*Uo+1e-6),C=Math.round(-W*zo+1e-6)+Math.round(-V*Co+1e-6)+Math.round(-B*Uo+1e-6),Ki=Math.round(-el*zo+1e-6)+Math.round(-$i*Co+1e-6)+Math.round(-Ji*Uo+1e-6),Nl=Math.round(-Cl*zo+1e-6)+Math.round(-Ul*Co+1e-6)+Math.round(-Pl*Uo+1e-6),
go=Math.round(-ho*zo+1e-6)+Math.round(-bo*Co+1e-6)+Math.round(-fo*Uo+1e-6),Rs=Math.round(-xs*zo+1e-6)+Math.round(-Ns*Co+1e-6)+Math.round(-Is*Uo+1e-6),nn=Math.round(-dn*zo+1e-6)+Math.round(-cn*Co+1e-6)+Math.round(-rn*Uo+1e-6),td=Math.round(-sd*zo+1e-6)+Math.round(-ld*Co+1e-6)+Math.round(-id*Uo+1e-6),Da=Math.round(-qa*zo+1e-6)+Math.round(-Fa*Co+1e-6)+Math.round(-Wa*Uo+1e-6),ti=Math.round(-si*zo+1e-6)+Math.round(-li*Co+1e-6)+Math.round(-ii*Uo+1e-6),ir=Math.round(-ur*zo+1e-6)+Math.round(-dr*Co+1e-6)+Math.round(-cr*Uo+1e-6),hr=Math.round(-Ce*Po+1e-6),Nc=Math.round(-ze*Po+1e-6),ua=Math.round(-De*Po+1e-6),Oa=Math.round(-Ke*Po+1e-6),x=Math.round(-Ge*Lo+1e-6),Rl=Math.round(-He*Lo+1e-6),Fi=Math.round(-Ye*Oo+1e-6),so=Math.round(-je*Oo+1e-6),'cav'==Wi?(As=Math.round(-Fs*Oo+1e-6),Ja=Math.round(-En*Oo+1e-6),Qc=Math.round(-qe*Oo+1e-6),Xo=Math.round(-Ve*Oo+1e-6),er=Math.round(-Be*Oo+1e-6)):'inf'==Wi?(As=Math.round(-Fs*Po+1e-6),Ja=Math.round(-En*Po+1e-6),Qc=Math.round(-qe*Po+1e-6),
Xo=Math.round(-Ve*Po+1e-6),er=Math.round(-Be*Po+1e-6)):'arc'==Wi&&(As=Math.round(-Fs*Lo+1e-6),Ja=Math.round(-En*Lo+1e-6),Qc=Math.round(-qe*Lo+1e-6),Xo=Math.round(-Ve*Lo+1e-6),er=Math.round(-Be*Lo+1e-6)),wr=Ce+hr,Oc=ze+Nc,ma=De+ua,P=Ge+x,Hi=Ye+Fi,Ml=He+Rl,uo=je+so,vs=Fs+As,tn=En+Ja,Jc=qe+Qc,Ca=Ke+Oa,nr=Be+er,$o=Ve+Xo,kr=q+Sr,Dc=Y+Uc,ha=H+_a,G=j+C,Zi=$+Ki,Ol=ee+Nl,_o=te+go,Ms=X+Rs,sn=Z+nn,od=J+td,Va=ae+Da,rr=K+ir,oi=Q+ti,cl=hr*s[0]+Nc*s[1]+ua*s[2]+x*s[3]+Fi*s[4]+Rl*s[5]+so*s[6]+As*s[7]+Ja*s[8]+Xo*s[9]+er*s[10]+Qc*s[11]+Oa*s[12],pl=Sr*s[0]+Uc*s[1]+_a*s[2]+C*s[3]+Ki*s[4]+Nl*s[5]+go*s[6]+Rs*s[7]+nn*s[8]+ti*s[9]+ir*s[10]+td*s[11]+Da*s[12],console.log(cl,pl),Sc=wr*s[0]+Oc*s[1]+ma*s[2]+P*s[3]+Hi*s[4]+Ml*s[5]+uo*s[6]+vs*s[7]+tn*s[8]+Jc*s[11]+Ca*s[12]+nr*s[10]+$o*s[9],kc=kr*s[0]+Dc*s[1]+ha*s[2]+G*s[3]+Zi*s[4]+Ol*s[5]+_o*s[6]+Ms*s[7]+sn*s[8]+od*s[11]+Va*s[12]+rr*s[10]+oi*s[9],console.log(kc,Sc),da=0==Zt||0==Wt?0:Wt<=Zt?1:Math.pow(Zt/Wt,.5/(Wt/Zt)),console.log(da),
is=wr*s[0]+Oc*s[1]+ma*s[2]+P*s[3]+Hi*s[4]+Ml*s[5]+uo*s[6]+vs*s[7]+tn*s[8]+$o*s[9]+nr*s[10]+Jc*s[11]+Ca*s[12],fs=kr*s[0]+Dc*s[1]+ha*s[2]+G*s[3]+Zi*s[4]+Ol*s[5]+_o*s[6]+Ms*s[7]+sn*s[8]+oi*s[9]+rr*s[10]+od*s[11]+Va*s[12],console.log(is,fs),Hs=vs*s[7]+tn*s[8]+Jc*s[11]+$o*s[9],'cav'==Wi?($l=Hi*s[4]+uo*s[6]+Hs,as=wr*s[0]+Oc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],Xl=P*s[3]+Ml*s[5]):'inf'==Wi?(as=wr*s[0]+Oc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10]+Hs,$l=Hi*s[4]+uo*s[6],Xl=P*s[3]+Ml*s[5]):'arc'==Wi?(as=wr*s[0]+Oc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],$l=Hi*s[4]+uo*s[6],Xl=P*s[3]+Ml*s[5]+Hs):(as=wr*s[0]+Oc*s[1]+ma*s[2]+Ca*s[12]+nr*s[10],$l=Hi*s[4]+uo*s[6],Xl=P*s[3]+Ml*s[5]),Al=0==as?0:Math.round(as/is*1e4)/1e4,hl=0==$l?0:Math.round($l/is*1e4)/1e4,bl=0==Xl?0:Math.round(Xl/is*1e4)/1e4,console.log(bl),Pr=Math.round(kr*Al),Or=Math.round(kr*hl),Lr=kr-Or-Pr,Yc=Math.round(Dc*Al),qc=Math.round(Dc*hl),Fc=Dc-qc-Yc,ya=Math.round(ha*Al),Ra=Math.round(ha*hl),Sa=ha-Ra-ya,la=Math.round(G*Al),ia=Math.round(G*hl),oa=G-ia-la,
ol=Math.round(Zi*Al),nl=Math.round(Zi*hl),al=Zi-nl-ol,Bl=Math.round(Ol*Al),Gl=Math.round(Ol*hl),Dl=Ol-Gl-Bl,vo=Math.round(_o*Al),wo=Math.round(_o*hl),Eo=_o-wo-vo,Us=Math.round(Ms*Al),Ps=Math.round(Ms*hl),Os=Ms-Ps-Us,mn=Math.round(sn*Al),gn=Math.round(sn*hl),pn=sn-gn-mn,Tr=Math.round(rr*Al),mr=Math.round(rr*hl),gr=rr-mr-Tr,ud=Math.round(od*Al),dd=Math.round(od*hl),cd=od-dd-ud,Ka=Math.round(Va*Al),ja=Math.round(Va*hl),Ha=Va-ja-Ka,ui=Math.round(oi*Al),di=Math.round(oi*hl),ci=oi-di-ui,ms=Pr*s[0]+Yc*s[1]+ya*s[2]+Ka*s[12]+Tr*s[10]+ol*s[4]+vo*s[6]+la*s[3]+Bl*s[5]+Us*s[7]+mn*s[8]+ud*s[11]+ui*s[9],us=Or*s[0]+qc*s[1]+Ra*s[2]+ja*s[12]+mr*s[10]+nl*s[4]+wo*s[6]+ia*s[3]+Gl*s[5]+Ps*s[7]+gn*s[8]+dd*s[11]+di*s[9],rs=Lr*s[0]+Fc*s[1]+Sa*s[2]+Ha*s[12]+gr*s[10]+al*s[4]+Eo*s[6]+oa*s[3]+Dl*s[5]+Os*s[7]+pn*s[8]+cd*s[11]+ci*s[9],console.log(rs,us,ms),
uc=Pr*n[0]*Zn[0]+Yc*n[1]*to[0]+ya*n[2]*kn[0]+Ka*n[12]+Tr*n[10]+ol*n[4]*Gn[0]+vo*n[6]*Un[0]+la*n[3]*vn[0]+Bl*n[5]*Fn[0]+Us*n[7]*jn[0]+mn*n[8]*xn[0]+ud*n[11]+ui*n[9],rc=Or*o[0]*Zn[0]+qc*o[1]*to[0]+Ra*o[2]*kn[0]+ja*o[12]+mr*o[10]+nl*o[4]*Gn[0]+wo*o[6]*Un[0]+ia*o[3]*vn[0]+Gl*o[5]*Fn[0]+Ps*o[7]*jn[0]+gn*o[8]*xn[0]+dd*o[11]+di*o[9],ic=Lr*i[0]*Zn[0]+Fc*i[1]*to[0]+Sa*i[2]*kn[0]+Ha*i[12]+gr*i[10]+al*i[4]*Gn[0]+Eo*i[6]*Un[0]+oa*i[3]*vn[0]+Dl*i[5]*Fn[0]+Os*i[7]*jn[0]+pn*i[8]*xn[0]+cd*i[11]+ci*i[9],Qs=vs*l[7]*Ei[1]+tn*l[8]*fi[1]+Jc*l[11]+$o*l[9],'cav'==Wi?($r=Hi*l[4]*hi[1]+uo*l[6]*bi[1]+Qs,ac=wr*l[0]*wi[1]+Oc*l[1]*vi[1]+ma*l[2]*_i[1]+Ca*l[12]*na+nr*l[10],Xr=P*l[3]*Ti[1]+Ml*l[5]*Ai[1]):'inf'==Wi?(ac=wr*l[0]*wi[1]+Oc*l[1]*vi[1]+ma*l[2]*_i[1]+Ca*l[12]*na+nr*l[10]+Qs,$r=Hi*l[4]*hi[1]+uo*l[6]*bi[1],Xr=P*l[3]*Ti[1]+Ml*l[5]*Ai[1]):'arc'==Wi?(ac=wr*l[0]*wi[1]+Oc*l[1]*vi[1]+ma*l[2]*_i[1]+Ca*l[12]*na+nr*l[10],$r=Hi*l[4]*hi[1]+uo*l[6]*bi[1],
Xr=P*l[3]*Ti[1]+Ml*l[5]*Ai[1]+Qs):(ac=wr*l[0]*wi[1]+Oc*l[1]*vi[1]+ma*l[2]*_i[1]+Ca*l[12]*na+nr*l[10],$r=Hi*l[4]*hi[1]+uo*l[6]*bi[1],Xr=P*l[3]*Ti[1]+Ml*l[5]*Ai[1]),jr=(Yr=ac*Qt)+(Wr=$r*Qt)+(Gr=Xr*Qt),wc=(Ac=uc*Bt)+(fc=rc*Bt)+(mc=ic*Bt),console.log(jr,wc),Vi=0==Yr||0==Ac?0:Ac<=Yr?1:Math.pow(Yr/Ac,.5)/(Ac/Yr),Di=0==Wr||0==fc?0:fc<=Wr?1:Math.pow(Wr/fc,.5)/(fc/Wr),Ui=0==Gr||0==mc?0:mc<=Gr?1:Math.pow(Gr/mc,.5)/(mc/Gr),Li=0==Yr||0==Ac?0:Yr<=Ac?1:Math.pow(Ac/Yr,.5)/(Yr/Ac),Ii=0==Wr||0==fc?0:Wr<=fc?1:Math.pow(fc/Wr,.5)/(Wr/fc),yi=0==Gr||0==mc?0:Gr<=mc?1:Math.pow(mc/Gr,.5)/(Gr/mc),Bo=Math.round(1e6*Li)/1e6,Go=Math.round(1e6*Ii)/1e6,Do=Math.round(1e6*yi)/1e6,Fo=Math.round(1e6*Vi)/1e6,Wo=Math.round(1e6*Di)/1e6,Vo=Math.round(1e6*Ui)/1e6,Rr=Math.round(-Pr*Fo+1e-6)+Math.round(-Or*Wo+1e-6)+Math.round(-Lr*Vo+1e-6),Cc=Math.round(-Yc*Fo+1e-6)+Math.round(-qc*Wo+1e-6)+Math.round(-Fc*Vo+1e-6),fa=Math.round(-ya*Fo+1e-6)+Math.round(-Ra*Wo+1e-6)+Math.round(-Sa*Vo+1e-6),
z=Math.round(-la*Fo+1e-6)+Math.round(-ia*Wo+1e-6)+Math.round(-oa*Vo+1e-6),Qi=Math.round(-ol*Fo+1e-6)+Math.round(-nl*Wo+1e-6)+Math.round(-al*Vo+1e-6),xl=Math.round(-Bl*Fo+1e-6)+Math.round(-Gl*Wo+1e-6)+Math.round(-Dl*Vo+1e-6),mo=Math.round(-vo*Fo+1e-6)+Math.round(-wo*Wo+1e-6)+Math.round(-Eo*Vo+1e-6),ys=Math.round(-Us*Fo+1e-6)+Math.round(-Ps*Wo+1e-6)+Math.round(-Os*Vo+1e-6),on=Math.round(-mn*Fo+1e-6)+Math.round(-gn*Wo+1e-6)+Math.round(-pn*Vo+1e-6),ad=Math.round(-ud*Fo+1e-6)+Math.round(-dd*Wo+1e-6)+Math.round(-cd*Vo+1e-6),Ga=Math.round(-Ka*Fo+1e-6)+Math.round(-ja*Wo+1e-6)+Math.round(-Ha*Vo+1e-6),ai=Math.round(-ui*Fo+1e-6)+Math.round(-di*Wo+1e-6)+Math.round(-ci*Vo+1e-6),lr=Math.round(-Tr*Fo+1e-6)+Math.round(-mr*Wo+1e-6)+Math.round(-gr*Vo+1e-6),Ar=Math.round(-wr*Bo+1e-6),xc=Math.round(-Oc*Bo+1e-6),pa=Math.round(-ma*Bo+1e-6),Pa=Math.round(-Ca*Bo+1e-6),L=Math.round(-P*Do+1e-6),yl=Math.round(-Ml*Do+1e-6),qi=Math.round(-Hi*Go+1e-6),ro=Math.round(-uo*Go+1e-6),
'cav'==Wi?(Es=Math.round(-vs*Go+1e-6),$a=Math.round(-tn*Go+1e-6),Xc=Math.round(-Jc*Go+1e-6),Zo=Math.round(-$o*Go+1e-6)):'inf'==Wi?(Es=Math.round(-vs*Bo+1e-6),$a=Math.round(-tn*Bo+1e-6),Xc=Math.round(-Jc*Bo+1e-6),Zo=Math.round(-$o*Bo+1e-6)):'arc'==Wi&&(Es=Math.round(-vs*Do+1e-6),$a=Math.round(-tn*Do+1e-6),Xc=Math.round(-Jc*Do+1e-6),Zo=Math.round(-$o*Do+1e-6)),tr=100*nr==as?0:Math.round(-nr*Bo+1e-6),vr=wr+Ar,Pc=Oc+xc,Ta=ma+pa,U=P+L,ji=Hi+qi,Il=Ml+yl,po=uo+ro,Ss=vs+Es,an=tn+$a,$c=Jc+Xc,za=Ca+Pa,or=nr+tr,ei=$o+Zo,xr=kr+Rr,Wc=Dc+Cc,va=ha+fa,F=G+z,tl=Zi+Qi,zl=Ol+xl,Ao=_o+mo,Ls=Ms+ys,un=sn+on,rd=od+ad,Ya=Va+Ga,pr=rr+lr,ri=oi+ai,dl=Ar*s[0]+xc*s[1]+pa*s[2]+L*s[3]+qi*s[4]+yl*s[5]+ro*s[6]+Es*s[7]+$a*s[8]+Zo*s[9]+tr*s[10]+Xc*s[11]+Pa*s[12],gl=Rr*s[0]+Cc*s[1]+fa*s[2]+z*s[3]+Qi*s[4]+xl*s[5]+mo*s[6]+ys*s[7]+on*s[8]+ai*s[9]+lr*s[10]+ad*s[11]+Ga*s[12],console.log(dl,gl),Rc=vr*s[0]+Pc*s[1]+Ta*s[2]+U*s[3]+ji*s[4]+Il*s[5]+po*s[6]+Ss*s[7]+an*s[8]+$c*s[11]+za*s[12]+or*s[10]+ei*s[9],
Mc=xr*s[0]+Wc*s[1]+va*s[2]+F*s[3]+tl*s[4]+zl*s[5]+Ao*s[6]+Ls*s[7]+un*s[8]+rd*s[11]+Ya*s[12]+pr*s[10]+ri*s[9],console.log(Mc,Rc),ls=vr*s[0]+Pc*s[1]+Ta*s[2]+U*s[3]+ji*s[4]+Il*s[5]+po*s[6]+Ss*s[7]+an*s[8]+ei*s[9]+or*s[10]+$c*s[11]+za*s[12],bs=xr*s[0]+Wc*s[1]+va*s[2]+F*s[3]+tl*s[4]+zl*s[5]+Ao*s[6]+Ls*s[7]+un*s[8]+ri*s[9]+pr*s[10]+rd*s[11]+Ya*s[12],console.log(ls,bs),qs=Ss*s[7]+an*s[8]+$c*s[11]+ei*s[9],'cav'==Wi?(es=ji*s[4]+po*s[6]+qs,ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+or*s[10],Zl=U*s[3]+Il*s[5]):'inf'==Wi?(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+or*s[10]+qs,es=ji*s[4]+po*s[6],Zl=U*s[3]+Il*s[5]):'arc'==Wi?(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+or*s[10],es=ji*s[4]+po*s[6],Zl=U*s[3]+Il*s[5]+qs):(ns=vr*s[0]+Pc*s[1]+Ta*s[2]+za*s[12]+or*s[10],es=ji*s[4]+po*s[6],Zl=U*s[3]+Il*s[5]),vl=0==ns?0:Math.round(ns/ls*1e4)/1e4,wl=0==es?0:Math.round(es/ls*1e4)/1e4,El=0==Zl?0:Math.round(Zl/ls*1e4)/1e4,console.log(El),zr=Math.round(xr*vl),Cr=Math.round(xr*wl),Ur=xr-Cr-zr,Kc=Math.round(Wc*vl),jc=Math.round(Wc*wl),
Hc=Wc-jc-Kc,Ia=Math.round(va*vl),Ma=Math.round(va*wl),ka=va-Ma-Ia,ca=Math.round(F*vl),ra=Math.round(F*wl),sa=F-ra-ca,sl=Math.round(tl*vl),ll=Math.round(tl*wl),il=tl-ll-sl,Fl=Math.round(zl*vl),Wl=Math.round(zl*wl),Vl=zl-Wl-Fl,yo=Math.round(Ao*vl),Ro=Math.round(Ao*wl),So=Ao-Ro-yo,Ds=Math.round(Ls*vl),zs=Math.round(Ls*wl),Cs=Ls-zs-Ds,fn=Math.round(un*vl),_n=Math.round(un*wl),Tn=un-_n-fn,br=Math.round(pr*vl),fr=Math.round(pr*wl),_r=pr-fr-br,md=Math.round(rd*vl),gd=Math.round(rd*wl),pd=rd-gd-md,Za=Math.round(Ya*vl),Xa=Math.round(Ya*wl),Qa=Ya-Xa-Za,mi=Math.round(ri*vl),gi=Math.round(ri*wl),pi=ri-gi-mi,Ts=zr*s[0]+Kc*s[1]+Ia*s[2]+Za*s[12]+br*s[10]+sl*s[4]+yo*s[6]+ca*s[3]+Fl*s[5]+Ds*s[7]+fn*s[8]+md*s[11]+mi*s[9],ps=Cr*s[0]+jc*s[1]+Ma*s[2]+Xa*s[12]+fr*s[10]+ll*s[4]+Ro*s[6]+ra*s[3]+Wl*s[5]+zs*s[7]+_n*s[8]+gd*s[11]+gi*s[9],cs=Ur*s[0]+Hc*s[1]+ka*s[2]+Qa*s[12]+_r*s[10]+il*s[4]+So*s[6]+sa*s[3]+Vl*s[5]+Cs*s[7]+Tn*s[8]+pd*s[11]+pi*s[9],console.log(cs,ps,Ts),
pc=zr*n[0]*Zn[0]+Kc*n[1]*to[0]+Ia*n[2]*kn[0]+Za*n[12]+br*n[10]+sl*n[4]*Gn[0]+yo*n[6]*Un[0]+ca*n[3]*vn[0]+Fl*n[5]*Fn[0]+Ds*n[7]*jn[0]+fn*n[8]*xn[0]+md*n[11]+mi*n[9],cc=Cr*o[0]*Zn[0]+jc*o[1]*to[0]+Ma*o[2]*kn[0]+Xa*o[12]+fr*o[10]+ll*o[4]*Gn[0]+Ro*o[6]*Un[0]+ra*o[3]*vn[0]+Wl*o[5]*Fn[0]+zs*o[7]*jn[0]+_n*o[8]*xn[0]+gd*o[11]+gi*o[9],lc=Ur*i[0]*Zn[0]+Hc*i[1]*to[0]+ka*i[2]*kn[0]+Qa*i[12]+_r*i[10]+il*i[4]*Gn[0]+So*i[6]*Un[0]+sa*i[3]*vn[0]+Vl*i[5]*Fn[0]+Cs*i[7]*jn[0]+Tn*i[8]*xn[0]+pd*i[11]+pi*i[9],js=Ss*l[7]*Ei[1]+an*l[8]*fi[1]+$c*l[11]+ei*l[9],'cav'==Wi?(ec=ji*l[4]*hi[1]+po*l[6]*bi[1]+js,nc=vr*l[0]*wi[1]+Pc*l[1]*vi[1]+Ta*l[2]*_i[1]+za*l[12]*na+or*l[10],Zr=U*l[3]*Ti[1]+Il*l[5]*Ai[1]):'inf'==Wi?(nc=vr*l[0]*wi[1]+Pc*l[1]*vi[1]+Ta*l[2]*_i[1]+za*l[12]*na+or*l[10]+js,ec=ji*l[4]*hi[1]+po*l[6]*bi[1],Zr=U*l[3]*Ti[1]+Il*l[5]*Ai[1]):'arc'==Wi?(nc=vr*l[0]*wi[1]+Pc*l[1]*vi[1]+Ta*l[2]*_i[1]+za*l[12]*na+or*l[10],ec=ji*l[4]*hi[1]+po*l[6]*bi[1],
Zr=U*l[3]*Ti[1]+Il*l[5]*Ai[1]+js):(nc=vr*l[0]*wi[1]+Pc*l[1]*vi[1]+Ta*l[2]*_i[1]+za*l[12]*na+or*l[10],ec=ji*l[4]*hi[1]+po*l[6]*bi[1],Zr=U*l[3]*Ti[1]+Il*l[5]*Ai[1]),Kr=(Hr=nc*Qt)+(Fr=ec*Qt)+(Br=Zr*Qt),vc=(Ec=pc*Bt)+(bc=cc*Bt)+(Tc=lc*Bt),console.log(Kr,vc),Gi=0==Hr||0==Ec?0:Ec<=Hr?1:Math.pow(Hr/Ec,.5)/(Ec/Hr),Ci=0==Fr||0==bc?0:bc<=Fr?1:Math.pow(Fr/bc,.5)/(bc/Fr),Oi=0==Br||0==Tc?0:Tc<=Br?1:Math.pow(Br/Tc,.5)/(Tc/Br),Ni=0==Hr||0==Ec?0:Hr<=Ec?1:Math.pow(Ec/Hr,.5)/(Hr/Ec),ki=0==Fr||0==bc?0:Fr<=bc?1:Math.pow(bc/Fr,.5)/(Fr/bc),Si=0==Br||0==Tc?0:Br<=Tc?1:Math.pow(Tc/Br,.5)/(Br/Tc),Ho=Math.round(1e6*Ni)/1e6,Yo=Math.round(1e6*ki)/1e6,qo=Math.round(1e6*Si)/1e6,Qo=Math.round(1e6*Gi)/1e6,Ko=Math.round(1e6*Ci)/1e6,jo=Math.round(1e6*Oi)/1e6,yr=Math.round(-zr*Qo+1e-6)+Math.round(-Cr*Ko+1e-6)+Math.round(-Ur*jo+1e-6),zc=Math.round(-Kc*Qo+1e-6)+Math.round(-jc*Ko+1e-6)+Math.round(-Hc*jo+1e-6),ba=Math.round(-Ia*Qo+1e-6)+Math.round(-Ma*Ko+1e-6)+Math.round(-ka*jo+1e-6),
D=Math.round(-ca*Qo+1e-6)+Math.round(-ra*Ko+1e-6)+Math.round(-sa*jo+1e-6),Xi=Math.round(-sl*Qo+1e-6)+Math.round(-ll*Ko+1e-6)+Math.round(-il*jo+1e-6),Ll=Math.round(-Fl*Qo+1e-6)+Math.round(-Wl*Ko+1e-6)+Math.round(-Vl*jo+1e-6),To=Math.round(-yo*Qo+1e-6)+Math.round(-Ro*Ko+1e-6)+Math.round(-So*jo+1e-6),ks=Math.round(-Ds*Qo+1e-6)+Math.round(-zs*Ko+1e-6)+Math.round(-Cs*jo+1e-6),ln=Math.round(-fn*Qo+1e-6)+Math.round(-_n*Ko+1e-6)+Math.round(-Tn*jo+1e-6),nd=Math.round(-md*Qo+1e-6)+Math.round(-gd*Ko+1e-6)+Math.round(-pd*jo+1e-6),Ba=Math.round(-Za*Qo+1e-6)+Math.round(-Xa*Ko+1e-6)+Math.round(-Qa*jo+1e-6),ni=Math.round(-mi*Qo+1e-6)+Math.round(-gi*Ko+1e-6)+Math.round(-pi*jo+1e-6),sr=Math.round(-br*Qo+1e-6)+Math.round(-fr*Ko+1e-6)+Math.round(-_r*jo+1e-6),Er=Math.round(-vr*Ho+1e-6),Lc=Math.round(-Pc*Ho+1e-6),ga=Math.round(-Ta*Ho+1e-6),Ua=Math.round(-za*Ho+1e-6),O=Math.round(-U*qo+1e-6),kl=Math.round(-Il*qo+1e-6),Yi=Math.round(-ji*Yo+1e-6),co=Math.round(-po*Yo+1e-6),
'cav'==Wi?(ws=Math.round(-Ss*Yo+1e-6),en=Math.round(-an*Yo+1e-6),Zc=Math.round(-$c*Yo+1e-6),Jo=Math.round(-ei*Yo+1e-6)):'inf'==Wi?(ws=Math.round(-Ss*Ho+1e-6),en=Math.round(-an*Ho+1e-6),Zc=Math.round(-$c*Ho+1e-6),Jo=Math.round(-ei*Ho+1e-6)):'arc'==Wi&&(ws=Math.round(-Ss*qo+1e-6),en=Math.round(-an*qo+1e-6),Zc=Math.round(-$c*qo+1e-6),Jo=Math.round(-ei*qo+1e-6)),ar=100*or==ns?0:Math.round(-or*Ho+1e-6),Et=vr+Er,wt=Pc+Lc,vt=Ta+ga,St=U+O,Nt=ji+Yi,xt=Il+kl,Lt=po+co,kt=Ss+ws,Mt=an+en,It=$c+Zc,Ot=za+Ua,Rt=or+ar,yt=ei+Jo,ve=xr+yr,Se=Wc+zc,Re=va+ba,ye=F+D,Le=tl+Xi,Oe=zl+Ll,Pe=Ao+To,Ie=Ls+ks,Ne=un+ln,xe=rd+nd,Ue=Ya+Ba,ke=pr+sr,Me=ri+ni,ul=Er*s[0]+Lc*s[1]+ga*s[2]+O*s[3]+Yi*s[4]+kl*s[5]+co*s[6]+ws*s[7]+en*s[8]+Jo*s[9]+ar*s[10]+Zc*s[11]+Ua*s[12],ml=yr*s[0]+zc*s[1]+ba*s[2]+D*s[3]+Xi*s[4]+Ll*s[5]+To*s[6]+ks*s[7]+ln*s[8]+ni*s[9]+sr*s[10]+nd*s[11]+Ba*s[12],console.log(ul,ml),yc=Et*s[0]+wt*s[1]+vt*s[2]+St*s[3]+Nt*s[4]+xt*s[5]+Lt*s[6]+kt*s[7]+Mt*s[8]+It*s[11]+Ot*s[12]+Rt*s[10]+yt*s[9],
Ic=ve*s[0]+Se*s[1]+Re*s[2]+ye*s[3]+Le*s[4]+Oe*s[5]+Pe*s[6]+Ie*s[7]+Ne*s[8]+xe*s[11]+Ue*s[12]+ke*s[10]+Me*s[9],console.log(Ic,yc),Qe=-Ce+Et,Xe=-ze+wt,Ze=-De+vt,Je=-Ge+St,ot=-Ye+Nt,it=-He+xt,lt=-je+Lt,tt=-We+kt,at=-Fe+Mt,nt=-qe+It,st=-Ke+Ot,$e=-Be+Rt,et=-Ve+yt,ne=-q+ve,oe=-Y+Se,ie=-H+Re,le=-j+ye,pe=-$+Le,ge=-ee+Oe,me=-te+Pe,ce=-X+Ie,de=-Z+Ne,ue=-J+xe,Te=-ae+Ue,se=-K+ke,re=-Q+Me,Ws=0==kt?0:kt*Qt*xo[1],Io=20==zt?18:19==zt?17:18==zt?15:17==zt?14:16==zt?13:15==zt?11:14==zt?10:13==zt||12==zt?9:11==zt?8:10==zt?7:9==zt||8==zt?6:7==zt||6==zt?5:5==zt||4==zt||3==zt?4:2==zt||1==zt?3:0,Gs=0==xa?0:2*Io,Bs=0==Ws||0==Gs?0:-Ws/Gs,lo=zt<=$s?zt:zt-$s<-Bs?zt<$s?zt:$s:zt+Bs,Dt=Math.round(lo),Ut='wall'==h?Dt:v[t.BATTLE_TARGET_LEVEL],An=0==Mt||0==Ut?0:Mt*Qt*fi[1],
...
return qe},Fa.getTrebuchetaLosses=function(){return nt},Fa.getTrebuchetaRevived=function(){return _t},Fa.getTrebuchetaSurvived=function(){return It},Fa.getLcaAmount=function(){return Ye},Fa.getLcaLosses=function(){return ot},Fa.getLcaRevived=function(){return ft},Fa.getLcaSurvived=function(){return Nt},Fa.getMaaAmount=function(){return He},Fa.getMaaLosses=function(){return it},Fa.getMaaRevived=function(){return bt},Fa.getMaaSurvived=function(){return xt},Fa.getHcaAmount=function(){return je},Fa.getHcaLosses=function(){return lt},Fa.getHcaRevived=function(){return ht},Fa.getHcaSurvived=function(){return Lt},Fa.getBerserkeraAmount=function(){return Ke},Fa.getBerserkeraLosses=function(){return st},Fa.getBerserkeraRevived=function(){return At},Fa.getBerserkeraSurvived=function(){return Ot},Fa.getPresetBerserker=function(){return _a},Fa.getPresetAxe=function(){return la},Fa.getPresetArcher=function(){return sa},Fa.getPresetSnob=function(){return ga},Fa.getPresetKnight=function(){return ma},
Fa.getPresetHc=function(){return da},Fa.getPresetLc=function(){return ra},Fa.getPresetMa=function(){return ca},Fa.getPresetRam=function(){return ua},Fa.getPresetCatapult=function(){return pa},Fa.getPresetSpear=function(){return oa},Fa.getPresetSword=function(){return ia},Fa.getPresetTrebuchet=function(){return Ta},Fa.getVillageBerserker=function(){return Aa},Fa.getVillageAxe=function(){return ba},Fa.getVillageArcher=function(){return fa},Fa.getVillageSnob=function(){return ya},Fa.getVillageKnight=function(){return wa},Fa.getVillageHc=function(){return Ea},Fa.getVillageLc=function(){return va},Fa.getVillageMa=function(){return Sa},Fa.getVillageRam=function(){return Ra},Fa.getVillageCatapult=function(){return ha},Fa.getVillageSpear=function(){return ka},Fa.getVillageSword=function(){return Ma},Fa.getVillageTrebuchet=function(){return Ia},Fa})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',
BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','struct/MapData','two/utils'],(function(e,t,n,i,l,r,d,u,p,m,T,_,f,b,h,A,E,w,v){let S,R,y,k,M=o.getPresetList(),I=!1;const N={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},x=function(e,t){I=t.data},L=function(){I=!1},O=function(e){S.selectedTab=e},P=function(){t.isRunning()?t.stop():t.start()},U=function(){
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,p,g,m,T,_,f,b){let h,A,E,w=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),R=!1,y=!1;const k={};let M,I,N,x,L,O=!0;const P='builder_queue_log',U='builder_queue_settings',C=function(){const e=D();if(!O)return Y.stop(),!1;e.forEach((function(e){const t=I.getVillage(e),a=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void G(t))}))},z=function(){D().forEach((function(e){const t=I.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},D=function(){const e=L[r.GROUP_VILLAGES];let a=[];return e?(a=M.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},G=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(k);const o=L[r.BUILDING_SEQUENCES][L[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),F(t))return!1;o.some((function(a){if(++n[a]>t[a])return w.compute(e),B(e,a,(function(t,a){t&&a.job&&(_.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),q(e.getId(),a.job))})),!0}))},B=function(e,t,a){const n=W(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&L[r.PRIORIZE_FARM]){const t=E[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){i.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-L[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-L[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-L[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},F=function(e){for(let t in e)if(e[t]<E[t])return!1;return!0},q=function(e,t){let a={time:b.gameTime(),villageId:e,building:t.building,level:t.level};return N.unshift(a),N.length>500&&N.splice(N.length-500,N.length),f.set(P,N),!0};let Y={};return Y.start=function(){if(!O)return _.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,h=setInterval(C,6e4),A=setInterval(z,6e3),e((function(){D().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),C(),z()}),['all_villages_ready']),_.trigger(s.BUILDER_QUEUE_START)},Y.stop=function(){y=!1,clearInterval(h),
clearInterval(A),_.trigger(s.BUILDER_QUEUE_STOP)},Y.isRunning=function(){return y},Y.isInitialized=function(){return R},Y.getSettings=function(){return x},Y.getLogs=function(){return N},Y.clearLogs=function(){N=[],f.set(P,N),_.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},Y.addBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,x.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},Y.updateBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=o.getGameData().getBuildings();for(let a=0;a<e.length;a++){let n=e[a];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(a[e]=t,x.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},Y.removeSequence=function(e){let t=L[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],x.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},Y.init=function(){R=!0,N=f.get(P,[],!0),I=o.getSelectedCharacter(),M=o.getGroupList(),x=new n({settingsMap:c,storageKey:U}),x.onChange((function(e,t,a){L=x.getAll(),y&&t[d.ANALYSE]&&C(),a.quiet||_.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),L=x.getAll();for(let e in m)k[m[e]]=0;O=Object.keys(L[r.BUILDING_SEQUENCES]).length,E=!!O&&function(e){const t=L[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(L[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=I.getVillage(t.village_id);G(e)}),1e3)}))},Y})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a];Array.isArray(n)?(n.sort(()=>Math.random()-.5),t=t.concat(n)):t.push(n)}return t}
...
E.$watch('selectedTab',(function(){E.selectedTab===x.ADD?T=setInterval((function(){Y()}),2500):clearInterval(T)})),E.waitingCommands.forEach(e=>{X(e)});let _=new n('twoverflow_queue_window',(function(){clearInterval(T),fe.clearCountdownUpdates()}));_.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),_.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),_.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),_.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),_.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),_.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),_.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),_.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),_.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),_.register(s.COMMAND_QUEUE_START,fe.start),_.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',E)};return function(){v=o.getSelectedCharacter(),O=i.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)C.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){z[e]=0})),M.forEach((function(e){D[e]=!1})),R={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(z),officers:angular.copy(D),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},U={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',10,g('i18n')('description',a.loc.ale,'command_queue')),w.addEventListener('click',be),_.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),_.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,W),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,p,g,m,T,b,h,A,E,w,v,S,R,y){let k,M,I,N,x,L=!1,O=!1,P=[],U=[],C=[],z=[],D=[],G=[],B=!1,V=!1,W=!1,F=0,q=null,Y=null,H=null,j={},K=A.gameTime(),Q=null,X=null;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(M[r.MIN_DISTANCE],M[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===N.getId()},included:function(e){return e.character_id&&!C.includes(e.id)},ignored:function(e){return z.includes(e.id)},points:function(e){
return!e.between(M[r.MIN_POINTS],M[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},oe=function(){!function(){const e=M[r.GROUP_INCLUDE];C=[],e.forEach((function(e){let t=o.getGroupList().getGroupVillageIds(e);C=C.concat(t)})),C=ne(C)}(),function(){const e=M[r.GROUP_IGNORE];z=o.getGroupList().getGroupVillageIds(e)}(),function(){const e=M[r.GROUP_ONLY];D=[],e.forEach((function(e){let t=o.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!N.getVillage(e)})),D=D.concat(t)})),D=ne(D)}(),function(){const e=z.concat(C);let t=!1;e.forEach((function(e){f.call(I,e)||(I[e]={time:A.gameTime(),report:!1},t=!0)})),T.each(I,(function(a,n){n=parseInt(n,10),e.includes(n)||(delete I[n],t=!0)})),t&&(y.set($,I),E.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),E.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},ie=function(e,t){
const a=M[r.GROUP_INCLUDE],n=M[r.GROUP_IGNORE],o=M[r.GROUP_ONLY],i=N.getVillage(t.village_id);let l=!1;if(oe(),n===t.group_id&&(i?(ke(t.village_id),l=!0):(Ne(t.village_id),_e(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!i&&(xe(),_e(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),o.includes(t.group_id)&&i){let e=Se(t.village_id);e.init().then((function(){O&&e.start()})),l=!0}l&&E.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=M[r.GROUP_INCLUDE],n=M[r.GROUP_IGNORE],o=M[r.GROUP_ONLY],i=N.getVillage(t.village_id);let l=!1;if(oe(),n===t.group_id)if(i){let e=Se(t.village_id);e.init().then((function(){O&&e.start()})),l=!0}else xe(),_e(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!i&&(xe(),_e(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),o.includes(t.group_id)&&i&&(ke(t.village_id),l=!0),l&&E.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=o.getGroupList().getGroups(),a=M[r.GROUP_IGNORE],n=M[r.GROUP_ONLY],i=M[r.GROUP_INCLUDE],l=f.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=n.filter(e=>f.call(t,e)),c=i.filter(e=>f.call(t,e));k.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),oe(),ye(),xe(),Re()},ce=function(){G=[];const e=o.getPresetList().getPresets();M[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),G.push(a)})),G=G.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),G.length||(E.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),O&&Le.stop())},ue=function(e,t){M[r.IGNORE_ON_LOSS]&&M[r.GROUP_IGNORE]&&O&&t.type===w.TYPES.ATTACK&&1!==t.result&&Ie(t.target_village_id)&&(j[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=M[r.GROUP_IGNORE];!!t&&i.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===l.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=x[a].load*e)})),t},Te=function(e){I[e]={time:A.gameTime(),report:j[e]||!1},delete j[e],y.set($,I),E.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},_e=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=A.gameTime(),t.type=e,U.unshift(t),fe(),!0)},fe=function(){const e=M[r.LOGS_LIMIT];U.length>e&&U.splice(U.length-e,U.length),y.set(Z,U),E.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},be=function(e,t,a){const n=M[r.TARGET_MULTIPLE_FARMERS],o=M[r.TARGET_SINGLE_ATTACK];if(n&&a){if(o&&e)return!0}else if(o){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=A.gameTime()},Ae=function(){clearTimeout(q),clearTimeout(Y),clearTimeout(H),q=null,Y=null,H=null
},Ee=function(){return Math.max(1,60*M[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*M[r.ATTACK_INTERVAL])},ve=function(e){if(this.villageId=e,this.village=N.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=_,this.status=n.WAITING_CYCLE};ve.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{E.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},ve.prototype.start=function(){return he(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,E.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(E.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(E.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,E.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),Ae(),this.onCycleEndFn(e),this.onCycleEndFn=_},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const _=()=>new Promise((t,a)=>{e.delay?Y=setTimeout(()=>{if(Y=null,!this.running)return a(n.USER_STOP);t()},T.randomSeconds(we())):t()}),b=()=>new Promise((e,a)=>{const o=50-M[r.PRESERVE_COMMAND_SLOTS];t.length>=o?a(n.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(M[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),o=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===o))return t(n.FULL_STORAGE)}e()
}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(n.NO_TARGETS)),k=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,o=>{if(te.points(o.points))return t(n.NOT_ALLOWED_POINTS);i.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},o=>{this.running?null!==a.character_id||null===o.owner_id||C.includes(a.id)?a.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),I=()=>new Promise((e,t)=>{!function(e,t){const a=o.getPresetList().getPresetsByVillageId(e);let n=[];if(G.forEach((function(e){f.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)f.call(a,e)&&n.push(e);i.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),x=()=>new Promise((e,t)=>{const o=this.village.getUnitInfo().getUnits(),i=60*M[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,a);T.each(G,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return o[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return i>r*s?(g=l,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),L=()=>new Promise((e,o)=>{c=!1,p=N.getVillageList();const i=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(i&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),be(u,c,i))return o(n.BUSY_TARGET);i&&(m=!0),e()}),O=()=>new Promise((e,t)=>{if(!u&&!c)return e();const o=60*M[r.MULTIPLE_ATTACKS_INTERVAL];if(!o)return e();if(M[r.TARGET_SINGLE_ATTACK]&&!M[r.TARGET_MULTIPLE_FARMERS])return e();const i=Math.round(A.gameTime()/1e3),l=M[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),T=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),_=d.getTravelTimeForDistance(g,T,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(i+_-e.time_completed)<o)}))return t(n.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(m)return e();i.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const o=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),i=o.some(e=>e.start_village_id!==this.villageId),l=o.some(e=>e.start_village_id===this.villageId);if(be(l,i,!0))return t(n.BUSY_TARGET);e()})});let U=new Promise((e,t)=>{_().then(b).then(S).then(y).then(k).then(I).then(x).then(L).then(O).then(P).then(e).catch(t)}),z=new Promise((e,t)=>{H=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([U,z]).then(()=>{if(!this.running)return!1
...
define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/marketHelper/types/buildings','two/marketHelper/types/level','two/marketHelper/types/units','two/ready','queues/EventQueue'],(function(e,t,n,i,l,r,c,d,u){let p,g,m=!1,T=!1,_=[];const f='market_helper_settings',b={[c.SPEAR]:'spear',[c.SWORD]:'sword',[c.AXE]:'axe',[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},h={[l.HEADQUARTER]:'headquarter',[l.WAREHOUSE]:'warehouse',[l.FARM]:'farm',[l.RALLY_POINT]:'rally_point',[l.STATUE]:'statue',[l.WALL]:'wall',[l.TAVERN]:'tavern',[l.BARRACKS]:'barracks',[l.PRECEPTORY]:'preceptory',[l.HOSPITAL]:'hospital',[l.CLAY_PIT]:'clay_pit',[l.IRON_MINE]:'iron_mine',[l.TIMBER_CAMP]:'timber_camp',
[l.CHAPEL]:'chapel',[l.CHURCH]:'church',[l.MARKET]:'market',[l.ACADEMY]:'academy'},A={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3,[r.LEVEL_4]:4,[r.LEVEL_5]:5,[r.LEVEL_6]:6,[r.LEVEL_7]:7,[r.LEVEL_8]:8,[r.LEVEL_9]:9,[r.LEVEL_10]:10,[r.LEVEL_11]:11,[r.LEVEL_12]:12,[r.LEVEL_13]:13,[r.LEVEL_14]:14,[r.LEVEL_15]:15,[r.LEVEL_16]:16,[r.LEVEL_17]:17,[r.LEVEL_18]:18,[r.LEVEL_19]:19,[r.LEVEL_20]:20,[r.LEVEL_21]:21,[r.LEVEL_22]:22,[r.LEVEL_23]:23,[r.LEVEL_24]:24,[r.LEVEL_25]:25,[r.LEVEL_26]:26,[r.LEVEL_27]:27,[r.LEVEL_28]:28,[r.LEVEL_29]:29,[r.LEVEL_30]:30};console.log(A,h,b);const E=function(){_=[];const e=o.getGroupList().getGroups();g[t.GROUPS].forEach((function(t){_.push(e[t])})),console.log('selectedGroups',_)},w={init:function(){m=!0,p=new e({settingsMap:n,storageKey:f}),p.onChange((function(e,t){g=p.getAll(),t[i.GROUPS]&&E()})),g=p.getAll(),console.log('marketHelper settings',g),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){T=!0,
console.log('selectedGroups',_),u.trigger(s.MARKET_HELPER_START)},stop:function(){T=!1,console.log('marketHelper stop'),u.trigger(s.MARKET_HELPER_STOP)},getSettings:function(){return p},isInitialized:function(){return m},isRunning:function(){return T}};return w})),define('two/marketHelper/events',[],(function(){angular.extend(s,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/types/buildings','two/marketHelper/types/level','two/marketHelper/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,l,r,d,u,p,m){let T,_,f,b=o.getGroupList();const h={TRADE:'trade',INSTANT_TRADE:'instant_trade',LOGS:'logs'},A=function(e){T.selectedTab=e},E=function(){_.setAll(_.decode(T.settings)),m.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},v=function(){
t.isRunning()?t.stop():t.start()},S=function(){T.groups=u.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},R=function(){T.running=!0,f.classList.remove('btn-orange'),f.classList.add('btn-red'),m.notif('success','marketHelper started')},y=function(){T.running=!1,f.classList.remove('btn-red'),f.classList.add('btn-orange'),m.notif('success','marketHelper stopped')},k=function(){T=a.$new(),T.SETTINGS=n,T.TAB_TYPES=h,T.running=t.isRunning(),T.selectedTab=h.TRADE,T.settingsMap=i,T.level=u.encodeList(r,{textObject:'market_helper',disabled:!0}),T.units=u.encodeList(d,{textObject:'market_helper',disabled:!0}),T.buildings=u.encodeList(l,{textObject:'market_helper',disabled:!0}),_.injectScope(T),S(),T.selectTab=A,T.saveSettings=E,T.switchState=w,T.switchStateI=v;let e=new p('twoverflow_market_helper_window',(function(){console.log('marketHelper closed')}));e.register(s.GROUPS_CREATED,S,!0),e.register(s.GROUPS_DESTROYED,S,!0),e.register(s.GROUPS_UPDATED,S,!0),
e.register(s.MARKET_HELPER_START,R),e.register(s.MARKET_HELPER_STOP,y),c.getScreenWithInjectedScope('!twoverflow_market_helper_window',T)};return function(){_=t.getSettings(),f=e.addMenuButton2('Handlarz',30,g('i18n')('description',a.loc.ale,'market_helper')),f.addEventListener('click',k),
...
;if(q.isNAP(e.tribe_id))return F.friendly}}return F.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const o=t||we(n);if(!o)continue;const i=n.x*R+(n.y%2?k:0),l=n.y*R;U.fillStyle=o,U.fillRect(i,l,S,S)}},Se=function(){S=ie[H[i.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,P.width=1e3*R,P.height=1e3*R,U.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;L.width=686,L.height=e,C.width=686,C.height=e,O.imageSmoothingEnabled=!1,z.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[N,x,e]),3===e.which&&(a=N,n=x,_.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(H[i.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id},A.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({
...
},xe=function(e){return e.preventDefault(),!1},Le=function(){K.tribe=le.getCustomColorsByGroup(E.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(E.PLAYER_COLORS)||{},fe()},Oe=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?E.PLAYER_COLORS:E.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t];const n='character'===e?E.PLAYER_COLORS:E.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e]),
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){L=e,L.style.background=H[i.COLOR_BACKGROUND],O=L.getContext('2d')},setViewportRef:function(e){C=e,z=C.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!D.width||!D.height)return!1;let e=_.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=_e(e[0]*t,e[1]*t),n=_e(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,D.width/2,D.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return Y},Pe.drawMinimap=function(){ge&&(ge=!1),L.style.background=H[i.COLOR_BACKGROUND],U.clearRect(0,0,P.width,P.height),d((function(){!function(){
const e=h.getPath(w.getMapPath()),t=H[i.SHOW_CONTINENT_DEMARCATIONS],a=H[i.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){U.fillStyle=H[i.COLOR_CONTINENT],U.fillRect(e*R+k-1,t*R+k-1,3,1),U.fillRect(e*R+k,t*R+k-2,1,3)},o=function(e,t){U.fillStyle=H[i.COLOR_PROVINCE],U.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const i=new DataView(e.response),l={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=b.toTile(i,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&o(e,l))}const r=l.a*R,c=s.a*R,d=(l.b-l.a)*R,u=(s.b-s.a)*R;U.beginPath(),U.lineWidth=2,U.strokeStyle="#2B4700",U.rect(r,c,d,u),U.stroke()}))}(),fe()}),'minimap_data')},Pe.enableRendering=function(){j=!0},Pe.disableRendering=function(){j=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),U=P.getContext('2d'),re=se.make('hover'),Y=new u({settingsMap:l,storageKey:oe}),Y.onChange((function(e,t){H=Y.getAll(),
...
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(M),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),be(),a.$on(s.VILLAGE_SELECTED_CHANGED,Oe),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Le)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,o,d,u,p,m,T,_,f,b,h,A,E){let w,v,S,R,y,k,M,I,N,x,L,O={},P=!1,U={character:{},tribe:{}};const C={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=C.MINIMAP,D=function(e){w.selectedTab=e,e===C.MINIMAP?o.enableRendering():o.disableRendering()},G=function(){Object.keys(w.highlights.character).forEach((function(e){e in U.character||function(e,t){i.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
U.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in U.tribe||function(e,t){i.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){U.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!N)return;let a=B(t.x,t.y);var n,o;x=a,O[a]=!0,P=!0,(n=t.x,o=t.y,new Promise((function(e){let t=h.getTownAt(n,o);if(t)return e(t);h.loadTownDataAsync(n,o,1,1,(function(t){e(t)}))}))).then((function(e){if(!O[B(e.x,e.y)])return;if(!P)return;M.appendChild(N),N.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=N.getBoundingClientRect(),n=M.getBoundingClientRect(),o=a.width+50,i=a.height+50,l=k.tt.position.y+i>n.top+n.height,s=k.tt.position.x+o>n.width;l&&(k.tt.position.y-=50),N.classList.toggle('left',s),N.classList.toggle('top',l)}))},W=function(e,t){if(!N)return;let a=t?B(t):x;O[a]=!1,P=!1,k.tt.visible=!1,N.classList.add('ng-hide'),I.appendChild(N)},F=function(e,t,n){let i,l,s=a.$new(),r=!0;s.colorPalettes=E.palette,'setting'===e?(l=t,i=L.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=L.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(i=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(i=w.highlights[t][n],s.submit=function(){o.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=i.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},q=function(){o.addHighlight(w.selectedHighlight,w.addHighlightColor)},Y=function(){L.setAll(L.decode(w.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},H=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){L.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},j=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){G()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+A.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=C,w.selectedTab=z,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=o.getHighlights(),w.highlightNames=U,w.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=D,w.openColorPalette=F,w.addCustomHighlight=q,w.removeHighlight=o.removeHighlight,w.saveSettings=Y,w.resetSettings=H,w.highlightsCount=j,w.openProfile=K,L.injectScope(w,{textObject:'minimap'});let e=new _('twoverflow_minimap_window',(function(){o.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),G(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(S),y.appendChild(R),o.enableRendering(),o.isFirstDraw()&&o.drawMinimap()};return function(){L=o.getSettings(),k=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',R=document.createElement('canvas'),R.className='cross',o.setViewport(S),o.setViewportRef(R),N=document.querySelector('#map-tooltip'),M=document.querySelector('#wrapper'),I=document.querySelector('#map'),v=t.addMenuButton4('Minimapa',30,g('i18n')('general.description',a.loc.ale,'minimap')),v.addEventListener('click',(function(){const e=o.getMapPosition();if(!e)return!1;X(),o.setCurrentPosition(e.x,e.y)})),
...
[i.LEVEL_10]:50,[i.LEVEL_11]:55,[i.LEVEL_12]:60,[i.LEVEL_13]:65,[i.LEVEL_14]:70,[i.LEVEL_15]:75,[i.LEVEL_16]:80,[i.LEVEL_17]:85,[i.LEVEL_18]:90,[i.LEVEL_19]:95,[i.LEVEL_20]:100};console.log(m,T);const _={init:function(){u=!0,c=new e({settingsMap:a,storageKey:g}),c.onChange((function(){d=c.getAll()})),d=c.getAll(),console.log('powerHelper settings',d)},start:function(){p=!0,r.trigger(s.POWER_HELPER_START)},stop:function(){p=!1,console.log('powerHelper stop'),r.trigger(s.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/powerHelper/events',[],(function(){angular.extend(s,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/types/ironwalls','two/powerHelper/types/wall','two/Settings','two/EventScope','two/utils'],(function(e,t,n,o,i,l,r,d,u){let p,g,m;const T={POWERS:'powers',BUNKER:'bunker',BEATBUNKER:'beatbunker'},_=function(e){p.selectedTab=e},f=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},b=function(){t.isRunning()?t.stop():t.start()},h=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},A=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),u.notif('success','Example module stopped')},E=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.POWERS,p.settingsMap=o,p.wall=r.encodeList(l,{textObject:'battle_calculator',disabled:!0}),p.ironwalls=r.encodeList(i,{textObject:'battle_calculator',disabled:!0
}),g.injectScope(p),p.selectTab=_,p.saveSettings=f,p.switchState=b;let e=new d('twoverflow_power_helper_window',(function(){console.log('powerHelper closed')}));e.register(s.POWER_HELPER_START,h),e.register(s.POWER_HELPER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton4('Bunkry',20),m.addEventListener('click',E),
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,n,i,l,r,c){let d,u,p=!1,g=!1,m=[];const T='prank_helper_settings',_={[l.INCREASE]:'increase',[l.DECREASE]:'decrease',[l.RANDOM]:'random'};console.log(_);const f=function(){m=[];const e=o.getGroupList().getGroups();u[t.GROUPS].forEach((function(t){m.push(e[t])}))},b={init:function(){p=!0,d=new e({settingsMap:n,storageKey:T}),d.onChange((function(e,t){u=d.getAll(),t[i.GROUPS]&&f()})),u=d.getAll(),console.log('all settings',u),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){g=!0,c.trigger(s.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(s.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return b})),define('two/prankHelper/events',[],(function(){angular.extend(s,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,l,r,d,u){let p,g,m,T=o.getGroupList();const _={RENAME:'rename',LOGS:'logs'},f=function(e){p.selectedTab=e},b=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},E=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},w=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
u.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=_,p.running=t.isRunning(),p.selectedTab=_.RENAME,p.settingsMap=i,p.type=r.encodeList(l,{textObject:'prank_helper',disabled:!0}),g.injectScope(p),A(),p.selectTab=f,p.saveSettings=b,p.switchState=h;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(s.GROUPS_CREATED,A,!0),e.register(s.GROUPS_DESTROYED,A,!0),e.register(s.GROUPS_UPDATED,A,!0),e.register(s.PRANK_HELPER_START,E),e.register(s.PRANK_HELPER_STOP,w),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',80),m.addEventListener('click',v),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,i,l,r){let c,d,u=!1,p=!1,g=[],m=[],T=[],_=[];const f='preset_asigner_settings',b=function(){g=[],m=[];const e=o.getPresetList().getPresets(),a=d[t.PRESETS1],n=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),n.forEach((function(t){m.push(e[t])}))},h=function(){T=[],_=[];const e=o.getGroupList().getGroups(),a=d[t.GROUP1],n=d[t.GROUP2];a.forEach((function(t){T.push(e[t])})),n.forEach((function(t){_.push(e[t])}))},A={init:function(){u=!0,c=new e({settingsMap:n,storageKey:f}),c.onChange((function(e,t){d=c.getAll(),t[i.PRESETS]&&b(),t[i.GROUPS]&&h()})),d=c.getAll(),console.log('presetAsigner settings',d),l((function(){b()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,b),a.$on(s.ARMY_PRESET_DELETED,b),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){p=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return A})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,l,r,d){let u,p,g,m=o.getPresetList(),T=o.getGroupList();const _={PRESETS:'presets',LOGS:'logs'},f=function(e){u.selectedTab=e},b=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()
},A=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},E=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=_,u.running=t.isRunning(),u.selectedTab=_.PRESETS,u.settingsMap=i,p.injectScope(u),A(),E(),u.selectTab=f,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,E,!0),e.register(s.GROUPS_DESTROYED,E,!0),e.register(s.GROUPS_UPDATED,E,!0),e.register(s.PRESET_ASIGNER_START,w),e.register(s.PRESET_ASIGNER_STOP,v),
...
define('two/recruitQueue',['two/Settings','two/recruitQueue/types/errors','two/recruitQueue/types/status','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/farmOverflow/types/logs','two/ready','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,u,p,g,m,T,_){let f,b,h,A=!1,E=!1,w=null,v=[];let S=[],R=[],y=[],k=[],M=[],I=[],N=[],x=[],L=[],O=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],F=[],q=[],Y=[],H=[],j=[];const K='recruit_queue_settings',Q='recruit_queue_log',X={[u.SPEAR]:'spear',[u.SWORD]:'sword',[u.AXE]:'axe',[u.ARCHER]:'archer',[u.LIGHT_CAVALRY]:'light_cavalry',[u.MOUNTED_ARCHER]:'mounted_archer',[u.HEAVT_CAVALRY]:'heavy_cavalry',[u.RAM]:'ram',[u.CATAPULT]:'catapult'};console.log(X);const Z=function(){S=[],R=[],y=[],k=[],M=[],I=[],N=[],x=[],L=[],O=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],F=[],q=[],Y=[],H=[],j=[]
;const e=o.getGroupList().getGroups(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],i=b[r.GROUP4],l=b[r.GROUP5],s=b[r.GROUP6],c=b[r.GROUP7],d=b[r.GROUP8],u=b[r.GROUP9],p=b[r.GROUP10],g=b[r.GROUP11],m=b[r.GROUP12],T=b[r.GROUP13],_=b[r.GROUP14],f=b[r.GROUP15],h=b[r.GROUP16],A=b[r.GROUP17],E=b[r.GROUP18],w=b[r.GROUP19],v=b[r.GROUP20],K=b[r.GROUP21],Q=b[r.GROUP22],X=b[r.GROUP23],Z=b[r.GROUP24];t.forEach((function(t){S.push(e[t])})),a.forEach((function(t){R.push(e[t])})),n.forEach((function(t){y.push(e[t])})),i.forEach((function(t){k.push(e[t])})),l.forEach((function(t){M.push(e[t])})),s.forEach((function(t){I.push(e[t])})),c.forEach((function(t){N.push(e[t])})),d.forEach((function(t){x.push(e[t])})),u.forEach((function(t){L.push(e[t])})),p.forEach((function(t){O.push(e[t])})),g.forEach((function(t){P.push(e[t])})),m.forEach((function(t){U.push(e[t])})),T.forEach((function(t){C.push(e[t])})),_.forEach((function(t){z.push(e[t])})),f.forEach((function(t){D.push(e[t])})),h.forEach((function(t){
G.push(e[t])})),A.forEach((function(t){B.push(e[t])})),E.forEach((function(t){V.push(e[t])})),w.forEach((function(t){W.push(e[t])})),v.forEach((function(t){F.push(e[t])})),K.forEach((function(t){q.push(e[t])})),Q.forEach((function(t){Y.push(e[t])})),X.forEach((function(t){H.push(e[t])})),Z.forEach((function(t){j.push(e[t])}))},J=function(){return Math.max(1,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3)},$=function(e,t,a){let n={time:_.gameTime(),villageId:e,unit:t,amount:a};return h.unshift(n),h.length>500&&h.splice(h.length-500,h.length),T.set(Q,h),!0},ee={init:function(){A=!0,h=T.get(Q,[],!0),f=new e({settingsMap:c,storageKey:K}),f.onChange((function(e,t){b=f.getAll(),t[d.GROUPS]&&Z()})),b=f.getAll(),console.log('recruitQueue settings',b),a.$on(s.GROUPS_CREATED,Z),a.$on(s.GROUPS_DESTROYED,Z),a.$on(s.GROUPS_UPDATED,Z)},ownRecrutation:function(){}};return ee.presetRecrutation=function(){if(1==E)return;m.trigger(s.RECRUIT_QUEUE_CYCLE_BEGIN),w=_.gameTime()+J()
;const e=o.getGroupList(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],c=b[r.GROUP4];var d=e.getGroupVillageIds(t),u=e.getGroupVillageIds(a),p=e.getGroupVillageIds(n),g=e.getGroupVillageIds(c)
;const T=b[r.MIN_PACK1],f=b[r.MIN_PACK2],h=b[r.MIN_PACK3],A=b[r.MIN_PACK4],S=b[r.START_AMOUNT4],R=b[r.START_AMOUNT3],y=b[r.START_AMOUNT9],k=b[r.START_AMOUNT7],M=b[r.START_AMOUNT5],I=b[r.START_AMOUNT6],N=b[r.START_AMOUNT8],x=b[r.START_AMOUNT1],L=b[r.START_AMOUNT2],O=b[r.START_AMOUNT14],P=b[r.START_AMOUNT13],U=b[r.START_AMOUNT19],C=b[r.START_AMOUNT17],z=b[r.START_AMOUNT15],D=b[r.START_AMOUNT16],G=b[r.START_AMOUNT18],B=b[r.START_AMOUNT11],V=b[r.START_AMOUNT12],W=b[r.START_AMOUNT24],F=b[r.START_AMOUNT23],q=b[r.START_AMOUNT29],Y=b[r.START_AMOUNT27],H=b[r.START_AMOUNT25],j=b[r.START_AMOUNT26],K=b[r.START_AMOUNT28],Q=b[r.START_AMOUNT21],X=b[r.START_AMOUNT22],Z=b[r.START_AMOUNT34],ee=b[r.START_AMOUNT33],te=b[r.START_AMOUNT39],ae=b[r.START_AMOUNT37],ne=b[r.START_AMOUNT35],oe=b[r.START_AMOUNT36],ie=b[r.START_AMOUNT38],le=b[r.START_AMOUNT31],se=b[r.START_AMOUNT32],re=b[r.FINAL_AMOUNT4],ce=b[r.FINAL_AMOUNT3],de=b[r.FINAL_AMOUNT9],ue=b[r.FINAL_AMOUNT7],pe=b[r.FINAL_AMOUNT5],ge=b[r.FINAL_AMOUNT6],me=b[r.FINAL_AMOUNT8],Te=b[r.FINAL_AMOUNT1],_e=b[r.FINAL_AMOUNT2],fe=b[r.FINAL_AMOUNT14],be=b[r.FINAL_AMOUNT13],he=b[r.FINAL_AMOUNT19],Ae=b[r.FINAL_AMOUNT17],Ee=b[r.FINAL_AMOUNT15],we=b[r.FINAL_AMOUNT16],ve=b[r.FINAL_AMOUNT18],Se=b[r.FINAL_AMOUNT11],Re=b[r.FINAL_AMOUNT12],ye=b[r.FINAL_AMOUNT24],ke=b[r.FINAL_AMOUNT23],Me=b[r.FINAL_AMOUNT29],Ie=b[r.FINAL_AMOUNT27],Ne=b[r.FINAL_AMOUNT25],xe=b[r.FINAL_AMOUNT26],Le=b[r.FINAL_AMOUNT28],Oe=b[r.FINAL_AMOUNT21],Pe=b[r.FINAL_AMOUNT22],Ue=b[r.FINAL_AMOUNT34],Ce=b[r.FINAL_AMOUNT33],ze=b[r.FINAL_AMOUNT39],De=b[r.FINAL_AMOUNT37],Ge=b[r.FINAL_AMOUNT35],Be=b[r.FINAL_AMOUNT36],Ve=b[r.FINAL_AMOUNT38],We=b[r.FINAL_AMOUNT31],Fe=b[r.FINAL_AMOUNT32]
;var qe=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],Ye=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],He=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],je=[1,1,1,1,4,5,6,5,8,1,100,10,6],Ke=0,Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,ot=0,it=0,lt=0,st='',rt=0,ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,_t=0,ft=0,bt=0,ht=0,At=0,Et=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,Mt=0,It=0,Nt=0,xt=0,Lt=0,Ot=0,Pt=0,Ut=0,Ct=0,zt=0,Dt=0,Gt=0,Bt=0,Vt=0,Wt=0,Ft=0,qt=0,Yt=0,Ht=0,jt=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,oa=0,ia=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=[],ma=0,Ta=0,_a=0,fa=[],ba=0,ha=0,Aa=0,Ea=[],wa=0,va=0,Sa=0,Ra=[],ya=0,ka=0,Ma=0,Ia=0,Na=0,xa=0,La=0,Oa=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,Fa=0,qa=0,Ya=0,Ha=0,ja=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0;function ln(){Ta=t>0?ot.length>=2?1:1==ot.length?.5:.25:0,function(){ma=ga.length>0?ga.reduce((function(e,t){return e+t})):0;!function(){
_a=t>0?ma>=936e5?0:ma<936e5&&ma>=864e5?.1:ma<864e5&&ma>=72e6?.25:ma<72e6&&ma>=576e5?.4:ma<576e5&&ma>=432e5?.55:ma<432e5&&ma>=288e5?.7:ma<288e5&&ma>=144e5?.85:ma<144e5&&ma>=72e5?.925:ma<72e5&&ma>=36e5?.9625:1:0;e=Te-Ke,a=_e-Qe,n=ce-Xe,o=re-Ze,r=pe-Je,c=ge-$e,d=me-et,u=de-tt,p=ue-at,g=Math.floor(x*_a*Ta),_=Math.floor(L*_a*Ta),f=Math.floor(R*_a*Ta),b=Math.floor(S*_a*Ta),h=Math.floor(M*_a*Ta),A=Math.floor(I*_a*Ta),E=Math.floor(N*_a*Ta),w=Math.floor(y*_a*Ta),O=Math.floor(k*_a*Ta),console.log(g,_,f,b,h,A,E,O,w),Ia=g*qe[0]+_*qe[1]+f*qe[2]+b*qe[3]+h*qe[4]+A*qe[5]+E*qe[7]+w*qe[8]+O*qe[6],Na=g*Ye[0]+_*Ye[1]+f*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+O*Ye[6],La=g*He[0]+_*He[1]+f*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+O*He[6],xa=g*je[0]+_*je[1]+f*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+O*je[6],console.log(Ia,Na,La,xa),e>0||p>0||u>0||a>0||n>0||o>0||r>0||c>0||d>0?(Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La<=Ca&&xa<=Oa?(oa=g,ra=_,_t=f,pt=b,qt=h,Kt=A,
Jt=E,At=w,Ct=O):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La<=Ca&&xa<=Oa?(Lt=Pa/Ia,oa=Math.floor(Lt*g)-1,ra=Math.floor(Lt*_)-1,_t=Math.floor(Lt*f)-1,pt=Math.floor(Lt*b)-1,qt=Math.floor(Lt*h)-1,Kt=Math.floor(Lt*A)-1,Jt=Math.floor(Lt*E)-1,At=Math.floor(Lt*w)-1,Ct=Math.floor(Lt*O)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La<=Ca&&xa<=Oa?(Lt=Ua/Na,oa=Math.floor(Lt*g)-1,ra=Math.floor(Lt*_)-1,_t=Math.floor(Lt*f)-1,pt=Math.floor(Lt*b)-1,qt=Math.floor(Lt*h)-1,Kt=Math.floor(Lt*A)-1,Jt=Math.floor(Lt*E)-1,At=Math.floor(Lt*w)-1,Ct=Math.floor(Lt*O)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La>=Ca&&xa<=Oa?(Lt=Ca/La,oa=Math.floor(Lt*g)-1,ra=Math.floor(Lt*_)-1,_t=Math.floor(Lt*f)-1,pt=Math.floor(Lt*b)-1,qt=Math.floor(Lt*h)-1,Kt=Math.floor(Lt*A)-1,Jt=Math.floor(Lt*E)-1,At=Math.floor(Lt*w)-1,
Ct=Math.floor(Lt*O)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La<=Ca&&xa>=Oa?(Lt=Oa/xa,oa=Math.floor(Lt*g)-1,ra=Math.floor(Lt*_)-1,_t=Math.floor(Lt*f)-1,pt=Math.floor(Lt*b)-1,qt=Math.floor(Lt*h)-1,Kt=Math.floor(Lt*A)-1,Jt=Math.floor(Lt*E)-1,At=Math.floor(Lt*w)-1,Ct=Math.floor(Lt*O)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La<=Ca&&xa<=Oa?(St=Ua/Na)>(rt=Pa/Ia)?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*_)-1,_t=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,qt=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*O)-1):(oa=Math.floor(St*g)-1,ra=Math.floor(St*_)-1,_t=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,qt=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*O)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La>=Ca&&xa<=Oa?(St=Ua/Na)>(Bt=Ca/La)?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*_)-1,
_t=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,qt=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*O)-1):(oa=Math.floor(St*g)-1,ra=Math.floor(St*_)-1,_t=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,qt=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*O)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La<=Ca&&xa>=Oa?(St=Ua/Na)>(Mt=Oa/xa)?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,qt=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*O)-1):(oa=Math.floor(St*g)-1,ra=Math.floor(St*_)-1,_t=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,qt=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*O)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La>=Ca&&xa<=Oa?(Bt=Ca/La)>(rt=Pa/Ia)?(oa=Math.floor(rt*g)-1,
ra=Math.floor(rt*_)-1,_t=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,qt=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*O)-1):(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*_)-1,_t=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,qt=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*O)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La>=Ca&&xa>=Oa?(Bt=Ca/La)>(Mt=Oa/xa)?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,qt=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*O)-1):(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*_)-1,_t=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,qt=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,
Ct=Math.floor(Bt*O)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La<=Ca&&xa>=Oa?(Mt=Oa/xa)>(rt=Pa/Ia)?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*_)-1,_t=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,qt=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*O)-1):(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,qt=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*O)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La>=Ca&&xa<=Oa?(rt=Pa/Ia,(St=Ua/Na)>(Bt=Ca/La)&&rt>Bt?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*_)-1,_t=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,qt=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*O)-1):Bt>St&&rt>St?(oa=Math.floor(St*g)-1,ra=Math.floor(St*_)-1,_t=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,qt=Math.floor(St*h)-1,
Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*O)-1):Bt>rt&&St>rt?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*_)-1,_t=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,qt=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*O)-1):console.log('Nie znam przyczyny :P')):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La<=Ca&&xa>=Oa?(rt=Pa/Ia,(St=Ua/Na)>(Mt=Oa/xa)&&rt>Mt?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,qt=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*O)-1):Mt>St&&rt>St?(oa=Math.floor(St*g)-1,ra=Math.floor(St*_)-1,_t=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,qt=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*O)-1):Mt>rt&&St>rt?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*_)-1,_t=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,
qt=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*O)-1):console.log('Nie znam przyczyny :P')):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&La>=Ca&&xa>=Oa?(rt=Pa/Ia,(Mt=Oa/xa)>(Bt=Ca/La)&&rt>Bt?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*_)-1,_t=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,qt=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*O)-1):Bt>Mt&&rt>Mt?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,qt=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*O)-1):Bt>rt&&Mt>rt?(oa=Math.floor(rt*g)-1,ra=Math.floor(rt*_)-1,_t=Math.floor(rt*f)-1,pt=Math.floor(rt*b)-1,qt=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,
Ct=Math.floor(rt*O)-1):console.log('Nie znam przyczyny :P')):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||o>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&La>=Ca&&xa>=Oa&&(Mt=Oa/xa,(St=Ua/Na)>(Bt=Ca/La)&&Mt>Bt?(oa=Math.floor(Bt*g)-1,ra=Math.floor(Bt*_)-1,_t=Math.floor(Bt*f)-1,pt=Math.floor(Bt*b)-1,qt=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*O)-1):Bt>St&&Mt>St?(oa=Math.floor(St*g)-1,ra=Math.floor(St*_)-1,_t=Math.floor(St*f)-1,pt=Math.floor(St*b)-1,qt=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*O)-1):Bt>Mt&&St>Mt?(oa=Math.floor(Mt*g)-1,ra=Math.floor(Mt*_)-1,_t=Math.floor(Mt*f)-1,pt=Math.floor(Mt*b)-1,qt=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*O)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){oa>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:oa}),v=[st='spear',oa],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){nt>=3&&(ra>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'sword',amount:ra}),v=[st='sword',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ra)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){nt>=5&&(_t>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:_t}),v=[st='axe',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,_t)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){nt>=9&&(pt>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:pt}),v=[st='archer',pt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,pt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){nt>=11&&(qt>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:qt}),v=[st='light_cavalry',qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,qt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){nt>=13&&(Kt>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Kt}),v=[st='mounted_archer',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Kt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){nt>=15&&(Jt>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:Jt}),v=[st='ram',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Jt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){nt>=17&&(At>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:At}),v=[st='catapult',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,At)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){nt>=21&&(Ct>=T?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:Ct}),v=[st='heavy_cavalry',Ct],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Ct)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,o,r,c,d,u,p,g,_,f,b,h,A,E,w,O}()}()}function sn(){ha=a>0?Ga.length>=2?1:1==Ga.length?.5:.25:0,function(){ba=fa.length>0?fa.reduce((function(e,t){return e+t})):0;!function(){
Aa=a>0?ba>=936e5?0:ba<936e5&&ba>=864e5?.1:ba<864e5&&ba>=72e6?.25:ba<72e6&&ba>=576e5?.4:ba<576e5&&ba>=432e5?.55:ba<432e5&&ba>=288e5?.7:ba<288e5&&ba>=144e5?.85:ba<144e5&&ba>=72e5?.925:ba<72e5&&ba>=36e5?.9625:1:0;e=Se-Ke,t=Re-Qe,n=be-Xe,o=fe-Ze,r=Ee-Je,c=we-$e,d=ve-et,u=he-tt,p=Ae-at,g=Math.floor(B*Aa*ha),T=Math.floor(V*Aa*ha),_=Math.floor(P*Aa*ha),b=Math.floor(O*Aa*ha),h=Math.floor(z*Aa*ha),A=Math.floor(D*Aa*ha),E=Math.floor(G*Aa*ha),w=Math.floor(U*Aa*ha),S=Math.floor(C*Aa*ha),R=g*qe[0]+T*qe[1]+_*qe[2]+b*qe[3]+h*qe[4]+A*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Ye[0]+T*Ye[1]+_*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],k=g*He[0]+T*He[1]+_*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],M=g*je[0]+T*je[1]+_*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||n>0||o>0||r>0||c>0||d>0?(R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k<=qa&&M<=Va?(ia=g,ca=T,ft=_,gt=b,Yt=h,Qt=A,$t=E,Et=w,
zt=S):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k<=qa&&M<=Va?(Ot=Wa/R,ia=Math.floor(Ot*g)-1,ca=Math.floor(Ot*T)-1,ft=Math.floor(Ot*_)-1,gt=Math.floor(Ot*b)-1,Yt=Math.floor(Ot*h)-1,Qt=Math.floor(Ot*A)-1,$t=Math.floor(Ot*E)-1,Et=Math.floor(Ot*w)-1,zt=Math.floor(Ot*S)-1):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k<=qa&&M<=Va?(Ot=Fa/y,ia=Math.floor(Ot*g)-1,ca=Math.floor(Ot*T)-1,ft=Math.floor(Ot*_)-1,gt=Math.floor(Ot*b)-1,Yt=Math.floor(Ot*h)-1,Qt=Math.floor(Ot*A)-1,$t=Math.floor(Ot*E)-1,Et=Math.floor(Ot*w)-1,zt=Math.floor(Ot*S)-1):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k>=qa&&M<=Va?(Ot=qa/k,ia=Math.floor(Ot*g)-1,ca=Math.floor(Ot*T)-1,ft=Math.floor(Ot*_)-1,gt=Math.floor(Ot*b)-1,Yt=Math.floor(Ot*h)-1,Qt=Math.floor(Ot*A)-1,$t=Math.floor(Ot*E)-1,Et=Math.floor(Ot*w)-1,zt=Math.floor(Ot*S)-1):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k<=qa&&M>=Va?(Ot=Va/M,ia=Math.floor(Ot*g)-1,
ca=Math.floor(Ot*T)-1,ft=Math.floor(Ot*_)-1,gt=Math.floor(Ot*b)-1,Yt=Math.floor(Ot*h)-1,Qt=Math.floor(Ot*A)-1,$t=Math.floor(Ot*E)-1,Et=Math.floor(Ot*w)-1,zt=Math.floor(Ot*S)-1):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k<=qa&&M<=Va?(Rt=Fa/y)>(ct=Wa/R)?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,ft=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,ft=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k>=qa&&M<=Va?(Rt=Fa/y)>(Vt=qa/k)?(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,ft=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,
zt=Math.floor(Vt*S)-1):(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,ft=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k<=qa&&M>=Va?(Rt=Fa/y)>(It=Va/M)?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,ft=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,ft=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k>=qa&&M<=Va?(Vt=qa/k)>(ct=Wa/R)?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,ft=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,
Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,ft=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k>=qa&&M>=Va?(Vt=qa/k)>(It=Va/M)?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,ft=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,ft=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k<=qa&&M>=Va?(It=Va/M)>(ct=Wa/R)?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,ft=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,
$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,ft=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k>=qa&&M<=Va?(ct=Wa/R,(Rt=Fa/y)>(Vt=qa/k)&&ct>Vt?(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,ft=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>Rt&&ct>Rt?(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,ft=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>ct&&Rt>ct?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,ft=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,
zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k<=qa&&M>=Va?(ct=Wa/R,(Rt=Fa/y)>(It=Va/M)&&ct>It?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,ft=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):It>Rt&&ct>Rt?(ia=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,ft=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):It>ct&&Rt>ct?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,ft=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y<=Fa&&k>=qa&&M>=Va?(ct=Wa/R,(It=Va/M)>(Vt=qa/k)&&ct>Vt?(ia=Math.floor(Vt*g)-1,
ca=Math.floor(Vt*T)-1,ft=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>It&&ct>It?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,ft=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):Vt>ct&&It>ct?(ia=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,ft=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R<=Wa&&(e>=f||p>=f||u>=f||t>=f||n>=f||o>=f||r>=f||c>=f||d>=f)&&y>=Fa&&k>=qa&&M>=Va&&(It=Va/M,(Rt=Fa/y)>(Vt=qa/k)&&It>Vt?(ia=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,ft=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>Rt&&It>Rt?(ia=Math.floor(Rt*g)-1,
ca=Math.floor(Rt*T)-1,ft=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>It&&Rt>It?(ia=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,ft=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ia>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:ia}),v=[st='spear',ia],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ia)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Da>=3&&(ca>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'sword',amount:ca}),v=[st='sword',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ca)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){Da>=5&&(ft>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:ft}),v=[st='axe',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ft)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Da>=9&&(gt>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:gt}),v=[st='archer',gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,gt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Da>=11&&(Yt>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:Yt}),v=[st='light_cavalry',Yt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Yt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Da>=13&&(Qt>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Qt}),
v=[st='mounted_archer',Qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Qt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Da>=15&&($t>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:$t}),v=[st='ram',$t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,$t)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Da>=17&&(Et>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:Et}),v=[st='catapult',Et],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Et)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Da>=21&&(zt>=f?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:zt}),v=[st='heavy_cavalry',zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,zt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,n,o,r,c,d,u,p,g,T,_,b,h,A,E,w,S,R,y,k,M}()}()}function rn(){va=n>0?Ha.length>=2?1:1==Ha.length?.5:.25:0,function(){wa=Ea.length>0?Ea.reduce((function(e,t){return e+t})):0;!function(){Sa=n>0?wa>=936e5?0:wa<936e5&&wa>=864e5?.1:wa<864e5&&wa>=72e6?.25:wa<72e6&&wa>=576e5?.4:wa<576e5&&wa>=432e5?.55:wa<432e5&&wa>=288e5?.7:wa<288e5&&wa>=144e5?.85:wa<144e5&&wa>=72e5?.925:wa<72e5&&wa>=36e5?.9625:1:0;e=Oe-Ke,t=Pe-Qe,a=ke-Xe,o=ye-Ze,r=Ne-Je,c=xe-$e,d=Le-et,u=Me-tt,p=Ie-at,g=Math.floor(Q*Sa*va),T=Math.floor(X*Sa*va),_=Math.floor(F*Sa*va),f=Math.floor(W*Sa*va),b=Math.floor(H*Sa*va),A=Math.floor(j*Sa*va),E=Math.floor(K*Sa*va),w=Math.floor(q*Sa*va),S=Math.floor(Y*Sa*va),R=g*qe[0]+T*qe[1]+_*qe[2]+f*qe[3]+b*qe[4]+A*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Ye[0]+T*Ye[1]+_*Ye[2]+f*Ye[3]+b*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],
k=g*He[0]+T*He[1]+_*He[2]+f*He[3]+b*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],M=g*je[0]+T*je[1]+_*je[2]+f*je[3]+b*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||a>0||o>0||r>0||c>0||d>0?(R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M<=Ka?(la=g,da=T,bt=_,mt=f,Ht=b,Xt=A,ea=E,wt=w,Dt=S):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M<=Ka?(Pt=Qa/R,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*f)-1,Ht=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M<=Ka?(Pt=Xa/y,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*f)-1,Ht=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,
Dt=Math.floor(Pt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M<=Ka?(Pt=Za/k,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*f)-1,Ht=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M>=Ka?(Pt=Ka/M,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*_)-1,mt=Math.floor(Pt*f)-1,Ht=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M<=Ka?(yt=Xa/y)>(dt=Qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*f)-1,Ht=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*f)-1,
Ht=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k>=Za&&M<=Ka?(yt=Xa/y)>(Wt=Za/k)?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*f)-1,Ht=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*f)-1,Ht=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M>=Ka?(yt=Xa/y)>(Nt=Ka/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*f)-1,Ht=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,
mt=Math.floor(yt*f)-1,Ht=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M<=Ka?(Wt=Za/k)>(dt=Qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*f)-1,Ht=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*f)-1,Ht=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M>=Ka?(Wt=Za/k)>(Nt=Ka/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*f)-1,Ht=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,
bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*f)-1,Ht=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M>=Ka?(Nt=Ka/M)>(dt=Qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*f)-1,Ht=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*f)-1,Ht=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k>=Za&&M<=Ka?(dt=Qa/R,(yt=Xa/y)>(Wt=Za/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*f)-1,Ht=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,
Dt=Math.floor(Wt*S)-1):Wt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*f)-1,Ht=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*f)-1,Ht=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M>=Ka?(dt=Qa/R,(yt=Xa/y)>(Nt=Ka/M)&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*f)-1,Ht=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Nt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*f)-1,Ht=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,
Dt=Math.floor(yt*S)-1):Nt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*f)-1,Ht=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M>=Ka?(dt=Qa/R,(Nt=Ka/M)>(Wt=Za/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*f)-1,Ht=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>Nt&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*f)-1,Ht=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Wt>dt&&Nt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*_)-1,mt=Math.floor(dt*f)-1,Ht=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,
Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||o>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k>=Za&&M>=Ka&&(Nt=Ka/M,(yt=Xa/y)>(Wt=Za/k)&&Nt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*_)-1,mt=Math.floor(Wt*f)-1,Ht=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&Nt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*_)-1,mt=Math.floor(yt*f)-1,Ht=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>Nt&&yt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*_)-1,mt=Math.floor(Nt*f)-1,Ht=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){la>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:la}),v=[st='spear',la],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,la)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ya>=3&&(da>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'sword',amount:da}),v=[st='sword',da],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,da)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Ya>=5&&(bt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:bt}),v=[st='axe',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,bt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ya>=9&&(mt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:mt}),v=[st='archer',mt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,mt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ya>=11&&(Ht>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:Ht}),v=[st='light_cavalry',Ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Ht)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ya>=13&&(Xt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Xt}),v=[st='mounted_archer',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Xt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ya>=15&&(ea>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:ea}),v=[st='ram',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ea)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){Ya>=17&&(wt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:wt}),v=[st='catapult',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,wt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Ya>=21&&(Dt>=h?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:Dt}),v=[st='heavy_cavalry',Dt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Dt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,a,o,r,c,d,u,p,g,T,_,f,b,A,E,w,S,R,y,k,M}()}()}function cn(){ka=c>0?$a.length>=2?1:1==$a.length?.5:.25:0,function(){ya=Ra.length>0?Ra.reduce((function(e,t){return e+t})):0;!function(){
Ma=c>0?ya>=936e5?0:ya<936e5&&ya>=864e5?.1:ya<864e5&&ya>=72e6?.25:ya<72e6&&ya>=576e5?.4:ya<576e5&&ya>=432e5?.55:ya<432e5&&ya>=288e5?.7:ya<288e5&&ya>=144e5?.85:ya<144e5&&ya>=72e5?.925:ya<72e5&&ya>=36e5?.9625:1:0;e=We-Ke,t=Fe-Qe,a=Ce-Xe,n=Ue-Ze,o=Ge-Je,r=Be-$e,d=Ve-et,u=ze-tt,p=De-at,g=Math.floor(le*Ma*ka),T=Math.floor(se*Ma*ka),_=Math.floor(ee*Ma*ka),f=Math.floor(Z*Ma*ka),b=Math.floor(ne*Ma*ka),h=Math.floor(oe*Ma*ka),E=Math.floor(ie*Ma*ka),w=Math.floor(te*Ma*ka),S=Math.floor(ae*Ma*ka),R=g*qe[0]+T*qe[1]+_*qe[2]+f*qe[3]+b*qe[4]+h*qe[5]+E*qe[7]+w*qe[8]+S*qe[6],y=g*Ye[0]+T*Ye[1]+_*Ye[2]+f*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],k=g*He[0]+T*He[1]+_*He[2]+f*He[3]+b*He[4]+h*He[5]+E*He[7]+w*He[8]+S*He[6],M=g*je[0]+T*je[1]+_*je[2]+f*je[3]+b*je[4]+h*je[5]+E*je[7]+w*je[8]+S*je[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||o<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M<=tn?(sa=g,ua=T,
ht=_,Tt=f,jt=b,Zt=h,ta=E,vt=w,Gt=S):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M<=tn?(Ut=an/R,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M<=tn?(Ut=nn/y,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M<=tn?(Ut=on/k,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,
Gt=Math.floor(Ut*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M>=tn?(Ut=tn/M,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*_)-1,Tt=Math.floor(Ut*f)-1,jt=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M<=tn?(kt=nn/y)>(ut=an/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k>=on&&M<=tn?(kt=nn/y)>(Ft=on/k)?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,
Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*h)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M>=tn?(kt=nn/y)>(xt=tn/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M<=tn?(Ft=on/k)>(ut=an/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,
ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*h)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M>=tn?(Ft=on/k)>(xt=tn/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*h)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M>=tn?(xt=tn/M)>(ut=an/R)?(sa=Math.floor(ut*g)-1,
ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k>=on&&M<=tn?(ut=an/R,(kt=nn/y)>(Ft=on/k)&&ut>Ft?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*h)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):Ft>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):Ft>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,
Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M>=tn?(ut=an/R,(kt=nn/y)>(xt=tn/M)&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):xt>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):xt>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,
Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M>=tn?(ut=an/R,(xt=tn/M)>(Ft=on/k)&&ut>Ft?(sa=Math.floor(Ft*g)-1,ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*h)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):Ft>xt&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):Ft>ut&&xt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*_)-1,Tt=Math.floor(ut*f)-1,jt=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||o>=A||r>=A||d>=A)&&y>=nn&&k>=on&&M>=tn&&(xt=tn/M,(kt=nn/y)>(Ft=on/k)&&xt>Ft?(sa=Math.floor(Ft*g)-1,
ua=Math.floor(Ft*T)-1,ht=Math.floor(Ft*_)-1,Tt=Math.floor(Ft*f)-1,jt=Math.floor(Ft*b)-1,Zt=Math.floor(Ft*h)-1,ta=Math.floor(Ft*E)-1,vt=Math.floor(Ft*w)-1,Gt=Math.floor(Ft*S)-1):Ft>kt&&xt>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*_)-1,Tt=Math.floor(kt*f)-1,jt=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):Ft>xt&&kt>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*_)-1,Tt=Math.floor(xt*f)-1,jt=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){sa>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:sa}),v=[st='spear',sa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,sa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ja>=3&&(ua>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,
unit_type:'sword',amount:ua}),v=[st='sword',ua],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ua)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Ja>=5&&(ht>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:ht}),v=[st='axe',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ht)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ja>=9&&(Tt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:Tt}),v=[st='archer',Tt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Tt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ja>=11&&(jt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:jt}),v=[st='light_cavalry',jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,jt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ja>=13&&(Zt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Zt}),v=[st='mounted_archer',Zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Zt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ja>=15&&(ta>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:ta}),v=[st='ram',ta],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ta)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Ja>=17&&(vt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:vt}),v=[st='catapult',vt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,vt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),
setTimeout((function(){Ja>=21&&(Gt>=A?(i.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:Gt}),v=[st='heavy_cavalry',Gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Gt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,t,a,n,o,r,d,u,p,g,T,_,f,b,h,E,w,S,R,y,k,M}()}()}function dn(){var e=o.getSelectedCharacter().getVillageList();console.log(e);var i=6e4*e.length,l=6e4*e.length+6e4*e.length,s=6e4*e.length+6e4*e.length+6e4*e.length;e.forEach((function(e,o){t&&setTimeout((function(){d.forEach((function(t){if(e.data.villageId==t){console.log('wioska:'+e.data.villageId),za=e.getId(),Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,
Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,nt=e.buildingData.data.barracks.level,ot=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),lt=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,o=a.clay,i=a.iron,l=a.food;Oa=l.currentStock,Pa=n.currentStock,Ua=o.currentStock,Ca=i.currentStock,lt.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,ga.push(na)})),ln()}}))}),6e4*o),a&&setTimeout((function(){u.forEach((function(t){if(e.data.villageId==t){Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,
Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Da=e.buildingData.data.barracks.level,Ga=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),Ba=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,o=a.clay,i=a.iron,l=a.food;Va=l.currentStock,Wa=n.currentStock,Fa=o.currentStock,qa=i.currentStock,Ba.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,fa.push(na)})),sn()}}))}),6e4*(o+1)+i),n&&setTimeout((function(){p.forEach((function(t){if(e.data.villageId==t){
Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Ya=e.buildingData.data.barracks.level,Ha=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),ja=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,o=a.clay,i=a.iron,l=a.food;Ka=l.currentStock,Qa=n.currentStock,Xa=o.currentStock,Za=i.currentStock,ja.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,
Ea.push(na)})),rn()}}))}),6e4*(o+2)+l),c&&setTimeout((function(){g.forEach((function(t){if(e.data.villageId==t){Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Ja=e.buildingData.data.barracks.level,$a=e.buildingQueue.data.queue,it=e.getRecruitingQueues(),en=it.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,o=a.clay,i=a.iron,l=a.food;tn=l.currentStock,an=n.currentStock,nn=o.currentStock,on=i.currentStock,
en.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,Ra.push(na)})),cn()}}))}),6e4*(o+3)+s)}))}setInterval((function(){1==E&&dn()}),18e5),1==E&&dn(),m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},ee.getLogs=function(){return h},ee.clearLogs=function(){return h=[],T.set(Q,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},ee.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START),$(p.RECRUIT_START,'start','')},ee.stop=function(e=n.USER_STOP){w?(e!==n.USER_STOP&&(w=_.gameTime()+J()),m.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):w=null,E=!1,m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&$(p.RECRUIT_STOP,'stop','')},ee.getSettings=function(){return f},ee.isInitialized=function(){return A},ee.isRunning=function(){return E},ee.getNextCycleDate=function(){return w},ee.getCycleInterval=J,ee})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{
RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop',RECRUIT_QUEUE_CLEAR_LOGS:'recruit_queue_clear_logs',RECRUIT_QUEUE_CYCLE_BEGIN:'recruit_queue_cycle_begin',RECRUIT_QUEUE_CYCLE_END:'recruit_queue_cycle_end'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/recruitQueue/types/status','two/recruitQueue/types/errors','two/Settings','queues/EventQueue','two/EventScope','helper/time','two/utils'],(function(e,t,n,d,u,p,T,_,f,b,h,A){let E,w,v,S=o.getGroupList(),R=!1,y=null,k={},M={},I={};const N={PRESETS:'presets',OWN:'own',LOGS:'logs'},x=function(e){E.selectedTab=e},L=function(){w.setAll(w.decode(E.settings)),A.notif('success','Settings saved')},O=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.presetRecrutation())},P=function(){t.isRunning()?t.stop():(t.start(),
w.setAll(w.decode(E.settings)),t.ownRecrutation())},U=function(){E.settings[n.GROUP1]=!1,E.settings[n.GROUP2]=!1,E.settings[n.GROUP3]=!1,E.settings[n.GROUP4]=!1,E.settings[n.FINAL_AMOUNT1]=0,E.settings[n.FINAL_AMOUNT2]=0,E.settings[n.FINAL_AMOUNT3]=0,E.settings[n.FINAL_AMOUNT4]=0,E.settings[n.FINAL_AMOUNT5]=0,E.settings[n.FINAL_AMOUNT6]=0,E.settings[n.FINAL_AMOUNT7]=0,E.settings[n.FINAL_AMOUNT8]=0,E.settings[n.FINAL_AMOUNT9]=0,E.settings[n.START_AMOUNT1]=0,E.settings[n.START_AMOUNT2]=0,E.settings[n.START_AMOUNT3]=0,E.settings[n.START_AMOUNT4]=0,E.settings[n.START_AMOUNT5]=0,E.settings[n.START_AMOUNT6]=0,E.settings[n.START_AMOUNT7]=0,E.settings[n.START_AMOUNT8]=0,E.settings[n.START_AMOUNT9]=0,E.settings[n.FINAL_AMOUNT11]=0,E.settings[n.FINAL_AMOUNT12]=0,E.settings[n.FINAL_AMOUNT13]=0,E.settings[n.FINAL_AMOUNT14]=0,E.settings[n.FINAL_AMOUNT15]=0,E.settings[n.FINAL_AMOUNT16]=0,E.settings[n.FINAL_AMOUNT17]=0,E.settings[n.FINAL_AMOUNT18]=0,E.settings[n.FINAL_AMOUNT19]=0,
E.settings[n.START_AMOUNT11]=0,E.settings[n.START_AMOUNT12]=0,E.settings[n.START_AMOUNT13]=0,E.settings[n.START_AMOUNT14]=0,E.settings[n.START_AMOUNT15]=0,E.settings[n.START_AMOUNT16]=0,E.settings[n.START_AMOUNT17]=0,E.settings[n.START_AMOUNT18]=0,E.settings[n.START_AMOUNT19]=0,E.settings[n.FINAL_AMOUNT21]=0,E.settings[n.FINAL_AMOUNT22]=0,E.settings[n.FINAL_AMOUNT23]=0,E.settings[n.FINAL_AMOUNT24]=0,E.settings[n.FINAL_AMOUNT25]=0,E.settings[n.FINAL_AMOUNT26]=0,E.settings[n.FINAL_AMOUNT27]=0,E.settings[n.FINAL_AMOUNT28]=0,E.settings[n.FINAL_AMOUNT29]=0,E.settings[n.START_AMOUNT21]=0,E.settings[n.START_AMOUNT22]=0,E.settings[n.START_AMOUNT23]=0,E.settings[n.START_AMOUNT24]=0,E.settings[n.START_AMOUNT25]=0,E.settings[n.START_AMOUNT26]=0,E.settings[n.START_AMOUNT27]=0,E.settings[n.START_AMOUNT28]=0,E.settings[n.START_AMOUNT29]=0,E.settings[n.FINAL_AMOUNT31]=0,E.settings[n.FINAL_AMOUNT32]=0,E.settings[n.FINAL_AMOUNT33]=0,E.settings[n.FINAL_AMOUNT34]=0,E.settings[n.FINAL_AMOUNT35]=0,
E.settings[n.FINAL_AMOUNT36]=0,E.settings[n.FINAL_AMOUNT37]=0,E.settings[n.FINAL_AMOUNT38]=0,E.settings[n.FINAL_AMOUNT39]=0,E.settings[n.START_AMOUNT31]=0,E.settings[n.START_AMOUNT32]=0,E.settings[n.START_AMOUNT33]=0,E.settings[n.START_AMOUNT34]=0,E.settings[n.START_AMOUNT35]=0,E.settings[n.START_AMOUNT36]=0,E.settings[n.START_AMOUNT37]=0,E.settings[n.START_AMOUNT38]=0,E.settings[n.START_AMOUNT39]=0,w.setAll(w.decode(E.settings))},C=function(){E.settings[n.GROUP5]=!1,E.settings[n.GROUP6]=!1,E.settings[n.GROUP7]=!1,E.settings[n.GROUP8]=!1,E.settings[n.GROUP9]=!1,E.settings[n.GROUP10]=!1,E.settings[n.GROUP11]=!1,E.settings[n.GROUP12]=!1,E.settings[n.GROUP13]=!1,E.settings[n.GROUP14]=!1,E.settings[n.GROUP15]=!1,E.settings[n.GROUP16]=!1,E.settings[n.GROUP17]=!1,E.settings[n.GROUP18]=!1,E.settings[n.GROUP19]=!1,E.settings[n.GROUP20]=!1,E.settings[n.GROUP21]=!1,E.settings[n.GROUP22]=!1,E.settings[n.GROUP23]=!1,E.settings[n.GROUP24]=!1,E.settings[n.UNIT1]=!1,E.settings[n.UNIT2]=!1,
E.settings[n.UNIT3]=!1,E.settings[n.UNIT4]=!1,E.settings[n.UNIT5]=!1,E.settings[n.UNIT6]=!1,E.settings[n.UNIT7]=!1,E.settings[n.UNIT8]=!1,E.settings[n.UNIT9]=!1,E.settings[n.UNIT10]=!1,E.settings[n.UNIT11]=!1,E.settings[n.UNIT12]=!1,E.settings[n.UNIT13]=!1,E.settings[n.UNIT14]=!1,E.settings[n.UNIT15]=!1,E.settings[n.UNIT16]=!1,E.settings[n.UNIT17]=!1,E.settings[n.UNIT18]=!1,E.settings[n.UNIT19]=!1,E.settings[n.UNIT20]=!1,E.settings[n.AMOUNT1]=1,E.settings[n.AMOUNT2]=1,E.settings[n.AMOUNT3]=1,E.settings[n.AMOUNT4]=1,E.settings[n.AMOUNT5]=1,E.settings[n.AMOUNT6]=1,E.settings[n.AMOUNT7]=1,E.settings[n.AMOUNT8]=1,E.settings[n.AMOUNT9]=1,E.settings[n.AMOUNT10]=1,E.settings[n.AMOUNT11]=1,E.settings[n.AMOUNT12]=1,E.settings[n.AMOUNT13]=1,E.settings[n.AMOUNT14]=1,E.settings[n.AMOUNT15]=1,E.settings[n.AMOUNT16]=1,E.settings[n.AMOUNT17]=1,E.settings[n.AMOUNT18]=1,E.settings[n.AMOUNT19]=1,E.settings[n.AMOUNT20]=1,w.setAll(w.decode(E.settings))};k.updateVisibleLogs=function(){
const e=E.pagination.logs.offset,t=E.pagination.logs.limit;k.visibleLogs=k.logs.slice(e,e+t),E.pagination.logs.count=k.logs.length,k.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,I[e]='ŁADOWANIE...',i.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:o.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},k.clearLogs=function(){t.clearLogs()};const z={updateGroups:function(){E.groups=_.encodeList(S.getGroups(),{disabled:!1,type:'groups'})},updateLogs:function(){E.logs=t.getLogs(),k.updateVisibleLogs(),E.logs.length||A.notif('success',g('i18n')('reseted_logs',a.loc.ale,'recruit_queue'))},clearLogs:function(){A.notif('success',g('i18n')('logs.cleared',a.loc.ale,'recruit_queue')),z.updateLogs()},start:function(){E.running=!0},stop:function(e,t){switch(E.running=!1,
E.showCycleTimer=!1,clearInterval(y),t.reason){case T.USER_STOP:A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))}},onCycleBegin:function(){E.showCycleTimer=!1,clearInterval(y)},onCycleEnd:function(e,a){a!==p.USER_STOP&&(E.showCycleTimer=!0,E.nextCycleCountdown=t.getCycleInterval(),y=setInterval((function(){E.nextCycleCountdown-=1e3}),1e3))}},D=function(){E=a.$new(),E.SETTINGS=n,E.TAB_TYPES=N,E.running=R,E.selectedTab=N.PRESETS,E.settingsMap=d,E.pagination={},E.clearP=U,E.clearO=C,E.units=_.encodeList(u,{textObject:'recruit_queue',disabled:!0}),w.injectScope(E),z.updateGroups(),function(){let e=t.getNextCycleDate();e&&(E.showCycleTimer=!0,E.nextCycleCountdown=e-h.gameTime(),y=setInterval((function(){E.nextCycleCountdown-=1e3}),1e3))}(),E.selectTab=x,E.saveSettings=L,E.switchRecruiterO=P,E.switchRecruiterP=O,E.logsView=k,E.logsView.logs=t.getLogs(),E.villagesInfo=M,E.villagesLabel=I,E.openVillageInfo=r.openVillageInfo,E.pagination.logs={count:k.logs.length,
offset:0,loader:k.updateVisibleLogs,limit:m.getPaginationLimit()},k.updateVisibleLogs();let e=new b('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed'),clearInterval(y)}));e.register(s.GROUPS_CREATED,z.updateGroups,!0),e.register(s.GROUPS_DESTROYED,z.updateGroups,!0),e.register(s.GROUPS_UPDATED,z.updateGroups,!0),e.register(s.RECRUIT_QUEUE_JOB_STARTED,z.updateLogs),e.register(s.RECRUIT_QUEUE_CLEAR_LOGS,z.clearLogs),e.register(s.RECRUIT_QUEUE_START,z.start),e.register(s.RECRUIT_QUEUE_STOP,z.stop),e.register(s.RECRUIT_QUEUE_CYCLE_BEGIN,z.onCycleBegin),e.register(s.RECRUIT_QUEUE_CYCLE_END,z.onCycleEnd),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',E)};return function(){w=t.getSettings(),v=e.addMenuButton('Kapitan',80),v.addEventListener('click',D),f.register(s.RECRUIT_QUEUE_START,(function(){R=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),A.notif('success',g('i18n')('general.started',a.loc.ale,'recruit_queue'))})),
f.register(s.RECRUIT_QUEUE_STOP,(function(){R=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))})),
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,i,l,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',_=function(){g=[];const e=o.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},f=function(){m=[];const e=o.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},b={init:function(){u=!0,c=new e({settingsMap:n,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[i.PRESETS]&&_(),t[i.GROUPS]&&f()})),d=c.getAll(),console.log('supportSender settings',d),l((function(){_()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,_),a.$on(s.ARMY_PRESET_DELETED,_),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.SUPPORT_SENDER_START)},stop:function(){p=!1,
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return b})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,l,r,d){let u,p,g,m=o.getPresetList(),T=o.getGroupList();const _={SUPPORT:'support',LOGS:'logs'},f=function(e){u.selectedTab=e},b=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},E=function(){u.groups=l.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=_,u.running=t.isRunning(),u.selectedTab=_.SUPPORT,u.settingsMap=i,p.injectScope(u),A(),E(),u.selectTab=f,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,E,!0),e.register(s.GROUPS_DESTROYED,E,!0),e.register(s.GROUPS_UPDATED,E,!0),e.register(s.SUPPORT_SENDER_START,w),e.register(s.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',S),
