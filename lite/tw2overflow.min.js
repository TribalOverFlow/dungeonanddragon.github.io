...
define('two/recruitQueue',['two/Settings','two/recruitQueue/types/errors','two/recruitQueue/types/status','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/farmOverflow/types/logs','two/ready','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,u,p,g,m,T,f){let _,b,h,A=!1,E=!1,w=null,v=[];let S=[],R=[],y=[],k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],q=[],F=[],Y=[],j=[],H=[];const K='recruit_queue_settings',Q='recruit_queue_log',X={[u.SPEAR]:'spear',[u.SWORD]:'sword',[u.AXE]:'axe',[u.ARCHER]:'archer',[u.LIGHT_CAVALRY]:'light_cavalry',[u.MOUNTED_ARCHER]:'mounted_archer',[u.HEAVT_CAVALRY]:'heavy_cavalry',[u.RAM]:'ram',[u.CATAPULT]:'catapult'};console.log(X);const Z=function(){S=[],R=[],y=[],k=[],M=[],I=[],N=[],x=[],O=[],L=[],P=[],U=[],C=[],z=[],D=[],G=[],B=[],V=[],W=[],q=[],F=[],Y=[],j=[],H=[]
;const e=i.getGroupList().getGroups(),t=b[r.GROUP1],a=b[r.GROUP2],n=b[r.GROUP3],o=b[r.GROUP4],l=b[r.GROUP5],s=b[r.GROUP6],c=b[r.GROUP7],d=b[r.GROUP8],u=b[r.GROUP9],p=b[r.GROUP10],g=b[r.GROUP11],m=b[r.GROUP12],T=b[r.GROUP13],f=b[r.GROUP14],_=b[r.GROUP15],h=b[r.GROUP16],A=b[r.GROUP17],E=b[r.GROUP18],w=b[r.GROUP19],v=b[r.GROUP20],K=b[r.GROUP21],Q=b[r.GROUP22],X=b[r.GROUP23],Z=b[r.GROUP24];t.forEach((function(t){S.push(e[t])})),a.forEach((function(t){R.push(e[t])})),n.forEach((function(t){y.push(e[t])})),o.forEach((function(t){k.push(e[t])})),l.forEach((function(t){M.push(e[t])})),s.forEach((function(t){I.push(e[t])})),c.forEach((function(t){N.push(e[t])})),d.forEach((function(t){x.push(e[t])})),u.forEach((function(t){O.push(e[t])})),p.forEach((function(t){L.push(e[t])})),g.forEach((function(t){P.push(e[t])})),m.forEach((function(t){U.push(e[t])})),T.forEach((function(t){C.push(e[t])})),f.forEach((function(t){z.push(e[t])})),_.forEach((function(t){D.push(e[t])})),h.forEach((function(t){
G.push(e[t])})),A.forEach((function(t){B.push(e[t])})),E.forEach((function(t){V.push(e[t])})),w.forEach((function(t){W.push(e[t])})),v.forEach((function(t){q.push(e[t])})),K.forEach((function(t){F.push(e[t])})),Q.forEach((function(t){Y.push(e[t])})),X.forEach((function(t){j.push(e[t])})),Z.forEach((function(t){H.push(e[t])}))},J=function(){return Math.max(1,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3)},$=function(e,t,a){let n={time:f.gameTime(),villageId:e,unit:t,amount:a};return h.unshift(n),h.length>500&&h.splice(h.length-500,h.length),T.set(Q,h),!0},ee={init:function(){A=!0,h=T.get(Q,[],!0),_=new e({settingsMap:c,storageKey:K}),_.onChange((function(e,t){b=_.getAll(),t[d.GROUPS]&&Z()})),b=_.getAll(),console.log('recruitQueue settings',b),a.$on(s.GROUPS_CREATED,Z),a.$on(s.GROUPS_DESTROYED,Z),a.$on(s.GROUPS_UPDATED,Z)},ownRecrutation:function(){}};return ee.presetRecrutation=function(){if(1==E)return;m.trigger(s.RECRUIT_QUEUE_CYCLE_BEGIN),w=f.gameTime()+J()
...
;const T=b[r.MIN_PACK1],_=b[r.MIN_PACK2],h=b[r.MIN_PACK3],A=b[r.MIN_PACK4],S=b[r.START_AMOUNT4],R=b[r.START_AMOUNT3],y=b[r.START_AMOUNT9],k=b[r.START_AMOUNT7],M=b[r.START_AMOUNT5],I=b[r.START_AMOUNT6],N=b[r.START_AMOUNT8],x=b[r.START_AMOUNT1],O=b[r.START_AMOUNT2],L=b[r.START_AMOUNT14],P=b[r.START_AMOUNT13],U=b[r.START_AMOUNT19],C=b[r.START_AMOUNT17],z=b[r.START_AMOUNT15],D=b[r.START_AMOUNT16],G=b[r.START_AMOUNT18],B=b[r.START_AMOUNT11],V=b[r.START_AMOUNT12],W=b[r.START_AMOUNT24],q=b[r.START_AMOUNT23],F=b[r.START_AMOUNT29],Y=b[r.START_AMOUNT27],j=b[r.START_AMOUNT25],H=b[r.START_AMOUNT26],K=b[r.START_AMOUNT28],Q=b[r.START_AMOUNT21],X=b[r.START_AMOUNT22],Z=b[r.START_AMOUNT34],ee=b[r.START_AMOUNT33],te=b[r.START_AMOUNT39],ae=b[r.START_AMOUNT37],ne=b[r.START_AMOUNT35],ie=b[r.START_AMOUNT36],oe=b[r.START_AMOUNT38],le=b[r.START_AMOUNT31],se=b[r.START_AMOUNT32],re=b[r.FINAL_AMOUNT4],ce=b[r.FINAL_AMOUNT3],de=b[r.FINAL_AMOUNT9],ue=b[r.FINAL_AMOUNT7],pe=b[r.FINAL_AMOUNT5],ge=b[r.FINAL_AMOUNT6],me=b[r.FINAL_AMOUNT8],Te=b[r.FINAL_AMOUNT1],fe=b[r.FINAL_AMOUNT2],_e=b[r.FINAL_AMOUNT14],be=b[r.FINAL_AMOUNT13],he=b[r.FINAL_AMOUNT19],Ae=b[r.FINAL_AMOUNT17],Ee=b[r.FINAL_AMOUNT15],we=b[r.FINAL_AMOUNT16],ve=b[r.FINAL_AMOUNT18],Se=b[r.FINAL_AMOUNT11],Re=b[r.FINAL_AMOUNT12],ye=b[r.FINAL_AMOUNT24],ke=b[r.FINAL_AMOUNT23],Me=b[r.FINAL_AMOUNT29],Ie=b[r.FINAL_AMOUNT27],Ne=b[r.FINAL_AMOUNT25],xe=b[r.FINAL_AMOUNT26],Oe=b[r.FINAL_AMOUNT28],Le=b[r.FINAL_AMOUNT21],Pe=b[r.FINAL_AMOUNT22],Ue=b[r.FINAL_AMOUNT34],Ce=b[r.FINAL_AMOUNT33],ze=b[r.FINAL_AMOUNT39],De=b[r.FINAL_AMOUNT37],Ge=b[r.FINAL_AMOUNT35],Be=b[r.FINAL_AMOUNT36],Ve=b[r.FINAL_AMOUNT38],We=b[r.FINAL_AMOUNT31],qe=b[r.FINAL_AMOUNT32]
;var Fe=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],Ye=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],je=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],He=[1,1,1,1,4,5,6,5,8,1,100,10,6],Ke=0,Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,ot=0,lt=0,st='',rt=0,ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,ft=0,_t=0,bt=0,ht=0,At=0,Et=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,Mt=0,It=0,Nt=0,xt=0,Ot=0,Lt=0,Pt=0,Ut=0,Ct=0,zt=0,Dt=0,Gt=0,Bt=0,Vt=0,Wt=0,qt=0,Ft=0,Yt=0,jt=0,Ht=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=[],ma=0,Ta=0,fa=0,_a=[],ba=0,ha=0,Aa=0,Ea=[],wa=0,va=0,Sa=0,Ra=[],ya=0,ka=0,Ma=0,Ia=0,Na=0,xa=0,Oa=0,La=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,qa=0,Fa=0,Ya=0,ja=0,Ha=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0;function ln(){Ta=t>0?it.length>=2?1:1==it.length?.5:.25:0,function(){ma=ga.length>0?ga.reduce((function(e,t){return e+t})):0;!function(){
fa=t>0?ma>=936e5?0:ma<936e5&&ma>=864e5?.1:ma<864e5&&ma>=72e6?.25:ma<72e6&&ma>=576e5?.4:ma<576e5&&ma>=432e5?.55:ma<432e5&&ma>=288e5?.7:ma<288e5&&ma>=144e5?.85:ma<144e5&&ma>=72e5?.925:ma<72e5&&ma>=36e5?.9625:1:0;e=Te-Ke,a=fe-Qe,n=ce-Xe,i=re-Ze,r=pe-Je,c=ge-$e,d=me-et,u=de-tt,p=ue-at,g=Math.floor(x*fa*Ta),f=Math.floor(O*fa*Ta),_=Math.floor(R*fa*Ta),b=Math.floor(S*fa*Ta),h=Math.floor(M*fa*Ta),A=Math.floor(I*fa*Ta),E=Math.floor(N*fa*Ta),w=Math.floor(y*fa*Ta),L=Math.floor(k*fa*Ta),console.log(g,f,_,b,h,A,E,L,w),Ia=g*Fe[0]+f*Fe[1]+_*Fe[2]+b*Fe[3]+h*Fe[4]+A*Fe[5]+E*Fe[7]+w*Fe[8]+L*Fe[6],Na=g*Ye[0]+f*Ye[1]+_*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+L*Ye[6],Oa=g*je[0]+f*je[1]+_*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+L*je[6],xa=g*He[0]+f*He[1]+_*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+L*He[6],console.log(Ia,Na,Oa,xa),e>0||p>0||u>0||a>0||n>0||i>0||r>0||c>0||d>0?(Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa<=Ca&&xa<=La?(ia=g,ra=f,ft=_,pt=b,Ft=h,Kt=A,
Jt=E,At=w,Ct=L):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa<=Ca&&xa<=La?(Ot=Pa/Ia,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*L)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa<=Ca&&xa<=La?(Ot=Ua/Na,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*L)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa>=Ca&&xa<=La?(Ot=Ca/Oa,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,
Ct=Math.floor(Ot*L)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa<=Ca&&xa>=La?(Ot=La/xa,ia=Math.floor(Ot*g)-1,ra=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,pt=Math.floor(Ot*b)-1,Ft=Math.floor(Ot*h)-1,Kt=Math.floor(Ot*A)-1,Jt=Math.floor(Ot*E)-1,At=Math.floor(Ot*w)-1,Ct=Math.floor(Ot*L)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa<=Ca&&xa<=La?(St=Ua/Na)>(rt=Pa/Ia)?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*f)-1,ft=Math.floor(rt*_)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*L)-1):(ia=Math.floor(St*g)-1,ra=Math.floor(St*f)-1,ft=Math.floor(St*_)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*L)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa>=Ca&&xa<=La?(St=Ua/Na)>(Bt=Ca/Oa)?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*f)-1,
ft=Math.floor(Bt*_)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*L)-1):(ia=Math.floor(St*g)-1,ra=Math.floor(St*f)-1,ft=Math.floor(St*_)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*L)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa<=Ca&&xa>=La?(St=Ua/Na)>(Mt=La/xa)?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*L)-1):(ia=Math.floor(St*g)-1,ra=Math.floor(St*f)-1,ft=Math.floor(St*_)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*L)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa>=Ca&&xa<=La?(Bt=Ca/Oa)>(rt=Pa/Ia)?(ia=Math.floor(rt*g)-1,
ra=Math.floor(rt*f)-1,ft=Math.floor(rt*_)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*L)-1):(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*f)-1,ft=Math.floor(Bt*_)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*L)-1):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa>=Ca&&xa>=La?(Bt=Ca/Oa)>(Mt=La/xa)?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*L)-1):(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*f)-1,ft=Math.floor(Bt*_)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,
Ct=Math.floor(Bt*L)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa<=Ca&&xa>=La?(Mt=La/xa)>(rt=Pa/Ia)?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*f)-1,ft=Math.floor(rt*_)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*L)-1):(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*L)-1):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa>=Ca&&xa<=La?(rt=Pa/Ia,(St=Ua/Na)>(Bt=Ca/Oa)&&rt>Bt?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*f)-1,ft=Math.floor(Bt*_)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*L)-1):Bt>St&&rt>St?(ia=Math.floor(St*g)-1,ra=Math.floor(St*f)-1,ft=Math.floor(St*_)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,
Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*L)-1):Bt>rt&&St>rt?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*f)-1,ft=Math.floor(rt*_)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*L)-1):console.log('Nie znam przyczyny :P')):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa<=Ca&&xa>=La?(rt=Pa/Ia,(St=Ua/Na)>(Mt=La/xa)&&rt>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*L)-1):Mt>St&&rt>St?(ia=Math.floor(St*g)-1,ra=Math.floor(St*f)-1,ft=Math.floor(St*_)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*L)-1):Mt>rt&&St>rt?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*f)-1,ft=Math.floor(rt*_)-1,pt=Math.floor(rt*b)-1,
Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,Ct=Math.floor(rt*L)-1):console.log('Nie znam przyczyny :P')):Ia>=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na<=Ua&&Oa>=Ca&&xa>=La?(rt=Pa/Ia,(Mt=La/xa)>(Bt=Ca/Oa)&&rt>Bt?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*f)-1,ft=Math.floor(Bt*_)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*L)-1):Bt>Mt&&rt>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*L)-1):Bt>rt&&Mt>rt?(ia=Math.floor(rt*g)-1,ra=Math.floor(rt*f)-1,ft=Math.floor(rt*_)-1,pt=Math.floor(rt*b)-1,Ft=Math.floor(rt*h)-1,Kt=Math.floor(rt*A)-1,Jt=Math.floor(rt*E)-1,At=Math.floor(rt*w)-1,
Ct=Math.floor(rt*L)-1):console.log('Nie znam przyczyny :P')):Ia<=Pa&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&Na>=Ua&&Oa>=Ca&&xa>=La&&(Mt=La/xa,(St=Ua/Na)>(Bt=Ca/Oa)&&Mt>Bt?(ia=Math.floor(Bt*g)-1,ra=Math.floor(Bt*f)-1,ft=Math.floor(Bt*_)-1,pt=Math.floor(Bt*b)-1,Ft=Math.floor(Bt*h)-1,Kt=Math.floor(Bt*A)-1,Jt=Math.floor(Bt*E)-1,At=Math.floor(Bt*w)-1,Ct=Math.floor(Bt*L)-1):Bt>St&&Mt>St?(ia=Math.floor(St*g)-1,ra=Math.floor(St*f)-1,ft=Math.floor(St*_)-1,pt=Math.floor(St*b)-1,Ft=Math.floor(St*h)-1,Kt=Math.floor(St*A)-1,Jt=Math.floor(St*E)-1,At=Math.floor(St*w)-1,Ct=Math.floor(St*L)-1):Bt>Mt&&St>Mt?(ia=Math.floor(Mt*g)-1,ra=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,pt=Math.floor(Mt*b)-1,Ft=Math.floor(Mt*h)-1,Kt=Math.floor(Mt*A)-1,Jt=Math.floor(Mt*E)-1,At=Math.floor(Mt*w)-1,Ct=Math.floor(Mt*L)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ia>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:ia}),v=[st='spear',ia],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ia)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){nt>=3&&(ra>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'sword',amount:ra}),v=[st='sword',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ra)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){nt>=5&&(ft>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:ft}),v=[st='axe',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ft)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){nt>=9&&(pt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:pt}),v=[st='archer',pt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,pt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){nt>=11&&(Ft>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:Ft}),v=[st='light_cavalry',Ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Ft)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){nt>=13&&(Kt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Kt}),v=[st='mounted_archer',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Kt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){nt>=15&&(Jt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:Jt}),v=[st='ram',Jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Jt)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){nt>=17&&(At>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:At}),v=[st='catapult',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,At)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){nt>=21&&(Ct>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:Ct}),v=[st='heavy_cavalry',Ct],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Ct)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,i,r,c,d,u,p,g,f,_,b,h,A,E,w,L}()}()}function sn(){ha=a>0?Ga.length>=2?1:1==Ga.length?.5:.25:0,function(){ba=_a.length>0?_a.reduce((function(e,t){return e+t})):0;!function(){
Aa=a>0?ba>=936e5?0:ba<936e5&&ba>=864e5?.1:ba<864e5&&ba>=72e6?.25:ba<72e6&&ba>=576e5?.4:ba<576e5&&ba>=432e5?.55:ba<432e5&&ba>=288e5?.7:ba<288e5&&ba>=144e5?.85:ba<144e5&&ba>=72e5?.925:ba<72e5&&ba>=36e5?.9625:1:0;e=Se-Ke,t=Re-Qe,n=be-Xe,i=_e-Ze,r=Ee-Je,c=we-$e,d=ve-et,u=he-tt,p=Ae-at,g=Math.floor(B*Aa*ha),T=Math.floor(V*Aa*ha),f=Math.floor(P*Aa*ha),b=Math.floor(L*Aa*ha),h=Math.floor(z*Aa*ha),A=Math.floor(D*Aa*ha),E=Math.floor(G*Aa*ha),w=Math.floor(U*Aa*ha),S=Math.floor(C*Aa*ha),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+b*Fe[3]+h*Fe[4]+A*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],y=g*Ye[0]+T*Ye[1]+f*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],k=g*je[0]+T*je[1]+f*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],M=g*He[0]+T*He[1]+f*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||n>0||i>0||r>0||c>0||d>0?(R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k<=Fa&&M<=Va?(oa=g,ca=T,_t=f,gt=b,Yt=h,Qt=A,$t=E,Et=w,
zt=S):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k<=Fa&&M<=Va?(Lt=Wa/R,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k<=Fa&&M<=Va?(Lt=qa/y,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k>=Fa&&M<=Va?(Lt=Fa/k,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k<=Fa&&M>=Va?(Lt=Va/M,oa=Math.floor(Lt*g)-1,
ca=Math.floor(Lt*T)-1,_t=Math.floor(Lt*f)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*S)-1):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k<=Fa&&M<=Va?(Rt=qa/y)>(ct=Wa/R)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k>=Fa&&M<=Va?(Rt=qa/y)>(Vt=Fa/k)?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,
zt=Math.floor(Vt*S)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k<=Fa&&M>=Va?(Rt=qa/y)>(It=Va/M)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k>=Fa&&M<=Va?(Vt=Fa/k)>(ct=Wa/R)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,
Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k>=Fa&&M>=Va?(Vt=Fa/k)>(It=Va/M)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k<=Fa&&M>=Va?(It=Va/M)>(ct=Wa/R)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,
$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k>=Fa&&M<=Va?(ct=Wa/R,(Rt=qa/y)>(Vt=Fa/k)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,
zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k<=Fa&&M>=Va?(ct=Wa/R,(Rt=qa/y)>(It=Va/M)&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):It>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):It>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R>=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=qa&&k>=Fa&&M>=Va?(ct=Wa/R,(It=Va/M)>(Vt=Fa/k)&&ct>Vt?(oa=Math.floor(Vt*g)-1,
ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>It&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):Vt>ct&&It>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*T)-1,_t=Math.floor(ct*f)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*S)-1):console.log('Nie znam przyczyny :P')):R<=Wa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=qa&&k>=Fa&&M>=Va&&(It=Va/M,(Rt=qa/y)>(Vt=Fa/k)&&It>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*T)-1,_t=Math.floor(Vt*f)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*S)-1):Vt>Rt&&It>Rt?(oa=Math.floor(Rt*g)-1,
ca=Math.floor(Rt*T)-1,_t=Math.floor(Rt*f)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*S)-1):Vt>It&&Rt>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*T)-1,_t=Math.floor(It*f)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){oa>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:oa}),v=[st='spear',oa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Da>=3&&(ca>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'sword',amount:ca}),v=[st='sword',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ca)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){Da>=5&&(_t>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:_t}),v=[st='axe',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,_t)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Da>=9&&(gt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:gt}),v=[st='archer',gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,gt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Da>=11&&(Yt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:Yt}),v=[st='light_cavalry',Yt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Yt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Da>=13&&(Qt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Qt}),
v=[st='mounted_archer',Qt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Qt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Da>=15&&($t>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:$t}),v=[st='ram',$t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,$t)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Da>=17&&(Et>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:Et}),v=[st='catapult',Et],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Et)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Da>=21&&(zt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:zt}),v=[st='heavy_cavalry',zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,zt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,n,i,r,c,d,u,p,g,T,f,b,h,A,E,w,S,R,y,k,M}()}()}function rn(){va=n>0?ja.length>=2?1:1==ja.length?.5:.25:0,function(){wa=Ea.length>0?Ea.reduce((function(e,t){return e+t})):0;!function(){Sa=n>0?wa>=936e5?0:wa<936e5&&wa>=864e5?.1:wa<864e5&&wa>=72e6?.25:wa<72e6&&wa>=576e5?.4:wa<576e5&&wa>=432e5?.55:wa<432e5&&wa>=288e5?.7:wa<288e5&&wa>=144e5?.85:wa<144e5&&wa>=72e5?.925:wa<72e5&&wa>=36e5?.9625:1:0;e=Le-Ke,t=Pe-Qe,a=ke-Xe,i=ye-Ze,r=Ne-Je,c=xe-$e,d=Oe-et,u=Me-tt,p=Ie-at,g=Math.floor(Q*Sa*va),T=Math.floor(X*Sa*va),f=Math.floor(q*Sa*va),_=Math.floor(W*Sa*va),b=Math.floor(j*Sa*va),A=Math.floor(H*Sa*va),E=Math.floor(K*Sa*va),w=Math.floor(F*Sa*va),S=Math.floor(Y*Sa*va),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+A*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],y=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],
k=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],M=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||a>0||i>0||r>0||c>0||d>0?(R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M<=Ka?(la=g,da=T,bt=f,mt=_,jt=b,Xt=A,ea=E,wt=w,Dt=S):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M<=Ka?(Pt=Qa/R,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M<=Ka?(Pt=Xa/y,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,
Dt=Math.floor(Pt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M<=Ka?(Pt=Za/k,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M>=Ka?(Pt=Ka/M,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*_)-1,jt=Math.floor(Pt*b)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M<=Ka?(yt=Xa/y)>(dt=Qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,
jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k>=Za&&M<=Ka?(yt=Xa/y)>(Wt=Za/k)?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M>=Ka?(yt=Xa/y)>(Nt=Ka/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,
mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M<=Ka?(Wt=Za/k)>(dt=Qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M>=Ka?(Wt=Za/k)>(Nt=Ka/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,
bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k<=Za&&M>=Ka?(Nt=Ka/M)>(dt=Qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k>=Za&&M<=Ka?(dt=Qa/R,(yt=Xa/y)>(Wt=Za/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,
Dt=Math.floor(Wt*S)-1):Wt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k<=Za&&M>=Ka?(dt=Qa/R,(yt=Xa/y)>(Nt=Ka/M)&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Nt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,
Dt=Math.floor(yt*S)-1):Nt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Xa&&k>=Za&&M>=Ka?(dt=Qa/R,(Nt=Ka/M)>(Wt=Za/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>Nt&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Wt>dt&&Nt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*_)-1,jt=Math.floor(dt*b)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,
Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R<=Qa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Xa&&k>=Za&&M>=Ka&&(Nt=Ka/M,(yt=Xa/y)>(Wt=Za/k)&&Nt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*_)-1,jt=Math.floor(Wt*b)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&Nt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*_)-1,jt=Math.floor(yt*b)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>Nt&&yt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*_)-1,jt=Math.floor(Nt*b)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){la>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:la}),v=[st='spear',la],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,la)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ya>=3&&(da>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'sword',amount:da}),v=[st='sword',da],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,da)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Ya>=5&&(bt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:bt}),v=[st='axe',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,bt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ya>=9&&(mt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:mt}),v=[st='archer',mt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,mt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ya>=11&&(jt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:jt}),v=[st='light_cavalry',jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,jt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ya>=13&&(Xt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Xt}),v=[st='mounted_archer',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Xt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ya>=15&&(ea>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:ea}),v=[st='ram',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ea)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){Ya>=17&&(wt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:wt}),v=[st='catapult',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,wt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Ya>=21&&(Dt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:Dt}),v=[st='heavy_cavalry',Dt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Dt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,a,i,r,c,d,u,p,g,T,f,_,b,A,E,w,S,R,y,k,M}()}()}function cn(){ka=c>0?$a.length>=2?1:1==$a.length?.5:.25:0,function(){ya=Ra.length>0?Ra.reduce((function(e,t){return e+t})):0;!function(){
Ma=c>0?ya>=936e5?0:ya<936e5&&ya>=864e5?.1:ya<864e5&&ya>=72e6?.25:ya<72e6&&ya>=576e5?.4:ya<576e5&&ya>=432e5?.55:ya<432e5&&ya>=288e5?.7:ya<288e5&&ya>=144e5?.85:ya<144e5&&ya>=72e5?.925:ya<72e5&&ya>=36e5?.9625:1:0;e=We-Ke,t=qe-Qe,a=Ce-Xe,n=Ue-Ze,i=Ge-Je,r=Be-$e,d=Ve-et,u=ze-tt,p=De-at,g=Math.floor(le*Ma*ka),T=Math.floor(se*Ma*ka),f=Math.floor(ee*Ma*ka),_=Math.floor(Z*Ma*ka),b=Math.floor(ne*Ma*ka),h=Math.floor(ie*Ma*ka),E=Math.floor(oe*Ma*ka),w=Math.floor(te*Ma*ka),S=Math.floor(ae*Ma*ka),R=g*Fe[0]+T*Fe[1]+f*Fe[2]+_*Fe[3]+b*Fe[4]+h*Fe[5]+E*Fe[7]+w*Fe[8]+S*Fe[6],y=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],k=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+h*je[5]+E*je[7]+w*je[8]+S*je[6],M=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+h*He[5]+E*He[7]+w*He[8]+S*He[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||i<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M<=tn?(sa=g,ua=T,
ht=f,Tt=_,Ht=b,Zt=h,ta=E,vt=w,Gt=S):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M<=tn?(Ut=an/R,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M<=tn?(Ut=nn/y,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M<=tn?(Ut=on/k,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,
Gt=Math.floor(Ut*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M>=tn?(Ut=tn/M,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*h)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M<=tn?(kt=nn/y)>(ut=an/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k>=on&&M<=tn?(kt=nn/y)>(qt=on/k)?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,
Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*h)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M>=tn?(kt=nn/y)>(xt=tn/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M<=tn?(qt=on/k)>(ut=an/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,
ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*h)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M>=tn?(qt=on/k)>(xt=tn/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*h)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k<=on&&M>=tn?(xt=tn/M)>(ut=an/R)?(sa=Math.floor(ut*g)-1,
ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k>=on&&M<=tn?(ut=an/R,(kt=nn/y)>(qt=on/k)&&ut>qt?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*h)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):qt>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):qt>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,
Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k<=on&&M>=tn?(ut=an/R,(kt=nn/y)>(xt=tn/M)&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):xt>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):xt>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,
Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=nn&&k>=on&&M>=tn?(ut=an/R,(xt=tn/M)>(qt=on/k)&&ut>qt?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*h)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):qt>xt&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):qt>ut&&xt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*h)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R<=an&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=nn&&k>=on&&M>=tn&&(xt=tn/M,(kt=nn/y)>(qt=on/k)&&xt>qt?(sa=Math.floor(qt*g)-1,
ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*h)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):qt>kt&&xt>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*h)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):qt>xt&&kt>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*h)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){sa>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'spear',amount:sa}),v=[st='spear',sa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,sa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ja>=3&&(ua>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,
unit_type:'sword',amount:ua}),v=[st='sword',ua],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ua)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){Ja>=5&&(ht>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'axe',amount:ht}),v=[st='axe',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ht)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ja>=9&&(Tt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'archer',amount:Tt}),v=[st='archer',Tt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Tt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ja>=11&&(Ht>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'light_cavalry',amount:Ht}),v=[st='light_cavalry',Ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(za,st,Ht)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ja>=13&&(Zt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'mounted_archer',amount:Zt}),v=[st='mounted_archer',Zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Zt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ja>=15&&(ta>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'ram',amount:ta}),v=[st='ram',ta],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,ta)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Ja>=17&&(vt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'catapult',amount:vt}),v=[st='catapult',vt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,vt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),
setTimeout((function(){Ja>=21&&(Gt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:za,unit_type:'heavy_cavalry',amount:Gt}),v=[st='heavy_cavalry',Gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(za,st,Gt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3));var e,t,a,n,i,r,d,u,p,g,T,f,_,b,h,E,w,S,R,y,k,M}()}()}function dn(){var e=i.getSelectedCharacter().getVillageList();console.log(e);var o=6e4*e.length,l=6e4*e.length+6e4*e.length,s=6e4*e.length+6e4*e.length+6e4*e.length;e.forEach((function(e,i){t&&setTimeout((function(){d.forEach((function(t){if(e.data.villageId==t){console.log('wioska:'+e.data.villageId),za=e.getId(),Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,
Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,nt=e.buildingData.data.barracks.level,it=e.buildingQueue.data.queue,ot=e.getRecruitingQueues(),lt=ot.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;La=l.currentStock,Pa=n.currentStock,Ua=i.currentStock,Ca=o.currentStock,lt.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,ga.push(na)})),ln()}}))}),6e4*i),a&&setTimeout((function(){u.forEach((function(t){if(e.data.villageId==t){Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,
Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Da=e.buildingData.data.barracks.level,Ga=e.buildingQueue.data.queue,ot=e.getRecruitingQueues(),Ba=ot.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Va=l.currentStock,Wa=n.currentStock,qa=i.currentStock,Fa=o.currentStock,Ba.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,_a.push(na)})),sn()}}))}),6e4*(i+1)+o),n&&setTimeout((function(){p.forEach((function(t){if(e.data.villageId==t){
Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Ya=e.buildingData.data.barracks.level,ja=e.buildingQueue.data.queue,ot=e.getRecruitingQueues(),Ha=ot.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;Ka=l.currentStock,Qa=n.currentStock,Xa=i.currentStock,Za=o.currentStock,Ha.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,
Ea.push(na)})),rn()}}))}),6e4*(i+2)+l),c&&setTimeout((function(){g.forEach((function(t){if(e.data.villageId==t){Ke=e.unitInfo.units.spear.own+e.unitInfo.units.spear.recruiting,Qe=e.unitInfo.units.sword.own+e.unitInfo.units.sword.recruiting,Xe=e.unitInfo.units.axe.own+e.unitInfo.units.axe.recruiting,Ze=e.unitInfo.units.archer.own+e.unitInfo.units.archer.recruiting,Je=e.unitInfo.units.light_cavalry.own+e.unitInfo.units.light_cavalry.recruiting,$e=e.unitInfo.units.mounted_archer.own+e.unitInfo.units.mounted_archer.recruiting,et=e.unitInfo.units.ram.own+e.unitInfo.units.ram.recruiting,tt=e.unitInfo.units.catapult.own+e.unitInfo.units.catapult.recruiting,at=e.unitInfo.units.heavy_cavalry.own+e.unitInfo.units.heavy_cavalry.recruiting,Ja=e.buildingData.data.barracks.level,$a=e.buildingQueue.data.queue,ot=e.getRecruitingQueues(),en=ot.barracks.jobs;var a=e.getResources().getComputed(),n=a.wood,i=a.clay,o=a.iron,l=a.food;tn=l.currentStock,an=n.currentStock,nn=i.currentStock,on=o.currentStock,
en.forEach((function(e){aa=e.clientRecruitingTime,pa=1e3*(e.data.time_completed-e.data.start_time),na=pa-aa,Ra.push(na)})),cn()}}))}),6e4*(i+3)+s)}))}dn(),setInterval((function(){dn()}),J),m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},ee.getLogs=function(){return h},ee.clearLogs=function(){return h=[],T.set(Q,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},ee.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START),$(p.RECRUIT_START,'start','')},ee.stop=function(e=n.USER_STOP){w?(e!==n.USER_STOP&&(w=f.gameTime()+J()),m.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):w=null,E=!1,m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&$(p.RECRUIT_STOP,'stop','')},ee.getSettings=function(){return _},ee.isInitialized=function(){return A},ee.isRunning=function(){return E},ee.getNextCycleDate=function(){return w},ee.getCycleInterval=J,ee})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',
RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop',RECRUIT_QUEUE_CLEAR_LOGS:'recruit_queue_clear_logs',RECRUIT_QUEUE_CYCLE_BEGIN:'recruit_queue_cycle_begin',RECRUIT_QUEUE_CYCLE_END:'recruit_queue_cycle_end'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/recruitQueue/types/status','two/recruitQueue/types/errors','two/Settings','queues/EventQueue','two/EventScope','helper/time','two/utils'],(function(e,t,n,d,u,p,T,f,_,b,h,A){let E,w,v,S=i.getGroupList(),R=!1,y=null,k={},M={},I={};const N={PRESETS:'presets',OWN:'own',LOGS:'logs'},x=function(e){E.selectedTab=e},O=function(){w.setAll(w.decode(E.settings)),A.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.presetRecrutation())},P=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.ownRecrutation())
},U=function(){E.settings[n.GROUP1]=!1,E.settings[n.GROUP2]=!1,E.settings[n.GROUP3]=!1,E.settings[n.GROUP4]=!1,E.settings[n.FINAL_AMOUNT1]=0,E.settings[n.FINAL_AMOUNT2]=0,E.settings[n.FINAL_AMOUNT3]=0,E.settings[n.FINAL_AMOUNT4]=0,E.settings[n.FINAL_AMOUNT5]=0,E.settings[n.FINAL_AMOUNT6]=0,E.settings[n.FINAL_AMOUNT7]=0,E.settings[n.FINAL_AMOUNT8]=0,E.settings[n.FINAL_AMOUNT9]=0,E.settings[n.START_AMOUNT1]=0,E.settings[n.START_AMOUNT2]=0,E.settings[n.START_AMOUNT3]=0,E.settings[n.START_AMOUNT4]=0,E.settings[n.START_AMOUNT5]=0,E.settings[n.START_AMOUNT6]=0,E.settings[n.START_AMOUNT7]=0,E.settings[n.START_AMOUNT8]=0,E.settings[n.START_AMOUNT9]=0,E.settings[n.FINAL_AMOUNT11]=0,E.settings[n.FINAL_AMOUNT12]=0,E.settings[n.FINAL_AMOUNT13]=0,E.settings[n.FINAL_AMOUNT14]=0,E.settings[n.FINAL_AMOUNT15]=0,E.settings[n.FINAL_AMOUNT16]=0,E.settings[n.FINAL_AMOUNT17]=0,E.settings[n.FINAL_AMOUNT18]=0,E.settings[n.FINAL_AMOUNT19]=0,E.settings[n.START_AMOUNT11]=0,E.settings[n.START_AMOUNT12]=0,
E.settings[n.START_AMOUNT13]=0,E.settings[n.START_AMOUNT14]=0,E.settings[n.START_AMOUNT15]=0,E.settings[n.START_AMOUNT16]=0,E.settings[n.START_AMOUNT17]=0,E.settings[n.START_AMOUNT18]=0,E.settings[n.START_AMOUNT19]=0,E.settings[n.FINAL_AMOUNT21]=0,E.settings[n.FINAL_AMOUNT22]=0,E.settings[n.FINAL_AMOUNT23]=0,E.settings[n.FINAL_AMOUNT24]=0,E.settings[n.FINAL_AMOUNT25]=0,E.settings[n.FINAL_AMOUNT26]=0,E.settings[n.FINAL_AMOUNT27]=0,E.settings[n.FINAL_AMOUNT28]=0,E.settings[n.FINAL_AMOUNT29]=0,E.settings[n.START_AMOUNT21]=0,E.settings[n.START_AMOUNT22]=0,E.settings[n.START_AMOUNT23]=0,E.settings[n.START_AMOUNT24]=0,E.settings[n.START_AMOUNT25]=0,E.settings[n.START_AMOUNT26]=0,E.settings[n.START_AMOUNT27]=0,E.settings[n.START_AMOUNT28]=0,E.settings[n.START_AMOUNT29]=0,E.settings[n.FINAL_AMOUNT31]=0,E.settings[n.FINAL_AMOUNT32]=0,E.settings[n.FINAL_AMOUNT33]=0,E.settings[n.FINAL_AMOUNT34]=0,E.settings[n.FINAL_AMOUNT35]=0,E.settings[n.FINAL_AMOUNT36]=0,E.settings[n.FINAL_AMOUNT37]=0,
E.settings[n.FINAL_AMOUNT38]=0,E.settings[n.FINAL_AMOUNT39]=0,E.settings[n.START_AMOUNT31]=0,E.settings[n.START_AMOUNT32]=0,E.settings[n.START_AMOUNT33]=0,E.settings[n.START_AMOUNT34]=0,E.settings[n.START_AMOUNT35]=0,E.settings[n.START_AMOUNT36]=0,E.settings[n.START_AMOUNT37]=0,E.settings[n.START_AMOUNT38]=0,E.settings[n.START_AMOUNT39]=0,w.setAll(w.decode(E.settings))},C=function(){E.settings[n.GROUP5]=!1,E.settings[n.GROUP6]=!1,E.settings[n.GROUP7]=!1,E.settings[n.GROUP8]=!1,E.settings[n.GROUP9]=!1,E.settings[n.GROUP10]=!1,E.settings[n.GROUP11]=!1,E.settings[n.GROUP12]=!1,E.settings[n.GROUP13]=!1,E.settings[n.GROUP14]=!1,E.settings[n.GROUP15]=!1,E.settings[n.GROUP16]=!1,E.settings[n.GROUP17]=!1,E.settings[n.GROUP18]=!1,E.settings[n.GROUP19]=!1,E.settings[n.GROUP20]=!1,E.settings[n.GROUP21]=!1,E.settings[n.GROUP22]=!1,E.settings[n.GROUP23]=!1,E.settings[n.GROUP24]=!1,E.settings[n.UNIT1]=!1,E.settings[n.UNIT2]=!1,E.settings[n.UNIT3]=!1,E.settings[n.UNIT4]=!1,E.settings[n.UNIT5]=!1,
E.settings[n.UNIT6]=!1,E.settings[n.UNIT7]=!1,E.settings[n.UNIT8]=!1,E.settings[n.UNIT9]=!1,E.settings[n.UNIT10]=!1,E.settings[n.UNIT11]=!1,E.settings[n.UNIT12]=!1,E.settings[n.UNIT13]=!1,E.settings[n.UNIT14]=!1,E.settings[n.UNIT15]=!1,E.settings[n.UNIT16]=!1,E.settings[n.UNIT17]=!1,E.settings[n.UNIT18]=!1,E.settings[n.UNIT19]=!1,E.settings[n.UNIT20]=!1,E.settings[n.AMOUNT1]=1,E.settings[n.AMOUNT2]=1,E.settings[n.AMOUNT3]=1,E.settings[n.AMOUNT4]=1,E.settings[n.AMOUNT5]=1,E.settings[n.AMOUNT6]=1,E.settings[n.AMOUNT7]=1,E.settings[n.AMOUNT8]=1,E.settings[n.AMOUNT9]=1,E.settings[n.AMOUNT10]=1,E.settings[n.AMOUNT11]=1,E.settings[n.AMOUNT12]=1,E.settings[n.AMOUNT13]=1,E.settings[n.AMOUNT14]=1,E.settings[n.AMOUNT15]=1,E.settings[n.AMOUNT16]=1,E.settings[n.AMOUNT17]=1,E.settings[n.AMOUNT18]=1,E.settings[n.AMOUNT19]=1,E.settings[n.AMOUNT20]=1,w.setAll(w.decode(E.settings))};k.updateVisibleLogs=function(){const e=E.pagination.logs.offset,t=E.pagination.logs.limit
;k.visibleLogs=k.logs.slice(e,e+t),E.pagination.logs.count=k.logs.length,k.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,I[e]='ŁADOWANIE...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},k.clearLogs=function(){t.clearLogs()};const z={updateGroups:function(){E.groups=f.encodeList(S.getGroups(),{disabled:!1,type:'groups'})},updateLogs:function(){E.logs=t.getLogs(),k.updateVisibleLogs(),E.logs.length||A.notif('success',g('i18n')('reseted_logs',a.loc.ale,'recruit_queue'))},clearLogs:function(){A.notif('success',g('i18n')('logs.cleared',a.loc.ale,'recruit_queue')),z.updateLogs()},start:function(){E.running=!0},stop:function(e,t){switch(E.running=!1,E.showCycleTimer=!1,clearInterval(y),t.reason){case T.USER_STOP:
A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))}},onCycleBegin:function(){E.showCycleTimer=!1,clearInterval(y)},onCycleEnd:function(e,a){a!==p.USER_STOP&&(E.showCycleTimer=!0,E.nextCycleCountdown=t.getCycleInterval(),y=setInterval((function(){E.nextCycleCountdown-=1e3}),1e3))}},D=function(){E=a.$new(),E.SETTINGS=n,E.TAB_TYPES=N,E.running=R,E.selectedTab=N.PRESETS,E.settingsMap=d,E.pagination={},E.clearP=U,E.clearO=C,E.units=f.encodeList(u,{textObject:'recruit_queue',disabled:!0}),w.injectScope(E),z.updateGroups(),function(){let e=t.getNextCycleDate();e&&(E.showCycleTimer=!0,E.nextCycleCountdown=e-h.gameTime(),y=setInterval((function(){E.nextCycleCountdown-=1e3}),1e3))}(),E.selectTab=x,E.saveSettings=O,E.switchRecruiterO=P,E.switchRecruiterP=L,E.logsView=k,E.logsView.logs=t.getLogs(),E.villagesInfo=M,E.villagesLabel=I,E.openVillageInfo=r.openVillageInfo,E.pagination.logs={count:k.logs.length,offset:0,loader:k.updateVisibleLogs,limit:m.getPaginationLimit()},
k.updateVisibleLogs();let e=new b('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed'),clearInterval(y)}));e.register(s.GROUPS_CREATED,z.updateGroups,!0),e.register(s.GROUPS_DESTROYED,z.updateGroups,!0),e.register(s.GROUPS_UPDATED,z.updateGroups,!0),e.register(s.RECRUIT_QUEUE_JOB_STARTED,z.updateLogs),e.register(s.RECRUIT_QUEUE_CLEAR_LOGS,z.clearLogs),e.register(s.RECRUIT_QUEUE_START,z.start),e.register(s.RECRUIT_QUEUE_STOP,z.stop),e.register(s.RECRUIT_QUEUE_CYCLE_BEGIN,z.onCycleBegin),e.register(s.RECRUIT_QUEUE_CYCLE_END,z.onCycleEnd),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',E)};return function(){w=t.getSettings(),v=e.addMenuButton('Kapitan',80),v.addEventListener('click',D),_.register(s.RECRUIT_QUEUE_START,(function(){R=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),A.notif('success',g('i18n')('general.started',a.loc.ale,'recruit_queue'))})),_.register(s.RECRUIT_QUEUE_STOP,(function(){R=!1,
v.classList.remove('btn-red'),v.classList.add('btn-orange'),A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))})),
