...
;const T=b[r.MIN_PACK1],_=b[r.MIN_PACK2],h=b[r.MIN_PACK3],A=b[r.MIN_PACK4],S=b[r.START_AMOUNT4],R=b[r.START_AMOUNT3],y=b[r.START_AMOUNT9],k=b[r.START_AMOUNT7],M=b[r.START_AMOUNT5],I=b[r.START_AMOUNT6],N=b[r.START_AMOUNT8],x=b[r.START_AMOUNT1],O=b[r.START_AMOUNT2],L=b[r.START_AMOUNT14],P=b[r.START_AMOUNT13],U=b[r.START_AMOUNT19],C=b[r.START_AMOUNT17],z=b[r.START_AMOUNT15],D=b[r.START_AMOUNT16],G=b[r.START_AMOUNT18],B=b[r.START_AMOUNT11],V=b[r.START_AMOUNT12],W=b[r.START_AMOUNT24],q=b[r.START_AMOUNT23],F=b[r.START_AMOUNT29],Y=b[r.START_AMOUNT27],j=b[r.START_AMOUNT25],H=b[r.START_AMOUNT26],K=b[r.START_AMOUNT28],Q=b[r.START_AMOUNT21],X=b[r.START_AMOUNT22],Z=b[r.START_AMOUNT34],te=b[r.START_AMOUNT33],ae=b[r.START_AMOUNT39],ne=b[r.START_AMOUNT37],ie=b[r.START_AMOUNT35],oe=b[r.START_AMOUNT36],le=b[r.START_AMOUNT38],se=b[r.START_AMOUNT31],re=b[r.START_AMOUNT32],ce=b[r.FINAL_AMOUNT4],de=b[r.FINAL_AMOUNT3],ue=b[r.FINAL_AMOUNT9],pe=b[r.FINAL_AMOUNT7],ge=b[r.FINAL_AMOUNT5],me=b[r.FINAL_AMOUNT6],Te=b[r.FINAL_AMOUNT8],fe=b[r.FINAL_AMOUNT1],_e=b[r.FINAL_AMOUNT2],be=b[r.FINAL_AMOUNT14],he=b[r.FINAL_AMOUNT13],Ae=b[r.FINAL_AMOUNT19],Ee=b[r.FINAL_AMOUNT17],we=b[r.FINAL_AMOUNT15],ve=b[r.FINAL_AMOUNT16],Se=b[r.FINAL_AMOUNT18],Re=b[r.FINAL_AMOUNT11],ye=b[r.FINAL_AMOUNT12],ke=b[r.FINAL_AMOUNT24],Me=b[r.FINAL_AMOUNT23],Ie=b[r.FINAL_AMOUNT29],Ne=b[r.FINAL_AMOUNT27],xe=b[r.FINAL_AMOUNT25],Oe=b[r.FINAL_AMOUNT26],Le=b[r.FINAL_AMOUNT28],Pe=b[r.FINAL_AMOUNT21],Ue=b[r.FINAL_AMOUNT22],Ce=b[r.FINAL_AMOUNT34],ze=b[r.FINAL_AMOUNT33],De=b[r.FINAL_AMOUNT39],Ge=b[r.FINAL_AMOUNT37],Be=b[r.FINAL_AMOUNT35],Ve=b[r.FINAL_AMOUNT36],We=b[r.FINAL_AMOUNT38],qe=b[r.FINAL_AMOUNT31],Fe=b[r.FINAL_AMOUNT32]
;var Ye=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],je=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],He=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],Ke=[1,1,1,1,4,5,6,5,8,1,100,10,6],Qe=0,Xe=0,Ze=0,Je=0,$e=0,et=0,tt=0,at=0,nt=0,it=0,ot=0,lt=0,st=0,rt='',ct=0,dt=0,ut=0,pt=0,gt=0,mt=0,Tt=0,ft=0,_t=0,bt=0,ht=0,At=0,Et=0,wt=0,vt=0,St=0,Rt=0,yt=0,kt=0,Mt=0,It=0,Nt=0,xt=0,Ot=0,Lt=0,Pt=0,Ut=0,Ct=0,zt=0,Dt=0,Gt=0,Bt=0,Vt=0,Wt=0,qt=0,Ft=0,Yt=0,jt=0,Ht=0,Kt=0,Qt=0,Xt=0,Zt=0,Jt=0,$t=0,ea=0,ta=0,aa=0,na=0,ia=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=[],Ta=0,fa=0,_a=0,ba=[],ha=0,Aa=0,Ea=0,wa=[],va=0,Sa=0,Ra=0,ya=[],ka=0,Ma=0,Ia=0,Na=0,xa=0,Oa=0,La=0,Pa=0,Ua=0,Ca=0,za=0,Da=0,Ga=0,Ba=0,Va=0,Wa=0,qa=0,Fa=0,Ya=0,ja=0,Ha=0,Ka=0,Qa=0,Xa=0,Za=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0;function sn(){fa=t>0?ot.length>=2?1:1==ot.length?.5:.25:0,function(){Ta=ma.length>0?ma.reduce((function(e,t){return e+t})):0;!function(){
_a=t>0?Ta>=936e5?0:Ta<936e5&&Ta>=864e5?.1:Ta<864e5&&Ta>=72e6?.25:Ta<72e6&&Ta>=576e5?.4:Ta<576e5&&Ta>=432e5?.55:Ta<432e5&&Ta>=288e5?.7:Ta<288e5&&Ta>=144e5?.85:Ta<144e5&&Ta>=72e5?.925:Ta<72e5&&Ta>=36e5?.9625:1:0;e=fe-Qe,a=_e-Xe,n=de-Ze,i=ce-Je,r=ge-$e,c=me-et,d=Te-tt,u=ue-at,p=pe-nt,g=Math.floor(x*_a*fa),f=Math.floor(O*_a*fa),_=Math.floor(R*_a*fa),b=Math.floor(S*_a*fa),h=Math.floor(M*_a*fa),A=Math.floor(I*_a*fa),E=Math.floor(N*_a*fa),w=Math.floor(y*_a*fa),L=Math.floor(k*_a*fa),console.log(g,f,_,b,h,A,E,L,w),Na=g*Ye[0]+f*Ye[1]+_*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+L*Ye[6],xa=g*je[0]+f*je[1]+_*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+L*je[6],La=g*He[0]+f*He[1]+_*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+L*He[6],Oa=g*Ke[0]+f*Ke[1]+_*Ke[2]+b*Ke[3]+h*Ke[4]+A*Ke[5]+E*Ke[7]+w*Ke[8]+L*Ke[6],console.log(Na,xa,La,Oa),e>0||p>0||u>0||a>0||n>0||i>0||r>0||c>0||d>0?(Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa<=Pa?(oa=g,ca=f,_t=_,gt=b,Yt=h,Qt=A,
$t=E,Et=w,zt=L):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa<=Pa?(Lt=Ua/Na,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*f)-1,_t=Math.floor(Lt*_)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa<=Pa?(Lt=Ca/xa,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*f)-1,_t=Math.floor(Lt*_)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa<=Pa?(Lt=za/La,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*f)-1,_t=Math.floor(Lt*_)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,
zt=Math.floor(Lt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa>=Pa?(Lt=Pa/Oa,oa=Math.floor(Lt*g)-1,ca=Math.floor(Lt*f)-1,_t=Math.floor(Lt*_)-1,gt=Math.floor(Lt*b)-1,Yt=Math.floor(Lt*h)-1,Qt=Math.floor(Lt*A)-1,$t=Math.floor(Lt*E)-1,Et=Math.floor(Lt*w)-1,zt=Math.floor(Lt*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa<=Pa?(Rt=Ca/xa)>(ct=Ua/Na)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*f)-1,_t=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*f)-1,_t=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La>=za&&Oa<=Pa?(Rt=Ca/xa)>(Vt=za/La)?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*f)-1,
_t=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*f)-1,_t=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa>=Pa?(Rt=Ca/xa)>(It=Pa/Oa)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*f)-1,_t=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*f)-1,_t=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa<=Pa?(Vt=za/La)>(ct=Ua/Na)?(oa=Math.floor(ct*g)-1,
ca=Math.floor(ct*f)-1,_t=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*f)-1,_t=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa>=Pa?(Vt=za/La)>(It=Pa/Oa)?(oa=Math.floor(It*g)-1,ca=Math.floor(It*f)-1,_t=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*f)-1,_t=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,
zt=Math.floor(Vt*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La<=za&&Oa>=Pa?(It=Pa/Oa)>(ct=Ua/Na)?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*f)-1,_t=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):(oa=Math.floor(It*g)-1,ca=Math.floor(It*f)-1,_t=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La>=za&&Oa<=Pa?(ct=Ua/Na,(Rt=Ca/xa)>(Vt=za/La)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*f)-1,_t=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Vt>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*f)-1,_t=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,
Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Vt>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*f)-1,_t=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):console.log('Nie znam przyczyny :P')):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La<=za&&Oa>=Pa?(ct=Ua/Na,(Rt=Ca/xa)>(It=Pa/Oa)&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*f)-1,_t=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):It>Rt&&ct>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*f)-1,_t=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):It>ct&&Rt>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*f)-1,_t=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,
Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,zt=Math.floor(ct*L)-1):console.log('Nie znam przyczyny :P')):Na>=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa<=Ca&&La>=za&&Oa>=Pa?(ct=Ua/Na,(It=Pa/Oa)>(Vt=za/La)&&ct>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*f)-1,_t=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Vt>It&&ct>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*f)-1,_t=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):Vt>ct&&It>ct?(oa=Math.floor(ct*g)-1,ca=Math.floor(ct*f)-1,_t=Math.floor(ct*_)-1,gt=Math.floor(ct*b)-1,Yt=Math.floor(ct*h)-1,Qt=Math.floor(ct*A)-1,$t=Math.floor(ct*E)-1,Et=Math.floor(ct*w)-1,
zt=Math.floor(ct*L)-1):console.log('Nie znam przyczyny :P')):Na<=Ua&&(e>=T||p>=T||u>=T||a>=T||n>=T||i>=T||r>=T||c>=T||d>=T)&&xa>=Ca&&La>=za&&Oa>=Pa&&(It=Pa/Oa,(Rt=Ca/xa)>(Vt=za/La)&&It>Vt?(oa=Math.floor(Vt*g)-1,ca=Math.floor(Vt*f)-1,_t=Math.floor(Vt*_)-1,gt=Math.floor(Vt*b)-1,Yt=Math.floor(Vt*h)-1,Qt=Math.floor(Vt*A)-1,$t=Math.floor(Vt*E)-1,Et=Math.floor(Vt*w)-1,zt=Math.floor(Vt*L)-1):Vt>Rt&&It>Rt?(oa=Math.floor(Rt*g)-1,ca=Math.floor(Rt*f)-1,_t=Math.floor(Rt*_)-1,gt=Math.floor(Rt*b)-1,Yt=Math.floor(Rt*h)-1,Qt=Math.floor(Rt*A)-1,$t=Math.floor(Rt*E)-1,Et=Math.floor(Rt*w)-1,zt=Math.floor(Rt*L)-1):Vt>It&&Rt>It?(oa=Math.floor(It*g)-1,ca=Math.floor(It*f)-1,_t=Math.floor(It*_)-1,gt=Math.floor(It*b)-1,Yt=Math.floor(It*h)-1,Qt=Math.floor(It*A)-1,$t=Math.floor(It*E)-1,Et=Math.floor(It*w)-1,zt=Math.floor(It*L)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){oa>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:oa}),v=[rt='spear',oa],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,oa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){it>=3&&(ca>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'sword',amount:ca}),v=[rt='sword',ca],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ca)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){it>=5&&(_t>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:_t}),v=[rt='axe',_t],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,_t)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){it>=9&&(gt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:gt}),v=[rt='archer',gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
...
}),42e3),setTimeout((function(){it>=17&&(Et>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:Et}),v=[rt='catapult',Et],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Et)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){it>=21&&(zt>=T?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:zt}),v=[rt='heavy_cavalry',zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,zt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,a,n,i,r,c,d,u,p,g,f,_,b,h,A,E,w,L}()}()}function rn(){Aa=a>0?Ba.length>=2?1:1==Ba.length?.5:.25:0,function(){ha=ba.length>0?ba.reduce((function(e,t){return e+t})):0;!function(){
Ea=a>0?ha>=936e5?0:ha<936e5&&ha>=864e5?.1:ha<864e5&&ha>=72e6?.25:ha<72e6&&ha>=576e5?.4:ha<576e5&&ha>=432e5?.55:ha<432e5&&ha>=288e5?.7:ha<288e5&&ha>=144e5?.85:ha<144e5&&ha>=72e5?.925:ha<72e5&&ha>=36e5?.9625:1:0;e=Re-Qe,t=ye-Xe,n=he-Ze,i=be-Je,r=we-$e,c=ve-et,d=Se-tt,u=Ae-at,p=Ee-nt,g=Math.floor(B*Ea*Aa),T=Math.floor(V*Ea*Aa),f=Math.floor(P*Ea*Aa),b=Math.floor(L*Ea*Aa),h=Math.floor(z*Ea*Aa),A=Math.floor(D*Ea*Aa),E=Math.floor(G*Ea*Aa),w=Math.floor(U*Ea*Aa),S=Math.floor(C*Ea*Aa),R=g*Ye[0]+T*Ye[1]+f*Ye[2]+b*Ye[3]+h*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],y=g*je[0]+T*je[1]+f*je[2]+b*je[3]+h*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],k=g*He[0]+T*He[1]+f*He[2]+b*He[3]+h*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],M=g*Ke[0]+T*Ke[1]+f*Ke[2]+b*Ke[3]+h*Ke[4]+A*Ke[5]+E*Ke[7]+w*Ke[8]+S*Ke[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||n>0||i>0||r>0||c>0||d>0?(R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k<=Ya&&M<=Wa?(la=g,da=T,bt=f,mt=b,jt=h,Xt=A,ea=E,wt=w,
Dt=S):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k<=Ya&&M<=Wa?(Pt=qa/R,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*b)-1,jt=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k<=Ya&&M<=Wa?(Pt=Fa/y,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*b)-1,jt=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k>=Ya&&M<=Wa?(Pt=Ya/k,la=Math.floor(Pt*g)-1,da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*b)-1,jt=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k<=Ya&&M>=Wa?(Pt=Wa/M,la=Math.floor(Pt*g)-1,
da=Math.floor(Pt*T)-1,bt=Math.floor(Pt*f)-1,mt=Math.floor(Pt*b)-1,jt=Math.floor(Pt*h)-1,Xt=Math.floor(Pt*A)-1,ea=Math.floor(Pt*E)-1,wt=Math.floor(Pt*w)-1,Dt=Math.floor(Pt*S)-1):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k<=Ya&&M<=Wa?(yt=Fa/y)>(dt=qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*b)-1,jt=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*b)-1,jt=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k>=Ya&&M<=Wa?(yt=Fa/y)>(Wt=Ya/k)?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*b)-1,jt=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,
Dt=Math.floor(Wt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*b)-1,jt=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k<=Ya&&M>=Wa?(yt=Fa/y)>(Nt=Wa/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*b)-1,jt=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*b)-1,jt=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k>=Ya&&M<=Wa?(Wt=Ya/k)>(dt=qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*b)-1,jt=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,
wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*b)-1,jt=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k>=Ya&&M>=Wa?(Wt=Ya/k)>(Nt=Wa/M)?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*b)-1,jt=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*b)-1,jt=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k<=Ya&&M>=Wa?(Nt=Wa/M)>(dt=qa/R)?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*b)-1,jt=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,
ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*b)-1,jt=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k>=Ya&&M<=Wa?(dt=qa/R,(yt=Fa/y)>(Wt=Ya/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*b)-1,jt=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*b)-1,jt=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*b)-1,jt=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,
Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k<=Ya&&M>=Wa?(dt=qa/R,(yt=Fa/y)>(Nt=Wa/M)&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*b)-1,jt=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Nt>yt&&dt>yt?(la=Math.floor(yt*g)-1,da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*b)-1,jt=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Nt>dt&&yt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*b)-1,jt=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R>=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y<=Fa&&k>=Ya&&M>=Wa?(dt=qa/R,(Nt=Wa/M)>(Wt=Ya/k)&&dt>Wt?(la=Math.floor(Wt*g)-1,
da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*b)-1,jt=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>Nt&&dt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*b)-1,jt=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):Wt>dt&&Nt>dt?(la=Math.floor(dt*g)-1,da=Math.floor(dt*T)-1,bt=Math.floor(dt*f)-1,mt=Math.floor(dt*b)-1,jt=Math.floor(dt*h)-1,Xt=Math.floor(dt*A)-1,ea=Math.floor(dt*E)-1,wt=Math.floor(dt*w)-1,Dt=Math.floor(dt*S)-1):console.log('Nie znam przyczyny :P')):R<=qa&&(e>=_||p>=_||u>=_||t>=_||n>=_||i>=_||r>=_||c>=_||d>=_)&&y>=Fa&&k>=Ya&&M>=Wa&&(Nt=Wa/M,(yt=Fa/y)>(Wt=Ya/k)&&Nt>Wt?(la=Math.floor(Wt*g)-1,da=Math.floor(Wt*T)-1,bt=Math.floor(Wt*f)-1,mt=Math.floor(Wt*b)-1,jt=Math.floor(Wt*h)-1,Xt=Math.floor(Wt*A)-1,ea=Math.floor(Wt*E)-1,wt=Math.floor(Wt*w)-1,Dt=Math.floor(Wt*S)-1):Wt>yt&&Nt>yt?(la=Math.floor(yt*g)-1,
da=Math.floor(yt*T)-1,bt=Math.floor(yt*f)-1,mt=Math.floor(yt*b)-1,jt=Math.floor(yt*h)-1,Xt=Math.floor(yt*A)-1,ea=Math.floor(yt*E)-1,wt=Math.floor(yt*w)-1,Dt=Math.floor(yt*S)-1):Wt>Nt&&yt>Nt?(la=Math.floor(Nt*g)-1,da=Math.floor(Nt*T)-1,bt=Math.floor(Nt*f)-1,mt=Math.floor(Nt*b)-1,jt=Math.floor(Nt*h)-1,Xt=Math.floor(Nt*A)-1,ea=Math.floor(Nt*E)-1,wt=Math.floor(Nt*w)-1,Dt=Math.floor(Nt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){la>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:la}),v=[rt='spear',la],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,la)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){Ga>=3&&(da>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'sword',amount:da}),v=[rt='sword',da],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,da)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),
setTimeout((function(){Ga>=5&&(bt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:bt}),v=[rt='axe',bt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,bt)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){Ga>=9&&(mt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:mt}),v=[rt='archer',mt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,mt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){Ga>=11&&(jt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:jt}),v=[rt='light_cavalry',jt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,jt)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){Ga>=13&&(Xt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'mounted_archer',amount:Xt}),
v=[rt='mounted_archer',Xt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Xt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){Ga>=15&&(ea>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'ram',amount:ea}),v=[rt='ram',ea],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ea)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),42e3),setTimeout((function(){Ga>=17&&(wt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:wt}),v=[rt='catapult',wt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,wt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){Ga>=21&&(Dt>=_?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:Dt}),v=[rt='heavy_cavalry',Dt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(Da,rt,Dt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,n,i,r,c,d,u,p,g,T,f,b,h,A,E,w,S,R,y,k,M}()}()}function cn(){Sa=n>0?Ha.length>=2?1:1==Ha.length?.5:.25:0,function(){va=wa.length>0?wa.reduce((function(e,t){return e+t})):0;!function(){Ra=n>0?va>=936e5?0:va<936e5&&va>=864e5?.1:va<864e5&&va>=72e6?.25:va<72e6&&va>=576e5?.4:va<576e5&&va>=432e5?.55:va<432e5&&va>=288e5?.7:va<288e5&&va>=144e5?.85:va<144e5&&va>=72e5?.925:va<72e5&&va>=36e5?.9625:1:0;e=Pe-Qe,t=Ue-Xe,a=Me-Ze,i=ke-Je,r=xe-$e,c=Oe-et,d=Le-tt,u=Ie-at,p=Ne-nt,g=Math.floor(Q*Ra*Sa),T=Math.floor(X*Ra*Sa),f=Math.floor(q*Ra*Sa),_=Math.floor(W*Ra*Sa),b=Math.floor(j*Ra*Sa),A=Math.floor(H*Ra*Sa),E=Math.floor(K*Ra*Sa),w=Math.floor(F*Ra*Sa),S=Math.floor(Y*Ra*Sa),R=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+A*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],y=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+A*je[5]+E*je[7]+w*je[8]+S*je[6],
k=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+A*He[5]+E*He[7]+w*He[8]+S*He[6],M=g*Ke[0]+T*Ke[1]+f*Ke[2]+_*Ke[3]+b*Ke[4]+A*Ke[5]+E*Ke[7]+w*Ke[8]+S*Ke[6],console.log(R,y,k,M),e>0||p>0||u>0||t>0||a>0||i>0||r>0||c>0||d>0?(R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M<=Qa?(sa=g,ua=T,ht=f,Tt=_,Ht=b,Zt=A,ta=E,vt=w,Gt=S):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M<=Qa?(Ut=Xa/R,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M<=Qa?(Ut=Za/y,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,
Gt=Math.floor(Ut*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M<=Qa?(Ut=Ja/k,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M>=Qa?(Ut=Qa/M,sa=Math.floor(Ut*g)-1,ua=Math.floor(Ut*T)-1,ht=Math.floor(Ut*f)-1,Tt=Math.floor(Ut*_)-1,Ht=Math.floor(Ut*b)-1,Zt=Math.floor(Ut*A)-1,ta=Math.floor(Ut*E)-1,vt=Math.floor(Ut*w)-1,Gt=Math.floor(Ut*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M<=Qa?(kt=Za/y)>(ut=Xa/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,
Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k>=Ja&&M<=Qa?(kt=Za/y)>(qt=Ja/k)?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*A)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M>=Qa?(kt=Za/y)>(xt=Qa/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,
Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M<=Qa?(qt=Ja/k)>(ut=Xa/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*A)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M>=Qa?(qt=Ja/k)>(xt=Qa/M)?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,
ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*A)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k<=Ja&&M>=Qa?(xt=Qa/M)>(ut=Xa/R)?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k>=Ja&&M<=Qa?(ut=Xa/R,(kt=Za/y)>(qt=Ja/k)&&ut>qt?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*A)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,
Gt=Math.floor(qt*S)-1):qt>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):qt>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k<=Ja&&M>=Qa?(ut=Xa/R,(kt=Za/y)>(xt=Qa/M)&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):xt>kt&&ut>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,
Gt=Math.floor(kt*S)-1):xt>ut&&kt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R>=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y<=Za&&k>=Ja&&M>=Qa?(ut=Xa/R,(xt=Qa/M)>(qt=Ja/k)&&ut>qt?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*A)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):qt>xt&&ut>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):qt>ut&&xt>ut?(sa=Math.floor(ut*g)-1,ua=Math.floor(ut*T)-1,ht=Math.floor(ut*f)-1,Tt=Math.floor(ut*_)-1,Ht=Math.floor(ut*b)-1,Zt=Math.floor(ut*A)-1,ta=Math.floor(ut*E)-1,vt=Math.floor(ut*w)-1,
Gt=Math.floor(ut*S)-1):console.log('Nie znam przyczyny :P')):R<=Xa&&(e>=h||p>=h||u>=h||t>=h||a>=h||i>=h||r>=h||c>=h||d>=h)&&y>=Za&&k>=Ja&&M>=Qa&&(xt=Qa/M,(kt=Za/y)>(qt=Ja/k)&&xt>qt?(sa=Math.floor(qt*g)-1,ua=Math.floor(qt*T)-1,ht=Math.floor(qt*f)-1,Tt=Math.floor(qt*_)-1,Ht=Math.floor(qt*b)-1,Zt=Math.floor(qt*A)-1,ta=Math.floor(qt*E)-1,vt=Math.floor(qt*w)-1,Gt=Math.floor(qt*S)-1):qt>kt&&xt>kt?(sa=Math.floor(kt*g)-1,ua=Math.floor(kt*T)-1,ht=Math.floor(kt*f)-1,Tt=Math.floor(kt*_)-1,Ht=Math.floor(kt*b)-1,Zt=Math.floor(kt*A)-1,ta=Math.floor(kt*E)-1,vt=Math.floor(kt*w)-1,Gt=Math.floor(kt*S)-1):qt>xt&&kt>xt?(sa=Math.floor(xt*g)-1,ua=Math.floor(xt*T)-1,ht=Math.floor(xt*f)-1,Tt=Math.floor(xt*_)-1,Ht=Math.floor(xt*b)-1,Zt=Math.floor(xt*A)-1,ta=Math.floor(xt*E)-1,vt=Math.floor(xt*w)-1,Gt=Math.floor(xt*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){sa>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:sa}),v=[rt='spear',sa],
m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,sa)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){ja>=3&&(ua>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'sword',amount:ua}),v=[rt='sword',ua],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ua)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){ja>=5&&(ht>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:ht}),v=[rt='axe',ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ht)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){ja>=9&&(Tt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:Tt}),v=[rt='archer',Tt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
$(Da,rt,Tt)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){ja>=11&&(Ht>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:Ht}),v=[rt='light_cavalry',Ht],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Ht)):console.log('Niezrekrutowano lk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),3e4),setTimeout((function(){ja>=13&&(Zt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'mounted_archer',amount:Zt}),v=[rt='mounted_archer',Zt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Zt)):console.log('Niezrekrutowano łk - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),36e3),setTimeout((function(){ja>=15&&(ta>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'ram',amount:ta}),v=[rt='ram',ta],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ta)):console.log('Niezrekrutowano taranów - mniej niż wskazane minimum lub zbyt niski poziom koszar'))
}),42e3),setTimeout((function(){ja>=17&&(vt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'catapult',amount:vt}),v=[rt='catapult',vt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,vt)):console.log('Niezrekrutowano katapult - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),48e3),setTimeout((function(){ja>=21&&(Gt>=h?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'heavy_cavalry',amount:Gt}),v=[rt='heavy_cavalry',Gt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,Gt)):console.log('Niezrekrutowano ck - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),54e3)):console.log('Brak jednostek do rekrutacji');var e,t,a,i,r,c,d,u,p,g,T,f,_,b,A,E,w,S,R,y,k,M}()}()}function dn(){Ma=c>0?en.length>=2?1:1==en.length?.5:.25:0,function(){ka=ya.length>0?ya.reduce((function(e,t){return e+t})):0;!function(){
Ia=c>0?ka>=936e5?0:ka<936e5&&ka>=864e5?.1:ka<864e5&&ka>=72e6?.25:ka<72e6&&ka>=576e5?.4:ka<576e5&&ka>=432e5?.55:ka<432e5&&ka>=288e5?.7:ka<288e5&&ka>=144e5?.85:ka<144e5&&ka>=72e5?.925:ka<72e5&&ka>=36e5?.9625:1:0;e=qe-Qe,t=Fe-Xe,a=ze-Ze,n=Ce-Je,i=Be-$e,r=Ve-et,d=We-tt,u=De-at,p=Ge-nt,g=Math.floor(se*Ia*Ma),T=Math.floor(re*Ia*Ma),f=Math.floor(te*Ia*Ma),_=Math.floor(Z*Ia*Ma),b=Math.floor(ie*Ia*Ma),h=Math.floor(oe*Ia*Ma),E=Math.floor(le*Ia*Ma),w=Math.floor(ae*Ia*Ma),S=Math.floor(ne*Ia*Ma),R=g*Ye[0]+T*Ye[1]+f*Ye[2]+_*Ye[3]+b*Ye[4]+h*Ye[5]+E*Ye[7]+w*Ye[8]+S*Ye[6],y=g*je[0]+T*je[1]+f*je[2]+_*je[3]+b*je[4]+h*je[5]+E*je[7]+w*je[8]+S*je[6],k=g*He[0]+T*He[1]+f*He[2]+_*He[3]+b*He[4]+h*He[5]+E*He[7]+w*He[8]+S*He[6],M=g*Ke[0]+T*Ke[1]+f*Ke[2]+_*Ke[3]+b*Ke[4]+h*Ke[5]+E*Ke[7]+w*Ke[8]+S*Ke[6],console.log(R,y,k,M),e<=0||p<=0||u<=0||t<=0||a<=0||n<=0||i<=0||r<=0||d<=0?console.log('Brak jednostek do rekrutacji'):(R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M<=an?(ra=g,pa=T,
At=f,ft=_,Kt=b,Jt=h,aa=E,St=w,Bt=S):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M<=an?(Ct=nn/R,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*f)-1,ft=Math.floor(Ct*_)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,Bt=Math.floor(Ct*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M<=an?(Ct=on/y,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*f)-1,ft=Math.floor(Ct*_)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,Bt=Math.floor(Ct*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M<=an?(Ct=ln/k,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*f)-1,ft=Math.floor(Ct*_)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,
Bt=Math.floor(Ct*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M>=an?(Ct=an/M,ra=Math.floor(Ct*g)-1,pa=Math.floor(Ct*T)-1,At=Math.floor(Ct*f)-1,ft=Math.floor(Ct*_)-1,Kt=Math.floor(Ct*b)-1,Jt=Math.floor(Ct*h)-1,aa=Math.floor(Ct*E)-1,St=Math.floor(Ct*w)-1,Bt=Math.floor(Ct*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M<=an?(Mt=on/y)>(pt=nn/R)?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*f)-1,ft=Math.floor(pt*_)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k>=ln&&M<=an?(Mt=on/y)>(Ft=ln/k)?(ra=Math.floor(Ft*g)-1,pa=Math.floor(Ft*T)-1,At=Math.floor(Ft*f)-1,
ft=Math.floor(Ft*_)-1,Kt=Math.floor(Ft*b)-1,Jt=Math.floor(Ft*h)-1,aa=Math.floor(Ft*E)-1,St=Math.floor(Ft*w)-1,Bt=Math.floor(Ft*S)-1):(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M>=an?(Mt=on/y)>(Ot=an/M)?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M<=an?(Ft=ln/k)>(pt=nn/R)?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,
At=Math.floor(pt*f)-1,ft=Math.floor(pt*_)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):(ra=Math.floor(Ft*g)-1,pa=Math.floor(Ft*T)-1,At=Math.floor(Ft*f)-1,ft=Math.floor(Ft*_)-1,Kt=Math.floor(Ft*b)-1,Jt=Math.floor(Ft*h)-1,aa=Math.floor(Ft*E)-1,St=Math.floor(Ft*w)-1,Bt=Math.floor(Ft*S)-1):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M>=an?(Ft=ln/k)>(Ot=an/M)?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):(ra=Math.floor(Ft*g)-1,pa=Math.floor(Ft*T)-1,At=Math.floor(Ft*f)-1,ft=Math.floor(Ft*_)-1,Kt=Math.floor(Ft*b)-1,Jt=Math.floor(Ft*h)-1,aa=Math.floor(Ft*E)-1,St=Math.floor(Ft*w)-1,Bt=Math.floor(Ft*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k<=ln&&M>=an?(Ot=an/M)>(pt=nn/R)?(ra=Math.floor(pt*g)-1,
pa=Math.floor(pt*T)-1,At=Math.floor(pt*f)-1,ft=Math.floor(pt*_)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k>=ln&&M<=an?(pt=nn/R,(Mt=on/y)>(Ft=ln/k)&&pt>Ft?(ra=Math.floor(Ft*g)-1,pa=Math.floor(Ft*T)-1,At=Math.floor(Ft*f)-1,ft=Math.floor(Ft*_)-1,Kt=Math.floor(Ft*b)-1,Jt=Math.floor(Ft*h)-1,aa=Math.floor(Ft*E)-1,St=Math.floor(Ft*w)-1,Bt=Math.floor(Ft*S)-1):Ft>Mt&&pt>Mt?(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):Ft>pt&&Mt>pt?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*f)-1,
ft=Math.floor(pt*_)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):console.log('Nie znam przyczyny :P')):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k<=ln&&M>=an?(pt=nn/R,(Mt=on/y)>(Ot=an/M)&&pt>Ot?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):Ot>Mt&&pt>Mt?(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):Ot>pt&&Mt>pt?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*f)-1,ft=Math.floor(pt*_)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,
Bt=Math.floor(pt*S)-1):console.log('Nie znam przyczyny :P')):R>=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y<=on&&k>=ln&&M>=an?(pt=nn/R,(Ot=an/M)>(Ft=ln/k)&&pt>Ft?(ra=Math.floor(Ft*g)-1,pa=Math.floor(Ft*T)-1,At=Math.floor(Ft*f)-1,ft=Math.floor(Ft*_)-1,Kt=Math.floor(Ft*b)-1,Jt=Math.floor(Ft*h)-1,aa=Math.floor(Ft*E)-1,St=Math.floor(Ft*w)-1,Bt=Math.floor(Ft*S)-1):Ft>Ot&&pt>Ot?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):Ft>pt&&Ot>pt?(ra=Math.floor(pt*g)-1,pa=Math.floor(pt*T)-1,At=Math.floor(pt*f)-1,ft=Math.floor(pt*_)-1,Kt=Math.floor(pt*b)-1,Jt=Math.floor(pt*h)-1,aa=Math.floor(pt*E)-1,St=Math.floor(pt*w)-1,Bt=Math.floor(pt*S)-1):console.log('Nie znam przyczyny :P')):R<=nn&&(e>=A||p>=A||u>=A||t>=A||a>=A||n>=A||i>=A||r>=A||d>=A)&&y>=on&&k>=ln&&M>=an&&(Ot=an/M,(Mt=on/y)>(Ft=ln/k)&&Ot>Ft?(ra=Math.floor(Ft*g)-1,
pa=Math.floor(Ft*T)-1,At=Math.floor(Ft*f)-1,ft=Math.floor(Ft*_)-1,Kt=Math.floor(Ft*b)-1,Jt=Math.floor(Ft*h)-1,aa=Math.floor(Ft*E)-1,St=Math.floor(Ft*w)-1,Bt=Math.floor(Ft*S)-1):Ft>Mt&&Ot>Mt?(ra=Math.floor(Mt*g)-1,pa=Math.floor(Mt*T)-1,At=Math.floor(Mt*f)-1,ft=Math.floor(Mt*_)-1,Kt=Math.floor(Mt*b)-1,Jt=Math.floor(Mt*h)-1,aa=Math.floor(Mt*E)-1,St=Math.floor(Mt*w)-1,Bt=Math.floor(Mt*S)-1):Ft>Ot&&Mt>Ot?(ra=Math.floor(Ot*g)-1,pa=Math.floor(Ot*T)-1,At=Math.floor(Ot*f)-1,ft=Math.floor(Ot*_)-1,Kt=Math.floor(Ot*b)-1,Jt=Math.floor(Ot*h)-1,aa=Math.floor(Ot*E)-1,St=Math.floor(Ot*w)-1,Bt=Math.floor(Ot*S)-1):console.log('Nie znam przyczyny :P')),setTimeout((function(){ra>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'spear',amount:ra}),v=[rt='spear',ra],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ra)):console.log('Niezrekrutowano pikinierów - mniej niż wskazane minimum lub zbyt niski poziom koszar')}),6e3),setTimeout((function(){$a>=3&&(pa>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,
unit_type:'sword',amount:pa}),v=[rt='sword',pa],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,pa)):console.log('Niezrekrutowano mieczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),12e3),setTimeout((function(){$a>=5&&(At>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'axe',amount:At}),v=[rt='axe',At],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,At)):console.log('Niezrekrutowano toporników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),18e3),setTimeout((function(){$a>=9&&(ft>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'archer',amount:ft}),v=[rt='archer',ft],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),$(Da,rt,ft)):console.log('Niezrekrutowano łuczników - mniej niż wskazane minimum lub zbyt niski poziom koszar'))}),24e3),setTimeout((function(){$a>=11&&(Kt>=A?(o.emit(l.BARRACKS_RECRUIT,{village_id:Da,unit_type:'light_cavalry',amount:Kt}),v=[rt='light_cavalry',Kt],m.trigger(s.RECRUIT_QUEUE_JOB_STARTED,v),
