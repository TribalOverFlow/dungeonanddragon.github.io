...
m.trigger(s.RECRUIT_QUEUE_CYCLE_END)},ae.getLogs=function(){return h},ae.clearLogs=function(){return h=[],T.set(Z,h),m.trigger(s.RECRUIT_QUEUE_CLEAR_LOGS),h},ae.start=function(){E=!0,m.trigger(s.RECRUIT_QUEUE_START),te(p.RECRUIT_START,'start',''),R=Math.max(1,60*b[r.RECRUIT_QUEUE_INTERVAL]*1e3),S=setInterval((function(){ae.presetRecrutation()}),R)},ae.stop=function(e=n.USER_STOP){w?(e!==n.USER_STOP&&(w=f.gameTime()+ee()),m.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):w=null,E=!1,clearInterval(S),m.trigger(s.RECRUIT_QUEUE_STOP,{reason:e}),m.trigger(s.RECRUIT_QUEUE_CYCLE_END,e),e===n.USER_STOP&&te(p.RECRUIT_STOP,'stop','')},ae.getSettings=function(){return _},ae.isInitialized=function(){return A},ae.isRunning=function(){return E},ae.getNextCycleDate=function(){return w},ae.getCycleInterval=ee,ae})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_JOB_STARTED:'recruit_queue_job_started',RECRUIT_QUEUE_START:'recruit_queue_start',
RECRUIT_QUEUE_STOP:'recruit_queue_stop',RECRUIT_QUEUE_CLEAR_LOGS:'recruit_queue_clear_logs',RECRUIT_QUEUE_CYCLE_BEGIN:'recruit_queue_cycle_begin',RECRUIT_QUEUE_CYCLE_END:'recruit_queue_cycle_end'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/recruitQueue/types/status','two/recruitQueue/types/errors','two/Settings','queues/EventQueue','two/EventScope','helper/time','two/utils'],(function(e,t,n,d,u,p,T,f,_,b,h,A){let E,w,v,S=i.getGroupList(),R=!1,y=null,k={},M={},I={};const N={PRESETS:'presets',OWN:'own',LOGS:'logs'},x=function(e){E.selectedTab=e},O=function(){w.setAll(w.decode(E.settings)),A.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.presetRecrutation())},P=function(){t.isRunning()?t.stop():(t.start(),w.setAll(w.decode(E.settings)),t.ownRecrutation())},U=function(){E.settings[n.GROUP1]=!1,
E.settings[n.GROUP2]=!1,E.settings[n.GROUP3]=!1,E.settings[n.GROUP4]=!1,E.settings[n.FINAL_AMOUNT1]=0,E.settings[n.FINAL_AMOUNT2]=0,E.settings[n.FINAL_AMOUNT3]=0,E.settings[n.FINAL_AMOUNT4]=0,E.settings[n.FINAL_AMOUNT5]=0,E.settings[n.FINAL_AMOUNT6]=0,E.settings[n.FINAL_AMOUNT7]=0,E.settings[n.FINAL_AMOUNT8]=0,E.settings[n.FINAL_AMOUNT9]=0,E.settings[n.START_AMOUNT1]=0,E.settings[n.START_AMOUNT2]=0,E.settings[n.START_AMOUNT3]=0,E.settings[n.START_AMOUNT4]=0,E.settings[n.START_AMOUNT5]=0,E.settings[n.START_AMOUNT6]=0,E.settings[n.START_AMOUNT7]=0,E.settings[n.START_AMOUNT8]=0,E.settings[n.START_AMOUNT9]=0,E.settings[n.FINAL_AMOUNT11]=0,E.settings[n.FINAL_AMOUNT12]=0,E.settings[n.FINAL_AMOUNT13]=0,E.settings[n.FINAL_AMOUNT14]=0,E.settings[n.FINAL_AMOUNT15]=0,E.settings[n.FINAL_AMOUNT16]=0,E.settings[n.FINAL_AMOUNT17]=0,E.settings[n.FINAL_AMOUNT18]=0,E.settings[n.FINAL_AMOUNT19]=0,E.settings[n.START_AMOUNT11]=0,E.settings[n.START_AMOUNT12]=0,E.settings[n.START_AMOUNT13]=0,
E.settings[n.START_AMOUNT14]=0,E.settings[n.START_AMOUNT15]=0,E.settings[n.START_AMOUNT16]=0,E.settings[n.START_AMOUNT17]=0,E.settings[n.START_AMOUNT18]=0,E.settings[n.START_AMOUNT19]=0,E.settings[n.FINAL_AMOUNT21]=0,E.settings[n.FINAL_AMOUNT22]=0,E.settings[n.FINAL_AMOUNT23]=0,E.settings[n.FINAL_AMOUNT24]=0,E.settings[n.FINAL_AMOUNT25]=0,E.settings[n.FINAL_AMOUNT26]=0,E.settings[n.FINAL_AMOUNT27]=0,E.settings[n.FINAL_AMOUNT28]=0,E.settings[n.FINAL_AMOUNT29]=0,E.settings[n.START_AMOUNT21]=0,E.settings[n.START_AMOUNT22]=0,E.settings[n.START_AMOUNT23]=0,E.settings[n.START_AMOUNT24]=0,E.settings[n.START_AMOUNT25]=0,E.settings[n.START_AMOUNT26]=0,E.settings[n.START_AMOUNT27]=0,E.settings[n.START_AMOUNT28]=0,E.settings[n.START_AMOUNT29]=0,E.settings[n.FINAL_AMOUNT31]=0,E.settings[n.FINAL_AMOUNT32]=0,E.settings[n.FINAL_AMOUNT33]=0,E.settings[n.FINAL_AMOUNT34]=0,E.settings[n.FINAL_AMOUNT35]=0,E.settings[n.FINAL_AMOUNT36]=0,E.settings[n.FINAL_AMOUNT37]=0,E.settings[n.FINAL_AMOUNT38]=0,
E.settings[n.FINAL_AMOUNT39]=0,E.settings[n.START_AMOUNT31]=0,E.settings[n.START_AMOUNT32]=0,E.settings[n.START_AMOUNT33]=0,E.settings[n.START_AMOUNT34]=0,E.settings[n.START_AMOUNT35]=0,E.settings[n.START_AMOUNT36]=0,E.settings[n.START_AMOUNT37]=0,E.settings[n.START_AMOUNT38]=0,E.settings[n.START_AMOUNT39]=0,w.setAll(w.decode(E.settings))},C=function(){E.settings[n.GROUP5]=!1,E.settings[n.GROUP6]=!1,E.settings[n.GROUP7]=!1,E.settings[n.GROUP8]=!1,E.settings[n.GROUP9]=!1,E.settings[n.GROUP10]=!1,E.settings[n.GROUP11]=!1,E.settings[n.GROUP12]=!1,E.settings[n.GROUP13]=!1,E.settings[n.GROUP14]=!1,E.settings[n.GROUP15]=!1,E.settings[n.GROUP16]=!1,E.settings[n.GROUP17]=!1,E.settings[n.GROUP18]=!1,E.settings[n.GROUP19]=!1,E.settings[n.GROUP20]=!1,E.settings[n.GROUP21]=!1,E.settings[n.GROUP22]=!1,E.settings[n.GROUP23]=!1,E.settings[n.GROUP24]=!1,E.settings[n.UNIT1]=!1,E.settings[n.UNIT2]=!1,E.settings[n.UNIT3]=!1,E.settings[n.UNIT4]=!1,E.settings[n.UNIT5]=!1,E.settings[n.UNIT6]=!1,
E.settings[n.UNIT7]=!1,E.settings[n.UNIT8]=!1,E.settings[n.UNIT9]=!1,E.settings[n.UNIT10]=!1,E.settings[n.UNIT11]=!1,E.settings[n.UNIT12]=!1,E.settings[n.UNIT13]=!1,E.settings[n.UNIT14]=!1,E.settings[n.UNIT15]=!1,E.settings[n.UNIT16]=!1,E.settings[n.UNIT17]=!1,E.settings[n.UNIT18]=!1,E.settings[n.UNIT19]=!1,E.settings[n.UNIT20]=!1,E.settings[n.AMOUNT1]=1,E.settings[n.AMOUNT2]=1,E.settings[n.AMOUNT3]=1,E.settings[n.AMOUNT4]=1,E.settings[n.AMOUNT5]=1,E.settings[n.AMOUNT6]=1,E.settings[n.AMOUNT7]=1,E.settings[n.AMOUNT8]=1,E.settings[n.AMOUNT9]=1,E.settings[n.AMOUNT10]=1,E.settings[n.AMOUNT11]=1,E.settings[n.AMOUNT12]=1,E.settings[n.AMOUNT13]=1,E.settings[n.AMOUNT14]=1,E.settings[n.AMOUNT15]=1,E.settings[n.AMOUNT16]=1,E.settings[n.AMOUNT17]=1,E.settings[n.AMOUNT18]=1,E.settings[n.AMOUNT19]=1,E.settings[n.AMOUNT20]=1,w.setAll(w.decode(E.settings))};k.updateVisibleLogs=function(){const e=E.pagination.logs.offset,t=E.pagination.logs.limit;k.visibleLogs=k.logs.slice(e,e+t),
E.pagination.logs.count=k.logs.length,k.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,I[e]='ŁADOWANIE...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},k.clearLogs=function(){t.clearLogs()};const z={updateGroups:function(){E.groups=f.encodeList(S.getGroups(),{disabled:!1,type:'groups'})},updateLogs:function(){E.logs=t.getLogs(),k.updateVisibleLogs(),E.logs.length||A.notif('success',g('i18n')('reseted_logs',a.loc.ale,'recruit_queue'))},clearLogs:function(){A.notif('success',g('i18n')('logs.cleared',a.loc.ale,'recruit_queue')),z.updateLogs()},start:function(){E.running=!0},stop:function(e,t){switch(E.running=!1,E.showCycleTimer=!1,clearInterval(y),t.reason){case T.USER_STOP:
A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))}},onCycleBegin:function(){E.showCycleTimer=!1,clearInterval(y)},onCycleEnd:function(e,a){a!==p.USER_STOP&&(E.showCycleTimer=!0,E.nextCycleCountdown=t.getCycleInterval(),y=setInterval((function(){E.nextCycleCountdown-=1e3}),1e3))}},D=function(){E=a.$new(),E.SETTINGS=n,E.TAB_TYPES=N,E.running=R,E.selectedTab=N.PRESETS,E.settingsMap=d,E.pagination={},E.clearP=U,E.clearO=C,E.units=f.encodeList(u,{textObject:'recruit_queue',disabled:!0}),w.injectScope(E),z.updateGroups(),function(){let e=t.getNextCycleDate(),a=e-h.gameTime();e&&(E.showCycleTimer=!0,E.nextCycleCountdown=a,y=setInterval((function(){E.nextCycleCountdown-=1e3,a<0&&(clearInterval(y),E.nextCycleCountdown='Cykl zakończony')}),1e3))}(),E.selectTab=x,E.saveSettings=O,E.switchRecruiterO=P,E.switchRecruiterP=L,E.logsView=k,E.logsView.logs=t.getLogs(),E.villagesInfo=M,E.villagesLabel=I,E.openVillageInfo=r.openVillageInfo,E.pagination.logs={count:k.logs.length,
...
_.register(s.RECRUIT_QUEUE_STOP,(function(){R=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),A.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))})),
