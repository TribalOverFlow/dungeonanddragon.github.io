 ...
 */
!function(e,t){const i=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),a=injector.get('modelDataService'),o=injector.get('socketService'),s=injector.get('routeProvider'),l=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),_=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),p=injector.get('reportService'),f=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||f,this.listeners=[];const n=i.$on(l.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,a){a?this.listeners.push(i.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
e.unregister(t,n)})))},t.prototype.destroy=function(){this.listeners.forEach(e=>{e()}),this.onDestroy()},t})),define('two/utils',['helper/time','helper/math'],(function(e,t){let n={randomSeconds:function(e){if(!e)return 0;const t=(e=parseInt(e,10))+e/2,i=e-e/2;return Math.round(Math.random()*(t-i)+i)},time2seconds:function(e){return(e=e.split(':'))[0]=60*parseInt(e[0],10)*60,e[1]=60*parseInt(e[1],10),e[2]=parseInt(e[2],10),e.reduce((function(e,t){return e+t}))},notif:function(e,t){i.$broadcast(l.NOTIFICATION_DISABLE),i.$broadcast(l.NOTIFICATION_ENABLE);const n='success'===e?l.MESSAGE_SUCCESS:l.MESSAGE_ERROR;i.$broadcast(n,{message:t})},genVillageLabel:function(e){return e.name+' ('+e.x+'|'+e.y+')'},isValidCoords:function(e){return/\s*\d{2,3}\|\d{2,3}\s*/.test(e)},isValidDateTime:function(e){return/^\s*([01][0-9]|2[0-3]):[0-5]\d:[0-5]\d(:\d{1,3})? (0[1-9]|[12][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/\d{4}\s*$/.test(e)},fixDate:function(e){const t=e.trim().split(' '),i=t[0],n=t[1].split('/')
;return i+' '+n[1]+'/'+n[0]+'/'+n[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const i=n.fixDate(e).split(' '),a=i[0].split(':'),o=i[1].split('/'),s=a[0],l=a[1],r=a[2],c=a[3]||null,d=parseInt(o[0],10)-1,u=o[1],g=o[2];return new Date(g,d,u,s,l,r,c).getTime()+(t||0)},formatDate:function(e,t){return _('readableDateFilter')(e,null,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+i.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(i,n){if(!e)return n();let a=new XMLHttpRequest;a.open('GET',e,!0),a.responseType=t,a.addEventListener('load',(function(){i(a)}),!1),a.send()}))},obj2selectOptions:function(e,t){let i=[];for(let n in e){let a={name:e[n].name,value:e[n].id};t&&(a.leftIcon=e[n].icon),i.push(a)}return i},getTravelTime:function(e,i,n,o,s,l){
const r=!i.character_id,c=i.character_id&&i.tribe_id&&i.tribe_id===a.getSelectedCharacter().getTribeId();!1!==l&&('attack'===o?('supporter'in s&&delete s.supporter,r&&(l=!0)):'support'===o&&(c&&(l=!0),'supporter'in s&&(l=!0)));const u={units:n,officers:angular.copy(s)},g=d.calculateTravelTime(u,{barbarian:r,ownTribe:c,officers:s,effects:l},o),_=t.actualDistance(e,i);return 1e3*d.getTravelTimeForDistance(u,g,_,o)},each:function(e,t){if('function'!=typeof t&&(t=f),Array.isArray(e)){for(let i=0,n=e.length;i<n;i++)if(!1===t(e[i],i))return!1}else if(angular.isObject(e))for(let i in e)if(E.call(e,i)&&!1===t(e[i],i))return!1;return!0}};return n})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let r={};const c=function(d,u){'string'==typeof(u=u||['map'])&&(u=[u]);const g=function(e){(u=u.filter((function(t){return t!==e}))).length||d()},_={map:function(){if(n.getSharedData('MapController').isInitialized)return g('map');i.$on(l.MAP_INITIALIZED,(function(){g('map')}))},
tribe_relations:function(){const e=a.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return g('tribe_relations')}const t=i.$on(l.TRIBE_RELATION_LIST,(function(){t(),g('tribe_relations')}))},initial_village:function(){if(a.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return g('initial_village');i.$on(l.GAME_STATE_INITIAL_VILLAGE_READY,(function(){g('initial_village')}))},all_villages_ready:function(){if(a.getGameState().getGameState(e.ALL_VILLAGES_READY))return g('all_villages_ready');i.$on(l.GAME_STATE_ALL_VILLAGES_READY,(function(){g('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return g('minimap_data');t.load((function(){g('minimap_data')}))},presets:function(){if(a.getPresetList().isLoaded())return g('presets');r.presets=r.presets||new Promise((function(e){o.emit(s.GET_PRESETS,{},e)})),r.presets.then((function(){g('presets')}))},world_config:function(){if(a.getWorldConfig&&a.getWorldConfig())return g('world_config')
;setTimeout(_.world_config,100)}};if(!n.getSharedData('MapController'))return setTimeout((function(){c(d,u)}),100);u.forEach((function(e){_[e]()}))};return c})),require(['two/ready','Lockr'],(function(e,t){e((function(){let e=a.getSelectedCharacter();t.prefix=e.getId()+'_twOverflow_'+e.getWorldId()+'-'}))})),define('two/language',['helper/i18n'],(function(e){let t=!1;const n={en_us:{about:{contact:"Kontakt",email:"",links:"Linki projektów",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia"},attack_view:{filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",commands_copy_arrival_tooltip:"Kopiuj czas dotarcia.",commands_copy_backtime_tooltip:"Kopiuj czas powrotu do wioski źródłowej.",commands_set_remove_tooltip:"Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazów.",
command_type_tooltip:"Rodzaj",slowest_unit_tooltip:"Najwolniejsza jednostka",command_type:"Rodzaj",slowest_unit:"Co?",actions:"Dostępne akcje",no_incoming:"Brak nadchodzących wojsk.",copy:"",current_only_tooltip:"Tylko aktywna wioska"},auto_collector:{description:"Automatyczny kolekcjoner depozytu/drugiej wioski.",activated:"Kolekcjoner aktywowany",deactivated:"Kolekcjoner deaktywowany"},builder_queue:{started:"BuilderQueue Uruchomiony",stopped:"BuilderQueue Zatrzymany",settings:"Ustawienia",settings_village_groups:"Buduj w wioskach z grupy",settings_building_sequence:"Szablon kolejki budowy",settings_building_sequence_final:"Finalne poziomy budynków",settings_priorize_farm:"Priorytet farmy, jeżeli brakuje prowiantu",settings_saved:"Ustawienia zapisane!",logs_no_builds:"Nie rozpoczęto żadnej rozbudowy",logs_clear:"Wyczyść logi",sequences:"Szablony",sequences_move_up:"Przesuń w górę",sequences_move_down:"Przesuń w dół",sequences_add_building:"Dodaj budynek",
sequences_select_edit:"Wybierz szablon do edytowania",sequences_edit_sequence:"Edytuj szablon",select_group:"Wybierz grupę",add_building_success:"%d dodany na pozycji %d",add_building_limit_exceeded:"%d osiągnął/eła maksymalny poziom (%d)",position:"Pozycja",remove_building:"Usuń budynek z listy",clone:"Klonuj",remove_sequence:"",name_sequence_min_lenght:"",sequence_created:"Nowy szablon %d utworzony.",sequence_updated:"Szablon %d zaktualizowany.",sequence_removed:"Szablon %d usunięty.",error_sequence_exists:"Ten szablon już istnieje.",error_sequence_no_exists:"Ta sekwencja nie istnieje.",error_sequence_invalid:"Niektóre z wartości szablonu są niepoprawne.",logs_cleared:"Logi wyczyszczone.",create_sequence:"Utwórz szablon",settings_preserve_resources:"Zarezerwowane surowce wioski",settings_preserve_wood:"",settings_preserve_clay:"",settings_preserve_iron:"",discard_changes_title:"",discard_changes_text:"",clone_warn_changed_sequence_title:"",clone_warn_changed_sequence_text:"",
clone_sequence:"",amount:"",empty_sequence:""},builder_queue_add_building_modal:{title:"Dodaj nowy budynek"},builder_queue_name_sequence_modal:{title:"Nazwa szablonu"},builder_queue_remove_sequence_modal:{title:"Usuń szablon",text:"Jesteś pewny, że chcesz usunąć ten szablon? Jeśli ten szablon jest teraz aktywny, inny szablon zostanie wybrany i BuilderQueue zatrzyma się."},command_queue:{title:"",attack:"Atak",support:"Wsparcie",relocate:"przenieś",sent:"wysłany/e",activated:"włączony",deactivated:"wyłączony",expired:"przedawniony/e",removed:"usunięty/e",added:"dodany/e",general_clear:"",general_next_command:"Następny rozkaz",add_basics:"Podstawowe informacje",add_origin:"Źródło",add_selected:"Aktywna wioska",add_target:"Cel",add_map_selected:"Wybrana wioska na mapie",date_type_arrive:"",date_type_out:"",add_current_date:"Obecny czas",add_current_date_plus:"Zwiększ czas o 100 milisekund.",add_current_date_minus:"Zmniejsz czas o 100 milisekund.",add_travel_times:"Czas podróży jednostek",
add_date:"Czas/Data",add_no_village:"Wybierz wioskę...",add_village_search:"Znajdź wioskę...",add_clear:"wyczyść",add_insert_preset:"Wybierz szablon",queue_waiting:"Rozkazy",queue_none_added:"Brak dodanych rozkazów.",queue_sent:"Rozkazy wysłane",queue_none_sent:"Brak wysłanych rozkazów.",queue_expired:"Przedawnione rozkazy",queue_none_expired:"Brak przedawnionych rozkazów.",queue_remove:"Usuń rozkaz z listy",queue_filters:"Filtruj rozkazy",filters_selected_village:"Pokaż tylko rozkazy z aktywnej wioski",filters_barbarian_target:"Pokaż tylko rozkazy na wioski barbarzyńskie",filters_attack:"Pokaż ataki",filters_support:"Pokaż wsparcia",filters_relocate:"Pokaż przeniesienia",filters_text_match:"Filtruj za pomocą tekstu...",command_out:"Czas wyjścia",command_time_left:"Pozostały czas",command_arrive:"Czas dotarcia",error_no_units_enough:"",error_not_own_village:"Wioska źródłowa nie należy do ciebie!",error_origin:"Nieprawidłowa wioska źródłowa!",error_target:"Nieprawidłowa wioska cel!",
error_no_units:"Nie wybrano jednostek!",error_invalid_date:"Nieprawidłowy Czas",error_already_sent_attack:"",error_already_sent_support:"",error_already_sent_relocate:"",error_relocate_disabled:"",error_no_map_selected_village:"Nie zaznaczono wioski na mapie.",error_remove_error:"Błąd usuwania rozkazu.",tab_add:"Dodaj rozkaz",tab_waiting:"Oczekujące",tab_logs:"Logi"},farm_overflow:{open_report:"Otwórz raport",no_report:"Nie ma raportu",reports:"Raporty",date:"Data",status_time_limit:"Cel jest zbyt daleko",status_command_limit:"Limit poleceń",status_full_storage:"Magazyn jest pełen",status_no_units:"Brak dostępnych jednostek",status_abandoned_conquered:"Porzucone podbicie",status_protected_village:"Cel jest chroniony",status_busy_target:"Cel jest atakowany",status_no_targets:"Brak dostępnych celów",status_target_cycle_end:"Cykl celów zakończony",status_not_allowed_points:"Punkty celu niedozwolone",status_unknown:"Nieznany status",status_attacking:"Attakuje",
status_waiting_cycle:"Cykl czekania",status_user_stop:"",status_expired_step:"",not_loaded:"Nie załadowany.",ignored_targets:"Ignorowane cele",no_ignored_targets:"Brak ignorowanych",included_targets:"Zawarte cele",no_included_targets:"Brak zawartych",farmer_villages:"Wioski farmy",no_farmer_villages:"Brak wiosek farm",last_status:"Ostatni status",attacking:"Atakuje.",paused:"Zatrzymany.",command_limit:"Limit 50 ataków osiągnięty, oczekiwanie na powrót wojsk.",last_attack:"Ostatni atak",village_switch:"Przejście do wioski",no_preset:"Brak dostępnych szablonów.",no_selected_village:"Brak dostępnych wiosek.",no_units:"Brak dostępnych jednostek w wiosce, oczekiwanie na powrót wojsk.",no_units_no_commands:"Brak jednostek w wioskach lub powracających wojsk.",no_villages:"Brak dostępnych wiosek, oczekiwanie na powrót wojsk.",preset_first:"Wybierz najpierw szablon!",selected_village:"Wybrana wioska",loading_targets:"Ładowanie celów...",checking_targets:"Sprawdzanie celów...",
restarting_commands:"Restartowanie poleceń...",ignored_village:"dodany do listy pominiętych",included_village:"dodany do listy zawartych",ignored_village_removed:"usunięty z listy ignorowanych",included_village_removed:"usunięty z listy zawartych",priority_target:"dodany do priorytetowych.",analyse_targets:"Analizowanie celów.",step_cycle_restart:"Restartowanie cyklu poleceń...",step_cycle_end:"Lista wiosek zakończona, oczekiwanie na następny cykl.",step_cycle_end_no_villages:"Brak wiosek do rozpoczęcia cyklu.",step_cycle_next:"Lista wiosek się skończyła, następny cykl: %d.",step_cycle_next_no_villages:"Brak wioski do rozpoczęcia cyklu, następny cykl: %d.",full_storage:"Magazyn w wiosce jest pełny",farm_stopped:"FarmOverflow zatrzymany.",farm_started:"Farmer uruchomiony",groups_presets:"Grupy i szablony",presets:"Szablony",group_ignored:"Pomijaj wioski z grupy",group_include:"Dodaj wioski z grupy",group_only:"Atakuj tylko wioski z grup",attack_interval:"Przerwa między atakami",
preserve_command_slots:"Rezerwuj sloty poleceń",target_single_attack:"Zezwól celom na jeden atak per wioska",target_multiple_farmers:"Zezwól celom otrzymywać ataki z kilku wiosek",farmer_cycle_interval:"Przerwa pomiędzy cyklami farmienia (minut)",ignore_on_loss:"Pomijaj cele jeśli straty",ignore_full_storage:"Pomijaj wioski jeśli magazyn pełny",step_cycle_header:"Cykl Farmienia",step_cycle:"Włącz Cykl farmienia",step_cycle_notifs:"Powiadomienia",target_filters:"Filtry celów",min_distance:"Minimalna odległość",max_distance:"Maksymalna odległość",min_points:"Minimalna liczba punktów",max_points:"Maksymalna liczba punktów",max_travel_time:"Maksymalny czas podróży (minuty)",logs_limit:"Maksymalna ilość wpisów logów",event_attack:"Logi ataków",event_village_change:"Logi zmiany wiosek",event_priority_add:"Logi celów priorytetowych",event_ignored_village:"Logi pominiętych wiosek",settings_saved:"Ustawienia zapisane!",misc:"Różne",attack:"atakuje",no_logs:"Brak zarejestrowanych logów",
clear_logs:"Wyczyść logi",reseted_logs:"Zarejestrowane logi zostały wyczyszczone.",date_added:"Data dodania",multiple_attacks_interval:"",next_cycle_in:"",target_limit_per_village:""},minimap:{minimap:"",highlights:"Podświetlenie",add:"Dodaj podświetlenie",remove:"Usuń podświetlenie",very_small:"",small:"",big:"",very_big:"",placeholder_search:"Szukaj gracz/plemię",highlight_add_success:"Podświetlenie dodane",highlight_add_error:"Najpierw sprecyzuj podświetlenie",highlight_update_success:"Podświetlenie zaktualizowane",highlight_remove_success:"Podświetlenie usunięte",highlight_villages:"Wioski",highlight_players:"Gracze",highlight_tribes:"Plemiona",highlight_add_error_exists:"Podświetlenie już istnieje!",highlight_add_error_no_entry:"Najpierw wybierz gracza/plemię!",highlight_add_error_invalid_color:"Nieprawidłowy kolor!",village:"Wioska",player:"Gracz",tribe:"Plemię",color:"Kolor (Hex)",tooltip_pick_color:"Wybierz kolor",misc:"Pozostałe ustawienia",colors_misc:"Różne kolory",
colors_diplomacy:"Dyplomacja - kolory",settings_saved:"Ustawienia zapisane!",settings_map_size:"",settings_right_click_action:"PPM aby wykonać działanie na wiosce",highlight_village:"Podświetl wioskę",highlight_player:"Podświetl gracza",highlight_tribe:"Podświetl plemie",settings_show_floating_minimap:"Pokaż ruchomą mapę",settings_show_view_reference:"",settings_show_continent_demarcations:"",settings_show_province_demarcations:"",settings_show_barbarians:"Pokaż wioski barbarzyńskie",settings_show_ghost_villages:"Pokaż niezaładowane wioski",settings_show_only_custom_highlights:"Pokaż tylko własne podświetlenia",settings_highlight_own:"Podświetl własne wioski",settings_highlight_selected:"Podświetl wybraną wioskę",settings_highlight_diplomacy:"Automatycznie podświetl plemienną dyplomację",settings_colors_background:"Tło minimapy",settings_colors_province:"Granica prowincji",settings_colors_continent:"Granica kontynentu",settings_colors_quick_highlight:"Szybkie podświetlenie",
settings_colors_tribe:"Własne plemie",settings_colors_player:"Własne wioski",settings_colors_selected:"Wybrana wioska",settings_colors_ghost:"Niezaładowana wioska",settings_colors_ally:"Sojusznik",settings_colors_pna:"PON",settings_colors_enemy:"Wróg",settings_colors_other:"Pozostałe wioski graczy",settings_colors_barbarian:"Wioski barbarzyńskie",settings_colors_view_reference:"",settings_reset:"Ustawienia zresetowane",tooltip_village:"Wioska",tooltip_village_points:"Punkty wioski",tooltip_player:"Nazwa gracza",tooltip_player_points:"Punkty gracza",tooltip_tribe:"Plemię",tooltip_tribe_points:"Punkty plemienia",tooltip_province:"Prowincja",no_highlights:"Brak utworzonych podświetleń",reset_confirm_title:"Resetuj ustawienia",reset_confirm_text:"Wszystkie ustawienia zostaną przywrócone do domyślnych.",reset_confirm_highlights_text:"Jak również wszystkie podświetlenia zostaną usunięte.",default_village_colors_info:""},common:{start:"",started:"Uruchomiony",pause:"Pauza",
paused:"Wstrzymany",stop:"Zatrzymany",stopped:"Zatrzymany",status:"",none:"Żaden",info:"Informacje",settings:"Ustawienia",others:"Inne",village:"Wioska",villages:"Wioski",building:"Budynek",buildings:"Budynki",level:"Poziom",registers:"Logi",filters:"Filtry",add:"Dodaj",waiting:"Oczekujące",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",activate:"Aktywuj",deactivate:"Wyłącz",units:"Jednostki",officers:"Oficerowie",origin:"Źródło",target:["Cel","Cele"],save:"Zapisz",logs:"Logi","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas trwania",points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"",new_version:"",check_changes:"",firefox_shill:""}},de_de:{about:{contact:"Kontakt",email:"",
links:"Projektlinks",source_code:"Quellcode",issues_suggestions:"Probleme/Vorschäge",translations:"Übersetzung"},attack_view:{filter_types:"Typen",filter_show_attacks_tooltip:"Zeige Angriffe",filter_show_supports_tooltip:"Zeige Unterstützungen",filter_show_relocations_tooltip:"Zeige Umsiedlungen",filter_incoming_units:"Eintreffende Einheiten",commands_copy_arrival_tooltip:"Kopiere Ankunftsdatum.",commands_copy_backtime_tooltip:"Kopiere Datum der Rückkehr.",commands_set_remove_tooltip:"Erzeuge eine Befehlskette, um alle Truppen vor dem Angriff zu versenden.",command_type_tooltip:"Befehlstyp",slowest_unit_tooltip:"Langsamste Einheit",command_type:"AT",slowest_unit:"LE",actions:"Aktionen",no_incoming:"Keine eingehenden Befehle.",copy:"Kopiere",current_only_tooltip:"Nur aktuelles Dorf"},auto_collector:{description:"Automatischer Ressourcensammler / Ausbau des zweiten Dorfs.",activated:"Automatischer Resourcensammler aktiviert",deactivated:"Automatischer Resourcensammler deaktiviert"},
builder_queue:{started:"Automatischer Dorfausbau gestartet",stopped:"Automatischer Dorfausbau angehalten",settings:"Einstellungen",settings_village_groups:"Ausbau von Dörfern mit den Gruppen",settings_building_sequence:"Reihenfolge",settings_building_sequence_final:"Finale Gebäudestufen",settings_priorize_farm:"Bevorzuge volle Farmen",settings_saved:"Einstellungen gespeichert!",logs_no_builds:"Kein Ausbau gestartet",logs_clear:"Protokoll löschen",sequences:"Sequenzen",sequences_move_up:"Bewege nach oben",sequences_move_down:"Bewege nach unten",sequences_add_building:"Gebäudestufe hinzufügen",sequences_select_edit:"Sequenz zum Ändern wählen",sequences_edit_sequence:"Sequenz ändern",select_group:"Gruppe wählen",add_building_success:"%d wurde auf Platz %d hinzugefügt",add_building_limit_exceeded:"%d hat die Höchststufe erreicht (%d)",position:"Platz",remove_building:"Entferne Gebäudestufe aus der Sequenz",clone:"Kopieren",remove_sequence:"",
name_sequence_min_lenght:"Name muss mindestens aus 3 Zeichen bestehen.",sequence_created:"Neue Sequenz %d erstellt.",sequence_updated:"Sequenz %d aktualisiert.",sequence_removed:"Sequenz %d entfernt.",error_sequence_exists:"Diese Sequenz existiert bereits.",error_sequence_no_exists:"Diese Sequenz existiert nicht.",error_sequence_invalid:"Manche Werte dieser Sequenz sind ungültig.",logs_cleared:"Protokoll gelöscht.",create_sequence:"Sequenz erstellen",settings_preserve_resources:"Dorf-Ressourcen aufbewahren",settings_preserve_wood:"",settings_preserve_clay:"",settings_preserve_iron:"",discard_changes_title:"",discard_changes_text:"",clone_warn_changed_sequence_title:"",clone_warn_changed_sequence_text:"",clone_sequence:"",amount:"",empty_sequence:""},builder_queue_add_building_modal:{title:"Neue Gebäudestufe hinzufügen"},builder_queue_name_sequence_modal:{title:"Name der Sequenz"},builder_queue_remove_sequence_modal:{title:"Sequenz entfernen",
text:"Möchtest Du diese Sequenz wirklich entfernen? Wenn diese Sequenz aktiv ist, wird eine andere gewählt und die automatische Bauschleifenbefüllung gestoppt."},command_queue:{title:"Befehlsschleife",attack:"angreifen",support:"unterstützen",relocate:"umsiedeln",sent:"gesendet",activated:"aktiviert",deactivated:"deaktiviert",expired:"abgelaufen",removed:"entfernt",added:"hinzugefügt",general_clear:"",general_next_command:"Nächster Befehl",add_basics:"Informationen",add_origin:"Startkoordinaten",add_selected:"Aktives Dorf",add_target:"Zielkoordinaten",add_map_selected:"Ausgewähltes Dorf",date_type_arrive:"",date_type_out:"",add_current_date:"Jetzt",add_current_date_plus:"Zeitpunkt um 100 Millisekunden erhöhen.",add_current_date_minus:"Zeitpunkt um 100 Millisekunden verringern.",add_travel_times:"Laufzeit",add_date:"Zeitpunkt",add_no_village:"Dorf auswählen...",add_village_search:"Dorf suchen...",add_clear:"Felder leeren",add_insert_preset:"Vorlagen einfügen",
queue_waiting:"Ausstehende Befehle",queue_none_added:"Es wurden keine Befehle hinzugefügt.",queue_sent:"Befehle gesendet",queue_none_sent:"Kein Befehl gesendet.",queue_expired:"Abgelaufene Befehle",queue_none_expired:"Keine abgelaufenen Befehle.",queue_remove:"Befehl aus Liste entfernen",queue_filters:"Filtruj rozkazy",filters_selected_village:"Zeige nur Befehle bezüglich des aktuellen Dorfs",filters_barbarian_target:"Zeige nur Befehle mit Barbarendörfer als Ziel",filters_attack:"Zeige Angriffe",filters_support:"Zeige Unterstützungen",filters_relocate:"Zeige Umsiedlungen",filters_text_match:"Filtern nach Text...",command_out:"Ausgehend",command_time_left:"Zeit verbleibend",command_arrive:"Ankunftszeit",error_no_units_enough:"",error_not_own_village:"Du bist nicht im Besitz des Startdorfes!",error_origin:"Startkoordinaten ungültig!",error_target:"Zielkoordinaten ungültig!",error_no_units:"Keine Einheiten ausgewählt!",error_invalid_date:"Ungültiges Datum",error_already_sent_attack:"",
error_already_sent_support:"",error_already_sent_relocate:"",error_relocate_disabled:"",error_no_map_selected_village:"Kein Dorf auf der Karte ausgewählt.",error_remove_error:"Fehler beim Entfernen des Befehls.",tab_add:"Befehl hinzufügen",tab_waiting:"Befehle in Warteschleife",tab_logs:"Befehlsprotokoll"},farm_overflow:{open_report:"Bericht öffnen",no_report:"Kein Bericht",reports:"Berichte",date:"Datum",status_time_limit:"Ziel ist zu weit weg",status_command_limit:"Befehlslimit",status_full_storage:"Speicher voll",status_no_units:"Keine verfügbaren Einheiten",status_abandoned_conquered:"Keine vefügbaren Einheiten",status_protected_village:"Ziel ist geschützt",status_busy_target:"Ziel wird angegriffen",status_no_targets:"Keine verfügbaren Ziele",status_target_cycle_end:"Zielzyklus beendet",status_not_allowed_points:"Zielpunkt nicht erlaubt",status_unknown:"Unbekannter Status",status_attacking:"Angreifen",status_waiting_cycle:"Wartezyklus",status_user_stop:"",status_expired_step:"",
not_loaded:"Nicht geladen.",ignored_targets:"Ignorierte Ziele",no_ignored_targets:"Nichts ignoriert",included_targets:"Hinzugefügte Ziele",no_included_targets:"Nichts hinzugefügt",farmer_villages:"Farmdörfer",no_farmer_villages:"Keine Farmdörfer",last_status:"Letzter Status",attacking:"Im Angriff.",paused:"Angehalten.",command_limit:"Das Befehlslimit ist erreicht, bitte warte auf die Rückkehr einiger Trupps.",last_attack:"Letzter Angriff",village_switch:"Wechsle zu Dorf",no_preset:"Keine Vorlage verfügbar.",no_selected_village:"Keine Dörfer verfügbar.",no_units:"Keine Einheiten im Dorf, wartet auf die Rückkehr von Trupps.",no_units_no_commands:"Kein Dorf hat Einheiten oder zurückkehrende Befehle.",no_villages:"Keine Dörfer verfügbar, warte auf Rückkehr von Befehlen.",preset_first:"Wähle zuerst eine Vorlage!",selected_village:"Ausgewähltes Dorf",loading_targets:"Ziele werden geladen...",checking_targets:"Ziele werden geprüft...",restarting_commands:"Befehle werden neu gestartet...",
ignored_village:"zur Ignorierliste hinzugefügt",included_village:"zur Eingeschlossenen-Liste hinzugefügt",ignored_village_removed:"aus der Ignorier-Liste entfernt",included_village_removed:"aus der Eingeschlossenen-Liste entfernt",priority_target:"zur Prioritätenliste hinzugefügt.",analyse_targets:"Ziele werden analysiert.",step_cycle_restart:"Befehlszyklus wird neu gestartet..",step_cycle_end:"Dorfliste abgearbeitet, warte auf den nächsten Durchlauf.",step_cycle_end_no_villages:"Keine Dörfer verfügbar um den Durchgang zu starten.",step_cycle_next:"Dorfliste abgearbeitet, nächster Durchgang: %d.",step_cycle_next_no_villages:"Kein Dorf verfügbar um den Durchgang zu starten, nächster Durchgang: %d.",full_storage:"Der Speicher des Dorfes ist voll.",farm_stopped:"FarmOverflow angehalten.",farm_started:"FarmOverflow gestartet.",groups_presets:"Gruppen & Vorlagen",presets:"Vorlagen zum Angriff",group_ignored:"Ignoriere Dorfgruppe",group_include:"Dorfgruppe umfassen",
group_only:"Greife nur aus Dörfern dieser Gruppen an",attack_interval:"Angriffsintervall",preserve_command_slots:"Befehlsslot aufbewahren",target_single_attack:"Erlaube nur einen Dorf-Angriff pro Ziel",target_multiple_farmers:"Erlaube Angriffe aus mehreren Dörfern pro Ziel",farmer_cycle_interval:"Intervall zwischen Farmzyklen (in Min.)",ignore_on_loss:"Ignoriere Dörfer, die Truppenverluste verursachen",ignore_full_storage:"Dörfer mit vollen Speichern überspringen",step_cycle_header:"Farmzyklus",step_cycle:"Farmzyklus aktivieren",step_cycle_notifs:"Benachrichtigungen",target_filters:"Zielfilter",min_distance:"Minimale Distanz des Zieldorfes",max_distance:"Maximale Distanz des Zieldorfes",min_points:"Minimale Punktzahl des Zielsdorfes",max_points:"Minimale Punktzahl des Zieldorfes",max_travel_time:"Maximale Laufzeit zum Zieldorf (Minuten)",logs_limit:"Max. Anzahl an Protokoll-Einträgen",event_attack:"Angriffe protokollieren",event_village_change:"Dorfwechsel protokollieren",
event_priority_add:"Priorisierte Ziele protokollieren",event_ignored_village:"Ignorierte Dörfer protokollieren",settings_saved:"Einstellungen gespeichert!",misc:"Weitere Einstellungen",attack:"angreifen",no_logs:"Keine Angriffe protokolliert",clear_logs:"Protokoll löschen",reseted_logs:"Protokoll wurde zurückgesetzt.",date_added:"Datum hinzugefügt",multiple_attacks_interval:"",next_cycle_in:"",target_limit_per_village:""},minimap:{minimap:"",highlights:"Farboptionen",add:"Farboption erstellen",remove:"Farboption entfernen",very_small:"",small:"",big:"",very_big:"",placeholder_search:"Suche Spieler/Stamm",highlight_add_success:"Farboption hinzugefügt",highlight_add_error:"Wähle zuerst eine Farboption",highlight_update_success:"Farboptionen aktualisiert",highlight_remove_success:"Farboption entfernt",highlight_villages:"Dörfer",highlight_players:"Spieler",highlight_tribes:"Stämme",highlight_add_error_exists:"Farboption existiert bereits!",
highlight_add_error_no_entry:"Wähle zuerst einen Spieler/Stamm aus!",highlight_add_error_invalid_color:"Ungültige Farbe!",village:"Dorf",player:"Spieler",tribe:"Stamm",color:"Wert (Hex)",tooltip_pick_color:"Eine Farbe auswählen",misc:"Weitere Einstellungen",colors_misc:"Sonstige Farben",colors_diplomacy:"Preset Farbenoptionen der Stammesdiplomatie",settings_saved:"Einstellungen gespeichert!",settings_map_size:"",settings_right_click_action:"Rechtsklickoption des Dorfes",highlight_village:"Dorf hervorheben",highlight_player:"Spieler hervorheben",highlight_tribe:"Stamm hervorheben",settings_show_floating_minimap:"Zeige Minimap",settings_show_view_reference:"",settings_show_continent_demarcations:"",settings_show_province_demarcations:"",settings_show_barbarians:"Zeige Barbarendörfer",settings_show_ghost_villages:"Nicht geladene Dörfer anzeigen",settings_show_only_custom_highlights:"Nur benutzerdefinierte Farboptionen anzeigen",
settings_highlight_own:"Eigene Dörfer automatisch hervorheben",settings_highlight_selected:"Ausgewähltes Dorf automatisch hervorheben",settings_highlight_diplomacy:"Stammesdiplomatie automatisch hervorheben",settings_colors_background:"Hintergrund der Karte",settings_colors_province:"Provinzgrenze",settings_colors_continent:"Königreichsgrenze",settings_colors_quick_highlight:"Schnelles Hervorheben",settings_colors_tribe:"Eigener Stamm",settings_colors_player:"Eigene Dörfer",settings_colors_selected:"Ausgewähltes Dorf",settings_colors_ghost:"Nicht geladene Dörfer",settings_colors_ally:"Bündnis",settings_colors_pna:"NAP",settings_colors_enemy:"Feind",settings_colors_other:"Sonstige",settings_colors_barbarian:"Barbaren",settings_colors_view_reference:"",settings_reset:"Einstellungen wurden zurückgesetzt",tooltip_village:"Dorf",tooltip_village_points:"Punkte des Dorfes",tooltip_player:"Spielername",tooltip_player_points:"Spielerpunkte",tooltip_tribe:"Stamm",
tooltip_tribe_points:"Punkte des Stammes",tooltip_province:"Name der Provinz",no_highlights:"Keine Farboptionen erstellt",reset_confirm_title:"Einstellungen zurück setzen",reset_confirm_text:"Alle Einstellungen werden auf Standardeinstellungen zurückgesetzt.",reset_confirm_highlights_text:"Es werden auch alle Farboptionen gelöscht.",default_village_colors_info:""},common:{start:"",started:"Gestartet",pause:"Pauza",paused:"Pausiert",stop:"Anhalten",stopped:"Angehalten",status:"",none:"Keine",info:"Informationen",settings:"Einstellungen",others:"Andere",village:"Dorf",villages:"Dörfer",building:"Gebäude",buildings:"Gebäude",level:"Stufe",registers:"Protokoll",filters:"Filter",add:"Hinzufügen",waiting:"Ausstehend",attack:"Angriff",support:"Unterstützung",relocate:"Umsiedlung",activate:"Aktivieren",deactivate:"Deaktivieren",units:"Einheiten",officers:"Offiziere",origin:"Herkunft",target:["Ziel","Ziele"],save:"Speichern",logs:"Protokoll","no-results":"Keine Ergebnisse...",
selected:"Ausgewählt",now:"Jetzt",costs:"Kosten",duration:"Dauer",points:"Punkte",player:"Spieler",players:"Spieler",next_features:"Kommende Features",misc:"Verschiedenes",colors:"Farben",reset:"Zurücksetzen",here:"hier",disabled:"— Deaktiviert —",cancel:"Abbrechen",actions:"Aktionen",remove:"Entfernen",started_at:"Gestartet um",arrive:"Ankommen",settings_saved:"Einstellungen gespeichert",discard:"",new_version:"",check_changes:"",firefox_shill:""}},pl_pl:{about:{contact:"Kontakt",email:"",links:"Linki projektów",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia"},attack_view:{filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",commands_copy_arrival_tooltip:"Kopiuj czas dotarcia.",commands_copy_backtime_tooltip:"Kopiuj czas powrotu do wioski źródłowej.",
commands_set_remove_tooltip:"Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazów.",command_type_tooltip:"Rodzaj",slowest_unit_tooltip:"Najwolniejsza jednostka",command_type:"Rodzaj",slowest_unit:"Co?",actions:"Dostępne akcje",no_incoming:"Brak nadchodzących wojsk.",copy:"",current_only_tooltip:"Tylko aktywna wioska"},auto_collector:{description:"Automatyczny kolekcjoner depozytu/drugiej wioski.",activated:"Kolekcjoner aktywowany",deactivated:"Kolekcjoner deaktywowany"},builder_queue:{started:"BuilderQueue Uruchomiony",stopped:"BuilderQueue Zatrzymany",settings:"Ustawienia",settings_village_groups:"Buduj w wioskach z grupy",settings_building_sequence:"Szablon kolejki budowy",settings_building_sequence_final:"Finalne poziomy budynków",settings_priorize_farm:"Priorytet farmy, jeżeli brakuje prowiantu",settings_saved:"Ustawienia zapisane!",logs_no_builds:"Nie rozpoczęto żadnej rozbudowy",logs_clear:"Wyczyść logi",sequences:"Szablony",sequences_move_up:"Przesuń w górę",
...
clone_warn_changed_sequence_title:"",clone_warn_changed_sequence_text:"",clone_sequence:"",amount:"",empty_sequence:""},builder_queue_add_building_modal:{title:"Dodaj nowy budynek"},builder_queue_name_sequence_modal:{title:"Nazwa szablonu"},builder_queue_remove_sequence_modal:{title:"Usuń szablon",text:"Jesteś pewny, że chcesz usunąć ten szablon? Jeśli ten szablon jest teraz aktywny, inny szablon zostanie wybrany i BuilderQueue zatrzyma się."},command_queue:{title:"",attack:"Atak",support:"Wsparcie",relocate:"przenieś",sent:"wysłany/e",activated:"włączony",deactivated:"wyłączony",expired:"przedawniony/e",removed:"usunięty/e",added:"dodany/e",general_clear:"",general_next_command:"Następny rozkaz",add_basics:"Podstawowe informacje",add_origin:"Źródło",add_selected:"Aktywna wioska",add_target:"Cel",add_map_selected:"Wybrana wioska na mapie",date_type_arrive:"",date_type_out:"",add_current_date:"Obecny czas",add_current_date_plus:"Zwiększ czas o 100 milisekund.",
...
status_target_cycle_end:"Cykl celów zakończony",status_not_allowed_points:"Punkty celu niedozwolone",status_unknown:"Nieznany status",status_attacking:"Attakuje",status_waiting_cycle:"Cykl czekania",status_user_stop:"",status_expired_step:"",not_loaded:"Nie załadowany.",ignored_targets:"Ignorowane cele",no_ignored_targets:"Brak ignorowanych",included_targets:"Zawarte cele",no_included_targets:"Brak zawartych",farmer_villages:"Wioski farmy",no_farmer_villages:"Brak wiosek farm",last_status:"Ostatni status",attacking:"Atakuje.",paused:"Zatrzymany.",command_limit:"Limit 50 ataków osiągnięty, oczekiwanie na powrót wojsk.",last_attack:"Ostatni atak",village_switch:"Przejście do wioski",no_preset:"Brak dostępnych szablonów.",no_selected_village:"Brak dostępnych wiosek.",no_units:"Brak dostępnych jednostek w wiosce, oczekiwanie na powrót wojsk.",no_units_no_commands:"Brak jednostek w wioskach lub powracających wojsk.",no_villages:"Brak dostępnych wiosek, oczekiwanie na powrót wojsk.",
preset_first:"Wybierz najpierw szablon!",selected_village:"Wybrana wioska",loading_targets:"Ładowanie celów...",checking_targets:"Sprawdzanie celów...",restarting_commands:"Restartowanie poleceń...",ignored_village:"dodany do listy pominiętych",included_village:"dodany do listy zawartych",ignored_village_removed:"usunięty z listy ignorowanych",included_village_removed:"usunięty z listy zawartych",priority_target:"dodany do priorytetowych.",analyse_targets:"Analizowanie celów.",step_cycle_restart:"Restartowanie cyklu poleceń...",step_cycle_end:"Lista wiosek zakończona, oczekiwanie na następny cykl.",step_cycle_end_no_villages:"Brak wiosek do rozpoczęcia cyklu.",step_cycle_next:"Lista wiosek się skończyła, następny cykl: %d.",step_cycle_next_no_villages:"Brak wioski do rozpoczęcia cyklu, następny cykl: %d.",full_storage:"Magazyn w wiosce jest pełny",farm_stopped:"FarmOverflow zatrzymany.",farm_started:"Farmer uruchomiony",groups_presets:"Grupy i szablony",presets:"Szablony",
group_ignored:"Pomijaj wioski z grupy",group_include:"Dodaj wioski z grupy",group_only:"Atakuj tylko wioski z grup",attack_interval:"Przerwa między atakami",preserve_command_slots:"Rezerwuj sloty poleceń",target_single_attack:"Zezwól celom na jeden atak per wioska",target_multiple_farmers:"Zezwól celom otrzymywać ataki z kilku wiosek",farmer_cycle_interval:"Przerwa pomiędzy cyklami farmienia (minut)",ignore_on_loss:"Pomijaj cele jeśli straty",ignore_full_storage:"Pomijaj wioski jeśli magazyn pełny",step_cycle_header:"Cykl Farmienia",step_cycle:"Włącz Cykl farmienia",step_cycle_notifs:"Powiadomienia",target_filters:"Filtry celów",min_distance:"Minimalna odległość",max_distance:"Maksymalna odległość",min_points:"Minimalna liczba punktów",max_points:"Maksymalna liczba punktów",max_travel_time:"Maksymalny czas podróży (minuty)",logs_limit:"Maksymalna ilość wpisów logów",event_attack:"Logi ataków",event_village_change:"Logi zmiany wiosek",event_priority_add:"Logi celów priorytetowych",
...
settings_colors_province:"Granica prowincji",settings_colors_continent:"Granica kontynentu",settings_colors_quick_highlight:"Szybkie podświetlenie",settings_colors_tribe:"Własne plemie",settings_colors_player:"Własne wioski",settings_colors_selected:"Wybrana wioska",settings_colors_ghost:"Niezaładowana wioska",settings_colors_ally:"Sojusznik",settings_colors_pna:"PON",settings_colors_enemy:"Wróg",settings_colors_other:"Pozostałe wioski graczy",settings_colors_barbarian:"Wioski barbarzyńskie",settings_colors_view_reference:"",settings_reset:"Ustawienia zresetowane",tooltip_village:"Wioska",tooltip_village_points:"Punkty wioski",tooltip_player:"Nazwa gracza",tooltip_player_points:"Punkty gracza",tooltip_tribe:"Plemię",tooltip_tribe_points:"Punkty plemienia",tooltip_province:"Prowincja",no_highlights:"Brak utworzonych podświetleń",reset_confirm_title:"Resetuj ustawienia",reset_confirm_text:"Wszystkie ustawienia zostaną przywrócone do domyślnych.",
reset_confirm_highlights_text:"Jak również wszystkie podświetlenia zostaną usunięte.",default_village_colors_info:""},common:{start:"",started:"Uruchomiony",pause:"Pauza",paused:"Wstrzymany",stop:"Zatrzymany",stopped:"Zatrzymany",status:"",none:"Żaden",info:"Informacje",settings:"Ustawienia",others:"Inne",village:"Wioska",villages:"Wioski",building:"Budynek",buildings:"Budynki",level:"Poziom",registers:"Logi",filters:"Filtry",add:"Dodaj",waiting:"Oczekujące",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",activate:"Aktywuj",deactivate:"Wyłącz",units:"Jednostki",officers:"Oficerowie",origin:"Źródło",target:["Cel","Cele"],save:"Zapisz",logs:"Logi","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas trwania",points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",
arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"",new_version:"",check_changes:"",firefox_shill:""}},pt_br:{about:{contact:"Contato",email:"E-mail",links:"Links do projeto",source_code:"Código Fonte",issues_suggestions:"Idéias/Sugestões",translations:"Traduções"},attack_view:{filter_types:"Tipos",filter_show_attacks_tooltip:"Mostrar ataques",filter_show_supports_tooltip:"Mostrar apoios",filter_show_relocations_tooltip:"Mostrar transferências",filter_incoming_units:"Unidades Chegando",commands_copy_arrival_tooltip:"Copiar data de chegada.",commands_copy_backtime_tooltip:"Copiar backtime.",commands_set_remove_tooltip:"Criar um comando no CommandQueue para remover todas tropas da aldeia antes do comando bater na aldeia.",command_type_tooltip:"Tipo de Comando",slowest_unit_tooltip:"Unidade mais Lenta",command_type:"TC",slowest_unit:"UL",actions:"Ações",no_incoming:"Nenhum comando chegando.",copy:"Copiar",current_only_tooltip:"Apenas aldeia selecionada"},auto_collector:{
description:"Coletor automático para Depósito de Recursos/Segunda Aldeia.",activated:"Coletor Automático ativado",deactivated:"Coletor Automático desativado"},builder_queue:{started:"BuilderQueue iniciado",stopped:"BuilderQueue parado",settings:"Configurações",settings_village_groups:"Construir apenas em aldeias do grupo",settings_building_sequence:"Sequência de construções",settings_building_sequence_final:"Nível final das construções",settings_priorize_farm:"Priorizar fazenda se estiver lotada",settings_saved:"Configurações salvas!",logs_no_builds:"Nenhuma construção iniciada",logs_clear:"Limpar registros",sequences:"Sequências",sequences_move_up:"Mover acima",sequences_move_down:"Mover abaixo",sequences_add_building:"Adicionar edifício",sequences_select_edit:"Selecione uma sequência para editar",sequences_edit_sequence:"Editar sequência",select_group:"Selecione um grupo",add_building_success:"%d foi adicionado à posição %d",
add_building_limit_exceeded:"%d chegou ao nível máximo (%d)",position:"Posição",remove_building:"Remover edifício da lista",clone:"Clonar",remove_sequence:"Remover sequência selecionada",name_sequence_min_lenght:"O nome da sequência deve ter pelo menos 3 caracteres.",sequence_created:"Nova sequência %d criada.",sequence_updated:"Sequência %d atualizada.",sequence_removed:"Sequência %d removida.",error_sequence_exists:"Esta sequência já existe.",error_sequence_no_exists:"Essa sequência não existe.",error_sequence_invalid:"Algum valor da sequência é inválido.",logs_cleared:"Registro limpo.",create_sequence:"Criar uma sequência",settings_preserve_resources:"Preservar recursos das aldeias",settings_preserve_wood:"Preservar madeira das aldeias",settings_preserve_clay:"Preservar argila das aldeias",settings_preserve_iron:"Preservar ferro das aldeias",discard_changes_title:"Sequência não salva",
discard_changes_text:"A sequência selecionada tem alterações não salvas. Tem certeza que deseja descartar  as alterações?",clone_warn_changed_sequence_title:"Sequência alterada",clone_warn_changed_sequence_text:"A sequência que você está tentando clonar foi alterada. Se aceitar, a versão antiga será clonada.",clone_sequence:"Clonar sequência selecionada",amount:"Quantidade",empty_sequence:"Sequência vazia"},builder_queue_add_building_modal:{title:"Adicionar novo edifício"},builder_queue_name_sequence_modal:{title:"Nomear sequência"},builder_queue_remove_sequence_modal:{title:"Remover sequência",text:"Tem certeza que deseja remover esta sequência? Se esta sequência estiver ativa, outra será selecionada e o BuilderQueue será parado."},command_queue:{title:"CommandQueue",attack:"Ataque",support:"Apoio",relocate:"Transferência",sent:"enviado",activated:"ativado",deactivated:"desativado",expired:"expirado",removed:"removido",added:"adicionado",general_clear:"Limpar registros",
general_next_command:"Próximo comando",add_basics:"Informações básicas",add_origin:"Coordenadas da origem",add_selected:"Aldeia ativa",add_target:"Coordenadas do alvo",add_map_selected:"Aldeia selecionada no mapa",date_type_arrive:"Comando chaga na data",date_type_out:"Comando sai na data",add_current_date:"Data/hora",add_current_date_plus:"Aumentar data em 100 milisegunds.",add_current_date_minus:"Reduzir data em 100 milisegunds.",add_travel_times:"Tempos de viagem",add_date:"Data",add_no_village:"selecione uma aldeia...",add_village_search:"Procurar aldeia...",add_clear:"Limpar campos",add_insert_preset:"Inserir predefinição",queue_waiting:"Comandos em espera",queue_none_added:"Nenhum comando adicionado.",queue_sent:"Comandos enviados",queue_none_sent:"Nenhum comando enviado.",queue_expired:"Comandos expirados",queue_none_expired:"Nenhum comando expirado.",queue_remove:"Remover comando da lista",queue_filters:"Filtro de comandos",
filters_selected_village:"Mostrar apenas comandos com origem da aldeia selecionada",filters_barbarian_target:"Mostrar apenas comandos com aldeias bárbaras como alvo",filters_attack:"Mostrar ataques",filters_support:"Mostrar apoios",filters_relocate:"Mostrar transferências",filters_text_match:"Filtrar por texto...",command_out:"Saída na data",command_time_left:"Tempo restante",command_arrive:"Chegada na data",error_no_units_enough:"Sem unidades o suficiente para enviar o comando!",error_not_own_village:"A aldeia de origem não pertence a você!",error_origin:"Aldeia de origem inválida!",error_target:"Aldeia alvo inválida!",error_no_units:"Nenhuma unidade especificada!",error_invalid_date:"Data inválida",error_already_sent_attack:"Esse ataque já deveria ter saído",error_already_sent_support:"Esse apoio já deveria ter saído",error_already_sent_relocate:"Essa transferência já deveria ter saído",error_relocate_disabled:"Transferência não está ativa nesse mundo.",
error_no_map_selected_village:"Nenhuma aldeia selecionada no mapa.",error_remove_error:"Erro ao remover comando.",tab_add:"Adicionar comando",tab_waiting:"Comandos em espera",tab_logs:"Registro de comandos"},farm_overflow:{open_report:"Abrir relatório",no_report:"Sem relatório",reports:"Relatórios",date:"Data",status_time_limit:"Alvo muito longe",status_command_limit:"Limite de comandos",status_full_storage:"Armazém lotado",status_no_units:"Sem tropas disponíveis",status_abandoned_conquered:"Abandonada conquistada",status_protected_village:"Alvo está protegido",status_busy_target:"Alvo já sob ataque",status_no_targets:"Nenhum alvo disponível",status_target_cycle_end:"Cicle de alvos acabou",status_not_allowed_points:"Pontos do alvo não permitido",status_unknown:"Status desconhecido",status_attacking:"Atacando",status_waiting_cycle:"Aguardando ciclo",status_user_stop:"Parado pelo jogador",status_expired_step:"Comando expirado",not_loaded:"Não carregado",ignored_targets:"Alvos Ignorados",
no_ignored_targets:"Nada ignorado",included_targets:"Alvos incluídos",no_included_targets:"Nada incluído",farmer_villages:"Aldeias Farm",no_farmer_villages:"Nenhuma aldeia farm disponível",last_status:"Último Status",attacking:"Atacando.",paused:"Pausado.",command_limit:"Limite de 50 ataques atingido, aguardando retorno.",last_attack:"Último ataque",village_switch:"Alternando para a aldeia",no_preset:"Nenhuma predefinição disponível.",no_selected_village:"Nenhuma aldeia disponível.",no_units:"Sem unidades na aldeia, aguardando ataques retornarem.",no_units_no_commands:"Nenhuma aldeia tem tropas nem ataques retornando.",no_villages:"Nenhuma aldeia disponível, aguardando ataques retornarem.",preset_first:"Configure uma predefinição primeiro!",selected_village:"Aldeia selecionada",loading_targets:"Carregando alvos...",checking_targets:"Checando alvos...",restarting_commands:"Reiniciando comandos...",ignored_village:"adicionado a lista de ignorados",
included_village:"adicionado à lista de aldeias incluídas",ignored_village_removed:"removida da lista de aldeias ignoradas",included_village_removed:"removida da lista de aldeias incluídas",priority_target:"adicionado as prioridades.",analyse_targets:"Analisando alvos.",step_cycle_restart:"Reiniciando o ciclo de comandos..",step_cycle_end:"A lista de aldeias acabou, esperando próxima execução.",step_cycle_end_no_villages:"Nenhuma aldeia disponível para iniciar o ciclo.",step_cycle_next:"A lista de aldeias acabou, próximo ciclo: %d.",step_cycle_next_no_villages:"Nenhuma aldeia disponível para iniciar o ciclo, próximo ciclo: %d.",full_storage:"O armazém da aldeia está cheio.",farm_stopped:"FarmOverflow parado.",farm_started:"FarmOverflow iniciado.",groups_presets:"Grupos & predefinições",presets:"Atacar com as predefinições",group_ignored:"Ignorar aldeias do grupo",group_include:"Incluir aldeias dos grupos",group_only:"Atacar apenas com aldeias dos grupos",
attack_interval:"Intervalo entre ataques",preserve_command_slots:"Número de comandos a se preservar",target_single_attack:"Permitir que alvos recebam apenas um ataque por aldeia",target_multiple_farmers:"Permitir que alvos recebam ataques de múltiplas aldeias",farmer_cycle_interval:"Intervalo entre ciclos de farm (minutos)",ignore_on_loss:"Ignorar alvos que causarem perdas",ignore_full_storage:"Ignorar aldeias com armazém lotado",step_cycle_header:"Configurações de Ciclos",step_cycle:"Ativar Ciclo",step_cycle_notifs:"Notificações de ciclos",target_filters:"Filtro de Alvos",min_distance:"Distância mínima",max_distance:"Distância máxima",min_points:"Pontuação mínima",max_points:"Pontuação máxima",max_travel_time:"Tempo máximo de viagem (minutos)",logs_limit:"Quantidade máxima de registros",event_attack:"Registrar ataques",event_village_change:"Registrar troca de aldeias",event_priority_add:"Registrar alvos prioritarios",event_ignored_village:"Registrar alvos ignorados",
settings_saved:"Configurações salvas!",misc:"Diversos",attack:"ataca",no_logs:"Nenhum evento registrado",clear_logs:"Limpar eventos",reseted_logs:"Registro de eventos resetado.",date_added:"Adicionado na data",multiple_attacks_interval:"Intervalo entre ataques no mesmo alvo (minutos)",next_cycle_in:"Próximo ciclo começa em",target_limit_per_village:"Limite de alvos por aldeia"},minimap:{minimap:"Minimapa",highlights:"Marcações",add:"Adicionar marcação",remove:"Remover marcação",very_small:"Muito pequeno",small:"Pequeno",big:"Grande",very_big:"Muito grande",placeholder_search:"Procurar jogador/tribo",highlight_add_success:"Marcação adicionada",highlight_add_error:"Especifique uma marcação primeiro",highlight_update_success:"Marcação atualizada",highlight_remove_success:"Marcação removida",highlight_villages:"Aldeias",highlight_players:"Jogadores",highlight_tribes:"Tribos",highlight_add_error_exists:"Marcação já existe!",
highlight_add_error_no_entry:"Selecione uma jogador/tribo primeiro!",highlight_add_error_invalid_color:"Cor inválida!",village:"Aldeia",player:"Jogador",tribe:"Tribo",color:"Cor (Hex)",tooltip_pick_color:"Selecione uma cor",misc:"Configurações diversas",colors_misc:"Cores diversas",colors_diplomacy:"Cores da diplomacia",settings_saved:"Configurações salvas!",settings_map_size:"Tamanho do mapa",settings_right_click_action:"Ação de clique direito na aldeia",highlight_village:"Marcar aldeia",highlight_player:"Marcar jogador",highlight_tribe:"Marcar tribo",settings_show_floating_minimap:"Mostrar minimapa flutuante",settings_show_view_reference:"Mostrar referência de localização",settings_show_continent_demarcations:"Mostrar demarcações dos continentes",settings_show_province_demarcations:"Mostrar demarcações das províncias",settings_show_barbarians:"Mostrar aldeias bárbaras",settings_show_ghost_villages:"Mostrar aldeias não carregadas",
settings_show_only_custom_highlights:"Mostrar apenas marcações manuais",settings_highlight_own:"Marcar próprias aldeias",settings_highlight_selected:"Marcar aldeia selecionada",settings_highlight_diplomacy:"Marcação automática baseado na diplomacia",settings_colors_background:"Fundo do minimapa",settings_colors_province:"Demarcação da provincia",settings_colors_continent:"Demarcação do continente",settings_colors_quick_highlight:"Marcação rápida",settings_colors_tribe:"Própria tribo",settings_colors_player:"Aldeias próprias",settings_colors_selected:"Aldeia selecionada",settings_colors_ghost:"Aldeias não carregadas",settings_colors_ally:"Aliados",settings_colors_pna:"PNA",settings_colors_enemy:"Inimigos",settings_colors_other:"Outros",settings_colors_barbarian:"Aldeias Bárbaras",settings_colors_view_reference:"Referência de localização",settings_reset:"Configurações resetadas",tooltip_village:"Aldeia",tooltip_village_points:"Pontos da aldeia",tooltip_player:"Nome do jogador",
tooltip_player_points:"Pontos do jogador",tooltip_tribe:"Tribo",tooltip_tribe_points:"Pontos da tribo",tooltip_province:"Nome da província",no_highlights:"Nenhuma marcação criada",reset_confirm_title:"Resetar configurações",reset_confirm_text:"Todas as configurações serão resetas para as configurações padrões.",reset_confirm_highlights_text:"Todas marcações também serão deletadas",default_village_colors_info:"Cores de aldeias padrões como abandonadas, aliados, própria tribo, etc. São alteradas pelo painel de configurações do próprio jogo."},common:{start:"Iniciar",started:"Iniciado",pause:"Pausar",paused:"Pausado",stop:"Parar",stopped:"Parado",status:"Status",none:"Nenhum",info:"Informações",settings:"Configurações",others:"Outros",village:"Aldeia",villages:"Aldeias",building:"Edifício",buildings:"Edifícios",level:"Nível",registers:"Registros",filters:"Filtros",add:"Adicionar",waiting:"Em espera",attack:"Ataque",support:"Apoio",relocate:"Transferência",activate:"Ativar",
deactivate:"Desativar",units:"Unidades",officers:"Oficiais",origin:"Origem",target:["Alvo","Alvos"],save:"Salvar",logs:"Eventos","no-results":"Sem resultados...",selected:"Selecionado",now:"Agora",costs:"Custos",duration:"Duração",points:"Pontos",player:"Jogador",players:"Jogadores",next_features:"Próximas funcionalidades",misc:"Diversos",colors:"Cores",reset:"Resetar",here:"aqui",disabled:"— Desativado —",cancel:"Cancelar",actions:"Ações",remove:"Remover",started_at:"Iniciado em",arrive:"Chegada",settings_saved:"Configurações salvas",discard:"Descartar",new_version:"TWOverflow atualizado para a versão %d",check_changes:"Clique aqui para ver as alterações",firefox_shill:"Se você quiser que o script funcione de fundo corretamente, use Firefox ao invés de navegadores baseado no Chrome."}},ru_ru:{about:{contact:"Контакты",email:"E-mail",links:"Ссылки проекта",source_code:"Исходный код",issues_suggestions:"Вопросы/предложения",translations:"переводчики"},attack_view:{filter_types:"Типы",
filter_show_attacks_tooltip:"Показать атаки",filter_show_supports_tooltip:"Показать подкрепления",filter_show_relocations_tooltip:"Показать перемещения",filter_incoming_units:"Входящие войска",commands_copy_arrival_tooltip:"Копировать дату прибытия.",commands_copy_backtime_tooltip:"Копировать дату возвращения.",commands_set_remove_tooltip:"Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazów.",command_type_tooltip:"Тип команды",slowest_unit_tooltip:"Самый медленный воин",command_type:"Rodzaj",slowest_unit:"Co?",actions:"Действия",no_incoming:"Нет входящих команд.",copy:"Копировать",current_only_tooltip:"Только текущая деревня"},auto_collector:{description:"Автоматический сбор наград с депозита/второй деревни.",activated:"Автоматический сбор включен",deactivated:"Автоматический сбор выключен"},builder_queue:{started:"Автоматическое строительство активировано",stopped:"Автоматическое строительство деактивировано",settings:"Настройки",
settings_village_groups:"Строить только в деревнях с группой",settings_building_sequence:"Очередь строительства",settings_building_sequence_final:"Максимальный уровень строения",settings_priorize_farm:"Priorytet farmy, jeżeli brakuje prowiantu",settings_saved:"Настройки сохранены!",logs_no_builds:"Nie rozpoczęto żadnej rozbudowy",logs_clear:"Очистить журнал событий",sequences:"Очередь строительства",sequences_move_up:"Поднять выше",sequences_move_down:"Снести",sequences_add_building:"Добавить строительство",sequences_select_edit:"Wybierz szablon do edytowania",sequences_edit_sequence:"Редактировать очередь",select_group:"Выбрать группу",add_building_success:"%d dodany na pozycji %d",add_building_limit_exceeded:"достигнут максимальный уровень",position:"Позиция",remove_building:"Удалить строение из списка",clone:"Клонировать",remove_sequence:"",name_sequence_min_lenght:"",sequence_created:"Nowy szablon %d utworzony.",sequence_updated:"Szablon %d zaktualizowany.",
sequence_removed:"Szablon %d usunięty.",error_sequence_exists:"Ten szablon już istnieje.",error_sequence_no_exists:"Ta sekwencja nie istnieje.",error_sequence_invalid:"Niektóre z wartości szablonu są niepoprawne.",logs_cleared:"Logi wyczyszczone.",create_sequence:"Utwórz szablon",settings_preserve_resources:"Zarezerwowane surowce wioski",settings_preserve_wood:"",settings_preserve_clay:"",settings_preserve_iron:"",discard_changes_title:"",discard_changes_text:"",clone_warn_changed_sequence_title:"",clone_warn_changed_sequence_text:"",clone_sequence:"",amount:"",empty_sequence:""},builder_queue_add_building_modal:{title:"Добавить строительство"},builder_queue_name_sequence_modal:{title:"Nazwa szablonu"},builder_queue_remove_sequence_modal:{title:"Usuń szablon",text:"Jesteś pewny, że chcesz usunąć ten szablon? Jeśli ten szablon jest teraz aktywny, inny szablon zostanie wybrany i BuilderQueue zatrzyma się."},command_queue:{title:"Очередь команд",attack:"атака",support:"поддержка",
relocate:"перемещение",sent:"послать",activated:"активировать",deactivated:"отключено",expired:"истекщий",removed:"удаленный",added:"добавлено",general_clear:"",general_next_command:"Следующая команда",add_basics:"Подробности",add_origin:"Координаты точки отправления",add_selected:"Текущая деревня",add_target:"Координаты точки назначения",add_map_selected:"Выбранная деревня на карте",date_type_arrive:"",date_type_out:"",add_current_date:"Текущая дата",add_current_date_plus:"Увеличить дату на 100 миллисекунд.",add_current_date_minus:"Уменьшить дату на 100 миллисекунд.",add_travel_times:"Время в пути",add_date:"Дата/время",add_no_village:"выбрать деревню...",add_village_search:"Поиск деревни...",add_clear:"Очистить поля",add_insert_preset:"Вставить шаблон",queue_waiting:"Ожидание команд",queue_none_added:"Нет добавленных команд.",queue_sent:"Отправленные команды",queue_none_sent:"Нет отправленных команд.",queue_expired:"Просроченные команды",queue_none_expired:"Нет завершенных команд.",
queue_remove:"Удалить команду из списка",queue_filters:"Фильтр команд",filters_selected_village:"Показать только команды из выбранной деревни",filters_barbarian_target:"Показать только команды с деревнями варваров в качестве цели",filters_attack:"Показать атаки",filters_support:"Показать подкрепления",filters_relocate:"Показать перемещения",filters_text_match:"Фильтр по тексту...",command_out:"Выход",command_time_left:"Времени осталось",command_arrive:"Прибытие",error_no_units_enough:"",error_not_own_village:"Деревня отправления принадлежит не Вам!",error_origin:"Координаты деревни отправления неверны!",error_target:"Координаты деревни назначения неверны!",error_no_units:"Не указаны войска!",error_invalid_date:"Неверная дата",error_already_sent_attack:"",error_already_sent_support:"",error_already_sent_relocate:"",error_relocate_disabled:"",error_no_map_selected_village:"Нет выбранной деревни на карте.",error_remove_error:"Ошибка удаления команды.",tab_add:"Добавить команду",
tab_waiting:"Команды в очереди",tab_logs:"Журнал команд"},farm_overflow:{open_report:"Открыть отчет",no_report:"Нет отчета",reports:"Отчёты",date:"Дата",status_time_limit:"Цель слишком далеко",status_command_limit:"Предел количества команд",status_full_storage:"Склад переполнен",status_no_units:"Нет доступных войск",status_abandoned_conquered:"Победа деревни варваров",status_protected_village:"Цель под защитой",status_busy_target:"Цель под атакой",status_no_targets:"Нет доступных целей",status_target_cycle_end:"Перечень целей закончен",status_not_allowed_points:"Запрещенные цели назначения",status_unknown:"Неизвестный статус",status_attacking:"Атаковано",status_waiting_cycle:"Ожидание",status_user_stop:"",status_expired_step:"",not_loaded:"Не загружено.",ignored_targets:"Игнорируемые цели",no_ignored_targets:"Ничего не игнорировать",included_targets:"Включенные цели",no_included_targets:"Нет включенных",farmer_villages:"Грабеж деревень",no_farmer_villages:"Нет деревень для грабежа",
last_status:"Последний статус",attacking:"Атаковано.",paused:"Приостановлен.",command_limit:"Достигнут лимит в 50 атак, дождитесь возвращения.",last_attack:"Последняя атака",village_switch:"Переход к деревни",no_preset:"Нет доступных шаблонов.",no_selected_village:"Нет доступных деревень.",no_units:"Нет доступных войск в деревни, дождитесь возвращения.",no_units_no_commands:"Ни в одной из деревень нет возвращающихся войск.",no_villages:"Нет доступных деревень, дождитесь возвращения войск.",preset_first:"Установите вначале шаблон!",selected_village:"Выбранная деревня",loading_targets:"Загрузка целей...",checking_targets:"Проверка целей...",restarting_commands:"Перезапуск команд...",ignored_village:"добавить в игнорируемое",included_village:"добавить во включенное",ignored_village_removed:"удалить из игнорируемого",included_village_removed:"удалить из включенного",priority_target:"добавить в приоритетное.",analyse_targets:"Анализ целей.",step_cycle_restart:"Перезапуск цикла команд..",
step_cycle_end:"Перечень деревень окончен, дождитесь следующего круга.",step_cycle_end_no_villages:"Нет доступных деревень для старта цикла.",step_cycle_next:"Перечень деревень закончился, следующий цикл: %d.",step_cycle_next_no_villages:"Нету свободных деревень для начала цыкла, следующий цыкл.",full_storage:"Склад деревни заполнен.",farm_stopped:"Переизбыток Фарма остановлен.",farm_started:"Переизбыток Фарма начат.",groups_presets:"Группы и Шаблоны",presets:"Атака с шаблонами",group_ignored:"Игнорировать деревни из группы",group_include:"Включить деревни из групп",group_only:"Атаковать только с деревнями из групп",attack_interval:"Интервалы между атаками",preserve_command_slots:"Сохранить управление слотами",target_single_attack:"Разрешить целям принимать только одну атаку на деревню",target_multiple_farmers:"Разрешить целям получать множество атак с разных деревень",farmer_cycle_interval:"Интервали между фарм цыклами (минуты)",
ignore_on_loss:"Игнорировать деревни, которые приносят потери",ignore_full_storage:"Не фармить при заполнении склада",step_cycle_header:"Cykl Farmienia",step_cycle:"Włącz Cykl farmienia",step_cycle_notifs:"Цыкл уведомлений",target_filters:"Целевые фильтры",min_distance:"Минимальное расстояние до цели",max_distance:"Максимальное расстояние до цели",min_points:"Минимальные очки цели",max_points:"Максимальные очки цели",max_travel_time:"Максимальное время передвижения (минуты)",logs_limit:"Максимальное колличество записей в журнале событий",event_attack:"Logi ataków",event_village_change:"Logi zmiany wiosek",event_priority_add:"Logi celów priorytetowych",event_ignored_village:"Logi pominiętych wiosek",settings_saved:"Настройки сохранены!",misc:"Разнообразный",attack:"Атака",no_logs:"Нету зарегистрированного журанал событий",clear_logs:"Очистить журнал события",reseted_logs:"Зарегистрованный журнал событий обнулён.",date_added:"Данные добавлены",
multiple_attacks_interval:"Интервал атак на одну и ту же деревню в минутах",next_cycle_in:"",target_limit_per_village:"Лимит исходящих атак деревни"},minimap:{minimap:"Миникарта",highlights:"Podświetlenie",add:"Dodaj podświetlenie",remove:"Usuń podświetlenie",very_small:"",small:"",big:"",very_big:"",placeholder_search:"Szukaj gracz/plemię",highlight_add_success:"Podświetlenie dodane",highlight_add_error:"Najpierw sprecyzuj podświetlenie",highlight_update_success:"Podświetlenie zaktualizowane",highlight_remove_success:"Podświetlenie usunięte",highlight_villages:"Wioski",highlight_players:"Gracze",highlight_tribes:"Plemiona",highlight_add_error_exists:"Podświetlenie już istnieje!",highlight_add_error_no_entry:"Najpierw wybierz gracza/plemię!",highlight_add_error_invalid_color:"Nieprawidłowy kolor!",village:"Wioska",player:"Gracz",tribe:"Plemię",color:"Kolor (Hex)",tooltip_pick_color:"Wybierz kolor",misc:"Pozostałe ustawienia",colors_misc:"Różne kolory",
colors_diplomacy:"Dyplomacja - kolory",settings_saved:"Ustawienia zapisane!",settings_map_size:"",settings_right_click_action:"PPM aby wykonać działanie na wiosce",highlight_village:"Podświetl wioskę",highlight_player:"Podświetl gracza",highlight_tribe:"Podświetl plemie",settings_show_floating_minimap:"Pokaż ruchomą mapę",settings_show_view_reference:"",settings_show_continent_demarcations:"",settings_show_province_demarcations:"",settings_show_barbarians:"Pokaż wioski barbarzyńskie",settings_show_ghost_villages:"Pokaż niezaładowane wioski",settings_show_only_custom_highlights:"Pokaż tylko własne podświetlenia",settings_highlight_own:"Podświetl własne wioski",settings_highlight_selected:"Podświetl wybraną wioskę",settings_highlight_diplomacy:"Automatycznie podświetl plemienną dyplomację",settings_colors_background:"Tło minimapy",settings_colors_province:"Granica prowincji",settings_colors_continent:"Granica kontynentu",settings_colors_quick_highlight:"Szybkie podświetlenie",
settings_colors_tribe:"Własne plemie",settings_colors_player:"Własne wioski",settings_colors_selected:"Wybrana wioska",settings_colors_ghost:"Niezaładowana wioska",settings_colors_ally:"Sojusznik",settings_colors_pna:"PON",settings_colors_enemy:"Wróg",settings_colors_other:"Pozostałe wioski graczy",settings_colors_barbarian:"Wioski barbarzyńskie",settings_colors_view_reference:"",settings_reset:"Ustawienia zresetowane",tooltip_village:"Wioska",tooltip_village_points:"Punkty wioski",tooltip_player:"Nazwa gracza",tooltip_player_points:"Punkty gracza",tooltip_tribe:"Plemię",tooltip_tribe_points:"Punkty plemienia",tooltip_province:"Prowincja",no_highlights:"Brak utworzonych podświetleń",reset_confirm_title:"Resetuj ustawienia",reset_confirm_text:"Wszystkie ustawienia zostaną przywrócone do domyślnych.",reset_confirm_highlights_text:"Jak również wszystkie podświetlenia zostaną usunięte.",default_village_colors_info:""},common:{start:"Начать",started:"Запущен",pause:"Пауза",
paused:"Приостановлен",stop:"Стоп",stopped:"Остановлен",status:"Статус",none:"Отсутсвует",info:"Информация",settings:"Настройки",others:"Прочее",village:"Деревня",villages:"Деревни",building:"Строение",buildings:"Строения",level:"Уровень",registers:"Журнал событий",filters:"Фильтры",add:"Добавить",waiting:"Ожидание",attack:"Атака",support:"Поддержка",relocate:"Перемещение",activate:"Активировать",deactivate:"Отключить",units:"Войска",officers:"Военачальники",origin:"Точка отправления",target:["Точка назначения","Цели"],save:"Сохранить",logs:"Журнал событий","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas trwania",points:"очки\nочков",player:"игрок",players:"игроки",next_features:"Następne funkcje",misc:"Różne",colors:"Цвета",reset:"Сбросить",here:"tutaj",disabled:"— Wyłączony —",cancel:"Отмена",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"",new_version:"",
check_changes:"",firefox_shill:""}}},a='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function s(t){t=E.call(o,t)?o[t]:t,e.setJSON(n[t]||n[a])}let l={init:function(){if(t)return!1;t=!0,s(i.loc.ale),i.$watch('loc.ale',(function(e,t){e!==t&&s(i.loc.ale)}))}};return l})),define('two/Settings',['two/utils','Lockr'],(function(e,t){const n=function(e,t){let i={};for(let n in e)E.call(t,n)?angular.equals(e[n],t[n])||(i[n]=t[n]):i[n]=e[n];return!angular.equals({},i)&&i},o=function(){return{name:_('i18n')('disabled',i.loc.ale,'common'),value:!1}},s=function(e,t){let i={};for(let n in t)(e[n].updates||[]).forEach((function(e){i[e]=!0}));return!angular.equals(i,{})&&i};let l=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let i in e)t[i]=e[i].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,t.get(this.storageKey,{})),this.events={settingsChange:e.onChange||f},this.injected=!1}
;return l.prototype.get=function(e){return angular.copy(this.settings[e])},l.prototype.getAll=function(){return angular.copy(this.settings)},l.prototype.getDefault=function(e){return E.call(this.defaults,e)?this.defaults[e]:void 0},l.prototype.store=function(){t.set(this.storageKey,this.settings)},l.prototype.set=function(e,t,i){if(!E.call(this.settingsMap,e))return!1;const a=this.settingsMap[e];'number'===a.inputType&&(t=parseInt(t,10),E.call(a,'min')&&(t=Math.max(a.min,t)),E.call(a,'max')&&(t=Math.min(a.max,t)));const o=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=n(o,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,i||{}),!0},l.prototype.setAll=function(e,t){const i=angular.copy(this.settings);for(let t in e)if(E.call(this.settingsMap,t)){const i=this.settingsMap[t];let n=e[t];'number'===i.inputType&&(n=parseInt(n,10),E.call(i,'min')&&(n=Math.max(i.min,n)),
E.call(i,'max')&&(n=Math.min(i.max,n))),this.settings[t]=n}const a=angular.copy(this.settings),o=n(i,a);if(!o)return!1;const l=s(this.settingsMap,o);return this.store(),this.updateScope(),this.events.settingsChange.call(this,o,l,t||{}),!0},l.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},l.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},l.prototype.each=function(e){for(let t in this.settings){if(!E.call(this.settingsMap,t))continue;let i=this.settingsMap[t];'checkbox'===i.inputType?e.call(this,t,!!this.settings[t],i):e.call(this,t,this.settings[t],i)}},l.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},l.prototype.injectScope=function(t,i){this.injected={$scope:t,opt:i},t.settings=this.encode(i),e.each(this.settingsMap,(function(e,i){'select'===e.inputType&&t.$watch((function(){return t.settings[i]}),(function(n){e.multiSelect?n.length||(t.settings[i]=[o()]):n||(t.settings[i]=o())}),!0)}))
},l.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},l.prototype.encode=function(e){let t={};const n=a.getPresetList().getPresets(),s=a.getGroupList().getGroups();return e=e||{},this.each((function(a,l,r){if('select'===r.inputType){if(!l&&r.disabledOption)return void(t[a]=r.multiSelect?[o()]:o());switch(r.type){case'presets':if(r.multiSelect){let e=[];l.forEach((function(t){n[t]&&e.push({name:n[t].name,value:t})})),t[a]=e.length?e:[o()]}else{if(!n[l]&&r.disabledOption)return void(t[a]=o());t[a]={name:n[l].name,value:l}}break;case'groups':if(r.multiSelect){let e=[];l.forEach((function(t){s[t]&&e.push({name:s[t].name,value:t,leftIcon:s[t].icon})})),t[a]=e.length?e:[o()]}else{if(!s[l]&&r.disabledOption)return void(t[a]=o());t[a]={name:s[l].name,value:l}}break;default:t[a]={name:e.textObject?_('i18n')(l,i.loc.ale,e.textObject):l,value:l},e.multiSelect&&(t[a]=[t[a]])}}else t[a]=l})),t},l.prototype.decode=function(e){
let t={};for(let i in e){let n=this.settingsMap[i];if('select'===n.inputType)if(n.multiSelect)if(1===e[i].length&&!1===e[i][0].value)t[i]=[];else{let n=[];e[i].forEach((function(e){n.push(e.value)})),t[i]=n}else t[i]=e[i].value;else t[i]=e[i]}return t},l.encodeList=function(e,t){let n=[];switch((t=t||{}).disabled&&n.push(o()),t.type){case'keys':for(let t in e)n.push({name:t,value:t});break;case'groups':for(let t in e){let i=e[t];n.push({name:i.name,value:i.id,leftIcon:i.icon})}break;case'presets':for(let t in e){let i=e[t];n.push({name:i.name,value:i.id})}break;case'values':default:for(let a in e){let o=e[a];n.push({name:t.textObject?_('i18n')(o,i.loc.ale,t.textObject):o,value:o})}}return n},l.disabledOption=o,l})),define('two/mapData',['conf/conf'],(function(e){let t=[],n=[],a=!1,r=!1,c=[];angular.extend(l,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=f,d){if(d)r=!1;else{if(a)return c.push(e);if(r)return e(t)}c.push(e),a=!0;let u=[]
;for(let e=0;e<n.length;e++)for(let t=0;t<n[e].length;t++)u.push(n[e][t]);let g=[];return u.forEach((function(e){let i=new Promise((function(i,n){o.emit(s.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return n(e.message);e.villages.length&&(t=t.concat(e.villages)),i()}))}));g.push(i)})),Promise.all(g).then((function(){a=!1,r=!0,i.$broadcast(l.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),i=Math.ceil(e.MAP_SIZE/306);for(let a=0;a<t;a++){n.push([]);let t=306*a,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let s=0;s<i;s++){let i=306*s,l=306..bound(0,i+306).bound(0,e.MAP_SIZE-i);i=i.bound(0,e.MAP_SIZE),n[a].push({x:t,y:i,width:o,height:l})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,n){
let a,o={},s={},r=!1,c=document.querySelector('head'),d=injector.get('httpService'),u=injector.get('templateManagerService'),g=injector.get('$templateCache');return u.load=function(n,a,o){let l;const r=function(e,t,n,o){g.put(l.substr(1),e),angular.isFunction(a)&&a(e,t,n,o),i.$$phase||i.$apply()},c=function(e,t,i,n){angular.isFunction(o)&&o(e,t,i,n)};l=0!==n.indexOf('!')?e.TEMPLATE_PATH_EXT.join(n):n.substr(1),g.get(l.substr(1))?r(g.get(l.substr(1)),304):t.versionMap[l]?d.get(l,r,c):r(s[l],304)},o.init=function(){if(r)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),i=document.createElement('div');t.className='two-menu-container',e.appendChild(t),i.className='two-main-button',i.style.display='none',t.appendChild(i),a=document.createElement('div'),a.className='two-menu',t.appendChild(a),r=!0,
...
n((function(){i.style.display='block'}),['map'])},o.addTemplate=function(e,t){s[e]=t},o.addStyle=function(e){let t=document.createElement('style');t.type='text/css',t.appendChild(document.createTextNode(e)),c.appendChild(t)},o.addMenuButton=function(e,t,n){let o=document.createElement('div');return o.className='btn-border btn-orange button',o.innerHTML=e,o.style.order=t,a.appendChild(o),'string'==typeof n&&(o.addEventListener('mouseenter',(function(e){i.$broadcast(l.TOOLTIP_SHOW,'twoverflow-tooltip',n,!0,e)})),o.addEventListener('mouseleave',(function(){i.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip')}))),a.appendChild(o)},o.addDivisor=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,a.appendChild(t)},o.isInitialized=function(){return r},o})),require(['two/ui'],(function(e){if(e.isInitialized())return!1;e.init()})),require(['two/language','two/ready','Lockr'],(function(e,t,n){t((function(){e.init(),function(){
const e=n.get('twoverflow_version','1.0.0');if("2.0.0".endsWith('dev'))return!1;const t=function(e){if(/\d+\.\d+\.\d+/.test(e))return parseInt(e.split('.').reduce((e,t)=>e+t),10)};if(t("2.0.0")>t(e)){const e='https://gitlab.com/relaxeaza/twoverflow/blob/master/CHANGELOG.md',t=_('i18n')('check_changes',i.loc.ale,'common'),a=_('i18n')('firefox_shill',i.loc.ale,'common'),o=_('i18n')('new_version',i.loc.ale,'common',"2.0.0");i.$broadcast(l.NOTIFICATION_NEW,{message:`[b]${o}[/b]\n[url=${e}]${t}[/url]\n\n${a}`}),n.set('twoverflow_version',"2.0.0")}}()}))})),define('Lockr',(function(e,t){'use strict';return t.prefix='',t._getPrefixedKey=function(e,t){return(t=t||{}).noPrefix?e:this.prefix+e},t.set=function(e,t,i){const n=this._getPrefixedKey(e,i);try{localStorage.setItem(n,JSON.stringify({data:t}))}catch(e){}},t.get=function(e,t,i){const n=this._getPrefixedKey(e,i);let a;try{a=JSON.parse(localStorage.getItem(n))}catch(e){a=localStorage[n]?{data:localStorage.getItem(n)}:null}
return null===a?t:'object'==typeof a&&void 0!==a.data?a.data:t},t})),define('two/about',[],(function(){let e=!1,t={isInitialized:function(){return e},init:function(){e=!0}};return t})),define('two/about/ui',['two/ui'],(function(e){let t;const n=function(e){t.selectedTab=e},a=function(){t=i.$new(),t.selectTab=n,c.getModal('!twoverflow_about_window',t)};return function(){e.addDivisor(99),e.addMenuButton('About',100).addEventListener('click',(function(){a()})),
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,r,c,d,u,g,_,m,p,f,E){let h,T,v=!1,b=injector.get('overviewService'),w=[],A=!1,S={},I={},y={reverse:!1,column:n.TIME_COMPLETED};const R='attack_view_filters',L={},N={},k=function(){
const e=[c.COMMAND_TYPES],t=a.getSelectedVillage().getId();let i={};for(let t=0;t<e.length;t++)for(let n in S[e[t]])if(i[e[t]]||(i[e[t]]=[]),S[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?i[e[t]].push(r.ATTACK):n===r.SUPPORT?i[e[t]].push(r.SUPPORT):n===r.RELOCATE&&i[e[t]].push(r.RELOCATE)}I=i,I.village=S[c.VILLAGE]?[t]:[]},O=function(){U.loadCommands()},C=function(e,t){E.trigger(l.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},x=function(e,t){for(let e=0;e<w.length;e++)w[e].command_id===t.command_id&&w.splice(e,1);E.trigger(l.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<w.length;e++)w[e].target_village_id===t.village_id?(w[e].target_village_name=t.name,w[e].targetVillage.name=t.name):w[e].origin_village_id===t.village_id&&(w[e].origin_village_name=t.name,w[e].originVillage.name=t.name);E.trigger(l.ATTACK_VIEW_VILLAGE_RENAMED,[t])},P=function(e,t){I[c.VILLAGE].length&&(I[c.VILLAGE]=[t],U.loadCommands())},D=function(e){const i={x:e.origin_x,
y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(a){const o=t.getTravelTime(i,n,{[a]:1},e.command_type,{},!1);return{unit:a,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},G=function(e,t){return e.sort((function(e,i){return m.actualDistance(t,e)-m.actualDistance(t,i)}))},z=function(e,t){let i=0;if(f.hasTownDataInChunk(e.x,e.y)){const i=f.loadTownData(e.x,e.y,25,25,25),n=a.getSelectedCharacter().getTribeId(),o=a.getSelectedCharacter().getId();let s,l=[];i.forEach((function(e){for(let t in e.data)for(let i in e.data[t])l.push(e.data[t][i])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=G(r,e);else if(c.length)s=G(c,e);else{if(!n)return t(!1);{const i=l.filter((function(e){return e.tribe_id===n}));if(!i.length)return t(!1);s=G(i,e)}}return t(s[0])}const n=p.scaledGridCoordinates(e.x,e.y,25,25,25)
;f.loadTownDataAsync(e.x,e.y,25,25,(function(){++i===n.length&&z(e,t)}))},q=function(e){w=e.commands;for(let e=0;e<w.length;e++)b.formatCommand(w[e]),w[e].slowestUnit=D(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[w])};let U={loadCommands:function(){const e=h.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:I[c.COMMAND_TYPES],villages:I[c.VILLAGE]},q)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return y},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],k(),_.set(R,S),U.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),U.loadCommands()},setCommander:function(e,i){z(e.targetVillage,(function(n){const a=e.targetVillage,o=n,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){
l[e]='*'})),A.addCommand(a,o,i,T.OUT,l,{},s,g.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return v},init:function(){for(let e=0;e<d.length;e++)L[d[e]]=!0;for(let e in r)N[r[e]]=!0;try{A=require('two/commandQueue'),T=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(N),[c.INCOMING_UNITS]:angular.copy(L),[c.VILLAGE]:!1};v=!0,h=a.getSelectedCharacter().getGlobalInfo(),S=_.get(R,t,!0),e((function(){k(),i.$on(l.COMMAND_INCOMING,O),i.$on(l.COMMAND_CANCELLED,C),i.$on(l.MAP_SELECTED_VILLAGE,P),i.$on(l.VILLAGE_NAME_CHANGED,M),i.$on(l.COMMAND_IGNORED,x),U.loadCommands()}),['initial_village'])}};return U})),define('two/attackView/events',[],(function(){angular.extend(l,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',
ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,o,s,d,u,p,f,E,h,T){let v,b;const w=function(){return Date.now()/1e3},A=function(e){let t=i.$new();t.text=_('readableDateFilter')(1e3*e,i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=_('i18n')('copy',i.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const n=_('readableDateFilter')(1e3*(e.time_completed-10),i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,n)},I=function(){
let e=T('#two-attack-view').parent(),t=T('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleCommands=v.commands.slice(e,e+t),v.pagination.count=v.commands.length},R=function(){const e=Date.now();for(let t=0;t<v.commands.length;t++)100===v.commands[t].model.percent(e)&&v.commands.splice(t,1);y()},L=function(e,i){t.toggleFilter(e,i),v.filters=t.getFilters()},N=function(e){t.toggleSorting(e),v.sorting=t.getSortings()},k=function(){v.commands=t.getCommands()},O=function(){v.selectedVillageId=a.getSelectedVillage().getId()},C=function(){v=i.$new(),v.commandQueueEnabled=t.commandQueueEnabled(),v.commands=t.getCommands(),v.selectedVillageId=a.getSelectedVillage().getId(),v.filters=t.getFilters(),v.sorting=t.getSortings(),v.UNIT_TYPES=f,v.FILTER_TYPES=u,v.COMMAND_TYPES=d,v.UNIT_SPEED_ORDER=p,v.COLUMN_TYPES=s,v.pagination={count:v.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},
v.openCharacterProfile=r.openCharacterProfile,v.openVillageInfo=r.openVillageInfo,v.jumpToVillage=g.jumpToVillage,v.now=w,v.copyTimeModal=A,v.removeTroops=S,v.switchWindowSize=I,v.toggleFilter=L,v.toggleSorting=N,y();let e=new n('twoverflow_queue_window',(function(){h.timer.remove(R)}));e.register(l.MAP_SELECTED_VILLAGE,O,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,k),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,k),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,k),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,k),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',v),h.timer.add(R)};return function(){b=e.addMenuButton('AttackView',40),b.addEventListener('click',C),
...
}})),define('two/attackView/types/columns',[],(function(){return{ORIGIN_VILLAGE:'origin_village_name',COMMAND_TYPE:'command_type',TARGET_VILLAGE:'target_village_name',TIME_COMPLETED:'time_completed',ORIGIN_CHARACTER:'origin_character_name'}})),define('two/attackView/types/commands',[],(function(){return{ATTACK:'attack',SUPPORT:'support',RELOCATE:'relocate'}})),define('two/attackView/types/filters',[],(function(){return{COMMAND_TYPES:'command_types',VILLAGE:'village',INCOMING_UNITS:'incoming_units'}})),define('two/attackView/unitSpeedOrder',['conf/unitTypes'],(function(e){return[e.LIGHT_CAVALRY,e.HEAVY_CAVALRY,e.AXE,e.SWORD,e.RAM,e.SNOB,e.TREBUCHET]})),require(['two/ready','two/attackView','two/attackView/ui','two/attackView/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/autoCollector',['queues/EventQueue'],(function(e){let t=!1,n=!1,r=!0,c=0;const d=function(){o.emit(s.RESOURCE_DEPOSIT_GET_INFO,{})},u=function(){if(!n)return!1
;let e=a.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return i=t.shift(),void o.emit(s.RESOURCE_DEPOSIT_COLLECT,{job_id:i.id,village_id:a.getSelectedVillage().getId()});var i;let l=e.getReadyJobs();return l?function(e){o.emit(s.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(g(l)):void 0},g=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let _={};return _.init=function(){t=!0,i.$on(l.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!r||!n)return!1;r=!1,setTimeout((function(){r=!0,u()}),1500)})),i.$on(l.RESOURCE_DEPOSIT_JOBS_REROLLED,u),i.$on(l.RESOURCE_DEPOSIT_JOB_COLLECTED,u),i.$on(l.RESOURCE_DEPOSIT_INFO,(function(e,t){u(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},_.start=function(){e.trigger(l.AUTO_COLLECTOR_STARTED),n=!0,u()},_.stop=function(){e.trigger(l.AUTO_COLLECTOR_STOPPED),n=!1},_.isRunning=function(){return n},
_.isInitialized=function(){return t},_})),define('two/autoCollector/events',[],(function(){angular.extend(l,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Collector',50,_('i18n')('description',i.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),n.notif('success',_('i18n')('deactivated',i.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),n.notif('success',_('i18n')('activated',i.loc.ale,'auto_collector')))})),a.register(l.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
a.register(l.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(l.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,n,r,c){let d=!1,u=!1,g=!1,_=injector.get('secondVillageService');const m=function(){var e;e=p,o.emit(s.SECOND_VILLAGE_GET_INFO,{},(function(t){if(_.hasFinishedLastJob(t.jobs))g=!0,o.emit(s.SECOND_VILLAGE_FINISH_VILLAGE),f.stop();else{let i=new c(t);a.getSelectedCharacter().setSecondVillage(i),e()}}))},p=function(){let e=a.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const i=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t<r.server2ClientTime(e[i].time_completed))return e[i];return!1}(e.data.jobs);if(i){const e=r.server2ClientTime(i.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const n=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t>=r.server2ClientTime(e[i].time_completed)&&!e[i].collected)return i;return!1}(e.data.jobs);if(n)return l=n,void o.emit(s.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:a.getSelectedVillage().getId(),job_id:l});var l;const c=_.getCurrentDayJobs(e.data.jobs,e.data.day),d=_.getCollectedJobs(e.data.jobs),g=a.getSelectedVillage().getResources().getResources(),p=_.getAvailableJobs(c,d,g,[]);if(p){const e=function(e){let i=!1;return t.each(e,(function(e){return i=e,!1})),i}(p);!function(e,t){o.emit(s.SECOND_VILLAGE_START_JOB,{village_id:a.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=p[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let f={start:function(){if(!d||g)return!1;n.trigger(l.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,m()},stop:function(){if(!d)return!1;n.trigger(l.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!_.isFeatureActive())return!1;d=!0,o.emit(s.SECOND_VILLAGE_GET_INFO,{},(function(e){_.hasFinishedLastJob(e.jobs)?(g=!0,o.emit(s.SECOND_VILLAGE_FINISH_VILLAGE)):(i.$on(l.SECOND_VILLAGE_VILLAGE_CREATED,m),i.$on(l.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=f})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,i,n,a){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),i(),e((function(){n.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),a.register(l.AUTO_COLLECTOR_STARTED,(function(){n.set(o,!0)})),a.register(l.AUTO_COLLECTOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,g,_,m,p,f,E,h){let T,v,b,w=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),I=!1,y=!1;const R={};let L,N,k,O,C,x=!0;const M='builder_queue_log',P='builder_queue_settings',D=function(){const e=z();if(!x)return j.stop(),!1;e.forEach((function(e){const t=N.getVillage(e),i=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!i.buildingQueue||!i.buildings)&&void q(t))}))},G=function(){z().forEach((function(e){const t=N.getVillage(e),i=t.buildingQueue;if(i.getAmountJobs()){i.getQueue().forEach((function(i){
S.canBeFinishedForFree(i,t)&&A.instantBuild(i,p.MASS_SCREEN,!0,e)}))}}))},z=function(){const e=C[r.GROUP_VILLAGES];let i=[];return e?(i=L.getGroupVillageIds(e),i=i.filter((function(e){return N.getVillage(e)}))):t.each(N.getVillages(),(function(e){i.push(e.getId())})),i},q=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const i=e.buildingQueue.getQueue();let n=angular.copy(R);const a=C[r.BUILDING_SEQUENCES][C[r.ACTIVE_SEQUENCE]];if(i.forEach((function(e){t[e.building]++})),F(t))return!1;a.some((function(i){if(++n[i]>t[i])return w.compute(e),U(e,i,(function(t,i){t&&i.job&&(f.trigger(l.BUILDER_QUEUE_JOB_STARTED,i.job),W(e.getId(),i.job))})),!0}))},U=function(e,t,i){const n=B(e,t);if(n===_.POSSIBLE)V(e,t,(function(e){i(!0,e)}));else if(n===_.NOT_ENOUGH_FOOD&&C[r.PRIORIZE_FARM]){const t=b[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){i(!0,e)}))}i(!1)},V=function(e,t,i){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:p.MASS_SCREEN,premium:!1},i)},B=function(e,t){const i=e.getBuildingData().getDataForBuilding(t);if(i.upgradeability===_.POSSIBLE){const t=i.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-C[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-C[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-C[r.PRESERVE_WOOD]<t.wood)return _.NOT_ENOUGH_RESOURCES}return i.upgradeability},F=function(e){for(let t in e)if(e[t]<b[t])return!1;return!0},W=function(e,t){let i={time:h.gameTime(),villageId:e,building:t.building,level:t.level};return k.unshift(i),k.length>500&&k.splice(k.length-500,k.length),E.set(M,k),!0};let j={};return j.start=function(){if(!x)return f.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,T=setInterval(D,6e4),v=setInterval(G,6e3),e((function(){z().forEach((function(e){const t=N.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),D(),G()}),['all_villages_ready']),f.trigger(l.BUILDER_QUEUE_START)},j.stop=function(){y=!1,clearInterval(T),
clearInterval(v),f.trigger(l.BUILDER_QUEUE_STOP)},j.isRunning=function(){return y},j.isInitialized=function(){return I},j.getSettings=function(){return O},j.getLogs=function(){return k},j.clearLogs=function(){k=[],E.set(M,k),f.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let i=C[r.BUILDING_SEQUENCES];return e in i?g.SEQUENCE_EXISTS:Array.isArray(t)?(i[e]=t,O.set(r.BUILDING_SEQUENCES,i,{quiet:!0}),f.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let i=C[r.BUILDING_SEQUENCES];return e in i?Array.isArray(t)&&function(e){const t=a.getGameData().getBuildings();for(let i=0;i<e.length;i++){let n=e[i];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(i[e]=t,O.set(r.BUILDING_SEQUENCES,i,{quiet:!0}),f.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=C[r.BUILDING_SEQUENCES]
;if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),f.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){I=!0,k=E.get(M,[],!0),N=a.getSelectedCharacter(),L=a.getGroupList(),O=new n({settingsMap:c,storageKey:P}),O.onChange((function(e,t,i){C=O.getAll(),y&&t[d.ANALYSE]&&D(),i.quiet||f.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),C=O.getAll();for(let e in m)R[m[e]]=0;x=Object.keys(C[r.BUILDING_SEQUENCES]).length,b=!!x&&function(e){const t=C[r.BUILDING_SEQUENCES][e];let i=angular.copy(R);return t.forEach((function(e){i[e]++})),i}(C[r.ACTIVE_SEQUENCE]),i.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=N.getVillage(t.village_id);q(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const i=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i];Array.isArray(n)?(n.sort(()=>Math.random()-.5),t=t.concat(n)):t.push(n)}return t}
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let n in e)E.call(e,n)&&(t[n]=i(e[n]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(l,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,t,n,d,u,g,p,f,h,T,v,b){let w,A,S,I,y=a.getGroupList(),R={},L=!1,N={sequencesAvail:!0,modal:{}},k={sequencesAvail:!0},O={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let x,M={},P={},D=!1,G=!1;const z=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},q=function(e,t,i){if(i>=e.length){let t=i-e.length+1;for(;t--;)e.push(void 0)}e.splice(i,0,e.splice(t,1)[0])},U=function(e,a){switch(t.addBuildingSequence(e,a)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
return n.notif('error',_('i18n')('error_sequence_exists',i.loc.ale,'builder_queue')),!1;case f.SEQUENCE_INVALID:return n.notif('error',_('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue')),!1}};k.generateSequences=function(){const e=I.get(g.BUILDING_SEQUENCES),t=Object.keys(e).length;if(k.sequencesAvail=t,!t)return!1;k.generateBuildingSequence(),k.generateBuildingSequenceFinal(),k.updateVisibleBuildingSequence()},k.generateBuildingSequence=function(){const e=w.settings[g.ACTIVE_SEQUENCE].value,t=w.settings[g.BUILDING_SEQUENCES][e],i=a.getGameData().getBuildings();let n={};if(k.sequencesAvail=!!t,!k.sequencesAvail)return!1;for(let e in h)n[h[e]]=0;k.buildingSequence=t.map((function(e){let t=++n[e],o=i[e].individual_level_costs[t],s='not-reached';return!function(e,t){return a.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const i=a.getSelectedVillage().getBuildingQueue().getQueue();let n=!1;return i.some((function(i){
if(i.building===e&&i.level===t)return n=!0})),n}(e,t)&&(s='progress'):s='reached',{level:t,price:i[e].individual_level_costs[t],building:e,duration:b.readableSeconds(o.build_time),levelPoints:R[e][t-1],state:s}}))},k.generateBuildingSequenceFinal=function(e){const t=w.settings[g.ACTIVE_SEQUENCE].value,i=w.settings[g.BUILDING_SEQUENCES][e||t];let n={},a=[];for(let e in S)n[e]={level:0,order:S[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};i.forEach((function(e){let t=++n[e].level,i=S[e].individual_level_costs[t];n[e].resources.wood+=parseInt(i.wood,10),n[e].resources.clay+=parseInt(i.clay,10),n[e].resources.iron+=parseInt(i.iron,10),n[e].resources.food+=parseInt(i.food,10),n[e].build_time+=parseInt(i.build_time,10),n[e].points+=R[e][t-1]}));for(let e in n)0!==n[e].level&&a.push({building:e,level:n[e].level,order:n[e].order,resources:n[e].resources,points:n[e].points,build_time:n[e].build_time});k.buildingSequenceFinal=a},
k.updateVisibleBuildingSequence=function(){const e=w.pagination.buildingSequence.offset,t=w.pagination.buildingSequence.limit;k.visibleBuildingSequence=k.buildingSequence.slice(e,e+t),w.pagination.buildingSequence.count=k.buildingSequence.length},k.generateBuildingsLevelPoints=function(){const e=a.getGameData();let t;for(let i in e.data.buildings){let n=e.getBuildingDataForBuilding(i);t=0,R[i]=[];for(let e=1;e<=n.max_level;e++){let a=z(n.points,n.points_factor,e)-t;t+=a,R[i].push(a)}}},N.moveUp=function(){let e=angular.copy(N.buildingSequence),t=!1;for(let i=0;i<e.length;i++){let n=e[i];n.checked&&(0!==i&&(e[i-1].checked||(e[i-1].building===n.building&&(e[i-1].level++,n.level--,t=!0),q(e,i,i-1))))}N.buildingSequence=e,N.updateVisibleBuildingSequence(),t&&(D=!0)},N.moveDown=function(){let e=angular.copy(N.buildingSequence),t=!1;for(let i=e.length-1;i>=0;i--){let n=e[i];n.checked&&(i!==e.length-1&&(e[i+1].checked||(e[i+1].building===n.building&&(e[i+1].level--,n.level++,t=!0),
q(e,i,i+1))))}N.buildingSequence=e,N.updateVisibleBuildingSequence(),t&&(D=!0)},N.addBuilding=function(e,t,i=1){const n=t-1;let a=N.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<i;e++)a.splice(n,0,o);return N.buildingSequence=N.updateLevels(a,e),N.updateVisibleBuildingSequence(),D=!0,!0},N.removeBuilding=function(e){const t=N.buildingSequence[e].building;N.buildingSequence.splice(e,1),N.buildingSequence=N.updateLevels(N.buildingSequence,t),N.updateVisibleBuildingSequence(),D=!0},N.updateLevels=function(e,t){let i=0,n=[];for(let a=0;a<e.length;a++){let o=e[a];o.building===t?i<S[t].max_level&&n.push({level:++i,building:t,checked:!1}):n.push(o)}return n},N.generateBuildingSequence=function(){const e=I.get(g.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;const i=e[N.selectedSequence.value];let n={};for(let e in h)n[h[e]]=0;N.buildingSequence=i.map((function(e){return{level:++n[e],building:e,checked:!1}})),
N.updateVisibleBuildingSequence()},N.updateVisibleBuildingSequence=function(){const e=w.pagination.buildingSequenceEditor.offset,t=w.pagination.buildingSequenceEditor.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),w.pagination.buildingSequenceEditor.count=N.buildingSequence.length},N.updateBuildingSequence=function(){const e=N.selectedSequence.value,a=N.buildingSequence.map((function(e){return e.building}));switch(t.updateBuildingSequence(e,a)){case f.SEQUENCE_SAVED:D=!1;break;case f.SEQUENCE_NO_EXISTS:n.notif('error',_('i18n')('error_sequence_no_exits',i.loc.ale,'builder_queue'));break;case f.SEQUENCE_INVALID:n.notif('error',_('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue'))}},N.modal.removeSequence=function(){let e=i.$new();e.title=_('i18n')('title',i.loc.ale,'builder_queue_remove_sequence_modal'),e.text=_('i18n')('text',i.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=_('i18n')('remove',i.loc.ale,'common'),
e.cancelText=_('i18n')('cancel',i.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),t.removeSequence(N.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},N.modal.addBuilding=function(){let e=i.$new();e.buildings=[],e.position=N.lastAddedIndex,e.indexLimit=N.buildingSequence.length+1,e.buildingsData=a.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:_('i18n')(N.lastAddedBuilding,i.loc.ale,'building_names'),value:N.lastAddedBuilding};for(let t in S)e.buildings.push({name:_('i18n')(t,i.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,a=e.position,o=e.amount,s=_('i18n')(t,i.loc.ale,'building_names'),l=S[t].max_level;N.lastAddedBuilding=t,N.lastAddedIndex=a,N.addBuilding(t,a,o)?(e.closeWindow(),n.notif('success',_('i18n')('add_building_success',i.loc.ale,'builder_queue',s,a))):n.notif('error',_('i18n')('add_building_limit_exceeded',i.loc.ale,'builder_queue',s,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},N.modal.nameSequence=function(){const e=function(){let e=i.$new();const t=N.selectedSequence.name,a=w.settings[g.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return n.notif('error',_('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;U(e.name,a)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=i.$new();t.title=_('i18n')('clone_warn_changed_sequence_title',i.loc.ale,'builder_queue'),t.text=_('i18n')('clone_warn_changed_sequence_text',i.loc.ale,'builder_queue'),t.submitText=_('i18n')('clone',i.loc.ale,'builder_queue'),t.cancelText=_('i18n')('cancel',i.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},O.updateVisibleLogs=function(){const e=w.pagination.logs.offset,t=w.pagination.logs.limit;O.visibleLogs=O.logs.slice(e,e+t),
w.pagination.logs.count=O.logs.length,O.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,P[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:a.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},P[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},O.clearLogs=function(){t.clearLogs()};const V=function(){let e=i.$new();const t=[h.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return n.notif('error',_('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;U(e.name,t)&&(w.settings[g.ACTIVE_SEQUENCE]={name:e.name,value:e.name},w.settings[g.BUILDING_SEQUENCES][e.name]=t,F(),k.selectedSequence={name:e.name,value:e.name},N.selectedSequence={name:e.name,value:e.name},k.generateSequences(),N.generateBuildingSequence(),e.closeWindow(),B(C.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},B=function(e){w.selectedTab=e},F=function(){I.setAll(I.decode(w.settings)),D=!1},W=function(){t.isRunning()?t.stop():t.start()},j=function(e,t){let n=i.$new();n.title=_('i18n')('discard_changes_title',i.loc.ale,'builder_queue'),n.text=_('i18n')('discard_changes_text',i.loc.ale,'builder_queue'),n.submitText=_('i18n')('discard',i.loc.ale,'common'),n.cancelText=_('i18n')('cancel',i.loc.ale,'common'),n.switchColors=!0,n.submit=function(){n.closeWindow(),e&&e()},n.cancel=function(){n.closeWindow(),t&&t()},c.getModal('modal_attention',n)},Y=function(){D?j((function(){x()})):x()},H={updateGroups:function(){w.groups=u.encodeList(y.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(g.BUILDING_SEQUENCES);w.sequences=u.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){k.generateSequences()},generateBuildingSequencesEditor:function(){N.generateBuildingSequence()},
updateLogs:function(){w.logs=t.getLogs(),O.updateVisibleLogs()},clearLogs:function(){n.notif('success',_('i18n')('logs_cleared',i.loc.ale,'builder_queue')),H.updateLogs()},buildingSequenceUpdate:function(e,t){const a=I.get(g.BUILDING_SEQUENCES);w.settings[g.BUILDING_SEQUENCES][t]=a[t],w.settings[g.ACTIVE_SEQUENCE].value===t&&k.generateSequences(),n.notif('success',_('i18n')('sequence_updated',i.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const a=I.get(g.BUILDING_SEQUENCES);w.settings[g.BUILDING_SEQUENCES][t]=a[t],H.updateSequences(),n.notif('success',_('i18n')('sequence_created',i.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete w.settings[g.BUILDING_SEQUENCES][t];const a=function(e){for(let t in e)if(E.call(e,t))return t;return!1}(w.settings[g.BUILDING_SEQUENCES]);N.selectedSequence={name:a,value:a},H.updateSequences(),N.generateBuildingSequence(),I.get(g.ACTIVE_SEQUENCE)===t&&(I.set(g.ACTIVE_SEQUENCE,a,{quiet:!0}),k.generateSequences()),
n.notif('success',_('i18n')('sequence_removed',i.loc.ale,'builder_queue',t))},saveSettings:function(){n.notif('success',_('i18n')('settings_saved',i.loc.ale,'builder_queue'))},started:function(){w.running=!0},stopped:function(){w.running=!1}},Q=function(){const e=I.get(g.ACTIVE_SEQUENCE);w=i.$new(),w.selectedTab=C.SETTINGS,w.TAB_TYPES=C,w.SETTINGS=g,w.running=L,w.pagination={},w.settingsMap=I.settingsMap,w.villagesLabel=P,w.villagesInfo=M,w.editorView=N,w.editorView.buildingSequence={},w.editorView.visibleBuildingSequence=[],w.editorView.selectedSequence={name:e,value:e},w.editorView.lastAddedBuilding=h.HEADQUARTER,w.editorView.lastAddedIndex=1,w.settingsView=k,w.settingsView.buildingSequence={},w.settingsView.buildingSequenceFinal={},w.logsView=O,w.logsView.logs=t.getLogs(),w.selectTab=B,w.switchBuilder=W,w.saveSettings=F,w.createSequence=V,w.openVillageInfo=r.openVillageInfo,I.injectScope(w),H.updateGroups(),H.updateSequences(),w.pagination.buildingSequence={
count:k.buildingSequence.length,offset:0,loader:k.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},w.pagination.buildingSequenceEditor={count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},w.pagination.logs={count:O.logs.length,offset:0,loader:O.updateVisibleLogs,limit:m.getPaginationLimit()},O.updateVisibleLogs(),k.generateSequences(),N.generateBuildingSequence();let n=new T('twoverflow_builder_queue_window');n.register(l.GROUPS_UPDATED,H.updateGroups,!0),n.register(l.GROUPS_CREATED,H.updateGroups,!0),n.register(l.GROUPS_DESTROYED,H.updateGroups,!0),n.register(l.VILLAGE_SELECTED_CHANGED,H.generateBuildingSequences,!0),n.register(l.BUILDING_UPGRADING,H.generateBuildingSequences,!0),n.register(l.BUILDING_LEVEL_CHANGED,H.generateBuildingSequences,!0),n.register(l.BUILDING_TEARING_DOWN,H.generateBuildingSequences,!0),n.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,H.generateBuildingSequences,!0),
n.register(l.BUILDER_QUEUE_JOB_STARTED,H.updateLogs),n.register(l.BUILDER_QUEUE_CLEAR_LOGS,H.clearLogs),n.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,H.buildingSequenceUpdate),n.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,H.buildingSequenceAdd),n.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,H.buildingSequenceRemoved),n.register(l.BUILDER_QUEUE_SETTINGS_CHANGE,H.saveSettings),n.register(l.BUILDER_QUEUE_START,H.started),n.register(l.BUILDER_QUEUE_STOP,H.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',w),x=w.closeWindow,w.closeWindow=Y,w.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&H.generateBuildingSequences()})),w.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?j((function(){H.generateBuildingSequencesEditor(),D=!1}),(function(){w.editorView.selectedSequence={name:t,value:t},G=!0})):H.generateBuildingSequencesEditor())}))};return function(){S=a.getGameData().getBuildings(),
k.generateBuildingsLevelPoints(),I=t.getSettings(),A=e.addMenuButton('Builder',30),A.addEventListener('click',Q),v.register(l.BUILDER_QUEUE_START,(function(){L=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),n.notif('success',_('i18n')('started',i.loc.ale,'builder_queue'))})),v.register(l.BUILDER_QUEUE_STOP,(function(){L=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),n.notif('success',_('i18n')('stopped',i.loc.ale,'builder_queue'))})),
...
updates:[i.ANALYSE],inputType:'number',min:0,max:6e5},[t.PRIORIZE_FARM]:{default:!0,inputType:'checkbox',updates:[i.ANALYSE]}}})),define('two/builderQueue/sequenceStatus',[],(function(){return{SEQUENCE_NO_EXISTS:'sequence_no_exists',SEQUENCE_EXISTS:'sequence_exists',SEQUENCE_INVALID:'sequence_invalid',SEQUENCE_SAVED:'sequence_saved'}})),require(['two/ready','two/builderQueue','two/builderQueue/ui','two/builderQueue/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/commandQueue',['two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','helper/time','helper/math','struct/MapData','Lockr','conf/buildingTypes','conf/officerTypes','conf/unitTypes'],(function(t,i,n,r,c,d,u,g,_,m,p,f,h,T,v){
const b=Object.values(c),w=Object.values(i),A=Object.values(v),S=Object.values(T),I=Object.values(h);let y,R=[],L={},N=[],k=[],O=!1;const C={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===a.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let i=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),a=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!a.includes(e))return i=!1,!0})),i}},x=function(e){return e<_.gameTime()+y},M=function(e){R.push(e)},P=function(e){L[e.id]=e},D=function(){
f.set(d.QUEUE_COMMANDS,R)},G=function(e){return!isNaN(e)&&e>0&&e<1e3},z=function(e){return E.call(e,'x')&&E.call(e,'y')&&G(e.x)&&G(e.y)};let q={initialized:!1};return q.init=function(){y=t.getTimeOffset(),q.initialized=!0,N=f.get(d.QUEUE_SENT,[],!0),k=f.get(d.QUEUE_EXPIRED,[],!0),function(){const e=f.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){_.gameTime()>e.sendTime?q.expireCommand(e,n.TIME_LIMIT):(M(e),P(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!x(e.sendTime))return!0;O?q.sendCommand(e):q.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&R.length&&(e.returnValue=!0)}))},q.sendCommand=function(e){const i=function(e){const i=a.getVillages()[e.origin.id];if(!i)return n.NOT_OWN_VILLAGE;const o=i.unitInfo.units;let s={},l=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return l=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return l=n.NOT_ENOUGH_UNITS,!1;s[t]=e})),angular.equals({},s)&&(l=n.NOT_ENOUGH_UNITS),l||s}(e);if('string'==typeof i)return q.expireCommand(e,i);e.units=i,o.emit(s.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){N.push(e)}(e),f.set(d.QUEUE_SENT,N),q.removeCommand(e,n.COMMAND_SENT),g.trigger(l.COMMAND_QUEUE_SEND,e)},q.expireCommand=function(e,t){!function(e){k.push(e)}(e),f.set(d.QUEUE_EXPIRED,k),q.removeCommand(e,t)},q.addCommand=function(e,n,o,s,l,r,d,g){let m={},f={};return new Promise((function(E,y){if(!z(e))return y(u.INVALID_ORIGIN);if(!z(n))return y(u.INVALID_TARGET);if(!t.isValidDateTime(o))return y(u.INVALID_DATE);if(angular.isObject(l)){if(!t.each(l,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return y(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(f[t]=!0)})))return y(u.INVALID_OFFICER_TYPE)}return b.includes(d)?d!==c.RELOCATE||a.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&f[T.SUPPORTER]&&delete f[T.SUPPORTER],'string'!=typeof g||I.includes(g)?(g=!(d!==c.ATTACK||!m[v.CATAPULT])&&(g||h.HEADQUARTER),w.includes(s)?void Promise.all([new Promise(t=>p.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>p.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(a){if(e=a[0],n=a[1],!e)return y(u.INVALID_ORIGIN);if(!n)return y(u.INVALID_TARGET);const l=t.getTimeFromString(o),r=t.getTravelTime(e,n,m,d,f,!0),c=s===i.ARRIVE?l-r:l,p=s===i.ARRIVE?l:l+r;if(x(c))return y(u.ALREADY_SENT);const h={id:t.guid(),travelTime:r,arriveTime:p,sendTime:c,origin:e,target:n,date:o,dateType:s,units:m,officers:f,type:d,catapultTarget:g,countdown:c-_.gameTime()};M(h),P(h),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
D(),E(h)})):y(u.INVALID_DATE_TYPE)):y(u.INVALID_CATAPULT_TARGET)):y(u.RELOCATE_DISABLED):y(u.INVALID_COMMAND_TYPE)}))},q.removeCommand=function(e,t){delete L[e.id];const i=R.some((function(t,i){if(t.id==e.id)return R.splice(i,1),D(),!0}));if(i)switch(t){case n.TIME_LIMIT:g.trigger(l.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:g.trigger(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:g.trigger(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:g.trigger(l.COMMAND_QUEUE_REMOVE,e)}else g.trigger(l.COMMAND_QUEUE_REMOVE_ERROR,e);return i},q.clearRegisters=function(){f.set(d.QUEUE_EXPIRED,[]),f.set(d.QUEUE_SENT,[]),k=[],N=[]},q.start=function(e){O=!0,g.trigger(l.COMMAND_QUEUE_START,{disableNotif:!!e})},q.stop=function(){O=!1,g.trigger(l.COMMAND_QUEUE_STOP)},q.isRunning=function(){return O},q.getWaitingCommands=function(){return R},q.getWaitingCommandsObject=function(){return L},q.getSentCommands=function(){return N},
q.getExpiredCommands=function(){return k},q.filterCommands=function(e,t,i){const n=C[e];return(i||R).filter((function(e){return n(e,t)}))},q})),define('two/commandQueue/events',[],(function(){angular.extend(l,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,s,d,u,g,m,p,f,E,h,T,v){let b,w,A,S,I,y=a.getGameData(),R=y.getOrderedUnitNames(),L=y.getOrderedOfficerNames(),N=a.getPresetList(),k=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},C=O.ADD;let x,M,P,D=[],G={},z={};const q={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},U=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){k=t.data},B=function(){k=!1},F=function(e){
const t=new Date(e||h.gameTime()+o.getTimeOffset()),i=t.getMilliseconds(),n=h.zerofill(i-i%100,3),a=h.zerofill(t.getSeconds(),2),s=h.zerofill(t.getMinutes(),2);return h.zerofill(t.getHours(),2)+':'+s+':'+a+':'+n+' '+h.zerofill(t.getDate(),2)+'/'+h.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},W=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),F(e+=t)):''},j=function(){if(b.isValidDate=o.isValidDateTime(I.date),!I.origin||!I.target)return;const e=!!b.isValidDate&&o.getTimeFromString(I.date),t=b.selectedDateType.value===s.ARRIVE;o.each(g,(function(i){o.each(q,(function(n,a){const s=o.getTravelTime(I.origin,I.target,n,i,I.officers,!0);b.travelTimes[i][a].travelTime=_('readableMillisecondsFilter')(s),b.travelTimes[i][a].status=e?Y(t?e-s:e):'neutral'}))}))},Y=function(e){return e&&b.isValidDate?h.gameTime()+x<e?'valid':'invalid':'neutral'},H=function(){I.dateType=b.selectedDateType.value,v.set(m.LAST_DATE_TYPE,b.selectedDateType.value),j()},Q=function(){
I.catapultTarget=b.catapultTarget.value},K=function(){const e=b.selectedInsertPreset.value;if(!e)return!1;const t=a.getPresetList().getPresets()[e];b.selectedInsertPreset={name:_('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},I.units=angular.copy(t.units),I.officers=angular.copy(t.officers),t.catapult_target&&(I.catapultTarget=t.catapult_target,b.catapultTarget={name:_('i18n')(t.catapult_target,i.loc.ale,'building_names'),value:t.catapult_target},b.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=h.serverTime()+i.GAME_TIME_OFFSET,n=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=n-t}),h.timer.add(e.updateCountdown)},X=function(){b.waitingCommands=t.getWaitingCommands()},J=function(){b.sentCommands=t.getSentCommands()},$=function(){b.expiredCommands=t.getExpiredCommands()},ee=function(){let e=b.waitingCommands;U.forEach((function(i){b.activeFilters[i]&&(e=t.filterCommands(i,b.filtersData,e))})),
b.visibleWaitingCommands=e},te=function(e){0===I.units[e]&&(I.units[e]='')},ie=function(e){''===I.units[e]&&(I.units[e]=0)},ne=function(){b.showCatapultSelect=!!I.units.catapult},ae=function(e){b.selectedTab=e},oe=function(){const e=a.getSelectedVillage().data;I.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},se=function(){if(!k)return o.notif('error',_('i18n')('error_no_map_selected_village',i.loc.ale,'command_queue'));E.loadTownDataAsync(k.x,k.y,1,1,(function(e){I.target=e}))},le=function(){I.date=F()},re=function(){if(!I.date)return!1;I.date=W(I.date,100)},ce=function(){if(!I.date)return!1;I.date=W(I.date,-100)},de=function(){I.units=angular.copy(G),I.officers=angular.copy(z),I.catapultTarget="wall",b.catapultTarget={name:_('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},b.showCatapultSelect=!1},ue=function(e){t.addCommand(I.origin,I.target,I.date,I.dateType,I.units,I.officers,e,I.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case p.INVALID_ORIGIN:o.notif('error',_('i18n')('error_origin',i.loc.ale,'command_queue'));break;case p.INVALID_TARGET:o.notif('error',_('i18n')('error_target',i.loc.ale,'command_queue'));break;case p.INVALID_DATE:o.notif('error',_('i18n')('error_invalid_date',i.loc.ale,'command_queue'));break;case p.NO_UNITS:o.notif('error',_('i18n')('error_no_units',i.loc.ale,'command_queue'));break;case p.RELOCATE_DISABLED:o.notif('error',_('i18n')('error_relocate_disabled',i.loc.ale,'command_queue'));break;case p.ALREADY_SENT:o.notif('error',_('i18n')('error_already_sent_'+e,i.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),J(),$()},_e=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,n){return n&&(e=n+'.'+e),_('i18n')(e,i.loc.ale,'command_queue')+' '+_('i18n')(t,i.loc.ale,'command_queue')},pe=function(e,t){b.activeFilters[e]=!b.activeFilters[e],
t&&(b.filtersData[u.ALLOWED_TYPES][e]=!b.filtersData[u.ALLOWED_TYPES][e]),ee()},fe=function(){b.activeFilters[u.TEXT_MATCH]=b.filtersData[u.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){b.presets=o.obj2selectOptions(N.getPresets())},autoCompleteSelected:function(e,t,i,n){if('commandqueue_village_search'!==t)return!1;I[n]={id:i.raw.id,x:i.raw.x,y:i.raw.y,name:i.raw.name},b.searchQuery[n]=''},removeCommand:function(e,t){h.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),i.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',_('i18n')('error_remove_error',i.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',_('i18n')('error_not_own_village',i.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',_('i18n')('error_no_units_enough',i.loc.ale,'command_queue'))},sendCommand:function(e,t){h.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,i){if(b.running=t.isRunning(),i.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){b.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){I.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){I.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{h.timer.remove(e.updateCountdown)})}},he=function(){const e=v.get(m.LAST_DATE_TYPE,s.OUT,!0);let p;b=i.$new(),b.selectedTab=C,b.inventory=a.getInventory(),b.presets=o.obj2selectOptions(N.getPresets()),b.travelTimes={},o.each(g,(function(e){b.travelTimes[e]={},o.each(q,(function(t,i){b.travelTimes[e][i]={
travelTime:0,status:'neutral'}}))})),b.unitOrder=S,b.officers=y.getOrderedOfficerNames(),b.searchQuery={origin:'',target:''},b.isValidDate=!1,b.dateTypes=T.toActionList(s,(function(e){return _('i18n')(e,i.loc.ale,'command_queue')})),b.selectedDateType={name:_('i18n')(e,i.loc.ale,'command_queue'),value:e},b.selectedInsertPreset={name:_('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},b.catapultTarget={name:_('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},b.autoCompleteOrigin={type:['village'],placeholder:_('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:_('i18n')('add_origin',i.loc.ale,'command_queue'),dropDown:!0},b.autoCompleteTarget={type:['village'],placeholder:_('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:_('i18n')('add_target',i.loc.ale,'command_queue'),dropDown:!0},b.showCatapultSelect=!!I.units.catapult,b.attackableBuildings=D,b.commandData=I,
b.activeFilters=M,b.filtersData=P,b.running=t.isRunning(),b.waitingCommands=t.getWaitingCommands(),b.visibleWaitingCommands=t.getWaitingCommands(),b.sentCommands=t.getSentCommands(),b.expiredCommands=t.getExpiredCommands(),b.EVENT_CODES=d,b.FILTER_TYPES=u,b.TAB_TYPES=O,b.COMMAND_TYPES=g,b.relocateEnabled=a.getWorldConfig().isRelocateUnitsEnabled(),b.onUnitInputFocus=te,b.onUnitInputBlur=ie,b.catapultTargetVisibility=ne,b.selectTab=ae,b.addSelected=oe,b.addMapSelected=se,b.addCurrentDate=le,b.incrementDate=re,b.reduceDate=ce,b.cleanUnitInputs=de,b.addCommand=ue,b.clearRegisters=ge,b.switchCommandQueue=_e,b.removeCommand=t.removeCommand,b.openVillageInfo=r.openVillageInfo,b.toggleFilter=pe,b.$watch('commandData.origin',j),b.$watch('commandData.target',j),b.$watch('commandData.date',j),b.$watch('commandData.officers',j),b.$watch('selectedDateType.value',H),b.$watch('selectedInsertPreset.value',K),b.$watch('catapultTarget.value',Q),b.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',fe),
b.$watch('selectedTab',(function(){b.selectedTab===O.ADD?p=setInterval((function(){j()}),2500):clearInterval(p)})),b.waitingCommands.forEach(e=>{Z(e)});let f=new n('twoverflow_queue_window',(function(){clearInterval(p),Ee.clearCountdownUpdates()}));f.register(l.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),f.register(l.ARMY_PRESET_DELETED,Ee.updatePresets,!0),f.register(l.SELECT_SELECTED,Ee.autoCompleteSelected,!0),f.register(l.COMMAND_QUEUE_REMOVE,Ee.removeCommand),f.register(l.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),f.register(l.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),f.register(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),f.register(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),f.register(l.COMMAND_QUEUE_SEND,Ee.sendCommand),f.register(l.COMMAND_QUEUE_START,Ee.start),f.register(l.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',b)};return function(){A=a.getSelectedCharacter(),x=o.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)D.push({name:_('i18n')(e,i.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){G[e]=0})),L.forEach((function(e){z[e]=!1})),I={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(G),officers:angular.copy(z),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Commander',20),w.addEventListener('click',he),f.register(l.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),f.register(l.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),i.$on(l.SHOW_CONTEXT_MENU,V),i.$on(l.DESTROY_CONTEXT_MENU,B),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,g,_,m,p,h,T,v,b,w,A,S,I,y){let R,L,N,k,O,C=!1,x=!1,M=[],P=[],D=[],G=[],z=[],q=[],U=!1,V=!1,B=!1,F=0,W=null,j=null,Y=null,H={},Q=v.gameTime(),K=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(L[r.MIN_DISTANCE],L[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===k.getId()},included:function(e){return e.character_id&&!D.includes(e.id)},ignored:function(e){return G.includes(e.id)},points:function(e){
return!e.between(L[r.MIN_POINTS],L[r.MAX_POINTS])}},ie=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,i){return!t||e!=i[t-1]}))},ae=function(){!function(){const e=L[r.GROUP_INCLUDE];D=[],e.forEach((function(e){let t=a.getGroupList().getGroupVillageIds(e);D=D.concat(t)})),D=ne(D)}(),function(){const e=L[r.GROUP_IGNORE];G=a.getGroupList().getGroupVillageIds(e)}(),function(){const e=L[r.GROUP_ONLY];z=[],e.forEach((function(e){let t=a.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!k.getVillage(e)})),z=z.concat(t)})),z=ne(z)}(),function(){const e=G.concat(D);let t=!1;e.forEach((function(e){E.call(N,e)||(N[e]={time:v.gameTime(),report:!1},t=!0)})),p.each(N,(function(i,n){n=parseInt(n,10),e.includes(n)||(delete N[n],t=!0)})),t&&(y.set($,N),b.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),b.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const i=L[r.GROUP_INCLUDE],n=L[r.GROUP_IGNORE],a=L[r.GROUP_ONLY],o=k.getVillage(t.village_id);let s=!1;if(ae(),n===t.group_id&&(o?(Re(t.village_id),s=!0):(ke(t.village_id),fe(_.IGNORED_VILLAGE,{villageId:t.village_id}),pe(t.village_id))),i.includes(t.group_id)&&!o&&(Oe(),fe(_.INCLUDED_VILLAGE,{villageId:t.village_id}),pe(t.village_id)),a.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){x&&e.start()})),s=!0}s&&b.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const i=L[r.GROUP_INCLUDE],n=L[r.GROUP_IGNORE],a=L[r.GROUP_ONLY],o=k.getVillage(t.village_id);let s=!1;if(ae(),n===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){x&&e.start()})),s=!0}else Oe(),fe(_.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});i.includes(t.group_id)&&!o&&(Oe(),fe(_.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),a.includes(t.group_id)&&o&&(Re(t.village_id),s=!0),s&&b.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){
const t=a.getGroupList().getGroups(),i=L[r.GROUP_IGNORE],n=L[r.GROUP_ONLY],o=L[r.GROUP_INCLUDE],s=E.call(t,i)?i:R.getDefault(r.GROUP_IGNORE),l=n.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));R.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ae(),ye(),Oe(),Ie()},ce=function(){q=[];const e=a.getPresetList().getPresets();L[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let i=e[t];i.load=me(i),i.travelTime=d.calculateTravelTime(i,{barbarian:!1,officers:!1}),q.push(i)})),q=q.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),q.length||(b.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),x&&Ce.stop())},ue=function(e,t){L[r.IGNORE_ON_LOSS]&&L[r.GROUP_IGNORE]&&x&&t.type===w.TYPES.ATTACK&&1!==t.result&&Ne(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=L[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ge=function(e,t){U&&B&&t.origin.id===U.getId()&&t.target.id===B.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&U.commandSent(t)},_e=function(e,t){U&&V&&B&&t.cause===s.SEND_PRESET.type&&U.commandError(t)},me=function(e){let t=0;return p.each(e.units,(function(e,i){e&&(t+=O[i].load*e)})),t},pe=function(e){N[e]={time:v.gameTime(),report:H[e]||!1},delete H[e],y.set($,N),b.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},fe=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=v.gameTime(),t.type=e,P.unshift(t),Ee(),!0)},Ee=function(){const e=L[r.LOGS_LIMIT];P.length>e&&P.splice(P.length-e,P.length),y.set(X,P),b.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},he=function(e,t,i){const n=L[r.TARGET_MULTIPLE_FARMERS],a=L[r.TARGET_SINGLE_ATTACK];if(n&&i){if(a&&e)return!0}else if(a){if(e||t)return!0}else if(t)return!0;return!1},Te=function(){Q=v.gameTime()},ve=function(){clearTimeout(W),clearTimeout(j),clearTimeout(Y),W=null,j=null,Y=null
},be=function(){return Math.max(1,60*L[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*L[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=k.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=f,this.status=n.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{b.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return Te(),!this.running&&(this.initialized?this.targets.length?(U=this,this.running=!0,b.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(b.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(b.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,b.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),ve(),this.onCycleEndFn(e),this.onCycleEndFn=f},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;Te();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let i,c,u,g,_=!1,m=!1;const f=()=>new Promise((t,i)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return i(n.USER_STOP);t()},p.randomSeconds(we())):t()}),h=()=>new Promise((e,i)=>{const a=50-L[r.PRESERVE_COMMAND_SLOTS];t.length>=a?i(n.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(L[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),i=e.getComputed(),a=e.getMaxStorage();if(ee.every(e=>i[e].currentStock===a))return t(n.FULL_STORAGE)}e()
}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(i=this.targets[this.index],void e()):t(n.NO_TARGETS)),R=()=>new Promise((e,t)=>{I.getTownAtAsync(i.x,i.y,a=>{if(te.points(a.points))return t(n.NOT_ALLOWED_POINTS);o.emit(s.GET_ATTACKING_FACTOR,{target_id:i.id},a=>{this.running?null!==i.character_id||null===a.owner_id||D.includes(i.id)?i.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),N=()=>new Promise((e,t)=>{!function(e,t){const i=a.getPresetList().getPresetsByVillageId(e);let n=[];if(q.forEach((function(e){E.call(i,e.id)||n.push(e.id)})),n.length){for(let e in i)E.call(i,e)&&n.push(e);o.emit(s.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),O=()=>new Promise((e,t)=>{const a=this.village.getUnitInfo().getUnits(),o=60*L[r.MAX_TRAVEL_TIME],s=this.village.getPosition(),l=T.actualDistance(s,i);p.each(q,s=>{
if(!!Object.entries(s.units).some(e=>{const t=e[0],i=e[1];return a[t].in_town<i}))return;const r=d.calculateTravelTime(s,{barbarian:!i.character_id,officers:!1});return o>r*l?(_=s,e()):t(n.TIME_LIMIT),!1}),_||t(n.NO_UNITS)}),C=()=>new Promise((e,a)=>{c=!1,g=k.getVillageList();const o=g.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===i.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===i.id&&'forward'===e.data.direction),he(u,c,o))return a(n.BUSY_TARGET);o&&(m=!0),e()}),x=()=>new Promise((e,t)=>{if(!u&&!c)return e();const a=60*L[r.MULTIPLE_ATTACKS_INTERVAL];if(!a)return e();if(L[r.TARGET_SINGLE_ATTACK]&&!L[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(v.gameTime()/1e3),s=L[r.TARGET_MULTIPLE_FARMERS]?g:[this.village],l=this.village.getPosition(),m=T.actualDistance(l,i),p=d.calculateTravelTime(_,{
barbarian:!i.character_id,officers:!0,effects:!0}),f=d.getTravelTimeForDistance(_,p,m,w.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===i.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+f-e.time_completed)<a)}))return t(n.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:i.id,num_reports:0},i=>{if(!this.running)return t(n.USER_STOP);const a=i.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=a.some(e=>e.start_village_id!==this.villageId),s=a.some(e=>e.start_village_id===this.villageId);if(he(s,o,!0))return t(n.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{f().then(h).then(S).then(y).then(R).then(N).then(O).then(C).then(x).then(M).then(e).catch(t)}),G=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([P,G]).then(()=>{if(!this.running)return!1
;this.setStatus(n.ATTACKING),V=!0,B=i,this.index++,o.emit(s.SEND_PRESET,{start_village:this.villageId,target_village:i.id,army_preset_id:_.id,type:w.TYPES.ATTACK})}).catch(t=>{switch(ve(),b.trigger(l.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case n.TIME_LIMIT:case n.BUSY_TARGET:case n.ABANDONED_CONQUERED:case n.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case n.USER_STOP:this.setStatus(t);break;case n.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),ke(i.id),this.targetStep(e);break;case n.NO_UNITS:case n.NO_TARGETS:case n.FULL_STORAGE:case n.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case n.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case n.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(n.UNKNOWN),this.stop(n.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||n.UNKNOWN},Ae.prototype.commandSent=function(e){V=!1,B=!1,ve(),fe(_.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){V=!1,B=!1,this.stop(n.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(i=>{this.targets=function(e,t){return e.map((function(e){return e.distance=T.actualDistance(t,e),e}))}(i,t),this.targets=function(e){return e.filter((function(e){return ie.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,L[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=L[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!z.includes(e))return!1;if(G.includes(e))return!1;let i=Ce.getFarmer(e);return i||(i=new Ae(e),M.push(i)),i},Ie=function(){p.each(k.getVillages(),(function(e,t){Se(t)})),b.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ye=function(){const e=L[r.GROUP_ONLY];let t=[];M.forEach((function(i){let n=i.getId();e.length&&!z.includes(n)?t.push(n):G.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){Re(e)})),b.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let i=0;i<M.length;i++)if(M[i].getId()===e)return M[i].stop(t.KILL_FARMER),M.splice(i,i+1),!0;return!1
},Le=function(e){Te(),M.length?F>=M.length?(F=0,U=!1,Z=v.gameTime()+be(),b.trigger(l.FARM_OVERFLOW_CYCLE_END)):U=M[F]:U=!1,U?(U.onCycleEnd((function(e){e!==t.USER_STOP&&(F++,Le())})),"cycle_begin"===e&&(Z=null,b.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN)),U.start()):W=setTimeout((function(){W=null,F=0,Z=null,b.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),Le()}),be())},Ne=function(e){for(let t=0;t<M.length;t++){let i=M[t].getTargets();for(let t=0;t<i.length;t++){if(i[t].id===e)return!0}}return!1},ke=function(e){M.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ce={};return Ce.init=function(){C=!0,P=y.get(X,[]),N=y.get($,{}),k=a.getSelectedCharacter(),O=a.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,i){L=R.getAll(),"ignore_update"!==i&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ae(),t[g.TARGETS]&&Oe(),t[g.VILLAGES]&&(ye(),Ie()),t[g.LOGS]&&Ee(),t[g.INTERVAL_TIMERS]&&x&&(j?(ve(),
U.targetStep({delay:!0})):W&&(ve(),b.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),F=0,Le())))})),L=R.getAll(),le("ignore_update"),ae(),Ie(),h((function(){ce()}),'presets'),h((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),i.$on(l.ARMY_PRESET_UPDATE,de),i.$on(l.ARMY_PRESET_DELETED,de),i.$on(l.GROUPS_VILLAGE_LINKED,oe),i.$on(l.GROUPS_VILLAGE_UNLINKED,se),i.$on(l.GROUPS_DESTROYED,re),i.$on(l.COMMAND_SENT,ge),i.$on(l.MESSAGE_ERROR,_e),i.$on(l.REPORT_NEW,ue)},Ce.start=function(){let e;return!x&&(q.length?(x=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Le("cycle_begin")})),Te(),function(){let e=be(),t=e+e/2+we();K=setInterval((function(){v.gameTime()-Q>t&&(Ce.stop(),setTimeout(Ce.start,5e3))}),3e4)}(),b.trigger(l.FARM_OVERFLOW_START),void fe(_.FARM_START)):(x=!1,!1)):(b.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ce.stop=function(e=n.USER_STOP){U?(U.stop(e),
e!==n.USER_STOP&&(Z=v.gameTime()+be()),b.trigger(l.FARM_OVERFLOW_CYCLE_END,e)):Z=null,x=!1,ve(),b.trigger(l.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(K),e===n.USER_STOP&&fe(_.FARM_STOP)},Ce.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Ce.getFarmers=function(){return M},Ce.getSettings=function(){return R},Ce.getExceptionVillages=function(){return{included:D,ignored:G}},Ce.getExceptionLogs=function(){return N},Ce.isInitialized=function(){return C},Ce.isRunning=function(){return x},Ce.getLogs=function(){return P},Ce.clearLogs=function(){return P=[],y.set(X,P),b.trigger(l.FARM_OVERFLOW_LOGS_UPDATED),P},Ce.getNextCycleDate=function(){return Z},Ce.getCycleInterval=be,Ce})),define('two/farmOverflow/events',[],(function(){angular.extend(l,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,u,f,E,h,T,v,b){let w,A,S,I=a.getPresetList(),y=a.getGroupList(),R={},L={},N=null;const k={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&C(e.villageId),e.targetId&&C(e.targetId)}))},C=function(e){if(R[e])return R[e];R[e]=!0,L[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:a.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},L[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},x=function(){
w.exceptionVillages.included.forEach((function(e){C(e)})),w.exceptionVillages.ignored.forEach((function(e){C(e)}))},M=function(){t.isRunning()?t.stop():t.start()},P=function(e){w.selectedTab=e},D=function(){A.setAll(A.decode(w.settings)),w.saveButtonColor='orange',T.notif('success',_('i18n')('settings_saved',i.loc.ale,'farm_overflow'))},G=function(e){const t=A.get(f.GROUP_IGNORE);if(!a.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},z=function(e){A.get(f.GROUP_INCLUDE).forEach((function(t){a.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},q=function(){w.presets=E.encodeList(I.getPresets(),{disabled:!1,type:'presets'})},U=function(){w.groups=E.encodeList(y.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=E.encodeList(y.getGroups(),{disabled:!0,type:'groups'})},V=function(){w.running=!0,
T.notif('success',_('i18n')('farm_started',i.loc.ale,'farm_overflow'))},B=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(N),t.reason){case d.NO_PRESETS:T.notif('success',_('i18n')('no_preset',i.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',_('i18n')('farm_stopped',i.loc.ale,'farm_overflow'))}},F=function(){w.logs=angular.copy(t.getLogs()),O(),w.logs.length||T.notif('success',_('i18n')('reseted_logs',i.loc.ale,'farm_overflow'))},W=function(){w.farmers=t.getFarmers()},j=function(){w.exceptionVillages=t.getExceptionVillages(),x()},Y=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(N)},Q=function(e,i){i!==n.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),N=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},K=function(){let e=!0;w=i.$new(),w.SETTINGS=f,w.TAB_TYPES=k,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=k.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=L,w.villagesInfo=R,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=A.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(w),q(),U(),O(),x(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-b.gameTime(),N=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=M,w.selectTab=P,w.saveSettings=D,w.clearLogs=t.clearLogs,w.jumpToVillage=g.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=p.showReport,w.removeIgnored=G,w.removeIncluded=z;let n=new h('twoverflow_farm_overflow_window',(function(){clearInterval(N)}));n.register(l.ARMY_PRESET_UPDATE,q,!0),n.register(l.ARMY_PRESET_DELETED,q,!0),n.register(l.GROUPS_UPDATED,U,!0),n.register(l.GROUPS_CREATED,U,!0),n.register(l.GROUPS_DESTROYED,U,!0),
n.register(l.FARM_OVERFLOW_START,V),n.register(l.FARM_OVERFLOW_STOP,B),n.register(l.FARM_OVERFLOW_LOGS_UPDATED,F),n.register(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,W),n.register(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),n.register(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),n.register(l.FARM_OVERFLOW_CYCLE_BEGIN,H),n.register(l.FARM_OVERFLOW_CYCLE_END,Q),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',w),w.$watch('settings',(function(){e||(w.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){K()})),v.register(l.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),v.register(l.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,s,r,c,d,u,_,m,p,f,h,T,v,b,w,A){let S,I,y,R,L,N,k,O,C,x,M,P,D,G,z,q,U,V,B,F,W,j,Y,H=!1,Q={},K={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ie={},ne=!1;const ae='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},ge={x:0,y:0},_e=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,pe=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,i=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(i/I)%2&&(t+=R),t-=t%I,i-=i%I,{x:Math.ceil((t-C.width/2)/I),y:Math.ceil((i-C.height/2)/I)}},fe=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},Ee=function(){Ae(L)},he=function(){if(H){const e={x:ee.x-C.width/2,y:ee.y-C.height/2};x.clearRect(0,0,C.width,C.height),G.clearRect(0,0,D.width,D.height),function(e){x.drawImage(M,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),i=(t.x-2)*I-e.x,n=(t.y-2)*I-e.y;G.fillStyle=Y[o.COLOR_VIEW_REFERENCE],G.fillRect(i,0,1,y),G.fillRect(0,n,y,1);const a=q.getBoundingClientRect(),s=a.width/w.TILESIZE.x/A.view.z*I,l=a.height/w.TILESIZE.y/A.view.z*I,r=i-s/2,c=n-l/2;G.clearRect(r,c,s,l),G.beginPath(),G.lineWidth=1,G.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],G.rect(r,c,s,l),G.stroke()}(e)}e.requestAnimationFrame(he)
},Te=function(){if(!ne)return!1;const e=K.village[k][O];be(e?K.character[e]:[[k,O]]),ne=!1,m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:k,y:O})},ve=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i][0],a=e[i][1];t.push(ie[n][a])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},be=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i][0],a=e[i][1];t.push(ie[n][a])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in Q.character?Q.character[e.character_id]:e.tribe_id in Q.tribe&&Q.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&F.barbarian;if(e.character_id===V){if(e.id===N.getId()&&Y[o.HIGHLIGHT_SELECTED])return F.selected;if(e.character_id in Q.character)return Q.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return F.player}else{if(e.character_id in Q.character)return Q.character[e.character_id];if(e.tribe_id in Q.tribe)return Q.tribe[e.tribe_id];if(B&&B===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return F.tribe;if(W&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(W.isAlly(e.tribe_id))return F.ally;if(W.isEnemy(e.tribe_id))return F.enemy;if(W.isNAP(e.tribe_id))return F.friendly}}return F.ugly},Ae=function(e,t){for(let i=0;i<e.length;i++){const n=e[i];if(n.id<0)continue;const a=t||we(n);if(!a)continue;const o=n.x*I+(n.y%2?R:0),s=n.y*I;P.fillStyle=a,P.fillRect(o,s,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),I=S+1,y=1e3*I,J.a=Z.a*I,J.b=Z.b*I,$.a=X.a*I,$.b=X.b*I,M.width=1e3*I,M.height=1e3*I,P.imageSmoothingEnabled=!1},Ie=function(){const e=document.body.clientHeight-265;C.width=686,C.height=e,D.width=686,D.height=e,x.imageSmoothingEnabled=!1,G.imageSmoothingEnabled=!1},ye=function(e){var i,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[k,O,e]),3===e.which&&(i=k,n=O,f.getTownAtAsync(i,n,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id
},v.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({type:'tribe',id:e.tribe_id},v.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},Le=function(e){if(ce=!1,ge=pe(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=ge.x,te.y=ge.y,!1;if(te.x===ge.x&&te.y===ge.y||(re.alpha=0,function(e,t){let i=g.tileCoordinate2Pixel(e,t);re.setTranslation(i[0]-25,i[1]+2),re.alpha=1}(ge.x,ge.y)),ge.x in ie&&ge.y in ie[ge.x]){let t=ie[ge.x][ge.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in Q.character?e=!0:t.tribe_id in Q.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(k===e.x&&O===e.y)return!1;Te()}ne=!0,k=e.x,O=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:k,y:O,event:t});const i=K.village[k][O];ve(i?K.character[i]:[[k,O]])}(ge,e)}Te()},Ne=function(){ne&&Te(),
m.trigger(l.MINIMAP_MOUSE_LEAVE)},ke=function(e){if(!ce)return!1;const t=pe(e);g.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ce=function(){Q.tribe=se.getCustomColorsByGroup(b.TRIBE_COLORS)||{},Q.character=se.getCustomColorsByGroup(b.PLAYER_COLORS)||{},Ee()},xe=function(){const e={id:N.getId(),x:N.getX(),y:N.getY()};N=U.getSelectedVillage(),Ae([{character_id:U.getId(),id:e.id,x:e.x,y:e.y},{character_id:U.getId(),id:N.getId(),x:N.getX(),y:N.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(Q,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;Q[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?b.PLAYER_COLORS:b.TRIBE_COLORS;return se.setCustomColorsByGroup(n,Q[e.type]),i.$broadcast(l.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(Q,e))return!1;if(!E.call(Q[e],t))return!1;delete Q[e][t]
;const n='character'===e?b.PLAYER_COLORS:b.TRIBE_COLORS;return se.setCustomColorsByGroup(n,Q[e]),i.$broadcast(l.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(Q[e],t)&&Q[e][t]},getHighlights:function(){return Q},eachHighlight:function(e){for(let t in Q)for(let i in Q[t])e(t,i,Q[t][i])},setViewport:function(e){C=e,C.style.background=Y[o.COLOR_BACKGROUND],x=C.getContext('2d')},setViewportRef:function(e){D=e,G=D.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*I,ee.y=t*I,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!z.width||!z.height)return!1;let e=f.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const i=fe(e[0]*t,e[1]*t),n=fe(e[2]*t,e[3]*t);return[i.x-1,i.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,z.width/2,z.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return j},Me.drawMinimap=function(){_e&&(_e=!1),C.style.background=Y[o.COLOR_BACKGROUND],P.clearRect(0,0,M.width,M.height),d((function(){
!function(){const e=T.getPath(w.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],i=Y[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){P.fillStyle=Y[o.COLOR_CONTINENT],P.fillRect(e*I+R-1,t*I+R-1,3,1),P.fillRect(e*I+R,t*I+R-2,1,3)},a=function(e,t){P.fillStyle=Y[o.COLOR_PROVINCE],P.fillRect(e*I+R,t*I+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:Z.a-10,b:Z.b+10},l={a:X.a-10,b:X.b+10};if(t||i)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=h.toTile(o,e,s);l.key.b&&(l.key.c&&t?n(e,s):i&&a(e,s))}const r=s.a*I,c=l.a*I,d=(s.b-s.a)*I,u=(l.b-l.a)*I;P.beginPath(),P.lineWidth=2,P.strokeStyle="#2B4700",P.rect(r,c,d,u),P.stroke()}))}(),Ee()}),'minimap_data')},Me.enableRendering=function(){H=!0},Me.disableRendering=function(){H=!1},Me.isFirstDraw=function(){return!!_e},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),P=M.getContext('2d'),re=le.make('hover'),j=new u({settingsMap:s,storageKey:ae}),j.onChange((function(e,t){
Y=j.getAll(),Se(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),Y=j.getAll(),Q.tribe=se.getCustomColorsByGroup(b.TRIBE_COLORS)||{},Q.character=se.getCustomColorsByGroup(b.PLAYER_COLORS)||{},Se()},Me.run=function(){d((function(){q=document.getElementById('map'),z=document.getElementById('main-canvas'),U=a.getSelectedCharacter(),W=U.getTribeRelations(),V=U.getId(),B=U.getTribeId(),F=U.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),Ie(),N=U.getSelectedVillage(),te.x=N.getX(),te.y=N.getY(),ee.x=N.getX()*I,ee.y=N.getY()*I,e.addEventListener('resize',Ie,!1),D.addEventListener('mousedown',ye),D.addEventListener('mouseup',Re),D.addEventListener('mousemove',Le),D.addEventListener('mouseleave',Ne),D.addEventListener('click',ke),D.addEventListener('contextmenu',Oe),_.load((function(){L=_.getVillages(),function(e){for(let t=0,i=e.length;t<i;t++){let i=e[t];i.id<0||(i.x in K.village||(K.village[i.x]={}),i.x in ie||(ie[i.x]=[]),
K.village[i.x][i.y]=i.character_id||0,ie[i.x][i.y]=i,i.character_id&&(i.character_id in K.character?K.character[i.character_id].push([i.x,i.y]):K.character[i.character_id]=[[i.x,i.y]],i.tribe_id&&(i.tribe_id in K.tribe?K.tribe[i.tribe_id].push(i.character_id):K.tribe[i.tribe_id]=[i.character_id])))}}(L),function(){let e=[],t=[];for(let i in K.village){e.push(i);for(let e in K.village[i])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*I,J.b=Z.b*I,$.a=X.a*I,$.b=X.b*I}(),he(),i.$on(l.VILLAGE_SELECTED_CHANGED,xe),i.$on(l.TRIBE_RELATION_CHANGED,Ee),i.$on(l.GROUPS_VILLAGES_CHANGED,Ce)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,a,d,u,g,m,p,f,E,h,T,v,b){let w,A,S,I,y,R,L,N,k,O,C,x={},M=!1,P={character:{},tribe:{}};const D={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},G=D.MINIMAP,z=function(e){w.selectedTab=e,e===D.MINIMAP?a.enableRendering():a.disableRendering()},q=function(){Object.keys(w.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
P.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},U=function(e,t){return String(e)+String(t)},V=function(e,t){if(!k)return;let i=U(t.x,t.y);var n,a;O=i,x[i]=!0,M=!0,(n=t.x,a=t.y,new Promise((function(e){let t=T.getTownAt(n,a);if(t)return e(t);T.loadTownDataAsync(n,a,1,1,(function(t){e(t)}))}))).then((function(e){if(!x[U(e.x,e.y)])return;if(!M)return;L.appendChild(k),k.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const i=k.getBoundingClientRect(),n=L.getBoundingClientRect(),a=i.width+50,o=i.height+50,s=R.tt.position.y+o>n.top+n.height,l=R.tt.position.x+a>n.width;s&&(R.tt.position.y-=50),k.classList.toggle('left',l),k.classList.toggle('top',s)}))},B=function(e,t){if(!k)return;let i=t?U(t):O;x[i]=!1,M=!1,R.tt.visible=!1,k.classList.add('ng-hide'),N.appendChild(k)},F=function(e,t,n){let o,s,l=i.$new(),r=!0;l.colorPalettes=b.palette,'setting'===e?(s=t,o=C.get(s),r=!1,l.submit=function(){w.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){w.settings[s]=C.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,l.submit=function(){w.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][n],l.submit=function(){a.addHighlight({id:n,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
c.getModal('modal_color_palette',l)},W=function(){a.addHighlight(w.selectedHighlight,w.addHighlightColor)},j=function(){C.setAll(C.decode(w.settings)),p.notif('success',_('i18n')('settings_saved',i.loc.ale,'minimap'))},Y=function(){let e=i.$new();e.title=_('i18n')('reset_confirm_title',i.loc.ale,'minimap'),e.text=_('i18n')('reset_confirm_text',i.loc.ale,'minimap'),e.submitText=_('i18n')('reset',i.loc.ale,'common'),e.cancelText=_('i18n')('cancel',i.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){C.resetAll(),p.notif('success',_('i18n')('settings_reset',i.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},Q=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},K={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){q()},highlightAddErrorExists:function(){p.notif('error',_('i18n')('highlight_add_error_exists',i.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){p.notif('error',_('i18n')('highlight_add_error_no_entry',i.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){p.notif('error',_('i18n')('highlight_add_error_invalid_color',i.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){B(),I.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){B(),I.style.cursor='url('+v.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){I.style.cursor=''}},Z=function(){w=i.$new(),w.SETTINGS=g,w.TAB_TYPES=D,w.selectedTab=G,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=a.getHighlights(),w.highlightNames=P,w.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:_('i18n')('placeholder_search',i.loc.ale,'minimap'),onEnter:K.addHighlightAutoCompleteSelect},w.selectTab=z,w.openColorPalette=F,w.addCustomHighlight=W,w.removeHighlight=a.removeHighlight,w.saveSettings=j,w.resetSettings=Y,w.highlightsCount=H,w.openProfile=Q,C.injectScope(w,{textObject:'minimap'});let e=new f('twoverflow_minimap_window',(function(){a.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,K.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,K.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,K.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,K.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,B),e.register(l.MINIMAP_MOUSE_LEAVE,K.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,K.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,K.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),q(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(S),y.appendChild(I),a.enableRendering(),a.isFirstDraw()&&a.drawMinimap()};return function(){C=a.getSettings(),R=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',I=document.createElement('canvas'),I.className='cross',a.setViewport(S),a.setViewportRef(I),k=document.querySelector('#map-tooltip'),L=document.querySelector('#wrapper'),N=document.querySelector('#map'),A=t.addMenuButton('Minimap',50),A.addEventListener('click',(function(){const e=a.getMapPosition();if(!e)return!1;Z(),a.setCurrentPosition(e.x,e.y)})),
