 ...
 */
!function(e,t){const i=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),a=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),m=injector.get('$filter'),p=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),E=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const n=i.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,a){a?this.listeners.push(i.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
a.register(s.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(s.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,n,r,c){let d=!1,u=!1,g=!1,m=injector.get('secondVillageService');const p=function(){var e;e=_,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(m.hasFinishedLastJob(t.jobs))g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),E.stop();else{let i=new c(t);a.getSelectedCharacter().setSecondVillage(i),e()}}))},_=function(){let e=a.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const i=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t<r.server2ClientTime(e[i].time_completed))return e[i];return!1}(e.data.jobs);if(i){const e=r.server2ClientTime(i.time_completed)-Date.now()+1e3;return setTimeout(p,e),!1}
const n=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t>=r.server2ClientTime(e[i].time_completed)&&!e[i].collected)return i;return!1}(e.data.jobs);if(n)return s=n,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:a.getSelectedVillage().getId(),job_id:s});var s;const c=m.getCurrentDayJobs(e.data.jobs,e.data.day),d=m.getCollectedJobs(e.data.jobs),g=a.getSelectedVillage().getResources().getResources(),_=m.getAvailableJobs(c,d,g,[]);if(_){const e=function(e){let i=!1;return t.each(e,(function(e){return i=e,!1})),i}(_);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:a.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=_[e];t?setTimeout(p,1e3*t.duration+1e3):setTimeout(p,6e4)}))}};let E={start:function(){if(!d||g)return!1;n.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,p()},stop:function(){if(!d)return!1;n.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!m.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){m.hasFinishedLastJob(e.jobs)?(g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(i.$on(s.SECOND_VILLAGE_VILLAGE_CREATED,p),i.$on(s.SECOND_VILLAGE_JOB_COLLECTED,p))}))}};e.secondVillage=E})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,i,n,a){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),i(),e((function(){n.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),a.register(s.AUTO_COLLECTOR_STARTED,(function(){n.set(o,!0)})),a.register(s.AUTO_COLLECTOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,g,m,p,_,E,f,T){let w,h,b,A=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),I=!1,R=!1;const y={};let L,O,N,k,C,M=!0;const x='builder_queue_log',P='builder_queue_settings',D=function(){const e=z();if(!M)return j.stop(),!1;e.forEach((function(e){const t=O.getVillage(e),i=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!i.buildingQueue||!i.buildings)&&void U(t))}))},G=function(){z().forEach((function(e){const t=O.getVillage(e),i=t.buildingQueue;if(i.getAmountJobs()){i.getQueue().forEach((function(i){
S.canBeFinishedForFree(i,t)&&v.instantBuild(i,_.MASS_SCREEN,!0,e)}))}}))},z=function(){const e=C[r.GROUP_VILLAGES];let i=[];return e?(i=L.getGroupVillageIds(e),i=i.filter((function(e){return O.getVillage(e)}))):t.each(O.getVillages(),(function(e){i.push(e.getId())})),i},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const i=e.buildingQueue.getQueue();let n=angular.copy(y);const a=C[r.BUILDING_SEQUENCES][C[r.ACTIVE_SEQUENCE]];if(i.forEach((function(e){t[e.building]++})),W(t))return!1;a.some((function(i){if(++n[i]>t[i])return A.compute(e),V(e,i,(function(t,i){t&&i.job&&(E.trigger(s.BUILDER_QUEUE_JOB_STARTED,i.job),F(e.getId(),i.job))})),!0}))},V=function(e,t,i){const n=B(e,t);if(n===m.POSSIBLE)q(e,t,(function(e){i(!0,e)}));else if(n===m.NOT_ENOUGH_FOOD&&C[r.PRIORIZE_FARM]){const t=b[p.FARM];e.getBuildingData().getDataForBuilding(p.FARM).level<t&&q(e,p.FARM,(function(e){i(!0,e)}))}i(!1)},q=function(e,t,i){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},i)},B=function(e,t){const i=e.getBuildingData().getDataForBuilding(t);if(i.upgradeability===m.POSSIBLE){const t=i.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-C[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-C[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-C[r.PRESERVE_WOOD]<t.wood)return m.NOT_ENOUGH_RESOURCES}return i.upgradeability},W=function(e){for(let t in e)if(e[t]<b[t])return!1;return!0},F=function(e,t){let i={time:T.gameTime(),villageId:e,building:t.building,level:t.level};return N.unshift(i),N.length>500&&N.splice(N.length-500,N.length),f.set(x,N),!0};let j={};return j.start=function(){if(!M)return E.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,w=setInterval(D,6e4),h=setInterval(G,6e3),e((function(){z().forEach((function(e){const t=O.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),D(),G()}),['all_villages_ready']),E.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){R=!1,clearInterval(w),
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,t,n,d,u,g,_,E,T,w,h,b){let A,v,S,I,R=a.getGroupList(),y={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},k={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,x={},P={},D=!1,G=!1;const z=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},U=function(e,t,i){if(i>=e.length){let t=i-e.length+1;for(;t--;)e.push(void 0)}e.splice(i,0,e.splice(t,1)[0])},V=function(e,a){switch(t.addBuildingSequence(e,a)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
}else if(e>0&&e>o[t].available)return s=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=n.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof i)return U.expireCommand(e,i);e.units=i,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){O.push(e)}(e),E.set(d.QUEUE_SENT,O),U.removeCommand(e,n.COMMAND_SENT),g.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){N.push(e)}(e),E.set(d.QUEUE_EXPIRED,N),U.removeCommand(e,t)},U.addCommand=function(e,n,o,l,s,r,d,g){let p={},E={};return new Promise((function(f,R){if(!z(e))return R(u.INVALID_ORIGIN);if(!z(n))return R(u.INVALID_TARGET);if(!t.isValidDateTime(o))return R(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(p[t]=e)})))return R(u.INVALID_UNIT_TYPE)}
if(angular.equals(p,{}))return R(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return R(u.INVALID_OFFICER_TYPE)}return b.includes(d)?d!==c.RELOCATE||a.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[w.SUPPORTER]&&delete E[w.SUPPORTER],'string'!=typeof g||I.includes(g)?(g=!(d!==c.ATTACK||!p[h.CATAPULT])&&(g||T.HEADQUARTER),A.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(a){if(e=a[0],n=a[1],!e)return R(u.INVALID_ORIGIN);if(!n)return R(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,n,p,d,E,!0),c=l===i.ARRIVE?s-r:s,_=l===i.ARRIVE?s:s+r;if(M(c))return R(u.ALREADY_SENT);const T={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:n,date:o,dateType:l,units:p,officers:E,type:d,catapultTarget:g,countdown:c-m.gameTime()};x(T),P(T),y=y.sort((function(e,t){return e.sendTime-t.sendTime})),
...
o.notif('success',pe(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',m('i18n')('error_origin',i.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',m('i18n')('error_target',i.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',m('i18n')('error_invalid_date',i.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',m('i18n')('error_no_units',i.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',m('i18n')('error_relocate_disabled',i.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',m('i18n')('error_already_sent_'+e,i.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),J(),$()},me=function(){t.isRunning()?t.stop():t.start()},pe=function(e,t,n){return n&&(e=n+'.'+e),m('i18n')(e,i.loc.ale,'command_queue')+' '+m('i18n')(t,i.loc.ale,'command_queue')},_e=function(e,t){b.activeFilters[e]=!b.activeFilters[e],
t&&(b.filtersData[u.ALLOWED_TYPES][e]=!b.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){b.activeFilters[u.TEXT_MATCH]=b.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){b.presets=o.obj2selectOptions(O.getPresets())},autoCompleteSelected:function(e,t,i,n){if('commandqueue_village_search'!==t)return!1;I[n]={id:i.raw.id,x:i.raw.x,y:i.raw.y,name:i.raw.name},b.searchQuery[n]=''},removeCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),i.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',pe(t.type,'removed'))},removeError:function(){o.notif('error',m('i18n')('error_remove_error',i.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',pe(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',m('i18n')('error_not_own_village',i.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',m('i18n')('error_no_units_enough',i.loc.ale,'command_queue'))},sendCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',pe(t.type,'sent'))},start:function(e,i){if(b.running=t.isRunning(),i.disableNotif)return!1;o.notif('success',pe('title','activated'))},stop:function(){b.running=t.isRunning(),o.notif('success',pe('title','deactivated'))},onAutoCompleteOrigin:function(e){I.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){I.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{T.timer.remove(e.updateCountdown)})}},Te=function(){const e=h.get(p.LAST_DATE_TYPE,l.OUT,!0);let _;b=i.$new(),b.selectedTab=C,b.inventory=a.getInventory(),b.presets=o.obj2selectOptions(O.getPresets()),b.travelTimes={},o.each(g,(function(e){b.travelTimes[e]={},o.each(U,(function(t,i){b.travelTimes[e][i]={
...
A.villagesLabel=L,A.villagesInfo=y,A.exceptionVillages=t.getExceptionVillages(),A.exceptionLogs=t.getExceptionLogs(),A.logs=t.getLogs(),A.visibleLogs=[],A.showCycleTimer=!1,A.nextCycleCountdown=0,A.saveButtonColor='orange',A.settingsMap=v.settingsMap,A.pagination={count:A.logs.length,offset:0,loader:k,limit:p.getPaginationLimit()},v.injectScope(A),U(),V(),k(),M(),function(){let e=t.getNextCycleDate();e&&(A.showCycleTimer=!0,A.nextCycleCountdown=e-b.gameTime(),O=setInterval((function(){A.nextCycleCountdown-=1e3}),1e3))}(),A.switchFarm=x,A.selectTab=P,A.saveSettings=D,A.clearLogs=t.clearLogs,A.jumpToVillage=g.jumpToVillage,A.openVillageInfo=r.openVillageInfo,A.showReport=_.showReport,A.removeIgnored=G,A.removeIncluded=z;let n=new T('twoverflow_farm_overflow_window',(function(){clearInterval(O)}));n.register(s.ARMY_PRESET_UPDATE,U,!0),n.register(s.ARMY_PRESET_DELETED,U,!0),n.register(s.GROUPS_UPDATED,V,!0),n.register(s.GROUPS_CREATED,V,!0),n.register(s.GROUPS_DESTROYED,V,!0),
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,a,d,u,g,p,_,E,f,T,w,h,b){let A,v,S,I,R,y,L,O,N,k,C,M={},x=!1,P={character:{},tribe:{}};const D={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},G=D.MINIMAP,z=function(e){A.selectedTab=e,e===D.MINIMAP?a.enableRendering():a.disableRendering()},U=function(){Object.keys(A.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
c.getModal('modal_color_palette',s)},F=function(){a.addHighlight(A.selectedHighlight,A.addHighlightColor)},j=function(){C.setAll(C.decode(A.settings)),_.notif('success',m('i18n')('settings_saved',i.loc.ale,'minimap'))},Y=function(){let e=i.$new();e.title=m('i18n')('reset_confirm_title',i.loc.ale,'minimap'),e.text=m('i18n')('reset_confirm_text',i.loc.ale,'minimap'),e.submitText=m('i18n')('reset',i.loc.ale,'common'),e.cancelText=m('i18n')('cancel',i.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){C.resetAll(),_.notif('success',m('i18n')('settings_reset',i.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(A.highlights.character).length+Object.keys(A.highlights.tribe).length},Q=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},K={addHighlightAutoCompleteSelect:function(e){A.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',m('i18n')('highlight_add_error_exists',i.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',m('i18n')('highlight_add_error_no_entry',i.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',m('i18n')('highlight_add_error_invalid_color',i.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){B(),I.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){B(),I.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){I.style.cursor=''}},Z=function(){A=i.$new(),A.SETTINGS=g,A.TAB_TYPES=D,A.selectedTab=G,A.selectedHighlight=!1,A.addHighlightColor='#000000',A.highlights=a.getHighlights(),A.highlightNames=P,A.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),A.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),A.autoComplete={
