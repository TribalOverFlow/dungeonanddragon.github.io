...
filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",commands_copy_arrival_tooltip:"Kopiuj czas dotarcia.",commands_copy_backtime_tooltip:"Kopiuj czas powrotu do wioski źródłowej.",commands_set_remove_tooltip:"Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazów.",command_type_tooltip:"Rodzaj",slowest_unit_tooltip:"Najwolniejsza jednostka",command_type:"Rodzaj",slowest_unit:"Co?",actions:"Dostępne akcje",no_incoming:"Brak nadchodzących wojsk.",copy:"Kopiuj",current_only_tooltip:"Tylko aktywna wioska",arrive:"Dotrze",arrivetime:"Czas dotarcia skopiowany!",backtime:"Czas powrotu skopiowany!",spyorigin:"Szpiedzy wysłani do %{name}!","commands.tooltip.kill":"Wstaw rozkaz klinowania do Kolejki rozkazów. MAŁY KLIN.","commands.tooltip.killBig":"Wstaw rozkaz klinowania do Kolejki rozkazów. DUŻY KLIN.",
...
mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},a='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=f.call(o,t)?o[t]:t,e.setJSON(n[t]||n[a])}let s={init:function(){if(t)return!1;t=!0,l(i.loc.ale),i.$watch('loc.ale',(function(e,t){e!==t&&l(i.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,t){const n=function(e,t){let i={};for(let n in e)f.call(t,n)?angular.equals(e[n],t[n])||(i[n]=t[n]):i[n]=e[n];return!angular.equals({},i)&&i},o=function(){return{name:m('i18n')('disabled',i.loc.ale,'common'),value:!1}},l=function(e,t){let i={};for(let n in t)(e[n].updates||[]).forEach((function(e){i[e]=!0}));return!angular.equals(i,{})&&i};let s=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let i in e)t[i]=e[i].default;return t}(this.settingsMap),
this.settings=angular.merge({},this.defaults,t.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return s.prototype.get=function(e){return angular.copy(this.settings[e])},s.prototype.getAll=function(){return angular.copy(this.settings)},s.prototype.getDefault=function(e){return f.call(this.defaults,e)?this.defaults[e]:void 0},s.prototype.store=function(){t.set(this.storageKey,this.settings)},s.prototype.set=function(e,t,i){if(!f.call(this.settingsMap,e))return!1;const a=this.settingsMap[e];'number'===a.inputType&&(t=parseInt(t,10),f.call(a,'min')&&(t=Math.max(a.min,t)),f.call(a,'max')&&(t=Math.min(a.max,t)));const o=angular.copy(this.settings);this.settings[e]=t;const s=angular.copy(this.settings),r=n(o,s);if(!r)return!1;const c=l(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,i||{}),!0},s.prototype.setAll=function(e,t){const i=angular.copy(this.settings)
;for(let t in e)if(f.call(this.settingsMap,t)){const i=this.settingsMap[t];let n=e[t];'number'===i.inputType&&(n=parseInt(n,10),f.call(i,'min')&&(n=Math.max(i.min,n)),f.call(i,'max')&&(n=Math.min(i.max,n))),this.settings[t]=n}const a=angular.copy(this.settings),o=n(i,a);if(!o)return!1;const s=l(this.settingsMap,o);return this.store(),this.updateScope(),this.events.settingsChange.call(this,o,s,t||{}),!0},s.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},s.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},s.prototype.each=function(e){for(let t in this.settings){if(!f.call(this.settingsMap,t))continue;let i=this.settingsMap[t];'checkbox'===i.inputType?e.call(this,t,!!this.settings[t],i):e.call(this,t,this.settings[t],i)}},s.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},s.prototype.injectScope=function(t,i){this.injected={$scope:t,opt:i},t.settings=this.encode(i),
e.each(this.settingsMap,(function(e,i){'select'===e.inputType&&t.$watch((function(){return t.settings[i]}),(function(n){e.multiSelect?n.length||(t.settings[i]=[o()]):n||(t.settings[i]=o())}),!0)}))},s.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},s.prototype.encode=function(e){let t={};const n=a.getPresetList().getPresets(),l=a.getGroupList().getGroups();return e=e||{},this.each((function(a,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[a]=r.multiSelect?[o()]:o());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){n[t]&&e.push({name:n[t].name,value:t})})),t[a]=e.length?e:[o()]}else{if(!n[s]&&r.disabledOption)return void(t[a]=o());t[a]={name:n[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){l[t]&&e.push({name:l[t].name,value:t,leftIcon:l[t].icon})})),t[a]=e.length?e:[o()]}else{if(!l[s]&&r.disabledOption)return void(t[a]=o())
;t[a]={name:l[s].name,value:s}}break;default:t[a]={name:e.textObject?m('i18n')(s,i.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[a]=[t[a]])}}else t[a]=s})),t},s.prototype.decode=function(e){let t={};for(let i in e){let n=this.settingsMap[i];if('select'===n.inputType)if(n.multiSelect)if(1===e[i].length&&!1===e[i][0].value)t[i]=[];else{let n=[];e[i].forEach((function(e){n.push(e.value)})),t[i]=n}else t[i]=e[i].value;else t[i]=e[i]}return t},s.encodeList=function(e,t){let n=[];switch((t=t||{}).disabled&&n.push(o()),t.type){case'keys':for(let t in e)n.push({name:t,value:t});break;case'groups':for(let t in e){let i=e[t];n.push({name:i.name,value:i.id,leftIcon:i.icon})}break;case'presets':for(let t in e){let i=e[t];n.push({name:i.name,value:i.id})}break;case'values':default:for(let a in e){let o=e[a];n.push({name:t.textObject?m('i18n')(o,i.loc.ale,t.textObject):o,value:o})}}return n},s.disabledOption=o,s})),define('two/mapData',['conf/conf'],(function(e){let t=[],n=[],a=!1,r=!1,c=[]
;angular.extend(s,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=E,d){if(d)r=!1;else{if(a)return c.push(e);if(r)return e(t)}c.push(e),a=!0;let u=[];for(let e=0;e<n.length;e++)for(let t=0;t<n[e].length;t++)u.push(n[e][t]);let g=[];return u.forEach((function(e){let i=new Promise((function(i,n){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return n(e.message);e.villages.length&&(t=t.concat(e.villages)),i()}))}));g.push(i)})),Promise.all(g).then((function(){a=!1,r=!0,i.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),i=Math.ceil(e.MAP_SIZE/306);for(let a=0;a<t;a++){n.push([]);let t=306*a,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<i;l++){let i=306*l,s=306..bound(0,i+306).bound(0,e.MAP_SIZE-i);i=i.bound(0,e.MAP_SIZE),n[a].push({x:t,y:i,width:o,
height:s})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,n){let a,o={},l={},r=!1,c=document.querySelector('head'),d=injector.get('httpService'),u=injector.get('templateManagerService'),g=injector.get('$templateCache');return u.load=function(n,a,o){let s;const r=function(e,t,n,o){g.put(s.substr(1),e),angular.isFunction(a)&&a(e,t,n,o),i.$$phase||i.$apply()},c=function(e,t,i,n){angular.isFunction(o)&&o(e,t,i,n)};s=0!==n.indexOf('!')?e.TEMPLATE_PATH_EXT.join(n):n.substr(1),g.get(s.substr(1))?r(g.get(s.substr(1)),304):t.versionMap[s]?d.get(s,r,c):r(l[s],304)},o.init=function(){if(r)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),i=document.createElement('div');t.className='two-menu-container',e.appendChild(t),i.className='two-main-button',i.style.display='none',t.appendChild(i),a=document.createElement('div'),a.className='two-menu',t.appendChild(a),r=!0,
...
const e=[c.COMMAND_TYPES],t=a.getSelectedVillage().getId();let i={};for(let t=0;t<e.length;t++)for(let n in S[e[t]])if(i[e[t]]||(i[e[t]]=[]),S[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?i[e[t]].push(r.ATTACK):n===r.SUPPORT?i[e[t]].push(r.SUPPORT):n===r.RELOCATE&&i[e[t]].push(r.RELOCATE)}I=i,I.village=S[c.VILLAGE]?[t]:[]},N=function(){V.loadCommands()},M=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){for(let e=0;e<A.length;e++)A[e].command_id===t.command_id&&A.splice(e,1);f.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},x=function(e,t){for(let e=0;e<A.length;e++)A[e].target_village_id===t.village_id?(A[e].target_village_name=t.name,A[e].targetVillage.name=t.name):A[e].origin_village_id===t.village_id&&(A[e].origin_village_name=t.name,A[e].originVillage.name=t.name);f.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},P=function(e,t){I[c.VILLAGE].length&&(I[c.VILLAGE]=[t],V.loadCommands())},D=function(e){const i={x:e.origin_x,
...
let e=w('#two-attack-view').parent(),t=w('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleCommands=h.commands.slice(e,e+t),h.pagination.count=h.commands.length},y=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);R()},L=function(e,i){t.toggleFilter(e,i),h.filters=t.getFilters()},O=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},k=function(){h.commands=t.getCommands()},N=function(){h.selectedVillageId=a.getSelectedVillage().getId()},M=function(){h=i.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=a.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=E,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=p,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:R,limit:_.getPaginationLimit()},
h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=g.jumpToVillage,h.now=A,h.copyTimeModal=v,h.removeTroops=S,h.switchWindowSize=I,h.toggleFilter=L,h.toggleSorting=O,R();let e=new n('twoverflow_queue_window',(function(){T.timer.remove(y)}));e.register(s.MAP_SELECTED_VILLAGE,N,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,k),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,k),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,k),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,k),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),T.timer.add(y)};return function(){b=e.addMenuButton('Strażnik',40),b.addEventListener('click',M),
...
a.register(s.AUTO_HEALER_STARTED,(function(){n.set(o,!0)})),a.register(s.AUTO_HEALER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,g,m,_,p,E,f,T){let w,h,b,A=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),I=!1,R=!1;const y={};let L,O,k,N,M,C=!0;const x='builder_queue_log',P='builder_queue_settings',D=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=O.getVillage(e),i=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!i.buildingQueue||!i.buildings)&&void U(t))}))},z=function(){G().forEach((function(e){
const t=O.getVillage(e),i=t.buildingQueue;if(i.getAmountJobs()){i.getQueue().forEach((function(i){S.canBeFinishedForFree(i,t)&&v.instantBuild(i,p.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=M[r.GROUP_VILLAGES];let i=[];return e?(i=L.getGroupVillageIds(e),i=i.filter((function(e){return O.getVillage(e)}))):t.each(O.getVillages(),(function(e){i.push(e.getId())})),i},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const i=e.buildingQueue.getQueue();let n=angular.copy(y);const a=M[r.BUILDING_SEQUENCES][M[r.ACTIVE_SEQUENCE]];if(i.forEach((function(e){t[e.building]++})),B(t))return!1;a.some((function(i){if(++n[i]>t[i])return A.compute(e),V(e,i,(function(t,i){t&&i.job&&(E.trigger(s.BUILDER_QUEUE_JOB_STARTED,i.job),F(e.getId(),i.job))})),!0}))},V=function(e,t,i){const n=W(e,t);if(n===m.POSSIBLE)q(e,t,(function(e){i(!0,e)}));else if(n===m.NOT_ENOUGH_FOOD&&M[r.PRIORIZE_FARM]){const t=b[_.FARM];e.getBuildingData().getDataForBuilding(_.FARM).level<t&&q(e,_.FARM,(function(e){
i(!0,e)}))}i(!1)},q=function(e,t,i){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:p.MASS_SCREEN,premium:!1},i)},W=function(e,t){const i=e.getBuildingData().getDataForBuilding(t);if(i.upgradeability===m.POSSIBLE){const t=i.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-M[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-M[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-M[r.PRESERVE_WOOD]<t.wood)return m.NOT_ENOUGH_RESOURCES}return i.upgradeability},B=function(e){for(let t in e)if(e[t]<b[t])return!1;return!0},F=function(e,t){let i={time:T.gameTime(),villageId:e,building:t.building,level:t.level};return k.unshift(i),k.length>500&&k.splice(k.length-500,k.length),f.set(x,k),!0};let j={};return j.start=function(){if(!C)return E.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,w=setInterval(D,6e4),h=setInterval(z,6e3),e((function(){G().forEach((function(e){const t=O.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),D(),z()
}),['all_villages_ready']),E.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){R=!1,clearInterval(w),clearInterval(h),E.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return R},j.isInitialized=function(){return I},j.getSettings=function(){return N},j.getLogs=function(){return k},j.clearLogs=function(){k=[],f.set(x,k),E.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let i=M[r.BUILDING_SEQUENCES];return e in i?g.SEQUENCE_EXISTS:Array.isArray(t)?(i[e]=t,N.set(r.BUILDING_SEQUENCES,i,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let i=M[r.BUILDING_SEQUENCES];return e in i?Array.isArray(t)&&function(e){const t=a.getGameData().getBuildings();for(let i=0;i<e.length;i++){let n=e[i];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(i[e]=t,N.set(r.BUILDING_SEQUENCES,i,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),
g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=M[r.BUILDING_SEQUENCES];if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){I=!0,k=f.get(x,[],!0),O=a.getSelectedCharacter(),L=a.getGroupList(),N=new n({settingsMap:c,storageKey:P}),N.onChange((function(e,t,i){M=N.getAll(),R&&t[d.ANALYSE]&&D(),i.quiet||E.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),M=N.getAll();for(let e in _)y[_[e]]=0;C=Object.keys(M[r.BUILDING_SEQUENCES]).length,b=!!C&&function(e){const t=M[r.BUILDING_SEQUENCES][e];let i=angular.copy(y);return t.forEach((function(e){i[e]++})),i}(M[r.ACTIVE_SEQUENCE]),i.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=O.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const i=function(e){let t=[]
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,t,n,d,u,g,p,E,T,w,h,b){let A,v,S,I,R=a.getGroupList(),y={},L=!1,O={sequencesAvail:!0,modal:{}},k={sequencesAvail:!0},N={};const M={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,x={},P={},D=!1,z=!1;const G=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},U=function(e,t,i){if(i>=e.length){let t=i-e.length+1;for(;t--;)e.push(void 0)}e.splice(i,0,e.splice(t,1)[0])},V=function(e,a){switch(t.addBuildingSequence(e,a)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
n.notif('success',m('i18n')('sequence_removed',i.loc.ale,'builder_queue',t))},saveSettings:function(){n.notif('success',m('i18n')('settings_saved',i.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(g.ACTIVE_SEQUENCE);A=i.$new(),A.selectedTab=M.SETTINGS,A.TAB_TYPES=M,A.SETTINGS=g,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=P,A.villagesInfo=x,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=T.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=k,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=N,A.logsView.logs=t.getLogs(),A.selectTab=W,A.switchBuilder=F,A.saveSettings=B,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,I.injectScope(A),H.updateGroups(),H.updateSequences(),A.pagination.buildingSequence={
...
if(!!Object.entries(l.units).some(e=>{const t=e[0],i=e[1];return a[t].in_town<i}))return;const r=d.calculateTravelTime(l,{barbarian:!i.character_id,officers:!1});return o>r*s?(m=l,e()):t(n.TIME_LIMIT),!1}),m||t(n.NO_UNITS)}),M=()=>new Promise((e,a)=>{c=!1,g=k.getVillageList();const o=g.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===i.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===i.id&&'forward'===e.data.direction),Te(u,c,o))return a(n.BUSY_TARGET);o&&(_=!0),e()}),C=()=>new Promise((e,t)=>{if(!u&&!c)return e();const a=60*L[r.MULTIPLE_ATTACKS_INTERVAL];if(!a)return e();if(L[r.TARGET_SINGLE_ATTACK]&&!L[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=L[r.TARGET_MULTIPLE_FARMERS]?g:[this.village],s=this.village.getPosition(),_=w.actualDistance(s,i),p=d.calculateTravelTime(m,{
barbarian:!i.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(m,p,_,A.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===i.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<a)}))return t(n.BUSY_TARGET);e()}),x=()=>new Promise((e,t)=>{if(_)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:i.id,num_reports:0},i=>{if(!this.running)return t(n.USER_STOP);const a=i.commands.own.filter(e=>e.type===A.TYPES.ATTACK&&'forward'===e.direction),o=a.some(e=>e.start_village_id!==this.villageId),l=a.some(e=>e.start_village_id===this.villageId);if(Te(l,o,!0))return t(n.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{E().then(T).then(S).then(R).then(y).then(O).then(N).then(M).then(C).then(x).then(e).catch(t)}),z=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([P,z]).then(()=>{if(!this.running)return!1
...
ve.prototype.isRunning=function(){return this.running},ve.prototype.isInitialized=function(){return this.initialized},ve.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},ve.prototype.getId=function(){return this.villageId};const Se=function(e){const t=L[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(z.includes(e))return!1;let i=Me.getFarmer(e);return i||(i=new ve(e),x.push(i)),i},Ie=function(){p.each(k.getVillages(),(function(e,t){Se(t)})),b.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=L[r.GROUP_ONLY];let t=[];x.forEach((function(i){let n=i.getId();e.length&&!G.includes(n)?t.push(n):z.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){ye(e)})),b.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ye=function(e){for(let i=0;i<x.length;i++)if(x[i].getId()===e)return x[i].stop(t.KILL_FARMER),x.splice(i,i+1),!0;return!1
},Le=function(e){we(),x.length?B>=x.length?(B=0,V=!1,Z=h.gameTime()+be(),b.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=x[B]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(B++,Le())})),"cycle_begin"===e&&(Z=null,b.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):F=setTimeout((function(){F=null,B=0,Z=null,b.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Le()}),be())},Oe=function(e){for(let t=0;t<x.length;t++){let i=x[t].getTargets();for(let t=0;t<i.length;t++){if(i[t].id===e)return!0}}return!1},ke=function(e){x.forEach((function(t){t.removeTarget(e)}))},Ne=function(){_.load((function(){x.forEach((function(e){e.loadTargets()}))}),!0)};let Me={};return Me.init=function(){M=!0,P=R.get(X,[]),O=R.get($,{}),k=a.getSelectedCharacter(),N=a.getGameData().getUnitsObject(),y=new e({settingsMap:c,storageKey:J}),y.onChange((function(e,t,i){L=y.getAll(),"ignore_update"!==i&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ae(),t[g.TARGETS]&&Ne(),t[g.VILLAGES]&&(Re(),Ie()),t[g.LOGS]&&fe(),t[g.INTERVAL_TIMERS]&&C&&(j?(he(),
V.targetStep({delay:!0})):F&&(he(),b.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),B=0,Le())))})),L=y.getAll(),se("ignore_update"),ae(),Ie(),T((function(){ce()}),'presets'),T((function(){x.forEach((function(e){e.loadTargets()}))}),'minimap_data'),i.$on(s.ARMY_PRESET_UPDATE,de),i.$on(s.ARMY_PRESET_DELETED,de),i.$on(s.GROUPS_VILLAGE_LINKED,oe),i.$on(s.GROUPS_VILLAGE_UNLINKED,le),i.$on(s.GROUPS_DESTROYED,re),i.$on(s.COMMAND_SENT,ge),i.$on(s.MESSAGE_ERROR,me),i.$on(s.REPORT_NEW,ue)},Me.start=function(){let e;return!C&&(U.length?(C=!0,e=[],x.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Le("cycle_begin")})),we(),function(){let e=be(),t=e+e/2+Ae();K=setInterval((function(){h.gameTime()-Q>t&&(Me.stop(),setTimeout(Me.start,5e3))}),3e4)}(),b.trigger(s.FARM_OVERFLOW_START),void Ee(m.FARM_START)):(C=!1,!1)):(b.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Me.stop=function(e=n.USER_STOP){V?(V.stop(e),
e!==n.USER_STOP&&(Z=h.gameTime()+be()),b.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,he(),b.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(K),e===n.USER_STOP&&Ee(m.FARM_STOP)},Me.getFarmer=function(e){return x.find((function(t){return t.getId()===e}))},Me.getFarmers=function(){return x},Me.getSettings=function(){return y},Me.getExceptionVillages=function(){return{included:D,ignored:z}},Me.getExceptionLogs=function(){return O},Me.isInitialized=function(){return M},Me.isRunning=function(){return C},Me.getLogs=function(){return P},Me.clearLogs=function(){return P=[],R.set(X,P),b.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),P},Me.getNextCycleDate=function(){return Z},Me.getCycleInterval=be,Me})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,r,c,d,u,m,_,p,E,T,w,h,b,A,v){let S,I,R,y,L,O,k,N,M,C,x,P,D,z,G,U,V,q,W,B,F,j,Y,H=!1,Q={},K={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ie={},ne=!1;const ae='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},ge={x:0,y:0},me=!0;const _e=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,pe=function(e){let t=Math.ceil(ee.x+e.offsetX)-y,i=Math.ceil(ee.y+e.offsetY)+y;return Math.floor(i/I)%2&&(t+=y),t-=t%I,i-=i%I,{x:Math.ceil((t-M.width/2)/I),y:Math.ceil((i-M.height/2)/I)}},Ee=function(e,t){return{x:e/A.TILESIZE.x,y:t/A.TILESIZE.y/A.TILESIZE.off}},fe=function(){ve(L)},Te=function(){if(H){const e={x:ee.x-M.width/2,y:ee.y-M.height/2};C.clearRect(0,0,M.width,M.height),z.clearRect(0,0,D.width,D.height),function(e){C.drawImage(x,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=xe.getMapPosition(),i=(t.x-2)*I-e.x,n=(t.y-2)*I-e.y;z.fillStyle=Y[o.COLOR_VIEW_REFERENCE],z.fillRect(i,0,1,R),z.fillRect(0,n,R,1);const a=U.getBoundingClientRect(),l=a.width/A.TILESIZE.x/v.view.z*I,s=a.height/A.TILESIZE.y/v.view.z*I,r=i-l/2,c=n-s/2;z.clearRect(r,c,l,s),z.beginPath(),z.lineWidth=1,z.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],z.rect(r,c,l,s),z.stroke()}(e)}e.requestAnimationFrame(Te)
},we=function(){if(!ne)return!1;const e=K.village[k][N];be(e?K.character[e]:[[k,N]]),ne=!1,_.trigger(s.MINIMAP_VILLAGE_BLUR,{x:k,y:N})},he=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i][0],a=e[i][1];t.push(ie[n][a])}ve(t,Y[o.COLOR_QUICK_HIGHLIGHT])},be=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i][0],a=e[i][1];t.push(ie[n][a])}ve(t)},Ae=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in Q.character?Q.character[e.character_id]:e.tribe_id in Q.tribe&&Q.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&B.barbarian;if(e.character_id===q){if(e.id===O.getId()&&Y[o.HIGHLIGHT_SELECTED])return B.selected;if(e.character_id in Q.character)return Q.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return B.player}else{if(e.character_id in Q.character)return Q.character[e.character_id];if(e.tribe_id in Q.tribe)return Q.tribe[e.tribe_id];if(W&&W===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return B.tribe;if(F&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(F.isAlly(e.tribe_id))return B.ally;if(F.isEnemy(e.tribe_id))return B.enemy;if(F.isNAP(e.tribe_id))return B.friendly}}return B.ugly},ve=function(e,t){for(let i=0;i<e.length;i++){const n=e[i];if(n.id<0)continue;const a=t||Ae(n);if(!a)continue;const o=n.x*I+(n.y%2?y:0),l=n.y*I;P.fillStyle=a,P.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],y=Math.round(S/2),I=S+1,R=1e3*I,J.a=Z.a*I,J.b=Z.b*I,$.a=X.a*I,$.b=X.b*I,x.width=1e3*I,x.height=1e3*I,P.imageSmoothingEnabled=!1},Ie=function(){const e=document.body.clientHeight-265;M.width=686,M.height=e,D.width=686,D.height=e,C.imageSmoothingEnabled=!1,z.imageSmoothingEnabled=!1},Re=function(e){var i,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(_.trigger(s.MINIMAP_VILLAGE_CLICK,[k,N,e]),3===e.which&&(i=k,n=N,E.getTownAtAsync(i,n,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;xe.addHighlight({type:'character',id:e.character_id
...
_.trigger(s.MINIMAP_MOUSE_LEAVE)},ke=function(e){if(!ce)return!1;const t=pe(e);g.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},Me=function(){Q.tribe=le.getCustomColorsByGroup(b.TRIBE_COLORS)||{},Q.character=le.getCustomColorsByGroup(b.PLAYER_COLORS)||{},fe()},Ce=function(){const e={id:O.getId(),x:O.getX(),y:O.getY()};O=V.getSelectedVillage(),ve([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:O.getId(),x:O.getX(),y:O.getY()}])};let xe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(Q,e.type)))return _.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!_e.test(t))return _.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;Q[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?b.PLAYER_COLORS:b.TRIBE_COLORS;return le.setCustomColorsByGroup(n,Q[e.type]),i.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(Q,e))return!1;if(!f.call(Q[e],t))return!1;delete Q[e][t]
;const n='character'===e?b.PLAYER_COLORS:b.TRIBE_COLORS;return le.setCustomColorsByGroup(n,Q[e]),i.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(Q[e],t)&&Q[e][t]},getHighlights:function(){return Q},eachHighlight:function(e){for(let t in Q)for(let i in Q[t])e(t,i,Q[t][i])},setViewport:function(e){M=e,M.style.background=Y[o.COLOR_BACKGROUND],C=M.getContext('2d')},setViewportRef:function(e){D=e,z=D.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*I,ee.y=t*I,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return xe.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const i=Ee(e[0]*t,e[1]*t),n=Ee(e[2]*t,e[3]*t);return[i.x-1,i.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},xe.getSettings=function(){return j},xe.drawMinimap=function(){me&&(me=!1),M.style.background=Y[o.COLOR_BACKGROUND],P.clearRect(0,0,x.width,x.height),d((function(){
...
K.village[i.x][i.y]=i.character_id||0,ie[i.x][i.y]=i,i.character_id&&(i.character_id in K.character?K.character[i.character_id].push([i.x,i.y]):K.character[i.character_id]=[[i.x,i.y]],i.tribe_id&&(i.tribe_id in K.tribe?K.tribe[i.tribe_id].push(i.character_id):K.tribe[i.tribe_id]=[i.character_id])))}}(L),function(){let e=[],t=[];for(let i in K.village){e.push(i);for(let e in K.village[i])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*I,J.b=Z.b*I,$.a=X.a*I,$.b=X.b*I}(),Te(),i.$on(s.VILLAGE_SELECTED_CHANGED,Ce),i.$on(s.TRIBE_RELATION_CHANGED,fe),i.$on(s.GROUPS_VILLAGES_CHANGED,Me)}))}),['initial_village','tribe_relations'])},xe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,a,d,u,g,_,p,E,f,T,w,h,b){let A,v,S,I,R,y,L,O,k,N,M,C={},x=!1,P={character:{},tribe:{}};const D={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=D.MINIMAP,G=function(e){A.selectedTab=e,e===D.MINIMAP?a.enableRendering():a.disableRendering()},U=function(){Object.keys(A.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
P.character[e]=t.character_name}))})),Object.keys(A.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!k)return;let i=V(t.x,t.y);var n,a;N=i,C[i]=!0,x=!0,(n=t.x,a=t.y,new Promise((function(e){let t=w.getTownAt(n,a);if(t)return e(t);w.loadTownDataAsync(n,a,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[V(e.x,e.y)])return;if(!x)return;L.appendChild(k),k.classList.remove('ng-hide'),y.tt.name=e.name,y.tt.x=e.x,y.tt.y=e.y,y.tt.province_name=e.province_name,y.tt.points=e.points,y.tt.character_name=e.character_name||'-',y.tt.character_points=e.character_points||0,y.tt.tribe_name=e.tribe_name||'-',y.tt.tribe_tag=e.tribe_tag||'-',y.tt.tribe_points=e.tribe_points||0,y.tt.morale=e.morale||0,y.tt.position={},y.tt.position.x=t.event.pageX+50,y.tt.position.y=t.event.pageY+50,y.tt.visible=!0
;const i=k.getBoundingClientRect(),n=L.getBoundingClientRect(),a=i.width+50,o=i.height+50,l=y.tt.position.y+o>n.top+n.height,s=y.tt.position.x+a>n.width;l&&(y.tt.position.y-=50),k.classList.toggle('left',s),k.classList.toggle('top',l)}))},W=function(e,t){if(!k)return;let i=t?V(t):N;C[i]=!1,x=!1,y.tt.visible=!1,k.classList.add('ng-hide'),O.appendChild(k)},B=function(e,t,n){let o,l,s=i.$new(),r=!0;s.colorPalettes=b.palette,'setting'===e?(l=t,o=M.get(l),r=!1,s.submit=function(){A.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){A.settings[l]=M.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=A.addHighlightColor,s.submit=function(){A.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=A.highlights[t][n],s.submit=function(){a.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},F=function(){a.addHighlight(A.selectedHighlight,A.addHighlightColor)},j=function(){M.setAll(M.decode(A.settings)),p.notif('success',m('i18n')('settings_saved',i.loc.ale,'minimap'))},Y=function(){let e=i.$new();e.title=m('i18n')('reset_confirm_title',i.loc.ale,'minimap'),e.text=m('i18n')('reset_confirm_text',i.loc.ale,'minimap'),e.submitText=m('i18n')('reset',i.loc.ale,'common'),e.cancelText=m('i18n')('cancel',i.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){M.resetAll(),p.notif('success',m('i18n')('settings_reset',i.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(A.highlights.character).length+Object.keys(A.highlights.tribe).length},Q=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},K={addHighlightAutoCompleteSelect:function(e){A.selectedHighlight={id:e.id,type:e.type,name:e.name}},
...
type:['character','tribe'],placeholder:m('i18n')('placeholder_search',i.loc.ale,'minimap'),onEnter:K.addHighlightAutoCompleteSelect},A.selectTab=G,A.openColorPalette=B,A.addCustomHighlight=F,A.removeHighlight=a.removeHighlight,A.saveSettings=j,A.resetSettings=Y,A.highlightsCount=H,A.openProfile=Q,M.injectScope(A,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){a.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,K.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,K.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,K.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,K.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,q),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,K.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,K.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,K.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',A),U(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(S),R.appendChild(I),a.enableRendering(),a.isFirstDraw()&&a.drawMinimap()};return function(){M=a.getSettings(),y=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',I=document.createElement('canvas'),I.className='cross',a.setViewport(S),a.setViewportRef(I),k=document.querySelector('#map-tooltip'),L=document.querySelector('#wrapper'),O=document.querySelector('#map'),v=t.addMenuButton('Minimapa',70),v.addEventListener('click',(function(){const e=a.getMapPosition();if(!e)return!1;Z(),a.setCurrentPosition(e.x,e.y)})),
