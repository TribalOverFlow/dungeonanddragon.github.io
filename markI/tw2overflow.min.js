...
;t.className='divisor',t.style.order=e,n.appendChild(t),o.appendChild(t),s.appendChild(t),r.appendChild(t)},c.isInitialized=function(){return u},c})),require(['two/ui'],(function(e){if(e.isInitialized())return!1;e.init()})),require(['two/language','two/ready','Lockr'],(function(e,t,i){t((function(){e.init(),function(){const e=i.get('twoverflow_version','1.0.0');if("2.0.0".endsWith('dev'))return!1;const t=function(e){if(/\d+\.\d+\.\d+/.test(e))return parseInt(e.split('.').reduce((e,t)=>e+t),10)};if(t("2.0.0")>t(e)){const e='https://gitlab.com/relaxeaza/twoverflow/blob/master/CHANGELOG.md',t=g('i18n')('check_changes',a.loc.ale,'common'),n=g('i18n')('firefox_shill',a.loc.ale,'common'),o=g('i18n')('new_version',a.loc.ale,'common',"2.0.0");a.$broadcast(l.NOTIFICATION_NEW,{message:`[b]${o}[/b]\n[url=${e}]${t}[/url]\n\n${n}`}),i.set('twoverflow_version',"2.0.0")}}()}))})),define('Lockr',(function(e,t){'use strict';return t.prefix='',t._getPrefixedKey=function(e,t){
return(t=t||{}).noPrefix?e:this.prefix+e},t.set=function(e,t,a){const i=this._getPrefixedKey(e,a);try{localStorage.setItem(i,JSON.stringify({data:t}))}catch(e){}},t.get=function(e,t,a){const i=this._getPrefixedKey(e,a);let n;try{n=JSON.parse(localStorage.getItem(i))}catch(e){n=localStorage[i]?{data:localStorage.getItem(i)}:null}return null===n?t:'object'==typeof n&&void 0!==n.data?n.data:t},t})),define('two/about',[],(function(){let e=!1,t={isInitialized:function(){return e},init:function(){e=!0}};return t})),define('two/about/ui',['two/ui'],(function(e){let t;const i=function(e){t.selectedTab=e},n=function(){t=a.$new(),t.selectTab=i,c.getModal('!twoverflow_about_window',t)};return function(){e.addDivisor(189),e.addMenuButton4('O mnie',190).addEventListener('click',(function(){n()})),
...
c.getScreenWithInjectedScope('!twoverflow_king_tool_window',u)};return function(){p=t.getSettings(),e.addDivisor(91),g=e.addMenuButton3('Marszałek',90),g.addEventListener('click',A),
