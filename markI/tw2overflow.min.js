 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),_=(injector.get('$timeout'),injector.get('storageService')),m=injector.get('reportService'),E=function(){},b=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
status_waiting_cycle:"Oczekuje",status_user_stop:"",status_expired_step:"",not_loaded:"Nie załadowany.",ignored_targets:"Ignorowane cele",no_ignored_targets:"Brak ignorowanych",included_targets:"Dodatkowe cele",no_included_targets:"Brak dodatkowych",farmer_villages:"Wioski farmiące",no_farmer_villages:"Brak wiosek farm",last_status:"Status",attacking:"Atakuje.",paused:"Zatrzymany.",command_limit:"Limit 50 ataków osiągnięty, oczekiwanie na powrót wojsk.",last_attack:"Ostatni atak",village_switch:"Przejście do wioski %{village}",no_preset:"Brak dostępnych szablonów.",no_selected_village:"Brak dostępnych wiosek.",no_units:"Brak dostępnych jednostek w wiosce, oczekiwanie na powrót wojsk.",no_units_no_commands:"Brak jednostek w wioskach lub powracających wojsk.",no_villages:"Brak dostępnych wiosek, oczekiwanie na powrót wojsk.",preset_first:"Wybierz najpierw szablon!",selected_village:"Wybrana wioska",loading_targets:"Ładowanie celów...",checking_targets:"Sprawdzanie celów...",
restarting_commands:"Restartowanie poleceń...",ignored_village:"Cel %{target} dodany do listy pominiętych.(straty)",included_village:"Cel %{target} dodany do listy zawartych",ignored_village_removed:"usunięty z listy ignorowanych",included_village_removed:"usunięty z listy zawartych",priority_target:"dodany do priorytetowych.",analyse_targets:"Analizowanie celów.",step_cycle_restart:"Restartowanie cyklu poleceń...",step_cycle_end:"Lista wiosek zakończona, oczekiwanie na następny cykl.",step_cycle_end_no_villages:"Brak wiosek do rozpoczęcia cyklu.",step_cycle_next:"Lista wiosek się skończyła, następny cykl: %d.",step_cycle_next_no_villages:"Brak wioski do rozpoczęcia cyklu, następny cykl: %d.",full_storage:"Magazyn w wiosce jest pełny",farm_stopped:"Farmer zatrzymany.",farm_started:"Farmer uruchomiony",groups_presets:"Grupy i szablony",presets:"Szablony",group_ignored:"Pomijaj wioski z grupy",group_include:"Dodaj wioski z grupy",group_only:"Atakuj tylko wioski z grup",
...
mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=b.call(o,t)?o[t]:t,e.setJSON(i[t]||i[n])}let s={init:function(){if(t)return!1;t=!0,l(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&l(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,i){const o=function(e,t){let a={};for(let i in e)b.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a},l=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),
this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return b.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!b.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),b.call(i,'min')&&(t=Math.max(i.min,t)),b.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(n,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(b.call(this.settingsMap,t)){
...
},l=[];return w.forEach((function(a){i[a]=1,l.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},I={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return I})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',100,g('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,_,m,E,b){let f,T,h=!1,v=injector.get('overviewService'),w=[],A=!1,S={},y={},I={reverse:!1,column:i.TIME_COMPLETED};const L='attack_view_filters',R={},k={},x=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},O=function(){U.loadCommands()},N=function(e,t){b.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){
for(let e=0;e<w.length;e++)w[e].command_id===t.command_id&&w.splice(e,1);b.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},P=function(e,t){for(let e=0;e<w.length;e++)w[e].target_village_id===t.village_id?(w[e].target_village_name=t.name,w[e].targetVillage.name=t.name):w[e].origin_village_id===t.village_id&&(w[e].origin_village_name=t.name,w[e].originVillage.name=t.name);b.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],U.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){return _.actualDistance(t,e)-_.actualDistance(t,a)}))},G=function(e,t){let a=0;if(E.hasTownDataInChunk(e.x,e.y)){
const a=E.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=m.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},V=function(e){w=e.commands;for(let e=0;e<w.length;e++)v.formatCommand(w[e]),w[e].slowestUnit=z(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),b.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[w])};let U={loadCommands:function(){const e=f.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},V)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],x(),g.set(L,S),U.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),U.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,T.OUT,s,{},l,p.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return h},init:function(){for(let e=0;e<d.length;e++)R[d[e]]=!0;for(let e in r)k[r[e]]=!0;try{A=require('two/commandQueue'),T=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(k),
[c.INCOMING_UNITS]:angular.copy(R),[c.VILLAGE]:!1};h=!0,f=n.getSelectedCharacter().getGlobalInfo(),S=g.get(L,t,!0),e((function(){x(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,M),a.$on(s.VILLAGE_NAME_CHANGED,P),a.$on(s.COMMAND_IGNORED,C),U.loadCommands()}),['initial_village'])}};return U})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
...
h.pagination.count=h.commands.length},L=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);I()},R=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},k=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},x=function(){h.commands=t.getCommands()},O=function(){h.selectedVillageId=n.getSelectedVillage().getId()},N=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=E,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=m,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:I,limit:_.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=p.jumpToVillage,h.now=w,h.copyTimeModal=A,h.removeTroops=S,h.switchWindowSize=y,h.toggleFilter=R,h.toggleSorting=k,I()
;let e=new i('twoverflow_queue_window',(function(){f.timer.remove(L)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,x),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,x),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,x),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,x),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),f.timer.add(L)};return function(){v=e.addMenuButton('Strażnik',40),v.addEventListener('click',N),
...
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c,d,u,p,g,_,m,E,b,f,T){let h,v,w=!1,A=!1,S=[];const y='battle_calculator_settings',I={[r.NONE]:0,[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},L={[l.NONE]:'none',[l.HALBERD_OF_GUAN_YU]:'spear',[l.PARACELSUS_LONGSWORD]:'sword',
[l.THORGARDS_BATTLE_AXE]:'axe',[l.NIMRODS_LONGBOW]:'archer',[l.MIESZKOS_LANCE]:'lc',[l.NIMRODS_COMPOSITE_BOW]:'ma',[l.BAPTISTES_BANNER]:'hc',[l.CAROLS_MORNING_STAR]:'ram',[l.ALETHEIAS_BONFIRE]:'catapult',[l.VASCOS_SCEPTER]:'snob'},R={[c.NONE]:'none',[c.HEADQUARTER]:'hq',[c.WAREHOUSE]:'wh',[c.FARM]:'fm',[c.RALLY_POINT]:'rp',[c.STATUE]:'st',[c.WALL]:'wl',[c.TAVERN]:'tv',[c.BARRACKS]:'bk',[c.PRECEPTORY]:'pc',[c.HOSPITAL]:'hp',[c.CLAY_PIT]:'cp',[c.IRON_MINE]:'im',[c.TIMBER_CAMP]:'tc',[c.CHAPEL]:'cl',[c.CHURCH]:'cc',[c.MARKET]:'mt',[c.ACADEMY]:'aa',[c.HALL_OF_ORDERS]:'ho'},k={[d.NONE]:'',[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},x={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},O={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,
[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},N={[g.NO_SKILL]:0,[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},C={[_.NO_SKILL]:0,[_.LEVEL_1]:1,[_.LEVEL_2]:2,[_.LEVEL_3]:3,[_.LEVEL_4]:4,[_.LEVEL_5]:5},P={[m.NO_SKILL]:0,[m.LEVEL_1]:100,[m.LEVEL_2]:200,[m.LEVEL_3]:300,[m.LEVEL_4]:400,[m.LEVEL_5]:500,[m.LEVEL_6]:600,[m.LEVEL_7]:700,[m.LEVEL_8]:800,[m.LEVEL_9]:900,[m.LEVEL_10]:1e3},M={[E.NO_HOSPITAL]:0,[E.LEVEL_1]:100,[E.LEVEL_2]:129,[E.LEVEL_3]:167,[E.LEVEL_4]:215,[E.LEVEL_5]:278,[E.LEVEL_6]:359,[E.LEVEL_7]:464,[E.LEVEL_8]:599,[E.LEVEL_9]:774,[E.LEVEL_10]:1e3},z={[b.NO_SKILL]:0,[b.LEVEL_1]:4,[b.LEVEL_2]:8,[b.LEVEL_3]:12,[b.LEVEL_4]:16,[b.LEVEL_5]:20};console.log(k,z,M,P,C,N,O,x,I,L,R);const D=function(){S=[];const e=n.getPresetList().getPresets();v[t.PRESETS].forEach((function(t){S.push(e[t])})),console.log('selectedPresets',S)},G={init:function(){w=!0,h=new e({settingsMap:i,storageKey:y}),h.onChange((function(e,t){v=h.getAll(),t[o.PRESETS]&&D()})),
v=h.getAll(),console.log('all settings',v),f((function(){D()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,D),a.$on(s.ARMY_PRESET_DELETED,D)},start:function(){A=!0,console.log('selectedPresets',S),T.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){A=!1,console.log('example module stop'),T.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return h},isInitialized:function(){return w},isRunning:function(){return A}};return G})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u,p,g,_,m,E,b,f,T,h,v){let w,A,S,y=n.getPresetList();const I={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},L=function(e){w.selectedTab=e},R=function(){A.setAll(A.decode(w.settings)),v.notif('success','Settings saved')},k=function(){t.isRunning()?t.stop():t.start()},x=function(){w.presets=T.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},O=function(){
w.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),v.notif('success','Example module started')},N=function(){w.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),v.notif('success','Example module stopped')},C=function(){w=a.$new(),w.SETTINGS=i,w.TAB_TYPES=I,w.running=t.isRunning(),w.selectedTab=I.BATTLE,w.settingsMap=o,w.catapulttarget=T.encodeList(d,{textObject:'battleCalculator',disabled:!0}),w.knightitem=T.encodeList(l,{textObject:'battleCalculator',disabled:!0}),w.itemlevel=T.encodeList(r,{textObject:'battleCalculator',disabled:!0}),w.order=T.encodeList(u,{textObject:'battleCalculator',disabled:!0}),w.wall=T.encodeList(p,{textObject:'battleCalculator',disabled:!0}),w.church=T.encodeList(g,{textObject:'battleCalculator',disabled:!0}),w.weaponmaster=T.encodeList(_,{textObject:'battleCalculator',disabled:!0}),w.ironwalls=T.encodeList(m,{textObject:'battleCalculator',disabled:!0}),w.clinique=T.encodeList(E,{textObject:'battleCalculator',
disabled:!0}),w.hospital=T.encodeList(b,{textObject:'battleCalculator',disabled:!0}),w.training=T.encodeList(f,{textObject:'battleCalculator',disabled:!0}),A.injectScope(w),x(),w.selectTab=L,w.saveSettings=R,w.switchState=k;let e=new h('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,x,!0),e.register(s.ARMY_PRESET_DELETED,x,!0),e.register(s.BATTLE_CALCULATOR_START,O),e.register(s.BATTLE_CALCULATOR_STOP,N),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',w)};return function(){A=t.getSettings(),S=e.addMenuButton('Kalkulator',180),S.addEventListener('click',C),
...
}})),define('two/battleCalculator/settings',[],(function(){return{BATTLE_CHURCH_A:'battle_church_a',BATTLE_KNIGHT_ITEM_D1:'battle_knight_item_d1',BATTLE_KNIGHT_ITEM_D2:'battle_knight_item_d2',BATTLE_KNIGHT_ITEM_D3:'battle_knight_item_d3',BATTLE_KNIGHT_ITEM_A:'battle_knight_item_a',BATTLE_ITEM_LEVEL_D1:'battle_item_level_d1',BATTLE_ITEM_LEVEL_D2:'battle_item_level_d2',BATTLE_ITEM_LEVEL_D3:'battle_item_level_d3',BATTLE_ITEM_LEVEL_A:'battle_item_level_a',BATTLE_CATAPULT_TARGET:'battle_catapult_target',BATTLE_CHURCH_D:'battle_church_d',BATTLE_MORALE:'battle_morale',BATTLE_LUCK:'battle_luck',BATTLE_WALL:'battle_wall',BATTLE_NIGHT_BONUS:'battle_night_bonus',BATTLE_OFFICER_LEADER:'battle_officer_leader',BATTLE_OFFICER_MEDIC:'battle_officer_medic',BATTLE_SKILL_MEDIC:'battle_skill_medic',BATTLE_SKILL_WEAPON_MASTER:'battle_skill_weapon_master',BATTLE_SKILL_IRON_WALLS:'battle_skill_iron_walls',BATTLE_SKILL_CLINIQUE:'battle_skill_clinique',BATTLE_HOSPITAL:'battle_hospital',
TROOPS_BARRACKS:'troops_barracks',TROOPS_PRECEPTORY:'troops_preceptory',TROOPS_ORDER:'troops_order',TROOPS_DOMINATION:'troops_domination',TROOPS_TRAINING:'troops_training',TROOPS_SPEAR:'troops_spear',TROOPS_SWORD:'troops_sword',TROOPS_AXE:'troops_axe',TROOPS_ARCHER:'troops_archer',TROOPS_LC:'troops_lc',TROOPS_MA:'troops_ma',TROOPS_HC:'troops_hc',TROOPS_RAM:'troops_ram',TROOPS_CATAPULT:'troops_catapult',TROOPS_KNIGHT:'troops_knight',TROOPS_SNOB:'troops_snob',TROOPS_DOPPELSOLDNER:'troops_doppelsoldner',TROOPS_TREBUCHET:'troops_trebuchet',BASHPOINTS_SPEAR:'bashpoints_spear',BASHPOINTS_SWORD:'bashpoints_sword',BASHPOINTS_AXE:'bashpoints_axe',BASHPOINTS_ARCHER:'bashpoints_archer',BASHPOINTS_LC:'bashpoints_lc',BASHPOINTS_MA:'bashpoints_ma',BASHPOINTS_HC:'bashpoints_hc',BASHPOINTS_RAM:'bashpoints_ram',BASHPOINTS_CATAPULT:'bashpoints_catapult',BASHPOINTS_KNIGHT:'bashpoints_knight',BASHPOINTS_SNOB:'bashpoints_snob',BASHPOINTS_DOPPELSOLDNER:'bashpoints_doppelsoldner',
BASHPOINTS_TREBUCHET:'bashpoints_trebuchet'}})),define('two/battleCalculator/settings/updates',(function(){return{MINIMAP:'minimap',MAP_POSITION:'map_position'}})),define('two/battleCalculator/settings/map',['two/battleCalculator/settings','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/church','two/battleCalculator/types/wall','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/order','two/battleCalculator/types/training'],(function(e,t,a,i,n,o,l,s,r,c,d,u){return{[e.BATTLE_CATAPULT_TARGET]:{default:i.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_ITEM_LEVEL_D1]:{default:a.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_ITEM_LEVEL_D2]:{default:a.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_ITEM_LEVEL_D3]:{default:a.NONE,disabledOption:!0,
inputType:'select'},[e.BATTLE_ITEM_LEVEL_A]:{default:a.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_KNIGHT_ITEM_D1]:{default:t.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_KNIGHT_ITEM_D2]:{default:t.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_KNIGHT_ITEM_D3]:{default:t.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_KNIGHT_ITEM_A]:{default:t.NONE,disabledOption:!0,inputType:'select'},[e.BATTLE_CHURCH_A]:{default:n.LEVEL_1,disabledOption:!0,inputType:'select'},[e.BATTLE_CHURCH_D]:{default:n.LEVEL_1,disabledOption:!0,inputType:'select'},[e.BATTLE_WALL]:{default:o.NO_WALL,disabledOption:!0,inputType:'select'},[e.BATTLE_NIGHT_BONUS]:{default:!1,inputType:'checkbox'},[e.BATTLE_OFFICER_LEADER]:{default:!1,inputType:'checkbox'},[e.BATTLE_OFFICER_MEDIC]:{default:!1,inputType:'checkbox'},[e.BATTLE_SKILL_MEDIC]:{default:!1,inputType:'checkbox'},[e.BATTLE_SKILL_WEAPON_MASTER]:{default:l.NO_SKILL,disabledOption:!0,inputType:'select'},[e.BATTLE_SKILL_IRON_WALLS]:{
default:s.NO_SKILL,disabledOption:!0,inputType:'select'},[e.BATTLE_SKILL_CLINIQUE]:{default:r.NO_SKILL,disabledOption:!0,inputType:'select'},[e.BATTLE_HOSPITAL]:{default:c.NO_HOSPITAL,disabledOption:!0,inputType:'select'},[e.TROOPS_BARRACKS]:{default:25,inputType:'number',min:1,max:25},[e.TROOPS_PRECEPTORY]:{default:10,inputType:'number',min:0,max:10},[e.TROOPS_ORDER]:{default:d.NONE,disabledOption:!0,inputType:'select'},[e.TROOPS_DOMINATION]:{default:!1,inputType:'checkbox'},[e.TROOPS_TRAINING]:{default:u.NO_SKILL,disabledOption:!0,inputType:'select'}}})),define('two/battleCalculator/types/item',[],(function(){return{NONE:'none',HALBERD_OF_GUAN_YU:'spear',PARACELSUS_LONGSWORD:'sword',THORGARDS_BATTLE_AXE:'axe',NIMRODS_LONGBOW:'archer',MIESZKOS_LANCE:'lc',NIMRODS_COMPOSITE_BOW:'ma',BAPTISTES_BANNER:'hc',CAROLS_MORNING_STAR:'ram',ALETHEIAS_BONFIRE:'catapult',VASCOS_SCEPTER:'snob'}})),define('two/battleCalculator/types/level',[],(function(){return{NONE:0,LEVEL_1:1,LEVEL_2:2,LEVEL_3:3}
})),define('two/battleCalculator/types/catapult-target',[],(function(){return{NONE:'none',HEADQUARTER:'hq',WAREHOUSE:'wh',FARM:'fm',RALLY_POINT:'rp',STATUE:'st',WALL:'wl',TAVERN:'tv',BARRACKS:'bk',PRECEPTORY:'pc',HOSPITAL:'hp',CLAY_PIT:'cp',IRON_MINE:'im',TIMBER_CAMP:'tc',CHAPEL:'cl',CHURCH:'cc',MARKET:'mt',ACADEMY:'aa',HALL_OF_ORDERS:'ho'}})),define('two/battleCalculator/types/order',[],(function(){return{NONE:'none',TEUTONIC_ORDER:'teutonic',TEMPLAR_ORDER:'templar'}})),define('two/battleCalculator/types/church',[],(function(){return{NO_CHURCH:'without',LEVEL_1:'first_level',LEVEL_2:'second_level',LEVEL_3:'third_level'}})),define('two/battleCalculator/types/wall',[],(function(){return{NO_WALL:'without',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5',LEVEL_6:'level_6',LEVEL_7:'level_7',LEVEL_8:'level_8',LEVEL_9:'level_9',LEVEL_10:'level_10',LEVEL_11:'level_11',LEVEL_12:'level_12',LEVEL_13:'level_13',LEVEL_14:'level_14',LEVEL_15:'level_15',
LEVEL_16:'level_16',LEVEL_17:'level_17',LEVEL_18:'level_18',LEVEL_19:'level_19',LEVEL_20:'level_20'}})),define('two/battleCalculator/types/weapon-master',[],(function(){return{NO_SKILL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5'}})),define('two/battleCalculator/types/iron-walls',[],(function(){return{NO_SKILL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5'}})),define('two/battleCalculator/types/clinique',[],(function(){return{NO_SKILL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5',LEVEL_6:'level_6',LEVEL_7:'level_7',LEVEL_8:'level_8',LEVEL_9:'level_9',LEVEL_10:'level_10'}})),define('two/battleCalculator/types/hospital',[],(function(){return{NO_HOSPITAL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5',
LEVEL_6:'level_6',LEVEL_7:'level_7',LEVEL_8:'level_8',LEVEL_9:'level_9',LEVEL_10:'level_10'}})),define('two/battleCalculator/types/training',[],(function(){return{NO_SKILL:'without',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5'}})),require(['two/ready','two/battleCalculator','two/battleCalculator/ui','two/battleCalculator/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,_,m,E,b,f){let T,h,v,w=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const L={};let R,k,x,O,N,C=!0
;const P='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=k.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void V(t))}))},D=function(){G().forEach((function(e){const t=k.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){S.canBeFinishedForFree(a,t)&&A.instantBuild(a,m.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=R.getGroupVillageIds(e),a=a.filter((function(e){return k.getVillage(e)}))):t.each(k.getVillages(),(function(e){a.push(e.getId())})),a},V=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(L);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return w.compute(e),
U(e,a,(function(t,a){t&&a.job&&(E.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),F(e.getId(),a.job))})),!0}))},U=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)B(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=v[_.FARM];e.getBuildingData().getDataForBuilding(_.FARM).level<t&&B(e,_.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:m.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<v[t])return!1;return!0},F=function(e,t){let a={time:f.gameTime(),villageId:e,building:t.building,level:t.level}
;return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),b.set(P,x),!0};let j={};return j.start=function(){if(!C)return E.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,T=setInterval(z,6e4),h=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=k.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),E.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){I=!1,clearInterval(T),clearInterval(h),E.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return I},j.isInitialized=function(){return y},j.getSettings=function(){return O},j.getLogs=function(){return x},j.clearLogs=function(){x=[],b.set(P,x),E.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){
let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES];if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,x=b.get(P,[],!0),k=n.getSelectedCharacter(),R=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),I&&t[d.ANALYSE]&&z(),a.quiet||E.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in _)L[_[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,v=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(L)
;return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=k.getVillage(t.village_id);V(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,m,E,f,T,h,v,w){let A,S,y,I,L=n.getGroupList(),R={},k=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,M={},z={},D=!1,G=!1;const V=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},U=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
...
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},x.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=x.selectedSequence.name,i=A.settings[m.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},N.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;N.visibleLogs=N.logs.slice(e,e+t),
A.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[T.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(A.settings[m.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[m.BUILDING_SEQUENCES][e.name]=t,F(),O.selectedSequence={name:e.name,value:e.name},x.selectedSequence={name:e.name,value:e.name},O.generateSequences(),x.generateBuildingSequence(),e.closeWindow(),W(C.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},F=function(){I.setAll(I.decode(A.settings)),D=!1},j=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){D?Y((function(){P()})):P()},K={updateGroups:function(){A.groups=p.encodeList(L.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(m.BUILDING_SEQUENCES);A.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){x.generateBuildingSequence()},
updateLogs:function(){A.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=I.get(m.BUILDING_SEQUENCES);A.settings[m.BUILDING_SEQUENCES][t]=i[t],A.settings[m.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=I.get(m.BUILDING_SEQUENCES);A.settings[m.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[m.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(b.call(e,t))return t;return!1}(A.settings[m.BUILDING_SEQUENCES]);x.selectedSequence={name:i,value:i},K.updateSequences(),x.generateBuildingSequence(),I.get(m.ACTIVE_SEQUENCE)===t&&(I.set(m.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(m.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=C.SETTINGS,A.TAB_TYPES=C,A.SETTINGS=m,A.running=k,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=z,A.villagesInfo=M,A.editorView=x,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=T.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=O,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=N,A.logsView.logs=i.getLogs(),A.selectTab=W,A.switchBuilder=j,A.saveSettings=F,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,I.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
...
O.generateBuildingsLevelPoints(),I=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),v.register(s.BUILDER_QUEUE_START,(function(){k=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),v.register(s.BUILDER_QUEUE_STOP,(function(){k=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const v=Object.values(c),w=Object.values(a),A=Object.values(h),S=Object.values(T),y=Object.values(f);let I,L=[],R={},k=[],x=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<g.gameTime()+I},P=function(e){L.push(e)},M=function(e){R[e.id]=e},z=function(){
E.set(d.QUEUE_COMMANDS,L)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return b.call(e,'x')&&b.call(e,'y')&&D(e.x)&&D(e.y)};let V={initialized:!1};return V.init=function(){I=t.getTimeOffset(),V.initialized=!0,k=E.get(d.QUEUE_SENT,[],!0),x=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?V.expireCommand(e,i.TIME_LIMIT):(P(e),M(e))}))}(),setInterval((function(){L.length&&L.some((function(e){if(!C(e.sendTime))return!0;O?V.sendCommand(e):V.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&L.length&&(e.returnValue=!0)}))},V.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return V.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){k.push(e)}(e),E.set(d.QUEUE_SENT,k),V.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},V.expireCommand=function(e,t){!function(e){x.push(e)}(e),E.set(d.QUEUE_EXPIRED,x),V.removeCommand(e,t)},V.addCommand=function(e,i,o,l,s,r,d,p){let _={},E={};return new Promise((function(b,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(i))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(_[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(_,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[T.SUPPORTER]&&delete E[T.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!_[h.CATAPULT])&&(p||f.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>m.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>m.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return I(u.INVALID_ORIGIN);if(!i)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,_,d,E,!0),c=l===a.ARRIVE?s-r:s,m=l===a.ARRIVE?s:s+r;if(C(c))return I(u.ALREADY_SENT);const f={id:t.guid(),travelTime:r,arriveTime:m,sendTime:c,origin:e,target:i,date:o,dateType:l,units:_,officers:E,type:d,catapultTarget:p,countdown:c-g.gameTime()};P(f),M(f),L=L.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),b(f)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},V.removeCommand=function(e,t){delete R[e.id];const a=L.some((function(t,a){if(t.id==e.id)return L.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},V.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),x=[],k=[]},V.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},V.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},V.isRunning=function(){return O},V.getWaitingCommands=function(){return L},V.getWaitingCommandsObject=function(){return R},V.getSentCommands=function(){return k},
V.getExpiredCommands=function(){return x},V.filterCommands=function(e,t,a){const i=N[e];return(a||L).filter((function(e){return i(e,t)}))},V})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,_,m,E,b,f,T,h){let v,w,A,S,y,I=n.getGameData(),L=I.getOrderedUnitNames(),R=I.getOrderedOfficerNames(),k=n.getPresetList(),x=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,P,M,z=[],D={},G={};const V={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},U=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){x=t.data},q=function(){x=!1},W=function(e){
const t=new Date(e||f.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=f.zerofill(a-a%100,3),n=f.zerofill(t.getSeconds(),2),l=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},F=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},j=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(V,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);v.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),v.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&v.isValidDate?f.gameTime()+C<e?'valid':'invalid':'neutral'},H=function(){y.dateType=v.selectedDateType.value,h.set(_.LAST_DATE_TYPE,v.selectedDateType.value),j()},K=function(){
y.catapultTarget=v.catapultTarget.value},Q=function(){const e=v.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,v.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},v.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=f.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),f.timer.add(e.updateCountdown)},X=function(){v.waitingCommands=t.getWaitingCommands()},J=function(){v.sentCommands=t.getSentCommands()},$=function(){v.expiredCommands=t.getExpiredCommands()},ee=function(){let e=v.waitingCommands;U.forEach((function(a){v.activeFilters[a]&&(e=t.filterCommands(a,v.filtersData,e))})),
...
o.notif('success',_e(e.type,'added'))})).catch((function(t){switch(t){case m.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case m.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case m.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case m.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case m.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case m.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},_e=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},me=function(e,t){v.activeFilters[e]=!v.activeFilters[e],
t&&(v.filtersData[u.ALLOWED_TYPES][e]=!v.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){v.activeFilters[u.TEXT_MATCH]=v.filtersData[u.TEXT_MATCH].length>0,ee()},be={updatePresets:function(){v.presets=o.obj2selectOptions(k.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},v.searchQuery[i]=''},removeCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',_e(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',_e(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',_e(t.type,'sent'))},start:function(e,a){if(v.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',_e('title','activated'))},stop:function(){v.running=t.isRunning(),o.notif('success',_e('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{f.timer.remove(e.updateCountdown)})}},fe=function(){const e=h.get(_.LAST_DATE_TYPE,l.OUT,!0);let m;v=a.$new(),v.selectedTab=N,v.inventory=n.getInventory(),v.presets=o.obj2selectOptions(k.getPresets()),v.travelTimes={},o.each(p,(function(e){v.travelTimes[e]={},o.each(V,(function(t,a){v.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),v.unitOrder=S,v.officers=I.getOrderedOfficerNames(),v.searchQuery={origin:'',target:''},v.isValidDate=!1,v.dateTypes=T.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),v.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},v.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},v.showCatapultSelect=!!y.units.catapult,v.attackableBuildings=z,v.commandData=y,
v.activeFilters=P,v.filtersData=M,v.running=t.isRunning(),v.waitingCommands=t.getWaitingCommands(),v.visibleWaitingCommands=t.getWaitingCommands(),v.sentCommands=t.getSentCommands(),v.expiredCommands=t.getExpiredCommands(),v.EVENT_CODES=d,v.FILTER_TYPES=u,v.TAB_TYPES=O,v.COMMAND_TYPES=p,v.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),v.onUnitInputFocus=te,v.onUnitInputBlur=ae,v.catapultTargetVisibility=ie,v.selectTab=ne,v.addSelected=oe,v.addMapSelected=le,v.addCurrentDate=se,v.incrementDate=re,v.reduceDate=ce,v.cleanUnitInputs=de,v.addCommand=ue,v.clearRegisters=pe,v.switchCommandQueue=ge,v.removeCommand=t.removeCommand,v.openVillageInfo=r.openVillageInfo,v.toggleFilter=me,v.$watch('commandData.origin',j),v.$watch('commandData.target',j),v.$watch('commandData.date',j),v.$watch('commandData.officers',j),v.$watch('selectedDateType.value',H),v.$watch('selectedInsertPreset.value',Q),v.$watch('catapultTarget.value',K),v.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
v.$watch('selectedTab',(function(){v.selectedTab===O.ADD?m=setInterval((function(){j()}),2500):clearInterval(m)})),v.waitingCommands.forEach(e=>{Z(e)});let E=new i('twoverflow_queue_window',(function(){clearInterval(m),be.clearCountdownUpdates()}));E.register(s.ARMY_PRESET_UPDATE,be.updatePresets,!0),E.register(s.ARMY_PRESET_DELETED,be.updatePresets,!0),E.register(s.SELECT_SELECTED,be.autoCompleteSelected,!0),E.register(s.COMMAND_QUEUE_REMOVE,be.removeCommand),E.register(s.COMMAND_QUEUE_REMOVE_ERROR,be.removeError),E.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,be.sendTimeLimit),E.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,be.sendNotOwnVillage),E.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,be.sendNoUnitsEnough),E.register(s.COMMAND_QUEUE_SEND,be.sendCommand),E.register(s.COMMAND_QUEUE_START,be.start),E.register(s.COMMAND_QUEUE_STOP,be.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){A=n.getSelectedCharacter(),C=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(L),S.splice(S.indexOf('catapult'),1),L.forEach((function(e){D[e]=0})),R.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',20),w.addEventListener('click',fe),E.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),E.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,_,m,f,T,h,v,w,A,S,y,I){let L,R,k,x,O,N=!1,C=!1,P=[],M=[],z=[],D=[],G=[],V=[],U=!1,B=!1,q=!1,W=0,F=null,j=null,Y=null,H={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(R[r.MIN_DISTANCE],R[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===x.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(R[r.MIN_POINTS],R[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=R[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=R[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=R[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!x.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){b.call(k,e)||(k[e]={time:h.gameTime(),report:!1},t=!0)})),m.each(k,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete k[i],t=!0)})),t&&(I.set($,k),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),v.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=R[r.GROUP_INCLUDE],i=R[r.GROUP_IGNORE],n=R[r.GROUP_ONLY],o=x.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(Le(t.village_id),l=!0):(xe(t.village_id),Ee(g.IGNORED_VILLAGE,{villageId:t.village_id}),me(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),Ee(g.INCLUDED_VILLAGE,{villageId:t.village_id}),me(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=R[r.GROUP_INCLUDE],i=R[r.GROUP_IGNORE],n=R[r.GROUP_ONLY],o=x.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}else Oe(),Ee(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),Ee(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Le(t.village_id),l=!0),l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=R[r.GROUP_IGNORE],i=R[r.GROUP_ONLY],o=R[r.GROUP_INCLUDE],l=b.call(t,a)?a:L.getDefault(r.GROUP_IGNORE),s=i.filter(e=>b.call(t,e)),c=o.filter(e=>b.call(t,e));L.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Ie(),Oe(),ye()},ce=function(){V=[];const e=n.getPresetList().getPresets();R[r.PRESETS].forEach((function(t){if(!b.call(e,t))return;let a=e[t];a.load=_e(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),V.push(a)})),V=V.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),V.length||(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),C&&Ne.stop())},ue=function(e,t){R[r.IGNORE_ON_LOSS]&&R[r.GROUP_IGNORE]&&C&&t.type===w.TYPES.ATTACK&&1!==t.result&&ke(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=R[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){U&&q&&t.origin.id===U.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&U.commandSent(t)},ge=function(e,t){U&&B&&q&&t.cause===l.SEND_PRESET.type&&U.commandError(t)},_e=function(e){let t=0;return m.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},me=function(e){k[e]={time:h.gameTime(),report:H[e]||!1},delete H[e],I.set($,k),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,M.unshift(t),be(),!0)},be=function(){const e=R[r.LOGS_LIMIT];M.length>e&&M.splice(M.length-e,M.length),I.set(X,M),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},fe=function(e,t,a){const i=R[r.TARGET_MULTIPLE_FARMERS],n=R[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},Te=function(){K=h.gameTime()},he=function(){clearTimeout(F),clearTimeout(j),clearTimeout(Y),F=null,j=null,Y=null
},ve=function(){return Math.max(1,60*R[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*R[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=x.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=i.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{v.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return Te(),!this.running&&(this.initialized?this.targets.length?(U=this,this.running=!0,v.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,v.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=E},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;Te();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,_=!1;const E=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return a(i.USER_STOP);t()},m.randomSeconds(we())):t()}),f=()=>new Promise((e,a)=>{const n=50-R[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(R[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),L=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),k=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(V.forEach((function(e){b.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)b.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),O=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*R[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=T.actualDistance(l,a);m.each(V,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,p=x.getVillageList();const o=p.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),fe(u,c,o))return n(i.BUSY_TARGET);o&&(_=!0),e()}),C=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*R[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(R[r.TARGET_SINGLE_ATTACK]&&!R[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=R[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),_=T.actualDistance(s,a),m=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(g,m,_,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(_)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(fe(l,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{E().then(f).then(S).then(I).then(L).then(k).then(O).then(N).then(C).then(P).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,D]).then(()=>{if(!this.running)return!1
...
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){B=!1,q=!1,he(),Ee(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){B=!1,q=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();_.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=T.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,R[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=R[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),P.push(a)),a},ye=function(){m.each(x.getVillages(),(function(e,t){Se(t)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=R[r.GROUP_ONLY];let t=[];P.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Le(e)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Le=function(e){for(let a=0;a<P.length;a++)if(P[a].getId()===e)return P[a].stop(t.KILL_FARMER),P.splice(a,a+1),!0;return!1
},Re=function(e){Te(),P.length?W>=P.length?(W=0,U=!1,Z=h.gameTime()+ve(),v.trigger(s.FARM_OVERFLOW_CYCLE_END)):U=P[W]:U=!1,U?(U.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,Re())})),"cycle_begin"===e&&(Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),U.start()):F=setTimeout((function(){F=null,W=0,Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Re()}),ve())},ke=function(e){for(let t=0;t<P.length;t++){let a=P[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){P.forEach((function(t){t.removeTarget(e)}))},Oe=function(){_.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=I.get(X,[]),k=I.get($,{}),x=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),L=new e({settingsMap:c,storageKey:J}),L.onChange((function(e,t,a){R=L.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(Ie(),ye()),t[p.LOGS]&&be(),t[p.INTERVAL_TIMERS]&&C&&(j?(he(),
U.targetStep({delay:!0})):F&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,Re())))})),R=L.getAll(),se("ignore_update"),ne(),ye(),f((function(){ce()}),'presets'),f((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(V.length?(C=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Re("cycle_begin")})),Te(),function(){let e=ve(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void Ee(g.FARM_START)):(C=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){U?(U.stop(e),
e!==i.USER_STOP&&(Z=h.gameTime()+ve()),v.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,he(),v.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&Ee(g.FARM_STOP)},Ne.getFarmer=function(e){return P.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return P},Ne.getSettings=function(){return L},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return k},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return C},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],I.set(X,M),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=ve,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,E,b,f,T,h,v){let w,A,S,y=n.getPresetList(),I=n.getGroupList(),L={},R={},k=null;const x={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(L[e])return L[e];L[e]=!0,R[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){L[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},R[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
w.exceptionVillages.included.forEach((function(e){N(e)})),w.exceptionVillages.ignored.forEach((function(e){N(e)}))},P=function(){t.isRunning()?t.stop():t.start()},M=function(e){w.selectedTab=e},z=function(){A.setAll(A.decode(w.settings)),w.saveButtonColor='orange',T.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(E.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(E.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},V=function(){w.presets=b.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},U=function(){w.groups=b.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=b.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},B=function(){w.running=!0,
T.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(k),t.reason){case d.NO_PRESETS:T.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){w.logs=angular.copy(t.getLogs()),O(),w.logs.length||T.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){w.farmers=t.getFarmers()},j=function(){w.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(k)},K=function(e,a){a!==i.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),k=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=E,w.TAB_TYPES=x,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=x.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=R,w.villagesInfo=L,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=A.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:O,limit:_.getPaginationLimit()},A.injectScope(w),V(),U(),O(),C(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-v.gameTime(),k=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=P,w.selectTab=M,w.saveSettings=z,w.clearLogs=t.clearLogs,w.jumpToVillage=p.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=m.showReport,w.removeIgnored=D,w.removeIncluded=G;let i=new f('twoverflow_farm_overflow_window',(function(){clearInterval(k)}));i.register(s.ARMY_PRESET_UPDATE,V,!0),i.register(s.ARMY_PRESET_DELETED,V,!0),i.register(s.GROUPS_UPDATED,U,!0),i.register(s.GROUPS_CREATED,U,!0),i.register(s.GROUPS_DESTROYED,U,!0),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,_,m,E,f,T,h,v,w,A){let S,y,I,L,R,k,x,O,N,C,P,M,z,D,G,V,U,B,q,W,F,j,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const _e=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,me=function(e){let t=Math.ceil(ee.x+e.offsetX)-L,a=Math.ceil(ee.y+e.offsetY)+L;return Math.floor(a/y)%2&&(t+=L),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},Ee=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},be=function(){Ae(R)},fe=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};C.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(P,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,I),D.fillRect(0,i,I,1);const n=V.getBoundingClientRect(),l=n.width/w.TILESIZE.x/A.view.z*y,s=n.height/w.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(fe)
},Te=function(){if(!ie)return!1;const e=Q.village[x][O];ve(e?Q.character[e]:[[x,O]]),ie=!1,_.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===k.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(F&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(F.isAlly(e.tribe_id))return W.ally;if(F.isEnemy(e.tribe_id))return W.enemy;if(F.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||we(i);if(!n)continue;const o=i.x*y+(i.y%2?L:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],L=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,P.width=1e3*y,P.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(_.trigger(s.MINIMAP_VILLAGE_CLICK,[x,O,e]),3===e.which&&(a=x,i=O,E.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),_.trigger(s.MINIMAP_START_MOVE)},Le=function(){de=!1,ue={},ce||_.trigger(s.MINIMAP_STOP_MOVE)},Re=function(e){if(ce=!1,pe=me(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(x===e.x&&O===e.y)return!1;Te()}ie=!0,x=e.x,O=e.y,_.trigger(s.MINIMAP_VILLAGE_HOVER,{x:x,y:O,event:t});const a=Q.village[x][O];he(a?Q.character[a]:[[x,O]])}(pe,e)}Te()},ke=function(){ie&&Te(),
_.trigger(s.MINIMAP_MOUSE_LEAVE)},xe=function(e){if(!ce)return!1;const t=me(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},be()},Ce=function(){const e={id:k.getId(),x:k.getX(),y:k.getY()};k=U.getSelectedVillage(),Ae([{character_id:U.getId(),id:e.id,x:e.x,y:e.y},{character_id:U.getId(),id:k.getId(),x:k.getX(),y:k.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&b.call(K,e.type)))return _.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!_e.test(t))return _.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),be(),!0},removeHighlight:function(e,t){if(void 0===t||!b.call(K,e))return!1;if(!b.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),be(),!0},getHighlight:function(e,t){return!!b.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],C=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Ee(e[0]*t,e[1]*t),i=Ee(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return j},Pe.drawMinimap=function(){ge&&(ge=!1),N.style.background=Y[o.COLOR_BACKGROUND],M.clearRect(0,0,P.width,P.height),d((function(){
!function(){const e=T.getPath(w.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*y+L-1,t*y+L-1,3,1),M.fillRect(e*y+L,t*y+L-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*y+L,t*y+L-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=f.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),be()}),'minimap_data')},Pe.enableRendering=function(){H=!0},Pe.disableRendering=function(){H=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),M=P.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),Se(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),Y=j.getAll(),K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){V=document.getElementById('map'),G=document.getElementById('main-canvas'),U=n.getSelectedCharacter(),F=U.getTribeRelations(),B=U.getId(),q=U.getTribeId(),W=U.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),k=U.getSelectedVillage(),te.x=k.getX(),te.y=k.getY(),ee.x=k.getX()*y,ee.y=k.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Ie),z.addEventListener('mouseup',Le),z.addEventListener('mousemove',Re),z.addEventListener('mouseleave',ke),z.addEventListener('click',xe),z.addEventListener('contextmenu',Oe),g.load((function(){R=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(R),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),fe(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ce),a.$on(s.TRIBE_RELATION_CHANGED,be),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,_,m,E,b,f,T,h,v){let w,A,S,y,I,L,R,k,x,O,N,C={},P=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){w.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},V=function(){Object.keys(w.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},U=function(e,t){return String(e)+String(t)},B=function(e,t){if(!x)return;let a=U(t.x,t.y);var i,n;O=a,C[a]=!0,P=!0,(i=t.x,n=t.y,new Promise((function(e){let t=T.getTownAt(i,n);if(t)return e(t);T.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[U(e.x,e.y)])return;if(!P)return;R.appendChild(x),x.classList.remove('ng-hide'),L.tt.name=e.name,L.tt.x=e.x,L.tt.y=e.y,L.tt.province_name=e.province_name,L.tt.points=e.points,L.tt.character_name=e.character_name||'-',L.tt.character_points=e.character_points||0,L.tt.tribe_name=e.tribe_name||'-',L.tt.tribe_tag=e.tribe_tag||'-',L.tt.tribe_points=e.tribe_points||0,L.tt.morale=e.morale||0,L.tt.position={},L.tt.position.x=t.event.pageX+50,L.tt.position.y=t.event.pageY+50,L.tt.visible=!0
;const a=x.getBoundingClientRect(),i=R.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=L.tt.position.y+o>i.top+i.height,s=L.tt.position.x+n>i.width;l&&(L.tt.position.y-=50),x.classList.toggle('left',s),x.classList.toggle('top',l)}))},q=function(e,t){if(!x)return;let a=t?U(t):O;C[a]=!1,P=!1,L.tt.visible=!1,x.classList.add('ng-hide'),k.appendChild(x)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=v.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},F=function(){n.addHighlight(w.selectedHighlight,w.addHighlightColor)},j=function(){N.setAll(N.decode(w.settings)),m.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),m.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){V()},highlightAddErrorExists:function(){m.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){m.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){m.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=z,w.selectedTab=D,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=n.getHighlights(),w.highlightNames=M,w.mapSizes=b.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=b.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=G,w.openColorPalette=W,w.addCustomHighlight=F,w.removeHighlight=n.removeHighlight,w.saveSettings=j,w.resetSettings=Y,w.highlightsCount=H,w.openProfile=K,N.injectScope(w,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,B),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),V(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),L=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),x=document.querySelector('#map-tooltip'),R=document.querySelector('#wrapper'),k=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',_='060506',m='060502',E='060501',b='060503',f='05020a',T='05030a',h='04080a',v='040a0a',w='070e04',A='070e05',S='070e0f',y='070e06',I='070e02',L='070e01',R='070e03',k='070e07',x='070e0b',O='070e0e',N='030d07',C='030d0b',P='030d0e';var M={init:function(){i=!0}};return M.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,_='string'==typeof _?parseInt(_,16):_,m='string'==typeof m?parseInt(m,16):m,E='string'==typeof E?parseInt(E,16):E,b='string'==typeof b?parseInt(b,16):b,f='string'==typeof f?parseInt(f,16):f,T='string'==typeof T?parseInt(T,16):T,h='string'==typeof h?parseInt(h,16):h,v='string'==typeof v?parseInt(v,16):v,w='string'==typeof w?parseInt(w,16):w,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,L='string'==typeof L?parseInt(L,16):L,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,x='string'==typeof x?parseInt(x,16):x,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,C='string'==typeof C?parseInt(C,16):C,P='string'==typeof P?parseInt(P,16):P,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
