...
},T=function(){t.isRunning()?t.stop():t.start()},h=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},v=function(){u.groups=l.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.BATTLE,u.settingsMap=o,p.injectScope(u),h(),v(),u.selectTab=f,u.saveSettings=E,u.switchState=T;let e=new r('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,h,!0),e.register(s.ARMY_PRESET_DELETED,h,!0),e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.BATTLE_CALCULATOR_START,w),
e.register(s.BATTLE_CALCULATOR_STOP,A),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Kalkulator',180),g.addEventListener('click',S),
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,T,h,v,w){let A,S,y,I,R=n.getGroupList(),k={},x=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
L.updateVisibleBuildingSequence()},L.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;L.visibleBuildingSequence=L.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=L.buildingSequence.length},L.updateBuildingSequence=function(){const e=L.selectedSequence.value,t=L.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:D=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},L.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
...
v.$watch('selectedTab',(function(){v.selectedTab===O.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),v.waitingCommands.forEach(e=>{Z(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),b.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),b.register(s.COMMAND_QUEUE_START,fe.start),b.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){A=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',20),w.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
B.targetStep({delay:!0})):F&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),se("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){C.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!P&&(U.length?(P=!0,e=[],C.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),Te(),function(){let e=ve(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){B?(B.stop(e),
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,T,h,v){let w,A,S,y=n.getPresetList(),I=n.getGroupList(),R={},k={},x=null;const L={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
w.exceptionVillages.included.forEach((function(e){N(e)})),w.exceptionVillages.ignored.forEach((function(e){N(e)}))},C=function(){t.isRunning()?t.stop():t.start()},M=function(e){w.selectedTab=e},z=function(){A.setAll(A.decode(w.settings)),w.saveButtonColor='orange',T.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){w.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){w.groups=f.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=f.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},V=function(){w.running=!0,
T.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(x),t.reason){case d.NO_PRESETS:T.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){w.logs=angular.copy(t.getLogs()),O(),w.logs.length||T.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){w.farmers=t.getFarmers()},j=function(){w.exceptionVillages=t.getExceptionVillages(),P()},Y=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(x)},K=function(e,a){a!==i.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),x=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=b,w.TAB_TYPES=L,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=L.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=k,w.villagesInfo=R,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=A.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(w),U(),B(),O(),P(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-v.gameTime(),x=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=C,w.selectTab=M,w.saveSettings=z,w.clearLogs=t.clearLogs,w.jumpToVillage=p.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=_.showReport,w.removeIgnored=D,w.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(x)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,B,!0),i.register(s.GROUPS_CREATED,B,!0),i.register(s.GROUPS_DESTROYED,B,!0),
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,f,E,T,h,v){let w,A,S,y,I,R,k,x,L,O,N,P={},C=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){w.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(w.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=G,w.openColorPalette=W,w.addCustomHighlight=F,w.removeHighlight=n.removeHighlight,w.saveSettings=j,w.resetSettings=Y,w.highlightsCount=H,w.openProfile=K,N.injectScope(w,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),U(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),R=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),L=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),x=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
