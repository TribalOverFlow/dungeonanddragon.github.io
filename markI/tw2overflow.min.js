...
m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){p=!0,c=new e({settingsMap:n,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&T(),t[l.GROUPS]&&E()})),d=c.getAll(),console.log('activityTool settings',d),o((function(){T()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,T),a.$on(s.ARMY_PRESET_DELETED,T),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){u=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.ACTIVITY_TOOL_START)},stop:function(){u=!1,console.log('example module stop'),r.trigger(s.ACTIVITY_TOOL_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return f})),define('two/activityTool/events',[],(function(){angular.extend(s,{ACTIVITY_TOOL_START:'activity_tool_start',ACTIVITY_TOOL_STOP:'activity_tool_stop'})})),
define('two/activityTool/ui',['two/ui','two/activityTool','two/activityTool/settings','two/activityTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let p,u,g,m=i.getPresetList(),b=i.getGroupList();const T={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){p.selectedTab=e},f=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},A=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.SETTINGS,p.settingsMap=l,
u.injectScope(p),A(),w(),p.selectTab=E,p.saveSettings=f,p.switchState=_;let e=new r('twoverflow_activity_tool_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.ACTIVITY_TOOL_START,h),e.register(s.ACTIVITY_TOOL_STOP,S),c.getScreenWithInjectedScope('!twoverflow_activity_tool_window',p)};return function(){u=t.getSettings(),g=e.addMenuButton3('Kwatermistrz',60),g.addEventListener('click',v),
...
require(['two/ready','two/activityTool','two/activityTool/ui','two/activityTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,n){let r;var c=injector.get('overviewService'),d=!1,p=!1,u=i.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=i.getSelectedCharacter(),b=m.tribeById[0],T=m.getVillageList(),E=[],f=m.data.character_id,_=m.data.character_name,A=[],w=[],h=[n.LIGHT_CAVALRY,n.HEAVY_CAVALRY,n.AXE,n.SWORD,n.RAM,n.SNOB,n.TREBUCHET];var S=function(){l.emit(o.TRIBE_GET_MEMBERLIST,{tribe:b},(function(e){for(var t=e.members,a=0;a<t.length;a++)w.push(t[a].id)})),T.forEach((function(e){E.push(e.getId())}));var e=u.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;l.emit(o.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],
villages:E},v),setTimeout(S,6e4)},v=function(e){for(var t,a=[],n=e.commands,i=0;i<n.length;i++)if(c.formatCommand(n[i]),w.includes(n[i].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+n[i].origin_character_id+' Rodzaj '+n[i].command_type);else if('attack'==n[i].command_type)if(A.includes(n[i].command_id))console.log('Już wysłano powiadomienie');else{A.push(n[i].command_id),n[i].slowestUnit=R(n[i]);var s=n[i].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),p='',u='';'sword'==n[i].slowestUnit?(u=' [color=03709d]MIECZNIK[/color]',p='sword'):'axe'==n[i].slowestUnit?(u=' [color=e21f1f]TOPORNIK[/color]',p='axe'):'ram'==n[i].slowestUnit?(u=' [color=730202]TARAN[/color]',p='ram'):'snob'==n[i].slowestUnit?(u=' [color=ffee00]SZLACHCIC[/color]',p='snob'):'trebuchet'==n[i].slowestUnit?(u=' [color=494500]TREBUSZ[/color]',p='trebuchet'):'light_cavalry'==n[i].slowestUnit?(u=' [color=d96a19]LEKKA KAWALERIA[/color]',
p='light_cavalry'):'heavy_cavalry'==n[i].slowestUnit&&(u=' [color=0111af]CIĘŻKA KAWALERIA[/color]',p='heavy_cavalry'),a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+p+'[/unit] [size=large][b]'+u+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+n[i].target_village_id+']'+n[i].target_village_name+'[/village][b] Gracz cel: [/b][player='+f+']'+_+'[/player][b] [br]Wioska pochodzenia: [/b][village='+n[i].origin_village_id+']'+n[i].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+n[i].origin_character_id+']'+n[i].origin_character_name+'[/player][/size]');var g=a.join();'snob'==p||'trebuchet'==p?('Hajduk Split'==_||'halfsack'==_||'Black Rider'==_?l.emit(o.MESSAGE_REPLY,{message_id:14378,message:g}):l.emit(o.MESSAGE_REPLY,{message_id:4646,message:g}),a=[]):('Hajduk Split'==_||'halfsack'==_||'Black Rider'==_?l.emit(o.MESSAGE_REPLY,{message_id:14379,message:g}):l.emit(o.MESSAGE_REPLY,{message_id:4648,
message:g}),a=[])}},R=function(e){var a=e.model.duration,n={},i={x:e.origin_x,y:e.origin_y},l={x:e.target_x,y:e.target_y},o=[];return h.forEach((function(a){n[a]=1,o.push({unit:a,duration:t.getTravelTime(i,l,n,e.command_type,{})})})),(o=o.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},y={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),p=!0,S()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),p=!1},isRunning:function(){return p},isInitialized:function(){return d}};return y})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,n,i){let l;return function(){return l=e.addMenuButton('Wartownik',60,g('i18n')('description',a.loc.ale,'alert_sender')),
...
define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r,c){let d,p,u=!1,g=!1,m=[],b=[];const T='army_helper_settings',E={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(E);const f=function(){m=[],b=[];const e=i.getGroupList().getGroups(),a=p[t.GROUP3],n=p[t.GROUP4];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){b.push(e[t])}))},_={init:function(){u=!0,d=new e({settingsMap:n,storageKey:T}),d.onChange((function(e,t){p=d.getAll(),t[l.GROUPS]&&f()})),p=d.getAll(),console.log('armyHelper settings',p),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),
a.$on(s.GROUPS_UPDATED,f)},start:function(){g=!0,c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return _})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p){let u,m,b,T=i.getGroupList();const E={ARMY:'army',BALANCER:'balancer',LOGS:'logs'},f=function(e){u.selectedTab=e},_=function(){m.setAll(m.decode(u.settings)),p.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()},w=function(){u.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,b.classList.remove('btn-orange'),
b.classList.add('btn-red'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},v=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.ARMY,u.settingsMap=l,u.unit=r.encodeList(o,{textObject:'army_helper',disabled:!0}),m.injectScope(u),w(),u.selectTab=f,u.saveSettings=_,u.switchState=A;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.ARMY_HELPER_START,h),e.register(s.ARMY_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',u)};return function(){m=t.getSettings(),b=e.addMenuButton('Hetman',90),b.addEventListener('click',v),
...
KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,r,c,d,p,u,g,m,b,T,E){let f,_,A=!1,w=injector.get('overviewService'),h=[],S=!1,v={},R={},y={reverse:!1,column:n.TIME_COMPLETED};const k='attack_view_filters',x={},I={},O=function(){const e=[c.COMMAND_TYPES],t=i.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let n in v[e[t]])if(a[e[t]]||(a[e[t]]=[]),v[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?a[e[t]].push(r.ATTACK):n===r.SUPPORT?a[e[t]].push(r.SUPPORT):n===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}R=a,
R.village=v[c.VILLAGE]?[t]:[]},L=function(){B.loadCommands()},N=function(e,t){E.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<h.length;e++)h[e].command_id===t.command_id&&h.splice(e,1);E.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<h.length;e++)h[e].target_village_id===t.village_id?(h[e].target_village_name=t.name,h[e].targetVillage.name=t.name):h[e].origin_village_id===t.village_id&&(h[e].origin_village_name=t.name,h[e].originVillage.name=t.name);E.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},C=function(e,t){R[c.VILLAGE].length&&(R[c.VILLAGE]=[t],B.loadCommands())},U=function(e){const a={x:e.origin_x,y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(i){const l=t.getTravelTime(a,n,{[i]:1},e.command_type,{},!1);return{unit:i,diff:Math.abs(l-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},G=function(e,t){return e.sort((function(e,a){
return m.actualDistance(t,e)-m.actualDistance(t,a)}))},D=function(e,t){let a=0;if(T.hasTownDataInChunk(e.x,e.y)){const a=T.loadTownData(e.x,e.y,25,25,25),n=i.getSelectedCharacter().getTribeId(),l=i.getSelectedCharacter().getId();let o,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===l&&e.id!==t.id}));if(r.length)o=G(r,e);else if(c.length)o=G(c,e);else{if(!n)return t(!1);{const a=s.filter((function(e){return e.tribe_id===n}));if(!a.length)return t(!1);o=G(a,e)}}return t(o[0])}const n=b.scaledGridCoordinates(e.x,e.y,25,25,25);T.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===n.length&&D(e,t)}))},z=function(e){h=e.commands;for(let e=0;e<h.length;e++)w.formatCommand(h[e]),h[e].slowestUnit=U(h[e]);h=h.filter((function(e){return v[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[h])};let B={
loadCommands:function(){const e=f.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;l.emit(o.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:R[c.COMMAND_TYPES],villages:R[c.VILLAGE]},z)},getCommands:function(){return h},getFilters:function(){return v},getSortings:function(){return y},toggleFilter:function(e,t){t?v[e][t]=!v[e][t]:v[e]=!v[e],O(),g.set(k,v),B.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),B.loadCommands()},setCommander:function(e,a){D(e.targetVillage,(function(n){const i=e.targetVillage,l=n,o=l.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(p,(function(e){s[e]='*'})),S.addCommand(i,l,a,_.OUT,s,{},o,u.WALL),S.isRunning()||S.start()}))},commandQueueEnabled:function(){return!!S},isInitialized:function(){return A},init:function(){for(let e=0;e<d.length;e++)x[d[e]]=!0;for(let e in r)I[r[e]]=!0;try{S=require('two/commandQueue'),
_=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(I),[c.INCOMING_UNITS]:angular.copy(x),[c.VILLAGE]:!1};A=!0,f=i.getSelectedCharacter().getGlobalInfo(),v=g.get(k,t,!0),e((function(){O(),a.$on(s.COMMAND_INCOMING,L),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,C),a.$on(s.VILLAGE_NAME_CHANGED,M),a.$on(s.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,l,o,d,p,b,T,E,f,_){let A,w;const h=function(){return Date.now()/1e3},S=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},v=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(n),t.setCommander(e,n)},R=function(){let e=_('#two-attack-view').parent(),t=_('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=A.pagination.offset,t=A.pagination.limit
;A.visibleCommands=A.commands.slice(e,e+t),A.pagination.count=A.commands.length},k=function(){const e=Date.now();for(let t=0;t<A.commands.length;t++)100===A.commands[t].model.percent(e)&&A.commands.splice(t,1);y()},x=function(e,a){t.toggleFilter(e,a),A.filters=t.getFilters()},I=function(e){t.toggleSorting(e),A.sorting=t.getSortings()},O=function(){A.commands=t.getCommands()},L=function(){A.selectedVillageId=i.getSelectedVillage().getId()},N=function(){A=a.$new(),A.commandQueueEnabled=t.commandQueueEnabled(),A.commands=t.getCommands(),A.selectedVillageId=i.getSelectedVillage().getId(),A.filters=t.getFilters(),A.sorting=t.getSortings(),A.UNIT_TYPES=T,A.FILTER_TYPES=p,A.COMMAND_TYPES=d,A.UNIT_SPEED_ORDER=b,A.COLUMN_TYPES=o,A.pagination={count:A.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},A.openCharacterProfile=r.openCharacterProfile,A.openVillageInfo=r.openVillageInfo,A.jumpToVillage=u.jumpToVillage,A.now=h,A.copyTimeModal=S,A.removeTroops=v,A.switchWindowSize=R,
A.toggleFilter=x,A.toggleSorting=I,y();let e=new n('twoverflow_queue_window',(function(){f.timer.remove(k)}));e.register(s.MAP_SELECTED_VILLAGE,L,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',A),f.timer.add(k)};return function(){w=e.addMenuButton('Strażnik',30),w.addEventListener('click',N),
...
}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r,c,d,p,u,g,m,b,T,E,f,_){let A,w,h=!1,S=!1,v=[];const R='battle_calculator_settings',y={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},k={[o.HALBERD_OF_GUAN_YU]:'spear',[o.PARACELSUS_LONGSWORD]:'sword',[o.THORGARDS_BATTLE_AXE]:'axe',[o.NIMRODS_LONGBOW]:'archer',[o.MIESZKOS_LANCE]:'lc',[o.NIMRODS_COMPOSITE_BOW]:'ma',[o.BAPTISTES_BANNER]:'hc',
[o.CAROLS_MORNING_STAR]:'ram',[o.ALETHEIAS_BONFIRE]:'catapult',[o.VASCOS_SCEPTER]:'snob'},x={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},I={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},O={[u.NO_CHURCH]:50,[u.LEVEL_1]:100,[u.LEVEL_2]:105,[u.LEVEL_3]:110},L={[p.NO_WALL]:0,[p.LEVEL_1]:5,[p.LEVEL_2]:10,[p.LEVEL_3]:15,[p.LEVEL_4]:20,[p.LEVEL_5]:25,[p.LEVEL_6]:30,[p.LEVEL_7]:35,[p.LEVEL_8]:40,[p.LEVEL_9]:45,[p.LEVEL_10]:50,[p.LEVEL_11]:55,[p.LEVEL_12]:60,[p.LEVEL_13]:65,[p.LEVEL_14]:70,[p.LEVEL_15]:75,[p.LEVEL_16]:80,[p.LEVEL_17]:85,[p.LEVEL_18]:90,[p.LEVEL_19]:95,[p.LEVEL_20]:100},N={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},M={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},C={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3},U={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(I,U,C,M,P,N,L,O,y,k,x);const G=function(){v=[];const e=i.getPresetList().getPresets();w[t.PRESET].forEach((function(t){v.push(e[t])}))},D={init:function(){h=!0,A=new e({settingsMap:n,storageKey:R}),A.onChange((function(e,t){w=A.getAll(),t[l.PRESETS]&&G()})),w=A.getAll(),console.log('battleCalculator settings',w),f((function(){G()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,G),a.$on(s.ARMY_PRESET_DELETED,G)},start:function(){S=!0,_.trigger(s.BATTLE_CALCULATOR_START)},
stop:function(){S=!1,console.log('battleCalculator stop'),_.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return A},isInitialized:function(){return h},isRunning:function(){return S}};return D})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p,u,g,m,b,T,E,f,_,A,w){let h,S,v,R=i.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){h.selectedTab=e},x=function(){S.setAll(S.decode(h.settings)),w.notif('success','Settings saved')},I=function(){t.isRunning()?t.stop():t.start()},O=function(){h.presets=_.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},L=function(){
h.running=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),w.notif('success','battleCalculator started')},N=function(){h.running=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),w.notif('success','battleCalculator stopped')},P=function(){h=a.$new(),h.SETTINGS=n,h.TAB_TYPES=y,h.running=t.isRunning(),h.selectedTab=y.BATTLE,h.settingsMap=l,h.catapulttarget=_.encodeList(d,{textObject:'battle_calculator',disabled:!0}),h.knightitem=_.encodeList(o,{textObject:'battle_calculator',disabled:!0}),h.itemlevel=_.encodeList(r,{textObject:'battle_calculator',disabled:!0}),h.order=_.encodeList(p,{textObject:'battle_calculator',disabled:!0}),h.wall=_.encodeList(u,{textObject:'battle_calculator',disabled:!0}),h.church=_.encodeList(g,{textObject:'battle_calculator',disabled:!0}),h.weaponmaster=_.encodeList(m,{textObject:'battle_calculator',disabled:!0}),h.ironwalls=_.encodeList(b,{textObject:'battle_calculator',disabled:!0}),h.clinique=_.encodeList(T,{
textObject:'battle_calculator',disabled:!0}),h.hospital=_.encodeList(E,{textObject:'battle_calculator',disabled:!0}),h.training=_.encodeList(f,{textObject:'battle_calculator',disabled:!0}),S.injectScope(h),O(),h.selectTab=k,h.saveSettings=x,h.switchState=I;let e=new A('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,O,!0),e.register(s.ARMY_PRESET_DELETED,O,!0),e.register(s.BATTLE_CALCULATOR_START,L),e.register(s.BATTLE_CALCULATOR_STOP,N),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',h)};return function(){S=t.getSettings(),v=e.addMenuButton4('Kalkulator',10),v.addEventListener('click',P),
...
const w=Object.values(c),h=Object.values(a),S=Object.values(A),v=Object.values(_),R=Object.values(f);let y,k=[],x={},I=[],O=[],L=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===i.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),i=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!i.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+y},M=function(e){k.push(e)},C=function(e){x[e.id]=e},U=function(){
T.set(d.QUEUE_COMMANDS,k)},G=function(e){return!isNaN(e)&&e>0&&e<1e3},D=function(e){return E.call(e,'x')&&E.call(e,'y')&&G(e.x)&&G(e.y)};let z={initialized:!1};return z.init=function(){y=t.getTimeOffset(),z.initialized=!0,I=T.get(d.QUEUE_SENT,[],!0),O=T.get(d.QUEUE_EXPIRED,[],!0),function(){const e=T.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?z.expireCommand(e,n.TIME_LIMIT):(M(e),C(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!P(e.sendTime))return!0;L?z.sendCommand(e):z.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){L&&k.length&&(e.returnValue=!0)}))},z.sendCommand=function(e){const a=function(e){const a=i.getVillages()[e.origin.id];if(!a)return n.NOT_OWN_VILLAGE;const l=a.unitInfo.units;let o={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=l[t].available))return}else if(e<0){if((e=l[t].available-Math.abs(e))<0)return s=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>l[t].available)return s=n.NOT_ENOUGH_UNITS,!1;o[t]=e})),angular.equals({},o)&&(s=n.NOT_ENOUGH_UNITS),s||o}(e);if('string'==typeof a)return z.expireCommand(e,a);e.units=a,l.emit(o.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){I.push(e)}(e),T.set(d.QUEUE_SENT,I),z.removeCommand(e,n.COMMAND_SENT),u.trigger(s.COMMAND_QUEUE_SEND,e)},z.expireCommand=function(e,t){!function(e){O.push(e)}(e),T.set(d.QUEUE_EXPIRED,O),z.removeCommand(e,t)},z.addCommand=function(e,n,l,o,s,r,d,u){let m={},T={};return new Promise((function(E,y){if(!D(e))return y(p.INVALID_ORIGIN);if(!D(n))return y(p.INVALID_TARGET);if(!t.isValidDateTime(l))return y(p.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!S.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(p.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return y(p.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!v.includes(t))return!1;r[t]&&(T[t]=!0)})))return y(p.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||i.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&T[_.SUPPORTER]&&delete T[_.SUPPORTER],'string'!=typeof u||R.includes(u)?(u=!(d!==c.ATTACK||!m[A.CATAPULT])&&(u||f.HEADQUARTER),h.includes(o)?void Promise.all([new Promise(t=>b.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>b.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(i){if(e=i[0],n=i[1],!e)return y(p.INVALID_ORIGIN);if(!n)return y(p.INVALID_TARGET);const s=t.getTimeFromString(l),r=t.getTravelTime(e,n,m,d,T,!0),c=o===a.ARRIVE?s-r:s,b=o===a.ARRIVE?s:s+r;if(P(c))return y(p.ALREADY_SENT);const f={id:t.guid(),travelTime:r,arriveTime:b,sendTime:c,origin:e,target:n,date:l,dateType:o,units:m,officers:T,type:d,catapultTarget:u,countdown:c-g.gameTime()};M(f),C(f),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
U(),E(f)})):y(p.INVALID_DATE_TYPE)):y(p.INVALID_CATAPULT_TARGET)):y(p.RELOCATE_DISABLED):y(p.INVALID_COMMAND_TYPE)}))},z.removeCommand=function(e,t){delete x[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),U(),!0}));if(a)switch(t){case n.TIME_LIMIT:u.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:u.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:u.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:u.trigger(s.COMMAND_QUEUE_REMOVE,e)}else u.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},z.clearRegisters=function(){T.set(d.QUEUE_EXPIRED,[]),T.set(d.QUEUE_SENT,[]),O=[],I=[]},z.start=function(e){L=!0,u.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},z.stop=function(){L=!1,u.trigger(s.COMMAND_QUEUE_STOP)},z.isRunning=function(){return L},z.getWaitingCommands=function(){return k},z.getWaitingCommandsObject=function(){return x},z.getSentCommands=function(){return I},
z.getExpiredCommands=function(){return O},z.filterCommands=function(e,t,a){const n=N[e];return(a||k).filter((function(e){return n(e,t)}))},z})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,l,o,d,p,u,m,b,T,E,f,_,A){let w,h,S,v,R,y=i.getGameData(),k=y.getOrderedUnitNames(),x=y.getOrderedOfficerNames(),I=i.getPresetList(),O=!1;const L={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=L.ADD;let P,M,C,U=[],G={},D={};const z={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[p.SELECTED_VILLAGE,p.BARBARIAN_TARGET,p.ALLOWED_TYPES,p.TEXT_MATCH],V=function(e,t){O=t.data},W=function(){O=!1},q=function(e){
const t=new Date(e||f.gameTime()+l.getTimeOffset()),a=t.getMilliseconds(),n=f.zerofill(a-a%100,3),i=f.zerofill(t.getSeconds(),2),o=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+o+':'+i+':'+n+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return l.isValidDateTime(e)?(e=l.getTimeFromString(e),q(e+=t)):''},F=function(){if(w.isValidDate=l.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!w.isValidDate&&l.getTimeFromString(R.date),t=w.selectedDateType.value===o.ARRIVE;l.each(u,(function(a){l.each(z,(function(n,i){const o=l.getTravelTime(R.origin,R.target,n,a,R.officers,!0);w.travelTimes[a][i].travelTime=g('readableMillisecondsFilter')(o),w.travelTimes[a][i].status=e?j(t?e-o:e):'neutral'}))}))},j=function(e){return e&&w.isValidDate?f.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){R.dateType=w.selectedDateType.value,A.set(m.LAST_DATE_TYPE,w.selectedDateType.value),F()},K=function(){
R.catapultTarget=w.catapultTarget.value},Q=function(){const e=w.selectedInsertPreset.value;if(!e)return!1;const t=i.getPresetList().getPresets()[e];w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},R.units=angular.copy(t.units),R.officers=angular.copy(t.officers),t.catapult_target&&(R.catapultTarget=t.catapult_target,w.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},w.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=f.serverTime()+a.GAME_TIME_OFFSET,n=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=n-t}),f.timer.add(e.updateCountdown)},Z=function(){w.waitingCommands=t.getWaitingCommands()},J=function(){w.sentCommands=t.getSentCommands()},$=function(){w.expiredCommands=t.getExpiredCommands()},ee=function(){let e=w.waitingCommands;B.forEach((function(a){w.activeFilters[a]&&(e=t.filterCommands(a,w.filtersData,e))})),
w.visibleWaitingCommands=e},te=function(e){0===R.units[e]&&(R.units[e]='')},ae=function(e){''===R.units[e]&&(R.units[e]=0)},ne=function(){w.showCatapultSelect=!!R.units.catapult},ie=function(e){w.selectedTab=e},le=function(){const e=i.getSelectedVillage().data;R.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:S.getId()}},oe=function(){if(!O)return l.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(O.x,O.y,1,1,(function(e){R.target=e}))},se=function(){R.date=q()},re=function(){if(!R.date)return!1;R.date=Y(R.date,100)},ce=function(){if(!R.date)return!1;R.date=Y(R.date,-100)},de=function(){R.units=angular.copy(G),R.officers=angular.copy(D),R.catapultTarget="wall",w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},pe=function(e){t.addCommand(R.origin,R.target,R.date,R.dateType,R.units,R.officers,e,R.catapultTarget).then((function(e){Z(),ee(),X(e),
...
t&&(w.filtersData[p.ALLOWED_TYPES][e]=!w.filtersData[p.ALLOWED_TYPES][e]),ee()},Te=function(){w.activeFilters[p.TEXT_MATCH]=w.filtersData[p.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){w.presets=l.obj2selectOptions(I.getPresets())},autoCompleteSelected:function(e,t,a,n){if('commandqueue_village_search'!==t)return!1;R[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},w.searchQuery[n]=''},removeCommand:function(e,t){f.timer.remove(t.updateCountdown)||l.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),l.notif('success',me(t.type,'removed'))},removeError:function(){l.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),l.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),l.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
l.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){f.timer.remove(t.updateCountdown)||l.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),l.notif('success',me(t.type,'sent'))},start:function(e,a){if(w.running=t.isRunning(),a.disableNotif)return!1;l.notif('success',me('title','activated'))},stop:function(){w.running=t.isRunning(),l.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){R.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){R.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{f.timer.remove(e.updateCountdown)})}},fe=function(){const e=A.get(m.LAST_DATE_TYPE,o.OUT,!0);let b;w=a.$new(),w.selectedTab=N,w.inventory=i.getInventory(),w.presets=l.obj2selectOptions(I.getPresets()),w.travelTimes={},l.each(u,(function(e){w.travelTimes[e]={},l.each(z,(function(t,a){w.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=v,w.officers=y.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=_.toActionList(o,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),w.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!R.units.catapult,w.attackableBuildings=U,w.commandData=R,
w.activeFilters=M,w.filtersData=C,w.running=t.isRunning(),w.waitingCommands=t.getWaitingCommands(),w.visibleWaitingCommands=t.getWaitingCommands(),w.sentCommands=t.getSentCommands(),w.expiredCommands=t.getExpiredCommands(),w.EVENT_CODES=d,w.FILTER_TYPES=p,w.TAB_TYPES=L,w.COMMAND_TYPES=u,w.relocateEnabled=i.getWorldConfig().isRelocateUnitsEnabled(),w.onUnitInputFocus=te,w.onUnitInputBlur=ae,w.catapultTargetVisibility=ne,w.selectTab=ie,w.addSelected=le,w.addMapSelected=oe,w.addCurrentDate=se,w.incrementDate=re,w.reduceDate=ce,w.cleanUnitInputs=de,w.addCommand=pe,w.clearRegisters=ue,w.switchCommandQueue=ge,w.removeCommand=t.removeCommand,w.openVillageInfo=r.openVillageInfo,w.toggleFilter=be,w.$watch('commandData.origin',F),w.$watch('commandData.target',F),w.$watch('commandData.date',F),w.$watch('commandData.officers',F),w.$watch('selectedDateType.value',H),w.$watch('selectedInsertPreset.value',Q),w.$watch('catapultTarget.value',K),w.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Te),
w.$watch('selectedTab',(function(){w.selectedTab===L.ADD?b=setInterval((function(){F()}),2500):clearInterval(b)})),w.waitingCommands.forEach(e=>{X(e)});let T=new n('twoverflow_queue_window',(function(){clearInterval(b),Ee.clearCountdownUpdates()}));T.register(s.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),T.register(s.ARMY_PRESET_DELETED,Ee.updatePresets,!0),T.register(s.SELECT_SELECTED,Ee.autoCompleteSelected,!0),T.register(s.COMMAND_QUEUE_REMOVE,Ee.removeCommand),T.register(s.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),T.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),T.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),T.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),T.register(s.COMMAND_QUEUE_SEND,Ee.sendCommand),T.register(s.COMMAND_QUEUE_START,Ee.start),T.register(s.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){S=i.getSelectedCharacter(),P=l.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)U.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});v=angular.copy(k),v.splice(v.indexOf('catapult'),1),k.forEach((function(e){G[e]=0})),x.forEach((function(e){D[e]=!1})),R={origin:!1,target:!1,date:'',dateType:o.OUT,units:angular.copy(G),officers:angular.copy(D),catapultTarget:"wall",type:null},M={[p.SELECTED_VILLAGE]:!1,[p.BARBARIAN_TARGET]:!1,[p.ALLOWED_TYPES]:!0,[p.ATTACK]:!0,[p.SUPPORT]:!0,[p.RELOCATE]:!0,[p.TEXT_MATCH]:!1},C={[p.ALLOWED_TYPES]:{[p.ATTACK]:!0,[p.SUPPORT]:!0,[p.RELOCATE]:!0},[p.TEXT_MATCH]:''},h=e.addMenuButton('Generał',10),h.addEventListener('click',fe),T.register(s.COMMAND_QUEUE_START,(function(){h.classList.remove('btn-orange'),h.classList.add('btn-red')})),T.register(s.COMMAND_QUEUE_STOP,(function(){h.classList.remove('btn-red'),h.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,W),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,n,r,c,d){let p,u,m,b,T,E=!1,f=!1,_=0;p=function(e){let t,a,n=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>n&&(n=a);return n},u=function(e,t){let a=i.getWorldConfig().getChurchBonus(),n=0
;return e<0||!t&&e>a.length-1?0:(n=t?i.getWorldConfig().getChapelBonus():a[e],Math.floor(100*n))},m=function(e,t){l.emit(o.VILLAGES_IN_PROVINCE,{village_id:e},t)};let A={init:function(){E=!0}};return A.start=function(){n.trigger(s.FAITH_CHECKER_STARTED),f=!0,i.getSelectedCharacter().getVillageList().forEach((function(n){let i=n.data.villageId,s=n.data.buildings.chapel.level,r=n.buildingQueue.data.queue,c=n.getResources().getComputed(),E=c.food,f=c.wood,A=c.clay,w=c.iron,h=E.currentStock,S=f.currentStock,v=A.currentStock,R=w.currentStock,y=[0,5e3],k=[160,16e3],x=[200,2e4],I=[50,5e3];1==s&&(_=1),m(i,(function(n){b=p(n.villages),T=u(b,1===s),console.log(T),50!=T||r!==t&&0!=r.length?50==T&&r?r.forEach((function(t){let n=t.building;'chapel'==n&&'church'==n||0!=_?'chapel'==n&&'church'==n||1!=_||(S>=k[1]&&v>=x[1]&&R>=I[1]&&h>=y[1]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:i,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):S>=k[0]&&v>=x[0]&&R>=I[0]&&h>=y[0]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:i,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==_?S>=k[1]&&v>=x[1]&&R>=I[1]&&h>=y[1]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:i,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):S>=k[0]&&v>=x[0]&&R>=I[0]&&h>=y[0]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:i,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},A.stop=function(){n.trigger(s.FAITH_CHECKER_STOPPED),f=!1},A.isRunning=function(){return f},A.isInitialized=function(){return E},A})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,n,i){let l;return function(){return l=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),n.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),i.register(s.FAITH_CHECKER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),
i.register(s.FAITH_CHECKER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&i.trigger(s.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,n,i){const l='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(l,!1,!0)&&t.start(),i.register(s.FAITH_CHECKER_STARTED,(function(){n.set(l,!0)})),i.register(s.FAITH_CHECKER_STOPPED,(function(){n.set(l,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r,c,d){let p,u,g=!1,m=!1,b=[],T=[],E=[],f=[],_=[];const A='fake_sender_settings',w={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',
[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},h={[o.ATTACK]:'attack',[o.SUPPORT]:'support',[o.QUATTRO]:'four',[o.FULL]:'full'};console.log(w,h);const S=function(){b=[],T=[],E=[],f=[],_=[];const e=i.getGroupList().getGroups(),a=u[t.GROUP],n=u[t.GROUPP],l=u[t.GROUPT],o=u[t.GROUPG],s=u[t.GROUP_TARGET];a.forEach((function(t){b.push(e[t])})),n.forEach((function(t){T.push(e[t])})),l.forEach((function(t){E.push(e[t])})),o.forEach((function(t){f.push(e[t])})),s.forEach((function(t){_.push(e[t])}))},v={init:function(){g=!0,p=new e({settingsMap:n,storageKey:A}),p.onChange((function(e,t){u=p.getAll(),t[l.GROUPS]&&S()})),u=p.getAll(),console.log('fakeSender settings',u),a.$on(s.GROUPS_CREATED,S),a.$on(s.GROUPS_DESTROYED,S),a.$on(s.GROUPS_UPDATED,S)},start:function(){m=!0,d.trigger(s.FAKE_SENDER_START)},
stop:function(){m=!1,d.trigger(s.FAKE_SENDER_STOP)},getSettings:function(){return p},isInitialized:function(){return g},isRunning:function(){return m}};return v})),define('two/fakeSender/events',[],(function(){angular.extend(s,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p,u){let m,b,T,E=i.getGroupList();const f={FAKE:'fake',LOGS:'logs'},_=function(e){m.selectedTab=e},A=function(){b.setAll(b.decode(m.settings)),u.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},w=function(){t.isRunning()?t.stop():t.start()},h=function(){m.groups=d.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},S=function(){m.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),
u.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},v=function(){m.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},R=function(){m=a.$new(),m.SETTINGS=n,m.TAB_TYPES=f,m.running=t.isRunning(),m.selectedTab=f.FAKE,m.settingsMap=l,m.type=d.encodeList(o,{textObject:'fake_sender',disabled:!0}),m.units=d.encodeList(r,{textObject:'fake_sender',disabled:!0}),b.injectScope(m),h(),m.selectTab=_,m.saveSettings=A,m.switchState=w;let e=new p('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(s.GROUPS_CREATED,h,!0),e.register(s.GROUPS_DESTROYED,h,!0),e.register(s.GROUPS_UPDATED,h,!0),e.register(s.FAKE_SENDER_START,S),e.register(s.FAKE_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',m)};return function(){b=t.getSettings(),e.addDivisor(21),T=e.addMenuButton('Watażka',20),T.addEventListener('click',R),
...
LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/fakeSender','two/fakeSender/ui','two/fakeSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,u,g,m,b,f,_,A,w,h,S,v,R,y){let k,x,I,O,L,N=!1,P=!1,M=[],C=[],U=[],G=[],D=[],z=[],B=!1,V=!1,W=!1,q=0,Y=null,F=null,j=null,H={},K=A.gameTime(),Q=null,X=null
;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[v.WOOD,v.CLAY,v.IRON],te={distance:function(e){return!e.distance.between(x[r.MIN_DISTANCE],x[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!U.includes(e.id)},ignored:function(e){return G.includes(e.id)},points:function(e){return!e.between(x[r.MIN_POINTS],x[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ie=function(){!function(){const e=x[r.GROUP_INCLUDE];U=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);U=U.concat(t)})),U=ne(U)}(),function(){const e=x[r.GROUP_IGNORE];G=i.getGroupList().getGroupVillageIds(e)}(),function(){const e=x[r.GROUP_ONLY];D=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),D=D.concat(t)})),D=ne(D)}(),
function(){const e=G.concat(U);let t=!1;e.forEach((function(e){E.call(I,e)||(I[e]={time:A.gameTime(),report:!1},t=!0)})),b.each(I,(function(a,n){n=parseInt(n,10),e.includes(n)||(delete I[n],t=!0)})),t&&(y.set($,I),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),w.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},le=function(e,t){const a=x[r.GROUP_INCLUDE],n=x[r.GROUP_IGNORE],i=x[r.GROUP_ONLY],l=O.getVillage(t.village_id);let o=!1;if(ie(),n===t.group_id&&(l?(ke(t.village_id),o=!0):(Oe(t.village_id),Te(g.IGNORED_VILLAGE,{villageId:t.village_id}),be(t.village_id))),a.includes(t.group_id)&&!l&&(Le(),Te(g.INCLUDED_VILLAGE,{villageId:t.village_id}),be(t.village_id)),i.includes(t.group_id)&&l){let e=ve(t.village_id);e.init().then((function(){P&&e.start()})),o=!0}o&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},oe=function(e,t){const a=x[r.GROUP_INCLUDE],n=x[r.GROUP_IGNORE],i=x[r.GROUP_ONLY],l=O.getVillage(t.village_id);let o=!1;if(ie(),n===t.group_id)if(l){
let e=ve(t.village_id);e.init().then((function(){P&&e.start()})),o=!0}else Le(),Te(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!l&&(Le(),Te(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),i.includes(t.group_id)&&l&&(ke(t.village_id),o=!0),o&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){const t=i.getGroupList().getGroups(),a=x[r.GROUP_IGNORE],n=x[r.GROUP_ONLY],l=x[r.GROUP_INCLUDE],o=E.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=n.filter(e=>E.call(t,e)),c=l.filter(e=>E.call(t,e));k.setAll({[r.GROUP_IGNORE]:o,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ie(),ye(),Le(),Re()},ce=function(){z=[];const e=i.getPresetList().getPresets();x[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),z.push(a)})),z=z.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),
z.length||(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},pe=function(e,t){x[r.IGNORE_ON_LOSS]&&x[r.GROUP_IGNORE]&&P&&t.type===h.TYPES.ATTACK&&1!==t.result&&Ie(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=x[r.GROUP_IGNORE];!!t&&l.emit(o.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},ue=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===h.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===o.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return b.each(e.units,(function(e,a){e&&(t+=L[a].load*e)})),t},be=function(e){I[e]={time:A.gameTime(),report:H[e]||!1},delete H[e],y.set($,I),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Te=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=A.gameTime(),t.type=e,C.unshift(t),Ee(),!0)},Ee=function(){const e=x[r.LOGS_LIMIT]
;C.length>e&&C.splice(C.length-e,C.length),y.set(Z,C),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},fe=function(e,t,a){const n=x[r.TARGET_MULTIPLE_FARMERS],i=x[r.TARGET_SINGLE_ATTACK];if(n&&a){if(i&&e)return!0}else if(i){if(e||t)return!0}else if(t)return!0;return!1},_e=function(){K=A.gameTime()},Ae=function(){clearTimeout(Y),clearTimeout(F),clearTimeout(j),Y=null,F=null,j=null},we=function(){return Math.max(1,60*x[r.FARMER_CYCLE_INTERVAL]*1e3)},he=function(){return Math.max(0,1e3*x[r.ATTACK_INTERVAL])},Se=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=T,this.status=n.WAITING_CYCLE};Se.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();p.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e()
;this.loadTargets(()=>{w.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Se.prototype.start=function(){return _e(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,w.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),!0):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Se.prototype.stop=function(e){this.running=!1,w.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),Ae(),this.onCycleEndFn(e),this.onCycleEndFn=T},Se.prototype.targetStep=async function(e={}){if(!this.running)return!1;_e();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,p,u,g=!1,m=!1;const T=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,
!this.running)return a(n.USER_STOP);t()},b.randomSeconds(he())):t()}),f=()=>new Promise((e,a)=>{const i=50-x[r.PRESERVE_COMMAND_SLOTS];t.length>=i?a(n.COMMAND_LIMIT):e()}),v=()=>new Promise((e,t)=>{if(x[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),i=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===i))return t(n.FULL_STORAGE)}e()}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(n.NO_TARGETS)),k=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,i=>{if(te.points(i.points))return t(n.NOT_ALLOWED_POINTS);l.emit(o.GET_ATTACKING_FACTOR,{target_id:a.id},i=>{this.running?null!==a.character_id||null===i.owner_id||U.includes(a.id)?a.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),I=()=>new Promise((e,t)=>{!function(e,t){const a=i.getPresetList().getPresetsByVillageId(e);let n=[]
;if(z.forEach((function(e){E.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)E.call(a,e)&&n.push(e);l.emit(o.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),L=()=>new Promise((e,t)=>{const i=this.village.getUnitInfo().getUnits(),l=60*x[r.MAX_TRAVEL_TIME],o=this.village.getPosition(),s=_.actualDistance(o,a);b.each(z,o=>{if(!!Object.entries(o.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(o,{barbarian:!a.character_id,officers:!1});return l>r*s?(g=o,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),N=()=>new Promise((e,i)=>{c=!1,u=O.getVillageList();const l=u.every(e=>e.isInitialized(S.READY_STATES.OWN_COMMANDS));if(l&&(c=u.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),p=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),
fe(p,c,l))return i(n.BUSY_TARGET);l&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!p&&!c)return e();const i=60*x[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(x[r.TARGET_SINGLE_ATTACK]&&!x[r.TARGET_MULTIPLE_FARMERS])return e();const l=Math.round(A.gameTime()/1e3),o=x[r.TARGET_MULTIPLE_FARMERS]?u:[this.village],s=this.village.getPosition(),m=_.actualDistance(s,a),b=d.calculateTravelTime(g,{barbarian:!a.character_id,officers:!0,effects:!0}),T=d.getTravelTimeForDistance(g,b,m,h.TYPES.ATTACK);if(o.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(l+T-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();l.emit(o.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP)
;const i=a.commands.own.filter(e=>e.type===h.TYPES.ATTACK&&'forward'===e.direction),l=i.some(e=>e.start_village_id!==this.villageId),o=i.some(e=>e.start_village_id===this.villageId);if(fe(o,l,!0))return t(n.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{T().then(f).then(v).then(y).then(k).then(I).then(L).then(N).then(P).then(M).then(e).catch(t)}),G=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([C,G]).then(()=>{if(!this.running)return!1;this.setStatus(n.ATTACKING),V=!0,W=a,this.index++,l.emit(o.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:h.TYPES.ATTACK})}).catch(t=>{switch(Ae(),w.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case n.TIME_LIMIT:case n.BUSY_TARGET:case n.ABANDONED_CONQUERED:case n.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case n.USER_STOP:this.setStatus(t);break;case n.NOT_ALLOWED_POINTS:this.index++,
this.setStatus(t),Oe(a.id),this.targetStep(e);break;case n.NO_UNITS:case n.NO_TARGETS:case n.FULL_STORAGE:case n.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case n.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case n.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(n.UNKNOWN),this.stop(n.UNKNOWN)}})},Se.prototype.setStatus=function(e){this.status=e},Se.prototype.getStatus=function(){return this.status||n.UNKNOWN},Se.prototype.commandSent=function(e){V=!1,W=!1,Ae(),Te(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Se.prototype.commandError=function(){V=!1,W=!1,this.stop(n.COMMAND_ERROR)},Se.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Se.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=_.actualDistance(t,e),e}))}(a,t),
this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,x[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Se.prototype.getTargets=function(){return this.targets},Se.prototype.getIndex=function(){return this.index},Se.prototype.getVillage=function(){return this.village},Se.prototype.isRunning=function(){return this.running},Se.prototype.isInitialized=function(){return this.initialized},Se.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Se.prototype.getId=function(){return this.villageId};const ve=function(e){const t=x[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!D.includes(e))return!1;if(G.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Se(e),M.push(a)),a
},Re=function(){b.each(O.getVillages(),(function(e,t){ve(t)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ye=function(){const e=x[r.GROUP_ONLY];let t=[];M.forEach((function(a){let n=a.getId();e.length&&!D.includes(n)?t.push(n):G.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){ke(e)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1},xe=function(e){_e(),M.length?q>=M.length?(q=0,B=!1,X=A.gameTime()+we(),w.trigger(s.FARM_OVERFLOW_CYCLE_END)):B=M[q]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(q++,xe())})),"cycle_begin"===e&&(X=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,q=0,X=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),xe()}),we())},Ie=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){
M.forEach((function(t){t.removeTarget(e)}))},Le=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,C=y.get(Z,[]),I=y.get($,{}),O=i.getSelectedCharacter(),L=i.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){x=k.getAll(),"ignore_update"!==a&&(t[u.PRESET]&&ce(),t[u.GROUPS]&&ie(),t[u.TARGETS]&&Le(),t[u.VILLAGES]&&(ye(),Re()),t[u.LOGS]&&Ee(),t[u.INTERVAL_TIMERS]&&P&&(F?(Ae(),B.targetStep({delay:!0})):Y&&(Ae(),w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),q=0,xe())))})),x=k.getAll(),se("ignore_update"),ie(),Re(),f((function(){ce()}),'presets'),f((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,le),a.$on(s.GROUPS_VILLAGE_UNLINKED,oe),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,ue),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,pe)},Ne.start=function(){let e
;return!P&&(z.length?(P=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){xe("cycle_begin")})),_e(),function(){let e=we(),t=e+e/2+he();Q=setInterval((function(){A.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),w.trigger(s.FARM_OVERFLOW_START),void Te(g.FARM_START)):(P=!1,!1)):(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=n.USER_STOP){B?(B.stop(e),e!==n.USER_STOP&&(X=A.gameTime()+we()),w.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,Ae(),w.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===n.USER_STOP&&Te(g.FARM_STOP)},Ne.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return M},Ne.getSettings=function(){return k},Ne.getExceptionVillages=function(){return{included:U,ignored:G}},Ne.getExceptionLogs=function(){return I},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return P},
...
FARM_OVERFLOW_VILLAGE_IGNORED:'farm_overflow_village_ignored',FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED:'farm_overflow_exception_villages_updated',FARM_OVERFLOW_FARMER_VILLAGES_UPDATED:'farm_overflow_farmer_villages_updated',FARM_OVERFLOW_REPORTS_UPDATED:'farm_overflow_reports_updated',FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED:'farm_overflow_exception_logs_updated',FARM_OVERFLOW_CYCLE_BEGIN:'farm_overflow_cycle_begin',FARM_OVERFLOW_CYCLE_END:'farm_overflow_cycle_end'})})),define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,p,T,E,f,_,A,w){let h,S,v,R=i.getPresetList(),y=i.getGroupList(),k={},x={},I=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},L=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleLogs=h.logs.slice(e,e+t),
h.pagination.count=h.logs.length,h.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(k[e])return k[e];k[e]=!0,x[e]='LOADING...',l.emit(o.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},x[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){h.exceptionVillages.included.forEach((function(e){N(e)})),h.exceptionVillages.ignored.forEach((function(e){N(e)}))},M=function(){t.isRunning()?t.stop():t.start()},C=function(e){h.selectedTab=e},U=function(){S.setAll(S.decode(h.settings)),h.saveButtonColor='orange',_.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},G=function(e){const t=S.get(T.GROUP_IGNORE);if(!i.getGroupList().getGroupVillageIds(t).includes(e))return!1;l.emit(o.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},D=function(e){
S.get(T.GROUP_INCLUDE).forEach((function(t){i.getGroupList().getGroupVillageIds(t).includes(e)&&l.emit(o.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},z=function(){h.presets=E.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},B=function(){h.groups=E.encodeList(y.getGroups(),{disabled:!1,type:'groups'}),h.groupsWithDisabled=E.encodeList(y.getGroups(),{disabled:!0,type:'groups'})},V=function(){h.running=!0,_.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},W=function(e,t){switch(h.running=!1,h.showCycleTimer=!1,clearInterval(I),t.reason){case d.NO_PRESETS:_.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:_.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},q=function(){h.logs=angular.copy(t.getLogs()),L(),h.logs.length||_.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){h.farmers=t.getFarmers()},F=function(){h.exceptionVillages=t.getExceptionVillages(),P()
},j=function(){h.exceptionLogs=t.getExceptionLogs()},H=function(){h.showCycleTimer=!1,clearInterval(I)},K=function(e,a){a!==n.USER_STOP&&(h.showCycleTimer=!0,h.nextCycleCountdown=t.getCycleInterval(),I=setInterval((function(){h.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;h=a.$new(),h.SETTINGS=T,h.TAB_TYPES=O,h.LOG_TYPES=p,h.running=t.isRunning(),h.selectedTab=O.SETTINGS,h.farmers=t.getFarmers(),h.villagesLabel=x,h.villagesInfo=k,h.exceptionVillages=t.getExceptionVillages(),h.exceptionLogs=t.getExceptionLogs(),h.logs=t.getLogs(),h.visibleLogs=[],h.showCycleTimer=!1,h.nextCycleCountdown=0,h.saveButtonColor='orange',h.settingsMap=S.settingsMap,h.pagination={count:h.logs.length,offset:0,loader:L,limit:m.getPaginationLimit()},S.injectScope(h),z(),B(),L(),P(),function(){let e=t.getNextCycleDate();e&&(h.showCycleTimer=!0,h.nextCycleCountdown=e-w.gameTime(),I=setInterval((function(){h.nextCycleCountdown-=1e3}),1e3))}(),h.switchFarm=M,h.selectTab=C,h.saveSettings=U,
h.clearLogs=t.clearLogs,h.jumpToVillage=u.jumpToVillage,h.openVillageInfo=r.openVillageInfo,h.showReport=b.showReport,h.removeIgnored=G,h.removeIncluded=D;let n=new f('twoverflow_farm_overflow_window',(function(){clearInterval(I)}));n.register(s.ARMY_PRESET_UPDATE,z,!0),n.register(s.ARMY_PRESET_DELETED,z,!0),n.register(s.GROUPS_UPDATED,B,!0),n.register(s.GROUPS_CREATED,B,!0),n.register(s.GROUPS_DESTROYED,B,!0),n.register(s.FARM_OVERFLOW_START,V),n.register(s.FARM_OVERFLOW_STOP,W),n.register(s.FARM_OVERFLOW_LOGS_UPDATED,q),n.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,Y),n.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),n.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,j),n.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),n.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',h),h.$watch('settings',(function(){e||(h.saveButtonColor='red'),e=!1}),!0)};return function(){S=t.getSettings(),v=e.addMenuButton2('Farmer',10),
v.addEventListener('click',(function(){Q()})),A.register(s.FARM_OVERFLOW_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),A.register(s.FARM_OVERFLOW_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/kingTool',['two/Settings','two/kingTool/settings','two/kingTool/settings/map','two/kingTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r){let c,d,p=!1,u=!1,g=[],m=[];const b='king_tool_settings',T=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){p=!0,c=new e({settingsMap:n,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&T(),t[l.GROUPS]&&E()})),d=c.getAll(),console.log('kingTool settings',d),o((function(){T()
}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,T),a.$on(s.ARMY_PRESET_DELETED,T),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){u=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.EXAMPLE_MODULE_START)},stop:function(){u=!1,console.log('example module stop'),r.trigger(s.EXAMPLE_MODULE_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return f})),define('two/kingTool/events',[],(function(){angular.extend(s,{KING_TOOL_START:'king_tool_start',KING_TOOL_STOP:'king_tool_stop'})})),define('two/kingTool/ui',['two/ui','two/kingTool','two/kingTool/settings','two/kingTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let p,u,g,m=i.getPresetList(),b=i.getGroupList();const T={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){p.selectedTab=e},f=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')
},_=function(){t.isRunning()?t.stop():t.start()},A=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.SETTINGS,p.settingsMap=l,u.injectScope(p),A(),w(),p.selectTab=E,p.saveSettings=f,p.switchState=_;let e=new r('twoverflow_king_tool_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.KING_TOOL_START,h),e.register(s.KING_TOOL_STOP,S),
...
require(['two/ready','two/kingTool','two/kingTool/ui','two/kingTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r){let c,d,p=!1,u=!1,g=[],m=[];const b='market_helper_settings',T=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){p=!0,c=new e({settingsMap:n,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&T(),t[l.GROUPS]&&E()})),d=c.getAll(),console.log('marketHelper settings',d),o((function(){T()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,T),a.$on(s.ARMY_PRESET_DELETED,T),a.$on(s.GROUPS_CREATED,E),
a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){u=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.MARKET_HELPER_START)},stop:function(){u=!1,console.log('marketHelper stop'),r.trigger(s.MARKET_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return f})),define('two/marketHelper/events',[],(function(){angular.extend(s,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let p,u,g,m=i.getPresetList(),b=i.getGroupList();const T={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){p.selectedTab=e},f=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},A=function(){
p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','marketHelper started')},S=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','marketHelper stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.SETTINGS,p.settingsMap=l,u.injectScope(p),A(),w(),p.selectTab=E,p.saveSettings=f,p.switchState=_;let e=new r('twoverflow_market_helper_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.MARKET_HELPER_START,h),e.register(s.MARKET_HELPER_STOP,S),
c.getScreenWithInjectedScope('!twoverflow_market_helper_window',p)};return function(){u=t.getSettings(),g=e.addMenuButton2('Handlarz',30),g.addEventListener('click',v),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,l,o,r,c,d,p,g,m,b,T,f,_,A,w,h,S){let v,R,y,k,x,I,O,L,N,P,M,C,U,G,D,z,B,V,W,q,Y,F,j,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',le={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},oe=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,pe={},ue={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,be=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/R)%2&&(t+=k),t-=t%R,a-=a%R,{x:Math.ceil((t-N.width/2)/R),y:Math.ceil((a-N.height/2)/R)}},Te=function(e,t){return{x:e/h.TILESIZE.x,y:t/h.TILESIZE.y/h.TILESIZE.off}},Ee=function(){Se(x)},fe=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),G.clearRect(0,0,U.width,U.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),j[l.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*R-e.x,n=(t.y-2)*R-e.y;G.fillStyle=j[l.COLOR_VIEW_REFERENCE],G.fillRect(a,0,1,y),G.fillRect(0,n,y,1);const i=z.getBoundingClientRect(),o=i.width/h.TILESIZE.x/S.view.z*R,s=i.height/h.TILESIZE.y/S.view.z*R,r=a-o/2,c=n-s/2;G.clearRect(r,c,o,s),G.beginPath(),G.lineWidth=1,G.strokeStyle=j[l.COLOR_VIEW_REFERENCE],G.rect(r,c,o,s),G.stroke()}(e)}e.requestAnimationFrame(fe)},_e=function(){if(!ne)return!1;const e=Q.village[O][L];we(e?Q.character[e]:[[O,L]]),ne=!1,
m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:O,y:L})},Ae=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}Se(t,j[l.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}Se(t)},he=function(e){if(j[l.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!j[l.SHOW_BARBARIANS]&&q.barbarian;if(e.character_id===V){if(e.id===I.getId()&&j[l.HIGHLIGHT_SELECTED])return q.selected;if(e.character_id in K.character)return K.character[e.character_id];if(j[l.HIGHLIGHT_OWN])return q.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&j[l.HIGHLIGHT_DIPLOMACY])return q.tribe;if(Y&&j[l.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return q.ally;if(Y.isEnemy(e.tribe_id))return q.enemy
;if(Y.isNAP(e.tribe_id))return q.friendly}}return q.ugly},Se=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||he(n);if(!i)continue;const l=n.x*R+(n.y%2?k:0),o=n.y*R;C.fillStyle=i,C.fillRect(l,o,v,v)}},ve=function(){v=le[j[l.MAP_SIZE]],k=Math.round(v/2),R=v+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,M.width=1e3*R,M.height=1e3*R,C.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,U.width=686,U.height=e,P.imageSmoothingEnabled=!1,G.imageSmoothingEnabled=!1},ye=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,pe.x=ee.x+e.pageX,pe.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[O,L,e]),3===e.which&&(a=O,n=L,T.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(j[l.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id},A.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({
type:'tribe',id:e.tribe_id},A.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,pe={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},xe=function(e){if(ce=!1,ue=be(e),de)return ee.x=(pe.x-e.pageX).bound(J.a,J.b),ee.y=(pe.y-e.pageY).bound($.a,$.b),te.x=ue.x,te.y=ue.y,!1;if(te.x===ue.x&&te.y===ue.y||(re.alpha=0,function(e,t){let a=u.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(ue.x,ue.y)),ue.x in ae&&ue.y in ae[ue.x]){let t=ae[ue.x][ue.y];if(!j[l.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[l.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(O===e.x&&L===e.y)return!1;_e()}ne=!0,O=e.x,L=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:O,y:L,event:t});const a=Q.village[O][L];Ae(a?Q.character[a]:[[O,L]])}(ue,e)}_e()},Ie=function(){ne&&_e(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=be(e);u.jumpToVillage(t.x,t.y)
},Le=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=oe.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=oe.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=B.getSelectedVillage(),Se([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return oe.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t];const n='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return oe.setCustomColorsByGroup(n,K[e]),
...
const e=_.getPath(h.getMapPath()),t=j[l.SHOW_CONTINENT_DEMARCATIONS],a=j[l.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){C.fillStyle=j[l.COLOR_CONTINENT],C.fillRect(e*R+k-1,t*R+k-1,3,1),C.fillRect(e*R+k,t*R+k-2,1,3)},i=function(e,t){C.fillStyle=j[l.COLOR_PROVINCE],C.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const l=new DataView(e.response),o={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=o.a;e<o.b;e++)for(let o=s.a;o<s.b;o++){const s=f.toTile(l,e,o);s.key.b&&(s.key.c&&t?n(e,o):a&&i(e,o))}const r=o.a*R,c=s.a*R,d=(o.b-o.a)*R,p=(s.b-s.a)*R;C.beginPath(),C.lineWidth=2,C.strokeStyle="#2B4700",C.rect(r,c,d,p),C.stroke()}))}(),Ee()}),'minimap_data')},Me.enableRendering=function(){H=!0},Me.disableRendering=function(){H=!1},Me.isFirstDraw=function(){return!!ge},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),C=M.getContext('2d'),re=se.make('hover'),F=new p({settingsMap:o,storageKey:ie}),F.onChange((function(e,t){j=F.getAll(),
ve(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),j=F.getAll(),K.tribe=oe.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=oe.getCustomColorsByGroup(w.PLAYER_COLORS)||{},ve()},Me.run=function(){d((function(){z=document.getElementById('map'),D=document.getElementById('main-canvas'),B=i.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),q=B.getVillagesColors(),re.alpha=0,S.graph.layers.effects.push(re),Re(),I=B.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*R,ee.y=I.getY()*R,e.addEventListener('resize',Re,!1),U.addEventListener('mousedown',ye),U.addEventListener('mouseup',ke),U.addEventListener('mousemove',xe),U.addEventListener('mouseleave',Ie),U.addEventListener('click',Oe),U.addEventListener('contextmenu',Le),g.load((function(){x=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(x),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),fe(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,Ee),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,p,u,m,b,T,E,f,_,A,w){let h,S,v,R,y,k,x,I,O,L,N,P={},M=!1,C={character:{},tribe:{}};const U={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},G=U.MINIMAP,D=function(e){h.selectedTab=e,e===U.MINIMAP?i.enableRendering():i.disableRendering()},z=function(){Object.keys(h.highlights.character).forEach((function(e){e in C.character||function(e,t){l.emit(o.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
C.character[e]=t.character_name}))})),Object.keys(h.highlights.tribe).forEach((function(e){e in C.tribe||function(e,t){l.emit(o.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){C.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!O)return;let a=B(t.x,t.y);var n,i;L=a,P[a]=!0,M=!0,(n=t.x,i=t.y,new Promise((function(e){let t=_.getTownAt(n,i);if(t)return e(t);_.loadTownDataAsync(n,i,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!M)return;x.appendChild(O),O.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=O.getBoundingClientRect(),n=x.getBoundingClientRect(),i=a.width+50,l=a.height+50,o=k.tt.position.y+l>n.top+n.height,s=k.tt.position.x+i>n.width;o&&(k.tt.position.y-=50),O.classList.toggle('left',s),O.classList.toggle('top',o)}))},W=function(e,t){if(!O)return;let a=t?B(t):L;P[a]=!1,M=!1,k.tt.visible=!1,O.classList.add('ng-hide'),I.appendChild(O)},q=function(e,t,n){let l,o,s=a.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(o=t,l=N.get(o),r=!1,s.submit=function(){h.settings[o]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){h.settings[o]=N.getDefault(o),s.closeWindow()}):'add_custom_highlight'===e?(l=h.addHighlightColor,s.submit=function(){h.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(l=h.highlights[t][n],s.submit=function(){i.addHighlight({id:n,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=l.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},Y=function(){i.addHighlight(h.selectedHighlight,h.addHighlightColor)},F=function(){N.setAll(N.decode(h.settings)),b.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},j=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),b.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(h.highlights.character).length+Object.keys(h.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){h.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){z()},highlightAddErrorExists:function(){b.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){b.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){b.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+A.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){h=a.$new(),h.SETTINGS=u,h.TAB_TYPES=U,h.selectedTab=G,h.selectedHighlight=!1,h.addHighlightColor='#000000',h.highlights=i.getHighlights(),h.highlightNames=C,h.mapSizes=E.encodeList(p,{textObject:'minimap',disabled:!1}),h.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),h.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},h.selectTab=D,h.openColorPalette=q,h.addCustomHighlight=Y,h.removeHighlight=i.removeHighlight,h.saveSettings=F,h.resetSettings=j,h.highlightsCount=H,h.openProfile=K,N.injectScope(h,{textObject:'minimap'});let e=new T('twoverflow_minimap_window',(function(){i.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',h),z(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(v),y.appendChild(R),i.enableRendering(),i.isFirstDraw()&&i.drawMinimap()};return function(){N=i.getSettings(),k=n.getSharedData('MapController'),v=document.createElement('canvas'),v.className='minimap',R=document.createElement('canvas'),R.className='cross',i.setViewport(v),i.setViewportRef(R),O=document.querySelector('#map-tooltip'),x=document.querySelector('#wrapper'),I=document.querySelector('#map'),S=t.addMenuButton4('Minimapa',30),S.addEventListener('click',(function(){const e=i.getMapPosition();if(!e)return!1;X(),i.setCurrentPosition(e.x,e.y)})),
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r,c){let d,p,u=!1,g=!1,m=[];const b='prank_helper_settings',T={[o.INCREASE]:'increase',[o.DECREASE]:'decrease',[o.RANDOM]:'random'};console.log(T);const E=function(){m=[];const e=i.getGroupList().getGroups();p[t.GROUPS].forEach((function(t){m.push(e[t])}))},f={init:function(){u=!0,d=new e({settingsMap:n,storageKey:b}),d.onChange((function(e,t){p=d.getAll(),t[l.GROUPS]&&E()})),p=d.getAll(),console.log('all settings',p),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){g=!0,c.trigger(s.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(s.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return f})),define('two/prankHelper/events',[],(function(){angular.extend(s,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p){let u,g,m,b=i.getGroupList();const T={RENAME:'rename',LOGS:'logs'},E=function(e){u.selectedTab=e},f=function(){g.setAll(g.decode(u.settings)),p.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},A=function(){u.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),p.notif('success','Example module started')},h=function(){u.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
p.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.RENAME,u.settingsMap=l,u.type=r.encodeList(o,{textObject:'prank_helper',disabled:!0}),g.injectScope(u),A(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(s.GROUPS_CREATED,A,!0),e.register(s.GROUPS_DESTROYED,A,!0),e.register(s.GROUPS_UPDATED,A,!0),e.register(s.PRANK_HELPER_START,w),e.register(s.PRANK_HELPER_STOP,h),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',u)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',80),m.addEventListener('click',S),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r){let c,d,p=!1,u=!1,g=[],m=[],b=[],T=[];const E='preset_asigner_settings',f=function(){g=[],m=[];const e=i.getPresetList().getPresets(),a=d[t.PRESETS1],n=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),n.forEach((function(t){m.push(e[t])}))},_=function(){b=[],T=[];const e=i.getGroupList().getGroups(),a=d[t.GROUP1],n=d[t.GROUP2];a.forEach((function(t){b.push(e[t])})),n.forEach((function(t){T.push(e[t])}))},A={init:function(){p=!0,c=new e({settingsMap:n,storageKey:E}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&f(),t[l.GROUPS]&&_()})),d=c.getAll(),console.log('presetAsigner settings',d),o((function(){f()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,f),a.$on(s.ARMY_PRESET_DELETED,f),a.$on(s.GROUPS_CREATED,_),a.$on(s.GROUPS_DESTROYED,_),a.$on(s.GROUPS_UPDATED,_)},start:function(){u=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){u=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return A})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let p,u,g,m=i.getPresetList(),b=i.getGroupList();const T={PRESETS:'presets',LOGS:'logs'},E=function(e){p.selectedTab=e},f=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()
},A=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.PRESETS,p.settingsMap=l,u.injectScope(p),A(),w(),p.selectTab=E,p.saveSettings=f,p.switchState=_;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.PRESET_ASIGNER_START,h),e.register(s.PRESET_ASIGNER_STOP,S),
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var n=!1,r=!1,c=i.getSelectedCharacter().getVillageList(),d='060504',p='060505',u='06050f',m='060506',b='060502',T='060501',E='060503',f='05020a',_='05030a',A='04080a',w='040a0a',h='070e04',S='070e05',v='070e0f',R='070e06',y='070e02',k='070e01',x='070e03',I='070e07',O='070e0b',L='070e0e',N='030d07',P='030d0b',M='030d0e';var C={init:function(){n=!0}};return C.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,p='string'==typeof p?parseInt(p,16):p,u='string'==typeof u?parseInt(u,16):u,m='string'==typeof m?parseInt(m,16):m,b='string'==typeof b?parseInt(b,16):b,T='string'==typeof T?parseInt(T,16):T,E='string'==typeof E?parseInt(E,16):E,f='string'==typeof f?parseInt(f,16):f,_='string'==typeof _?parseInt(_,16):_,A='string'==typeof A?parseInt(A,16):A,w='string'==typeof w?parseInt(w,16):w,
h='string'==typeof h?parseInt(h,16):h,S='string'==typeof S?parseInt(S,16):S,v='string'==typeof v?parseInt(v,16):v,R='string'==typeof R?parseInt(R,16):R,y='string'==typeof y?parseInt(y,16):y,k='string'==typeof k?parseInt(k,16):k,x='string'==typeof x?parseInt(x,16):x,I='string'==typeof I?parseInt(I,16):I,O='string'==typeof O?parseInt(O,16):O,L='string'==typeof L?parseInt(L,16):L,N='string'==typeof N?parseInt(N,16):N,P='string'==typeof P?parseInt(P,16):P,M='string'==typeof M?parseInt(M,16):M,l.emit(o.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:20,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),l.emit(o.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (miecz)',icon:p,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:33,axe:0,
...
let d,p,u=!1,g=!1,m=[],b=[],T=[],E=[],f=[],_=[],A=[],w=[],h=[],S=[],v=[],R=[],y=[],k=[],x=[],I=[],O=[],L=[],N=[],P=[],M=[],C=[],U=[],G=[],D=[],z=[],B=[],V=[],W=[],q=[],Y=[],F=[];const j='recruit_queue_settings',H={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],b=[],T=[],E=[],f=[],_=[],A=[],w=[];const e=i.getPresetList().getPresets(),a=p[t.PRESET1],n=p[t.PRESET2],l=p[t.PRESET3],o=p[t.PRESET4],s=p[t.PRESET1_FINAL],r=p[t.PRESET2_FINAL],c=p[t.PRESET3_FINAL],d=p[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){b.push(e[t])})),l.forEach((function(t){T.push(e[t])})),o.forEach((function(t){E.push(e[t])})),s.forEach((function(t){f.push(e[t])})),r.forEach((function(t){
_.push(e[t])})),c.forEach((function(t){A.push(e[t])})),d.forEach((function(t){w.push(e[t])}))},Q=function(){h=[],S=[],v=[],R=[],y=[],k=[],x=[],I=[],O=[],L=[],N=[],P=[],M=[],C=[],U=[],G=[],D=[],z=[],B=[],V=[],W=[],q=[],Y=[],F=[];const e=i.getGroupList().getGroups(),a=p[t.GROUP1],n=p[t.GROUP2],l=p[t.GROUP3],o=p[t.GROUP4],s=p[t.GROUP5],r=p[t.GROUP6],c=p[t.GROUP7],d=p[t.GROUP8],u=p[t.GROUP9],g=p[t.GROUP10],m=p[t.GROUP11],b=p[t.GROUP12],T=p[t.GROUP13],E=p[t.GROUP14],f=p[t.GROUP15],_=p[t.GROUP16],A=p[t.GROUP17],w=p[t.GROUP18],j=p[t.GROUP19],H=p[t.GROUP20],K=p[t.GROUP21],Q=p[t.GROUP22],X=p[t.GROUP23],Z=p[t.GROUP24];a.forEach((function(t){h.push(e[t])})),n.forEach((function(t){S.push(e[t])})),l.forEach((function(t){v.push(e[t])})),o.forEach((function(t){R.push(e[t])})),s.forEach((function(t){y.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){x.push(e[t])})),d.forEach((function(t){I.push(e[t])})),u.forEach((function(t){O.push(e[t])})),g.forEach((function(t){
L.push(e[t])})),m.forEach((function(t){N.push(e[t])})),b.forEach((function(t){P.push(e[t])})),T.forEach((function(t){M.push(e[t])})),E.forEach((function(t){C.push(e[t])})),f.forEach((function(t){U.push(e[t])})),_.forEach((function(t){G.push(e[t])})),A.forEach((function(t){D.push(e[t])})),w.forEach((function(t){z.push(e[t])})),j.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),K.forEach((function(t){W.push(e[t])})),Q.forEach((function(t){q.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){u=!0,d=new e({settingsMap:n,storageKey:j}),d.onChange((function(e,t){p=d.getAll(),t[l.PRESETS]&&K(),t[l.GROUPS]&&Q()})),p=d.getAll(),console.log('recruitQueue settings',p),r((function(){K()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,K),a.$on(s.ARMY_PRESET_DELETED,K),a.$on(s.GROUPS_CREATED,Q),a.$on(s.GROUPS_DESTROYED,Q),a.$on(s.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(s.recruit_queue_START)},stop:function(){
g=!1,c.trigger(s.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p){let u,m,b,T=i.getPresetList(),E=i.getGroupList();const f={PRESETS:'presets',OWN:'own',LOGS:'logs'},_=function(e){u.selectedTab=e},A=function(){m.setAll(m.decode(u.settings)),p.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},h=function(){u.presets=r.encodeList(T.getPresets(),{disabled:!1,type:'presets'})},S=function(){u.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,
b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},R=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},y=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=f,u.running=t.isRunning(),u.selectedTab=f.PRESETS,u.settingsMap=l,u.units=r.encodeList(o,{textObject:'recruit_queue',disabled:!0}),m.injectScope(u),h(),S(),u.selectTab=_,u.saveSettings=A,u.switchState=w;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed')}));e.register(s.ARMY_PRESET_UPDATE,h,!0),e.register(s.ARMY_PRESET_DELETED,h,!0),e.register(s.GROUPS_CREATED,S,!0),e.register(s.GROUPS_DESTROYED,S,!0),e.register(s.GROUPS_UPDATED,S,!0),e.register(s.recruit_queue_START,v),e.register(s.recruit_queue_STOP,R),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',u)};return function(){
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r){let c,d,p=!1,u=!1,g=[],m=[];const b='report_helper_settings',T=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){p=!0,c=new e({settingsMap:n,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&T(),t[l.GROUPS]&&E()})),d=c.getAll(),console.log('reportHelper settings',d),o((function(){T()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,T),a.$on(s.ARMY_PRESET_DELETED,T),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){u=!0,
console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.REPORT_HELPER_START)},stop:function(){u=!1,console.log('reportHelper stop'),r.trigger(s.REPORT_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return f})),define('two/reportHelper/events',[],(function(){angular.extend(s,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let p,u,g,m=i.getPresetList(),b=i.getGroupList();const T={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){p.selectedTab=e},f=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},A=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){
p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.SETTINGS,p.settingsMap=l,u.injectScope(p),A(),w(),p.selectTab=E,p.saveSettings=f,p.switchState=_;let e=new r('twoverflow_report_helper_window',(function(){console.log('reportHelper window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.REPORT_HELPER_START,h),e.register(s.REPORT_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',p)};return function(){u=t.getSettings(),
...
require(['two/ready','two/reportHelper','two/reportHelper/ui','two/reportHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=i.getSelectedCharacter(),a=t.data.character_id,n=t.data.character_name,r=!1,c=!1,d=[],p=[],u=[];function g(e){var t=new Date(1e3*e);return t.toLocaleString()}var m=function(){l.emit(o.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),l.emit(o.REPORT_GET,{id:t[a].id},b))})),l.emit(o.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(p.push(t[a].id),l.emit(o.REPORT_GET,{id:t[a].id},T))})),l.emit(o.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']
},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport ataku już wysłany'):(u.push(t[a].id),l.emit(o.REPORT_GET,{id:t[a].id},E))})),setTimeout(m,3e4)},b=function(e){var t,i,s,r,c,d=[],p=e.result,u=e.token,m=e.time_created,b=g(m),T=e.ReportScouting,E=T.attCharacterId,f=T.attCharacterName,_=T.attScouts,A=T.attLosses,w=T.attVillageId,h=T.attVillageName,S=T.defCharacterId,v=T.defCharacterName,R=T.defLosses,y=T.defScouts,k=T.defVillageId,x=T.defVillageName,I=T.commandType,O='',L='',N='',P='',M=Date.now(),C=u.split('.').join('_');2==p?O=' [color=d96a19]Częściowy sukces[/color]':1==p?O=' [color=0a8028]Sukces[/color]':3==p&&(O=' [color=e21f1f]Porażka[/color]'),L='units'==I?'Jednostki':'buildings'==I?'Budynki':'Sabotaż',i=null==y?'nieznana':y,s=null==_?'nieznana':_,r=null==R?'nieznana':R,c=null==A?'nieznana':A,P=null==f&&null==E?'Brak danych':'[player='+E+']'+f+'[/player]',N=null==h&&null==w?'Brak danych':'[village='+w+']'+h+'[/village]',
t=Math.floor(M/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+C+'[/report][br]'+O+' --- Typ: '+L+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+b+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+x+'[/village][b] Gracz cel: [/b][player='+S+']'+v+'[/player][br]Liczba szpiegów: [b]'+i+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var U=d.join();S!=a?t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?l.emit(o.MESSAGE_REPLY,{message_id:14383,message:U}):l.emit(o.MESSAGE_REPLY,{message_id:6467,message:U}),d=[]):t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?l.emit(o.MESSAGE_REPLY,{message_id:14382,message:U}):l.emit(o.MESSAGE_REPLY,{message_id:6466,message:U}),d=[])},T=function(e){
var t,a=[],i=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,p=d.attCharacterId,u=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var _=[],A=[];T.forEach((function(e){var t=e.type,a=0,n=0,i=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),_.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,_.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,_.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,_.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,_.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,_.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,_.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,_.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,_.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,_.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,_.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,_.push(' Zjednoczenie '+g+'%'))}));var w=_.join();E.forEach((function(e){var t=e.type,a=0,n=0,i=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),A.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,A.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,A.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,A.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,A.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,A.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
A.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,A.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,A.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,A.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,A.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,A.push(' Zjednoczenie '+g+'%'))}));var h=A.join(),S=(100*d.attFaith).toFixed([0]),v=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),y=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,x=d.defCharacterName,I=d.defVillageId,O=d.defVillageName,L=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),M=d.night,C=d.loyaltyAfter,U=d.loyaltyBefore,G=d.wallAfter,D=d.wallBefore,z=d.officers,B=d.leader,V='',W='',q='',Y='',F='',j='',H='',K='',Q='',X=Date.now(),Z=s.split('.').join('_')
;null!=U&&(j='Lojalność przed atakiem: '+Math.floor(U)+' '),null!=C&&(H='Lojalność po ataku: '+Math.floor(C)+' '),null!=D&&(K='Mury przed ataku: '+D+' '),null!=G&&(Q='Mury po ataku: '+G+' '),null==z&&1==B?F='Brak':null==z&&1.1==B&&(F=' Wielki Mistrz '),Y=0==M?'Nie':'Tak',2==i?V=' [color=d96a19]Częściowy sukces[/color]':1==i?V=' [color=0a8028]Sukces[/color]':3==i&&(V=' [color=e21f1f]Porażka[/color]'),q=null==u&&null==p?'Brak danych':'[player='+p+']'+u+'[/player]',W=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(X/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+O+'[/village][b] Gracz cel: [/b][player='+k+']'+x+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+L+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+v+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+y+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+j+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?l.emit(o.MESSAGE_REPLY,{message_id:14381,message:J}):l.emit(o.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},E=function(e){
var t,a=[],i=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,p=d.attCharacterId,u=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var _=[],A=[];T.forEach((function(e){var t=e.type,a=0,n=0,i=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),_.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,_.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,_.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,_.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,_.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,_.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,_.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,_.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,_.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,_.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,_.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,_.push(' Zjednoczenie '+g+'%'))}));var w=_.join();E.forEach((function(e){var t=e.type,a=0,n=0,i=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),A.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(n=e.min_level,A.push(' Żelazny mur '+n)),'modify_attack_factor'==t&&(i=100*e.bonus,A.push(' Mistrzostwo broni '+i+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,A.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,A.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,A.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
A.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,A.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,A.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,A.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,A.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,A.push(' Zjednoczenie '+g+'%'))}));var h,S=A.join(),v=(100*d.attFaith).toFixed([0]),R=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),x=d.defCharacterId,I=d.defCharacterName,O=d.defVillageId,L=d.defVillageName,N=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),M=(100*d.wallBonus).toFixed([0]),C=d.night,U=d.loyaltyAfter,G=d.loyaltyBefore,D=d.wallAfter,z=d.wallBefore,B=d.officers,V='',W='',q='',Y='',F='',j='',H='',K='',Q=[],X=Date.now(),Z=s.split('.').join('_')
;if(null!=G&&(F='Lojalność przed atakiem: '+Math.floor(G)+' '),null!=U&&(j='Lojalność po ataku: '+Math.floor(U)+' '),null!=z&&(H='Mury przed ataku: '+z+' '),null!=D&&(K='Mury po ataku: '+D+' '),null==B)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ne=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ne?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ne?Q.push(' Taktyk '):Q.push(''))}if(Y=0==C?'Nie':'Tak',2==i?V=' [color=d96a19]Częściowy sukces[/color]':1==i?V=' [color=0a8028]Sukces[/color]':3==i&&(V=' [color=e21f1f]Porażka[/color]'),q=null==u&&null==p?'Brak danych':'[player='+p+']'+u+'[/player]',W=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(X/1e3-r),h=Q.join(),null!=I){
a.push('[size=XL][b]Raport z ataku: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+L+'[/village][b] Gracz cel: [/b][player='+x+']'+I+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+M+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+S+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+R+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+v+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+h+'[/b][br]'+F+j+'[br]'+H+K+'[/size]');var ie=a.join();t<10800&&('Hajduk Split'==n||'halfsack'==n||'Black Rider'==n?l.emit(o.MESSAGE_REPLY,{message_id:14380,message:ie}):l.emit(o.MESSAGE_REPLY,{message_id:6983,message:ie}),a=[])}}},f={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
...
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,n,i){const l='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){n.get(l,!1,!0)&&t.start(),i.register(s.REPORT_SENDER_STARTED,(function(){n.set(l,!0)})),i.register(s.REPORT_SENDER_STOPPED,(function(){n.set(l,!1)}))}),['initial_village'])}))})),define('two/specialQueue',['two/Settings','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/settings/updates','two/specialQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r,c){let d,p,u=!1,g=!1,m=[],b=[];const T='special_queue_settings',E={[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner'};console.log(E);const f=function(){m=[],b=[];const e=i.getGroupList().getGroups(),a=p[t.GROUPNOBLE],n=p[t.GROUPSPECIAL];a.forEach((function(t){m.push(e[t])})),n.forEach((function(t){b.push(e[t])}))},_={init:function(){u=!0,
d=new e({settingsMap:n,storageKey:T}),d.onChange((function(e,t){p=d.getAll(),t[l.GROUPS]&&f()})),p=d.getAll(),console.log('specialQueue settings',p),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){g=!0,c.trigger(s.SPECIAL_QUEUE_START)},stop:function(){g=!1,c.trigger(s.SPECIAL_QUEUE_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return _})),define('two/specialQueue/events',[],(function(){angular.extend(s,{SPECIAL_QUEUE_START:'special_queue_start',SPECIAL_QUEUE_STOP:'special_queue_stop'})})),define('two/specialQueue/ui',['two/ui','two/specialQueue','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d,p){let u,m,b,T=i.getGroupList();const E={NOBLE:'noble',SPECIAL:'special',LOGS:'logs'},f=function(e){u.selectedTab=e},_=function(){m.setAll(m.decode(u.settings)),
p.notif('success',g('i18n')('general.saved',a.loc.ale,'special_queue'))},A=function(){t.isRunning()?t.stop():t.start()},w=function(){u.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.started',a.loc.ale,'special_queue'))},S=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'special_queue'))},v=function(){u=a.$new(),u.SETTINGS=n,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.NOBLE,u.settingsMap=l,u.units=r.encodeList(o,{textObject:'special_queue',disabled:!0}),m.injectScope(u),w(),u.selectTab=f,u.saveSettings=_,u.switchState=A;let e=new d('twoverflow_special_queue_window',(function(){console.log('specialQueue closed')}));e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),
e.register(s.SPECIAL_QUEUE_START,h),e.register(s.SPECIAL_QUEUE_STOP,S),c.getScreenWithInjectedScope('!twoverflow_special_queue_window',u)};return function(){m=t.getSettings(),e.addDivisor(86),b=e.addMenuButton('Weteran',85),b.addEventListener('click',v),
...
isRunning:function(){return p}};return b})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,n,i,l,o,r,d,p){let u,m,b;const T={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},E=function(e){u.selectedTab=e},f=function(){m.setAll(m.decode(u.settings)),p.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},A=function(){u.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},w=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},h=function(){u=a.$new(),
u.SETTINGS=n,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.SPY,u.settingsMap=i,u.building=r.encodeList(l,{textObject:'spy_master',disabled:!0}),u.unit=r.encodeList(o,{textObject:'spy_master',disabled:!0}),m.injectScope(u),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new d('twoverflow_spy_master_window',(function(){console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,A),e.register(s.SPY_MASTER_STOP,w),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',u)};return function(){m=t.getSettings(),b=e.addMenuButton3('Zwiadowca',10),b.addEventListener('click',h),
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,n,l,o,r){let c,d,p=!1,u=!1,g=[],m=[];const b='support_sender_settings',T=function(){g=[];const e=i.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},E=function(){m=[];const e=i.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},f={init:function(){p=!0,c=new e({settingsMap:n,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&T(),t[l.GROUPS]&&E()})),d=c.getAll(),console.log('supportSender settings',d),o((function(){T()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,T),a.$on(s.ARMY_PRESET_DELETED,T),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){u=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.SUPPORT_SENDER_START)},stop:function(){u=!1,
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return f})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,n,l,o,r,d){let p,u,g,m=i.getPresetList(),b=i.getGroupList();const T={SUPPORT:'support',LOGS:'logs'},E=function(e){p.selectedTab=e},f=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},A=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},S=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){p=a.$new(),p.SETTINGS=n,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.SUPPORT,p.settingsMap=l,u.injectScope(p),A(),w(),p.selectTab=E,p.saveSettings=f,p.switchState=_;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.SUPPORT_SENDER_START,h),e.register(s.SUPPORT_SENDER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',p)};return function(){u=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',v),
