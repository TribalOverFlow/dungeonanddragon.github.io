 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),s=injector.get('routeProvider'),l=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),b=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||b,this.listeners=[];const i=a.$on(l.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
"entry/id":"Wioska/gracz/plemie","tooltip.village-id":"Id wioski","tooltip.player-id":"Id gracza","tooltip.tribe-id":"Id plemienia"},mint_helper:{title:"Mincerz",description:"Automatycznie wybija monety gdy włączony.",activated:"Mincerz aktywowany",deactivated:"Mincerz deaktywowany"},power_helper:{title:"Obrona"},prank_helper:{title:"Błazen"},preset_creator:{title:"Wojewoda",description:"Automatycznie tworzy szablony do rekrutacji, fejków i farmy.",activated:"Wojewoda aktywowany",done:"Wojewoda utworzył szablony",deactivated:"Wojewoda skończył działanie"},recruit_queue:{title:"Kapitan",presets:"Szablonowa","presets.recruit":"Rekrutacja z szablonów","presets.group":"Grupa wiosek","presets.preset":"Szablon cząstkowy","presets.presetfinal":"Szablon docelowy","presets.start":"Rekrutuj","presets.clear":"Wyczyść",own:"Własne ustawienia","own.recruit":"Rekrutacja wg własnych ustawień","own.group":"Grupa wiosek","own.amount":"Ilość","own.unit":"Jednostka","own.start":"Rekrutuj",
...
spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function s(t){t=E.call(o,t)?o[t]:t,e.setJSON(i[t]||i[n])}let l={init:function(){if(t)return!1;t=!0,s(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&s(a.loc.ale)}))}};return l})),define('two/Settings',['two/utils','Lockr'],(function(e,i){const o=function(e,t){let a={};for(let i in e)E.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a},s=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},l=function(e,t){let a={};for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,
this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||b},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return E.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!E.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),E.call(i,'min')&&(t=Math.max(i.min,t)),E.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const s=angular.copy(this.settings),r=o(n,s);if(!r)return!1;const c=l(this.settingsMap,r);return this.store(),this.updateScope(),
this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(E.call(this.settingsMap,t)){const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),E.call(a,'min')&&(i=Math.max(a.min,i)),E.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=o(a,i);if(!n)return!1;const s=l(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,s,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!E.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/activityTool',['two/Settings','two/activityTool/settings','two/activityTool/settings/map','two/activityTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='activity_tool_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){
m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('activityTool settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.ACTIVITY_TOOL_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.ACTIVITY_TOOL_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/activityTool/events',[],(function(){angular.extend(l,{ACTIVITY_TOOL_START:'activity_tool_start',ACTIVITY_TOOL_STOP:'activity_tool_stop'})})),
define('two/activityTool/ui',['two/ui','two/activityTool','two/activityTool/settings','two/activityTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,
p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_activity_tool_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.ACTIVITY_TOOL_START,S),e.register(l.ACTIVITY_TOOL_STOP,v),c.getScreenWithInjectedScope('!twoverflow_activity_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Kwatermistrz',40),g.addEventListener('click',A),
...
define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[],b=[],E=[],f=[],_=[];const w='army_helper_settings',h={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(h);const S=function(){m=[],T=[];const e=n.getPresetList().getPresets(),a=u[t.PRESETS1],i=u[t.PRESETS2];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])}))},v=function(){b=[],E=[],f=[],_=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4];a.forEach((function(t){b.push(e[t])})),i.forEach((function(t){
E.push(e[t])})),o.forEach((function(t){f.push(e[t])})),s.forEach((function(t){_.push(e[t])}))},A={init:function(){p=!0,d=new e({settingsMap:i,storageKey:w}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&S(),t[o.GROUPS]&&v()})),u=d.getAll(),console.log('armyHelper settings',u),r((function(){S()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,S),a.$on(l.ARMY_PRESET_DELETED,S),a.$on(l.GROUPS_CREATED,v),a.$on(l.GROUPS_DESTROYED,v),a.$on(l.GROUPS_UPDATED,v)},start:function(){g=!0,c.trigger(l.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(l.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return A})),define('two/armyHelper/events',[],(function(){angular.extend(l,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),
define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,b=n.getPresetList(),E=n.getGroupList();const f={PRESETS:'presets',ARMY:'army',BALANCER:'balancer'},_=function(e){p.selectedTab=e},w=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},S=function(){p.presets=r.encodeList(b.getPresets(),{disabled:!1,type:'presets'})},v=function(){p.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},y=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},R=function(){p=a.$new(),p.SETTINGS=i,
p.TAB_TYPES=f,p.running=t.isRunning(),p.selectedTab=f.PRESETS,p.settingsMap=o,p.unit=r.encodeList(s,{textObject:'army_helper',disabled:!0}),m.injectScope(p),S(),v(),p.selectTab=_,p.saveSettings=w,p.switchState=h;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(l.ARMY_PRESET_UPDATE,S,!0),e.register(l.ARMY_PRESET_DELETED,S,!0),e.register(l.GROUPS_CREATED,v,!0),e.register(l.GROUPS_DESTROYED,v,!0),e.register(l.GROUPS_UPDATED,v,!0),e.register(l.ARMY_HELPER_START,A),e.register(l.ARMY_HELPER_STOP,y),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Administrator',90),T.addEventListener('click',R),
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,T,b,E){let f,_,w=!1,h=injector.get('overviewService'),S=[],v=!1,A={},y={},R={reverse:!1,column:i.TIME_COMPLETED};const k='attack_view_filters',I={},x={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in A[e[t]])if(a[e[t]]||(a[e[t]]=[]),A[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=A[c.VILLAGE]?[t]:[]},N=function(){B.loadCommands()},L=function(e,t){E.trigger(l.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){
for(let e=0;e<S.length;e++)S[e].command_id===t.command_id&&S.splice(e,1);E.trigger(l.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<S.length;e++)S[e].target_village_id===t.village_id?(S[e].target_village_name=t.name,S[e].targetVillage.name=t.name):S[e].origin_village_id===t.village_id&&(S[e].origin_village_name=t.name,S[e].originVillage.name=t.name);E.trigger(l.ATTACK_VIEW_VILLAGE_RENAMED,[t])},G=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],B.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},C=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},U=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let s,l=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=C(r,e);else if(c.length)s=C(c,e);else{if(!i)return t(!1);{const a=l.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);s=C(a,e)}}return t(s[0])}const i=T.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&U(e,t)}))},D=function(e){S=e.commands;for(let e=0;e<S.length;e++)h.formatCommand(S[e]),S[e].slowestUnit=z(S[e]);S=S.filter((function(e){return A[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[S])};let B={loadCommands:function(){const e=f.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:R.column,reverse:R.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},D)},getCommands:function(){return S},getFilters:function(){return A},getSortings:function(){return R},toggleFilter:function(e,t){t?A[e][t]=!A[e][t]:A[e]=!A[e],O(),g.set(k,A),B.loadCommands()},toggleSorting:function(e){e===R.column?R.reverse=!R.reverse:(R.column=e,R.reverse=!1),B.loadCommands()},setCommander:function(e,a){U(e.targetVillage,(function(i){const n=e.targetVillage,o=i,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){l[e]='*'})),v.addCommand(n,o,a,_.OUT,l,{},s,p.WALL),v.isRunning()||v.start()}))},commandQueueEnabled:function(){return!!v},isInitialized:function(){return w},init:function(){for(let e=0;e<d.length;e++)I[d[e]]=!0;for(let e in r)x[r[e]]=!0;try{v=require('two/commandQueue'),_=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(x),
[c.INCOMING_UNITS]:angular.copy(I),[c.VILLAGE]:!1};w=!0,f=n.getSelectedCharacter().getGlobalInfo(),A=g.get(k,t,!0),e((function(){O(),a.$on(l.COMMAND_INCOMING,N),a.$on(l.COMMAND_CANCELLED,L),a.$on(l.MAP_SELECTED_VILLAGE,G),a.$on(l.VILLAGE_NAME_CHANGED,M),a.$on(l.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(l,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,s,d,u,T,b,E,f,_){let w,h;const S=function(){return Date.now()/1e3},v=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},A=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=_('#two-attack-view').parent(),t=_('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=w.pagination.offset,t=w.pagination.limit
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);R()},I=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},x=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},O=function(){w.commands=t.getCommands()},N=function(){w.selectedVillageId=n.getSelectedVillage().getId()},L=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=b,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=T,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=S,w.copyTimeModal=v,w.removeTroops=A,w.switchWindowSize=y,
w.toggleFilter=I,w.toggleSorting=x,R();let e=new i('twoverflow_queue_window',(function(){f.timer.remove(k)}));e.register(l.MAP_SELECTED_VILLAGE,N,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),f.timer.add(k)};return function(){h=e.addMenuButton('Strażnik',30),h.addEventListener('click',L),
...
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},M={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},G={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3},z={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(x,z,G,M,P,L,N,O,R,k,I);const C=function(){A=[];const e=n.getPresetList().getPresets();h[t.PRESET].forEach((function(t){A.push(e[t])}))},U={init:function(){S=!0,w=new e({settingsMap:i,storageKey:y}),w.onChange((function(e,t){h=w.getAll(),t[o.PRESETS]&&C()})),h=w.getAll(),console.log('battleCalculator settings',h),f((function(){C()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,C),a.$on(l.ARMY_PRESET_DELETED,C)},start:function(){v=!0,_.trigger(l.BATTLE_CALCULATOR_START)},
stop:function(){v=!1,console.log('battleCalculator stop'),_.trigger(l.BATTLE_CALCULATOR_STOP)},getSettings:function(){return w},isInitialized:function(){return S},isRunning:function(){return v}};return U})),define('two/battleCalculator/events',[],(function(){angular.extend(l,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p,g,m,T,b,E,f,_,w,h){let S,v,A,y=n.getPresetList();const R={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){S.selectedTab=e},I=function(){v.setAll(v.decode(S.settings)),h.notif('success','Settings saved')},x=function(){t.isRunning()?t.stop():t.start()},O=function(){S.presets=_.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},N=function(){
S.running=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),h.notif('success','battleCalculator started')},L=function(){S.running=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),h.notif('success','battleCalculator stopped')},P=function(){S=a.$new(),S.SETTINGS=i,S.TAB_TYPES=R,S.running=t.isRunning(),S.selectedTab=R.BATTLE,S.settingsMap=o,S.catapulttarget=_.encodeList(d,{textObject:'battle_calculator',disabled:!0}),S.knightitem=_.encodeList(s,{textObject:'battle_calculator',disabled:!0}),S.itemlevel=_.encodeList(r,{textObject:'battle_calculator',disabled:!0}),S.order=_.encodeList(u,{textObject:'battle_calculator',disabled:!0}),S.wall=_.encodeList(p,{textObject:'battle_calculator',disabled:!0}),S.church=_.encodeList(g,{textObject:'battle_calculator',disabled:!0}),S.weaponmaster=_.encodeList(m,{textObject:'battle_calculator',disabled:!0}),S.ironwalls=_.encodeList(T,{textObject:'battle_calculator',disabled:!0}),S.clinique=_.encodeList(b,{
textObject:'battle_calculator',disabled:!0}),S.hospital=_.encodeList(E,{textObject:'battle_calculator',disabled:!0}),S.training=_.encodeList(f,{textObject:'battle_calculator',disabled:!0}),v.injectScope(S),O(),S.selectTab=k,S.saveSettings=I,S.switchState=x;let e=new w('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(l.ARMY_PRESET_UPDATE,O,!0),e.register(l.ARMY_PRESET_DELETED,O,!0),e.register(l.BATTLE_CALCULATOR_START,N),e.register(l.BATTLE_CALCULATOR_STOP,L),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',S)};return function(){v=t.getSettings(),A=e.addMenuButton4('Kalkulator',10),A.addEventListener('click',P),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,b,E,f){let _,w,h,S=injector.get('buildingService'),v=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const k={};let I,x,O,N,L,P=!0;const M='builder_queue_log',G='builder_queue_settings',z=function(){const e=U();if(!P)return F.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},C=function(){U().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
A.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},U=function(){const e=L[r.GROUP_VILLAGES];let a=[];return e?(a=I.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(k);const n=L[r.BUILDING_SEQUENCES][L[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return S.compute(e),B(e,a,(function(t,a){t&&a.job&&(b.trigger(l.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&L[r.PRIORIZE_FARM]){const t=h[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-L[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-L[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-L[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},Y=function(e,t){let a={time:f.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),E.set(M,O),!0};let F={};return F.start=function(){if(!P)return b.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,_=setInterval(z,6e4),w=setInterval(C,6e3),e((function(){U().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),C()}),['all_villages_ready']),b.trigger(l.BUILDER_QUEUE_START)},F.stop=function(){R=!1,clearInterval(_),
clearInterval(w),b.trigger(l.BUILDER_QUEUE_STOP)},F.isRunning=function(){return R},F.isInitialized=function(){return y},F.getSettings=function(){return N},F.getLogs=function(){return O},F.clearLogs=function(){O=[],E.set(M,O),b.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=L[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,O=E.get(M,[],!0),x=n.getSelectedCharacter(),I=n.getGroupList(),N=new i({settingsMap:c,storageKey:G}),N.onChange((function(e,t,a){L=N.getAll(),R&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),L=N.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(L[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=L[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(L[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);D(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=O.selectedSequence.name,i=v.settings[T.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(C){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},L.updateVisibleLogs=function(){const e=v.pagination.logs.offset,t=v.pagination.logs.limit;L.visibleLogs=L.logs.slice(e,e+t),
v.pagination.logs.count=L.logs.length,L.visibleLogs.forEach((function(e){e.villageId&&function(e){if(G[e])return G[e];G[e]=!0,z[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){G[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},L.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[_.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,t)&&(v.settings[T.ACTIVE_SEQUENCE]={name:e.name,value:e.name},v.settings[T.BUILDING_SEQUENCES][e.name]=t,Y(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){v.selectedTab=e},Y=function(){R.setAll(R.decode(v.settings)),C=!1},F=function(){i.isRunning()?i.stop():i.start()},j=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){C?j((function(){M()})):M()},K={updateGroups:function(){v.groups=p.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(T.BUILDING_SEQUENCES);v.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){v.logs=i.getLogs(),L.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=R.get(T.BUILDING_SEQUENCES);v.settings[T.BUILDING_SEQUENCES][t]=i[t],v.settings[T.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=R.get(T.BUILDING_SEQUENCES);v.settings[T.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete v.settings[T.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(E.call(e,t))return t;return!1}(v.settings[T.BUILDING_SEQUENCES]);O.selectedSequence={name:i,value:i},K.updateSequences(),O.generateBuildingSequence(),R.get(T.ACTIVE_SEQUENCE)===t&&(R.set(T.ACTIVE_SEQUENCE,i,{quiet:!0}),N.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){v.running=!0},stopped:function(){v.running=!1}},Q=function(){const e=R.get(T.ACTIVE_SEQUENCE);v=a.$new(),v.selectedTab=P.SETTINGS,v.TAB_TYPES=P,v.SETTINGS=T,v.running=x,v.pagination={},v.settingsMap=R.settingsMap,v.villagesLabel=z,v.villagesInfo=G,v.editorView=O,v.editorView.buildingSequence={},v.editorView.visibleBuildingSequence=[],v.editorView.selectedSequence={name:e,value:e},v.editorView.lastAddedBuilding=_.HEADQUARTER,v.editorView.lastAddedIndex=1,v.settingsView=N,v.settingsView.buildingSequence={},v.settingsView.buildingSequenceFinal={},v.logsView=L,v.logsView.logs=i.getLogs(),v.selectTab=W,v.switchBuilder=F,v.saveSettings=Y,v.createSequence=q,v.openVillageInfo=r.openVillageInfo,R.injectScope(v),K.updateGroups(),K.updateSequences(),v.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},v.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},v.pagination.logs={count:L.logs.length,offset:0,loader:L.updateVisibleLogs,limit:m.getPaginationLimit()},L.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(l.GROUPS_UPDATED,K.updateGroups,!0),t.register(l.GROUPS_CREATED,K.updateGroups,!0),t.register(l.GROUPS_DESTROYED,K.updateGroups,!0),t.register(l.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(l.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(l.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(l.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(l.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(l.BUILDER_QUEUE_START,K.started),t.register(l.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',v),M=v.closeWindow,v.closeWindow=H,v.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),v.$watch('editorView.selectedSequence.value',(function(e,t){U?U=!1:e!==t&&(C?j((function(){K.generateBuildingSequencesEditor(),C=!1}),(function(){v.editorView.selectedSequence={name:t,value:t},U=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),R=i.getSettings(),A=e.addMenuButton2('Budowniczy',20),A.addEventListener('click',Q),h.register(l.BUILDER_QUEUE_START,(function(){x=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),h.register(l.BUILDER_QUEUE_STOP,(function(){x=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const h=Object.values(c),S=Object.values(a),v=Object.values(w),A=Object.values(_),y=Object.values(f);let R,k=[],I={},x=[],O=[],N=!1;const L={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+R},M=function(e){k.push(e)},G=function(e){I[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,k)},C=function(e){return!isNaN(e)&&e>0&&e<1e3},U=function(e){return E.call(e,'x')&&E.call(e,'y')&&C(e.x)&&C(e.y)};let D={initialized:!1};return D.init=function(){R=t.getTimeOffset(),D.initialized=!0,x=b.get(d.QUEUE_SENT,[],!0),O=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?D.expireCommand(e,i.TIME_LIMIT):(M(e),G(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!P(e.sendTime))return!0;N?D.sendCommand(e):D.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&k.length&&(e.returnValue=!0)}))},D.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let s={},l=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return l=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return l=i.NOT_ENOUGH_UNITS,!1;s[t]=e})),angular.equals({},s)&&(l=i.NOT_ENOUGH_UNITS),l||s}(e);if('string'==typeof a)return D.expireCommand(e,a);e.units=a,o.emit(s.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),b.set(d.QUEUE_SENT,x),D.removeCommand(e,i.COMMAND_SENT),p.trigger(l.COMMAND_QUEUE_SEND,e)},D.expireCommand=function(e,t){!function(e){O.push(e)}(e),b.set(d.QUEUE_EXPIRED,O),D.removeCommand(e,t)},D.addCommand=function(e,i,o,s,l,r,d,p){let m={},b={};return new Promise((function(E,R){if(!U(e))return R(u.INVALID_ORIGIN);if(!U(i))return R(u.INVALID_TARGET);if(!t.isValidDateTime(o))return R(u.INVALID_DATE);if(angular.isObject(l)){if(!t.each(l,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return R(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return R(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!A.includes(t))return!1;r[t]&&(b[t]=!0)})))return R(u.INVALID_OFFICER_TYPE)}return h.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[_.SUPPORTER]&&delete b[_.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[w.CATAPULT])&&(p||f.HEADQUARTER),S.includes(s)?void Promise.all([new Promise(t=>T.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>T.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return R(u.INVALID_ORIGIN);if(!i)return R(u.INVALID_TARGET);const l=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=s===a.ARRIVE?l-r:l,T=s===a.ARRIVE?l:l+r;if(P(c))return R(u.ALREADY_SENT);const f={id:t.guid(),travelTime:r,arriveTime:T,sendTime:c,origin:e,target:i,date:o,dateType:s,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};M(f),G(f),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),E(f)})):R(u.INVALID_DATE_TYPE)):R(u.INVALID_CATAPULT_TARGET)):R(u.RELOCATE_DISABLED):R(u.INVALID_COMMAND_TYPE)}))},D.removeCommand=function(e,t){delete I[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(l.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(l.COMMAND_QUEUE_REMOVE,e)}else p.trigger(l.COMMAND_QUEUE_REMOVE_ERROR,e);return a},D.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),O=[],x=[]},D.start=function(e){N=!0,p.trigger(l.COMMAND_QUEUE_START,{disableNotif:!!e})},D.stop=function(){N=!1,p.trigger(l.COMMAND_QUEUE_STOP)},D.isRunning=function(){return N},D.getWaitingCommands=function(){return k},D.getWaitingCommandsObject=function(){return I},D.getSentCommands=function(){return x},
D.getExpiredCommands=function(){return O},D.filterCommands=function(e,t,a){const i=L[e];return(a||k).filter((function(e){return i(e,t)}))},D})),define('two/commandQueue/events',[],(function(){angular.extend(l,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,s,d,u,p,m,T,b,E,f,_,w){let h,S,v,A,y,R=n.getGameData(),k=R.getOrderedUnitNames(),I=R.getOrderedOfficerNames(),x=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},L=N.ADD;let P,M,G,z=[],C={},U={};const D={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){O=t.data},q=function(){O=!1},W=function(e){
const t=new Date(e||f.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=f.zerofill(a-a%100,3),n=f.zerofill(t.getSeconds(),2),s=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+s+':'+n+':'+i+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(h.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!h.isValidDate&&o.getTimeFromString(y.date),t=h.selectedDateType.value===s.ARRIVE;o.each(p,(function(a){o.each(D,(function(i,n){const s=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);h.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(s),h.travelTimes[a][n].status=e?j(t?e-s:e):'neutral'}))}))},j=function(e){return e&&h.isValidDate?f.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=h.selectedDateType.value,w.set(m.LAST_DATE_TYPE,h.selectedDateType.value),F()},K=function(){
y.catapultTarget=h.catapultTarget.value},Q=function(){const e=h.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];h.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,h.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},h.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=f.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),f.timer.add(e.updateCountdown)},Z=function(){h.waitingCommands=t.getWaitingCommands()},J=function(){h.sentCommands=t.getSentCommands()},$=function(){h.expiredCommands=t.getExpiredCommands()},ee=function(){let e=h.waitingCommands;B.forEach((function(a){h.activeFilters[a]&&(e=t.filterCommands(a,h.filtersData,e))})),
h.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){h.showCatapultSelect=!!y.units.catapult},ne=function(e){h.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:v.getId()}},se=function(){if(!O)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},le=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=Y(y.date,100)},ce=function(){if(!y.date)return!1;y.date=Y(y.date,-100)},de=function(){y.units=angular.copy(C),y.officers=angular.copy(U),y.catapultTarget="wall",h.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},h.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){Z(),ee(),X(e),
...
t&&(h.filtersData[u.ALLOWED_TYPES][e]=!h.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){h.activeFilters[u.TEXT_MATCH]=h.filtersData[u.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){h.presets=o.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},h.searchQuery[i]=''},removeCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(h.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){h.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{f.timer.remove(e.updateCountdown)})}},fe=function(){const e=w.get(m.LAST_DATE_TYPE,s.OUT,!0);let T;h=a.$new(),h.selectedTab=L,h.inventory=n.getInventory(),h.presets=o.obj2selectOptions(x.getPresets()),h.travelTimes={},o.each(p,(function(e){h.travelTimes[e]={},o.each(D,(function(t,a){h.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),h.unitOrder=A,h.officers=R.getOrderedOfficerNames(),h.searchQuery={origin:'',target:''},h.isValidDate=!1,h.dateTypes=_.toActionList(s,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),h.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},h.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},h.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},h.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},h.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},h.showCatapultSelect=!!y.units.catapult,h.attackableBuildings=z,h.commandData=y,
h.activeFilters=M,h.filtersData=G,h.running=t.isRunning(),h.waitingCommands=t.getWaitingCommands(),h.visibleWaitingCommands=t.getWaitingCommands(),h.sentCommands=t.getSentCommands(),h.expiredCommands=t.getExpiredCommands(),h.EVENT_CODES=d,h.FILTER_TYPES=u,h.TAB_TYPES=N,h.COMMAND_TYPES=p,h.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),h.onUnitInputFocus=te,h.onUnitInputBlur=ae,h.catapultTargetVisibility=ie,h.selectTab=ne,h.addSelected=oe,h.addMapSelected=se,h.addCurrentDate=le,h.incrementDate=re,h.reduceDate=ce,h.cleanUnitInputs=de,h.addCommand=ue,h.clearRegisters=pe,h.switchCommandQueue=ge,h.removeCommand=t.removeCommand,h.openVillageInfo=r.openVillageInfo,h.toggleFilter=Te,h.$watch('commandData.origin',F),h.$watch('commandData.target',F),h.$watch('commandData.date',F),h.$watch('commandData.officers',F),h.$watch('selectedDateType.value',H),h.$watch('selectedInsertPreset.value',Q),h.$watch('catapultTarget.value',K),h.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',be),
h.$watch('selectedTab',(function(){h.selectedTab===N.ADD?T=setInterval((function(){F()}),2500):clearInterval(T)})),h.waitingCommands.forEach(e=>{X(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(T),Ee.clearCountdownUpdates()}));b.register(l.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),b.register(l.ARMY_PRESET_DELETED,Ee.updatePresets,!0),b.register(l.SELECT_SELECTED,Ee.autoCompleteSelected,!0),b.register(l.COMMAND_QUEUE_REMOVE,Ee.removeCommand),b.register(l.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),b.register(l.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),b.register(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),b.register(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),b.register(l.COMMAND_QUEUE_SEND,Ee.sendCommand),b.register(l.COMMAND_QUEUE_START,Ee.start),b.register(l.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',h)};return function(){v=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=R.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});A=angular.copy(k),A.splice(A.indexOf('catapult'),1),k.forEach((function(e){C[e]=0})),I.forEach((function(e){U[e]=!1})),y={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(C),officers:angular.copy(U),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},G={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},S=e.addMenuButton('Generał',10),S.addEventListener('click',fe),b.register(l.COMMAND_QUEUE_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),b.register(l.COMMAND_QUEUE_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,V),a.$on(l.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,T,b,E=!1,f=!1,_=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(s.VILLAGES_IN_PROVINCE,{village_id:e},t)};let w={init:function(){E=!0}};return w.start=function(){i.trigger(l.FAITH_CHECKER_STARTED),f=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,l=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),E=c.food,f=c.wood,w=c.clay,h=c.iron,S=E.currentStock,v=f.currentStock,A=w.currentStock,y=h.currentStock,R=[0,5e3],k=[160,16e3],I=[200,2e4],x=[50,5e3];1==l&&(_=1),m(n,(function(i){T=u(i.villages),b=p(T,1===l),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=_?'chapel'==i&&'church'==i||1!=_||(v>=k[1]&&A>=I[1]&&y>=x[1]&&S>=R[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):v>=k[0]&&A>=I[0]&&y>=x[0]&&S>=R[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==_?v>=k[1]&&A>=I[1]&&y>=x[1]&&S>=R[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):v>=k[0]&&A>=I[0]&&y>=x[0]&&S>=R[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},w.stop=function(){i.trigger(l.FAITH_CHECKER_STOPPED),f=!1},w.isRunning=function(){return f},w.isInitialized=function(){return E},w})),define('two/faithChecker/events',[],(function(){angular.extend(l,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(l.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(l.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,i,n){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.FAITH_CHECKER_STARTED,(function(){i.set(o,!0)})),n.register(l.FAITH_CHECKER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c,d){let u,p,g=!1,m=!1,T=[],b=[],E=[],f=[],_=[];const w='fake_sender_settings',h={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',
[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},S={[s.ATTACK]:'attack',[s.SUPPORT]:'support',[s.QUATTRO]:'four',[s.FULL]:'full'};console.log(h,S);const v=function(){T=[],b=[],E=[],f=[],_=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP],i=p[t.GROUPP],o=p[t.GROUPT],s=p[t.GROUPG],l=p[t.GROUP_TARGET];a.forEach((function(t){T.push(e[t])})),i.forEach((function(t){b.push(e[t])})),o.forEach((function(t){E.push(e[t])})),s.forEach((function(t){f.push(e[t])})),l.forEach((function(t){_.push(e[t])}))},A={init:function(){g=!0,u=new e({settingsMap:i,storageKey:w}),u.onChange((function(e,t){p=u.getAll(),t[o.GROUPS]&&v()})),p=u.getAll(),console.log('fakeSender settings',p),a.$on(l.GROUPS_CREATED,v),a.$on(l.GROUPS_DESTROYED,v),a.$on(l.GROUPS_UPDATED,v)},start:function(){m=!0,d.trigger(l.FAKE_SENDER_START)},
stop:function(){m=!1,d.trigger(l.FAKE_SENDER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return A})),define('two/fakeSender/events',[],(function(){angular.extend(l,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p){let m,T,b,E=n.getGroupList();const f={FAKE:'fake',LOGS:'logs'},_=function(e){m.selectedTab=e},w=function(){T.setAll(T.decode(m.settings)),p.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},h=function(){t.isRunning()?t.stop():t.start()},S=function(){m.groups=d.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},v=function(){m.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),
p.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},A=function(){m.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},y=function(){m=a.$new(),m.SETTINGS=i,m.TAB_TYPES=f,m.running=t.isRunning(),m.selectedTab=f.FAKE,m.settingsMap=o,m.type=d.encodeList(s,{textObject:'fake_sender',disabled:!0}),m.units=d.encodeList(r,{textObject:'fake_sender',disabled:!0}),T.injectScope(m),S(),m.selectTab=_,m.saveSettings=w,m.switchState=h;let e=new u('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(l.GROUPS_CREATED,S,!0),e.register(l.GROUPS_DESTROYED,S,!0),e.register(l.GROUPS_UPDATED,S,!0),e.register(l.FAKE_SENDER_START,v),e.register(l.FAKE_SENDER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',m)};return function(){T=t.getSettings(),e.addDivisor(21),b=e.addMenuButton('Watażka',20),b.addEventListener('click',y),
...
function(){const e=C.concat(z);let t=!1;e.forEach((function(e){E.call(x,e)||(x[e]={time:w.gameTime(),report:!1},t=!0)})),T.each(x,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete x[i],t=!0)})),t&&(R.set($,x),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),h.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id&&(o?(ke(t.village_id),s=!0):(Oe(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),n.includes(t.group_id)&&o){let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id)if(o){
let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}else Ne(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(ke(t.village_id),s=!0),s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){const t=n.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],s=E.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),l=i.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));k.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ne(),Re(),Ne(),ye()},ce=function(){D=[];const e=n.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),D.push(a)})),D=D.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),
D.length||(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Le.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===S.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},pe=function(e,t){B&&q&&t.origin.id===B.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===S.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&q&&t.cause===s.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},Te=function(e){x[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],R.set($,x),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,G.unshift(t),Ee(),!0)},Ee=function(){const e=I[r.LOGS_LIMIT]
;G.length>e&&G.splice(G.length-e,G.length),R.set(Z,G),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},fe=function(e,t,a){const i=I[r.TARGET_MULTIPLE_FARMERS],n=I[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},_e=function(){K=w.gameTime()},we=function(){clearTimeout(Y),clearTimeout(F),clearTimeout(j),Y=null,F=null,j=null},he=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},Se=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},ve=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};ve.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e()
;this.loadTargets(()=>{h.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},ve.prototype.start=function(){return _e(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,h.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),!0):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,h.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=b},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;_e();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,
!this.running)return a(i.USER_STOP);t()},T.randomSeconds(Se())):t()}),f=()=>new Promise((e,a)=>{const n=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),A=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()}),R=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),k=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(s.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),x=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[]
;if(D.forEach((function(e){E.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)E.call(a,e)&&i.push(e);o.emit(s.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*I[r.MAX_TRAVEL_TIME],s=this.village.getPosition(),l=_.actualDistance(s,a);T.each(D,s=>{if(!!Object.entries(s.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(s,{barbarian:!a.character_id,officers:!1});return o>r*l?(g=s,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),L=()=>new Promise((e,n)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),
fe(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(w.gameTime()/1e3),s=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],l=this.village.getPosition(),m=_.actualDistance(l,a),T=d.calculateTravelTime(g,{barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,T,m,S.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP)
;const n=a.commands.own.filter(e=>e.type===S.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),s=n.some(e=>e.start_village_id===this.villageId);if(fe(s,o,!0))return t(i.BUSY_TARGET);e()})});let G=new Promise((e,t)=>{b().then(f).then(A).then(R).then(k).then(x).then(N).then(L).then(P).then(M).then(e).catch(t)}),C=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([G,C]).then(()=>{if(!this.running)return!1;this.setStatus(i.ATTACKING),V=!0,q=a,this.index++,o.emit(s.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:S.TYPES.ATTACK})}).catch(t=>{switch(we(),h.trigger(l.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,
this.setStatus(t),Oe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},ve.prototype.setStatus=function(e){this.status=e},ve.prototype.getStatus=function(){return this.status||i.UNKNOWN},ve.prototype.commandSent=function(e){V=!1,q=!1,we(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},ve.prototype.commandError=function(){V=!1,q=!1,this.stop(i.COMMAND_ERROR)},ve.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},ve.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=_.actualDistance(t,e),e}))}(a,t),
this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},ve.prototype.getTargets=function(){return this.targets},ve.prototype.getIndex=function(){return this.index},ve.prototype.getVillage=function(){return this.village},ve.prototype.isRunning=function(){return this.running},ve.prototype.isInitialized=function(){return this.initialized},ve.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},ve.prototype.getId=function(){return this.villageId};const Ae=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!U.includes(e))return!1;if(C.includes(e))return!1;let a=Le.getFarmer(e);return a||(a=new ve(e),M.push(a)),a
},ye=function(){T.each(O.getVillages(),(function(e,t){Ae(t)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=I[r.GROUP_ONLY];let t=[];M.forEach((function(a){let i=a.getId();e.length&&!U.includes(i)?t.push(i):C.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){ke(e)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1},Ie=function(e){_e(),M.length?W>=M.length?(W=0,B=!1,X=w.gameTime()+he(),h.trigger(l.FARM_OVERFLOW_CYCLE_END)):B=M[W]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,Ie())})),"cycle_begin"===e&&(X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,W=0,X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),Ie()}),he())},xe=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){
M.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Le={};return Le.init=function(){L=!0,G=R.get(Z,[]),x=R.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){I=k.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Ne(),t[p.VILLAGES]&&(Re(),ye()),t[p.LOGS]&&Ee(),t[p.INTERVAL_TIMERS]&&P&&(F?(we(),B.targetStep({delay:!0})):Y&&(we(),h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),W=0,Ie())))})),I=k.getAll(),le("ignore_update"),ne(),ye(),f((function(){ce()}),'presets'),f((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(l.ARMY_PRESET_UPDATE,de),a.$on(l.ARMY_PRESET_DELETED,de),a.$on(l.GROUPS_VILLAGE_LINKED,oe),a.$on(l.GROUPS_VILLAGE_UNLINKED,se),a.$on(l.GROUPS_DESTROYED,re),a.$on(l.COMMAND_SENT,pe),a.$on(l.MESSAGE_ERROR,ge),a.$on(l.REPORT_NEW,ue)},Le.start=function(){let e
;return!P&&(D.length?(P=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Ie("cycle_begin")})),_e(),function(){let e=he(),t=e+e/2+Se();Q=setInterval((function(){w.gameTime()-K>t&&(Le.stop(),setTimeout(Le.start,5e3))}),3e4)}(),h.trigger(l.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Le.stop=function(e=i.USER_STOP){B?(B.stop(e),e!==i.USER_STOP&&(X=w.gameTime()+he()),h.trigger(l.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,we(),h.trigger(l.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Le.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Le.getFarmers=function(){return M},Le.getSettings=function(){return k},Le.getExceptionVillages=function(){return{included:z,ignored:C}},Le.getExceptionLogs=function(){return x},Le.isInitialized=function(){return L},Le.isRunning=function(){return P},
Le.getLogs=function(){return G},Le.clearLogs=function(){return G=[],R.set(Z,G),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED),G},Le.getNextCycleDate=function(){return X},Le.getCycleInterval=he,Le})),define('two/farmOverflow/events',[],(function(){angular.extend(l,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',FARM_OVERFLOW_INSTANCE_STOP:'farm_overflow_instance_stop',FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS:'farm_overflow_instance_error_no_targets',FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY:'farm_overflow_instance_error_not_ready',FARM_OVERFLOW_INSTANCE_STEP_STATUS:'farm_overflow_instance_command_status',FARM_OVERFLOW_PRESETS_LOADED:'farm_overflow_presets_loaded',FARM_OVERFLOW_LOGS_UPDATED:'farm_overflow_log_updated',FARM_OVERFLOW_COMMAND_SENT:'farm_overflow_command_sent',FARM_OVERFLOW_IGNORED_TARGET:'farm_overflow_ignored_target',
FARM_OVERFLOW_VILLAGE_IGNORED:'farm_overflow_village_ignored',FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED:'farm_overflow_exception_villages_updated',FARM_OVERFLOW_FARMER_VILLAGES_UPDATED:'farm_overflow_farmer_villages_updated',FARM_OVERFLOW_REPORTS_UPDATED:'farm_overflow_reports_updated',FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED:'farm_overflow_exception_logs_updated',FARM_OVERFLOW_CYCLE_BEGIN:'farm_overflow_cycle_begin',FARM_OVERFLOW_CYCLE_END:'farm_overflow_cycle_end'})})),define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,E,f,_,w,h){let S,v,A,y=n.getPresetList(),R=n.getGroupList(),k={},I={},x=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=S.pagination.offset,t=S.pagination.limit;S.visibleLogs=S.logs.slice(e,e+t),
S.pagination.count=S.logs.length,S.visibleLogs.forEach((function(e){e.villageId&&L(e.villageId),e.targetId&&L(e.targetId)}))},L=function(e){if(k[e])return k[e];k[e]=!0,I[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){S.exceptionVillages.included.forEach((function(e){L(e)})),S.exceptionVillages.ignored.forEach((function(e){L(e)}))},M=function(){t.isRunning()?t.stop():t.start()},G=function(e){S.selectedTab=e},z=function(){v.setAll(v.decode(S.settings)),S.saveButtonColor='orange',_.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},C=function(e){const t=v.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},U=function(e){
v.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){S.presets=E.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){S.groups=E.encodeList(R.getGroups(),{disabled:!1,type:'groups'}),S.groupsWithDisabled=E.encodeList(R.getGroups(),{disabled:!0,type:'groups'})},V=function(){S.running=!0,_.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(S.running=!1,S.showCycleTimer=!1,clearInterval(x),t.reason){case d.NO_PRESETS:_.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:_.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){S.logs=angular.copy(t.getLogs()),N(),S.logs.length||_.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){S.farmers=t.getFarmers()},F=function(){S.exceptionVillages=t.getExceptionVillages(),P()
},j=function(){S.exceptionLogs=t.getExceptionLogs()},H=function(){S.showCycleTimer=!1,clearInterval(x)},K=function(e,a){a!==i.USER_STOP&&(S.showCycleTimer=!0,S.nextCycleCountdown=t.getCycleInterval(),x=setInterval((function(){S.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;S=a.$new(),S.SETTINGS=b,S.TAB_TYPES=O,S.LOG_TYPES=u,S.running=t.isRunning(),S.selectedTab=O.SETTINGS,S.farmers=t.getFarmers(),S.villagesLabel=I,S.villagesInfo=k,S.exceptionVillages=t.getExceptionVillages(),S.exceptionLogs=t.getExceptionLogs(),S.logs=t.getLogs(),S.visibleLogs=[],S.showCycleTimer=!1,S.nextCycleCountdown=0,S.saveButtonColor='orange',S.settingsMap=v.settingsMap,S.pagination={count:S.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},v.injectScope(S),D(),B(),N(),P(),function(){let e=t.getNextCycleDate();e&&(S.showCycleTimer=!0,S.nextCycleCountdown=e-h.gameTime(),x=setInterval((function(){S.nextCycleCountdown-=1e3}),1e3))}(),S.switchFarm=M,S.selectTab=G,S.saveSettings=z,
S.clearLogs=t.clearLogs,S.jumpToVillage=p.jumpToVillage,S.openVillageInfo=r.openVillageInfo,S.showReport=T.showReport,S.removeIgnored=C,S.removeIncluded=U;let i=new f('twoverflow_farm_overflow_window',(function(){clearInterval(x)}));i.register(l.ARMY_PRESET_UPDATE,D,!0),i.register(l.ARMY_PRESET_DELETED,D,!0),i.register(l.GROUPS_UPDATED,B,!0),i.register(l.GROUPS_CREATED,B,!0),i.register(l.GROUPS_DESTROYED,B,!0),i.register(l.FARM_OVERFLOW_START,V),i.register(l.FARM_OVERFLOW_STOP,q),i.register(l.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,Y),i.register(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),i.register(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,j),i.register(l.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(l.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',S),S.$watch('settings',(function(){e||(S.saveButtonColor='red'),e=!1}),!0)};return function(){v=t.getSettings(),A=e.addMenuButton2('Farmer',10),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/kingTool',['two/Settings','two/kingTool/settings','two/kingTool/settings/map','two/kingTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='king_tool_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('kingTool settings',d),s((function(){b()
}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.EXAMPLE_MODULE_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.EXAMPLE_MODULE_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/kingTool/events',[],(function(){angular.extend(l,{KING_TOOL_START:'king_tool_start',KING_TOOL_STOP:'king_tool_stop'})})),define('two/kingTool/ui',['two/ui','two/kingTool','two/kingTool/settings','two/kingTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')
},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_king_tool_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.KING_TOOL_START,S),e.register(l.KING_TOOL_STOP,v),
...
require(['two/ready','two/kingTool','two/kingTool/ui','two/kingTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='market_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('marketHelper settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),
a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.MARKET_HELPER_START)},stop:function(){p=!1,console.log('marketHelper stop'),r.trigger(l.MARKET_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/marketHelper/events',[],(function(){angular.extend(l,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){
u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','marketHelper started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','marketHelper stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_market_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.MARKET_HELPER_START,S),e.register(l.MARKET_HELPER_STOP,v),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,T,b,f,_,w,h,S,v){let A,y,R,k,I,x,O,N,L,P,M,G,z,C,U,D,B,V,q,W,Y,F,j,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/y)%2&&(t+=k),t-=t%y,a-=a%y,{x:Math.ceil((t-L.width/2)/y),y:Math.ceil((a-L.height/2)/y)}},be=function(e,t){return{x:e/S.TILESIZE.x,y:t/S.TILESIZE.y/S.TILESIZE.off}},Ee=function(){ve(I)},fe=function(){if(H){const e={x:ee.x-L.width/2,y:ee.y-L.height/2};P.clearRect(0,0,L.width,L.height),C.clearRect(0,0,z.width,z.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),j[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;C.fillStyle=j[o.COLOR_VIEW_REFERENCE],C.fillRect(a,0,1,R),C.fillRect(0,i,R,1);const n=D.getBoundingClientRect(),s=n.width/S.TILESIZE.x/v.view.z*y,l=n.height/S.TILESIZE.y/v.view.z*y,r=a-s/2,c=i-l/2;C.clearRect(r,c,s,l),C.beginPath(),C.lineWidth=1,C.strokeStyle=j[o.COLOR_VIEW_REFERENCE],C.rect(r,c,s,l),C.stroke()}(e)}e.requestAnimationFrame(fe)},_e=function(){if(!ie)return!1;const e=Q.village[O][N];he(e?Q.character[e]:[[O,N]]),ie=!1,
m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t,j[o.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t)},Se=function(e){if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!j[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===x.getId()&&j[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(j[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&j[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(Y&&j[o.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return W.ally;if(Y.isEnemy(e.tribe_id))return W.enemy
;if(Y.isNAP(e.tribe_id))return W.friendly}}return W.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Se(i);if(!n)continue;const o=i.x*y+(i.y%2?k:0),s=i.y*y;G.fillStyle=n,G.fillRect(o,s,A,A)}},Ae=function(){A=oe[j[o.MAP_SIZE]],k=Math.round(A/2),y=A+1,R=1e3*y,J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y,M.width=1e3*y,M.height=1e3*y,G.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;L.width=686,L.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,C.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(j[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({
type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!j[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;_e()}ie=!0,O=e.x,N=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=Q.village[O][N];we(a?Q.character[a]:[[O,N]])}(pe,e)}_e()},xe=function(){ie&&_e(),m.trigger(l.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},Ne=function(e){return e.preventDefault(),!1},Le=function(){K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t];const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e]),
a.$broadcast(l.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){L=e,L.style.background=j[o.COLOR_BACKGROUND],P=L.getContext('2d')},setViewportRef:function(e){z=e,C=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return F},Me.drawMinimap=function(){ge&&(ge=!1),L.style.background=j[o.COLOR_BACKGROUND],G.clearRect(0,0,M.width,M.height),d((function(){!function(){
const e=_.getPath(S.getMapPath()),t=j[o.SHOW_CONTINENT_DEMARCATIONS],a=j[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){G.fillStyle=j[o.COLOR_CONTINENT],G.fillRect(e*y+k-1,t*y+k-1,3,1),G.fillRect(e*y+k,t*y+k-2,1,3)},n=function(e,t){G.fillStyle=j[o.COLOR_PROVINCE],G.fillRect(e*y+k,t*y+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=f.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*y,c=l.a*y,d=(s.b-s.a)*y,u=(l.b-l.a)*y;G.beginPath(),G.lineWidth=2,G.strokeStyle="#2B4700",G.rect(r,c,d,u),G.stroke()}))}(),Ee()}),'minimap_data')},Me.enableRendering=function(){H=!0},Me.disableRendering=function(){H=!1},Me.isFirstDraw=function(){return!!ge},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),G=M.getContext('2d'),re=le.make('hover'),F=new u({settingsMap:s,storageKey:ne}),F.onChange((function(e,t){j=F.getAll(),
Ae(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),j=F.getAll(),K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ae()},Me.run=function(){d((function(){D=document.getElementById('map'),U=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),W=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),ye(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*y,ee.y=x.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Re),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y}(),fe(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,Ee),a.$on(l.GROUPS_VILLAGES_CHANGED,Le)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,b,E,f,_,w,h){let S,v,A,y,R,k,I,x,O,N,L,P={},M=!1,G={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},C=z.MINIMAP,U=function(e){S.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(S.highlights.character).forEach((function(e){e in G.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
G.character[e]=t.character_name}))})),Object.keys(S.highlights.tribe).forEach((function(e){e in G.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){G.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!O)return;let a=B(t.x,t.y);var i,n;N=a,P[a]=!0,M=!0,(i=t.x,n=t.y,new Promise((function(e){let t=_.getTownAt(i,n);if(t)return e(t);_.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!M)return;I.appendChild(O),O.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=O.getBoundingClientRect(),i=I.getBoundingClientRect(),n=a.width+50,o=a.height+50,s=k.tt.position.y+o>i.top+i.height,l=k.tt.position.x+n>i.width;s&&(k.tt.position.y-=50),O.classList.toggle('left',l),O.classList.toggle('top',s)}))},q=function(e,t){if(!O)return;let a=t?B(t):N;P[a]=!1,M=!1,k.tt.visible=!1,O.classList.add('ng-hide'),x.appendChild(O)},W=function(e,t,i){let o,s,l=a.$new(),r=!0;l.colorPalettes=h.palette,'setting'===e?(s=t,o=L.get(s),r=!1,l.submit=function(){S.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){S.settings[s]=L.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=S.addHighlightColor,l.submit=function(){S.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=S.highlights[t][i],l.submit=function(){n.addHighlight({id:i,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
c.getModal('modal_color_palette',l)},Y=function(){n.addHighlight(S.selectedHighlight,S.addHighlightColor)},F=function(){L.setAll(L.decode(S.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},j=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){L.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(S.highlights.character).length+Object.keys(S.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){S.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){D()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},X=function(){S=a.$new(),S.SETTINGS=p,S.TAB_TYPES=z,S.selectedTab=C,S.selectedHighlight=!1,S.addHighlightColor='#000000',S.highlights=n.getHighlights(),S.highlightNames=G,S.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),S.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),S.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},S.selectTab=U,S.openColorPalette=W,S.addCustomHighlight=Y,S.removeHighlight=n.removeHighlight,S.saveSettings=F,S.resetSettings=j,S.highlightsCount=H,S.openProfile=K,L.injectScope(S,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,q),e.register(l.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',S),D(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(A),R.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){L=n.getSettings(),k=i.getSharedData('MapController'),A=document.createElement('canvas'),A.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(A),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),I=document.querySelector('#wrapper'),x=document.querySelector('#map'),v=t.addMenuButton4('Minimapa',30),v.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(l.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/powerHelper',['two/Settings','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='power_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={
init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('powerHelper settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.POWER_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/powerHelper/events',[],(function(){angular.extend(l,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),
w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_power_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.POWER_HELPER_START,S),e.register(l.POWER_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton4('Obrona',20),g.addEventListener('click',A),
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='prank_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('all settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),
a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.PRANK_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.PRANK_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/prankHelper/events',[],(function(){angular.extend(l,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){
u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.PRANK_HELPER_START,S),e.register(l.PRANK_HELPER_STOP,v),
c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Błazen',60),g.addEventListener('click',A),
...
e.addStyle('#two-prank-helper div[select]{float:right}#two-prank-helper div[select] .select-handler{line-height:28px}#two-prank-helper .range-container{width:250px}#two-prank-helper .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-prank-helper .textfield-border.fit{width:100%}')}})),define('two/prankHelper/settings',[],(function(){return{PRESETS:'presets',GROUPS:'groups',SOME_NUMBER:'some_number'}})),define('two/prankHelper/settings/updates',(function(){return{PRESETS:'presets',GROUPS:'groups'}})),define('two/prankHelper/settings/map',['two/prankHelper/settings','two/prankHelper/settings/updates'],(function(e,t){return{[e.PRESETS]:{default:[],updates:[t.PRESETS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'presets'},[e.GROUPS]:{default:[],updates:[t.GROUPS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'groups'},[e.SOME_NUMBER]:{default:60,inputType:'number',min:0,max:120}}})),
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',T='060502',b='060501',E='060503',f='05020a',_='05030a',w='04080a',h='040a0a',S='070e04',v='070e05',A='070e0f',y='070e06',R='070e02',k='070e01',I='070e03',x='070e07',O='070e0b',N='070e0e',L='030d07',P='030d0b',M='030d0e';var G={init:function(){i=!0}};return G.start=function(){e.trigger(l.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,T='string'==typeof T?parseInt(T,16):T,b='string'==typeof b?parseInt(b,16):b,E='string'==typeof E?parseInt(E,16):E,f='string'==typeof f?parseInt(f,16):f,
_='string'==typeof _?parseInt(_,16):_,w='string'==typeof w?parseInt(w,16):w,h='string'==typeof h?parseInt(h,16):h,S='string'==typeof S?parseInt(S,16):S,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,y='string'==typeof y?parseInt(y,16):y,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,I='string'==typeof I?parseInt(I,16):I,x='string'==typeof x?parseInt(x,16):x,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,L='string'==typeof L?parseInt(L,16):L,P='string'==typeof P?parseInt(P,16):P,M='string'==typeof M?parseInt(M,16):M,o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:20,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (miecz)',
...
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),G.stop()},G.stop=function(){e.trigger(l.PRESET_CREATOR_STOPPED),r=!1},G.isRunning=function(){return r},G.isInitialized=function(){return i},G})),define('two/presetCreator/events',[],(function(){angular.extend(l,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(101),o=e.addMenuButton('Wojewoda',100,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
...
define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[],b=[],E=[],f=[],_=[],w=[],h=[],S=[],v=[],A=[],y=[],R=[],k=[],I=[],x=[],O=[],N=[],L=[],P=[],M=[],G=[],z=[],C=[],U=[],D=[],B=[],V=[],q=[],W=[],Y=[],F=[];const j='recruit_queue_settings',H={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],T=[],b=[],E=[],f=[],_=[],w=[],h=[]
;const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],s=u[t.PRESET4],l=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])})),o.forEach((function(t){b.push(e[t])})),s.forEach((function(t){E.push(e[t])})),l.forEach((function(t){f.push(e[t])})),r.forEach((function(t){_.push(e[t])})),c.forEach((function(t){w.push(e[t])})),d.forEach((function(t){h.push(e[t])}))},Q=function(){S=[],v=[],A=[],y=[],R=[],k=[],I=[],x=[],O=[],N=[],L=[],P=[],M=[],G=[],z=[],C=[],U=[],D=[],B=[],V=[],q=[],W=[],Y=[],F=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4],l=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],b=u[t.GROUP13],E=u[t.GROUP14],f=u[t.GROUP15],_=u[t.GROUP16],w=u[t.GROUP17],h=u[t.GROUP18],j=u[t.GROUP19],H=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){S.push(e[t])})),i.forEach((function(t){v.push(e[t])})),o.forEach((function(t){A.push(e[t])})),s.forEach((function(t){y.push(e[t])})),l.forEach((function(t){R.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){x.push(e[t])})),p.forEach((function(t){O.push(e[t])})),g.forEach((function(t){N.push(e[t])})),m.forEach((function(t){L.push(e[t])})),T.forEach((function(t){P.push(e[t])})),b.forEach((function(t){M.push(e[t])})),E.forEach((function(t){G.push(e[t])})),f.forEach((function(t){z.push(e[t])})),_.forEach((function(t){
...
RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,b=n.getPresetList(),E=n.getGroupList();const f={PRESETS:'presets',OWN:'own',LOGS:'logs'},_=function(e){p.selectedTab=e},w=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},S=function(){p.presets=r.encodeList(b.getPresets(),{disabled:!1,type:'presets'})},v=function(){p.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},y=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),
u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},R=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=f,p.running=t.isRunning(),p.selectedTab=f.PRESETS,p.settingsMap=o,p.units=r.encodeList(s,{textObject:'recruit_queue',disabled:!0}),m.injectScope(p),S(),v(),p.selectTab=_,p.saveSettings=w,p.switchState=h;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed')}));e.register(l.ARMY_PRESET_UPDATE,S,!0),e.register(l.ARMY_PRESET_DELETED,S,!0),e.register(l.GROUPS_CREATED,v,!0),e.register(l.GROUPS_DESTROYED,v,!0),e.register(l.GROUPS_UPDATED,v,!0),e.register(l.recruit_queue_START,A),e.register(l.recruit_queue_STOP,y),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Kapitan',80),T.addEventListener('click',R),
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='report_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('reportHelper settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,
console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.REPORT_HELPER_START)},stop:function(){p=!1,console.log('reportHelper stop'),r.trigger(l.REPORT_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/reportHelper/events',[],(function(){angular.extend(l,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){
u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_report_helper_window',(function(){console.log('reportHelper window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.REPORT_HELPER_START,S),e.register(l.REPORT_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',u)};return function(){p=t.getSettings(),
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('supportSender settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),
r.trigger(l.SUPPORT_SENDER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/supportSender/events',[],(function(){angular.extend(l,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,
type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.SUPPORT_SENDER_START,S),e.register(l.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',A),
