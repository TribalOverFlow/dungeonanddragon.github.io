 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),b=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||b,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
let d,u,p=!1,g=!1,m=[],_=[],b=[],E=[];const T='army_helper_settings',f={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(f);const h=function(){m=[],_=[],b=[],E=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){_.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){E.push(e[t])})),console.log('selectedGroups',m,_,b,E)},w={init:function(){p=!0,d=new e({settingsMap:i,storageKey:T}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&h()})),u=d.getAll(),console.log('all settings',u),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){g=!0,
c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return w})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u){let p,m,_,b=n.getGroupList();const E={PRESETS:'presets',ARMY:'army',BALANCER:'balancer'},T=function(e){p.selectedTab=e},f=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},w=function(){p.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},v=function(){p.running=!0,_.classList.remove('btn-orange'),_.classList.add('btn-red'),
u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){p.running=!1,_.classList.remove('btn-red'),_.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},A=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.unit=r.encodeList(l,{textObject:'army_helper',disabled:!0}),m.injectScope(p),w(),p.selectTab=T,p.saveSettings=f,p.switchState=h;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.ARMY_HELPER_START,v),e.register(s.ARMY_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),_=e.addMenuButton('Administrator',140),_.addEventListener('click',A),
...
MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,_,b,E){let T,f,h=!1,w=injector.get('overviewService'),v=[],S=!1,A={},y={},R={reverse:!1,column:i.TIME_COMPLETED};const I='attack_view_filters',k={},L={},x=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in A[e[t]])if(a[e[t]]||(a[e[t]]=[]),
A[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=A[c.VILLAGE]?[t]:[]},O=function(){V.loadCommands()},N=function(e,t){E.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);E.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},C=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);E.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{
unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},G=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},U=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=G(r,e);else if(c.length)l=G(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=G(a,e)}}return t(l[0])}const i=_.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&U(e,t)}))},D=function(e){v=e.commands;for(let e=0;e<v.length;e++)w.formatCommand(v[e]),
v[e].slowestUnit=z(v[e]);v=v.filter((function(e){return A[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[v])};let V={loadCommands:function(){const e=T.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:R.column,reverse:R.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},D)},getCommands:function(){return v},getFilters:function(){return A},getSortings:function(){return R},toggleFilter:function(e,t){t?A[e][t]=!A[e][t]:A[e]=!A[e],x(),g.set(I,A),V.loadCommands()},toggleSorting:function(e){e===R.column?R.reverse=!R.reverse:(R.column=e,R.reverse=!1),V.loadCommands()},setCommander:function(e,a){U(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),S.addCommand(n,o,a,f.OUT,s,{},l,p.WALL),S.isRunning()||S.start()}))},commandQueueEnabled:function(){return!!S},isInitialized:function(){
return h},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)L[r[e]]=!0;try{S=require('two/commandQueue'),f=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};h=!0,T=n.getSelectedCharacter().getGlobalInfo(),A=g.get(I,t,!0),e((function(){x(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,M),a.$on(s.VILLAGE_NAME_CHANGED,C),a.$on(s.COMMAND_IGNORED,P),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,_,b,E,T,f){let h,w;const v=function(){return Date.now()/1e3},S=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},A=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=f('#two-attack-view').parent(),t=f('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=h.pagination.offset,t=h.pagination.limit
;h.visibleCommands=h.commands.slice(e,e+t),h.pagination.count=h.commands.length},I=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);R()},k=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},L=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},x=function(){h.commands=t.getCommands()},O=function(){h.selectedVillageId=n.getSelectedVillage().getId()},N=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=b,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=_,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=p.jumpToVillage,h.now=v,h.copyTimeModal=S,h.removeTroops=A,h.switchWindowSize=y,
h.toggleFilter=k,h.toggleSorting=L,R();let e=new i('twoverflow_queue_window',(function(){T.timer.remove(I)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,x),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,x),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,x),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,x),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),T.timer.add(I)};return function(){w=e.addMenuButton('Strażnik',40),w.addEventListener('click',N),
...
[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},N={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},C={[_.LEVEL_1]:100,[_.LEVEL_2]:200,[_.LEVEL_3]:300,[_.LEVEL_4]:400,[_.LEVEL_5]:500,[_.LEVEL_6]:600,[_.LEVEL_7]:700,[_.LEVEL_8]:800,[_.LEVEL_9]:900,[_.LEVEL_10]:1e3},M={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3},z={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(L,z,M,C,P,N,O,x,R,I,k);const G=function(){A=[];const e=n.getPresetList().getPresets();w[t.PRESETS].forEach((function(t){A.push(e[t])})),console.log('selectedPresets',A)},U={init:function(){v=!0,h=new e({settingsMap:i,storageKey:y}),w=h.getAll(),console.log('all settings',w),T((function(){G()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,G),a.$on(s.ARMY_PRESET_DELETED,G)},start:function(){S=!0,console.log('selectedPresets',A),f.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){S=!1,console.log('example module stop'),f.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return h},isInitialized:function(){return v},isRunning:function(){return S}};return U})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u,p,g,m,_,b,E,T,f,h,w){let v,S,A,y=n.getPresetList();const R={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},I=function(e){v.selectedTab=e},k=function(){S.setAll(S.decode(v.settings)),w.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():t.start()},x=function(){v.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},O=function(){
v.running=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),w.notif('success','Example module started')},N=function(){v.running=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),w.notif('success','Example module stopped')},P=function(){v=a.$new(),v.SETTINGS=i,v.TAB_TYPES=R,v.running=t.isRunning(),v.selectedTab=R.BATTLE,v.settingsMap=o,v.catapulttarget=f.encodeList(d,{textObject:'battle_calculator',disabled:!0}),v.knightitem=f.encodeList(l,{textObject:'battle_calculator',disabled:!0}),v.itemlevel=f.encodeList(r,{textObject:'battle_calculator',disabled:!0}),v.order=f.encodeList(u,{textObject:'battle_calculator',disabled:!0}),v.wall=f.encodeList(p,{textObject:'battle_calculator',disabled:!0}),v.church=f.encodeList(g,{textObject:'battle_calculator',disabled:!0}),v.weaponmaster=f.encodeList(m,{textObject:'battle_calculator',disabled:!0}),v.ironwalls=f.encodeList(_,{textObject:'battle_calculator',disabled:!0}),v.clinique=f.encodeList(b,{
textObject:'battle_calculator',disabled:!0}),v.hospital=f.encodeList(E,{textObject:'battle_calculator',disabled:!0}),v.training=f.encodeList(T,{textObject:'battle_calculator',disabled:!0}),S.injectScope(v),x(),v.selectTab=I,v.saveSettings=k,v.switchState=L;let e=new h('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,x,!0),e.register(s.ARMY_PRESET_DELETED,x,!0),e.register(s.BATTLE_CALCULATOR_START,O),e.register(s.BATTLE_CALCULATOR_STOP,N),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',v)};return function(){S=t.getSettings(),A=e.addMenuButton('Kalkulator',180),A.addEventListener('click',P),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,E,T){let f,h,w,v=injector.get('buildingService'),S=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const I={};let k,L,x,O,N,P=!0;const C='builder_queue_log',M='builder_queue_settings',z=function(){const e=U();if(!P)return F.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},G=function(){U().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
A.canBeFinishedForFree(a,t)&&S.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},U=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return v.compute(e),V(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),j(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)B(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=w[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&B(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},j=function(e,t){let a={time:T.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),E.set(C,x),!0};let F={};return F.start=function(){if(!P)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,f=setInterval(z,6e4),h=setInterval(G,6e3),e((function(){U().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),G()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){R=!1,clearInterval(f),
clearInterval(h),b.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return R},F.isInitialized=function(){return y},F.getSettings=function(){return O},F.getLogs=function(){return x},F.clearLogs=function(){x=[],E.set(C,x),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,x=E.get(C,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),R&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)I[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,w=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);D(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,T,f,h,w,v){let S,A,y,R,I=n.getGroupList(),k={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},G=!1,U=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case T.SEQUENCE_SAVED:return!0;case T.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case T.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};O.generateSequences=function(){const e=R.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=S.settings[_.ACTIVE_SEQUENCE].value,t=S.settings[_.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in f)i[f[e]]=0;O.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=S.settings[_.ACTIVE_SEQUENCE].value,a=S.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=k[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
...
V(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(G=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),G=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),G=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=R.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in f)i[f[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),S.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case T.SEQUENCE_SAVED:G=!1;break;case T.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case T.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(x.selectedSequence.value),G=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=x.lastAddedIndex,e.indexLimit=x.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(x.lastAddedBuilding,a.loc.ale,'building_names'),value:x.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),l=y[t].max_level;x.lastAddedBuilding=t,x.lastAddedIndex=i,x.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},x.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=x.selectedSequence.name,i=S.settings[_.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(G){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},N.updateVisibleLogs=function(){const e=S.pagination.logs.offset,t=S.pagination.logs.limit;N.visibleLogs=N.logs.slice(e,e+t),
S.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[f.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(S.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},S.settings[_.BUILDING_SEQUENCES][e.name]=t,j(),O.selectedSequence={name:e.name,value:e.name},x.selectedSequence={name:e.name,value:e.name},O.generateSequences(),x.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){S.selectedTab=e},j=function(){R.setAll(R.decode(S.settings)),G=!1},F=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){G?Y((function(){C()})):C()},K={updateGroups:function(){S.groups=p.encodeList(I.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(_.BUILDING_SEQUENCES);S.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){x.generateBuildingSequence()},
updateLogs:function(){S.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=R.get(_.BUILDING_SEQUENCES);S.settings[_.BUILDING_SEQUENCES][t]=i[t],S.settings[_.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=R.get(_.BUILDING_SEQUENCES);S.settings[_.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete S.settings[_.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(E.call(e,t))return t;return!1}(S.settings[_.BUILDING_SEQUENCES]);x.selectedSequence={name:i,value:i},K.updateSequences(),x.generateBuildingSequence(),R.get(_.ACTIVE_SEQUENCE)===t&&(R.set(_.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){S.running=!0},stopped:function(){S.running=!1}},Q=function(){const e=R.get(_.ACTIVE_SEQUENCE);S=a.$new(),S.selectedTab=P.SETTINGS,S.TAB_TYPES=P,S.SETTINGS=_,S.running=L,S.pagination={},S.settingsMap=R.settingsMap,S.villagesLabel=z,S.villagesInfo=M,S.editorView=x,S.editorView.buildingSequence={},S.editorView.visibleBuildingSequence=[],S.editorView.selectedSequence={name:e,value:e},S.editorView.lastAddedBuilding=f.HEADQUARTER,S.editorView.lastAddedIndex=1,S.settingsView=O,S.settingsView.buildingSequence={},S.settingsView.buildingSequenceFinal={},S.logsView=N,S.logsView.logs=i.getLogs(),S.selectTab=W,S.switchBuilder=F,S.saveSettings=j,S.createSequence=q,S.openVillageInfo=r.openVillageInfo,R.injectScope(S),K.updateGroups(),K.updateSequences(),S.pagination.buildingSequence={
count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.buildingSequenceEditor={count:x.buildingSequence.length,offset:0,loader:x.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.logs={count:N.logs.length,offset:0,loader:N.updateVisibleLogs,limit:m.getPaginationLimit()},N.updateVisibleLogs(),O.generateSequences(),x.generateBuildingSequence();let t=new h('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(s.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',S),C=S.closeWindow,S.closeWindow=H,S.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),S.$watch('editorView.selectedSequence.value',(function(e,t){U?U=!1:e!==t&&(G?Y((function(){K.generateBuildingSequencesEditor(),G=!1}),(function(){S.editorView.selectedSequence={name:t,value:t},U=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
O.generateBuildingsLevelPoints(),R=i.getSettings(),A=e.addMenuButton('Budowniczy',30),A.addEventListener('click',Q),w.register(s.BUILDER_QUEUE_START,(function(){L=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),w.register(s.BUILDER_QUEUE_STOP,(function(){L=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const w=Object.values(c),v=Object.values(a),S=Object.values(h),A=Object.values(f),y=Object.values(T);let R,I=[],k={},L=[],x=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+R},C=function(e){I.push(e)},M=function(e){k[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,I)},G=function(e){return!isNaN(e)&&e>0&&e<1e3},U=function(e){return E.call(e,'x')&&E.call(e,'y')&&G(e.x)&&G(e.y)};let D={initialized:!1};return D.init=function(){R=t.getTimeOffset(),D.initialized=!0,L=b.get(d.QUEUE_SENT,[],!0),x=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?D.expireCommand(e,i.TIME_LIMIT):(C(e),M(e))}))}(),setInterval((function(){I.length&&I.some((function(e){if(!P(e.sendTime))return!0;O?D.sendCommand(e):D.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&I.length&&(e.returnValue=!0)}))},D.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return D.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),b.set(d.QUEUE_SENT,L),D.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},D.expireCommand=function(e,t){!function(e){x.push(e)}(e),b.set(d.QUEUE_EXPIRED,x),D.removeCommand(e,t)},D.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(E,R){if(!U(e))return R(u.INVALID_ORIGIN);if(!U(i))return R(u.INVALID_TARGET);if(!t.isValidDateTime(o))return R(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!S.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return R(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return R(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!A.includes(t))return!1;r[t]&&(b[t]=!0)})))return R(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[f.SUPPORTER]&&delete b[f.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[h.CATAPULT])&&(p||T.HEADQUARTER),v.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return R(u.INVALID_ORIGIN);if(!i)return R(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(P(c))return R(u.ALREADY_SENT);const T={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};C(T),M(T),I=I.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),E(T)})):R(u.INVALID_DATE_TYPE)):R(u.INVALID_CATAPULT_TARGET)):R(u.RELOCATE_DISABLED):R(u.INVALID_COMMAND_TYPE)}))},D.removeCommand=function(e,t){delete k[e.id];const a=I.some((function(t,a){if(t.id==e.id)return I.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},D.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),x=[],L=[]},D.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},D.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},D.isRunning=function(){return O},D.getWaitingCommands=function(){return I},D.getWaitingCommandsObject=function(){return k},D.getSentCommands=function(){return L},
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,E,T,f,h){let w,v,S,A,y,R=n.getGameData(),I=R.getOrderedUnitNames(),k=R.getOrderedOfficerNames(),L=n.getPresetList(),x=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let P,C,M,z=[],G={},U={};const D={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){x=t.data},q=function(){x=!1},W=function(e){
const t=new Date(e||T.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=T.zerofill(a-a%100,3),n=T.zerofill(t.getSeconds(),2),l=T.zerofill(t.getMinutes(),2);return T.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+T.zerofill(t.getDate(),2)+'/'+T.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(w.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!w.isValidDate&&o.getTimeFromString(y.date),t=w.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(D,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);w.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),w.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&w.isValidDate?T.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=w.selectedDateType.value,h.set(m.LAST_DATE_TYPE,w.selectedDateType.value),F()},K=function(){
y.catapultTarget=w.catapultTarget.value},Q=function(){const e=w.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,w.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},w.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=T.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),T.timer.add(e.updateCountdown)},X=function(){w.waitingCommands=t.getWaitingCommands()},J=function(){w.sentCommands=t.getSentCommands()},$=function(){w.expiredCommands=t.getExpiredCommands()},ee=function(){let e=w.waitingCommands;V.forEach((function(a){w.activeFilters[a]&&(e=t.filterCommands(a,w.filtersData,e))})),
w.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){w.showCatapultSelect=!!y.units.catapult},ne=function(e){w.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:S.getId()}},le=function(){if(!x)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(x.x,x.y,1,1,(function(e){y.target=e}))},se=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=j(y.date,100)},ce=function(){if(!y.date)return!1;y.date=j(y.date,-100)},de=function(){y.units=angular.copy(G),y.officers=angular.copy(U),y.catapultTarget="wall",w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},_e=function(e,t){w.activeFilters[e]=!w.activeFilters[e],
t&&(w.filtersData[u.ALLOWED_TYPES][e]=!w.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){w.activeFilters[u.TEXT_MATCH]=w.filtersData[u.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){w.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},w.searchQuery[i]=''},removeCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(w.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){w.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{T.timer.remove(e.updateCountdown)})}},Te=function(){const e=h.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;w=a.$new(),w.selectedTab=N,w.inventory=n.getInventory(),w.presets=o.obj2selectOptions(L.getPresets()),w.travelTimes={},o.each(p,(function(e){w.travelTimes[e]={},o.each(D,(function(t,a){w.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=A,w.officers=R.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=f.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),w.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!y.units.catapult,w.attackableBuildings=z,w.commandData=y,
w.activeFilters=C,w.filtersData=M,w.running=t.isRunning(),w.waitingCommands=t.getWaitingCommands(),w.visibleWaitingCommands=t.getWaitingCommands(),w.sentCommands=t.getSentCommands(),w.expiredCommands=t.getExpiredCommands(),w.EVENT_CODES=d,w.FILTER_TYPES=u,w.TAB_TYPES=O,w.COMMAND_TYPES=p,w.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),w.onUnitInputFocus=te,w.onUnitInputBlur=ae,w.catapultTargetVisibility=ie,w.selectTab=ne,w.addSelected=oe,w.addMapSelected=le,w.addCurrentDate=se,w.incrementDate=re,w.reduceDate=ce,w.cleanUnitInputs=de,w.addCommand=ue,w.clearRegisters=pe,w.switchCommandQueue=ge,w.removeCommand=t.removeCommand,w.openVillageInfo=r.openVillageInfo,w.toggleFilter=_e,w.$watch('commandData.origin',F),w.$watch('commandData.target',F),w.$watch('commandData.date',F),w.$watch('commandData.officers',F),w.$watch('selectedDateType.value',H),w.$watch('selectedInsertPreset.value',Q),w.$watch('catapultTarget.value',K),w.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',be),
w.$watch('selectedTab',(function(){w.selectedTab===O.ADD?_=setInterval((function(){F()}),2500):clearInterval(_)})),w.waitingCommands.forEach(e=>{Z(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(_),Ee.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,Ee.updatePresets,!0),b.register(s.SELECT_SELECTED,Ee.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,Ee.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,Ee.sendCommand),b.register(s.COMMAND_QUEUE_START,Ee.start),b.register(s.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){S=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=R.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});A=angular.copy(I),A.splice(A.indexOf('catapult'),1),I.forEach((function(e){G[e]=0})),k.forEach((function(e){U[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(G),officers:angular.copy(U),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',20),v.addEventListener('click',Te),b.register(s.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,_,b,E=!1,T=!1,f=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){E=!0}};return h.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),T=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),E=c.food,T=c.wood,h=c.clay,w=c.iron,v=E.currentStock,S=T.currentStock,A=h.currentStock,y=w.currentStock,R=[0,5e3],I=[160,16e3],k=[200,2e4],L=[50,5e3];1==s&&(f=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=f?'chapel'==i&&'church'==i||1!=f||(S>=I[1]&&A>=k[1]&&y>=L[1]&&v>=R[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):S>=I[0]&&A>=k[0]&&y>=L[0]&&v>=R[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==f?S>=I[1]&&A>=k[1]&&y>=L[1]&&v>=R[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):S>=I[0]&&A>=k[0]&&y>=L[0]&&v>=R[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},h.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),T=!1},h.isRunning=function(){return T},h.isInitialized=function(){return E},h})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Kapelan',30,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,_,T,f,h,w,v,S,A,y,R){let I,k,L,x,O,N=!1,P=!1,C=[],M=[],z=[],G=[],U=[],D=[],V=!1,B=!1,q=!1,W=0,j=null,F=null,Y=null,H={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[A.WOOD,A.CLAY,A.IRON],te={distance:function(e){return!e.distance.between(k[r.MIN_DISTANCE],k[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===x.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return G.includes(e.id)},points:function(e){
return!e.between(k[r.MIN_POINTS],k[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=k[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=k[r.GROUP_IGNORE];G=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[r.GROUP_ONLY];U=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!x.getVillage(e)})),U=U.concat(t)})),U=ie(U)}(),function(){const e=G.concat(z);let t=!1;e.forEach((function(e){E.call(L,e)||(L[e]={time:h.gameTime(),report:!1},t=!0)})),_.each(L,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete L[i],t=!0)})),t&&(R.set($,L),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),w.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=x.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(Ie(t.village_id),l=!0):(xe(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),n.includes(t.group_id)&&o){let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}l&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=x.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}else Oe(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Ie(t.village_id),l=!0),l&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=k[r.GROUP_IGNORE],i=k[r.GROUP_ONLY],o=k[r.GROUP_INCLUDE],l=E.call(t,a)?a:I.getDefault(r.GROUP_IGNORE),s=i.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));I.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Re(),Oe(),ye()},ce=function(){D=[];const e=n.getPresetList().getPresets();k[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),D.push(a)})),D=D.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),D.length||(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){k[r.IGNORE_ON_LOSS]&&k[r.GROUP_IGNORE]&&P&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){V&&q&&t.origin.id===V.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},ge=function(e,t){V&&B&&q&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},_e=function(e){L[e]={time:h.gameTime(),report:H[e]||!1},delete H[e],R.set($,L),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,M.unshift(t),Ee(),!0)},Ee=function(){const e=k[r.LOGS_LIMIT];M.length>e&&M.splice(M.length-e,M.length),R.set(X,M),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},Te=function(e,t,a){const i=k[r.TARGET_MULTIPLE_FARMERS],n=k[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},fe=function(){K=h.gameTime()},he=function(){clearTimeout(j),clearTimeout(F),clearTimeout(Y),j=null,F=null,Y=null
},we=function(){return Math.max(1,60*k[r.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*k[r.ATTACK_INTERVAL])},Se=function(e){if(this.villageId=e,this.village=x.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};Se.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{w.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Se.prototype.start=function(){return fe(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,w.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Se.prototype.stop=function(e){this.running=!1,w.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=b},Se.prototype.targetStep=async function(e={}){if(!this.running)return!1;fe();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return a(i.USER_STOP);t()},_.randomSeconds(ve())):t()}),T=()=>new Promise((e,a)=>{const n=50-k[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),A=()=>new Promise((e,t)=>{if(k[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),R=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),I=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(D.forEach((function(e){E.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)E.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),O=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=f.actualDistance(l,a);_.each(D,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,p=x.getVillageList();const o=p.every(e=>e.isInitialized(S.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),Te(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[r.TARGET_SINGLE_ATTACK]&&!k[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=k[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=f.actualDistance(s,a),_=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,_,m,v.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(Te(l,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{b().then(T).then(A).then(R).then(I).then(L).then(O).then(N).then(P).then(C).then(e).catch(t)}),G=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,G]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),B=!0,q=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:v.TYPES.ATTACK})}).catch(t=>{switch(he(),w.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),xe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Se.prototype.setStatus=function(e){this.status=e},
Se.prototype.getStatus=function(){return this.status||i.UNKNOWN},Se.prototype.commandSent=function(e){B=!1,q=!1,he(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Se.prototype.commandError=function(){B=!1,q=!1,this.stop(i.COMMAND_ERROR)},Se.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Se.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=f.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Se.prototype.getTargets=function(){return this.targets},Se.prototype.getIndex=function(){return this.index},Se.prototype.getVillage=function(){return this.village},
Se.prototype.isRunning=function(){return this.running},Se.prototype.isInitialized=function(){return this.initialized},Se.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Se.prototype.getId=function(){return this.villageId};const Ae=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!U.includes(e))return!1;if(G.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Se(e),C.push(a)),a},ye=function(){_.each(x.getVillages(),(function(e,t){Ae(t)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=k[r.GROUP_ONLY];let t=[];C.forEach((function(a){let i=a.getId();e.length&&!U.includes(i)?t.push(i):G.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Ie(e)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Ie=function(e){for(let a=0;a<C.length;a++)if(C[a].getId()===e)return C[a].stop(t.KILL_FARMER),C.splice(a,a+1),!0;return!1
},ke=function(e){fe(),C.length?W>=C.length?(W=0,V=!1,Z=h.gameTime()+we(),w.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=C[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):j=setTimeout((function(){j=null,W=0,Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),we())},Le=function(e){for(let t=0;t<C.length;t++){let a=C[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){C.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){C.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=R.get(X,[]),L=R.get($,{}),x=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),I=new e({settingsMap:c,storageKey:J}),I.onChange((function(e,t,a){k=I.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(Re(),ye()),t[p.LOGS]&&Ee(),t[p.INTERVAL_TIMERS]&&P&&(F?(he(),
V.targetStep({delay:!0})):j&&(he(),w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=I.getAll(),se("ignore_update"),ne(),ye(),T((function(){ce()}),'presets'),T((function(){C.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!P&&(D.length?(P=!0,e=[],C.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),fe(),function(){let e=we(),t=e+e/2+ve();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),w.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=h.gameTime()+we()),w.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,P=!1,he(),w.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Ne.getFarmer=function(e){return C.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return C},Ne.getSettings=function(){return I},Ne.getExceptionVillages=function(){return{included:z,ignored:G}},Ne.getExceptionLogs=function(){return L},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return P},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],R.set(X,M),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=we,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,E,T,f,h,w){let v,S,A,y=n.getPresetList(),R=n.getGroupList(),I={},k={},L=null;const x={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(I[e])return I[e];I[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){I[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
v.exceptionVillages.included.forEach((function(e){N(e)})),v.exceptionVillages.ignored.forEach((function(e){N(e)}))},C=function(){t.isRunning()?t.stop():t.start()},M=function(e){v.selectedTab=e},z=function(){S.setAll(S.decode(v.settings)),v.saveButtonColor='orange',f.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},G=function(e){const t=S.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},U=function(e){S.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){v.presets=E.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){v.groups=E.encodeList(R.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=E.encodeList(R.getGroups(),{disabled:!0,type:'groups'})},B=function(){v.running=!0,
f.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:f.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:f.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){v.logs=angular.copy(t.getLogs()),O(),v.logs.length||f.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},j=function(){v.farmers=t.getFarmers()},F=function(){v.exceptionVillages=t.getExceptionVillages(),P()},Y=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=a.$new(),v.SETTINGS=b,v.TAB_TYPES=x,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=x.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=k,v.villagesInfo=I,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=S.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},S.injectScope(v),D(),V(),O(),P(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-w.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=C,v.selectTab=M,v.saveSettings=z,v.clearLogs=t.clearLogs,v.jumpToVillage=p.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=_.showReport,v.removeIgnored=G,v.removeIncluded=U;let i=new T('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(s.ARMY_PRESET_UPDATE,D,!0),i.register(s.ARMY_PRESET_DELETED,D,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
i.register(s.FARM_OVERFLOW_START,B),i.register(s.FARM_OVERFLOW_STOP,q),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){S=t.getSettings(),A=e.addMenuButton('Farmer',10),A.addEventListener('click',(function(){Q()})),h.register(s.FARM_OVERFLOW_START,(function(){A.classList.remove('btn-orange'),A.classList.add('btn-red')})),h.register(s.FARM_OVERFLOW_STOP,(function(){A.classList.remove('btn-red'),A.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,T,f,h,w,v,S){let A,y,R,I,k,L,x,O,N,P,C,M,z,G,U,D,V,B,q,W,j,F,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/y)%2&&(t+=I),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},be=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},Ee=function(){Se(k)},Te=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),G.clearRect(0,0,z.width,z.height),function(e){P.drawImage(C,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;G.fillStyle=Y[o.COLOR_VIEW_REFERENCE],G.fillRect(a,0,1,R),G.fillRect(0,i,R,1);const n=D.getBoundingClientRect(),l=n.width/v.TILESIZE.x/S.view.z*y,s=n.height/v.TILESIZE.y/S.view.z*y,r=a-l/2,c=i-s/2;G.clearRect(r,c,l,s),G.beginPath(),G.lineWidth=1,G.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],G.rect(r,c,l,s),G.stroke()}(e)}e.requestAnimationFrame(Te)
},fe=function(){if(!ie)return!1;const e=Q.village[x][O];we(e?Q.character[e]:[[x,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t)},ve=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return W.ally;if(j.isEnemy(e.tribe_id))return W.enemy;if(j.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Se=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||ve(i);if(!n)continue;const o=i.x*y+(i.y%2?I:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,A,A)}},Ae=function(){A=oe[Y[o.MAP_SIZE]],I=Math.round(A/2),y=A+1,R=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,C.width=1e3*y,C.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,G.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[x,O,e]),3===e.which&&(a=x,i=O,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Ie=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(x===e.x&&O===e.y)return!1;fe()}ie=!0,x=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:x,y:O,event:t});const a=Q.village[x][O];he(a?Q.character[a]:[[x,O]])}(pe,e)}fe()},Le=function(){ie&&fe(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},xe=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Se([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,G=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return F},Ce.drawMinimap=function(){ge&&(ge=!1),N.style.background=Y[o.COLOR_BACKGROUND],M.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=f.getPath(v.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*y+I-1,t*y+I-1,3,1),M.fillRect(e*y+I,t*y+I-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*y+I,t*y+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=T.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),Ee()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),M=C.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ne}),F.onChange((function(e,t){
Y=F.getAll(),Ae(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),Y=F.getAll(),K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Ae()},Ce.run=function(){d((function(){D=document.getElementById('map'),U=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),j=V.getTribeRelations(),B=V.getId(),q=V.getTribeId(),W=V.getVillagesColors(),re.alpha=0,S.graph.layers.effects.push(re),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Re),z.addEventListener('mouseup',Ie),z.addEventListener('mousemove',ke),z.addEventListener('mouseleave',Le),z.addEventListener('click',xe),z.addEventListener('contextmenu',Oe),g.load((function(){k=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(k),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),Te(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,Ee),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,E,T,f,h,w){let v,S,A,y,R,I,k,L,x,O,N,P={},C=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},G=z.MINIMAP,U=function(e){v.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(v.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},B=function(e,t){if(!x)return;let a=V(t.x,t.y);var i,n;O=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=f.getTownAt(i,n);if(t)return e(t);f.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[V(e.x,e.y)])return;if(!C)return;k.appendChild(x),x.classList.remove('ng-hide'),I.tt.name=e.name,I.tt.x=e.x,I.tt.y=e.y,I.tt.province_name=e.province_name,I.tt.points=e.points,I.tt.character_name=e.character_name||'-',I.tt.character_points=e.character_points||0,I.tt.tribe_name=e.tribe_name||'-',I.tt.tribe_tag=e.tribe_tag||'-',I.tt.tribe_points=e.tribe_points||0,I.tt.morale=e.morale||0,I.tt.position={},I.tt.position.x=t.event.pageX+50,I.tt.position.y=t.event.pageY+50,I.tt.visible=!0
;const a=x.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=I.tt.position.y+o>i.top+i.height,s=I.tt.position.x+n>i.width;l&&(I.tt.position.y-=50),x.classList.toggle('left',s),x.classList.toggle('top',l)}))},q=function(e,t){if(!x)return;let a=t?V(t):O;P[a]=!1,C=!1,I.tt.visible=!1,x.classList.add('ng-hide'),L.appendChild(x)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){v.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){v.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,s.submit=function(){v.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},j=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},F=function(){N.setAll(N.decode(v.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){D()},highlightAddErrorExists:function(){_.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){v=a.$new(),v.SETTINGS=p,v.TAB_TYPES=z,v.selectedTab=G,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=n.getHighlights(),v.highlightNames=M,v.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=U,v.openColorPalette=W,v.addCustomHighlight=j,v.removeHighlight=n.removeHighlight,v.saveSettings=F,v.resetSettings=Y,v.highlightsCount=H,v.openProfile=K,N.injectScope(v,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,B),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',v),D(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(A),R.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),I=i.getSharedData('MapController'),A=document.createElement('canvas'),A.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(A),n.setViewportRef(y),x=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),L=document.querySelector('#map'),S=t.addMenuButton('Minimapa',180),S.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',_='060502',b='060501',E='060503',T='05020a',f='05030a',h='04080a',w='040a0a',v='070e04',S='070e05',A='070e0f',y='070e06',R='070e02',I='070e01',k='070e03',L='070e07',x='070e0b',O='070e0e',N='030d07',P='030d0b',C='030d0e';var M={init:function(){i=!0}};return M.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,_='string'==typeof _?parseInt(_,16):_,b='string'==typeof b?parseInt(b,16):b,E='string'==typeof E?parseInt(E,16):E,T='string'==typeof T?parseInt(T,16):T,f='string'==typeof f?parseInt(f,16):f,h='string'==typeof h?parseInt(h,16):h,w='string'==typeof w?parseInt(w,16):w,v='string'==typeof v?parseInt(v,16):v,S='string'==typeof S?parseInt(S,16):S,A='string'==typeof A?parseInt(A,16):A,y='string'==typeof y?parseInt(y,16):y,R='string'==typeof R?parseInt(R,16):R,I='string'==typeof I?parseInt(I,16):I,k='string'==typeof k?parseInt(k,16):k,L='string'==typeof L?parseInt(L,16):L,x='string'==typeof x?parseInt(x,16):x,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,P='string'==typeof P?parseInt(P,16):P,C='string'==typeof C?parseInt(C,16):C,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
...
axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:C,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),M.stop()},M.stop=function(){e.trigger(s.PRESET_CREATOR_STOPPED),r=!1},M.isRunning=function(){return r},M.isInitialized=function(){return i},M})),define('two/presetCreator/events',[],(function(){angular.extend(s,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),
...
i.get(o,!1,!0)&&t.start(),n.register(s.PRESET_CREATOR_STARTED,(function(){i.set(o,!0)})),n.register(s.PRESET_CREATOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c){let d,u,p=!1,g=!1,m=[],_=[],b=[],E=[],T=[],f=[],h=[],w=[],v=[],S=[],A=[],y=[],R=[],I=[],k=[],L=[],x=[],O=[],N=[],P=[],C=[],M=[],z=[],G=[],U=[],D=[],V=[],B=[],q=[],W=[],j=[],F=[];const Y='recruit_queue_settings',H={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],_=[],b=[],E=[],T=[],f=[],h=[],
w=[];const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],l=u[t.PRESET4],s=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){_.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){E.push(e[t])})),s.forEach((function(t){T.push(e[t])})),r.forEach((function(t){f.push(e[t])})),c.forEach((function(t){h.push(e[t])})),d.forEach((function(t){w.push(e[t])}))},Q=function(){v=[],S=[],A=[],y=[],R=[],I=[],k=[],L=[],x=[],O=[],N=[],P=[],C=[],M=[],z=[],G=[],U=[],D=[],V=[],B=[],q=[],W=[],j=[],F=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4],s=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],_=u[t.GROUP12],b=u[t.GROUP13],E=u[t.GROUP14],T=u[t.GROUP15],f=u[t.GROUP16],h=u[t.GROUP17],w=u[t.GROUP18],Y=u[t.GROUP19],H=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],Z=u[t.GROUP23],X=u[t.GROUP24];a.forEach((function(t){v.push(e[t])})),i.forEach((function(t){S.push(e[t])})),o.forEach((function(t){A.push(e[t])})),l.forEach((function(t){y.push(e[t])})),s.forEach((function(t){R.push(e[t])})),r.forEach((function(t){I.push(e[t])})),c.forEach((function(t){k.push(e[t])})),d.forEach((function(t){L.push(e[t])})),p.forEach((function(t){x.push(e[t])})),g.forEach((function(t){O.push(e[t])})),m.forEach((function(t){N.push(e[t])})),_.forEach((function(t){P.push(e[t])})),b.forEach((function(t){C.push(e[t])})),E.forEach((function(t){M.push(e[t])})),T.forEach((function(t){z.push(e[t])})),f.forEach((function(t){
G.push(e[t])})),h.forEach((function(t){U.push(e[t])})),w.forEach((function(t){D.push(e[t])})),Y.forEach((function(t){V.push(e[t])})),H.forEach((function(t){B.push(e[t])})),K.forEach((function(t){q.push(e[t])})),Q.forEach((function(t){W.push(e[t])})),Z.forEach((function(t){j.push(e[t])})),X.forEach((function(t){F.push(e[t])}))},Z={init:function(){p=!0,d=new e({settingsMap:i,storageKey:Y}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('all settings',u),r((function(){K()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,K),a.$on(s.ARMY_PRESET_DELETED,K),a.$on(s.GROUPS_CREATED,Q),a.$on(s.GROUPS_DESTROYED,Q),a.$on(s.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(s.recruit_queue_START)},stop:function(){g=!1,c.trigger(s.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return Z})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{
RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u){let p,g,m,_=n.getPresetList(),b=n.getGroupList();const E={PRESETS:'presets',OWN:'own',LOGS:'logs'},T=function(e){p.selectedTab=e},f=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},w=function(){p.presets=r.encodeList(_.getPresets(),{disabled:!1,type:'presets'})},v=function(){p.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},S=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},A=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),u.notif('success','Example module stopped')
},y=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.units=r.encodeList(l,{textObject:'recruit_queue',disabled:!0}),g.injectScope(p),w(),v(),p.selectTab=T,p.saveSettings=f,p.switchState=h;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,w,!0),e.register(s.ARMY_PRESET_DELETED,w,!0),e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.recruit_queue_START,S),e.register(s.recruit_queue_STOP,A),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton('Kapitan',150),m.addEventListener('click',y),
...
o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},_))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},E))})),setTimeout(m,3e4)},_=function(e){
var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,_=g(m),b=e.ReportScouting,E=b.attCharacterId,T=b.attCharacterName,f=b.attScouts,h=b.attLosses,w=b.attVillageId,v=b.attVillageName,S=b.defCharacterId,A=b.defCharacterName,y=b.defLosses,R=b.defScouts,I=b.defVillageId,k=b.defVillageName,L=b.commandType,x='',O='',N='',P='',C=Date.now(),M=p.split('.').join('_');2==u?x=' [color=d96a19]Częściowy sukces[/color]':1==u?x=' [color=0a8028]Sukces[/color]':3==u&&(x=' [color=e21f1f]Porażka[/color]'),O='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==R?'nieznana':R,s=null==f?'nieznana':f,r=null==y?'nieznana':y,c=null==h?'nieznana':h,P=null==T&&null==E?'Brak danych':'[player='+E+']'+T+'[/player]',N=null==v&&null==w?'Brak danych':'[village='+w+']'+v+'[/village]',t=Math.floor(C/1e3-m),
d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+x+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+_+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+k+'[/village][b] Gracz cel: [/b][player='+S+']'+A+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();S!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,b=d.attEffects,E=d.defEffects,T=d.attUnits;if(T.spear+T.sword+T.axe+T.archer+T.light_cavalry+T.mounted_archer+T.ram+T.catapult+T.heavy_cavalry+T.trebuchet+T.knight+T.snob+T.doppelsoldner>30){var f=[],h=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,f.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var w=f.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var v=h.join(),S=(100*d.attFaith).toFixed([0]),A=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,k=d.defCharacterName,L=d.defVillageId,x=d.defVillageName,O=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),C=d.night,M=d.loyaltyAfter,z=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,D=d.officers,V=d.leader,B='',q='',W='',j='',F='',Y='',H='',K='',Q='',Z=Date.now(),X=s.split('.').join('_')
;null!=z&&(Y='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=M&&(H='Lojalność po ataku: '+Math.floor(M)+' '),null!=U&&(K='Mury przed ataku: '+U+' '),null!=G&&(Q='Mury po ataku: '+G+' '),null==D&&1==V?F='Brak':null==D&&1.1==V&&(F=' Wielki Mistrz '),j=0==C?'Nie':'Tak',2==n?B=' [color=d96a19]Częściowy sukces[/color]':1==n?B=' [color=0a8028]Sukces[/color]':3==n&&(B=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+x+'[/village][b] Gracz cel: [/b][player='+I+']'+k+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+A+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+Y+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},E=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,b=d.attEffects,E=d.defEffects,T=d.attUnits;if(T.spear+T.sword+T.axe+T.archer+T.light_cavalry+T.mounted_archer+T.ram+T.catapult+T.heavy_cavalry+T.trebuchet+T.knight+T.snob+T.doppelsoldner>30){var f=[],h=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,f.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var w=f.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var v,S=h.join(),A=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,L=d.defCharacterName,x=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),M=d.night,z=d.loyaltyAfter,G=d.loyaltyBefore,U=d.wallAfter,D=d.wallBefore,V=d.officers,B='',q='',W='',j='',F='',Y='',H='',K='',Q=[],Z=Date.now(),X=s.split('.').join('_')
;if(null!=G&&(F='Lojalność przed atakiem: '+Math.floor(G)+' '),null!=z&&(Y='Lojalność po ataku: '+Math.floor(z)+' '),null!=D&&(H='Mury przed ataku: '+D+' '),null!=U&&(K='Mury po ataku: '+U+' '),null==V)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(j=0==M?'Nie':'Tak',2==n?B=' [color=d96a19]Częściowy sukces[/color]':1==n?B=' [color=0a8028]Sukces[/color]':3==n&&(B=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),v=Q.join(),null!=L){
a.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+O+'[/village][b] Gracz cel: [/b][player='+k+']'+L+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+S+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+v+'[/b][br]'+F+Y+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},T={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return r}};return T})),define('two/reportSender/events',[],(function(){angular.extend(s,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Goniec',60,g('i18n')('description',a.loc.ale,'report_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'report_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'report_sender')))})),n.register(s.REPORT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.REPORT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.REPORT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(s.REPORT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/settings/updates','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/ready','queues/EventQueue'],(function(e,t,a,i,n,o,l,r,c,d){let u,p,g=!1,m=!1;const _='spy_master_settings',b={[n.HEADQUARTER]:'headquarter',[n.WAREHOUSE]:'warehouse',[n.FARM]:'farm',[n.RALLY_POINT]:'rally_point',[n.STATUE]:'statue',[n.WALL]:'wall',[n.TAVERN]:'tavern',[n.BARRACKS]:'barracks',[n.PRECEPTORY]:'preceptory',
[n.HOSPITAL]:'hospital',[n.CLAY_PIT]:'clay_pit',[n.IRON_MINE]:'iron_mine',[n.TIMBER_CAMP]:'timber_camp',[n.CHAPEL]:'chapel',[n.CHURCH]:'church',[n.MARKET]:'market',[n.ACADEMY]:'academy'},E={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},T={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'},f={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',
[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(f,E,b,T);const h={init:function(){g=!0,u=new e({settingsMap:a,storageKey:_}),p=u.getAll(),console.log('all settings',p)},start:function(){m=!0,d.trigger(s.SPY_MASTER_START)},stop:function(){m=!1,d.trigger(s.SPY_MASTER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return h})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,l,r,d,u,p,m){let _,b,E;const T={SPY:'spy',COUNTERMEASURES:'countermeasures',
LOGS:'logs'},f=function(e){_.selectedTab=e},h=function(){b.setAll(b.decode(_.settings)),m.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},v=function(){_.running=!0,E.classList.remove('btn-orange'),E.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},S=function(){_.running=!1,E.classList.remove('btn-red'),E.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},A=function(){_=a.$new(),_.SETTINGS=i,_.TAB_TYPES=T,_.running=t.isRunning(),_.selectedTab=T.SPY,_.settingsMap=n,_.building=u.encodeList(o,{textObject:'spy_master',disabled:!0}),_.unit=u.encodeList(l,{textObject:'spy_master',disabled:!0}),_.dummies=u.encodeList(r,{textObject:'spy_master',disabled:!0}),_.replacement=u.encodeList(d,{textObject:'spy_master',disabled:!0}),b.injectScope(_),_.selectTab=f,_.saveSettings=h,_.switchState=w;let e=new p('twoverflow_spy_master_window',(function(){
console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,v),e.register(s.SPY_MASTER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',_)};return function(){b=t.getSettings(),E=e.addMenuButton('Zwiadowca',130),E.addEventListener('click',A),
