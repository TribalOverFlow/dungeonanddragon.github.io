...
this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return b.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!b.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),b.call(i,'min')&&(t=Math.max(i.min,t)),b.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const s=angular.copy(this.settings),r=o(n,s);if(!r)return!1;const c=l(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(b.call(this.settingsMap,t)){
const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),b.call(a,'min')&&(i=Math.max(a.min,i)),b.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=o(a,i);if(!n)return!1;const s=l(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,s,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!b.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){
...
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},I=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);R()},k=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},O=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},L=function(){w.commands=t.getCommands()},x=function(){w.selectedVillageId=n.getSelectedVillage().getId()},N=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=E,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=T,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=S,w.copyTimeModal=v,w.removeTroops=A,w.switchWindowSize=y,
...
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},G={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},C={[E.LEVEL_1]:100,[E.LEVEL_2]:129,[E.LEVEL_3]:167,[E.LEVEL_4]:215,[E.LEVEL_5]:278,[E.LEVEL_6]:359,[E.LEVEL_7]:464,[E.LEVEL_8]:599,[E.LEVEL_9]:774,[E.LEVEL_10]:1e3},M={[b.LEVEL_1]:4,[b.LEVEL_2]:8,[b.LEVEL_3]:12,[b.LEVEL_4]:16,[b.LEVEL_5]:20};console.log(O,M,C,G,P,N,x,L,R,I,k);const z=function(){A=[];const e=n.getPresetList().getPresets();h[t.PRESETS].forEach((function(t){A.push(e[t])})),console.log('selectedPresets',A)},U={init:function(){S=!0,w=new e({settingsMap:i,storageKey:y}),h=w.getAll(),console.log('all settings',h),f((function(){z()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,z),a.$on(l.ARMY_PRESET_DELETED,z)},start:function(){v=!0,console.log('selectedPresets',A),_.trigger(l.BATTLE_CALCULATOR_START)},stop:function(){
...
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p,g,m,T,E,b,f,_,w,h){let S,v,A,y=n.getPresetList();const R={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},I=function(e){S.selectedTab=e},k=function(){v.setAll(v.decode(S.settings)),h.notif('success','Settings saved')},O=function(){t.isRunning()?t.stop():t.start()},L=function(){S.presets=_.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},x=function(){
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,E,b,f){let _,w,h,S=injector.get('buildingService'),v=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const I={};let k,O,L,x,N,P=!0;const G='builder_queue_log',C='builder_queue_settings',M=function(){const e=U();if(!P)return F.stop(),!1;e.forEach((function(e){const t=O.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},z=function(){U().forEach((function(e){const t=O.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
A.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},U=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return O.getVillage(e)}))):t.each(O.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return S.compute(e),B(e,a,(function(t,a){t&&a.job&&(E.trigger(l.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=h[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},Y=function(e,t){let a={time:f.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),b.set(G,L),!0};let F={};return F.start=function(){if(!P)return E.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,_=setInterval(M,6e4),w=setInterval(z,6e3),e((function(){U().forEach((function(e){const t=O.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),M(),z()}),['all_villages_ready']),E.trigger(l.BUILDER_QUEUE_START)},F.stop=function(){R=!1,clearInterval(_),
clearInterval(w),E.trigger(l.BUILDER_QUEUE_STOP)},F.isRunning=function(){return R},F.isInitialized=function(){return y},F.getSettings=function(){return x},F.getLogs=function(){return L},F.clearLogs=function(){L=[],b.set(G,L),E.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,x.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,x.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],x.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,L=b.get(G,[],!0),O=n.getSelectedCharacter(),k=n.getGroupList(),x=new i({settingsMap:c,storageKey:C}),x.onChange((function(e,t,a){N=x.getAll(),R&&t[d.ANALYSE]&&M(),a.quiet||E.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=x.getAll();for(let e in m)I[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=O.getVillage(t.village_id);D(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,E,f,_,w,h,S){let v,A,y,R,I=n.getGroupList(),k={},O=!1,L={sequencesAvail:!0,modal:{}},x={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let G,C={},M={},z=!1,U=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
...
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(s.VILLAGES_IN_PROVINCE,{village_id:e},t)};let w={init:function(){b=!0}};return w.start=function(){i.trigger(l.FAITH_CHECKER_STARTED),f=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,l=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),b=c.food,f=c.wood,w=c.clay,h=c.iron,S=b.currentStock,v=f.currentStock,A=w.currentStock,y=h.currentStock,R=[0,5e3],I=[160,16e3],k=[200,2e4],O=[50,5e3];1==l&&(_=1),m(n,(function(i){T=u(i.villages),E=p(T,1===l),console.log(E),50!=E||r!==t&&0!=r.length?50==E&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=_?'chapel'==i&&'church'==i||1!=_||(v>=I[1]&&A>=k[1]&&y>=O[1]&&S>=R[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
...
barbarian:!a.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(g,T,m,S.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),G=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===S.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),s=n.some(e=>e.start_village_id===this.villageId);if(fe(s,o,!0))return t(i.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{E().then(f).then(A).then(R).then(I).then(O).then(x).then(N).then(P).then(G).then(e).catch(t)}),z=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([C,z]).then(()=>{if(!this.running)return!1
...
},xe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},be()},Pe=function(){const e={id:O.getId(),x:O.getX(),y:O.getY()};O=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:O.getId(),x:O.getX(),y:O.getY()}])};let Ge={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&b.call(K,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),be(),!0},removeHighlight:function(e,t){if(void 0===t||!b.call(K,e))return!1;if(!b.call(K[e],t))return!1;delete K[e][t];const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e]),
a.$broadcast(l.GROUPS_VILLAGES_CHANGED),be(),!0},getHighlight:function(e,t){return!!b.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=j[o.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){M=e,z=M.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ge.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Ee(e[0]*t,e[1]*t),i=Ee(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ge.getSettings=function(){return F},Ge.drawMinimap=function(){ge&&(ge=!1),N.style.background=j[o.COLOR_BACKGROUND],C.clearRect(0,0,G.width,G.height),d((function(){!function(){
const e=_.getPath(S.getMapPath()),t=j[o.SHOW_CONTINENT_DEMARCATIONS],a=j[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){C.fillStyle=j[o.COLOR_CONTINENT],C.fillRect(e*y+I-1,t*y+I-1,3,1),C.fillRect(e*y+I,t*y+I-2,1,3)},n=function(e,t){C.fillStyle=j[o.COLOR_PROVINCE],C.fillRect(e*y+I,t*y+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=f.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*y,c=l.a*y,d=(s.b-s.a)*y,u=(l.b-l.a)*y;C.beginPath(),C.lineWidth=2,C.strokeStyle="#2B4700",C.rect(r,c,d,u),C.stroke()}))}(),be()}),'minimap_data')},Ge.enableRendering=function(){H=!0},Ge.disableRendering=function(){H=!1},Ge.isFirstDraw=function(){return!!ge},Ge.init=function(){Ge.initialized=!0,G=document.createElement('canvas'),C=G.getContext('2d'),re=le.make('hover'),F=new u({settingsMap:s,storageKey:ne}),F.onChange((function(e,t){j=F.getAll(),
...
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(k),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y}(),fe(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,be),a.$on(l.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Ge})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,E,b,f,_,w,h){let S,v,A,y,R,I,k,O,L,x,N,P={},G=!1,C={character:{},tribe:{}};const M={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=M.MINIMAP,U=function(e){S.selectedTab=e,e===M.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(S.highlights.character).forEach((function(e){e in C.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,p.injectScope(u),
w(),h(),u.selectTab=b,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.PRANK_HELPER_START,S),e.register(l.PRANK_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Błazen',60),g.addEventListener('click',A),
...
default:!1,disabledOption:!0,inputType:'select'},[e.UNIT18]:{default:!1,disabledOption:!0,inputType:'select'},[e.UNIT19]:{default:!1,disabledOption:!0,inputType:'select'},[e.UNIT20]:{default:!1,disabledOption:!0,inputType:'select'}}})),define('two/recruitQueue/types/units',[],(function(){return{SPEAR:'spear',SWORD:'sword',AXE:'axe',ARCHER:'archer',LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/recruitQueue','two/recruitQueue/ui','two/recruitQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='report_helper_settings',E=function(){g=[]
;const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('all settings',d),s((function(){E()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.REPORT_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.REPORT_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/reportHelper/events',[],(function(){
angular.extend(l,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),
u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=b,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_report_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.REPORT_HELPER_START,S),e.register(l.REPORT_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Skryba',70),g.addEventListener('click',A),
...
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.REPORT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(l.REPORT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/settings/updates','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/ready','queues/EventQueue'],(function(e,t,a,i,n,o,s,r,c,d){let u,p,g=!1,m=!1;const T='spy_master_settings',E={[n.HEADQUARTER]:'headquarter',[n.WAREHOUSE]:'warehouse',[n.FARM]:'farm',[n.RALLY_POINT]:'rally_point',[n.STATUE]:'statue',[n.WALL]:'wall',[n.TAVERN]:'tavern',[n.BARRACKS]:'barracks',[n.PRECEPTORY]:'preceptory',
[n.HOSPITAL]:'hospital',[n.CLAY_PIT]:'clay_pit',[n.IRON_MINE]:'iron_mine',[n.TIMBER_CAMP]:'timber_camp',[n.CHAPEL]:'chapel',[n.CHURCH]:'church',[n.MARKET]:'market',[n.ACADEMY]:'academy'},b={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},f={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'},_={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',
[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(_,b,E,f);const w={init:function(){g=!0,u=new e({settingsMap:a,storageKey:T}),p=u.getAll(),console.log('all settings',p)},start:function(){m=!0,d.trigger(l.SPY_MASTER_START)},stop:function(){m=!1,d.trigger(l.SPY_MASTER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return w})),define('two/spyMaster/events',[],(function(){angular.extend(l,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u,p,m){let T,E,b;const f={SPY:'spy',COUNTERMEASURES:'countermeasures',
LOGS:'logs'},_=function(e){T.selectedTab=e},w=function(){E.setAll(E.decode(T.settings)),m.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},S=function(){T.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},v=function(){T.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},A=function(){T=a.$new(),T.SETTINGS=i,T.TAB_TYPES=f,T.running=t.isRunning(),T.selectedTab=f.SPY,T.settingsMap=n,T.building=u.encodeList(o,{textObject:'spy_master',disabled:!0}),T.unit=u.encodeList(s,{textObject:'spy_master',disabled:!0}),T.dummies=u.encodeList(r,{textObject:'spy_master',disabled:!0}),T.replacement=u.encodeList(d,{textObject:'spy_master',disabled:!0}),E.injectScope(T),T.selectTab=_,T.saveSettings=w,T.switchState=h;let e=new p('twoverflow_spy_master_window',(function(){
console.log('spyMaster window closed')}));e.register(l.SPY_MASTER_START,S),e.register(l.SPY_MASTER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',T)};return function(){E=t.getSettings(),b=e.addMenuButton3('Zwiadowca',10),b.addEventListener('click',A),
...
define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,
p.injectScope(u),w(),h(),u.selectTab=b,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.SUPPORT_SENDER_START,S),e.register(l.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',A),
