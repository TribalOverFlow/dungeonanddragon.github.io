...
(void 0).target=e}))},sn=function(e){d.selectedTab=e},rn=function(){const e=i.getSelectedVillage().data;(void 0).origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:(void 0).getId()}};const cn={autoCompleteSelected:function(e,t,a,n){if('battleCalculator_village_search'!==t)return!1;(void 0)[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},d.searchQuery[n]=''},onAutoCompleteOrigin:function(e){(void 0).origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){(void 0).target={id:e.id,x:e.x,y:e.y,name:e.name}},start:function(){an(),r.notif('success',g('i18n')('calculated',a.loc.ale,'battle_calculator'))}},dn=function(){d=a.$new(),d.selectedTab=m.BATTLE,d.TAB_TYPES=m,d.selectTab=sn,d.addSelected=rn,d.addMapSelected=ln,d.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'battle_calculator'),onEnter:cn.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'battle_calculator'),dropDown:!0},d.searchQuery={target:''},
kt=(void 0).find('.item-simulate span'),xt=(void 0).find('.item-insert span'),Rt=(void 0).find('.item-insertV span'),Mt=(void 0).find('.item-insertP span'),Lt=(void 0).find('.item-insertVD span'),Ot=(void 0).find('.item-insertPD span'),Nt=(void 0).find('.item-check span'),Ct=(void 0).find('.points-att'),Dt=(void 0).find('.points-def'),Pt=(void 0).find('.item-check-T span'),zt=(void 0).find('.wood'),Gt=(void 0).find('.clay'),Bt=(void 0).find('.iron'),Ut=(void 0).find('.food'),Vt=(void 0).find('.attack'),qt=(void 0).find('.attackinf'),Ft=(void 0).find('.attackcav'),Wt=(void 0).find('.attackarc'),jt=(void 0).find('.definf'),Yt=(void 0).find('.defcav'),Ht=(void 0).find('.defarc'),Qt=(void 0).find('.speed'),Kt=(void 0).find('.load'),Zt=(void 0).find('.discipline'),Xt=(void 0).find('.buildtime'),Jt=(void 0).find('.dataTraining'),$t=(void 0).find('.dataOrder'),ea=(void 0).find('.beliefAttacker'),ta=(void 0).find('.beliefDefender'),aa=(void 0).find('.dataMaster'),
na=(void 0).find('.dataWalls'),ia=(void 0).find('.dataClinique'),oa=(void 0).find('.dataHospital'),la=(void 0).find('.catapultTarget'),sa=(void 0).find('.dataEquip1'),ra=(void 0).find('.dataEquip2'),ca=(void 0).find('.dataEquip3'),da=(void 0).find('.dataEquip4'),ua=(void 0).find('.dataLevel1'),pa=(void 0).find('.dataLevel2'),ga=(void 0).find('.dataLevel3'),ma=(void 0).find('.dataLevel4'),L=(void 0).find('.spearA-amount'),O=(void 0).find('.spearA-losses'),N=(void 0).find('.spearA-revived'),C=(void 0).find('.spearA-survived'),D=(void 0).find('.swordA-amount'),P=(void 0).find('.swordA-losses'),z=(void 0).find('.swordA-revived'),G=(void 0).find('.swordA-survived'),B=(void 0).find('.axeA-amount'),U=(void 0).find('.axeA-losses'),V=(void 0).find('.axeA-revived'),q=(void 0).find('.axeA-survived'),F=(void 0).find('.archerA-amount'),W=(void 0).find('.archerA-losses'),j=(void 0).find('.archerA-revived'),Y=(void 0).find('.archerA-survived'),H=(void 0).find('.lcA-amount'),
Q=(void 0).find('.lcA-losses'),K=(void 0).find('.lcA-revived'),Z=(void 0).find('.lcA-survived'),X=(void 0).find('.maA-amount'),J=(void 0).find('.maA-losses'),$=(void 0).find('.maA-revived'),ee=(void 0).find('.maA-survived'),te=(void 0).find('.hcA-amount'),ae=(void 0).find('.hcA-losses'),ne=(void 0).find('.hcA-revived'),ie=(void 0).find('.hcA-survived'),oe=(void 0).find('.ramA-amount'),le=(void 0).find('.ramA-losses'),se=(void 0).find('.ramA-revived'),re=(void 0).find('.ramA-survived'),ce=(void 0).find('.catapultA-amount'),de=(void 0).find('.catapultA-losses'),ue=(void 0).find('.catapultA-revived'),pe=(void 0).find('.catapultA-survived'),ge=(void 0).find('.snobA-amount'),me=(void 0).find('.snobA-losses'),_e=(void 0).find('.snobA-revived'),fe=(void 0).find('.snobA-survived'),he=(void 0).find('.knightA-amount'),be=(void 0).find('.knightA-losses'),ve=(void 0).find('.knightA-revived'),Ee=(void 0).find('.knightA-survived'),we=(void 0).find('.trebuchetA-amount'),
Te=(void 0).find('.trebuchetA-losses'),Ae=(void 0).find('.trebuchetA-revived'),ye=(void 0).find('.trebuchetA-survived'),Se=(void 0).find('.berserkerA-amount'),Ie=(void 0).find('.berserkerA-losses'),ke=(void 0).find('.berserkerA-revived'),xe=(void 0).find('.berserkerA-survived'),Re=(void 0).find('.spearD-amount'),Me=(void 0).find('.spearD-losses'),Le=(void 0).find('.spearD-revived'),Oe=(void 0).find('.spearD-survived'),Ne=(void 0).find('.swordD-amount'),Ce=(void 0).find('.swordD-losses'),De=(void 0).find('.swordD-revived'),Pe=(void 0).find('.swordD-survived'),ze=(void 0).find('.axeD-amount'),Ge=(void 0).find('.axeD-losses'),Be=(void 0).find('.axeD-revived'),Ue=(void 0).find('.axeD-survived'),Ve=(void 0).find('.archerD-amount'),qe=(void 0).find('.archerD-losses'),Fe=(void 0).find('.archerD-revived'),We=(void 0).find('.archerD-survived'),je=(void 0).find('.lcD-amount'),Ye=(void 0).find('.lcD-losses'),He=(void 0).find('.lcD-revived'),Qe=(void 0).find('.lcD-survived'),
Ke=(void 0).find('.maD-amount'),Ze=(void 0).find('.maD-losses'),Xe=(void 0).find('.maD-revived'),Je=(void 0).find('.maD-survived'),$e=(void 0).find('.hcD-amount'),et=(void 0).find('.hcD-losses'),tt=(void 0).find('.hcD-revived'),at=(void 0).find('.hcD-survived'),nt=(void 0).find('.ramD-amount'),it=(void 0).find('.ramD-losses'),ot=(void 0).find('.ramD-revived'),lt=(void 0).find('.ramD-survived'),st=(void 0).find('.catapultD-amount'),rt=(void 0).find('.catapultD-losses'),ct=(void 0).find('.catapultD-revived'),dt=(void 0).find('.catapultD-survived'),ut=(void 0).find('.snobD-amount'),pt=(void 0).find('.snobD-losses'),gt=(void 0).find('.snobD-revived'),mt=(void 0).find('.snobD-survived'),_t=(void 0).find('.knightD-amount'),ft=(void 0).find('.knightD-losses'),ht=(void 0).find('.knightD-revived'),bt=(void 0).find('.knightD-survived'),vt=(void 0).find('.trebuchetD-amount'),Et=(void 0).find('.trebuchetD-losses'),wt=(void 0).find('.trebuchetD-revived'),Tt=(void 0).find('.trebuchetD-survived'),
At=(void 0).find('.berserkerD-amount'),yt=(void 0).find('.berserkerD-losses'),St=(void 0).find('.berserkerD-revived'),It=(void 0).find('.berserkerD-survived'),_=(void 0).find('.attackModifier'),f=(void 0).find('.attackProvisions'),h=(void 0).find('.attackBashpoint'),b=(void 0).find('.killrateA'),v=(void 0).find('.strentghAttack'),E=(void 0).find('.defenceModifier'),w=(void 0).find('.defenceProvisions'),T=(void 0).find('.defenceBashpoint'),A=(void 0).find('.killrateD'),y=(void 0).find('.strentghDefend'),S=(void 0).find('.wallfrompre'),I=(void 0).find('.walltopre'),k=(void 0).find('.wallfrom'),x=(void 0).find('.wallto'),_a=(void 0).find('.target'),R=(void 0).find('.buildingfrom'),M=(void 0).find('.buildingto'),fa=(void 0).find('.attackKilledProvisions'),ha=(void 0).find('.attackSurvivedProvisions'),ba=(void 0).find('.defenceKilledProvisions'),va=(void 0).find('.defenceSurvivedProvisions'),Ea=(void 0).find('.doubleStrength'),wa=(void 0).find('.availableBeds'),
Ta=(void 0).find('.strongestTypeOff'),Aa=(void 0).find('.strongestTypeDef'),(void 0).register(s.SELECT_SELECTED,cn.autoCompleteSelected,!0),(void 0).register(s.BATTLE_CALCULATOR_START,cn.start),(void 0).register(s.BATTLE_CALCULATOR_STOP,cn.stop),(void 0).register(s.COMMAND_QUEUE_START,cn.start),c.getScreenWithInjectedScope('!twoverflow_queue_window',d)};return function(){u=e.addMenuButton('Kalkulator',170),u.addEventListener('click',dn),o.register(s.BATTLE_CALCULATOR_START,(function(){u.classList.remove('btn-orange'),u.classList.add('btn-red')})),o.register(s.BATTLE_CALCULATOR_STOP,(function(){u.classList.remove('btn-red'),u.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,nn),a.$on(s.DESTROY_CONTEXT_MENU,on),
