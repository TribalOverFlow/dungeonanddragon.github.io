...
e.trigger(s.AUTO_HEALER_STARTED),r=!0,a.getSelectedCharacter().getVillageList().forEach((function(e,n){var a=e.hospital.patients.healed;0==a.length?t.notif('success',m('i18n')('no-patients',i.loc.ale,'auto_healer')):setTimeout((function(){a.forEach((function(i,n){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:i.id})}),n*d),t.notif('success','W wiosce: '+e.getName()+' wyleczono: '+i.id)}))}),n*c)})),t.notif('success',m('i18n')('deactivated',i.loc.ale,'auto_healer')),u.stop()},u.stop=function(){e.trigger(s.AUTO_HEALER_STOPPED),r=!1},u.isRunning=function(){return r},u.isInitialized=function(){return n},u})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','two/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Medyk',70,m('i18n')('description',i.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
