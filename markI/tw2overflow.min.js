...
},l=[];return w.forEach((function(a){i[a]=1,l.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},R={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return R})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',50,g('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),
...
g.isInitialized=function(){return t},g})),define('two/autoCollector/events',[],(function(){angular.extend(s,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Kolekcjoner',30,g('i18n')('description',a.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_collector')))})),n.register(s.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
textObject:'battle_calculator',disabled:!0}),w.hospital=f.encodeList(E,{textObject:'battle_calculator',disabled:!0}),w.training=f.encodeList(_,{textObject:'battle_calculator',disabled:!0}),A.injectScope(w),O(),w.selectTab=I,w.saveSettings=k,w.switchState=L;let e=new h('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,O,!0),e.register(s.ARMY_PRESET_DELETED,O,!0),e.register(s.BATTLE_CALCULATOR_START,N),e.register(s.BATTLE_CALCULATOR_STOP,x),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',w)};return function(){A=t.getSettings(),S=e.addMenuButton4('Kalkulator',10),S.addEventListener('click',P),
...
;const t=R.getAttackableBuildings();for(let e in t)M.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(I),S.splice(S.indexOf('catapult'),1),I.forEach((function(e){U[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(U),officers:angular.copy(G),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},z={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',10),w.addEventListener('click',_e),T.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),T.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},h.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),_=!1},h.isRunning=function(){return _},h.isInitialized=function(){return E},h})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,w),e.register(s.SPY_MASTER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',b)};return function(){T=t.getSettings(),E=e.addMenuButton3('Zwiadowca',10),E.addEventListener('click',S),
