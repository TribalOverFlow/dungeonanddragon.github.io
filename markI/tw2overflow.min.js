 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),b=injector.get('reportService'),T=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||T,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=E.call(o,t)?o[t]:t,e.setJSON(i[t]||i[n])}let s={init:function(){if(t)return!1;t=!0,l(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&l(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,i){const o=function(e,t){let a={};for(let i in e)E.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a},l=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),
this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||T},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return E.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!E.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),E.call(i,'min')&&(t=Math.max(i.min,t)),E.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(n,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(E.call(this.settingsMap,t)){
const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),E.call(a,'min')&&(i=Math.max(a.min,i)),E.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=o(a,i);if(!n)return!1;const l=s(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,l,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!E.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){
'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(i){e.multiSelect?i.length||(t.settings[a]=[l()]):i||(t.settings[a]=l())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const i=n.getPresetList().getPresets(),o=n.getGroupList().getGroups();return e=e||{},this.each((function(n,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[n]=r.multiSelect?[l()]:l());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){i[t]&&e.push({name:i[t].name,value:t})})),t[n]=e.length?e:[l()]}else{if(!i[s]&&r.disabledOption)return void(t[n]=l());t[n]={name:i[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[n]=e.length?e:[l()]}else{if(!o[s]&&r.disabledOption)return void(t[n]=l());t[n]={name:o[s].name,value:s}}break
;default:t[n]={name:e.textObject?g('i18n')(s,a.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[n]=[t[n]])}}else t[n]=s})),t},r.prototype.decode=function(e){let t={};for(let a in e){let i=this.settingsMap[a];if('select'===i.inputType)if(i.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let i=[];e[a].forEach((function(e){i.push(e.value)})),t[a]=i}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let i=[];switch((t=t||{}).disabled&&i.push(l()),t.type){case'keys':for(let t in e)i.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];i.push({name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){let a=e[t];i.push({name:a.name,value:a.id})}break;case'values':default:for(let n in e){let o=e[n];i.push({name:t.textObject?g('i18n')(o,a.loc.ale,t.textObject):o,value:o})}}return i},r.disabledOption=l,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],i=[],n=!1,r=!1,c=[];angular.extend(s,{
MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=T,d){if(d)r=!1;else{if(n)return c.push(e);if(r)return e(t)}c.push(e),n=!0;let u=[];for(let e=0;e<i.length;e++)for(let t=0;t<i[e].length;t++)u.push(i[e][t]);let p=[];return u.forEach((function(e){let a=new Promise((function(a,i){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return i(e.message);e.villages.length&&(t=t.concat(e.villages)),a()}))}));p.push(a)})),Promise.all(p).then((function(){n=!1,r=!0,a.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),a=Math.ceil(e.MAP_SIZE/306);for(let n=0;n<t;n++){i.push([]);let t=306*n,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<a;l++){let a=306*l,s=306..bound(0,a+306).bound(0,e.MAP_SIZE-a);a=a.bound(0,e.MAP_SIZE),i[n].push({x:t,y:a,width:o,height:s})}}}(),d
})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,i){let n,o,l,r,c={},d={},u=!1,p=document.querySelector('head'),g=injector.get('httpService'),m=injector.get('templateManagerService'),b=injector.get('$templateCache');return m.load=function(i,n,o){let l;const s=function(e,t,i,o){b.put(l.substr(1),e),angular.isFunction(n)&&n(e,t,i,o),a.$$phase||a.$apply()},r=function(e,t,a,i){angular.isFunction(o)&&o(e,t,a,i)};l=0!==i.indexOf('!')?e.TEMPLATE_PATH_EXT.join(i):i.substr(1),b.get(l.substr(1))?s(b.get(l.substr(1)),304):t.versionMap[l]?g.get(l,s,r):s(d[l],304)},c.init=function(){if(u)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div'),s=document.createElement('div'),d=document.createElement('div'),p=document.createElement('div'),g=document.createElement('div'),m=document.createElement('div'),b=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-menu-container2',
e.appendChild(a),s.className='two-menu-container3',e.appendChild(s),d.className='two-menu-container4',e.appendChild(d),p.className='two-main-button',p.style.display='none',g.className='two-economy-button',g.style.display='none',m.className='two-intrigue-button',m.style.display='none',b.className='two-other-button',b.style.display='none',t.appendChild(p),a.appendChild(g),s.appendChild(m),d.appendChild(b),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),o=document.createElement('div'),o.className='two-menu2',a.appendChild(o),l=document.createElement('div'),l.className='two-menu3',s.appendChild(l),r=document.createElement('div'),r.className='two-menu4',d.appendChild(r),u=!0,
...
;t.className='divisor',t.style.order=e,n.appendChild(t),o.appendChild(t),l.appendChild(t),r.appendChild(t)},c.isInitialized=function(){return u},c})),require(['two/ui'],(function(e){if(e.isInitialized())return!1;e.init()})),require(['two/language','two/ready','Lockr'],(function(e,t,i){t((function(){e.init(),function(){const e=i.get('twoverflow_version','1.0.0');if("2.0.0".endsWith('dev'))return!1;const t=function(e){if(/\d+\.\d+\.\d+/.test(e))return parseInt(e.split('.').reduce((e,t)=>e+t),10)};if(t("2.0.0")>t(e)){const e='https://gitlab.com/relaxeaza/twoverflow/blob/master/CHANGELOG.md',t=g('i18n')('check_changes',a.loc.ale,'common'),n=g('i18n')('firefox_shill',a.loc.ale,'common'),o=g('i18n')('new_version',a.loc.ale,'common',"2.0.0");a.$broadcast(s.NOTIFICATION_NEW,{message:`[b]${o}[/b]\n[url=${e}]${t}[/url]\n\n${n}`}),i.set('twoverflow_version',"2.0.0")}}()}))})),define('Lockr',(function(e,t){'use strict';return t.prefix='',t._getPrefixedKey=function(e,t){
return(t=t||{}).noPrefix?e:this.prefix+e},t.set=function(e,t,a){const i=this._getPrefixedKey(e,a);try{localStorage.setItem(i,JSON.stringify({data:t}))}catch(e){}},t.get=function(e,t,a){const i=this._getPrefixedKey(e,a);let n;try{n=JSON.parse(localStorage.getItem(i))}catch(e){n=localStorage[i]?{data:localStorage.getItem(i)}:null}return null===n?t:'object'==typeof n&&void 0!==n.data?n.data:t},t})),define('two/about',[],(function(){let e=!1,t={isInitialized:function(){return e},init:function(){e=!0}};return t})),define('two/about/ui',['two/ui'],(function(e){let t;const i=function(e){t.selectedTab=e},n=function(){t=a.$new(),t.selectTab=i,c.getModal('!twoverflow_about_window',t)};return function(){e.addDivisor(189),e.addMenuButton2('O mnie',190).addEventListener('click',(function(){n()})),
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,i){let r;var c=injector.get('overviewService'),d=!1,u=!1,p=n.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=n.getSelectedCharacter(),b=m.tribeById[0],T=m.getVillageList(),E=[],_=m.data.character_id,f=m.data.character_name,h=[],v=[],w=[i.LIGHT_CAVALRY,i.HEAVY_CAVALRY,i.AXE,i.SWORD,i.RAM,i.SNOB,i.TREBUCHET];var A=function(){
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:b},(function(e){for(var t=e.members,a=0;a<t.length;a++)v.push(t[a].id)})),T.forEach((function(e){E.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:E},S),setTimeout(A,6e4)},S=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),v.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(h.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{h.push(i[n].command_id),i[n].slowestUnit=y(i[n]);var s=i[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',p='';'sword'==i[n].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',
...
a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+p+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+i[n].target_village_id+']'+i[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+_+']'+f+'[/player][b] [br]Wioska pochodzenia: [/b][village='+i[n].origin_village_id+']'+i[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+i[n].origin_character_id+']'+i[n].origin_character_name+'[/player][/size]');var g=a.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==f||'halfsack'==f||'Black Rider'==f?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:g}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:g}),a=[]):('Hajduk Split'==f||'halfsack'==f||'Black Rider'==f?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:g}):o.emit(l.MESSAGE_REPLY,{message_id:4648,message:g}),a=[])}},y=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y
},l=[];return w.forEach((function(a){i[a]=1,l.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},R={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return R})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Wartownik',50,g('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),
i.notif('success',g('i18n')('activated',a.loc.ale,'alert_sender')))})),n.register(s.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,a,i,n){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.ALERT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(s.ALERT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c){
let d,u,p=!1,g=!1,m=[],b=[],T=[],E=[];const _='army_helper_settings',f={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(f);const h=function(){m=[],b=[],T=[],E=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){b.push(e[t])})),o.forEach((function(t){T.push(e[t])})),l.forEach((function(t){E.push(e[t])})),console.log('selectedGroups',m,b,T,E)},v={init:function(){p=!0,d=new e({settingsMap:i,storageKey:_}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&h()})),u=d.getAll(),console.log('all settings',u),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){g=!0,
c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return v})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u){let p,m,b,T=n.getGroupList();const E={PRESETS:'presets',ARMY:'army',BALANCER:'balancer'},_=function(e){p.selectedTab=e},f=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},v=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){p.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),
u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},A=function(){p.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.unit=r.encodeList(l,{textObject:'army_helper',disabled:!0}),m.injectScope(p),v(),p.selectTab=_,p.saveSettings=f,p.switchState=h;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.ARMY_HELPER_START,w),e.register(s.ARMY_HELPER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),b=e.addMenuButton('Administrator',140),b.addEventListener('click',S),
...
MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,b,T,E){let _,f,h=!1,v=injector.get('overviewService'),w=[],A=!1,S={},y={},R={reverse:!1,column:i.TIME_COMPLETED};const I='attack_view_filters',k={},L={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),
S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},N=function(){V.loadCommands()},x=function(e,t){E.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<w.length;e++)w[e].command_id===t.command_id&&w.splice(e,1);E.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},C=function(e,t){for(let e=0;e<w.length;e++)w[e].target_village_id===t.village_id?(w[e].target_village_name=t.name,w[e].targetVillage.name=t.name):w[e].origin_village_id===t.village_id&&(w[e].origin_village_name=t.name,w[e].originVillage.name=t.name);E.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},z=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},M=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{
unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},U=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(T.hasTownDataInChunk(e.x,e.y)){const a=T.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=U(r,e);else if(c.length)l=U(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=U(a,e)}}return t(l[0])}const i=b.scaledGridCoordinates(e.x,e.y,25,25,25);T.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},D=function(e){w=e.commands;for(let e=0;e<w.length;e++)v.formatCommand(w[e]),
w[e].slowestUnit=M(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[w])};let V={loadCommands:function(){const e=_.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:R.column,reverse:R.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},D)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return R},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),g.set(I,S),V.loadCommands()},toggleSorting:function(e){e===R.column?R.reverse=!R.reverse:(R.column=e,R.reverse=!1),V.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,f.OUT,s,{},l,p.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){
return h},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)L[r[e]]=!0;try{A=require('two/commandQueue'),f=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};h=!0,_=n.getSelectedCharacter().getGlobalInfo(),S=g.get(I,t,!0),e((function(){O(),a.$on(s.COMMAND_INCOMING,N),a.$on(s.COMMAND_CANCELLED,x),a.$on(s.MAP_SELECTED_VILLAGE,z),a.$on(s.VILLAGE_NAME_CHANGED,C),a.$on(s.COMMAND_IGNORED,P),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,b,T,E,_,f){let h,v;const w=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=f('#two-attack-view').parent(),t=f('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=h.pagination.offset,t=h.pagination.limit
;h.visibleCommands=h.commands.slice(e,e+t),h.pagination.count=h.commands.length},I=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);R()},k=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},L=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},O=function(){h.commands=t.getCommands()},N=function(){h.selectedVillageId=n.getSelectedVillage().getId()},x=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=T,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=b,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=p.jumpToVillage,h.now=w,h.copyTimeModal=A,h.removeTroops=S,h.switchWindowSize=y,
h.toggleFilter=k,h.toggleSorting=L,R();let e=new i('twoverflow_queue_window',(function(){_.timer.remove(I)}));e.register(s.MAP_SELECTED_VILLAGE,N,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),_.timer.add(I)};return function(){v=e.addMenuButton('Strażnik',40),v.addEventListener('click',x),
...
g.isInitialized=function(){return t},g})),define('two/autoCollector/events',[],(function(){angular.extend(s,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Kolekcjoner',80,g('i18n')('description',a.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_collector')))})),n.register(s.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(s.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,i,r,c){let d=!1,u=!1,p=!1,g=injector.get('secondVillageService');const m=function(){var e;e=b,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(g.hasFinishedLastJob(t.jobs))p=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),T.stop();else{let a=new c(t);n.getSelectedCharacter().setSecondVillage(a),e()}}))},b=function(){let e=n.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const a=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t<r.server2ClientTime(e[a].time_completed))return e[a];return!1}(e.data.jobs);if(a){const e=r.server2ClientTime(a.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const i=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t>=r.server2ClientTime(e[a].time_completed)&&!e[a].collected)return a;return!1}(e.data.jobs);if(i)return s=i,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:n.getSelectedVillage().getId(),job_id:s});var s;const c=g.getCurrentDayJobs(e.data.jobs,e.data.day),d=g.getCollectedJobs(e.data.jobs),p=n.getSelectedVillage().getResources().getResources(),b=g.getAvailableJobs(c,d,p,[]);if(b){const e=function(e){let a=!1;return t.each(e,(function(e){return a=e,!1})),a}(b);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:n.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=b[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let T={start:function(){if(!d||p)return!1;i.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,m()},stop:function(){if(!d)return!1;i.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!g.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){g.hasFinishedLastJob(e.jobs)?(p=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(a.$on(s.SECOND_VILLAGE_VILLAGE_CREATED,m),a.$on(s.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=T})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,a,i,n){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),a(),e((function(){i.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),n.register(s.AUTO_COLLECTOR_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_COLLECTOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let i=!1,r=!1;let c={init:function(){i=!0}};return c.start=function(){
t.trigger(s.AUTO_HEALER_STARTED),r=!0,function(){if(!r)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let a=e.hospital.patients.healed;0==a.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){a.forEach((function(t,a){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*a),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(s.AUTO_HEALER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),
define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Medyk',40,g('i18n')('description',a.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_healer')))})),n.register(s.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,a,i,n){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c,d,u,p,g,m,b,T,E,_,f){let h,v,w=!1,A=!1,S=[];const y='battle_calculator_settings',R={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},I={[l.HALBERD_OF_GUAN_YU]:'spear',[l.PARACELSUS_LONGSWORD]:'sword',
[l.THORGARDS_BATTLE_AXE]:'axe',[l.NIMRODS_LONGBOW]:'archer',[l.MIESZKOS_LANCE]:'lc',[l.NIMRODS_COMPOSITE_BOW]:'ma',[l.BAPTISTES_BANNER]:'hc',[l.CAROLS_MORNING_STAR]:'ram',[l.ALETHEIAS_BONFIRE]:'catapult',[l.VASCOS_SCEPTER]:'snob'},k={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},L={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},O={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},N={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,
[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},x={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},C={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},z={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3},M={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(L,M,z,C,P,x,N,O,R,I,k);const U=function(){S=[];const e=n.getPresetList().getPresets();v[t.PRESETS].forEach((function(t){S.push(e[t])})),console.log('selectedPresets',S)},G={init:function(){w=!0,h=new e({settingsMap:i,storageKey:y}),v=h.getAll(),console.log('all settings',v),_((function(){U()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,U),a.$on(s.ARMY_PRESET_DELETED,U)},start:function(){A=!0,console.log('selectedPresets',S),f.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){A=!1,console.log('example module stop'),f.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return h},isInitialized:function(){return w},isRunning:function(){return A}};return G})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u,p,g,m,b,T,E,_,f,h,v){let w,A,S,y=n.getPresetList();const R={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},I=function(e){w.selectedTab=e},k=function(){A.setAll(A.decode(w.settings)),v.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():t.start()},O=function(){w.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},N=function(){
w.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),v.notif('success','Example module started')},x=function(){w.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),v.notif('success','Example module stopped')},P=function(){w=a.$new(),w.SETTINGS=i,w.TAB_TYPES=R,w.running=t.isRunning(),w.selectedTab=R.BATTLE,w.settingsMap=o,w.catapulttarget=f.encodeList(d,{textObject:'battle_calculator',disabled:!0}),w.knightitem=f.encodeList(l,{textObject:'battle_calculator',disabled:!0}),w.itemlevel=f.encodeList(r,{textObject:'battle_calculator',disabled:!0}),w.order=f.encodeList(u,{textObject:'battle_calculator',disabled:!0}),w.wall=f.encodeList(p,{textObject:'battle_calculator',disabled:!0}),w.church=f.encodeList(g,{textObject:'battle_calculator',disabled:!0}),w.weaponmaster=f.encodeList(m,{textObject:'battle_calculator',disabled:!0}),w.ironwalls=f.encodeList(b,{textObject:'battle_calculator',disabled:!0}),w.clinique=f.encodeList(T,{
textObject:'battle_calculator',disabled:!0}),w.hospital=f.encodeList(E,{textObject:'battle_calculator',disabled:!0}),w.training=f.encodeList(_,{textObject:'battle_calculator',disabled:!0}),A.injectScope(w),O(),w.selectTab=I,w.saveSettings=k,w.switchState=L;let e=new h('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,O,!0),e.register(s.ARMY_PRESET_DELETED,O,!0),e.register(s.BATTLE_CALCULATOR_START,N),e.register(s.BATTLE_CALCULATOR_STOP,x),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',w)};return function(){A=t.getSettings(),S=e.addMenuButton('Kalkulator',180),S.addEventListener('click',P),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,b,T,E,_){let f,h,v,w=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,R=!1;const I={};let k,L,O,N,x,P=!0;const C='builder_queue_log',z='builder_queue_settings',M=function(){const e=G();if(!P)return F.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},U=function(){G().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&A.instantBuild(a,b.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=x[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=x[r.BUILDING_SEQUENCES][x[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return w.compute(e),V(e,a,(function(t,a){t&&a.job&&(T.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),j(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)B(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&x[r.PRIORIZE_FARM]){const t=v[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&B(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:b.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-x[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-x[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-x[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<v[t])return!1;return!0},j=function(e,t){let a={time:_.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),E.set(C,O),!0};let F={};return F.start=function(){if(!P)return T.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,f=setInterval(M,6e4),h=setInterval(U,6e3),e((function(){G().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),M(),U()}),['all_villages_ready']),T.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){R=!1,clearInterval(f),
clearInterval(h),T.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return R},F.isInitialized=function(){return y},F.getSettings=function(){return N},F.getLogs=function(){return O},F.clearLogs=function(){O=[],E.set(C,O),T.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=x[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=x[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=x[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,O=E.get(C,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),N=new i({settingsMap:c,storageKey:z}),N.onChange((function(e,t,a){x=N.getAll(),R&&t[d.ANALYSE]&&M(),a.quiet||T.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),x=N.getAll();for(let e in m)I[m[e]]=0;P=Object.keys(x[r.BUILDING_SEQUENCES]).length,v=!!P&&function(e){const t=x[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(x[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);D(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let i in e)E.call(e,i)&&(t[i]=a(e[i]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(s,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,b,T,_,f,h,v,w){let A,S,y,R,I=n.getGroupList(),k={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},x={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,z={},M={},U=!1,G=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case _.SEQUENCE_SAVED:return!0;case _.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case _.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=R.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=A.settings[b.ACTIVE_SEQUENCE].value,t=A.settings[b.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in f)i[f[e]]=0;N.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:w.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},N.generateBuildingSequenceFinal=function(e){const t=A.settings[b.ACTIVE_SEQUENCE].value,a=A.settings[b.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=k[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});N.buildingSequenceFinal=n},
N.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,k[a]=[];for(let e=1;e<=i.max_level;e++){let n=D(i.points,i.points_factor,e)-t;t+=n,k[a].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(U=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(U=!0)},O.addBuilding=function(e,t,a=1){const i=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),U=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),U=!0},O.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},O.generateBuildingSequence=function(){const e=R.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const a=e[O.selectedSequence.value];let i={};for(let e in f)i[f[e]]=0;O.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
...
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=O.selectedSequence.name,i=A.settings[b.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(U){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},x.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;x.visibleLogs=x.logs.slice(e,e+t),
A.pagination.logs.count=x.logs.length,x.visibleLogs.forEach((function(e){e.villageId&&function(e){if(z[e])return z[e];z[e]=!0,M[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){z[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},M[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},x.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[f.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(A.settings[b.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[b.BUILDING_SEQUENCES][e.name]=t,j(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},j=function(){R.setAll(R.decode(A.settings)),U=!1},F=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){U?Y((function(){C()})):C()},K={updateGroups:function(){A.groups=p.encodeList(I.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(b.BUILDING_SEQUENCES);A.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){A.logs=i.getLogs(),x.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=R.get(b.BUILDING_SEQUENCES);A.settings[b.BUILDING_SEQUENCES][t]=i[t],A.settings[b.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=R.get(b.BUILDING_SEQUENCES);A.settings[b.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[b.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(E.call(e,t))return t;return!1}(A.settings[b.BUILDING_SEQUENCES]);O.selectedSequence={name:i,value:i},K.updateSequences(),O.generateBuildingSequence(),R.get(b.ACTIVE_SEQUENCE)===t&&(R.set(b.ACTIVE_SEQUENCE,i,{quiet:!0}),N.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=R.get(b.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=P.SETTINGS,A.TAB_TYPES=P,A.SETTINGS=b,A.running=L,A.pagination={},A.settingsMap=R.settingsMap,A.villagesLabel=M,A.villagesInfo=z,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=f.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=N,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=x,A.logsView.logs=i.getLogs(),A.selectTab=W,A.switchBuilder=F,A.saveSettings=j,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,R.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.logs={count:x.logs.length,offset:0,loader:x.updateVisibleLogs,limit:m.getPaginationLimit()},x.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new h('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(s.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',A),C=A.closeWindow,A.closeWindow=H,A.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),A.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(U?Y((function(){K.generateBuildingSequencesEditor(),U=!1}),(function(){A.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),R=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),v.register(s.BUILDER_QUEUE_START,(function(){L=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),v.register(s.BUILDER_QUEUE_STOP,(function(){L=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const v=Object.values(c),w=Object.values(a),A=Object.values(h),S=Object.values(f),y=Object.values(_);let R,I=[],k={},L=[],O=[],N=!1;const x={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+R},C=function(e){I.push(e)},z=function(e){k[e.id]=e},M=function(){
T.set(d.QUEUE_COMMANDS,I)},U=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return E.call(e,'x')&&E.call(e,'y')&&U(e.x)&&U(e.y)};let D={initialized:!1};return D.init=function(){R=t.getTimeOffset(),D.initialized=!0,L=T.get(d.QUEUE_SENT,[],!0),O=T.get(d.QUEUE_EXPIRED,[],!0),function(){const e=T.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?D.expireCommand(e,i.TIME_LIMIT):(C(e),z(e))}))}(),setInterval((function(){I.length&&I.some((function(e){if(!P(e.sendTime))return!0;N?D.sendCommand(e):D.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&I.length&&(e.returnValue=!0)}))},D.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return D.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),T.set(d.QUEUE_SENT,L),D.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},D.expireCommand=function(e,t){!function(e){O.push(e)}(e),T.set(d.QUEUE_EXPIRED,O),D.removeCommand(e,t)},D.addCommand=function(e,i,o,l,s,r,d,p){let m={},T={};return new Promise((function(E,R){if(!G(e))return R(u.INVALID_ORIGIN);if(!G(i))return R(u.INVALID_TARGET);if(!t.isValidDateTime(o))return R(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return R(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return R(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(T[t]=!0)})))return R(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&T[f.SUPPORTER]&&delete T[f.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[h.CATAPULT])&&(p||_.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>b.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>b.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return R(u.INVALID_ORIGIN);if(!i)return R(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,T,!0),c=l===a.ARRIVE?s-r:s,b=l===a.ARRIVE?s:s+r;if(P(c))return R(u.ALREADY_SENT);const _={id:t.guid(),travelTime:r,arriveTime:b,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:T,type:d,catapultTarget:p,countdown:c-g.gameTime()};C(_),z(_),I=I.sort((function(e,t){return e.sendTime-t.sendTime})),
M(),E(_)})):R(u.INVALID_DATE_TYPE)):R(u.INVALID_CATAPULT_TARGET)):R(u.RELOCATE_DISABLED):R(u.INVALID_COMMAND_TYPE)}))},D.removeCommand=function(e,t){delete k[e.id];const a=I.some((function(t,a){if(t.id==e.id)return I.splice(a,1),M(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},D.clearRegisters=function(){T.set(d.QUEUE_EXPIRED,[]),T.set(d.QUEUE_SENT,[]),O=[],L=[]},D.start=function(e){N=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},D.stop=function(){N=!1,p.trigger(s.COMMAND_QUEUE_STOP)},D.isRunning=function(){return N},D.getWaitingCommands=function(){return I},D.getWaitingCommandsObject=function(){return k},D.getSentCommands=function(){return L},
D.getExpiredCommands=function(){return O},D.filterCommands=function(e,t,a){const i=x[e];return(a||I).filter((function(e){return i(e,t)}))},D})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,b,T,E,_,f,h){let v,w,A,S,y,R=n.getGameData(),I=R.getOrderedUnitNames(),k=R.getOrderedOfficerNames(),L=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},x=N.ADD;let P,C,z,M=[],U={},G={};const D={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){O=t.data},q=function(){O=!1},W=function(e){
const t=new Date(e||_.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=_.zerofill(a-a%100,3),n=_.zerofill(t.getSeconds(),2),l=_.zerofill(t.getMinutes(),2);return _.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+_.zerofill(t.getDate(),2)+'/'+_.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(D,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);v.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),v.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&v.isValidDate?_.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=v.selectedDateType.value,h.set(m.LAST_DATE_TYPE,v.selectedDateType.value),F()},K=function(){
y.catapultTarget=v.catapultTarget.value},Q=function(){const e=v.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,v.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},v.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=_.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),_.timer.add(e.updateCountdown)},X=function(){v.waitingCommands=t.getWaitingCommands()},J=function(){v.sentCommands=t.getSentCommands()},$=function(){v.expiredCommands=t.getExpiredCommands()},ee=function(){let e=v.waitingCommands;V.forEach((function(a){v.activeFilters[a]&&(e=t.filterCommands(a,v.filtersData,e))})),
v.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){v.showCatapultSelect=!!y.units.catapult},ne=function(e){v.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!O)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},se=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=j(y.date,100)},ce=function(){if(!y.date)return!1;y.date=j(y.date,-100)},de=function(){y.units=angular.copy(U),y.officers=angular.copy(G),y.catapultTarget="wall",v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case b.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case b.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case b.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case b.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case b.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case b.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},be=function(e,t){v.activeFilters[e]=!v.activeFilters[e],
t&&(v.filtersData[u.ALLOWED_TYPES][e]=!v.filtersData[u.ALLOWED_TYPES][e]),ee()},Te=function(){v.activeFilters[u.TEXT_MATCH]=v.filtersData[u.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){v.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},v.searchQuery[i]=''},removeCommand:function(e,t){_.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){_.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(v.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){v.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{_.timer.remove(e.updateCountdown)})}},_e=function(){const e=h.get(m.LAST_DATE_TYPE,l.OUT,!0);let b;v=a.$new(),v.selectedTab=x,v.inventory=n.getInventory(),v.presets=o.obj2selectOptions(L.getPresets()),v.travelTimes={},o.each(p,(function(e){v.travelTimes[e]={},o.each(D,(function(t,a){v.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),v.unitOrder=S,v.officers=R.getOrderedOfficerNames(),v.searchQuery={origin:'',target:''},v.isValidDate=!1,v.dateTypes=f.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),v.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},v.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},v.showCatapultSelect=!!y.units.catapult,v.attackableBuildings=M,v.commandData=y,
v.activeFilters=C,v.filtersData=z,v.running=t.isRunning(),v.waitingCommands=t.getWaitingCommands(),v.visibleWaitingCommands=t.getWaitingCommands(),v.sentCommands=t.getSentCommands(),v.expiredCommands=t.getExpiredCommands(),v.EVENT_CODES=d,v.FILTER_TYPES=u,v.TAB_TYPES=N,v.COMMAND_TYPES=p,v.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),v.onUnitInputFocus=te,v.onUnitInputBlur=ae,v.catapultTargetVisibility=ie,v.selectTab=ne,v.addSelected=oe,v.addMapSelected=le,v.addCurrentDate=se,v.incrementDate=re,v.reduceDate=ce,v.cleanUnitInputs=de,v.addCommand=ue,v.clearRegisters=pe,v.switchCommandQueue=ge,v.removeCommand=t.removeCommand,v.openVillageInfo=r.openVillageInfo,v.toggleFilter=be,v.$watch('commandData.origin',F),v.$watch('commandData.target',F),v.$watch('commandData.date',F),v.$watch('commandData.officers',F),v.$watch('selectedDateType.value',H),v.$watch('selectedInsertPreset.value',Q),v.$watch('catapultTarget.value',K),v.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Te),
v.$watch('selectedTab',(function(){v.selectedTab===N.ADD?b=setInterval((function(){F()}),2500):clearInterval(b)})),v.waitingCommands.forEach(e=>{Z(e)});let T=new i('twoverflow_queue_window',(function(){clearInterval(b),Ee.clearCountdownUpdates()}));T.register(s.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),T.register(s.ARMY_PRESET_DELETED,Ee.updatePresets,!0),T.register(s.SELECT_SELECTED,Ee.autoCompleteSelected,!0),T.register(s.COMMAND_QUEUE_REMOVE,Ee.removeCommand),T.register(s.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),T.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),T.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),T.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),T.register(s.COMMAND_QUEUE_SEND,Ee.sendCommand),T.register(s.COMMAND_QUEUE_START,Ee.start),T.register(s.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){A=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=R.getAttackableBuildings();for(let e in t)M.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(I),S.splice(S.indexOf('catapult'),1),I.forEach((function(e){U[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(U),officers:angular.copy(G),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},z={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',20),w.addEventListener('click',_e),T.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),T.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,b,T,E=!1,_=!1,f=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){E=!0}};return h.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),_=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),E=c.food,_=c.wood,h=c.clay,v=c.iron,w=E.currentStock,A=_.currentStock,S=h.currentStock,y=v.currentStock,R=[0,5e3],I=[160,16e3],k=[200,2e4],L=[50,5e3];1==s&&(f=1),m(n,(function(i){b=u(i.villages),T=p(b,1===s),console.log(T),50!=T||r!==t&&0!=r.length?50==T&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=f?'chapel'==i&&'church'==i||1!=f||(A>=I[1]&&S>=k[1]&&y>=L[1]&&w>=R[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):A>=I[0]&&S>=k[0]&&y>=L[0]&&w>=R[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==f?A>=I[1]&&S>=k[1]&&y>=L[1]&&w>=R[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):A>=I[0]&&S>=k[0]&&y>=L[0]&&w>=R[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},h.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),_=!1},h.isRunning=function(){return _},h.isInitialized=function(){return E},h})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Kapelan',30,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,b,_,f,h,v,w,A,S,y,R){let I,k,L,O,N,x=!1,P=!1,C=[],z=[],M=[],U=[],G=[],D=[],V=!1,B=!1,q=!1,W=0,j=null,F=null,Y=null,H={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(k[r.MIN_DISTANCE],k[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!M.includes(e.id)},ignored:function(e){return U.includes(e.id)},points:function(e){
return!e.between(k[r.MIN_POINTS],k[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=k[r.GROUP_INCLUDE];M=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);M=M.concat(t)})),M=ie(M)}(),function(){const e=k[r.GROUP_IGNORE];U=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=U.concat(M);let t=!1;e.forEach((function(e){E.call(L,e)||(L[e]={time:h.gameTime(),report:!1},t=!0)})),b.each(L,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete L[i],t=!0)})),t&&(R.set($,L),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),v.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(Ie(t.village_id),l=!0):(Oe(t.village_id),Te(g.IGNORED_VILLAGE,{villageId:t.village_id}),be(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),Te(g.INCLUDED_VILLAGE,{villageId:t.village_id}),be(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}else Ne(),Te(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),Te(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Ie(t.village_id),l=!0),l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=k[r.GROUP_IGNORE],i=k[r.GROUP_ONLY],o=k[r.GROUP_INCLUDE],l=E.call(t,a)?a:I.getDefault(r.GROUP_IGNORE),s=i.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));I.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Re(),Ne(),ye()},ce=function(){D=[];const e=n.getPresetList().getPresets();k[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),D.push(a)})),D=D.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),D.length||(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&xe.stop())},ue=function(e,t){k[r.IGNORE_ON_LOSS]&&k[r.GROUP_IGNORE]&&P&&t.type===w.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){V&&q&&t.origin.id===V.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&V.commandSent(t)},ge=function(e,t){V&&B&&q&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return b.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},be=function(e){L[e]={time:h.gameTime(),report:H[e]||!1},delete H[e],R.set($,L),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Te=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,z.unshift(t),Ee(),!0)},Ee=function(){const e=k[r.LOGS_LIMIT];z.length>e&&z.splice(z.length-e,z.length),R.set(X,z),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},_e=function(e,t,a){const i=k[r.TARGET_MULTIPLE_FARMERS],n=k[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},fe=function(){K=h.gameTime()},he=function(){clearTimeout(j),clearTimeout(F),clearTimeout(Y),j=null,F=null,Y=null
},ve=function(){return Math.max(1,60*k[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*k[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=T,this.status=i.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{v.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return fe(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,v.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,v.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=T},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;fe();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const T=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return a(i.USER_STOP);t()},b.randomSeconds(we())):t()}),_=()=>new Promise((e,a)=>{const n=50-k[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(k[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),R=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),I=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||M.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(D.forEach((function(e){E.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)E.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=f.actualDistance(l,a);b.each(D,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),x=()=>new Promise((e,n)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),_e(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[r.TARGET_SINGLE_ATTACK]&&!k[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=k[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=f.actualDistance(s,a),b=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),T=d.getTravelTimeForDistance(g,b,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+T-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(_e(l,o,!0))return t(i.BUSY_TARGET);e()})});let z=new Promise((e,t)=>{T().then(_).then(S).then(R).then(I).then(L).then(N).then(x).then(P).then(C).then(e).catch(t)}),U=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([z,U]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),B=!0,q=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:w.TYPES.ATTACK})}).catch(t=>{switch(he(),v.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Oe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){B=!1,q=!1,he(),Te(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){B=!1,q=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=f.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(U.includes(e))return!1;let a=xe.getFarmer(e);return a||(a=new Ae(e),C.push(a)),a},ye=function(){b.each(O.getVillages(),(function(e,t){Se(t)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=k[r.GROUP_ONLY];let t=[];C.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):U.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Ie(e)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Ie=function(e){for(let a=0;a<C.length;a++)if(C[a].getId()===e)return C[a].stop(t.KILL_FARMER),C.splice(a,a+1),!0;return!1
},ke=function(e){fe(),C.length?W>=C.length?(W=0,V=!1,Z=h.gameTime()+ve(),v.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=C[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):j=setTimeout((function(){j=null,W=0,Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),ve())},Le=function(e){for(let t=0;t<C.length;t++){let a=C[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){C.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){C.forEach((function(e){e.loadTargets()}))}),!0)};let xe={};return xe.init=function(){x=!0,z=R.get(X,[]),L=R.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),I=new e({settingsMap:c,storageKey:J}),I.onChange((function(e,t,a){k=I.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Ne(),t[p.VILLAGES]&&(Re(),ye()),t[p.LOGS]&&Ee(),t[p.INTERVAL_TIMERS]&&P&&(F?(he(),
V.targetStep({delay:!0})):j&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=I.getAll(),se("ignore_update"),ne(),ye(),_((function(){ce()}),'presets'),_((function(){C.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},xe.start=function(){let e;return!P&&(D.length?(P=!0,e=[],C.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),fe(),function(){let e=ve(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(xe.stop(),setTimeout(xe.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void Te(g.FARM_START)):(P=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},xe.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=h.gameTime()+ve()),v.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,P=!1,he(),v.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&Te(g.FARM_STOP)},xe.getFarmer=function(e){return C.find((function(t){return t.getId()===e}))},xe.getFarmers=function(){return C},xe.getSettings=function(){return I},xe.getExceptionVillages=function(){return{included:M,ignored:U}},xe.getExceptionLogs=function(){return L},xe.isInitialized=function(){return x},xe.isRunning=function(){return P},xe.getLogs=function(){return z},xe.clearLogs=function(){return z=[],R.set(X,z),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),z},xe.getNextCycleDate=function(){return Z},xe.getCycleInterval=ve,xe})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,T,E,_,f,h,v){let w,A,S,y=n.getPresetList(),R=n.getGroupList(),I={},k={},L=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&x(e.villageId),e.targetId&&x(e.targetId)}))},x=function(e){if(I[e])return I[e];I[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){I[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
w.exceptionVillages.included.forEach((function(e){x(e)})),w.exceptionVillages.ignored.forEach((function(e){x(e)}))},C=function(){t.isRunning()?t.stop():t.start()},z=function(e){w.selectedTab=e},M=function(){A.setAll(A.decode(w.settings)),w.saveButtonColor='orange',f.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},U=function(e){const t=A.get(T.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(T.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){w.presets=E.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){w.groups=E.encodeList(R.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=E.encodeList(R.getGroups(),{disabled:!0,type:'groups'})},B=function(){w.running=!0,
f.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:f.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:f.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){w.logs=angular.copy(t.getLogs()),N(),w.logs.length||f.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},j=function(){w.farmers=t.getFarmers()},F=function(){w.exceptionVillages=t.getExceptionVillages(),P()},Y=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=T,w.TAB_TYPES=O,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=O.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=k,w.villagesInfo=I,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=A.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},A.injectScope(w),D(),V(),N(),P(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-v.gameTime(),L=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=C,w.selectTab=z,w.saveSettings=M,w.clearLogs=t.clearLogs,w.jumpToVillage=p.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=b.showReport,w.removeIgnored=U,w.removeIncluded=G;let i=new _('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(s.ARMY_PRESET_UPDATE,D,!0),i.register(s.ARMY_PRESET_DELETED,D,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
i.register(s.FARM_OVERFLOW_START,B),i.register(s.FARM_OVERFLOW_STOP,q),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',w),w.$watch('settings',(function(){e||(w.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){Q()})),h.register(s.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),h.register(s.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,b,T,_,f,h,v,w,A){let S,y,R,I,k,L,O,N,x,P,C,z,M,U,G,D,V,B,q,W,j,F,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,be=function(e){let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/y)%2&&(t+=I),t-=t%y,a-=a%y,{x:Math.ceil((t-x.width/2)/y),y:Math.ceil((a-x.height/2)/y)}},Te=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},Ee=function(){Ae(k)},_e=function(){if(H){const e={x:ee.x-x.width/2,y:ee.y-x.height/2};P.clearRect(0,0,x.width,x.height),U.clearRect(0,0,M.width,M.height),function(e){P.drawImage(C,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;U.fillStyle=Y[o.COLOR_VIEW_REFERENCE],U.fillRect(a,0,1,R),U.fillRect(0,i,R,1);const n=D.getBoundingClientRect(),l=n.width/w.TILESIZE.x/A.view.z*y,s=n.height/w.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;U.clearRect(r,c,l,s),U.beginPath(),U.lineWidth=1,U.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],U.rect(r,c,l,s),U.stroke()}(e)}e.requestAnimationFrame(_e)
},fe=function(){if(!ie)return!1;const e=Q.village[O][N];ve(e?Q.character[e]:[[O,N]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return W.ally;if(j.isEnemy(e.tribe_id))return W.enemy;if(j.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||we(i);if(!n)continue;const o=i.x*y+(i.y%2?I:0),l=i.y*y;z.fillStyle=n,z.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],I=Math.round(S/2),y=S+1,R=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,C.width=1e3*y,C.height=1e3*y,z.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;x.width=686,x.height=e,M.width=686,M.height=e,P.imageSmoothingEnabled=!1,U.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,T.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Ie=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,pe=be(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;fe()}ie=!0,O=e.x,N=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=Q.village[O][N];he(a?Q.character[a]:[[O,N]])}(pe,e)}fe()},Le=function(){ie&&fe(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=be(e);p.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},xe=function(){K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){x=e,x.style.background=Y[o.COLOR_BACKGROUND],P=x.getContext('2d')},setViewportRef:function(e){M=e,U=M.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=T.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Te(e[0]*t,e[1]*t),i=Te(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return F},Ce.drawMinimap=function(){ge&&(ge=!1),x.style.background=Y[o.COLOR_BACKGROUND],z.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=f.getPath(w.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){z.fillStyle=Y[o.COLOR_CONTINENT],z.fillRect(e*y+I-1,t*y+I-1,3,1),z.fillRect(e*y+I,t*y+I-2,1,3)},n=function(e,t){z.fillStyle=Y[o.COLOR_PROVINCE],z.fillRect(e*y+I,t*y+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=_.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;z.beginPath(),z.lineWidth=2,z.strokeStyle="#2B4700",z.rect(r,c,d,u),z.stroke()}))}(),Ee()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),z=C.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ne}),F.onChange((function(e,t){
Y=F.getAll(),Se(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),Y=F.getAll(),K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Se()},Ce.run=function(){d((function(){D=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),j=V.getTribeRelations(),B=V.getId(),q=V.getTribeId(),W=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),M.addEventListener('mousedown',Re),M.addEventListener('mouseup',Ie),M.addEventListener('mousemove',ke),M.addEventListener('mouseleave',Le),M.addEventListener('click',Oe),M.addEventListener('contextmenu',Ne),g.load((function(){k=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(k),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),_e(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,Ee),a.$on(s.GROUPS_VILLAGES_CHANGED,xe)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,b,T,E,_,f,h,v){let w,A,S,y,R,I,k,L,O,N,x,P={},C=!1,z={character:{},tribe:{}};const M={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},U=M.MINIMAP,G=function(e){w.selectedTab=e,e===M.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(w.highlights.character).forEach((function(e){e in z.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
z.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in z.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){z.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},B=function(e,t){if(!O)return;let a=V(t.x,t.y);var i,n;N=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=f.getTownAt(i,n);if(t)return e(t);f.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[V(e.x,e.y)])return;if(!C)return;k.appendChild(O),O.classList.remove('ng-hide'),I.tt.name=e.name,I.tt.x=e.x,I.tt.y=e.y,I.tt.province_name=e.province_name,I.tt.points=e.points,I.tt.character_name=e.character_name||'-',I.tt.character_points=e.character_points||0,I.tt.tribe_name=e.tribe_name||'-',I.tt.tribe_tag=e.tribe_tag||'-',I.tt.tribe_points=e.tribe_points||0,I.tt.morale=e.morale||0,I.tt.position={},I.tt.position.x=t.event.pageX+50,I.tt.position.y=t.event.pageY+50,I.tt.visible=!0
;const a=O.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=I.tt.position.y+o>i.top+i.height,s=I.tt.position.x+n>i.width;l&&(I.tt.position.y-=50),O.classList.toggle('left',s),O.classList.toggle('top',l)}))},q=function(e,t){if(!O)return;let a=t?V(t):N;P[a]=!1,C=!1,I.tt.visible=!1,O.classList.add('ng-hide'),L.appendChild(O)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=v.palette,'setting'===e?(l=t,o=x.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=x.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},j=function(){n.addHighlight(w.selectedHighlight,w.addHighlightColor)},F=function(){x.setAll(x.decode(w.settings)),b.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){x.resetAll(),b.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){D()},highlightAddErrorExists:function(){b.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){b.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){b.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=M,w.selectedTab=U,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=n.getHighlights(),w.highlightNames=z,w.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=G,w.openColorPalette=W,w.addCustomHighlight=j,w.removeHighlight=n.removeHighlight,w.saveSettings=F,w.resetSettings=Y,w.highlightsCount=H,w.openProfile=K,x.injectScope(w,{textObject:'minimap'});let e=new T('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,B),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),D(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(S),R.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){x=n.getSettings(),I=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),L=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
e.trigger(s.MINT_HELPER_STARTED),a=!0,r()},stop:function(){e.trigger(s.MINT_HELPER_STOPPED),a=!1},isRunning:function(){return a},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(s,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Mincerz',10,g('i18n')('description',a.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'mint_helper'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'mint_helper')))})),n.register(s.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',b='060502',T='060501',E='060503',_='05020a',f='05030a',h='04080a',v='040a0a',w='070e04',A='070e05',S='070e0f',y='070e06',R='070e02',I='070e01',k='070e03',L='070e07',O='070e0b',N='070e0e',x='030d07',P='030d0b',C='030d0e';var z={init:function(){i=!0}};return z.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,b='string'==typeof b?parseInt(b,16):b,T='string'==typeof T?parseInt(T,16):T,E='string'==typeof E?parseInt(E,16):E,_='string'==typeof _?parseInt(_,16):_,f='string'==typeof f?parseInt(f,16):f,h='string'==typeof h?parseInt(h,16):h,v='string'==typeof v?parseInt(v,16):v,w='string'==typeof w?parseInt(w,16):w,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,R='string'==typeof R?parseInt(R,16):R,I='string'==typeof I?parseInt(I,16):I,k='string'==typeof k?parseInt(k,16):k,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,x='string'==typeof x?parseInt(x,16):x,P='string'==typeof P?parseInt(P,16):P,C='string'==typeof C?parseInt(C,16):C,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
...
default:!1,disabledOption:!0,inputType:'select'},[e.UNIT18]:{default:!1,disabledOption:!0,inputType:'select'},[e.UNIT19]:{default:!1,disabledOption:!0,inputType:'select'},[e.UNIT20]:{default:!1,disabledOption:!0,inputType:'select'}}})),define('two/recruitQueue/types/units',[],(function(){return{SPEAR:'spear',SWORD:'sword',AXE:'axe',ARCHER:'archer',LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/recruitQueue','two/recruitQueue/ui','two/recruitQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=n.getSelectedCharacter(),a=t.data.character_id,i=t.data.character_name,r=!1,c=!1,d=[],u=[],p=[];function g(e){var t=new Date(1e3*e);return t.toLocaleString()}var m=function(){
o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},T))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},E))})),setTimeout(m,3e4)},b=function(e){
var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,b=g(m),T=e.ReportScouting,E=T.attCharacterId,_=T.attCharacterName,f=T.attScouts,h=T.attLosses,v=T.attVillageId,w=T.attVillageName,A=T.defCharacterId,S=T.defCharacterName,y=T.defLosses,R=T.defScouts,I=T.defVillageId,k=T.defVillageName,L=T.commandType,O='',N='',x='',P='',C=Date.now(),z=p.split('.').join('_');2==u?O=' [color=d96a19]Częściowy sukces[/color]':1==u?O=' [color=0a8028]Sukces[/color]':3==u&&(O=' [color=e21f1f]Porażka[/color]'),N='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==R?'nieznana':R,s=null==f?'nieznana':f,r=null==y?'nieznana':y,c=null==h?'nieznana':h,P=null==_&&null==E?'Brak danych':'[player='+E+']'+_+'[/player]',x=null==w&&null==v?'Brak danych':'[village='+v+']'+w+'[/village]',t=Math.floor(C/1e3-m),
d.push('[size=XL][b]Raport szpiegowski: [report]'+z+'[/report][br]'+O+' --- Typ: '+N+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+b+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+k+'[/village][b] Gracz cel: [/b][player='+A+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+x+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var M=d.join();A!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:M}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:M}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:M}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:M}),d=[])},T=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var f=[],h=[];T.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,f.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var v=f.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var w=h.join(),A=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,k=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),x=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),C=d.night,z=d.loyaltyAfter,M=d.loyaltyBefore,U=d.wallAfter,G=d.wallBefore,D=d.officers,V=d.leader,B='',q='',W='',j='',F='',Y='',H='',K='',Q='',Z=Date.now(),X=s.split('.').join('_')
;null!=M&&(Y='Lojalność przed atakiem: '+Math.floor(M)+' '),null!=z&&(H='Lojalność po ataku: '+Math.floor(z)+' '),null!=G&&(K='Mury przed ataku: '+G+' '),null!=U&&(Q='Mury po ataku: '+U+' '),null==D&&1==V?F='Brak':null==D&&1.1==V&&(F=' Wielki Mistrz '),j=0==C?'Nie':'Tak',2==n?B=' [color=d96a19]Częściowy sukces[/color]':1==n?B=' [color=0a8028]Sukces[/color]':3==n&&(B=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+I+']'+k+'[/player][br]Modyfikator obrony: [b]'+x+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+Y+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},E=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var f=[],h=[];T.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,f.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var v=f.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var w,A=h.join(),S=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,L=d.defCharacterName,O=d.defVillageId,N=d.defVillageName,x=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),z=d.night,M=d.loyaltyAfter,U=d.loyaltyBefore,G=d.wallAfter,D=d.wallBefore,V=d.officers,B='',q='',W='',j='',F='',Y='',H='',K='',Q=[],Z=Date.now(),X=s.split('.').join('_')
;if(null!=U&&(F='Lojalność przed atakiem: '+Math.floor(U)+' '),null!=M&&(Y='Lojalność po ataku: '+Math.floor(M)+' '),null!=D&&(H='Mury przed ataku: '+D+' '),null!=G&&(K='Mury po ataku: '+G+' '),null==V)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(j=0==z?'Nie':'Tak',2==n?B=' [color=d96a19]Częściowy sukces[/color]':1==n?B=' [color=0a8028]Sukces[/color]':3==n&&(B=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(Z/1e3-r),w=Q.join(),null!=L){
a.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+N+'[/village][b] Gracz cel: [/b][player='+k+']'+L+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+x+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br]Oficerowie: [b]'+w+'[/b][br]'+F+Y+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},_={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return r}};return _})),define('two/reportSender/events',[],(function(){angular.extend(s,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Goniec',60,g('i18n')('description',a.loc.ale,'report_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'report_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'report_sender')))})),n.register(s.REPORT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.REPORT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.REPORT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(s.REPORT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/settings/updates','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/ready','queues/EventQueue'],(function(e,t,a,i,n,o,l,r,c,d){let u,p,g=!1,m=!1;const b='spy_master_settings',T={[n.HEADQUARTER]:'headquarter',[n.WAREHOUSE]:'warehouse',[n.FARM]:'farm',[n.RALLY_POINT]:'rally_point',[n.STATUE]:'statue',[n.WALL]:'wall',[n.TAVERN]:'tavern',[n.BARRACKS]:'barracks',[n.PRECEPTORY]:'preceptory',
[n.HOSPITAL]:'hospital',[n.CLAY_PIT]:'clay_pit',[n.IRON_MINE]:'iron_mine',[n.TIMBER_CAMP]:'timber_camp',[n.CHAPEL]:'chapel',[n.CHURCH]:'church',[n.MARKET]:'market',[n.ACADEMY]:'academy'},E={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},_={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'},f={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',
[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(f,E,T,_);const h={init:function(){g=!0,u=new e({settingsMap:a,storageKey:b}),p=u.getAll(),console.log('all settings',p)},start:function(){m=!0,d.trigger(s.SPY_MASTER_START)},stop:function(){m=!1,d.trigger(s.SPY_MASTER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return h})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,l,r,d,u,p,m){let b,T,E;const _={SPY:'spy',COUNTERMEASURES:'countermeasures',
LOGS:'logs'},f=function(e){b.selectedTab=e},h=function(){T.setAll(T.decode(b.settings)),m.notif('success','Settings saved')},v=function(){t.isRunning()?t.stop():t.start()},w=function(){b.running=!0,E.classList.remove('btn-orange'),E.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},A=function(){b.running=!1,E.classList.remove('btn-red'),E.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},S=function(){b=a.$new(),b.SETTINGS=i,b.TAB_TYPES=_,b.running=t.isRunning(),b.selectedTab=_.SPY,b.settingsMap=n,b.building=u.encodeList(o,{textObject:'spy_master',disabled:!0}),b.unit=u.encodeList(l,{textObject:'spy_master',disabled:!0}),b.dummies=u.encodeList(r,{textObject:'spy_master',disabled:!0}),b.replacement=u.encodeList(d,{textObject:'spy_master',disabled:!0}),T.injectScope(b),b.selectTab=f,b.saveSettings=h,b.switchState=v;let e=new p('twoverflow_spy_master_window',(function(){
console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,w),e.register(s.SPY_MASTER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',b)};return function(){T=t.getSettings(),E=e.addMenuButton('Zwiadowca',130),E.addEventListener('click',S),
...
i=!0}};return c.start=function(){t.trigger(s.SPY_RECRUITER_STARTED),r=!0,setInterval((function(){n.getSelectedCharacter().getVillageList().forEach((function(e){var t=e.data.buildings.tavern.level,a=e.scoutingInfo.spies,i=e.getResources().getComputed(),n=i.wood,s=i.clay,r=i.iron,c=n.currentStock,d=s.currentStock,u=r.currentStock,p=[500,1e3,2200,7e3,12e3],g=[500,800,2e3,6500,1e4],m=[500,1200,2400,8e3,18e3];t<1?console.log('Brak tawerny w wiosce:'+e.getId):t>=1&&t<3?(a.forEach((function(t){1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]&&o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1})})),console.log('spy',1,'from village',e.getId(),'can be recruited')):t>=3&&t<6?a.forEach((function(t){1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),
console.log('spy',1,'from village',e.getId(),'can be recruited')):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]&&(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('spy',2,'from village',e.getId(),'can be recruited'))})):t>=6&&t<9?a.forEach((function(t){3==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',3,'from village',e.getId(),'recruit cancelled'),console.log('spy',1,'from village',e.getId(),'can be recruited')):1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',1,'from village',e.getId(),'can be recruited')):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),
console.log('spy',2,'from village',e.getId(),'can be recruited')):3==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[3]&&d>=g[3]&&u>=m[3]&&(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('spy',3,'from village',e.getId(),'can be recruited'))})):t>=9&&t<12?a.forEach((function(t){4==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',4,'from village',e.getId(),'recruit cancelled'),console.log('spy',1,'from village',e.getId(),'can be recruited')):4==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('spy',4,'from village',e.getId(),'recruit cancelled'),
console.log('spy',2,'from village',e.getId(),'can be recruited')):3==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',3,'from village',e.getId(),'recruit cancelled'),console.log('spy',1,'from village',e.getId(),'can be recruited')):3==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('spy',3,'from village',e.getId(),'recruit cancelled'),console.log('spy',2,'from village',e.getId(),'can be recruited')):1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',1,'from village',e.getId(),'can be recruited')):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]?(o.emit(l.SCOUTING_RECRUIT,{
village_id:e.getId(),slot:2}),console.log('spy',2,'from village',e.getId(),'can be recruited')):3==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[3]&&d>=g[3]&&u>=m[3]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('spy',3,'from village',e.getId(),'can be recruited')):4==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[4]&&d>=g[4]&&u>=m[4]&&(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:4}),console.log('spy',4,'from village',e.getId(),'can be recruited'))})):t>=12&&a.forEach((function(t){5==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',5,'from village',e.getId(),'recruit cancelled'),console.log('spy',1,'from village',e.getId(),'can be recruited')):5==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(l.SCOUTING_RECRUIT,{
village_id:e.getId(),slot:2}),console.log('spy',5,'from village',e.getId(),'recruit cancelled'),console.log('spy',2,'from village',e.getId(),'can be recruited')):4==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',4,'from village',e.getId(),'recruit cancelled'),console.log('spy',1,'from village',e.getId(),'can be recruited')):3==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',3,'from village',e.getId(),'recruit cancelled'),console.log('spy',1,'from village',e.getId(),'can be recruited')):4==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),
console.log('spy',4,'from village',e.getId(),'recruit cancelled'),console.log('spy',2,'from village',e.getId(),'can be recruited')):5==t.id&&1==t.recruitingInProgress&&3==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('spy',5,'from village',e.getId(),'recruit cancelled'),console.log('spy',3,'from village',e.getId(),'can be recruited')):3==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('spy',3,'from village',e.getId(),'recruit cancelled'),console.log('spy',2,'from village',e.getId(),'can be recruited')):4==t.id&&1==t.recruitingInProgress&&3==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('spy',4,'from village',e.getId(),'recruit cancelled'),
console.log('spy',3,'from village',e.getId(),'can be recruited')):5==t.id&&1==t.recruitingInProgress&&4==t.id&&1!=t.active?(o.emit(l.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:4}),console.log('spy',5,'from village',e.getId(),'recruit cancelled'),console.log('spy',4,'from village',e.getId(),'can be recruited')):1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('spy',1,'from village',e.getId(),'can be recruited')):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('spy',2,'from village',e.getId(),'can be recruited')):3==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[3]&&d>=g[3]&&u>=m[3]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),
console.log('spy',3,'from village',e.getId(),'can be recruited')):4==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[4]&&d>=g[4]&&u>=m[4]?(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:4}),console.log('spy',4,'from village',e.getId(),'can be recruited')):5==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[5]&&d>=g[5]&&u>=m[5]&&(o.emit(l.SCOUTING_RECRUIT,{village_id:e.getId(),slot:5}),console.log('spy',5,'from village',e.getId(),'can be recruited'))}))})),e.notif('success',g('i18n')('revived',a.loc.ale,'spy_recruiter'))}),12e4)},c.stop=function(){t.trigger(s.SPY_RECRUITER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/spyRecruiter/events',[],(function(){angular.extend(s,{SPY_RECRUITER_STARTED:'spy_recruiter_started',SPY_RECRUITER_STOPPED:'spy_recruiter_stopped'})})),define('two/spyRecruiter/ui',['two/ui','two/spyRecruiter','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){
return o=e.addMenuButton2('Szpieg',20,g('i18n')('description',a.loc.ale,'spy_recruiter')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'spy_recruiter'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'spy_recruiter')))})),n.register(s.SPY_RECRUITER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.SPY_RECRUITER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.SPY_RECRUITER_STARTED),opener}})),require(['two/ready','two/spyRecruiter','two/spyRecruiter/ui','Lockr','queues/EventQueue','two/spyRecruiter/events'],(function(e,t,a,i,n){const o='spy_recruiter_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.SPY_RECRUITER_STARTED,(function(){i.set(o,!0)})),n.register(s.SPY_RECRUITER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])
}))}))}(this);