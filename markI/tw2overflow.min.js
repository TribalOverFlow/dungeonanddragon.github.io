...
i.get(l,!1,!0)&&t.start(),n.register(s.AUTO_FOUNDATOR_STARTED,(function(){i.set(l,!0)})),n.register(s.AUTO_FOUNDATOR_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let i=!1,r=!1;let c={init:function(){i=!0}};return c.start=function(){t.trigger(s.AUTO_HEALER_STARTED),r=!0,function(){if(!r)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let a=e.hospital.patients.healed;0==a.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){a.forEach((function(t,a){setTimeout((function(){l.emit(o.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*a),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(s.AUTO_HEALER_STOPPED),r=!1},
c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton('Medyk',120,g('i18n')('description',a.loc.ale,'auto_healer')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_healer')))})),n.register(s.AUTO_HEALER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.AUTO_HEALER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_HEALER_STARTED),opener}})),
