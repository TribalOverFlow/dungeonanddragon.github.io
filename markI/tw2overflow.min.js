 ...
 */
!function(e,t){const a=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),i=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),f=function(){},h=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||f,this.listeners=[];const n=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,i){i?this.listeners.push(a.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,r,c,d,u,p,g,m,_,f,h){let b,v,E=!1,w=injector.get('overviewService'),T=[],A=!1,y={},S={},I={reverse:!1,column:n.TIME_COMPLETED};const k='attack_view_filters',x={},R={},M=function(){const e=[c.COMMAND_TYPES],t=i.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let n in y[e[t]])if(a[e[t]]||(a[e[t]]=[]),y[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?a[e[t]].push(r.ATTACK):n===r.SUPPORT?a[e[t]].push(r.SUPPORT):n===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}S=a,S.village=y[c.VILLAGE]?[t]:[]},L=function(){U.loadCommands()},O=function(e,t){h.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},N=function(e,t){
for(let e=0;e<T.length;e++)T[e].command_id===t.command_id&&T.splice(e,1);h.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},C=function(e,t){for(let e=0;e<T.length;e++)T[e].target_village_id===t.village_id?(T[e].target_village_name=t.name,T[e].targetVillage.name=t.name):T[e].origin_village_id===t.village_id&&(T[e].origin_village_name=t.name,T[e].originVillage.name=t.name);h.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},D=function(e,t){S[c.VILLAGE].length&&(S[c.VILLAGE]=[t],U.loadCommands())},P=function(e){const a={x:e.origin_x,y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(i){const o=t.getTravelTime(a,n,{[i]:1},e.command_type,{},!1);return{unit:i,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},z=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(f.hasTownDataInChunk(e.x,e.y)){
const a=f.loadTownData(e.x,e.y,25,25,25),n=i.getSelectedCharacter().getTribeId(),o=i.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=z(r,e);else if(c.length)l=z(c,e);else{if(!n)return t(!1);{const a=s.filter((function(e){return e.tribe_id===n}));if(!a.length)return t(!1);l=z(a,e)}}return t(l[0])}const n=_.scaledGridCoordinates(e.x,e.y,25,25,25);f.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===n.length&&G(e,t)}))},B=function(e){T=e.commands;for(let e=0;e<T.length;e++)w.formatCommand(T[e]),T[e].slowestUnit=P(T[e]);T=T.filter((function(e){return y[c.INCOMING_UNITS][e.slowestUnit]})),h.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[T])};let U={loadCommands:function(){const e=b.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
...
;var _,f,h,b,v,E,w,T,A,y,S,I,k,x,R,M,L,O,N,C,D,P,z,G,B,U,V,q,F,W,j,Y,H,Q,K,Z,X,J,$,ee,te,ae,ne,ie,oe,le,se,re,ce,de,ue,pe,ge,me,_e,fe,he,be,ve,Ee,we,Te,Ae,ye,Se,Ie,ke,xe,Re,Me,Le,Oe,Ne,Ce,De,Pe,ze,Ge,Be,Ue,Ve,qe,Fe,We,je,Ye,He,Qe,Ke,Ze,Xe,Je,$e,et,tt,at,nt,it,ot,lt,st,rt,ct,dt,ut,pt,gt,mt,_t,ft,ht,bt,vt,Et,wt,Tt,At,yt,St,It,kt,xt,Rt,Mt,Lt,Ot,Nt,Ct,Dt,Pt,zt,Gt,Bt,Ut,Vt,qt,Ft,Wt,jt,Yt,Ht,Qt,Kt,Zt,Xt,Jt,$t,ea,ta,aa,na,ia,oa,la,sa,ra,ca,da,ua,pa,ga,ma,_a,fa,ha,ba,va,Ea,wa,Ta,Aa,ya,Sa,Ia,ka,xa,Ra,Ma,La,Oa,Na,Ca,Da,Pa,za,Ga,Ba,Ua,Va,qa,Fa,Wa,ja,Ya,Ha,Qa,Ka,Za,Xa,Ja,$a,en,tn={},an=function(){kt.on('click',(function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],t=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],o=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=parseInt(document.getElementById('archerA').value),s=parseInt(document.getElementById('archerD').value),c=[10,25,45,25,130,150,150,2,100,150,30,30,300],d=parseInt(document.getElementById('axeA').value),u=parseInt(document.getElementById('axeD').value),p=parseInt(document.getElementById('berserkerA').value),m=parseInt(document.getElementById('berserkerD').value),kt=parseInt(document.getElementById('catapultA').value),xt=parseInt(document.getElementById('catapultD').value),Rt=parseInt(document.getElementById('buildingLevel').value),Mt=[1,1,1,1,4,5,6,5,8,1,100,10,6],Lt=parseInt(document.getElementById('hcA').value),Ot=parseInt(document.getElementById('hcD').value),Nt=parseInt(document.getElementById('knightA').value),Ct=parseInt(document.getElementById('knightD').value),Dt=parseInt(document.getElementById('lcA').value),Pt=parseInt(document.getElementById('lcD').value),zt=parseInt(document.getElementById('luck').value),Gt=parseInt(document.getElementById('maA').value),Bt=parseInt(document.getElementById('maD').value),Ut=parseInt(document.getElementById('morale').value),Vt=parseInt(document.getElementById('ramA').value),qt=parseInt(document.getElementById('ramD').value),Ft=parseInt(document.getElementById('snobA').value),Wt=parseInt(document.getElementById('snobD').value),jt=parseInt(document.getElementById('spearA').value),Yt=parseInt(document.getElementById('spearD').value),Ht=parseInt(document.getElementById('swordA').value),Qt=parseInt(document.getElementById('swordD').value),Kt=parseInt(document.getElementById('trebuchetA').value),Zt=parseInt(document.getElementById('trebuchetD').value),Xt=parseInt(document.getElementById('wall').value),Jt=0,$t=0,ya=0,Sa=0,Ia=0,ka=0,xa=0,Ra=0,Ma=0,La=0,Oa=0,Na=0,Ca=0,Da=0,Pa=0,za=0,Ga=0,Ba=0,Ua=0,Va=0,qa=0,Fa=0,Wa=0,ja=0,Ya=0,Ha=0,Qa=0,Ka=0,Za=0,Xa=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,_n=0,fn=0,hn=0,bn=0,vn=0,En=0,wn=0,Tn=0,An=0,yn=0,Sn=0,In=0,kn=0,xn=0,Rn=0,Mn=0,Ln=0,On=0,Nn=0,Cn=0,Dn=0,Pn=0,zn=0,Gn=0,Bn=0,Un=0,Vn=0,qn=0,Fn=0,Wn=0,jn=0,Yn=0,Hn=0,Qn=0,Kn=0,Zn=0,Xn=0,Jn=0,$n=0,ei=0,ti=0,ai=0,ni=0,ii=0,oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,_i=0,fi=0,hi=0,bi=0,vi=0,Ei=0,wi=[1,1],Ti=[1,1],Ai=[1,1],yi=[1,1],Si=[1,1],Ii=[1,1],ki=[1,1],xi=[1,1],Ri=[1,1],Mi=[1,1],Li=[1,1],Oi=[1,1],Ni=[1,1],Ci=[1,1],Di=[1,1],Pi=[1,1],zi=[1,1],Gi=[1,1],Bi=[1,1],Ui=[1,1],Vi=[1,1],qi=[1,1],Fi=[1,1],Wi=[1,1],ji=[1,1],Yi=[1,1],Hi=[1,1],Qi=[1,1],Ki=[1,1],Zi=[1,1],Xi=[1,1],Ji=[1,1],$i=[1,1],eo=[1,1],to=[1,1],ao=[1,1],no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,_o=0,fo=0,ho=0,bo=0,vo=0,Eo=0,wo=0,To=0,Ao=0,yo=0,So=0,Io=0,ko=0,xo=0,Ro=0,Mo=0,Lo=0,Oo=0,No=0,Co=0,Do=0,Po=0,zo=0,Go=0,Bo=0,Uo=[1,1],Vo=0,qo=0,Fo=0,Wo=0,jo=0,Yo=0,Ho=0,Qo=0,Ko=0,Zo=0,Xo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,_l=0,fl=0,hl=0,bl=0,vl=0,El=0,wl=0,Tl=0,Al=0,yl=0,Sl=0,Il=0,kl=0,xl=0,Rl=0,Ml=[1,1],Ll=[1,1],Ol=[1,1],Nl=[1,1],Cl=[1,1],Dl=[1,1],Pl=[1,1],zl=[1,1],Gl=[1,1],Bl=0,Ul=0,Vl=0,ql=0,Fl=0,Wl=0,jl=0,Yl=0,Hl=0,Ql=0,Kl=0,Zl=0,Xl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,_s=0,fs=0,hs=0,bs=0,vs=0,Es=0,ws=0,Ts=0,As=0,ys=0,Ss=0,Is=0,ks=0,xs=0,Rs=0,Ms=0,Ls=0,Os=0,Ns=0,Cs=0,Ds=0,Ps=0,zs=0,Gs=0,Bs=0,Us=0,Vs=0,qs=0,Fs=0,Ws=0,js=0,Ys=0,Hs=0,Qs=0,Ks=0,Zs=0,Xs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,_r=0,fr=0,hr=0,br=0,vr=0,Er=0,wr=1,Tr=0,Ar=0,yr=0,Sr=0,Ir=0,kr=0,xr=0,Rr=0,Mr=0,Lr=0,Or=0,Nr=0,Cr=0,Dr=0,Pr=0,zr=0,Gr=0,Br=0,Ur=0,Vr=0,qr=0,Fr=0,Wr=0,jr=0,Yr=0,Hr=0,Qr=0,Kr=0,Zr=0,Xr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,_c=0,fc=0,hc=0,bc=0,vc=0,Ec=0,wc=0,Tc=0,Ac=0,yc=0,Sc=0,Ic=0,kc=0,xc=0,Rc=0,Mc=0,Lc=0,Oc=0,Nc=0,Cc=0,Dc=0,Pc=0,zc=0,Gc=0,Bc=0,Uc=0,Vc=0,qc=0,Fc=0,Wc=0,jc=0,Yc=0,Hc=0,Qc=0,Kc=0,Zc=0,Xc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,_d=0,fd=0,hd=0,bd=0,vd=0,Ed=0,wd=0,Td=0,Ad=0,yd=0,Sd=0,Id=0,kd=0,xd=0,Rd=0,Md=0,Ld=0,Od=0,Nd=0,Cd=0,Dd=0,Pd=0,zd=0,Gd=0,Bd=0,Ud=0,Vd=0,qd=0,Fd=0,Wd=0,jd=0,Yd=0,Hd=0,Qd=0,Kd=0,Zd=0,Xd=0,Jd=0,$d=0,eu=0,tu=0,au=0,nu=0,iu=0,ou=0,lu=0,su=0,ru=0,cu=0,du=0,uu=0,pu=0,gu=0,mu=0,_u=0,fu=0,hu=0,bu=0,vu=0,Eu=0,wu=0,Tu=0,Au=0,yu=0,Su=0,Iu=0,ku=0,xu=0,Ru=0,Mu=0,Lu=0,Ou=0,Nu=0,Cu=0,Du=0,Pu=0,zu=0,Gu=0,Bu=0,Uu=0,Vu=0,qu=0,Fu=0,Wu=0,ju=0,Yu=0,Hu=0,Qu=0,Ku=0,Zu=0,Xu=0,Ju=0,$u=0,ep=0,tp=0,ap=0,np=0,ip=0,op=0,lp=0,sp=0,rp=0,cp=0,dp=0,up=0,pp=0,gp=0,mp=0,_p=0,fp=0,hp=0,bp=0,vp=0,Ep=0,wp=0,Tp=0,Ap=0,yp=0,Sp=0,Ip=0,kp=0,xp=0,Rp=0,Mp=0,Lp=0,Op=0,Np=0,Cp=0,Dp=0,Pp=0,zp=0,Gp=0,Bp=0,Up=0,Vp=0,qp=0,Fp=0,Wp=0,jp=0,Yp=0,Hp=0,Qp=0,Kp=0,Zp=0
;io=parseInt(ea[0].dataset.value),oo=parseInt(ta[0].dataset.value),wr=document.getElementById('settings-nightBonus').checked?2:1,ks=document.getElementById('settings-officerLeader').checked?.1:0,vr=document.getElementById('settings-officerMedic').checked?.1:0,Nc=document.getElementById('settings-skillMedic').checked?.1:0,Lc=parseInt(aa[0].dataset.value),Cc=parseInt(na[0].dataset.value),Oc=parseInt(ia[0].dataset.value),Do=parseInt(oa[0].dataset.value),bi=la[0].dataset.value,Rp=la[0].dataset.name,Po=sa[0].dataset.value,zo=ra[0].dataset.value,Go=ca[0].dataset.value,Bo=da[0].dataset.value,xs=parseInt(ua[0].dataset.value),Rs=parseInt(pa[0].dataset.value),Ms=parseInt(ga[0].dataset.value),Ls=parseInt(ma[0].dataset.value),Ii='axe'==Po&1==xs?[1.05,1.1]:'axe'==Po&2==xs?[1.1,1.2]:'axe'==Po&3==xs?[1.2,1.3]:[1,1],qi='ma'==Po&1==xs?[1.05,1.1]:'ma'==Po&2==xs?[1.1,1.2]:'ma'==Po&3==xs?[1.2,1.3]:[1,1],Zi='spear'==Po&1==xs?[1.1,1.05]:'spear'==Po&2==xs?[1.2,1.1]:'spear'==Po&3==xs?[1.3,1.2]:[1,1],
eo='sword'==Po&1==xs?[1.1,1.05]:'sword'==Po&2==xs?[1.2,1.1]:'sword'==Po&3==xs?[1.3,1.2]:[1,1],Ti='archer'==Po&1==xs?[1.1,1.05]:'archer'==Po&2==xs?[1.2,1.1]:'archer'==Po&3==xs?[1.3,1.2]:[1,1],Ci='hc'==Po&1==xs?[1.1,1.1]:'hc'==Po&2==xs?[1.2,1.2]:'hc'==Po&3==xs?[1.3,1.3]:[1,1],Yi='ram'==Po&1==xs?[1.05,1.25]:'ram'==Po&2==xs?[1.1,1.5]:'ram'==Po&3==xs?[1.2,2]:[1,1],Mi='catapult'==Po&1==xs?[1.05,1.25]:'catapult'==Po&2==xs?[1.1,1.5]:'catapult'==Po&3==xs?[1.2,2]:[1,1],ki='axe'==zo&1==Rs?[1.05,1.1]:'axe'==zo&2==Rs?[1.1,1.2]:'axe'==zo&3==Rs?[1.2,1.3]:[1,1],Fi='ma'==zo&1==Rs?[1.05,1.1]:'ma'==zo&2==Rs?[1.1,1.2]:'ma'==zo&3==Rs?[1.2,1.3]:[1,1],Xi='spear'==zo&1==Rs?[1.1,1.05]:'spear'==zo&2==Rs?[1.2,1.1]:'spear'==zo&3==Rs?[1.3,1.2]:[1,1],to='sword'==zo&1==Rs?[1.1,1.05]:'sword'==zo&2==Rs?[1.2,1.1]:'sword'==zo&3==Rs?[1.3,1.2]:[1,1],Ai='archer'==zo&1==Rs?[1.1,1.05]:'archer'==zo&2==Rs?[1.2,1.1]:'archer'==zo&3==Rs?[1.3,1.2]:[1,1],
Di='hc'==zo&1==Rs?[1.1,1.1]:'hc'==zo&2==Rs?[1.2,1.2]:'hc'==zo&3==Rs?[1.3,1.3]:[1,1],Hi='ram'==zo&1==Rs?[1.05,1.25]:'ram'==zo&2==Rs?[1.1,1.5]:'ram'==zo&3==Rs?[1.2,2]:[1,1],Li='catapult'==zo&1==Rs?[1.05,1.25]:'catapult'==zo&2==Rs?[1.1,1.5]:'catapult'==zo&3==Rs?[1.2,2]:[1,1],Ui='lc'==Go&1==Ms?[1.05,1.1]:'lc'==Go&2==Ms?[1.1,1.2]:'lc'==Go&3==Ms?[1.2,1.3]:[1,1],xi='axe'==Go&1==Ms?[1.05,1.1]:'axe'==Go&2==Ms?[1.1,1.2]:'axe'==Go&3==Ms?[1.2,1.3]:[1,1],Wi='ma'==Go&1==Ms?[1.05,1.1]:'ma'==Go&2==Ms?[1.1,1.2]:'ma'==Go&3==Ms?[1.2,1.3]:[1,1],Ji='spear'==Go&1==Ms?[1.1,1.05]:'spear'==Go&2==Ms?[1.2,1.1]:'spear'==Go&3==Ms?[1.3,1.2]:[1,1],ao='sword'==Go&1==Ms?[1.1,1.05]:'sword'==Go&2==Ms?[1.2,1.1]:'sword'==Go&3==Ms?[1.3,1.2]:[1,1],yi='archer'==Go&1==Ms?[1.1,1.05]:'archer'==Go&2==Ms?[1.2,1.1]:'archer'==Go&3==Ms?[1.3,1.2]:[1,1],Pi='hc'==Go&1==Ms?[1.1,1.1]:'hc'==Go&2==Ms?[1.2,1.2]:'hc'==Go&3==Ms?[1.3,1.3]:[1,1],Qi='ram'==Go&1==Ms?[1.05,1.25]:'ram'==Go&2==Ms?[1.1,1.5]:'ram'==Go&3==Ms?[1.2,2]:[1,1],
Oi='catapult'==Go&1==Ms?[1.05,1.25]:'catapult'==Go&2==Ms?[1.1,1.5]:'catapult'==Go&3==Ms?[1.2,2]:[1,1],zi=(Gi='lc'==Po&1==xs?[1.05,1.1]:'lc'==Po&2==xs?[1.1,1.2]:'lc'==Po&3==xs?[1.2,1.3]:[1,1])[0]>=(Bi='lc'==zo&1==Rs?[1.05,1.1]:'lc'==zo&2==Rs?[1.1,1.2]:'lc'==zo&3==Rs?[1.2,1.3]:[1,1])[0]&&Gi[0]>=Ui[0]?Gi:Bi[0]>=Gi[0]&&Bi[0]>=Ui[0]?Bi:Ui[0]>=Gi[0]&&Ui[0]>=Bi[0]?Ui:[1,1],Si=Ii[0]>=ki[0]&&Ii[0]>=xi[0]?Ii:ki[0]>=Ii[0]&&ki[0]>=xi[0]?ki:xi[0]>=Ii[0]&&xi[0]>=ki[0]?xi:[1,1],Vi=qi[0]>=Fi[0]&&qi[0]>=Wi[0]?qi:Fi[0]>=qi[0]&&Fi[0]>=Wi[0]?Fi:Wi[0]>=qi[0]&&Wi[0]>=Fi[0]?Wi:[1,1],Ni=Ci[0]>=Di[0]&&Ci[0]>=Pi[0]?Ci:Di[0]>=Ci[0]&&Di[0]>=Pi[0]?Di:Pi[0]>=Ci[0]&&Pi[0]>=Di[0]?Pi:[1,1],ji=Yi[0]>=Hi[0]&&Yi[0]>=Qi[0]?Yi:Hi[0]>=Yi[0]&&Hi[0]>=Qi[0]?Hi:Qi[0]>=Yi[0]&&Qi[0]>=Hi[0]?Qi:[1,1],Ri=Mi[0]>=Li[0]&&Mi[0]>=Oi[0]?Mi:Li[0]>=Mi[0]&&Li[0]>=Oi[0]?Li:Oi[0]>=Mi[0]&&Oi[0]>=Li[0]?Oi:[1,1],Ki=Zi[0]>=Xi[0]&&Zi[0]>=Ji[0]?Zi:Xi[0]>=Zi[0]&&Xi[0]>=Ji[0]?Xi:Ji[0]>=Zi[0]&&Ji[0]>=Xi[0]?Ji:[1,1],
$i=eo[0]>=to[0]&&eo[0]>=ao[0]?eo:to[0]>=eo[0]&&to[0]>=ao[0]?to:ao[0]>=eo[0]&&ao[0]>=to[0]?ao:[1,1],wi=Ti[0]>=Ai[0]&&Ti[0]>=yi[0]?Ti:Ai[0]>=Ti[0]&&Ai[0]>=yi[0]?Ai:yi[0]>=Ti[0]&&yi[0]>=Ai[0]?yi:[1,1],Cl='lc'==Bo&1==Ls?[1.05,1.1]:'lc'==Bo&2==Ls?[1.1,1.2]:'lc'==Bo&3==Ls?[1.2,1.3]:[1,1],Ll='axe'==Bo&1==Ls?[1.05,1.1]:'axe'==Bo&2==Ls?[1.1,1.2]:'axe'==Bo&3==Ls?[1.2,1.3]:[1,1],Dl='ma'==Bo&1==Ls?[1.05,1.1]:'ma'==Bo&2==Ls?[1.1,1.2]:'ma'==Bo&3==Ls?[1.2,1.3]:[1,1],zl='spear'==Bo&1==Ls?[1.1,1.05]:'spear'==Bo&2==Ls?[1.2,1.1]:'spear'==Bo&3==Ls?[1.3,1.2]:[1,1],Gl='sword'==Bo&1==Ls?[1.1,1.05]:'sword'==Bo&2==Ls?[1.2,1.1]:'sword'==Bo&3==Ls?[1.3,1.2]:[1,1],Ml='archer'==Bo&1==Ls?[1.1,1.05]:'archer'==Bo&2==Ls?[1.2,1.1]:'archer'==Bo&3==Ls?[1.3,1.2]:[1,1],Nl='hc'==Bo&1==Ls?[1.1,1.1]:'hc'==Bo&2==Ls?[1.2,1.2]:'hc'==Bo&3==Ls?[1.3,1.3]:[1,1],Pl='ram'==Bo&1==Ls?[1.05,1.25]:'ram'==Bo&2==Ls?[1.1,1.5]:'ram'==Bo&3==Ls?[1.2,2]:[1,1],
Ol='catapult'==Bo&1==Ls?[1.05,1.25]:'catapult'==Bo&2==Ls?[1.1,1.5]:'catapult'==Bo&3==Ls?[1.2,2]:[1,1],Qa=jt*Mt[0]+Ht*Mt[1]+d*Mt[2]+l*Mt[3]+Dt*Mt[4]+Gt*Mt[5]+Lt*Mt[6]+Vt*Mt[7]+kt*Mt[8]+Nt*Mt[9]+Ft*Mt[10]+Kt*Mt[11]+p*Mt[12],vi=Yt*Mt[0]+Qt*Mt[1]+u*Mt[2]+s*Mt[3]+Pt*Mt[4]+Bt*Mt[5]+Ot*Mt[6]+qt*Mt[7]+xt*Mt[8]+Ct*Mt[9]+Wt*Mt[10]+Zt*Mt[11]+m*Mt[12],no=2*Qa<=vi?2:1,Tr=Qa-5*Vt,Sr=0==Xt?0:Math.round(20*Math.pow(1.2515,Xt-1)),Ei=vi+(Sr+100*Wt),Zr=0==Tr||0==Ei?0:Tr/Ei>1?1:Tr/Ei,Er=Ut/100,Ks=zt/100,yr=Math.round(1e3*(io/100*Er*(1+Ks)+Lc/100+ks))/1e3,Ep=kt/(vp=Vt+kt),wp=Vt/vp,Xu=Math.round(Zt*Ep),mp=Math.round(Zt*wp),Tc=(yc=Vt-(0==Vt?0:Vt<mp?Vt:mp))*Zr*yr*(Uo='ram'==Bo?1==Ls?[1.05,1.25]:2==Ls?[1.1,1.5]:3==Ls?[1.2,2]:[1,1]:[1,1])[1],No=20==Xt?18:19==Xt?17:18==Xt?15:17==Xt?14:16==Xt?13:15==Xt?11:14==Xt?10:13==Xt||12==Xt?9:11==Xt?8:10==Xt?7:9==Xt||8==Xt?6:7==Xt||6==Xt?5:5==Xt||4==Xt||3==Xt?4:2==Xt||1==Xt?3:0,hp=0==Xt?0:2*No,_p=0==Xt?0:Tc/hp,bp=Xt<=Cc?Xt:Xt-Cc<_p?Xt<Cc?Xt:Cc:Xt-_p,wn=Math.round(bp),
En=Math.round(.05*wn*1e3)/1e3,Ar=Math.round(oo/100*(1+En)*wr*1e3)/1e3,hi=kt-(0==kt?0:kt<Xu?kt:Xu),vn=0==(fp=Math.round(bp))?0:Math.round(20*Math.pow(1.2515,fp-1)),ns=jt+Ht+d+p>Dt+Lt&&jt+Ht+d+p>l+Gt?'inf':Dt+Lt>jt+Ht+d+p&&Dt+Lt>l+Gt?'cav':'arc',Dr=jt*Mt[0]+Ht*Mt[1]+d*Mt[2]+l*Mt[3]+Dt*Mt[4]+Gt*Mt[5]+Lt*Mt[6]+yc*Mt[7]+hi*Mt[8]+Nt*Mt[9]+Ft*Mt[10]+Kt*Mt[11]+p*Mt[12],Hr=Yt*Mt[0]+Qt*Mt[1]+u*Mt[2]+s*Mt[3]+Pt*Mt[4]+Bt*Mt[5]+Ot*Mt[6]+qt*Mt[7]+xt*Mt[8]+Ct*Mt[9]+Wt*Mt[10]+Zt*Mt[11]+m*Mt[12],console.log('provisionDefenderRound1Total'+Hr),Ic=yc*Mt[7]+hi*Mt[8]+Kt*Mt[11]+Nt*Mt[9]+Ft*Mt[10],'cav'==ns?(Rr=Dt*Mt[4]+Lt*Mt[6]+Ic,Or=jt*Mt[0]+Ht*Mt[1]+d*Mt[2]+p*Mt[12],Ir=l*Mt[3]+Gt*Mt[5]):'inf'==ns?(Or=jt*Mt[0]+Ht*Mt[1]+d*Mt[2]+p*Mt[12]+Ic,Rr=Dt*Mt[4]+Lt*Mt[6],Ir=l*Mt[3]+Gt*Mt[5]):'arc'==ns?(Or=jt*Mt[0]+Ht*Mt[1]+d*Mt[2]+p*Mt[12],Rr=Dt*Mt[4]+Lt*Mt[6],Ir=l*Mt[3]+Gt*Mt[5]+Ic):(Or=jt*Mt[0]+Ht*Mt[1]+d*Mt[2]+p*Mt[12],Rr=Dt*Mt[4]+Lt*Mt[6],Ir=l*Mt[3]+Gt*Mt[5]),Us=0==Or?0:Math.round(Or/Dr*1e4)/1e4,
Bs=0==Rr?0:Math.round(Rr/Dr*1e4)/1e4,0==Ir?(Gs=0,console.log('lossesPercentRound1Arc'+Gs)):(Gs=Math.round(Ir/Dr*1e4)/1e4,console.log('lossesPercentRound1Arc'+Gs)),bd=Math.round(Yt*Us),hd=Math.round(Yt*Bs),fd=Yt-hd-bd,Du=Math.round(Qt*Us),Cu=Math.round(Qt*Bs),Nu=Qt-Cu-Du,dn=Math.round(u*Us),cn=Math.round(u*Bs),rn=u-cn-dn,Ga=Math.round(s*Us),za=Math.round(s*Bs),Pa=s-za-Ga,bs=Math.round(Pt*Us),hs=Math.round(Pt*Bs),fs=Pt-hs-bs,dr=Math.round(Bt*Us),cr=Math.round(Bt*Bs),rr=Bt-cr-dr,Ao=Math.round(Ot*Us),To=Math.round(Ot*Bs),wo=Ot-To-Ao,uc=Math.round(qt*Us),dc=Math.round(qt*Bs),cc=qt-dc-uc,oi=Math.round(xt*Us),ii=Math.round(xt*Bs),ni=xt-ii-oi,Kc=Math.round(Wt*Us),Qc=Math.round(Wt*Bs),Hc=Wt-Qc-Kc,op=Math.round(Zt*Us),ip=Math.round(Zt*Bs),np=Zt-ip-op,Pn=Math.round(m*Us),Dn=Math.round(m*Bs),Cn=m-Dn-Pn,wl=Math.round(Ct*Us),El=Math.round(Ct*Bs),vl=Ct-El-wl,Wr=bd*Mt[0]+Du*Mt[1]+dn*Mt[2]+Pn*Mt[12]+Kc*Mt[10]+bs*Mt[4]+Ao*Mt[6]+Ga*Mt[3]+dr*Mt[5]+uc*Mt[7]+oi*Mt[8]+op*Mt[11]+wl*Mt[9],
console.log('provisionDefenderInfRound1'+Wr),Vr=hd*Mt[0]+Cu*Mt[1]+cn*Mt[2]+Dn*Mt[12]+Qc*Mt[10]+hs*Mt[4]+To*Mt[6]+za*Mt[3]+cr*Mt[5]+dc*Mt[7]+ii*Mt[8]+ip*Mt[11]+El*Mt[9],console.log('provisionDefenderCavRound1'+Vr),Gr=fd*Mt[0]+Nu*Mt[1]+rn*Mt[2]+Cn*Mt[12]+Hc*Mt[10]+fs*Mt[4]+wo*Mt[6]+Pa*Mt[3]+rr*Mt[5]+cc*Mt[7]+ni*Mt[8]+np*Mt[11]+vl*Mt[9],console.log('provisionDefenderArcRound1'+Gr),eu=bd*n[0]*Ki[0]+Du*n[1]*$i[0]+dn*n[2]*Si[0]+Pn*n[12]+Kc*n[10]+bs*n[4]*zi[0]+Ao*n[6]*Ni[0]+Ga*n[3]*wi[0]+dr*n[5]*Vi[0]+uc*n[7]*ji[0]+oi*n[8]*Ri[0]+op*n[11]+wl*n[9],Xd=hd*i[0]*Ki[0]+Cu*i[1]*$i[0]+cn*i[2]*Si[0]+Dn*i[12]+Qc*i[10]+hs*i[4]*zi[0]+To*i[6]*Ni[0]+za*i[3]*wi[0]+cr*i[5]*Vi[0]+dc*i[7]*ji[0]+ii*i[8]*Ri[0]+ip*i[11]+El*i[9],Qd=fd*o[0]*Ki[0]+Nu*o[1]*$i[0]+rn*o[2]*Si[0]+Cn*o[12]+Hc*o[10]+fs*o[4]*zi[0]+wo*o[6]*Ni[0]+Pa*o[3]*wi[0]+rr*o[5]*Vi[0]+cc*o[7]*ji[0]+ni*o[8]*Ri[0]+np*o[11]+vl*o[9],Rc=yc*c[7]*Pl[1]+hi*c[8]*Ol[1]+Kt*c[11]+Nt*c[9]+Ft*c[10],'cav'==ns?(qd=Dt*c[4]*Cl[1]+Lt*c[6]*Nl[1]+Rc,
jd=jt*c[0]*zl[1]+Ht*c[1]*Gl[1]+d*c[2]*Ll[1]+p*c[12]*no,Bd=l*c[3]*Ml[1]+Gt*c[5]*Dl[1]):'inf'==ns?(jd=jt*c[0]*zl[1]+Ht*c[1]*Gl[1]+d*c[2]*Ll[1]+p*c[12]*no+Rc,qd=Dt*c[4]*Cl[1]+Lt*c[6]*Nl[1],Bd=l*c[3]*Ml[1]+Gt*c[5]*Dl[1]):'arc'==ns?(jd=jt*c[0]*zl[1]+Ht*c[1]*Gl[1]+d*c[2]*Ll[1]+p*c[12]*no,qd=Dt*c[4]*Cl[1]+Lt*c[6]*Nl[1],Bd=l*c[3]*Ml[1]+Gt*c[5]*Dl[1]+Rc):(jd=jt*c[0]*zl[1]+Ht*c[1]*Gl[1]+d*c[2]*Ll[1]+p*c[12]*no,qd=Dt*c[4]*Cl[1]+Lt*c[6]*Nl[1],Bd=l*c[3]*Ml[1]+Gt*c[5]*Dl[1]),Pd=(Nd=jd*yr)+(Md=qd*yr)+(kd=Bd*yr),pu=(cu=eu*Ar+vn)+(lu=Xd*Ar+vn)+(nu=Qd*Ar+vn),as=0==Nd||0==cu?0:cu<=Nd?1:Math.pow(Nd/cu,.5)/(cu/Nd),ts=0==Md||0==lu?0:lu<=Md?1:Math.pow(Md/lu,.5)/(lu/Md),es=0==kd||0==nu?0:nu<=kd?1:Math.pow(kd/nu,.5)/(nu/kd),$l=0==Nd||0==cu?0:Nd<=cu?1:Math.pow(cu/Nd,.5)/(Nd/cu),Jl=0==Md||0==lu?0:Md<=lu?1:Math.pow(lu/Md,.5)/(Md/lu),Xl=0==kd||0==nu?0:kd<=nu?1:Math.pow(nu/kd,.5)/(kd/nu),Fo=Math.round(1e6*$l)/1e6,qo=Math.round(1e6*Jl)/1e6,Vo=Math.round(1e6*Xl)/1e6,Yo=Math.round(1e6*as)/1e6,
jo=Math.round(1e6*ts)/1e6,Wo=Math.round(1e6*es)/1e6,pd=Math.round(-bd*Yo+1e-6)+Math.round(-hd*jo+1e-6)+Math.round(-fd*Wo+1e-6),Ru=Math.round(-Du*Yo+1e-6)+Math.round(-Cu*jo+1e-6)+Math.round(-Nu*Wo+1e-6),nn=Math.round(-dn*Yo+1e-6)+Math.round(-cn*jo+1e-6)+Math.round(-rn*Wo+1e-6),Oa=Math.round(-Ga*Yo+1e-6)+Math.round(-za*jo+1e-6)+Math.round(-Pa*Wo+1e-6),ps=Math.round(-bs*Yo+1e-6)+Math.round(-hs*jo+1e-6)+Math.round(-fs*Wo+1e-6),ir=Math.round(-dr*Yo+1e-6)+Math.round(-cr*jo+1e-6)+Math.round(-rr*Wo+1e-6),ho=Math.round(-Ao*Yo+1e-6)+Math.round(-To*jo+1e-6)+Math.round(-wo*Wo+1e-6),oc=Math.round(-uc*Yo+1e-6)+Math.round(-dc*jo+1e-6)+Math.round(-cc*Wo+1e-6),$n=Math.round(-oi*Yo+1e-6)+Math.round(-ii*jo+1e-6)+Math.round(-ni*Wo+1e-6),$u=Math.round(-op*Yo+1e-6)+Math.round(-ip*jo+1e-6)+Math.round(-np*Wo+1e-6),Mn=Math.round(-Pn*Yo+1e-6)+Math.round(-Dn*jo+1e-6)+Math.round(-Cn*Wo+1e-6),_l=Math.round(-wl*Yo+1e-6)+Math.round(-El*jo+1e-6)+Math.round(-vl*Wo+1e-6),
Fc=Math.round(-Kc*Yo+1e-6)+Math.round(-Qc*jo+1e-6)+Math.round(-Hc*Wo+1e-6),od=Math.round(-jt*Fo+1e-6),Tu=Math.round(-Ht*Fo+1e-6),Za=Math.round(-d*Fo+1e-6),An=Math.round(-p*Fo+1e-6),Sa=Math.round(-l*Vo+1e-6),Xs=Math.round(-Gt*Vo+1e-6),os=Math.round(-Dt*qo+1e-6),co=Math.round(-Lt*qo+1e-6),'cav'==ns?(Jr=Math.round(-yc*qo+1e-6),Yn=Math.round(-hi*qo+1e-6),ju=Math.round(-Kt*qo+1e-6),rl=Math.round(-Nt*qo+1e-6),Pc=Math.round(-Ft*qo+1e-6)):'inf'==ns?(Jr=Math.round(-yc*Fo+1e-6),Yn=Math.round(-hi*Fo+1e-6),ju=Math.round(-Kt*Fo+1e-6),rl=Math.round(-Nt*Fo+1e-6),Pc=Math.round(-Ft*Fo+1e-6)):'arc'==ns&&(Jr=Math.round(-yc*Vo+1e-6),Yn=Math.round(-hi*Vo+1e-6),ju=Math.round(-Kt*Vo+1e-6),rl=Math.round(-Nt*Vo+1e-6),Pc=Math.round(-Ft*Vo+1e-6)),rd=jt+od,Su=Ht+Tu,$a=d+Za,xa=l+Sa,rs=Dt+os,er=Gt+Xs,go=Lt+co,tc=yc+Jr,Kn=hi+Yn,Qu=Kt+ju,In=p+An,Bc=Ft+Pc,ul=Nt+rl,_d=Yt+pd,Ou=Qt+Ru,sn=u+nn,Da=s+Oa,_s=Pt+ps,sr=Bt+ir,Eo=Ot+ho,rc=qt+oc,ai=xt+$n,ap=Zt+$u,Nn=m+Mn,Yc=Wt+Fc,bl=Ct+_l,
Os=od*Mt[0]+Tu*Mt[1]+Za*Mt[2]+Sa*Mt[3]+os*Mt[4]+Xs*Mt[5]+co*Mt[6]+Jr*Mt[7]+Yn*Mt[8]+rl*Mt[9]+Pc*Mt[10]+ju*Mt[11]+An*Mt[12],console.log('lossesAttackerRound1Total'+Os),Ds=pd*Mt[0]+Ru*Mt[1]+nn*Mt[2]+Oa*Mt[3]+ps*Mt[4]+ir*Mt[5]+ho*Mt[6]+oc*Mt[7]+$n*Mt[8]+_l*Mt[9]+Fc*Mt[10]+$u*Mt[11]+Mn*Mt[12],console.log('lossesDefenderRound1Total'+Ds),_u=rd*Mt[0]+Su*Mt[1]+$a*Mt[2]+xa*Mt[3]+rs*Mt[4]+er*Mt[5]+go*Mt[6]+tc*Mt[7]+Kn*Mt[8]+Qu*Mt[11]+In*Mt[12]+Bc*Mt[10]+ul*Mt[9],console.log('survivorsAttackerRound1Total'+_u),bu=_d*Mt[0]+Ou*Mt[1]+sn*Mt[2]+Da*Mt[3]+_s*Mt[4]+sr*Mt[5]+Eo*Mt[6]+rc*Mt[7]+ai*Mt[8]+ap*Mt[11]+Nn*Mt[12]+Yc*Mt[10]+bl*Mt[9],console.log('survivorsDefenderRound1Total'+bu),0==Pd||0==pu?(Ha=0,console.log('armyLossesPercentEachRound'+Ha)):pu<=Pd?(Ha=1,console.log('armyLossesPercentEachRound'+Ha)):(Ha=Math.pow(Pd/pu,.5/(pu/Pd)),console.log('armyLossesPercentEachRound'+Ha)),Pr=rd*Mt[0]+Su*Mt[1]+$a*Mt[2]+xa*Mt[3]+rs*Mt[4]+er*Mt[5]+go*Mt[6]+tc*Mt[7]+Kn*Mt[8]+ul*Mt[9]+Bc*Mt[10]+Qu*Mt[11]+In*Mt[12],
Qr=_d*Mt[0]+Ou*Mt[1]+sn*Mt[2]+Da*Mt[3]+_s*Mt[4]+sr*Mt[5]+Eo*Mt[6]+rc*Mt[7]+ai*Mt[8]+bl*Mt[9]+Yc*Mt[10]+ap*Mt[11]+Nn*Mt[12],console.log('provisionDefenderRound2Total'+Qr),kc=tc*Mt[7]+Kn*Mt[8]+Qu*Mt[11]+ul*Mt[9],'cav'==ns?(Mr=rs*Mt[4]+go*Mt[6]+kc,Nr=rd*Mt[0]+Su*Mt[1]+$a*Mt[2]+In*Mt[12]+Bc*Mt[10],kr=xa*Mt[3]+er*Mt[5]):'inf'==ns?(Nr=rd*Mt[0]+Su*Mt[1]+$a*Mt[2]+In*Mt[12]+Bc*Mt[10]+kc,Mr=rs*Mt[4]+go*Mt[6],kr=xa*Mt[3]+er*Mt[5]):'arc'==ns?(Nr=rd*Mt[0]+Su*Mt[1]+$a*Mt[2]+In*Mt[12]+Bc*Mt[10],Mr=rs*Mt[4]+go*Mt[6],kr=xa*Mt[3]+er*Mt[5]+kc):(Nr=rd*Mt[0]+Su*Mt[1]+$a*Mt[2]+In*Mt[12]+Bc*Mt[10],Mr=rs*Mt[4]+go*Mt[6],kr=xa*Mt[3]+er*Mt[5]),Fs=0==Nr?0:Math.round(Nr/Pr*1e4)/1e4,qs=0==Mr?0:Math.round(Mr/Pr*1e4)/1e4,0==kr?(Vs=0,console.log('lossesPercentRound2Arc'+Vs)):(Vs=Math.round(kr/Pr*1e4)/1e4,console.log('lossesPercentRound2Arc'+Vs)),Td=Math.round(_d*Fs),wd=Math.round(_d*qs),Ed=_d-wd-Td,Bu=Math.round(Ou*Fs),Gu=Math.round(Ou*qs),zu=Ou-Gu-Bu,mn=Math.round(sn*Fs),gn=Math.round(sn*qs),pn=sn-gn-mn,
qa=Math.round(Da*Fs),Va=Math.round(Da*qs),Ua=Da-Va-qa,Ts=Math.round(_s*Fs),ws=Math.round(_s*qs),Es=_s-ws-Ts,mr=Math.round(sr*Fs),gr=Math.round(sr*qs),pr=sr-gr-mr,ko=Math.round(Eo*Fs),Io=Math.round(Eo*qs),So=Eo-Io-ko,_c=Math.round(rc*Fs),mc=Math.round(rc*qs),gc=rc-mc-_c,ci=Math.round(ai*Fs),ri=Math.round(ai*qs),si=ai-ri-ci,$c=Math.round(Yc*Fs),Jc=Math.round(Yc*qs),Xc=Yc-Jc-$c,cp=Math.round(ap*Fs),rp=Math.round(ap*qs),sp=ap-rp-cp,Un=Math.round(Nn*Fs),Bn=Math.round(Nn*qs),Gn=Nn-Bn-Un,Sl=Math.round(bl*Fs),yl=Math.round(bl*qs),Al=bl-yl-Sl,jr=Td*Mt[0]+Bu*Mt[1]+mn*Mt[2]+Un*Mt[12]+$c*Mt[10]+Ts*Mt[4]+ko*Mt[6]+qa*Mt[3]+mr*Mt[5]+_c*Mt[7]+ci*Mt[8]+cp*Mt[11]+Sl*Mt[9],console.log('provisionDefenderInfRound2'+jr),qr=wd*Mt[0]+Gu*Mt[1]+gn*Mt[2]+Bn*Mt[12]+Jc*Mt[10]+ws*Mt[4]+Io*Mt[6]+Va*Mt[3]+gr*Mt[5]+mc*Mt[7]+ri*Mt[8]+rp*Mt[11]+yl*Mt[9],console.log('provisionDefenderCavRound2'+qr),Br=Ed*Mt[0]+zu*Mt[1]+pn*Mt[2]+Gn*Mt[12]+Xc*Mt[10]+Es*Mt[4]+So*Mt[6]+Ua*Mt[3]+pr*Mt[5]+gc*Mt[7]+si*Mt[8]+sp*Mt[11]+Al*Mt[9],
console.log('provisionDefenderArcRound2'+Br),tu=Td*n[0]*Ki[0]+Bu*n[1]*$i[0]+mn*n[2]*Si[0]+Un*n[12]+$c*n[10]+Ts*n[4]*zi[0]+ko*n[6]*Ni[0]+qa*n[3]*wi[0]+mr*n[5]*Vi[0]+_c*n[7]*ji[0]+ci*n[8]*Ri[0]+cp*n[11]+Sl*n[9],Jd=wd*i[0]*Ki[0]+Gu*i[1]*$i[0]+gn*i[2]*Si[0]+Bn*i[12]+Jc*i[10]+ws*i[4]*zi[0]+Io*i[6]*Ni[0]+Va*i[3]*wi[0]+gr*i[5]*Vi[0]+mc*i[7]*ji[0]+ri*i[8]*Ri[0]+rp*i[11]+yl*i[9],Kd=Ed*o[0]*Ki[0]+zu*o[1]*$i[0]+pn*o[2]*Si[0]+Gn*o[12]+Xc*o[10]+Es*o[4]*zi[0]+So*o[6]*Ni[0]+Ua*o[3]*wi[0]+pr*o[5]*Vi[0]+gc*o[7]*ji[0]+si*o[8]*Ri[0]+sp*o[11]+Al*o[9],Mc=tc*c[7]*Pl[1]+Kn*c[8]*Ol[1]+Qu*c[11]+ul*c[9],'cav'==ns?(Fd=rs*c[4]*Cl[1]+go*c[6]*Nl[1]+Mc,Yd=rd*c[0]*zl[1]+Su*c[1]*Gl[1]+$a*c[2]*Ll[1]+In*c[12]*no+Bc*c[10],Ud=xa*c[3]*Ml[1]+er*c[5]*Dl[1]):'inf'==ns?(Yd=rd*c[0]*zl[1]+Su*c[1]*Gl[1]+$a*c[2]*Ll[1]+In*c[12]*no+Bc*c[10]+Mc,Fd=rs*c[4]*Cl[1]+go*c[6]*Nl[1],Ud=xa*c[3]*Ml[1]+er*c[5]*Dl[1]):'arc'==ns?(Yd=rd*c[0]*zl[1]+Su*c[1]*Gl[1]+$a*c[2]*Ll[1]+In*c[12]*no+Bc*c[10],Fd=rs*c[4]*Cl[1]+go*c[6]*Nl[1],
Ud=xa*c[3]*Ml[1]+er*c[5]*Dl[1]+Mc):(Yd=rd*c[0]*zl[1]+Su*c[1]*Gl[1]+$a*c[2]*Ll[1]+In*c[12]*no+Bc*c[10],Fd=rs*c[4]*Cl[1]+go*c[6]*Nl[1],Ud=xa*c[3]*Ml[1]+er*c[5]*Dl[1]),du=tu*Ar,su=Jd*Ar,iu=Kd*Ar,zd=(Cd=Yd*yr)+(Ld=Fd*yr)+(xd=Ud*yr),console.log('strengthAttackerRound2'+zd),gu=du+su+iu,console.log('strengthDefenderRound2'+gu),Wl=0==Cd||0==du?0:du<=Cd?1:Math.pow(Cd/du,.5)/(du/Cd),Fl=0==Ld||0==su?0:su<=Ld?1:Math.pow(Ld/su,.5)/(su/Ld),ql=0==xd||0==iu?0:iu<=xd?1:Math.pow(xd/iu,.5)/(iu/xd),Vl=0==Cd||0==du?0:Cd<=du?1:Math.pow(du/Cd,.5)/(Cd/du),Ul=0==Ld||0==su?0:Ld<=su?1:Math.pow(su/Ld,.5)/(Ld/su),Bl=0==xd||0==iu?0:xd<=iu?1:Math.pow(iu/xd,.5)/(xd/iu),Ko=Math.round(1e6*Vl)/1e6,Qo=Math.round(1e6*Ul)/1e6,Ho=Math.round(1e6*Bl)/1e6,Jo=Math.round(1e6*Wl)/1e6,Xo=Math.round(1e6*Fl)/1e6,Zo=Math.round(1e6*ql)/1e6,gd=Math.round(-Td*Jo+1e-6)+Math.round(-wd*Xo+1e-6)+Math.round(-Ed*Zo+1e-6),Mu=Math.round(-Bu*Jo+1e-6)+Math.round(-Gu*Xo+1e-6)+Math.round(-zu*Zo+1e-6),
on=Math.round(-mn*Jo+1e-6)+Math.round(-gn*Xo+1e-6)+Math.round(-pn*Zo+1e-6),Na=Math.round(-qa*Jo+1e-6)+Math.round(-Va*Xo+1e-6)+Math.round(-Ua*Zo+1e-6),gs=Math.round(-Ts*Jo+1e-6)+Math.round(-ws*Xo+1e-6)+Math.round(-Es*Zo+1e-6),or=Math.round(-mr*Jo+1e-6)+Math.round(-gr*Xo+1e-6)+Math.round(-pr*Zo+1e-6),bo=Math.round(-ko*Jo+1e-6)+Math.round(-Io*Xo+1e-6)+Math.round(-So*Zo+1e-6),lc=Math.round(-_c*Jo+1e-6)+Math.round(-mc*Xo+1e-6)+Math.round(-gc*Zo+1e-6),ei=Math.round(-ci*Jo+1e-6)+Math.round(-ri*Xo+1e-6)+Math.round(-si*Zo+1e-6),ep=Math.round(-cp*Jo+1e-6)+Math.round(-rp*Xo+1e-6)+Math.round(-sp*Zo+1e-6),Ln=Math.round(-Un*Jo+1e-6)+Math.round(-Bn*Xo+1e-6)+Math.round(-Gn*Zo+1e-6),fl=Math.round(-Sl*Jo+1e-6)+Math.round(-yl*Xo+1e-6)+Math.round(-Al*Zo+1e-6),Wc=Math.round(-$c*Jo+1e-6)+Math.round(-Jc*Xo+1e-6)+Math.round(-Xc*Zo+1e-6),ld=Math.round(-rd*Ko+1e-6),Au=Math.round(-Su*Ko+1e-6),Xa=Math.round(-$a*Ko+1e-6),yn=Math.round(-In*Ko+1e-6),Ia=Math.round(-xa*Ho+1e-6),Js=Math.round(-er*Ho+1e-6),
ls=Math.round(-rs*Qo+1e-6),uo=Math.round(-go*Qo+1e-6),'cav'==ns?($r=Math.round(-tc*Qo+1e-6),Hn=Math.round(-Kn*Qo+1e-6),Yu=Math.round(-Qu*Qo+1e-6),cl=Math.round(-ul*Qo+1e-6)):'inf'==ns?($r=Math.round(-tc*Ko+1e-6),Hn=Math.round(-Kn*Ko+1e-6),Yu=Math.round(-Qu*Ko+1e-6),cl=Math.round(-ul*Ko+1e-6)):'arc'==ns&&($r=Math.round(-tc*Ho+1e-6),Hn=Math.round(-Kn*Ho+1e-6),Yu=Math.round(-Qu*Ho+1e-6),cl=Math.round(-ul*Ho+1e-6)),zc=100*Bc==Nr?0:Math.round(-Bc*Ko+1e-6),cd=rd+ld,Iu=Su+Au,en=$a+Xa,Ra=xa+Ia,cs=rs+ls,tr=er+Js,mo=go+uo,ac=tc+$r,Zn=Kn+Hn,Ku=Qu+Yu,kn=In+yn,Uc=Bc+zc,pl=ul+cl,vd=_d+gd,Pu=Ou+Mu,un=sn+on,Ba=Da+Na,vs=_s+gs,ur=sr+or,yo=Eo+bo,pc=rc+lc,li=ai+ei,lp=ap+ep,zn=Nn+Ln,Zc=Yc+Wc,Tl=bl+fl,Ns=ld*Mt[0]+Au*Mt[1]+Xa*Mt[2]+Ia*Mt[3]+ls*Mt[4]+Js*Mt[5]+uo*Mt[6]+$r*Mt[7]+Hn*Mt[8]+cl*Mt[9]+zc*Mt[10]+Yu*Mt[11]+yn*Mt[12],console.log('lossesAttackerRound2Total'+Ns),Ps=gd*Mt[0]+Mu*Mt[1]+on*Mt[2]+Na*Mt[3]+gs*Mt[4]+or*Mt[5]+bo*Mt[6]+lc*Mt[7]+ei*Mt[8]+fl*Mt[9]+Wc*Mt[10]+ep*Mt[11]+Ln*Mt[12],
console.log('lossesDefenderRound2Total'+Ps),fu=cd*Mt[0]+Iu*Mt[1]+en*Mt[2]+Ra*Mt[3]+cs*Mt[4]+tr*Mt[5]+mo*Mt[6]+ac*Mt[7]+Zn*Mt[8]+Ku*Mt[11]+kn*Mt[12]+Uc*Mt[10]+pl*Mt[9],console.log('survivorsAttackerRound2Total'+fu),vu=vd*Mt[0]+Pu*Mt[1]+un*Mt[2]+Ba*Mt[3]+vs*Mt[4]+ur*Mt[5]+yo*Mt[6]+pc*Mt[7]+li*Mt[8]+lp*Mt[11]+zn*Mt[12]+Zc*Mt[10]+Tl*Mt[9],console.log('survivorsDefenderRound2Total'+vu),zr=cd*Mt[0]+Iu*Mt[1]+en*Mt[2]+Ra*Mt[3]+cs*Mt[4]+tr*Mt[5]+mo*Mt[6]+ac*Mt[7]+Zn*Mt[8]+pl*Mt[9]+Uc*Mt[10]+Ku*Mt[11]+kn*Mt[12],Kr=vd*Mt[0]+Pu*Mt[1]+un*Mt[2]+Ba*Mt[3]+vs*Mt[4]+ur*Mt[5]+yo*Mt[6]+pc*Mt[7]+li*Mt[8]+Tl*Mt[9]+Zc*Mt[10]+lp*Mt[11]+zn*Mt[12],console.log('provisionDefenderRound3Total'+Kr),Sc=ac*Mt[7]+Zn*Mt[8]+Ku*Mt[11]+pl*Mt[9],'cav'==ns?(Lr=cs*Mt[4]+mo*Mt[6]+Sc,Cr=cd*Mt[0]+Iu*Mt[1]+en*Mt[2]+kn*Mt[12]+Uc*Mt[10],xr=Ra*Mt[3]+tr*Mt[5]):'inf'==ns?(Cr=cd*Mt[0]+Iu*Mt[1]+en*Mt[2]+kn*Mt[12]+Uc*Mt[10]+Sc,Lr=cs*Mt[4]+mo*Mt[6],xr=Ra*Mt[3]+tr*Mt[5]):'arc'==ns?(Cr=cd*Mt[0]+Iu*Mt[1]+en*Mt[2]+kn*Mt[12]+Uc*Mt[10],
Lr=cs*Mt[4]+mo*Mt[6],xr=Ra*Mt[3]+tr*Mt[5]+Sc):(Cr=cd*Mt[0]+Iu*Mt[1]+en*Mt[2]+kn*Mt[12]+Uc*Mt[10],Lr=cs*Mt[4]+mo*Mt[6],xr=Ra*Mt[3]+tr*Mt[5]),Ys=0==Cr?0:Math.round(Cr/zr*1e4)/1e4,js=0==Lr?0:Math.round(Lr/zr*1e4)/1e4,0==xr?(Ws=0,console.log('lossesPercentRound3Arc'+Ws)):(Ws=Math.round(xr/zr*1e4)/1e4,console.log('lossesPercentRound3Arc'+Ws)),Id=Math.round(vd*Ys),Sd=Math.round(vd*js),yd=vd-Sd-Id,Fu=Math.round(Pu*Ys),qu=Math.round(Pu*js),Vu=Pu-qu-Fu,bn=Math.round(un*Ys),hn=Math.round(un*js),fn=un-hn-bn,Ya=Math.round(Ba*Ys),ja=Math.round(Ba*js),Wa=Ba-ja-Ya,Is=Math.round(vs*Ys),Ss=Math.round(vs*js),ys=vs-Ss-Is,br=Math.round(ur*Ys),hr=Math.round(ur*js),fr=ur-hr-br,Lo=Math.round(yo*Ys),Mo=Math.round(yo*js),Ro=yo-Mo-Lo,vc=Math.round(pc*Ys),bc=Math.round(pc*js),hc=pc-bc-vc,gi=Math.round(li*Ys),pi=Math.round(li*js),ui=li-pi-gi,nd=Math.round(Zc*Ys),ad=Math.round(Zc*js),td=Zc-ad-nd,gp=Math.round(lp*Ys),pp=Math.round(lp*js),up=lp-pp-gp,Wn=Math.round(zn*Ys),Fn=Math.round(zn*js),qn=zn-Fn-Wn,
Rl=Math.round(Tl*Ys),xl=Math.round(Tl*js),kl=Tl-xl-Rl,Yr=Id*Mt[0]+Fu*Mt[1]+bn*Mt[2]+Wn*Mt[12]+nd*Mt[10]+Is*Mt[4]+Lo*Mt[6]+Ya*Mt[3]+br*Mt[5]+vc*Mt[7]+gi*Mt[8]+gp*Mt[11]+Rl*Mt[9],console.log('provisionDefenderInfRound3'+Yr),Fr=Sd*Mt[0]+qu*Mt[1]+hn*Mt[2]+Fn*Mt[12]+ad*Mt[10]+Ss*Mt[4]+Mo*Mt[6]+ja*Mt[3]+hr*Mt[5]+bc*Mt[7]+pi*Mt[8]+pp*Mt[11]+xl*Mt[9],console.log('provisionDefenderCavRound3'+Fr),Ur=yd*Mt[0]+Vu*Mt[1]+fn*Mt[2]+qn*Mt[12]+td*Mt[10]+ys*Mt[4]+Ro*Mt[6]+Wa*Mt[3]+fr*Mt[5]+hc*Mt[7]+ui*Mt[8]+up*Mt[11]+kl*Mt[9],console.log('provisionDefenderArcRound3'+Ur),au=Id*n[0]*Ki[0]+Fu*n[1]*$i[0]+bn*n[2]*Si[0]+Wn*n[12]+nd*n[10]+Is*n[4]*zi[0]+Lo*n[6]*Ni[0]+Ya*n[3]*wi[0]+br*n[5]*Vi[0]+vc*n[7]*ji[0]+gi*n[8]*Ri[0]+gp*n[11]+Rl*n[9],$d=Sd*i[0]*Ki[0]+qu*i[1]*$i[0]+hn*i[2]*Si[0]+Fn*i[12]+ad*i[10]+Ss*i[4]*zi[0]+Mo*i[6]*Ni[0]+ja*i[3]*wi[0]+hr*i[5]*Vi[0]+bc*i[7]*ji[0]+pi*i[8]*Ri[0]+pp*i[11]+xl*i[9],
Zd=yd*o[0]*Ki[0]+Vu*o[1]*$i[0]+fn*o[2]*Si[0]+qn*o[12]+td*o[10]+ys*o[4]*zi[0]+Ro*o[6]*Ni[0]+Wa*o[3]*wi[0]+fr*o[5]*Vi[0]+hc*o[7]*ji[0]+ui*o[8]*Ri[0]+up*o[11]+kl*o[9],xc=ac*c[7]*Pl[1]+Zn*c[8]*Ol[1]+Ku*c[11]+pl*c[9],'cav'==ns?(Wd=cs*c[4]*Cl[1]+mo*c[6]*Nl[1]+xc,Hd=cd*c[0]*zl[1]+Iu*c[1]*Gl[1]+en*c[2]*Ll[1]+kn*c[12]*no+Uc*c[10],Vd=Ra*c[3]*Ml[1]+tr*c[5]*Dl[1]):'inf'==ns?(Hd=cd*c[0]*zl[1]+Iu*c[1]*Gl[1]+en*c[2]*Ll[1]+kn*c[12]*no+Uc*c[10]+xc,Wd=cs*c[4]*Cl[1]+mo*c[6]*Nl[1],Vd=Ra*c[3]*Ml[1]+tr*c[5]*Dl[1]):'arc'==ns?(Hd=cd*c[0]*zl[1]+Iu*c[1]*Gl[1]+en*c[2]*Ll[1]+kn*c[12]*no+Uc*c[10],Wd=cs*c[4]*Cl[1]+mo*c[6]*Nl[1],Vd=Ra*c[3]*Ml[1]+tr*c[5]*Dl[1]+xc):(Hd=cd*c[0]*zl[1]+Iu*c[1]*Gl[1]+en*c[2]*Ll[1]+kn*c[12]*no+Uc*c[10],Wd=cs*c[4]*Cl[1]+mo*c[6]*Nl[1],Vd=Ra*c[3]*Ml[1]+tr*c[5]*Dl[1]),uu=au*Ar,ru=$d*Ar,ou=Zd*Ar,Gd=(Dd=Hd*yr)+(Od=Wd*yr)+(Rd=Vd*yr),console.log('strengthAttackerRound3'+Gd),mu=uu+ru+ou,console.log('strengthDefenderRound3'+mu),Zl=0==Dd||0==uu?0:uu<=Dd?1:Math.pow(Dd/uu,.5)/(uu/Dd),
Kl=0==Od||0==ru?0:ru<=Od?1:Math.pow(Od/ru,.5)/(ru/Od),Ql=0==Rd||0==ou?0:ou<=Rd?1:Math.pow(Rd/ou,.5)/(ou/Rd),Hl=0==Dd||0==uu?0:Dd<=uu?1:Math.pow(uu/Dd,.5)/(Dd/uu),Yl=0==Od||0==ru?0:Od<=ru?1:Math.pow(ru/Od,.5)/(Od/ru),jl=0==Rd||0==ou?0:Rd<=ou?1:Math.pow(ou/Rd,.5)/(Rd/ou),tl=Math.round(1e6*Hl)/1e6,el=Math.round(1e6*Yl)/1e6,$o=Math.round(1e6*jl)/1e6,il=Math.round(1e6*Zl)/1e6,nl=Math.round(1e6*Kl)/1e6,al=Math.round(1e6*Ql)/1e6,md=Math.round(-Id*il+1e-6)+Math.round(-Sd*nl+1e-6)+Math.round(-yd*al+1e-6),Lu=Math.round(-Fu*il+1e-6)+Math.round(-qu*nl+1e-6)+Math.round(-Vu*al+1e-6),ln=Math.round(-bn*il+1e-6)+Math.round(-hn*nl+1e-6)+Math.round(-fn*al+1e-6),Ca=Math.round(-Ya*il+1e-6)+Math.round(-ja*nl+1e-6)+Math.round(-Wa*al+1e-6),ms=Math.round(-Is*il+1e-6)+Math.round(-Ss*nl+1e-6)+Math.round(-ys*al+1e-6),lr=Math.round(-br*il+1e-6)+Math.round(-hr*nl+1e-6)+Math.round(-fr*al+1e-6),vo=Math.round(-Lo*il+1e-6)+Math.round(-Mo*nl+1e-6)+Math.round(-Ro*al+1e-6),
sc=Math.round(-vc*il+1e-6)+Math.round(-bc*nl+1e-6)+Math.round(-hc*al+1e-6),ti=Math.round(-gi*il+1e-6)+Math.round(-pi*nl+1e-6)+Math.round(-ui*al+1e-6),tp=Math.round(-gp*il+1e-6)+Math.round(-pp*nl+1e-6)+Math.round(-up*al+1e-6),On=Math.round(-Wn*il+1e-6)+Math.round(-Fn*nl+1e-6)+Math.round(-qn*al+1e-6),hl=Math.round(-Rl*il+1e-6)+Math.round(-xl*nl+1e-6)+Math.round(-kl*al+1e-6),jc=Math.round(-nd*il+1e-6)+Math.round(-ad*nl+1e-6)+Math.round(-td*al+1e-6),sd=Math.round(-cd*tl+1e-6),yu=Math.round(-Iu*tl+1e-6),Ja=Math.round(-en*tl+1e-6),Sn=Math.round(-kn*tl+1e-6),ka=Math.round(-Ra*$o+1e-6),$s=Math.round(-tr*$o+1e-6),ss=Math.round(-cs*el+1e-6),po=Math.round(-mo*el+1e-6),'cav'==ns?(ec=Math.round(-ac*el+1e-6),Qn=Math.round(-Zn*el+1e-6),Hu=Math.round(-Ku*el+1e-6),dl=Math.round(-pl*el+1e-6)):'inf'==ns?(ec=Math.round(-ac*tl+1e-6),Qn=Math.round(-Zn*tl+1e-6),Hu=Math.round(-Ku*tl+1e-6),dl=Math.round(-pl*tl+1e-6)):'arc'==ns&&(ec=Math.round(-ac*$o+1e-6),Qn=Math.round(-Zn*$o+1e-6),Hu=Math.round(-Ku*$o+1e-6),
dl=Math.round(-pl*$o+1e-6)),Gc=100*Uc==Cr?0:Math.round(-Uc*tl+1e-6),dd=cd+sd,ku=Iu+yu,tn=en+Ja,Ma=Ra+ka,ds=cs+ss,ar=tr+$s,_o=mo+po,nc=ac+ec,Xn=Zn+Qn,Zu=Ku+Hu,xn=kn+Sn,Vc=Uc+Gc,gl=pl+dl,Ad=vd+md,Uu=Pu+Lu,_n=un+ln,Fa=Ba+Ca,As=vs+ms,_r=ur+lr,xo=yo+vo,fc=pc+sc,di=li+ti,dp=lp+tp,Vn=zn+On,ed=Zc+jc,Il=Tl+hl,Cs=sd*Mt[0]+yu*Mt[1]+Ja*Mt[2]+ka*Mt[3]+ss*Mt[4]+$s*Mt[5]+po*Mt[6]+ec*Mt[7]+Qn*Mt[8]+dl*Mt[9]+Gc*Mt[10]+Hu*Mt[11]+Sn*Mt[12],console.log('lossesAttackerRound3Total'+Cs),zs=md*Mt[0]+Lu*Mt[1]+ln*Mt[2]+Ca*Mt[3]+ms*Mt[4]+lr*Mt[5]+vo*Mt[6]+sc*Mt[7]+ti*Mt[8]+hl*Mt[9]+jc*Mt[10]+tp*Mt[11]+On*Mt[12],console.log('lossesDefenderRound3Total'+zs),hu=dd*Mt[0]+ku*Mt[1]+tn*Mt[2]+Ma*Mt[3]+ds*Mt[4]+ar*Mt[5]+_o*Mt[6]+nc*Mt[7]+Xn*Mt[8]+Zu*Mt[11]+xn*Mt[12]+Vc*Mt[10]+gl*Mt[9],console.log('survivorsAttackerRound3Total'+hu),Eu=Ad*Mt[0]+Uu*Mt[1]+_n*Mt[2]+Fa*Mt[3]+As*Mt[4]+_r*Mt[5]+xo*Mt[6]+fc*Mt[7]+di*Mt[8]+dp*Mt[11]+Vn*Mt[12]+ed*Mt[10]+Il*Mt[9],console.log('survivorsDefenderRound3Total'+Eu),id=-jt+dd,wu=-Ht+ku,
Ka=-d+tn,ya=-l+Ma,is=-Dt+ds,Zs=-Gt+ar,ro=-Lt+_o,Xr=-Vt+nc,jn=-kt+Xn,Wu=-Kt+Zu,Tn=-p+xn,Dc=-Ft+Vc,sl=-Nt+gl,ud=-Yt+Ad,xu=-Qt+Uu,an=-u+_n,La=-s+Fa,us=-Pt+As,nr=-Bt+_r,fo=-Ot+xo,ic=-qt+fc,Jn=-xt+di,Ju=-Zt+dp,Rn=-m+Vn,qc=-Wt+ed,ml=-Ct+Il,Ac=0==nc?0:nc*yr*Uo[1],Co=20==fp?18:19==fp?17:18==fp?15:17==fp?14:16==fp?13:15==fp?11:14==fp?10:13==fp||12==fp?9:11==fp?8:10==fp?7:9==fp||8==fp?6:7==fp||6==fp?5:5==fp||4==fp||3==fp?4:2==fp||1==fp?3:0,Ec=0==En?0:2*Co,wc=0==Ac||0==Ec?0:-Ac/Ec,so=fp<=Cc?fp:fp-Cc<-wc?fp<Cc?fp:Cc:fp+wc,$t=Math.round(so),Rt='wall'==bi?$t:parseInt(document.getElementById('buildingLevel').value),fi=0==Xn||0==Rt?0:Xn*yr*Ol[1],
Oo='headquarter'==bi?30==Rt?72:29==Rt?65:28==Rt?59:27==Rt?54:26==Rt?50:25==Rt?45:24==Rt?41:23==Rt?36:22==Rt?33:21==Rt?30:20==Rt?27:19==Rt?26:18==Rt?23:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'wall'==bi?20==$t?18:19==$t?17:18==$t?15:17==$t?14:16==$t?13:15==$t?11:14==$t?10:13==$t||12==$t?9:11==$t?8:10==$t?7:9==$t||8==$t?6:7==$t||6==$t?5:5==$t||4==$t||3==$t?4:2==$t||1==$t?3:0:'tavern'==bi?15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'hospital'==bi?10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'satue'==bi?5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'rally_point'==bi?5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'church'==bi?3==Rt||2==Rt||1==Rt?800:0:'academy'==bi?1==Rt?500:0:'preceptory'==bi?10==Rt?71:9==Rt?43:8==Rt?39:7==Rt?35:6==Rt?32:5==Rt?29:4==Rt?27:3==Rt?24:2==Rt?22:1==Rt?20:0:'barracks'==bi?25==Rt?30:24==Rt?27:23==Rt?24:22==Rt?22:21==Rt?20:20==Rt?18:19==Rt?17:18==Rt?15:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'market'==bi?25==Rt?30:24==Rt?27:23==Rt?24:22==Rt?22:21==Rt?20:20==Rt?18:19==Rt?17:18==Rt?15:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'warehouse'==bi?30==Rt?48:29==Rt?43:28==Rt?39:27==Rt?36:26==Rt?33:25==Rt?30:24==Rt?27:23==Rt?24:22==Rt?22:21==Rt?20:20==Rt?18:19==Rt?17:18==Rt?15:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'timber_camp'==bi?30==Rt?48:29==Rt?43:28==Rt?39:27==Rt?36:26==Rt?33:25==Rt?30:24==Rt?27:23==Rt?24:22==Rt?22:21==Rt?20:20==Rt?18:19==Rt?17:18==Rt?15:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'clay_pit'==bi?30==Rt?48:29==Rt?43:28==Rt?39:27==Rt?36:26==Rt?33:25==Rt?30:24==Rt?27:23==Rt?24:22==Rt?22:21==Rt?20:20==Rt?18:19==Rt?17:18==Rt?15:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'iron_mine'==bi?30==Rt?48:29==Rt?43:28==Rt?39:27==Rt?36:26==Rt?33:25==Rt?30:24==Rt?27:23==Rt?24:22==Rt?22:21==Rt?20:20==Rt?18:19==Rt?17:18==Rt?15:17==Rt?14:16==Rt?13:15==Rt?11:14==Rt?10:13==Rt||12==Rt?9:11==Rt?8:10==Rt?7:9==Rt||8==Rt?6:7==Rt||6==Rt?5:5==Rt||4==Rt||3==Rt?4:2==Rt||1==Rt?3:0:'farm'==bi?30==Rt?79:29==Rt?72:28==Rt?66:27==Rt?60:26==Rt?54:25==Rt?49:24==Rt?45:23==Rt?41:22==Rt?37:21==Rt?34:20==Rt?31:19==Rt?28:18==Rt?25:17==Rt?23:16==Rt?21:15==Rt?19:14==Rt?17:13==Rt?16:12==Rt?14:11==Rt?13:10==Rt?12:9==Rt?11:8==Rt?10:7==Rt?9:6==Rt?8:5==Rt||4==Rt?7:2==Rt||3==Rt?6:1==Rt?5:0:0,
mi=0==Rt?0:Oo*Ar,_i=0==fi||0==mi?0:-fi/mi,lo='wall'==bi?so<=Cc?so:so-Cc<-_i?so<Cc?so:Cc:so+_i:_i+Rt<=0?0:_i+Rt,Jt=Math.round(lo),Hs=id*Mt[0]+wu*Mt[1]+Ka*Mt[2]+ya*Mt[3]+is*Mt[4]+Zs*Mt[5]+ro*Mt[6]+Xr*Mt[7]+jn*Mt[8]+sl*Mt[9]+Dc*Mt[10]+Wu*Mt[11]+Tn*Mt[12],Qs=ud*Mt[0]+xu*Mt[1]+an*Mt[2]+La*Mt[3]+us*Mt[4]+nr*Mt[5]+fo*Mt[6]+ic*Mt[7]+Jn*Mt[8]+ml*Mt[9]+qc*Mt[10]+Ju*Mt[11]+Rn*Mt[12],Tp=ud*t[0]+xu*t[1]+an*t[2]+La*t[3]+us*t[4]+nr*t[5]+fo*t[6]+ic*t[7]+Jn*t[8]+ml*t[9]+qc*t[10]+Ju*t[11]+Rn*t[12],Ap=id*e[0]+wu*e[1]+Ka*e[2]+ya*e[3]+is*e[4]+Zs*e[5]+ro*e[6]+Xr*e[7]+jn*e[8]+sl*e[9]+Dc*e[10]+Wu*e[11]+Tn*e[12],ol=0==Qa||0==Hs?0:Math.round(-Hs/Qa*1e3)/1e3,kp='inf'==ns?'piechota':'cav'==ns?'kawaleria':'łucznicy',xp='inf'==(yp=Yt+Qt+u+m>Pt+Ot&&Yt+Qt+u+m>s+Bt?'inf':Pt+Ot>Yt+Qt+u+m&&Pt+Ot>s+Bt?'cav':'arc')?'piechota':'cav'==yp?'kawaleria':'łucznicy',ll=0==vi||0==Qs?0:Math.round(-Qs/vi*1e3)/1e3,zp=Math.round(id*(vr+Nc)),Gp=Math.round(wu*(vr+Nc)),Bp=Math.round(Ka*(vr+Nc)),Up=Math.round(ya*(vr+Nc)),
Vp=Math.round(is*(vr+Nc)),qp=Math.round(Zs*(vr+Nc)),Fp=Math.round(ro*(vr+Nc)),Wp=Math.round(Xr*(vr+Nc)),jp=Math.round(jn*(vr+Nc)),Yp=Math.round(Dc*(vr+Nc)),Hp=Math.round(sl*(vr+Nc)),Qp=Math.round(Wu*(vr+Nc)),Kp=Math.round(Tn*(vr+Nc)),Zp=Do+Oc,0==Do?(Mp=0,Lp=0,Op=0,Np=0,Cp=0,Dp=0,Pp=0):Do<1e3?Zp<=(La+ud+xu+an)/2?(Mp=Math.round(ud/2),Lp=Math.round(xu/2),Op=Math.round(an/2),Np=Math.round(La/2),Cp=0,Dp=0,Pp=0):(Mp=Math.round(ud*Zp/(La+ud+xu+an)),Lp=Math.round(xu*Zp/(La+ud+xu+an)),Op=Math.round(an*Zp/(La+ud+xu+an)),Np=Math.round(La*Zp/(La+ud+xu+an)),Cp=0,Dp=0,Pp=0):Zp<=(La+ud+xu+an+4*us+5*nr+6*fo)/2?(Mp=Math.round(ud/2),Lp=Math.round(xu/2),Op=Math.round(an/2),Np=Math.round(La/2),Cp=Math.round(us/2),Dp=Math.round(nr/2),Pp=Math.round(fo/2)):(Mp=Math.round(ud*Zp/(La+ud+xu+an+4*us+5*nr+6*fo)),Lp=Math.round(xu*Zp/(La+ud+xu+an+4*us+5*nr+6*fo)),Op=Math.round(an*Zp/(La+ud+xu+an+4*us+5*nr+6*fo)),Np=Math.round(La*Zp/(La+ud+xu+an+4*us+5*nr+6*fo)),Cp=Math.round(us*Zp/(La+ud+xu+an+4*us+5*nr+6*fo)),
Dp=Math.round(nr*Zp/(La+ud+xu+an+4*us+5*nr+6*fo)),Pp=Math.round(fo*Zp/(La+ud+xu+an+4*us+5*nr+6*fo))),Sp=Qa+Hs,Ip=vi+Qs,L.html(jt),O.html(-id),N.html(-zp),C.html(dd),D.html(Ht),P.html(-wu),z.html(-Gp),G.html(ku),B.html(d),U.html(-Ka),V.html(-Bp),q.html(tn),F.html(l),W.html(-ya),j.html(-Up),Y.html(Ma),H.html(Dt),Q.html(-is),K.html(-Vp),Z.html(ds),X.html(Gt),J.html(-Zs),$.html(-qp),ee.html(ar),te.html(Lt),ae.html(-ro),ne.html(-Fp),ie.html(_o),oe.html(Vt),le.html(-Xr),se.html(-Wp),re.html(nc),ce.html(kt),de.html(-jn),ue.html(-jp),pe.html(Xn),ge.html(Ft),me.html(-Dc),_e.html(-Yp),fe.html(Vc),he.html(Nt),be.html(-sl),ve.html(-Hp),Ee.html(gl),we.html(Kt),Te.html(-Wu),Ae.html(-Qp),ye.html(Zu),Se.html(p),Ie.html(-Tn),ke.html(-Kp),xe.html(xn),Re.html(Yt),Me.html(-ud),Le.html(Mp),Oe.html(Ad),Ne.html(Qt),Ce.html(-xu),De.html(Lp),Pe.html(Uu),ze.html(u),Ge.html(-an),Be.html(Op),Ue.html(_n),Ve.html(s),qe.html(-La),Fe.html(Np),We.html(Fa),je.html(Pt),Ye.html(-us),He.html(Cp),Qe.html(As),Ke.html(Bt),
Ze.html(-nr),Xe.html(Dp),Je.html(_r),$e.html(Ot),et.html(-fo),tt.html(Pp),at.html(xo),nt.html(qt),it.html(-ic),ot.html(0),lt.html(fc),st.html(xt),rt.html(-Jn),ct.html(0),dt.html(di),ut.html(Wt),pt.html(-qc),gt.html(0),mt.html(ed),_t.html(Ct),ft.html(-ml),ht.html(0),bt.html(Il),vt.html(Zt),Et.html(-Ju),wt.html(0),Tt.html(dp),At.html(m),yt.html(-Rn),St.html(0),It.html(Vn),_.html(100*yr),f.html(Qa),fa.html(-Hs),ha.html(Sp),ba.html(-Qs),va.html(Ip),Ea.html(no),wa.html(Zp),Ta.html(kp),Aa.html(xp),h.html(-Tp),b.html(100*ol),v.html(Pd),E.html(100*Ar),w.html(vi),T.html(-Ap),A.html(100*ll),y.html(pu),S.html(Xt),I.html(fp),k.html(fp),x.html($t),_a.html(Rp),R.html(Rt),M.html(Jt),r.notif('success',g('i18n')('calculated',a.loc.ale,'battle_calculator'))})),xt.on('click',(function(){document.getElementById('spearA').value=parseInt(document.getElementById('spearA-survived').innerHTML),document.getElementById('swordA').value=parseInt(document.getElementById('swordA-survived').innerHTML),
...
g.push(e.presets[t].units.spear),p.push(e.presets[t].units.snob))})),setTimeout(f,500)})),Pt.on('click',(function(){
var e,t,a,n,i=document.getElementById('spearCost').value,o=document.getElementById('swordCost').value,l=document.getElementById('axeCost').value,s=document.getElementById('archerCost').value,r=document.getElementById('lcCost').value,c=document.getElementById('maCost').value,d=document.getElementById('hcCost').value,u=document.getElementById('ramCost').value,p=document.getElementById('catapultCost').value,g=document.getElementById('berserkerCost').value,m=document.getElementById('trebuchetCost').value,_=document.getElementById('snobCost').value,f=document.getElementById('knightCost').value,h=document.getElementById('barracks').value,b=document.getElementById('preceptory').value,v=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],E=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],w=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],T=[1,1,1,1,4,5,6,5,8,1,100,10,6],A=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],y=[10,25,45,25,130,150,150,2,100,150,30,30,300],S=[25,55,10,10,30,40,200,20,100,250,100,200,100],I=[45,5,5,30,40,30,160,50,50,400,50,250,100],k=[10,30,10,60,30,50,180,20,100,150,100,200,50],x=[8,9,14,18,24,35,50,0],R=[25,15,10,10,80,50,50,0,0,100,0,0,10],M=[0,33,66,99],L=0,O=0,N=1,C=1,D=1,P=1,z=1,G=1,B=1,U=1,V=$t[0].dataset.value
;C=h>=10&&h<20?1.05:h>=20&&h<25?1.15:h>=25?1.3:1,P=Jt[0].dataset.value,z=1==b?1.01:2==b?1.02:3==b?1.03:4==b?1.04:5==b?1.05:6==b?1.06:7==b?1.07:8==b?1.08:9==b?1.09:10==b?1.1:1,D=document.getElementById('settings-domination').checked?1.1:1,L=m>0?x[6]+' minut':_>0?x[5]+' minut':u>0||p>0?x[4]+' minuty':o>0?x[3]+' minut':i>0||l>0||s>0||g>0?x[2]+' minut':d>0?x[1]+' minut':r>0||c>0||f>0?x[0]+' minut':x[7]+' minut',O=h>=7&&h<14?M[1]:h>=14&&h<23?M[2]:h>=23?M[3]:M[0],B=(G=N/(D*P)/C)/z,U=N/z,ya='deff'==V?B*(i*A[0]+o*A[1]+s*A[3]+d*A[6])+U*(m*A[11])+G*(l*A[2]+r*A[4]+c*A[5]+u*A[7]+p*A[8])+g*A[12]+f*A[9]+_*A[10]:'off'==V?G*(i*A[0]+o*A[1]+s*A[3]+d*A[6])+m*A[11]+B*(l*A[2]+r*A[4]+c*A[5]+u*A[7]+p*A[8])+U*(g*A[12])+f*A[9]+_*A[10]:G*(i*A[0]+o*A[1]+s*A[3]+d*A[6])+m*A[11]+G*(l*A[2]+r*A[4]+c*A[5]+u*A[7]+p*A[8])+g*A[12]+f*A[9]+_*A[10],Sa=i*v[0]+o*v[1]+l*v[2]+s*v[3]+r*v[4]+c*v[5]+d*v[6]+u*v[7]+p*v[8]+f*v[9]+_*v[10]+m*v[11]+g*v[12],
Ia=i*E[0]+o*E[1]+l*E[2]+s*E[3]+r*E[4]+c*E[5]+d*E[6]+u*E[7]+p*E[8]+f*E[9]+_*E[10]+m*E[11]+g*E[12],ka=i*w[0]+o*w[1]+l*w[2]+s*w[3]+r*w[4]+c*w[5]+d*w[6]+u*w[7]+p*w[8]+f*w[9]+_*w[10]+m*w[11]+g*w[12],xa=i*T[0]+o*T[1]+l*T[2]+s*T[3]+r*T[4]+c*T[5]+d*T[6]+u*T[7]+p*T[8]+f*T[9]+_*T[10]+m*T[11]+g*T[12],Ma=i*y[0]+o*y[1]+l*y[2]+s*y[3]+r*y[4]+c*y[5]+d*y[6]+u*y[7]+p*y[8]+f*y[9]+_*y[10]+m*y[11]+g*y[12],La=i*S[0]+o*S[1]+l*S[2]+s*S[3]+r*S[4]+c*S[5]+d*S[6]+u*S[7]+p*S[8]+f*S[9]+_*S[10]+m*S[11]+g*S[12],Oa=i*I[0]+o*I[1]+l*I[2]+s*I[3]+r*I[4]+c*I[5]+d*I[6]+u*I[7]+p*I[8]+f*I[9]+_*I[10]+m*I[11]+g*I[12],Na=i*k[0]+o*k[1]+l*k[2]+s*k[3]+r*k[4]+c*k[5]+d*k[6]+u*k[7]+p*k[8]+f*k[9]+_*k[10]+m*k[11]+g*k[12],Ra=i*R[0]+o*R[1]+l*R[2]+s*R[3]+r*R[4]+c*R[5]+d*R[6]+u*R[7]+p*R[8]+f*R[9]+_*R[10]+m*R[11]+g*R[12],e=ya,t='',a=new Date(1e3*e).toISOString().substr(11,8),(n=Math.floor(e/86400))>1?t=n+' dni i ':n>0&&(t='1 dzień i '),Ca=t+=a,Da=i*y[0]+o*y[1]+l*y[2]+u*y[7]+p*y[8]+m*y[11]+g*y[12],Pa=r*y[4]+d*y[6]+f*y[9],za=s*y[3]+c*y[5],
zt.html(Sa),Gt.html(Ia),Bt.html(ka),Ut.html(xa),Vt.html(Ma),qt.html(Da),Ft.html(Pa),Wt.html(za),jt.html(La),Yt.html(Oa),Ht.html(Na),Qt.html(L),Kt.html(Ra),Zt.html(O),Xt.html(Ca)})),Nt.on('click',(function(){var e=document.getElementById('spearBash').value,t=document.getElementById('swordBash').value,a=document.getElementById('axeBash').value,n=document.getElementById('archerBash').value,i=document.getElementById('lcBash').value,o=document.getElementById('maBash').value,l=document.getElementById('hcBash').value,s=document.getElementById('ramBash').value,r=document.getElementById('catapultBash').value,c=document.getElementById('berserkerBash').value,d=document.getElementById('trebuchetBash').value,u=document.getElementById('snobBash').value,p=document.getElementById('knightBash').value,g=[1,2,4,2,13,12,15,8,10,20,200,0,25],m=[4,5,1,5,5,6,23,4,12,40,200,25,10],_=0,f=0;function h(){Ct.html(f),Dt.html(_)}
_=e*g[0]+t*g[1]+a*g[2]+n*g[3]+i*g[4]+o*g[5]+l*g[6]+s*g[7]+r*g[8]+p*g[9]+u*g[10]+d*g[11]+c*g[12],f=e*m[0]+t*m[1]+a*m[2]+n*m[3]+i*m[4]+o*m[5]+l*m[6]+s*m[7]+r*m[8]+p*m[9]+u*m[10]+d*m[11]+c*m[12],setTimeout(h,500)})),Jt.on('selectSelected',(function(){Ga=Jt[0].dataset.value,console.log('intenseTraining'+Ga)})),$t.on('selectSelected',(function(){Ba=$t[0].dataset.value,console.log('order'+Ba)})),ta.on('selectSelected',(function(){Ua=ta[0].dataset.value,console.log('faithDefender'+Ua)})),ea.on('selectSelected',(function(){Va=ea[0].dataset.value,console.log('faithAttacker'+Va)})),aa.on('selectSelected',(function(){qa=aa[0].dataset.value,console.log('skillAttack'+qa)})),na.on('selectSelected',(function(){Fa=na[0].dataset.value,console.log('skillWalls'+Fa)})),ia.on('selectSelected',(function(){Wa=ia[0].dataset.value,console.log('skillClinique'+Wa)})),oa.on('selectSelected',(function(){ja=oa[0].dataset.value,console.log('hospitalBeds'+ja)})),la.on('selectSelected',(function(){
Ya=la[0].dataset.value,console.log('catapultTarget'+Ya)})),sa.on('selectSelected',(function(){Ha=sa[0].dataset.value,console.log('itemDeff1'+Ha)})),ra.on('selectSelected',(function(){Qa=ra[0].dataset.value,console.log('itemDeff2'+Qa)})),ca.on('selectSelected',(function(){Ka=ca[0].dataset.value,console.log('itemDeff3'+Ka)})),da.on('selectSelected',(function(){Za=da[0].dataset.value,console.log('itemOff'+Za)})),ua.on('selectSelected',(function(){Xa=ua[0].dataset.value,console.log('levelDeff1'+Xa)})),pa.on('selectSelected',(function(){Ja=pa[0].dataset.value,console.log('levelDeff2'+Ja)})),ga.on('selectSelected',(function(){$a=ga[0].dataset.value,console.log('levelDeff3'+$a)})),ma.on('selectSelected',(function(){en=ma[0].dataset.value,console.log('levelOff'+en)}))};const nn=function(e,t){p=t.data},on=function(){p=!1},ln=function(){if(!p)return r.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'battle_calculator'));l.loadTownDataAsync(p.x,p.y,1,1,(function(e){
(void 0).target=e}))},sn=function(e){d.selectedTab=e},rn=function(){const e=i.getSelectedVillage().data;(void 0).origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:(void 0).getId()}};const cn={autoCompleteSelected:function(e,t,a,n){if('battleCalculator_village_search'!==t)return!1;(void 0)[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},d.searchQuery[n]=''},onAutoCompleteOrigin:function(e){(void 0).origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){(void 0).target={id:e.id,x:e.x,y:e.y,name:e.name}}},dn=function(){d=a.$new(),d.selectedTab=m.BATTLE,d.TAB_TYPES=m,d.running=n.isRunning(),d.selectTab=sn,d.addSelected=rn,d.addMapSelected=ln,d.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'battle_calculator'),onEnter:cn.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'battle_calculator'),dropDown:!0},d.searchQuery={target:''},kt=(void 0).find('.item-simulate span'),
xt=(void 0).find('.item-insert span'),Rt=(void 0).find('.item-insertV span'),Mt=(void 0).find('.item-insertP span'),Lt=(void 0).find('.item-insertVD span'),Ot=(void 0).find('.item-insertPD span'),Nt=(void 0).find('.item-check span'),Ct=(void 0).find('.points-att'),Dt=(void 0).find('.points-def'),Pt=(void 0).find('.item-check-T span'),zt=(void 0).find('.wood'),Gt=(void 0).find('.clay'),Bt=(void 0).find('.iron'),Ut=(void 0).find('.food'),Vt=(void 0).find('.attack'),qt=(void 0).find('.attackinf'),Ft=(void 0).find('.attackcav'),Wt=(void 0).find('.attackarc'),jt=(void 0).find('.definf'),Yt=(void 0).find('.defcav'),Ht=(void 0).find('.defarc'),Qt=(void 0).find('.speed'),Kt=(void 0).find('.load'),Zt=(void 0).find('.discipline'),Xt=(void 0).find('.buildtime'),Jt=(void 0).find('.dataTraining'),$t=(void 0).find('.dataOrder'),ea=(void 0).find('.beliefAttacker'),ta=(void 0).find('.beliefDefender'),aa=(void 0).find('.dataMaster'),na=(void 0).find('.dataWalls'),ia=(void 0).find('.dataClinique'),
oa=(void 0).find('.dataHospital'),la=(void 0).find('.catapultTarget'),sa=(void 0).find('.dataEquip1'),ra=(void 0).find('.dataEquip2'),ca=(void 0).find('.dataEquip3'),da=(void 0).find('.dataEquip4'),ua=(void 0).find('.dataLevel1'),pa=(void 0).find('.dataLevel2'),ga=(void 0).find('.dataLevel3'),ma=(void 0).find('.dataLevel4'),L=(void 0).find('.spearA-amount'),O=(void 0).find('.spearA-losses'),N=(void 0).find('.spearA-revived'),C=(void 0).find('.spearA-survived'),D=(void 0).find('.swordA-amount'),P=(void 0).find('.swordA-losses'),z=(void 0).find('.swordA-revived'),G=(void 0).find('.swordA-survived'),B=(void 0).find('.axeA-amount'),U=(void 0).find('.axeA-losses'),V=(void 0).find('.axeA-revived'),q=(void 0).find('.axeA-survived'),F=(void 0).find('.archerA-amount'),W=(void 0).find('.archerA-losses'),j=(void 0).find('.archerA-revived'),Y=(void 0).find('.archerA-survived'),H=(void 0).find('.lcA-amount'),Q=(void 0).find('.lcA-losses'),K=(void 0).find('.lcA-revived'),
Z=(void 0).find('.lcA-survived'),X=(void 0).find('.maA-amount'),J=(void 0).find('.maA-losses'),$=(void 0).find('.maA-revived'),ee=(void 0).find('.maA-survived'),te=(void 0).find('.hcA-amount'),ae=(void 0).find('.hcA-losses'),ne=(void 0).find('.hcA-revived'),ie=(void 0).find('.hcA-survived'),oe=(void 0).find('.ramA-amount'),le=(void 0).find('.ramA-losses'),se=(void 0).find('.ramA-revived'),re=(void 0).find('.ramA-survived'),ce=(void 0).find('.catapultA-amount'),de=(void 0).find('.catapultA-losses'),ue=(void 0).find('.catapultA-revived'),pe=(void 0).find('.catapultA-survived'),ge=(void 0).find('.snobA-amount'),me=(void 0).find('.snobA-losses'),_e=(void 0).find('.snobA-revived'),fe=(void 0).find('.snobA-survived'),he=(void 0).find('.knightA-amount'),be=(void 0).find('.knightA-losses'),ve=(void 0).find('.knightA-revived'),Ee=(void 0).find('.knightA-survived'),we=(void 0).find('.trebuchetA-amount'),Te=(void 0).find('.trebuchetA-losses'),Ae=(void 0).find('.trebuchetA-revived'),
ye=(void 0).find('.trebuchetA-survived'),Se=(void 0).find('.berserkerA-amount'),Ie=(void 0).find('.berserkerA-losses'),ke=(void 0).find('.berserkerA-revived'),xe=(void 0).find('.berserkerA-survived'),Re=(void 0).find('.spearD-amount'),Me=(void 0).find('.spearD-losses'),Le=(void 0).find('.spearD-revived'),Oe=(void 0).find('.spearD-survived'),Ne=(void 0).find('.swordD-amount'),Ce=(void 0).find('.swordD-losses'),De=(void 0).find('.swordD-revived'),Pe=(void 0).find('.swordD-survived'),ze=(void 0).find('.axeD-amount'),Ge=(void 0).find('.axeD-losses'),Be=(void 0).find('.axeD-revived'),Ue=(void 0).find('.axeD-survived'),Ve=(void 0).find('.archerD-amount'),qe=(void 0).find('.archerD-losses'),Fe=(void 0).find('.archerD-revived'),We=(void 0).find('.archerD-survived'),je=(void 0).find('.lcD-amount'),Ye=(void 0).find('.lcD-losses'),He=(void 0).find('.lcD-revived'),Qe=(void 0).find('.lcD-survived'),Ke=(void 0).find('.maD-amount'),Ze=(void 0).find('.maD-losses'),Xe=(void 0).find('.maD-revived'),
Je=(void 0).find('.maD-survived'),$e=(void 0).find('.hcD-amount'),et=(void 0).find('.hcD-losses'),tt=(void 0).find('.hcD-revived'),at=(void 0).find('.hcD-survived'),nt=(void 0).find('.ramD-amount'),it=(void 0).find('.ramD-losses'),ot=(void 0).find('.ramD-revived'),lt=(void 0).find('.ramD-survived'),st=(void 0).find('.catapultD-amount'),rt=(void 0).find('.catapultD-losses'),ct=(void 0).find('.catapultD-revived'),dt=(void 0).find('.catapultD-survived'),ut=(void 0).find('.snobD-amount'),pt=(void 0).find('.snobD-losses'),gt=(void 0).find('.snobD-revived'),mt=(void 0).find('.snobD-survived'),_t=(void 0).find('.knightD-amount'),ft=(void 0).find('.knightD-losses'),ht=(void 0).find('.knightD-revived'),bt=(void 0).find('.knightD-survived'),vt=(void 0).find('.trebuchetD-amount'),Et=(void 0).find('.trebuchetD-losses'),wt=(void 0).find('.trebuchetD-revived'),Tt=(void 0).find('.trebuchetD-survived'),At=(void 0).find('.berserkerD-amount'),yt=(void 0).find('.berserkerD-losses'),
St=(void 0).find('.berserkerD-revived'),It=(void 0).find('.berserkerD-survived'),_=(void 0).find('.attackModifier'),f=(void 0).find('.attackProvisions'),h=(void 0).find('.attackBashpoint'),b=(void 0).find('.killrateA'),v=(void 0).find('.strentghAttack'),E=(void 0).find('.defenceModifier'),w=(void 0).find('.defenceProvisions'),T=(void 0).find('.defenceBashpoint'),A=(void 0).find('.killrateD'),y=(void 0).find('.strentghDefend'),S=(void 0).find('.wallfrompre'),I=(void 0).find('.walltopre'),k=(void 0).find('.wallfrom'),x=(void 0).find('.wallto'),_a=(void 0).find('.target'),R=(void 0).find('.buildingfrom'),M=(void 0).find('.buildingto'),fa=(void 0).find('.attackKilledProvisions'),ha=(void 0).find('.attackSurvivedProvisions'),ba=(void 0).find('.defenceKilledProvisions'),va=(void 0).find('.defenceSurvivedProvisions'),Ea=(void 0).find('.doubleStrength'),wa=(void 0).find('.availableBeds'),Ta=(void 0).find('.strongestTypeOff'),Aa=(void 0).find('.strongestTypeDef'),
(void 0).register(s.SELECT_SELECTED,cn.autoCompleteSelected,!0),(void 0).register(s.BATTLE_CALCULATOR_START,cn.start),(void 0).register(s.BATTLE_CALCULATOR_STOP,cn.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',d),an(),n.interfaceInitialized=!0};return function(){u=e.addMenuButton('Kalkulator',170),u.addEventListener('click',dn),o.register(s.BATTLE_CALCULATOR_START,(function(){u.classList.remove('btn-orange'),u.classList.add('btn-red')})),o.register(s.BATTLE_CALCULATOR_STOP,(function(){u.classList.remove('btn-red'),u.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,nn),a.$on(s.DESTROY_CONTEXT_MENU,on),
...
}})),require(['two/ready','two/battleCalculator','two/battleCalculator/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a(),t.run()}))})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,p,g,m,_,f,h,b){let v,E,w,T=injector.get('buildingService'),A=injector.get('premiumActionService'),y=injector.get('buildingQueueService'),S=!1,I=!1;const k={};let x,R,M,L,O,N=!0;const C='builder_queue_log',D='builder_queue_settings',P=function(){const e=G();if(!N)return j.stop(),!1;e.forEach((function(e){const t=R.getVillage(e),a=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void B(t))}))},z=function(){
G().forEach((function(e){const t=R.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){y.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=O[r.GROUP_VILLAGES];let a=[];return e?(a=x.getGroupVillageIds(e),a=a.filter((function(e){return R.getVillage(e)}))):t.each(R.getVillages(),(function(e){a.push(e.getId())})),a},B=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(k);const i=O[r.BUILDING_SEQUENCES][O[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),F(t))return!1;i.some((function(a){if(++n[a]>t[a])return T.compute(e),U(e,a,(function(t,a){t&&a.job&&(f.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),W(e.getId(),a.job))})),!0}))},U=function(e,t,a){const n=q(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&O[r.PRIORIZE_FARM]){const t=w[m.FARM]
;e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-O[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-O[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-O[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},F=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},W=function(e,t){let a={time:b.gameTime(),villageId:e,building:t.building,level:t.level};return M.unshift(a),M.length>500&&M.splice(M.length-500,M.length),h.set(C,M),!0};let j={};return j.start=function(){if(!N)return f.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,v=setInterval(P,6e4),E=setInterval(z,6e3),e((function(){G().forEach((function(e){
const t=R.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),P(),z()}),['all_villages_ready']),f.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){I=!1,clearInterval(v),clearInterval(E),f.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return I},j.isInitialized=function(){return S},j.getSettings=function(){return L},j.getLogs=function(){return M},j.clearLogs=function(){M=[],h.set(C,M),f.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=O[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,L.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),f.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=O[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=i.getGameData().getBuildings();for(let a=0;a<e.length;a++){let n=e[a];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(a[e]=t,L.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),
f.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=O[r.BUILDING_SEQUENCES];if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],L.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),f.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){S=!0,M=h.get(C,[],!0),R=i.getSelectedCharacter(),x=i.getGroupList(),L=new n({settingsMap:c,storageKey:D}),L.onChange((function(e,t,a){O=L.getAll(),I&&t[d.ANALYSE]&&P(),a.quiet||f.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),O=L.getAll();for(let e in m)k[m[e]]=0;N=Object.keys(O[r.BUILDING_SEQUENCES]).length,w=!!N&&function(e){const t=O[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(O[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=R.getVillage(t.village_id);B(e)}),1e3)}))},j})),
...
const w=Object.values(c),T=Object.values(a),A=Object.values(E),y=Object.values(v),S=Object.values(b);let I,k=[],x={},R=[],M=[],L=!1;const O={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===i.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),i=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!i.includes(e))return a=!1,!0})),a}},N=function(e){return e<g.gameTime()+I},C=function(e){k.push(e)},D=function(e){x[e.id]=e},P=function(){
f.set(d.QUEUE_COMMANDS,k)},z=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return h.call(e,'x')&&h.call(e,'y')&&z(e.x)&&z(e.y)};let B={initialized:!1};return B.init=function(){I=t.getTimeOffset(),B.initialized=!0,R=f.get(d.QUEUE_SENT,[],!0),M=f.get(d.QUEUE_EXPIRED,[],!0),function(){const e=f.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?B.expireCommand(e,n.TIME_LIMIT):(C(e),D(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!N(e.sendTime))return!0;L?B.sendCommand(e):B.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){L&&k.length&&(e.returnValue=!0)}))},B.sendCommand=function(e){const a=function(e){const a=i.getVillages()[e.origin.id];if(!a)return n.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=n.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return B.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){R.push(e)}(e),f.set(d.QUEUE_SENT,R),B.removeCommand(e,n.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},B.expireCommand=function(e,t){!function(e){M.push(e)}(e),f.set(d.QUEUE_EXPIRED,M),B.removeCommand(e,t)},B.addCommand=function(e,n,o,l,s,r,d,p){let m={},f={};return new Promise((function(h,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(n))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!y.includes(t))return!1;r[t]&&(f[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||i.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&f[v.SUPPORTER]&&delete f[v.SUPPORTER],'string'!=typeof p||S.includes(p)?(p=!(d!==c.ATTACK||!m[E.CATAPULT])&&(p||b.HEADQUARTER),T.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(i){if(e=i[0],n=i[1],!e)return I(u.INVALID_ORIGIN);if(!n)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,n,m,d,f,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(N(c))return I(u.ALREADY_SENT);const b={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:n,date:o,dateType:l,units:m,officers:f,type:d,catapultTarget:p,countdown:c-g.gameTime()};C(b),D(b),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
P(),h(b)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},B.removeCommand=function(e,t){delete x[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),P(),!0}));if(a)switch(t){case n.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},B.clearRegisters=function(){f.set(d.QUEUE_EXPIRED,[]),f.set(d.QUEUE_SENT,[]),M=[],R=[]},B.start=function(e){L=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},B.stop=function(){L=!1,p.trigger(s.COMMAND_QUEUE_STOP)},B.isRunning=function(){return L},B.getWaitingCommands=function(){return k},B.getWaitingCommandsObject=function(){return x},B.getSentCommands=function(){return R},
...
t&&(w.filtersData[u.ALLOWED_TYPES][e]=!w.filtersData[u.ALLOWED_TYPES][e]),ee()},fe=function(){w.activeFilters[u.TEXT_MATCH]=w.filtersData[u.TEXT_MATCH].length>0,ee()},he={updatePresets:function(){w.presets=o.obj2selectOptions(R.getPresets())},autoCompleteSelected:function(e,t,a,n){if('commandqueue_village_search'!==t)return!1;S[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},w.searchQuery[n]=''},removeCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(w.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){w.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){S.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){S.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{b.timer.remove(e.updateCountdown)})}},be=function(){const e=E.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;w=a.$new(),w.selectedTab=O,w.inventory=i.getInventory(),w.presets=o.obj2selectOptions(R.getPresets()),w.travelTimes={},o.each(p,(function(e){w.travelTimes[e]={},o.each(B,(function(t,a){w.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=y,w.officers=I.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=v.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),w.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:he.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:he.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!S.units.catapult,w.attackableBuildings=P,w.commandData=S,
...
w.$watch('selectedTab',(function(){w.selectedTab===L.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),w.waitingCommands.forEach(e=>{Z(e)});let f=new n('twoverflow_queue_window',(function(){clearInterval(_),he.clearCountdownUpdates()}));f.register(s.ARMY_PRESET_UPDATE,he.updatePresets,!0),f.register(s.ARMY_PRESET_DELETED,he.updatePresets,!0),f.register(s.SELECT_SELECTED,he.autoCompleteSelected,!0),f.register(s.COMMAND_QUEUE_REMOVE,he.removeCommand),f.register(s.COMMAND_QUEUE_REMOVE_ERROR,he.removeError),f.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,he.sendTimeLimit),f.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,he.sendNotOwnVillage),f.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,he.sendNoUnitsEnough),f.register(s.COMMAND_QUEUE_SEND,he.sendCommand),f.register(s.COMMAND_QUEUE_START,he.start),f.register(s.COMMAND_QUEUE_STOP,he.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){A=i.getSelectedCharacter(),N=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)P.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});y=angular.copy(k),y.splice(y.indexOf('catapult'),1),k.forEach((function(e){z[e]=0})),x.forEach((function(e){G[e]=!1})),S={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(z),officers:angular.copy(G),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},D={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},T=e.addMenuButton('Generał',20),T.addEventListener('click',be),f.register(s.COMMAND_QUEUE_START,(function(){T.classList.remove('btn-orange'),T.classList.add('btn-red')})),f.register(s.COMMAND_QUEUE_STOP,(function(){T.classList.remove('btn-red'),T.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
!0):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,w.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),Ee(),this.onCycleEndFn(e),this.onCycleEndFn=f},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;ve();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const f=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return a(n.USER_STOP);t()},_.randomSeconds(Te())):t()}),b=()=>new Promise((e,a)=>{const i=50-x[r.PRESERVE_COMMAND_SLOTS];t.length>=i?a(n.COMMAND_LIMIT):e()}),y=()=>new Promise((e,t)=>{if(x[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),i=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===i))return t(n.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(n.NO_TARGETS)),k=()=>new Promise((e,t)=>{S.getTownAtAsync(a.x,a.y,i=>{if(te.points(i.points))return t(n.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},i=>{this.running?null!==a.character_id||null===i.owner_id||P.includes(a.id)?a.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),R=()=>new Promise((e,t)=>{!function(e,t){const a=i.getPresetList().getPresetsByVillageId(e);let n=[];if(B.forEach((function(e){h.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)h.call(a,e)&&n.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),L=()=>new Promise((e,t)=>{const i=this.village.getUnitInfo().getUnits(),o=60*x[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=v.actualDistance(l,a);_.each(B,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(n.TIME_LIMIT),!1}),g||t(n.NO_UNITS)}),O=()=>new Promise((e,i)=>{c=!1,p=M.getVillageList();const o=p.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),be(u,c,o))return i(n.BUSY_TARGET);o&&(m=!0),e()}),N=()=>new Promise((e,t)=>{if(!u&&!c)return e();const i=60*x[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(x[r.TARGET_SINGLE_ATTACK]&&!x[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(E.gameTime()/1e3),l=x[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=v.actualDistance(s,a),_=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),f=d.getTravelTimeForDistance(g,_,m,T.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+f-e.time_completed)<i)}))return t(n.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(n.USER_STOP);const i=a.commands.own.filter(e=>e.type===T.TYPES.ATTACK&&'forward'===e.direction),o=i.some(e=>e.start_village_id!==this.villageId),l=i.some(e=>e.start_village_id===this.villageId);if(be(l,o,!0))return t(n.BUSY_TARGET);e()})});let D=new Promise((e,t)=>{f().then(b).then(y).then(I).then(k).then(R).then(L).then(O).then(N).then(C).then(e).catch(t)}),z=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([D,z]).then(()=>{if(!this.running)return!1
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,u,f,h,b,v,E,w){let T,A,y,S=i.getPresetList(),I=i.getGroupList(),k={},x={},R=null;const M={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},L=function(){const e=T.pagination.offset,t=T.pagination.limit;T.visibleLogs=T.logs.slice(e,e+t),T.pagination.count=T.logs.length,T.visibleLogs.forEach((function(e){e.villageId&&O(e.villageId),e.targetId&&O(e.targetId)}))},O=function(e){if(k[e])return k[e];k[e]=!0,x[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},x[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},N=function(){
T.exceptionVillages.included.forEach((function(e){O(e)})),T.exceptionVillages.ignored.forEach((function(e){O(e)}))},C=function(){t.isRunning()?t.stop():t.start()},D=function(e){T.selectedTab=e},P=function(){A.setAll(A.decode(T.settings)),T.saveButtonColor='orange',v.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},z=function(e){const t=A.get(f.GROUP_IGNORE);if(!i.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(f.GROUP_INCLUDE).forEach((function(t){i.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},B=function(){T.presets=h.encodeList(S.getPresets(),{disabled:!1,type:'presets'})},U=function(){T.groups=h.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),T.groupsWithDisabled=h.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},V=function(){T.running=!0,
v.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(T.running=!1,T.showCycleTimer=!1,clearInterval(R),t.reason){case d.NO_PRESETS:v.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:v.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},F=function(){T.logs=angular.copy(t.getLogs()),L(),T.logs.length||v.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},W=function(){T.farmers=t.getFarmers()},j=function(){T.exceptionVillages=t.getExceptionVillages(),N()},Y=function(){T.exceptionLogs=t.getExceptionLogs()},H=function(){T.showCycleTimer=!1,clearInterval(R)},Q=function(e,a){a!==n.USER_STOP&&(T.showCycleTimer=!0,T.nextCycleCountdown=t.getCycleInterval(),R=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))},K=function(){let e=!0;T=a.$new(),T.SETTINGS=f,T.TAB_TYPES=M,T.LOG_TYPES=u,T.running=t.isRunning(),T.selectedTab=M.SETTINGS,T.farmers=t.getFarmers(),
T.villagesLabel=x,T.villagesInfo=k,T.exceptionVillages=t.getExceptionVillages(),T.exceptionLogs=t.getExceptionLogs(),T.logs=t.getLogs(),T.visibleLogs=[],T.showCycleTimer=!1,T.nextCycleCountdown=0,T.saveButtonColor='orange',T.settingsMap=A.settingsMap,T.pagination={count:T.logs.length,offset:0,loader:L,limit:m.getPaginationLimit()},A.injectScope(T),B(),U(),L(),N(),function(){let e=t.getNextCycleDate();e&&(T.showCycleTimer=!0,T.nextCycleCountdown=e-w.gameTime(),R=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))}(),T.switchFarm=C,T.selectTab=D,T.saveSettings=P,T.clearLogs=t.clearLogs,T.jumpToVillage=p.jumpToVillage,T.openVillageInfo=r.openVillageInfo,T.showReport=_.showReport,T.removeIgnored=z,T.removeIncluded=G;let n=new b('twoverflow_farm_overflow_window',(function(){clearInterval(R)}));n.register(s.ARMY_PRESET_UPDATE,B,!0),n.register(s.ARMY_PRESET_DELETED,B,!0),n.register(s.GROUPS_UPDATED,U,!0),n.register(s.GROUPS_CREATED,U,!0),n.register(s.GROUPS_DESTROYED,U,!0),
n.register(s.FARM_OVERFLOW_START,V),n.register(s.FARM_OVERFLOW_STOP,q),n.register(s.FARM_OVERFLOW_LOGS_UPDATED,F),n.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,W),n.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),n.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),n.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),n.register(s.FARM_OVERFLOW_CYCLE_END,Q),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',T),T.$watch('settings',(function(){e||(T.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),y=e.addMenuButton('Farmer',10),y.addEventListener('click',(function(){K()})),E.register(s.FARM_OVERFLOW_START,(function(){y.classList.remove('btn-orange'),y.classList.add('btn-red')})),E.register(s.FARM_OVERFLOW_STOP,(function(){y.classList.remove('btn-red'),y.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,r,c,d,u,g,m,_,f,b,v,E,w,T,A){let y,S,I,k,x,R,M,L,O,N,C,D,P,z,G,B,U,V,q,F,W,j,Y,H=!1,Q={},K={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/S)%2&&(t+=k),t-=t%S,a-=a%S,{x:Math.ceil((t-O.width/2)/S),y:Math.ceil((a-O.height/2)/S)}},fe=function(e,t){return{x:e/T.TILESIZE.x,y:t/T.TILESIZE.y/T.TILESIZE.off}},he=function(){Ae(x)},be=function(){if(H){const e={x:ee.x-O.width/2,y:ee.y-O.height/2};N.clearRect(0,0,O.width,O.height),z.clearRect(0,0,P.width,P.height),function(e){N.drawImage(C,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*S-e.x,n=(t.y-2)*S-e.y;z.fillStyle=Y[o.COLOR_VIEW_REFERENCE],z.fillRect(a,0,1,I),z.fillRect(0,n,I,1);const i=B.getBoundingClientRect(),l=i.width/T.TILESIZE.x/A.view.z*S,s=i.height/T.TILESIZE.y/A.view.z*S,r=a-l/2,c=n-s/2;z.clearRect(r,c,l,s),z.beginPath(),z.lineWidth=1,z.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],z.rect(r,c,l,s),z.stroke()}(e)}e.requestAnimationFrame(be)
},ve=function(){if(!ne)return!1;const e=K.village[M][L];we(e?K.character[e]:[[M,L]]),ne=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:M,y:L})},Ee=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}Ae(t)},Te=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in Q.character?Q.character[e.character_id]:e.tribe_id in Q.tribe&&Q.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&F.barbarian;if(e.character_id===V){if(e.id===R.getId()&&Y[o.HIGHLIGHT_SELECTED])return F.selected;if(e.character_id in Q.character)return Q.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return F.player}else{if(e.character_id in Q.character)return Q.character[e.character_id];if(e.tribe_id in Q.tribe)return Q.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return F.tribe;if(W&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(W.isAlly(e.tribe_id))return F.ally;if(W.isEnemy(e.tribe_id))return F.enemy;if(W.isNAP(e.tribe_id))return F.friendly}}return F.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||Te(n);if(!i)continue;const o=n.x*S+(n.y%2?k:0),l=n.y*S;D.fillStyle=i,D.fillRect(o,l,y,y)}},ye=function(){y=oe[Y[o.MAP_SIZE]],k=Math.round(y/2),S=y+1,I=1e3*S,J.a=Z.a*S,J.b=Z.b*S,$.a=X.a*S,$.b=X.b*S,C.width=1e3*S,C.height=1e3*S,D.imageSmoothingEnabled=!1},Se=function(){const e=document.body.clientHeight-265;O.width=686,O.height=e,P.width=686,P.height=e,N.imageSmoothingEnabled=!1,z.imageSmoothingEnabled=!1},Ie=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[M,L,e]),3===e.which&&(a=M,n=L,f.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
...
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Me=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Le=function(e){return e.preventDefault(),!1},Oe=function(){Q.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},Q.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},he()},Ne=function(){const e={id:R.getId(),x:R.getX(),y:R.getY()};R=U.getSelectedVillage(),Ae([{character_id:U.getId(),id:e.id,x:e.x,y:e.y},{character_id:U.getId(),id:R.getId(),x:R.getX(),y:R.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&h.call(Q,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;Q[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(n,Q[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),he(),!0},removeHighlight:function(e,t){if(void 0===t||!h.call(Q,e))return!1;if(!h.call(Q[e],t))return!1;delete Q[e][t]
;const n='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(n,Q[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),he(),!0},getHighlight:function(e,t){return!!h.call(Q[e],t)&&Q[e][t]},getHighlights:function(){return Q},eachHighlight:function(e){for(let t in Q)for(let a in Q[t])e(t,a,Q[t][a])},setViewport:function(e){O=e,O.style.background=Y[o.COLOR_BACKGROUND],N=O.getContext('2d')},setViewportRef:function(e){P=e,z=P.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*S,ee.y=t*S,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=f.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=fe(e[0]*t,e[1]*t),n=fe(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return j},Ce.drawMinimap=function(){ge&&(ge=!1),O.style.background=Y[o.COLOR_BACKGROUND],D.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=v.getPath(T.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){D.fillStyle=Y[o.COLOR_CONTINENT],D.fillRect(e*S+k-1,t*S+k-1,3,1),D.fillRect(e*S+k,t*S+k-2,1,3)},i=function(e,t){D.fillStyle=Y[o.COLOR_PROVINCE],D.fillRect(e*S+k,t*S+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=b.toTile(o,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&i(e,l))}const r=l.a*S,c=s.a*S,d=(l.b-l.a)*S,u=(s.b-s.a)*S;D.beginPath(),D.lineWidth=2,D.strokeStyle="#2B4700",D.rect(r,c,d,u),D.stroke()}))}(),he()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),D=C.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ie}),j.onChange((function(e,t){
Y=j.getAll(),ye(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),Y=j.getAll(),Q.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},Q.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},ye()},Ce.run=function(){d((function(){B=document.getElementById('map'),G=document.getElementById('main-canvas'),U=i.getSelectedCharacter(),W=U.getTribeRelations(),V=U.getId(),q=U.getTribeId(),F=U.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),Se(),R=U.getSelectedVillage(),te.x=R.getX(),te.y=R.getY(),ee.x=R.getX()*S,ee.y=R.getY()*S,e.addEventListener('resize',Se,!1),P.addEventListener('mousedown',Ie),P.addEventListener('mouseup',ke),P.addEventListener('mousemove',xe),P.addEventListener('mouseleave',Re),P.addEventListener('click',Me),P.addEventListener('contextmenu',Le),g.load((function(){x=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in K.village||(K.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
K.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in K.character?K.character[a.character_id].push([a.x,a.y]):K.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in K.tribe?K.tribe[a.tribe_id].push(a.character_id):K.tribe[a.tribe_id]=[a.character_id])))}}(x),function(){let e=[],t=[];for(let a in K.village){e.push(a);for(let e in K.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*S,J.b=Z.b*S,$.a=X.a*S,$.b=X.b*S}(),be(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ne),a.$on(s.TRIBE_RELATION_CHANGED,he),a.$on(s.GROUPS_VILLAGES_CHANGED,Oe)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,_,f,h,b,v,E,w){let T,A,y,S,I,k,x,R,M,L,O,N={},C=!1,D={character:{},tribe:{}};const P={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=P.MINIMAP,G=function(e){T.selectedTab=e,e===P.MINIMAP?i.enableRendering():i.disableRendering()},B=function(){Object.keys(T.highlights.character).forEach((function(e){e in D.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
