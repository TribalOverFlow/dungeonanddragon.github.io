...
message:g}),a=[])}},y=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y},s=[];return h.forEach((function(a){i[a]=1,s.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(s=s.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},R={init:function(){d=!0},start:function(){e.trigger(l.ALERT_SENDER_STARTED),u=!0,v()},stop:function(){e.trigger(l.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return R})),define('two/alertSender/events',[],(function(){angular.extend(l,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',50,g('i18n')('description',a.loc.ale,'alert_sender')),
...
c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Administrator',70),T.addEventListener('click',A),
...
c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/autoHealer/events',[],(function(){angular.extend(l,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Medyk',90,g('i18n')('description',a.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_healer')))})),n.register(l.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.AUTO_HEALER_STARTED),opener}})),
...
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},w.stop=function(){i.trigger(l.FAITH_CHECKER_STOPPED),f=!1},w.isRunning=function(){return f},w.isInitialized=function(){return b},w})),define('two/faithChecker/events',[],(function(){angular.extend(l,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(l.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
S(),u.selectTab=b,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_fake_sender_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,S,!0),e.register(l.GROUPS_DESTROYED,S,!0),e.register(l.GROUPS_UPDATED,S,!0),e.register(l.FAKE_SENDER_START,h),e.register(l.FAKE_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Watażka',100),g.addEventListener('click',A),
...
c.getScreenWithInjectedScope('!twoverflow_king_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Marszałek',90),g.addEventListener('click',A),
...
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),G.stop()},G.stop=function(){e.trigger(l.PRESET_CREATOR_STOPPED),r=!1},G.isRunning=function(){return r},G.isInitialized=function(){return i},G})),define('two/presetCreator/events',[],(function(){angular.extend(l,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wojewoda',100,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator'))):(t.start(),
