...
fakesend2:"Cel-określona wioska",send:"Wyślij",change:"Zmień",interval:"Przedział minutowy (od czasu początkowego w przód)",intervalT:"1-60",intervalP:"Liczba minut","no-targetP":"Uzupełnij najpierw ID gracza!","no-targetV":"Uzupełnij najpierw ID wioski!","no-presets":"Brak szablonów do fejkowania!","no-villages":"Brak przypisanych wiosek do wskazanego szablonu!",sending:"Wysyła karete fejkową na 4 różne wioski wroga z każdej twojej wioski(z przypisanym szablonem)-zabiera 16 rozkazów z wioski.",sending1:"Wysyła jeden atak fejkowy na 6 różnych wioske z każdej twojej wioski(z przypisanym szablonem)-zabiera 6 rozkazów z wioski.",sending2:"Wysyła jeden atak fejkowy na wskazaną wioskę z kazdej twojej wioski(z przypisanym szablonem)- zabiera 1 rozkaz z wioski.",renaming:"Zmienia nazwy wszystkich wiosek na nową.","rename-done":"Przemianowanie w toku","entry/id":"Gracz","entry/vid":"Wioska",origin:"Wioska pochodzenia",target:"Wioska cel",preset:"Szablon",date:"Data",
"logs.noFakes":"Brak wykonanych działań",clear:"Wyczyść",start:"Start",logs:"Logi","general.started":"Watażka uruchomiony","general.stopped":"Watażka zatrzymany","logs.clear":"Wyczyść logi","entry/name":"Nowa nazwa"},farm_overflow:{title:"Farmer",open_report:"Otwórz raport",no_report:"Nie ma raportu",reports:"Raporty",date:"Data",status_time_limit:"Cel jest zbyt daleko",status_command_limit:"Limit poleceń",status_full_storage:"Magazyn jest pełny",status_no_units:"Brak dostępnych jednostek",status_abandoned_conquered:"Porzucone podbicie",status_protected_village:"Cel jest chroniony",status_busy_target:"Cel jest atakowany",status_no_targets:"Brak dostępnych celów",status_target_cycle_end:"Cykl wysyłania zakończony",status_not_allowed_points:"Punkty celu niedozwolone",status_unknown:"Nieznany status",status_attacking:"Atakuje",status_waiting_cycle:"Oczekuje",status_user_stop:"",status_expired_step:"",not_loaded:"Nie załadowany.",ignored_targets:"Ignorowane cele",
...
const t=new Date(e||f.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=f.zerofill(a-a%100,3),n=f.zerofill(t.getSeconds(),2),s=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+s+':'+n+':'+i+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(h.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!h.isValidDate&&o.getTimeFromString(y.date),t=h.selectedDateType.value===s.ARRIVE;o.each(p,(function(a){o.each(D,(function(i,n){const s=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);h.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(s),h.travelTimes[a][n].status=e?Y(t?e-s:e):'neutral'}))}))},Y=function(e){return e&&h.isValidDate?f.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=h.selectedDateType.value,_.set(m.LAST_DATE_TYPE,h.selectedDateType.value),F()},K=function(){
...
},we=function(){if(!ie)return!1;const e=Q.village[O][N];he(e?Q.character[e]:[[O,N]]),ie=!1,m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},_e=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},ve=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
