...
description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},army_helper:{title:"Administrator",presets:"Szablony","presets.asign":"Przypisz","presets.all":"Wszystkie szablony","presets.textall":"Przypisz wszystkie szablony do wszystkich wiosek.","presets.name":"Szablony z nazwą","presets.textname":"Przypisz szablony zawierające wskazaną frazę do wszystkich wiosek.","presets.or":"Lub wybierz z listy","presets.group":"Szablony do grupy","presets.textgroup":"Przypisz wszystkie szablony do wybranej grupy wiosek.","presets.name-group":"Szablony - zaawansowane przypisywanie","presets.textname-group":"Przypisz szablony zawierające wskazaną fraze do wybranej grupy wiosek.","presets.name-placeholder":"Wpisz frazę",army:"Wojsko","army.header":"Sprawdź ilość jednostek w wioskach","army.check":"Zlicz","army.troops":"Wojsko","army.unit":"Jednostka","army.available":"Dostępne",
"army.own":"Posiadane","army.in-town":"W wioskach","army.support":"Wsparcie","army.recruiting":"Rekrutacja","army.total":"Wszystko","army.deffensive":"Defensywne jednostki","army.offensive":"Ofensywne jednostki","army.special-troops":"Specjalne jednostki",balancer:"Balanser","balancer.balance":"Balansuj","balancer.all":"Wszystkie typy wojsk","balancer.textall":"Zbalansuj po równo całe swoje wojsko.","balancer.unit":"Jednostka","balancer.textunit":"Zbalansuj po równo wojska danego typu.","balancer.group":"Grupa","balancer.textgroup":"Zbalansuj po równo wojska w danej grupie wiosek.","balancer.unit-group":"Grupa/Jednostka","balancer.textunit-group":"Zbalansuj po równo wojska w danej grupie wiosek dany typ jednostki.(np miecznik w grupie Deff)",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",
snob:"Szlachcic",knight:"Rycerz"},attack_view:{title:"Strażnik",filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",commands_copy_arrival_tooltip:"Kopiuj czas dotarcia.",commands_copy_backtime_tooltip:"Kopiuj czas powrotu.",commands_set_remove_tooltip:"Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazów.",command_type_tooltip:"Rodzaj",slowest_unit_tooltip:"Najwolniejsza jednostka",command_type:"Rodzaj",slowest_unit:"Co?",actions:"Dostępne akcje",no_incoming:"Brak nadchodzących wojsk.",copy:"Kopiuj",current_only_tooltip:"Tylko aktywna wioska",arrive:"Dotrze",arrivetime:"Czas dotarcia skopiowany!",backtime:"Czas powrotu skopiowany!",spyorigin:"Szpiedzy wysłani do %{name}!",commands_kill_nobleman_tooltip:"Wstaw rozkaz klinowania do Kolejki rozkazów. MAŁY KLIN.",
commands_kill_noblemanBig_tooltip:"Wstaw rozkaz klinowania do Kolejki rozkazów. DUŻY KLIN.",commands_bunker_village_tooltip:"Zabunkruj wioske z wojsk znajdujących się na najbliższych twoich wioskach które zdążą przed atakiem. Uwaga! robisz to na własną odpowiedzialność.",commands_spy_village_tooltip:"Szpieguj wioske źródłową.",commands_withdraw_army_tooltip:"Wycofaj wszystkie wsparcia sekundę przed wejsciem tego ataku."},auto_collector:{title:"Kolekcjoner",description:"Automatyczny kolekcjoner depozytu/drugiej wioski.",activated:"Kolekcjoner aktywowany",deactivated:"Kolekcjoner deaktywowany"},auto_foundator:{title:"Fundator",description:"Automatycznie wykonuje darowizny na plemie co jedną godzinę 2% z wszystkich wiosek.",activated:"Fundator aktywowany",deactivated:"Fundator skończył działanie"},auto_healer:{title:"Medyk",description:"Automatycznie przywraca uzdrowione jednostki ze szpitala.",activated:"Medyk aktywowany",deactivated:"Medyk skończył działanie"},auto_withdraw:{
title:"Dezerter",description:"Automatycznie wycofuje wojska przed nadchodzącymi atakami jeśli to nie szlachcic lub trebuchet.",activated:"Dezerter aktywowany",deactivated:"Dezerter skończył działanie"},battle_calculator:{title:"Kalkulator",battle:"Bitwa","battle.simulate":"Symuluj","battle.predamage":"Uszkodzenia wstępne","battle.bonuses":"Modyfikatory bitewne","battle.options":"Szybkie opcje","battle.header":"Kalkulator bitewny","battle.id":"Wioska","battle.killrateA":"Procent strat","battle.attackBashpoint":"Ofensywne punkty bojowe","battle.strentghAttack":"Siła bojowa off","battle.killrateD":"Procent strat","battle.defenceBashpoint":"Defensywne punkty bojowe","battle.strentghDefend":"Siła bojowa deff","battle.attackModifier":"Modyfikator ataku","battle.defenceModifier":"Modyfikator obrony","battle.provisions":"Całkowity prowiant","battle.killedprovisions":"Prowiant stracony","battle.doublestrength":"Szał berków?","battle.strongesttype":"Najwięcej wojsk typu",
...
return m.actualDistance(t,e)-m.actualDistance(t,a)}))},z=function(e,t){let a=0;if(E.hasTownDataInChunk(e.x,e.y)){const a=E.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let s,l=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=G(r,e);else if(c.length)s=G(c,e);else{if(!i)return t(!1);{const a=l.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);s=G(a,e)}}return t(s[0])}const i=T.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&z(e,t)}))},D=function(e){h=e.commands;for(let e=0;e<h.length;e++)w.formatCommand(h[e]),h[e].slowestUnit=U(h[e]);h=h.filter((function(e){return v[c.INCOMING_UNITS][e.slowestUnit]})),b.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[h])};let B={
loadCommands:function(){const e=_.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:R[c.COMMAND_TYPES],villages:R[c.VILLAGE]},D)},getCommands:function(){return h},getFilters:function(){return v},getSortings:function(){return y},toggleFilter:function(e,t){t?v[e][t]=!v[e][t]:v[e]=!v[e],x(),g.set(I,v),B.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),B.loadCommands()},setCommander:function(e,a){z(e.targetVillage,(function(i){const n=e.targetVillage,o=i,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){l[e]='*'})),S.addCommand(n,o,a,f.OUT,l,{},s,p.WALL),S.isRunning()||S.start()}))},commandQueueEnabled:function(){return!!S},isInitialized:function(){return A},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)O[r[e]]=!0;try{S=require('two/commandQueue'),
...
t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(l.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(l.BUILDER_QUEUE_START,K.started),t.register(l.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',S),M=S.closeWindow,S.closeWindow=j,S.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),S.$watch('editorView.selectedSequence.value',(function(e,t){z?z=!1:e!==t&&(G?H((function(){K.generateBuildingSequencesEditor(),G=!1}),(function(){S.editorView.selectedSequence={name:t,value:t},z=!0})):K.generateBuildingSequencesEditor())}))};return function(){R=n.getGameData().getBuildings(),N.generateBuildingsLevelPoints(),y=i.getSettings(),v=e.addMenuButton2('Budowniczy',20),v.addEventListener('click',Q),w.register(l.BUILDER_QUEUE_START,(function(){O=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),
...
E.set(d.QUEUE_COMMANDS,I)},G=function(e){return!isNaN(e)&&e>0&&e<1e3},z=function(e){return b.call(e,'x')&&b.call(e,'y')&&G(e.x)&&G(e.y)};let D={initialized:!1};return D.init=function(){y=t.getTimeOffset(),D.initialized=!0,O=E.get(d.QUEUE_SENT,[],!0),x=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?D.expireCommand(e,i.TIME_LIMIT):(M(e),C(e))}))}(),setInterval((function(){I.length&&I.some((function(e){if(!P(e.sendTime))return!0;N?D.sendCommand(e):D.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&I.length&&(e.returnValue=!0)}))},D.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let s={},l=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return l=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return l=i.NOT_ENOUGH_UNITS,!1;s[t]=e})),angular.equals({},s)&&(l=i.NOT_ENOUGH_UNITS),l||s}(e);if('string'==typeof a)return D.expireCommand(e,a);e.units=a,o.emit(s.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){O.push(e)}(e),E.set(d.QUEUE_SENT,O),D.removeCommand(e,i.COMMAND_SENT),p.trigger(l.COMMAND_QUEUE_SEND,e)},D.expireCommand=function(e,t){!function(e){x.push(e)}(e),E.set(d.QUEUE_EXPIRED,x),D.removeCommand(e,t)},D.addCommand=function(e,i,o,s,l,r,d,p){let m={},E={};return new Promise((function(b,y){if(!z(e))return y(u.INVALID_ORIGIN);if(!z(i))return y(u.INVALID_TARGET);if(!t.isValidDateTime(o))return y(u.INVALID_DATE);if(angular.isObject(l)){if(!t.each(l,(function(e,t){if(!S.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(u.INVALID_UNIT_TYPE)}
...
;const t=y.getAttackableBuildings();for(let e in t)U.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});v=angular.copy(I),v.splice(v.indexOf('catapult'),1),I.forEach((function(e){G[e]=0})),k.forEach((function(e){z[e]=!1})),R={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(G),officers:angular.copy(z),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},C={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},h=e.addMenuButton('Generał',10),h.addEventListener('click',_e),E.register(l.COMMAND_QUEUE_START,(function(){h.classList.remove('btn-orange'),h.classList.add('btn-red')})),E.register(l.COMMAND_QUEUE_STOP,(function(){h.classList.remove('btn-red'),h.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,V),a.$on(l.DESTROY_CONTEXT_MENU,W),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,T,E,_,f,A,w,h,S){let v,R,y,I,k,O,x,N,L,P,M,C,U,G,z,D,B,V,W,q,Y,F,H,j=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/R)%2&&(t+=I),t-=t%R,a-=a%R,{x:Math.ceil((t-L.width/2)/R),y:Math.ceil((a-L.height/2)/R)}},Ee=function(e,t){return{x:e/h.TILESIZE.x,y:t/h.TILESIZE.y/h.TILESIZE.off}},be=function(){Se(k)},_e=function(){if(j){const e={x:ee.x-L.width/2,y:ee.y-L.height/2};P.clearRect(0,0,L.width,L.height),G.clearRect(0,0,U.width,U.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),H[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*R-e.x,i=(t.y-2)*R-e.y;G.fillStyle=H[o.COLOR_VIEW_REFERENCE],G.fillRect(a,0,1,y),G.fillRect(0,i,y,1);const n=D.getBoundingClientRect(),s=n.width/h.TILESIZE.x/S.view.z*R,l=n.height/h.TILESIZE.y/S.view.z*R,r=a-s/2,c=i-l/2;G.clearRect(r,c,s,l),G.beginPath(),G.lineWidth=1,G.strokeStyle=H[o.COLOR_VIEW_REFERENCE],G.rect(r,c,s,l),G.stroke()}(e)}e.requestAnimationFrame(_e)},fe=function(){if(!ie)return!1;const e=Q.village[x][N];we(e?Q.character[e]:[[x,N]]),ie=!1,
...
c.getScreenWithInjectedScope('!twoverflow_minimap_window',h),D(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(v),y.appendChild(R),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){L=n.getSettings(),I=i.getSharedData('MapController'),v=document.createElement('canvas'),v.className='minimap',R=document.createElement('canvas'),R.className='cross',n.setViewport(v),n.setViewportRef(R),x=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),O=document.querySelector('#map'),S=t.addMenuButton4('Minimapa',30),S.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
