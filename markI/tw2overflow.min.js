 ...
 */
!function(e,t){const i=injector.get('$rootScope'),a=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),p=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),E=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const a=i.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),a())})};return t.prototype.register=function(t,a,n){n?this.listeners.push(i.$on(t,a)):(e.register(t,a),this.listeners.push((function(){
e.unregister(t,a)})))},t.prototype.destroy=function(){this.listeners.forEach(e=>{e()}),this.onDestroy()},t})),define('two/utils',['helper/time','helper/math'],(function(e,t){let a={randomSeconds:function(e){if(!e)return 0;const t=(e=parseInt(e,10))+e/2,i=e-e/2;return Math.round(Math.random()*(t-i)+i)},time2seconds:function(e){return(e=e.split(':'))[0]=60*parseInt(e[0],10)*60,e[1]=60*parseInt(e[1],10),e[2]=parseInt(e[2],10),e.reduce((function(e,t){return e+t}))},notif:function(e,t){i.$broadcast(s.NOTIFICATION_DISABLE),i.$broadcast(s.NOTIFICATION_ENABLE);const a='success'===e?s.MESSAGE_SUCCESS:s.MESSAGE_ERROR;i.$broadcast(a,{message:t})},genVillageLabel:function(e){return e.name+' ('+e.x+'|'+e.y+')'},isValidCoords:function(e){return/\s*\d{2,3}\|\d{2,3}\s*/.test(e)},isValidDateTime:function(e){return/^\s*([01][0-9]|2[0-3]):[0-5]\d:[0-5]\d(:\d{1,3})? (0[1-9]|[12][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/\d{4}\s*$/.test(e)},fixDate:function(e){const t=e.trim().split(' '),i=t[0],a=t[1].split('/')
;return i+' '+a[1]+'/'+a[0]+'/'+a[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const i=a.fixDate(e).split(' '),n=i[0].split(':'),o=i[1].split('/'),l=n[0],s=n[1],r=n[2],c=n[3]||null,d=parseInt(o[0],10)-1,u=o[1],g=o[2];return new Date(g,d,u,l,s,r,c).getTime()+(t||0)},formatDate:function(e,t){return p('readableDateFilter')(e,null,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+i.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(i,a){if(!e)return a();let n=new XMLHttpRequest;n.open('GET',e,!0),n.responseType=t,n.addEventListener('load',(function(){i(n)}),!1),n.send()}))},obj2selectOptions:function(e,t){let i=[];for(let a in e){let n={name:e[a].name,value:e[a].id};t&&(n.leftIcon=e[a].icon),i.push(n)}return i},getTravelTime:function(e,i,a,o,l,s){
const r=!i.character_id,c=i.character_id&&i.tribe_id&&i.tribe_id===n.getSelectedCharacter().getTribeId();!1!==s&&('attack'===o?('supporter'in l&&delete l.supporter,r&&(s=!0)):'support'===o&&(c&&(s=!0),'supporter'in l&&(s=!0)));const u={units:a,officers:angular.copy(l)},g=d.calculateTravelTime(u,{barbarian:r,ownTribe:c,officers:l,effects:s},o),p=t.actualDistance(e,i);return 1e3*d.getTravelTimeForDistance(u,g,p,o)},each:function(e,t){if('function'!=typeof t&&(t=E),Array.isArray(e)){for(let i=0,a=e.length;i<a;i++)if(!1===t(e[i],i))return!1}else if(angular.isObject(e))for(let i in e)if(f.call(e,i)&&!1===t(e[i],i))return!1;return!0}};return a})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let r={};const c=function(d,u){'string'==typeof(u=u||['map'])&&(u=[u]);const g=function(e){(u=u.filter((function(t){return t!==e}))).length||d()},p={map:function(){if(a.getSharedData('MapController').isInitialized)return g('map');i.$on(s.MAP_INITIALIZED,(function(){g('map')}))},
tribe_relations:function(){const e=n.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return g('tribe_relations')}const t=i.$on(s.TRIBE_RELATION_LIST,(function(){t(),g('tribe_relations')}))},initial_village:function(){if(n.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return g('initial_village');i.$on(s.GAME_STATE_INITIAL_VILLAGE_READY,(function(){g('initial_village')}))},all_villages_ready:function(){if(n.getGameState().getGameState(e.ALL_VILLAGES_READY))return g('all_villages_ready');i.$on(s.GAME_STATE_ALL_VILLAGES_READY,(function(){g('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return g('minimap_data');t.load((function(){g('minimap_data')}))},presets:function(){if(n.getPresetList().isLoaded())return g('presets');r.presets=r.presets||new Promise((function(e){o.emit(l.GET_PRESETS,{},e)})),r.presets.then((function(){g('presets')}))},world_config:function(){if(n.getWorldConfig&&n.getWorldConfig())return g('world_config')
...
actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=f.call(o,t)?o[t]:t,e.setJSON(a[t]||a[n])}let s={init:function(){if(t)return!1;t=!0,l(i.loc.ale),i.$watch('loc.ale',(function(e,t){
e!==t&&l(i.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,a){const o=function(e,t){let i={};for(let a in e)f.call(t,a)?angular.equals(e[a],t[a])||(i[a]=t[a]):i[a]=e[a];return!angular.equals({},i)&&i},l=function(){return{name:p('i18n')('disabled',i.loc.ale,'common'),value:!1}},s=function(e,t){let i={};for(let a in t)(e[a].updates||[]).forEach((function(e){i[e]=!0}));return!angular.equals(i,{})&&i};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let i in e)t[i]=e[i].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,a.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return f.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){
a.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,i){if(!f.call(this.settingsMap,e))return!1;const a=this.settingsMap[e];'number'===a.inputType&&(t=parseInt(t,10),f.call(a,'min')&&(t=Math.max(a.min,t)),f.call(a,'max')&&(t=Math.min(a.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(n,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,i||{}),!0},r.prototype.setAll=function(e,t){const i=angular.copy(this.settings);for(let t in e)if(f.call(this.settingsMap,t)){const i=this.settingsMap[t];let a=e[t];'number'===i.inputType&&(a=parseInt(a,10),f.call(i,'min')&&(a=Math.max(i.min,a)),f.call(i,'max')&&(a=Math.min(i.max,a))),this.settings[t]=a}const a=angular.copy(this.settings),n=o(i,a);if(!n)return!1;const l=s(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,l,t||{}),!0},
r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!f.call(this.settingsMap,t))continue;let i=this.settingsMap[t];'checkbox'===i.inputType?e.call(this,t,!!this.settings[t],i):e.call(this,t,this.settings[t],i)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,i){this.injected={$scope:t,opt:i},t.settings=this.encode(i),e.each(this.settingsMap,(function(e,i){'select'===e.inputType&&t.$watch((function(){return t.settings[i]}),(function(a){e.multiSelect?a.length||(t.settings[i]=[l()]):a||(t.settings[i]=l())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const a=n.getPresetList().getPresets(),o=n.getGroupList().getGroups()
;return e=e||{},this.each((function(n,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[n]=r.multiSelect?[l()]:l());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){a[t]&&e.push({name:a[t].name,value:t})})),t[n]=e.length?e:[l()]}else{if(!a[s]&&r.disabledOption)return void(t[n]=l());t[n]={name:a[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[n]=e.length?e:[l()]}else{if(!o[s]&&r.disabledOption)return void(t[n]=l());t[n]={name:o[s].name,value:s}}break;default:t[n]={name:e.textObject?p('i18n')(s,i.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[n]=[t[n]])}}else t[n]=s})),t},r.prototype.decode=function(e){let t={};for(let i in e){let a=this.settingsMap[i];if('select'===a.inputType)if(a.multiSelect)if(1===e[i].length&&!1===e[i][0].value)t[i]=[];else{let a=[];e[i].forEach((function(e){a.push(e.value)})),t[i]=a
}else t[i]=e[i].value;else t[i]=e[i]}return t},r.encodeList=function(e,t){let a=[];switch((t=t||{}).disabled&&a.push(l()),t.type){case'keys':for(let t in e)a.push({name:t,value:t});break;case'groups':for(let t in e){let i=e[t];a.push({name:i.name,value:i.id,leftIcon:i.icon})}break;case'presets':for(let t in e){let i=e[t];a.push({name:i.name,value:i.id})}break;case'values':default:for(let n in e){let o=e[n];a.push({name:t.textObject?p('i18n')(o,i.loc.ale,t.textObject):o,value:o})}}return a},r.disabledOption=l,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],a=[],n=!1,r=!1,c=[];angular.extend(s,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=E,d){if(d)r=!1;else{if(n)return c.push(e);if(r)return e(t)}c.push(e),n=!0;let u=[];for(let e=0;e<a.length;e++)for(let t=0;t<a[e].length;t++)u.push(a[e][t]);let g=[];return u.forEach((function(e){let i=new Promise((function(i,a){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return a(e.message)
;e.villages.length&&(t=t.concat(e.villages)),i()}))}));g.push(i)})),Promise.all(g).then((function(){n=!1,r=!0,i.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),i=Math.ceil(e.MAP_SIZE/306);for(let n=0;n<t;n++){a.push([]);let t=306*n,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<i;l++){let i=306*l,s=306..bound(0,i+306).bound(0,e.MAP_SIZE-i);i=i.bound(0,e.MAP_SIZE),a[n].push({x:t,y:i,width:o,height:s})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,a){let n,o={},l={},r=!1,c=document.querySelector('head'),d=injector.get('httpService'),u=injector.get('templateManagerService'),g=injector.get('$templateCache');return u.load=function(a,n,o){let s;const r=function(e,t,a,o){g.put(s.substr(1),e),angular.isFunction(n)&&n(e,t,a,o),i.$$phase||i.$apply()
},c=function(e,t,i,a){angular.isFunction(o)&&o(e,t,i,a)};s=0!==a.indexOf('!')?e.TEMPLATE_PATH_EXT.join(a):a.substr(1),g.get(s.substr(1))?r(g.get(s.substr(1)),304):t.versionMap[s]?d.get(s,r,c):r(l[s],304)},o.init=function(){if(r)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),i=document.createElement('div');t.className='two-menu-container',e.appendChild(t),i.className='two-main-button',i.style.display='none',t.appendChild(i),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),r=!0,
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map'])})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,i,a){let r;var c=injector.get('overviewService'),d=!1,u=!1,g=n.getSelectedCharacter().getGlobalInfo(),p={reverse:!1,column:'command_progress'},m=n.getSelectedCharacter(),_=m.tribeById[0],E=m.getVillageList(),f=[],b=m.data.character_id,h=m.data.character_name,T=[],w=[],v=[a.LIGHT_CAVALRY,a.HEAVY_CAVALRY,a.AXE,a.SWORD,a.RAM,a.SNOB,a.TREBUCHET];var A=function(){
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:_},(function(e){for(var t=e.members,i=0;i<t.length;i++)w.push(t[i].id)})),E.forEach((function(e){f.push(e.getId())}));var e=g.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:p.column,reverse:p.reverse?1:0,groups:[],command_types:['attack'],villages:f},S),setTimeout(A,6e4)},S=function(e){for(var t,i=[],a=e.commands,n=0;n<a.length;n++)if(c.formatCommand(a[n]),w.includes(a[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+a[n].origin_character_id+' Rodzaj '+a[n].command_type);else if('attack'==a[n].command_type)if(T.includes(a[n].command_id))console.log('Już wysłano powiadomienie');else{T.push(a[n].command_id),a[n].slowestUnit=y(a[n]);var s=a[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',g='';'sword'==a[n].slowestUnit?(g=' [color=03709d]MIECZNIK[/color]',
...
i.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+g+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+a[n].target_village_id+']'+a[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+b+']'+h+'[/player][b] [br]Wioska pochodzenia: [/b][village='+a[n].origin_village_id+']'+a[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+a[n].origin_character_id+']'+a[n].origin_character_name+'[/player][/size]');var p=i.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==h||'halfsack'==h||'Black Rider'==h?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:p}),i=[]):('Hajduk Split'==h||'halfsack'==h||'Black Rider'==h?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4648,message:p}),i=[])}},y=function(e){var i=e.model.duration,a={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y
},l=[];return v.forEach((function(i){a[i]=1,l.push({unit:i,duration:t.getTravelTime(n,o,a,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-i),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},I={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return I})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Wartownik',100,p('i18n')('description',i.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'alert_sender'))):(t.start(),
a.notif('success',p('i18n')('activated',i.loc.ale,'alert_sender')))})),n.register(s.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,i,a,n){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(s.ALERT_SENDER_STARTED,(function(){a.set(o,!0)})),n.register(s.ALERT_SENDER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,a,r,c,d,u,g,p,m,_,E,f){let b,h,T=!1,w=injector.get('overviewService'),v=[],A=!1,S={},y={},I={reverse:!1,column:a.TIME_COMPLETED};const R='attack_view_filters',k={},L={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let i={};for(let t=0;t<e.length;t++)for(let a in S[e[t]])if(i[e[t]]||(i[e[t]]=[]),S[e[t]][a])switch(e[t]){case c.COMMAND_TYPES:a===r.ATTACK?i[e[t]].push(r.ATTACK):a===r.SUPPORT?i[e[t]].push(r.SUPPORT):a===r.RELOCATE&&i[e[t]].push(r.RELOCATE)}y=i,y.village=S[c.VILLAGE]?[t]:[]},N=function(){V.loadCommands()},C=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},x=function(e,t){
for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);f.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);f.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},P=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const i={x:e.origin_x,y:e.origin_y},a={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(i,a,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,i){return m.actualDistance(t,e)-m.actualDistance(t,i)}))},G=function(e,t){let i=0;if(E.hasTownDataInChunk(e.x,e.y)){
const i=E.loadTownData(e.x,e.y,25,25,25),a=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];i.forEach((function(e){for(let t in e.data)for(let i in e.data[t])s.push(e.data[t][i])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!a)return t(!1);{const i=s.filter((function(e){return e.tribe_id===a}));if(!i.length)return t(!1);l=D(i,e)}}return t(l[0])}const a=_.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++i===a.length&&G(e,t)}))},U=function(e){v=e.commands;for(let e=0;e<v.length;e++)w.formatCommand(v[e]),v[e].slowestUnit=z(v[e]);v=v.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[v])};let V={loadCommands:function(){const e=b.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return v},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),p.set(R,S),V.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),V.loadCommands()},setCommander:function(e,i){G(e.targetVillage,(function(a){const n=e.targetVillage,o=a,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,i,h.OUT,s,{},l,g.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return T},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)L[r[e]]=!0;try{A=require('two/commandQueue'),h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),
[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};T=!0,b=n.getSelectedCharacter().getGlobalInfo(),S=p.get(R,t,!0),e((function(){O(),i.$on(s.COMMAND_INCOMING,N),i.$on(s.COMMAND_CANCELLED,C),i.$on(s.MAP_SELECTED_VILLAGE,P),i.$on(s.VILLAGE_NAME_CHANGED,M),i.$on(s.COMMAND_IGNORED,x),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,a,o,l,d,u,_,E,f,b,h){let T,w;const v=function(){return Date.now()/1e3},A=function(e){let t=i.$new();t.text=p('readableDateFilter')(1e3*e,i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=p('i18n')('copy',i.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const a=p('readableDateFilter')(1e3*(e.time_completed-10),i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,a)},y=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},I=function(){const e=T.pagination.offset,t=T.pagination.limit;T.visibleCommands=T.commands.slice(e,e+t),
T.pagination.count=T.commands.length},R=function(){const e=Date.now();for(let t=0;t<T.commands.length;t++)100===T.commands[t].model.percent(e)&&T.commands.splice(t,1);I()},k=function(e,i){t.toggleFilter(e,i),T.filters=t.getFilters()},L=function(e){t.toggleSorting(e),T.sorting=t.getSortings()},O=function(){T.commands=t.getCommands()},N=function(){T.selectedVillageId=n.getSelectedVillage().getId()},C=function(){T=i.$new(),T.commandQueueEnabled=t.commandQueueEnabled(),T.commands=t.getCommands(),T.selectedVillageId=n.getSelectedVillage().getId(),T.filters=t.getFilters(),T.sorting=t.getSortings(),T.UNIT_TYPES=E,T.FILTER_TYPES=u,T.COMMAND_TYPES=d,T.UNIT_SPEED_ORDER=_,T.COLUMN_TYPES=l,T.pagination={count:T.commands.length,offset:0,loader:I,limit:m.getPaginationLimit()},T.openCharacterProfile=r.openCharacterProfile,T.openVillageInfo=r.openVillageInfo,T.jumpToVillage=g.jumpToVillage,T.now=v,T.copyTimeModal=A,T.removeTroops=S,T.switchWindowSize=y,T.toggleFilter=k,T.toggleSorting=L,I()
;let e=new a('twoverflow_queue_window',(function(){b.timer.remove(R)}));e.register(s.MAP_SELECTED_VILLAGE,N,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',T),b.timer.add(R)};return function(){w=e.addMenuButton('Strażnik',40),w.addEventListener('click',C),
...
}})),define('two/attackView/types/columns',[],(function(){return{ORIGIN_VILLAGE:'origin_village_name',COMMAND_TYPE:'command_type',TARGET_VILLAGE:'target_village_name',TIME_COMPLETED:'time_completed',ORIGIN_CHARACTER:'origin_character_name'}})),define('two/attackView/types/commands',[],(function(){return{ATTACK:'attack',SUPPORT:'support',RELOCATE:'relocate'}})),define('two/attackView/types/filters',[],(function(){return{COMMAND_TYPES:'command_types',VILLAGE:'village',INCOMING_UNITS:'incoming_units'}})),define('two/attackView/unitSpeedOrder',['conf/unitTypes'],(function(e){return[e.LIGHT_CAVALRY,e.HEAVY_CAVALRY,e.AXE,e.SWORD,e.RAM,e.SNOB,e.TREBUCHET]})),require(['two/ready','two/attackView','two/attackView/ui','two/attackView/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/autoCollector',['queues/EventQueue'],(function(e){let t=!1,a=!1,r=!0,c=0;const d=function(){o.emit(l.RESOURCE_DEPOSIT_GET_INFO,{})},u=function(){if(!a)return!1
;let e=n.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return i=t.shift(),void o.emit(l.RESOURCE_DEPOSIT_COLLECT,{job_id:i.id,village_id:n.getSelectedVillage().getId()});var i;let s=e.getReadyJobs();return s?function(e){o.emit(l.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(g(s)):void 0},g=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let p={};return p.init=function(){t=!0,i.$on(s.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!r||!a)return!1;r=!1,setTimeout((function(){r=!0,u()}),1500)})),i.$on(s.RESOURCE_DEPOSIT_JOBS_REROLLED,u),i.$on(s.RESOURCE_DEPOSIT_JOB_COLLECTED,u),i.$on(s.RESOURCE_DEPOSIT_INFO,(function(e,t){u(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},p.start=function(){e.trigger(s.AUTO_COLLECTOR_STARTED),a=!0,u()},p.stop=function(){e.trigger(s.AUTO_COLLECTOR_STOPPED),a=!1},p.isRunning=function(){return a},
p.isInitialized=function(){return t},p})),define('two/autoCollector/events',[],(function(){angular.extend(s,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Kolekcjoner',50,p('i18n')('description',i.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'auto_collector')))})),n.register(s.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(s.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,a,r,c){let d=!1,u=!1,g=!1,p=injector.get('secondVillageService');const m=function(){var e;e=_,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(p.hasFinishedLastJob(t.jobs))g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),E.stop();else{let i=new c(t);n.getSelectedCharacter().setSecondVillage(i),e()}}))},_=function(){let e=n.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const i=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t<r.server2ClientTime(e[i].time_completed))return e[i];return!1}(e.data.jobs);if(i){const e=r.server2ClientTime(i.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const a=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t>=r.server2ClientTime(e[i].time_completed)&&!e[i].collected)return i;return!1}(e.data.jobs);if(a)return s=a,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:n.getSelectedVillage().getId(),job_id:s});var s;const c=p.getCurrentDayJobs(e.data.jobs,e.data.day),d=p.getCollectedJobs(e.data.jobs),g=n.getSelectedVillage().getResources().getResources(),_=p.getAvailableJobs(c,d,g,[]);if(_){const e=function(e){let i=!1;return t.each(e,(function(e){return i=e,!1})),i}(_);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:n.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=_[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let E={start:function(){if(!d||g)return!1;a.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,m()},stop:function(){if(!d)return!1;a.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!p.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){p.hasFinishedLastJob(e.jobs)?(g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(i.$on(s.SECOND_VILLAGE_VILLAGE_CREATED,m),i.$on(s.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=E})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,i,a,n){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),i(),e((function(){a.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),n.register(s.AUTO_COLLECTOR_STARTED,(function(){a.set(o,!0)})),n.register(s.AUTO_COLLECTOR_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,r=!1;let c={init:function(){a=!0}};return c.start=function(){
t.trigger(s.AUTO_HEALER_STARTED),r=!0,function(){if(!r)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let i=e.hospital.patients.healed;0==i.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){i.forEach((function(t,i){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*i),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(s.AUTO_HEALER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return a},c})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),
define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Medyk',70,p('i18n')('description',i.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_healer'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'auto_healer')))})),n.register(s.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,i,a,n){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),
n.register(s.AUTO_HEALER_STARTED,(function(){a.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/ready','queues/EventQueue'],(function(e,t,a,o,l,r){let c,d,u=!1,g=!1,p=[],m=[];const _='battle_calculator_settings',E=function(){p=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){p.push(e[t])})),console.log('selectedPresets',p)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},b={init:function(){u=!0,c=new e({settingsMap:a,storageKey:_}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('all settings',d),l((function(){E()}),'presets'),i.$on(s.ARMY_PRESET_UPDATE,E),i.$on(s.ARMY_PRESET_DELETED,E),
i.$on(s.GROUPS_CREATED,f),i.$on(s.GROUPS_DESTROYED,f),i.$on(s.GROUPS_UPDATED,f)},start:function(){g=!0,console.log('selectedPresets',p),console.log('selectedGroups',m),r.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){g=!1,console.log('example module stop'),r.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return g}};return b})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,a,o,l,r,d){let u,g,p,m=n.getPresetList(),_=n.getGroupList();const E={BATTLE:'battle',TROOPS:'troops'},f=function(e){u.selectedTab=e},b=function(){g.setAll(g.decode(u.settings)),d.notif('success','Settings saved')
},h=function(){t.isRunning()?t.stop():t.start()},T=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=l.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,p.classList.remove('btn-orange'),p.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,p.classList.remove('btn-red'),p.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=i.$new(),u.SETTINGS=a,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.BATTLE,u.settingsMap=o,g.injectScope(u),T(),w(),u.selectTab=f,u.saveSettings=b,u.switchState=h;let e=new r('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,T,!0),e.register(s.ARMY_PRESET_DELETED,T,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.BATTLE_CALCULATOR_START,v),
e.register(s.BATTLE_CALCULATOR_STOP,A),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',u)};return function(){g=t.getSettings(),p=e.addMenuButton('Kalkulator',180),p.addEventListener('click',S),
...
require(['two/ready','two/battleCalculator','two/battleCalculator/ui','two/battleCalculator/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','world_config'])})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,a,r,c,d,g,p,m,_,E,f,b){let h,T,w,v=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const R={};let k,L,O,N,C,x=!0;const M='builder_queue_log',P='builder_queue_settings',z=function(){const e=G();if(!x)return F.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),i=t.checkReadyState(),a=t.buildingQueue;return a.getAmountJobs()!==a.getUnlockedSlots()&&(!(!i.buildingQueue||!i.buildings)&&void U(t))
}))},D=function(){G().forEach((function(e){const t=L.getVillage(e),i=t.buildingQueue;if(i.getAmountJobs()){i.getQueue().forEach((function(i){S.canBeFinishedForFree(i,t)&&A.instantBuild(i,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=C[r.GROUP_VILLAGES];let i=[];return e?(i=k.getGroupVillageIds(e),i=i.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){i.push(e.getId())})),i},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const i=e.buildingQueue.getQueue();let a=angular.copy(R);const n=C[r.BUILDING_SEQUENCES][C[r.ACTIVE_SEQUENCE]];if(i.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(i){if(++a[i]>t[i])return v.compute(e),V(e,i,(function(t,i){t&&i.job&&(E.trigger(s.BUILDER_QUEUE_JOB_STARTED,i.job),j(e.getId(),i.job))})),!0}))},V=function(e,t,i){const a=B(e,t);if(a===p.POSSIBLE)q(e,t,(function(e){i(!0,e)}));else if(a===p.NOT_ENOUGH_FOOD&&C[r.PRIORIZE_FARM]){const t=w[m.FARM]
;e.getBuildingData().getDataForBuilding(m.FARM).level<t&&q(e,m.FARM,(function(e){i(!0,e)}))}i(!1)},q=function(e,t,i){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},i)},B=function(e,t){const i=e.getBuildingData().getDataForBuilding(t);if(i.upgradeability===p.POSSIBLE){const t=i.nextLevelCosts,a=e.getResources().getComputed();if(a.clay.currentStock-C[r.PRESERVE_CLAY]<t.clay||a.iron.currentStock-C[r.PRESERVE_IRON]<t.iron||a.wood.currentStock-C[r.PRESERVE_WOOD]<t.wood)return p.NOT_ENOUGH_RESOURCES}return i.upgradeability},W=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},j=function(e,t){let i={time:b.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(i),O.length>500&&O.splice(O.length-500,O.length),f.set(M,O),!0};let F={};return F.start=function(){if(!x)return E.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,h=setInterval(z,6e4),T=setInterval(D,6e3),e((function(){G().forEach((function(e){
const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),E.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){I=!1,clearInterval(h),clearInterval(T),E.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return I},F.isInitialized=function(){return y},F.getSettings=function(){return N},F.getLogs=function(){return O},F.clearLogs=function(){O=[],f.set(M,O),E.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let i=C[r.BUILDING_SEQUENCES];return e in i?g.SEQUENCE_EXISTS:Array.isArray(t)?(i[e]=t,N.set(r.BUILDING_SEQUENCES,i,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let i=C[r.BUILDING_SEQUENCES];return e in i?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let i=0;i<e.length;i++){let a=e[i];if(++e[a]>t[a].max_level)return!1}return!0}(t)?(i[e]=t,N.set(r.BUILDING_SEQUENCES,i,{quiet:!0}),
E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=C[r.BUILDING_SEQUENCES];if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,O=f.get(M,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),N=new a({settingsMap:c,storageKey:P}),N.onChange((function(e,t,i){C=N.getAll(),I&&t[d.ANALYSE]&&z(),i.quiet||E.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),C=N.getAll();for(let e in m)R[m[e]]=0;x=Object.keys(C[r.BUILDING_SEQUENCES]).length,w=!!x&&function(e){const t=C[r.BUILDING_SEQUENCES][e];let i=angular.copy(R);return t.forEach((function(e){i[e]++})),i}(C[r.ACTIVE_SEQUENCE]),i.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);U(e)}),1e3)}))},F})),
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let a in e)f.call(e,a)&&(t[a]=i(e[a]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(s,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,a,d,u,g,_,E,b,h,T,w,v){let A,S,y,I,R=n.getGroupList(),k={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},C={};const x={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,P={},z={},D=!1,G=!1;const U=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},V=function(e,i,a){if(a>=e.length){let i=a-e.length+1;for(;i--;)e.push(t)}e.splice(a,0,e.splice(i,1)[0])},q=function(e,t){switch(a.addBuildingSequence(e,t)){case b.SEQUENCE_SAVED:return!0;case b.SEQUENCE_EXISTS:
return d.notif('error',p('i18n')('error_sequence_exists',i.loc.ale,'builder_queue')),!1;case b.SEQUENCE_INVALID:return d.notif('error',p('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=A.settings[_.ACTIVE_SEQUENCE].value,t=A.settings[_.BUILDING_SEQUENCES][e],i=n.getGameData().getBuildings();let a={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in h)a[h[e]]=0;N.buildingSequence=t.map((function(e){let t=++a[e],o=i[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const i=n.getSelectedVillage().getBuildingQueue().getQueue();let a=!1;return i.some((function(i){
if(i.building===e&&i.level===t)return a=!0})),a}(e,t)&&(l='progress'):l='reached',{level:t,price:i[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},N.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,i=A.settings[_.BUILDING_SEQUENCES][e||t];let a={},n=[];for(let e in y)a[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};i.forEach((function(e){let t=++a[e].level,i=y[e].individual_level_costs[t];a[e].resources.wood+=parseInt(i.wood,10),a[e].resources.clay+=parseInt(i.clay,10),a[e].resources.iron+=parseInt(i.iron,10),a[e].resources.food+=parseInt(i.food,10),a[e].build_time+=parseInt(i.build_time,10),a[e].points+=k[e][t-1]}));for(let e in a)0!==a[e].level&&n.push({building:e,level:a[e].level,order:a[e].order,resources:a[e].resources,points:a[e].points,build_time:a[e].build_time});N.buildingSequenceFinal=n},
...
V(e,i,i+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.addBuilding=function(e,t,i=1){const a=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<i;e++)n.splice(a,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),D=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),D=!0},O.updateLevels=function(e,t){let i=0,a=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?i<y[t].max_level&&a.push({level:++i,building:t,checked:!1}):a.push(o)}return a},O.generateBuildingSequence=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const i=e[O.selectedSequence.value];let a={};for(let e in h)a[h[e]]=0;O.buildingSequence=i.map((function(e){return{level:++a[e],building:e,checked:!1}})),
...
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=i.$new();const t=O.selectedSequence.name,a=A.settings[_.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;q(e.name,a)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=i.$new();t.title=p('i18n')('clone_warn_changed_sequence_title',i.loc.ale,'builder_queue'),t.text=p('i18n')('clone_warn_changed_sequence_text',i.loc.ale,'builder_queue'),t.submitText=p('i18n')('clone',i.loc.ale,'builder_queue'),t.cancelText=p('i18n')('cancel',i.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},C.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;C.visibleLogs=C.logs.slice(e,e+t),
A.pagination.logs.count=C.logs.length,C.visibleLogs.forEach((function(e){e.villageId&&function(e){if(P[e])return P[e];P[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){P[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},C.clearLogs=function(){a.clearLogs()};const B=function(){let e=i.$new();const t=[h.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;q(e.name,t)&&(A.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[_.BUILDING_SEQUENCES][e.name]=t,j(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(x.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},j=function(){I.setAll(I.decode(A.settings)),D=!1},F=function(){a.isRunning()?a.stop():a.start()},Y=function(e,t){let a=i.$new();a.title=p('i18n')('discard_changes_title',i.loc.ale,'builder_queue'),a.text=p('i18n')('discard_changes_text',i.loc.ale,'builder_queue'),a.submitText=p('i18n')('discard',i.loc.ale,'common'),a.cancelText=p('i18n')('cancel',i.loc.ale,'common'),a.switchColors=!0,a.submit=function(){a.closeWindow(),e&&e()},a.cancel=function(){a.closeWindow(),t&&t()},c.getModal('modal_attention',a)},H=function(){D?Y((function(){M()})):M()},K={updateGroups:function(){A.groups=g.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(_.BUILDING_SEQUENCES);A.sequences=g.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){A.logs=a.getLogs(),C.updateVisibleLogs()},clearLogs:function(){d.notif('success',p('i18n')('logs_cleared',i.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const a=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=a[t],A.settings[_.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',p('i18n')('sequence_updated',i.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const a=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=a[t],K.updateSequences(),d.notif('success',p('i18n')('sequence_created',i.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[_.BUILDING_SEQUENCES][t];const a=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(A.settings[_.BUILDING_SEQUENCES]);O.selectedSequence={name:a,value:a},K.updateSequences(),O.generateBuildingSequence(),I.get(_.ACTIVE_SEQUENCE)===t&&(I.set(_.ACTIVE_SEQUENCE,a,{quiet:!0}),N.generateSequences()),
d.notif('success',p('i18n')('sequence_removed',i.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',p('i18n')('settings_saved',i.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(_.ACTIVE_SEQUENCE);A=i.$new(),A.selectedTab=x.SETTINGS,A.TAB_TYPES=x,A.SETTINGS=_,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=z,A.villagesInfo=P,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=h.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=N,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=C,A.logsView.logs=a.getLogs(),A.selectTab=W,A.switchBuilder=F,A.saveSettings=j,A.createSequence=B,A.openVillageInfo=r.openVillageInfo,I.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.logs={count:C.logs.length,offset:0,loader:C.updateVisibleLogs,limit:m.getPaginationLimit()},C.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new T('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(s.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',A),M=A.closeWindow,A.closeWindow=H,A.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),A.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?Y((function(){K.generateBuildingSequencesEditor(),D=!1}),(function(){A.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),I=a.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),w.register(s.BUILDER_QUEUE_START,(function(){L=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',p('i18n')('started',i.loc.ale,'builder_queue'))})),w.register(s.BUILDER_QUEUE_STOP,(function(){L=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',p('i18n')('stopped',i.loc.ale,'builder_queue'))})),
...
updates:[i.ANALYSE],inputType:'number',min:0,max:6e5},[t.PRIORIZE_FARM]:{default:!0,inputType:'checkbox',updates:[i.ANALYSE]}}})),define('two/builderQueue/sequenceStatus',[],(function(){return{SEQUENCE_NO_EXISTS:'sequence_no_exists',SEQUENCE_EXISTS:'sequence_exists',SEQUENCE_INVALID:'sequence_invalid',SEQUENCE_SAVED:'sequence_saved'}})),require(['two/ready','two/builderQueue','two/builderQueue/ui','two/builderQueue/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/commandQueue',['two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','helper/time','helper/math','struct/MapData','Lockr','conf/buildingTypes','conf/officerTypes','conf/unitTypes'],(function(t,i,a,r,c,d,u,g,p,m,_,E,b,h,T){
const w=Object.values(c),v=Object.values(i),A=Object.values(T),S=Object.values(h),y=Object.values(b);let I,R=[],k={},L=[],O=[],N=!1;const C={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let i=!0;const a=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return a.some((function(e){if(e.length&&!n.includes(e))return i=!1,!0})),i}},x=function(e){return e<p.gameTime()+I},M=function(e){R.push(e)},P=function(e){k[e.id]=e},z=function(){
E.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,L=E.get(d.QUEUE_SENT,[],!0),O=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){p.gameTime()>e.sendTime?U.expireCommand(e,a.TIME_LIMIT):(M(e),P(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!x(e.sendTime))return!0;N?U.sendCommand(e):U.expireCommand(e,a.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const i=function(e){const i=n.getVillages()[e.origin.id];if(!i)return a.NOT_OWN_VILLAGE;const o=i.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=a.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=a.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=a.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof i)return U.expireCommand(e,i);e.units=i,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),E.set(d.QUEUE_SENT,L),U.removeCommand(e,a.COMMAND_SENT),g.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){O.push(e)}(e),E.set(d.QUEUE_EXPIRED,O),U.removeCommand(e,t)},U.addCommand=function(e,a,o,l,s,r,d,g){let m={},E={};return new Promise((function(f,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(a))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[h.SUPPORTER]&&delete E[h.SUPPORTER],'string'!=typeof g||y.includes(g)?(g=!(d!==c.ATTACK||!m[T.CATAPULT])&&(g||b.HEADQUARTER),v.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(a.x,a.y,1,1,e))]).then((function(n){if(e=n[0],a=n[1],!e)return I(u.INVALID_ORIGIN);if(!a)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,a,m,d,E,!0),c=l===i.ARRIVE?s-r:s,_=l===i.ARRIVE?s:s+r;if(x(c))return I(u.ALREADY_SENT);const b={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:a,date:o,dateType:l,units:m,officers:E,type:d,catapultTarget:g,countdown:c-p.gameTime()};M(b),P(b),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(b)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete k[e.id];const i=R.some((function(t,i){if(t.id==e.id)return R.splice(i,1),z(),!0}));if(i)switch(t){case a.TIME_LIMIT:g.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case a.NOT_OWN_VILLAGE:g.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case a.NOT_ENOUGH_UNITS:g.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case a.COMMAND_REMOVED:g.trigger(s.COMMAND_QUEUE_REMOVE,e)}else g.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return i},U.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),O=[],L=[]},U.start=function(e){N=!0,g.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){N=!1,g.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return N},U.getWaitingCommands=function(){return R},U.getWaitingCommandsObject=function(){return k},U.getSentCommands=function(){return L},
U.getExpiredCommands=function(){return O},U.filterCommands=function(e,t,i){const a=C[e];return(i||R).filter((function(e){return a(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,a,o,l,d,u,g,m,_,E,f,b,h,T){let w,v,A,S,y,I=n.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),L=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},C=N.ADD;let x,M,P,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){O=t.data},B=function(){O=!1},W=function(e){
const t=new Date(e||b.gameTime()+o.getTimeOffset()),i=t.getMilliseconds(),a=b.zerofill(i-i%100,3),n=b.zerofill(t.getSeconds(),2),l=b.zerofill(t.getMinutes(),2);return b.zerofill(t.getHours(),2)+':'+l+':'+n+':'+a+' '+b.zerofill(t.getDate(),2)+'/'+b.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(w.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!w.isValidDate&&o.getTimeFromString(y.date),t=w.selectedDateType.value===l.ARRIVE;o.each(g,(function(i){o.each(U,(function(a,n){const l=o.getTravelTime(y.origin,y.target,a,i,y.officers,!0);w.travelTimes[i][n].travelTime=p('readableMillisecondsFilter')(l),w.travelTimes[i][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&w.isValidDate?b.gameTime()+x<e?'valid':'invalid':'neutral'},H=function(){y.dateType=w.selectedDateType.value,T.set(m.LAST_DATE_TYPE,w.selectedDateType.value),F()},K=function(){
...
w.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ie=function(e){''===y.units[e]&&(y.units[e]=0)},ae=function(){w.showCatapultSelect=!!y.units.catapult},ne=function(e){w.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!O)return o.notif('error',p('i18n')('error_no_map_selected_village',i.loc.ale,'command_queue'));f.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},se=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=j(y.date,100)},ce=function(){if(!y.date)return!1;y.date=j(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",w.catapultTarget={name:p('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',p('i18n')('error_origin',i.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',p('i18n')('error_target',i.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',p('i18n')('error_invalid_date',i.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',p('i18n')('error_no_units',i.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',p('i18n')('error_relocate_disabled',i.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',p('i18n')('error_already_sent_'+e,i.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),J(),$()},pe=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,a){return a&&(e=a+'.'+e),p('i18n')(e,i.loc.ale,'command_queue')+' '+p('i18n')(t,i.loc.ale,'command_queue')},_e=function(e,t){w.activeFilters[e]=!w.activeFilters[e],
t&&(w.filtersData[u.ALLOWED_TYPES][e]=!w.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){w.activeFilters[u.TEXT_MATCH]=w.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){w.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,i,a){if('commandqueue_village_search'!==t)return!1;y[a]={id:i.raw.id,x:i.raw.x,y:i.raw.y,name:i.raw.name},w.searchQuery[a]=''},removeCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),i.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',p('i18n')('error_remove_error',i.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',p('i18n')('error_not_own_village',i.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',p('i18n')('error_no_units_enough',i.loc.ale,'command_queue'))},sendCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,i){if(w.running=t.isRunning(),i.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){w.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{b.timer.remove(e.updateCountdown)})}},be=function(){const e=T.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;w=i.$new(),w.selectedTab=C,w.inventory=n.getInventory(),w.presets=o.obj2selectOptions(L.getPresets()),w.travelTimes={},o.each(g,(function(e){w.travelTimes[e]={},o.each(U,(function(t,i){w.travelTimes[e][i]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=S,w.officers=I.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=h.toActionList(l,(function(e){return p('i18n')(e,i.loc.ale,'command_queue')})),w.selectedDateType={name:p('i18n')(e,i.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:p('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},w.catapultTarget={name:p('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:p('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:p('i18n')('add_origin',i.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:p('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:p('i18n')('add_target',i.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!y.units.catapult,w.attackableBuildings=z,w.commandData=y,
w.activeFilters=M,w.filtersData=P,w.running=t.isRunning(),w.waitingCommands=t.getWaitingCommands(),w.visibleWaitingCommands=t.getWaitingCommands(),w.sentCommands=t.getSentCommands(),w.expiredCommands=t.getExpiredCommands(),w.EVENT_CODES=d,w.FILTER_TYPES=u,w.TAB_TYPES=N,w.COMMAND_TYPES=g,w.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),w.onUnitInputFocus=te,w.onUnitInputBlur=ie,w.catapultTargetVisibility=ae,w.selectTab=ne,w.addSelected=oe,w.addMapSelected=le,w.addCurrentDate=se,w.incrementDate=re,w.reduceDate=ce,w.cleanUnitInputs=de,w.addCommand=ue,w.clearRegisters=ge,w.switchCommandQueue=pe,w.removeCommand=t.removeCommand,w.openVillageInfo=r.openVillageInfo,w.toggleFilter=_e,w.$watch('commandData.origin',F),w.$watch('commandData.target',F),w.$watch('commandData.date',F),w.$watch('commandData.officers',F),w.$watch('selectedDateType.value',H),w.$watch('selectedInsertPreset.value',Q),w.$watch('catapultTarget.value',K),w.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
w.$watch('selectedTab',(function(){w.selectedTab===N.ADD?_=setInterval((function(){F()}),2500):clearInterval(_)})),w.waitingCommands.forEach(e=>{Z(e)});let E=new a('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));E.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),E.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),E.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),E.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),E.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),E.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),E.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),E.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),E.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),E.register(s.COMMAND_QUEUE_START,fe.start),E.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){A=n.getSelectedCharacter(),x=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:p('i18n')(e,i.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',20),v.addEventListener('click',be),E.register(s.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),E.register(s.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),i.$on(s.SHOW_CONTEXT_MENU,q),i.$on(s.DESTROY_CONTEXT_MENU,B),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,i){if(t.initialized)return!1;e((function(){t.init(),i(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,a,r,c,d){let u,g,m,_,E,f=!1,b=!1,h=0;u=function(e){let t,i,a=0;for(t=0;t<e.length;t++)i=e[t].chapel||e[t].church,i&&i>a&&(a=i);return a},g=function(e,t){let i=n.getWorldConfig().getChurchBonus(),a=0
;return e<0||!t&&e>i.length-1?0:(a=t?n.getWorldConfig().getChapelBonus():i[e],Math.floor(100*a))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let T={init:function(){f=!0}};return T.start=function(){a.trigger(s.FAITH_CHECKER_STARTED),b=!0,n.getSelectedCharacter().getVillageList().forEach((function(a){let n=a.data.villageId,s=a.data.buildings.chapel.level,r=a.buildingQueue.data.queue,c=a.getResources().getComputed(),f=c.food,b=c.wood,T=c.clay,w=c.iron,v=f.currentStock,A=b.currentStock,S=T.currentStock,y=w.currentStock,I=[0,5e3],R=[160,16e3],k=[200,2e4],L=[50,5e3];1==s&&(h=1),m(n,(function(a){_=u(a.villages),E=g(_,1===s),console.log(E),50!=E||r!==t&&0!=r.length?50==E&&r?r.forEach((function(t){let a=t.building;'chapel'==a&&'church'==a||0!=h?'chapel'==a&&'church'==a||1!=h||(A>=R[1]&&S>=k[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('church',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))):A>=R[0]&&S>=k[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('chapel',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))})):e.notif('success',p('i18n')('full',i.loc.ale,'faith_checker')):1==h?A>=R[1]&&S>=k[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('church',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker')):A>=R[0]&&S>=k[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('chapel',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))}))}))},T.stop=function(){a.trigger(s.FAITH_CHECKER_STOPPED),b=!1},T.isRunning=function(){return b},T.isInitialized=function(){return f},T})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,p('i18n')('description',i.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'faith_checker'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(s.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,i,a,n){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(s.FAITH_CHECKER_STARTED,(function(){a.set(o,!0)})),n.register(s.FAITH_CHECKER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,a,r,c,g,p,m,_,b,h,T,w,v,A,S,y,I){let R,k,L,O,N,C=!1,x=!1,M=[],P=[],z=[],D=[],G=[],U=[],V=!1,q=!1,B=!1,W=0,j=null,F=null,Y=null,H={},K=T.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(k[r.MIN_DISTANCE],k[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(k[r.MIN_POINTS],k[r.MAX_POINTS])}},ie=[te.distance,te.ownPlayer,te.included,te.ignored],ae=function(e){return e.sort().filter((function(e,t,i){return!t||e!=i[t-1]}))},ne=function(){!function(){const e=k[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ae(z)}(),function(){const e=k[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),G=G.concat(t)})),G=ae(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){f.call(L,e)||(L[e]={time:T.gameTime(),report:!1},t=!0)})),_.each(L,(function(i,a){a=parseInt(a,10),e.includes(a)||(delete L[a],t=!0)})),t&&(I.set($,L),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),w.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const i=k[r.GROUP_INCLUDE],a=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),a===t.group_id&&(o?(Re(t.village_id),l=!0):(Oe(t.village_id),Ee(p.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),i.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){x&&e.start()})),l=!0}l&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const i=k[r.GROUP_INCLUDE],a=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),a===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){x&&e.start()})),l=!0}else Ne(),Ee(p.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});i.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Re(t.village_id),l=!0),l&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),i=k[r.GROUP_IGNORE],a=k[r.GROUP_ONLY],o=k[r.GROUP_INCLUDE],l=f.call(t,i)?i:R.getDefault(r.GROUP_IGNORE),s=a.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));R.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Ie(),Ne(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();k[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let i=e[t];i.load=me(i),i.travelTime=d.calculateTravelTime(i,{barbarian:!1,officers:!1}),U.push(i)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),x&&Ce.stop())},ue=function(e,t){k[r.IGNORE_ON_LOSS]&&k[r.GROUP_IGNORE]&&x&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ge=function(e,t){V&&B&&t.origin.id===V.getId()&&t.target.id===B.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},pe=function(e,t){V&&q&&B&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,i){e&&(t+=N[i].load*e)})),t},_e=function(e){L[e]={time:T.gameTime(),report:H[e]||!1},delete H[e],I.set($,L),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=T.gameTime(),t.type=e,P.unshift(t),fe(),!0)},fe=function(){const e=k[r.LOGS_LIMIT];P.length>e&&P.splice(P.length-e,P.length),I.set(X,P),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},be=function(e,t,i){const a=k[r.TARGET_MULTIPLE_FARMERS],n=k[r.TARGET_SINGLE_ATTACK];if(a&&i){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=T.gameTime()},Te=function(){clearTimeout(j),clearTimeout(F),clearTimeout(Y),j=null,F=null,Y=null
},we=function(){return Math.max(1,60*k[r.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*k[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=a.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{w.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return he(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,w.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,w.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(a.USER_STOP),Te(),this.onCycleEndFn(e),this.onCycleEndFn=E},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let i,c,u,g,p=!1,m=!1;const E=()=>new Promise((t,i)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return i(a.USER_STOP);t()},_.randomSeconds(ve())):t()}),b=()=>new Promise((e,i)=>{const n=50-k[r.PRESERVE_COMMAND_SLOTS];t.length>=n?i(a.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(k[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),i=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>i[e].currentStock===n))return t(a.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(a.TARGET_CYCLE_END):(i=this.targets[this.index],void e()):t(a.NO_TARGETS)),R=()=>new Promise((e,t)=>{y.getTownAtAsync(i.x,i.y,n=>{if(te.points(n.points))return t(a.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:i.id},n=>{this.running?null!==i.character_id||null===n.owner_id||z.includes(i.id)?i.attack_protection?t(a.PROTECTED_VILLAGE):e():t(a.ABANDONED_CONQUERED):t(a.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const i=n.getPresetList().getPresetsByVillageId(e);let a=[];if(U.forEach((function(e){f.call(i,e.id)||a.push(e.id)})),a.length){for(let e in i)f.call(i,e)&&a.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:a},t)}else t()}(this.villageId,()=>{this.running?e():t(a.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,i);_.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],i=e[1];return n[t].in_town<i}))return;const r=d.calculateTravelTime(l,{barbarian:!i.character_id,officers:!1});return o>r*s?(p=l,e()):t(a.TIME_LIMIT),!1}),p||t(a.NO_UNITS)}),C=()=>new Promise((e,n)=>{c=!1,g=O.getVillageList();const o=g.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===i.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===i.id&&'forward'===e.data.direction),be(u,c,o))return n(a.BUSY_TARGET);o&&(m=!0),e()}),x=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[r.TARGET_SINGLE_ATTACK]&&!k[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(T.gameTime()/1e3),l=k[r.TARGET_MULTIPLE_FARMERS]?g:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,i),_=d.calculateTravelTime(p,{
barbarian:!i.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(p,_,m,v.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===i.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(a.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:i.id,num_reports:0},i=>{if(!this.running)return t(a.USER_STOP);const n=i.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(be(l,o,!0))return t(a.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{E().then(b).then(S).then(I).then(R).then(L).then(N).then(C).then(x).then(M).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(a.EXPIRED_STEP)},3e4)});Promise.race([P,D]).then(()=>{if(!this.running)return!1
;this.setStatus(a.ATTACKING),q=!0,B=i,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:i.id,army_preset_id:p.id,type:v.TYPES.ATTACK})}).catch(t=>{switch(Te(),w.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case a.TIME_LIMIT:case a.BUSY_TARGET:case a.ABANDONED_CONQUERED:case a.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case a.USER_STOP:this.setStatus(t);break;case a.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Oe(i.id),this.targetStep(e);break;case a.NO_UNITS:case a.NO_TARGETS:case a.FULL_STORAGE:case a.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case a.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case a.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(a.UNKNOWN),this.stop(a.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||a.UNKNOWN},Ae.prototype.commandSent=function(e){q=!1,B=!1,Te(),Ee(p.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){q=!1,B=!1,this.stop(a.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(i=>{this.targets=function(e,t){return e.map((function(e){return e.distance=h.actualDistance(t,e),e}))}(i,t),this.targets=function(e){return e.filter((function(e){return ie.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let i=Ce.getFarmer(e);return i||(i=new Ae(e),M.push(i)),i},ye=function(){_.each(O.getVillages(),(function(e,t){Se(t)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=k[r.GROUP_ONLY];let t=[];M.forEach((function(i){let a=i.getId();e.length&&!G.includes(a)?t.push(a):D.includes(a)&&t.push(a)})),t.length&&(t.forEach((function(e){Re(e)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let i=0;i<M.length;i++)if(M[i].getId()===e)return M[i].stop(t.KILL_FARMER),M.splice(i,i+1),!0;return!1
},ke=function(e){he(),M.length?W>=M.length?(W=0,V=!1,Z=T.gameTime()+we(),w.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=M[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):j=setTimeout((function(){j=null,W=0,Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),we())},Le=function(e){for(let t=0;t<M.length;t++){let i=M[t].getTargets();for(let t=0;t<i.length;t++){if(i[t].id===e)return!0}}return!1},Oe=function(e){M.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ce={};return Ce.init=function(){C=!0,P=I.get(X,[]),L=I.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,i){k=R.getAll(),"ignore_update"!==i&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ne(),t[g.TARGETS]&&Ne(),t[g.VILLAGES]&&(Ie(),ye()),t[g.LOGS]&&fe(),t[g.INTERVAL_TIMERS]&&x&&(F?(Te(),
V.targetStep({delay:!0})):j&&(Te(),w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),se("ignore_update"),ne(),ye(),b((function(){ce()}),'presets'),b((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),i.$on(s.ARMY_PRESET_UPDATE,de),i.$on(s.ARMY_PRESET_DELETED,de),i.$on(s.GROUPS_VILLAGE_LINKED,oe),i.$on(s.GROUPS_VILLAGE_UNLINKED,le),i.$on(s.GROUPS_DESTROYED,re),i.$on(s.COMMAND_SENT,ge),i.$on(s.MESSAGE_ERROR,pe),i.$on(s.REPORT_NEW,ue)},Ce.start=function(){let e;return!x&&(U.length?(x=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),he(),function(){let e=we(),t=e+e/2+ve();Q=setInterval((function(){T.gameTime()-K>t&&(Ce.stop(),setTimeout(Ce.start,5e3))}),3e4)}(),w.trigger(s.FARM_OVERFLOW_START),void Ee(p.FARM_START)):(x=!1,!1)):(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ce.stop=function(e=a.USER_STOP){V?(V.stop(e),
e!==a.USER_STOP&&(Z=T.gameTime()+we()),w.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,x=!1,Te(),w.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===a.USER_STOP&&Ee(p.FARM_STOP)},Ce.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Ce.getFarmers=function(){return M},Ce.getSettings=function(){return R},Ce.getExceptionVillages=function(){return{included:z,ignored:D}},Ce.getExceptionLogs=function(){return L},Ce.isInitialized=function(){return C},Ce.isRunning=function(){return x},Ce.getLogs=function(){return P},Ce.clearLogs=function(){return P=[],I.set(X,P),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),P},Ce.getNextCycleDate=function(){return Z},Ce.getCycleInterval=we,Ce})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,a,d,u,E,f,b,h,T,w){let v,A,S,y=n.getPresetList(),I=n.getGroupList(),R={},k={},L=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&C(e.villageId),e.targetId&&C(e.targetId)}))},C=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},x=function(){
v.exceptionVillages.included.forEach((function(e){C(e)})),v.exceptionVillages.ignored.forEach((function(e){C(e)}))},M=function(){t.isRunning()?t.stop():t.start()},P=function(e){v.selectedTab=e},z=function(){A.setAll(A.decode(v.settings)),v.saveButtonColor='orange',h.notif('success',p('i18n')('settings_saved',i.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(E.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(E.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){v.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){v.groups=f.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=f.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},q=function(){v.running=!0,
h.notif('success',p('i18n')('farm_started',i.loc.ale,'farm_overflow'))},B=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:h.notif('success',p('i18n')('no_preset',i.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',p('i18n')('farm_stopped',i.loc.ale,'farm_overflow'))}},W=function(){v.logs=angular.copy(t.getLogs()),N(),v.logs.length||h.notif('success',p('i18n')('reseted_logs',i.loc.ale,'farm_overflow'))},j=function(){v.farmers=t.getFarmers()},F=function(){v.exceptionVillages=t.getExceptionVillages(),x()},Y=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,i){i!==a.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=i.$new(),v.SETTINGS=E,v.TAB_TYPES=O,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=O.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=k,v.villagesInfo=R,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=A.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},A.injectScope(v),U(),V(),N(),x(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-w.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=M,v.selectTab=P,v.saveSettings=z,v.clearLogs=t.clearLogs,v.jumpToVillage=g.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=_.showReport,v.removeIgnored=D,v.removeIncluded=G;let a=new b('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));a.register(s.ARMY_PRESET_UPDATE,U,!0),a.register(s.ARMY_PRESET_DELETED,U,!0),a.register(s.GROUPS_UPDATED,V,!0),a.register(s.GROUPS_CREATED,V,!0),a.register(s.GROUPS_DESTROYED,V,!0),
a.register(s.FARM_OVERFLOW_START,q),a.register(s.FARM_OVERFLOW_STOP,B),a.register(s.FARM_OVERFLOW_LOGS_UPDATED,W),a.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,j),a.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),a.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),a.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),a.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){Q()})),T.register(s.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),T.register(s.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,a,o,l,r,c,d,u,p,m,_,E,b,h,T,w,v,A){let S,y,I,R,k,L,O,N,C,x,M,P,z,D,G,U,V,q,B,W,j,F,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ie={},ae=!1;const ne='minimap_settings',oe={[a.VERY_SMALL]:2,[a.SMALL]:3,[a.BIG]:5,[a.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},ge={x:0,y:0},pe=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,i=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(i/y)%2&&(t+=R),t-=t%y,i-=i%y,{x:Math.ceil((t-C.width/2)/y),y:Math.ceil((i-C.height/2)/y)}},Ee=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},fe=function(){Ae(k)},be=function(){if(H){const e={x:ee.x-C.width/2,y:ee.y-C.height/2};x.clearRect(0,0,C.width,C.height),D.clearRect(0,0,z.width,z.height),function(e){x.drawImage(M,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),i=(t.x-2)*y-e.x,a=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(i,0,1,I),D.fillRect(0,a,I,1);const n=U.getBoundingClientRect(),l=n.width/v.TILESIZE.x/A.view.z*y,s=n.height/v.TILESIZE.y/A.view.z*y,r=i-l/2,c=a-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(be)
},he=function(){if(!ae)return!1;const e=Q.village[O][N];we(e?Q.character[e]:[[O,N]]),ae=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},Te=function(e){let t=[];for(let i=0;i<e.length;i++){let a=e[i][0],n=e[i][1];t.push(ie[a][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let i=0;i<e.length;i++){let a=e[i][0],n=e[i][1];t.push(ie[a][n])}Ae(t)},ve=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===q){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(B&&B===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return W.ally;if(j.isEnemy(e.tribe_id))return W.enemy;if(j.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let i=0;i<e.length;i++){const a=e[i];if(a.id<0)continue;const n=t||ve(a);if(!n)continue;const o=a.x*y+(a.y%2?R:0),l=a.y*y;P.fillStyle=n,P.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,M.width=1e3*y,M.height=1e3*y,P.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;C.width=686,C.height=e,z.width=686,z.height=e,x.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var i,a;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ae&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(i=O,a=N,E.getTownAtAsync(i,a,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id
},T.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({type:'tribe',id:e.tribe_id},T.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,ge=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=ge.x,te.y=ge.y,!1;if(te.x===ge.x&&te.y===ge.y||(re.alpha=0,function(e,t){let i=g.tileCoordinate2Pixel(e,t);re.setTranslation(i[0]-25,i[1]+2),re.alpha=1}(ge.x,ge.y)),ge.x in ie&&ge.y in ie[ge.x]){let t=ie[ge.x][ge.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ae){if(O===e.x&&N===e.y)return!1;he()}ae=!0,O=e.x,N=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const i=Q.village[O][N];Te(i?Q.character[i]:[[O,N]])}(ge,e)}he()},Le=function(){ae&&he(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=_e(e);g.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},Ce=function(){K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},fe()},xe=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const a='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(a,K[e.type]),i.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
;const a='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(a,K[e]),i.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let i in K[t])e(t,i,K[t][i])},setViewport:function(e){C=e,C.style.background=Y[o.COLOR_BACKGROUND],x=C.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const i=Ee(e[0]*t,e[1]*t),a=Ee(e[2]*t,e[3]*t);return[i.x-1,i.y-1,a.x+3||1,a.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return F},Me.drawMinimap=function(){pe&&(pe=!1),C.style.background=Y[o.COLOR_BACKGROUND],P.clearRect(0,0,M.width,M.height),d((function(){
!function(){const e=h.getPath(v.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],i=Y[o.SHOW_PROVINCE_DEMARCATIONS],a=function(e,t){P.fillStyle=Y[o.COLOR_CONTINENT],P.fillRect(e*y+R-1,t*y+R-1,3,1),P.fillRect(e*y+R,t*y+R-2,1,3)},n=function(e,t){P.fillStyle=Y[o.COLOR_PROVINCE],P.fillRect(e*y+R,t*y+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||i)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=b.toTile(o,e,l);s.key.b&&(s.key.c&&t?a(e,l):i&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;P.beginPath(),P.lineWidth=2,P.strokeStyle="#2B4700",P.rect(r,c,d,u),P.stroke()}))}(),fe()}),'minimap_data')},Me.enableRendering=function(){H=!0},Me.disableRendering=function(){H=!1},Me.isFirstDraw=function(){return!!pe},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),P=M.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ne}),F.onChange((function(e,t){
Y=F.getAll(),Se(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),Y=F.getAll(),K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Se()},Me.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),j=V.getTribeRelations(),q=V.getId(),B=V.getTribeId(),W=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Ie),z.addEventListener('mouseup',Re),z.addEventListener('mousemove',ke),z.addEventListener('mouseleave',Le),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),p.load((function(){k=p.getVillages(),function(e){for(let t=0,i=e.length;t<i;t++){let i=e[t];i.id<0||(i.x in Q.village||(Q.village[i.x]={}),i.x in ie||(ie[i.x]=[]),
Q.village[i.x][i.y]=i.character_id||0,ie[i.x][i.y]=i,i.character_id&&(i.character_id in Q.character?Q.character[i.character_id].push([i.x,i.y]):Q.character[i.character_id]=[[i.x,i.y]],i.tribe_id&&(i.tribe_id in Q.tribe?Q.tribe[i.tribe_id].push(i.character_id):Q.tribe[i.tribe_id]=[i.character_id])))}}(k),function(){let e=[],t=[];for(let i in Q.village){e.push(i);for(let e in Q.village[i])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),be(),i.$on(s.VILLAGE_SELECTED_CHANGED,xe),i.$on(s.TRIBE_RELATION_CHANGED,fe),i.$on(s.GROUPS_VILLAGES_CHANGED,Ce)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,g,m,_,E,f,b,h,T,w){let v,A,S,y,I,R,k,L,O,N,C,x={},M=!1,P={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){v.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(v.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
P.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!O)return;let i=V(t.x,t.y);var a,n;N=i,x[i]=!0,M=!0,(a=t.x,n=t.y,new Promise((function(e){let t=h.getTownAt(a,n);if(t)return e(t);h.loadTownDataAsync(a,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!x[V(e.x,e.y)])return;if(!M)return;k.appendChild(O),O.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const i=O.getBoundingClientRect(),a=k.getBoundingClientRect(),n=i.width+50,o=i.height+50,l=R.tt.position.y+o>a.top+a.height,s=R.tt.position.x+n>a.width;l&&(R.tt.position.y-=50),O.classList.toggle('left',s),O.classList.toggle('top',l)}))},B=function(e,t){if(!O)return;let i=t?V(t):N;x[i]=!1,M=!1,R.tt.visible=!1,O.classList.add('ng-hide'),L.appendChild(O)},W=function(e,t,a){let o,l,s=i.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(l=t,o=C.get(l),r=!1,s.submit=function(){v.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){v.settings[l]=C.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,s.submit=function(){v.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][a],s.submit=function(){n.addHighlight({id:a,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},j=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},F=function(){C.setAll(C.decode(v.settings)),_.notif('success',p('i18n')('settings_saved',i.loc.ale,'minimap'))},Y=function(){let e=i.$new();e.title=p('i18n')('reset_confirm_title',i.loc.ale,'minimap'),e.text=p('i18n')('reset_confirm_text',i.loc.ale,'minimap'),e.submitText=p('i18n')('reset',i.loc.ale,'common'),e.cancelText=p('i18n')('cancel',i.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){C.resetAll(),_.notif('success',p('i18n')('settings_reset',i.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',p('i18n')('highlight_add_error_exists',i.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',p('i18n')('highlight_add_error_no_entry',i.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',p('i18n')('highlight_add_error_invalid_color',i.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){B(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){B(),y.style.cursor='url('+T.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){v=i.$new(),v.SETTINGS=g,v.TAB_TYPES=z,v.selectedTab=D,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=n.getHighlights(),v.highlightNames=P,v.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:p('i18n')('placeholder_search',i.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=G,v.openColorPalette=W,v.addCustomHighlight=j,v.removeHighlight=n.removeHighlight,v.saveSettings=F,v.resetSettings=Y,v.highlightsCount=H,v.openProfile=K,C.injectScope(v,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,q),e.register(s.MINIMAP_VILLAGE_BLUR,B),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
...
define('two/mintHelper',['queues/EventQueue'],(function(e){let t=!1,i=!1,a=3e3;function r(){n.getSelectedCharacter().getVillageList().forEach((function(e){let t=0,i=0,n=0,s=e.data.buildings.academy.level,r=e.getResources().getComputed(),c=r.wood,d=r.clay,u=r.iron,g=c.currentStock,p=d.currentStock,m=u.currentStock;setTimeout((function(){s>0?g>=28e3&&p>=3e4&&m>=25e3?(t=Math.floor(g/28e3),i=Math.floor(p/3e4),n=Math.floor(m/25e3),t<=n&&t<=i?(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:t}),console.log('W wiosce '+e.getName()+' wybito '+t+' monet.')):i<=n&&i<=t?(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:i}),console.log('W wiosce '+e.getName()+' wybito '+i+' monet.')):(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:n}),console.log('W wiosce '+e.getName()+' wybito '+n+' monet.'))):console.log('Za mało surowców żeby wybić monety w wiosce'+e.getName()):console.log('W wiosce '+e.getName()+' brak akademi')}),a)})),setTimeout(r,3e4)}let c={init:function(){t=!0},start:function(){
e.trigger(s.MINT_HELPER_STARTED),i=!0,r()},stop:function(){e.trigger(s.MINT_HELPER_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(s,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Mincerz',90,p('i18n')('description',i.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'mint_helper'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'mint_helper')))})),n.register(s.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,i,a,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){a.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var a=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',g='06050f',m='060506',_='060502',E='060501',f='060503',b='05020a',h='05030a',T='04080a',w='040a0a',v='070e04',A='070e05',S='070e0f',y='070e06',I='070e02',R='070e01',k='070e03',L='070e07',O='070e0b',N='070e0e',C='030d07',x='030d0b',M='030d0e';var P={init:function(){a=!0}};return P.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,g='string'==typeof g?parseInt(g,16):g,m='string'==typeof m?parseInt(m,16):m,_='string'==typeof _?parseInt(_,16):_,E='string'==typeof E?parseInt(E,16):E,f='string'==typeof f?parseInt(f,16):f,b='string'==typeof b?parseInt(b,16):b,h='string'==typeof h?parseInt(h,16):h,T='string'==typeof T?parseInt(T,16):T,w='string'==typeof w?parseInt(w,16):w,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,C='string'==typeof C?parseInt(C,16):C,x='string'==typeof x?parseInt(x,16):x,M='string'==typeof M?parseInt(M,16):M,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
