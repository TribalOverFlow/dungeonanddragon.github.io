...
let e=w('#two-attack-view').parent(),t=w('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleCommands=h.commands.slice(e,e+t),h.pagination.count=h.commands.length},R=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);y()},L=function(e,i){t.toggleFilter(e,i),h.filters=t.getFilters()},O=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},k=function(){h.commands=t.getCommands()},N=function(){h.selectedVillageId=a.getSelectedVillage().getId()},M=function(){h=i.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=a.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=E,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=p,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:y,limit:_.getPaginationLimit()},
h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=g.jumpToVillage,h.now=A,h.copyTimeModal=v,h.removeTroops=S,h.switchWindowSize=I,h.toggleFilter=L,h.toggleSorting=O,y();let e=new n('twoverflow_queue_window',(function(){T.timer.remove(R)}));e.register(s.MAP_SELECTED_VILLAGE,N,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,k),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,k),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,k),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,k),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),T.timer.add(R)};return function(){b=e.addMenuButton('Strażnik',40),b.addEventListener('click',M),
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,t,n,d,u,g,p,E,T,w,h,b){let A,v,S,I,y=a.getGroupList(),R={},L=!1,O={sequencesAvail:!0,modal:{}},k={sequencesAvail:!0},N={};const M={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,x={},P={},D=!1,z=!1;const G=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},U=function(e,t,i){if(i>=e.length){let t=i-e.length+1;for(;t--;)e.push(void 0)}e.splice(i,0,e.splice(t,1)[0])},V=function(e,a){switch(t.addBuildingSequence(e,a)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
const b=Object.values(c),A=Object.values(i),v=Object.values(h),S=Object.values(w),I=Object.values(T);let y,R=[],L={},O=[],k=[],N=!1;const M={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===a.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let i=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),a=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!a.includes(e))return i=!1,!0})),i}},C=function(e){return e<m.gameTime()+y},x=function(e){R.push(e)},P=function(e){L[e.id]=e},D=function(){
E.set(d.QUEUE_COMMANDS,R)},z=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&z(e.x)&&z(e.y)};let U={initialized:!1};return U.init=function(){y=t.getTimeOffset(),U.initialized=!0,O=E.get(d.QUEUE_SENT,[],!0),k=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){m.gameTime()>e.sendTime?U.expireCommand(e,n.TIME_LIMIT):(x(e),P(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!C(e.sendTime))return!0;N?U.sendCommand(e):U.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const i=function(e){const i=a.getVillages()[e.origin.id];if(!i)return n.NOT_OWN_VILLAGE;const o=i.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=n.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof i)return U.expireCommand(e,i);e.units=i,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){O.push(e)}(e),E.set(d.QUEUE_SENT,O),U.removeCommand(e,n.COMMAND_SENT),g.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){k.push(e)}(e),E.set(d.QUEUE_EXPIRED,k),U.removeCommand(e,t)},U.addCommand=function(e,n,o,l,s,r,d,g){let _={},E={};return new Promise((function(f,y){if(!G(e))return y(u.INVALID_ORIGIN);if(!G(n))return y(u.INVALID_TARGET);if(!t.isValidDateTime(o))return y(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(_[t]=e)})))return y(u.INVALID_UNIT_TYPE)}
if(angular.equals(_,{}))return y(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return y(u.INVALID_OFFICER_TYPE)}return b.includes(d)?d!==c.RELOCATE||a.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[w.SUPPORTER]&&delete E[w.SUPPORTER],'string'!=typeof g||I.includes(g)?(g=!(d!==c.ATTACK||!_[h.CATAPULT])&&(g||T.HEADQUARTER),A.includes(l)?void Promise.all([new Promise(t=>p.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>p.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(a){if(e=a[0],n=a[1],!e)return y(u.INVALID_ORIGIN);if(!n)return y(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,n,_,d,E,!0),c=l===i.ARRIVE?s-r:s,p=l===i.ARRIVE?s:s+r;if(C(c))return y(u.ALREADY_SENT);const T={id:t.guid(),travelTime:r,arriveTime:p,sendTime:c,origin:e,target:n,date:o,dateType:l,units:_,officers:E,type:d,catapultTarget:g,countdown:c-m.gameTime()};x(T),P(T),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
D(),f(T)})):y(u.INVALID_DATE_TYPE)):y(u.INVALID_CATAPULT_TARGET)):y(u.RELOCATE_DISABLED):y(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete L[e.id];const i=R.some((function(t,i){if(t.id==e.id)return R.splice(i,1),D(),!0}));if(i)switch(t){case n.TIME_LIMIT:g.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:g.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:g.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:g.trigger(s.COMMAND_QUEUE_REMOVE,e)}else g.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return i},U.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),k=[],O=[]},U.start=function(e){N=!0,g.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){N=!1,g.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return N},U.getWaitingCommands=function(){return R},U.getWaitingCommandsObject=function(){return L},U.getSentCommands=function(){return O},
U.getExpiredCommands=function(){return k},U.filterCommands=function(e,t,i){const n=M[e];return(i||R).filter((function(e){return n(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,l,d,u,g,_,p,E,f,T,w,h){let b,A,v,S,I,y=a.getGameData(),R=y.getOrderedUnitNames(),L=y.getOrderedOfficerNames(),O=a.getPresetList(),k=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},M=N.ADD;let C,x,P,D=[],z={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){k=t.data},W=function(){k=!1},B=function(e){
...
;const t=y.getAttackableBuildings();for(let e in t)D.push({name:m('i18n')(e,i.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){z[e]=0})),L.forEach((function(e){G[e]=!1})),I={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(z),officers:angular.copy(G),catapultTarget:"wall",type:null},x={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},A=e.addMenuButton('Generał',20),A.addEventListener('click',Te),E.register(s.COMMAND_QUEUE_START,(function(){A.classList.remove('btn-orange'),A.classList.add('btn-red')})),E.register(s.COMMAND_QUEUE_STOP,(function(){A.classList.remove('btn-red'),A.classList.add('btn-orange')})),i.$on(s.SHOW_CONTEXT_MENU,q),i.$on(s.DESTROY_CONTEXT_MENU,W),
...
barbarian:!i.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(m,p,_,A.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===i.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<a)}))return t(n.BUSY_TARGET);e()}),x=()=>new Promise((e,t)=>{if(_)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:i.id,num_reports:0},i=>{if(!this.running)return t(n.USER_STOP);const a=i.commands.own.filter(e=>e.type===A.TYPES.ATTACK&&'forward'===e.direction),o=a.some(e=>e.start_village_id!==this.villageId),l=a.some(e=>e.start_village_id===this.villageId);if(Te(l,o,!0))return t(n.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{E().then(T).then(S).then(y).then(R).then(O).then(N).then(M).then(C).then(x).then(e).catch(t)}),z=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([P,z]).then(()=>{if(!this.running)return!1
...
if(F.isAlly(e.tribe_id))return B.ally;if(F.isEnemy(e.tribe_id))return B.enemy;if(F.isNAP(e.tribe_id))return B.friendly}}return B.ugly},ve=function(e,t){for(let i=0;i<e.length;i++){const n=e[i];if(n.id<0)continue;const a=t||Ae(n);if(!a)continue;const o=n.x*I+(n.y%2?R:0),l=n.y*I;P.fillStyle=a,P.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),I=S+1,y=1e3*I,J.a=Z.a*I,J.b=Z.b*I,$.a=X.a*I,$.b=X.b*I,x.width=1e3*I,x.height=1e3*I,P.imageSmoothingEnabled=!1},Ie=function(){const e=document.body.clientHeight-265;M.width=686,M.height=e,D.width=686,D.height=e,C.imageSmoothingEnabled=!1,z.imageSmoothingEnabled=!1},ye=function(e){var i,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(_.trigger(s.MINIMAP_VILLAGE_CLICK,[k,N,e]),3===e.which&&(i=k,n=N,E.getTownAtAsync(i,n,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;xe.addHighlight({type:'character',id:e.character_id
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,a,d,u,g,_,p,E,f,T,w,h,b){let A,v,S,I,y,R,L,O,k,N,M,C={},x=!1,P={character:{},tribe:{}};const D={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=D.MINIMAP,G=function(e){A.selectedTab=e,e===D.MINIMAP?a.enableRendering():a.disableRendering()},U=function(){Object.keys(A.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
c.getScreenWithInjectedScope('!twoverflow_minimap_window',A),U(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(S),y.appendChild(I),a.enableRendering(),a.isFirstDraw()&&a.drawMinimap()};return function(){M=a.getSettings(),R=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',I=document.createElement('canvas'),I.className='cross',a.setViewport(S),a.setViewportRef(I),k=document.querySelector('#map-tooltip'),L=document.querySelector('#wrapper'),O=document.querySelector('#map'),v=t.addMenuButton('Minimapa',70),v.addEventListener('click',(function(){const e=a.getMapPosition();if(!e)return!1;Z(),a.setCurrentPosition(e.x,e.y)})),
...
e.trigger(s.MINT_HELPER_STARTED),i=!0,r()},stop:function(){e.trigger(s.MINT_HELPER_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return t}};return c})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Mincerz',90,m('i18n')('description',i.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',m('i18n')('deactivated',i.loc.ale,'mint_helper'))):(t.start(),n.notif('success',m('i18n')('activated',i.loc.ale,'mint_helper')))})),a.register(s.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),a.register(s.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(s.MINT_HELPER_STARTED),opener}})),
require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,i,n,a){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){n.get(o,!1,!0)&&t.start(),a.register(s.AUTO_HELPER_STARTED,(function(){n.set(o,!0)})),a.register(s.AUTO_HELPER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))}))}(this);