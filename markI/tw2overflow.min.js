...
v.pagination.count=v.commands.length},x=function(){const e=Date.now();for(let t=0;t<v.commands.length;t++)100===v.commands[t].model.percent(e)&&v.commands.splice(t,1);k()},R=function(e,a){t.toggleFilter(e,a),v.filters=t.getFilters()},I=function(e){t.toggleSorting(e),v.sorting=t.getSortings()},L=function(){v.commands=t.getCommands()},O=function(){v.selectedVillageId=n.getSelectedVillage().getId()},N=function(){v=a.$new(),v.commandQueueEnabled=t.commandQueueEnabled(),v.commands=t.getCommands(),v.selectedVillageId=n.getSelectedVillage().getId(),v.filters=t.getFilters(),v.sorting=t.getSortings(),v.UNIT_TYPES=b,v.FILTER_TYPES=u,v.COMMAND_TYPES=d,v.UNIT_SPEED_ORDER=_,v.COLUMN_TYPES=l,v.pagination={count:v.commands.length,offset:0,loader:k,limit:m.getPaginationLimit()},v.openCharacterProfile=r.openCharacterProfile,v.openVillageInfo=r.openVillageInfo,v.jumpToVillage=p.jumpToVillage,v.now=T,v.copyTimeModal=A,v.removeTroops=y,v.switchWindowSize=S,v.toggleFilter=R,v.toggleSorting=I,k()
;let e=new i('twoverflow_queue_window',(function(){E.timer.remove(x)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,L),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,L),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,L),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,L),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',v),E.timer.add(x)};return function(){w=e.addMenuButton('Strażnik',40),w.addEventListener('click',N),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,f,E){let h,v,w,T=injector.get('buildingService'),A=injector.get('premiumActionService'),y=injector.get('buildingQueueService'),S=!1,k=!1;const x={};let R,I,L,O,N,C=!0;const P='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=I.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=I.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
y.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=R.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(x);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return T.compute(e),V(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),F(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=B(e,t);if(i===g.POSSIBLE)q(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=w[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&q(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},q=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},B=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},F=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),f.set(P,L),!0};let j={};return j.start=function(){if(!C)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;k=!0,h=setInterval(z,6e4),v=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){k=!1,clearInterval(h),
...
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){S=!0,L=f.get(P,[],!0),I=n.getSelectedCharacter(),R=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),k&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)x[m[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,w=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(x);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!k)return!1;setTimeout((function(){let e=I.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,h,v,w,T){let A,y,S,k,x=n.getGroupList(),R={},I=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},q=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:T.readableSeconds(o.build_time),levelPoints:R[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,a=A.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in S)i[e]={level:0,order:S[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=S[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=R[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
...
const w=Object.values(c),T=Object.values(a),A=Object.values(v),y=Object.values(h),S=Object.values(E);let k,x=[],R={},I=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<g.gameTime()+k},P=function(e){x.push(e)},M=function(e){R[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,x)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){k=t.getTimeOffset(),U.initialized=!0,I=b.get(d.QUEUE_SENT,[],!0),L=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(P(e),M(e))}))}(),setInterval((function(){x.length&&x.some((function(e){if(!C(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&x.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){I.push(e)}(e),b.set(d.QUEUE_SENT,I),U.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){L.push(e)}(e),b.set(d.QUEUE_EXPIRED,L),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(f,k){if(!G(e))return k(u.INVALID_ORIGIN);if(!G(i))return k(u.INVALID_TARGET);if(!t.isValidDateTime(o))return k(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return k(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return k(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!y.includes(t))return!1;r[t]&&(b[t]=!0)})))return k(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[h.SUPPORTER]&&delete b[h.SUPPORTER],'string'!=typeof p||S.includes(p)?(p=!(d!==c.ATTACK||!m[v.CATAPULT])&&(p||E.HEADQUARTER),T.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return k(u.INVALID_ORIGIN);if(!i)return k(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(C(c))return k(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};P(E),M(E),x=x.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):k(u.INVALID_DATE_TYPE)):k(u.INVALID_CATAPULT_TARGET)):k(u.RELOCATE_DISABLED):k(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete R[e.id];const a=x.some((function(t,a){if(t.id==e.id)return x.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),L=[],I=[]},U.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return O},U.getWaitingCommands=function(){return x},U.getWaitingCommandsObject=function(){return R},U.getSentCommands=function(){return I},
U.getExpiredCommands=function(){return L},U.filterCommands=function(e,t,a){const i=N[e];return(a||x).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,f,E,h,v){let w,T,A,y,S,k=n.getGameData(),x=k.getOrderedUnitNames(),R=k.getOrderedOfficerNames(),I=n.getPresetList(),L=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,P,M,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){L=t.data},B=function(){L=!1},W=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),l=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},F=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},j=function(){if(w.isValidDate=o.isValidDateTime(S.date),!S.origin||!S.target)return;const e=!!w.isValidDate&&o.getTimeFromString(S.date),t=w.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(S.origin,S.target,i,a,S.officers,!0);w.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),w.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&w.isValidDate?E.gameTime()+C<e?'valid':'invalid':'neutral'},K=function(){S.dateType=w.selectedDateType.value,v.set(m.LAST_DATE_TYPE,w.selectedDateType.value),j()},Q=function(){
...
;const t=k.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});y=angular.copy(x),y.splice(y.indexOf('catapult'),1),x.forEach((function(e){D[e]=0})),R.forEach((function(e){G[e]=!1})),S={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},T=e.addMenuButton('Generał',20),T.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){T.classList.remove('btn-orange'),T.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){T.classList.remove('btn-red'),T.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,q),a.$on(s.DESTROY_CONTEXT_MENU,B),
...
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let v={init:function(){f=!0}};return v.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,v=c.clay,w=c.iron,T=f.currentStock,A=E.currentStock,y=v.currentStock,S=w.currentStock,k=[0,5e3],x=[160,16e3],R=[200,2e4],I=[50,5e3];1==s&&(h=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=h?'chapel'==i&&'church'==i||1!=h||(A>=x[1]&&y>=R[1]&&S>=I[1]&&T>=k[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):A>=x[0]&&y>=R[0]&&S>=I[0]&&T>=k[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==h?A>=x[1]&&y>=R[1]&&S>=I[1]&&T>=k[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):A>=x[0]&&y>=R[0]&&S>=I[0]&&T>=k[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
...
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const ye=function(e){const t=R[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),P.push(a)),a},Se=function(){_.each(L.getVillages(),(function(e,t){ye(t)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ke=function(){const e=R[r.GROUP_ONLY];let t=[];P.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){xe(e)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},xe=function(e){for(let a=0;a<P.length;a++)if(P[a].getId()===e)return P[a].stop(t.KILL_FARMER),P.splice(a,a+1),!0;return!1
},Re=function(e){he(),P.length?W>=P.length?(W=0,V=!1,Z=v.gameTime()+we(),w.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=P[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,Re())})),"cycle_begin"===e&&(Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):F=setTimeout((function(){F=null,W=0,Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Re()}),we())},Ie=function(e){for(let t=0;t<P.length;t++){let a=P[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Le=function(e){P.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=k.get(X,[]),I=k.get($,{}),L=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),x=new e({settingsMap:c,storageKey:J}),x.onChange((function(e,t,a){R=x.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(ke(),Se()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&C&&(j?(ve(),
V.targetStep({delay:!0})):F&&(ve(),w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,Re())))})),R=x.getAll(),se("ignore_update"),ne(),Se(),E((function(){ce()}),'presets'),E((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(U.length?(C=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Re("cycle_begin")})),he(),function(){let e=we(),t=e+e/2+Te();H=setInterval((function(){v.gameTime()-Q>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),w.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(C=!1,!1)):(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=v.gameTime()+we()),w.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,ve(),w.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(H),e===i.USER_STOP&&be(g.FARM_STOP)},Ne.getFarmer=function(e){return P.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return P},Ne.getSettings=function(){return x},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return I},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return C},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],k.set(X,M),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=we,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,h,v,w){let T,A,y,S=n.getPresetList(),k=n.getGroupList(),x={},R={},I=null;const L={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=T.pagination.offset,t=T.pagination.limit;T.visibleLogs=T.logs.slice(e,e+t),T.pagination.count=T.logs.length,T.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(x[e])return x[e];x[e]=!0,R[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){x[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},R[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
T.exceptionVillages.included.forEach((function(e){N(e)})),T.exceptionVillages.ignored.forEach((function(e){N(e)}))},P=function(){t.isRunning()?t.stop():t.start()},M=function(e){T.selectedTab=e},z=function(){A.setAll(A.decode(T.settings)),T.saveButtonColor='orange',h.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){T.presets=f.encodeList(S.getPresets(),{disabled:!1,type:'presets'})},V=function(){T.groups=f.encodeList(k.getGroups(),{disabled:!1,type:'groups'}),T.groupsWithDisabled=f.encodeList(k.getGroups(),{disabled:!0,type:'groups'})},q=function(){T.running=!0,
h.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},B=function(e,t){switch(T.running=!1,T.showCycleTimer=!1,clearInterval(I),t.reason){case d.NO_PRESETS:h.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){T.logs=angular.copy(t.getLogs()),O(),T.logs.length||h.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){T.farmers=t.getFarmers()},j=function(){T.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){T.exceptionLogs=t.getExceptionLogs()},K=function(){T.showCycleTimer=!1,clearInterval(I)},Q=function(e,a){a!==i.USER_STOP&&(T.showCycleTimer=!0,T.nextCycleCountdown=t.getCycleInterval(),I=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))},H=function(){let e=!0;T=a.$new(),T.SETTINGS=b,T.TAB_TYPES=L,T.LOG_TYPES=u,T.running=t.isRunning(),T.selectedTab=L.SETTINGS,T.farmers=t.getFarmers(),
T.villagesLabel=R,T.villagesInfo=x,T.exceptionVillages=t.getExceptionVillages(),T.exceptionLogs=t.getExceptionLogs(),T.logs=t.getLogs(),T.visibleLogs=[],T.showCycleTimer=!1,T.nextCycleCountdown=0,T.saveButtonColor='orange',T.settingsMap=A.settingsMap,T.pagination={count:T.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(T),U(),V(),O(),C(),function(){let e=t.getNextCycleDate();e&&(T.showCycleTimer=!0,T.nextCycleCountdown=e-w.gameTime(),I=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))}(),T.switchFarm=P,T.selectTab=M,T.saveSettings=z,T.clearLogs=t.clearLogs,T.jumpToVillage=p.jumpToVillage,T.openVillageInfo=r.openVillageInfo,T.showReport=_.showReport,T.removeIgnored=D,T.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(I)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
i.register(s.FARM_OVERFLOW_START,q),i.register(s.FARM_OVERFLOW_STOP,B),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,F),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,K),i.register(s.FARM_OVERFLOW_CYCLE_END,Q),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',T),T.$watch('settings',(function(){e||(T.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),y=e.addMenuButton('Farmer',10),y.addEventListener('click',(function(){H()})),v.register(s.FARM_OVERFLOW_START,(function(){y.classList.remove('btn-orange'),y.classList.add('btn-red')})),v.register(s.FARM_OVERFLOW_STOP,(function(){y.classList.remove('btn-red'),y.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,E,h,v,w,T,A){let y,S,k,x,R,I,L,O,N,C,P,M,z,D,G,U,V,q,B,W,F,j,Y,K=!1,Q={},H={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-x,a=Math.ceil(ee.y+e.offsetY)+x;return Math.floor(a/S)%2&&(t+=x),t-=t%S,a-=a%S,{x:Math.ceil((t-N.width/2)/S),y:Math.ceil((a-N.height/2)/S)}},be=function(e,t){return{x:e/T.TILESIZE.x,y:t/T.TILESIZE.y/T.TILESIZE.off}},fe=function(){Ae(R)},Ee=function(){if(K){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};C.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(P,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*S-e.x,i=(t.y-2)*S-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,k),D.fillRect(0,i,k,1);const n=U.getBoundingClientRect(),l=n.width/T.TILESIZE.x/A.view.z*S,s=n.height/T.TILESIZE.y/A.view.z*S,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)
},he=function(){if(!ie)return!1;const e=H.village[L][O];we(e?H.character[e]:[[L,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:L,y:O})},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},Te=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in Q.character?Q.character[e.character_id]:e.tribe_id in Q.tribe&&Q.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===q){if(e.id===I.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in Q.character)return Q.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in Q.character)return Q.character[e.character_id];if(e.tribe_id in Q.tribe)return Q.tribe[e.tribe_id];if(B&&B===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(F&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(F.isAlly(e.tribe_id))return W.ally;if(F.isEnemy(e.tribe_id))return W.enemy;if(F.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Te(i);if(!n)continue;const o=i.x*S+(i.y%2?x:0),l=i.y*S;M.fillStyle=n,M.fillRect(o,l,y,y)}},ye=function(){y=oe[Y[o.MAP_SIZE]],x=Math.round(y/2),S=y+1,k=1e3*S,J.a=Z.a*S,J.b=Z.b*S,$.a=X.a*S,$.b=X.b*S,P.width=1e3*S,P.height=1e3*S,M.imageSmoothingEnabled=!1},Se=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ke=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,i=O,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id
},v.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({type:'tribe',id:e.tribe_id},v.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},xe=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Re=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in Q.character?e=!0:t.tribe_id in Q.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(L===e.x&&O===e.y)return!1;he()}ie=!0,L=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:L,y:O,event:t});const a=H.village[L][O];ve(a?H.character[a]:[[L,O]])}(pe,e)}he()},Ie=function(){ie&&he(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){Q.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},Q.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},fe()},Ce=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(Q,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;Q[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,Q[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(Q,e))return!1;if(!f.call(Q[e],t))return!1;delete Q[e][t]
;const i='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,Q[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(Q[e],t)&&Q[e][t]},getHighlights:function(){return Q},eachHighlight:function(e){for(let t in Q)for(let a in Q[t])e(t,a,Q[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],C=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*S,ee.y=t*S,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return j},Pe.drawMinimap=function(){ge&&(ge=!1),N.style.background=Y[o.COLOR_BACKGROUND],M.clearRect(0,0,P.width,P.height),d((function(){
!function(){const e=h.getPath(T.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*S+x-1,t*S+x-1,3,1),M.fillRect(e*S+x,t*S+x-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*S+x,t*S+x-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=E.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*S,c=s.a*S,d=(l.b-l.a)*S,u=(s.b-s.a)*S;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Pe.enableRendering=function(){K=!0},Pe.disableRendering=function(){K=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),M=P.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),ye(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),Y=j.getAll(),Q.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},Q.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},ye()},Pe.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),F=V.getTribeRelations(),q=V.getId(),B=V.getTribeId(),W=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),Se(),I=V.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*S,ee.y=I.getY()*S,e.addEventListener('resize',Se,!1),z.addEventListener('mousedown',ke),z.addEventListener('mouseup',xe),z.addEventListener('mousemove',Re),z.addEventListener('mouseleave',Ie),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){R=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in H.village||(H.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
H.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in H.character?H.character[a.character_id].push([a.x,a.y]):H.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in H.tribe?H.tribe[a.tribe_id].push(a.character_id):H.tribe[a.tribe_id]=[a.character_id])))}}(R),function(){let e=[],t=[];for(let a in H.village){e.push(a);for(let e in H.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*S,J.b=Z.b*S,$.a=X.a*S,$.b=X.b*S}(),Ee(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ce),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,f,E,h,v,w){let T,A,y,S,k,x,R,I,L,O,N,C={},P=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){T.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(T.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(T.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!L)return;let a=V(t.x,t.y);var i,n;O=a,C[a]=!0,P=!0,(i=t.x,n=t.y,new Promise((function(e){let t=h.getTownAt(i,n);if(t)return e(t);h.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[V(e.x,e.y)])return;if(!P)return;R.appendChild(L),L.classList.remove('ng-hide'),x.tt.name=e.name,x.tt.x=e.x,x.tt.y=e.y,x.tt.province_name=e.province_name,x.tt.points=e.points,x.tt.character_name=e.character_name||'-',x.tt.character_points=e.character_points||0,x.tt.tribe_name=e.tribe_name||'-',x.tt.tribe_tag=e.tribe_tag||'-',x.tt.tribe_points=e.tribe_points||0,x.tt.morale=e.morale||0,x.tt.position={},x.tt.position.x=t.event.pageX+50,x.tt.position.y=t.event.pageY+50,x.tt.visible=!0
;const a=L.getBoundingClientRect(),i=R.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=x.tt.position.y+o>i.top+i.height,s=x.tt.position.x+n>i.width;l&&(x.tt.position.y-=50),L.classList.toggle('left',s),L.classList.toggle('top',l)}))},B=function(e,t){if(!L)return;let a=t?V(t):O;C[a]=!1,P=!1,x.tt.visible=!1,L.classList.add('ng-hide'),I.appendChild(L)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){T.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){T.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=T.addHighlightColor,s.submit=function(){T.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=T.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},F=function(){n.addHighlight(T.selectedHighlight,T.addHighlightColor)},j=function(){N.setAll(N.decode(T.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},K=function(){return Object.keys(T.highlights.character).length+Object.keys(T.highlights.tribe).length},Q=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},H={addHighlightAutoCompleteSelect:function(e){T.selectedHighlight={id:e.id,type:e.type,name:e.name}},
...
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:H.addHighlightAutoCompleteSelect},T.selectTab=G,T.openColorPalette=W,T.addCustomHighlight=F,T.removeHighlight=n.removeHighlight,T.saveSettings=j,T.resetSettings=Y,T.highlightsCount=K,T.openProfile=Q,N.injectScope(T,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,H.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,H.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,H.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,H.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,q),e.register(s.MINIMAP_VILLAGE_BLUR,B),e.register(s.MINIMAP_MOUSE_LEAVE,H.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,H.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,H.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',T),U(),k=document.querySelector('#two-minimap .minimap-container'),k.appendChild(y),k.appendChild(S),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),x=i.getSharedData('MapController'),y=document.createElement('canvas'),y.className='minimap',S=document.createElement('canvas'),S.className='cross',n.setViewport(y),n.setViewportRef(S),L=document.querySelector('#map-tooltip'),R=document.querySelector('#wrapper'),I=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
v.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,v.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,v.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,v.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,v.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,v.push(' Zjednoczenie '+g+'%'))}));var T=v.join(),A=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),S=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),x=d.defCharacterId,R=d.defCharacterName,I=d.defVillageId,L=d.defVillageName,O=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),P=d.night,M=d.loyaltyAfter,z=d.loyaltyBefore,D=d.wallAfter,G=d.wallBefore,U=d.officers,V=d.leader,q='',B='',W='',F='',j='',Y='',K='',Q='',H='',Z=Date.now(),X=s.split('.').join('_')
;null!=z&&(Y='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=M&&(K='Lojalność po ataku: '+Math.floor(M)+' '),null!=G&&(Q='Mury przed ataku: '+G+' '),null!=D&&(H='Mury po ataku: '+D+' '),null==U&&1==V?j='Brak':null==U&&1.1==V&&(j=' Wielki Mistrz '),F=0==P?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',B=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+L+'[/village][b] Gracz cel: [/b][player='+x+']'+R+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+T+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+S+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+j+'[/b][br]'+Y+K+'[br]'+Q+H+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},f=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var h=[],v=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,h.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var w=h.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),v.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,v.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,v.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,v.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,v.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,v.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
v.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,v.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,v.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,v.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,v.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,v.push(' Zjednoczenie '+g+'%'))}));var T,A=v.join(),y=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),k=Math.round(100*d.morale).toFixed([0]),x=(100*(d.luck-1)).toFixed([0]),R=d.defCharacterId,I=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),C=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),M=d.night,z=d.loyaltyAfter,D=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,V=d.officers,q='',B='',W='',F='',j='',Y='',K='',Q='',H=[],Z=Date.now(),X=s.split('.').join('_')
;if(null!=D&&(j='Lojalność przed atakiem: '+Math.floor(D)+' '),null!=z&&(Y='Lojalność po ataku: '+Math.floor(z)+' '),null!=U&&(K='Mury przed ataku: '+U+' '),null!=G&&(Q='Mury po ataku: '+G+' '),null==V)H.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?H.push('Brak'):(1==J?H.push(' Oszust '):H.push(''),1==$?H.push(' Wielki Mistrz '):H.push(''),1==ee?H.push(' Medyk '):H.push(''),1==te?H.push(' Łowczy '):H.push(''),1==ae?H.push(' Mistrz Łupu '):H.push(''),1==ie?H.push(' Taktyk '):H.push(''))}if(F=0==M?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',B=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),T=H.join(),null!=I){
a.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+R+']'+I+'[/player][br]Modyfikator obrony: [b]'+C+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+k+'[/b][br]Wiara: [b]'+y+'[/b] Szczęście: [b]'+x+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+T+'[/b][br]'+j+Y+'[br]'+K+Q+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},E={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
