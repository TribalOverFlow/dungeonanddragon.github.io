...
return null===a?t:'object'==typeof a&&void 0!==a.data?a.data:t},t})),define('two/about',[],(function(){let e=!1,t={isInitialized:function(){return e},init:function(){e=!0}};return t})),define('two/about/ui',['two/ui'],(function(e){let t;const n=function(e){t.selectedTab=e},a=function(){t=i.$new(),t.selectTab=n,c.getModal('!twoverflow_about_window',t)};return function(){e.addDivisor(99),e.addMenuButton('O mnie',190).addEventListener('click',(function(){a()})),
