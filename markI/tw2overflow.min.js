...
v.pagination.count=v.commands.length},x=function(){const e=Date.now();for(let t=0;t<v.commands.length;t++)100===v.commands[t].model.percent(e)&&v.commands.splice(t,1);k()},I=function(e,a){t.toggleFilter(e,a),v.filters=t.getFilters()},R=function(e){t.toggleSorting(e),v.sorting=t.getSortings()},L=function(){v.commands=t.getCommands()},O=function(){v.selectedVillageId=n.getSelectedVillage().getId()},N=function(){v=a.$new(),v.commandQueueEnabled=t.commandQueueEnabled(),v.commands=t.getCommands(),v.selectedVillageId=n.getSelectedVillage().getId(),v.filters=t.getFilters(),v.sorting=t.getSortings(),v.UNIT_TYPES=b,v.FILTER_TYPES=u,v.COMMAND_TYPES=d,v.UNIT_SPEED_ORDER=_,v.COLUMN_TYPES=l,v.pagination={count:v.commands.length,offset:0,loader:k,limit:m.getPaginationLimit()},v.openCharacterProfile=r.openCharacterProfile,v.openVillageInfo=r.openVillageInfo,v.jumpToVillage=p.jumpToVillage,v.now=T,v.copyTimeModal=A,v.removeTroops=y,v.switchWindowSize=S,v.toggleFilter=I,v.toggleSorting=R,k()
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,h,v,w,T){let A,y,S,k,x=n.getGroupList(),I={},R=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},q=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:T.readableSeconds(o.build_time),levelPoints:I[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,a=A.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in S)i[e]={level:0,order:S[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=S[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=I[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
...
const w=Object.values(c),T=Object.values(a),A=Object.values(v),y=Object.values(h),S=Object.values(E);let k,x=[],I={},R=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<g.gameTime()+k},P=function(e){x.push(e)},M=function(e){I[e.id]=e},z=function(){
...
h.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},B=function(e,t){switch(T.running=!1,T.showCycleTimer=!1,clearInterval(R),t.reason){case d.NO_PRESETS:h.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){T.logs=angular.copy(t.getLogs()),O(),T.logs.length||h.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){T.farmers=t.getFarmers()},j=function(){T.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){T.exceptionLogs=t.getExceptionLogs()},K=function(){T.showCycleTimer=!1,clearInterval(R)},Q=function(e,a){a!==i.USER_STOP&&(T.showCycleTimer=!0,T.nextCycleCountdown=t.getCycleInterval(),R=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))},H=function(){let e=!0;T=a.$new(),T.SETTINGS=b,T.TAB_TYPES=L,T.LOG_TYPES=u,T.running=t.isRunning(),T.selectedTab=L.SETTINGS,T.farmers=t.getFarmers(),
T.villagesLabel=I,T.villagesInfo=x,T.exceptionVillages=t.getExceptionVillages(),T.exceptionLogs=t.getExceptionLogs(),T.logs=t.getLogs(),T.visibleLogs=[],T.showCycleTimer=!1,T.nextCycleCountdown=0,T.saveButtonColor='orange',T.settingsMap=A.settingsMap,T.pagination={count:T.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(T),U(),V(),O(),C(),function(){let e=t.getNextCycleDate();e&&(T.showCycleTimer=!0,T.nextCycleCountdown=e-w.gameTime(),R=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))}(),T.switchFarm=P,T.selectTab=M,T.saveSettings=z,T.clearLogs=t.clearLogs,T.jumpToVillage=p.jumpToVillage,T.openVillageInfo=r.openVillageInfo,T.showReport=_.showReport,T.removeIgnored=D,T.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(R)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
...
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){Q.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},Q.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},fe()},Ce=function(){const e={id:R.getId(),x:R.getX(),y:R.getY()};R=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:R.getId(),x:R.getX(),y:R.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(Q,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;Q[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,Q[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(Q,e))return!1;if(!f.call(Q[e],t))return!1;delete Q[e][t]
