...
snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}},pl_pl:{about:{contact:"Kontakt",email:"Email",links:"Linki projektów",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},army_helper:{title:"Administrator",presets:"Szablony","presets.asign":"Przypisz","presets.all":"Przypisz wszystkie szablony do wszystkich wiosek.","presets.textall":"Przypisz wszystkie szablony do wszystkich wiosek.","presets.name":"Przypisz szablony zawierające wskazaną frazę do wszystkich wiosek.","presets.textname":"Przypisz szablony zawierające wskazaną frazę do wszystkich wiosek.","presets.or":"Lub wybierz z listy","presets.group":"Przypisz wszystkie szablony do wybranej grupy wiosek.","presets.textgroup":"Przypisz wszystkie szablony do wybranej grupy wiosek.",
...
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},C={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},M={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3},G={[f.LEVEL_1]:4,[f.LEVEL_2]:8,[f.LEVEL_3]:12,[f.LEVEL_4]:16,[f.LEVEL_5]:20};console.log(L,G,M,C,P,N,O,x,R,k,I);const z=function(){A=[];const e=n.getPresetList().getPresets();h[t.PRESET].forEach((function(t){A.push(e[t])}))},D={init:function(){v=!0,w=new e({settingsMap:i,storageKey:y}),w.onChange((function(e,t){h=w.getAll(),t[o.PRESETS]&&z()})),h=w.getAll(),console.log('battleCalculator settings',h),E((function(){z()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,z),a.$on(l.ARMY_PRESET_DELETED,z)},start:function(){S=!0,_.trigger(l.BATTLE_CALCULATOR_START)},
stop:function(){S=!1,console.log('example module stop'),_.trigger(l.BATTLE_CALCULATOR_STOP)},getSettings:function(){return w},isInitialized:function(){return v},isRunning:function(){return S}};return D})),define('two/battleCalculator/events',[],(function(){angular.extend(l,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
...
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},F=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),f.set(C,x),!0};let Y={};return Y.start=function(){if(!P)return b.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,_=setInterval(G,6e4),w=setInterval(z,6e3),e((function(){D().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),G(),z()}),['all_villages_ready']),b.trigger(l.BUILDER_QUEUE_START)},Y.stop=function(){R=!1,clearInterval(_),
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,b,E,_,w,h,v){let S,A,y,R,k=n.getGroupList(),I={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},G={},z=!1,D=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
O.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequence.offset,t=S.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),S.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},x.moveUp=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(z=!0)},x.moveDown=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(z=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),z=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),z=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=R.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in _)i[_[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),S.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:z=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(x.selectedSequence.value),z=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=x.lastAddedIndex,e.indexLimit=x.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(x.lastAddedBuilding,a.loc.ale,'building_names'),value:x.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),s=y[t].max_level;x.lastAddedBuilding=t,x.lastAddedIndex=i,x.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,s))},
...
;const t=R.getAttackableBuildings();for(let e in t)G.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});A=angular.copy(k),A.splice(A.indexOf('catapult'),1),k.forEach((function(e){z[e]=0})),I.forEach((function(e){D[e]=!1})),y={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(z),officers:angular.copy(D),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',10),v.addEventListener('click',Ee),b.register(l.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),b.register(l.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,B),a.$on(l.DESTROY_CONTEXT_MENU,q),
...
v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(k[e])return k[e];k[e]=!0,I[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){v.exceptionVillages.included.forEach((function(e){N(e)})),v.exceptionVillages.ignored.forEach((function(e){N(e)}))},C=function(){t.isRunning()?t.stop():t.start()},M=function(e){v.selectedTab=e},G=function(){S.setAll(S.decode(v.settings)),v.saveButtonColor='orange',_.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},z=function(e){const t=S.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},D=function(e){
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,b,f,E,_,w,h){let v,S,A,y,R,k,I,L,x,O,N,P={},C=!1,M={character:{},tribe:{}};const G={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},z=G.MINIMAP,D=function(e){v.selectedTab=e,e===G.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(v.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
t=Math.floor(C/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+x+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+I+'[/village][b] Gracz cel: [/b][player='+S+']'+A+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+l+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var G=d.join();S!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14383,message:G}):o.emit(s.MESSAGE_REPLY,{message_id:6467,message:G}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14382,message:G}):o.emit(s.MESSAGE_REPLY,{message_id:6466,message:G}),d=[])},b=function(e){
...
[n.HOSPITAL]:'hospital',[n.CLAY_PIT]:'clay_pit',[n.IRON_MINE]:'iron_mine',[n.TIMBER_CAMP]:'timber_camp',[n.CHAPEL]:'chapel',[n.CHURCH]:'church',[n.MARKET]:'market',[n.ACADEMY]:'academy'},f={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},E={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'},_={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',
[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(_,f,b,E);const w={init:function(){g=!0,u=new e({settingsMap:a,storageKey:T}),p=u.getAll(),console.log('all settings',p)},start:function(){m=!0,d.trigger(l.SPY_MASTER_START)},stop:function(){m=!1,d.trigger(l.SPY_MASTER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return w})),define('two/spyMaster/events',[],(function(){angular.extend(l,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u,p,m){let T,b,f;const E={SPY:'spy',COUNTERMEASURES:'countermeasures',
LOGS:'logs'},_=function(e){T.selectedTab=e},w=function(){b.setAll(b.decode(T.settings)),m.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},v=function(){T.running=!0,f.classList.remove('btn-orange'),f.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},S=function(){T.running=!1,f.classList.remove('btn-red'),f.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},A=function(){T=a.$new(),T.SETTINGS=i,T.TAB_TYPES=E,T.running=t.isRunning(),T.selectedTab=E.SPY,T.settingsMap=n,T.building=u.encodeList(o,{textObject:'spy_master',disabled:!0}),T.unit=u.encodeList(s,{textObject:'spy_master',disabled:!0}),T.dummies=u.encodeList(r,{textObject:'spy_master',disabled:!0}),T.replacement=u.encodeList(d,{textObject:'spy_master',disabled:!0}),b.injectScope(T),T.selectTab=_,T.saveSettings=w,T.switchState=h;let e=new p('twoverflow_spy_master_window',(function(){
console.log('spyMaster window closed')}));e.register(l.SPY_MASTER_START,v),e.register(l.SPY_MASTER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',T)};return function(){b=t.getSettings(),f=e.addMenuButton3('Zwiadowca',10),f.addEventListener('click',A),
