...
;var _,f,h,b,v,E,w,T,A,y,S,I,k,x,R,M,L,O,N,C,D,P,z,G,B,U,V,q,W,F,j,Y,H,Q,K,Z,X,J,$,ee,te,ae,ne,ie,oe,le,se,re,ce,de,ue,pe,ge,me,_e,fe,he,be,ve,Ee,we,Te,Ae,ye,Se,Ie,ke,xe,Re,Me,Le,Oe,Ne,Ce,De,Pe,ze,Ge,Be,Ue,Ve,qe,We,Fe,je,Ye,He,Qe,Ke,Ze,Xe,Je,$e,et,tt,at,nt,it,ot,lt,st,rt,ct,dt,ut,pt,gt,mt,_t,ft,ht,bt,vt,Et,wt,Tt,At,yt,St,It,kt,xt,Rt,Mt,Lt,Ot,Nt,Ct,Dt,Pt,zt,Gt,Bt,Ut,Vt,qt,Wt,Ft,jt,Yt,Ht,Qt,Kt,Zt,Xt,Jt,$t,ea,ta,aa,na,ia,oa,la,sa,ra,ca,da,ua,pa,ga,ma,_a,fa,ha,ba,va,Ea,wa,Ta,Aa,ya,Sa,Ia,ka,xa,Ra,Ma,La,Oa,Na,Ca,Da,Pa,za,Ga,Ba,Ua,Va,qa,Wa,Fa,ja,Ya,Ha,Qa,Ka,Za,Xa,Ja,$a,en,tn={},an=function(){kt.on('click',(function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],t=[4,5,1,5,5,6,23,4,12,40,200,25,10],a=[25,55,10,10,30,40,200,20,100,250,100,200,100],n=[45,5,5,30,40,30,160,50,50,400,50,250,100],i=[10,30,10,60,30,50,180,20,100,150,100,200,50],o=parseInt(document.getElementById('archerA').value),l=parseInt(document.getElementById('archerD').value),s=[10,25,45,25,130,150,150,2,100,150,30,30,300],r=parseInt(document.getElementById('axeA').value),c=parseInt(document.getElementById('axeD').value),d=parseInt(document.getElementById('berserkerA').value),u=parseInt(document.getElementById('berserkerD').value),p=parseInt(document.getElementById('catapultA').value),g=parseInt(document.getElementById('catapultD').value),m=parseInt(document.getElementById('buildingLevel').value),kt=[1,1,1,1,4,5,6,5,8,1,100,10,6],xt=parseInt(document.getElementById('hcA').value),Rt=parseInt(document.getElementById('hcD').value),Mt=parseInt(document.getElementById('knightA').value),Lt=parseInt(document.getElementById('knightD').value),Ot=parseInt(document.getElementById('lcA').value),Nt=parseInt(document.getElementById('lcD').value),Ct=parseInt(document.getElementById('luck').value),Dt=parseInt(document.getElementById('maA').value),Pt=parseInt(document.getElementById('maD').value),zt=parseInt(document.getElementById('morale').value),Gt=parseInt(document.getElementById('ramA').value),Bt=parseInt(document.getElementById('ramD').value),Ut=parseInt(document.getElementById('snobA').value),Vt=parseInt(document.getElementById('snobD').value),qt=parseInt(document.getElementById('spearA').value),Wt=parseInt(document.getElementById('spearD').value),Ft=parseInt(document.getElementById('swordA').value),jt=parseInt(document.getElementById('swordD').value),Yt=parseInt(document.getElementById('trebuchetA').value),Ht=parseInt(document.getElementById('trebuchetD').value),Qt=parseInt(document.getElementById('wall').value),Kt=0,Zt=0,Xt=0,Jt=0,$t=0,ya=0,Sa=0,Ia=0,ka=0,xa=0,Ra=0,Ma=0,La=0,Oa=0,Na=0,Ca=0,Da=0,Pa=0,za=0,Ga=0,Ba=0,Ua=0,Va=0,qa=0,Wa=0,Fa=0,ja=0,Ya=0,Ha=0,Qa=0,Ka=0,Za=0,Xa=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,_n=0,fn=0,hn=0,bn=0,vn=0,En=0,wn=0,Tn=0,An=0,yn=0,Sn=0,In=0,kn=0,xn=0,Rn=0,Mn=0,Ln=0,On=0,Nn=0,Cn=0,Dn=0,Pn=0,zn=0,Gn=0,Bn=0,Un=0,Vn=0,qn=0,Wn=0,Fn=0,jn=0,Yn=0,Hn=0,Qn=0,Kn=0,Zn=0,Xn=0,Jn=0,$n=0,ei=0,ti=0,ai=0,ni=0,ii=0,oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,_i=0,fi=0,hi=0,bi=[1,1],vi=[1,1],Ei=[1,1],wi=[1,1],Ti=[1,1],Ai=[1,1],yi=[1,1],Si=[1,1],Ii=[1,1],ki=[1,1],xi=[1,1],Ri=[1,1],Mi=[1,1],Li=[1,1],Oi=[1,1],Ni=[1,1],Ci=[1,1],Di=[1,1],Pi=[1,1],zi=[1,1],Gi=[1,1],Bi=[1,1],Ui=[1,1],Vi=[1,1],qi=[1,1],Wi=[1,1],Fi=[1,1],ji=[1,1],Yi=[1,1],Hi=[1,1],Qi=[1,1],Ki=[1,1],Zi=[1,1],Xi=[1,1],Ji=[1,1],$i=[1,1],eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,_o=0,fo=0,ho=0,bo=0,vo=0,Eo=0,wo=0,To=0,Ao=0,yo=0,So=0,Io=0,ko=0,xo=0,Ro=0,Mo=0,Lo=0,Oo=0,No=0,Co=0,Do=0,Po=0,zo=[1,1],Go=0,Bo=0,Uo=0,Vo=0,qo=0,Wo=0,Fo=0,jo=0,Yo=0,Ho=0,Qo=0,Ko=0,Zo=0,Xo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,_l=0,fl=0,hl=0,bl=0,vl=0,El=0,wl=0,Tl=0,Al=0,yl=0,Sl=0,Il=0,kl=[1,1],xl=[1,1],Rl=[1,1],Ml=[1,1],Ll=[1,1],Ol=[1,1],Nl=[1,1],Cl=[1,1],Dl=[1,1],Pl=0,zl=0,Gl=0,Bl=0,Ul=0,Vl=0,ql=0,Wl=0,Fl=0,jl=0,Yl=0,Hl=0,Ql=0,Kl=0,Zl=0,Xl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,_s=0,fs=0,hs=0,bs=0,vs=0,Es=0,ws=0,Ts=0,As=0,ys=0,Ss=0,Is=0,ks=0,xs=0,Rs=0,Ms=0,Ls=0,Os=0,Ns=0,Cs=0,Ds=0,Ps=0,zs=0,Gs=0,Bs=0,Us=0,Vs=0,qs=0,Ws=0,Fs=0,js=0,Ys=0,Hs=0,Qs=0,Ks=0,Zs=0,Xs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,_r=0,fr=0,hr=0,br=1,vr=0,Er=0,wr=0,Tr=0,Ar=0,yr=0,Sr=0,Ir=0,kr=0,xr=0,Rr=0,Mr=0,Lr=0,Or=0,Nr=0,Cr=0,Dr=0,Pr=0,zr=0,Gr=0,Br=0,Ur=0,Vr=0,qr=0,Wr=0,Fr=0,jr=0,Yr=0,Hr=0,Qr=0,Kr=0,Zr=0,Xr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,_c=0,fc=0,hc=0,bc=0,vc=0,Ec=0,wc=0,Tc=0,Ac=0,yc=0,Sc=0,Ic=0,kc=0,xc=0,Rc=0,Mc=0,Lc=0,Oc=0,Nc=0,Cc=0,Dc=0,Pc=0,zc=0,Gc=0,Bc=0,Uc=0,Vc=0,qc=0,Wc=0,Fc=0,jc=0,Yc=0,Hc=0,Qc=0,Kc=0,Zc=0,Xc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,_d=0,fd=0,hd=0,bd=0,vd=0,Ed=0,wd=0,Td=0,Ad=0,yd=0,Sd=0,Id=0,kd=0,xd=0,Rd=0,Md=0,Ld=0,Od=0,Nd=0,Cd=0,Dd=0,Pd=0,zd=0,Gd=0,Bd=0,Ud=0,Vd=0,qd=0,Wd=0,Fd=0,jd=0,Yd=0,Hd=0,Qd=0,Kd=0,Zd=0,Xd=0,Jd=0,$d=0,eu=0,tu=0,au=0,nu=0,iu=0,ou=0,lu=0,su=0,ru=0,cu=0,du=0,uu=0,pu=0,gu=0,mu=0,_u=0,fu=0,hu=0,bu=0,vu=0,Eu=0,wu=0,Tu=0,Au=0,yu=0,Su=0,Iu=0,ku=0,xu=0,Ru=0,Mu=0,Lu=0,Ou=0,Nu=0,Cu=0,Du=0,Pu=0,zu=0,Gu=0,Bu=0,Uu=0,Vu=0,qu=0,Wu=0,Fu=0,ju=0,Yu=0,Hu=0,Qu=0,Ku=0,Zu=0,Xu=0,Ju=0,$u=0,ep=0,tp=0,ap=0,np=0,ip=0,op=0,lp=0,sp=0,rp=0,cp=0,dp=0,up=0,pp=0,gp=0,mp=0,_p=0,fp=0,hp=0,bp=0,vp=0,Ep=0,wp=0,Tp=0,Ap=0,yp=0,Sp=0,Ip=0,kp=0,xp=0,Rp=0,Mp=0,Lp=0,Op=0,Np=0,Cp=0,Dp=0,Pp=0,zp=0,Gp=0,Bp=0,Up=0,Vp=0,qp=0,Wp=0,Fp=0,jp=0,Yp=0,Hp=0
...
Rl='catapult'==Po&1==xs?[1.05,1.25]:'catapult'==Po&2==xs?[1.1,1.5]:'catapult'==Po&3==xs?[1.2,2]:[1,1],ja=qt*kt[0]+Ft*kt[1]+r*kt[2]+o*kt[3]+Ot*kt[4]+Dt*kt[5]+xt*kt[6]+Gt*kt[7]+p*kt[8]+Mt*kt[9]+Ut*kt[10]+Yt*kt[11]+d*kt[12],fi=Wt*kt[0]+jt*kt[1]+c*kt[2]+l*kt[3]+Nt*kt[4]+Pt*kt[5]+Rt*kt[6]+Bt*kt[7]+g*kt[8]+Lt*kt[9]+Vt*kt[10]+Ht*kt[11]+u*kt[12],eo=2*ja<=fi?2:1,vr=ja-5*Gt,Tr=0==Qt?0:Math.round(20*Math.pow(1.2515,Qt-1)),hi=fi+(Tr+100*Vt),Hr=0==vr||0==hi?0:vr/hi>1?1:vr/hi,hr=zt/100,Ys=Ct/100,wr=Math.round(1e3*(to/100*hr*(1+Ys)+xc/100+ys))/1e3,hp=p/(fp=Gt+p),bp=Gt/fp,Qu=Math.round(Ht*hp),up=Math.round(Ht*bp),vc=(wc=Gt-(0==Gt?0:Gt<up?Gt:up))*Hr*wr*(zo='ram'==Po?1==xs?[1.05,1.25]:2==xs?[1.1,1.5]:3==xs?[1.2,2]:[1,1]:[1,1])[1],Mo=20==Qt?18:19==Qt?17:18==Qt?15:17==Qt?14:16==Qt?13:15==Qt?11:14==Qt?10:13==Qt||12==Qt?9:11==Qt?8:10==Qt?7:9==Qt||8==Qt?6:7==Qt||6==Qt?5:5==Qt||4==Qt||3==Qt?4:2==Qt||1==Qt?3:0,mp=0==Qt?0:2*Mo,pp=0==Qt?0:vc/mp,_p=Qt<=Lc?Qt:Qt-Lc<pp?Qt<Lc?Qt:Lc:Qt-pp,bn=Math.round(_p),
hn=Math.round(.05*bn*1e3)/1e3,Er=Math.round(ao/100*(1+hn)*br*1e3)/1e3,mi=p-(0==p?0:p<Qu?p:Qu),fn=0==(gp=Math.round(_p))?0:Math.round(20*Math.pow(1.2515,gp-1)),es=qt+Ft+r+d>Ot+xt&&qt+Ft+r+d>o+Dt?'inf':Ot+xt>qt+Ft+r+d&&Ot+xt>o+Dt?'cav':'arc',Or=qt*kt[0]+Ft*kt[1]+r*kt[2]+o*kt[3]+Ot*kt[4]+Dt*kt[5]+xt*kt[6]+wc*kt[7]+mi*kt[8]+Mt*kt[9]+Ut*kt[10]+Yt*kt[11]+d*kt[12],Fr=Wt*kt[0]+jt*kt[1]+c*kt[2]+l*kt[3]+Nt*kt[4]+Pt*kt[5]+Rt*kt[6]+Bt*kt[7]+g*kt[8]+Lt*kt[9]+Vt*kt[10]+Ht*kt[11]+u*kt[12],console.log('provisionDefenderRound1Total'+Fr),Ac=wc*kt[7]+mi*kt[8]+Yt*kt[11]+Mt*kt[9]+Ut*kt[10],'cav'==es?(Ir=Ot*kt[4]+xt*kt[6]+Ac,Rr=qt*kt[0]+Ft*kt[1]+r*kt[2]+d*kt[12],Ar=o*kt[3]+Dt*kt[5]):'inf'==es?(Rr=qt*kt[0]+Ft*kt[1]+r*kt[2]+d*kt[12]+Ac,Ir=Ot*kt[4]+xt*kt[6],Ar=o*kt[3]+Dt*kt[5]):'arc'==es?(Rr=qt*kt[0]+Ft*kt[1]+r*kt[2]+d*kt[12],Ir=Ot*kt[4]+xt*kt[6],Ar=o*kt[3]+Dt*kt[5]+Ac):(Rr=qt*kt[0]+Ft*kt[1]+r*kt[2]+d*kt[12],Ir=Ot*kt[4]+xt*kt[6],Ar=o*kt[3]+Dt*kt[5]),zs=0==Rr?0:Math.round(Rr/Or*1e4)/1e4,
Ps=0==Ir?0:Math.round(Ir/Or*1e4)/1e4,0==Ar?(Ds=0,console.log('lossesPercentRound1Arc'+Ds)):(Ds=Math.round(Ar/Or*1e4)/1e4,console.log('lossesPercentRound1Arc'+Ds)),_d=Math.round(Wt*zs),md=Math.round(Wt*Ps),gd=Wt-md-_d,Ou=Math.round(jt*zs),Lu=Math.round(jt*Ps),Mu=jt-Lu-Ou,sn=Math.round(c*zs),ln=Math.round(c*Ps),on=c-ln-sn,Da=Math.round(l*zs),Ca=Math.round(l*Ps),Na=l-Ca-Da,_s=Math.round(Nt*zs),ms=Math.round(Nt*Ps),gs=Nt-ms-_s,sr=Math.round(Pt*zs),lr=Math.round(Pt*Ps),or=Pt-lr-sr,Eo=Math.round(Rt*zs),vo=Math.round(Rt*Ps),bo=Rt-vo-Eo,rc=Math.round(Bt*zs),sc=Math.round(Bt*Ps),lc=Bt-sc-rc,ai=Math.round(g*zs),ti=Math.round(g*Ps),ei=g-ti-ai,Yc=Math.round(Vt*zs),jc=Math.round(Vt*Ps),Fc=Vt-jc-Yc,ap=Math.round(Ht*zs),tp=Math.round(Ht*Ps),ep=Ht-tp-ap,Nn=Math.round(u*zs),On=Math.round(u*Ps),Ln=u-On-Nn,bl=Math.round(Lt*zs),hl=Math.round(Lt*Ps),fl=Lt-hl-bl,Vr=_d*kt[0]+Ou*kt[1]+sn*kt[2]+Nn*kt[12]+Yc*kt[10]+_s*kt[4]+Eo*kt[6]+Da*kt[3]+sr*kt[5]+rc*kt[7]+ai*kt[8]+ap*kt[11]+bl*kt[9],
console.log('provisionDefenderInfRound1'+Vr),Gr=md*kt[0]+Lu*kt[1]+ln*kt[2]+On*kt[12]+jc*kt[10]+ms*kt[4]+vo*kt[6]+Ca*kt[3]+lr*kt[5]+sc*kt[7]+ti*kt[8]+tp*kt[11]+hl*kt[9],console.log('provisionDefenderCavRound1'+Gr),Dr=gd*kt[0]+Mu*kt[1]+on*kt[2]+Ln*kt[12]+Fc*kt[10]+gs*kt[4]+bo*kt[6]+Na*kt[3]+or*kt[5]+lc*kt[7]+ei*kt[8]+ep*kt[11]+fl*kt[9],console.log('provisionDefenderArcRound1'+Dr),Xd=_d*a[0]*Yi[0]+Ou*a[1]*Zi[0]+sn*a[2]*Ti[0]+Nn*a[12]+Yc*a[10]+_s*a[4]*Ci[0]+Eo*a[6]*Mi[0]+Da*a[3]*bi[0]+sr*a[5]*Gi[0]+rc*a[7]*qi[0]+ai*a[8]*Ii[0]+ap*a[11]+bl*a[9],Qd=md*n[0]*Yi[0]+Lu*n[1]*Zi[0]+ln*n[2]*Ti[0]+On*n[12]+jc*n[10]+ms*n[4]*Ci[0]+vo*n[6]*Mi[0]+Ca*n[3]*bi[0]+lr*n[5]*Gi[0]+sc*n[7]*qi[0]+ti*n[8]*Ii[0]+tp*n[11]+hl*n[9],jd=gd*i[0]*Yi[0]+Mu*i[1]*Zi[0]+on*i[2]*Ti[0]+Ln*i[12]+Fc*i[10]+gs*i[4]*Ci[0]+bo*i[6]*Mi[0]+Na*i[3]*bi[0]+or*i[5]*Gi[0]+lc*i[7]*qi[0]+ei*i[8]*Ii[0]+ep*i[11]+fl*i[9],Ic=wc*s[7]*Nl[1]+mi*s[8]*Rl[1]+Yt*s[11]+Mt*s[9]+Ut*s[10],'cav'==es?(Bd=Ot*s[4]*Ll[1]+xt*s[6]*Ml[1]+Ic,
...
qo=Math.round(1e6*Jl)/1e6,Vo=Math.round(1e6*Xl)/1e6,cd=Math.round(-_d*Wo+1e-6)+Math.round(-md*qo+1e-6)+Math.round(-gd*Vo+1e-6),Iu=Math.round(-Ou*Wo+1e-6)+Math.round(-Lu*qo+1e-6)+Math.round(-Mu*Vo+1e-6),en=Math.round(-sn*Wo+1e-6)+Math.round(-ln*qo+1e-6)+Math.round(-on*Vo+1e-6),Ra=Math.round(-Da*Wo+1e-6)+Math.round(-Ca*qo+1e-6)+Math.round(-Na*Vo+1e-6),cs=Math.round(-_s*Wo+1e-6)+Math.round(-ms*qo+1e-6)+Math.round(-gs*Vo+1e-6),tr=Math.round(-sr*Wo+1e-6)+Math.round(-lr*qo+1e-6)+Math.round(-or*Vo+1e-6),mo=Math.round(-Eo*Wo+1e-6)+Math.round(-vo*qo+1e-6)+Math.round(-bo*Vo+1e-6),ac=Math.round(-rc*Wo+1e-6)+Math.round(-sc*qo+1e-6)+Math.round(-lc*Vo+1e-6),Zn=Math.round(-ai*Wo+1e-6)+Math.round(-ti*qo+1e-6)+Math.round(-ei*Vo+1e-6),Zu=Math.round(-ap*Wo+1e-6)+Math.round(-tp*qo+1e-6)+Math.round(-ep*Vo+1e-6),kn=Math.round(-Nn*Wo+1e-6)+Math.round(-On*qo+1e-6)+Math.round(-Ln*Vo+1e-6),pl=Math.round(-bl*Wo+1e-6)+Math.round(-hl*qo+1e-6)+Math.round(-fl*Vo+1e-6),
Uc=Math.round(-Yc*Wo+1e-6)+Math.round(-jc*qo+1e-6)+Math.round(-Fc*Vo+1e-6),ad=Math.round(-qt*Uo+1e-6),vu=Math.round(-Ft*Uo+1e-6),Ha=Math.round(-r*Uo+1e-6),En=Math.round(-d*Uo+1e-6),Jt=Math.round(-o*Go+1e-6),Qs=Math.round(-Dt*Go+1e-6),as=Math.round(-Ot*Bo+1e-6),lo=Math.round(-xt*Bo+1e-6),'cav'==es?(Kr=Math.round(-wc*Bo+1e-6),Wn=Math.round(-mi*Bo+1e-6),qu=Math.round(-Yt*Bo+1e-6),ol=Math.round(-Mt*Bo+1e-6),Nc=Math.round(-Ut*Bo+1e-6)):'inf'==es?(Kr=Math.round(-wc*Uo+1e-6),Wn=Math.round(-mi*Uo+1e-6),qu=Math.round(-Yt*Uo+1e-6),ol=Math.round(-Mt*Uo+1e-6),Nc=Math.round(-Ut*Uo+1e-6)):'arc'==es&&(Kr=Math.round(-wc*Go+1e-6),Wn=Math.round(-mi*Go+1e-6),qu=Math.round(-Yt*Go+1e-6),ol=Math.round(-Mt*Go+1e-6),Nc=Math.round(-Ut*Go+1e-6)),od=qt+ad,Tu=Ft+vu,Za=r+Ha,Sa=o+Jt,os=Ot+as,Xs=Dt+Qs,co=xt+lo,Jr=wc+Kr,Yn=mi+Wn,ju=Yt+qu,An=d+En,Pc=Ut+Nc,rl=Mt+ol,pd=Wt+cd,Ru=jt+Iu,nn=c+en,Oa=l+Ra,ps=Nt+cs,ir=Pt+tr,ho=Rt+mo,oc=Bt+ac,$n=g+Zn,$u=Ht+Zu,Mn=u+kn,Wc=Vt+Uc,_l=Lt+pl,
Rs=ad*kt[0]+vu*kt[1]+Ha*kt[2]+Jt*kt[3]+as*kt[4]+Qs*kt[5]+lo*kt[6]+Kr*kt[7]+Wn*kt[8]+ol*kt[9]+Nc*kt[10]+qu*kt[11]+En*kt[12],console.log('lossesAttackerRound1Total'+Rs),Os=cd*kt[0]+Iu*kt[1]+en*kt[2]+Ra*kt[3]+cs*kt[4]+tr*kt[5]+mo*kt[6]+ac*kt[7]+Zn*kt[8]+pl*kt[9]+Uc*kt[10]+Zu*kt[11]+kn*kt[12],console.log('lossesDefenderRound1Total'+Os),pu=od*kt[0]+Tu*kt[1]+Za*kt[2]+Sa*kt[3]+os*kt[4]+Xs*kt[5]+co*kt[6]+Jr*kt[7]+Yn*kt[8]+ju*kt[11]+An*kt[12]+Pc*kt[10]+rl*kt[9],console.log('survivorsAttackerRound1Total'+pu),_u=pd*kt[0]+Ru*kt[1]+nn*kt[2]+Oa*kt[3]+ps*kt[4]+ir*kt[5]+ho*kt[6]+oc*kt[7]+$n*kt[8]+$u*kt[11]+Mn*kt[12]+Wc*kt[10]+_l*kt[9],console.log('survivorsDefenderRound1Total'+_u),0==Nd||0==cu?(Fa=0,console.log('armyLossesPercentEachRound'+Fa)):cu<=Nd?(Fa=1,console.log('armyLossesPercentEachRound'+Fa)):(Fa=Math.pow(Nd/cu,.5/(cu/Nd)),console.log('armyLossesPercentEachRound'+Fa)),Nr=od*kt[0]+Tu*kt[1]+Za*kt[2]+Sa*kt[3]+os*kt[4]+Xs*kt[5]+co*kt[6]+Jr*kt[7]+Yn*kt[8]+rl*kt[9]+Pc*kt[10]+ju*kt[11]+An*kt[12],
jr=pd*kt[0]+Ru*kt[1]+nn*kt[2]+Oa*kt[3]+ps*kt[4]+ir*kt[5]+ho*kt[6]+oc*kt[7]+$n*kt[8]+_l*kt[9]+Wc*kt[10]+$u*kt[11]+Mn*kt[12],console.log('provisionDefenderRound2Total'+jr),yc=Jr*kt[7]+Yn*kt[8]+ju*kt[11]+rl*kt[9],'cav'==es?(kr=os*kt[4]+co*kt[6]+yc,Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10],yr=Sa*kt[3]+Xs*kt[5]):'inf'==es?(Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10]+yc,kr=os*kt[4]+co*kt[6],yr=Sa*kt[3]+Xs*kt[5]):'arc'==es?(Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10],kr=os*kt[4]+co*kt[6],yr=Sa*kt[3]+Xs*kt[5]+yc):(Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10],kr=os*kt[4]+co*kt[6],yr=Sa*kt[3]+Xs*kt[5]),Us=0==Mr?0:Math.round(Mr/Nr*1e4)/1e4,Bs=0==kr?0:Math.round(kr/Nr*1e4)/1e4,0==yr?(Gs=0,console.log('lossesPercentRound2Arc'+Gs)):(Gs=Math.round(yr/Nr*1e4)/1e4,console.log('lossesPercentRound2Arc'+Gs)),vd=Math.round(pd*Us),bd=Math.round(pd*Bs),hd=pd-bd-vd,Pu=Math.round(Ru*Us),Du=Math.round(Ru*Bs),Cu=Ru-Du-Pu,un=Math.round(nn*Us),dn=Math.round(nn*Bs),cn=nn-dn-un,
Ba=Math.round(Oa*Us),Ga=Math.round(Oa*Bs),za=Oa-Ga-Ba,vs=Math.round(ps*Us),bs=Math.round(ps*Bs),hs=ps-bs-vs,ur=Math.round(ir*Us),dr=Math.round(ir*Bs),cr=ir-dr-ur,yo=Math.round(ho*Us),Ao=Math.round(ho*Bs),To=ho-Ao-yo,pc=Math.round(oc*Us),uc=Math.round(oc*Bs),dc=oc-uc-pc,li=Math.round($n*Us),oi=Math.round($n*Bs),ii=$n-oi-li,Zc=Math.round(Wc*Us),Kc=Math.round(Wc*Bs),Qc=Wc-Kc-Zc,lp=Math.round($u*Us),op=Math.round($u*Bs),ip=$u-op-lp,zn=Math.round(Mn*Us),Pn=Math.round(Mn*Bs),Dn=Mn-Pn-zn,Tl=Math.round(_l*Us),wl=Math.round(_l*Bs),El=_l-wl-Tl,qr=vd*kt[0]+Pu*kt[1]+un*kt[2]+zn*kt[12]+Zc*kt[10]+vs*kt[4]+yo*kt[6]+Ba*kt[3]+ur*kt[5]+pc*kt[7]+li*kt[8]+lp*kt[11]+Tl*kt[9],console.log('provisionDefenderInfRound2'+qr),Br=bd*kt[0]+Du*kt[1]+dn*kt[2]+Pn*kt[12]+Kc*kt[10]+bs*kt[4]+Ao*kt[6]+Ga*kt[3]+dr*kt[5]+uc*kt[7]+oi*kt[8]+op*kt[11]+wl*kt[9],console.log('provisionDefenderCavRound2'+Br),Pr=hd*kt[0]+Cu*kt[1]+cn*kt[2]+Dn*kt[12]+Qc*kt[10]+hs*kt[4]+To*kt[6]+za*kt[3]+cr*kt[5]+dc*kt[7]+ii*kt[8]+ip*kt[11]+El*kt[9],
...
xr=ls*kt[4]+uo*kt[6],Sr=Ia*kt[3]+Js*kt[5]+Tc):(Lr=ld*kt[0]+Au*kt[1]+Xa*kt[2]+yn*kt[12]+zc*kt[10],xr=ls*kt[4]+uo*kt[6],Sr=Ia*kt[3]+Js*kt[5]),Ws=0==Lr?0:Math.round(Lr/Cr*1e4)/1e4,qs=0==xr?0:Math.round(xr/Cr*1e4)/1e4,0==Sr?(Vs=0,console.log('lossesPercentRound3Arc'+Vs)):(Vs=Math.round(Sr/Cr*1e4)/1e4,console.log('lossesPercentRound3Arc'+Vs)),Ad=Math.round(fd*Ws),Td=Math.round(fd*qs),wd=fd-Td-Ad,Uu=Math.round(Nu*Ws),Bu=Math.round(Nu*qs),Gu=Nu-Bu-Uu,_n=Math.round(rn*Ws),mn=Math.round(rn*qs),gn=rn-mn-_n,Wa=Math.round(Pa*Ws),qa=Math.round(Pa*qs),Va=Pa-qa-Wa,As=Math.round(fs*Ws),Ts=Math.round(fs*qs),ws=fs-Ts-As,_r=Math.round(rr*Ws),mr=Math.round(rr*qs),gr=rr-mr-_r,xo=Math.round(wo*Ws),ko=Math.round(wo*qs),Io=wo-ko-xo,fc=Math.round(cc*Ws),_c=Math.round(cc*qs),mc=cc-_c-fc,di=Math.round(ni*Ws),ci=Math.round(ni*qs),ri=ni-ci-di,ed=Math.round(Hc*Ws),$c=Math.round(Hc*qs),Jc=Hc-$c-ed,dp=Math.round(np*Ws),cp=Math.round(np*qs),rp=np-cp-dp,Vn=Math.round(Cn*Ws),Un=Math.round(Cn*qs),Bn=Cn-Un-Vn,
Il=Math.round(vl*Ws),Sl=Math.round(vl*qs),yl=vl-Sl-Il,Wr=Ad*kt[0]+Uu*kt[1]+_n*kt[2]+Vn*kt[12]+ed*kt[10]+As*kt[4]+xo*kt[6]+Wa*kt[3]+_r*kt[5]+fc*kt[7]+di*kt[8]+dp*kt[11]+Il*kt[9],console.log('provisionDefenderInfRound3'+Wr),Ur=Td*kt[0]+Bu*kt[1]+mn*kt[2]+Un*kt[12]+$c*kt[10]+Ts*kt[4]+ko*kt[6]+qa*kt[3]+mr*kt[5]+_c*kt[7]+ci*kt[8]+cp*kt[11]+Sl*kt[9],console.log('provisionDefenderCavRound3'+Ur),zr=wd*kt[0]+Gu*kt[1]+gn*kt[2]+Bn*kt[12]+Jc*kt[10]+ws*kt[4]+Io*kt[6]+Va*kt[3]+gr*kt[5]+mc*kt[7]+ri*kt[8]+rp*kt[11]+yl*kt[9],console.log('provisionDefenderArcRound3'+zr),$d=Ad*a[0]*Yi[0]+Uu*a[1]*Zi[0]+_n*a[2]*Ti[0]+Vn*a[12]+ed*a[10]+As*a[4]*Ci[0]+xo*a[6]*Mi[0]+Wa*a[3]*bi[0]+_r*a[5]*Gi[0]+fc*a[7]*qi[0]+di*a[8]*Ii[0]+dp*a[11]+Il*a[9],Zd=Td*n[0]*Yi[0]+Bu*n[1]*Zi[0]+mn*n[2]*Ti[0]+Un*n[12]+$c*n[10]+Ts*n[4]*Ci[0]+ko*n[6]*Mi[0]+qa*n[3]*bi[0]+mr*n[5]*Gi[0]+_c*n[7]*qi[0]+ci*n[8]*Ii[0]+cp*n[11]+Sl*n[9],
...
ui=0==m?0:Ro*Er,pi=0==gi||0==ui?0:-gi/ui,no='wall'==_i?io<=Lc?io:io-Lc<-pi?io<Lc?io:Lc:io+pi:pi+m<=0?0:pi+m,Kt=Math.round(no),Fs=td*kt[0]+bu*kt[1]+Ya*kt[2]+Xt*kt[3]+ts*kt[4]+Hs*kt[5]+oo*kt[6]+Qr*kt[7]+qn*kt[8]+il*kt[9]+Oc*kt[10]+Vu*kt[11]+vn*kt[12],js=rd*kt[0]+Su*kt[1]+$a*kt[2]+xa*kt[3]+rs*kt[4]+er*kt[5]+go*kt[6]+tc*kt[7]+Kn*kt[8]+ul*kt[9]+Bc*kt[10]+Ku*kt[11]+In*kt[12],vp=rd*t[0]+Su*t[1]+$a*t[2]+xa*t[3]+rs*t[4]+er*t[5]+go*t[6]+tc*t[7]+Kn*t[8]+ul*t[9]+Bc*t[10]+Ku*t[11]+In*t[12],Ep=td*e[0]+bu*e[1]+Ya*e[2]+Xt*e[3]+ts*e[4]+Hs*e[5]+oo*e[6]+Qr*e[7]+qn*e[8]+il*e[9]+Oc*e[10]+Vu*e[11]+vn*e[12],al=0==ja||0==Fs?0:Math.round(-Fs/ja*1e3)/1e3,yp='inf'==es?'piechota':'cav'==es?'kawaleria':'łucznicy',Sp='inf'==(wp=Wt+jt+c+u>Nt+Rt&&Wt+jt+c+u>l+Pt?'inf':Nt+Rt>Wt+jt+c+u&&Nt+Rt>l+Pt?'cav':'arc')?'piechota':'cav'==wp?'kawaleria':'łucznicy',nl=0==fi||0==js?0:Math.round(-js/fi*1e3)/1e3,Cp=Math.round(td*(fr+Mc)),Dp=Math.round(bu*(fr+Mc)),Pp=Math.round(Ya*(fr+Mc)),zp=Math.round(Xt*(fr+Mc)),
Gp=Math.round(ts*(fr+Mc)),Bp=Math.round(Hs*(fr+Mc)),Up=Math.round(oo*(fr+Mc)),Vp=Math.round(Qr*(fr+Mc)),qp=Math.round(qn*(fr+Mc)),Wp=Math.round(Oc*(fr+Mc)),Fp=Math.round(il*(fr+Mc)),jp=Math.round(Vu*(fr+Mc)),Yp=Math.round(vn*(fr+Mc)),Hp=Oo+Rc,0==Oo?(kp=0,xp=0,Rp=0,Mp=0,Lp=0,Op=0,Np=0):Oo<1e3?Hp<=(xa+rd+Su+$a)/2?(kp=Math.round(rd/2),xp=Math.round(Su/2),Rp=Math.round($a/2),Mp=Math.round(xa/2),Lp=0,Op=0,Np=0):(kp=Math.round(rd*Hp/(xa+rd+Su+$a)),xp=Math.round(Su*Hp/(xa+rd+Su+$a)),Rp=Math.round($a*Hp/(xa+rd+Su+$a)),Mp=Math.round(xa*Hp/(xa+rd+Su+$a)),Lp=0,Op=0,Np=0):Hp<=(xa+rd+Su+$a+4*rs+5*er+6*go)/2?(kp=Math.round(rd/2),xp=Math.round(Su/2),Rp=Math.round($a/2),Mp=Math.round(xa/2),Lp=Math.round(rs/2),Op=Math.round(er/2),Np=Math.round(go/2)):(kp=Math.round(rd*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),xp=Math.round(Su*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Rp=Math.round($a*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Mp=Math.round(xa*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Lp=Math.round(rs*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),
Op=Math.round(er*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Np=Math.round(go*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go))),Tp=ja+Fs,Ap=fi+js,L.html(qt),O.html(-td),N.html(-Cp),C.html(sd),D.html(Ft),P.html(-bu),z.html(-Dp),G.html(yu),B.html(r),U.html(-Ya),V.html(-Pp),q.html(Ja),W.html(o),F.html(-Xt),j.html(-zp),Y.html(ka),H.html(Ot),Q.html(-ts),K.html(-Gp),Z.html(ss),X.html(Dt),J.html(-Hs),$.html(-Bp),ee.html($s),te.html(xt),ae.html(-oo),ne.html(-Up),ie.html(po),oe.html(Gt),le.html(-Qr),se.html(-Vp),re.html(ec),ce.html(p),de.html(-qn),ue.html(-qp),pe.html(Qn),ge.html(Ut),me.html(-Oc),_e.html(-Wp),fe.html(Gc),he.html(Mt),be.html(-il),ve.html(-Fp),Ee.html(dl),we.html(Yt),Te.html(-Vu),Ae.html(-jp),ye.html(Hu),Se.html(d),Ie.html(-vn),ke.html(-Yp),xe.html(Sn),Re.html(Wt),Me.html(-rd),Le.html(kp),Oe.html(Ed),Ne.html(jt),Ce.html(-Su),De.html(xp),Pe.html(zu),ze.html(c),Ge.html(-$a),Be.html(Rp),Ue.html(pn),Ve.html(l),qe.html(-xa),We.html(Mp),Fe.html(Ua),je.html(Nt),Ye.html(-rs),He.html(Lp),Qe.html(Es),Ke.html(Pt),
Ze.html(-er),Xe.html(Op),Je.html(pr),$e.html(Rt),et.html(-go),tt.html(Np),at.html(So),nt.html(Bt),it.html(-tc),ot.html(0),lt.html(gc),st.html(g),rt.html(-Kn),ct.html(0),dt.html(si),ut.html(Vt),pt.html(-Bc),gt.html(0),mt.html(Xc),_t.html(Lt),ft.html(-ul),ht.html(0),bt.html(Al),vt.html(Ht),Et.html(-Ku),wt.html(0),Tt.html(sp),At.html(u),yt.html(-In),St.html(0),It.html(Gn),_.html(100*wr),f.html(ja),fa.html(-Fs),ha.html(Tp),ba.html(-js),va.html(Ap),Ea.html(eo),wa.html(Hp),Ta.html(yp),Aa.html(Sp),h.html(-vp),b.html(100*al),v.html(Nd),E.html(100*Er),w.html(fi),T.html(-Ep),A.html(100*nl),y.html(cu),S.html(Qt),I.html(gp),k.html(gp),x.html(Zt),_a.html(Ip),R.html(m),M.html(Kt)})),xt.on('click',(function(){document.getElementById('spearA').value=parseInt(document.getElementById('spearA-survived').innerHTML),document.getElementById('swordA').value=parseInt(document.getElementById('swordA-survived').innerHTML),
