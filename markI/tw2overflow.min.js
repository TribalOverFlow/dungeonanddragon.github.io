...
let d,u,p=!1,g=!1,m=[],_=[],b=[],E=[];const f='army_helper_settings',T={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(T);const h=function(){m=[],_=[],b=[],E=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){_.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){E.push(e[t])})),console.log('selectedGroups',m,_,b,E)},w={init:function(){p=!0,d=new e({settingsMap:i,storageKey:f}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&h()})),u=d.getAll(),console.log('all settings',u),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){g=!0,
console.log('selectedGroups',m,_,b,E),c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,console.log('armyHelper module stop'),c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return w})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u){let p,m,_,b=n.getGroupList();const E={PRESETS:'presets',ARMY:'army',BALANCER:'balancer'},f=function(e){p.selectedTab=e},T=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},w=function(){p.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},v=function(){p.running=!0,
_.classList.remove('btn-orange'),_.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},A=function(){p.running=!1,_.classList.remove('btn-red'),_.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.unit=r.encodeList(l,{textObject:'army_helper',disabled:!0}),m.injectScope(p),w(),p.selectTab=f,p.saveSettings=T,p.switchState=h;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.ARMY_HELPER_START,v),e.register(s.ARMY_HELPER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),_=e.addMenuButton('Administrator',150),_.addEventListener('click',S),
