 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),p=injector.get('$filter'),_=(injector.get('$timeout'),injector.get('storageService')),m=injector.get('reportService'),E=function(){},b=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
;return a+' '+i[1]+'/'+i[0]+'/'+i[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const a=i.fixDate(e).split(' '),n=a[0].split(':'),o=a[1].split('/'),l=n[0],s=n[1],r=n[2],c=n[3]||null,d=parseInt(o[0],10)-1,u=o[1],g=o[2];return new Date(g,d,u,l,s,r,c).getTime()+(t||0)},formatDate:function(e,t){return p('readableDateFilter')(e,null,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+a.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(a,i){if(!e)return i();let n=new XMLHttpRequest;n.open('GET',e,!0),n.responseType=t,n.addEventListener('load',(function(){a(n)}),!1),n.send()}))},obj2selectOptions:function(e,t){let a=[];for(let i in e){let n={name:e[i].name,value:e[i].id};t&&(n.leftIcon=e[i].icon),a.push(n)}return a},getTravelTime:function(e,a,i,o,l,s){
const r=!a.character_id,c=a.character_id&&a.tribe_id&&a.tribe_id===n.getSelectedCharacter().getTribeId();!1!==s&&('attack'===o?('supporter'in l&&delete l.supporter,r&&(s=!0)):'support'===o&&(c&&(s=!0),'supporter'in l&&(s=!0)));const u={units:i,officers:angular.copy(l)},g=d.calculateTravelTime(u,{barbarian:r,ownTribe:c,officers:l,effects:s},o),p=t.actualDistance(e,a);return 1e3*d.getTravelTimeForDistance(u,g,p,o)},each:function(e,t){if('function'!=typeof t&&(t=E),Array.isArray(e)){for(let a=0,i=e.length;a<i;a++)if(!1===t(e[a],a))return!1}else if(angular.isObject(e))for(let a in e)if(b.call(e,a)&&!1===t(e[a],a))return!1;return!0}};return i})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let r={};const c=function(d,u){'string'==typeof(u=u||['map'])&&(u=[u]);const g=function(e){(u=u.filter((function(t){return t!==e}))).length||d()},p={map:function(){if(i.getSharedData('MapController').isInitialized)return g('map');a.$on(s.MAP_INITIALIZED,(function(){g('map')}))},
tribe_relations:function(){const e=n.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return g('tribe_relations')}const t=a.$on(s.TRIBE_RELATION_LIST,(function(){t(),g('tribe_relations')}))},initial_village:function(){if(n.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return g('initial_village');a.$on(s.GAME_STATE_INITIAL_VILLAGE_READY,(function(){g('initial_village')}))},all_villages_ready:function(){if(n.getGameState().getGameState(e.ALL_VILLAGES_READY))return g('all_villages_ready');a.$on(s.GAME_STATE_ALL_VILLAGES_READY,(function(){g('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return g('minimap_data');t.load((function(){g('minimap_data')}))},presets:function(){if(n.getPresetList().isLoaded())return g('presets');r.presets=r.presets||new Promise((function(e){o.emit(l.GET_PRESETS,{},e)})),r.presets.then((function(){g('presets')}))},world_config:function(){if(n.getWorldConfig&&n.getWorldConfig())return g('world_config')
;setTimeout(p.world_config,100)}};if(!i.getSharedData('MapController'))return setTimeout((function(){c(d,u)}),100);u.forEach((function(e){p[e]()}))};return c})),require(['two/ready','Lockr'],(function(e,t){e((function(){let e=n.getSelectedCharacter();t.prefix=e.getId()+'_twOverflow_'+e.getWorldId()+'-'}))})),define('two/language',['helper/i18n'],(function(e){let t=!1;const i={en_us:{about:{contact:"Kontakt",email:"Email",links:"Linki projektów",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},attack_view:{title:"Strażnik",filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",
...
"battle.nightbonus":"Bonus nocny","battle.leader":"Wielki mistrz","battle.medic":"Medyk","battle.doctor":"Doktor","battle.attack-bonus":"Mistrzostwo broni","battle.iron-walls":"Żelazny mur","battle.clinique":"Klinika","battle.hospital":"Szpital","battle.equip":"Przedmioty rycerza","battle.halberd":"Halabarda Guan Yu","battle.longsword":"Długi miecz Paracelsusa","battle.battleaxe":"Bojowy topór Thorgarda","battle.longbow":"Łuk Nimroda","battle.lance":"Lanca Mieszka","battle.compositebow":"Kompozytowy łuk Nimroda","battle.banner":"Chorągiew Baptystów","battle.star":"Gwiazda poranna Karola","battle.bonfire":"Pochodnia Alethei","battle.scepter":"Berło Vasca","battle.target":"Cel katapult","battle.target-level":"Poziom budynku",bunker:"Bunkier","bunker.header":"Kalkulator optymalnego offa na bunkier",troops:"Koszt jednostek","troops.header":"Kalkulator kosztów produkcji jednostek","troops.th":"Koszty produkcji","troops.units":"Jednostki","troops.building":"Budynki",
"troops.barracks":"Koszary","troops.preceptory":"Komturia","troops.effects":"Efekty","troops.domination":"Dominacja","troops.training":"Intensywny trening","troops.order":"Zakon","troops.templars":"Zakon Templariuszy","troops.teutonic":"Zakon Krzyżacki","troops.none":"Brak",bashpoints:"Punkty Bojowe","bashpoints.header":"Kalkulator punktów bojowych","bashpoints.th":"Punkty bojowe","bashpoints.attacker":"Jako atakujący","bashpoints.defender":"Jako obrońca","bashpoints.killed":"Zniszczone jednostki",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",none:"Brak",without:"Brak",level_1:"1",level_2:"2",level_3:"3",level_4:"4",level_5:"5",level_6:"6",level_7:"7",level_8:"8",level_9:"9",level_10:"10",level_11:"11",level_12:"12",
level_13:"13",level_14:"14",level_15:"15",level_16:"16",level_17:"17",level_18:"18",level_19:"19",level_20:"20"},builder_queue:{title:"Budowniczy",started:"Budowniczy Uruchomiony",stopped:"Budowniczy Zatrzymany",settings:"Ustawienia",settings_village_groups:"Buduj w wioskach z grupy",settings_building_sequence:"Szablon kolejki budowy",settings_building_sequence_final:"Finalne poziomy budynków",settings_priorize_farm:"Priorytet farmy, jeżeli brakuje prowiantu",settings_saved:"Ustawienia zapisane!",logs_no_builds:"Nie rozpoczęto żadnej rozbudowy",logs_clear:"Wyczyść logi",sequences:"Szablony",sequences_move_up:"Przesuń w górę",sequences_move_down:"Przesuń w dół",sequences_add_building:"Dodaj budynek",sequences_select_edit:"Wybierz szablon do edytowania",sequences_edit_sequence:"Edytuj szablon",select_group:"Wybierz grupę",add_building_success:"%d dodany na pozycji %d",add_building_limit_exceeded:"%d osiągnął/eła maksymalny poziom (%d)",position:"Pozycja",
...
"info.content":"Zawartość"},builder_queue_add_building_modal:{title:"Dodaj nowy budynek"},builder_queue_name_sequence_modal:{title:"Nazwa szablonu"},builder_queue_remove_sequence_modal:{title:"Usuń szablon",text:"Jesteś pewny, że chcesz usunąć ten szablon? Jeśli ten szablon jest teraz aktywny, inny szablon zostanie wybrany i Budowniczy zatrzyma się."},command_queue:{title:"Generał",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",sent:"wysłany/e",activated:"włączony",deactivated:"wyłączony",expired:"przedawniony/e",removed:"usunięty/e",added:"dodany/e",general_clear:"Wyczyść logi",general_next_command:"Następny rozkaz",add_basics:"Podstawowe informacje",add_origin:"Źródło",add_selected:"Aktywna wioska",add_target:"Cel",add_map_selected:"Wybrana wioska na mapie",date_type_arrive:"Czas dotarcia na cel",date_type_out:"Czas wyjścia z  twojej wioski",add_current_date:"Obecny czas",add_current_date_plus:"Zwiększ czas o 100 milisekund.",
...
countermeasures:"Kontrwywiad",light_cavalry:"LK",mounted_archer:"ŁK",heavy_cavalry:"CK",torpedo:"Cel misji szpiegowskich",spyU:"Szpieguj jednostki",spyB:"Szpieguj budynki",spyA:"Efektywne szpiegowanie",spyP:"Szpieguj całego gracza",sabotage:"Sabotuj wioskę","spyU.text":"Wysyła 7 szpiegów z twoich wiosek na wioskę wskazaną aby zdobyć informacje tylko jednostkach.","spyB.text":"Wysyła 7 szpiegów z twoich wiosek na wioskę wskazaną aby zdobyć informacje tylko budynkach.","sabotage.text":"Wysyła po 3 szpiegów z twoich wiosek na wioskę wskazaną aby dokonać sabotażu na budynkach.","spyA.text":"Wysyła 8-10 szpiegów z twoich wiosek na wioskę wskazaną aby zdobyć informacje o budynkach oraz jednostkach(pierwsi szpiedzy na budynki ostatni na jednostki).","spyP.text":"Wysyła szpiegów z twoich wiosek na wioski gracza aby zdobyć informacje o budynkach oraz jednostkach(pierwsi szpiedzy na budynki ostatni na jednostki).",send:"Wyślij",sabote:"Sabotuj",sendingU:"Wszyscy na jednostki",
...
"logs.noMissions":"Brak wysłanych szpiegów.",none:"-- Wyłączona --"},spy_recruiter:{title:"Szpieg",description:"Automatycznie rekrutuje szpiegów jesli brak na wioskach.",activated:"Szpieg aktywowany",deactivated:"Szpieg skończył działanie",revived:"Szpiedzy dodani do kolejki rekrutacji"},common:{start:"Start",started:"Uruchomiony",pause:"Pauza",paused:"Wstrzymany",stop:"Zatrzymany",stopped:"Zatrzymany",status:"Status",none:"Żaden",info:"Informacje",settings:"Ustawienia",others:"Inne",village:"Wioska",villages:"Wioski",building:"Budynek",buildings:"Budynki",level:"Poziom",registers:"Rejestry",filters:"Filtry",add:"Dodaj",waiting:"Oczekujące",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",activate:"Aktywuj",deactivate:"Wyłącz",units:"Jednostki",officers:"Oficerowie",origin:"Źródło",target:["Cel","Cele"],save:"Zapisz",logs:"Logi","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas",points:"Punkty",player:"Gracz",players:"Gracze",
next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){
t=b.call(o,t)?o[t]:t,e.setJSON(i[t]||i[n])}let s={init:function(){if(t)return!1;t=!0,l(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&l(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,i){const o=function(e,t){let a={};for(let i in e)b.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a},l=function(){return{name:p('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){
return angular.copy(this.settings)},r.prototype.getDefault=function(e){return b.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!b.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),b.call(i,'min')&&(t=Math.max(i.min,t)),b.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(n,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(b.call(this.settingsMap,t)){const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),b.call(a,'min')&&(i=Math.max(a.min,i)),b.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=o(a,i);if(!n)return!1
;const l=s(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,l,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!b.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(i){e.multiSelect?i.length||(t.settings[a]=[l()]):i||(t.settings[a]=l())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1
;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const i=n.getPresetList().getPresets(),o=n.getGroupList().getGroups();return e=e||{},this.each((function(n,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[n]=r.multiSelect?[l()]:l());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){i[t]&&e.push({name:i[t].name,value:t})})),t[n]=e.length?e:[l()]}else{if(!i[s]&&r.disabledOption)return void(t[n]=l());t[n]={name:i[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[n]=e.length?e:[l()]}else{if(!o[s]&&r.disabledOption)return void(t[n]=l());t[n]={name:o[s].name,value:s}}break;default:t[n]={name:e.textObject?p('i18n')(s,a.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[n]=[t[n]])}}else t[n]=s})),t},r.prototype.decode=function(e){let t={};for(let a in e){let i=this.settingsMap[a]
;if('select'===i.inputType)if(i.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let i=[];e[a].forEach((function(e){i.push(e.value)})),t[a]=i}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let i=[];switch((t=t||{}).disabled&&i.push(l()),t.type){case'keys':for(let t in e)i.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];i.push({name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){let a=e[t];i.push({name:a.name,value:a.id})}break;case'values':default:for(let n in e){let o=e[n];i.push({name:t.textObject?p('i18n')(o,a.loc.ale,t.textObject):o,value:o})}}return i},r.disabledOption=l,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],i=[],n=!1,r=!1,c=[];angular.extend(s,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=E,d){if(d)r=!1;else{if(n)return c.push(e);if(r)return e(t)}c.push(e),n=!0;let u=[];for(let e=0;e<i.length;e++)for(let t=0;t<i[e].length;t++)u.push(i[e][t]);let g=[]
;return u.forEach((function(e){let a=new Promise((function(a,i){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return i(e.message);e.villages.length&&(t=t.concat(e.villages)),a()}))}));g.push(a)})),Promise.all(g).then((function(){n=!1,r=!0,a.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),a=Math.ceil(e.MAP_SIZE/306);for(let n=0;n<t;n++){i.push([]);let t=306*n,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<a;l++){let a=306*l,s=306..bound(0,a+306).bound(0,e.MAP_SIZE-a);a=a.bound(0,e.MAP_SIZE),i[n].push({x:t,y:a,width:o,height:s})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,i){
let n,o={},l={},r=!1,c=document.querySelector('head'),d=injector.get('httpService'),u=injector.get('templateManagerService'),g=injector.get('$templateCache');return u.load=function(i,n,o){let s;const r=function(e,t,i,o){g.put(s.substr(1),e),angular.isFunction(n)&&n(e,t,i,o),a.$$phase||a.$apply()},c=function(e,t,a,i){angular.isFunction(o)&&o(e,t,a,i)};s=0!==i.indexOf('!')?e.TEMPLATE_PATH_EXT.join(i):i.substr(1),g.get(s.substr(1))?r(g.get(s.substr(1)),304):t.versionMap[s]?d.get(s,r,c):r(l[s],304)},o.init=function(){if(r)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-main-button',a.style.display='none',t.appendChild(a),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),r=!0,
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,i){let r;var c=injector.get('overviewService'),d=!1,u=!1,g=n.getSelectedCharacter().getGlobalInfo(),p={reverse:!1,column:'command_progress'},_=n.getSelectedCharacter(),m=_.tribeById[0],E=_.getVillageList(),b=[],f=_.data.character_id,T=_.data.character_name,h=[],v=[],w=[i.LIGHT_CAVALRY,i.HEAVY_CAVALRY,i.AXE,i.SWORD,i.RAM,i.SNOB,i.TREBUCHET];var A=function(){
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:m},(function(e){for(var t=e.members,a=0;a<t.length;a++)v.push(t[a].id)})),E.forEach((function(e){b.push(e.getId())}));var e=g.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:p.column,reverse:p.reverse?1:0,groups:[],command_types:['attack'],villages:b},S),setTimeout(A,6e4)},S=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),v.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(h.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{h.push(i[n].command_id),i[n].slowestUnit=y(i[n]);var s=i[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',g='';'sword'==i[n].slowestUnit?(g=' [color=03709d]MIECZNIK[/color]',
u='sword'):'axe'==i[n].slowestUnit?(g=' [color=e21f1f]TOPORNIK[/color]',u='axe'):'ram'==i[n].slowestUnit?(g=' [color=730202]TARAN[/color]',u='ram'):'snob'==i[n].slowestUnit?(g=' [color=ffee00]SZLACHCIC[/color]',u='snob'):'trebuchet'==i[n].slowestUnit?(g=' [color=494500]TREBUSZ[/color]',u='trebuchet'):'light_cavalry'==i[n].slowestUnit?(g=' [color=d96a19]LEKKA KAWALERIA[/color]',u='light_cavalry'):'heavy_cavalry'==i[n].slowestUnit&&(g=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),
a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+g+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+i[n].target_village_id+']'+i[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+f+']'+T+'[/player][b] [br]Wioska pochodzenia: [/b][village='+i[n].origin_village_id+']'+i[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+i[n].origin_character_id+']'+i[n].origin_character_name+'[/player][/size]');var p=a.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==T||'halfsack'==T||'Black Rider'==T?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:p}),a=[]):('Hajduk Split'==T||'halfsack'==T||'Black Rider'==T?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4648,message:p}),a=[])}},y=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y
},l=[];return w.forEach((function(a){i[a]=1,l.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},I={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return I})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',100,p('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),
i.notif('success',p('i18n')('activated',a.loc.ale,'alert_sender')))})),n.register(s.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,a,i,n){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.ALERT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(s.ALERT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,g,p,_,m,E,b){let f,T,h=!1,v=injector.get('overviewService'),w=[],A=!1,S={},y={},I={reverse:!1,column:i.TIME_COMPLETED};const R='attack_view_filters',k={},L={},x=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},O=function(){V.loadCommands()},N=function(e,t){b.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){
for(let e=0;e<w.length;e++)w[e].command_id===t.command_id&&w.splice(e,1);b.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},P=function(e,t){for(let e=0;e<w.length;e++)w[e].target_village_id===t.village_id?(w[e].target_village_name=t.name,w[e].targetVillage.name=t.name):w[e].origin_village_id===t.village_id&&(w[e].origin_village_name=t.name,w[e].originVillage.name=t.name);b.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){return _.actualDistance(t,e)-_.actualDistance(t,a)}))},G=function(e,t){let a=0;if(E.hasTownDataInChunk(e.x,e.y)){
const a=E.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=m.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},U=function(e){w=e.commands;for(let e=0;e<w.length;e++)v.formatCommand(w[e]),w[e].slowestUnit=z(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),b.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[w])};let V={loadCommands:function(){const e=f.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],x(),p.set(R,S),V.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),V.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,T.OUT,s,{},l,g.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return h},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)L[r[e]]=!0;try{A=require('two/commandQueue'),T=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),
[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};h=!0,f=n.getSelectedCharacter().getGlobalInfo(),S=p.get(R,t,!0),e((function(){x(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,M),a.$on(s.VILLAGE_NAME_CHANGED,P),a.$on(s.COMMAND_IGNORED,C),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,m,E,b,f,T){let h,v;const w=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=p('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=p('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=p('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=T('#two-attack-view').parent(),t=T('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},I=function(){const e=h.pagination.offset,t=h.pagination.limit
;h.visibleCommands=h.commands.slice(e,e+t),h.pagination.count=h.commands.length},R=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);I()},k=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},L=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},x=function(){h.commands=t.getCommands()},O=function(){h.selectedVillageId=n.getSelectedVillage().getId()},N=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=E,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=m,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:I,limit:_.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=g.jumpToVillage,h.now=w,h.copyTimeModal=A,h.removeTroops=S,h.switchWindowSize=y,
h.toggleFilter=k,h.toggleSorting=L,I();let e=new i('twoverflow_queue_window',(function(){f.timer.remove(R)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,x),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,x),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,x),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,x),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),f.timer.add(R)};return function(){v=e.addMenuButton('Strażnik',40),v.addEventListener('click',N),
...
;let e=n.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return a=t.shift(),void o.emit(l.RESOURCE_DEPOSIT_COLLECT,{job_id:a.id,village_id:n.getSelectedVillage().getId()});var a;let s=e.getReadyJobs();return s?function(e){o.emit(l.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(g(s)):void 0},g=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let p={};return p.init=function(){t=!0,a.$on(s.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!r||!i)return!1;r=!1,setTimeout((function(){r=!0,u()}),1500)})),a.$on(s.RESOURCE_DEPOSIT_JOBS_REROLLED,u),a.$on(s.RESOURCE_DEPOSIT_JOB_COLLECTED,u),a.$on(s.RESOURCE_DEPOSIT_INFO,(function(e,t){u(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},p.start=function(){e.trigger(s.AUTO_COLLECTOR_STARTED),i=!0,u()},p.stop=function(){e.trigger(s.AUTO_COLLECTOR_STOPPED),i=!1},p.isRunning=function(){return i},
p.isInitialized=function(){return t},p})),define('two/autoCollector/events',[],(function(){angular.extend(s,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kolekcjoner',50,p('i18n')('description',a.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),i.notif('success',p('i18n')('activated',a.loc.ale,'auto_collector')))})),n.register(s.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(s.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,i,r,c){let d=!1,u=!1,g=!1,p=injector.get('secondVillageService');const _=function(){var e;e=m,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(p.hasFinishedLastJob(t.jobs))g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),E.stop();else{let a=new c(t);n.getSelectedCharacter().setSecondVillage(a),e()}}))},m=function(){let e=n.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const a=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t<r.server2ClientTime(e[a].time_completed))return e[a];return!1}(e.data.jobs);if(a){const e=r.server2ClientTime(a.time_completed)-Date.now()+1e3;return setTimeout(_,e),!1}
const i=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t>=r.server2ClientTime(e[a].time_completed)&&!e[a].collected)return a;return!1}(e.data.jobs);if(i)return s=i,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:n.getSelectedVillage().getId(),job_id:s});var s;const c=p.getCurrentDayJobs(e.data.jobs,e.data.day),d=p.getCollectedJobs(e.data.jobs),g=n.getSelectedVillage().getResources().getResources(),m=p.getAvailableJobs(c,d,g,[]);if(m){const e=function(e){let a=!1;return t.each(e,(function(e){return a=e,!1})),a}(m);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:n.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=m[e];t?setTimeout(_,1e3*t.duration+1e3):setTimeout(_,6e4)}))}};let E={start:function(){if(!d||g)return!1;i.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,_()},stop:function(){if(!d)return!1;i.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!p.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){p.hasFinishedLastJob(e.jobs)?(g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(a.$on(s.SECOND_VILLAGE_VILLAGE_CREATED,_),a.$on(s.SECOND_VILLAGE_JOB_COLLECTED,_))}))}};e.secondVillage=E})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,a,i,n){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),a(),e((function(){i.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),n.register(s.AUTO_COLLECTOR_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_COLLECTOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let i=!1,r=!1;let c={init:function(){i=!0}};return c.start=function(){
t.trigger(s.AUTO_HEALER_STARTED),r=!0,function(){if(!r)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let a=e.hospital.patients.healed;0==a.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){a.forEach((function(t,a){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*a),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',p('i18n')('deactivated',a.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(s.AUTO_HEALER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),
define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Medyk',70,p('i18n')('description',a.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),i.notif('success',p('i18n')('activated',a.loc.ale,'auto_healer')))})),n.register(s.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,a,i,n){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c,d,u,g,p,_,m,E,b,f,T){let h,v,w=!1,A=!1,S=[];const y='battle_calculator_settings',I={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},R={[l.HALBERD_OF_GUAN_YU]:'spear',[l.PARACELSUS_LONGSWORD]:'sword',
[l.THORGARDS_BATTLE_AXE]:'axe',[l.NIMRODS_LONGBOW]:'archer',[l.MIESZKOS_LANCE]:'lc',[l.NIMRODS_COMPOSITE_BOW]:'ma',[l.BAPTISTES_BANNER]:'hc',[l.CAROLS_MORNING_STAR]:'ram',[l.ALETHEIAS_BONFIRE]:'catapult',[l.VASCOS_SCEPTER]:'snob'},k={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},L={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},x={[g.NO_CHURCH]:50,[g.LEVEL_1]:100,[g.LEVEL_2]:105,[g.LEVEL_3]:110},O={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,
[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},N={[p.LEVEL_1]:2,[p.LEVEL_2]:4,[p.LEVEL_3]:6,[p.LEVEL_4]:8,[p.LEVEL_5]:10},C={[_.LEVEL_1]:1,[_.LEVEL_2]:2,[_.LEVEL_3]:3,[_.LEVEL_4]:4,[_.LEVEL_5]:5},P={[m.LEVEL_1]:100,[m.LEVEL_2]:200,[m.LEVEL_3]:300,[m.LEVEL_4]:400,[m.LEVEL_5]:500,[m.LEVEL_6]:600,[m.LEVEL_7]:700,[m.LEVEL_8]:800,[m.LEVEL_9]:900,[m.LEVEL_10]:1e3},M={[E.LEVEL_1]:100,[E.LEVEL_2]:129,[E.LEVEL_3]:167,[E.LEVEL_4]:215,[E.LEVEL_5]:278,[E.LEVEL_6]:359,[E.LEVEL_7]:464,[E.LEVEL_8]:599,[E.LEVEL_9]:774,[E.LEVEL_10]:1e3},z={[b.LEVEL_1]:4,[b.LEVEL_2]:8,[b.LEVEL_3]:12,[b.LEVEL_4]:16,[b.LEVEL_5]:20};console.log(L,z,M,P,C,N,O,x,I,R,k);const D=function(){S=[];const e=n.getPresetList().getPresets();v[t.PRESETS].forEach((function(t){S.push(e[t])})),console.log('selectedPresets',S)},G={init:function(){w=!0,h=new e({settingsMap:i,storageKey:y}),v=h.getAll(),console.log('all settings',v),f((function(){D()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,D),a.$on(s.ARMY_PRESET_DELETED,D)},start:function(){A=!0,console.log('selectedPresets',S),T.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){A=!1,console.log('example module stop'),T.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return h},isInitialized:function(){return w},isRunning:function(){return A}};return G})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u,g,p,_,m,E,b,f,T,h,v){let w,A,S,y=n.getPresetList();const I={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},R=function(e){w.selectedTab=e},k=function(){A.setAll(A.decode(w.settings)),v.notif('success','Settings saved')},L=function(){t.isRunning()?t.stop():t.start()},x=function(){w.presets=T.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},O=function(){
w.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),v.notif('success','Example module started')},N=function(){w.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),v.notif('success','Example module stopped')},C=function(){w=a.$new(),w.SETTINGS=i,w.TAB_TYPES=I,w.running=t.isRunning(),w.selectedTab=I.BATTLE,w.settingsMap=o,w.catapulttarget=T.encodeList(d,{textObject:'battle_calculator',disabled:!0}),w.knightitem=T.encodeList(l,{textObject:'battle_calculator',disabled:!0}),w.itemlevel=T.encodeList(r,{textObject:'battle_calculator',disabled:!0}),w.order=T.encodeList(u,{textObject:'battle_calculator',disabled:!0}),w.wall=T.encodeList(g,{textObject:'battle_calculator',disabled:!0}),w.church=T.encodeList(p,{textObject:'battle_calculator',disabled:!0}),w.weaponmaster=T.encodeList(_,{textObject:'battle_calculator',disabled:!0}),w.ironwalls=T.encodeList(m,{textObject:'battle_calculator',disabled:!0}),w.clinique=T.encodeList(E,{
textObject:'battle_calculator',disabled:!0}),w.hospital=T.encodeList(b,{textObject:'battle_calculator',disabled:!0}),w.training=T.encodeList(f,{textObject:'battle_calculator',disabled:!0}),A.injectScope(w),x(),w.selectTab=R,w.saveSettings=k,w.switchState=L;let e=new h('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,x,!0),e.register(s.ARMY_PRESET_DELETED,x,!0),e.register(s.BATTLE_CALCULATOR_START,O),e.register(s.BATTLE_CALCULATOR_STOP,N),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',w)};return function(){A=t.getSettings(),S=e.addMenuButton('Kalkulator',180),S.addEventListener('click',C),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,g,p,_,m,E,b,f){let T,h,v,w=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const R={};let k,L,x,O,N,C=!0;const P='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!C)return F.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&A.instantBuild(a,m.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(R);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return w.compute(e),V(e,a,(function(t,a){t&&a.job&&(E.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),j(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=q(e,t);if(i===p.POSSIBLE)B(e,t,(function(e){a(!0,e)}));else if(i===p.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=v[_.FARM];e.getBuildingData().getDataForBuilding(_.FARM).level<t&&B(e,_.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:m.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===p.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return p.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<v[t])return!1;return!0},j=function(e,t){let a={time:f.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),b.set(P,x),!0};let F={};return F.start=function(){if(!C)return E.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,T=setInterval(z,6e4),h=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),E.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){I=!1,clearInterval(T),
clearInterval(h),E.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return I},F.isInitialized=function(){return y},F.getSettings=function(){return O},F.getLogs=function(){return x},F.clearLogs=function(){x=[],b.set(P,x),E.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?g.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,x=b.get(P,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),I&&t[d.ANALYSE]&&z(),a.quiet||E.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in _)R[_[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,v=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(R);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);U(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let i in e)b.call(e,i)&&(t[i]=a(e[i]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(s,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,g,m,E,f,T,h,v,w){let A,S,y,I,R=n.getGroupList(),k={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
return d.notif('error',p('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case f.SEQUENCE_INVALID:return d.notif('error',p('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};O.generateSequences=function(){const e=I.get(m.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=A.settings[m.ACTIVE_SEQUENCE].value,t=A.settings[m.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in T)i[T[e]]=0;O.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:w.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=A.settings[m.ACTIVE_SEQUENCE].value,a=A.settings[m.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=k[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
O.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,k[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,k[a].push(n)}}},x.moveUp=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(D=!0)},x.moveDown=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(D=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),D=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),D=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=I.get(m.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in T)i[T[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case f.SEQUENCE_SAVED:D=!1;break;case f.SEQUENCE_NO_EXISTS:d.notif('error',p('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case f.SEQUENCE_INVALID:d.notif('error',p('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=p('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=p('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=p('i18n')('remove',a.loc.ale,'common'),
e.cancelText=p('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(x.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=x.lastAddedIndex,e.indexLimit=x.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:p('i18n')(x.lastAddedBuilding,a.loc.ale,'building_names'),value:x.lastAddedBuilding};for(let t in y)e.buildings.push({name:p('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=p('i18n')(t,a.loc.ale,'building_names'),l=y[t].max_level;x.lastAddedBuilding=t,x.lastAddedIndex=i,x.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',p('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',p('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},x.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=x.selectedSequence.name,i=A.settings[m.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=a.$new();t.title=p('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=p('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=p('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=p('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},N.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;N.visibleLogs=N.logs.slice(e,e+t),
A.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[T.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(A.settings[m.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[m.BUILDING_SEQUENCES][e.name]=t,j(),O.selectedSequence={name:e.name,value:e.name},x.selectedSequence={name:e.name,value:e.name},O.generateSequences(),x.generateBuildingSequence(),e.closeWindow(),W(C.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},j=function(){I.setAll(I.decode(A.settings)),D=!1},F=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=p('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=p('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=p('i18n')('discard',a.loc.ale,'common'),i.cancelText=p('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){D?Y((function(){P()})):P()},K={updateGroups:function(){A.groups=g.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(m.BUILDING_SEQUENCES);A.sequences=g.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){x.generateBuildingSequence()},
updateLogs:function(){A.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',p('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=I.get(m.BUILDING_SEQUENCES);A.settings[m.BUILDING_SEQUENCES][t]=i[t],A.settings[m.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',p('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=I.get(m.BUILDING_SEQUENCES);A.settings[m.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',p('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[m.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(b.call(e,t))return t;return!1}(A.settings[m.BUILDING_SEQUENCES]);x.selectedSequence={name:i,value:i},K.updateSequences(),x.generateBuildingSequence(),I.get(m.ACTIVE_SEQUENCE)===t&&(I.set(m.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),
d.notif('success',p('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',p('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(m.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=C.SETTINGS,A.TAB_TYPES=C,A.SETTINGS=m,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=z,A.villagesInfo=M,A.editorView=x,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=T.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=O,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=N,A.logsView.logs=i.getLogs(),A.selectTab=W,A.switchBuilder=F,A.saveSettings=j,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,I.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:_.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:x.buildingSequence.length,offset:0,loader:x.updateVisibleBuildingSequence,limit:_.getPaginationLimit()},A.pagination.logs={count:N.logs.length,offset:0,loader:N.updateVisibleLogs,limit:_.getPaginationLimit()},N.updateVisibleLogs(),O.generateSequences(),x.generateBuildingSequence();let t=new h('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(s.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',A),P=A.closeWindow,A.closeWindow=H,A.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),A.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?Y((function(){K.generateBuildingSequencesEditor(),D=!1}),(function(){A.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
O.generateBuildingsLevelPoints(),I=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),v.register(s.BUILDER_QUEUE_START,(function(){L=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',p('i18n')('started',a.loc.ale,'builder_queue'))})),v.register(s.BUILDER_QUEUE_STOP,(function(){L=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',p('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const v=Object.values(c),w=Object.values(a),A=Object.values(h),S=Object.values(T),y=Object.values(f);let I,R=[],k={},L=[],x=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<p.gameTime()+I},P=function(e){R.push(e)},M=function(e){k[e.id]=e},z=function(){
E.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return b.call(e,'x')&&b.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,L=E.get(d.QUEUE_SENT,[],!0),x=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){p.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(P(e),M(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!C(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),E.set(d.QUEUE_SENT,L),U.removeCommand(e,i.COMMAND_SENT),g.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){x.push(e)}(e),E.set(d.QUEUE_EXPIRED,x),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,g){let _={},E={};return new Promise((function(b,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(i))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(_[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(_,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[T.SUPPORTER]&&delete E[T.SUPPORTER],'string'!=typeof g||y.includes(g)?(g=!(d!==c.ATTACK||!_[h.CATAPULT])&&(g||f.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>m.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>m.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return I(u.INVALID_ORIGIN);if(!i)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,_,d,E,!0),c=l===a.ARRIVE?s-r:s,m=l===a.ARRIVE?s:s+r;if(C(c))return I(u.ALREADY_SENT);const f={id:t.guid(),travelTime:r,arriveTime:m,sendTime:c,origin:e,target:i,date:o,dateType:l,units:_,officers:E,type:d,catapultTarget:g,countdown:c-p.gameTime()};P(f),M(f),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),b(f)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete k[e.id];const a=R.some((function(t,a){if(t.id==e.id)return R.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:g.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:g.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:g.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:g.trigger(s.COMMAND_QUEUE_REMOVE,e)}else g.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),x=[],L=[]},U.start=function(e){O=!0,g.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){O=!1,g.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return O},U.getWaitingCommands=function(){return R},U.getWaitingCommandsObject=function(){return k},U.getSentCommands=function(){return L},
U.getExpiredCommands=function(){return x},U.filterCommands=function(e,t,a){const i=N[e];return(a||R).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,g,_,m,E,b,f,T,h){let v,w,A,S,y,I=n.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),L=n.getPresetList(),x=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,P,M,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){x=t.data},q=function(){x=!1},W=function(e){
const t=new Date(e||f.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=f.zerofill(a-a%100,3),n=f.zerofill(t.getSeconds(),2),l=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(g,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);v.travelTimes[a][n].travelTime=p('readableMillisecondsFilter')(l),v.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&v.isValidDate?f.gameTime()+C<e?'valid':'invalid':'neutral'},H=function(){y.dateType=v.selectedDateType.value,h.set(_.LAST_DATE_TYPE,v.selectedDateType.value),F()},K=function(){
y.catapultTarget=v.catapultTarget.value},Q=function(){const e=v.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];v.selectedInsertPreset={name:p('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,v.catapultTarget={name:p('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},v.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=f.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),f.timer.add(e.updateCountdown)},X=function(){v.waitingCommands=t.getWaitingCommands()},J=function(){v.sentCommands=t.getSentCommands()},$=function(){v.expiredCommands=t.getExpiredCommands()},ee=function(){let e=v.waitingCommands;V.forEach((function(a){v.activeFilters[a]&&(e=t.filterCommands(a,v.filtersData,e))})),
v.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){v.showCatapultSelect=!!y.units.catapult},ne=function(e){v.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!x)return o.notif('error',p('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));b.loadTownDataAsync(x.x,x.y,1,1,(function(e){y.target=e}))},se=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=j(y.date,100)},ce=function(){if(!y.date)return!1;y.date=j(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",v.catapultTarget={name:p('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',_e(e.type,'added'))})).catch((function(t){switch(t){case m.INVALID_ORIGIN:o.notif('error',p('i18n')('error_origin',a.loc.ale,'command_queue'));break;case m.INVALID_TARGET:o.notif('error',p('i18n')('error_target',a.loc.ale,'command_queue'));break;case m.INVALID_DATE:o.notif('error',p('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case m.NO_UNITS:o.notif('error',p('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case m.RELOCATE_DISABLED:o.notif('error',p('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case m.ALREADY_SENT:o.notif('error',p('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),J(),$()},pe=function(){t.isRunning()?t.stop():t.start()},_e=function(e,t,i){return i&&(e=i+'.'+e),p('i18n')(e,a.loc.ale,'command_queue')+' '+p('i18n')(t,a.loc.ale,'command_queue')},me=function(e,t){v.activeFilters[e]=!v.activeFilters[e],
t&&(v.filtersData[u.ALLOWED_TYPES][e]=!v.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){v.activeFilters[u.TEXT_MATCH]=v.filtersData[u.TEXT_MATCH].length>0,ee()},be={updatePresets:function(){v.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},v.searchQuery[i]=''},removeCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',_e(t.type,'removed'))},removeError:function(){o.notif('error',p('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',_e(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',p('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',p('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',_e(t.type,'sent'))},start:function(e,a){if(v.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',_e('title','activated'))},stop:function(){v.running=t.isRunning(),o.notif('success',_e('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{f.timer.remove(e.updateCountdown)})}},fe=function(){const e=h.get(_.LAST_DATE_TYPE,l.OUT,!0);let m;v=a.$new(),v.selectedTab=N,v.inventory=n.getInventory(),v.presets=o.obj2selectOptions(L.getPresets()),v.travelTimes={},o.each(g,(function(e){v.travelTimes[e]={},o.each(U,(function(t,a){v.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),v.unitOrder=S,v.officers=I.getOrderedOfficerNames(),v.searchQuery={origin:'',target:''},v.isValidDate=!1,v.dateTypes=T.toActionList(l,(function(e){return p('i18n')(e,a.loc.ale,'command_queue')})),v.selectedDateType={name:p('i18n')(e,a.loc.ale,'command_queue'),value:e},v.selectedInsertPreset={name:p('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},v.catapultTarget={name:p('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.autoCompleteOrigin={type:['village'],placeholder:p('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteOrigin,tooltip:p('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},v.autoCompleteTarget={type:['village'],placeholder:p('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteTarget,tooltip:p('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},v.showCatapultSelect=!!y.units.catapult,v.attackableBuildings=z,v.commandData=y,
v.activeFilters=P,v.filtersData=M,v.running=t.isRunning(),v.waitingCommands=t.getWaitingCommands(),v.visibleWaitingCommands=t.getWaitingCommands(),v.sentCommands=t.getSentCommands(),v.expiredCommands=t.getExpiredCommands(),v.EVENT_CODES=d,v.FILTER_TYPES=u,v.TAB_TYPES=O,v.COMMAND_TYPES=g,v.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),v.onUnitInputFocus=te,v.onUnitInputBlur=ae,v.catapultTargetVisibility=ie,v.selectTab=ne,v.addSelected=oe,v.addMapSelected=le,v.addCurrentDate=se,v.incrementDate=re,v.reduceDate=ce,v.cleanUnitInputs=de,v.addCommand=ue,v.clearRegisters=ge,v.switchCommandQueue=pe,v.removeCommand=t.removeCommand,v.openVillageInfo=r.openVillageInfo,v.toggleFilter=me,v.$watch('commandData.origin',F),v.$watch('commandData.target',F),v.$watch('commandData.date',F),v.$watch('commandData.officers',F),v.$watch('selectedDateType.value',H),v.$watch('selectedInsertPreset.value',Q),v.$watch('catapultTarget.value',K),v.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
v.$watch('selectedTab',(function(){v.selectedTab===O.ADD?m=setInterval((function(){F()}),2500):clearInterval(m)})),v.waitingCommands.forEach(e=>{Z(e)});let E=new i('twoverflow_queue_window',(function(){clearInterval(m),be.clearCountdownUpdates()}));E.register(s.ARMY_PRESET_UPDATE,be.updatePresets,!0),E.register(s.ARMY_PRESET_DELETED,be.updatePresets,!0),E.register(s.SELECT_SELECTED,be.autoCompleteSelected,!0),E.register(s.COMMAND_QUEUE_REMOVE,be.removeCommand),E.register(s.COMMAND_QUEUE_REMOVE_ERROR,be.removeError),E.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,be.sendTimeLimit),E.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,be.sendNotOwnVillage),E.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,be.sendNoUnitsEnough),E.register(s.COMMAND_QUEUE_SEND,be.sendCommand),E.register(s.COMMAND_QUEUE_START,be.start),E.register(s.COMMAND_QUEUE_STOP,be.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){A=n.getSelectedCharacter(),C=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:p('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',20),w.addEventListener('click',fe),E.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),E.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,g,_,m,E,b=!1,f=!1,T=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},g=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},_=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){b=!0}};return h.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),f=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),b=c.food,f=c.wood,h=c.clay,v=c.iron,w=b.currentStock,A=f.currentStock,S=h.currentStock,y=v.currentStock,I=[0,5e3],R=[160,16e3],k=[200,2e4],L=[50,5e3];1==s&&(T=1),_(n,(function(i){m=u(i.villages),E=g(m,1===s),console.log(E),50!=E||r!==t&&0!=r.length?50==E&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=T?'chapel'==i&&'church'==i||1!=T||(A>=R[1]&&S>=k[1]&&y>=L[1]&&w>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker'))):A>=R[0]&&S>=k[0]&&y>=L[0]&&w>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',p('i18n')('full',a.loc.ale,'faith_checker')):1==T?A>=R[1]&&S>=k[1]&&y>=L[1]&&w>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker')):A>=R[0]&&S>=k[0]&&y>=L[0]&&w>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},h.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),f=!1},h.isRunning=function(){return f},h.isInitialized=function(){return b},h})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,p('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',p('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,g,p,_,m,f,T,h,v,w,A,S,y,I){let R,k,L,x,O,N=!1,C=!1,P=[],M=[],z=[],D=[],G=[],U=[],V=!1,B=!1,q=!1,W=0,j=null,F=null,Y=null,H={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(k[r.MIN_DISTANCE],k[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===x.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(k[r.MIN_POINTS],k[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=k[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=k[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!x.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){b.call(L,e)||(L[e]={time:h.gameTime(),report:!1},t=!0)})),m.each(L,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete L[i],t=!0)})),t&&(I.set($,L),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),v.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=x.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(Re(t.village_id),l=!0):(xe(t.village_id),Ee(p.IGNORED_VILLAGE,{villageId:t.village_id}),me(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),Ee(p.INCLUDED_VILLAGE,{villageId:t.village_id}),me(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=x.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}else Oe(),Ee(p.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),Ee(p.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Re(t.village_id),l=!0),l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=k[r.GROUP_IGNORE],i=k[r.GROUP_ONLY],o=k[r.GROUP_INCLUDE],l=b.call(t,a)?a:R.getDefault(r.GROUP_IGNORE),s=i.filter(e=>b.call(t,e)),c=o.filter(e=>b.call(t,e));R.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Ie(),Oe(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();k[r.PRESETS].forEach((function(t){if(!b.call(e,t))return;let a=e[t];a.load=_e(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),C&&Ne.stop())},ue=function(e,t){k[r.IGNORE_ON_LOSS]&&k[r.GROUP_IGNORE]&&C&&t.type===w.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ge=function(e,t){V&&q&&t.origin.id===V.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&V.commandSent(t)},pe=function(e,t){V&&B&&q&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},_e=function(e){let t=0;return m.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},me=function(e){L[e]={time:h.gameTime(),report:H[e]||!1},delete H[e],I.set($,L),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,M.unshift(t),be(),!0)},be=function(){const e=k[r.LOGS_LIMIT];M.length>e&&M.splice(M.length-e,M.length),I.set(X,M),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},fe=function(e,t,a){const i=k[r.TARGET_MULTIPLE_FARMERS],n=k[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},Te=function(){K=h.gameTime()},he=function(){clearTimeout(j),clearTimeout(F),clearTimeout(Y),j=null,F=null,Y=null
},ve=function(){return Math.max(1,60*k[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*k[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=x.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=i.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{v.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return Te(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,v.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,v.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=E},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;Te();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,g,p=!1,_=!1;const E=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return a(i.USER_STOP);t()},m.randomSeconds(we())):t()}),f=()=>new Promise((e,a)=>{const n=50-k[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(k[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),R=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(U.forEach((function(e){b.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)b.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),O=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=T.actualDistance(l,a);m.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(p=l,e()):t(i.TIME_LIMIT),!1}),p||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,g=x.getVillageList();const o=g.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),fe(u,c,o))return n(i.BUSY_TARGET);o&&(_=!0),e()}),C=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[r.TARGET_SINGLE_ATTACK]&&!k[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=k[r.TARGET_MULTIPLE_FARMERS]?g:[this.village],s=this.village.getPosition(),_=T.actualDistance(s,a),m=d.calculateTravelTime(p,{
barbarian:!a.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(p,m,_,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(_)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(fe(l,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{E().then(f).then(S).then(I).then(R).then(L).then(O).then(N).then(C).then(P).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,D]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),B=!0,q=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:p.id,type:w.TYPES.ATTACK})}).catch(t=>{switch(he(),v.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),xe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){B=!1,q=!1,he(),Ee(p.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){B=!1,q=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();_.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=T.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),P.push(a)),a},ye=function(){m.each(x.getVillages(),(function(e,t){Se(t)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=k[r.GROUP_ONLY];let t=[];P.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Re(e)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let a=0;a<P.length;a++)if(P[a].getId()===e)return P[a].stop(t.KILL_FARMER),P.splice(a,a+1),!0;return!1
},ke=function(e){Te(),P.length?W>=P.length?(W=0,V=!1,Z=h.gameTime()+ve(),v.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=P[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):j=setTimeout((function(){j=null,W=0,Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),ve())},Le=function(e){for(let t=0;t<P.length;t++){let a=P[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){P.forEach((function(t){t.removeTarget(e)}))},Oe=function(){_.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=I.get(X,[]),L=I.get($,{}),x=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,a){k=R.getAll(),"ignore_update"!==a&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ne(),t[g.TARGETS]&&Oe(),t[g.VILLAGES]&&(Ie(),ye()),t[g.LOGS]&&be(),t[g.INTERVAL_TIMERS]&&C&&(F?(he(),
V.targetStep({delay:!0})):j&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),se("ignore_update"),ne(),ye(),f((function(){ce()}),'presets'),f((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,ge),a.$on(s.MESSAGE_ERROR,pe),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(U.length?(C=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),Te(),function(){let e=ve(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void Ee(p.FARM_START)):(C=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=h.gameTime()+ve()),v.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,he(),v.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&Ee(p.FARM_STOP)},Ne.getFarmer=function(e){return P.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return P},Ne.getSettings=function(){return R},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return L},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return C},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],I.set(X,M),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=ve,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,E,b,f,T,h,v){let w,A,S,y=n.getPresetList(),I=n.getGroupList(),R={},k={},L=null;const x={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
w.exceptionVillages.included.forEach((function(e){N(e)})),w.exceptionVillages.ignored.forEach((function(e){N(e)}))},P=function(){t.isRunning()?t.stop():t.start()},M=function(e){w.selectedTab=e},z=function(){A.setAll(A.decode(w.settings)),w.saveButtonColor='orange',T.notif('success',p('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(E.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(E.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){w.presets=b.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){w.groups=b.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=b.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},B=function(){w.running=!0,
T.notif('success',p('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:T.notif('success',p('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',p('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){w.logs=angular.copy(t.getLogs()),O(),w.logs.length||T.notif('success',p('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},j=function(){w.farmers=t.getFarmers()},F=function(){w.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=E,w.TAB_TYPES=x,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=x.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=k,w.villagesInfo=R,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=A.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:O,limit:_.getPaginationLimit()},A.injectScope(w),U(),V(),O(),C(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-v.gameTime(),L=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=P,w.selectTab=M,w.saveSettings=z,w.clearLogs=t.clearLogs,w.jumpToVillage=g.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=m.showReport,w.removeIgnored=D,w.removeIncluded=G;let i=new f('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,p,_,m,E,f,T,h,v,w,A){let S,y,I,R,k,L,x,O,N,C,P,M,z,D,G,U,V,B,q,W,j,F,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},ge={x:0,y:0},pe=!0;const _e=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,me=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,a=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(a/y)%2&&(t+=R),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},Ee=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},be=function(){Ae(k)},fe=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};C.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(P,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,I),D.fillRect(0,i,I,1);const n=U.getBoundingClientRect(),l=n.width/w.TILESIZE.x/A.view.z*y,s=n.height/w.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(fe)
},Te=function(){if(!ie)return!1;const e=Q.village[x][O];ve(e?Q.character[e]:[[x,O]]),ie=!1,_.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return W.ally;if(j.isEnemy(e.tribe_id))return W.enemy;if(j.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||we(i);if(!n)continue;const o=i.x*y+(i.y%2?R:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,P.width=1e3*y,P.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(_.trigger(s.MINIMAP_VILLAGE_CLICK,[x,O,e]),3===e.which&&(a=x,i=O,E.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),_.trigger(s.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||_.trigger(s.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,ge=me(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=ge.x,te.y=ge.y,!1;if(te.x===ge.x&&te.y===ge.y||(re.alpha=0,function(e,t){let a=g.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(ge.x,ge.y)),ge.x in ae&&ge.y in ae[ge.x]){let t=ae[ge.x][ge.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(x===e.x&&O===e.y)return!1;Te()}ie=!0,x=e.x,O=e.y,_.trigger(s.MINIMAP_VILLAGE_HOVER,{x:x,y:O,event:t});const a=Q.village[x][O];he(a?Q.character[a]:[[x,O]])}(ge,e)}Te()},Le=function(){ie&&Te(),
_.trigger(s.MINIMAP_MOUSE_LEAVE)},xe=function(e){if(!ce)return!1;const t=me(e);g.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},be()},Ce=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&b.call(K,e.type)))return _.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!_e.test(t))return _.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),be(),!0},removeHighlight:function(e,t){if(void 0===t||!b.call(K,e))return!1;if(!b.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),be(),!0},getHighlight:function(e,t){return!!b.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],C=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Ee(e[0]*t,e[1]*t),i=Ee(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return F},Pe.drawMinimap=function(){pe&&(pe=!1),N.style.background=Y[o.COLOR_BACKGROUND],M.clearRect(0,0,P.width,P.height),d((function(){
!function(){const e=T.getPath(w.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*y+R-1,t*y+R-1,3,1),M.fillRect(e*y+R,t*y+R-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*y+R,t*y+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=f.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),be()}),'minimap_data')},Pe.enableRendering=function(){H=!0},Pe.disableRendering=function(){H=!1},Pe.isFirstDraw=function(){return!!pe},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),M=P.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ne}),F.onChange((function(e,t){
Y=F.getAll(),Se(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),Y=F.getAll(),K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),j=V.getTribeRelations(),B=V.getId(),q=V.getTribeId(),W=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Ie),z.addEventListener('mouseup',Re),z.addEventListener('mousemove',ke),z.addEventListener('mouseleave',Le),z.addEventListener('click',xe),z.addEventListener('contextmenu',Oe),p.load((function(){k=p.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(k),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),fe(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ce),a.$on(s.TRIBE_RELATION_CHANGED,be),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,g,_,m,E,b,f,T,h,v){let w,A,S,y,I,R,k,L,x,O,N,C={},P=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){w.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(w.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},B=function(e,t){if(!x)return;let a=V(t.x,t.y);var i,n;O=a,C[a]=!0,P=!0,(i=t.x,n=t.y,new Promise((function(e){let t=T.getTownAt(i,n);if(t)return e(t);T.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[V(e.x,e.y)])return;if(!P)return;k.appendChild(x),x.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const a=x.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=R.tt.position.y+o>i.top+i.height,s=R.tt.position.x+n>i.width;l&&(R.tt.position.y-=50),x.classList.toggle('left',s),x.classList.toggle('top',l)}))},q=function(e,t){if(!x)return;let a=t?V(t):O;C[a]=!1,P=!1,R.tt.visible=!1,x.classList.add('ng-hide'),L.appendChild(x)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=v.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},j=function(){n.addHighlight(w.selectedHighlight,w.addHighlightColor)},F=function(){N.setAll(N.decode(w.settings)),m.notif('success',p('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=p('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=p('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=p('i18n')('reset',a.loc.ale,'common'),e.cancelText=p('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),m.notif('success',p('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){m.notif('error',p('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){m.notif('error',p('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){m.notif('error',p('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){w=a.$new(),w.SETTINGS=g,w.TAB_TYPES=z,w.selectedTab=D,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=n.getHighlights(),w.highlightNames=M,w.mapSizes=b.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=b.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:p('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=G,w.openColorPalette=W,w.addCustomHighlight=j,w.removeHighlight=n.removeHighlight,w.saveSettings=F,w.resetSettings=Y,w.highlightsCount=H,w.openProfile=K,N.injectScope(w,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,B),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),U(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),R=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),x=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),L=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:P,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',p('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',p('i18n')('deactivated',a.loc.ale,'preset_creator')),M.stop()},M.stop=function(){e.trigger(s.PRESET_CREATOR_STOPPED),r=!1},M.isRunning=function(){return r},M.isInitialized=function(){return i},M})),define('two/presetCreator/events',[],(function(){angular.extend(s,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),
define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wojewoda',60,p('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'preset_creator'))):(t.start(),i.notif('success',p('i18n')('activated',a.loc.ale,'preset_creator')))})),n.register(s.PRESET_CREATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.PRESET_CREATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,a,i,n){const o='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){
i.get(o,!1,!0)&&t.start(),n.register(s.PRESET_CREATOR_STARTED,(function(){i.set(o,!0)})),n.register(s.PRESET_CREATOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=n.getSelectedCharacter(),a=t.data.character_id,i=t.data.character_name,r=!1,c=!1,d=[],u=[],g=[];function p(e){var t=new Date(1e3*e);return t.toLocaleString()}var _=function(){o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},m))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},E))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)g.includes(t[a].id)?console.log('Raport ataku już wysłany'):(g.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),setTimeout(_,3e4)},m=function(e){var t,n,s,r,c,d=[],u=e.result,g=e.token,_=e.time_created,m=p(_),E=e.ReportScouting,b=E.attCharacterId,f=E.attCharacterName,T=E.attScouts,h=E.attLosses,v=E.attVillageId,w=E.attVillageName,A=E.defCharacterId,S=E.defCharacterName,y=E.defLosses,I=E.defScouts,R=E.defVillageId,k=E.defVillageName,L=E.commandType,x='',O='',N='',C='',P=Date.now(),M=g.split('.').join('_');2==u?x=' [color=d96a19]Częściowy sukces[/color]':1==u?x=' [color=0a8028]Sukces[/color]':3==u&&(x=' [color=e21f1f]Porażka[/color]'),O='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==I?'nieznana':I,s=null==T?'nieznana':T,r=null==y?'nieznana':y,c=null==h?'nieznana':h,C=null==f&&null==b?'Brak danych':'[player='+b+']'+f+'[/player]',N=null==w&&null==v?'Brak danych':'[village='+v+']'+w+'[/village]',
t=Math.floor(P/1e3-_),d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+x+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+m+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+R+']'+k+'[/village][b] Gracz cel: [/b][player='+A+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+C+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();A!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},E=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=p(r),d=e.ReportAttack,u=d.attCharacterId,g=d.attCharacterName,_=d.attVillageId,m=d.attVillageName,E=d.attEffects,b=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var T=[],h=[];E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),T.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,T.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,T.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,T.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,T.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,T.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,T.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,T.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,T.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,T.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,T.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,T.push(' Zjednoczenie '+p+'%'))}));var v=T.join();b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,h.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,h.push(' Zjednoczenie '+p+'%'))}));var w=h.join(),A=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),R=d.defCharacterId,k=d.defCharacterName,L=d.defVillageId,x=d.defVillageName,O=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),P=d.night,M=d.loyaltyAfter,z=d.loyaltyBefore,D=d.wallAfter,G=d.wallBefore,U=d.officers,V=d.leader,B='',q='',W='',j='',F='',Y='',H='',K='',Q='',Z=Date.now(),X=s.split('.').join('_')
;null!=z&&(Y='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=M&&(H='Lojalność po ataku: '+Math.floor(M)+' '),null!=G&&(K='Mury przed ataku: '+G+' '),null!=D&&(Q='Mury po ataku: '+D+' '),null==U&&1==V?F='Brak':null==U&&1.1==V&&(F=' Wielki Mistrz '),j=0==P?'Nie':'Tak',2==n?B=' [color=d96a19]Częściowy sukces[/color]':1==n?B=' [color=0a8028]Sukces[/color]':3==n&&(B=' [color=e21f1f]Porażka[/color]'),W=null==g&&null==u?'Brak danych':'[player='+u+']'+g+'[/player]',q=null==m&&null==_?'Brak danych':'[village='+_+']'+m+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+x+'[/village][b] Gracz cel: [/b][player='+R+']'+k+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+Y+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},b=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=p(r),d=e.ReportAttack,u=d.attCharacterId,g=d.attCharacterName,_=d.attVillageId,m=d.attVillageName,E=d.attEffects,b=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var T=[],h=[];E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),T.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,T.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,T.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,T.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,T.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,T.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,T.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,T.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,T.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,T.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,T.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,T.push(' Zjednoczenie '+p+'%'))}));var v=T.join();b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,h.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,h.push(' Zjednoczenie '+p+'%'))}));var w,A=h.join(),S=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),I=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,L=d.defCharacterName,x=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),C=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),M=d.night,z=d.loyaltyAfter,D=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,V=d.officers,B='',q='',W='',j='',F='',Y='',H='',K='',Q=[],Z=Date.now(),X=s.split('.').join('_')
;if(null!=D&&(F='Lojalność przed atakiem: '+Math.floor(D)+' '),null!=z&&(Y='Lojalność po ataku: '+Math.floor(z)+' '),null!=U&&(H='Mury przed ataku: '+U+' '),null!=G&&(K='Mury po ataku: '+G+' '),null==V)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(j=0==M?'Nie':'Tak',2==n?B=' [color=d96a19]Częściowy sukces[/color]':1==n?B=' [color=0a8028]Sukces[/color]':3==n&&(B=' [color=e21f1f]Porażka[/color]'),W=null==g&&null==u?'Brak danych':'[player='+u+']'+g+'[/player]',q=null==m&&null==_?'Brak danych':'[village='+_+']'+m+'[/village]',t=Math.floor(Z/1e3-r),w=Q.join(),null!=L){
a.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+O+'[/village][b] Gracz cel: [/b][player='+k+']'+L+'[/player][br]Modyfikator obrony: [b]'+C+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+I+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br]Oficerowie: [b]'+w+'[/b][br]'+F+Y+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},f={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,_()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return r}};return f})),define('two/reportSender/events',[],(function(){angular.extend(s,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Goniec',110,p('i18n')('description',a.loc.ale,'report_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'report_sender'))):(t.start(),i.notif('success',p('i18n')('activated',a.loc.ale,'report_sender')))})),n.register(s.REPORT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(s.REPORT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.REPORT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(s.REPORT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/settings/updates','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/ready','queues/EventQueue'],(function(e,t,a,i,n,o,l,r,c,d){let u,g,p=!1,_=!1;const m='spy_master_settings',E={[n.HEADQUARTER]:'headquarter',[n.WAREHOUSE]:'warehouse',[n.FARM]:'farm',[n.RALLY_POINT]:'rally_point',[n.STATUE]:'statue',[n.WALL]:'wall',[n.TAVERN]:'tavern',[n.BARRACKS]:'barracks',[n.PRECEPTORY]:'preceptory',
[n.HOSPITAL]:'hospital',[n.CLAY_PIT]:'clay_pit',[n.IRON_MINE]:'iron_mine',[n.TIMBER_CAMP]:'timber_camp',[n.CHAPEL]:'chapel',[n.CHURCH]:'church',[n.MARKET]:'market',[n.ACADEMY]:'academy'},b={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'},f={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'},T={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',
[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(T,b,E,f);const h={init:function(){p=!0,u=new e({settingsMap:a,storageKey:m}),g=u.getAll(),console.log('all settings',g)},start:function(){_=!0,d.trigger(s.SPY_MASTER_START)},stop:function(){_=!1,d.trigger(s.SPY_MASTER_STOP)},getSettings:function(){return u},isInitialized:function(){return p},isRunning:function(){return _}};return h})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,l,r,d,u,g,_){let m,E,b;const f={SPY:'spy',COUNTERMEASURES:'countermeasures',
LOGS:'logs'},T=function(e){m.selectedTab=e},h=function(){E.setAll(E.decode(m.settings)),_.notif('success','Settings saved')},v=function(){t.isRunning()?t.stop():t.start()},w=function(){m.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),_.notif('success',p('i18n')('general.started',a.loc.ale,'spy_master'))},A=function(){m.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),_.notif('success',p('i18n')('general.stopped',a.loc.ale,'spy_master'))},S=function(){m=a.$new(),m.SETTINGS=i,m.TAB_TYPES=f,m.running=t.isRunning(),m.selectedTab=f.SPY,m.settingsMap=n,m.building=u.encodeList(o,{textObject:'spy_master',disabled:!0}),m.unit=u.encodeList(l,{textObject:'spy_master',disabled:!0}),m.dummies=u.encodeList(r,{textObject:'spy_master',disabled:!0}),m.replacement=u.encodeList(d,{textObject:'spy_master',disabled:!0}),E.injectScope(m),m.selectTab=T,m.saveSettings=h,m.switchState=v;let e=new g('twoverflow_spy_master_window',(function(){
console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,w),e.register(s.SPY_MASTER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',m)};return function(){E=t.getSettings(),b=e.addMenuButton('Zwiadowca',170),b.addEventListener('click',S),
