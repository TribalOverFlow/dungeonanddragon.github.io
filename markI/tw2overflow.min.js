...
e.trigger(s.AUTO_HEALER_STARTED),r=!0,a.getSelectedCharacter().getVillageList().forEach((function(e,i){let n=e.hospital.patients.healed;0==n.length?console.log('W wiosce: '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){n.forEach((function(i,n){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:i.id})}),n*d),t.notif('success','W wiosce: '+e.getName()+' wyleczono: '+i.id)}))}),i*c)})),t.notif('success',m('i18n')('deactivated',i.loc.ale,'auto_healer')),u.stop()},u.stop=function(){e.trigger(s.AUTO_HEALER_STOPPED),r=!1},u.isRunning=function(){return r},u.isInitialized=function(){return n},u})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){
