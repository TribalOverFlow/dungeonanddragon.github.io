...
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p,g,m,T,b,f,E,_,w,h){let S,v,A,y=n.getPresetList();const R={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){S.selectedTab=e},I=function(){v.setAll(v.decode(S.settings)),h.notif('success','Settings saved')},x=function(){t.isRunning()?t.stop():t.start()},O=function(){S.presets=_.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},N=function(){
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,b,f,E){let _,w,h,S=injector.get('buildingService'),v=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const k={};let I,x,O,N,L,P=!0;const G='builder_queue_log',M='builder_queue_settings',z=function(){const e=U();if(!P)return F.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},C=function(){U().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,b,E,_,w,h,S){let v,A,y,R,k=n.getGroupList(),I={},x=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},L={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let G,M={},z={},C=!1,U=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){v.selectedTab=e},Y=function(){R.setAll(R.decode(v.settings)),C=!1},F=function(){i.isRunning()?i.stop():i.start()},j=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){C?j((function(){G()})):G()},Q={updateGroups:function(){v.groups=p.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(T.BUILDING_SEQUENCES);v.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){v.logs=i.getLogs(),L.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),Q.updateLogs()},buildingSequenceUpdate:function(e,t){const i=R.get(T.BUILDING_SEQUENCES);v.settings[T.BUILDING_SEQUENCES][t]=i[t],v.settings[T.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=R.get(T.BUILDING_SEQUENCES);v.settings[T.BUILDING_SEQUENCES][t]=i[t],Q.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete v.settings[T.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(v.settings[T.BUILDING_SEQUENCES]);O.selectedSequence={name:i,value:i},Q.updateSequences(),O.generateBuildingSequence(),R.get(T.ACTIVE_SEQUENCE)===t&&(R.set(T.ACTIVE_SEQUENCE,i,{quiet:!0}),N.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){v.running=!0},stopped:function(){v.running=!1}},K=function(){const e=R.get(T.ACTIVE_SEQUENCE);v=a.$new(),v.selectedTab=P.SETTINGS,v.TAB_TYPES=P,v.SETTINGS=T,v.running=x,v.pagination={},v.settingsMap=R.settingsMap,v.villagesLabel=z,v.villagesInfo=M,v.editorView=O,v.editorView.buildingSequence={},v.editorView.visibleBuildingSequence=[],v.editorView.selectedSequence={name:e,value:e},v.editorView.lastAddedBuilding=_.HEADQUARTER,v.editorView.lastAddedIndex=1,v.settingsView=N,v.settingsView.buildingSequence={},v.settingsView.buildingSequenceFinal={},v.logsView=L,v.logsView.logs=i.getLogs(),v.selectTab=W,v.switchBuilder=F,v.saveSettings=Y,v.createSequence=q,v.openVillageInfo=r.openVillageInfo,R.injectScope(v),Q.updateGroups(),Q.updateSequences(),v.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},v.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},v.pagination.logs={count:L.logs.length,offset:0,loader:L.updateVisibleLogs,limit:m.getPaginationLimit()},L.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(l.GROUPS_UPDATED,Q.updateGroups,!0),t.register(l.GROUPS_CREATED,Q.updateGroups,!0),t.register(l.GROUPS_DESTROYED,Q.updateGroups,!0),t.register(l.VILLAGE_SELECTED_CHANGED,Q.generateBuildingSequences,!0),t.register(l.BUILDING_UPGRADING,Q.generateBuildingSequences,!0),t.register(l.BUILDING_LEVEL_CHANGED,Q.generateBuildingSequences,!0),t.register(l.BUILDING_TEARING_DOWN,Q.generateBuildingSequences,!0),t.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,Q.generateBuildingSequences,!0),
t.register(l.BUILDER_QUEUE_JOB_STARTED,Q.updateLogs),t.register(l.BUILDER_QUEUE_CLEAR_LOGS,Q.clearLogs),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,Q.buildingSequenceUpdate),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,Q.buildingSequenceAdd),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,Q.buildingSequenceRemoved),t.register(l.BUILDER_QUEUE_SETTINGS_CHANGE,Q.saveSettings),t.register(l.BUILDER_QUEUE_START,Q.started),t.register(l.BUILDER_QUEUE_STOP,Q.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',v),G=v.closeWindow,v.closeWindow=H,v.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&Q.generateBuildingSequences()})),v.$watch('editorView.selectedSequence.value',(function(e,t){U?U=!1:e!==t&&(C?j((function(){Q.generateBuildingSequencesEditor(),C=!1}),(function(){v.editorView.selectedSequence={name:t,value:t},U=!0})):Q.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),R=i.getSettings(),A=e.addMenuButton2('Budowniczy',20),A.addEventListener('click',K),h.register(l.BUILDER_QUEUE_START,(function(){x=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),h.register(l.BUILDER_QUEUE_STOP,(function(){x=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
;const t=R.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});A=angular.copy(k),A.splice(A.indexOf('catapult'),1),k.forEach((function(e){C[e]=0})),I.forEach((function(e){U[e]=!1})),y={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(C),officers:angular.copy(U),catapultTarget:"wall",type:null},G={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},S=e.addMenuButton('Generał',10),S.addEventListener('click',Ee),b.register(l.COMMAND_QUEUE_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),b.register(l.COMMAND_QUEUE_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,V),a.$on(l.DESTROY_CONTEXT_MENU,q),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,T,b,E,_,w,h,S,v){let A,y,R,k,I,x,O,N,L,P,G,M,z,C,U,D,B,V,q,W,Y,F,j,H=!1,Q={},K={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/y)%2&&(t+=k),t-=t%y,a-=a%y,{x:Math.ceil((t-L.width/2)/y),y:Math.ceil((a-L.height/2)/y)}},be=function(e,t){return{x:e/S.TILESIZE.x,y:t/S.TILESIZE.y/S.TILESIZE.off}},fe=function(){ve(I)},Ee=function(){if(H){const e={x:ee.x-L.width/2,y:ee.y-L.height/2};P.clearRect(0,0,L.width,L.height),C.clearRect(0,0,z.width,z.height),function(e){P.drawImage(G,-e.x,-e.y)}(e),j[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ge.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;C.fillStyle=j[o.COLOR_VIEW_REFERENCE],C.fillRect(a,0,1,R),C.fillRect(0,i,R,1);const n=D.getBoundingClientRect(),s=n.width/S.TILESIZE.x/v.view.z*y,l=n.height/S.TILESIZE.y/v.view.z*y,r=a-s/2,c=i-l/2;C.clearRect(r,c,s,l),C.beginPath(),C.lineWidth=1,C.strokeStyle=j[o.COLOR_VIEW_REFERENCE],C.rect(r,c,s,l),C.stroke()}(e)}e.requestAnimationFrame(Ee)},_e=function(){if(!ie)return!1;const e=K.village[O][N];he(e?K.character[e]:[[O,N]]),ie=!1,
m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t,j[o.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t)},Se=function(e){if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in Q.character?Q.character[e.character_id]:e.tribe_id in Q.tribe&&Q.tribe[e.tribe_id];if(!e.character_id)return!!j[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===x.getId()&&j[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in Q.character)return Q.character[e.character_id];if(j[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in Q.character)return Q.character[e.character_id];if(e.tribe_id in Q.tribe)return Q.tribe[e.tribe_id];if(q&&q===e.tribe_id&&j[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(Y&&j[o.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return W.ally;if(Y.isEnemy(e.tribe_id))return W.enemy
;if(Y.isNAP(e.tribe_id))return W.friendly}}return W.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Se(i);if(!n)continue;const o=i.x*y+(i.y%2?k:0),s=i.y*y;M.fillStyle=n,M.fillRect(o,s,A,A)}},Ae=function(){A=oe[j[o.MAP_SIZE]],k=Math.round(A/2),y=A+1,R=1e3*y,J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y,G.width=1e3*y,G.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;L.width=686,L.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,C.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(j[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ge.addHighlight({type:'character',id:e.character_id},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ge.addHighlight({
type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!j[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in Q.character?e=!0:t.tribe_id in Q.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;_e()}ie=!0,O=e.x,N=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=K.village[O][N];we(a?K.character[a]:[[O,N]])}(pe,e)}_e()},xe=function(){ie&&_e(),m.trigger(l.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},Ne=function(e){return e.preventDefault(),!1},Le=function(){Q.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},Q.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},fe()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Ge={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(Q,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;Q[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,Q[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(Q,e))return!1;if(!f.call(Q[e],t))return!1;delete Q[e][t];const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,Q[e]),
a.$broadcast(l.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(Q[e],t)&&Q[e][t]},getHighlights:function(){return Q},eachHighlight:function(e){for(let t in Q)for(let a in Q[t])e(t,a,Q[t][a])},setViewport:function(e){L=e,L.style.background=j[o.COLOR_BACKGROUND],P=L.getContext('2d')},setViewportRef:function(e){z=e,C=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ge.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ge.getSettings=function(){return F},Ge.drawMinimap=function(){ge&&(ge=!1),L.style.background=j[o.COLOR_BACKGROUND],M.clearRect(0,0,G.width,G.height),d((function(){!function(){
const e=_.getPath(S.getMapPath()),t=j[o.SHOW_CONTINENT_DEMARCATIONS],a=j[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=j[o.COLOR_CONTINENT],M.fillRect(e*y+k-1,t*y+k-1,3,1),M.fillRect(e*y+k,t*y+k-2,1,3)},n=function(e,t){M.fillStyle=j[o.COLOR_PROVINCE],M.fillRect(e*y+k,t*y+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=E.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*y,c=l.a*y,d=(s.b-s.a)*y,u=(l.b-l.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Ge.enableRendering=function(){H=!0},Ge.disableRendering=function(){H=!1},Ge.isFirstDraw=function(){return!!ge},Ge.init=function(){Ge.initialized=!0,G=document.createElement('canvas'),M=G.getContext('2d'),re=le.make('hover'),F=new u({settingsMap:s,storageKey:ne}),F.onChange((function(e,t){j=F.getAll(),
Ae(),t[r.MAP_POSITION]&&Ge.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ge.drawMinimap()})),j=F.getAll(),Q.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},Q.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ae()},Ge.run=function(){d((function(){D=document.getElementById('map'),U=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),W=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),ye(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*y,ee.y=x.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Re),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in K.village||(K.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
K.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in K.character?K.character[a.character_id].push([a.x,a.y]):K.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in K.tribe?K.tribe[a.tribe_id].push(a.character_id):K.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in K.village){e.push(a);for(let e in K.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y}(),Ee(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,fe),a.$on(l.GROUPS_VILLAGES_CHANGED,Le)}))}),['initial_village','tribe_relations'])},Ge})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,b,f,E,_,w,h){let S,v,A,y,R,k,I,x,O,N,L,P={},G=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},C=z.MINIMAP,U=function(e){S.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(S.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
...
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:K.addHighlightAutoCompleteSelect},S.selectTab=U,S.openColorPalette=W,S.addCustomHighlight=Y,S.removeHighlight=n.removeHighlight,S.saveSettings=F,S.resetSettings=j,S.highlightsCount=H,S.openProfile=Q,L.injectScope(S,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,K.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,K.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,K.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,K.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,q),e.register(l.MINIMAP_MOUSE_LEAVE,K.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,K.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,K.onMouseStopMoveMinimap),
...
define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[],b=[],f=[],E=[],_=[],w=[],h=[],S=[],v=[],A=[],y=[],R=[],k=[],I=[],x=[],O=[],N=[],L=[],P=[],G=[],M=[],z=[],C=[],U=[],D=[],B=[],V=[],q=[],W=[],Y=[],F=[];const j='recruit_queue_settings',H={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(H);const Q=function(){m=[],T=[],b=[],f=[],E=[],_=[],w=[],h=[]
;const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],s=u[t.PRESET4],l=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])})),o.forEach((function(t){b.push(e[t])})),s.forEach((function(t){f.push(e[t])})),l.forEach((function(t){E.push(e[t])})),r.forEach((function(t){_.push(e[t])})),c.forEach((function(t){w.push(e[t])})),d.forEach((function(t){h.push(e[t])}))},K=function(){S=[],v=[],A=[],y=[],R=[],k=[],I=[],x=[],O=[],N=[],L=[],P=[],G=[],M=[],z=[],C=[],U=[],D=[],B=[],V=[],q=[],W=[],Y=[],F=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4],l=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],b=u[t.GROUP13],f=u[t.GROUP14],E=u[t.GROUP15],_=u[t.GROUP16],w=u[t.GROUP17],h=u[t.GROUP18],j=u[t.GROUP19],H=u[t.GROUP20],Q=u[t.GROUP21],K=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){S.push(e[t])})),i.forEach((function(t){v.push(e[t])})),o.forEach((function(t){A.push(e[t])})),s.forEach((function(t){y.push(e[t])})),l.forEach((function(t){R.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){x.push(e[t])})),p.forEach((function(t){O.push(e[t])})),g.forEach((function(t){N.push(e[t])})),m.forEach((function(t){L.push(e[t])})),T.forEach((function(t){P.push(e[t])})),b.forEach((function(t){G.push(e[t])})),f.forEach((function(t){M.push(e[t])})),E.forEach((function(t){z.push(e[t])})),_.forEach((function(t){
C.push(e[t])})),w.forEach((function(t){U.push(e[t])})),h.forEach((function(t){D.push(e[t])})),j.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),Q.forEach((function(t){q.push(e[t])})),K.forEach((function(t){W.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:i,storageKey:j}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&Q(),t[o.GROUPS]&&K()})),u=d.getAll(),console.log('recruitQueue settings',u),r((function(){Q()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,Q),a.$on(l.ARMY_PRESET_DELETED,Q),a.$on(l.GROUPS_CREATED,K),a.$on(l.GROUPS_DESTROYED,K),a.$on(l.GROUPS_UPDATED,K)},start:function(){g=!0,c.trigger(l.recruit_queue_START)},stop:function(){g=!1,c.trigger(l.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(l,{
