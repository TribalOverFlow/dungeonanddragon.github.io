 ...
 */
!function(e,t){const i=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),a=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),r=injector.get('eventTypeProvider'),s=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),p=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),E=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const n=i.$on(r.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,a){a?this.listeners.push(i.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
e.unregister(t,n)})))},t.prototype.destroy=function(){this.listeners.forEach(e=>{e()}),this.onDestroy()},t})),define('two/utils',['helper/time','helper/math'],(function(e,t){let n={randomSeconds:function(e){if(!e)return 0;const t=(e=parseInt(e,10))+e/2,i=e-e/2;return Math.round(Math.random()*(t-i)+i)},time2seconds:function(e){return(e=e.split(':'))[0]=60*parseInt(e[0],10)*60,e[1]=60*parseInt(e[1],10),e[2]=parseInt(e[2],10),e.reduce((function(e,t){return e+t}))},notif:function(e,t){i.$broadcast(r.NOTIFICATION_DISABLE),i.$broadcast(r.NOTIFICATION_ENABLE);const n='success'===e?r.MESSAGE_SUCCESS:r.MESSAGE_ERROR;i.$broadcast(n,{message:t})},genVillageLabel:function(e){return e.name+' ('+e.x+'|'+e.y+')'},isValidCoords:function(e){return/\s*\d{2,3}\|\d{2,3}\s*/.test(e)},isValidDateTime:function(e){return/^\s*([01][0-9]|2[0-3]):[0-5]\d:[0-5]\d(:\d{1,3})? (0[1-9]|[12][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/\d{4}\s*$/.test(e)},fixDate:function(e){const t=e.trim().split(' '),i=t[0],n=t[1].split('/')
;return i+' '+n[1]+'/'+n[0]+'/'+n[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const i=n.fixDate(e).split(' '),a=i[0].split(':'),o=i[1].split('/'),l=a[0],r=a[1],s=a[2],c=a[3]||null,d=parseInt(o[0],10)-1,u=o[1],g=o[2];return new Date(g,d,u,l,r,s,c).getTime()+(t||0)},formatDate:function(e,t){return p('readableDateFilter')(e,null,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+i.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(i,n){if(!e)return n();let a=new XMLHttpRequest;a.open('GET',e,!0),a.responseType=t,a.addEventListener('load',(function(){i(a)}),!1),a.send()}))},obj2selectOptions:function(e,t){let i=[];for(let n in e){let a={name:e[n].name,value:e[n].id};t&&(a.leftIcon=e[n].icon),i.push(a)}return i},getTravelTime:function(e,i,n,o,l,r){
const s=!i.character_id,c=i.character_id&&i.tribe_id&&i.tribe_id===a.getSelectedCharacter().getTribeId();!1!==r&&('attack'===o?('supporter'in l&&delete l.supporter,s&&(r=!0)):'support'===o&&(c&&(r=!0),'supporter'in l&&(r=!0)));const u={units:n,officers:angular.copy(l)},g=d.calculateTravelTime(u,{barbarian:s,ownTribe:c,officers:l,effects:r},o),p=t.actualDistance(e,i);return 1e3*d.getTravelTimeForDistance(u,g,p,o)},each:function(e,t){if('function'!=typeof t&&(t=E),Array.isArray(e)){for(let i=0,n=e.length;i<n;i++)if(!1===t(e[i],i))return!1}else if(angular.isObject(e))for(let i in e)if(f.call(e,i)&&!1===t(e[i],i))return!1;return!0}};return n})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let s={};const c=function(d,u){'string'==typeof(u=u||['map'])&&(u=[u]);const g=function(e){(u=u.filter((function(t){return t!==e}))).length||d()},p={map:function(){if(n.getSharedData('MapController').isInitialized)return g('map');i.$on(r.MAP_INITIALIZED,(function(){g('map')}))},
tribe_relations:function(){const e=a.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return g('tribe_relations')}const t=i.$on(r.TRIBE_RELATION_LIST,(function(){t(),g('tribe_relations')}))},initial_village:function(){if(a.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return g('initial_village');i.$on(r.GAME_STATE_INITIAL_VILLAGE_READY,(function(){g('initial_village')}))},all_villages_ready:function(){if(a.getGameState().getGameState(e.ALL_VILLAGES_READY))return g('all_villages_ready');i.$on(r.GAME_STATE_ALL_VILLAGES_READY,(function(){g('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return g('minimap_data');t.load((function(){g('minimap_data')}))},presets:function(){if(a.getPresetList().isLoaded())return g('presets');s.presets=s.presets||new Promise((function(e){o.emit(l.GET_PRESETS,{},e)})),s.presets.then((function(){g('presets')}))},world_config:function(){if(a.getWorldConfig&&a.getWorldConfig())return g('world_config')
;setTimeout(p.world_config,100)}};if(!n.getSharedData('MapController'))return setTimeout((function(){c(d,u)}),100);u.forEach((function(e){p[e]()}))};return c})),require(['two/ready','Lockr'],(function(e,t){e((function(){let e=a.getSelectedCharacter();t.prefix=e.getId()+'_twOverflow_'+e.getWorldId()+'-'}))})),define('two/language',['helper/i18n'],(function(e){let t=!1;const n={en_us:{about:{contact:"Kontakt",email:"Email",links:"Linki projektów",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},attack_view:{title:"Strażnik",filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map'])})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,i,n){let s;var c=injector.get('overviewService'),d=!1,u=!1,g=a.getSelectedCharacter().getGlobalInfo(),p={reverse:!1,column:'command_progress'},m=a.getSelectedCharacter(),_=m.tribeById[0],E=m.getVillageList(),f=[],T=m.data.character_id,w=m.data.character_name,h=[],b=[],v=[n.LIGHT_CAVALRY,n.HEAVY_CAVALRY,n.AXE,n.SWORD,n.RAM,n.SNOB,n.TREBUCHET];var A=function(){
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:_},(function(e){for(var t=e.members,i=0;i<t.length;i++)b.push(t[i].id)})),E.forEach((function(e){f.push(e.getId())}));var e=g.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:p.column,reverse:p.reverse?1:0,groups:[],command_types:['attack'],villages:f},S),setTimeout(A,6e4)},S=function(e){for(var t,i=[],n=e.commands,a=0;a<n.length;a++)if(c.formatCommand(n[a]),b.includes(n[a].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+n[a].origin_character_id+' Rodzaj '+n[a].command_type);else if('attack'==n[a].command_type)if(h.includes(n[a].command_id))console.log('');else{h.push(n[a].command_id),n[a].slowestUnit=y(n[a]);var r=n[a].time_completed,d=(t=void 0,t=new Date(1e3*r),s=t.toLocaleString(),s),u='',g='';'sword'==n[a].slowestUnit?(g=' [color=03709d]MIECZNIK[/color]',u='sword'):'axe'==n[a].slowestUnit?(g=' [color=e21f1f]TOPORNIK[/color]',
u='axe'):'ram'==n[a].slowestUnit?(g=' [color=730202]TARAN[/color]',u='ram'):'snob'==n[a].slowestUnit?(g=' [color=ffee00]SZLACHCIC[/color]',u='snob'):'trebuchet'==n[a].slowestUnit?(g=' [color=494500]TREBUSZ[/color]',u='trebuchet'):'light_cavalry'==n[a].slowestUnit?(g=' [color=d96a19]LEKKA KAWALERIA[/color]',u='light_cavalry'):'heavy_cavalry'==n[a].slowestUnit&&(g=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),i.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+g+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+n[a].target_village_id+']'+n[a].target_village_name+'[/village][b] Gracz cel: [/b][player='+T+']'+w+'[/player][b] [br]Wioska pochodzenia: [/b][village='+n[a].origin_village_id+']'+n[a].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+n[a].origin_character_id+']'+n[a].origin_character_name+'[/player][/size]');var p=i.join()
;'snob'==u||'trebuchet'==u?('Hajduk Split'==w||'halfsack'==w||'Black Rider'==w?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:p}),i=[]):('Hajduk Split'==w||'halfsack'==w||'Black Rider'==w?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4648,message:p}),i=[])}},y=function(e){var i=e.model.duration,n={},a={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y},l=[];return v.forEach((function(i){n[i]=1,l.push({unit:i,duration:t.getTravelTime(a,o,n,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-i),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},I={init:function(){d=!0},start:function(){e.trigger(r.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(r.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return I})),define('two/alertSender/events',[],(function(){angular.extend(r,{
ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Wartownik',130,p('i18n')('description',i.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',p('i18n')('deactivated',i.loc.ale,'alert_sender'))):(t.start(),n.notif('success',p('i18n')('activated',i.loc.ale,'alert_sender')))})),a.register(r.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),a.register(r.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(r.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,i,n,a){const o='alert_sender_active'
;if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){n.get(o,!1,!0)&&t.start(),a.register(r.ALERT_SENDER_STARTED,(function(){n.set(o,!0)})),a.register(r.ALERT_SENDER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,s,c,d,u,g,p,m,_,E,f){let T,w,h=!1,b=injector.get('overviewService'),v=[],A=!1,S={},y={},I={reverse:!1,column:n.TIME_COMPLETED};const R='attack_view_filters',k={},L={},O=function(){const e=[c.COMMAND_TYPES],t=a.getSelectedVillage().getId();let i={};for(let t=0;t<e.length;t++)for(let n in S[e[t]])if(i[e[t]]||(i[e[t]]=[]),S[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:
n===s.ATTACK?i[e[t]].push(s.ATTACK):n===s.SUPPORT?i[e[t]].push(s.SUPPORT):n===s.RELOCATE&&i[e[t]].push(s.RELOCATE)}y=i,y.village=S[c.VILLAGE]?[t]:[]},N=function(){V.loadCommands()},C=function(e,t){f.trigger(r.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},M=function(e,t){for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);f.trigger(r.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},x=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);f.trigger(r.ATTACK_VIEW_VILLAGE_RENAMED,[t])},P=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const i={x:e.origin_x,y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(a){const o=t.getTravelTime(i,n,{[a]:1},e.command_type,{},!1);return{unit:a,diff:Math.abs(o-e.model.duration)}
})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,i){return m.actualDistance(t,e)-m.actualDistance(t,i)}))},G=function(e,t){let i=0;if(E.hasTownDataInChunk(e.x,e.y)){const i=E.loadTownData(e.x,e.y,25,25,25),n=a.getSelectedCharacter().getTribeId(),o=a.getSelectedCharacter().getId();let l,r=[];i.forEach((function(e){for(let t in e.data)for(let i in e.data[t])r.push(e.data[t][i])}));const s=r.filter((function(e){return null===e.character_id&&e.id>0})),c=r.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(s.length)l=D(s,e);else if(c.length)l=D(c,e);else{if(!n)return t(!1);{const i=r.filter((function(e){return e.tribe_id===n}));if(!i.length)return t(!1);l=D(i,e)}}return t(l[0])}const n=_.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++i===n.length&&G(e,t)}))},U=function(e){v=e.commands;for(let e=0;e<v.length;e++)b.formatCommand(v[e]),v[e].slowestUnit=z(v[e]);v=v.filter((function(e){
return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(r.ATTACK_VIEW_COMMANDS_LOADED,[v])};let V={loadCommands:function(){const e=T.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return v},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),p.set(R,S),V.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),V.loadCommands()},setCommander:function(e,i){G(e.targetVillage,(function(n){const a=e.targetVillage,o=n,l=o.character_id?s.SUPPORT:s.ATTACK;let r={};t.each(u,(function(e){r[e]='*'})),A.addCommand(a,o,i,w.OUT,r,{},l,g.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return h},init:function(){
for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in s)L[s[e]]=!0;try{A=require('two/commandQueue'),w=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};h=!0,T=a.getSelectedCharacter().getGlobalInfo(),S=p.get(R,t,!0),e((function(){O(),i.$on(r.COMMAND_INCOMING,N),i.$on(r.COMMAND_CANCELLED,C),i.$on(r.MAP_SELECTED_VILLAGE,P),i.$on(r.VILLAGE_NAME_CHANGED,x),i.$on(r.COMMAND_IGNORED,M),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(r,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,o,l,d,u,_,E,f,T,w){let h,b;const v=function(){return Date.now()/1e3},A=function(e){let t=i.$new();t.text=p('readableDateFilter')(1e3*e,i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=p('i18n')('copy',i.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const n=p('readableDateFilter')(1e3*(e.time_completed-10),i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,n)},y=function(){let e=w('#two-attack-view').parent(),t=w('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},I=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleCommands=h.commands.slice(e,e+t),
h.pagination.count=h.commands.length},R=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);I()},k=function(e,i){t.toggleFilter(e,i),h.filters=t.getFilters()},L=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},O=function(){h.commands=t.getCommands()},N=function(){h.selectedVillageId=a.getSelectedVillage().getId()},C=function(){h=i.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=a.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=E,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=_,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:I,limit:m.getPaginationLimit()},h.openCharacterProfile=s.openCharacterProfile,h.openVillageInfo=s.openVillageInfo,h.jumpToVillage=g.jumpToVillage,h.now=v,h.copyTimeModal=A,h.removeTroops=S,h.switchWindowSize=y,h.toggleFilter=k,h.toggleSorting=L,I()
;let e=new n('twoverflow_queue_window',(function(){T.timer.remove(R)}));e.register(r.MAP_SELECTED_VILLAGE,N,!0),e.register(r.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(r.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(r.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(r.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),T.timer.add(R)};return function(){b=e.addMenuButton('Strażnik',40),b.addEventListener('click',C),
...
}})),define('two/attackView/types/columns',[],(function(){return{ORIGIN_VILLAGE:'origin_village_name',COMMAND_TYPE:'command_type',TARGET_VILLAGE:'target_village_name',TIME_COMPLETED:'time_completed',ORIGIN_CHARACTER:'origin_character_name'}})),define('two/attackView/types/commands',[],(function(){return{ATTACK:'attack',SUPPORT:'support',RELOCATE:'relocate'}})),define('two/attackView/types/filters',[],(function(){return{COMMAND_TYPES:'command_types',VILLAGE:'village',INCOMING_UNITS:'incoming_units'}})),define('two/attackView/unitSpeedOrder',['conf/unitTypes'],(function(e){return[e.LIGHT_CAVALRY,e.HEAVY_CAVALRY,e.AXE,e.SWORD,e.RAM,e.SNOB,e.TREBUCHET]})),require(['two/ready','two/attackView','two/attackView/ui','two/attackView/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/autoCollector',['queues/EventQueue'],(function(e){let t=!1,n=!1,s=!0,c=0;const d=function(){o.emit(l.RESOURCE_DEPOSIT_GET_INFO,{})},u=function(){if(!n)return!1
;let e=a.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return i=t.shift(),void o.emit(l.RESOURCE_DEPOSIT_COLLECT,{job_id:i.id,village_id:a.getSelectedVillage().getId()});var i;let r=e.getReadyJobs();return r?function(e){o.emit(l.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(g(r)):void 0},g=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let p={};return p.init=function(){t=!0,i.$on(r.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!s||!n)return!1;s=!1,setTimeout((function(){s=!0,u()}),1500)})),i.$on(r.RESOURCE_DEPOSIT_JOBS_REROLLED,u),i.$on(r.RESOURCE_DEPOSIT_JOB_COLLECTED,u),i.$on(r.RESOURCE_DEPOSIT_INFO,(function(e,t){u(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},p.start=function(){e.trigger(r.AUTO_COLLECTOR_STARTED),n=!0,u()},p.stop=function(){e.trigger(r.AUTO_COLLECTOR_STOPPED),n=!1},p.isRunning=function(){return n},
p.isInitialized=function(){return t},p})),define('two/autoCollector/events',[],(function(){angular.extend(r,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Kolekcjoner',50,p('i18n')('description',i.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),n.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),n.notif('success',p('i18n')('activated',i.loc.ale,'auto_collector')))})),a.register(r.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
a.register(r.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(r.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,n,s,c){let d=!1,u=!1,g=!1,p=injector.get('secondVillageService');const m=function(){var e;e=_,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(p.hasFinishedLastJob(t.jobs))g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),E.stop();else{let i=new c(t);a.getSelectedCharacter().setSecondVillage(i),e()}}))},_=function(){let e=a.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const i=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t<s.server2ClientTime(e[i].time_completed))return e[i];return!1}(e.data.jobs);if(i){const e=s.server2ClientTime(i.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const n=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t>=s.server2ClientTime(e[i].time_completed)&&!e[i].collected)return i;return!1}(e.data.jobs);if(n)return r=n,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:a.getSelectedVillage().getId(),job_id:r});var r;const c=p.getCurrentDayJobs(e.data.jobs,e.data.day),d=p.getCollectedJobs(e.data.jobs),g=a.getSelectedVillage().getResources().getResources(),_=p.getAvailableJobs(c,d,g,[]);if(_){const e=function(e){let i=!1;return t.each(e,(function(e){return i=e,!1})),i}(_);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:a.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=_[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let E={start:function(){if(!d||g)return!1;n.trigger(r.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,m()},stop:function(){if(!d)return!1;n.trigger(r.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!p.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){p.hasFinishedLastJob(e.jobs)?(g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(i.$on(r.SECOND_VILLAGE_VILLAGE_CREATED,m),i.$on(r.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=E})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,i,n,a){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),i(),e((function(){n.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),a.register(r.AUTO_COLLECTOR_STARTED,(function(){n.set(o,!0)})),a.register(r.AUTO_COLLECTOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let n=!1,s=!1;let c={init:function(){n=!0}};return c.start=function(){
t.trigger(r.AUTO_HEALER_STARTED),s=!0,function(){if(!s)return!1;console.log('Medyk uruchomiony'),a.getSelectedCharacter().getVillageList().forEach((function(e,t){let i=e.hospital.patients.healed;0==i.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){i.forEach((function(t,i){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*i),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(r.AUTO_HEALER_STOPPED),s=!1},c.isRunning=function(){return s},c.isInitialized=function(){return n},c})),define('two/autoHealer/events',[],(function(){angular.extend(r,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),
define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Medyk',60,p('i18n')('description',i.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_healer'))):(t.start(),n.notif('success',p('i18n')('activated',i.loc.ale,'auto_healer')))})),a.register(r.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),a.register(r.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(r.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,i,n,a){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){n.get(o,!1,!0)&&t.start(),
a.register(r.AUTO_HEALER_STARTED,(function(){n.set(o,!0)})),a.register(r.AUTO_HEALER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,s,c,d,g,p,m,_,E,f,T){let w,h,b,v=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const R={};let k,L,O,N,C,M=!0;const x='builder_queue_log',P='builder_queue_settings',z=function(){const e=G();if(!M)return F.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),i=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!i.buildingQueue||!i.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){
const t=L.getVillage(e),i=t.buildingQueue;if(i.getAmountJobs()){i.getQueue().forEach((function(i){S.canBeFinishedForFree(i,t)&&A.instantBuild(i,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=C[s.GROUP_VILLAGES];let i=[];return e?(i=k.getGroupVillageIds(e),i=i.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){i.push(e.getId())})),i},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const i=e.buildingQueue.getQueue();let n=angular.copy(R);const a=C[s.BUILDING_SEQUENCES][C[s.ACTIVE_SEQUENCE]];if(i.forEach((function(e){t[e.building]++})),B(t))return!1;a.some((function(i){if(++n[i]>t[i])return v.compute(e),V(e,i,(function(t,i){t&&i.job&&(E.trigger(r.BUILDER_QUEUE_JOB_STARTED,i.job),j(e.getId(),i.job))})),!0}))},V=function(e,t,i){const n=W(e,t);if(n===p.POSSIBLE)q(e,t,(function(e){i(!0,e)}));else if(n===p.NOT_ENOUGH_FOOD&&C[s.PRIORIZE_FARM]){const t=b[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&q(e,m.FARM,(function(e){
i(!0,e)}))}i(!1)},q=function(e,t,i){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},i)},W=function(e,t){const i=e.getBuildingData().getDataForBuilding(t);if(i.upgradeability===p.POSSIBLE){const t=i.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-C[s.PRESERVE_CLAY]<t.clay||n.iron.currentStock-C[s.PRESERVE_IRON]<t.iron||n.wood.currentStock-C[s.PRESERVE_WOOD]<t.wood)return p.NOT_ENOUGH_RESOURCES}return i.upgradeability},B=function(e){for(let t in e)if(e[t]<b[t])return!1;return!0},j=function(e,t){let i={time:T.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(i),O.length>500&&O.splice(O.length-500,O.length),f.set(x,O),!0};let F={};return F.start=function(){if(!M)return E.trigger(r.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,w=setInterval(z,6e4),h=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()
}),['all_villages_ready']),E.trigger(r.BUILDER_QUEUE_START)},F.stop=function(){I=!1,clearInterval(w),clearInterval(h),E.trigger(r.BUILDER_QUEUE_STOP)},F.isRunning=function(){return I},F.isInitialized=function(){return y},F.getSettings=function(){return N},F.getLogs=function(){return O},F.clearLogs=function(){O=[],f.set(x,O),E.trigger(r.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let i=C[s.BUILDING_SEQUENCES];return e in i?g.SEQUENCE_EXISTS:Array.isArray(t)?(i[e]=t,N.set(s.BUILDING_SEQUENCES,i,{quiet:!0}),E.trigger(r.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let i=C[s.BUILDING_SEQUENCES];return e in i?Array.isArray(t)&&function(e){const t=a.getGameData().getBuildings();for(let i=0;i<e.length;i++){let n=e[i];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(i[e]=t,N.set(s.BUILDING_SEQUENCES,i,{quiet:!0}),E.trigger(r.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),
g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=C[s.BUILDING_SEQUENCES];if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],N.set(s.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(r.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,O=f.get(x,[],!0),L=a.getSelectedCharacter(),k=a.getGroupList(),N=new n({settingsMap:c,storageKey:P}),N.onChange((function(e,t,i){C=N.getAll(),I&&t[d.ANALYSE]&&z(),i.quiet||E.trigger(r.BUILDER_QUEUE_SETTINGS_CHANGE)})),C=N.getAll();for(let e in m)R[m[e]]=0;M=Object.keys(C[s.BUILDING_SEQUENCES]).length,b=!!M&&function(e){const t=C[s.BUILDING_SEQUENCES][e];let i=angular.copy(R);return t.forEach((function(e){i[e]++})),i}(C[s.ACTIVE_SEQUENCE]),i.$on(r.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);U(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const i=function(e){let t=[]
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,n,d,u,g,_,E,T,w,h,b,v){let A,S,y,I,R=a.getGroupList(),k={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},C={};const M={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let x,P={},z={},D=!1,G=!1;const U=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},V=function(e,i,n){if(n>=e.length){let i=n-e.length+1;for(;i--;)e.push(t)}e.splice(n,0,e.splice(i,1)[0])},q=function(e,t){switch(n.addBuildingSequence(e,t)){case T.SEQUENCE_SAVED:return!0;case T.SEQUENCE_EXISTS:
return d.notif('error',p('i18n')('error_sequence_exists',i.loc.ale,'builder_queue')),!1;case T.SEQUENCE_INVALID:return d.notif('error',p('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=A.settings[_.ACTIVE_SEQUENCE].value,t=A.settings[_.BUILDING_SEQUENCES][e],i=a.getGameData().getBuildings();let n={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in w)n[w[e]]=0;N.buildingSequence=t.map((function(e){let t=++n[e],o=i[e].individual_level_costs[t],l='not-reached';return!function(e,t){return a.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const i=a.getSelectedVillage().getBuildingQueue().getQueue();let n=!1;return i.some((function(i){
if(i.building===e&&i.level===t)return n=!0})),n}(e,t)&&(l='progress'):l='reached',{level:t,price:i[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},N.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,i=A.settings[_.BUILDING_SEQUENCES][e||t];let n={},a=[];for(let e in y)n[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};i.forEach((function(e){let t=++n[e].level,i=y[e].individual_level_costs[t];n[e].resources.wood+=parseInt(i.wood,10),n[e].resources.clay+=parseInt(i.clay,10),n[e].resources.iron+=parseInt(i.iron,10),n[e].resources.food+=parseInt(i.food,10),n[e].build_time+=parseInt(i.build_time,10),n[e].points+=k[e][t-1]}));for(let e in n)0!==n[e].level&&a.push({building:e,level:n[e].level,order:n[e].order,resources:n[e].resources,points:n[e].points,build_time:n[e].build_time});N.buildingSequenceFinal=a},
N.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=a.getGameData();let t;for(let i in e.data.buildings){let n=e.getBuildingDataForBuilding(i);t=0,k[i]=[];for(let e=1;e<=n.max_level;e++){let a=U(n.points,n.points_factor,e)-t;t+=a,k[i].push(a)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let i=0;i<e.length;i++){let n=e[i];n.checked&&(0!==i&&(e[i-1].checked||(e[i-1].building===n.building&&(e[i-1].level++,n.level--,t=!0),V(e,i,i-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let i=e.length-1;i>=0;i--){let n=e[i];n.checked&&(i!==e.length-1&&(e[i+1].checked||(e[i+1].building===n.building&&(e[i+1].level--,n.level++,t=!0),
V(e,i,i+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.addBuilding=function(e,t,i=1){const n=t-1;let a=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<i;e++)a.splice(n,0,o);return O.buildingSequence=O.updateLevels(a,e),O.updateVisibleBuildingSequence(),D=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),D=!0},O.updateLevels=function(e,t){let i=0,n=[];for(let a=0;a<e.length;a++){let o=e[a];o.building===t?i<y[t].max_level&&n.push({level:++i,building:t,checked:!1}):n.push(o)}return n},O.generateBuildingSequence=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const i=e[O.selectedSequence.value];let n={};for(let e in w)n[w[e]]=0;O.buildingSequence=i.map((function(e){return{level:++n[e],building:e,checked:!1}})),
O.updateVisibleBuildingSequence()},O.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=O.buildingSequence.length},O.updateBuildingSequence=function(){const e=O.selectedSequence.value,t=O.buildingSequence.map((function(e){return e.building}));switch(n.updateBuildingSequence(e,t)){case T.SEQUENCE_SAVED:D=!1;break;case T.SEQUENCE_NO_EXISTS:d.notif('error',p('i18n')('error_sequence_no_exits',i.loc.ale,'builder_queue'));break;case T.SEQUENCE_INVALID:d.notif('error',p('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue'))}},O.modal.removeSequence=function(){let e=i.$new();e.title=p('i18n')('title',i.loc.ale,'builder_queue_remove_sequence_modal'),e.text=p('i18n')('text',i.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=p('i18n')('remove',i.loc.ale,'common'),
e.cancelText=p('i18n')('cancel',i.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),n.removeSequence(O.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},O.modal.addBuilding=function(){let e=i.$new();e.buildings=[],e.position=O.lastAddedIndex,e.indexLimit=O.buildingSequence.length+1,e.buildingsData=a.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:p('i18n')(O.lastAddedBuilding,i.loc.ale,'building_names'),value:O.lastAddedBuilding};for(let t in y)e.buildings.push({name:p('i18n')(t,i.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,n=e.position,a=e.amount,o=p('i18n')(t,i.loc.ale,'building_names'),l=y[t].max_level;O.lastAddedBuilding=t,O.lastAddedIndex=n,O.addBuilding(t,n,a)?(e.closeWindow(),d.notif('success',p('i18n')('add_building_success',i.loc.ale,'builder_queue',o,n))):d.notif('error',p('i18n')('add_building_limit_exceeded',i.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=i.$new();const t=O.selectedSequence.name,n=A.settings[_.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;q(e.name,n)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=i.$new();t.title=p('i18n')('clone_warn_changed_sequence_title',i.loc.ale,'builder_queue'),t.text=p('i18n')('clone_warn_changed_sequence_text',i.loc.ale,'builder_queue'),t.submitText=p('i18n')('clone',i.loc.ale,'builder_queue'),t.cancelText=p('i18n')('cancel',i.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},C.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;C.visibleLogs=C.logs.slice(e,e+t),
A.pagination.logs.count=C.logs.length,C.visibleLogs.forEach((function(e){e.villageId&&function(e){if(P[e])return P[e];P[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:a.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){P[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},C.clearLogs=function(){n.clearLogs()};const W=function(){let e=i.$new();const t=[w.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;q(e.name,t)&&(A.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[_.BUILDING_SEQUENCES][e.name]=t,j(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),B(M.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},B=function(e){A.selectedTab=e},j=function(){I.setAll(I.decode(A.settings)),D=!1},F=function(){n.isRunning()?n.stop():n.start()},H=function(e,t){let n=i.$new();n.title=p('i18n')('discard_changes_title',i.loc.ale,'builder_queue'),n.text=p('i18n')('discard_changes_text',i.loc.ale,'builder_queue'),n.submitText=p('i18n')('discard',i.loc.ale,'common'),n.cancelText=p('i18n')('cancel',i.loc.ale,'common'),n.switchColors=!0,n.submit=function(){n.closeWindow(),e&&e()},n.cancel=function(){n.closeWindow(),t&&t()},c.getModal('modal_attention',n)},Y=function(){D?H((function(){x()})):x()},K={updateGroups:function(){A.groups=g.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(_.BUILDING_SEQUENCES);A.sequences=g.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){A.logs=n.getLogs(),C.updateVisibleLogs()},clearLogs:function(){d.notif('success',p('i18n')('logs_cleared',i.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const n=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=n[t],A.settings[_.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',p('i18n')('sequence_updated',i.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const n=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=n[t],K.updateSequences(),d.notif('success',p('i18n')('sequence_created',i.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[_.BUILDING_SEQUENCES][t];const n=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(A.settings[_.BUILDING_SEQUENCES]);O.selectedSequence={name:n,value:n},K.updateSequences(),O.generateBuildingSequence(),I.get(_.ACTIVE_SEQUENCE)===t&&(I.set(_.ACTIVE_SEQUENCE,n,{quiet:!0}),N.generateSequences()),
d.notif('success',p('i18n')('sequence_removed',i.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',p('i18n')('settings_saved',i.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(_.ACTIVE_SEQUENCE);A=i.$new(),A.selectedTab=M.SETTINGS,A.TAB_TYPES=M,A.SETTINGS=_,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=z,A.villagesInfo=P,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=w.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=N,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=C,A.logsView.logs=n.getLogs(),A.selectTab=B,A.switchBuilder=F,A.saveSettings=j,A.createSequence=W,A.openVillageInfo=s.openVillageInfo,I.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.logs={count:C.logs.length,offset:0,loader:C.updateVisibleLogs,limit:m.getPaginationLimit()},C.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new h('twoverflow_builder_queue_window');t.register(r.GROUPS_UPDATED,K.updateGroups,!0),t.register(r.GROUPS_CREATED,K.updateGroups,!0),t.register(r.GROUPS_DESTROYED,K.updateGroups,!0),t.register(r.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(r.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(r.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(r.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(r.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(r.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(r.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(r.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(r.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(r.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(r.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(r.BUILDER_QUEUE_START,K.started),t.register(r.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',A),x=A.closeWindow,A.closeWindow=Y,A.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),A.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?H((function(){K.generateBuildingSequencesEditor(),D=!1}),(function(){A.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=a.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),I=n.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),b.register(r.BUILDER_QUEUE_START,(function(){L=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',p('i18n')('started',i.loc.ale,'builder_queue'))})),b.register(r.BUILDER_QUEUE_STOP,(function(){L=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',p('i18n')('stopped',i.loc.ale,'builder_queue'))})),
...
updates:[i.ANALYSE],inputType:'number',min:0,max:6e5},[t.PRIORIZE_FARM]:{default:!0,inputType:'checkbox',updates:[i.ANALYSE]}}})),define('two/builderQueue/sequenceStatus',[],(function(){return{SEQUENCE_NO_EXISTS:'sequence_no_exists',SEQUENCE_EXISTS:'sequence_exists',SEQUENCE_INVALID:'sequence_invalid',SEQUENCE_SAVED:'sequence_saved'}})),require(['two/ready','two/builderQueue','two/builderQueue/ui','two/builderQueue/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/commandQueue',['two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','helper/time','helper/math','struct/MapData','Lockr','conf/buildingTypes','conf/officerTypes','conf/unitTypes'],(function(t,i,n,s,c,d,u,g,p,m,_,E,T,w,h){
const b=Object.values(c),v=Object.values(i),A=Object.values(h),S=Object.values(w),y=Object.values(T);let I,R=[],k={},L=[],O=[],N=!1;const C={[s.SELECTED_VILLAGE]:function(e){return e.origin.id===a.getSelectedVillage().getId()},[s.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[s.ALLOWED_TYPES]:function(e,t){return t[s.ALLOWED_TYPES][e.type]},[s.ATTACK]:function(e){return e.type!==c.ATTACK},[s.SUPPORT]:function(e){return e.type!==c.SUPPORT},[s.RELOCATE]:function(e){return e.type!==c.RELOCATE},[s.TEXT_MATCH]:function(e,t){let i=!0;const n=t[s.TEXT_MATCH].toLowerCase().split(/\W/),a=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!a.includes(e))return i=!1,!0})),i}},M=function(e){return e<p.gameTime()+I},x=function(e){R.push(e)},P=function(e){k[e.id]=e},z=function(){
E.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,L=E.get(d.QUEUE_SENT,[],!0),O=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){p.gameTime()>e.sendTime?U.expireCommand(e,n.TIME_LIMIT):(x(e),P(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!M(e.sendTime))return!0;N?U.sendCommand(e):U.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const i=function(e){const i=a.getVillages()[e.origin.id];if(!i)return n.NOT_OWN_VILLAGE;const o=i.unitInfo.units;let l={},r=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return r=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return r=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(r=n.NOT_ENOUGH_UNITS),r||l}(e);if('string'==typeof i)return U.expireCommand(e,i);e.units=i,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),E.set(d.QUEUE_SENT,L),U.removeCommand(e,n.COMMAND_SENT),g.trigger(r.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){O.push(e)}(e),E.set(d.QUEUE_EXPIRED,O),U.removeCommand(e,t)},U.addCommand=function(e,n,o,l,r,s,d,g){let m={},E={};return new Promise((function(f,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(n))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!S.includes(t))return!1;s[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return b.includes(d)?d!==c.RELOCATE||a.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[w.SUPPORTER]&&delete E[w.SUPPORTER],'string'!=typeof g||y.includes(g)?(g=!(d!==c.ATTACK||!m[h.CATAPULT])&&(g||T.HEADQUARTER),v.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(a){if(e=a[0],n=a[1],!e)return I(u.INVALID_ORIGIN);if(!n)return I(u.INVALID_TARGET);const r=t.getTimeFromString(o),s=t.getTravelTime(e,n,m,d,E,!0),c=l===i.ARRIVE?r-s:r,_=l===i.ARRIVE?r:r+s;if(M(c))return I(u.ALREADY_SENT);const T={id:t.guid(),travelTime:s,arriveTime:_,sendTime:c,origin:e,target:n,date:o,dateType:l,units:m,officers:E,type:d,catapultTarget:g,countdown:c-p.gameTime()};x(T),P(T),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(T)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete k[e.id];const i=R.some((function(t,i){if(t.id==e.id)return R.splice(i,1),z(),!0}));if(i)switch(t){case n.TIME_LIMIT:g.trigger(r.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:g.trigger(r.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:g.trigger(r.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:g.trigger(r.COMMAND_QUEUE_REMOVE,e)}else g.trigger(r.COMMAND_QUEUE_REMOVE_ERROR,e);return i},U.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),O=[],L=[]},U.start=function(e){N=!0,g.trigger(r.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){N=!1,g.trigger(r.COMMAND_QUEUE_STOP)},U.isRunning=function(){return N},U.getWaitingCommands=function(){return R},U.getWaitingCommandsObject=function(){return k},U.getSentCommands=function(){return L},
U.getExpiredCommands=function(){return O},U.filterCommands=function(e,t,i){const n=C[e];return(i||R).filter((function(e){return n(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(r,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,l,d,u,g,m,_,E,f,T,w,h){let b,v,A,S,y,I=a.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),L=a.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},C=N.ADD;let M,x,P,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){O=t.data},W=function(){O=!1},B=function(e){
const t=new Date(e||T.gameTime()+o.getTimeOffset()),i=t.getMilliseconds(),n=T.zerofill(i-i%100,3),a=T.zerofill(t.getSeconds(),2),l=T.zerofill(t.getMinutes(),2);return T.zerofill(t.getHours(),2)+':'+l+':'+a+':'+n+' '+T.zerofill(t.getDate(),2)+'/'+T.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),B(e+=t)):''},F=function(){if(b.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!b.isValidDate&&o.getTimeFromString(y.date),t=b.selectedDateType.value===l.ARRIVE;o.each(g,(function(i){o.each(U,(function(n,a){const l=o.getTravelTime(y.origin,y.target,n,i,y.officers,!0);b.travelTimes[i][a].travelTime=p('readableMillisecondsFilter')(l),b.travelTimes[i][a].status=e?H(t?e-l:e):'neutral'}))}))},H=function(e){return e&&b.isValidDate?T.gameTime()+M<e?'valid':'invalid':'neutral'},Y=function(){y.dateType=b.selectedDateType.value,h.set(m.LAST_DATE_TYPE,b.selectedDateType.value),F()},K=function(){
y.catapultTarget=b.catapultTarget.value},Q=function(){const e=b.selectedInsertPreset.value;if(!e)return!1;const t=a.getPresetList().getPresets()[e];b.selectedInsertPreset={name:p('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,b.catapultTarget={name:p('i18n')(t.catapult_target,i.loc.ale,'building_names'),value:t.catapult_target},b.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=T.serverTime()+i.GAME_TIME_OFFSET,n=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=n-t}),T.timer.add(e.updateCountdown)},X=function(){b.waitingCommands=t.getWaitingCommands()},J=function(){b.sentCommands=t.getSentCommands()},$=function(){b.expiredCommands=t.getExpiredCommands()},ee=function(){let e=b.waitingCommands;V.forEach((function(i){b.activeFilters[i]&&(e=t.filterCommands(i,b.filtersData,e))})),
b.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ie=function(e){''===y.units[e]&&(y.units[e]=0)},ne=function(){b.showCatapultSelect=!!y.units.catapult},ae=function(e){b.selectedTab=e},oe=function(){const e=a.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!O)return o.notif('error',p('i18n')('error_no_map_selected_village',i.loc.ale,'command_queue'));f.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},re=function(){y.date=B()},se=function(){if(!y.date)return!1;y.date=j(y.date,100)},ce=function(){if(!y.date)return!1;y.date=j(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",b.catapultTarget={name:p('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},b.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',p('i18n')('error_origin',i.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',p('i18n')('error_target',i.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',p('i18n')('error_invalid_date',i.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',p('i18n')('error_no_units',i.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',p('i18n')('error_relocate_disabled',i.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',p('i18n')('error_already_sent_'+e,i.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),J(),$()},pe=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,n){return n&&(e=n+'.'+e),p('i18n')(e,i.loc.ale,'command_queue')+' '+p('i18n')(t,i.loc.ale,'command_queue')},_e=function(e,t){b.activeFilters[e]=!b.activeFilters[e],
t&&(b.filtersData[u.ALLOWED_TYPES][e]=!b.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){b.activeFilters[u.TEXT_MATCH]=b.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){b.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,i,n){if('commandqueue_village_search'!==t)return!1;y[n]={id:i.raw.id,x:i.raw.x,y:i.raw.y,name:i.raw.name},b.searchQuery[n]=''},removeCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),i.$broadcast(r.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',p('i18n')('error_remove_error',i.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',p('i18n')('error_not_own_village',i.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',p('i18n')('error_no_units_enough',i.loc.ale,'command_queue'))},sendCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,i){if(b.running=t.isRunning(),i.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){b.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{T.timer.remove(e.updateCountdown)})}},Te=function(){const e=h.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;b=i.$new(),b.selectedTab=C,b.inventory=a.getInventory(),b.presets=o.obj2selectOptions(L.getPresets()),b.travelTimes={},o.each(g,(function(e){b.travelTimes[e]={},o.each(U,(function(t,i){b.travelTimes[e][i]={
travelTime:0,status:'neutral'}}))})),b.unitOrder=S,b.officers=I.getOrderedOfficerNames(),b.searchQuery={origin:'',target:''},b.isValidDate=!1,b.dateTypes=w.toActionList(l,(function(e){return p('i18n')(e,i.loc.ale,'command_queue')})),b.selectedDateType={name:p('i18n')(e,i.loc.ale,'command_queue'),value:e},b.selectedInsertPreset={name:p('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},b.catapultTarget={name:p('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},b.autoCompleteOrigin={type:['village'],placeholder:p('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:p('i18n')('add_origin',i.loc.ale,'command_queue'),dropDown:!0},b.autoCompleteTarget={type:['village'],placeholder:p('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:p('i18n')('add_target',i.loc.ale,'command_queue'),dropDown:!0},b.showCatapultSelect=!!y.units.catapult,b.attackableBuildings=z,b.commandData=y,
b.activeFilters=x,b.filtersData=P,b.running=t.isRunning(),b.waitingCommands=t.getWaitingCommands(),b.visibleWaitingCommands=t.getWaitingCommands(),b.sentCommands=t.getSentCommands(),b.expiredCommands=t.getExpiredCommands(),b.EVENT_CODES=d,b.FILTER_TYPES=u,b.TAB_TYPES=N,b.COMMAND_TYPES=g,b.relocateEnabled=a.getWorldConfig().isRelocateUnitsEnabled(),b.onUnitInputFocus=te,b.onUnitInputBlur=ie,b.catapultTargetVisibility=ne,b.selectTab=ae,b.addSelected=oe,b.addMapSelected=le,b.addCurrentDate=re,b.incrementDate=se,b.reduceDate=ce,b.cleanUnitInputs=de,b.addCommand=ue,b.clearRegisters=ge,b.switchCommandQueue=pe,b.removeCommand=t.removeCommand,b.openVillageInfo=s.openVillageInfo,b.toggleFilter=_e,b.$watch('commandData.origin',F),b.$watch('commandData.target',F),b.$watch('commandData.date',F),b.$watch('commandData.officers',F),b.$watch('selectedDateType.value',Y),b.$watch('selectedInsertPreset.value',Q),b.$watch('catapultTarget.value',K),b.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
b.$watch('selectedTab',(function(){b.selectedTab===N.ADD?_=setInterval((function(){F()}),2500):clearInterval(_)})),b.waitingCommands.forEach(e=>{Z(e)});let E=new n('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));E.register(r.ARMY_PRESET_UPDATE,fe.updatePresets,!0),E.register(r.ARMY_PRESET_DELETED,fe.updatePresets,!0),E.register(r.SELECT_SELECTED,fe.autoCompleteSelected,!0),E.register(r.COMMAND_QUEUE_REMOVE,fe.removeCommand),E.register(r.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),E.register(r.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),E.register(r.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),E.register(r.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),E.register(r.COMMAND_QUEUE_SEND,fe.sendCommand),E.register(r.COMMAND_QUEUE_START,fe.start),E.register(r.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',b)};return function(){A=a.getSelectedCharacter(),M=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:p('i18n')(e,i.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},x={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',20),v.addEventListener('click',Te),E.register(r.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),E.register(r.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),i.$on(r.SHOW_CONTEXT_MENU,q),i.$on(r.DESTROY_CONTEXT_MENU,W),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,i){if(t.initialized)return!1;e((function(){t.init(),i(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,n,s,c,d){let u,g,m,_,E,f=!1,T=!1,w=0;u=function(e){let t,i,n=0;for(t=0;t<e.length;t++)i=e[t].chapel||e[t].church,i&&i>n&&(n=i);return n},g=function(e,t){let i=a.getWorldConfig().getChurchBonus(),n=0
;return e<0||!t&&e>i.length-1?0:(n=t?a.getWorldConfig().getChapelBonus():i[e],Math.floor(100*n))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){f=!0}};return h.start=function(){n.trigger(r.FAITH_CHECKER_STARTED),T=!0,a.getSelectedCharacter().getVillageList().forEach((function(n){let a=n.data.villageId,r=n.data.buildings.chapel.level,s=n.buildingQueue.data.queue,c=n.getResources().getComputed(),f=c.food,T=c.wood,h=c.clay,b=c.iron,v=f.currentStock,A=T.currentStock,S=h.currentStock,y=b.currentStock,I=[0,5e3],R=[160,16e3],k=[200,2e4],L=[50,5e3];1==r&&(w=1),m(a,(function(n){_=u(n.villages),E=g(_,1===r),console.log(E),50!=E||s!==t&&0!=s.length?50==E&&s?s.forEach((function(t){let n=t.building;'chapel'==n&&'church'==n||0!=w?'chapel'==n&&'church'==n||1!=w||(A>=R[1]&&S>=k[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:a,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('church',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))):A>=R[0]&&S>=k[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:a,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('chapel',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))})):e.notif('success',p('i18n')('full',i.loc.ale,'faith_checker')):1==w?A>=R[1]&&S>=k[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:a,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('church',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker')):A>=R[0]&&S>=k[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:a,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('chapel',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))}))}))},h.stop=function(){n.trigger(r.FAITH_CHECKER_STOPPED),T=!1},h.isRunning=function(){return T},h.isInitialized=function(){return f},h})),define('two/faithChecker/events',[],(function(){angular.extend(r,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Kapelan',80,p('i18n')('description',i.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',p('i18n')('deactivated',i.loc.ale,'faith_checker'))):(t.start(),n.notif('success',p('i18n')('activated',i.loc.ale,'faith_checker')))})),a.register(r.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
a.register(r.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(r.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,i,n,a){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){n.get(o,!1,!0)&&t.start(),a.register(r.FAITH_CHECKER_STARTED,(function(){n.set(o,!0)})),a.register(r.FAITH_CHECKER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,s,c,g,p,m,_,T,w,h,b,v,A,S,y,I){let R,k,L,O,N,C=!1,M=!1,x=[],P=[],z=[],D=[],G=[],U=[],V=!1,q=!1,W=!1,B=0,j=null,F=null,H=null,Y={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(k[s.MIN_DISTANCE],k[s.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(k[s.MIN_POINTS],k[s.MAX_POINTS])}},ie=[te.distance,te.ownPlayer,te.included,te.ignored],ne=function(e){return e.sort().filter((function(e,t,i){return!t||e!=i[t-1]}))},ae=function(){!function(){const e=k[s.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=a.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ne(z)}(),function(){const e=k[s.GROUP_IGNORE];D=a.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[s.GROUP_ONLY];G=[],e.forEach((function(e){let t=a.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),G=G.concat(t)})),G=ne(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){f.call(L,e)||(L[e]={time:h.gameTime(),report:!1},t=!0)})),_.each(L,(function(i,n){n=parseInt(n,10),e.includes(n)||(delete L[n],t=!0)})),t&&(I.set($,L),b.trigger(r.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),b.trigger(r.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const i=k[s.GROUP_INCLUDE],n=k[s.GROUP_IGNORE],a=k[s.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ae(),n===t.group_id&&(o?(Re(t.village_id),l=!0):(Oe(t.village_id),Ee(p.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),i.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),a.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){M&&e.start()})),l=!0}l&&b.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const i=k[s.GROUP_INCLUDE],n=k[s.GROUP_IGNORE],a=k[s.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ae(),n===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){M&&e.start()})),l=!0}else Ne(),Ee(p.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});i.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),a.includes(t.group_id)&&o&&(Re(t.village_id),l=!0),l&&b.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},re=function(e){
const t=a.getGroupList().getGroups(),i=k[s.GROUP_IGNORE],n=k[s.GROUP_ONLY],o=k[s.GROUP_INCLUDE],l=f.call(t,i)?i:R.getDefault(s.GROUP_IGNORE),r=n.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));R.setAll({[s.GROUP_IGNORE]:l,[s.GROUP_ONLY]:r,[s.GROUP_INCLUDE]:c},e)},se=function(){re(),ae(),Ie(),Ne(),ye()},ce=function(){U=[];const e=a.getPresetList().getPresets();k[s.PRESETS].forEach((function(t){if(!f.call(e,t))return;let i=e[t];i.load=me(i),i.travelTime=d.calculateTravelTime(i,{barbarian:!1,officers:!1}),U.push(i)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(b.trigger(r.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),M&&Ce.stop())},ue=function(e,t){k[s.IGNORE_ON_LOSS]&&k[s.GROUP_IGNORE]&&M&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(Y[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[s.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ge=function(e,t){V&&W&&t.origin.id===V.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},pe=function(e,t){V&&q&&W&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,i){e&&(t+=N[i].load*e)})),t},_e=function(e){L[e]={time:h.gameTime(),report:Y[e]||!1},delete Y[e],I.set($,L),b.trigger(r.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,P.unshift(t),fe(),!0)},fe=function(){const e=k[s.LOGS_LIMIT];P.length>e&&P.splice(P.length-e,P.length),I.set(X,P),b.trigger(r.FARM_OVERFLOW_LOGS_UPDATED)},Te=function(e,t,i){const n=k[s.TARGET_MULTIPLE_FARMERS],a=k[s.TARGET_SINGLE_ATTACK];if(n&&i){if(a&&e)return!0}else if(a){if(e||t)return!0}else if(t)return!0;return!1},we=function(){K=h.gameTime()},he=function(){clearTimeout(j),clearTimeout(F),clearTimeout(H),j=null,F=null,H=null
},be=function(){return Math.max(1,60*k[s.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*k[s.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=n.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{b.trigger(r.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return we(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,b.trigger(r.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(b.trigger(r.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(b.trigger(r.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,b.trigger(r.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(n.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=E},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;we();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let i,c,u,g,p=!1,m=!1;const E=()=>new Promise((t,i)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return i(n.USER_STOP);t()},_.randomSeconds(ve())):t()}),T=()=>new Promise((e,i)=>{const a=50-k[s.PRESERVE_COMMAND_SLOTS];t.length>=a?i(n.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(k[s.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),i=e.getComputed(),a=e.getMaxStorage();if(ee.every(e=>i[e].currentStock===a))return t(n.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(n.TARGET_CYCLE_END):(i=this.targets[this.index],void e()):t(n.NO_TARGETS)),R=()=>new Promise((e,t)=>{y.getTownAtAsync(i.x,i.y,a=>{if(te.points(a.points))return t(n.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:i.id},a=>{this.running?null!==i.character_id||null===a.owner_id||z.includes(i.id)?i.attack_protection?t(n.PROTECTED_VILLAGE):e():t(n.ABANDONED_CONQUERED):t(n.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const i=a.getPresetList().getPresetsByVillageId(e);let n=[];if(U.forEach((function(e){f.call(i,e.id)||n.push(e.id)})),n.length){for(let e in i)f.call(i,e)&&n.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():t(n.USER_STOP)})}),N=()=>new Promise((e,t)=>{const a=this.village.getUnitInfo().getUnits(),o=60*k[s.MAX_TRAVEL_TIME],l=this.village.getPosition(),r=w.actualDistance(l,i);_.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],i=e[1];return a[t].in_town<i}))return;const s=d.calculateTravelTime(l,{barbarian:!i.character_id,officers:!1});return o>s*r?(p=l,e()):t(n.TIME_LIMIT),!1}),p||t(n.NO_UNITS)}),C=()=>new Promise((e,a)=>{c=!1,g=O.getVillageList();const o=g.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===i.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===i.id&&'forward'===e.data.direction),Te(u,c,o))return a(n.BUSY_TARGET);o&&(m=!0),e()}),M=()=>new Promise((e,t)=>{if(!u&&!c)return e();const a=60*k[s.MULTIPLE_ATTACKS_INTERVAL];if(!a)return e();if(k[s.TARGET_SINGLE_ATTACK]&&!k[s.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=k[s.TARGET_MULTIPLE_FARMERS]?g:[this.village],r=this.village.getPosition(),m=w.actualDistance(r,i),_=d.calculateTravelTime(p,{
barbarian:!i.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(p,_,m,v.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===i.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<a)}))return t(n.BUSY_TARGET);e()}),x=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:i.id,num_reports:0},i=>{if(!this.running)return t(n.USER_STOP);const a=i.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=a.some(e=>e.start_village_id!==this.villageId),l=a.some(e=>e.start_village_id===this.villageId);if(Te(l,o,!0))return t(n.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{E().then(T).then(S).then(I).then(R).then(L).then(N).then(C).then(M).then(x).then(e).catch(t)}),D=new Promise((e,t)=>{H=setTimeout(()=>{this.running&&t(n.EXPIRED_STEP)},3e4)});Promise.race([P,D]).then(()=>{if(!this.running)return!1
;this.setStatus(n.ATTACKING),q=!0,W=i,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:i.id,army_preset_id:p.id,type:v.TYPES.ATTACK})}).catch(t=>{switch(he(),b.trigger(r.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case n.TIME_LIMIT:case n.BUSY_TARGET:case n.ABANDONED_CONQUERED:case n.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case n.USER_STOP:this.setStatus(t);break;case n.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Oe(i.id),this.targetStep(e);break;case n.NO_UNITS:case n.NO_TARGETS:case n.FULL_STORAGE:case n.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case n.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case n.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(n.UNKNOWN),this.stop(n.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||n.UNKNOWN},Ae.prototype.commandSent=function(e){q=!1,W=!1,he(),Ee(p.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){q=!1,W=!1,this.stop(n.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(i=>{this.targets=function(e,t){return e.map((function(e){return e.distance=w.actualDistance(t,e),e}))}(i,t),this.targets=function(e){return e.filter((function(e){return ie.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[s.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[s.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let i=Ce.getFarmer(e);return i||(i=new Ae(e),x.push(i)),i},ye=function(){_.each(O.getVillages(),(function(e,t){Se(t)})),b.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=k[s.GROUP_ONLY];let t=[];x.forEach((function(i){let n=i.getId();e.length&&!G.includes(n)?t.push(n):D.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){Re(e)})),b.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let i=0;i<x.length;i++)if(x[i].getId()===e)return x[i].stop(t.KILL_FARMER),x.splice(i,i+1),!0;return!1
},ke=function(e){we(),x.length?B>=x.length?(B=0,V=!1,Z=h.gameTime()+be(),b.trigger(r.FARM_OVERFLOW_CYCLE_END)):V=x[B]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(B++,ke())})),"cycle_begin"===e&&(Z=null,b.trigger(r.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):j=setTimeout((function(){j=null,B=0,Z=null,b.trigger(r.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),be())},Le=function(e){for(let t=0;t<x.length;t++){let i=x[t].getTargets();for(let t=0;t<i.length;t++){if(i[t].id===e)return!0}}return!1},Oe=function(e){x.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){x.forEach((function(e){e.loadTargets()}))}),!0)};let Ce={};return Ce.init=function(){C=!0,P=I.get(X,[]),L=I.get($,{}),O=a.getSelectedCharacter(),N=a.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,i){k=R.getAll(),"ignore_update"!==i&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ae(),t[g.TARGETS]&&Ne(),t[g.VILLAGES]&&(Ie(),ye()),t[g.LOGS]&&fe(),t[g.INTERVAL_TIMERS]&&M&&(F?(he(),
V.targetStep({delay:!0})):j&&(he(),b.trigger(r.FARM_OVERFLOW_CYCLE_BEGIN),B=0,ke())))})),k=R.getAll(),re("ignore_update"),ae(),ye(),T((function(){ce()}),'presets'),T((function(){x.forEach((function(e){e.loadTargets()}))}),'minimap_data'),i.$on(r.ARMY_PRESET_UPDATE,de),i.$on(r.ARMY_PRESET_DELETED,de),i.$on(r.GROUPS_VILLAGE_LINKED,oe),i.$on(r.GROUPS_VILLAGE_UNLINKED,le),i.$on(r.GROUPS_DESTROYED,se),i.$on(r.COMMAND_SENT,ge),i.$on(r.MESSAGE_ERROR,pe),i.$on(r.REPORT_NEW,ue)},Ce.start=function(){let e;return!M&&(U.length?(M=!0,e=[],x.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),we(),function(){let e=be(),t=e+e/2+ve();Q=setInterval((function(){h.gameTime()-K>t&&(Ce.stop(),setTimeout(Ce.start,5e3))}),3e4)}(),b.trigger(r.FARM_OVERFLOW_START),void Ee(p.FARM_START)):(M=!1,!1)):(b.trigger(r.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ce.stop=function(e=n.USER_STOP){V?(V.stop(e),
e!==n.USER_STOP&&(Z=h.gameTime()+be()),b.trigger(r.FARM_OVERFLOW_CYCLE_END,e)):Z=null,M=!1,he(),b.trigger(r.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===n.USER_STOP&&Ee(p.FARM_STOP)},Ce.getFarmer=function(e){return x.find((function(t){return t.getId()===e}))},Ce.getFarmers=function(){return x},Ce.getSettings=function(){return R},Ce.getExceptionVillages=function(){return{included:z,ignored:D}},Ce.getExceptionLogs=function(){return L},Ce.isInitialized=function(){return C},Ce.isRunning=function(){return M},Ce.getLogs=function(){return P},Ce.clearLogs=function(){return P=[],I.set(X,P),b.trigger(r.FARM_OVERFLOW_LOGS_UPDATED),P},Ce.getNextCycleDate=function(){return Z},Ce.getCycleInterval=be,Ce})),define('two/farmOverflow/events',[],(function(){angular.extend(r,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,u,E,f,T,w,h,b){let v,A,S,y=a.getPresetList(),I=a.getGroupList(),R={},k={},L=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&C(e.villageId),e.targetId&&C(e.targetId)}))},C=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:a.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},M=function(){
v.exceptionVillages.included.forEach((function(e){C(e)})),v.exceptionVillages.ignored.forEach((function(e){C(e)}))},x=function(){t.isRunning()?t.stop():t.start()},P=function(e){v.selectedTab=e},z=function(){A.setAll(A.decode(v.settings)),v.saveButtonColor='orange',w.notif('success',p('i18n')('settings_saved',i.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(E.GROUP_IGNORE);if(!a.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(E.GROUP_INCLUDE).forEach((function(t){a.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){v.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){v.groups=f.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=f.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},q=function(){v.running=!0,
w.notif('success',p('i18n')('farm_started',i.loc.ale,'farm_overflow'))},W=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:w.notif('success',p('i18n')('no_preset',i.loc.ale,'farm_overflow'));break;case d.USER_STOP:w.notif('success',p('i18n')('farm_stopped',i.loc.ale,'farm_overflow'))}},B=function(){v.logs=angular.copy(t.getLogs()),N(),v.logs.length||w.notif('success',p('i18n')('reseted_logs',i.loc.ale,'farm_overflow'))},j=function(){v.farmers=t.getFarmers()},F=function(){v.exceptionVillages=t.getExceptionVillages(),M()},H=function(){v.exceptionLogs=t.getExceptionLogs()},Y=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,i){i!==n.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=i.$new(),v.SETTINGS=E,v.TAB_TYPES=O,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=O.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=k,v.villagesInfo=R,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=A.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},A.injectScope(v),U(),V(),N(),M(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-b.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=x,v.selectTab=P,v.saveSettings=z,v.clearLogs=t.clearLogs,v.jumpToVillage=g.jumpToVillage,v.openVillageInfo=s.openVillageInfo,v.showReport=_.showReport,v.removeIgnored=D,v.removeIncluded=G;let n=new T('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));n.register(r.ARMY_PRESET_UPDATE,U,!0),n.register(r.ARMY_PRESET_DELETED,U,!0),n.register(r.GROUPS_UPDATED,V,!0),n.register(r.GROUPS_CREATED,V,!0),n.register(r.GROUPS_DESTROYED,V,!0),
n.register(r.FARM_OVERFLOW_START,q),n.register(r.FARM_OVERFLOW_STOP,W),n.register(r.FARM_OVERFLOW_LOGS_UPDATED,B),n.register(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,j),n.register(r.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),n.register(r.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,H),n.register(r.FARM_OVERFLOW_CYCLE_BEGIN,Y),n.register(r.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){Q()})),h.register(r.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),h.register(r.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,s,c,d,u,p,m,_,E,T,w,h,b,v,A){let S,y,I,R,k,L,O,N,C,M,x,P,z,D,G,U,V,q,W,B,j,F,H,Y=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ie={},ne=!1;const ae='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7},le=injector.get('colorService'),re=injector.get('spriteFactory')
;let se,ce=!0,de=!1,ue={},ge={x:0,y:0},pe=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,i=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(i/y)%2&&(t+=R),t-=t%y,i-=i%y,{x:Math.ceil((t-C.width/2)/y),y:Math.ceil((i-C.height/2)/y)}},Ee=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},fe=function(){Ae(k)},Te=function(){if(Y){const e={x:ee.x-C.width/2,y:ee.y-C.height/2};M.clearRect(0,0,C.width,C.height),D.clearRect(0,0,z.width,z.height),function(e){M.drawImage(x,-e.x,-e.y)}(e),H[o.SHOW_VIEW_REFERENCE]&&function(e){const t=xe.getMapPosition(),i=(t.x-2)*y-e.x,n=(t.y-2)*y-e.y;D.fillStyle=H[o.COLOR_VIEW_REFERENCE],D.fillRect(i,0,1,I),D.fillRect(0,n,I,1);const a=U.getBoundingClientRect(),l=a.width/v.TILESIZE.x/A.view.z*y,r=a.height/v.TILESIZE.y/A.view.z*y,s=i-l/2,c=n-r/2;D.clearRect(s,c,l,r),D.beginPath(),D.lineWidth=1,D.strokeStyle=H[o.COLOR_VIEW_REFERENCE],D.rect(s,c,l,r),D.stroke()}(e)}e.requestAnimationFrame(Te)
},we=function(){if(!ne)return!1;const e=Q.village[O][N];be(e?Q.character[e]:[[O,N]]),ne=!1,m.trigger(r.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},he=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i][0],a=e[i][1];t.push(ie[n][a])}Ae(t,H[o.COLOR_QUICK_HIGHLIGHT])},be=function(e){let t=[];for(let i=0;i<e.length;i++){let n=e[i][0],a=e[i][1];t.push(ie[n][a])}Ae(t)},ve=function(e){if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!H[o.SHOW_BARBARIANS]&&B.barbarian;if(e.character_id===q){if(e.id===L.getId()&&H[o.HIGHLIGHT_SELECTED])return B.selected;if(e.character_id in K.character)return K.character[e.character_id];if(H[o.HIGHLIGHT_OWN])return B.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&H[o.HIGHLIGHT_DIPLOMACY])return B.tribe;if(j&&H[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return B.ally;if(j.isEnemy(e.tribe_id))return B.enemy;if(j.isNAP(e.tribe_id))return B.friendly}}return B.ugly},Ae=function(e,t){for(let i=0;i<e.length;i++){const n=e[i];if(n.id<0)continue;const a=t||ve(n);if(!a)continue;const o=n.x*y+(n.y%2?R:0),l=n.y*y;P.fillStyle=a,P.fillRect(o,l,S,S)}},Se=function(){S=oe[H[o.MAP_SIZE]],R=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,x.width=1e3*y,x.height=1e3*y,P.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;C.width=686,C.height=e,z.width=686,z.height=e,M.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var i,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(r.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(i=O,n=N,E.getTownAtAsync(i,n,(function(e){if(!e)return!1;switch(H[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;xe.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;xe.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),m.trigger(r.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||m.trigger(r.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,ge=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=ge.x,te.y=ge.y,!1;if(te.x===ge.x&&te.y===ge.y||(se.alpha=0,function(e,t){let i=g.tileCoordinate2Pixel(e,t);se.setTranslation(i[0]-25,i[1]+2),se.alpha=1}(ge.x,ge.y)),ge.x in ie&&ge.y in ie[ge.x]){let t=ie[ge.x][ge.y];if(!H[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(O===e.x&&N===e.y)return!1;we()}ne=!0,O=e.x,N=e.y,m.trigger(r.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const i=Q.village[O][N];he(i?Q.character[i]:[[O,N]])}(ge,e)}we()},Le=function(){ne&&we(),
m.trigger(r.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=_e(e);g.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},Ce=function(){K.tribe=le.getCustomColorsByGroup(b.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(b.PLAYER_COLORS)||{},fe()},Me=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let xe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(r.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(r.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?b.PLAYER_COLORS:b.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e.type]),i.$broadcast(r.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
;const n='character'===e?b.PLAYER_COLORS:b.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e]),i.$broadcast(r.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let i in K[t])e(t,i,K[t][i])},setViewport:function(e){C=e,C.style.background=H[o.COLOR_BACKGROUND],M=C.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return xe.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const i=Ee(e[0]*t,e[1]*t),n=Ee(e[2]*t,e[3]*t);return[i.x-1,i.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},xe.getSettings=function(){return F},xe.drawMinimap=function(){pe&&(pe=!1),C.style.background=H[o.COLOR_BACKGROUND],P.clearRect(0,0,x.width,x.height),d((function(){
!function(){const e=w.getPath(v.getMapPath()),t=H[o.SHOW_CONTINENT_DEMARCATIONS],i=H[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){P.fillStyle=H[o.COLOR_CONTINENT],P.fillRect(e*y+R-1,t*y+R-1,3,1),P.fillRect(e*y+R,t*y+R-2,1,3)},a=function(e,t){P.fillStyle=H[o.COLOR_PROVINCE],P.fillRect(e*y+R,t*y+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},r={a:X.a-10,b:X.b+10};if(t||i)for(let e=l.a;e<l.b;e++)for(let l=r.a;l<r.b;l++){const r=T.toTile(o,e,l);r.key.b&&(r.key.c&&t?n(e,l):i&&a(e,l))}const s=l.a*y,c=r.a*y,d=(l.b-l.a)*y,u=(r.b-r.a)*y;P.beginPath(),P.lineWidth=2,P.strokeStyle="#2B4700",P.rect(s,c,d,u),P.stroke()}))}(),fe()}),'minimap_data')},xe.enableRendering=function(){Y=!0},xe.disableRendering=function(){Y=!1},xe.isFirstDraw=function(){return!!pe},xe.init=function(){xe.initialized=!0,x=document.createElement('canvas'),P=x.getContext('2d'),se=re.make('hover'),F=new u({settingsMap:l,storageKey:ae}),F.onChange((function(e,t){
H=F.getAll(),Se(),t[s.MAP_POSITION]&&xe.setCurrentPosition(te.x,te.y),t[s.MINIMAP]&&xe.drawMinimap()})),H=F.getAll(),K.tribe=le.getCustomColorsByGroup(b.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(b.PLAYER_COLORS)||{},Se()},xe.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=a.getSelectedCharacter(),j=V.getTribeRelations(),q=V.getId(),W=V.getTribeId(),B=V.getVillagesColors(),se.alpha=0,A.graph.layers.effects.push(se),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Ie),z.addEventListener('mouseup',Re),z.addEventListener('mousemove',ke),z.addEventListener('mouseleave',Le),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),p.load((function(){k=p.getVillages(),function(e){for(let t=0,i=e.length;t<i;t++){let i=e[t];i.id<0||(i.x in Q.village||(Q.village[i.x]={}),i.x in ie||(ie[i.x]=[]),
Q.village[i.x][i.y]=i.character_id||0,ie[i.x][i.y]=i,i.character_id&&(i.character_id in Q.character?Q.character[i.character_id].push([i.x,i.y]):Q.character[i.character_id]=[[i.x,i.y]],i.tribe_id&&(i.tribe_id in Q.tribe?Q.tribe[i.tribe_id].push(i.character_id):Q.tribe[i.tribe_id]=[i.character_id])))}}(k),function(){let e=[],t=[];for(let i in Q.village){e.push(i);for(let e in Q.village[i])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),Te(),i.$on(r.VILLAGE_SELECTED_CHANGED,Me),i.$on(r.TRIBE_RELATION_CHANGED,fe),i.$on(r.GROUPS_VILLAGES_CHANGED,Ce)}))}),['initial_village','tribe_relations'])},xe})),define('two/minimap/events',[],(function(){angular.extend(r,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,a,d,u,g,m,_,E,f,T,w,h,b){let v,A,S,y,I,R,k,L,O,N,C,M={},x=!1,P={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){v.selectedTab=e,e===z.MINIMAP?a.enableRendering():a.disableRendering()},U=function(){Object.keys(v.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
P.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!O)return;let i=V(t.x,t.y);var n,a;N=i,M[i]=!0,x=!0,(n=t.x,a=t.y,new Promise((function(e){let t=w.getTownAt(n,a);if(t)return e(t);w.loadTownDataAsync(n,a,1,1,(function(t){e(t)}))}))).then((function(e){if(!M[V(e.x,e.y)])return;if(!x)return;k.appendChild(O),O.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const i=O.getBoundingClientRect(),n=k.getBoundingClientRect(),a=i.width+50,o=i.height+50,l=R.tt.position.y+o>n.top+n.height,r=R.tt.position.x+a>n.width;l&&(R.tt.position.y-=50),O.classList.toggle('left',r),O.classList.toggle('top',l)}))},W=function(e,t){if(!O)return;let i=t?V(t):N;M[i]=!1,x=!1,R.tt.visible=!1,O.classList.add('ng-hide'),L.appendChild(O)},B=function(e,t,n){let o,l,r=i.$new(),s=!0;r.colorPalettes=b.palette,'setting'===e?(l=t,o=C.get(l),s=!1,r.submit=function(){v.settings[l]='#'+r.selectedColor,r.closeWindow()},r.reset=function(){v.settings[l]=C.getDefault(l),r.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,r.submit=function(){v.addHighlightColor='#'+r.selectedColor,r.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][n],r.submit=function(){a.addHighlight({id:n,type:t},r.selectedColor),r.closeWindow()}),r.selectedColor=o.replace('#',''),r.hasCustomColors=!0,r.hideReset=s,r.finishAction=function(e,t){r.selectedColor=t},
c.getModal('modal_color_palette',r)},j=function(){a.addHighlight(v.selectedHighlight,v.addHighlightColor)},F=function(){C.setAll(C.decode(v.settings)),_.notif('success',p('i18n')('settings_saved',i.loc.ale,'minimap'))},H=function(){let e=i.$new();e.title=p('i18n')('reset_confirm_title',i.loc.ale,'minimap'),e.text=p('i18n')('reset_confirm_text',i.loc.ale,'minimap'),e.submitText=p('i18n')('reset',i.loc.ale,'common'),e.cancelText=p('i18n')('cancel',i.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){C.resetAll(),_.notif('success',p('i18n')('settings_reset',i.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},Y=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?s.openCharacterProfile:s.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',p('i18n')('highlight_add_error_exists',i.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',p('i18n')('highlight_add_error_no_entry',i.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',p('i18n')('highlight_add_error_invalid_color',i.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){v=i.$new(),v.SETTINGS=g,v.TAB_TYPES=z,v.selectedTab=D,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=a.getHighlights(),v.highlightNames=P,v.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:p('i18n')('placeholder_search',i.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=G,v.openColorPalette=B,v.addCustomHighlight=j,v.removeHighlight=a.removeHighlight,v.saveSettings=F,v.resetSettings=H,v.highlightsCount=Y,v.openProfile=K,C.injectScope(v,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){a.disableRendering()}));e.register(r.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(r.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(r.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(r.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(r.MINIMAP_VILLAGE_HOVER,q),e.register(r.MINIMAP_VILLAGE_BLUR,W),e.register(r.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(r.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(r.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',v),U(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),a.enableRendering(),a.isFirstDraw()&&a.drawMinimap()};return function(){C=a.getSettings(),R=n.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',a.setViewport(S),a.setViewportRef(y),O=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),L=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=a.getMapPosition();if(!e)return!1;Z(),a.setCurrentPosition(e.x,e.y)})),
...
define('two/mintHelper',['queues/EventQueue'],(function(e){let t=!1,i=!1,n=3e3;function s(){a.getSelectedCharacter().getVillageList().forEach((function(e){let t=0,i=0,a=0,r=e.data.buildings.academy.level,s=e.getResources().getComputed(),c=s.wood,d=s.clay,u=s.iron,g=c.currentStock,p=d.currentStock,m=u.currentStock;setTimeout((function(){r>0?g>=28e3&&p>=3e4&&m>=25e3?(t=Math.floor(g/28e3),i=Math.floor(p/3e4),a=Math.floor(m/25e3),t<=a&&t<=i?(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:t}),console.log('W wiosce '+e.getName()+' wybito '+t+' monet.')):i<=a&&i<=t?(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:i}),console.log('W wiosce '+e.getName()+' wybito '+i+' monet.')):(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:a}),console.log('W wiosce '+e.getName()+' wybito '+a+' monet.'))):console.log('Za mało surowców żeby wybić monety w wiosce'+e.getName()):console.log('W wiosce '+e.getName()+' brak akademi')}),n)})),setTimeout(s,3e4)}let c={init:function(){t=!0},start:function(){
e.trigger(r.MINT_HELPER_STARTED),i=!0,s()},stop:function(){e.trigger(r.MINT_HELPER_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(r,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Mincerz',90,p('i18n')('description',i.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',p('i18n')('deactivated',i.loc.ale,'mint_helper'))):(t.start(),n.notif('success',p('i18n')('activated',i.loc.ale,'mint_helper')))})),a.register(r.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),a.register(r.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),
t.isRunning()&&a.trigger(r.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,i,n,a){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){n.get(o,!1,!0)&&t.start(),a.register(r.AUTO_HELPER_STARTED,(function(){n.set(o,!0)})),a.register(r.AUTO_HELPER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var n=!1,s=!1,c=a.getSelectedCharacter().getVillageList(),d='060504',u='060505',g='06050f',m='060506',_='060502',E='060501',f='060503',T='05020a',w='05030a',h='04080a',b='040a0a',v='070e04',A='070e05',S='070e0f',y='070e06',I='070e02',R='070e01',k='070e03',L='070e07',O='070e0b',N='070e0e',C='030d07',M='030d0b',x='030d0e';var P={init:function(){n=!0}};return P.start=function(){e.trigger(r.PRESET_CREATOR_STARTED),s=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,g='string'==typeof g?parseInt(g,16):g,m='string'==typeof m?parseInt(m,16):m,_='string'==typeof _?parseInt(_,16):_,E='string'==typeof E?parseInt(E,16):E,f='string'==typeof f?parseInt(f,16):f,T='string'==typeof T?parseInt(T,16):T,w='string'==typeof w?parseInt(w,16):w,h='string'==typeof h?parseInt(h,16):h,b='string'==typeof b?parseInt(b,16):b,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,C='string'==typeof C?parseInt(C,16):C,M='string'==typeof M?parseInt(M,16):M,x='string'==typeof x?parseInt(x,16):x,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
...
scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (treb)',icon:N,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (tar)',icon:x,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (kat)',icon:x,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,
axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:x,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',p('i18n')('done',i.loc.ale,'preset_creator')),t.notif('success',p('i18n')('deactivated',i.loc.ale,'preset_creator')),P.stop()},P.stop=function(){e.trigger(r.PRESET_CREATOR_STOPPED),s=!1},P.isRunning=function(){return s},P.isInitialized=function(){return n},P})),define('two/presetCreator/events',[],(function(){angular.extend(r,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),
define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Wojewoda',120,p('i18n')('description',i.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),n.notif('success',p('i18n')('deactivated',i.loc.ale,'preset_creator'))):(t.start(),n.notif('success',p('i18n')('activated',i.loc.ale,'preset_creator')))})),a.register(r.PRESET_CREATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),a.register(r.PRESET_CREATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(r.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,i,n,a){const o='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){
n.get(o,!1,!0)&&t.start(),a.register(r.PRESET_CREATOR_STARTED,(function(){n.set(o,!0)})),a.register(r.PRESET_CREATOR_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))}))}(this);