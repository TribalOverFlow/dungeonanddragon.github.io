...
this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||b},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return f.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!f.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),f.call(i,'min')&&(t=Math.max(i.min,t)),f.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),r=o(n,l);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(f.call(this.settingsMap,t)){
...
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:_},(function(e){for(var t=e.members,a=0;a<t.length;a++)v.push(t[a].id)})),b.forEach((function(e){f.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:f},S),setTimeout(A,6e4)},S=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),v.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(h.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{h.push(i[n].command_id),i[n].slowestUnit=y(i[n]);var s=i[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',p='';'sword'==i[n].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',
...
h.pagination.count=h.commands.length},R=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);I()},k=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},L=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},x=function(){h.commands=t.getCommands()},O=function(){h.selectedVillageId=n.getSelectedVillage().getId()},N=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=b,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=_,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:I,limit:m.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=p.jumpToVillage,h.now=w,h.copyTimeModal=A,h.removeTroops=S,h.switchWindowSize=y,h.toggleFilter=k,h.toggleSorting=L,I()
...
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c,d,u,p,g,m,_,b){let f,E,T=!1,h=!1,v=[],w=[];const A='battle_calculator_settings',S=function(){v=[];const e=n.getPresetList().getPresets();E[t.PRESETS].forEach((function(t){v.push(e[t])})),console.log('selectedPresets',v)},y=function(){w=[];const e=n.getGroupList().getGroups();E[t.GROUPS].forEach((function(t){w.push(e[t])})),
console.log('selectedGroups',w)},I={init:function(){T=!0,f=new e({settingsMap:i,storageKey:A}),f.onChange((function(e,t){E=f.getAll(),t[o.PRESETS]&&S(),t[o.GROUPS]&&y()})),E=f.getAll(),console.log('all settings',E),_((function(){S()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,S),a.$on(s.ARMY_PRESET_DELETED,S),a.$on(s.GROUPS_CREATED,y),a.$on(s.GROUPS_DESTROYED,y),a.$on(s.GROUPS_UPDATED,y)},start:function(){h=!0,console.log('selectedPresets',v),console.log('selectedGroups',w),b.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){h=!1,console.log('example module stop'),b.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return f},isInitialized:function(){return T},isRunning:function(){return h}};return I})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u,p,g,m,_,b,f,E){let T,h,v,w=n.getPresetList();const A={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},S=function(e){T.selectedTab=e},y=function(){h.setAll(h.decode(T.settings)),E.notif('success','Settings saved')},I=function(){t.isRunning()?t.stop():t.start()},R=function(){T.presets=b.encodeList(w.getPresets(),{disabled:!1,type:'presets'})},k=function(){T.running=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),E.notif('success','Example module started')
},L=function(){T.running=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),E.notif('success','Example module stopped')},x=function(){T=a.$new(),T.SETTINGS=i,T.TAB_TYPES=A,T.running=t.isRunning(),T.selectedTab=A.BATTLE,T.settingsMap=o,T.order=b.encodeList(l,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(r,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(d,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(u,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(p,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(g,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(m,{textObject:'battleCalculator',disabled:!1}),T.order=b.encodeList(_,{textObject:'battleCalculator',disabled:!1}),h.injectScope(T),R(),T.selectTab=S,T.saveSettings=y,T.switchState=I;let e=new f('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}))
;e.register(s.ARMY_PRESET_UPDATE,R,!0),e.register(s.ARMY_PRESET_DELETED,R,!0),e.register(s.BATTLE_CALCULATOR_START,k),e.register(s.BATTLE_CALCULATOR_STOP,L),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',T)};return function(){h=t.getSettings(),v=e.addMenuButton('Kalkulator',180),v.addEventListener('click',x),
...
BASHPOINTS_CATAPULT:'bashpoints_catapult',BASHPOINTS_KNIGHT:'bashpoints_knight',BASHPOINTS_SNOB:'bashpoints_snob',BASHPOINTS_DOPPELSOLDNER:'bashpoints_doppelsoldner',BASHPOINTS_TREBUCHET:'bashpoints_trebuchet'}})),define('two/battleCalculator/settings/map',['two/battleCalculator/settings','two/battleCalculator/types/church','two/battleCalculator/types/wall','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/order','two/battleCalculator/types/training','two/battleCalculator/settings/updates'],(function(e,t,a,i,n,o,l,s,r,c){return{[e.BATTLE_CHURCH_A]:{default:t.LEVEL_1,updates:[c.BATTLE_CHURCH_A],disabledOption:!0,inputType:'select',multiSelect:!1,type:'church'},[e.BATTLE_CHURCH_D]:{default:t.LEVEL_1,updates:[c.BATTLE_CHURCH_D],disabledOption:!0,inputType:'select',multiSelect:!1,type:'church'},[e.BATTLE_WALL]:{default:a.NO_WALL,updates:[c.BATTLE_WALL],
disabledOption:!0,inputType:'select',multiSelect:!1,type:'wall'},[e.BATTLE_NIGHT_BONUS]:{default:!1,updates:[c.BATTLE_NIGHT_BONUS],inputType:'checkbox'},[e.BATTLE_OFFICER_LEADER]:{default:!1,updates:[c.BATTLE_OFFICER_LEADER],inputType:'checkbox'},[e.BATTLE_OFFICER_MEDIC]:{default:!1,updates:[c.BATTLE_OFFICER_MEDIC],inputType:'checkbox'},[e.BATTLE_SKILL_MEDIC]:{default:!1,updates:[c.BATTLE_SKILL_MEDIC],inputType:'checkbox'},[e.BATTLE_SKILL_WEAPON_MASTER]:{default:i.NO_SKILL,updates:[c.BATTLE_SKILL_WEAPON_MASTER],disabledOption:!0,inputType:'select',multiSelect:!1,type:'weapon-master'},[e.BATTLE_SKILL_IRON_WALLS]:{default:n.NO_SKILL,updates:[c.BATTLE_SKILL_IRON_WALLS],disabledOption:!0,inputType:'select',multiSelect:!1,type:'iron-walls'},[e.BATTLE_SKILL_CLINIQUE]:{default:o.NO_SKILL,updates:[c.BATTLE_SKILL_CLINIQUE],disabledOption:!0,inputType:'select',multiSelect:!1,type:'clinique'},[e.BATTLE_HOSPITAL]:{default:l.NO_HOSPITAL,updates:[c.BATTLE_HOSPITAL],disabledOption:!0,
inputType:'select',multiSelect:!1,type:'hospital'},[e.TROOPS_BARRACKS]:{default:25,updates:[c.TROOPS_BARRACKS],inputType:'number',min:1,max:25},[e.TROOPS_PRECEPTORY]:{default:10,updates:[c.TROOPS_PRECEPTORY],inputType:'number',min:0,max:10},[e.TROOPS_ORDER]:{default:s.NONE,updates:[c.TROOPS_ORDER],disabledOption:!0,inputType:'select',multiSelect:!1,type:'orders'},[e.TROOPS_DOMINATION]:{default:!1,updates:[c.TROOPS_DOMINATION],inputType:'checkbox'},[e.TROOPS_TRAINING]:{default:r.NO_SKILL,updates:[c.TROOPS_TRAINING],disabledOption:!0,inputType:'select',multiSelect:!1,type:'training'}}})),define('two/battleCalculator/types/order',[],(function(){return{NONE:'none',TEUTONIC_ORDER:'teutonic',TEMPLAR_ORDER:'templar'}})),define('two/battleCalculator/types/church',[],(function(){return{NO_CHURCH:'without',LEVEL_1:'first_level',LEVEL_2:'second_level',LEVEL_3:'third_level'}})),define('two/battleCalculator/types/wall',[],(function(){return{NO_WALL:'without',LEVEL_1:'level_1',LEVEL_2:'level_2',
LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5',LEVEL_6:'level_6',LEVEL_7:'level_7',LEVEL_8:'level_8',LEVEL_9:'level_9',LEVEL_10:'level_10',LEVEL_11:'level_11',LEVEL_12:'level_12',LEVEL_13:'level_13',LEVEL_14:'level_14',LEVEL_15:'level_15',LEVEL_16:'level_16',LEVEL_17:'level_17',LEVEL_18:'level_18',LEVEL_19:'level_19',LEVEL_20:'level_20'}})),define('two/battleCalculator/types/weapon-master',[],(function(){return{NO_SKILL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5'}})),define('two/battleCalculator/types/iron-walls',[],(function(){return{NO_SKILL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5'}})),define('two/battleCalculator/types/clinique',[],(function(){return{NO_SKILL:'without',LEVEL_0:'level_0',LEVEL_1:'level_1',LEVEL_2:'level_2',LEVEL_3:'level_3',LEVEL_4:'level_4',LEVEL_5:'level_5',LEVEL_6:'level_6',LEVEL_7:'level_7',
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,f,E){let T,h,v,w=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const R={};let k,L,x,O,N,C=!0;const P='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(R);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return w.compute(e),V(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),F(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)B(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=v[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&B(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<v[t])return!1;return!0},F=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),f.set(P,x),!0};let j={};return j.start=function(){if(!C)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,T=setInterval(z,6e4),h=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){I=!1,clearInterval(T),
clearInterval(h),b.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return I},j.isInitialized=function(){return y},j.getSettings=function(){return O},j.getLogs=function(){return x},j.clearLogs=function(){x=[],f.set(P,x),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,x=f.get(P,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),I&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)R[m[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,v=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(R);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,T,h,v,w){let A,S,y,I,R=n.getGroupList(),k={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case E.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};O.generateSequences=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=A.settings[_.ACTIVE_SEQUENCE].value,t=A.settings[_.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in T)i[T[e]]=0;O.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:w.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,a=A.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=k[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
...
V(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(D=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),D=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),D=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in T)i[T[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:D=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
...
A.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[T.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(A.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[_.BUILDING_SEQUENCES][e.name]=t,F(),O.selectedSequence={name:e.name,value:e.name},x.selectedSequence={name:e.name,value:e.name},O.generateSequences(),x.generateBuildingSequence(),e.closeWindow(),W(C.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},F=function(){I.setAll(I.decode(A.settings)),D=!1},j=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){D?Y((function(){P()})):P()},K={updateGroups:function(){A.groups=p.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(_.BUILDING_SEQUENCES);A.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){x.generateBuildingSequence()},
updateLogs:function(){A.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=i[t],A.settings[_.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[_.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(A.settings[_.BUILDING_SEQUENCES]);x.selectedSequence={name:i,value:i},K.updateSequences(),x.generateBuildingSequence(),I.get(_.ACTIVE_SEQUENCE)===t&&(I.set(_.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(_.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=C.SETTINGS,A.TAB_TYPES=C,A.SETTINGS=_,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=z,A.villagesInfo=M,A.editorView=x,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=T.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=O,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=N,A.logsView.logs=i.getLogs(),A.selectTab=W,A.switchBuilder=j,A.saveSettings=F,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,I.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
...
const v=Object.values(c),w=Object.values(a),A=Object.values(h),S=Object.values(T),y=Object.values(E);let I,R=[],k={},L=[],x=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<g.gameTime()+I},P=function(e){R.push(e)},M=function(e){k[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,L=b.get(d.QUEUE_SENT,[],!0),x=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(P(e),M(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!C(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),b.set(d.QUEUE_SENT,L),U.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){x.push(e)}(e),b.set(d.QUEUE_EXPIRED,x),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(f,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(i))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(b[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[T.SUPPORTER]&&delete b[T.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[h.CATAPULT])&&(p||E.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return I(u.INVALID_ORIGIN);if(!i)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(C(c))return I(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};P(E),M(E),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,f,E,T,h){let v,w,A,S,y,I=n.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),L=n.getPresetList(),x=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,P,M,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){x=t.data},q=function(){x=!1},W=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),l=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},F=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},j=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);v.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),v.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&v.isValidDate?E.gameTime()+C<e?'valid':'invalid':'neutral'},H=function(){y.dateType=v.selectedDateType.value,h.set(m.LAST_DATE_TYPE,v.selectedDateType.value),j()},K=function(){
...
v.$watch('selectedTab',(function(){v.selectedTab===O.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),v.waitingCommands.forEach(e=>{Z(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),b.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),b.register(s.COMMAND_QUEUE_START,fe.start),b.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){A=n.getSelectedCharacter(),C=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',20),w.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){f=!0}};return h.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,h=c.clay,v=c.iron,w=f.currentStock,A=E.currentStock,S=h.currentStock,y=v.currentStock,I=[0,5e3],R=[160,16e3],k=[200,2e4],L=[50,5e3];1==s&&(T=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=T?'chapel'==i&&'church'==i||1!=T||(A>=R[1]&&S>=k[1]&&y>=L[1]&&w>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):A>=R[0]&&S>=k[0]&&y>=L[0]&&w>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==T?A>=R[1]&&S>=k[1]&&y>=L[1]&&w>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):A>=R[0]&&S>=k[0]&&y>=L[0]&&w>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
...
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),P.push(a)),a},ye=function(){_.each(x.getVillages(),(function(e,t){Se(t)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=k[r.GROUP_ONLY];let t=[];P.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Re(e)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let a=0;a<P.length;a++)if(P[a].getId()===e)return P[a].stop(t.KILL_FARMER),P.splice(a,a+1),!0;return!1
},ke=function(e){Te(),P.length?W>=P.length?(W=0,V=!1,Z=h.gameTime()+ve(),v.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=P[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):F=setTimeout((function(){F=null,W=0,Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),ve())},Le=function(e){for(let t=0;t<P.length;t++){let a=P[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){P.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=I.get(X,[]),L=I.get($,{}),x=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,a){k=R.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(Ie(),ye()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&C&&(j?(he(),
V.targetStep({delay:!0})):F&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),se("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(U.length?(C=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),Te(),function(){let e=ve(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(C=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,T,h,v){let w,A,S,y=n.getPresetList(),I=n.getGroupList(),R={},k={},L=null;const x={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleLogs=w.logs.slice(e,e+t),w.pagination.count=w.logs.length,w.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
w.exceptionVillages.included.forEach((function(e){N(e)})),w.exceptionVillages.ignored.forEach((function(e){N(e)}))},P=function(){t.isRunning()?t.stop():t.start()},M=function(e){w.selectedTab=e},z=function(){A.setAll(A.decode(w.settings)),w.saveButtonColor='orange',T.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){w.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){w.groups=f.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),w.groupsWithDisabled=f.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},B=function(){w.running=!0,
T.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(w.running=!1,w.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:T.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){w.logs=angular.copy(t.getLogs()),O(),w.logs.length||T.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){w.farmers=t.getFarmers()},j=function(){w.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){w.exceptionLogs=t.getExceptionLogs()},H=function(){w.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(w.showCycleTimer=!0,w.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;w=a.$new(),w.SETTINGS=b,w.TAB_TYPES=x,w.LOG_TYPES=u,w.running=t.isRunning(),w.selectedTab=x.SETTINGS,w.farmers=t.getFarmers(),
w.villagesLabel=k,w.villagesInfo=R,w.exceptionVillages=t.getExceptionVillages(),w.exceptionLogs=t.getExceptionLogs(),w.logs=t.getLogs(),w.visibleLogs=[],w.showCycleTimer=!1,w.nextCycleCountdown=0,w.saveButtonColor='orange',w.settingsMap=A.settingsMap,w.pagination={count:w.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(w),U(),V(),O(),C(),function(){let e=t.getNextCycleDate();e&&(w.showCycleTimer=!0,w.nextCycleCountdown=e-v.gameTime(),L=setInterval((function(){w.nextCycleCountdown-=1e3}),1e3))}(),w.switchFarm=P,w.selectTab=M,w.saveSettings=z,w.clearLogs=t.clearLogs,w.jumpToVillage=p.jumpToVillage,w.openVillageInfo=r.openVillageInfo,w.showReport=_.showReport,w.removeIgnored=D,w.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,E,T,h,v,w,A){let S,y,I,R,k,L,x,O,N,C,P,M,z,D,G,U,V,B,q,W,F,j,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,a=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(a/y)%2&&(t+=R),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},be=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},fe=function(){Ae(k)},Ee=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};C.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(P,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,I),D.fillRect(0,i,I,1);const n=U.getBoundingClientRect(),l=n.width/w.TILESIZE.x/A.view.z*y,s=n.height/w.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)
},Te=function(){if(!ie)return!1;const e=Q.village[x][O];ve(e?Q.character[e]:[[x,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(F&&Y[o.HIGHLIGHT_DIPLOMACY]){
...
c.getModal('modal_color_palette',s)},F=function(){n.addHighlight(w.selectedHighlight,w.addHighlightColor)},j=function(){N.setAll(N.decode(w.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=z,w.selectedTab=D,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=n.getHighlights(),w.highlightNames=M,w.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},w.selectTab=G,w.openColorPalette=W,w.addCustomHighlight=F,w.removeHighlight=n.removeHighlight,w.saveSettings=j,w.resetSettings=Y,w.highlightsCount=H,w.openProfile=K,N.injectScope(w,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,B),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
...
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},_=function(e){var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,_=g(m),b=e.ReportScouting,f=b.attCharacterId,E=b.attCharacterName,T=b.attScouts,h=b.attLosses,v=b.attVillageId,w=b.attVillageName,A=b.defCharacterId,S=b.defCharacterName,y=b.defLosses,I=b.defScouts,R=b.defVillageId,k=b.defVillageName,L=b.commandType,x='',O='',N='',C='',P=Date.now(),M=p.split('.').join('_');2==u?x=' [color=d96a19]Częściowy sukces[/color]':1==u?x=' [color=0a8028]Sukces[/color]':3==u&&(x=' [color=e21f1f]Porażka[/color]'),O='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==I?'nieznana':I,s=null==T?'nieznana':T,r=null==y?'nieznana':y,c=null==h?'nieznana':h,C=null==E&&null==f?'Brak danych':'[player='+f+']'+E+'[/player]',N=null==w&&null==v?'Brak danych':'[village='+v+']'+w+'[/village]',
