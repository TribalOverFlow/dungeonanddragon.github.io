 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),b=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||b,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
"battle.insertVD":"Wstaw jednostki z wioski - broniący","battle.insertPD":"Wstaw jednostki z szablonu - broniący","battle.faith":"Wiara","battle.morale":"Morale","battle.luck":"Szczęście","battle.wall":"Mury","battle.nightbonus":"Bonus nocny","battle.leader":"Wielki mistrz","battle.medic":"Medyk","battle.doctor":"Doktor","battle.attack-bonus":"Mistrzostwo broni","battle.iron-walls":"Żelazny mur","battle.clinique":"Klinika","battle.hospital":"Szpital","battle.equip":"Przedmioty rycerza","battle.halberd":"Halabarda Guan Yu","battle.longsword":"Długi miecz Paracelsusa","battle.battleaxe":"Bojowy topór Thorgarda","battle.longbow":"Łuk Nimroda","battle.lance":"Lanca Mieszka","battle.compositebow":"Kompozytowy łuk Nimroda","battle.banner":"Chorągiew Baptystów","battle.star":"Gwiazda poranna Karola","battle.bonfire":"Pochodnia Alethei","battle.scepter":"Berło Vasca","battle.target":"Cel katapult",bunker:"Bunkier","bunker.header":"Kalkulator optymalnego offa na bunkier",
troops:"Koszt jednostek","troops.header":"Kalkulator kosztów produkcji jednostek","troops.th":"Koszty produkcji","troops.units":"Jednostki","troops.building":"Budynek","troops.barracks":"Koszary","troops.preceptory":"Komturia","troops.effects":"Efekty","troops.domination":"Dominacja","troops.training":"Intensywny trening","troops.order":"Zakon","troops.templars":"Zakon Templariuszy","troops.teutonic":"Zakon Krzyżacki","troops.none":"Brak",bashpoints:"Punkty Bojowe","bashpoints.header":"Kalkulator punktów bojowych","bashpoints.th":"Punkty bojowe","bashpoints.attacker":"Jako atakujący","bashpoints.defender":"Jako obrońca","bashpoints.killed":"Zniszczone jednostki"},builder_queue:{title:"Budowniczy",started:"Budowniczy Uruchomiony",stopped:"Budowniczy Zatrzymany",settings:"Ustawienia",settings_village_groups:"Buduj w wioskach z grupy",settings_building_sequence:"Szablon kolejki budowy",settings_building_sequence_final:"Finalne poziomy budynków",
...
a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+p+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+i[n].target_village_id+']'+i[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+E+']'+T+'[/player][b] [br]Wioska pochodzenia: [/b][village='+i[n].origin_village_id+']'+i[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+i[n].origin_character_id+']'+i[n].origin_character_name+'[/player][/size]');var g=a.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==T||'halfsack'==T||'Black Rider'==T?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:g}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:g}),a=[]):('Hajduk Split'==T||'halfsack'==T||'Black Rider'==T?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:g}):o.emit(l.MESSAGE_REPLY,{message_id:4648,message:g}),a=[])}},y=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y
},l=[];return A.forEach((function(a){i[a]=1,l.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},I={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,w()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return I})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',100,g('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,_,b,f){let E,T,h=!1,v=injector.get('overviewService'),A=[],w=!1,S={},y={},I={reverse:!1,column:i.TIME_COMPLETED};const R='attack_view_filters',k={},x={},L=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},O=function(){B.loadCommands()},N=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){
for(let e=0;e<A.length;e++)A[e].command_id===t.command_id&&A.splice(e,1);f.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},C=function(e,t){for(let e=0;e<A.length;e++)A[e].target_village_id===t.village_id?(A[e].target_village_name=t.name,A[e].targetVillage.name=t.name):A[e].origin_village_id===t.village_id&&(A[e].origin_village_name=t.name,A[e].originVillage.name=t.name);f.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],B.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=_.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},U=function(e){A=e.commands;for(let e=0;e<A.length;e++)v.formatCommand(A[e]),A[e].slowestUnit=z(A[e]);A=A.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[A])};let B={loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return A},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],L(),g.set(R,S),B.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),B.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),w.addCommand(n,o,a,T.OUT,s,{},l,p.WALL),w.isRunning()||w.start()}))},commandQueueEnabled:function(){return!!w},isInitialized:function(){return h},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)x[r[e]]=!0;try{w=require('two/commandQueue'),T=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(x),
[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};h=!0,E=n.getSelectedCharacter().getGlobalInfo(),S=g.get(R,t,!0),e((function(){L(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,M),a.$on(s.VILLAGE_NAME_CHANGED,C),a.$on(s.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,_,b,f,E,T){let h,v;const A=function(){return Date.now()/1e3},w=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,i)},y=function(){let e=T('#two-attack-view').parent(),t=T('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},I=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleCommands=h.commands.slice(e,e+t),
h.pagination.count=h.commands.length},R=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);I()},k=function(e,a){t.toggleFilter(e,a),h.filters=t.getFilters()},x=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},L=function(){h.commands=t.getCommands()},O=function(){h.selectedVillageId=n.getSelectedVillage().getId()},N=function(){h=a.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=b,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=_,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:I,limit:m.getPaginationLimit()},h.openCharacterProfile=r.openCharacterProfile,h.openVillageInfo=r.openVillageInfo,h.jumpToVillage=p.jumpToVillage,h.now=A,h.copyTimeModal=w,h.removeTroops=S,h.switchWindowSize=y,h.toggleFilter=k,h.toggleSorting=x,I()
;let e=new i('twoverflow_queue_window',(function(){E.timer.remove(R)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,L),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,L),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,L),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,L),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),E.timer.add(R)};return function(){v=e.addMenuButton('Strażnik',40),v.addEventListener('click',N),
...
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r){let c,d,u=!1,p=!1,g=[],m=[];const _='battle_calculator_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:_}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('all settings',d),l((function(){b()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,b),a.$on(s.ARMY_PRESET_DELETED,b),
a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d){let u,p,g,m=n.getPresetList(),_=n.getGroupList();const b={BATTLE:'battle',TROOPS:'troops'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')
},T=function(){t.isRunning()?t.stop():t.start()},h=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},v=function(){u.groups=l.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},A=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},w=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.BATTLE,u.settingsMap=o,p.injectScope(u),h(),v(),u.selectTab=f,u.saveSettings=E,u.switchState=T;let e=new r('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,h,!0),e.register(s.ARMY_PRESET_DELETED,h,!0),e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.BATTLE_CALCULATOR_START,A),
e.register(s.BATTLE_CALCULATOR_STOP,w),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Kalkulator',180),g.addEventListener('click',S),
...
}})),define('two/battleCalculator/settings',[],(function(){return{BATTLE_CHURCH_A:'battle_church_a',BATTLE_CHURCH_D:'battle_church_d',BATTLE_MORALE:'battle_morale',BATTLE_LUCK:'battle_luck',BATTLE_WALL:'battle_wall',BATTLE_NIGHT_BONUS:'battle_night_bonus',BATTLE_OFFICER_LEADER:'battle_officer_leader',BATTLE_OFFICER_MEDIC:'battle_officer_medic',BATTLE_SKILL_MEDIC:'battle_skill_medic',BATTLE_SKILL_WEAPON_MASTER:'battle_skill_weapon_master',BATTLE_SKILL_IRON_WALLS:'battle_skill_iron_walls',BATTLE_SKILL_CLINIQUE:'battle_skill_clinique',BATTLE_HOSPITAL:'battle_hospital',TROOPS_BARRACKS:'troops_barracks',TROOPS_PRECEPTORY:'troops_preceptory',TROOPS_ORDER:'troops_order',TROOPS_DOMINATION:'troops_domination',TROOPS_TRAINING:'troops_training',TROOPS_SPEAR:'troops_spear',TROOPS_SWORD:'troops_sword',TROOPS_AXE:'troops_axe',TROOPS_ARCHER:'troops_archer',TROOPS_LC:'troops_lc',TROOPS_MA:'troops_ma',TROOPS_HC:'troops_hc',TROOPS_RAM:'troops_ram',TROOPS_CATAPULT:'troops_catapult',
TROOPS_KNIGHT:'troops_knight',TROOPS_SNOB:'troops_snob',TROOPS_DOPPELSOLDNER:'troops_doppelsoldner',TROOPS_TREBUCHET:'troops_trebuchet',BASHPOINTS_SPEAR:'bashpoints_spear',BASHPOINTS_SWORD:'bashpoints_sword',BASHPOINTS_AXE:'bashpoints_axe',BASHPOINTS_ARCHER:'bashpoints_archer',BASHPOINTS_LC:'bashpoints_lc',BASHPOINTS_MA:'bashpoints_ma',BASHPOINTS_HC:'bashpoints_hc',BASHPOINTS_RAM:'bashpoints_ram',BASHPOINTS_CATAPULT:'bashpoints_catapult',BASHPOINTS_KNIGHT:'bashpoints_knight',BASHPOINTS_SNOB:'bashpoints_snob',BASHPOINTS_DOPPELSOLDNER:'bashpoints_doppelsoldner',BASHPOINTS_TREBUCHET:'bashpoints_trebuchet'}})),define('two/battleCalculator/settings/updates',(function(){return{BATTLE_CHURCH_A:'battle_church_a',BATTLE_CHURCH_D:'battle_church_d',BATTLE_MORALE:'battle_morale',BATTLE_LUCK:'battle_luck',BATTLE_WALL:'battle_wall',BATTLE_NIGHT_BONUS:'battle_night_bonus',BATTLE_OFFICER_LEADER:'battle_officer_leader',BATTLE_OFFICER_MEDIC:'battle_officer_medic',BATTLE_SKILL_MEDIC:'battle_skill_medic',
BATTLE_SKILL_WEAPON_MASTER:'battle_skill_weapon_master',BATTLE_SKILL_IRON_WALLS:'battle_skill_iron_walls',BATTLE_SKILL_CLINIQUE:'battle_skill_clinique',BATTLE_HOSPITAL:'battle_hospital',TROOPS_BARRACKS:'troops_barracks',TROOPS_PRECEPTORY:'troops_preceptory',TROOPS_ORDER:'troops_order',TROOPS_DOMINATION:'troops_domination',TROOPS_TRAINING:'troops_training',TROOPS_SPEAR:'troops_spear',TROOPS_SWORD:'troops_sword',TROOPS_AXE:'troops_axe',TROOPS_ARCHER:'troops_archer',TROOPS_LC:'troops_lc',TROOPS_MA:'troops_ma',TROOPS_HC:'troops_hc',TROOPS_RAM:'troops_ram',TROOPS_CATAPULT:'troops_catapult',TROOPS_KNIGHT:'troops_knight',TROOPS_SNOB:'troops_snob',TROOPS_DOPPELSOLDNER:'troops_doppelsoldner',TROOPS_TREBUCHET:'troops_trebuchet',BASHPOINTS_SPEAR:'bashpoints_spear',BASHPOINTS_SWORD:'bashpoints_sword',BASHPOINTS_AXE:'bashpoints_axe',BASHPOINTS_ARCHER:'bashpoints_archer',BASHPOINTS_LC:'bashpoints_lc',BASHPOINTS_MA:'bashpoints_ma',BASHPOINTS_HC:'bashpoints_hc',BASHPOINTS_RAM:'bashpoints_ram',
BASHPOINTS_CATAPULT:'bashpoints_catapult',BASHPOINTS_KNIGHT:'bashpoints_knight',BASHPOINTS_SNOB:'bashpoints_snob',BASHPOINTS_DOPPELSOLDNER:'bashpoints_doppelsoldner',BASHPOINTS_TREBUCHET:'bashpoints_trebuchet'}})),define('two/battleCalculator/settings/map',['two/battleCalculator/settings','two/battleCalculator/settings/updates'],(function(e,t){return{[e.BATTLE_CHURCH_A]:{default:[],updates:[t.BATTLE_CHURCH_A],disabledOption:!0,inputType:'select',multiSelect:!1,type:'church'},[e.BATTLE_CHURCH_D]:{default:[],updates:[t.BATTLE_CHURCH_D],disabledOption:!0,inputType:'select',multiSelect:!1,type:'church'},[e.BATTLE_WALL]:{default:[],updates:[t.BATTLE_WALL],disabledOption:!0,inputType:'select',multiSelect:!1,type:'wall'},[e.BATTLE_NIGHT_BONUS]:{default:!1,updates:[t.BATTLE_NIGHT_BONUS],inputType:'checkbox'},[e.BATTLE_OFFICER_LEADER]:{default:!1,updates:[t.BATTLE_OFFICER_LEADER],inputType:'checkbox'},[e.BATTLE_OFFICER_MEDIC]:{default:!1,updates:[t.BATTLE_OFFICER_MEDIC],inputType:'checkbox'},
[e.BATTLE_SKILL_MEDIC]:{default:!1,updates:[t.BATTLE_SKILL_MEDIC],inputType:'checkbox'},[e.BATTLE_SKILL_WEAPON_MASTER]:{default:[],updates:[t.BATTLE_SKILL_WEAPON_MASTER],disabledOption:!0,inputType:'select',multiSelect:!1,type:'weapon-master'},[e.BATTLE_SKILL_IRON_WALLS]:{default:[],updates:[t.BATTLE_SKILL_IRON_WALLS],disabledOption:!0,inputType:'select',multiSelect:!1,type:'iron-walls'},[e.BATTLE_SKILL_CLINIQUE]:{default:[],updates:[t.BATTLE_SKILL_CLINIQUE],disabledOption:!0,inputType:'select',multiSelect:!1,type:'clinique'},[e.BATTLE_HOSPITAL]:{default:[],updates:[t.BATTLE_HOSPITAL],disabledOption:!0,inputType:'select',multiSelect:!1,type:'hospital'},[e.TROOPS_BARRACKS]:{default:25,updates:[t.TROOPS_BARRACKS],inputType:'number',min:1,max:25},[e.TROOPS_PRECEPTORY]:{default:10,updates:[t.TROOPS_PRECEPTORY],inputType:'number',min:0,max:10},[e.TROOPS_ORDER]:{default:[],updates:[t.TROOPS_ORDER],disabledOption:!0,inputType:'select',multiSelect:!1,type:'orders'},[e.TROOPS_DOMINATION]:{
default:!1,updates:[t.TROOPS_DOMINATION],inputType:'checkbox'},[e.TROOPS_TRAINING]:{default:[],updates:[t.TROOPS_TRAINING],disabledOption:!0,inputType:'select',multiSelect:!1,type:'training'}}})),require(['two/ready','two/battleCalculator','two/battleCalculator/ui','two/battleCalculator/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,f,E){let T,h,v,A=injector.get('buildingService'),w=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const R={};let k,x,L,O,N,P=!0;const C='builder_queue_log',M='builder_queue_settings',z=function(){const e=G()
;if(!P)return j.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){S.canBeFinishedForFree(a,t)&&w.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(R);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return A.compute(e),B(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),
F(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=v[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<v[t])return!1;return!0},F=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),f.set(C,L),!0};let j={}
;return j.start=function(){if(!P)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,T=setInterval(z,6e4),h=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){I=!1,clearInterval(T),clearInterval(h),b.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return I},j.isInitialized=function(){return y},j.getSettings=function(){return O},j.getLogs=function(){return L},j.clearLogs=function(){L=[],f.set(C,L),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){
const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES];if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,L=f.get(C,[],!0),x=n.getSelectedCharacter(),k=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),I&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)R[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,v=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(R);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),
a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let i in e)f.call(e,i)&&(t[i]=a(e[i]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(s,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,T,h,v,A){let w,S,y,I,R=n.getGroupList(),k={},x=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case E.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};O.generateSequences=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=w.settings[_.ACTIVE_SEQUENCE].value,t=w.settings[_.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in T)i[T[e]]=0;O.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:A.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=w.settings[_.ACTIVE_SEQUENCE].value,a=w.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=k[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
O.updateVisibleBuildingSequence=function(){const e=w.pagination.buildingSequence.offset,t=w.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),w.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,k[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,k[a].push(n)}}},L.moveUp=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(D=!0)},L.moveDown=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
B(e,a,a+1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(D=!0)},L.addBuilding=function(e,t,a=1){const i=t-1;let n=L.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return L.buildingSequence=L.updateLevels(n,e),L.updateVisibleBuildingSequence(),D=!0,!0},L.removeBuilding=function(e){const t=L.buildingSequence[e].building;L.buildingSequence.splice(e,1),L.buildingSequence=L.updateLevels(L.buildingSequence,t),L.updateVisibleBuildingSequence(),D=!0},L.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},L.generateBuildingSequence=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(L.sequencesAvail=t,!t)return!1;const a=e[L.selectedSequence.value];let i={};for(let e in T)i[T[e]]=0;L.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
L.updateVisibleBuildingSequence()},L.updateVisibleBuildingSequence=function(){const e=w.pagination.buildingSequenceEditor.offset,t=w.pagination.buildingSequenceEditor.limit;L.visibleBuildingSequence=L.buildingSequence.slice(e,e+t),w.pagination.buildingSequenceEditor.count=L.buildingSequence.length},L.updateBuildingSequence=function(){const e=L.selectedSequence.value,t=L.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:D=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},L.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(L.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},L.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=L.lastAddedIndex,e.indexLimit=L.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(L.lastAddedBuilding,a.loc.ale,'building_names'),value:L.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),l=y[t].max_level;L.lastAddedBuilding=t,L.lastAddedIndex=i,L.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},L.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=L.selectedSequence.name,i=w.settings[_.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},N.updateVisibleLogs=function(){const e=w.pagination.logs.offset,t=w.pagination.logs.limit;N.visibleLogs=N.logs.slice(e,e+t),
w.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[T.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,t)&&(w.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},w.settings[_.BUILDING_SEQUENCES][e.name]=t,F(),O.selectedSequence={name:e.name,value:e.name},L.selectedSequence={name:e.name,value:e.name},O.generateSequences(),L.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){w.selectedTab=e},F=function(){I.setAll(I.decode(w.settings)),D=!1},j=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){D?Y((function(){C()})):C()},K={updateGroups:function(){w.groups=p.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(_.BUILDING_SEQUENCES);w.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){L.generateBuildingSequence()},
updateLogs:function(){w.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=I.get(_.BUILDING_SEQUENCES);w.settings[_.BUILDING_SEQUENCES][t]=i[t],w.settings[_.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=I.get(_.BUILDING_SEQUENCES);w.settings[_.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete w.settings[_.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(w.settings[_.BUILDING_SEQUENCES]);L.selectedSequence={name:i,value:i},K.updateSequences(),L.generateBuildingSequence(),I.get(_.ACTIVE_SEQUENCE)===t&&(I.set(_.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){w.running=!0},stopped:function(){w.running=!1}},Q=function(){const e=I.get(_.ACTIVE_SEQUENCE);w=a.$new(),w.selectedTab=P.SETTINGS,w.TAB_TYPES=P,w.SETTINGS=_,w.running=x,w.pagination={},w.settingsMap=I.settingsMap,w.villagesLabel=z,w.villagesInfo=M,w.editorView=L,w.editorView.buildingSequence={},w.editorView.visibleBuildingSequence=[],w.editorView.selectedSequence={name:e,value:e},w.editorView.lastAddedBuilding=T.HEADQUARTER,w.editorView.lastAddedIndex=1,w.settingsView=O,w.settingsView.buildingSequence={},w.settingsView.buildingSequenceFinal={},w.logsView=N,w.logsView.logs=i.getLogs(),w.selectTab=W,w.switchBuilder=j,w.saveSettings=F,w.createSequence=q,w.openVillageInfo=r.openVillageInfo,I.injectScope(w),K.updateGroups(),K.updateSequences(),w.pagination.buildingSequence={
count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},w.pagination.buildingSequenceEditor={count:L.buildingSequence.length,offset:0,loader:L.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},w.pagination.logs={count:N.logs.length,offset:0,loader:N.updateVisibleLogs,limit:m.getPaginationLimit()},N.updateVisibleLogs(),O.generateSequences(),L.generateBuildingSequence();let t=new h('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(s.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',w),C=w.closeWindow,w.closeWindow=H,w.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),w.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?Y((function(){K.generateBuildingSequencesEditor(),D=!1}),(function(){w.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
O.generateBuildingsLevelPoints(),I=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),v.register(s.BUILDER_QUEUE_START,(function(){x=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),v.register(s.BUILDER_QUEUE_STOP,(function(){x=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const v=Object.values(c),A=Object.values(a),w=Object.values(h),S=Object.values(T),y=Object.values(E);let I,R=[],k={},x=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+I},C=function(e){R.push(e)},M=function(e){k[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,x=b.get(d.QUEUE_SENT,[],!0),L=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(C(e),M(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!P(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),b.set(d.QUEUE_SENT,x),U.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){L.push(e)}(e),b.set(d.QUEUE_EXPIRED,L),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(f,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(i))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!w.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(b[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[T.SUPPORTER]&&delete b[T.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[h.CATAPULT])&&(p||E.HEADQUARTER),A.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return I(u.INVALID_ORIGIN);if(!i)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(P(c))return I(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};C(E),M(E),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete k[e.id];const a=R.some((function(t,a){if(t.id==e.id)return R.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),L=[],x=[]},U.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return O},U.getWaitingCommands=function(){return R},U.getWaitingCommandsObject=function(){return k},U.getSentCommands=function(){return x},
U.getExpiredCommands=function(){return L},U.filterCommands=function(e,t,a){const i=N[e];return(a||R).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,f,E,T,h){let v,A,w,S,y,I=n.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),x=n.getPresetList(),L=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let P,C,M,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){L=t.data},q=function(){L=!1},W=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),l=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},F=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},j=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);v.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),v.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&v.isValidDate?E.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=v.selectedDateType.value,h.set(m.LAST_DATE_TYPE,v.selectedDateType.value),j()},K=function(){
y.catapultTarget=v.catapultTarget.value},Q=function(){const e=v.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,v.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},v.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=E.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),E.timer.add(e.updateCountdown)},X=function(){v.waitingCommands=t.getWaitingCommands()},J=function(){v.sentCommands=t.getSentCommands()},$=function(){v.expiredCommands=t.getExpiredCommands()},ee=function(){let e=v.waitingCommands;B.forEach((function(a){v.activeFilters[a]&&(e=t.filterCommands(a,v.filtersData,e))})),
v.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){v.showCatapultSelect=!!y.units.catapult},ne=function(e){v.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:w.getId()}},le=function(){if(!L)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));f.loadTownDataAsync(L.x,L.y,1,1,(function(e){y.target=e}))},se=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=F(y.date,100)},ce=function(){if(!y.date)return!1;y.date=F(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},_e=function(e,t){v.activeFilters[e]=!v.activeFilters[e],
t&&(v.filtersData[u.ALLOWED_TYPES][e]=!v.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){v.activeFilters[u.TEXT_MATCH]=v.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){v.presets=o.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},v.searchQuery[i]=''},removeCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(v.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){v.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{E.timer.remove(e.updateCountdown)})}},Ee=function(){const e=h.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;v=a.$new(),v.selectedTab=N,v.inventory=n.getInventory(),v.presets=o.obj2selectOptions(x.getPresets()),v.travelTimes={},o.each(p,(function(e){v.travelTimes[e]={},o.each(U,(function(t,a){v.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),v.unitOrder=S,v.officers=I.getOrderedOfficerNames(),v.searchQuery={origin:'',target:''},v.isValidDate=!1,v.dateTypes=T.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),v.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},v.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},v.showCatapultSelect=!!y.units.catapult,v.attackableBuildings=z,v.commandData=y,
v.activeFilters=C,v.filtersData=M,v.running=t.isRunning(),v.waitingCommands=t.getWaitingCommands(),v.visibleWaitingCommands=t.getWaitingCommands(),v.sentCommands=t.getSentCommands(),v.expiredCommands=t.getExpiredCommands(),v.EVENT_CODES=d,v.FILTER_TYPES=u,v.TAB_TYPES=O,v.COMMAND_TYPES=p,v.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),v.onUnitInputFocus=te,v.onUnitInputBlur=ae,v.catapultTargetVisibility=ie,v.selectTab=ne,v.addSelected=oe,v.addMapSelected=le,v.addCurrentDate=se,v.incrementDate=re,v.reduceDate=ce,v.cleanUnitInputs=de,v.addCommand=ue,v.clearRegisters=pe,v.switchCommandQueue=ge,v.removeCommand=t.removeCommand,v.openVillageInfo=r.openVillageInfo,v.toggleFilter=_e,v.$watch('commandData.origin',j),v.$watch('commandData.target',j),v.$watch('commandData.date',j),v.$watch('commandData.officers',j),v.$watch('selectedDateType.value',H),v.$watch('selectedInsertPreset.value',Q),v.$watch('catapultTarget.value',K),v.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',be),
v.$watch('selectedTab',(function(){v.selectedTab===O.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),v.waitingCommands.forEach(e=>{Z(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),b.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),b.register(s.COMMAND_QUEUE_START,fe.start),b.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){w=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},A=e.addMenuButton('Generał',20),A.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){A.classList.remove('btn-orange'),A.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){A.classList.remove('btn-red'),A.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,_,b,f=!1,E=!1,T=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){f=!0}};return h.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,h=c.clay,v=c.iron,A=f.currentStock,w=E.currentStock,S=h.currentStock,y=v.currentStock,I=[0,5e3],R=[160,16e3],k=[200,2e4],x=[50,5e3];1==s&&(T=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=T?'chapel'==i&&'church'==i||1!=T||(w>=R[1]&&S>=k[1]&&y>=x[1]&&A>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):w>=R[0]&&S>=k[0]&&y>=x[0]&&A>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==T?w>=R[1]&&S>=k[1]&&y>=x[1]&&A>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):w>=R[0]&&S>=k[0]&&y>=x[0]&&A>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},h.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),E=!1},h.isRunning=function(){return E},h.isInitialized=function(){return f},h})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,_,E,T,h,v,A,w,S,y,I){let R,k,x,L,O,N=!1,P=!1,C=[],M=[],z=[],D=[],G=[],U=[],B=!1,V=!1,q=!1,W=0,F=null,j=null,Y=null,H={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(k[r.MIN_DISTANCE],k[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===L.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(k[r.MIN_POINTS],k[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=k[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=k[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!L.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){f.call(x,e)||(x[e]={time:h.gameTime(),report:!1},t=!0)})),_.each(x,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete x[i],t=!0)})),t&&(I.set($,x),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),v.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=L.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(Re(t.village_id),l=!0):(Le(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=L.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}else Oe(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Re(t.village_id),l=!0),l&&v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=k[r.GROUP_IGNORE],i=k[r.GROUP_ONLY],o=k[r.GROUP_INCLUDE],l=f.call(t,a)?a:R.getDefault(r.GROUP_IGNORE),s=i.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));R.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Ie(),Oe(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();k[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){k[r.IGNORE_ON_LOSS]&&k[r.GROUP_IGNORE]&&P&&t.type===A.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){B&&q&&t.origin.id===B.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===A.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&q&&t.cause===l.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},_e=function(e){x[e]={time:h.gameTime(),report:H[e]||!1},delete H[e],I.set($,x),v.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,M.unshift(t),fe(),!0)},fe=function(){const e=k[r.LOGS_LIMIT];M.length>e&&M.splice(M.length-e,M.length),I.set(X,M),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const i=k[r.TARGET_MULTIPLE_FARMERS],n=k[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},Te=function(){K=h.gameTime()},he=function(){clearTimeout(F),clearTimeout(j),clearTimeout(Y),F=null,j=null,Y=null
},ve=function(){return Math.max(1,60*k[r.FARMER_CYCLE_INTERVAL]*1e3)},Ae=function(){return Math.max(0,1e3*k[r.ATTACK_INTERVAL])},we=function(e){if(this.villageId=e,this.village=L.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};we.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{v.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},we.prototype.start=function(){return Te(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,v.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(v.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},we.prototype.stop=function(e){this.running=!1,v.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=b},we.prototype.targetStep=async function(e={}){if(!this.running)return!1;Te();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return a(i.USER_STOP);t()},_.randomSeconds(Ae())):t()}),E=()=>new Promise((e,a)=>{const n=50-k[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(k[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),R=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),x=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(U.forEach((function(e){f.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)f.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),O=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=T.actualDistance(l,a);_.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,p=L.getVillageList();const o=p.every(e=>e.isInitialized(w.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),Ee(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[r.TARGET_SINGLE_ATTACK]&&!k[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=k[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=T.actualDistance(s,a),_=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,_,m,A.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===A.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(Ee(l,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{b().then(E).then(S).then(I).then(R).then(x).then(O).then(N).then(P).then(C).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,D]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),V=!0,q=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:A.TYPES.ATTACK})}).catch(t=>{switch(he(),v.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Le(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},we.prototype.setStatus=function(e){this.status=e},
we.prototype.getStatus=function(){return this.status||i.UNKNOWN},we.prototype.commandSent=function(e){V=!1,q=!1,he(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},we.prototype.commandError=function(){V=!1,q=!1,this.stop(i.COMMAND_ERROR)},we.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},we.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=T.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},we.prototype.getTargets=function(){return this.targets},we.prototype.getIndex=function(){return this.index},we.prototype.getVillage=function(){return this.village},
we.prototype.isRunning=function(){return this.running},we.prototype.isInitialized=function(){return this.initialized},we.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},we.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new we(e),C.push(a)),a},ye=function(){_.each(L.getVillages(),(function(e,t){Se(t)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=k[r.GROUP_ONLY];let t=[];C.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Re(e)})),v.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let a=0;a<C.length;a++)if(C[a].getId()===e)return C[a].stop(t.KILL_FARMER),C.splice(a,a+1),!0;return!1
},ke=function(e){Te(),C.length?W>=C.length?(W=0,B=!1,Z=h.gameTime()+ve(),v.trigger(s.FARM_OVERFLOW_CYCLE_END)):B=C[W]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):F=setTimeout((function(){F=null,W=0,Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),ve())},xe=function(e){for(let t=0;t<C.length;t++){let a=C[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Le=function(e){C.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){C.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=I.get(X,[]),x=I.get($,{}),L=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,a){k=R.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(Ie(),ye()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&P&&(j?(he(),
B.targetStep({delay:!0})):F&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),se("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){C.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!P&&(U.length?(P=!0,e=[],C.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),Te(),function(){let e=ve(),t=e+e/2+Ae();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){B?(B.stop(e),
e!==i.USER_STOP&&(Z=h.gameTime()+ve()),v.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,P=!1,he(),v.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Ne.getFarmer=function(e){return C.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return C},Ne.getSettings=function(){return R},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return x},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return P},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],I.set(X,M),v.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=ve,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,T,h,v){let A,w,S,y=n.getPresetList(),I=n.getGroupList(),R={},k={},x=null;const L={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=A.pagination.offset,t=A.pagination.limit;A.visibleLogs=A.logs.slice(e,e+t),A.pagination.count=A.logs.length,A.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
A.exceptionVillages.included.forEach((function(e){N(e)})),A.exceptionVillages.ignored.forEach((function(e){N(e)}))},C=function(){t.isRunning()?t.stop():t.start()},M=function(e){A.selectedTab=e},z=function(){w.setAll(w.decode(A.settings)),A.saveButtonColor='orange',T.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=w.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){w.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){A.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){A.groups=f.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),A.groupsWithDisabled=f.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},V=function(){A.running=!0,
T.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(A.running=!1,A.showCycleTimer=!1,clearInterval(x),t.reason){case d.NO_PRESETS:T.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){A.logs=angular.copy(t.getLogs()),O(),A.logs.length||T.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){A.farmers=t.getFarmers()},j=function(){A.exceptionVillages=t.getExceptionVillages(),P()},Y=function(){A.exceptionLogs=t.getExceptionLogs()},H=function(){A.showCycleTimer=!1,clearInterval(x)},K=function(e,a){a!==i.USER_STOP&&(A.showCycleTimer=!0,A.nextCycleCountdown=t.getCycleInterval(),x=setInterval((function(){A.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;A=a.$new(),A.SETTINGS=b,A.TAB_TYPES=L,A.LOG_TYPES=u,A.running=t.isRunning(),A.selectedTab=L.SETTINGS,A.farmers=t.getFarmers(),
A.villagesLabel=k,A.villagesInfo=R,A.exceptionVillages=t.getExceptionVillages(),A.exceptionLogs=t.getExceptionLogs(),A.logs=t.getLogs(),A.visibleLogs=[],A.showCycleTimer=!1,A.nextCycleCountdown=0,A.saveButtonColor='orange',A.settingsMap=w.settingsMap,A.pagination={count:A.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},w.injectScope(A),U(),B(),O(),P(),function(){let e=t.getNextCycleDate();e&&(A.showCycleTimer=!0,A.nextCycleCountdown=e-v.gameTime(),x=setInterval((function(){A.nextCycleCountdown-=1e3}),1e3))}(),A.switchFarm=C,A.selectTab=M,A.saveSettings=z,A.clearLogs=t.clearLogs,A.jumpToVillage=p.jumpToVillage,A.openVillageInfo=r.openVillageInfo,A.showReport=_.showReport,A.removeIgnored=D,A.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(x)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,B,!0),i.register(s.GROUPS_CREATED,B,!0),i.register(s.GROUPS_DESTROYED,B,!0),
i.register(s.FARM_OVERFLOW_START,V),i.register(s.FARM_OVERFLOW_STOP,q),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,F),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',A),A.$watch('settings',(function(){e||(A.saveButtonColor='red'),e=!1}),!0)};return function(){w=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){Q()})),h.register(s.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),h.register(s.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,E,T,h,v,A,w){let S,y,I,R,k,x,L,O,N,P,C,M,z,D,G,U,B,V,q,W,F,j,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,a=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(a/y)%2&&(t+=R),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},be=function(e,t){return{x:e/A.TILESIZE.x,y:t/A.TILESIZE.y/A.TILESIZE.off}},fe=function(){we(k)},Ee=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){P.drawImage(C,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,I),D.fillRect(0,i,I,1);const n=U.getBoundingClientRect(),l=n.width/A.TILESIZE.x/w.view.z*y,s=n.height/A.TILESIZE.y/w.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)
},Te=function(){if(!ie)return!1;const e=Q.village[L][O];ve(e?Q.character[e]:[[L,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:L,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}we(t,Y[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}we(t)},Ae=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===x.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(F&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(F.isAlly(e.tribe_id))return W.ally;if(F.isEnemy(e.tribe_id))return W.enemy;if(F.isNAP(e.tribe_id))return W.friendly}}return W.ugly},we=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Ae(i);if(!n)continue;const o=i.x*y+(i.y%2?R:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,C.width=1e3*y,C.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,i=O,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(L===e.x&&O===e.y)return!1;Te()}ie=!0,L=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:L,y:O,event:t});const a=Q.village[L][O];he(a?Q.character[a]:[[L,O]])}(pe,e)}Te()},xe=function(){ie&&Te(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},fe()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),we([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return j},Ce.drawMinimap=function(){ge&&(ge=!1),N.style.background=Y[o.COLOR_BACKGROUND],M.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=T.getPath(A.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*y+R-1,t*y+R-1,3,1),M.fillRect(e*y+R,t*y+R-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*y+R,t*y+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=E.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),M=C.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),Se(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),Y=j.getAll(),K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Se()},Ce.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),F=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),W=B.getVillagesColors(),re.alpha=0,w.graph.layers.effects.push(re),ye(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*y,ee.y=x.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Ie),z.addEventListener('mouseup',Re),z.addEventListener('mousemove',ke),z.addEventListener('mouseleave',xe),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){k=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(k),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),Ee(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,f,E,T,h,v){let A,w,S,y,I,R,k,x,L,O,N,P={},C=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){A.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(A.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(A.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!L)return;let a=B(t.x,t.y);var i,n;O=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=T.getTownAt(i,n);if(t)return e(t);T.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!C)return;k.appendChild(L),L.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const a=L.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=R.tt.position.y+o>i.top+i.height,s=R.tt.position.x+n>i.width;l&&(R.tt.position.y-=50),L.classList.toggle('left',s),L.classList.toggle('top',l)}))},q=function(e,t){if(!L)return;let a=t?B(t):O;P[a]=!1,C=!1,R.tt.visible=!1,L.classList.add('ng-hide'),x.appendChild(L)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=v.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){A.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){A.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=A.addHighlightColor,s.submit=function(){A.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=A.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},F=function(){n.addHighlight(A.selectedHighlight,A.addHighlightColor)},j=function(){N.setAll(N.decode(A.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(A.highlights.character).length+Object.keys(A.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){A.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){A=a.$new(),A.SETTINGS=p,A.TAB_TYPES=z,A.selectedTab=D,A.selectedHighlight=!1,A.addHighlightColor='#000000',A.highlights=n.getHighlights(),A.highlightNames=M,A.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),A.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),A.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},A.selectTab=G,A.openColorPalette=W,A.addCustomHighlight=F,A.removeHighlight=n.removeHighlight,A.saveSettings=j,A.resetSettings=Y,A.highlightsCount=H,A.openProfile=K,N.injectScope(A,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',A),U(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),R=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),L=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),x=document.querySelector('#map'),w=t.addMenuButton('Minimapa',180),w.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',_='060502',b='060501',f='060503',E='05020a',T='05030a',h='04080a',v='040a0a',A='070e04',w='070e05',S='070e0f',y='070e06',I='070e02',R='070e01',k='070e03',x='070e07',L='070e0b',O='070e0e',N='030d07',P='030d0b',C='030d0e';var M={init:function(){i=!0}};return M.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,_='string'==typeof _?parseInt(_,16):_,b='string'==typeof b?parseInt(b,16):b,f='string'==typeof f?parseInt(f,16):f,E='string'==typeof E?parseInt(E,16):E,T='string'==typeof T?parseInt(T,16):T,h='string'==typeof h?parseInt(h,16):h,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,w='string'==typeof w?parseInt(w,16):w,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,x='string'==typeof x?parseInt(x,16):x,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,P='string'==typeof P?parseInt(P,16):P,C='string'==typeof C?parseInt(C,16):C,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
...
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},_=function(e){var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,_=g(m),b=e.ReportScouting,f=b.attCharacterId,E=b.attCharacterName,T=b.attScouts,h=b.attLosses,v=b.attVillageId,A=b.attVillageName,w=b.defCharacterId,S=b.defCharacterName,y=b.defLosses,I=b.defScouts,R=b.defVillageId,k=b.defVillageName,x=b.commandType,L='',O='',N='',P='',C=Date.now(),M=p.split('.').join('_');2==u?L=' [color=d96a19]Częściowy sukces[/color]':1==u?L=' [color=0a8028]Sukces[/color]':3==u&&(L=' [color=e21f1f]Porażka[/color]'),O='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',n=null==I?'nieznana':I,s=null==T?'nieznana':T,r=null==y?'nieznana':y,c=null==h?'nieznana':h,P=null==E&&null==f?'Brak danych':'[player='+f+']'+E+'[/player]',N=null==A&&null==v?'Brak danych':'[village='+v+']'+A+'[/village]',
t=Math.floor(C/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+_+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+R+']'+k+'[/village][b] Gracz cel: [/b][player='+w+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();w!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var T=[],h=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),T.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,T.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,T.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,T.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,T.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,T.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,T.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,T.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,T.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,T.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,T.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,T.push(' Zjednoczenie '+g+'%'))}));var v=T.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var A=h.join(),w=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),R=d.defCharacterId,k=d.defCharacterName,x=d.defVillageId,L=d.defVillageName,O=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),C=d.night,M=d.loyaltyAfter,z=d.loyaltyBefore,D=d.wallAfter,G=d.wallBefore,U=d.officers,B=d.leader,V='',q='',W='',F='',j='',Y='',H='',K='',Q='',Z=Date.now(),X=s.split('.').join('_')
;null!=z&&(Y='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=M&&(H='Lojalność po ataku: '+Math.floor(M)+' '),null!=G&&(K='Mury przed ataku: '+G+' '),null!=D&&(Q='Mury po ataku: '+D+' '),null==U&&1==B?j='Brak':null==U&&1.1==B&&(j=' Wielki Mistrz '),F=0==C?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+L+'[/village][b] Gracz cel: [/b][player='+R+']'+k+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+w+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br]Oficerowie: [b]'+j+'[/b][br]'+Y+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},f=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var T=[],h=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),T.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,T.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,T.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,T.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,T.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,T.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,T.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,T.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,T.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,T.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,T.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,T.push(' Zjednoczenie '+g+'%'))}));var v=T.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
h.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var A,w=h.join(),S=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),I=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,x=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),M=d.night,z=d.loyaltyAfter,D=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,B=d.officers,V='',q='',W='',F='',j='',Y='',H='',K='',Q=[],Z=Date.now(),X=s.split('.').join('_')
;if(null!=D&&(j='Lojalność przed atakiem: '+Math.floor(D)+' '),null!=z&&(Y='Lojalność po ataku: '+Math.floor(z)+' '),null!=U&&(H='Mury przed ataku: '+U+' '),null!=G&&(K='Mury po ataku: '+G+' '),null==B)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(F=0==M?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),A=Q.join(),null!=x){
a.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+k+']'+x+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+I+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br]Oficerowie: [b]'+A+'[/b][br]'+j+Y+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},E={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
