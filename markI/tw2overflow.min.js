 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),p=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),E=function(){},b=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,i){let r;var c=injector.get('overviewService'),d=!1,u=!1,g=n.getSelectedCharacter().getGlobalInfo(),p={reverse:!1,column:'command_progress'},m=n.getSelectedCharacter(),_=m.tribeById[0],E=m.getVillageList(),b=[],f=m.data.character_id,h=m.data.character_name,w=[],T=[],v=[i.LIGHT_CAVALRY,i.HEAVY_CAVALRY,i.AXE,i.SWORD,i.RAM,i.SNOB,i.TREBUCHET];var A=function(){
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:_},(function(e){for(var t=e.members,a=0;a<t.length;a++)T.push(t[a].id)})),E.forEach((function(e){b.push(e.getId())}));var e=g.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:p.column,reverse:p.reverse?1:0,groups:[],command_types:['attack'],villages:b},S),setTimeout(A,6e4)},S=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),T.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(w.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{w.push(i[n].command_id),i[n].slowestUnit=y(i[n]);var s=i[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',g='';'sword'==i[n].slowestUnit?(g=' [color=03709d]MIECZNIK[/color]',
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,g,p,m,_,E,b){let f,h,w=!1,T=injector.get('overviewService'),v=[],A=!1,S={},y={},I={reverse:!1,column:i.TIME_COMPLETED};const k='attack_view_filters',R={},L={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},N=function(){V.loadCommands()},x=function(e,t){b.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){
for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);b.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);b.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},P=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(E.hasTownDataInChunk(e.x,e.y)){
const a=E.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=_.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},U=function(e){v=e.commands;for(let e=0;e<v.length;e++)T.formatCommand(v[e]),v[e].slowestUnit=z(v[e]);v=v.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),b.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[v])};let V={loadCommands:function(){const e=f.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return v},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),p.set(k,S),V.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),V.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,h.OUT,s,{},l,g.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return w},init:function(){for(let e=0;e<d.length;e++)R[d[e]]=!0;for(let e in r)L[r[e]]=!0;try{A=require('two/commandQueue'),h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),
[c.INCOMING_UNITS]:angular.copy(R),[c.VILLAGE]:!1};w=!0,f=n.getSelectedCharacter().getGlobalInfo(),S=p.get(k,t,!0),e((function(){O(),a.$on(s.COMMAND_INCOMING,N),a.$on(s.COMMAND_CANCELLED,x),a.$on(s.MAP_SELECTED_VILLAGE,P),a.$on(s.VILLAGE_NAME_CHANGED,M),a.$on(s.COMMAND_IGNORED,C),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,_,E,b,f,h){let w,T;const v=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=p('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=p('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=p('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,i)},y=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},I=function(){const e=w.pagination.offset,t=w.pagination.limit;w.visibleCommands=w.commands.slice(e,e+t),
w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);I()},R=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},L=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},O=function(){w.commands=t.getCommands()},N=function(){w.selectedVillageId=n.getSelectedVillage().getId()},x=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=E,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=_,w.COLUMN_TYPES=l,w.pagination={count:w.commands.length,offset:0,loader:I,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=g.jumpToVillage,w.now=v,w.copyTimeModal=A,w.removeTroops=S,w.switchWindowSize=y,w.toggleFilter=R,w.toggleSorting=L,I()
;let e=new i('twoverflow_queue_window',(function(){f.timer.remove(k)}));e.register(s.MAP_SELECTED_VILLAGE,N,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),f.timer.add(k)};return function(){T=e.addMenuButton('Strażnik',40),T.addEventListener('click',x),
...
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r){let c,d,u=!1,g=!1,p=[],m=[];const _='battle_calculator_settings',E=function(){p=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){p.push(e[t])})),console.log('selectedPresets',p)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:_}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('all settings',d),l((function(){E()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,E),a.$on(s.ARMY_PRESET_DELETED,E),
a.$on(s.GROUPS_CREATED,b),a.$on(s.GROUPS_DESTROYED,b),a.$on(s.GROUPS_UPDATED,b)},start:function(){g=!0,console.log('selectedPresets',p),console.log('selectedGroups',m),r.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){g=!1,console.log('example module stop'),r.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return g}};return f})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d){let u,g,p,m=n.getPresetList(),_=n.getGroupList();const E={BATTLE:'battle',TROOPS:'troops'},b=function(e){u.selectedTab=e},f=function(){g.setAll(g.decode(u.settings)),d.notif('success','Settings saved')
},h=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},T=function(){u.groups=l.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,p.classList.remove('btn-orange'),p.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,p.classList.remove('btn-red'),p.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.BATTLE,u.settingsMap=o,g.injectScope(u),w(),T(),u.selectTab=b,u.saveSettings=f,u.switchState=h;let e=new r('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,w,!0),e.register(s.ARMY_PRESET_DELETED,w,!0),e.register(s.GROUPS_CREATED,T,!0),e.register(s.GROUPS_DESTROYED,T,!0),e.register(s.GROUPS_UPDATED,T,!0),e.register(s.BATTLE_CALCULATOR_START,v),
...
}})),define('two/battleCalculator/settings',[],(function(){return{PRESETS:'presets',GROUPS:'groups',SOME_NUMBER:'some_number'}})),define('two/battleCalculator/settings/updates',(function(){return{PRESETS:'presets',GROUPS:'groups'}})),define('two/battleCalculator/settings/map',['two/battleCalculator/settings','two/battleCalculator/settings/updates'],(function(e,t){return{[e.PRESETS]:{default:[],updates:[t.PRESETS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'presets'},[e.GROUPS]:{default:[],updates:[t.GROUPS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'groups'},[e.SOME_NUMBER]:{default:60,inputType:'number',min:0,max:120}}})),require(['two/ready','two/battleCalculator','two/battleCalculator/ui','two/battleCalculator/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,g,p,m,_,E,b,f){let h,w,T,v=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const k={};let R,L,O,N,x,C=!0;const M='builder_queue_log',P='builder_queue_settings',z=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=x[r.GROUP_VILLAGES];let a=[];return e?(a=R.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(k);const n=x[r.BUILDING_SEQUENCES][x[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),F(t))return!1;n.some((function(a){if(++i[a]>t[a])return v.compute(e),V(e,a,(function(t,a){t&&a.job&&(E.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),W(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=B(e,t);if(i===p.POSSIBLE)q(e,t,(function(e){a(!0,e)}));else if(i===p.NOT_ENOUGH_FOOD&&x[r.PRIORIZE_FARM]){const t=T[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&q(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},q=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},B=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===p.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-x[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-x[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-x[r.PRESERVE_WOOD]<t.wood)return p.NOT_ENOUGH_RESOURCES}return a.upgradeability},F=function(e){for(let t in e)if(e[t]<T[t])return!1;return!0},W=function(e,t){let a={time:f.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),b.set(M,O),!0};let j={};return j.start=function(){if(!C)return E.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,h=setInterval(z,6e4),w=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),E.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){I=!1,clearInterval(h),
clearInterval(w),E.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return I},j.isInitialized=function(){return y},j.getSettings=function(){return N},j.getLogs=function(){return O},j.clearLogs=function(){O=[],b.set(M,O),E.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=x[r.BUILDING_SEQUENCES];return e in a?g.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=x[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=x[r.BUILDING_SEQUENCES]
;if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,O=b.get(M,[],!0),L=n.getSelectedCharacter(),R=n.getGroupList(),N=new i({settingsMap:c,storageKey:P}),N.onChange((function(e,t,a){x=N.getAll(),I&&t[d.ANALYSE]&&z(),a.quiet||E.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),x=N.getAll();for(let e in m)k[m[e]]=0;C=Object.keys(x[r.BUILDING_SEQUENCES]).length,T=!!C&&function(e){const t=x[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(x[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,g,_,E,f,h,w,T,v){let A,S,y,I,k=n.getGroupList(),R={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},x={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,P={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},q=function(e,t){switch(i.addBuildingSequence(e,t)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
return d.notif('error',p('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case f.SEQUENCE_INVALID:return d.notif('error',p('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=A.settings[_.ACTIVE_SEQUENCE].value,t=A.settings[_.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in h)i[h[e]]=0;N.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:R[e][t-1],state:l}}))},N.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,a=A.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=R[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});N.buildingSequenceFinal=n},
N.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,R[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,R[a].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.addBuilding=function(e,t,a=1){const i=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),D=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),D=!0},O.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},O.generateBuildingSequence=function(){const e=I.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const a=e[O.selectedSequence.value];let i={};for(let e in h)i[h[e]]=0;O.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
O.updateVisibleBuildingSequence()},O.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=O.buildingSequence.length},O.updateBuildingSequence=function(){const e=O.selectedSequence.value,t=O.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case f.SEQUENCE_SAVED:D=!1;break;case f.SEQUENCE_NO_EXISTS:d.notif('error',p('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case f.SEQUENCE_INVALID:d.notif('error',p('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},O.modal.removeSequence=function(){let e=a.$new();e.title=p('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=p('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=p('i18n')('remove',a.loc.ale,'common'),
e.cancelText=p('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(O.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},O.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=O.lastAddedIndex,e.indexLimit=O.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:p('i18n')(O.lastAddedBuilding,a.loc.ale,'building_names'),value:O.lastAddedBuilding};for(let t in y)e.buildings.push({name:p('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=p('i18n')(t,a.loc.ale,'building_names'),l=y[t].max_level;O.lastAddedBuilding=t,O.lastAddedIndex=i,O.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',p('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',p('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=O.selectedSequence.name,i=A.settings[_.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;q(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=a.$new();t.title=p('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=p('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=p('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=p('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},x.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;x.visibleLogs=x.logs.slice(e,e+t),
A.pagination.logs.count=x.logs.length,x.visibleLogs.forEach((function(e){e.villageId&&function(e){if(P[e])return P[e];P[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){P[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},x.clearLogs=function(){i.clearLogs()};const B=function(){let e=a.$new();const t=[h.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;q(e.name,t)&&(A.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[_.BUILDING_SEQUENCES][e.name]=t,W(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),F(C.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},F=function(e){A.selectedTab=e},W=function(){I.setAll(I.decode(A.settings)),D=!1},j=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=p('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=p('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=p('i18n')('discard',a.loc.ale,'common'),i.cancelText=p('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},Q=function(){D?Y((function(){M()})):M()},H={updateGroups:function(){A.groups=g.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(_.BUILDING_SEQUENCES);A.sequences=g.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){A.logs=i.getLogs(),x.updateVisibleLogs()},clearLogs:function(){d.notif('success',p('i18n')('logs_cleared',a.loc.ale,'builder_queue')),H.updateLogs()},buildingSequenceUpdate:function(e,t){const i=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=i[t],A.settings[_.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',p('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=I.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=i[t],H.updateSequences(),d.notif('success',p('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[_.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(b.call(e,t))return t;return!1}(A.settings[_.BUILDING_SEQUENCES]);O.selectedSequence={name:i,value:i},H.updateSequences(),O.generateBuildingSequence(),I.get(_.ACTIVE_SEQUENCE)===t&&(I.set(_.ACTIVE_SEQUENCE,i,{quiet:!0}),N.generateSequences()),
d.notif('success',p('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',p('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},K=function(){const e=I.get(_.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=C.SETTINGS,A.TAB_TYPES=C,A.SETTINGS=_,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=z,A.villagesInfo=P,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=h.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=N,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=x,A.logsView.logs=i.getLogs(),A.selectTab=F,A.switchBuilder=j,A.saveSettings=W,A.createSequence=B,A.openVillageInfo=r.openVillageInfo,I.injectScope(A),H.updateGroups(),H.updateSequences(),A.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.logs={count:x.logs.length,offset:0,loader:x.updateVisibleLogs,limit:m.getPaginationLimit()},x.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,H.updateGroups,!0),t.register(s.GROUPS_CREATED,H.updateGroups,!0),t.register(s.GROUPS_DESTROYED,H.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,H.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,H.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,H.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,H.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,H.generateBuildingSequences,!0),
t.register(s.BUILDER_QUEUE_JOB_STARTED,H.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,H.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,H.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,H.buildingSequenceAdd),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,H.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,H.saveSettings),t.register(s.BUILDER_QUEUE_START,H.started),t.register(s.BUILDER_QUEUE_STOP,H.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',A),M=A.closeWindow,A.closeWindow=Q,A.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&H.generateBuildingSequences()})),A.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?Y((function(){H.generateBuildingSequencesEditor(),D=!1}),(function(){A.editorView.selectedSequence={name:t,value:t},G=!0})):H.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),I=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',K),T.register(s.BUILDER_QUEUE_START,(function(){L=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',p('i18n')('started',a.loc.ale,'builder_queue'))})),T.register(s.BUILDER_QUEUE_STOP,(function(){L=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',p('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const T=Object.values(c),v=Object.values(a),A=Object.values(w),S=Object.values(h),y=Object.values(f);let I,k=[],R={},L=[],O=[],N=!1;const x={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<p.gameTime()+I},M=function(e){k.push(e)},P=function(e){R[e.id]=e},z=function(){
E.set(d.QUEUE_COMMANDS,k)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return b.call(e,'x')&&b.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,L=E.get(d.QUEUE_SENT,[],!0),O=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){p.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(M(e),P(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!C(e.sendTime))return!0;N?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&k.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),E.set(d.QUEUE_SENT,L),U.removeCommand(e,i.COMMAND_SENT),g.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){O.push(e)}(e),E.set(d.QUEUE_EXPIRED,O),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,g){let m={},E={};return new Promise((function(b,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(i))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return T.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[h.SUPPORTER]&&delete E[h.SUPPORTER],'string'!=typeof g||y.includes(g)?(g=!(d!==c.ATTACK||!m[w.CATAPULT])&&(g||f.HEADQUARTER),v.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return I(u.INVALID_ORIGIN);if(!i)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,E,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(C(c))return I(u.ALREADY_SENT);const f={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:E,type:d,catapultTarget:g,countdown:c-p.gameTime()};M(f),P(f),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),b(f)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete R[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:g.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:g.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:g.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:g.trigger(s.COMMAND_QUEUE_REMOVE,e)}else g.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),O=[],L=[]},U.start=function(e){N=!0,g.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){N=!1,g.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return N},U.getWaitingCommands=function(){return k},U.getWaitingCommandsObject=function(){return R},U.getSentCommands=function(){return L},
U.getExpiredCommands=function(){return O},U.filterCommands=function(e,t,a){const i=x[e];return(a||k).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,g,m,_,E,b,f,h,w){let T,v,A,S,y,I=n.getGameData(),k=I.getOrderedUnitNames(),R=I.getOrderedOfficerNames(),L=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},x=N.ADD;let C,M,P,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){O=t.data},B=function(){O=!1},F=function(e){
const t=new Date(e||f.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=f.zerofill(a-a%100,3),n=f.zerofill(t.getSeconds(),2),l=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},W=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),F(e+=t)):''},j=function(){if(T.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!T.isValidDate&&o.getTimeFromString(y.date),t=T.selectedDateType.value===l.ARRIVE;o.each(g,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);T.travelTimes[a][n].travelTime=p('readableMillisecondsFilter')(l),T.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&T.isValidDate?f.gameTime()+C<e?'valid':'invalid':'neutral'},Q=function(){y.dateType=T.selectedDateType.value,w.set(m.LAST_DATE_TYPE,T.selectedDateType.value),j()},H=function(){
y.catapultTarget=T.catapultTarget.value},K=function(){const e=T.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];T.selectedInsertPreset={name:p('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,T.catapultTarget={name:p('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},T.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=f.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),f.timer.add(e.updateCountdown)},J=function(){T.waitingCommands=t.getWaitingCommands()},X=function(){T.sentCommands=t.getSentCommands()},$=function(){T.expiredCommands=t.getExpiredCommands()},ee=function(){let e=T.waitingCommands;V.forEach((function(a){T.activeFilters[a]&&(e=t.filterCommands(a,T.filtersData,e))})),
T.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){T.showCatapultSelect=!!y.units.catapult},ne=function(e){T.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!O)return o.notif('error',p('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));b.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},se=function(){y.date=F()},re=function(){if(!y.date)return!1;y.date=W(y.date,100)},ce=function(){if(!y.date)return!1;y.date=W(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",T.catapultTarget={name:p('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},T.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){J(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',p('i18n')('error_origin',a.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',p('i18n')('error_target',a.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',p('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',p('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',p('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',p('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),X(),$()},pe=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),p('i18n')(e,a.loc.ale,'command_queue')+' '+p('i18n')(t,a.loc.ale,'command_queue')},_e=function(e,t){T.activeFilters[e]=!T.activeFilters[e],
t&&(T.filtersData[u.ALLOWED_TYPES][e]=!T.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){T.activeFilters[u.TEXT_MATCH]=T.filtersData[u.TEXT_MATCH].length>0,ee()},be={updatePresets:function(){T.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},T.searchQuery[i]=''},removeCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),J(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',p('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){X(),$(),J(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){X(),$(),J(),ee(),o.notif('error',p('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){X(),$(),J(),ee(),
o.notif('error',p('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),X(),J(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(T.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){T.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{f.timer.remove(e.updateCountdown)})}},fe=function(){const e=w.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;T=a.$new(),T.selectedTab=x,T.inventory=n.getInventory(),T.presets=o.obj2selectOptions(L.getPresets()),T.travelTimes={},o.each(g,(function(e){T.travelTimes[e]={},o.each(U,(function(t,a){T.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),T.unitOrder=S,T.officers=I.getOrderedOfficerNames(),T.searchQuery={origin:'',target:''},T.isValidDate=!1,T.dateTypes=h.toActionList(l,(function(e){return p('i18n')(e,a.loc.ale,'command_queue')})),T.selectedDateType={name:p('i18n')(e,a.loc.ale,'command_queue'),value:e},T.selectedInsertPreset={name:p('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},T.catapultTarget={name:p('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},T.autoCompleteOrigin={type:['village'],placeholder:p('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteOrigin,tooltip:p('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},T.autoCompleteTarget={type:['village'],placeholder:p('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteTarget,tooltip:p('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},T.showCatapultSelect=!!y.units.catapult,T.attackableBuildings=z,T.commandData=y,
T.activeFilters=M,T.filtersData=P,T.running=t.isRunning(),T.waitingCommands=t.getWaitingCommands(),T.visibleWaitingCommands=t.getWaitingCommands(),T.sentCommands=t.getSentCommands(),T.expiredCommands=t.getExpiredCommands(),T.EVENT_CODES=d,T.FILTER_TYPES=u,T.TAB_TYPES=N,T.COMMAND_TYPES=g,T.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),T.onUnitInputFocus=te,T.onUnitInputBlur=ae,T.catapultTargetVisibility=ie,T.selectTab=ne,T.addSelected=oe,T.addMapSelected=le,T.addCurrentDate=se,T.incrementDate=re,T.reduceDate=ce,T.cleanUnitInputs=de,T.addCommand=ue,T.clearRegisters=ge,T.switchCommandQueue=pe,T.removeCommand=t.removeCommand,T.openVillageInfo=r.openVillageInfo,T.toggleFilter=_e,T.$watch('commandData.origin',j),T.$watch('commandData.target',j),T.$watch('commandData.date',j),T.$watch('commandData.officers',j),T.$watch('selectedDateType.value',Q),T.$watch('selectedInsertPreset.value',K),T.$watch('catapultTarget.value',H),T.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
T.$watch('selectedTab',(function(){T.selectedTab===N.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),T.waitingCommands.forEach(e=>{Z(e)});let E=new i('twoverflow_queue_window',(function(){clearInterval(_),be.clearCountdownUpdates()}));E.register(s.ARMY_PRESET_UPDATE,be.updatePresets,!0),E.register(s.ARMY_PRESET_DELETED,be.updatePresets,!0),E.register(s.SELECT_SELECTED,be.autoCompleteSelected,!0),E.register(s.COMMAND_QUEUE_REMOVE,be.removeCommand),E.register(s.COMMAND_QUEUE_REMOVE_ERROR,be.removeError),E.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,be.sendTimeLimit),E.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,be.sendNotOwnVillage),E.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,be.sendNoUnitsEnough),E.register(s.COMMAND_QUEUE_SEND,be.sendCommand),E.register(s.COMMAND_QUEUE_START,be.start),E.register(s.COMMAND_QUEUE_STOP,be.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',T)};return function(){A=n.getSelectedCharacter(),C=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)z.push({name:p('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){D[e]=0})),R.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',20),v.addEventListener('click',fe),E.register(s.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),E.register(s.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,q),a.$on(s.DESTROY_CONTEXT_MENU,B),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,g,m,_,E,b=!1,f=!1,h=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},g=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let w={init:function(){b=!0}};return w.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),f=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),b=c.food,f=c.wood,w=c.clay,T=c.iron,v=b.currentStock,A=f.currentStock,S=w.currentStock,y=T.currentStock,I=[0,5e3],k=[160,16e3],R=[200,2e4],L=[50,5e3];1==s&&(h=1),m(n,(function(i){_=u(i.villages),E=g(_,1===s),console.log(E),50!=E||r!==t&&0!=r.length?50==E&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=h?'chapel'==i&&'church'==i||1!=h||(A>=k[1]&&S>=R[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker'))):A>=k[0]&&S>=R[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',p('i18n')('full',a.loc.ale,'faith_checker')):1==h?A>=k[1]&&S>=R[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker')):A>=k[0]&&S>=R[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},w.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),f=!1},w.isRunning=function(){return f},w.isInitialized=function(){return b},w})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,p('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',p('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',p('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,g,p,m,_,f,h,w,T,v,A,S,y,I){let k,R,L,O,N,x=!1,C=!1,M=[],P=[],z=[],D=[],G=[],U=[],V=!1,q=!1,B=!1,F=0,W=null,j=null,Y=null,Q={},H=w.gameTime(),K=null,Z=null;const J='farm_overflow_logs',X='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(R[r.MIN_DISTANCE],R[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(R[r.MIN_POINTS],R[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=R[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=R[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=R[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){b.call(L,e)||(L[e]={time:w.gameTime(),report:!1},t=!0)})),_.each(L,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete L[i],t=!0)})),t&&(I.set($,L),T.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),T.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=R[r.GROUP_INCLUDE],i=R[r.GROUP_IGNORE],n=R[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(ke(t.village_id),l=!0):(Oe(t.village_id),Ee(p.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}l&&T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=R[r.GROUP_INCLUDE],i=R[r.GROUP_IGNORE],n=R[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}else Ne(),Ee(p.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(ke(t.village_id),l=!0),l&&T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=R[r.GROUP_IGNORE],i=R[r.GROUP_ONLY],o=R[r.GROUP_INCLUDE],l=b.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=i.filter(e=>b.call(t,e)),c=o.filter(e=>b.call(t,e));k.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Ie(),Ne(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();R[r.PRESETS].forEach((function(t){if(!b.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(T.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),C&&xe.stop())},ue=function(e,t){R[r.IGNORE_ON_LOSS]&&R[r.GROUP_IGNORE]&&C&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(Q[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=R[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ge=function(e,t){V&&B&&t.origin.id===V.getId()&&t.target.id===B.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},pe=function(e,t){V&&q&&B&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},_e=function(e){L[e]={time:w.gameTime(),report:Q[e]||!1},delete Q[e],I.set($,L),T.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,P.unshift(t),be(),!0)},be=function(){const e=R[r.LOGS_LIMIT];P.length>e&&P.splice(P.length-e,P.length),I.set(J,P),T.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},fe=function(e,t,a){const i=R[r.TARGET_MULTIPLE_FARMERS],n=R[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},he=function(){H=w.gameTime()},we=function(){clearTimeout(W),clearTimeout(j),clearTimeout(Y),W=null,j=null,Y=null
},Te=function(){return Math.max(1,60*R[r.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*R[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=i.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{T.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return he(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,T.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(T.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(T.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,T.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=E},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,g,p=!1,m=!1;const E=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return a(i.USER_STOP);t()},_.randomSeconds(ve())):t()}),f=()=>new Promise((e,a)=>{const n=50-R[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(R[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),k=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(U.forEach((function(e){b.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)b.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*R[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,a);_.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(p=l,e()):t(i.TIME_LIMIT),!1}),p||t(i.NO_UNITS)}),x=()=>new Promise((e,n)=>{c=!1,g=O.getVillageList();const o=g.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),fe(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),C=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*R[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(R[r.TARGET_SINGLE_ATTACK]&&!R[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(w.gameTime()/1e3),l=R[r.TARGET_MULTIPLE_FARMERS]?g:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),_=d.calculateTravelTime(p,{
barbarian:!a.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(p,_,m,v.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(fe(l,o,!0))return t(i.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{E().then(f).then(S).then(I).then(k).then(L).then(N).then(x).then(C).then(M).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([P,D]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),q=!0,B=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:p.id,type:v.TYPES.ATTACK})}).catch(t=>{switch(we(),T.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Oe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){q=!1,B=!1,we(),Ee(p.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){q=!1,B=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=h.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,R[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=R[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=xe.getFarmer(e);return a||(a=new Ae(e),M.push(a)),a},ye=function(){_.each(O.getVillages(),(function(e,t){Se(t)})),T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=R[r.GROUP_ONLY];let t=[];M.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){ke(e)})),T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1
},Re=function(e){he(),M.length?F>=M.length?(F=0,V=!1,Z=w.gameTime()+Te(),T.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=M[F]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(F++,Re())})),"cycle_begin"===e&&(Z=null,T.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):W=setTimeout((function(){W=null,F=0,Z=null,T.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Re()}),Te())},Le=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){M.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let xe={};return xe.init=function(){x=!0,P=I.get(J,[]),L=I.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:X}),k.onChange((function(e,t,a){R=k.getAll(),"ignore_update"!==a&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ne(),t[g.TARGETS]&&Ne(),t[g.VILLAGES]&&(Ie(),ye()),t[g.LOGS]&&be(),t[g.INTERVAL_TIMERS]&&C&&(j?(we(),
V.targetStep({delay:!0})):W&&(we(),T.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),F=0,Re())))})),R=k.getAll(),se("ignore_update"),ne(),ye(),f((function(){ce()}),'presets'),f((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,ge),a.$on(s.MESSAGE_ERROR,pe),a.$on(s.REPORT_NEW,ue)},xe.start=function(){let e;return!C&&(U.length?(C=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Re("cycle_begin")})),he(),function(){let e=Te(),t=e+e/2+ve();K=setInterval((function(){w.gameTime()-H>t&&(xe.stop(),setTimeout(xe.start,5e3))}),3e4)}(),T.trigger(s.FARM_OVERFLOW_START),void Ee(p.FARM_START)):(C=!1,!1)):(T.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},xe.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=w.gameTime()+Te()),T.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,we(),T.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(K),e===i.USER_STOP&&Ee(p.FARM_STOP)},xe.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},xe.getFarmers=function(){return M},xe.getSettings=function(){return k},xe.getExceptionVillages=function(){return{included:z,ignored:D}},xe.getExceptionLogs=function(){return L},xe.isInitialized=function(){return x},xe.isRunning=function(){return C},xe.getLogs=function(){return P},xe.clearLogs=function(){return P=[],I.set(J,P),T.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),P},xe.getNextCycleDate=function(){return Z},xe.getCycleInterval=Te,xe})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,E,b,f,h,w,T){let v,A,S,y=n.getPresetList(),I=n.getGroupList(),k={},R={},L=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&x(e.villageId),e.targetId&&x(e.targetId)}))},x=function(e){if(k[e])return k[e];k[e]=!0,R[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},R[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
v.exceptionVillages.included.forEach((function(e){x(e)})),v.exceptionVillages.ignored.forEach((function(e){x(e)}))},M=function(){t.isRunning()?t.stop():t.start()},P=function(e){v.selectedTab=e},z=function(){A.setAll(A.decode(v.settings)),v.saveButtonColor='orange',h.notif('success',p('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(E.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(E.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){v.presets=b.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){v.groups=b.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=b.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},q=function(){v.running=!0,
h.notif('success',p('i18n')('farm_started',a.loc.ale,'farm_overflow'))},B=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:h.notif('success',p('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',p('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},F=function(){v.logs=angular.copy(t.getLogs()),N(),v.logs.length||h.notif('success',p('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},W=function(){v.farmers=t.getFarmers()},j=function(){v.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){v.exceptionLogs=t.getExceptionLogs()},Q=function(){v.showCycleTimer=!1,clearInterval(L)},H=function(e,a){a!==i.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},K=function(){let e=!0;v=a.$new(),v.SETTINGS=E,v.TAB_TYPES=O,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=O.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=R,v.villagesInfo=k,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=A.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},A.injectScope(v),U(),V(),N(),C(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-T.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=M,v.selectTab=P,v.saveSettings=z,v.clearLogs=t.clearLogs,v.jumpToVillage=g.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=_.showReport,v.removeIgnored=D,v.removeIncluded=G;let i=new f('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
i.register(s.FARM_OVERFLOW_START,q),i.register(s.FARM_OVERFLOW_STOP,B),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,F),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,W),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,Q),i.register(s.FARM_OVERFLOW_CYCLE_END,H),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){K()})),w.register(s.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),w.register(s.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,p,m,_,E,f,h,w,T,v,A){let S,y,I,k,R,L,O,N,x,C,M,P,z,D,G,U,V,q,B,F,W,j,Y,Q=!1,H={},K={village:{},character:{},tribe:{}},Z={a:0,b:0},J={a:0,b:0},X={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},ge={x:0,y:0},pe=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/y)%2&&(t+=k),t-=t%y,a-=a%y,{x:Math.ceil((t-x.width/2)/y),y:Math.ceil((a-x.height/2)/y)}},Ee=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},be=function(){Ae(R)},fe=function(){if(Q){const e={x:ee.x-x.width/2,y:ee.y-x.height/2};C.clearRect(0,0,x.width,x.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(M,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,I),D.fillRect(0,i,I,1);const n=U.getBoundingClientRect(),l=n.width/v.TILESIZE.x/A.view.z*y,s=n.height/v.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(fe)
},he=function(){if(!ie)return!1;const e=K.village[O][N];Te(e?K.character[e]:[[O,N]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},Te=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},ve=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in H.character?H.character[e.character_id]:e.tribe_id in H.tribe&&H.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&F.barbarian;if(e.character_id===q){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return F.selected;if(e.character_id in H.character)return H.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return F.player}else{if(e.character_id in H.character)return H.character[e.character_id];if(e.tribe_id in H.tribe)return H.tribe[e.tribe_id];if(B&&B===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return F.tribe;if(W&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(W.isAlly(e.tribe_id))return F.ally;if(W.isEnemy(e.tribe_id))return F.enemy;if(W.isNAP(e.tribe_id))return F.friendly}}return F.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||ve(i);if(!n)continue;const o=i.x*y+(i.y%2?k:0),l=i.y*y;P.fillStyle=n,P.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],k=Math.round(S/2),y=S+1,I=1e3*y,X.a=Z.a*y,X.b=Z.b*y,$.a=J.a*y,$.b=J.b*y,M.width=1e3*y,M.height=1e3*y,P.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;x.width=686,x.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,E.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id
},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Re=function(e){if(ce=!1,ge=_e(e),de)return ee.x=(ue.x-e.pageX).bound(X.a,X.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=ge.x,te.y=ge.y,!1;if(te.x===ge.x&&te.y===ge.y||(re.alpha=0,function(e,t){let a=g.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(ge.x,ge.y)),ge.x in ae&&ge.y in ae[ge.x]){let t=ae[ge.x][ge.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in H.character?e=!0:t.tribe_id in H.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;he()}ie=!0,O=e.x,N=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=K.village[O][N];we(a?K.character[a]:[[O,N]])}(ge,e)}he()},Le=function(){ie&&he(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=_e(e);g.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},xe=function(){H.tribe=le.getCustomColorsByGroup(T.TRIBE_COLORS)||{},H.character=le.getCustomColorsByGroup(T.PLAYER_COLORS)||{},be()},Ce=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&b.call(H,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;H[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?T.PLAYER_COLORS:T.TRIBE_COLORS;return le.setCustomColorsByGroup(i,H[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),be(),!0},removeHighlight:function(e,t){if(void 0===t||!b.call(H,e))return!1;if(!b.call(H[e],t))return!1;delete H[e][t]
;const i='character'===e?T.PLAYER_COLORS:T.TRIBE_COLORS;return le.setCustomColorsByGroup(i,H[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),be(),!0},getHighlight:function(e,t){return!!b.call(H[e],t)&&H[e][t]},getHighlights:function(){return H},eachHighlight:function(e){for(let t in H)for(let a in H[t])e(t,a,H[t][a])},setViewport:function(e){x=e,x.style.background=Y[o.COLOR_BACKGROUND],C=x.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Ee(e[0]*t,e[1]*t),i=Ee(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return j},Me.drawMinimap=function(){pe&&(pe=!1),x.style.background=Y[o.COLOR_BACKGROUND],P.clearRect(0,0,M.width,M.height),d((function(){
!function(){const e=h.getPath(v.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){P.fillStyle=Y[o.COLOR_CONTINENT],P.fillRect(e*y+k-1,t*y+k-1,3,1),P.fillRect(e*y+k,t*y+k-2,1,3)},n=function(e,t){P.fillStyle=Y[o.COLOR_PROVINCE],P.fillRect(e*y+k,t*y+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:J.a-10,b:J.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=f.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;P.beginPath(),P.lineWidth=2,P.strokeStyle="#2B4700",P.rect(r,c,d,u),P.stroke()}))}(),be()}),'minimap_data')},Me.enableRendering=function(){Q=!0},Me.disableRendering=function(){Q=!1},Me.isFirstDraw=function(){return!!pe},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),P=M.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),Se(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),Y=j.getAll(),H.tribe=le.getCustomColorsByGroup(T.TRIBE_COLORS)||{},H.character=le.getCustomColorsByGroup(T.PLAYER_COLORS)||{},Se()},Me.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),W=V.getTribeRelations(),q=V.getId(),B=V.getTribeId(),F=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Ie),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Re),z.addEventListener('mouseleave',Le),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),p.load((function(){R=p.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in K.village||(K.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
K.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in K.character?K.character[a.character_id].push([a.x,a.y]):K.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in K.tribe?K.tribe[a.tribe_id].push(a.character_id):K.tribe[a.tribe_id]=[a.character_id])))}}(R),function(){let e=[],t=[];for(let a in K.village){e.push(a);for(let e in K.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),J.a=Math.min(...t),J.b=Math.max(...t),X.a=Z.a*y,X.b=Z.b*y,$.a=J.a*y,$.b=J.b*y}(),fe(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ce),a.$on(s.TRIBE_RELATION_CHANGED,be),a.$on(s.GROUPS_VILLAGES_CHANGED,xe)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,g,m,_,E,b,f,h,w,T){let v,A,S,y,I,k,R,L,O,N,x,C={},M=!1,P={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){v.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(v.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
P.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!O)return;let a=V(t.x,t.y);var i,n;N=a,C[a]=!0,M=!0,(i=t.x,n=t.y,new Promise((function(e){let t=h.getTownAt(i,n);if(t)return e(t);h.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[V(e.x,e.y)])return;if(!M)return;R.appendChild(O),O.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=O.getBoundingClientRect(),i=R.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=k.tt.position.y+o>i.top+i.height,s=k.tt.position.x+n>i.width;l&&(k.tt.position.y-=50),O.classList.toggle('left',s),O.classList.toggle('top',l)}))},B=function(e,t){if(!O)return;let a=t?V(t):N;C[a]=!1,M=!1,k.tt.visible=!1,O.classList.add('ng-hide'),L.appendChild(O)},F=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=T.palette,'setting'===e?(l=t,o=x.get(l),r=!1,s.submit=function(){v.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){v.settings[l]=x.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,s.submit=function(){v.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},W=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},j=function(){x.setAll(x.decode(v.settings)),_.notif('success',p('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=p('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=p('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=p('i18n')('reset',a.loc.ale,'common'),e.cancelText=p('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){x.resetAll(),_.notif('success',p('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},Q=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},H=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},K={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',p('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',p('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',p('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){B(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){B(),y.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){v=a.$new(),v.SETTINGS=g,v.TAB_TYPES=z,v.selectedTab=D,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=n.getHighlights(),v.highlightNames=P,v.mapSizes=b.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=b.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:p('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:K.addHighlightAutoCompleteSelect},v.selectTab=G,v.openColorPalette=F,v.addCustomHighlight=W,v.removeHighlight=n.removeHighlight,v.saveSettings=j,v.resetSettings=Y,v.highlightsCount=Q,v.openProfile=H,x.injectScope(v,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,K.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,K.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,K.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,K.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,q),e.register(s.MINIMAP_VILLAGE_BLUR,B),e.register(s.MINIMAP_MOUSE_LEAVE,K.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,K.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,K.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',v),U(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){x=n.getSettings(),k=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),R=document.querySelector('#wrapper'),L=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',g='06050f',m='060506',_='060502',E='060501',b='060503',f='05020a',h='05030a',w='04080a',T='040a0a',v='070e04',A='070e05',S='070e0f',y='070e06',I='070e02',k='070e01',R='070e03',L='070e07',O='070e0b',N='070e0e',x='030d07',C='030d0b',M='030d0e';var P={init:function(){i=!0}};return P.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,g='string'==typeof g?parseInt(g,16):g,m='string'==typeof m?parseInt(m,16):m,_='string'==typeof _?parseInt(_,16):_,E='string'==typeof E?parseInt(E,16):E,b='string'==typeof b?parseInt(b,16):b,f='string'==typeof f?parseInt(f,16):f,h='string'==typeof h?parseInt(h,16):h,w='string'==typeof w?parseInt(w,16):w,T='string'==typeof T?parseInt(T,16):T,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,k='string'==typeof k?parseInt(k,16):k,R='string'==typeof R?parseInt(R,16):R,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,x='string'==typeof x?parseInt(x,16):x,C='string'==typeof C?parseInt(C,16):C,M='string'==typeof M?parseInt(M,16):M,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
...
axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',p('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',p('i18n')('deactivated',a.loc.ale,'preset_creator')),P.stop()},P.stop=function(){e.trigger(s.PRESET_CREATOR_STOPPED),r=!1},P.isRunning=function(){return r},P.isInitialized=function(){return i},P})),define('two/presetCreator/events',[],(function(){angular.extend(s,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),
...
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)g.includes(t[a].id)?console.log('Raport ataku już wysłany'):(g.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),setTimeout(m,3e4)},_=function(e){var t,n,s,r,c,d=[],u=e.result,g=e.token,m=e.time_created,_=p(m),E=e.ReportScouting,b=E.attCharacterId,f=E.attCharacterName,h=E.attScouts,w=E.attLosses,T=E.attVillageId,v=E.attVillageName,A=E.defCharacterId,S=E.defCharacterName,y=E.defLosses,I=E.defScouts,k=E.defVillageId,R=E.defVillageName,L=E.commandType,O='',N='',x='',C='',M=Date.now(),P=g.split('.').join('_');2==u?O=' [color=d96a19]Częściowy sukces[/color]':1==u?O=' [color=0a8028]Sukces[/color]':3==u&&(O=' [color=e21f1f]Porażka[/color]'),N='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==I?'nieznana':I,s=null==h?'nieznana':h,r=null==y?'nieznana':y,c=null==w?'nieznana':w,C=null==f&&null==b?'Brak danych':'[player='+b+']'+f+'[/player]',x=null==v&&null==T?'Brak danych':'[village='+T+']'+v+'[/village]',
t=Math.floor(M/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+P+'[/report][br]'+O+' --- Typ: '+N+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+_+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+R+'[/village][b] Gracz cel: [/b][player='+A+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+x+'[b] Gracz szpiegujący: [/b]'+C+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();A!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},E=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=p(r),d=e.ReportAttack,u=d.attCharacterId,g=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,E=d.attEffects,b=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var h=[],w=[];E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,h.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,h.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,h.push(' Zjednoczenie '+p+'%'))}));var T=h.join();b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,w.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,w.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,w.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,w.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,w.push(' Zjednoczenie '+p+'%'))}));var v=w.join(),A=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,R=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),x=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),M=d.night,P=d.loyaltyAfter,z=d.loyaltyBefore,D=d.wallAfter,G=d.wallBefore,U=d.officers,V=d.leader,q='',B='',F='',W='',j='',Y='',Q='',H='',K='',Z=Date.now(),J=s.split('.').join('_')
;null!=z&&(Y='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=P&&(Q='Lojalność po ataku: '+Math.floor(P)+' '),null!=G&&(H='Mury przed ataku: '+G+' '),null!=D&&(K='Mury po ataku: '+D+' '),null==U&&1==V?j='Brak':null==U&&1.1==V&&(j=' Wielki Mistrz '),W=0==M?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),F=null==g&&null==u?'Brak danych':'[player='+u+']'+g+'[/player]',B=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+J+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+k+']'+R+'[/player][br]Modyfikator obrony: [b]'+x+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+W+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+F+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+T+'[/b][br]Oficerowie: [b]'+j+'[/b][br]'+Y+Q+'[br]'+H+K+'[/size]');var X=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:X}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:X}),a=[])}},b=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=p(r),d=e.ReportAttack,u=d.attCharacterId,g=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,E=d.attEffects,b=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var h=[],w=[];E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,h.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,h.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,h.push(' Zjednoczenie '+p+'%'))}));var T=h.join();b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,w.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,w.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,w.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,w.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,w.push(' Zjednoczenie '+p+'%'))}));var v,A=w.join(),S=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),I=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),R=d.defCharacterId,L=d.defCharacterName,O=d.defVillageId,N=d.defVillageName,x=(100*d.defFaith).toFixed([0]),C=Math.round(100*d.defModifier).toFixed([0]),M=(100*d.wallBonus).toFixed([0]),P=d.night,z=d.loyaltyAfter,D=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,V=d.officers,q='',B='',F='',W='',j='',Y='',Q='',H='',K=[],Z=Date.now(),J=s.split('.').join('_')
;if(null!=D&&(j='Lojalność przed atakiem: '+Math.floor(D)+' '),null!=z&&(Y='Lojalność po ataku: '+Math.floor(z)+' '),null!=U&&(Q='Mury przed ataku: '+U+' '),null!=G&&(H='Mury po ataku: '+G+' '),null==V)K.push('Brak');else{var X=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==X&&0==$&&0==ee&&0==ae&&0==te&&0==ie?K.push('Brak'):(1==X?K.push(' Oszust '):K.push(''),1==$?K.push(' Wielki Mistrz '):K.push(''),1==ee?K.push(' Medyk '):K.push(''),1==te?K.push(' Łowczy '):K.push(''),1==ae?K.push(' Mistrz Łupu '):K.push(''),1==ie?K.push(' Taktyk '):K.push(''))}if(W=0==P?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),F=null==g&&null==u?'Brak danych':'[player='+u+']'+g+'[/player]',B=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),v=K.join(),null!=L){
a.push('[size=XL][b]Raport z ataku: [report]'+J+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+N+'[/village][b] Gracz cel: [/b][player='+R+']'+L+'[/player][br]Modyfikator obrony: [b]'+C+'[/b] Bonus za mury: [b]'+M+'[/b][br]Wiara: [b]'+x+'[/b] Bonus nocny: [b]'+W+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+F+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+I+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+T+'[/b][br]Oficerowie: [b]'+v+'[/b][br]'+j+Y+'[br]'+Q+H+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},f={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
