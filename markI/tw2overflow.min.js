 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),s=injector.get('routeProvider'),l=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),b=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||b,this.listeners=[];const i=a.$on(l.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
"entry/id":"Wioska/gracz/plemie","tooltip.village-id":"Id wioski","tooltip.player-id":"Id gracza","tooltip.tribe-id":"Id plemienia"},mint_helper:{title:"Mincerz",description:"Automatycznie wybija monety gdy włączony.",activated:"Mincerz aktywowany",deactivated:"Mincerz deaktywowany"},power_helper:{title:"Obrona"},prank_helper:{title:"Błazen",rename:"Nazwy wiosek","rename.all":"Zmień nazwy wszystkich wiosek","rename.type":"Typ","rename.prologue":"Prefix/Przedrostek","rename.center":"Nazwa właściwa","rename.epilogue":"Sufix/Przyrostek","rename.name":"Wpisz tekst...","rename.from":"Od (liczba lub litera startowa)","rename.to":"Do (liczba lub litera końcowa)","rename.char":"Wpisz znak...","rename.tip":"Litera lub liczba","rename.clear":"Wyczyść","rename.start":"Zmień","rename.province":"Zmień nazwy wiosek w wybranej prowincji","rename.add_village":"Wybierz wioskę...","rename.no_village":"Nie wybrano wioski","rename.add_map_selected":"Wybrana wioska z mapy","rename.selected":"Wybierz",
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/activityTool',['two/Settings','two/activityTool/settings','two/activityTool/settings/map','two/activityTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='activity_tool_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){
m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('activityTool settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.ACTIVITY_TOOL_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.ACTIVITY_TOOL_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/activityTool/events',[],(function(){angular.extend(l,{ACTIVITY_TOOL_START:'activity_tool_start',ACTIVITY_TOOL_STOP:'activity_tool_stop'})})),
define('two/activityTool/ui',['two/ui','two/activityTool','two/activityTool/settings','two/activityTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,
p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_activity_tool_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.ACTIVITY_TOOL_START,v),e.register(l.ACTIVITY_TOOL_STOP,S),c.getScreenWithInjectedScope('!twoverflow_activity_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Kwatermistrz',40),g.addEventListener('click',A),
...
require(['two/ready','two/activityTool','two/activityTool/ui','two/activityTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,i){let r;var c=injector.get('overviewService'),d=!1,u=!1,p=n.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=n.getSelectedCharacter(),T=m.tribeById[0],b=m.getVillageList(),f=[],E=m.data.character_id,_=m.data.character_name,w=[],h=[],v=[i.LIGHT_CAVALRY,i.HEAVY_CAVALRY,i.AXE,i.SWORD,i.RAM,i.SNOB,i.TREBUCHET];var S=function(){o.emit(s.TRIBE_GET_MEMBERLIST,{tribe:T},(function(e){for(var t=e.members,a=0;a<t.length;a++)h.push(t[a].id)})),b.forEach((function(e){f.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],
villages:f},A),setTimeout(S,6e4)},A=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),h.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(w.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{w.push(i[n].command_id),i[n].slowestUnit=y(i[n]);var l=i[n].time_completed,d=(t=void 0,t=new Date(1e3*l),r=t.toLocaleString(),r),u='',p='';'sword'==i[n].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',u='sword'):'axe'==i[n].slowestUnit?(p=' [color=e21f1f]TOPORNIK[/color]',u='axe'):'ram'==i[n].slowestUnit?(p=' [color=730202]TARAN[/color]',u='ram'):'snob'==i[n].slowestUnit?(p=' [color=ffee00]SZLACHCIC[/color]',u='snob'):'trebuchet'==i[n].slowestUnit?(p=' [color=494500]TREBUSZ[/color]',u='trebuchet'):'light_cavalry'==i[n].slowestUnit?(p=' [color=d96a19]LEKKA KAWALERIA[/color]',
u='light_cavalry'):'heavy_cavalry'==i[n].slowestUnit&&(p=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+p+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+i[n].target_village_id+']'+i[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+E+']'+_+'[/player][b] [br]Wioska pochodzenia: [/b][village='+i[n].origin_village_id+']'+i[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+i[n].origin_character_id+']'+i[n].origin_character_name+'[/player][/size]');var g=a.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==_||'halfsack'==_||'Black Rider'==_?o.emit(s.MESSAGE_REPLY,{message_id:14378,message:g}):o.emit(s.MESSAGE_REPLY,{message_id:4646,message:g}),a=[]):('Hajduk Split'==_||'halfsack'==_||'Black Rider'==_?o.emit(s.MESSAGE_REPLY,{message_id:14379,message:g}):o.emit(s.MESSAGE_REPLY,{message_id:4648,
message:g}),a=[])}},y=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y},s=[];return v.forEach((function(a){i[a]=1,s.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(s=s.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},k={init:function(){d=!0},start:function(){e.trigger(l.ALERT_SENDER_STARTED),u=!0,S()},stop:function(){e.trigger(l.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return k})),define('two/alertSender/events',[],(function(){angular.extend(l,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',60,g('i18n')('description',a.loc.ale,'alert_sender')),
...
define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[],b=[],f=[],E=[],_=[];const w='army_helper_settings',h={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(h);const v=function(){m=[],T=[];const e=n.getPresetList().getPresets(),a=u[t.PRESETS1],i=u[t.PRESETS2];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])}))},S=function(){b=[],f=[],E=[],_=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4];a.forEach((function(t){b.push(e[t])})),i.forEach((function(t){
f.push(e[t])})),o.forEach((function(t){E.push(e[t])})),s.forEach((function(t){_.push(e[t])}))},A={init:function(){p=!0,d=new e({settingsMap:i,storageKey:w}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&v(),t[o.GROUPS]&&S()})),u=d.getAll(),console.log('armyHelper settings',u),r((function(){v()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,v),a.$on(l.ARMY_PRESET_DELETED,v),a.$on(l.GROUPS_CREATED,S),a.$on(l.GROUPS_DESTROYED,S),a.$on(l.GROUPS_UPDATED,S)},start:function(){g=!0,c.trigger(l.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(l.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return A})),define('two/armyHelper/events',[],(function(){angular.extend(l,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),
define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,b=n.getPresetList(),f=n.getGroupList();const E={PRESETS:'presets',ARMY:'army',BALANCER:'balancer'},_=function(e){p.selectedTab=e},w=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},v=function(){p.presets=r.encodeList(b.getPresets(),{disabled:!1,type:'presets'})},S=function(){p.groups=r.encodeList(f.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},y=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},k=function(){p=a.$new(),p.SETTINGS=i,
p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.unit=r.encodeList(s,{textObject:'army_helper',disabled:!0}),m.injectScope(p),v(),S(),p.selectTab=_,p.saveSettings=w,p.switchState=h;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(l.ARMY_PRESET_UPDATE,v,!0),e.register(l.ARMY_PRESET_DELETED,v,!0),e.register(l.GROUPS_CREATED,S,!0),e.register(l.GROUPS_DESTROYED,S,!0),e.register(l.GROUPS_UPDATED,S,!0),e.register(l.ARMY_HELPER_START,A),e.register(l.ARMY_HELPER_STOP,y),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Administrator',90),T.addEventListener('click',k),
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,T,b,f){let E,_,w=!1,h=injector.get('overviewService'),v=[],S=!1,A={},y={},k={reverse:!1,column:i.TIME_COMPLETED};const R='attack_view_filters',I={},x={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in A[e[t]])if(a[e[t]]||(a[e[t]]=[]),A[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=A[c.VILLAGE]?[t]:[]},N=function(){B.loadCommands()},L=function(e,t){f.trigger(l.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){
for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);f.trigger(l.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},G=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);f.trigger(l.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],B.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},C=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},U=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let s,l=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=C(r,e);else if(c.length)s=C(c,e);else{if(!i)return t(!1);{const a=l.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);s=C(a,e)}}return t(s[0])}const i=T.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&U(e,t)}))},D=function(e){v=e.commands;for(let e=0;e<v.length;e++)h.formatCommand(v[e]),v[e].slowestUnit=z(v[e]);v=v.filter((function(e){return A[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[v])};let B={loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:k.column,reverse:k.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},D)},getCommands:function(){return v},getFilters:function(){return A},getSortings:function(){return k},toggleFilter:function(e,t){t?A[e][t]=!A[e][t]:A[e]=!A[e],O(),g.set(R,A),B.loadCommands()},toggleSorting:function(e){e===k.column?k.reverse=!k.reverse:(k.column=e,k.reverse=!1),B.loadCommands()},setCommander:function(e,a){U(e.targetVillage,(function(i){const n=e.targetVillage,o=i,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){l[e]='*'})),S.addCommand(n,o,a,_.OUT,l,{},s,p.WALL),S.isRunning()||S.start()}))},commandQueueEnabled:function(){return!!S},isInitialized:function(){return w},init:function(){for(let e=0;e<d.length;e++)I[d[e]]=!0;for(let e in r)x[r[e]]=!0;try{S=require('two/commandQueue'),_=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(x),
[c.INCOMING_UNITS]:angular.copy(I),[c.VILLAGE]:!1};w=!0,E=n.getSelectedCharacter().getGlobalInfo(),A=g.get(R,t,!0),e((function(){O(),a.$on(l.COMMAND_INCOMING,N),a.$on(l.COMMAND_CANCELLED,L),a.$on(l.MAP_SELECTED_VILLAGE,M),a.$on(l.VILLAGE_NAME_CHANGED,G),a.$on(l.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(l,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,s,d,u,T,b,f,E,_){let w,h;const v=function(){return Date.now()/1e3},S=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},A=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=_('#two-attack-view').parent(),t=_('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},k=function(){const e=w.pagination.offset,t=w.pagination.limit
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},R=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);k()},I=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},x=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},O=function(){w.commands=t.getCommands()},N=function(){w.selectedVillageId=n.getSelectedVillage().getId()},L=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=b,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=T,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:k,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=v,w.copyTimeModal=S,w.removeTroops=A,w.switchWindowSize=y,
w.toggleFilter=I,w.toggleSorting=x,k();let e=new i('twoverflow_queue_window',(function(){E.timer.remove(R)}));e.register(l.MAP_SELECTED_VILLAGE,N,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),E.timer.add(R)};return function(){h=e.addMenuButton('Strażnik',30),h.addEventListener('click',L),
...
}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c,d,u,p,g,m,T,b,f,E,_){let w,h,v=!1,S=!1,A=[];const y='battle_calculator_settings',k={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},R={[s.HALBERD_OF_GUAN_YU]:'spear',[s.PARACELSUS_LONGSWORD]:'sword',[s.THORGARDS_BATTLE_AXE]:'axe',[s.NIMRODS_LONGBOW]:'archer',[s.MIESZKOS_LANCE]:'lc',[s.NIMRODS_COMPOSITE_BOW]:'ma',[s.BAPTISTES_BANNER]:'hc',
[s.CAROLS_MORNING_STAR]:'ram',[s.ALETHEIAS_BONFIRE]:'catapult',[s.VASCOS_SCEPTER]:'snob'},I={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},x={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},O={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},N={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},L={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},G={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},M={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3},z={[f.LEVEL_1]:4,[f.LEVEL_2]:8,[f.LEVEL_3]:12,[f.LEVEL_4]:16,[f.LEVEL_5]:20};console.log(x,z,M,G,P,L,N,O,k,R,I);const C=function(){A=[];const e=n.getPresetList().getPresets();h[t.PRESET].forEach((function(t){A.push(e[t])}))},U={init:function(){v=!0,w=new e({settingsMap:i,storageKey:y}),w.onChange((function(e,t){h=w.getAll(),t[o.PRESETS]&&C()})),h=w.getAll(),console.log('battleCalculator settings',h),E((function(){C()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,C),a.$on(l.ARMY_PRESET_DELETED,C)},start:function(){S=!0,_.trigger(l.BATTLE_CALCULATOR_START)},
stop:function(){S=!1,console.log('battleCalculator stop'),_.trigger(l.BATTLE_CALCULATOR_STOP)},getSettings:function(){return w},isInitialized:function(){return v},isRunning:function(){return S}};return U})),define('two/battleCalculator/events',[],(function(){angular.extend(l,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p,g,m,T,b,f,E,_,w,h){let v,S,A,y=n.getPresetList();const k={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},R=function(e){v.selectedTab=e},I=function(){S.setAll(S.decode(v.settings)),h.notif('success','Settings saved')},x=function(){t.isRunning()?t.stop():t.start()},O=function(){v.presets=_.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},N=function(){
v.running=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),h.notif('success','battleCalculator started')},L=function(){v.running=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),h.notif('success','battleCalculator stopped')},P=function(){v=a.$new(),v.SETTINGS=i,v.TAB_TYPES=k,v.running=t.isRunning(),v.selectedTab=k.BATTLE,v.settingsMap=o,v.catapulttarget=_.encodeList(d,{textObject:'battle_calculator',disabled:!0}),v.knightitem=_.encodeList(s,{textObject:'battle_calculator',disabled:!0}),v.itemlevel=_.encodeList(r,{textObject:'battle_calculator',disabled:!0}),v.order=_.encodeList(u,{textObject:'battle_calculator',disabled:!0}),v.wall=_.encodeList(p,{textObject:'battle_calculator',disabled:!0}),v.church=_.encodeList(g,{textObject:'battle_calculator',disabled:!0}),v.weaponmaster=_.encodeList(m,{textObject:'battle_calculator',disabled:!0}),v.ironwalls=_.encodeList(T,{textObject:'battle_calculator',disabled:!0}),v.clinique=_.encodeList(b,{
textObject:'battle_calculator',disabled:!0}),v.hospital=_.encodeList(f,{textObject:'battle_calculator',disabled:!0}),v.training=_.encodeList(E,{textObject:'battle_calculator',disabled:!0}),S.injectScope(v),O(),v.selectTab=R,v.saveSettings=I,v.switchState=x;let e=new w('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(l.ARMY_PRESET_UPDATE,O,!0),e.register(l.ARMY_PRESET_DELETED,O,!0),e.register(l.BATTLE_CALCULATOR_START,N),e.register(l.BATTLE_CALCULATOR_STOP,L),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',v)};return function(){S=t.getSettings(),A=e.addMenuButton4('Kalkulator',10),A.addEventListener('click',P),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,b,f,E){let _,w,h,v=injector.get('buildingService'),S=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,k=!1;const R={};let I,x,O,N,L,P=!0;const G='builder_queue_log',M='builder_queue_settings',z=function(){const e=U();if(!P)return F.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},C=function(){U().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
A.canBeFinishedForFree(a,t)&&S.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},U=function(){const e=L[r.GROUP_VILLAGES];let a=[];return e?(a=I.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(R);const n=L[r.BUILDING_SEQUENCES][L[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return v.compute(e),B(e,a,(function(t,a){t&&a.job&&(b.trigger(l.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&L[r.PRIORIZE_FARM]){const t=h[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-L[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-L[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-L[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},Y=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),f.set(G,O),!0};let F={};return F.start=function(){if(!P)return b.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;k=!0,_=setInterval(z,6e4),w=setInterval(C,6e3),e((function(){U().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),C()}),['all_villages_ready']),b.trigger(l.BUILDER_QUEUE_START)},F.stop=function(){k=!1,clearInterval(_),
clearInterval(w),b.trigger(l.BUILDER_QUEUE_STOP)},F.isRunning=function(){return k},F.isInitialized=function(){return y},F.getSettings=function(){return N},F.getLogs=function(){return O},F.clearLogs=function(){O=[],f.set(G,O),b.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=L[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,O=f.get(G,[],!0),x=n.getSelectedCharacter(),I=n.getGroupList(),N=new i({settingsMap:c,storageKey:M}),N.onChange((function(e,t,a){L=N.getAll(),k&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),L=N.getAll();for(let e in m)R[m[e]]=0;P=Object.keys(L[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=L[r.BUILDING_SEQUENCES][e];let a=angular.copy(R);return t.forEach((function(e){a[e]++})),a}(L[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!k)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);D(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let i in e)f.call(e,i)&&(t[i]=a(e[i]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(l,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,b,E,_,w,h,v){let S,A,y,k,R=n.getGroupList(),I={},x=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},L={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let G,M={},z={},C=!1,U=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case E.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=k.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=S.settings[T.ACTIVE_SEQUENCE].value,t=S.settings[T.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in _)i[_[e]]=0;N.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],s='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(s='progress'):s='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:I[e][t-1],state:s}}))},N.generateBuildingSequenceFinal=function(e){const t=S.settings[T.ACTIVE_SEQUENCE].value,a=S.settings[T.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=I[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});N.buildingSequenceFinal=n},
N.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequence.offset,t=S.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),S.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=D(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(C=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
B(e,a,a+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(C=!0)},O.addBuilding=function(e,t,a=1){const i=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),C=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),C=!0},O.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},O.generateBuildingSequence=function(){const e=k.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const a=e[O.selectedSequence.value];let i={};for(let e in _)i[_[e]]=0;O.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
O.updateVisibleBuildingSequence()},O.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),S.pagination.buildingSequenceEditor.count=O.buildingSequence.length},O.updateBuildingSequence=function(){const e=O.selectedSequence.value,t=O.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:C=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},O.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(O.selectedSequence.value),C=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},O.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=O.lastAddedIndex,e.indexLimit=O.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(O.lastAddedBuilding,a.loc.ale,'building_names'),value:O.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),s=y[t].max_level;O.lastAddedBuilding=t,O.lastAddedIndex=i,O.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,s))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=O.selectedSequence.name,i=S.settings[T.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(C){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},L.updateVisibleLogs=function(){const e=S.pagination.logs.offset,t=S.pagination.logs.limit;L.visibleLogs=L.logs.slice(e,e+t),
S.pagination.logs.count=L.logs.length,L.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},L.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[_.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,t)&&(S.settings[T.ACTIVE_SEQUENCE]={name:e.name,value:e.name},S.settings[T.BUILDING_SEQUENCES][e.name]=t,Y(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){S.selectedTab=e},Y=function(){k.setAll(k.decode(S.settings)),C=!1},F=function(){i.isRunning()?i.stop():i.start()},j=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){C?j((function(){G()})):G()},K={updateGroups:function(){S.groups=p.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=k.get(T.BUILDING_SEQUENCES);S.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){S.logs=i.getLogs(),L.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=k.get(T.BUILDING_SEQUENCES);S.settings[T.BUILDING_SEQUENCES][t]=i[t],S.settings[T.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=k.get(T.BUILDING_SEQUENCES);S.settings[T.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete S.settings[T.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(S.settings[T.BUILDING_SEQUENCES]);O.selectedSequence={name:i,value:i},K.updateSequences(),O.generateBuildingSequence(),k.get(T.ACTIVE_SEQUENCE)===t&&(k.set(T.ACTIVE_SEQUENCE,i,{quiet:!0}),N.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){S.running=!0},stopped:function(){S.running=!1}},Q=function(){const e=k.get(T.ACTIVE_SEQUENCE);S=a.$new(),S.selectedTab=P.SETTINGS,S.TAB_TYPES=P,S.SETTINGS=T,S.running=x,S.pagination={},S.settingsMap=k.settingsMap,S.villagesLabel=z,S.villagesInfo=M,S.editorView=O,S.editorView.buildingSequence={},S.editorView.visibleBuildingSequence=[],S.editorView.selectedSequence={name:e,value:e},S.editorView.lastAddedBuilding=_.HEADQUARTER,S.editorView.lastAddedIndex=1,S.settingsView=N,S.settingsView.buildingSequence={},S.settingsView.buildingSequenceFinal={},S.logsView=L,S.logsView.logs=i.getLogs(),S.selectTab=W,S.switchBuilder=F,S.saveSettings=Y,S.createSequence=q,S.openVillageInfo=r.openVillageInfo,k.injectScope(S),K.updateGroups(),K.updateSequences(),S.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.logs={count:L.logs.length,offset:0,loader:L.updateVisibleLogs,limit:m.getPaginationLimit()},L.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(l.GROUPS_UPDATED,K.updateGroups,!0),t.register(l.GROUPS_CREATED,K.updateGroups,!0),t.register(l.GROUPS_DESTROYED,K.updateGroups,!0),t.register(l.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(l.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(l.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(l.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(l.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(l.BUILDER_QUEUE_START,K.started),t.register(l.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',S),G=S.closeWindow,S.closeWindow=H,S.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),S.$watch('editorView.selectedSequence.value',(function(e,t){U?U=!1:e!==t&&(C?j((function(){K.generateBuildingSequencesEditor(),C=!1}),(function(){S.editorView.selectedSequence={name:t,value:t},U=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),k=i.getSettings(),A=e.addMenuButton2('Budowniczy',20),A.addEventListener('click',Q),h.register(l.BUILDER_QUEUE_START,(function(){x=!0,A.classList.remove('btn-orange'),A.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),h.register(l.BUILDER_QUEUE_STOP,(function(){x=!1,A.classList.remove('btn-red'),A.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const h=Object.values(c),v=Object.values(a),S=Object.values(w),A=Object.values(_),y=Object.values(E);let k,R=[],I={},x=[],O=[],N=!1;const L={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+k},G=function(e){R.push(e)},M=function(e){I[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,R)},C=function(e){return!isNaN(e)&&e>0&&e<1e3},U=function(e){return f.call(e,'x')&&f.call(e,'y')&&C(e.x)&&C(e.y)};let D={initialized:!1};return D.init=function(){k=t.getTimeOffset(),D.initialized=!0,x=b.get(d.QUEUE_SENT,[],!0),O=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?D.expireCommand(e,i.TIME_LIMIT):(G(e),M(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!P(e.sendTime))return!0;N?D.sendCommand(e):D.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&R.length&&(e.returnValue=!0)}))},D.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let s={},l=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return l=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return l=i.NOT_ENOUGH_UNITS,!1;s[t]=e})),angular.equals({},s)&&(l=i.NOT_ENOUGH_UNITS),l||s}(e);if('string'==typeof a)return D.expireCommand(e,a);e.units=a,o.emit(s.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),b.set(d.QUEUE_SENT,x),D.removeCommand(e,i.COMMAND_SENT),p.trigger(l.COMMAND_QUEUE_SEND,e)},D.expireCommand=function(e,t){!function(e){O.push(e)}(e),b.set(d.QUEUE_EXPIRED,O),D.removeCommand(e,t)},D.addCommand=function(e,i,o,s,l,r,d,p){let m={},b={};return new Promise((function(f,k){if(!U(e))return k(u.INVALID_ORIGIN);if(!U(i))return k(u.INVALID_TARGET);if(!t.isValidDateTime(o))return k(u.INVALID_DATE);if(angular.isObject(l)){if(!t.each(l,(function(e,t){if(!S.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return k(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return k(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!A.includes(t))return!1;r[t]&&(b[t]=!0)})))return k(u.INVALID_OFFICER_TYPE)}return h.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[_.SUPPORTER]&&delete b[_.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[w.CATAPULT])&&(p||E.HEADQUARTER),v.includes(s)?void Promise.all([new Promise(t=>T.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>T.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return k(u.INVALID_ORIGIN);if(!i)return k(u.INVALID_TARGET);const l=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=s===a.ARRIVE?l-r:l,T=s===a.ARRIVE?l:l+r;if(P(c))return k(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:T,sendTime:c,origin:e,target:i,date:o,dateType:s,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};G(E),M(E),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):k(u.INVALID_DATE_TYPE)):k(u.INVALID_CATAPULT_TARGET)):k(u.RELOCATE_DISABLED):k(u.INVALID_COMMAND_TYPE)}))},D.removeCommand=function(e,t){delete I[e.id];const a=R.some((function(t,a){if(t.id==e.id)return R.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(l.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(l.COMMAND_QUEUE_REMOVE,e)}else p.trigger(l.COMMAND_QUEUE_REMOVE_ERROR,e);return a},D.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),O=[],x=[]},D.start=function(e){N=!0,p.trigger(l.COMMAND_QUEUE_START,{disableNotif:!!e})},D.stop=function(){N=!1,p.trigger(l.COMMAND_QUEUE_STOP)},D.isRunning=function(){return N},D.getWaitingCommands=function(){return R},D.getWaitingCommandsObject=function(){return I},D.getSentCommands=function(){return x},
D.getExpiredCommands=function(){return O},D.filterCommands=function(e,t,a){const i=L[e];return(a||R).filter((function(e){return i(e,t)}))},D})),define('two/commandQueue/events',[],(function(){angular.extend(l,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,s,d,u,p,m,T,b,f,E,_,w){let h,v,S,A,y,k=n.getGameData(),R=k.getOrderedUnitNames(),I=k.getOrderedOfficerNames(),x=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},L=N.ADD;let P,G,M,z=[],C={},U={};const D={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){O=t.data},q=function(){O=!1},W=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),s=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+s+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(h.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!h.isValidDate&&o.getTimeFromString(y.date),t=h.selectedDateType.value===s.ARRIVE;o.each(p,(function(a){o.each(D,(function(i,n){const s=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);h.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(s),h.travelTimes[a][n].status=e?j(t?e-s:e):'neutral'}))}))},j=function(e){return e&&h.isValidDate?E.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=h.selectedDateType.value,w.set(m.LAST_DATE_TYPE,h.selectedDateType.value),F()},K=function(){
y.catapultTarget=h.catapultTarget.value},Q=function(){const e=h.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];h.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,h.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},h.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=E.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),E.timer.add(e.updateCountdown)},Z=function(){h.waitingCommands=t.getWaitingCommands()},J=function(){h.sentCommands=t.getSentCommands()},$=function(){h.expiredCommands=t.getExpiredCommands()},ee=function(){let e=h.waitingCommands;B.forEach((function(a){h.activeFilters[a]&&(e=t.filterCommands(a,h.filtersData,e))})),
h.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){h.showCatapultSelect=!!y.units.catapult},ne=function(e){h.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:S.getId()}},se=function(){if(!O)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));f.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},le=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=Y(y.date,100)},ce=function(){if(!y.date)return!1;y.date=Y(y.date,-100)},de=function(){y.units=angular.copy(C),y.officers=angular.copy(U),y.catapultTarget="wall",h.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},h.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){Z(),ee(),X(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case T.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case T.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case T.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case T.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case T.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case T.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},Te=function(e,t){h.activeFilters[e]=!h.activeFilters[e],
t&&(h.filtersData[u.ALLOWED_TYPES][e]=!h.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){h.activeFilters[u.TEXT_MATCH]=h.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){h.presets=o.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},h.searchQuery[i]=''},removeCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(h.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){h.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{E.timer.remove(e.updateCountdown)})}},Ee=function(){const e=w.get(m.LAST_DATE_TYPE,s.OUT,!0);let T;h=a.$new(),h.selectedTab=L,h.inventory=n.getInventory(),h.presets=o.obj2selectOptions(x.getPresets()),h.travelTimes={},o.each(p,(function(e){h.travelTimes[e]={},o.each(D,(function(t,a){h.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),h.unitOrder=A,h.officers=k.getOrderedOfficerNames(),h.searchQuery={origin:'',target:''},h.isValidDate=!1,h.dateTypes=_.toActionList(s,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),h.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},h.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},h.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},h.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},h.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},h.showCatapultSelect=!!y.units.catapult,h.attackableBuildings=z,h.commandData=y,
h.activeFilters=G,h.filtersData=M,h.running=t.isRunning(),h.waitingCommands=t.getWaitingCommands(),h.visibleWaitingCommands=t.getWaitingCommands(),h.sentCommands=t.getSentCommands(),h.expiredCommands=t.getExpiredCommands(),h.EVENT_CODES=d,h.FILTER_TYPES=u,h.TAB_TYPES=N,h.COMMAND_TYPES=p,h.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),h.onUnitInputFocus=te,h.onUnitInputBlur=ae,h.catapultTargetVisibility=ie,h.selectTab=ne,h.addSelected=oe,h.addMapSelected=se,h.addCurrentDate=le,h.incrementDate=re,h.reduceDate=ce,h.cleanUnitInputs=de,h.addCommand=ue,h.clearRegisters=pe,h.switchCommandQueue=ge,h.removeCommand=t.removeCommand,h.openVillageInfo=r.openVillageInfo,h.toggleFilter=Te,h.$watch('commandData.origin',F),h.$watch('commandData.target',F),h.$watch('commandData.date',F),h.$watch('commandData.officers',F),h.$watch('selectedDateType.value',H),h.$watch('selectedInsertPreset.value',Q),h.$watch('catapultTarget.value',K),h.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',be),
h.$watch('selectedTab',(function(){h.selectedTab===N.ADD?T=setInterval((function(){F()}),2500):clearInterval(T)})),h.waitingCommands.forEach(e=>{X(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(T),fe.clearCountdownUpdates()}));b.register(l.ARMY_PRESET_UPDATE,fe.updatePresets,!0),b.register(l.ARMY_PRESET_DELETED,fe.updatePresets,!0),b.register(l.SELECT_SELECTED,fe.autoCompleteSelected,!0),b.register(l.COMMAND_QUEUE_REMOVE,fe.removeCommand),b.register(l.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),b.register(l.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),b.register(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),b.register(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),b.register(l.COMMAND_QUEUE_SEND,fe.sendCommand),b.register(l.COMMAND_QUEUE_START,fe.start),b.register(l.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',h)};return function(){S=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=k.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});A=angular.copy(R),A.splice(A.indexOf('catapult'),1),R.forEach((function(e){C[e]=0})),I.forEach((function(e){U[e]=!1})),y={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(C),officers:angular.copy(U),catapultTarget:"wall",type:null},G={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',10),v.addEventListener('click',Ee),b.register(l.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),b.register(l.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,V),a.$on(l.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,T,b,f=!1,E=!1,_=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(s.VILLAGES_IN_PROVINCE,{village_id:e},t)};let w={init:function(){f=!0}};return w.start=function(){i.trigger(l.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,l=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,w=c.clay,h=c.iron,v=f.currentStock,S=E.currentStock,A=w.currentStock,y=h.currentStock,k=[0,5e3],R=[160,16e3],I=[200,2e4],x=[50,5e3];1==l&&(_=1),m(n,(function(i){T=u(i.villages),b=p(T,1===l),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=_?'chapel'==i&&'church'==i||1!=_||(S>=R[1]&&A>=I[1]&&y>=x[1]&&v>=k[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):S>=R[0]&&A>=I[0]&&y>=x[0]&&v>=k[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==_?S>=R[1]&&A>=I[1]&&y>=x[1]&&v>=k[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):S>=R[0]&&A>=I[0]&&y>=x[0]&&v>=k[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},w.stop=function(){i.trigger(l.FAITH_CHECKER_STOPPED),E=!1},w.isRunning=function(){return E},w.isInitialized=function(){return f},w})),define('two/faithChecker/events',[],(function(){angular.extend(l,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(l.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(l.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,i,n){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.FAITH_CHECKER_STARTED,(function(){i.set(o,!0)})),n.register(l.FAITH_CHECKER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c,d){let u,p,g=!1,m=!1,T=[],b=[],f=[],E=[],_=[];const w='fake_sender_settings',h={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',
[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},v={[s.ATTACK]:'attack',[s.SUPPORT]:'support',[s.QUATTRO]:'four',[s.FULL]:'full'};console.log(h,v);const S=function(){T=[],b=[],f=[],E=[],_=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP],i=p[t.GROUPP],o=p[t.GROUPT],s=p[t.GROUPG],l=p[t.GROUP_TARGET];a.forEach((function(t){T.push(e[t])})),i.forEach((function(t){b.push(e[t])})),o.forEach((function(t){f.push(e[t])})),s.forEach((function(t){E.push(e[t])})),l.forEach((function(t){_.push(e[t])}))},A={init:function(){g=!0,u=new e({settingsMap:i,storageKey:w}),u.onChange((function(e,t){p=u.getAll(),t[o.GROUPS]&&S()})),p=u.getAll(),console.log('fakeSender settings',p),a.$on(l.GROUPS_CREATED,S),a.$on(l.GROUPS_DESTROYED,S),a.$on(l.GROUPS_UPDATED,S)},start:function(){m=!0,d.trigger(l.FAKE_SENDER_START)},
stop:function(){m=!1,d.trigger(l.FAKE_SENDER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return A})),define('two/fakeSender/events',[],(function(){angular.extend(l,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p){let m,T,b,f=n.getGroupList();const E={FAKE:'fake',LOGS:'logs'},_=function(e){m.selectedTab=e},w=function(){T.setAll(T.decode(m.settings)),p.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},h=function(){t.isRunning()?t.stop():t.start()},v=function(){m.groups=d.encodeList(f.getGroups(),{disabled:!1,type:'groups'})},S=function(){m.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),
p.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},A=function(){m.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},y=function(){m=a.$new(),m.SETTINGS=i,m.TAB_TYPES=E,m.running=t.isRunning(),m.selectedTab=E.FAKE,m.settingsMap=o,m.type=d.encodeList(s,{textObject:'fake_sender',disabled:!0}),m.units=d.encodeList(r,{textObject:'fake_sender',disabled:!0}),T.injectScope(m),v(),m.selectTab=_,m.saveSettings=w,m.switchState=h;let e=new u('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(l.GROUPS_CREATED,v,!0),e.register(l.GROUPS_DESTROYED,v,!0),e.register(l.GROUPS_UPDATED,v,!0),e.register(l.FAKE_SENDER_START,S),e.register(l.FAKE_SENDER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',m)};return function(){T=t.getSettings(),e.addDivisor(21),b=e.addMenuButton('Watażka',20),b.addEventListener('click',y),
...
LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/fakeSender','two/fakeSender/ui','two/fakeSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,T,E,_,w,h,v,S,A,y,k){let R,I,x,O,N,L=!1,P=!1,G=[],M=[],z=[],C=[],U=[],D=[],B=!1,V=!1,q=!1,W=0,Y=null,F=null,j=null,H={},K=w.gameTime(),Q=null,X=null
;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[A.WOOD,A.CLAY,A.IRON],te={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return C.includes(e.id)},points:function(e){return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=I[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=I[r.GROUP_IGNORE];C=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];U=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),U=U.concat(t)})),U=ie(U)}(),
function(){const e=C.concat(z);let t=!1;e.forEach((function(e){f.call(x,e)||(x[e]={time:w.gameTime(),report:!1},t=!0)})),T.each(x,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete x[i],t=!0)})),t&&(k.set($,x),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),h.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id&&(o?(Re(t.village_id),s=!0):(Oe(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),n.includes(t.group_id)&&o){let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id)if(o){
let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}else Ne(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Re(t.village_id),s=!0),s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){const t=n.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],s=f.call(t,a)?a:R.getDefault(r.GROUP_IGNORE),l=i.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));R.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ne(),ke(),Ne(),ye()},ce=function(){D=[];const e=n.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),D.push(a)})),D=D.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),
D.length||(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Le.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===v.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},pe=function(e,t){B&&q&&t.origin.id===B.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&q&&t.cause===s.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},Te=function(e){x[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],k.set($,x),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,M.unshift(t),fe(),!0)},fe=function(){const e=I[r.LOGS_LIMIT]
;M.length>e&&M.splice(M.length-e,M.length),k.set(Z,M),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const i=I[r.TARGET_MULTIPLE_FARMERS],n=I[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},_e=function(){K=w.gameTime()},we=function(){clearTimeout(Y),clearTimeout(F),clearTimeout(j),Y=null,F=null,j=null},he=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},Se=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};Se.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e()
;this.loadTargets(()=>{h.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Se.prototype.start=function(){return _e(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,h.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),!0):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Se.prototype.stop=function(e){this.running=!1,h.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=b},Se.prototype.targetStep=async function(e={}){if(!this.running)return!1;_e();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,
!this.running)return a(i.USER_STOP);t()},T.randomSeconds(ve())):t()}),E=()=>new Promise((e,a)=>{const n=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),A=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()}),k=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),R=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(s.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),x=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[]
;if(D.forEach((function(e){f.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)f.call(a,e)&&i.push(e);o.emit(s.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*I[r.MAX_TRAVEL_TIME],s=this.village.getPosition(),l=_.actualDistance(s,a);T.each(D,s=>{if(!!Object.entries(s.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(s,{barbarian:!a.character_id,officers:!1});return o>r*l?(g=s,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),L=()=>new Promise((e,n)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(S.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),
Ee(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(w.gameTime()/1e3),s=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],l=this.village.getPosition(),m=_.actualDistance(l,a),T=d.calculateTravelTime(g,{barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,T,m,v.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),G=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP)
;const n=a.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),s=n.some(e=>e.start_village_id===this.villageId);if(Ee(s,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{b().then(E).then(A).then(k).then(R).then(x).then(N).then(L).then(P).then(G).then(e).catch(t)}),C=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,C]).then(()=>{if(!this.running)return!1;this.setStatus(i.ATTACKING),V=!0,q=a,this.index++,o.emit(s.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:v.TYPES.ATTACK})}).catch(t=>{switch(we(),h.trigger(l.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,
this.setStatus(t),Oe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Se.prototype.setStatus=function(e){this.status=e},Se.prototype.getStatus=function(){return this.status||i.UNKNOWN},Se.prototype.commandSent=function(e){V=!1,q=!1,we(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Se.prototype.commandError=function(){V=!1,q=!1,this.stop(i.COMMAND_ERROR)},Se.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Se.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=_.actualDistance(t,e),e}))}(a,t),
this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Se.prototype.getTargets=function(){return this.targets},Se.prototype.getIndex=function(){return this.index},Se.prototype.getVillage=function(){return this.village},Se.prototype.isRunning=function(){return this.running},Se.prototype.isInitialized=function(){return this.initialized},Se.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Se.prototype.getId=function(){return this.villageId};const Ae=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!U.includes(e))return!1;if(C.includes(e))return!1;let a=Le.getFarmer(e);return a||(a=new Se(e),G.push(a)),a
},ye=function(){T.each(O.getVillages(),(function(e,t){Ae(t)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ke=function(){const e=I[r.GROUP_ONLY];let t=[];G.forEach((function(a){let i=a.getId();e.length&&!U.includes(i)?t.push(i):C.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Re(e)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let a=0;a<G.length;a++)if(G[a].getId()===e)return G[a].stop(t.KILL_FARMER),G.splice(a,a+1),!0;return!1},Ie=function(e){_e(),G.length?W>=G.length?(W=0,B=!1,X=w.gameTime()+he(),h.trigger(l.FARM_OVERFLOW_CYCLE_END)):B=G[W]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,Ie())})),"cycle_begin"===e&&(X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,W=0,X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),Ie()}),he())},xe=function(e){for(let t=0;t<G.length;t++){let a=G[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){
G.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){G.forEach((function(e){e.loadTargets()}))}),!0)};let Le={};return Le.init=function(){L=!0,M=k.get(Z,[]),x=k.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,a){I=R.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Ne(),t[p.VILLAGES]&&(ke(),ye()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&P&&(F?(we(),B.targetStep({delay:!0})):Y&&(we(),h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),W=0,Ie())))})),I=R.getAll(),le("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){G.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(l.ARMY_PRESET_UPDATE,de),a.$on(l.ARMY_PRESET_DELETED,de),a.$on(l.GROUPS_VILLAGE_LINKED,oe),a.$on(l.GROUPS_VILLAGE_UNLINKED,se),a.$on(l.GROUPS_DESTROYED,re),a.$on(l.COMMAND_SENT,pe),a.$on(l.MESSAGE_ERROR,ge),a.$on(l.REPORT_NEW,ue)},Le.start=function(){let e
;return!P&&(D.length?(P=!0,e=[],G.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Ie("cycle_begin")})),_e(),function(){let e=he(),t=e+e/2+ve();Q=setInterval((function(){w.gameTime()-K>t&&(Le.stop(),setTimeout(Le.start,5e3))}),3e4)}(),h.trigger(l.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Le.stop=function(e=i.USER_STOP){B?(B.stop(e),e!==i.USER_STOP&&(X=w.gameTime()+he()),h.trigger(l.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,we(),h.trigger(l.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Le.getFarmer=function(e){return G.find((function(t){return t.getId()===e}))},Le.getFarmers=function(){return G},Le.getSettings=function(){return R},Le.getExceptionVillages=function(){return{included:z,ignored:C}},Le.getExceptionLogs=function(){return x},Le.isInitialized=function(){return L},Le.isRunning=function(){return P},
Le.getLogs=function(){return M},Le.clearLogs=function(){return M=[],k.set(Z,M),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED),M},Le.getNextCycleDate=function(){return X},Le.getCycleInterval=he,Le})),define('two/farmOverflow/events',[],(function(){angular.extend(l,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',FARM_OVERFLOW_INSTANCE_STOP:'farm_overflow_instance_stop',FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS:'farm_overflow_instance_error_no_targets',FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY:'farm_overflow_instance_error_not_ready',FARM_OVERFLOW_INSTANCE_STEP_STATUS:'farm_overflow_instance_command_status',FARM_OVERFLOW_PRESETS_LOADED:'farm_overflow_presets_loaded',FARM_OVERFLOW_LOGS_UPDATED:'farm_overflow_log_updated',FARM_OVERFLOW_COMMAND_SENT:'farm_overflow_command_sent',FARM_OVERFLOW_IGNORED_TARGET:'farm_overflow_ignored_target',
FARM_OVERFLOW_VILLAGE_IGNORED:'farm_overflow_village_ignored',FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED:'farm_overflow_exception_villages_updated',FARM_OVERFLOW_FARMER_VILLAGES_UPDATED:'farm_overflow_farmer_villages_updated',FARM_OVERFLOW_REPORTS_UPDATED:'farm_overflow_reports_updated',FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED:'farm_overflow_exception_logs_updated',FARM_OVERFLOW_CYCLE_BEGIN:'farm_overflow_cycle_begin',FARM_OVERFLOW_CYCLE_END:'farm_overflow_cycle_end'})})),define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,_,w,h){let v,S,A,y=n.getPresetList(),k=n.getGroupList(),R={},I={},x=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),
v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&L(e.villageId),e.targetId&&L(e.targetId)}))},L=function(e){if(R[e])return R[e];R[e]=!0,I[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){v.exceptionVillages.included.forEach((function(e){L(e)})),v.exceptionVillages.ignored.forEach((function(e){L(e)}))},G=function(){t.isRunning()?t.stop():t.start()},M=function(e){v.selectedTab=e},z=function(){S.setAll(S.decode(v.settings)),v.saveButtonColor='orange',_.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},C=function(e){const t=S.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},U=function(e){
S.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){v.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){v.groups=f.encodeList(k.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=f.encodeList(k.getGroups(),{disabled:!0,type:'groups'})},V=function(){v.running=!0,_.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(x),t.reason){case d.NO_PRESETS:_.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:_.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){v.logs=angular.copy(t.getLogs()),N(),v.logs.length||_.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){v.farmers=t.getFarmers()},F=function(){v.exceptionVillages=t.getExceptionVillages(),P()
},j=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(x)},K=function(e,a){a!==i.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),x=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=a.$new(),v.SETTINGS=b,v.TAB_TYPES=O,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=O.SETTINGS,v.farmers=t.getFarmers(),v.villagesLabel=I,v.villagesInfo=R,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=S.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},S.injectScope(v),D(),B(),N(),P(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-h.gameTime(),x=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=G,v.selectTab=M,v.saveSettings=z,
v.clearLogs=t.clearLogs,v.jumpToVillage=p.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=T.showReport,v.removeIgnored=C,v.removeIncluded=U;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(x)}));i.register(l.ARMY_PRESET_UPDATE,D,!0),i.register(l.ARMY_PRESET_DELETED,D,!0),i.register(l.GROUPS_UPDATED,B,!0),i.register(l.GROUPS_CREATED,B,!0),i.register(l.GROUPS_DESTROYED,B,!0),i.register(l.FARM_OVERFLOW_START,V),i.register(l.FARM_OVERFLOW_STOP,q),i.register(l.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,Y),i.register(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),i.register(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,j),i.register(l.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(l.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){S=t.getSettings(),A=e.addMenuButton2('Farmer',10),
A.addEventListener('click',(function(){Q()})),w.register(l.FARM_OVERFLOW_START,(function(){A.classList.remove('btn-orange'),A.classList.add('btn-red')})),w.register(l.FARM_OVERFLOW_STOP,(function(){A.classList.remove('btn-red'),A.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/kingTool',['two/Settings','two/kingTool/settings','two/kingTool/settings/map','two/kingTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='king_tool_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('kingTool settings',d),s((function(){b()
}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.EXAMPLE_MODULE_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.EXAMPLE_MODULE_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/kingTool/events',[],(function(){angular.extend(l,{KING_TOOL_START:'king_tool_start',KING_TOOL_STOP:'king_tool_stop'})})),define('two/kingTool/ui',['two/ui','two/kingTool','two/kingTool/settings','two/kingTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')
},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_king_tool_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.KING_TOOL_START,v),e.register(l.KING_TOOL_STOP,S),
c.getScreenWithInjectedScope('!twoverflow_king_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Marszałek',30),g.addEventListener('click',A),
...
require(['two/ready','two/kingTool','two/kingTool/ui','two/kingTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='market_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('marketHelper settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),
a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.MARKET_HELPER_START)},stop:function(){p=!1,console.log('marketHelper stop'),r.trigger(l.MARKET_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/marketHelper/events',[],(function(){angular.extend(l,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){
u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','marketHelper started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','marketHelper stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_market_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.MARKET_HELPER_START,v),e.register(l.MARKET_HELPER_STOP,S),
c.getScreenWithInjectedScope('!twoverflow_market_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton2('Handlarz',30),g.addEventListener('click',A),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,T,b,E,_,w,h,v,S){let A,y,k,R,I,x,O,N,L,P,G,M,z,C,U,D,B,V,q,W,Y,F,j,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-R,a=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(a/y)%2&&(t+=R),t-=t%y,a-=a%y,{x:Math.ceil((t-L.width/2)/y),y:Math.ceil((a-L.height/2)/y)}},be=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},fe=function(){Se(I)},Ee=function(){if(H){const e={x:ee.x-L.width/2,y:ee.y-L.height/2};P.clearRect(0,0,L.width,L.height),C.clearRect(0,0,z.width,z.height),function(e){P.drawImage(G,-e.x,-e.y)}(e),j[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ge.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;C.fillStyle=j[o.COLOR_VIEW_REFERENCE],C.fillRect(a,0,1,k),C.fillRect(0,i,k,1);const n=D.getBoundingClientRect(),s=n.width/v.TILESIZE.x/S.view.z*y,l=n.height/v.TILESIZE.y/S.view.z*y,r=a-s/2,c=i-l/2;C.clearRect(r,c,s,l),C.beginPath(),C.lineWidth=1,C.strokeStyle=j[o.COLOR_VIEW_REFERENCE],C.rect(r,c,s,l),C.stroke()}(e)}e.requestAnimationFrame(Ee)},_e=function(){if(!ie)return!1;const e=Q.village[O][N];he(e?Q.character[e]:[[O,N]]),ie=!1,
m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t,j[o.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t)},ve=function(e){if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!j[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===x.getId()&&j[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(j[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&j[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(Y&&j[o.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return W.ally;if(Y.isEnemy(e.tribe_id))return W.enemy
;if(Y.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Se=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||ve(i);if(!n)continue;const o=i.x*y+(i.y%2?R:0),s=i.y*y;M.fillStyle=n,M.fillRect(o,s,A,A)}},Ae=function(){A=oe[j[o.MAP_SIZE]],R=Math.round(A/2),y=A+1,k=1e3*y,J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y,G.width=1e3*y,G.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;L.width=686,L.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,C.imageSmoothingEnabled=!1},ke=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(j[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ge.addHighlight({type:'character',id:e.character_id},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ge.addHighlight({
type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!j[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;_e()}ie=!0,O=e.x,N=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=Q.village[O][N];we(a?Q.character[a]:[[O,N]])}(pe,e)}_e()},xe=function(){ie&&_e(),m.trigger(l.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},Ne=function(e){return e.preventDefault(),!1},Le=function(){K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},fe()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),Se([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Ge={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t];const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e]),
a.$broadcast(l.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){L=e,L.style.background=j[o.COLOR_BACKGROUND],P=L.getContext('2d')},setViewportRef:function(e){z=e,C=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ge.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ge.getSettings=function(){return F},Ge.drawMinimap=function(){ge&&(ge=!1),L.style.background=j[o.COLOR_BACKGROUND],M.clearRect(0,0,G.width,G.height),d((function(){!function(){
const e=_.getPath(v.getMapPath()),t=j[o.SHOW_CONTINENT_DEMARCATIONS],a=j[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=j[o.COLOR_CONTINENT],M.fillRect(e*y+R-1,t*y+R-1,3,1),M.fillRect(e*y+R,t*y+R-2,1,3)},n=function(e,t){M.fillStyle=j[o.COLOR_PROVINCE],M.fillRect(e*y+R,t*y+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=E.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*y,c=l.a*y,d=(s.b-s.a)*y,u=(l.b-l.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Ge.enableRendering=function(){H=!0},Ge.disableRendering=function(){H=!1},Ge.isFirstDraw=function(){return!!ge},Ge.init=function(){Ge.initialized=!0,G=document.createElement('canvas'),M=G.getContext('2d'),re=le.make('hover'),F=new u({settingsMap:s,storageKey:ne}),F.onChange((function(e,t){j=F.getAll(),
Ae(),t[r.MAP_POSITION]&&Ge.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ge.drawMinimap()})),j=F.getAll(),K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ae()},Ge.run=function(){d((function(){D=document.getElementById('map'),U=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),W=B.getVillagesColors(),re.alpha=0,S.graph.layers.effects.push(re),ye(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*y,ee.y=x.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',ke),z.addEventListener('mouseup',Re),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y}(),Ee(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,fe),a.$on(l.GROUPS_VILLAGES_CHANGED,Le)}))}),['initial_village','tribe_relations'])},Ge})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,b,f,E,_,w,h){let v,S,A,y,k,R,I,x,O,N,L,P={},G=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},C=z.MINIMAP,U=function(e){v.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(v.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!O)return;let a=B(t.x,t.y);var i,n;N=a,P[a]=!0,G=!0,(i=t.x,n=t.y,new Promise((function(e){let t=_.getTownAt(i,n);if(t)return e(t);_.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!G)return;I.appendChild(O),O.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const a=O.getBoundingClientRect(),i=I.getBoundingClientRect(),n=a.width+50,o=a.height+50,s=R.tt.position.y+o>i.top+i.height,l=R.tt.position.x+n>i.width;s&&(R.tt.position.y-=50),O.classList.toggle('left',l),O.classList.toggle('top',s)}))},q=function(e,t){if(!O)return;let a=t?B(t):N;P[a]=!1,G=!1,R.tt.visible=!1,O.classList.add('ng-hide'),x.appendChild(O)},W=function(e,t,i){let o,s,l=a.$new(),r=!0;l.colorPalettes=h.palette,'setting'===e?(s=t,o=L.get(s),r=!1,l.submit=function(){v.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){v.settings[s]=L.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,l.submit=function(){v.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][i],l.submit=function(){n.addHighlight({id:i,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
c.getModal('modal_color_palette',l)},Y=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},F=function(){L.setAll(L.decode(v.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},j=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){L.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){D()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},X=function(){v=a.$new(),v.SETTINGS=p,v.TAB_TYPES=z,v.selectedTab=C,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=n.getHighlights(),v.highlightNames=M,v.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=U,v.openColorPalette=W,v.addCustomHighlight=Y,v.removeHighlight=n.removeHighlight,v.saveSettings=F,v.resetSettings=j,v.highlightsCount=H,v.openProfile=K,L.injectScope(v,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,q),e.register(l.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',v),D(),k=document.querySelector('#two-minimap .minimap-container'),k.appendChild(A),k.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){L=n.getSettings(),R=i.getSharedData('MapController'),A=document.createElement('canvas'),A.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(A),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),I=document.querySelector('#wrapper'),x=document.querySelector('#map'),S=t.addMenuButton4('Minimapa',30),S.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(l.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/powerHelper',['two/Settings','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='power_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={
init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('powerHelper settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.POWER_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/powerHelper/events',[],(function(){angular.extend(l,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),
w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_power_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.POWER_HELPER_START,v),e.register(l.POWER_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton4('Obrona',20),g.addEventListener('click',A),
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[];const T='prank_helper_settings',b={[s.INCREASE]:'increase',[s.DECREASE]:'decrease',[s.RANDOM]:'random'};console.log(b);const f=function(){m=[];const e=n.getGroupList().getGroups();u[t.GROUPS].forEach((function(t){m.push(e[t])}))},E={init:function(){p=!0,d=new e({settingsMap:i,storageKey:T}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&f()})),u=d.getAll(),console.log('all settings',u),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){g=!0,c.trigger(l.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(l.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return E})),define('two/prankHelper/events',[],(function(){angular.extend(l,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,g,m,T=n.getGroupList();const b={RENAME:'rename',LOGS:'logs'},f=function(e){p.selectedTab=e},E=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},v=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
u.notif('success','Example module stopped')},S=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.RENAME,p.settingsMap=o,p.type=r.encodeList(s,{textObject:'prank_helper',disabled:!0}),g.injectScope(p),w(),p.selectTab=f,p.saveSettings=E,p.switchState=_;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.PRANK_HELPER_START,h),e.register(l.PRANK_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',60),m.addEventListener('click',S),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',T='060502',b='060501',f='060503',E='05020a',_='05030a',w='04080a',h='040a0a',v='070e04',S='070e05',A='070e0f',y='070e06',k='070e02',R='070e01',I='070e03',x='070e07',O='070e0b',N='070e0e',L='030d07',P='030d0b',G='030d0e';var M={init:function(){i=!0}};return M.start=function(){e.trigger(l.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,T='string'==typeof T?parseInt(T,16):T,b='string'==typeof b?parseInt(b,16):b,f='string'==typeof f?parseInt(f,16):f,E='string'==typeof E?parseInt(E,16):E,
_='string'==typeof _?parseInt(_,16):_,w='string'==typeof w?parseInt(w,16):w,h='string'==typeof h?parseInt(h,16):h,v='string'==typeof v?parseInt(v,16):v,S='string'==typeof S?parseInt(S,16):S,A='string'==typeof A?parseInt(A,16):A,y='string'==typeof y?parseInt(y,16):y,k='string'==typeof k?parseInt(k,16):k,R='string'==typeof R?parseInt(R,16):R,I='string'==typeof I?parseInt(I,16):I,x='string'==typeof x?parseInt(x,16):x,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,L='string'==typeof L?parseInt(L,16):L,P='string'==typeof P?parseInt(P,16):P,G='string'==typeof G?parseInt(G,16):G,o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:20,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (miecz)',
icon:u,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:33,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (top)',icon:p,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:25,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (łuk)',icon:m,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:50,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (lk)',icon:T,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,
supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:10,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (łk)',icon:b,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:10,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (ck)',icon:f,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:10,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'PartDeff',icon:E,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:180,sword:140,axe:0,
archer:100,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'FullDeff',icon:_,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:9e3,sword:7e3,axe:0,archer:5e3,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'PartOff',icon:w,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:200,archer:0,light_cavalry:75,mounted_archer:87,heavy_cavalry:0,ram:15,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'FullOff',icon:h,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:4e3,archer:0,light_cavalry:1500,mounted_archer:1750,
heavy_cavalry:0,ram:300,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (pik)',icon:v,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:1,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (miecz)',icon:S,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:1,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (top)',icon:A,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:1,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,
snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (łuk)',icon:y,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:1,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (lk)',icon:k,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:1,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (łk)',icon:R,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:1,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{
village_id:c[0].data.villageId,name:'fejk (ck)',icon:I,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:1,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (tar)',icon:x,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (kat)',icon:O,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (treb)',icon:N,officers:{
leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (tar)',icon:G,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (kat)',icon:G,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:G,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),M.stop()},M.stop=function(){e.trigger(l.PRESET_CREATOR_STOPPED),r=!1},M.isRunning=function(){return r},M.isInitialized=function(){return i},M})),define('two/presetCreator/events',[],(function(){angular.extend(l,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(101),o=e.addMenuButton('Wojewoda',100,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
i.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'preset_creator')))})),n.register(l.PRESET_CREATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.PRESET_CREATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,a,i,n){const o='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.PRESET_CREATOR_STARTED,(function(){i.set(o,!0)})),n.register(l.PRESET_CREATOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),
define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[],b=[],f=[],E=[],_=[],w=[],h=[],v=[],S=[],A=[],y=[],k=[],R=[],I=[],x=[],O=[],N=[],L=[],P=[],G=[],M=[],z=[],C=[],U=[],D=[],B=[],V=[],q=[],W=[],Y=[],F=[];const j='recruit_queue_settings',H={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],T=[],b=[],f=[],E=[],_=[],w=[],h=[]
;const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],s=u[t.PRESET4],l=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])})),o.forEach((function(t){b.push(e[t])})),s.forEach((function(t){f.push(e[t])})),l.forEach((function(t){E.push(e[t])})),r.forEach((function(t){_.push(e[t])})),c.forEach((function(t){w.push(e[t])})),d.forEach((function(t){h.push(e[t])}))},Q=function(){v=[],S=[],A=[],y=[],k=[],R=[],I=[],x=[],O=[],N=[],L=[],P=[],G=[],M=[],z=[],C=[],U=[],D=[],B=[],V=[],q=[],W=[],Y=[],F=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4],l=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],b=u[t.GROUP13],f=u[t.GROUP14],E=u[t.GROUP15],_=u[t.GROUP16],w=u[t.GROUP17],h=u[t.GROUP18],j=u[t.GROUP19],H=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){v.push(e[t])})),i.forEach((function(t){S.push(e[t])})),o.forEach((function(t){A.push(e[t])})),s.forEach((function(t){y.push(e[t])})),l.forEach((function(t){k.push(e[t])})),r.forEach((function(t){R.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){x.push(e[t])})),p.forEach((function(t){O.push(e[t])})),g.forEach((function(t){N.push(e[t])})),m.forEach((function(t){L.push(e[t])})),T.forEach((function(t){P.push(e[t])})),b.forEach((function(t){G.push(e[t])})),f.forEach((function(t){M.push(e[t])})),E.forEach((function(t){z.push(e[t])})),_.forEach((function(t){
C.push(e[t])})),w.forEach((function(t){U.push(e[t])})),h.forEach((function(t){D.push(e[t])})),j.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),K.forEach((function(t){q.push(e[t])})),Q.forEach((function(t){W.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:i,storageKey:j}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('recruitQueue settings',u),r((function(){K()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,K),a.$on(l.ARMY_PRESET_DELETED,K),a.$on(l.GROUPS_CREATED,Q),a.$on(l.GROUPS_DESTROYED,Q),a.$on(l.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(l.recruit_queue_START)},stop:function(){g=!1,c.trigger(l.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(l,{
RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,b=n.getPresetList(),f=n.getGroupList();const E={PRESETS:'presets',OWN:'own',LOGS:'logs'},_=function(e){p.selectedTab=e},w=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},v=function(){p.presets=r.encodeList(b.getPresets(),{disabled:!1,type:'presets'})},S=function(){p.groups=r.encodeList(f.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},y=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),
u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},k=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.units=r.encodeList(s,{textObject:'recruit_queue',disabled:!0}),m.injectScope(p),v(),S(),p.selectTab=_,p.saveSettings=w,p.switchState=h;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed')}));e.register(l.ARMY_PRESET_UPDATE,v,!0),e.register(l.ARMY_PRESET_DELETED,v,!0),e.register(l.GROUPS_CREATED,S,!0),e.register(l.GROUPS_DESTROYED,S,!0),e.register(l.GROUPS_UPDATED,S,!0),e.register(l.recruit_queue_START,A),e.register(l.recruit_queue_STOP,y),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Kapitan',80),T.addEventListener('click',k),
...
require(['two/ready','two/reportHelper','two/reportHelper/ui','two/reportHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=n.getSelectedCharacter(),a=t.data.character_id,i=t.data.character_name,r=!1,c=!1,d=[],u=[],p=[];function g(e){var t=new Date(1e3*e);return t.toLocaleString()}var m=function(){o.emit(s.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},T))})),o.emit(s.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},b))})),o.emit(s.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']
},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},T=function(e){var t,n,l,r,c,d=[],u=e.result,p=e.token,m=e.time_created,T=g(m),b=e.ReportScouting,f=b.attCharacterId,E=b.attCharacterName,_=b.attScouts,w=b.attLosses,h=b.attVillageId,v=b.attVillageName,S=b.defCharacterId,A=b.defCharacterName,y=b.defLosses,k=b.defScouts,R=b.defVillageId,I=b.defVillageName,x=b.commandType,O='',N='',L='',P='',G=Date.now(),M=p.split('.').join('_');2==u?O=' [color=d96a19]Częściowy sukces[/color]':1==u?O=' [color=0a8028]Sukces[/color]':3==u&&(O=' [color=e21f1f]Porażka[/color]'),N='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',n=null==k?'nieznana':k,l=null==_?'nieznana':_,r=null==y?'nieznana':y,c=null==w?'nieznana':w,P=null==E&&null==f?'Brak danych':'[player='+f+']'+E+'[/player]',L=null==v&&null==h?'Brak danych':'[village='+h+']'+v+'[/village]',
t=Math.floor(G/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+O+' --- Typ: '+N+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+R+']'+I+'[/village][b] Gracz cel: [/b][player='+S+']'+A+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+L+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+l+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();S!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(s.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(s.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){
var t,a=[],n=e.result,l=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var _=[],w=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),_.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,_.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,_.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,_.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,_.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,_.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,_.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,_.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,_.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,_.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,_.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,_.push(' Zjednoczenie '+g+'%'))}));var h=_.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,w.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,w.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,w.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,w.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}));var v=w.join(),S=(100*d.attFaith).toFixed([0]),A=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),R=d.defCharacterId,I=d.defCharacterName,x=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),L=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),G=d.night,M=d.loyaltyAfter,z=d.loyaltyBefore,C=d.wallAfter,U=d.wallBefore,D=d.officers,B=d.leader,V='',q='',W='',Y='',F='',j='',H='',K='',Q='',X=Date.now(),Z=l.split('.').join('_')
;null!=z&&(j='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=M&&(H='Lojalność po ataku: '+Math.floor(M)+' '),null!=U&&(K='Mury przed ataku: '+U+' '),null!=C&&(Q='Mury po ataku: '+C+' '),null==D&&1==B?F='Brak':null==D&&1.1==B&&(F=' Wielki Mistrz '),Y=0==G?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==T&&null==m?'Brak danych':'[village='+m+']'+T+'[/village]',t=Math.floor(X/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+O+'[/village][b] Gracz cel: [/b][player='+R+']'+I+'[/player][br]Modyfikator obrony: [b]'+L+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+A+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+j+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(s.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},f=function(e){
var t,a=[],n=e.result,l=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var _=[],w=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),_.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,_.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,_.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,_.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,_.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,_.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,_.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,_.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,_.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,_.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,_.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,_.push(' Zjednoczenie '+g+'%'))}));var h=_.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,w.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,w.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,w.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,w.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}));var v,S=w.join(),A=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),k=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,x=d.defCharacterName,O=d.defVillageId,N=d.defVillageName,L=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),G=(100*d.wallBonus).toFixed([0]),M=d.night,z=d.loyaltyAfter,C=d.loyaltyBefore,U=d.wallAfter,D=d.wallBefore,B=d.officers,V='',q='',W='',Y='',F='',j='',H='',K='',Q=[],X=Date.now(),Z=l.split('.').join('_')
;if(null!=C&&(F='Lojalność przed atakiem: '+Math.floor(C)+' '),null!=z&&(j='Lojalność po ataku: '+Math.floor(z)+' '),null!=D&&(H='Mury przed ataku: '+D+' '),null!=U&&(K='Mury po ataku: '+U+' '),null==B)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(Y=0==M?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==T&&null==m?'Brak danych':'[village='+m+']'+T+'[/village]',t=Math.floor(X/1e3-r),v=Q.join(),null!=x){
a.push('[size=XL][b]Raport z ataku: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+N+'[/village][b] Gracz cel: [/b][player='+I+']'+x+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+G+'[/b][br]Wiara: [b]'+L+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+S+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+k+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+v+'[/b][br]'+F+j+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(s.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},E={init:function(){r=!0},start:function(){e.trigger(l.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(l.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return r}};return E})),define('two/reportSender/events',[],(function(){angular.extend(l,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(71),o=e.addMenuButton('Goniec',70,g('i18n')('description',a.loc.ale,'report_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'report_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'report_sender')))})),n.register(l.REPORT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.REPORT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.REPORT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(l.REPORT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/specialQueue',['two/Settings','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/settings/updates','two/specialQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[];const b='special_queue_settings',f={[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner'};console.log(f);const E=function(){m=[],T=[];const e=n.getGroupList().getGroups(),a=u[t.GROUPNOBLE],i=u[t.GROUPSPECIAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])}))},_={init:function(){p=!0,
d=new e({settingsMap:i,storageKey:b}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&E()})),u=d.getAll(),console.log('specialQueue settings',u),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){g=!0,c.trigger(l.SPECIAL_QUEUE_START)},stop:function(){g=!1,c.trigger(l.SPECIAL_QUEUE_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return _})),define('two/specialQueue/events',[],(function(){angular.extend(l,{SPECIAL_QUEUE_START:'special_queue_start',SPECIAL_QUEUE_STOP:'special_queue_stop'})})),define('two/specialQueue/ui',['two/ui','two/specialQueue','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,b=n.getGroupList();const f={NOBLE:'noble',SPECIAL:'special',LOGS:'logs'},E=function(e){p.selectedTab=e},_=function(){m.setAll(m.decode(p.settings)),
u.notif('success',g('i18n')('general.saved',a.loc.ale,'special_queue'))},w=function(){t.isRunning()?t.stop():t.start()},h=function(){p.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},v=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'special_queue'))},S=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'special_queue'))},A=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=f,p.running=t.isRunning(),p.selectedTab=f.NOBLE,p.settingsMap=o,p.units=r.encodeList(s,{textObject:'special_queue',disabled:!0}),m.injectScope(p),h(),p.selectTab=E,p.saveSettings=_,p.switchState=w;let e=new d('twoverflow_special_queue_window',(function(){console.log('specialQueue closed')}));e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),
e.register(l.SPECIAL_QUEUE_START,v),e.register(l.SPECIAL_QUEUE_STOP,S),c.getScreenWithInjectedScope('!twoverflow_special_queue_window',p)};return function(){m=t.getSettings(),e.addDivisor(86),T=e.addMenuButton('Weteran',85),T.addEventListener('click',A),
...
isRunning:function(){return u}};return T})),define('two/spyMaster/events',[],(function(){angular.extend(l,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u){let p,m,T;const b={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},f=function(e){p.selectedTab=e},E=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},h=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},v=function(){p=a.$new(),
p.SETTINGS=i,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.SPY,p.settingsMap=n,p.building=r.encodeList(o,{textObject:'spy_master',disabled:!0}),p.unit=r.encodeList(s,{textObject:'spy_master',disabled:!0}),m.injectScope(p),p.selectTab=f,p.saveSettings=E,p.switchState=_;let e=new d('twoverflow_spy_master_window',(function(){console.log('spyMaster window closed')}));e.register(l.SPY_MASTER_START,w),e.register(l.SPY_MASTER_STOP,h),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton3('Zwiadowca',10),T.addEventListener('click',v),
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('supportSender settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),
r.trigger(l.SUPPORT_SENDER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/supportSender/events',[],(function(){angular.extend(l,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,
type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.SUPPORT_SENDER_START,v),e.register(l.SUPPORT_SENDER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',A),
...
e.addStyle('#two-support-sender div[select]{float:right}#two-support-sender div[select] .select-handler{line-height:28px}#two-support-sender .range-container{width:250px}#two-support-sender .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-support-sender .textfield-border.fit{width:100%}')}})),define('two/supportSender/settings',[],(function(){return{PRESETS:'presets',GROUPS:'groups',SOME_NUMBER:'some_number'}})),define('two/supportSender/settings/updates',(function(){return{PRESETS:'presets',GROUPS:'groups'}})),define('two/supportSender/settings/map',['two/supportSender/settings','two/supportSender/settings/updates'],(function(e,t){return{[e.PRESETS]:{default:[],updates:[t.PRESETS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'presets'},[e.GROUPS]:{default:[],updates:[t.GROUPS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'groups'},[e.SOME_NUMBER]:{default:60,inputType:'number',min:0,max:120}}})),
