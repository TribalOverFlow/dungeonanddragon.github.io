...
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);R()},I=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},L=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},x=function(){w.commands=t.getCommands()},O=function(){w.selectedVillageId=n.getSelectedVillage().getId()},N=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=b,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=T,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=v,w.copyTimeModal=S,w.removeTroops=A,w.switchWindowSize=y,
w.toggleFilter=I,w.toggleSorting=L,R();let e=new i('twoverflow_queue_window',(function(){E.timer.remove(k)}));e.register(l.MAP_SELECTED_VILLAGE,O,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,x),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,x),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,x),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,x),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),E.timer.add(k)};return function(){h=e.addMenuButton('Strażnik',30),h.addEventListener('click',N),
...
textObject:'battle_calculator',disabled:!0}),v.hospital=_.encodeList(f,{textObject:'battle_calculator',disabled:!0}),v.training=_.encodeList(E,{textObject:'battle_calculator',disabled:!0}),S.injectScope(v),x(),v.selectTab=k,v.saveSettings=I,v.switchState=L;let e=new w('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(l.ARMY_PRESET_UPDATE,x,!0),e.register(l.ARMY_PRESET_DELETED,x,!0),e.register(l.BATTLE_CALCULATOR_START,O),e.register(l.BATTLE_CALCULATOR_STOP,N),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',v)};return function(){S=t.getSettings(),A=e.addMenuButton4('Kalkulator',10),A.addEventListener('click',P),
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,b,E,_,w,h,v){let S,A,y,R,k=n.getGroupList(),I={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},G=!1,D=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
O.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequence.offset,t=S.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),S.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},x.moveUp=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(G=!0)},x.moveDown=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(G=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),G=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),G=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=R.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in _)i[_[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),S.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:G=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(x.selectedSequence.value),G=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=x.lastAddedIndex,e.indexLimit=x.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(x.lastAddedBuilding,a.loc.ale,'building_names'),value:x.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),s=y[t].max_level;x.lastAddedBuilding=t,x.lastAddedIndex=i,x.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,s))},
...
count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.buildingSequenceEditor={count:x.buildingSequence.length,offset:0,loader:x.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.logs={count:N.logs.length,offset:0,loader:N.updateVisibleLogs,limit:m.getPaginationLimit()},N.updateVisibleLogs(),O.generateSequences(),x.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(l.GROUPS_UPDATED,K.updateGroups,!0),t.register(l.GROUPS_CREATED,K.updateGroups,!0),t.register(l.GROUPS_DESTROYED,K.updateGroups,!0),t.register(l.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(l.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
...
U.length||(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},pe=function(e,t){V&&q&&t.origin.id===V.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},ge=function(e,t){V&&B&&q&&t.cause===s.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},Te=function(e){L[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],R.set($,L),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,M.unshift(t),fe(),!0)},fe=function(){const e=I[r.LOGS_LIMIT]
...
},j=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=a.$new(),v.SETTINGS=b,v.TAB_TYPES=x,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=x.SETTINGS,v.farmers=t.getFarmers(),v.villagesLabel=I,v.villagesInfo=k,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=S.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},S.injectScope(v),U(),V(),O(),P(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-h.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=C,v.selectTab=M,v.saveSettings=z,
v.clearLogs=t.clearLogs,v.jumpToVillage=p.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=T.showReport,v.removeIgnored=G,v.removeIncluded=D;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(l.ARMY_PRESET_UPDATE,U,!0),i.register(l.ARMY_PRESET_DELETED,U,!0),i.register(l.GROUPS_UPDATED,V,!0),i.register(l.GROUPS_CREATED,V,!0),i.register(l.GROUPS_DESTROYED,V,!0),i.register(l.FARM_OVERFLOW_START,B),i.register(l.FARM_OVERFLOW_STOP,q),i.register(l.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,F),i.register(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,Y),i.register(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,j),i.register(l.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(l.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){S=t.getSettings(),A=e.addMenuButton2('Farmer',10),
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,b,f,E,_,w,h){let v,S,A,y,R,k,I,L,x,O,N,P={},C=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},G=z.MINIMAP,D=function(e){v.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(v.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},B=function(e,t){if(!x)return;let a=V(t.x,t.y);var i,n;O=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=_.getTownAt(i,n);if(t)return e(t);_.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[V(e.x,e.y)])return;if(!C)return;I.appendChild(x),x.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=x.getBoundingClientRect(),i=I.getBoundingClientRect(),n=a.width+50,o=a.height+50,s=k.tt.position.y+o>i.top+i.height,l=k.tt.position.x+n>i.width;s&&(k.tt.position.y-=50),x.classList.toggle('left',l),x.classList.toggle('top',s)}))},q=function(e,t){if(!x)return;let a=t?V(t):O;P[a]=!1,C=!1,k.tt.visible=!1,x.classList.add('ng-hide'),L.appendChild(x)},W=function(e,t,i){let o,s,l=a.$new(),r=!0;l.colorPalettes=h.palette,'setting'===e?(s=t,o=N.get(s),r=!1,l.submit=function(){v.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){v.settings[s]=N.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,l.submit=function(){v.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][i],l.submit=function(){n.addHighlight({id:i,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
