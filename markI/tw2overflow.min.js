 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),s=injector.get('routeProvider'),l=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),T=injector.get('reportService'),E=function(){},b=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const i=a.$on(l.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
e.unregister(t,i)})))},t.prototype.destroy=function(){this.listeners.forEach(e=>{e()}),this.onDestroy()},t})),define('two/utils',['helper/time','helper/math'],(function(e,t){let i={randomSeconds:function(e){if(!e)return 0;const t=(e=parseInt(e,10))+e/2,a=e-e/2;return Math.round(Math.random()*(t-a)+a)},time2seconds:function(e){return(e=e.split(':'))[0]=60*parseInt(e[0],10)*60,e[1]=60*parseInt(e[1],10),e[2]=parseInt(e[2],10),e.reduce((function(e,t){return e+t}))},notif:function(e,t){a.$broadcast(l.NOTIFICATION_DISABLE),a.$broadcast(l.NOTIFICATION_ENABLE);const i='success'===e?l.MESSAGE_SUCCESS:l.MESSAGE_ERROR;a.$broadcast(i,{message:t})},genVillageLabel:function(e){return e.name+' ('+e.x+'|'+e.y+')'},isValidCoords:function(e){return/\s*\d{2,3}\|\d{2,3}\s*/.test(e)},isValidDateTime:function(e){return/^\s*([01][0-9]|2[0-3]):[0-5]\d:[0-5]\d(:\d{1,3})? (0[1-9]|[12][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/\d{4}\s*$/.test(e)},fixDate:function(e){const t=e.trim().split(' '),a=t[0],i=t[1].split('/')
;return a+' '+i[1]+'/'+i[0]+'/'+i[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const a=i.fixDate(e).split(' '),n=a[0].split(':'),o=a[1].split('/'),s=n[0],l=n[1],r=n[2],c=n[3]||null,d=parseInt(o[0],10)-1,u=o[1],p=o[2];return new Date(p,d,u,s,l,r,c).getTime()+(t||0)},formatDate:function(e,t){return g('readableDateFilter')(e,null,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+a.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(a,i){if(!e)return i();let n=new XMLHttpRequest;n.open('GET',e,!0),n.responseType=t,n.addEventListener('load',(function(){a(n)}),!1),n.send()}))},obj2selectOptions:function(e,t){let a=[];for(let i in e){let n={name:e[i].name,value:e[i].id};t&&(n.leftIcon=e[i].icon),a.push(n)}return a},getTravelTime:function(e,a,i,o,s,l){
const r=!a.character_id,c=a.character_id&&a.tribe_id&&a.tribe_id===n.getSelectedCharacter().getTribeId();!1!==l&&('attack'===o?('supporter'in s&&delete s.supporter,r&&(l=!0)):'support'===o&&(c&&(l=!0),'supporter'in s&&(l=!0)));const u={units:i,officers:angular.copy(s)},p=d.calculateTravelTime(u,{barbarian:r,ownTribe:c,officers:s,effects:l},o),g=t.actualDistance(e,a);return 1e3*d.getTravelTimeForDistance(u,p,g,o)},each:function(e,t){if('function'!=typeof t&&(t=E),Array.isArray(e)){for(let a=0,i=e.length;a<i;a++)if(!1===t(e[a],a))return!1}else if(angular.isObject(e))for(let a in e)if(b.call(e,a)&&!1===t(e[a],a))return!1;return!0}};return i})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let r={};const c=function(d,u){'string'==typeof(u=u||['map'])&&(u=[u]);const p=function(e){(u=u.filter((function(t){return t!==e}))).length||d()},g={map:function(){if(i.getSharedData('MapController').isInitialized)return p('map');a.$on(l.MAP_INITIALIZED,(function(){p('map')}))},
tribe_relations:function(){const e=n.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return p('tribe_relations')}const t=a.$on(l.TRIBE_RELATION_LIST,(function(){t(),p('tribe_relations')}))},initial_village:function(){if(n.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return p('initial_village');a.$on(l.GAME_STATE_INITIAL_VILLAGE_READY,(function(){p('initial_village')}))},all_villages_ready:function(){if(n.getGameState().getGameState(e.ALL_VILLAGES_READY))return p('all_villages_ready');a.$on(l.GAME_STATE_ALL_VILLAGES_READY,(function(){p('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return p('minimap_data');t.load((function(){p('minimap_data')}))},presets:function(){if(n.getPresetList().isLoaded())return p('presets');r.presets=r.presets||new Promise((function(e){o.emit(s.GET_PRESETS,{},e)})),r.presets.then((function(){p('presets')}))},world_config:function(){if(n.getWorldConfig&&n.getWorldConfig())return p('world_config')
;setTimeout(g.world_config,100)}};if(!i.getSharedData('MapController'))return setTimeout((function(){c(d,u)}),100);u.forEach((function(e){g[e]()}))};return c})),require(['two/ready','Lockr'],(function(e,t){e((function(){let e=n.getSelectedCharacter();t.prefix=e.getId()+'_twOverflow_'+e.getWorldId()+'-'}))})),define('two/language',['helper/i18n'],(function(e){let t=!1;const i={en_us:{about:{contact:"Kontakt",version:"Tw2Master v3.00(baza tw2overflow v2.0.0)",email:"Email",edit:"Od Edytora",editor:"Edytował",edit_autor:"DirtyPrank/Dr Doom/NewPope",text:"Życzę miłej zabawy z Tribal Wars 2 :)",close:"Zamknij",links:"Linki projektów",autor:"Autor",source_autor:"Relaxeaza",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia",donate:"Jeśli wesprzesz mnie donacją $, mogę stworzyć indywidualne skrypty dla ciebie."},activity_tool:{title:"Kwatermistrz"},alert_sender:{title:"Wartownik",
...
full_storage:"Magazyn w wiosce jest pełny",farm_stopped:"Farmer zatrzymany.",farm_started:"Farmer uruchomiony",groups_presets:"Grupy i szablony",presets:"Szablony",group_ignored:"Pomijaj wioski z grupy",group_include:"Dodaj wioski z grupy",group_only:"Atakuj tylko wioski z grup",attack_interval:"Przerwa między atakami (sekundy)",preserve_command_slots:"Rezerwuj sloty poleceń",target_single_attack:"Zezwól celom na jeden atak per wioska",target_multiple_farmers:"Zezwól celom otrzymywać ataki z kilku wiosek",farmer_cycle_interval:"Przerwa pomiędzy cyklami farmienia (minut)",ignore_on_loss:"Pomijaj cele jeśli straty",ignore_full_storage:"Pomijaj wioski jeśli magazyn pełny",step_cycle_header:"Cykl Farmienia",step_cycle:"Włącz Cykl farmienia",step_cycle_notifs:"Powiadomienia",target_filters:"Filtry celów",min_distance:"Minimalna odległość",max_distance:"Maksymalna odległość",min_points:"Minimalna liczba punktów",max_points:"Maksymalna liczba punktów",
max_travel_time:"Maksymalny czas podróży (minuty)",logs_limit:"Maksymalna ilość logów",event_attack:"Logi ataków",event_village_change:"Logi zmiany wiosek",event_priority_add:"Logi celów priorytetowych",event_ignored_village:"Logi pominiętych wiosek",settings_saved:"Ustawienia zapisane!",misc:"Różne",attack:"atakuje",no_logs:"Brak zarejestrowanych logów",clear_logs:"Wyczyść logi",reseted_logs:"Zarejestrowane logi zostały wyczyszczone.",date_added:"Data dodania",multiple_attacks_interval:"Przerwa między atakami (sekundy)",next_cycle_in:"Następny cykl za",target_limit_per_village:"Limit celów na wioskę","settings.hotkeySwitch":"Skrót Start/Pauza","settings.hotkeyWindow":"Skrót okna Farmera","settings.remote":"Sterowanie Zdalne za pomocą wiadomości PW","settingError.minDistance":"Odległość celu musi być większa niż %{min}.","settingError.maxDistance":"Odległość celu nie może przekraczać %{max}.","settingError.maxTravelTime":"Maksymalny czas podróży hh:mm:ss.",
...
settings_colors_barbarian:"Wioski barbarzyńskie",settings_colors_view_reference:"Wskaźnik obecnej pozycji",settings_reset:"Ustawienia zresetowane",tooltip_village:"Wioska",tooltip_village_points:"Punkty wioski",tooltip_player:"Nazwa gracza",tooltip_player_points:"Punkty gracza",tooltip_tribe:"Plemię",tooltip_tribe_points:"Punkty plemienia",tooltip_province:"Prowincja",no_highlights:"Brak utworzonych podświetleń",reset_confirm_title:"Resetuj ustawienia",reset_confirm_text:"Wszystkie ustawienia zostaną przywrócone do domyślnych.",reset_confirm_highlights_text:"Jak również wszystkie podświetlenia zostaną usunięte.",default_village_colors_info:"Informacje o domyślnych kolorach wiosek","entry/id":"Wioska/gracz/plemie","tooltip.village-id":"Id wioski","tooltip.player-id":"Id gracza","tooltip.tribe-id":"Id plemienia"},mint_helper:{title:"Mincerz",description:"Automatycznie wybija monety gdy włączony.",activated:"Mincerz aktywowany",deactivated:"Mincerz deaktywowany"},power_helper:{
title:"Obrona"},prank_helper:{title:"Błazen",rename:"Nazwy wiosek","rename.all":"Zmień nazwy wszystkich wiosek","rename.type":"Typ","rename.prologue":"Prefix/Przedrostek","rename.center":"Nazwa właściwa","rename.epilogue":"Sufix/Przyrostek","rename.name":"Wpisz tekst...","rename.from":"Od (liczba lub litera startowa)","rename.to":"Do (liczba lub litera końcowa)","rename.char":"Wpisz znak...","rename.tip":"Litera lub liczba","rename.clear":"Wyczyść","rename.start":"Zmień","rename.province":"Zmień nazwy wiosek w wybranej prowincji","rename.add_village":"Wybierz wioskę...","rename.no_village":"Nie wybrano wioski","rename.add_map_selected":"Wybrana wioska z mapy","rename.selected":"Wybierz","rename.group":"Zmień nazwy wiosek w wybranej grupie","rename.groups":"Grupa/y",logs:"Logi","logs.village":"Wioska","logs.old":"Stara nazwa","logs.new":"Nowa nazwa","logs.date":"Data","logs.noRenames":"Nie zmieniono żadnych nazw wiosek","logs.clear":"Wyczyść logi",decrease:"Malejąco/Z-A",
increase:"Rosnąco/A-Z",random:"Domyślnie"},preset_creator:{title:"Wojewoda",description:"Automatycznie tworzy szablony do rekrutacji, fejków i farmy.",activated:"Wojewoda aktywowany",done:"Wojewoda utworzył szablony",deactivated:"Wojewoda skończył działanie"},recruit_queue:{title:"Kapitan",presets:"Szablonowa","presets.recruit":"Rekrutacja z szablonów","presets.group":"Grupa wiosek","presets.preset":"Szablon cząstkowy","presets.presetfinal":"Szablon docelowy","presets.start":"Rekrutuj","presets.clear":"Wyczyść",own:"Własne ustawienia","own.recruit":"Rekrutacja wg własnych ustawień","own.group":"Grupa wiosek","own.amount":"Ilość","own.unit":"Jednostka","own.start":"Rekrutuj","own.clear":"Wyczyść",logs:"Logi","logs.clear":"Wyczyść logi","logs.amount":"Ilość","logs.date":"Data","logs.unit":"Jednostka","logs.village":"Wioska","logs.noRecruits":"Nie rozpoczęto żadnych rekrutacji",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",
mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz","general.started":"Kapitan Uruchomiony!","general.stopped":"Kapitan Zatrzymany!"},report_helper:{title:"Skryba"},report_sender:{title:"Goniec",description:"Automatycznie wysyła raporty z misji szpiegowskich, ataków oraz wsparć tworząc odpowiednie wiadomości.",activated:"Goniec aktywowany",deactivated:"Goniec skończył działanie"},special_queue:{title:"Weteran",noble:"Rycerz-Szlachcic","noble.knight":"Rekrutacja rycerza","noble.add_village":"Wybierz wioskę...","noble.no_village":"Nie wybrano wioski","noble.add_map_selected":"Wybrana wioska z mapy","noble.selected":"Wybierz","noble.recruit":"Rekrutuj","noble.nobleman":"Rekrutacja szlachty","noble.noblevillage":"Rekrutacja w wybranej wiosce","noble.byvillage":"Wybierz wioskę w której chcesz rekrutować szlachtę","noble.amount":"Ilość",
...
"support.no_village":"Nie wybrano wioski","support.add_map_selected":"Wybrana wioska z mapy","support.selected":"Wybierz","support.group":"Grupa/y","support.preset":"Szablon","support.textpreset":"Lub wybierz szablon z którego zostaną pobrane ilości jednostek defensywnych","support.distance":"Dystans do wspieranej wioski","support.spear":"Pikinierzy","support.sword":"Miecznicy","support.archer":"Łucznicy","support.heavycavalry":"Ciężka Kawaleria","support.trebuchet":"Trebusze","support.start":"Start","support.pause":"Pauza","support.clear":"Wyczyść",logs:"Logi","logs.origin":"Wioska Źródłowa","logs.target":"Wioska Cel","logs.unit":"Jednostka","logs.amount":"Ilość","logs.date":"Data","logs.noSupports":"Nie wysłano żadnych wsparć.","logs.clear":"Wyczyść logi"},common:{start:"Start",started:"Uruchomiony",pause:"Pauza",paused:"Wstrzymany",stop:"Zatrzymany",stopped:"Zatrzymany",status:"Status",none:"Żaden",info:"Informacje",settings:"Ustawienia",others:"Inne",village:"Wioska",
villages:"Wioski",building:"Budynek",buildings:"Budynki",level:"Poziom",registers:"Rejestry",filters:"Filtry",add:"Dodaj",waiting:"Oczekujące",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",activate:"Aktywuj",deactivate:"Wyłącz",units:"Jednostki",officers:"Oficerowie",origin:"Źródło",target:["Cel","Cele"],save:"Zapisz",logs:"Logi","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas",points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",
market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function s(t){t=b.call(o,t)?o[t]:t,e.setJSON(i[t]||i[n])}let l={init:function(){if(t)return!1;t=!0,s(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&s(a.loc.ale)}))}};return l})),define('two/Settings',['two/utils','Lockr'],(function(e,i){const o=function(e,t){let a={};for(let i in e)b.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a},s=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},l=function(e,t){let a={}
;for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return b.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!b.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),b.call(i,'min')&&(t=Math.max(i.min,t)),b.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t
;const s=angular.copy(this.settings),r=o(n,s);if(!r)return!1;const c=l(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(b.call(this.settingsMap,t)){const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),b.call(a,'min')&&(i=Math.max(a.min,i)),b.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=o(a,i);if(!n)return!1;const s=l(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,s,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!b.call(this.settingsMap,t))continue;let a=this.settingsMap[t]
;'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(i){e.multiSelect?i.length||(t.settings[a]=[s()]):i||(t.settings[a]=s())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const i=n.getPresetList().getPresets(),o=n.getGroupList().getGroups();return e=e||{},this.each((function(n,l,r){if('select'===r.inputType){if(!l&&r.disabledOption)return void(t[n]=r.multiSelect?[s()]:s());switch(r.type){case'presets':if(r.multiSelect){let e=[];l.forEach((function(t){i[t]&&e.push({name:i[t].name,value:t})})),t[n]=e.length?e:[s()]}else{
if(!i[l]&&r.disabledOption)return void(t[n]=s());t[n]={name:i[l].name,value:l}}break;case'groups':if(r.multiSelect){let e=[];l.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[n]=e.length?e:[s()]}else{if(!o[l]&&r.disabledOption)return void(t[n]=s());t[n]={name:o[l].name,value:l}}break;default:t[n]={name:e.textObject?g('i18n')(l,a.loc.ale,e.textObject):l,value:l},e.multiSelect&&(t[n]=[t[n]])}}else t[n]=l})),t},r.prototype.decode=function(e){let t={};for(let a in e){let i=this.settingsMap[a];if('select'===i.inputType)if(i.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let i=[];e[a].forEach((function(e){i.push(e.value)})),t[a]=i}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let i=[];switch((t=t||{}).disabled&&i.push(s()),t.type){case'keys':for(let t in e)i.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];i.push({name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){
let a=e[t];i.push({name:a.name,value:a.id})}break;case'values':default:for(let n in e){let o=e[n];i.push({name:t.textObject?g('i18n')(o,a.loc.ale,t.textObject):o,value:o})}}return i},r.disabledOption=s,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],i=[],n=!1,r=!1,c=[];angular.extend(l,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=E,d){if(d)r=!1;else{if(n)return c.push(e);if(r)return e(t)}c.push(e),n=!0;let u=[];for(let e=0;e<i.length;e++)for(let t=0;t<i[e].length;t++)u.push(i[e][t]);let p=[];return u.forEach((function(e){let a=new Promise((function(a,i){o.emit(s.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return i(e.message);e.villages.length&&(t=t.concat(e.villages)),a()}))}));p.push(a)})),Promise.all(p).then((function(){n=!1,r=!0,a.$broadcast(l.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return r}};return function(){
const t=Math.ceil(e.MAP_SIZE/306),a=Math.ceil(e.MAP_SIZE/306);for(let n=0;n<t;n++){i.push([]);let t=306*n,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let s=0;s<a;s++){let a=306*s,l=306..bound(0,a+306).bound(0,e.MAP_SIZE-a);a=a.bound(0,e.MAP_SIZE),i[n].push({x:t,y:a,width:o,height:l})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,i){let n,o,s,r,c={},d={},u=!1,p=document.querySelector('head'),g=injector.get('httpService'),m=injector.get('templateManagerService'),T=injector.get('$templateCache');return m.load=function(i,n,o){let s;const l=function(e,t,i,o){T.put(s.substr(1),e),angular.isFunction(n)&&n(e,t,i,o),a.$$phase||a.$apply()},r=function(e,t,a,i){angular.isFunction(o)&&o(e,t,a,i)};s=0!==i.indexOf('!')?e.TEMPLATE_PATH_EXT.join(i):i.substr(1),T.get(s.substr(1))?l(T.get(s.substr(1)),304):t.versionMap[s]?g.get(s,l,r):l(d[s],304)},c.init=function(){if(u)return!1
;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div'),l=document.createElement('div'),d=document.createElement('div'),p=document.createElement('div'),g=document.createElement('div'),m=document.createElement('div'),T=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-menu-container2',e.appendChild(a),l.className='two-menu-container3',e.appendChild(l),d.className='two-menu-container4',e.appendChild(d),p.className='two-main-button',p.style.display='none',g.className='two-economy-button',g.style.display='none',m.className='two-intrigue-button',m.style.display='none',T.className='two-other-button',T.style.display='none',t.appendChild(p),a.appendChild(g),l.appendChild(m),d.appendChild(T),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),o=document.createElement('div'),o.className='two-menu2',a.appendChild(o),s=document.createElement('div'),s.className='two-menu3',
l.appendChild(s),r=document.createElement('div'),r.className='two-menu4',d.appendChild(r),u=!0,
...
i((function(){p.style.display='block',g.style.display='block',m.style.display='block',T.style.display='block'}),['map'])},c.addTemplate=function(e,t){d[e]=t},c.addStyle=function(e){let t=document.createElement('style');t.type='text/css',t.appendChild(document.createTextNode(e)),p.appendChild(t)},c.addMenuButton=function(e,t,i){let o=document.createElement('div');return o.className='btn-border btn-orange button',o.innerHTML=e,o.style.order=t,n.appendChild(o),'string'==typeof i&&(o.addEventListener('mouseenter',(function(e){a.$broadcast(l.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),o.addEventListener('mouseleave',(function(){a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip')}))),n.appendChild(o)},c.addMenuButton2=function(e,t,i){let n=document.createElement('div');return n.className='btn-border btn-orange button',n.innerHTML=e,n.style.order=t,o.appendChild(n),'string'==typeof i&&(n.addEventListener('mouseenter',(function(e){a.$broadcast(l.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),
n.addEventListener('mouseleave',(function(){a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip')}))),o.appendChild(n)},c.addMenuButton3=function(e,t,i){let n=document.createElement('div');return n.className='btn-border btn-orange button',n.innerHTML=e,n.style.order=t,s.appendChild(n),'string'==typeof i&&(n.addEventListener('mouseenter',(function(e){a.$broadcast(l.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),n.addEventListener('mouseleave',(function(){a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip')}))),s.appendChild(n)},c.addMenuButton4=function(e,t,i){let n=document.createElement('div');return n.className='btn-border btn-orange button',n.innerHTML=e,n.style.order=t,r.appendChild(n),'string'==typeof i&&(n.addEventListener('mouseenter',(function(e){a.$broadcast(l.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),n.addEventListener('mouseleave',(function(){a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip')}))),r.appendChild(n)},c.addDivisor=function(e){let t=document.createElement('div')
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/activityTool',['two/Settings','two/activityTool/settings','two/activityTool/settings/map','two/activityTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='activity_tool_settings',E=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){
m.push(e[t])})),console.log('selectedGroups',m)},_={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('activityTool settings',d),s((function(){E()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.ACTIVITY_TOOL_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.ACTIVITY_TOOL_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/activityTool/events',[],(function(){angular.extend(l,{ACTIVITY_TOOL_START:'activity_tool_start',ACTIVITY_TOOL_STOP:'activity_tool_stop'})})),
define('two/activityTool/ui',['two/ui','two/activityTool','two/activityTool/settings','two/activityTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,
p.injectScope(u),A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_activity_tool_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.ACTIVITY_TOOL_START,h),e.register(l.ACTIVITY_TOOL_STOP,S),c.getScreenWithInjectedScope('!twoverflow_activity_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Kwatermistrz',60),g.addEventListener('click',v),
...
require(['two/ready','two/activityTool','two/activityTool/ui','two/activityTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,i){let r;var c=injector.get('overviewService'),d=!1,u=!1,p=n.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=n.getSelectedCharacter(),T=m.tribeById[0],E=m.getVillageList(),b=[],_=m.data.character_id,f=m.data.character_name,A=[],w=[],h=[i.LIGHT_CAVALRY,i.HEAVY_CAVALRY,i.AXE,i.SWORD,i.RAM,i.SNOB,i.TREBUCHET];var S=function(){o.emit(s.TRIBE_GET_MEMBERLIST,{tribe:T},(function(e){for(var t=e.members,a=0;a<t.length;a++)w.push(t[a].id)})),E.forEach((function(e){b.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],
villages:b},v),setTimeout(S,6e4)},v=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),w.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(A.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{A.push(i[n].command_id),i[n].slowestUnit=R(i[n]);var l=i[n].time_completed,d=(t=void 0,t=new Date(1e3*l),r=t.toLocaleString(),r),u='',p='';'sword'==i[n].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',u='sword'):'axe'==i[n].slowestUnit?(p=' [color=e21f1f]TOPORNIK[/color]',u='axe'):'ram'==i[n].slowestUnit?(p=' [color=730202]TARAN[/color]',u='ram'):'snob'==i[n].slowestUnit?(p=' [color=ffee00]SZLACHCIC[/color]',u='snob'):'trebuchet'==i[n].slowestUnit?(p=' [color=494500]TREBUSZ[/color]',u='trebuchet'):'light_cavalry'==i[n].slowestUnit?(p=' [color=d96a19]LEKKA KAWALERIA[/color]',
u='light_cavalry'):'heavy_cavalry'==i[n].slowestUnit&&(p=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+p+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+i[n].target_village_id+']'+i[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+_+']'+f+'[/player][b] [br]Wioska pochodzenia: [/b][village='+i[n].origin_village_id+']'+i[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+i[n].origin_character_id+']'+i[n].origin_character_name+'[/player][/size]');var g=a.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==f||'halfsack'==f||'Black Rider'==f?o.emit(s.MESSAGE_REPLY,{message_id:14378,message:g}):o.emit(s.MESSAGE_REPLY,{message_id:4646,message:g}),a=[]):('Hajduk Split'==f||'halfsack'==f||'Black Rider'==f?o.emit(s.MESSAGE_REPLY,{message_id:14379,message:g}):o.emit(s.MESSAGE_REPLY,{message_id:4648,
message:g}),a=[])}},R=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y},s=[];return h.forEach((function(a){i[a]=1,s.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(s=s.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},y={init:function(){d=!0},start:function(){e.trigger(l.ALERT_SENDER_STARTED),u=!0,S()},stop:function(){e.trigger(l.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return y})),define('two/alertSender/events',[],(function(){angular.extend(l,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',60,g('i18n')('description',a.loc.ale,'alert_sender')),
o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'alert_sender')))})),n.register(l.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,a,i,n){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.ALERT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(l.ALERT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),
define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[];const E='army_helper_settings',b={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(b);const _=function(){m=[],T=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP3],i=u[t.GROUP4];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])}))},f={init:function(){p=!0,d=new e({settingsMap:i,storageKey:E}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&_()})),u=d.getAll(),console.log('armyHelper settings',u),a.$on(l.GROUPS_CREATED,_),a.$on(l.GROUPS_DESTROYED,_),
a.$on(l.GROUPS_UPDATED,_)},start:function(){g=!0,c.trigger(l.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(l.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return f})),define('two/armyHelper/events',[],(function(){angular.extend(l,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,E=n.getGroupList();const b={ARMY:'army',BALANCER:'balancer',LOGS:'logs'},_=function(e){p.selectedTab=e},f=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},A=function(){t.isRunning()?t.stop():t.start()},w=function(){p.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,T.classList.remove('btn-orange'),
T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},v=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.ARMY,p.settingsMap=o,p.unit=r.encodeList(s,{textObject:'army_helper',disabled:!0}),m.injectScope(p),w(),p.selectTab=_,p.saveSettings=f,p.switchState=A;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.ARMY_HELPER_START,h),e.register(l.ARMY_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_army_helper_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton('Hetman',90),T.addEventListener('click',v),
...
KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,T,E,b){let _,f,A=!1,w=injector.get('overviewService'),h=[],S=!1,v={},R={},y={reverse:!1,column:i.TIME_COMPLETED};const I='attack_view_filters',k={},O={},x=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in v[e[t]])if(a[e[t]]||(a[e[t]]=[]),v[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}R=a,
R.village=v[c.VILLAGE]?[t]:[]},N=function(){B.loadCommands()},L=function(e,t){b.trigger(l.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<h.length;e++)h[e].command_id===t.command_id&&h.splice(e,1);b.trigger(l.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<h.length;e++)h[e].target_village_id===t.village_id?(h[e].target_village_name=t.name,h[e].targetVillage.name=t.name):h[e].origin_village_id===t.village_id&&(h[e].origin_village_name=t.name,h[e].originVillage.name=t.name);b.trigger(l.ATTACK_VIEW_VILLAGE_RENAMED,[t])},C=function(e,t){R[c.VILLAGE].length&&(R[c.VILLAGE]=[t],B.loadCommands())},U=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},G=function(e,t){return e.sort((function(e,a){
return m.actualDistance(t,e)-m.actualDistance(t,a)}))},D=function(e,t){let a=0;if(E.hasTownDataInChunk(e.x,e.y)){const a=E.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let s,l=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=G(r,e);else if(c.length)s=G(c,e);else{if(!i)return t(!1);{const a=l.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);s=G(a,e)}}return t(s[0])}const i=T.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&D(e,t)}))},z=function(e){h=e.commands;for(let e=0;e<h.length;e++)w.formatCommand(h[e]),h[e].slowestUnit=U(h[e]);h=h.filter((function(e){return v[c.INCOMING_UNITS][e.slowestUnit]})),b.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[h])};let B={
loadCommands:function(){const e=_.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:R[c.COMMAND_TYPES],villages:R[c.VILLAGE]},z)},getCommands:function(){return h},getFilters:function(){return v},getSortings:function(){return y},toggleFilter:function(e,t){t?v[e][t]=!v[e][t]:v[e]=!v[e],x(),g.set(I,v),B.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),B.loadCommands()},setCommander:function(e,a){D(e.targetVillage,(function(i){const n=e.targetVillage,o=i,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){l[e]='*'})),S.addCommand(n,o,a,f.OUT,l,{},s,p.WALL),S.isRunning()||S.start()}))},commandQueueEnabled:function(){return!!S},isInitialized:function(){return A},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in r)O[r[e]]=!0;try{S=require('two/commandQueue'),
f=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(O),[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};A=!0,_=n.getSelectedCharacter().getGlobalInfo(),v=g.get(I,t,!0),e((function(){x(),a.$on(l.COMMAND_INCOMING,N),a.$on(l.COMMAND_CANCELLED,L),a.$on(l.MAP_SELECTED_VILLAGE,C),a.$on(l.VILLAGE_NAME_CHANGED,M),a.$on(l.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(l,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,s,d,u,T,E,b,_,f){let A,w;const h=function(){return Date.now()/1e3},S=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},v=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},R=function(){let e=f('#two-attack-view').parent(),t=f('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=A.pagination.offset,t=A.pagination.limit
;A.visibleCommands=A.commands.slice(e,e+t),A.pagination.count=A.commands.length},I=function(){const e=Date.now();for(let t=0;t<A.commands.length;t++)100===A.commands[t].model.percent(e)&&A.commands.splice(t,1);y()},k=function(e,a){t.toggleFilter(e,a),A.filters=t.getFilters()},O=function(e){t.toggleSorting(e),A.sorting=t.getSortings()},x=function(){A.commands=t.getCommands()},N=function(){A.selectedVillageId=n.getSelectedVillage().getId()},L=function(){A=a.$new(),A.commandQueueEnabled=t.commandQueueEnabled(),A.commands=t.getCommands(),A.selectedVillageId=n.getSelectedVillage().getId(),A.filters=t.getFilters(),A.sorting=t.getSortings(),A.UNIT_TYPES=E,A.FILTER_TYPES=u,A.COMMAND_TYPES=d,A.UNIT_SPEED_ORDER=T,A.COLUMN_TYPES=s,A.pagination={count:A.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},A.openCharacterProfile=r.openCharacterProfile,A.openVillageInfo=r.openVillageInfo,A.jumpToVillage=p.jumpToVillage,A.now=h,A.copyTimeModal=S,A.removeTroops=v,A.switchWindowSize=R,
A.toggleFilter=k,A.toggleSorting=O,y();let e=new i('twoverflow_queue_window',(function(){_.timer.remove(I)}));e.register(l.MAP_SELECTED_VILLAGE,N,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,x),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,x),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,x),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,x),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',A),_.timer.add(I)};return function(){w=e.addMenuButton('Strażnik',30),w.addEventListener('click',L),
...
}})),define('two/attackView/types/columns',[],(function(){return{ORIGIN_VILLAGE:'origin_village_name',COMMAND_TYPE:'command_type',TARGET_VILLAGE:'target_village_name',TIME_COMPLETED:'time_completed',ORIGIN_CHARACTER:'origin_character_name'}})),define('two/attackView/types/commands',[],(function(){return{ATTACK:'attack',SUPPORT:'support',RELOCATE:'relocate'}})),define('two/attackView/types/filters',[],(function(){return{COMMAND_TYPES:'command_types',VILLAGE:'village',INCOMING_UNITS:'incoming_units'}})),define('two/attackView/unitSpeedOrder',['conf/unitTypes'],(function(e){return[e.LIGHT_CAVALRY,e.HEAVY_CAVALRY,e.AXE,e.SWORD,e.RAM,e.SNOB,e.TREBUCHET]})),require(['two/ready','two/attackView','two/attackView/ui','two/attackView/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/autoCollector',['queues/EventQueue'],(function(e){let t=!1,i=!1,r=!0,c=0;const d=function(){o.emit(s.RESOURCE_DEPOSIT_GET_INFO,{})},u=function(){if(!i)return!1
;let e=n.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return a=t.shift(),void o.emit(s.RESOURCE_DEPOSIT_COLLECT,{job_id:a.id,village_id:n.getSelectedVillage().getId()});var a;let l=e.getReadyJobs();return l?function(e){o.emit(s.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(p(l)):void 0},p=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let g={};return g.init=function(){t=!0,a.$on(l.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!r||!i)return!1;r=!1,setTimeout((function(){r=!0,u()}),1500)})),a.$on(l.RESOURCE_DEPOSIT_JOBS_REROLLED,u),a.$on(l.RESOURCE_DEPOSIT_JOB_COLLECTED,u),a.$on(l.RESOURCE_DEPOSIT_INFO,(function(e,t){u(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},g.start=function(){e.trigger(l.AUTO_COLLECTOR_STARTED),i=!0,u()},g.stop=function(){e.trigger(l.AUTO_COLLECTOR_STOPPED),i=!1},g.isRunning=function(){return i},
g.isInitialized=function(){return t},g})),define('two/autoCollector/events',[],(function(){angular.extend(l,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Kolekcjoner',40,g('i18n')('description',a.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_collector')))})),n.register(l.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(l.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,i,r,c){let d=!1,u=!1,p=!1,g=injector.get('secondVillageService');const m=function(){var e;e=T,o.emit(s.SECOND_VILLAGE_GET_INFO,{},(function(t){if(g.hasFinishedLastJob(t.jobs))p=!0,o.emit(s.SECOND_VILLAGE_FINISH_VILLAGE),E.stop();else{let a=new c(t);n.getSelectedCharacter().setSecondVillage(a),e()}}))},T=function(){let e=n.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const a=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t<r.server2ClientTime(e[a].time_completed))return e[a];return!1}(e.data.jobs);if(a){const e=r.server2ClientTime(a.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const i=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t>=r.server2ClientTime(e[a].time_completed)&&!e[a].collected)return a;return!1}(e.data.jobs);if(i)return l=i,void o.emit(s.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:n.getSelectedVillage().getId(),job_id:l});var l;const c=g.getCurrentDayJobs(e.data.jobs,e.data.day),d=g.getCollectedJobs(e.data.jobs),p=n.getSelectedVillage().getResources().getResources(),T=g.getAvailableJobs(c,d,p,[]);if(T){const e=function(e){let a=!1;return t.each(e,(function(e){return a=e,!1})),a}(T);!function(e,t){o.emit(s.SECOND_VILLAGE_START_JOB,{village_id:n.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=T[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let E={start:function(){if(!d||p)return!1;i.trigger(l.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,m()},stop:function(){if(!d)return!1;i.trigger(l.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!g.isFeatureActive())return!1;d=!0,o.emit(s.SECOND_VILLAGE_GET_INFO,{},(function(e){g.hasFinishedLastJob(e.jobs)?(p=!0,o.emit(s.SECOND_VILLAGE_FINISH_VILLAGE)):(a.$on(l.SECOND_VILLAGE_VILLAGE_CREATED,m),a.$on(l.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=E})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,a,i,n){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),a(),e((function(){i.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),n.register(l.AUTO_COLLECTOR_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_COLLECTOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/autoFoundator',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,i=!1;const r=function(){if(!i)return!1;console.log('Fundator uruchomiony'),
n.getSelectedCharacter().getVillageList().forEach((function(e,t){var a=e.getResources().getComputed(),i=a.wood,n=a.clay,l=a.iron,r=i.currentStock,c=n.currentStock,d=l.currentStock,u=Math.round(.02*r)+1,p=Math.round(.02*d)+1,g=Math.round(.02*c)+1;setTimeout((function(){o.emit(s.TRIBE_SKILL_DONATE,{village_id:e.getId(),crowns:0,resources:{wood:u,clay:g,iron:p}})}),t*Math.random()*3e3),console.log('Wykonano darowizne na plemię: '+e.getName()+' drewno: '+u+', glina: '+g+', żelazo: '+p)})),setTimeout(c,1e3)};function c(){setTimeout(r,36e5)}let d={init:function(){a=!0},start:function(){t.trigger(l.AUTO_FOUNDATOR_STARTED),i=!0,r()},stop:function(){t.trigger(l.AUTO_FOUNDATOR_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return a}};return d})),define('two/autoFoundator/events',[],(function(){angular.extend(l,{AUTO_FOUNDATOR_STARTED:'auto_foundator_started',AUTO_FOUNDATOR_STOPPED:'auto_foundator_stopped'})})),
define('two/autoFoundator/ui',['two/ui','two/autoFoundator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor3(71),o=e.addMenuButton3('Fundator',70,g('i18n')('description',a.loc.ale,'auto_foundator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_foundator'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_foundator')))})),n.register(l.AUTO_FOUNDATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.AUTO_FOUNDATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.AUTO_FOUNDATOR_STARTED),opener}})),require(['two/ready','two/autoFoundator','two/autoFoundator/ui','Lockr','queues/EventQueue','two/autoFoundator/events'],(function(e,t,a,i,n){const o='auto_foundator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){
i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_FOUNDATOR_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_FOUNDATOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let i=!1,r=!1;let c={init:function(){i=!0}};return c.start=function(){t.trigger(l.AUTO_HEALER_STARTED),r=!0,function(){if(!r)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let a=e.hospital.patients.healed;0==a.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){a.forEach((function(t,a){setTimeout((function(){o.emit(s.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*a),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(l.AUTO_HEALER_STOPPED),r=!1},
c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/autoHealer/events',[],(function(){angular.extend(l,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Medyk',120,g('i18n')('description',a.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_healer')))})),n.register(l.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.AUTO_HEALER_STARTED),opener}})),
require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,a,i,n){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/autoWithdraw',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,i=!1,n={init:function(){a=!0},start:function(){t.trigger(l.AUTO_WITHDRAW_STARTED),i=!0},stop:function(){t.trigger(l.AUTO_WITHDRAW_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return a}};return n})),define('two/autoWithdraw/events',[],(function(){angular.extend(l,{AUTO_WITHDRAW_STARTED:'auto_withdraw_started',AUTO_WITHDRAW_STOPPED:'auto_withdraw_stopped'})})),define('two/autoWithdraw/ui',['two/ui','two/autoWithdraw','two/utils','queues/EventQueue'],(function(e,t,i,n){let o
;return function(){return o=e.addMenuButton('Dezerter',40,g('i18n')('description',a.loc.ale,'auto_withdraw')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_withdraw'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_withdraw')))})),n.register(l.AUTO_WITHDRAW_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.AUTO_WITHDRAW_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.AUTO_WITHDRAW_STARTED),opener}})),require(['two/ready','two/autoWithdraw','two/autoWithdraw/ui','Lockr','queues/EventQueue','two/autoWithdraw/events'],(function(e,t,a,i,n){const o='auto_withdraw_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_WITHDRAW_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_WITHDRAW_STOPPED,(function(){i.set(o,!1)}))
}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c,d,u,p,g,m,T,E,b,_,f){let A,w,h=!1,S=!1,v=[];const R='battle_calculator_settings',y={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},I={[s.HALBERD_OF_GUAN_YU]:'spear',[s.PARACELSUS_LONGSWORD]:'sword',[s.THORGARDS_BATTLE_AXE]:'axe',[s.NIMRODS_LONGBOW]:'archer',[s.MIESZKOS_LANCE]:'lc',[s.NIMRODS_COMPOSITE_BOW]:'ma',[s.BAPTISTES_BANNER]:'hc',
[s.CAROLS_MORNING_STAR]:'ram',[s.ALETHEIAS_BONFIRE]:'catapult',[s.VASCOS_SCEPTER]:'snob'},k={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},O={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},x={[p.NO_CHURCH]:50,[p.LEVEL_1]:100,[p.LEVEL_2]:105,[p.LEVEL_3]:110},N={[u.NO_WALL]:0,[u.LEVEL_1]:5,[u.LEVEL_2]:10,[u.LEVEL_3]:15,[u.LEVEL_4]:20,[u.LEVEL_5]:25,[u.LEVEL_6]:30,[u.LEVEL_7]:35,[u.LEVEL_8]:40,[u.LEVEL_9]:45,[u.LEVEL_10]:50,[u.LEVEL_11]:55,[u.LEVEL_12]:60,[u.LEVEL_13]:65,[u.LEVEL_14]:70,[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},L={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},M={[T.LEVEL_1]:100,[T.LEVEL_2]:200,[T.LEVEL_3]:300,[T.LEVEL_4]:400,[T.LEVEL_5]:500,[T.LEVEL_6]:600,[T.LEVEL_7]:700,[T.LEVEL_8]:800,[T.LEVEL_9]:900,[T.LEVEL_10]:1e3},C={[E.LEVEL_1]:100,[E.LEVEL_2]:129,[E.LEVEL_3]:167,[E.LEVEL_4]:215,[E.LEVEL_5]:278,[E.LEVEL_6]:359,[E.LEVEL_7]:464,[E.LEVEL_8]:599,[E.LEVEL_9]:774,[E.LEVEL_10]:1e3},U={[b.LEVEL_1]:4,[b.LEVEL_2]:8,[b.LEVEL_3]:12,[b.LEVEL_4]:16,[b.LEVEL_5]:20};console.log(O,U,C,M,P,L,N,x,y,I,k);const G=function(){v=[];const e=n.getPresetList().getPresets();w[t.PRESET].forEach((function(t){v.push(e[t])}))},D={init:function(){h=!0,A=new e({settingsMap:i,storageKey:R}),A.onChange((function(e,t){w=A.getAll(),t[o.PRESETS]&&G()})),w=A.getAll(),console.log('battleCalculator settings',w),_((function(){G()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,G),a.$on(l.ARMY_PRESET_DELETED,G)},start:function(){S=!0,f.trigger(l.BATTLE_CALCULATOR_START)},
stop:function(){S=!1,console.log('battleCalculator stop'),f.trigger(l.BATTLE_CALCULATOR_STOP)},getSettings:function(){return A},isInitialized:function(){return h},isRunning:function(){return S}};return D})),define('two/battleCalculator/events',[],(function(){angular.extend(l,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p,g,m,T,E,b,_,f,A,w){let h,S,v,R=n.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},I=function(e){h.selectedTab=e},k=function(){S.setAll(S.decode(h.settings)),w.notif('success','Settings saved')},O=function(){t.isRunning()?t.stop():t.start()},x=function(){h.presets=f.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},N=function(){
h.running=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),w.notif('success','battleCalculator started')},L=function(){h.running=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),w.notif('success','battleCalculator stopped')},P=function(){h=a.$new(),h.SETTINGS=i,h.TAB_TYPES=y,h.running=t.isRunning(),h.selectedTab=y.BATTLE,h.settingsMap=o,h.catapulttarget=f.encodeList(d,{textObject:'battle_calculator',disabled:!0}),h.knightitem=f.encodeList(s,{textObject:'battle_calculator',disabled:!0}),h.itemlevel=f.encodeList(r,{textObject:'battle_calculator',disabled:!0}),h.order=f.encodeList(u,{textObject:'battle_calculator',disabled:!0}),h.wall=f.encodeList(p,{textObject:'battle_calculator',disabled:!0}),h.church=f.encodeList(g,{textObject:'battle_calculator',disabled:!0}),h.weaponmaster=f.encodeList(m,{textObject:'battle_calculator',disabled:!0}),h.ironwalls=f.encodeList(T,{textObject:'battle_calculator',disabled:!0}),h.clinique=f.encodeList(E,{
textObject:'battle_calculator',disabled:!0}),h.hospital=f.encodeList(b,{textObject:'battle_calculator',disabled:!0}),h.training=f.encodeList(_,{textObject:'battle_calculator',disabled:!0}),S.injectScope(h),x(),h.selectTab=I,h.saveSettings=k,h.switchState=O;let e=new A('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(l.ARMY_PRESET_UPDATE,x,!0),e.register(l.ARMY_PRESET_DELETED,x,!0),e.register(l.BATTLE_CALCULATOR_START,N),e.register(l.BATTLE_CALCULATOR_STOP,L),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',h)};return function(){S=t.getSettings(),v=e.addMenuButton4('Kalkulator',10),v.addEventListener('click',P),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,E,b,_){let f,A,w,h=injector.get('buildingService'),S=injector.get('premiumActionService'),v=injector.get('buildingQueueService'),R=!1,y=!1;const I={};let k,O,x,N,L,P=!0;const M='builder_queue_log',C='builder_queue_settings',U=function(){const e=D();if(!P)return F.stop(),!1;e.forEach((function(e){const t=O.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void z(t))}))},G=function(){D().forEach((function(e){const t=O.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
v.canBeFinishedForFree(a,t)&&S.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},D=function(){const e=L[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return O.getVillage(e)}))):t.each(O.getVillages(),(function(e){a.push(e.getId())})),a},z=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=L[r.BUILDING_SEQUENCES][L[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),q(t))return!1;n.some((function(a){if(++i[a]>t[a])return h.compute(e),B(e,a,(function(t,a){t&&a.job&&(E.trigger(l.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=W(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&L[r.PRIORIZE_FARM]){const t=w[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-L[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-L[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-L[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},q=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},Y=function(e,t){let a={time:_.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),b.set(M,x),!0};let F={};return F.start=function(){if(!P)return E.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,f=setInterval(U,6e4),A=setInterval(G,6e3),e((function(){D().forEach((function(e){const t=O.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),U(),G()}),['all_villages_ready']),E.trigger(l.BUILDER_QUEUE_START)},F.stop=function(){y=!1,clearInterval(f),
clearInterval(A),E.trigger(l.BUILDER_QUEUE_STOP)},F.isRunning=function(){return y},F.isInitialized=function(){return R},F.getSettings=function(){return N},F.getLogs=function(){return x},F.clearLogs=function(){x=[],b.set(M,x),E.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=L[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){R=!0,x=b.get(M,[],!0),O=n.getSelectedCharacter(),k=n.getGroupList(),N=new i({settingsMap:c,storageKey:C}),N.onChange((function(e,t,a){L=N.getAll(),y&&t[d.ANALYSE]&&U(),a.quiet||E.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),L=N.getAll();for(let e in m)I[m[e]]=0;P=Object.keys(L[r.BUILDING_SEQUENCES]).length,w=!!P&&function(e){const t=L[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(L[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=O.getVillage(t.village_id);z(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
t.MuryMax=[e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL,e.WALL],t.Farma=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],
...
t.KomturiaMax=[e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.HEADQUARTER,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY,e.PRECEPTORY],t.RynekMax=[e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET,e.MARKET],
t.KoszarMax=[e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS,e.BARRACKS],t.SzpitalMax=[e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL,e.HOSPITAL],
...
t.EkoMax=[e.WAREHOUSE,e.TIMBER_CAMP,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.IRON_MINE,e.IRON_MINE,e.IRON_MINE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.IRON_MINE,e.IRON_MINE,e.IRON_MINE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.TIMBER_CAMP,e.CLAY_PIT,e.TIMBER_CAMP,e.TIMBER_CAMP,e.TIMBER_CAMP,e.CLAY_PIT,e.TIMBER_CAMP,e.CLAY_PIT,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.WAREHOUSE,e.WAREHOUSE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.CLAY_PIT,e.IRON_MINE,e.TIMBER_CAMP,e.CLAY_PIT,e.CLAY_PIT,e.IRON_MINE],
function(e){let t={};for(let i in e)b.call(e,i)&&(t[i]=a(e[i]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(l,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),
define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,E,_,f,A,w,h){let S,v,R,y,I=n.getGroupList(),k={},O=!1,x={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},L={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,C={},U={},G=!1,D=!1;const z=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case _.SEQUENCE_SAVED:return!0;case _.SEQUENCE_EXISTS:return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case _.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}}
;N.generateSequences=function(){const e=y.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=S.settings[T.ACTIVE_SEQUENCE].value,t=S.settings[T.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in f)i[f[e]]=0;N.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],s='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(s='progress'):s='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:h.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:s}}))},
N.generateBuildingSequenceFinal=function(e){const t=S.settings[T.ACTIVE_SEQUENCE].value,a=S.settings[T.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in R)i[e]={level:0,order:R[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=R[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=k[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});N.buildingSequenceFinal=n},N.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequence.offset,t=S.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),S.pagination.buildingSequence.count=N.buildingSequence.length},
N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,k[a]=[];for(let e=1;e<=i.max_level;e++){let n=z(i.points,i.points_factor,e)-t;t+=n,k[a].push(n)}}},x.moveUp=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(G=!0)},x.moveDown=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),B(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(G=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o)
;return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),G=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),G=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<R[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=y.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in f)i[f[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),
S.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case _.SEQUENCE_SAVED:G=!1;break;case _.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case _.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(x.selectedSequence.value),G=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){
let e=a.$new();e.buildings=[],e.position=x.lastAddedIndex,e.indexLimit=x.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(x.lastAddedBuilding,a.loc.ale,'building_names'),value:x.lastAddedBuilding};for(let t in R)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),s=R[t].max_level;x.lastAddedBuilding=t,x.lastAddedIndex=i,x.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,s))},c.getModal('!twoverflow_builder_queue_add_building_modal',e)},x.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=x.selectedSequence.name,i=S.settings[T.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){
if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(G){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},L.updateVisibleLogs=function(){const e=S.pagination.logs.offset,t=S.pagination.logs.limit;L.visibleLogs=L.logs.slice(e,e+t),S.pagination.logs.count=L.logs.length,L.visibleLogs.forEach((function(e){e.villageId&&function(e){if(C[e])return C[e];C[e]=!0,U[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1
},(function(t){C[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},U[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},L.clearLogs=function(){i.clearLogs()};const W=function(){let e=a.$new();const t=[f.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,t)&&(S.settings[T.ACTIVE_SEQUENCE]={name:e.name,value:e.name},S.settings[T.BUILDING_SEQUENCES][e.name]=t,Y(),N.selectedSequence={name:e.name,value:e.name},x.selectedSequence={name:e.name,value:e.name},N.generateSequences(),x.generateBuildingSequence(),e.closeWindow(),q(P.SEQUENCES))},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},q=function(e){S.selectedTab=e},Y=function(){y.setAll(y.decode(S.settings)),G=!1},F=function(){i.isRunning()?i.stop():i.start()},H=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),
i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},j=function(){G?H((function(){M()})):M()},K={updateGroups:function(){S.groups=p.encodeList(I.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=y.get(T.BUILDING_SEQUENCES);S.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){x.generateBuildingSequence()},updateLogs:function(){S.logs=i.getLogs(),L.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=y.get(T.BUILDING_SEQUENCES);S.settings[T.BUILDING_SEQUENCES][t]=i[t],
S.settings[T.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=y.get(T.BUILDING_SEQUENCES);S.settings[T.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete S.settings[T.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(b.call(e,t))return t;return!1}(S.settings[T.BUILDING_SEQUENCES]);x.selectedSequence={name:i,value:i},K.updateSequences(),x.generateBuildingSequence(),y.get(T.ACTIVE_SEQUENCE)===t&&(y.set(T.ACTIVE_SEQUENCE,i,{quiet:!0}),N.generateSequences()),d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){S.running=!0},stopped:function(){S.running=!1}},Q=function(){const e=y.get(T.ACTIVE_SEQUENCE)
;S=a.$new(),S.selectedTab=P.SETTINGS,S.TAB_TYPES=P,S.SETTINGS=T,S.running=O,S.pagination={},S.settingsMap=y.settingsMap,S.villagesLabel=U,S.villagesInfo=C,S.editorView=x,S.editorView.buildingSequence={},S.editorView.visibleBuildingSequence=[],S.editorView.selectedSequence={name:e,value:e},S.editorView.lastAddedBuilding=f.HEADQUARTER,S.editorView.lastAddedIndex=1,S.settingsView=N,S.settingsView.buildingSequence={},S.settingsView.buildingSequenceFinal={},S.logsView=L,S.logsView.logs=i.getLogs(),S.selectTab=q,S.switchBuilder=F,S.saveSettings=Y,S.createSequence=W,S.openVillageInfo=r.openVillageInfo,y.injectScope(S),K.updateGroups(),K.updateSequences(),S.pagination.buildingSequence={count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.buildingSequenceEditor={count:x.buildingSequence.length,offset:0,loader:x.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.logs={count:L.logs.length,offset:0,
loader:L.updateVisibleLogs,limit:m.getPaginationLimit()},L.updateVisibleLogs(),N.generateSequences(),x.generateBuildingSequence();let t=new A('twoverflow_builder_queue_window');t.register(l.GROUPS_UPDATED,K.updateGroups,!0),t.register(l.GROUPS_CREATED,K.updateGroups,!0),t.register(l.GROUPS_DESTROYED,K.updateGroups,!0),t.register(l.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(l.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(l.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),
t.register(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(l.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(l.BUILDER_QUEUE_START,K.started),t.register(l.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',S),M=S.closeWindow,S.closeWindow=j,S.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),S.$watch('editorView.selectedSequence.value',(function(e,t){D?D=!1:e!==t&&(G?H((function(){K.generateBuildingSequencesEditor(),G=!1}),(function(){S.editorView.selectedSequence={name:t,value:t},D=!0})):K.generateBuildingSequencesEditor())}))};return function(){R=n.getGameData().getBuildings(),N.generateBuildingsLevelPoints(),y=i.getSettings(),v=e.addMenuButton2('Budowniczy',20),v.addEventListener('click',Q),w.register(l.BUILDER_QUEUE_START,(function(){O=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),
d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),w.register(l.BUILDER_QUEUE_STOP,(function(){O=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const w=Object.values(c),h=Object.values(a),S=Object.values(A),v=Object.values(f),R=Object.values(_);let y,I=[],k={},O=[],x=[],N=!1;const L={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+y},M=function(e){I.push(e)},C=function(e){k[e.id]=e},U=function(){
E.set(d.QUEUE_COMMANDS,I)},G=function(e){return!isNaN(e)&&e>0&&e<1e3},D=function(e){return b.call(e,'x')&&b.call(e,'y')&&G(e.x)&&G(e.y)};let z={initialized:!1};return z.init=function(){y=t.getTimeOffset(),z.initialized=!0,O=E.get(d.QUEUE_SENT,[],!0),x=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?z.expireCommand(e,i.TIME_LIMIT):(M(e),C(e))}))}(),setInterval((function(){I.length&&I.some((function(e){if(!P(e.sendTime))return!0;N?z.sendCommand(e):z.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&I.length&&(e.returnValue=!0)}))},z.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let s={},l=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return l=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return l=i.NOT_ENOUGH_UNITS,!1;s[t]=e})),angular.equals({},s)&&(l=i.NOT_ENOUGH_UNITS),l||s}(e);if('string'==typeof a)return z.expireCommand(e,a);e.units=a,o.emit(s.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){O.push(e)}(e),E.set(d.QUEUE_SENT,O),z.removeCommand(e,i.COMMAND_SENT),p.trigger(l.COMMAND_QUEUE_SEND,e)},z.expireCommand=function(e,t){!function(e){x.push(e)}(e),E.set(d.QUEUE_EXPIRED,x),z.removeCommand(e,t)},z.addCommand=function(e,i,o,s,l,r,d,p){let m={},E={};return new Promise((function(b,y){if(!D(e))return y(u.INVALID_ORIGIN);if(!D(i))return y(u.INVALID_TARGET);if(!t.isValidDateTime(o))return y(u.INVALID_DATE);if(angular.isObject(l)){if(!t.each(l,(function(e,t){if(!S.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return y(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!v.includes(t))return!1;r[t]&&(E[t]=!0)})))return y(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[f.SUPPORTER]&&delete E[f.SUPPORTER],'string'!=typeof p||R.includes(p)?(p=!(d!==c.ATTACK||!m[A.CATAPULT])&&(p||_.HEADQUARTER),h.includes(s)?void Promise.all([new Promise(t=>T.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>T.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return y(u.INVALID_ORIGIN);if(!i)return y(u.INVALID_TARGET);const l=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,E,!0),c=s===a.ARRIVE?l-r:l,T=s===a.ARRIVE?l:l+r;if(P(c))return y(u.ALREADY_SENT);const _={id:t.guid(),travelTime:r,arriveTime:T,sendTime:c,origin:e,target:i,date:o,dateType:s,units:m,officers:E,type:d,catapultTarget:p,countdown:c-g.gameTime()};M(_),C(_),I=I.sort((function(e,t){return e.sendTime-t.sendTime})),
U(),b(_)})):y(u.INVALID_DATE_TYPE)):y(u.INVALID_CATAPULT_TARGET)):y(u.RELOCATE_DISABLED):y(u.INVALID_COMMAND_TYPE)}))},z.removeCommand=function(e,t){delete k[e.id];const a=I.some((function(t,a){if(t.id==e.id)return I.splice(a,1),U(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(l.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(l.COMMAND_QUEUE_REMOVE,e)}else p.trigger(l.COMMAND_QUEUE_REMOVE_ERROR,e);return a},z.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),x=[],O=[]},z.start=function(e){N=!0,p.trigger(l.COMMAND_QUEUE_START,{disableNotif:!!e})},z.stop=function(){N=!1,p.trigger(l.COMMAND_QUEUE_STOP)},z.isRunning=function(){return N},z.getWaitingCommands=function(){return I},z.getWaitingCommandsObject=function(){return k},z.getSentCommands=function(){return O},
z.getExpiredCommands=function(){return x},z.filterCommands=function(e,t,a){const i=L[e];return(a||I).filter((function(e){return i(e,t)}))},z})),define('two/commandQueue/events',[],(function(){angular.extend(l,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,s,d,u,p,m,T,E,b,_,f,A){let w,h,S,v,R,y=n.getGameData(),I=y.getOrderedUnitNames(),k=y.getOrderedOfficerNames(),O=n.getPresetList(),x=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},L=N.ADD;let P,M,C,U=[],G={},D={};const z={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){x=t.data},W=function(){x=!1},q=function(e){
const t=new Date(e||_.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=_.zerofill(a-a%100,3),n=_.zerofill(t.getSeconds(),2),s=_.zerofill(t.getMinutes(),2);return _.zerofill(t.getHours(),2)+':'+s+':'+n+':'+i+' '+_.zerofill(t.getDate(),2)+'/'+_.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),q(e+=t)):''},F=function(){if(w.isValidDate=o.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!w.isValidDate&&o.getTimeFromString(R.date),t=w.selectedDateType.value===s.ARRIVE;o.each(p,(function(a){o.each(z,(function(i,n){const s=o.getTravelTime(R.origin,R.target,i,a,R.officers,!0);w.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(s),w.travelTimes[a][n].status=e?H(t?e-s:e):'neutral'}))}))},H=function(e){return e&&w.isValidDate?_.gameTime()+P<e?'valid':'invalid':'neutral'},j=function(){R.dateType=w.selectedDateType.value,A.set(m.LAST_DATE_TYPE,w.selectedDateType.value),F()},K=function(){
R.catapultTarget=w.catapultTarget.value},Q=function(){const e=w.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},R.units=angular.copy(t.units),R.officers=angular.copy(t.officers),t.catapult_target&&(R.catapultTarget=t.catapult_target,w.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},w.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=_.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),_.timer.add(e.updateCountdown)},Z=function(){w.waitingCommands=t.getWaitingCommands()},J=function(){w.sentCommands=t.getSentCommands()},$=function(){w.expiredCommands=t.getExpiredCommands()},ee=function(){let e=w.waitingCommands;B.forEach((function(a){w.activeFilters[a]&&(e=t.filterCommands(a,w.filtersData,e))})),
w.visibleWaitingCommands=e},te=function(e){0===R.units[e]&&(R.units[e]='')},ae=function(e){''===R.units[e]&&(R.units[e]=0)},ie=function(){w.showCatapultSelect=!!R.units.catapult},ne=function(e){w.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;R.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:S.getId()}},se=function(){if(!x)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));b.loadTownDataAsync(x.x,x.y,1,1,(function(e){R.target=e}))},le=function(){R.date=q()},re=function(){if(!R.date)return!1;R.date=Y(R.date,100)},ce=function(){if(!R.date)return!1;R.date=Y(R.date,-100)},de=function(){R.units=angular.copy(G),R.officers=angular.copy(D),R.catapultTarget="wall",w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},ue=function(e){t.addCommand(R.origin,R.target,R.date,R.dateType,R.units,R.officers,e,R.catapultTarget).then((function(e){Z(),ee(),X(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case T.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case T.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case T.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case T.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case T.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case T.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},Te=function(e,t){w.activeFilters[e]=!w.activeFilters[e],
t&&(w.filtersData[u.ALLOWED_TYPES][e]=!w.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){w.activeFilters[u.TEXT_MATCH]=w.filtersData[u.TEXT_MATCH].length>0,ee()},be={updatePresets:function(){w.presets=o.obj2selectOptions(O.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;R[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},w.searchQuery[i]=''},removeCommand:function(e,t){_.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(l.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){_.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(w.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){w.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){R.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){R.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{_.timer.remove(e.updateCountdown)})}},_e=function(){const e=A.get(m.LAST_DATE_TYPE,s.OUT,!0);let T;w=a.$new(),w.selectedTab=L,w.inventory=n.getInventory(),w.presets=o.obj2selectOptions(O.getPresets()),w.travelTimes={},o.each(p,(function(e){w.travelTimes[e]={},o.each(z,(function(t,a){w.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=v,w.officers=y.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=f.toActionList(s,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),w.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:be.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!R.units.catapult,w.attackableBuildings=U,w.commandData=R,
w.activeFilters=M,w.filtersData=C,w.running=t.isRunning(),w.waitingCommands=t.getWaitingCommands(),w.visibleWaitingCommands=t.getWaitingCommands(),w.sentCommands=t.getSentCommands(),w.expiredCommands=t.getExpiredCommands(),w.EVENT_CODES=d,w.FILTER_TYPES=u,w.TAB_TYPES=N,w.COMMAND_TYPES=p,w.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),w.onUnitInputFocus=te,w.onUnitInputBlur=ae,w.catapultTargetVisibility=ie,w.selectTab=ne,w.addSelected=oe,w.addMapSelected=se,w.addCurrentDate=le,w.incrementDate=re,w.reduceDate=ce,w.cleanUnitInputs=de,w.addCommand=ue,w.clearRegisters=pe,w.switchCommandQueue=ge,w.removeCommand=t.removeCommand,w.openVillageInfo=r.openVillageInfo,w.toggleFilter=Te,w.$watch('commandData.origin',F),w.$watch('commandData.target',F),w.$watch('commandData.date',F),w.$watch('commandData.officers',F),w.$watch('selectedDateType.value',j),w.$watch('selectedInsertPreset.value',Q),w.$watch('catapultTarget.value',K),w.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
w.$watch('selectedTab',(function(){w.selectedTab===N.ADD?T=setInterval((function(){F()}),2500):clearInterval(T)})),w.waitingCommands.forEach(e=>{X(e)});let E=new i('twoverflow_queue_window',(function(){clearInterval(T),be.clearCountdownUpdates()}));E.register(l.ARMY_PRESET_UPDATE,be.updatePresets,!0),E.register(l.ARMY_PRESET_DELETED,be.updatePresets,!0),E.register(l.SELECT_SELECTED,be.autoCompleteSelected,!0),E.register(l.COMMAND_QUEUE_REMOVE,be.removeCommand),E.register(l.COMMAND_QUEUE_REMOVE_ERROR,be.removeError),E.register(l.COMMAND_QUEUE_SEND_TIME_LIMIT,be.sendTimeLimit),E.register(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,be.sendNotOwnVillage),E.register(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,be.sendNoUnitsEnough),E.register(l.COMMAND_QUEUE_SEND,be.sendCommand),E.register(l.COMMAND_QUEUE_START,be.start),E.register(l.COMMAND_QUEUE_STOP,be.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){S=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)U.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});v=angular.copy(I),v.splice(v.indexOf('catapult'),1),I.forEach((function(e){G[e]=0})),k.forEach((function(e){D[e]=!1})),R={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(G),officers:angular.copy(D),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},C={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},h=e.addMenuButton('Generał',10),h.addEventListener('click',_e),E.register(l.COMMAND_QUEUE_START,(function(){h.classList.remove('btn-orange'),h.classList.add('btn-red')})),E.register(l.COMMAND_QUEUE_STOP,(function(){h.classList.remove('btn-red'),h.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,V),a.$on(l.DESTROY_CONTEXT_MENU,W),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,T,E,b=!1,_=!1,f=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(s.VILLAGES_IN_PROVINCE,{village_id:e},t)};let A={init:function(){b=!0}};return A.start=function(){i.trigger(l.FAITH_CHECKER_STARTED),_=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,l=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),b=c.food,_=c.wood,A=c.clay,w=c.iron,h=b.currentStock,S=_.currentStock,v=A.currentStock,R=w.currentStock,y=[0,5e3],I=[160,16e3],k=[200,2e4],O=[50,5e3];1==l&&(f=1),m(n,(function(i){T=u(i.villages),E=p(T,1===l),console.log(E),50!=E||r!==t&&0!=r.length?50==E&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=f?'chapel'==i&&'church'==i||1!=f||(S>=I[1]&&v>=k[1]&&R>=O[1]&&h>=y[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):S>=I[0]&&v>=k[0]&&R>=O[0]&&h>=y[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==f?S>=I[1]&&v>=k[1]&&R>=O[1]&&h>=y[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):S>=I[0]&&v>=k[0]&&R>=O[0]&&h>=y[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},A.stop=function(){i.trigger(l.FAITH_CHECKER_STOPPED),_=!1},A.isRunning=function(){return _},A.isInitialized=function(){return b},A})),define('two/faithChecker/events',[],(function(){angular.extend(l,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(l.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(l.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,i,n){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.FAITH_CHECKER_STARTED,(function(){i.set(o,!0)})),n.register(l.FAITH_CHECKER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c,d){let u,p,g=!1,m=!1,T=[],E=[],b=[],_=[],f=[];const A='fake_sender_settings',w={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',
[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},h={[s.ATTACK]:'attack',[s.SUPPORT]:'support',[s.QUATTRO]:'four',[s.FULL]:'full'};console.log(w,h);const S=function(){T=[],E=[],b=[],_=[],f=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP],i=p[t.GROUPP],o=p[t.GROUPT],s=p[t.GROUPG],l=p[t.GROUP_TARGET];a.forEach((function(t){T.push(e[t])})),i.forEach((function(t){E.push(e[t])})),o.forEach((function(t){b.push(e[t])})),s.forEach((function(t){_.push(e[t])})),l.forEach((function(t){f.push(e[t])}))},v={init:function(){g=!0,u=new e({settingsMap:i,storageKey:A}),u.onChange((function(e,t){p=u.getAll(),t[o.GROUPS]&&S()})),p=u.getAll(),console.log('fakeSender settings',p),a.$on(l.GROUPS_CREATED,S),a.$on(l.GROUPS_DESTROYED,S),a.$on(l.GROUPS_UPDATED,S)},start:function(){m=!0,d.trigger(l.FAKE_SENDER_START)},
stop:function(){m=!1,d.trigger(l.FAKE_SENDER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return v})),define('two/fakeSender/events',[],(function(){angular.extend(l,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p){let m,T,E,b=n.getGroupList();const _={FAKE:'fake',LOGS:'logs'},f=function(e){m.selectedTab=e},A=function(){T.setAll(T.decode(m.settings)),p.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},w=function(){t.isRunning()?t.stop():t.start()},h=function(){m.groups=d.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},S=function(){m.running=!0,E.classList.remove('btn-orange'),E.classList.add('btn-red'),
p.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},v=function(){m.running=!1,E.classList.remove('btn-red'),E.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},R=function(){m=a.$new(),m.SETTINGS=i,m.TAB_TYPES=_,m.running=t.isRunning(),m.selectedTab=_.FAKE,m.settingsMap=o,m.type=d.encodeList(s,{textObject:'fake_sender',disabled:!0}),m.units=d.encodeList(r,{textObject:'fake_sender',disabled:!0}),T.injectScope(m),h(),m.selectTab=f,m.saveSettings=A,m.switchState=w;let e=new u('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.FAKE_SENDER_START,S),e.register(l.FAKE_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',m)};return function(){T=t.getSettings(),e.addDivisor(21),E=e.addMenuButton('Watażka',20),E.addEventListener('click',R),
...
LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/fakeSender','two/fakeSender/ui','two/fakeSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,T,_,f,A,w,h,S,v,R,y){let I,k,O,x,N,L=!1,P=!1,M=[],C=[],U=[],G=[],D=[],z=[],B=!1,V=!1,W=!1,q=0,Y=null,F=null,H=null,j={},K=A.gameTime(),Q=null,X=null
;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[v.WOOD,v.CLAY,v.IRON],te={distance:function(e){return!e.distance.between(k[r.MIN_DISTANCE],k[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===x.getId()},included:function(e){return e.character_id&&!U.includes(e.id)},ignored:function(e){return G.includes(e.id)},points:function(e){return!e.between(k[r.MIN_POINTS],k[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=k[r.GROUP_INCLUDE];U=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);U=U.concat(t)})),U=ie(U)}(),function(){const e=k[r.GROUP_IGNORE];G=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[r.GROUP_ONLY];D=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!x.getVillage(e)})),D=D.concat(t)})),D=ie(D)}(),
function(){const e=G.concat(U);let t=!1;e.forEach((function(e){b.call(O,e)||(O[e]={time:A.gameTime(),report:!1},t=!0)})),T.each(O,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete O[i],t=!0)})),t&&(y.set($,O),w.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),w.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=x.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id&&(o?(Ie(t.village_id),s=!0):(xe(t.village_id),Ee(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),Ee(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),n.includes(t.group_id)&&o){let e=ve(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}s&&w.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const a=k[r.GROUP_INCLUDE],i=k[r.GROUP_IGNORE],n=k[r.GROUP_ONLY],o=x.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id)if(o){
let e=ve(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}else Ne(),Ee(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),Ee(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Ie(t.village_id),s=!0),s&&w.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){const t=n.getGroupList().getGroups(),a=k[r.GROUP_IGNORE],i=k[r.GROUP_ONLY],o=k[r.GROUP_INCLUDE],s=b.call(t,a)?a:I.getDefault(r.GROUP_IGNORE),l=i.filter(e=>b.call(t,e)),c=o.filter(e=>b.call(t,e));I.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ne(),ye(),Ne(),Re()},ce=function(){z=[];const e=n.getPresetList().getPresets();k[r.PRESETS].forEach((function(t){if(!b.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),z.push(a)})),z=z.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),
z.length||(w.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Le.stop())},ue=function(e,t){k[r.IGNORE_ON_LOSS]&&k[r.GROUP_IGNORE]&&P&&t.type===h.TYPES.ATTACK&&1!==t.result&&Oe(t.target_village_id)&&(j[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},pe=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===h.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===s.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},Te=function(e){O[e]={time:A.gameTime(),report:j[e]||!1},delete j[e],y.set($,O),w.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=A.gameTime(),t.type=e,C.unshift(t),be(),!0)},be=function(){const e=k[r.LOGS_LIMIT]
;C.length>e&&C.splice(C.length-e,C.length),y.set(Z,C),w.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},_e=function(e,t,a){const i=k[r.TARGET_MULTIPLE_FARMERS],n=k[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},fe=function(){K=A.gameTime()},Ae=function(){clearTimeout(Y),clearTimeout(F),clearTimeout(H),Y=null,F=null,H=null},we=function(){return Math.max(1,60*k[r.FARMER_CYCLE_INTERVAL]*1e3)},he=function(){return Math.max(0,1e3*k[r.ATTACK_INTERVAL])},Se=function(e){if(this.villageId=e,this.village=x.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=i.WAITING_CYCLE};Se.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e()
;this.loadTargets(()=>{w.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Se.prototype.start=function(){return fe(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,w.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),!0):(w.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Se.prototype.stop=function(e){this.running=!1,w.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),Ae(),this.onCycleEndFn(e),this.onCycleEndFn=E},Se.prototype.targetStep=async function(e={}){if(!this.running)return!1;fe();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const E=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,
!this.running)return a(i.USER_STOP);t()},T.randomSeconds(he())):t()}),_=()=>new Promise((e,a)=>{const n=50-k[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),v=()=>new Promise((e,t)=>{if(k[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),I=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(s.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||U.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),O=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[]
;if(z.forEach((function(e){b.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)b.call(a,e)&&i.push(e);o.emit(s.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[r.MAX_TRAVEL_TIME],s=this.village.getPosition(),l=f.actualDistance(s,a);T.each(z,s=>{if(!!Object.entries(s.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(s,{barbarian:!a.character_id,officers:!1});return o>r*l?(g=s,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),L=()=>new Promise((e,n)=>{c=!1,p=x.getVillageList();const o=p.every(e=>e.isInitialized(S.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),
_e(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[r.TARGET_SINGLE_ATTACK]&&!k[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(A.gameTime()/1e3),s=k[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],l=this.village.getPosition(),m=f.actualDistance(l,a),T=d.calculateTravelTime(g,{barbarian:!a.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(g,T,m,h.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP)
;const n=a.commands.own.filter(e=>e.type===h.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),s=n.some(e=>e.start_village_id===this.villageId);if(_e(s,o,!0))return t(i.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{E().then(_).then(v).then(y).then(I).then(O).then(N).then(L).then(P).then(M).then(e).catch(t)}),G=new Promise((e,t)=>{H=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([C,G]).then(()=>{if(!this.running)return!1;this.setStatus(i.ATTACKING),V=!0,W=a,this.index++,o.emit(s.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:h.TYPES.ATTACK})}).catch(t=>{switch(Ae(),w.trigger(l.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,
this.setStatus(t),xe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Se.prototype.setStatus=function(e){this.status=e},Se.prototype.getStatus=function(){return this.status||i.UNKNOWN},Se.prototype.commandSent=function(e){V=!1,W=!1,Ae(),Ee(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Se.prototype.commandError=function(){V=!1,W=!1,this.stop(i.COMMAND_ERROR)},Se.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Se.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=f.actualDistance(t,e),e}))}(a,t),
this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Se.prototype.getTargets=function(){return this.targets},Se.prototype.getIndex=function(){return this.index},Se.prototype.getVillage=function(){return this.village},Se.prototype.isRunning=function(){return this.running},Se.prototype.isInitialized=function(){return this.initialized},Se.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Se.prototype.getId=function(){return this.villageId};const ve=function(e){const t=k[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!D.includes(e))return!1;if(G.includes(e))return!1;let a=Le.getFarmer(e);return a||(a=new Se(e),M.push(a)),a
},Re=function(){T.each(x.getVillages(),(function(e,t){ve(t)})),w.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ye=function(){const e=k[r.GROUP_ONLY];let t=[];M.forEach((function(a){let i=a.getId();e.length&&!D.includes(i)?t.push(i):G.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Ie(e)})),w.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Ie=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1},ke=function(e){fe(),M.length?q>=M.length?(q=0,B=!1,X=A.gameTime()+we(),w.trigger(l.FARM_OVERFLOW_CYCLE_END)):B=M[q]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(q++,ke())})),"cycle_begin"===e&&(X=null,w.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,q=0,X=null,w.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),we())},Oe=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){
M.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Le={};return Le.init=function(){L=!0,C=y.get(Z,[]),O=y.get($,{}),x=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),I=new e({settingsMap:c,storageKey:J}),I.onChange((function(e,t,a){k=I.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Ne(),t[p.VILLAGES]&&(ye(),Re()),t[p.LOGS]&&be(),t[p.INTERVAL_TIMERS]&&P&&(F?(Ae(),B.targetStep({delay:!0})):Y&&(Ae(),w.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),q=0,ke())))})),k=I.getAll(),le("ignore_update"),ne(),Re(),_((function(){ce()}),'presets'),_((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(l.ARMY_PRESET_UPDATE,de),a.$on(l.ARMY_PRESET_DELETED,de),a.$on(l.GROUPS_VILLAGE_LINKED,oe),a.$on(l.GROUPS_VILLAGE_UNLINKED,se),a.$on(l.GROUPS_DESTROYED,re),a.$on(l.COMMAND_SENT,pe),a.$on(l.MESSAGE_ERROR,ge),a.$on(l.REPORT_NEW,ue)},Le.start=function(){let e
;return!P&&(z.length?(P=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),fe(),function(){let e=we(),t=e+e/2+he();Q=setInterval((function(){A.gameTime()-K>t&&(Le.stop(),setTimeout(Le.start,5e3))}),3e4)}(),w.trigger(l.FARM_OVERFLOW_START),void Ee(g.FARM_START)):(P=!1,!1)):(w.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Le.stop=function(e=i.USER_STOP){B?(B.stop(e),e!==i.USER_STOP&&(X=A.gameTime()+we()),w.trigger(l.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,Ae(),w.trigger(l.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&Ee(g.FARM_STOP)},Le.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Le.getFarmers=function(){return M},Le.getSettings=function(){return I},Le.getExceptionVillages=function(){return{included:U,ignored:G}},Le.getExceptionLogs=function(){return O},Le.isInitialized=function(){return L},Le.isRunning=function(){return P},
Le.getLogs=function(){return C},Le.clearLogs=function(){return C=[],y.set(Z,C),w.trigger(l.FARM_OVERFLOW_LOGS_UPDATED),C},Le.getNextCycleDate=function(){return X},Le.getCycleInterval=we,Le})),define('two/farmOverflow/events',[],(function(){angular.extend(l,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',FARM_OVERFLOW_INSTANCE_STOP:'farm_overflow_instance_stop',FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS:'farm_overflow_instance_error_no_targets',FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY:'farm_overflow_instance_error_not_ready',FARM_OVERFLOW_INSTANCE_STEP_STATUS:'farm_overflow_instance_command_status',FARM_OVERFLOW_PRESETS_LOADED:'farm_overflow_presets_loaded',FARM_OVERFLOW_LOGS_UPDATED:'farm_overflow_log_updated',FARM_OVERFLOW_COMMAND_SENT:'farm_overflow_command_sent',FARM_OVERFLOW_IGNORED_TARGET:'farm_overflow_ignored_target',
FARM_OVERFLOW_VILLAGE_IGNORED:'farm_overflow_village_ignored',FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED:'farm_overflow_exception_villages_updated',FARM_OVERFLOW_FARMER_VILLAGES_UPDATED:'farm_overflow_farmer_villages_updated',FARM_OVERFLOW_REPORTS_UPDATED:'farm_overflow_reports_updated',FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED:'farm_overflow_exception_logs_updated',FARM_OVERFLOW_CYCLE_BEGIN:'farm_overflow_cycle_begin',FARM_OVERFLOW_CYCLE_END:'farm_overflow_cycle_end'})})),define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,E,b,_,f,A,w){let h,S,v,R=n.getPresetList(),y=n.getGroupList(),I={},k={},O=null;const x={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleLogs=h.logs.slice(e,e+t),
h.pagination.count=h.logs.length,h.visibleLogs.forEach((function(e){e.villageId&&L(e.villageId),e.targetId&&L(e.targetId)}))},L=function(e){if(I[e])return I[e];I[e]=!0,k[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){I[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){h.exceptionVillages.included.forEach((function(e){L(e)})),h.exceptionVillages.ignored.forEach((function(e){L(e)}))},M=function(){t.isRunning()?t.stop():t.start()},C=function(e){h.selectedTab=e},U=function(){S.setAll(S.decode(h.settings)),h.saveButtonColor='orange',f.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},G=function(e){const t=S.get(E.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},D=function(e){
S.get(E.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},z=function(){h.presets=b.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},B=function(){h.groups=b.encodeList(y.getGroups(),{disabled:!1,type:'groups'}),h.groupsWithDisabled=b.encodeList(y.getGroups(),{disabled:!0,type:'groups'})},V=function(){h.running=!0,f.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},W=function(e,t){switch(h.running=!1,h.showCycleTimer=!1,clearInterval(O),t.reason){case d.NO_PRESETS:f.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:f.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},q=function(){h.logs=angular.copy(t.getLogs()),N(),h.logs.length||f.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){h.farmers=t.getFarmers()},F=function(){h.exceptionVillages=t.getExceptionVillages(),P()
},H=function(){h.exceptionLogs=t.getExceptionLogs()},j=function(){h.showCycleTimer=!1,clearInterval(O)},K=function(e,a){a!==i.USER_STOP&&(h.showCycleTimer=!0,h.nextCycleCountdown=t.getCycleInterval(),O=setInterval((function(){h.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;h=a.$new(),h.SETTINGS=E,h.TAB_TYPES=x,h.LOG_TYPES=u,h.running=t.isRunning(),h.selectedTab=x.SETTINGS,h.farmers=t.getFarmers(),h.villagesLabel=k,h.villagesInfo=I,h.exceptionVillages=t.getExceptionVillages(),h.exceptionLogs=t.getExceptionLogs(),h.logs=t.getLogs(),h.visibleLogs=[],h.showCycleTimer=!1,h.nextCycleCountdown=0,h.saveButtonColor='orange',h.settingsMap=S.settingsMap,h.pagination={count:h.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},S.injectScope(h),z(),B(),N(),P(),function(){let e=t.getNextCycleDate();e&&(h.showCycleTimer=!0,h.nextCycleCountdown=e-w.gameTime(),O=setInterval((function(){h.nextCycleCountdown-=1e3}),1e3))}(),h.switchFarm=M,h.selectTab=C,h.saveSettings=U,
h.clearLogs=t.clearLogs,h.jumpToVillage=p.jumpToVillage,h.openVillageInfo=r.openVillageInfo,h.showReport=T.showReport,h.removeIgnored=G,h.removeIncluded=D;let i=new _('twoverflow_farm_overflow_window',(function(){clearInterval(O)}));i.register(l.ARMY_PRESET_UPDATE,z,!0),i.register(l.ARMY_PRESET_DELETED,z,!0),i.register(l.GROUPS_UPDATED,B,!0),i.register(l.GROUPS_CREATED,B,!0),i.register(l.GROUPS_DESTROYED,B,!0),i.register(l.FARM_OVERFLOW_START,V),i.register(l.FARM_OVERFLOW_STOP,W),i.register(l.FARM_OVERFLOW_LOGS_UPDATED,q),i.register(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,Y),i.register(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),i.register(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,H),i.register(l.FARM_OVERFLOW_CYCLE_BEGIN,j),i.register(l.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',h),h.$watch('settings',(function(){e||(h.saveButtonColor='red'),e=!1}),!0)};return function(){S=t.getSettings(),v=e.addMenuButton2('Farmer',10),
v.addEventListener('click',(function(){Q()})),A.register(l.FARM_OVERFLOW_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),A.register(l.FARM_OVERFLOW_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/kingTool',['two/Settings','two/kingTool/settings','two/kingTool/settings/map','two/kingTool/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='king_tool_settings',E=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},_={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('kingTool settings',d),s((function(){E()
}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.EXAMPLE_MODULE_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.EXAMPLE_MODULE_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/kingTool/events',[],(function(){angular.extend(l,{KING_TOOL_START:'king_tool_start',KING_TOOL_STOP:'king_tool_stop'})})),define('two/kingTool/ui',['two/ui','two/kingTool','two/kingTool/settings','two/kingTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')
},f=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,p.injectScope(u),A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_king_tool_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.KING_TOOL_START,h),e.register(l.KING_TOOL_STOP,S),
c.getScreenWithInjectedScope('!twoverflow_king_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Marszałek',50),g.addEventListener('click',v),
...
require(['two/ready','two/kingTool','two/kingTool/ui','two/kingTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='market_helper_settings',E=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},_={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('marketHelper settings',d),s((function(){E()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),
a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.MARKET_HELPER_START)},stop:function(){p=!1,console.log('marketHelper stop'),r.trigger(l.MARKET_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/marketHelper/events',[],(function(){angular.extend(l,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){
u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','marketHelper started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','marketHelper stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,p.injectScope(u),A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_market_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.MARKET_HELPER_START,h),e.register(l.MARKET_HELPER_STOP,S),
c.getScreenWithInjectedScope('!twoverflow_market_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton2('Handlarz',30),g.addEventListener('click',v),
...
e.addStyle('#two-market-helper div[select]{float:right}#two-market-helper div[select] .select-handler{line-height:28px}#two-market-helper .range-container{width:250px}#two-market-helper .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-market-helper .textfield-border.fit{width:100%}')}})),define('two/marketHelper/settings',[],(function(){return{PRESETS:'presets',GROUPS:'groups',SOME_NUMBER:'some_number'}})),define('two/marketHelper/settings/updates',(function(){return{PRESETS:'presets',GROUPS:'groups'}})),define('two/marketHelper/settings/map',['two/marketHelper/settings','two/marketHelper/settings/updates'],(function(e,t){return{[e.PRESETS]:{default:[],updates:[t.PRESETS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'presets'},[e.GROUPS]:{default:[],updates:[t.GROUPS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'groups'},[e.SOME_NUMBER]:{default:60,inputType:'number',min:0,max:120}}})),
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,T,E,_,f,A,w,h,S){let v,R,y,I,k,O,x,N,L,P,M,C,U,G,D,z,B,V,W,q,Y,F,H,j=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/R)%2&&(t+=I),t-=t%R,a-=a%R,{x:Math.ceil((t-L.width/2)/R),y:Math.ceil((a-L.height/2)/R)}},Ee=function(e,t){return{x:e/h.TILESIZE.x,y:t/h.TILESIZE.y/h.TILESIZE.off}},be=function(){Se(k)},_e=function(){if(j){const e={x:ee.x-L.width/2,y:ee.y-L.height/2};P.clearRect(0,0,L.width,L.height),G.clearRect(0,0,U.width,U.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),H[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*R-e.x,i=(t.y-2)*R-e.y;G.fillStyle=H[o.COLOR_VIEW_REFERENCE],G.fillRect(a,0,1,y),G.fillRect(0,i,y,1);const n=z.getBoundingClientRect(),s=n.width/h.TILESIZE.x/S.view.z*R,l=n.height/h.TILESIZE.y/S.view.z*R,r=a-s/2,c=i-l/2;G.clearRect(r,c,s,l),G.beginPath(),G.lineWidth=1,G.strokeStyle=H[o.COLOR_VIEW_REFERENCE],G.rect(r,c,s,l),G.stroke()}(e)}e.requestAnimationFrame(_e)},fe=function(){if(!ie)return!1;const e=Q.village[x][N];we(e?Q.character[e]:[[x,N]]),ie=!1,
m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:x,y:N})},Ae=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t,H[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t)},he=function(e){if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!H[o.SHOW_BARBARIANS]&&q.barbarian;if(e.character_id===V){if(e.id===O.getId()&&H[o.HIGHLIGHT_SELECTED])return q.selected;if(e.character_id in K.character)return K.character[e.character_id];if(H[o.HIGHLIGHT_OWN])return q.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&H[o.HIGHLIGHT_DIPLOMACY])return q.tribe;if(Y&&H[o.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return q.ally;if(Y.isEnemy(e.tribe_id))return q.enemy
;if(Y.isNAP(e.tribe_id))return q.friendly}}return q.ugly},Se=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||he(i);if(!n)continue;const o=i.x*R+(i.y%2?I:0),s=i.y*R;C.fillStyle=n,C.fillRect(o,s,v,v)}},ve=function(){v=oe[H[o.MAP_SIZE]],I=Math.round(v/2),R=v+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,M.width=1e3*R,M.height=1e3*R,C.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;L.width=686,L.height=e,U.width=686,U.height=e,P.imageSmoothingEnabled=!1,G.imageSmoothingEnabled=!1},ye=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[x,N,e]),3===e.which&&(a=x,i=N,E.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(H[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id},A.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({
type:'tribe',id:e.tribe_id},A.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},Ie=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!H[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(x===e.x&&N===e.y)return!1;fe()}ie=!0,x=e.x,N=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:x,y:N,event:t});const a=Q.village[x][N];Ae(a?Q.character[a]:[[x,N]])}(pe,e)}fe()},Oe=function(){ie&&fe(),m.trigger(l.MINIMAP_MOUSE_LEAVE)},xe=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},Ne=function(e){return e.preventDefault(),!1},Le=function(){K.tribe=se.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(w.PLAYER_COLORS)||{},be()},Pe=function(){const e={id:O.getId(),x:O.getX(),y:O.getY()};O=B.getSelectedVillage(),Se([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:O.getId(),x:O.getX(),y:O.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&b.call(K,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),be(),!0},removeHighlight:function(e,t){if(void 0===t||!b.call(K,e))return!1;if(!b.call(K[e],t))return!1;delete K[e][t];const i='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e]),
a.$broadcast(l.GROUPS_VILLAGES_CHANGED),be(),!0},getHighlight:function(e,t){return!!b.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){L=e,L.style.background=H[o.COLOR_BACKGROUND],P=L.getContext('2d')},setViewportRef:function(e){U=e,G=U.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!D.width||!D.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Ee(e[0]*t,e[1]*t),i=Ee(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,D.width/2,D.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return F},Me.drawMinimap=function(){ge&&(ge=!1),L.style.background=H[o.COLOR_BACKGROUND],C.clearRect(0,0,M.width,M.height),d((function(){!function(){
const e=f.getPath(h.getMapPath()),t=H[o.SHOW_CONTINENT_DEMARCATIONS],a=H[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){C.fillStyle=H[o.COLOR_CONTINENT],C.fillRect(e*R+I-1,t*R+I-1,3,1),C.fillRect(e*R+I,t*R+I-2,1,3)},n=function(e,t){C.fillStyle=H[o.COLOR_PROVINCE],C.fillRect(e*R+I,t*R+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=_.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*R,c=l.a*R,d=(s.b-s.a)*R,u=(l.b-l.a)*R;C.beginPath(),C.lineWidth=2,C.strokeStyle="#2B4700",C.rect(r,c,d,u),C.stroke()}))}(),be()}),'minimap_data')},Me.enableRendering=function(){j=!0},Me.disableRendering=function(){j=!1},Me.isFirstDraw=function(){return!!ge},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),C=M.getContext('2d'),re=le.make('hover'),F=new u({settingsMap:s,storageKey:ne}),F.onChange((function(e,t){H=F.getAll(),
ve(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),H=F.getAll(),K.tribe=se.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(w.PLAYER_COLORS)||{},ve()},Me.run=function(){d((function(){z=document.getElementById('map'),D=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),q=B.getVillagesColors(),re.alpha=0,S.graph.layers.effects.push(re),Re(),O=B.getSelectedVillage(),te.x=O.getX(),te.y=O.getY(),ee.x=O.getX()*R,ee.y=O.getY()*R,e.addEventListener('resize',Re,!1),U.addEventListener('mousedown',ye),U.addEventListener('mouseup',Ie),U.addEventListener('mousemove',ke),U.addEventListener('mouseleave',Oe),U.addEventListener('click',xe),U.addEventListener('contextmenu',Ne),g.load((function(){k=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(k),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R}(),_e(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,be),a.$on(l.GROUPS_VILLAGES_CHANGED,Le)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,E,b,_,f,A,w){let h,S,v,R,y,I,k,O,x,N,L,P={},M=!1,C={character:{},tribe:{}};const U={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},G=U.MINIMAP,D=function(e){h.selectedTab=e,e===U.MINIMAP?n.enableRendering():n.disableRendering()},z=function(){Object.keys(h.highlights.character).forEach((function(e){e in C.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
C.character[e]=t.character_name}))})),Object.keys(h.highlights.tribe).forEach((function(e){e in C.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){C.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!x)return;let a=B(t.x,t.y);var i,n;N=a,P[a]=!0,M=!0,(i=t.x,n=t.y,new Promise((function(e){let t=f.getTownAt(i,n);if(t)return e(t);f.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!M)return;k.appendChild(x),x.classList.remove('ng-hide'),I.tt.name=e.name,I.tt.x=e.x,I.tt.y=e.y,I.tt.province_name=e.province_name,I.tt.points=e.points,I.tt.character_name=e.character_name||'-',I.tt.character_points=e.character_points||0,I.tt.tribe_name=e.tribe_name||'-',I.tt.tribe_tag=e.tribe_tag||'-',I.tt.tribe_points=e.tribe_points||0,I.tt.morale=e.morale||0,I.tt.position={},I.tt.position.x=t.event.pageX+50,I.tt.position.y=t.event.pageY+50,I.tt.visible=!0
;const a=x.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,s=I.tt.position.y+o>i.top+i.height,l=I.tt.position.x+n>i.width;s&&(I.tt.position.y-=50),x.classList.toggle('left',l),x.classList.toggle('top',s)}))},W=function(e,t){if(!x)return;let a=t?B(t):N;P[a]=!1,M=!1,I.tt.visible=!1,x.classList.add('ng-hide'),O.appendChild(x)},q=function(e,t,i){let o,s,l=a.$new(),r=!0;l.colorPalettes=w.palette,'setting'===e?(s=t,o=L.get(s),r=!1,l.submit=function(){h.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){h.settings[s]=L.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=h.addHighlightColor,l.submit=function(){h.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=h.highlights[t][i],l.submit=function(){n.addHighlight({id:i,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
c.getModal('modal_color_palette',l)},Y=function(){n.addHighlight(h.selectedHighlight,h.addHighlightColor)},F=function(){L.setAll(L.decode(h.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},H=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){L.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},j=function(){return Object.keys(h.highlights.character).length+Object.keys(h.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){h.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){z()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+A.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){h=a.$new(),h.SETTINGS=p,h.TAB_TYPES=U,h.selectedTab=G,h.selectedHighlight=!1,h.addHighlightColor='#000000',h.highlights=n.getHighlights(),h.highlightNames=C,h.mapSizes=b.encodeList(u,{textObject:'minimap',disabled:!1}),h.actionTypes=b.encodeList(d,{textObject:'minimap',disabled:!1}),h.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},h.selectTab=D,h.openColorPalette=q,h.addCustomHighlight=Y,h.removeHighlight=n.removeHighlight,h.saveSettings=F,h.resetSettings=H,h.highlightsCount=j,h.openProfile=K,L.injectScope(h,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,W),e.register(l.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',h),z(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(v),y.appendChild(R),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){L=n.getSettings(),I=i.getSharedData('MapController'),v=document.createElement('canvas'),v.className='minimap',R=document.createElement('canvas'),R.className='cross',n.setViewport(v),n.setViewportRef(R),x=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),O=document.querySelector('#map'),S=t.addMenuButton4('Minimapa',30),S.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
...
define('two/mintHelper',['queues/EventQueue'],(function(e){let t=!1,a=!1,i=3e3;function r(){n.getSelectedCharacter().getVillageList().forEach((function(e){let t=0,a=0,n=0,l=e.data.buildings.academy.level,r=e.getResources().getComputed(),c=r.wood,d=r.clay,u=r.iron,p=c.currentStock,g=d.currentStock,m=u.currentStock;setTimeout((function(){l>0?p>=28e3&&g>=3e4&&m>=25e3?(t=Math.floor(p/28e3),a=Math.floor(g/3e4),n=Math.floor(m/25e3),t<=n&&t<=a?(o.emit(s.MINT_COINS,{village_id:e.getId(),amount:t}),console.log('W wiosce '+e.getName()+' wybito '+t+' monet.')):a<=n&&a<=t?(o.emit(s.MINT_COINS,{village_id:e.getId(),amount:a}),console.log('W wiosce '+e.getName()+' wybito '+a+' monet.')):(o.emit(s.MINT_COINS,{village_id:e.getId(),amount:n}),console.log('W wiosce '+e.getName()+' wybito '+n+' monet.'))):console.log('Za mało surowców żeby wybić monety w wiosce'+e.getName()):console.log('W wiosce '+e.getName()+' brak akademi')}),i)})),setTimeout(r,3e4)}let c={init:function(){t=!0},start:function(){
e.trigger(l.MINT_HELPER_STARTED),a=!0,r()},stop:function(){e.trigger(l.MINT_HELPER_STOPPED),a=!1},isRunning:function(){return a},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(l,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton2('Mincerz',50,g('i18n')('description',a.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'mint_helper'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'mint_helper')))})),n.register(l.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),
t.isRunning()&&n.trigger(l.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/powerHelper',['two/Settings','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='power_helper_settings',E=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},_={
init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('powerHelper settings',d),s((function(){E()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.POWER_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/powerHelper/events',[],(function(){angular.extend(l,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,p.injectScope(u),
A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_power_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.POWER_HELPER_START,h),e.register(l.POWER_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton4('Bunkry',20),g.addEventListener('click',v),
...
e.addStyle('#two-power-helper div[select]{float:right}#two-power-helper div[select] .select-handler{line-height:28px}#two-power-helper .range-container{width:250px}#two-power-helper .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-power-helper .textfield-border.fit{width:100%}')}})),define('two/powerHelper/settings',[],(function(){return{PRESETS:'presets',GROUPS:'groups',SOME_NUMBER:'some_number'}})),define('two/powerHelper/settings/updates',(function(){return{PRESETS:'presets',GROUPS:'groups'}})),define('two/powerHelper/settings/map',['two/powerHelper/settings','two/powerHelper/settings/updates'],(function(e,t){return{[e.PRESETS]:{default:[],updates:[t.PRESETS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'presets'},[e.GROUPS]:{default:[],updates:[t.GROUPS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'groups'},[e.SOME_NUMBER]:{default:60,inputType:'number',min:0,max:120}}})),
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[];const T='prank_helper_settings',E={[s.INCREASE]:'increase',[s.DECREASE]:'decrease',[s.RANDOM]:'random'};console.log(E);const b=function(){m=[];const e=n.getGroupList().getGroups();u[t.GROUPS].forEach((function(t){m.push(e[t])}))},_={init:function(){p=!0,d=new e({settingsMap:i,storageKey:T}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&b()})),u=d.getAll(),console.log('all settings',u),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){g=!0,c.trigger(l.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(l.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return _})),define('two/prankHelper/events',[],(function(){angular.extend(l,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,g,m,T=n.getGroupList();const E={RENAME:'rename',LOGS:'logs'},b=function(e){p.selectedTab=e},_=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},w=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},h=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
u.notif('success','Example module stopped')},S=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.RENAME,p.settingsMap=o,p.type=r.encodeList(s,{textObject:'prank_helper',disabled:!0}),g.injectScope(p),A(),p.selectTab=b,p.saveSettings=_,p.switchState=f;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(l.GROUPS_CREATED,A,!0),e.register(l.GROUPS_DESTROYED,A,!0),e.register(l.GROUPS_UPDATED,A,!0),e.register(l.PRANK_HELPER_START,w),e.register(l.PRANK_HELPER_STOP,h),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',p)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',80),m.addEventListener('click',S),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[],T=[],E=[];const b='preset_asigner_settings',_=function(){g=[],m=[];const e=n.getPresetList().getPresets(),a=d[t.PRESETS1],i=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),i.forEach((function(t){m.push(e[t])}))},f=function(){T=[],E=[];const e=n.getGroupList().getGroups(),a=d[t.GROUP1],i=d[t.GROUP2];a.forEach((function(t){T.push(e[t])})),i.forEach((function(t){E.push(e[t])}))},A={init:function(){u=!0,c=new e({settingsMap:i,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&_(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('presetAsigner settings',d),s((function(){_()}),'presets'),
a.$on(l.ARMY_PRESET_UPDATE,_),a.$on(l.ARMY_PRESET_DELETED,_),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,r.trigger(l.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('presetAsigner stop'),r.trigger(l.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return A})),define('two/presetAsigner/events',[],(function(){angular.extend(l,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={PRESETS:'presets',LOGS:'logs'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()
},A=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.PRESETS,u.settingsMap=o,p.injectScope(u),A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.PRESET_ASIGNER_START,h),e.register(l.PRESET_ASIGNER_STOP,S),
c.getScreenWithInjectedScope('!twoverflow_preset_asigner_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Administrator',30),g.addEventListener('click',v),
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',T='060502',E='060501',b='060503',_='05020a',f='05030a',A='04080a',w='040a0a',h='070e04',S='070e05',v='070e0f',R='070e06',y='070e02',I='070e01',k='070e03',O='070e07',x='070e0b',N='070e0e',L='030d07',P='030d0b',M='030d0e';var C={init:function(){i=!0}};return C.start=function(){e.trigger(l.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,T='string'==typeof T?parseInt(T,16):T,E='string'==typeof E?parseInt(E,16):E,b='string'==typeof b?parseInt(b,16):b,_='string'==typeof _?parseInt(_,16):_,f='string'==typeof f?parseInt(f,16):f,A='string'==typeof A?parseInt(A,16):A,w='string'==typeof w?parseInt(w,16):w,
h='string'==typeof h?parseInt(h,16):h,S='string'==typeof S?parseInt(S,16):S,v='string'==typeof v?parseInt(v,16):v,R='string'==typeof R?parseInt(R,16):R,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,k='string'==typeof k?parseInt(k,16):k,O='string'==typeof O?parseInt(O,16):O,x='string'==typeof x?parseInt(x,16):x,N='string'==typeof N?parseInt(N,16):N,L='string'==typeof L?parseInt(L,16):L,P='string'==typeof P?parseInt(P,16):P,M='string'==typeof M?parseInt(M,16):M,o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:20,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (miecz)',icon:u,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:33,axe:0,
archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (top)',icon:p,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:25,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (łuk)',icon:m,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:50,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (lk)',icon:T,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:10,mounted_archer:0,heavy_cavalry:0,
ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (łk)',icon:E,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:10,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (ck)',icon:b,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:10,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'PartDeff',icon:_,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:180,sword:140,axe:0,archer:100,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}
}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'FullDeff',icon:f,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:9e3,sword:7e3,axe:0,archer:5e3,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'PartOff',icon:A,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:200,archer:0,light_cavalry:75,mounted_archer:87,heavy_cavalry:0,ram:15,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'FullOff',icon:w,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:4e3,archer:0,light_cavalry:1500,mounted_archer:1750,heavy_cavalry:0,ram:300,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{
village_id:c[0].data.villageId,name:'fejk (pik)',icon:h,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:1,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (miecz)',icon:S,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:1,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (top)',icon:v,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:1,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (łuk)',icon:R,
officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:1,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (lk)',icon:y,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:1,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (łk)',icon:I,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:1,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (ck)',icon:k,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:1,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (tar)',icon:O,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (kat)',icon:x,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'fejk (treb)',icon:N,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,
mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (tar)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:1,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (kat)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:M,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,
trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),C.stop()},C.stop=function(){e.trigger(l.PRESET_CREATOR_STOPPED),r=!1},C.isRunning=function(){return r},C.isInitialized=function(){return i},C})),define('two/presetCreator/events',[],(function(){angular.extend(l,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(41),o=e.addMenuButton3('Wojewoda',40,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'preset_creator')))})),
n.register(l.PRESET_CREATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.PRESET_CREATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,a,i,n){const o='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.PRESET_CREATOR_STARTED,(function(){i.set(o,!0)})),n.register(l.PRESET_CREATOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){
let d,u,p=!1,g=!1,m=[],T=[],E=[],b=[],_=[],f=[],A=[],w=[],h=[],S=[],v=[],R=[],y=[],I=[],k=[],O=[],x=[],N=[],L=[],P=[],M=[],C=[],U=[],G=[],D=[],z=[],B=[],V=[],W=[],q=[],Y=[],F=[];const H='recruit_queue_settings',j={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(j);const K=function(){m=[],T=[],E=[],b=[],_=[],f=[],A=[],w=[];const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],s=u[t.PRESET4],l=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])})),o.forEach((function(t){E.push(e[t])})),s.forEach((function(t){b.push(e[t])})),l.forEach((function(t){_.push(e[t])})),r.forEach((function(t){
f.push(e[t])})),c.forEach((function(t){A.push(e[t])})),d.forEach((function(t){w.push(e[t])}))},Q=function(){h=[],S=[],v=[],R=[],y=[],I=[],k=[],O=[],x=[],N=[],L=[],P=[],M=[],C=[],U=[],G=[],D=[],z=[],B=[],V=[],W=[],q=[],Y=[],F=[];const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4],l=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],E=u[t.GROUP13],b=u[t.GROUP14],_=u[t.GROUP15],f=u[t.GROUP16],A=u[t.GROUP17],w=u[t.GROUP18],H=u[t.GROUP19],j=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){h.push(e[t])})),i.forEach((function(t){S.push(e[t])})),o.forEach((function(t){v.push(e[t])})),s.forEach((function(t){R.push(e[t])})),l.forEach((function(t){y.push(e[t])})),r.forEach((function(t){I.push(e[t])})),c.forEach((function(t){k.push(e[t])})),d.forEach((function(t){O.push(e[t])})),p.forEach((function(t){x.push(e[t])})),g.forEach((function(t){
N.push(e[t])})),m.forEach((function(t){L.push(e[t])})),T.forEach((function(t){P.push(e[t])})),E.forEach((function(t){M.push(e[t])})),b.forEach((function(t){C.push(e[t])})),_.forEach((function(t){U.push(e[t])})),f.forEach((function(t){G.push(e[t])})),A.forEach((function(t){D.push(e[t])})),w.forEach((function(t){z.push(e[t])})),H.forEach((function(t){B.push(e[t])})),j.forEach((function(t){V.push(e[t])})),K.forEach((function(t){W.push(e[t])})),Q.forEach((function(t){q.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:i,storageKey:H}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('recruitQueue settings',u),r((function(){K()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,K),a.$on(l.ARMY_PRESET_DELETED,K),a.$on(l.GROUPS_CREATED,Q),a.$on(l.GROUPS_DESTROYED,Q),a.$on(l.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(l.recruit_queue_START)},stop:function(){
g=!1,c.trigger(l.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(l,{RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,E=n.getPresetList(),b=n.getGroupList();const _={PRESETS:'presets',OWN:'own',LOGS:'logs'},f=function(e){p.selectedTab=e},A=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},h=function(){p.presets=r.encodeList(E.getPresets(),{disabled:!1,type:'presets'})},S=function(){p.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},v=function(){p.running=!0,
T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},R=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},y=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=_,p.running=t.isRunning(),p.selectedTab=_.PRESETS,p.settingsMap=o,p.units=r.encodeList(s,{textObject:'recruit_queue',disabled:!0}),m.injectScope(p),h(),S(),p.selectTab=f,p.saveSettings=A,p.switchState=w;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed')}));e.register(l.ARMY_PRESET_UPDATE,h,!0),e.register(l.ARMY_PRESET_DELETED,h,!0),e.register(l.GROUPS_CREATED,S,!0),e.register(l.GROUPS_DESTROYED,S,!0),e.register(l.GROUPS_UPDATED,S,!0),e.register(l.recruit_queue_START,v),e.register(l.recruit_queue_STOP,R),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',p)};return function(){
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='report_helper_settings',E=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},_={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('reportHelper settings',d),s((function(){E()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,
console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.REPORT_HELPER_START)},stop:function(){p=!1,console.log('reportHelper stop'),r.trigger(l.REPORT_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/reportHelper/events',[],(function(){angular.extend(l,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SETTINGS:'settings',SOME_VIEW:'some_view'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){
u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SETTINGS,u.settingsMap=o,p.injectScope(u),A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_report_helper_window',(function(){console.log('reportHelper window closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.REPORT_HELPER_START,h),e.register(l.REPORT_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',u)};return function(){p=t.getSettings(),
...
require(['two/ready','two/reportHelper','two/reportHelper/ui','two/reportHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=n.getSelectedCharacter(),a=t.data.character_id,i=t.data.character_name,r=!1,c=!1,d=[],u=[],p=[];function g(e){var t=new Date(1e3*e);return t.toLocaleString()}var m=function(){o.emit(s.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},T))})),o.emit(s.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},E))})),o.emit(s.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']
},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},b))})),setTimeout(m,3e4)},T=function(e){var t,n,l,r,c,d=[],u=e.result,p=e.token,m=e.time_created,T=g(m),E=e.ReportScouting,b=E.attCharacterId,_=E.attCharacterName,f=E.attScouts,A=E.attLosses,w=E.attVillageId,h=E.attVillageName,S=E.defCharacterId,v=E.defCharacterName,R=E.defLosses,y=E.defScouts,I=E.defVillageId,k=E.defVillageName,O=E.commandType,x='',N='',L='',P='',M=Date.now(),C=p.split('.').join('_');2==u?x=' [color=d96a19]Częściowy sukces[/color]':1==u?x=' [color=0a8028]Sukces[/color]':3==u&&(x=' [color=e21f1f]Porażka[/color]'),N='units'==O?'Jednostki':'buildings'==O?'Budynki':'Sabotaż',n=null==y?'nieznana':y,l=null==f?'nieznana':f,r=null==R?'nieznana':R,c=null==A?'nieznana':A,P=null==_&&null==b?'Brak danych':'[player='+b+']'+_+'[/player]',L=null==h&&null==w?'Brak danych':'[village='+w+']'+h+'[/village]',
t=Math.floor(M/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+C+'[/report][br]'+x+' --- Typ: '+N+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+k+'[/village][b] Gracz cel: [/b][player='+S+']'+v+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+L+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+l+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var U=d.join();S!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14383,message:U}):o.emit(s.MESSAGE_REPLY,{message_id:6467,message:U}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14382,message:U}):o.emit(s.MESSAGE_REPLY,{message_id:6466,message:U}),d=[])},E=function(e){
var t,a=[],n=e.result,l=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,E=d.attEffects,b=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var f=[],A=[];E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,f.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,f.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var w=f.join();b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),A.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,A.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,A.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,A.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,A.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,A.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,
A.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,A.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,A.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,A.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,A.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,A.push(' Zjednoczenie '+g+'%'))}));var h=A.join(),S=(100*d.attFaith).toFixed([0]),v=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),y=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,k=d.defCharacterName,O=d.defVillageId,x=d.defVillageName,N=(100*d.defFaith).toFixed([0]),L=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),M=d.night,C=d.loyaltyAfter,U=d.loyaltyBefore,G=d.wallAfter,D=d.wallBefore,z=d.officers,B=d.leader,V='',W='',q='',Y='',F='',H='',j='',K='',Q='',X=Date.now(),Z=l.split('.').join('_')
;null!=U&&(H='Lojalność przed atakiem: '+Math.floor(U)+' '),null!=C&&(j='Lojalność po ataku: '+Math.floor(C)+' '),null!=D&&(K='Mury przed ataku: '+D+' '),null!=G&&(Q='Mury po ataku: '+G+' '),null==z&&1==B?F='Brak':null==z&&1.1==B&&(F=' Wielki Mistrz '),Y=0==M?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),q=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',W=null==T&&null==m?'Brak danych':'[village='+m+']'+T+'[/village]',t=Math.floor(X/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+x+'[/village][b] Gracz cel: [/b][player='+I+']'+k+'[/player][br]Modyfikator obrony: [b]'+L+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+v+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+y+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+H+j+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(s.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},b=function(e){
var t,a=[],n=e.result,l=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,E=d.attEffects,b=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var f=[],A=[];E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,f.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,f.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,f.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,f.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,f.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var w=f.join();b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),A.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,A.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,A.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,A.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,A.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,A.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,
A.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,A.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,A.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,A.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,A.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,A.push(' Zjednoczenie '+g+'%'))}));var h,S=A.join(),v=(100*d.attFaith).toFixed([0]),R=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,O=d.defCharacterName,x=d.defVillageId,N=d.defVillageName,L=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),M=(100*d.wallBonus).toFixed([0]),C=d.night,U=d.loyaltyAfter,G=d.loyaltyBefore,D=d.wallAfter,z=d.wallBefore,B=d.officers,V='',W='',q='',Y='',F='',H='',j='',K='',Q=[],X=Date.now(),Z=l.split('.').join('_')
;if(null!=G&&(F='Lojalność przed atakiem: '+Math.floor(G)+' '),null!=U&&(H='Lojalność po ataku: '+Math.floor(U)+' '),null!=z&&(j='Mury przed ataku: '+z+' '),null!=D&&(K='Mury po ataku: '+D+' '),null==B)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(Y=0==C?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),q=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',W=null==T&&null==m?'Brak danych':'[village='+m+']'+T+'[/village]',t=Math.floor(X/1e3-r),h=Q.join(),null!=O){
a.push('[size=XL][b]Raport z ataku: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+N+'[/village][b] Gracz cel: [/b][player='+k+']'+O+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+M+'[/b][br]Wiara: [b]'+L+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+S+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+R+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+v+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+h+'[/b][br]'+F+H+'[br]'+j+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(s.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},_={init:function(){r=!0},start:function(){e.trigger(l.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(l.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return r}};return _})),define('two/reportSender/events',[],(function(){angular.extend(l,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(71),o=e.addMenuButton('Goniec',70,g('i18n')('description',a.loc.ale,'report_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'report_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'report_sender')))})),n.register(l.REPORT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.REPORT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.REPORT_SENDER_STARTED,(function(){i.set(o,!0)})),n.register(l.REPORT_SENDER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/specialQueue',['two/Settings','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/settings/updates','two/specialQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[];const E='special_queue_settings',b={[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner'};console.log(b);const _=function(){m=[],T=[];const e=n.getGroupList().getGroups(),a=u[t.GROUPNOBLE],i=u[t.GROUPSPECIAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])}))},f={init:function(){p=!0,
d=new e({settingsMap:i,storageKey:E}),d.onChange((function(e,t){u=d.getAll(),t[o.GROUPS]&&_()})),u=d.getAll(),console.log('specialQueue settings',u),a.$on(l.GROUPS_CREATED,_),a.$on(l.GROUPS_DESTROYED,_),a.$on(l.GROUPS_UPDATED,_)},start:function(){g=!0,c.trigger(l.SPECIAL_QUEUE_START)},stop:function(){g=!1,c.trigger(l.SPECIAL_QUEUE_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return f})),define('two/specialQueue/events',[],(function(){angular.extend(l,{SPECIAL_QUEUE_START:'special_queue_start',SPECIAL_QUEUE_STOP:'special_queue_stop'})})),define('two/specialQueue/ui',['two/ui','two/specialQueue','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,m,T,E=n.getGroupList();const b={NOBLE:'noble',SPECIAL:'special',LOGS:'logs'},_=function(e){p.selectedTab=e},f=function(){m.setAll(m.decode(p.settings)),
u.notif('success',g('i18n')('general.saved',a.loc.ale,'special_queue'))},A=function(){t.isRunning()?t.stop():t.start()},w=function(){p.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},h=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'special_queue'))},S=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'special_queue'))},v=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.NOBLE,p.settingsMap=o,p.units=r.encodeList(s,{textObject:'special_queue',disabled:!0}),m.injectScope(p),w(),p.selectTab=_,p.saveSettings=f,p.switchState=A;let e=new d('twoverflow_special_queue_window',(function(){console.log('specialQueue closed')}));e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),
e.register(l.SPECIAL_QUEUE_START,h),e.register(l.SPECIAL_QUEUE_STOP,S),c.getScreenWithInjectedScope('!twoverflow_special_queue_window',p)};return function(){m=t.getSettings(),e.addDivisor(86),T=e.addMenuButton('Weteran',85),T.addEventListener('click',v),
...
[e.AMOUNT5]:{default:0,inputType:'number',min:0,max:1e5},[e.AMOUNT6]:{default:0,inputType:'number',min:0,max:4e3},[e.AMOUNT7]:{default:0,inputType:'number',min:0,max:4e3},[e.AMOUNT8]:{default:0,inputType:'number',min:0,max:4e3},[e.UNIT1]:{default:!1,multiSelect:!0,inputType:'select'},[e.UNIT2]:{default:!1,multiSelect:!0,inputType:'select'},[e.UNIT3]:{default:!1,multiSelect:!0,inputType:'select'}}})),define('two/specialQueue/types/units',[],(function(){return{TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner'}})),require(['two/ready','two/specialQueue','two/specialQueue/ui','two/specialQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/ready','queues/EventQueue'],(function(e,t,a,i,n,o,s){let r,c,d=!1,u=!1;const p='spy_master_settings',g={[i.HEADQUARTER]:'headquarter',
[i.WAREHOUSE]:'warehouse',[i.FARM]:'farm',[i.RALLY_POINT]:'rally_point',[i.STATUE]:'statue',[i.WALL]:'wall',[i.TAVERN]:'tavern',[i.BARRACKS]:'barracks',[i.PRECEPTORY]:'preceptory',[i.HOSPITAL]:'hospital',[i.CLAY_PIT]:'clay_pit',[i.IRON_MINE]:'iron_mine',[i.TIMBER_CAMP]:'timber_camp',[i.CHAPEL]:'chapel',[i.CHURCH]:'church',[i.MARKET]:'market',[i.ACADEMY]:'academy'},m={[n.SPEAR]:'spear',[n.SWORD]:'sword',[n.AXE]:'axe',[n.ARCHER]:'archer',[n.LIGHT_CAVALRY]:'light_cavalry',[n.MOUNTED_ARCHER]:'mounted_archer',[n.HEAVT_CAVALRY]:'heavy_cavalry',[n.RAM]:'ram',[n.CATAPULT]:'catapult',[n.TREBUCHET]:'trebuchet',[n.DOPPELSOLDNER]:'doppelsoldner',[n.SNOB]:'snob',[n.KNIGHT]:'knight'};console.log(m,g);const T={init:function(){d=!0,r=new e({settingsMap:a,storageKey:p}),c=r.getAll(),console.log('spyMaster settings',c)},start:function(){u=!0,s.trigger(l.SPY_MASTER_START)},stop:function(){u=!1,s.trigger(l.SPY_MASTER_STOP)},getSettings:function(){return r},isInitialized:function(){return d},
isRunning:function(){return u}};return T})),define('two/spyMaster/events',[],(function(){angular.extend(l,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u){let p,m,T;const E={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},b=function(e){p.selectedTab=e},_=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},w=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},h=function(){p=a.$new(),
p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.SPY,p.settingsMap=n,p.building=r.encodeList(o,{textObject:'spy_master',disabled:!0}),p.unit=r.encodeList(s,{textObject:'spy_master',disabled:!0}),m.injectScope(p),p.selectTab=b,p.saveSettings=_,p.switchState=f;let e=new d('twoverflow_spy_master_window',(function(){console.log('spyMaster window closed')}));e.register(l.SPY_MASTER_START,A),e.register(l.SPY_MASTER_STOP,w),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',p)};return function(){m=t.getSettings(),T=e.addMenuButton3('Zwiadowca',10),T.addEventListener('click',h),
...
ARCHER:'archer',LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/spyMaster','two/spyMaster/ui','two/spyMaster/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/spyRecruiter',['two/utils','queues/EventQueue'],(function(e,t){let i=!1,r=!1;let c={init:function(){i=!0}};return c.start=function(){t.trigger(l.SPY_RECRUITER_STARTED),r=!0,setInterval((function(){n.getSelectedCharacter().getVillageList().forEach((function(e){var t=e.data.buildings.tavern.level,a=e.scoutingInfo.spies,i=e.getResources().getComputed(),n=i.wood,l=i.clay,r=i.iron,c=n.currentStock,d=l.currentStock,u=r.currentStock,p=[500,1e3,2200,7e3,12e3],g=[500,800,2e3,6500,1e4],m=[500,1200,2400,8e3,18e3]
;t<1?console.log('Brak tawerny w wiosce:'+e.getName()):t>=1&&t<3?(a.forEach((function(t){1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]&&o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1})})),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):t>=3&&t<6?a.forEach((function(t){1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]&&(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName()))})):t>=6&&t<9?a.forEach((function(t){3==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),
console.log('Anulowano rekrutację szpiega (slot 3) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):3==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[3]&&d>=g[3]&&u>=m[3]&&(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('Dodano do rekrutacji szpiega (slot 3) w wiosce:'+e.getName()))})):t>=9&&t<12?a.forEach((function(t){4==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),
console.log('Anulowano rekrutację szpiega (slot 4) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):4==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Anulowano rekrutację szpiega (slot 4) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):3==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Anulowano rekrutację szpiega (slot 3) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):3==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),
console.log('Anulowano rekrutację szpiega (slot 3) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):3==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[3]&&d>=g[3]&&u>=m[3]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('Dodano do rekrutacji szpiega (slot 3) w wiosce:'+e.getName())):4==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[4]&&d>=g[4]&&u>=m[4]&&(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:4}),console.log('Dodano do rekrutacji szpiega (slot 4) w wiosce:'+e.getName()))
})):t>=12&&a.forEach((function(t){5==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Anulowano rekrutację szpiega (slot 5) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):5==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Anulowano rekrutację szpiega (slot 5) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):4==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Anulowano rekrutację szpiega (slot 4) w wiosce:'+e.getName()),
console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):3==t.id&&1==t.recruitingInProgress&&1==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Anulowano rekrutację szpiega (slot 3) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):4==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Anulowano rekrutację szpiega (slot 4) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):5==t.id&&1==t.recruitingInProgress&&3==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('Anulowano rekrutację szpiega (slot 5) w wiosce:'+e.getName()),
console.log('Dodano do rekrutacji szpiega (slot 3) w wiosce:'+e.getName())):3==t.id&&1==t.recruitingInProgress&&2==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:3}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Anulowano rekrutację szpiega (slot 3) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):4==t.id&&1==t.recruitingInProgress&&3==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:4}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('Anulowano rekrutację szpiega (slot 4) w wiosce:'+e.getName()),console.log('Dodano do rekrutacji szpiega (slot 3) w wiosce:'+e.getName())):5==t.id&&1==t.recruitingInProgress&&4==t.id&&1!=t.active?(o.emit(s.SCOUTING_CANCEL_RECRUIT,{village_id:e.getId(),slot:5}),o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:4}),console.log('Anulowano rekrutację szpiega (slot 5) w wiosce:'+e.getName()),
console.log('Dodano do rekrutacji szpiega (slot 4) w wiosce:'+e.getName())):1==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[1]&&d>=g[1]&&u>=m[1]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:1}),console.log('Dodano do rekrutacji szpiega (slot 1) w wiosce:'+e.getName())):2==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[2]&&d>=g[2]&&u>=m[2]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:2}),console.log('Dodano do rekrutacji szpiega (slot 2) w wiosce:'+e.getName())):3==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[3]&&d>=g[3]&&u>=m[3]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:3}),console.log('Dodano do rekrutacji szpiega (slot 3) w wiosce:'+e.getName())):4==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[4]&&d>=g[4]&&u>=m[4]?(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:4}),
console.log('Dodano do rekrutacji szpiega (slot 4) w wiosce:'+e.getName())):5==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=p[5]&&d>=g[5]&&u>=m[5]&&(o.emit(s.SCOUTING_RECRUIT,{village_id:e.getId(),slot:5}),console.log('Dodano do rekrutacji szpiega (slot 5) w wiosce:'+e.getName()))}))})),e.notif('success',g('i18n')('revived',a.loc.ale,'spy_recruiter'))}),12e4)},c.stop=function(){t.trigger(l.SPY_RECRUITER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/spyRecruiter/events',[],(function(){angular.extend(l,{SPY_RECRUITER_STARTED:'spy_recruiter_started',SPY_RECRUITER_STOPPED:'spy_recruiter_stopped'})})),define('two/spyRecruiter/ui',['two/ui','two/spyRecruiter','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor3(21),o=e.addMenuButton3('Szpieg',20,g('i18n')('description',a.loc.ale,'spy_recruiter')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
i.notif('success',g('i18n')('deactivated',a.loc.ale,'spy_recruiter'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'spy_recruiter')))})),n.register(l.SPY_RECRUITER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(l.SPY_RECRUITER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.SPY_RECRUITER_STARTED),opener}})),require(['two/ready','two/spyRecruiter','two/spyRecruiter/ui','Lockr','queues/EventQueue','two/spyRecruiter/events'],(function(e,t,a,i,n){const o='spy_recruiter_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.SPY_RECRUITER_STARTED,(function(){i.set(o,!0)})),n.register(l.SPY_RECRUITER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',E=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},b=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},_={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&b()})),d=c.getAll(),console.log('supportSender settings',d),s((function(){E()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,E),a.$on(l.ARMY_PRESET_DELETED,E),a.$on(l.GROUPS_CREATED,b),a.$on(l.GROUPS_DESTROYED,b),a.$on(l.GROUPS_UPDATED,b)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.SUPPORT_SENDER_START)},stop:function(){p=!1,
r.trigger(l.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return _})),define('two/supportSender/events',[],(function(){angular.extend(l,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const E={SUPPORT:'support',LOGS:'logs'},b=function(e){u.selectedTab=e},_=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.SUPPORT,u.settingsMap=o,p.injectScope(u),A(),w(),u.selectTab=b,u.saveSettings=_,u.switchState=f;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,A,!0),e.register(l.ARMY_PRESET_DELETED,A,!0),e.register(l.GROUPS_CREATED,w,!0),e.register(l.GROUPS_DESTROYED,w,!0),e.register(l.GROUPS_UPDATED,w,!0),e.register(l.SUPPORT_SENDER_START,h),e.register(l.SUPPORT_SENDER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',v),
