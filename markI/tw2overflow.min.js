 ...
 */
!function(e,t){const i=injector.get('$rootScope'),a=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),r=injector.get('eventTypeProvider'),s=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),g=injector.get('mapService'),p=injector.get('$filter'),_=(injector.get('$timeout'),injector.get('storageService')),m=injector.get('reportService'),E=function(){},f=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const a=i.$on(r.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),a())})};return t.prototype.register=function(t,a,n){n?this.listeners.push(i.$on(t,a)):(e.register(t,a),this.listeners.push((function(){
...
;return i+' '+a[1]+'/'+a[0]+'/'+a[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const i=a.fixDate(e).split(' '),n=i[0].split(':'),o=i[1].split('/'),l=n[0],r=n[1],s=n[2],c=n[3]||null,d=parseInt(o[0],10)-1,u=o[1],g=o[2];return new Date(g,d,u,l,r,s,c).getTime()+(t||0)},formatDate:function(e,t){return p('readableDateFilter')(e,null,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+i.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(i,a){if(!e)return a();let n=new XMLHttpRequest;n.open('GET',e,!0),n.responseType=t,n.addEventListener('load',(function(){i(n)}),!1),n.send()}))},obj2selectOptions:function(e,t){let i=[];for(let a in e){let n={name:e[a].name,value:e[a].id};t&&(n.leftIcon=e[a].icon),i.push(n)}return i},getTravelTime:function(e,i,a,o,l,r){
const s=!i.character_id,c=i.character_id&&i.tribe_id&&i.tribe_id===n.getSelectedCharacter().getTribeId();!1!==r&&('attack'===o?('supporter'in l&&delete l.supporter,s&&(r=!0)):'support'===o&&(c&&(r=!0),'supporter'in l&&(r=!0)));const u={units:a,officers:angular.copy(l)},g=d.calculateTravelTime(u,{barbarian:s,ownTribe:c,officers:l,effects:r},o),p=t.actualDistance(e,i);return 1e3*d.getTravelTimeForDistance(u,g,p,o)},each:function(e,t){if('function'!=typeof t&&(t=E),Array.isArray(e)){for(let i=0,a=e.length;i<a;i++)if(!1===t(e[i],i))return!1}else if(angular.isObject(e))for(let i in e)if(f.call(e,i)&&!1===t(e[i],i))return!1;return!0}};return a})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let s={};const c=function(d,u){'string'==typeof(u=u||['map'])&&(u=[u]);const g=function(e){(u=u.filter((function(t){return t!==e}))).length||d()},p={map:function(){if(a.getSharedData('MapController').isInitialized)return g('map');i.$on(r.MAP_INITIALIZED,(function(){g('map')}))},
tribe_relations:function(){const e=n.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return g('tribe_relations')}const t=i.$on(r.TRIBE_RELATION_LIST,(function(){t(),g('tribe_relations')}))},initial_village:function(){if(n.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return g('initial_village');i.$on(r.GAME_STATE_INITIAL_VILLAGE_READY,(function(){g('initial_village')}))},all_villages_ready:function(){if(n.getGameState().getGameState(e.ALL_VILLAGES_READY))return g('all_villages_ready');i.$on(r.GAME_STATE_ALL_VILLAGES_READY,(function(){g('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return g('minimap_data');t.load((function(){g('minimap_data')}))},presets:function(){if(n.getPresetList().isLoaded())return g('presets');s.presets=s.presets||new Promise((function(e){o.emit(l.GET_PRESETS,{},e)})),s.presets.then((function(){g('presets')}))},world_config:function(){if(n.getWorldConfig&&n.getWorldConfig())return g('world_config')
;setTimeout(p.world_config,100)}};if(!a.getSharedData('MapController'))return setTimeout((function(){c(d,u)}),100);u.forEach((function(e){p[e]()}))};return c})),require(['two/ready','Lockr'],(function(e,t){e((function(){let e=n.getSelectedCharacter();t.prefix=e.getId()+'_twOverflow_'+e.getWorldId()+'-'}))})),define('two/language',['helper/i18n'],(function(e){let t=!1;const a={en_us:{about:{contact:"Kontakt",email:"Email",links:"Linki projektów",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},attack_view:{title:"Strażnik",filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",
...
actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function l(t){t=f.call(o,t)?o[t]:t,e.setJSON(a[t]||a[n])}let r={init:function(){if(t)return!1;t=!0,l(i.loc.ale),i.$watch('loc.ale',(function(e,t){
e!==t&&l(i.loc.ale)}))}};return r})),define('two/Settings',['two/utils','Lockr'],(function(e,a){const o=function(e,t){let i={};for(let a in e)f.call(t,a)?angular.equals(e[a],t[a])||(i[a]=t[a]):i[a]=e[a];return!angular.equals({},i)&&i},l=function(){return{name:p('i18n')('disabled',i.loc.ale,'common'),value:!1}},r=function(e,t){let i={};for(let a in t)(e[a].updates||[]).forEach((function(e){i[e]=!0}));return!angular.equals(i,{})&&i};let s=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let i in e)t[i]=e[i].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,a.get(this.storageKey,{})),this.events={settingsChange:e.onChange||E},this.injected=!1};return s.prototype.get=function(e){return angular.copy(this.settings[e])},s.prototype.getAll=function(){return angular.copy(this.settings)},s.prototype.getDefault=function(e){return f.call(this.defaults,e)?this.defaults[e]:t},s.prototype.store=function(){
a.set(this.storageKey,this.settings)},s.prototype.set=function(e,t,i){if(!f.call(this.settingsMap,e))return!1;const a=this.settingsMap[e];'number'===a.inputType&&(t=parseInt(t,10),f.call(a,'min')&&(t=Math.max(a.min,t)),f.call(a,'max')&&(t=Math.min(a.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const l=angular.copy(this.settings),s=o(n,l);if(!s)return!1;const c=r(this.settingsMap,s);return this.store(),this.updateScope(),this.events.settingsChange.call(this,s,c,i||{}),!0},s.prototype.setAll=function(e,t){const i=angular.copy(this.settings);for(let t in e)if(f.call(this.settingsMap,t)){const i=this.settingsMap[t];let a=e[t];'number'===i.inputType&&(a=parseInt(a,10),f.call(i,'min')&&(a=Math.max(i.min,a)),f.call(i,'max')&&(a=Math.min(i.max,a))),this.settings[t]=a}const a=angular.copy(this.settings),n=o(i,a);if(!n)return!1;const l=r(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,l,t||{}),!0},
s.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},s.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},s.prototype.each=function(e){for(let t in this.settings){if(!f.call(this.settingsMap,t))continue;let i=this.settingsMap[t];'checkbox'===i.inputType?e.call(this,t,!!this.settings[t],i):e.call(this,t,this.settings[t],i)}},s.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},s.prototype.injectScope=function(t,i){this.injected={$scope:t,opt:i},t.settings=this.encode(i),e.each(this.settingsMap,(function(e,i){'select'===e.inputType&&t.$watch((function(){return t.settings[i]}),(function(a){e.multiSelect?a.length||(t.settings[i]=[l()]):a||(t.settings[i]=l())}),!0)}))},s.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},s.prototype.encode=function(e){let t={};const a=n.getPresetList().getPresets(),o=n.getGroupList().getGroups()
;return e=e||{},this.each((function(n,r,s){if('select'===s.inputType){if(!r&&s.disabledOption)return void(t[n]=s.multiSelect?[l()]:l());switch(s.type){case'presets':if(s.multiSelect){let e=[];r.forEach((function(t){a[t]&&e.push({name:a[t].name,value:t})})),t[n]=e.length?e:[l()]}else{if(!a[r]&&s.disabledOption)return void(t[n]=l());t[n]={name:a[r].name,value:r}}break;case'groups':if(s.multiSelect){let e=[];r.forEach((function(t){o[t]&&e.push({name:o[t].name,value:t,leftIcon:o[t].icon})})),t[n]=e.length?e:[l()]}else{if(!o[r]&&s.disabledOption)return void(t[n]=l());t[n]={name:o[r].name,value:r}}break;default:t[n]={name:e.textObject?p('i18n')(r,i.loc.ale,e.textObject):r,value:r},e.multiSelect&&(t[n]=[t[n]])}}else t[n]=r})),t},s.prototype.decode=function(e){let t={};for(let i in e){let a=this.settingsMap[i];if('select'===a.inputType)if(a.multiSelect)if(1===e[i].length&&!1===e[i][0].value)t[i]=[];else{let a=[];e[i].forEach((function(e){a.push(e.value)})),t[i]=a
}else t[i]=e[i].value;else t[i]=e[i]}return t},s.encodeList=function(e,t){let a=[];switch((t=t||{}).disabled&&a.push(l()),t.type){case'keys':for(let t in e)a.push({name:t,value:t});break;case'groups':for(let t in e){let i=e[t];a.push({name:i.name,value:i.id,leftIcon:i.icon})}break;case'presets':for(let t in e){let i=e[t];a.push({name:i.name,value:i.id})}break;case'values':default:for(let n in e){let o=e[n];a.push({name:t.textObject?p('i18n')(o,i.loc.ale,t.textObject):o,value:o})}}return a},s.disabledOption=l,s})),define('two/mapData',['conf/conf'],(function(e){let t=[],a=[],n=!1,s=!1,c=[];angular.extend(r,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=E,d){if(d)s=!1;else{if(n)return c.push(e);if(s)return e(t)}c.push(e),n=!0;let u=[];for(let e=0;e<a.length;e++)for(let t=0;t<a[e].length;t++)u.push(a[e][t]);let g=[];return u.forEach((function(e){let i=new Promise((function(i,a){o.emit(l.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return a(e.message)
;e.villages.length&&(t=t.concat(e.villages)),i()}))}));g.push(i)})),Promise.all(g).then((function(){n=!1,s=!0,i.$broadcast(r.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){return t},isLoaded:function(){return s}};return function(){const t=Math.ceil(e.MAP_SIZE/306),i=Math.ceil(e.MAP_SIZE/306);for(let n=0;n<t;n++){a.push([]);let t=306*n,o=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let l=0;l<i;l++){let i=306*l,r=306..bound(0,i+306).bound(0,e.MAP_SIZE-i);i=i.bound(0,e.MAP_SIZE),a[n].push({x:t,y:i,width:o,height:r})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,a){let n,o={},l={},s=!1,c=document.querySelector('head'),d=injector.get('httpService'),u=injector.get('templateManagerService'),g=injector.get('$templateCache');return u.load=function(a,n,o){let r;const s=function(e,t,a,o){g.put(r.substr(1),e),angular.isFunction(n)&&n(e,t,a,o),i.$$phase||i.$apply()
},c=function(e,t,i,a){angular.isFunction(o)&&o(e,t,i,a)};r=0!==a.indexOf('!')?e.TEMPLATE_PATH_EXT.join(a):a.substr(1),g.get(r.substr(1))?s(g.get(r.substr(1)),304):t.versionMap[r]?d.get(r,s,c):s(l[r],304)},o.init=function(){if(s)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),i=document.createElement('div');t.className='two-menu-container',e.appendChild(t),i.className='two-main-button',i.style.display='none',t.appendChild(i),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),s=!0,
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map'])})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,i,a){let s;var c=injector.get('overviewService'),d=!1,u=!1,g=n.getSelectedCharacter().getGlobalInfo(),p={reverse:!1,column:'command_progress'},_=n.getSelectedCharacter(),m=_.tribeById[0],E=_.getVillageList(),f=[],b=_.data.character_id,T=_.data.character_name,h=[],w=[],v=[a.LIGHT_CAVALRY,a.HEAVY_CAVALRY,a.AXE,a.SWORD,a.RAM,a.SNOB,a.TREBUCHET];var A=function(){
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:m},(function(e){for(var t=e.members,i=0;i<t.length;i++)w.push(t[i].id)})),E.forEach((function(e){f.push(e.getId())}));var e=g.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:p.column,reverse:p.reverse?1:0,groups:[],command_types:['attack'],villages:f},S),setTimeout(A,6e4)},S=function(e){for(var t,i=[],a=e.commands,n=0;n<a.length;n++)if(c.formatCommand(a[n]),w.includes(a[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+a[n].origin_character_id+' Rodzaj '+a[n].command_type);else if('attack'==a[n].command_type)if(h.includes(a[n].command_id))console.log('Już wysłano powiadomienie');else{h.push(a[n].command_id),a[n].slowestUnit=y(a[n]);var r=a[n].time_completed,d=(t=void 0,t=new Date(1e3*r),s=t.toLocaleString(),s),u='',g='';'sword'==a[n].slowestUnit?(g=' [color=03709d]MIECZNIK[/color]',
u='sword'):'axe'==a[n].slowestUnit?(g=' [color=e21f1f]TOPORNIK[/color]',u='axe'):'ram'==a[n].slowestUnit?(g=' [color=730202]TARAN[/color]',u='ram'):'snob'==a[n].slowestUnit?(g=' [color=ffee00]SZLACHCIC[/color]',u='snob'):'trebuchet'==a[n].slowestUnit?(g=' [color=494500]TREBUSZ[/color]',u='trebuchet'):'light_cavalry'==a[n].slowestUnit?(g=' [color=d96a19]LEKKA KAWALERIA[/color]',u='light_cavalry'):'heavy_cavalry'==a[n].slowestUnit&&(g=' [color=0111af]CIĘŻKA KAWALERIA[/color]',u='heavy_cavalry'),
i.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+u+'[/unit] [size=large][b]'+g+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+a[n].target_village_id+']'+a[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+b+']'+T+'[/player][b] [br]Wioska pochodzenia: [/b][village='+a[n].origin_village_id+']'+a[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+a[n].origin_character_id+']'+a[n].origin_character_name+'[/player][/size]');var p=i.join();'snob'==u||'trebuchet'==u?('Hajduk Split'==T||'halfsack'==T||'Black Rider'==T?o.emit(l.MESSAGE_REPLY,{message_id:14378,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4646,message:p}),i=[]):('Hajduk Split'==T||'halfsack'==T||'Black Rider'==T?o.emit(l.MESSAGE_REPLY,{message_id:14379,message:p}):o.emit(l.MESSAGE_REPLY,{message_id:4648,message:p}),i=[])}},y=function(e){var i=e.model.duration,a={},n={x:e.origin_x,y:e.origin_y},o={x:e.target_x,y:e.target_y
},l=[];return v.forEach((function(i){a[i]=1,l.push({unit:i,duration:t.getTravelTime(n,o,a,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-i),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},I={init:function(){d=!0},start:function(){e.trigger(r.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(r.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return I})),define('two/alertSender/events',[],(function(){angular.extend(r,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Wartownik',100,p('i18n')('description',i.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'alert_sender'))):(t.start(),
a.notif('success',p('i18n')('activated',i.loc.ale,'alert_sender')))})),n.register(r.ALERT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(r.ALERT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(r.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,i,a,n){const o='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(r.ALERT_SENDER_STARTED,(function(){a.set(o,!0)})),n.register(r.ALERT_SENDER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,a,s,c,d,u,g,p,_,m,E,f){let b,T,h=!1,w=injector.get('overviewService'),v=[],A=!1,S={},y={},I={reverse:!1,column:a.TIME_COMPLETED};const R='attack_view_filters',k={},L={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let i={};for(let t=0;t<e.length;t++)for(let a in S[e[t]])if(i[e[t]]||(i[e[t]]=[]),S[e[t]][a])switch(e[t]){case c.COMMAND_TYPES:a===s.ATTACK?i[e[t]].push(s.ATTACK):a===s.SUPPORT?i[e[t]].push(s.SUPPORT):a===s.RELOCATE&&i[e[t]].push(s.RELOCATE)}y=i,y.village=S[c.VILLAGE]?[t]:[]},N=function(){V.loadCommands()},C=function(e,t){f.trigger(r.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},M=function(e,t){
for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);f.trigger(r.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},P=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);f.trigger(r.ATTACK_VIEW_VILLAGE_RENAMED,[t])},z=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},x=function(e){const i={x:e.origin_x,y:e.origin_y},a={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(i,a,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,i){return _.actualDistance(t,e)-_.actualDistance(t,i)}))},G=function(e,t){let i=0;if(E.hasTownDataInChunk(e.x,e.y)){
const i=E.loadTownData(e.x,e.y,25,25,25),a=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,r=[];i.forEach((function(e){for(let t in e.data)for(let i in e.data[t])r.push(e.data[t][i])}));const s=r.filter((function(e){return null===e.character_id&&e.id>0})),c=r.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(s.length)l=D(s,e);else if(c.length)l=D(c,e);else{if(!a)return t(!1);{const i=r.filter((function(e){return e.tribe_id===a}));if(!i.length)return t(!1);l=D(i,e)}}return t(l[0])}const a=m.scaledGridCoordinates(e.x,e.y,25,25,25);E.loadTownDataAsync(e.x,e.y,25,25,(function(){++i===a.length&&G(e,t)}))},U=function(e){v=e.commands;for(let e=0;e<v.length;e++)w.formatCommand(v[e]),v[e].slowestUnit=x(v[e]);v=v.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(r.ATTACK_VIEW_COMMANDS_LOADED,[v])};let V={loadCommands:function(){const e=b.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:I.column,reverse:I.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return v},getFilters:function(){return S},getSortings:function(){return I},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),p.set(R,S),V.loadCommands()},toggleSorting:function(e){e===I.column?I.reverse=!I.reverse:(I.column=e,I.reverse=!1),V.loadCommands()},setCommander:function(e,i){G(e.targetVillage,(function(a){const n=e.targetVillage,o=a,l=o.character_id?s.SUPPORT:s.ATTACK;let r={};t.each(u,(function(e){r[e]='*'})),A.addCommand(n,o,i,T.OUT,r,{},l,g.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return h},init:function(){for(let e=0;e<d.length;e++)k[d[e]]=!0;for(let e in s)L[s[e]]=!0;try{A=require('two/commandQueue'),T=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),
[c.INCOMING_UNITS]:angular.copy(k),[c.VILLAGE]:!1};h=!0,b=n.getSelectedCharacter().getGlobalInfo(),S=p.get(R,t,!0),e((function(){O(),i.$on(r.COMMAND_INCOMING,N),i.$on(r.COMMAND_CANCELLED,C),i.$on(r.MAP_SELECTED_VILLAGE,z),i.$on(r.VILLAGE_NAME_CHANGED,P),i.$on(r.COMMAND_IGNORED,M),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(r,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,a,o,l,d,u,m,E,f,b,T){let h,w;const v=function(){return Date.now()/1e3},A=function(e){let t=i.$new();t.text=p('readableDateFilter')(1e3*e,i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=p('i18n')('copy',i.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const a=p('readableDateFilter')(1e3*(e.time_completed-10),i.loc.ale,i.GAME_TIMEZONE,i.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,a)},y=function(){let e=T('#two-attack-view').parent(),t=T('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},I=function(){const e=h.pagination.offset,t=h.pagination.limit;h.visibleCommands=h.commands.slice(e,e+t),
h.pagination.count=h.commands.length},R=function(){const e=Date.now();for(let t=0;t<h.commands.length;t++)100===h.commands[t].model.percent(e)&&h.commands.splice(t,1);I()},k=function(e,i){t.toggleFilter(e,i),h.filters=t.getFilters()},L=function(e){t.toggleSorting(e),h.sorting=t.getSortings()},O=function(){h.commands=t.getCommands()},N=function(){h.selectedVillageId=n.getSelectedVillage().getId()},C=function(){h=i.$new(),h.commandQueueEnabled=t.commandQueueEnabled(),h.commands=t.getCommands(),h.selectedVillageId=n.getSelectedVillage().getId(),h.filters=t.getFilters(),h.sorting=t.getSortings(),h.UNIT_TYPES=E,h.FILTER_TYPES=u,h.COMMAND_TYPES=d,h.UNIT_SPEED_ORDER=m,h.COLUMN_TYPES=l,h.pagination={count:h.commands.length,offset:0,loader:I,limit:_.getPaginationLimit()},h.openCharacterProfile=s.openCharacterProfile,h.openVillageInfo=s.openVillageInfo,h.jumpToVillage=g.jumpToVillage,h.now=v,h.copyTimeModal=A,h.removeTroops=S,h.switchWindowSize=y,h.toggleFilter=k,h.toggleSorting=L,I()
;let e=new a('twoverflow_queue_window',(function(){b.timer.remove(R)}));e.register(r.MAP_SELECTED_VILLAGE,N,!0),e.register(r.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(r.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(r.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(r.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',h),b.timer.add(R)};return function(){w=e.addMenuButton('Strażnik',40),w.addEventListener('click',C),
...
}})),define('two/attackView/types/columns',[],(function(){return{ORIGIN_VILLAGE:'origin_village_name',COMMAND_TYPE:'command_type',TARGET_VILLAGE:'target_village_name',TIME_COMPLETED:'time_completed',ORIGIN_CHARACTER:'origin_character_name'}})),define('two/attackView/types/commands',[],(function(){return{ATTACK:'attack',SUPPORT:'support',RELOCATE:'relocate'}})),define('two/attackView/types/filters',[],(function(){return{COMMAND_TYPES:'command_types',VILLAGE:'village',INCOMING_UNITS:'incoming_units'}})),define('two/attackView/unitSpeedOrder',['conf/unitTypes'],(function(e){return[e.LIGHT_CAVALRY,e.HEAVY_CAVALRY,e.AXE,e.SWORD,e.RAM,e.SNOB,e.TREBUCHET]})),require(['two/ready','two/attackView','two/attackView/ui','two/attackView/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/autoCollector',['queues/EventQueue'],(function(e){let t=!1,a=!1,s=!0,c=0;const d=function(){o.emit(l.RESOURCE_DEPOSIT_GET_INFO,{})},u=function(){if(!a)return!1
;let e=n.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return i=t.shift(),void o.emit(l.RESOURCE_DEPOSIT_COLLECT,{job_id:i.id,village_id:n.getSelectedVillage().getId()});var i;let r=e.getReadyJobs();return r?function(e){o.emit(l.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(g(r)):void 0},g=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let p={};return p.init=function(){t=!0,i.$on(r.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!s||!a)return!1;s=!1,setTimeout((function(){s=!0,u()}),1500)})),i.$on(r.RESOURCE_DEPOSIT_JOBS_REROLLED,u),i.$on(r.RESOURCE_DEPOSIT_JOB_COLLECTED,u),i.$on(r.RESOURCE_DEPOSIT_INFO,(function(e,t){u(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},p.start=function(){e.trigger(r.AUTO_COLLECTOR_STARTED),a=!0,u()},p.stop=function(){e.trigger(r.AUTO_COLLECTOR_STOPPED),a=!1},p.isRunning=function(){return a},
p.isInitialized=function(){return t},p})),define('two/autoCollector/events',[],(function(){angular.extend(r,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Kolekcjoner',50,p('i18n')('description',i.loc.ale,'auto_collector')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'auto_collector')))})),n.register(r.AUTO_COLLECTOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(r.AUTO_COLLECTOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(r.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,a,s,c){let d=!1,u=!1,g=!1,p=injector.get('secondVillageService');const _=function(){var e;e=m,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(t){if(p.hasFinishedLastJob(t.jobs))g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE),E.stop();else{let i=new c(t);n.getSelectedCharacter().setSecondVillage(i),e()}}))},m=function(){let e=n.getSelectedCharacter().getSecondVillage();if(!u||!e||!e.isAvailable())return!1;const i=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t<s.server2ClientTime(e[i].time_completed))return e[i];return!1}(e.data.jobs);if(i){const e=s.server2ClientTime(i.time_completed)-Date.now()+1e3;return setTimeout(_,e),!1}
const a=function(e){const t=Date.now();for(let i in e)if(e[i].time_started&&e[i].time_completed&&t>=s.server2ClientTime(e[i].time_completed)&&!e[i].collected)return i;return!1}(e.data.jobs);if(a)return r=a,void o.emit(l.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:n.getSelectedVillage().getId(),job_id:r});var r;const c=p.getCurrentDayJobs(e.data.jobs,e.data.day),d=p.getCollectedJobs(e.data.jobs),g=n.getSelectedVillage().getResources().getResources(),m=p.getAvailableJobs(c,d,g,[]);if(m){const e=function(e){let i=!1;return t.each(e,(function(e){return i=e,!1})),i}(m);!function(e,t){o.emit(l.SECOND_VILLAGE_START_JOB,{village_id:n.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=m[e];t?setTimeout(_,1e3*t.duration+1e3):setTimeout(_,6e4)}))}};let E={start:function(){if(!d||g)return!1;a.trigger(r.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),u=!0,_()},stop:function(){if(!d)return!1;a.trigger(r.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),u=!1},isRunning:function(){return u},
isInitialized:function(){return d},init:function(){if(!p.isFeatureActive())return!1;d=!0,o.emit(l.SECOND_VILLAGE_GET_INFO,{},(function(e){p.hasFinishedLastJob(e.jobs)?(g=!0,o.emit(l.SECOND_VILLAGE_FINISH_VILLAGE)):(i.$on(r.SECOND_VILLAGE_VILLAGE_CREATED,_),i.$on(r.SECOND_VILLAGE_JOB_COLLECTED,_))}))}};e.secondVillage=E})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,i,a,n){const o='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),i(),e((function(){a.get(o,!1,!0)&&(t.start(),t.secondVillage.start()),n.register(r.AUTO_COLLECTOR_STARTED,(function(){a.set(o,!0)})),n.register(r.AUTO_COLLECTOR_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,s=!1;let c={init:function(){a=!0}};return c.start=function(){
t.trigger(r.AUTO_HEALER_STARTED),s=!0,function(){if(!s)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let i=e.hospital.patients.healed;0==i.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia.'):setTimeout((function(){i.forEach((function(t,i){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),1e3*i),console.log('W wiosce: '+e.getName()+' wyleczono: '+t.id)}))}),3e3*t)})),e.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_healer')),console.log('Medyk zatrzymany'),c.stop()}()},c.stop=function(){t.trigger(r.AUTO_HEALER_STOPPED),s=!1},c.isRunning=function(){return s},c.isInitialized=function(){return a},c})),define('two/autoHealer/events',[],(function(){angular.extend(r,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),
define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Medyk',70,p('i18n')('description',i.loc.ale,'auto_healer')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'auto_healer'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'auto_healer')))})),n.register(r.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(r.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(r.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,i,a,n){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),
n.register(r.AUTO_HEALER_STARTED,(function(){a.set(o,!0)})),n.register(r.AUTO_HEALER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/ready','queues/EventQueue'],(function(e,t,a,o,l,s){let c,d,u=!1,g=!1,p=[],_=[];const m='battle_calculator_settings',E=function(){p=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){p.push(e[t])})),console.log('selectedPresets',p)},f=function(){_=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){_.push(e[t])})),console.log('selectedGroups',_)},b={init:function(){u=!0,c=new e({settingsMap:a,storageKey:m}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&E(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('all settings',d),l((function(){E()}),'presets'),i.$on(r.ARMY_PRESET_UPDATE,E),i.$on(r.ARMY_PRESET_DELETED,E),
i.$on(r.GROUPS_CREATED,f),i.$on(r.GROUPS_DESTROYED,f),i.$on(r.GROUPS_UPDATED,f)},start:function(){g=!0,console.log('selectedPresets',p),console.log('selectedGroups',_),s.trigger(r.BATTLE_CALCULATOR_START)},stop:function(){g=!1,console.log('example module stop'),s.trigger(r.BATTLE_CALCULATOR_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return g}};return b})),define('two/battleCalculator/events',[],(function(){angular.extend(r,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,a,o,l,s,d){let u,g,p,_=n.getPresetList(),m=n.getGroupList();const E={BATTLE:'battle',TROOPS:'troops'},f=function(e){u.selectedTab=e},b=function(){g.setAll(g.decode(u.settings)),d.notif('success','Settings saved')
},T=function(){t.isRunning()?t.stop():t.start()},h=function(){u.presets=l.encodeList(_.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=l.encodeList(m.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,p.classList.remove('btn-orange'),p.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,p.classList.remove('btn-red'),p.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=i.$new(),u.SETTINGS=a,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.BATTLE,u.settingsMap=o,g.injectScope(u),h(),w(),u.selectTab=f,u.saveSettings=b,u.switchState=T;let e=new s('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(r.ARMY_PRESET_UPDATE,h,!0),e.register(r.ARMY_PRESET_DELETED,h,!0),e.register(r.GROUPS_CREATED,w,!0),e.register(r.GROUPS_DESTROYED,w,!0),e.register(r.GROUPS_UPDATED,w,!0),e.register(r.BATTLE_CALCULATOR_START,v),
e.register(r.BATTLE_CALCULATOR_STOP,A),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',u)};return function(){g=t.getSettings(),p=e.addMenuButton('Kalkulator',180),p.addEventListener('click',S),
...
e.addStyle('#two-example-module div[select]{float:right}#two-example-module div[select] .select-handler{line-height:28px}#two-example-module .range-container{width:250px}#two-example-module .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-example-module .textfield-border.fit{width:100%}')}})),define('two/battleCalculator/settings',[],(function(){return{PRESETS:'presets',GROUPS:'groups',SOME_NUMBER:'some_number'}})),define('two/battleCalculator/settings/updates',(function(){return{PRESETS:'presets',GROUPS:'groups'}})),define('two/battleCalculator/settings/map',['two/battleCalculator/settings','two/battleCalculator/settings/updates'],(function(e,t){return{[e.PRESETS]:{default:[],updates:[t.PRESETS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'presets'},[e.GROUPS]:{default:[],updates:[t.GROUPS],disabledOption:!0,inputType:'select',multiSelect:!0,type:'groups'},[e.SOME_NUMBER]:{default:60,inputType:'number',min:0,max:120}}})),
require(['two/ready','two/battleCalculator','two/battleCalculator/ui','two/battleCalculator/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','world_config'])})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,a,s,c,d,g,p,_,m,E,f,b){let T,h,w,v=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,I=!1;const R={};let k,L,O,N,C,M=!0;const P='builder_queue_log',z='builder_queue_settings',x=function(){const e=G();if(!M)return F.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),i=t.checkReadyState(),a=t.buildingQueue;return a.getAmountJobs()!==a.getUnlockedSlots()&&(!(!i.buildingQueue||!i.buildings)&&void U(t))
}))},D=function(){G().forEach((function(e){const t=L.getVillage(e),i=t.buildingQueue;if(i.getAmountJobs()){i.getQueue().forEach((function(i){S.canBeFinishedForFree(i,t)&&A.instantBuild(i,m.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=C[s.GROUP_VILLAGES];let i=[];return e?(i=k.getGroupVillageIds(e),i=i.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){i.push(e.getId())})),i},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const i=e.buildingQueue.getQueue();let a=angular.copy(R);const n=C[s.BUILDING_SEQUENCES][C[s.ACTIVE_SEQUENCE]];if(i.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(i){if(++a[i]>t[i])return v.compute(e),V(e,i,(function(t,i){t&&i.job&&(E.trigger(r.BUILDER_QUEUE_JOB_STARTED,i.job),j(e.getId(),i.job))})),!0}))},V=function(e,t,i){const a=B(e,t);if(a===p.POSSIBLE)q(e,t,(function(e){i(!0,e)}));else if(a===p.NOT_ENOUGH_FOOD&&C[s.PRIORIZE_FARM]){const t=w[_.FARM]
;e.getBuildingData().getDataForBuilding(_.FARM).level<t&&q(e,_.FARM,(function(e){i(!0,e)}))}i(!1)},q=function(e,t,i){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:m.MASS_SCREEN,premium:!1},i)},B=function(e,t){const i=e.getBuildingData().getDataForBuilding(t);if(i.upgradeability===p.POSSIBLE){const t=i.nextLevelCosts,a=e.getResources().getComputed();if(a.clay.currentStock-C[s.PRESERVE_CLAY]<t.clay||a.iron.currentStock-C[s.PRESERVE_IRON]<t.iron||a.wood.currentStock-C[s.PRESERVE_WOOD]<t.wood)return p.NOT_ENOUGH_RESOURCES}return i.upgradeability},W=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},j=function(e,t){let i={time:b.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(i),O.length>500&&O.splice(O.length-500,O.length),f.set(P,O),!0};let F={};return F.start=function(){if(!M)return E.trigger(r.BUILDER_QUEUE_NO_SEQUENCES),!1;I=!0,T=setInterval(x,6e4),h=setInterval(D,6e3),e((function(){G().forEach((function(e){
const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),x(),D()}),['all_villages_ready']),E.trigger(r.BUILDER_QUEUE_START)},F.stop=function(){I=!1,clearInterval(T),clearInterval(h),E.trigger(r.BUILDER_QUEUE_STOP)},F.isRunning=function(){return I},F.isInitialized=function(){return y},F.getSettings=function(){return N},F.getLogs=function(){return O},F.clearLogs=function(){O=[],f.set(P,O),E.trigger(r.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let i=C[s.BUILDING_SEQUENCES];return e in i?g.SEQUENCE_EXISTS:Array.isArray(t)?(i[e]=t,N.set(s.BUILDING_SEQUENCES,i,{quiet:!0}),E.trigger(r.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let i=C[s.BUILDING_SEQUENCES];return e in i?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let i=0;i<e.length;i++){let a=e[i];if(++e[a]>t[a].max_level)return!1}return!0}(t)?(i[e]=t,N.set(s.BUILDING_SEQUENCES,i,{quiet:!0}),
E.trigger(r.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),g.SEQUENCE_SAVED):g.SEQUENCE_INVALID:g.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=C[s.BUILDING_SEQUENCES];if(!(e in t))return g.SEQUENCE_NO_EXISTS;delete t[e],N.set(s.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(r.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,O=f.get(P,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),N=new a({settingsMap:c,storageKey:z}),N.onChange((function(e,t,i){C=N.getAll(),I&&t[d.ANALYSE]&&x(),i.quiet||E.trigger(r.BUILDER_QUEUE_SETTINGS_CHANGE)})),C=N.getAll();for(let e in _)R[_[e]]=0;M=Object.keys(C[s.BUILDING_SEQUENCES]).length,w=!!M&&function(e){const t=C[s.BUILDING_SEQUENCES][e];let i=angular.copy(R);return t.forEach((function(e){i[e]++})),i}(C[s.ACTIVE_SEQUENCE]),i.$on(r.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);U(e)}),1e3)}))},F})),
define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const i=function(e){let t=[];for(let i=0;i<e.length;i++){let a=e[i];Array.isArray(a)?(a.sort(()=>Math.random()-.5),t=t.concat(a)):t.push(a)}return t}
...
t['Full Farm']=[e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM,e.FARM],function(e){let t={};for(let a in e)f.call(e,a)&&(t[a]=i(e[a]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(r,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,a,d,u,g,m,E,b,T,h,w,v){let A,S,y,I,R=n.getGroupList(),k={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},C={};const M={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,z={},x={},D=!1,G=!1;const U=function(e,t,i){return i?parseInt(Math.round(e*Math.pow(t,i-1)),10):0},V=function(e,i,a){if(a>=e.length){let i=a-e.length+1;for(;i--;)e.push(t)}e.splice(a,0,e.splice(i,1)[0])},q=function(e,t){switch(a.addBuildingSequence(e,t)){case b.SEQUENCE_SAVED:return!0;case b.SEQUENCE_EXISTS:
return d.notif('error',p('i18n')('error_sequence_exists',i.loc.ale,'builder_queue')),!1;case b.SEQUENCE_INVALID:return d.notif('error',p('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=I.get(m.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=A.settings[m.ACTIVE_SEQUENCE].value,t=A.settings[m.BUILDING_SEQUENCES][e],i=n.getGameData().getBuildings();let a={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in T)a[T[e]]=0;N.buildingSequence=t.map((function(e){let t=++a[e],o=i[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const i=n.getSelectedVillage().getBuildingQueue().getQueue();let a=!1;return i.some((function(i){
if(i.building===e&&i.level===t)return a=!0})),a}(e,t)&&(l='progress'):l='reached',{level:t,price:i[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:k[e][t-1],state:l}}))},N.generateBuildingSequenceFinal=function(e){const t=A.settings[m.ACTIVE_SEQUENCE].value,i=A.settings[m.BUILDING_SEQUENCES][e||t];let a={},n=[];for(let e in y)a[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};i.forEach((function(e){let t=++a[e].level,i=y[e].individual_level_costs[t];a[e].resources.wood+=parseInt(i.wood,10),a[e].resources.clay+=parseInt(i.clay,10),a[e].resources.iron+=parseInt(i.iron,10),a[e].resources.food+=parseInt(i.food,10),a[e].build_time+=parseInt(i.build_time,10),a[e].points+=k[e][t-1]}));for(let e in a)0!==a[e].level&&n.push({building:e,level:a[e].level,order:a[e].order,resources:a[e].resources,points:a[e].points,build_time:a[e].build_time});N.buildingSequenceFinal=n},
N.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let i in e.data.buildings){let a=e.getBuildingDataForBuilding(i);t=0,k[i]=[];for(let e=1;e<=a.max_level;e++){let n=U(a.points,a.points_factor,e)-t;t+=n,k[i].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let i=0;i<e.length;i++){let a=e[i];a.checked&&(0!==i&&(e[i-1].checked||(e[i-1].building===a.building&&(e[i-1].level++,a.level--,t=!0),V(e,i,i-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let i=e.length-1;i>=0;i--){let a=e[i];a.checked&&(i!==e.length-1&&(e[i+1].checked||(e[i+1].building===a.building&&(e[i+1].level--,a.level++,t=!0),
V(e,i,i+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.addBuilding=function(e,t,i=1){const a=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<i;e++)n.splice(a,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),D=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),D=!0},O.updateLevels=function(e,t){let i=0,a=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?i<y[t].max_level&&a.push({level:++i,building:t,checked:!1}):a.push(o)}return a},O.generateBuildingSequence=function(){const e=I.get(m.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const i=e[O.selectedSequence.value];let a={};for(let e in T)a[T[e]]=0;O.buildingSequence=i.map((function(e){return{level:++a[e],building:e,checked:!1}})),
O.updateVisibleBuildingSequence()},O.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=O.buildingSequence.length},O.updateBuildingSequence=function(){const e=O.selectedSequence.value,t=O.buildingSequence.map((function(e){return e.building}));switch(a.updateBuildingSequence(e,t)){case b.SEQUENCE_SAVED:D=!1;break;case b.SEQUENCE_NO_EXISTS:d.notif('error',p('i18n')('error_sequence_no_exits',i.loc.ale,'builder_queue'));break;case b.SEQUENCE_INVALID:d.notif('error',p('i18n')('error_sequence_invalid',i.loc.ale,'builder_queue'))}},O.modal.removeSequence=function(){let e=i.$new();e.title=p('i18n')('title',i.loc.ale,'builder_queue_remove_sequence_modal'),e.text=p('i18n')('text',i.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=p('i18n')('remove',i.loc.ale,'common'),
e.cancelText=p('i18n')('cancel',i.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),a.removeSequence(O.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},O.modal.addBuilding=function(){let e=i.$new();e.buildings=[],e.position=O.lastAddedIndex,e.indexLimit=O.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:p('i18n')(O.lastAddedBuilding,i.loc.ale,'building_names'),value:O.lastAddedBuilding};for(let t in y)e.buildings.push({name:p('i18n')(t,i.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,a=e.position,n=e.amount,o=p('i18n')(t,i.loc.ale,'building_names'),l=y[t].max_level;O.lastAddedBuilding=t,O.lastAddedIndex=a,O.addBuilding(t,a,n)?(e.closeWindow(),d.notif('success',p('i18n')('add_building_success',i.loc.ale,'builder_queue',o,a))):d.notif('error',p('i18n')('add_building_limit_exceeded',i.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=i.$new();const t=O.selectedSequence.name,a=A.settings[m.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;q(e.name,a)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=i.$new();t.title=p('i18n')('clone_warn_changed_sequence_title',i.loc.ale,'builder_queue'),t.text=p('i18n')('clone_warn_changed_sequence_text',i.loc.ale,'builder_queue'),t.submitText=p('i18n')('clone',i.loc.ale,'builder_queue'),t.cancelText=p('i18n')('cancel',i.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},C.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;C.visibleLogs=C.logs.slice(e,e+t),
A.pagination.logs.count=C.logs.length,C.visibleLogs.forEach((function(e){e.villageId&&function(e){if(z[e])return z[e];z[e]=!0,x[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){z[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},x[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},C.clearLogs=function(){a.clearLogs()};const B=function(){let e=i.$new();const t=[T.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',p('i18n')('name_sequence_min_lenght',i.loc.ale,'builder_queue')),!1;q(e.name,t)&&(A.settings[m.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[m.BUILDING_SEQUENCES][e.name]=t,j(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(M.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},j=function(){I.setAll(I.decode(A.settings)),D=!1},F=function(){a.isRunning()?a.stop():a.start()},Y=function(e,t){let a=i.$new();a.title=p('i18n')('discard_changes_title',i.loc.ale,'builder_queue'),a.text=p('i18n')('discard_changes_text',i.loc.ale,'builder_queue'),a.submitText=p('i18n')('discard',i.loc.ale,'common'),a.cancelText=p('i18n')('cancel',i.loc.ale,'common'),a.switchColors=!0,a.submit=function(){a.closeWindow(),e&&e()},a.cancel=function(){a.closeWindow(),t&&t()},c.getModal('modal_attention',a)},H=function(){D?Y((function(){P()})):P()},K={updateGroups:function(){A.groups=g.encodeList(R.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=I.get(m.BUILDING_SEQUENCES);A.sequences=g.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){A.logs=a.getLogs(),C.updateVisibleLogs()},clearLogs:function(){d.notif('success',p('i18n')('logs_cleared',i.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const a=I.get(m.BUILDING_SEQUENCES);A.settings[m.BUILDING_SEQUENCES][t]=a[t],A.settings[m.ACTIVE_SEQUENCE].value===t&&N.generateSequences(),d.notif('success',p('i18n')('sequence_updated',i.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const a=I.get(m.BUILDING_SEQUENCES);A.settings[m.BUILDING_SEQUENCES][t]=a[t],K.updateSequences(),d.notif('success',p('i18n')('sequence_created',i.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[m.BUILDING_SEQUENCES][t];const a=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(A.settings[m.BUILDING_SEQUENCES]);O.selectedSequence={name:a,value:a},K.updateSequences(),O.generateBuildingSequence(),I.get(m.ACTIVE_SEQUENCE)===t&&(I.set(m.ACTIVE_SEQUENCE,a,{quiet:!0}),N.generateSequences()),
d.notif('success',p('i18n')('sequence_removed',i.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',p('i18n')('settings_saved',i.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=I.get(m.ACTIVE_SEQUENCE);A=i.$new(),A.selectedTab=M.SETTINGS,A.TAB_TYPES=M,A.SETTINGS=m,A.running=L,A.pagination={},A.settingsMap=I.settingsMap,A.villagesLabel=x,A.villagesInfo=z,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=T.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=N,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=C,A.logsView.logs=a.getLogs(),A.selectTab=W,A.switchBuilder=F,A.saveSettings=j,A.createSequence=B,A.openVillageInfo=s.openVillageInfo,I.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
count:N.buildingSequence.length,offset:0,loader:N.updateVisibleBuildingSequence,limit:_.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:_.getPaginationLimit()},A.pagination.logs={count:C.logs.length,offset:0,loader:C.updateVisibleLogs,limit:_.getPaginationLimit()},C.updateVisibleLogs(),N.generateSequences(),O.generateBuildingSequence();let t=new h('twoverflow_builder_queue_window');t.register(r.GROUPS_UPDATED,K.updateGroups,!0),t.register(r.GROUPS_CREATED,K.updateGroups,!0),t.register(r.GROUPS_DESTROYED,K.updateGroups,!0),t.register(r.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(r.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(r.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(r.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(r.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
t.register(r.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(r.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(r.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(r.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),t.register(r.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(r.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(r.BUILDER_QUEUE_START,K.started),t.register(r.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',A),P=A.closeWindow,A.closeWindow=H,A.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),A.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(D?Y((function(){K.generateBuildingSequencesEditor(),D=!1}),(function(){A.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){y=n.getGameData().getBuildings(),
N.generateBuildingsLevelPoints(),I=a.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),w.register(r.BUILDER_QUEUE_START,(function(){L=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',p('i18n')('started',i.loc.ale,'builder_queue'))})),w.register(r.BUILDER_QUEUE_STOP,(function(){L=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',p('i18n')('stopped',i.loc.ale,'builder_queue'))})),
...
updates:[i.ANALYSE],inputType:'number',min:0,max:6e5},[t.PRIORIZE_FARM]:{default:!0,inputType:'checkbox',updates:[i.ANALYSE]}}})),define('two/builderQueue/sequenceStatus',[],(function(){return{SEQUENCE_NO_EXISTS:'sequence_no_exists',SEQUENCE_EXISTS:'sequence_exists',SEQUENCE_INVALID:'sequence_invalid',SEQUENCE_SAVED:'sequence_saved'}})),require(['two/ready','two/builderQueue','two/builderQueue/ui','two/builderQueue/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}))})),define('two/commandQueue',['two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','helper/time','helper/math','struct/MapData','Lockr','conf/buildingTypes','conf/officerTypes','conf/unitTypes'],(function(t,i,a,s,c,d,u,g,p,_,m,E,b,T,h){
const w=Object.values(c),v=Object.values(i),A=Object.values(h),S=Object.values(T),y=Object.values(b);let I,R=[],k={},L=[],O=[],N=!1;const C={[s.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[s.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[s.ALLOWED_TYPES]:function(e,t){return t[s.ALLOWED_TYPES][e.type]},[s.ATTACK]:function(e){return e.type!==c.ATTACK},[s.SUPPORT]:function(e){return e.type!==c.SUPPORT},[s.RELOCATE]:function(e){return e.type!==c.RELOCATE},[s.TEXT_MATCH]:function(e,t){let i=!0;const a=t[s.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return a.some((function(e){if(e.length&&!n.includes(e))return i=!1,!0})),i}},M=function(e){return e<p.gameTime()+I},P=function(e){R.push(e)},z=function(e){k[e.id]=e},x=function(){
E.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){I=t.getTimeOffset(),U.initialized=!0,L=E.get(d.QUEUE_SENT,[],!0),O=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){p.gameTime()>e.sendTime?U.expireCommand(e,a.TIME_LIMIT):(P(e),z(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!M(e.sendTime))return!0;N?U.sendCommand(e):U.expireCommand(e,a.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&R.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const i=function(e){const i=n.getVillages()[e.origin.id];if(!i)return a.NOT_OWN_VILLAGE;const o=i.unitInfo.units;let l={},r=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return r=a.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return r=a.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(r=a.NOT_ENOUGH_UNITS),r||l}(e);if('string'==typeof i)return U.expireCommand(e,i);e.units=i,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),E.set(d.QUEUE_SENT,L),U.removeCommand(e,a.COMMAND_SENT),g.trigger(r.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){O.push(e)}(e),E.set(d.QUEUE_EXPIRED,O),U.removeCommand(e,t)},U.addCommand=function(e,a,o,l,r,s,d,g){let _={},E={};return new Promise((function(f,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(a))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(_[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(_,{}))return I(u.NO_UNITS);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!S.includes(t))return!1;s[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[T.SUPPORTER]&&delete E[T.SUPPORTER],'string'!=typeof g||y.includes(g)?(g=!(d!==c.ATTACK||!_[h.CATAPULT])&&(g||b.HEADQUARTER),v.includes(l)?void Promise.all([new Promise(t=>m.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>m.loadTownDataAsync(a.x,a.y,1,1,e))]).then((function(n){if(e=n[0],a=n[1],!e)return I(u.INVALID_ORIGIN);if(!a)return I(u.INVALID_TARGET);const r=t.getTimeFromString(o),s=t.getTravelTime(e,a,_,d,E,!0),c=l===i.ARRIVE?r-s:r,m=l===i.ARRIVE?r:r+s;if(M(c))return I(u.ALREADY_SENT);const b={id:t.guid(),travelTime:s,arriveTime:m,sendTime:c,origin:e,target:a,date:o,dateType:l,units:_,officers:E,type:d,catapultTarget:g,countdown:c-p.gameTime()};P(b),z(b),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
x(),f(b)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete k[e.id];const i=R.some((function(t,i){if(t.id==e.id)return R.splice(i,1),x(),!0}));if(i)switch(t){case a.TIME_LIMIT:g.trigger(r.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case a.NOT_OWN_VILLAGE:g.trigger(r.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case a.NOT_ENOUGH_UNITS:g.trigger(r.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case a.COMMAND_REMOVED:g.trigger(r.COMMAND_QUEUE_REMOVE,e)}else g.trigger(r.COMMAND_QUEUE_REMOVE_ERROR,e);return i},U.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),O=[],L=[]},U.start=function(e){N=!0,g.trigger(r.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){N=!1,g.trigger(r.COMMAND_QUEUE_STOP)},U.isRunning=function(){return N},U.getWaitingCommands=function(){return R},U.getWaitingCommandsObject=function(){return k},U.getSentCommands=function(){return L},
U.getExpiredCommands=function(){return O},U.filterCommands=function(e,t,i){const a=C[e];return(i||R).filter((function(e){return a(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(r,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,a,o,l,d,u,g,_,m,E,f,b,T,h){let w,v,A,S,y,I=n.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),L=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},C=N.ADD;let M,P,z,x=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){O=t.data},B=function(){O=!1},W=function(e){
const t=new Date(e||b.gameTime()+o.getTimeOffset()),i=t.getMilliseconds(),a=b.zerofill(i-i%100,3),n=b.zerofill(t.getSeconds(),2),l=b.zerofill(t.getMinutes(),2);return b.zerofill(t.getHours(),2)+':'+l+':'+n+':'+a+' '+b.zerofill(t.getDate(),2)+'/'+b.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(w.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!w.isValidDate&&o.getTimeFromString(y.date),t=w.selectedDateType.value===l.ARRIVE;o.each(g,(function(i){o.each(U,(function(a,n){const l=o.getTravelTime(y.origin,y.target,a,i,y.officers,!0);w.travelTimes[i][n].travelTime=p('readableMillisecondsFilter')(l),w.travelTimes[i][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&w.isValidDate?b.gameTime()+M<e?'valid':'invalid':'neutral'},H=function(){y.dateType=w.selectedDateType.value,h.set(_.LAST_DATE_TYPE,w.selectedDateType.value),F()},K=function(){
y.catapultTarget=w.catapultTarget.value},Q=function(){const e=w.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];w.selectedInsertPreset={name:p('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,w.catapultTarget={name:p('i18n')(t.catapult_target,i.loc.ale,'building_names'),value:t.catapult_target},w.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=b.serverTime()+i.GAME_TIME_OFFSET,a=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=a-t}),b.timer.add(e.updateCountdown)},X=function(){w.waitingCommands=t.getWaitingCommands()},J=function(){w.sentCommands=t.getSentCommands()},$=function(){w.expiredCommands=t.getExpiredCommands()},ee=function(){let e=w.waitingCommands;V.forEach((function(i){w.activeFilters[i]&&(e=t.filterCommands(i,w.filtersData,e))})),
w.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ie=function(e){''===y.units[e]&&(y.units[e]=0)},ae=function(){w.showCatapultSelect=!!y.units.catapult},ne=function(e){w.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!O)return o.notif('error',p('i18n')('error_no_map_selected_village',i.loc.ale,'command_queue'));f.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},re=function(){y.date=W()},se=function(){if(!y.date)return!1;y.date=j(y.date,100)},ce=function(){if(!y.date)return!1;y.date=j(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",w.catapultTarget={name:p('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',_e(e.type,'added'))})).catch((function(t){switch(t){case m.INVALID_ORIGIN:o.notif('error',p('i18n')('error_origin',i.loc.ale,'command_queue'));break;case m.INVALID_TARGET:o.notif('error',p('i18n')('error_target',i.loc.ale,'command_queue'));break;case m.INVALID_DATE:o.notif('error',p('i18n')('error_invalid_date',i.loc.ale,'command_queue'));break;case m.NO_UNITS:o.notif('error',p('i18n')('error_no_units',i.loc.ale,'command_queue'));break;case m.RELOCATE_DISABLED:o.notif('error',p('i18n')('error_relocate_disabled',i.loc.ale,'command_queue'));break;case m.ALREADY_SENT:o.notif('error',p('i18n')('error_already_sent_'+e,i.loc.ale,'command_queue'))}}))},ge=function(){t.clearRegisters(),J(),$()},pe=function(){t.isRunning()?t.stop():t.start()},_e=function(e,t,a){return a&&(e=a+'.'+e),p('i18n')(e,i.loc.ale,'command_queue')+' '+p('i18n')(t,i.loc.ale,'command_queue')},me=function(e,t){w.activeFilters[e]=!w.activeFilters[e],
t&&(w.filtersData[u.ALLOWED_TYPES][e]=!w.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){w.activeFilters[u.TEXT_MATCH]=w.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){w.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,i,a){if('commandqueue_village_search'!==t)return!1;y[a]={id:i.raw.id,x:i.raw.x,y:i.raw.y,name:i.raw.name},w.searchQuery[a]=''},removeCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),i.$broadcast(r.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',_e(t.type,'removed'))},removeError:function(){o.notif('error',p('i18n')('error_remove_error',i.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',_e(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',p('i18n')('error_not_own_village',i.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',p('i18n')('error_no_units_enough',i.loc.ale,'command_queue'))},sendCommand:function(e,t){b.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',_e(t.type,'sent'))},start:function(e,i){if(w.running=t.isRunning(),i.disableNotif)return!1;o.notif('success',_e('title','activated'))},stop:function(){w.running=t.isRunning(),o.notif('success',_e('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{b.timer.remove(e.updateCountdown)})}},be=function(){const e=h.get(_.LAST_DATE_TYPE,l.OUT,!0);let m;w=i.$new(),w.selectedTab=C,w.inventory=n.getInventory(),w.presets=o.obj2selectOptions(L.getPresets()),w.travelTimes={},o.each(g,(function(e){w.travelTimes[e]={},o.each(U,(function(t,i){w.travelTimes[e][i]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=S,w.officers=I.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=T.toActionList(l,(function(e){return p('i18n')(e,i.loc.ale,'command_queue')})),w.selectedDateType={name:p('i18n')(e,i.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:p('i18n')('add_insert_preset',i.loc.ale,'command_queue'),value:null},w.catapultTarget={name:p('i18n')("wall",i.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:p('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:p('i18n')('add_origin',i.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:p('i18n')('add_village_search',i.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:p('i18n')('add_target',i.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!y.units.catapult,w.attackableBuildings=x,w.commandData=y,
w.activeFilters=P,w.filtersData=z,w.running=t.isRunning(),w.waitingCommands=t.getWaitingCommands(),w.visibleWaitingCommands=t.getWaitingCommands(),w.sentCommands=t.getSentCommands(),w.expiredCommands=t.getExpiredCommands(),w.EVENT_CODES=d,w.FILTER_TYPES=u,w.TAB_TYPES=N,w.COMMAND_TYPES=g,w.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),w.onUnitInputFocus=te,w.onUnitInputBlur=ie,w.catapultTargetVisibility=ae,w.selectTab=ne,w.addSelected=oe,w.addMapSelected=le,w.addCurrentDate=re,w.incrementDate=se,w.reduceDate=ce,w.cleanUnitInputs=de,w.addCommand=ue,w.clearRegisters=ge,w.switchCommandQueue=pe,w.removeCommand=t.removeCommand,w.openVillageInfo=s.openVillageInfo,w.toggleFilter=me,w.$watch('commandData.origin',F),w.$watch('commandData.target',F),w.$watch('commandData.date',F),w.$watch('commandData.officers',F),w.$watch('selectedDateType.value',H),w.$watch('selectedInsertPreset.value',Q),w.$watch('catapultTarget.value',K),w.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),
w.$watch('selectedTab',(function(){w.selectedTab===N.ADD?m=setInterval((function(){F()}),2500):clearInterval(m)})),w.waitingCommands.forEach(e=>{Z(e)});let E=new a('twoverflow_queue_window',(function(){clearInterval(m),fe.clearCountdownUpdates()}));E.register(r.ARMY_PRESET_UPDATE,fe.updatePresets,!0),E.register(r.ARMY_PRESET_DELETED,fe.updatePresets,!0),E.register(r.SELECT_SELECTED,fe.autoCompleteSelected,!0),E.register(r.COMMAND_QUEUE_REMOVE,fe.removeCommand),E.register(r.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),E.register(r.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),E.register(r.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),E.register(r.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),E.register(r.COMMAND_QUEUE_SEND,fe.sendCommand),E.register(r.COMMAND_QUEUE_START,fe.start),E.register(r.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){A=n.getSelectedCharacter(),M=o.getTimeOffset()
;const t=I.getAttackableBuildings();for(let e in t)x.push({name:p('i18n')(e,i.loc.ale,'building_names'),value:e});S=angular.copy(R),S.splice(S.indexOf('catapult'),1),R.forEach((function(e){D[e]=0})),k.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},z={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',20),v.addEventListener('click',be),E.register(r.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),E.register(r.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),i.$on(r.SHOW_CONTEXT_MENU,q),i.$on(r.DESTROY_CONTEXT_MENU,B),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,i){if(t.initialized)return!1;e((function(){t.init(),i(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,a,s,c,d){let u,g,_,m,E,f=!1,b=!1,T=0;u=function(e){let t,i,a=0;for(t=0;t<e.length;t++)i=e[t].chapel||e[t].church,i&&i>a&&(a=i);return a},g=function(e,t){let i=n.getWorldConfig().getChurchBonus(),a=0
;return e<0||!t&&e>i.length-1?0:(a=t?n.getWorldConfig().getChapelBonus():i[e],Math.floor(100*a))},_=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let h={init:function(){f=!0}};return h.start=function(){a.trigger(r.FAITH_CHECKER_STARTED),b=!0,n.getSelectedCharacter().getVillageList().forEach((function(a){let n=a.data.villageId,r=a.data.buildings.chapel.level,s=a.buildingQueue.data.queue,c=a.getResources().getComputed(),f=c.food,b=c.wood,h=c.clay,w=c.iron,v=f.currentStock,A=b.currentStock,S=h.currentStock,y=w.currentStock,I=[0,5e3],R=[160,16e3],k=[200,2e4],L=[50,5e3];1==r&&(T=1),_(n,(function(a){m=u(a.villages),E=g(m,1===r),console.log(E),50!=E||s!==t&&0!=s.length?50==E&&s?s.forEach((function(t){let a=t.building;'chapel'==a&&'church'==a||0!=T?'chapel'==a&&'church'==a||1!=T||(A>=R[1]&&S>=k[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('church',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))):A>=R[0]&&S>=k[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('chapel',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))})):e.notif('success',p('i18n')('full',i.loc.ale,'faith_checker')):1==T?A>=R[1]&&S>=k[1]&&y>=L[1]&&v>=I[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',p('i18n')('church',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker')):A>=R[0]&&S>=k[0]&&y>=L[0]&&v>=I[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',p('i18n')('chapel',i.loc.ale,'faith_checker'))):e.notif('error',p('i18n')('resources',i.loc.ale,'faith_checker'))}))}))},h.stop=function(){a.trigger(r.FAITH_CHECKER_STOPPED),b=!1},h.isRunning=function(){return b},h.isInitialized=function(){return f},h})),define('two/faithChecker/events',[],(function(){angular.extend(r,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,p('i18n')('description',i.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'faith_checker'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'faith_checker')))})),n.register(r.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
n.register(r.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(r.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,i,a,n){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(r.FAITH_CHECKER_STARTED,(function(){a.set(o,!0)})),n.register(r.FAITH_CHECKER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,a,s,c,g,p,_,m,b,T,h,w,v,A,S,y,I){let R,k,L,O,N,C=!1,M=!1,P=[],z=[],x=[],D=[],G=[],U=[],V=!1,q=!1,B=!1,W=0,j=null,F=null,Y=null,H={},K=h.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(k[s.MIN_DISTANCE],k[s.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!x.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(k[s.MIN_POINTS],k[s.MAX_POINTS])}},ie=[te.distance,te.ownPlayer,te.included,te.ignored],ae=function(e){return e.sort().filter((function(e,t,i){return!t||e!=i[t-1]}))},ne=function(){!function(){const e=k[s.GROUP_INCLUDE];x=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);x=x.concat(t)})),x=ae(x)}(),function(){const e=k[s.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=k[s.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),G=G.concat(t)})),G=ae(G)}(),function(){const e=D.concat(x);let t=!1;e.forEach((function(e){f.call(L,e)||(L[e]={time:h.gameTime(),report:!1},t=!0)})),m.each(L,(function(i,a){a=parseInt(a,10),e.includes(a)||(delete L[a],t=!0)})),t&&(I.set($,L),w.trigger(r.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),w.trigger(r.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const i=k[s.GROUP_INCLUDE],a=k[s.GROUP_IGNORE],n=k[s.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),a===t.group_id&&(o?(Re(t.village_id),l=!0):(Oe(t.village_id),Ee(p.IGNORED_VILLAGE,{villageId:t.village_id}),me(t.village_id))),i.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE,{villageId:t.village_id}),me(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){M&&e.start()})),l=!0}l&&w.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const i=k[s.GROUP_INCLUDE],a=k[s.GROUP_IGNORE],n=k[s.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),a===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){M&&e.start()})),l=!0}else Ne(),Ee(p.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});i.includes(t.group_id)&&!o&&(Ne(),Ee(p.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Re(t.village_id),l=!0),l&&w.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},re=function(e){
const t=n.getGroupList().getGroups(),i=k[s.GROUP_IGNORE],a=k[s.GROUP_ONLY],o=k[s.GROUP_INCLUDE],l=f.call(t,i)?i:R.getDefault(s.GROUP_IGNORE),r=a.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));R.setAll({[s.GROUP_IGNORE]:l,[s.GROUP_ONLY]:r,[s.GROUP_INCLUDE]:c},e)},se=function(){re(),ne(),Ie(),Ne(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();k[s.PRESETS].forEach((function(t){if(!f.call(e,t))return;let i=e[t];i.load=_e(i),i.travelTime=d.calculateTravelTime(i,{barbarian:!1,officers:!1}),U.push(i)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(w.trigger(r.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),M&&Ce.stop())},ue=function(e,t){k[s.IGNORE_ON_LOSS]&&k[s.GROUP_IGNORE]&&M&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=k[s.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ge=function(e,t){V&&B&&t.origin.id===V.getId()&&t.target.id===B.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},pe=function(e,t){V&&q&&B&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},_e=function(e){let t=0;return m.each(e.units,(function(e,i){e&&(t+=N[i].load*e)})),t},me=function(e){L[e]={time:h.gameTime(),report:H[e]||!1},delete H[e],I.set($,L),w.trigger(r.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Ee=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=h.gameTime(),t.type=e,z.unshift(t),fe(),!0)},fe=function(){const e=k[s.LOGS_LIMIT];z.length>e&&z.splice(z.length-e,z.length),I.set(X,z),w.trigger(r.FARM_OVERFLOW_LOGS_UPDATED)},be=function(e,t,i){const a=k[s.TARGET_MULTIPLE_FARMERS],n=k[s.TARGET_SINGLE_ATTACK];if(a&&i){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},Te=function(){K=h.gameTime()},he=function(){clearTimeout(j),clearTimeout(F),clearTimeout(Y),j=null,F=null,Y=null
},we=function(){return Math.max(1,60*k[s.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*k[s.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=E,this.status=a.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{w.trigger(r.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return Te(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,w.trigger(r.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(w.trigger(r.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(r.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,w.trigger(r.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(a.USER_STOP),he(),this.onCycleEndFn(e),this.onCycleEndFn=E},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;Te();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let i,c,u,g,p=!1,_=!1;const E=()=>new Promise((t,i)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return i(a.USER_STOP);t()},m.randomSeconds(ve())):t()}),b=()=>new Promise((e,i)=>{const n=50-k[s.PRESERVE_COMMAND_SLOTS];t.length>=n?i(a.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(k[s.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),i=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>i[e].currentStock===n))return t(a.FULL_STORAGE)}e()
}),I=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(a.TARGET_CYCLE_END):(i=this.targets[this.index],void e()):t(a.NO_TARGETS)),R=()=>new Promise((e,t)=>{y.getTownAtAsync(i.x,i.y,n=>{if(te.points(n.points))return t(a.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:i.id},n=>{this.running?null!==i.character_id||null===n.owner_id||x.includes(i.id)?i.attack_protection?t(a.PROTECTED_VILLAGE):e():t(a.ABANDONED_CONQUERED):t(a.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const i=n.getPresetList().getPresetsByVillageId(e);let a=[];if(U.forEach((function(e){f.call(i,e.id)||a.push(e.id)})),a.length){for(let e in i)f.call(i,e)&&a.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:a},t)}else t()}(this.villageId,()=>{this.running?e():t(a.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*k[s.MAX_TRAVEL_TIME],l=this.village.getPosition(),r=T.actualDistance(l,i);m.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],i=e[1];return n[t].in_town<i}))return;const s=d.calculateTravelTime(l,{barbarian:!i.character_id,officers:!1});return o>s*r?(p=l,e()):t(a.TIME_LIMIT),!1}),p||t(a.NO_UNITS)}),C=()=>new Promise((e,n)=>{c=!1,g=O.getVillageList();const o=g.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=g.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===i.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===i.id&&'forward'===e.data.direction),be(u,c,o))return n(a.BUSY_TARGET);o&&(_=!0),e()}),M=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*k[s.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(k[s.TARGET_SINGLE_ATTACK]&&!k[s.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(h.gameTime()/1e3),l=k[s.TARGET_MULTIPLE_FARMERS]?g:[this.village],r=this.village.getPosition(),_=T.actualDistance(r,i),m=d.calculateTravelTime(p,{
barbarian:!i.character_id,officers:!0,effects:!0}),E=d.getTravelTimeForDistance(p,m,_,v.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===i.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+E-e.time_completed)<n)}))return t(a.BUSY_TARGET);e()}),P=()=>new Promise((e,t)=>{if(_)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:i.id,num_reports:0},i=>{if(!this.running)return t(a.USER_STOP);const n=i.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(be(l,o,!0))return t(a.BUSY_TARGET);e()})});let z=new Promise((e,t)=>{E().then(b).then(S).then(I).then(R).then(L).then(N).then(C).then(M).then(P).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(a.EXPIRED_STEP)},3e4)});Promise.race([z,D]).then(()=>{if(!this.running)return!1
;this.setStatus(a.ATTACKING),q=!0,B=i,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:i.id,army_preset_id:p.id,type:v.TYPES.ATTACK})}).catch(t=>{switch(he(),w.trigger(r.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case a.TIME_LIMIT:case a.BUSY_TARGET:case a.ABANDONED_CONQUERED:case a.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case a.USER_STOP:this.setStatus(t);break;case a.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Oe(i.id),this.targetStep(e);break;case a.NO_UNITS:case a.NO_TARGETS:case a.FULL_STORAGE:case a.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case a.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case a.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(a.UNKNOWN),this.stop(a.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||a.UNKNOWN},Ae.prototype.commandSent=function(e){q=!1,B=!1,he(),Ee(p.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){q=!1,B=!1,this.stop(a.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();_.load(i=>{this.targets=function(e,t){return e.map((function(e){return e.distance=T.actualDistance(t,e),e}))}(i,t),this.targets=function(e){return e.filter((function(e){return ie.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,k[s.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=k[s.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let i=Ce.getFarmer(e);return i||(i=new Ae(e),P.push(i)),i},ye=function(){m.each(O.getVillages(),(function(e,t){Se(t)})),w.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Ie=function(){const e=k[s.GROUP_ONLY];let t=[];P.forEach((function(i){let a=i.getId();e.length&&!G.includes(a)?t.push(a):D.includes(a)&&t.push(a)})),t.length&&(t.forEach((function(e){Re(e)})),w.trigger(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Re=function(e){for(let i=0;i<P.length;i++)if(P[i].getId()===e)return P[i].stop(t.KILL_FARMER),P.splice(i,i+1),!0;return!1
},ke=function(e){Te(),P.length?W>=P.length?(W=0,V=!1,Z=h.gameTime()+we(),w.trigger(r.FARM_OVERFLOW_CYCLE_END)):V=P[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,w.trigger(r.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):j=setTimeout((function(){j=null,W=0,Z=null,w.trigger(r.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),we())},Le=function(e){for(let t=0;t<P.length;t++){let i=P[t].getTargets();for(let t=0;t<i.length;t++){if(i[t].id===e)return!0}}return!1},Oe=function(e){P.forEach((function(t){t.removeTarget(e)}))},Ne=function(){_.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ce={};return Ce.init=function(){C=!0,z=I.get(X,[]),L=I.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,i){k=R.getAll(),"ignore_update"!==i&&(t[g.PRESET]&&ce(),t[g.GROUPS]&&ne(),t[g.TARGETS]&&Ne(),t[g.VILLAGES]&&(Ie(),ye()),t[g.LOGS]&&fe(),t[g.INTERVAL_TIMERS]&&M&&(F?(he(),
V.targetStep({delay:!0})):j&&(he(),w.trigger(r.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),re("ignore_update"),ne(),ye(),b((function(){ce()}),'presets'),b((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),i.$on(r.ARMY_PRESET_UPDATE,de),i.$on(r.ARMY_PRESET_DELETED,de),i.$on(r.GROUPS_VILLAGE_LINKED,oe),i.$on(r.GROUPS_VILLAGE_UNLINKED,le),i.$on(r.GROUPS_DESTROYED,se),i.$on(r.COMMAND_SENT,ge),i.$on(r.MESSAGE_ERROR,pe),i.$on(r.REPORT_NEW,ue)},Ce.start=function(){let e;return!M&&(U.length?(M=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),Te(),function(){let e=we(),t=e+e/2+ve();Q=setInterval((function(){h.gameTime()-K>t&&(Ce.stop(),setTimeout(Ce.start,5e3))}),3e4)}(),w.trigger(r.FARM_OVERFLOW_START),void Ee(p.FARM_START)):(M=!1,!1)):(w.trigger(r.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ce.stop=function(e=a.USER_STOP){V?(V.stop(e),
e!==a.USER_STOP&&(Z=h.gameTime()+we()),w.trigger(r.FARM_OVERFLOW_CYCLE_END,e)):Z=null,M=!1,he(),w.trigger(r.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===a.USER_STOP&&Ee(p.FARM_STOP)},Ce.getFarmer=function(e){return P.find((function(t){return t.getId()===e}))},Ce.getFarmers=function(){return P},Ce.getSettings=function(){return R},Ce.getExceptionVillages=function(){return{included:x,ignored:D}},Ce.getExceptionLogs=function(){return L},Ce.isInitialized=function(){return C},Ce.isRunning=function(){return M},Ce.getLogs=function(){return z},Ce.clearLogs=function(){return z=[],I.set(X,z),w.trigger(r.FARM_OVERFLOW_LOGS_UPDATED),z},Ce.getNextCycleDate=function(){return Z},Ce.getCycleInterval=we,Ce})),define('two/farmOverflow/events',[],(function(){angular.extend(r,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,a,d,u,E,f,b,T,h,w){let v,A,S,y=n.getPresetList(),I=n.getGroupList(),R={},k={},L=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&C(e.villageId),e.targetId&&C(e.targetId)}))},C=function(e){if(R[e])return R[e];R[e]=!0,k[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){R[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},k[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},M=function(){
v.exceptionVillages.included.forEach((function(e){C(e)})),v.exceptionVillages.ignored.forEach((function(e){C(e)}))},P=function(){t.isRunning()?t.stop():t.start()},z=function(e){v.selectedTab=e},x=function(){A.setAll(A.decode(v.settings)),v.saveButtonColor='orange',T.notif('success',p('i18n')('settings_saved',i.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(E.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(E.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){v.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){v.groups=f.encodeList(I.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=f.encodeList(I.getGroups(),{disabled:!0,type:'groups'})},q=function(){v.running=!0,
T.notif('success',p('i18n')('farm_started',i.loc.ale,'farm_overflow'))},B=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:T.notif('success',p('i18n')('no_preset',i.loc.ale,'farm_overflow'));break;case d.USER_STOP:T.notif('success',p('i18n')('farm_stopped',i.loc.ale,'farm_overflow'))}},W=function(){v.logs=angular.copy(t.getLogs()),N(),v.logs.length||T.notif('success',p('i18n')('reseted_logs',i.loc.ale,'farm_overflow'))},j=function(){v.farmers=t.getFarmers()},F=function(){v.exceptionVillages=t.getExceptionVillages(),M()},Y=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,i){i!==a.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=i.$new(),v.SETTINGS=E,v.TAB_TYPES=O,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=O.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=k,v.villagesInfo=R,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=A.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:N,limit:_.getPaginationLimit()},A.injectScope(v),U(),V(),N(),M(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-w.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=P,v.selectTab=z,v.saveSettings=x,v.clearLogs=t.clearLogs,v.jumpToVillage=g.jumpToVillage,v.openVillageInfo=s.openVillageInfo,v.showReport=m.showReport,v.removeIgnored=D,v.removeIncluded=G;let a=new b('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));a.register(r.ARMY_PRESET_UPDATE,U,!0),a.register(r.ARMY_PRESET_DELETED,U,!0),a.register(r.GROUPS_UPDATED,V,!0),a.register(r.GROUPS_CREATED,V,!0),a.register(r.GROUPS_DESTROYED,V,!0),
a.register(r.FARM_OVERFLOW_START,q),a.register(r.FARM_OVERFLOW_STOP,B),a.register(r.FARM_OVERFLOW_LOGS_UPDATED,W),a.register(r.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,j),a.register(r.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),a.register(r.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),a.register(r.FARM_OVERFLOW_CYCLE_BEGIN,H),a.register(r.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){Q()})),h.register(r.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),h.register(r.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,i){if(t.isInitialized())return!1;e((function(){t.init(),i()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,a,o,l,s,c,d,u,p,_,m,E,b,T,h,w,v,A){let S,y,I,R,k,L,O,N,C,M,P,z,x,D,G,U,V,q,B,W,j,F,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ie={},ae=!1;const ne='minimap_settings',oe={[a.VERY_SMALL]:2,[a.SMALL]:3,[a.BIG]:5,[a.VERY_BIG]:7},le=injector.get('colorService'),re=injector.get('spriteFactory')
;let se,ce=!0,de=!1,ue={},ge={x:0,y:0},pe=!0;const _e=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,me=function(e){let t=Math.ceil(ee.x+e.offsetX)-R,i=Math.ceil(ee.y+e.offsetY)+R;return Math.floor(i/y)%2&&(t+=R),t-=t%y,i-=i%y,{x:Math.ceil((t-C.width/2)/y),y:Math.ceil((i-C.height/2)/y)}},Ee=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},fe=function(){Ae(k)},be=function(){if(H){const e={x:ee.x-C.width/2,y:ee.y-C.height/2};M.clearRect(0,0,C.width,C.height),D.clearRect(0,0,x.width,x.height),function(e){M.drawImage(P,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),i=(t.x-2)*y-e.x,a=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(i,0,1,I),D.fillRect(0,a,I,1);const n=U.getBoundingClientRect(),l=n.width/v.TILESIZE.x/A.view.z*y,r=n.height/v.TILESIZE.y/A.view.z*y,s=i-l/2,c=a-r/2;D.clearRect(s,c,l,r),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(s,c,l,r),D.stroke()}(e)}e.requestAnimationFrame(be)
},Te=function(){if(!ae)return!1;const e=Q.village[O][N];we(e?Q.character[e]:[[O,N]]),ae=!1,_.trigger(r.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},he=function(e){let t=[];for(let i=0;i<e.length;i++){let a=e[i][0],n=e[i][1];t.push(ie[a][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let i=0;i<e.length;i++){let a=e[i][0],n=e[i][1];t.push(ie[a][n])}Ae(t)},ve=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===q){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(B&&B===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return W.ally;if(j.isEnemy(e.tribe_id))return W.enemy;if(j.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let i=0;i<e.length;i++){const a=e[i];if(a.id<0)continue;const n=t||ve(a);if(!n)continue;const o=a.x*y+(a.y%2?R:0),l=a.y*y;z.fillStyle=n,z.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,P.width=1e3*y,P.height=1e3*y,z.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;C.width=686,C.height=e,x.width=686,x.height=e,M.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var i,a;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ae&&(_.trigger(r.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(i=O,a=N,E.getTownAtAsync(i,a,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),_.trigger(r.MINIMAP_START_MOVE)},Re=function(){de=!1,ue={},ce||_.trigger(r.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,ge=me(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=ge.x,te.y=ge.y,!1;if(te.x===ge.x&&te.y===ge.y||(se.alpha=0,function(e,t){let i=g.tileCoordinate2Pixel(e,t);se.setTranslation(i[0]-25,i[1]+2),se.alpha=1}(ge.x,ge.y)),ge.x in ie&&ge.y in ie[ge.x]){let t=ie[ge.x][ge.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ae){if(O===e.x&&N===e.y)return!1;Te()}ae=!0,O=e.x,N=e.y,_.trigger(r.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const i=Q.village[O][N];he(i?Q.character[i]:[[O,N]])}(ge,e)}Te()},Le=function(){ae&&Te(),
_.trigger(r.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=me(e);g.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},Ce=function(){K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},fe()},Me=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return _.trigger(r.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!_e.test(t))return _.trigger(r.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const a='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(a,K[e.type]),i.$broadcast(r.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
;const a='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(a,K[e]),i.$broadcast(r.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let i in K[t])e(t,i,K[t][i])},setViewport:function(e){C=e,C.style.background=Y[o.COLOR_BACKGROUND],M=C.getContext('2d')},setViewportRef:function(e){x=e,D=x.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Pe.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=E.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const i=Ee(e[0]*t,e[1]*t),a=Ee(e[2]*t,e[3]*t);return[i.x-1,i.y-1,a.x+3||1,a.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Pe.getSettings=function(){return F},Pe.drawMinimap=function(){pe&&(pe=!1),C.style.background=Y[o.COLOR_BACKGROUND],z.clearRect(0,0,P.width,P.height),d((function(){
!function(){const e=T.getPath(v.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],i=Y[o.SHOW_PROVINCE_DEMARCATIONS],a=function(e,t){z.fillStyle=Y[o.COLOR_CONTINENT],z.fillRect(e*y+R-1,t*y+R-1,3,1),z.fillRect(e*y+R,t*y+R-2,1,3)},n=function(e,t){z.fillStyle=Y[o.COLOR_PROVINCE],z.fillRect(e*y+R,t*y+R-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},r={a:X.a-10,b:X.b+10};if(t||i)for(let e=l.a;e<l.b;e++)for(let l=r.a;l<r.b;l++){const r=b.toTile(o,e,l);r.key.b&&(r.key.c&&t?a(e,l):i&&n(e,l))}const s=l.a*y,c=r.a*y,d=(l.b-l.a)*y,u=(r.b-r.a)*y;z.beginPath(),z.lineWidth=2,z.strokeStyle="#2B4700",z.rect(s,c,d,u),z.stroke()}))}(),fe()}),'minimap_data')},Pe.enableRendering=function(){H=!0},Pe.disableRendering=function(){H=!1},Pe.isFirstDraw=function(){return!!pe},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),z=P.getContext('2d'),se=re.make('hover'),F=new u({settingsMap:l,storageKey:ne}),F.onChange((function(e,t){
Y=F.getAll(),Se(),t[s.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[s.MINIMAP]&&Pe.drawMinimap()})),Y=F.getAll(),K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),j=V.getTribeRelations(),q=V.getId(),B=V.getTribeId(),W=V.getVillagesColors(),se.alpha=0,A.graph.layers.effects.push(se),ye(),L=V.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),x.addEventListener('mousedown',Ie),x.addEventListener('mouseup',Re),x.addEventListener('mousemove',ke),x.addEventListener('mouseleave',Le),x.addEventListener('click',Oe),x.addEventListener('contextmenu',Ne),p.load((function(){k=p.getVillages(),function(e){for(let t=0,i=e.length;t<i;t++){let i=e[t];i.id<0||(i.x in Q.village||(Q.village[i.x]={}),i.x in ie||(ie[i.x]=[]),
Q.village[i.x][i.y]=i.character_id||0,ie[i.x][i.y]=i,i.character_id&&(i.character_id in Q.character?Q.character[i.character_id].push([i.x,i.y]):Q.character[i.character_id]=[[i.x,i.y]],i.tribe_id&&(i.tribe_id in Q.tribe?Q.tribe[i.tribe_id].push(i.character_id):Q.tribe[i.tribe_id]=[i.character_id])))}}(k),function(){let e=[],t=[];for(let i in Q.village){e.push(i);for(let e in Q.village[i])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),be(),i.$on(r.VILLAGE_SELECTED_CHANGED,Me),i.$on(r.TRIBE_RELATION_CHANGED,fe),i.$on(r.GROUPS_VILLAGES_CHANGED,Ce)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(r,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,g,_,m,E,f,b,T,h,w){let v,A,S,y,I,R,k,L,O,N,C,M={},P=!1,z={character:{},tribe:{}};const x={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=x.MINIMAP,G=function(e){v.selectedTab=e,e===x.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(v.highlights.character).forEach((function(e){e in z.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
z.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in z.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){z.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!O)return;let i=V(t.x,t.y);var a,n;N=i,M[i]=!0,P=!0,(a=t.x,n=t.y,new Promise((function(e){let t=T.getTownAt(a,n);if(t)return e(t);T.loadTownDataAsync(a,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!M[V(e.x,e.y)])return;if(!P)return;k.appendChild(O),O.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const i=O.getBoundingClientRect(),a=k.getBoundingClientRect(),n=i.width+50,o=i.height+50,l=R.tt.position.y+o>a.top+a.height,r=R.tt.position.x+n>a.width;l&&(R.tt.position.y-=50),O.classList.toggle('left',r),O.classList.toggle('top',l)}))},B=function(e,t){if(!O)return;let i=t?V(t):N;M[i]=!1,P=!1,R.tt.visible=!1,O.classList.add('ng-hide'),L.appendChild(O)},W=function(e,t,a){let o,l,r=i.$new(),s=!0;r.colorPalettes=w.palette,'setting'===e?(l=t,o=C.get(l),s=!1,r.submit=function(){v.settings[l]='#'+r.selectedColor,r.closeWindow()},r.reset=function(){v.settings[l]=C.getDefault(l),r.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,r.submit=function(){v.addHighlightColor='#'+r.selectedColor,r.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][a],r.submit=function(){n.addHighlight({id:a,type:t},r.selectedColor),r.closeWindow()}),r.selectedColor=o.replace('#',''),r.hasCustomColors=!0,r.hideReset=s,r.finishAction=function(e,t){r.selectedColor=t},
c.getModal('modal_color_palette',r)},j=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},F=function(){C.setAll(C.decode(v.settings)),m.notif('success',p('i18n')('settings_saved',i.loc.ale,'minimap'))},Y=function(){let e=i.$new();e.title=p('i18n')('reset_confirm_title',i.loc.ale,'minimap'),e.text=p('i18n')('reset_confirm_text',i.loc.ale,'minimap'),e.submitText=p('i18n')('reset',i.loc.ale,'common'),e.cancelText=p('i18n')('cancel',i.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){C.resetAll(),m.notif('success',p('i18n')('settings_reset',i.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?s.openCharacterProfile:s.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){m.notif('error',p('i18n')('highlight_add_error_exists',i.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){m.notif('error',p('i18n')('highlight_add_error_no_entry',i.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){m.notif('error',p('i18n')('highlight_add_error_invalid_color',i.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){B(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){B(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){v=i.$new(),v.SETTINGS=g,v.TAB_TYPES=x,v.selectedTab=D,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=n.getHighlights(),v.highlightNames=z,v.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:p('i18n')('placeholder_search',i.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=G,v.openColorPalette=W,v.addCustomHighlight=j,v.removeHighlight=n.removeHighlight,v.saveSettings=F,v.resetSettings=Y,v.highlightsCount=H,v.openProfile=K,C.injectScope(v,{textObject:'minimap'});let e=new E('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(r.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(r.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(r.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(r.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(r.MINIMAP_VILLAGE_HOVER,q),e.register(r.MINIMAP_VILLAGE_BLUR,B),e.register(r.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(r.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(r.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',v),U(),I=document.querySelector('#two-minimap .minimap-container'),I.appendChild(S),I.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){C=n.getSettings(),R=a.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),k=document.querySelector('#wrapper'),L=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
[e.COLOR_VIEW_REFERENCE]:{default:'#999999',inputType:'color',updates:[a.MINIMAP]},[e.COLOR_TRIBE]:{default:'#0000DB',inputType:'color',updates:[a.MINIMAP]},[e.COLOR_ALLY]:{default:'#00a0f4',inputType:'color',updates:[a.MINIMAP]},[e.COLOR_ENEMY]:{default:'#ED1212',inputType:'color',updates:[a.MINIMAP]},[e.COLOR_FRIENDLY]:{default:'#BF4DA4',inputType:'color',updates:[a.MINIMAP]},[e.COLOR_GHOST]:{default:'#3E551C',inputType:'color',updates:[a.MINIMAP]}}})),define('two/minimap/types/actions',[],(function(){return{HIGHLIGHT_PLAYER:'highlight_player',HIGHLIGHT_TRIBE:'highlight_tribe'}})),define('two/minimap/types/mapSizes',[],(function(){return{VERY_SMALL:'very_small',SMALL:'small',BIG:'big',VERY_BIG:'very_big'}})),require(['two/ready','two/minimap','two/minimap/ui','two/minimap/events','two/minimap/types/actions','two/minimap/settings','two/minimap/settings/updates','two/minimap/settings/map'],(function(e,t,i){if(t.initialized)return!1;e((function(){t.init(),i(),t.run()}),'map')})),
define('two/mintHelper',['queues/EventQueue'],(function(e){let t=!1,i=!1,a=3e3;function s(){n.getSelectedCharacter().getVillageList().forEach((function(e){let t=0,i=0,n=0,r=e.data.buildings.academy.level,s=e.getResources().getComputed(),c=s.wood,d=s.clay,u=s.iron,g=c.currentStock,p=d.currentStock,_=u.currentStock;setTimeout((function(){r>0?g>=28e3&&p>=3e4&&_>=25e3?(t=Math.floor(g/28e3),i=Math.floor(p/3e4),n=Math.floor(_/25e3),t<=n&&t<=i?(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:t}),console.log('W wiosce '+e.getName()+' wybito '+t+' monet.')):i<=n&&i<=t?(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:i}),console.log('W wiosce '+e.getName()+' wybito '+i+' monet.')):(o.emit(l.MINT_COINS,{village_id:e.getId(),amount:n}),console.log('W wiosce '+e.getName()+' wybito '+n+' monet.'))):console.log('Za mało surowców żeby wybić monety w wiosce'+e.getName()):console.log('W wiosce '+e.getName()+' brak akademi')}),a)})),setTimeout(s,3e4)}let c={init:function(){t=!0},start:function(){
e.trigger(r.MINT_HELPER_STARTED),i=!0,s()},stop:function(){e.trigger(r.MINT_HELPER_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(r,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Mincerz',90,p('i18n')('description',i.loc.ale,'mint_helper')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'mint_helper'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'mint_helper')))})),n.register(r.MINT_HELPER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(r.MINT_HELPER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),
t.isRunning()&&n.trigger(r.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,i,a,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(r.AUTO_HELPER_STARTED,(function(){a.set(o,!0)})),n.register(r.AUTO_HELPER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var a=!1,s=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',g='06050f',_='060506',m='060502',E='060501',f='060503',b='05020a',T='05030a',h='04080a',w='040a0a',v='070e04',A='070e05',S='070e0f',y='070e06',I='070e02',R='070e01',k='070e03',L='070e07',O='070e0b',N='070e0e',C='030d07',M='030d0b',P='030d0e';var z={init:function(){a=!0}};return z.start=function(){e.trigger(r.PRESET_CREATOR_STARTED),s=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,g='string'==typeof g?parseInt(g,16):g,_='string'==typeof _?parseInt(_,16):_,m='string'==typeof m?parseInt(m,16):m,E='string'==typeof E?parseInt(E,16):E,f='string'==typeof f?parseInt(f,16):f,b='string'==typeof b?parseInt(b,16):b,T='string'==typeof T?parseInt(T,16):T,h='string'==typeof h?parseInt(h,16):h,w='string'==typeof w?parseInt(w,16):w,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,I='string'==typeof I?parseInt(I,16):I,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,C='string'==typeof C?parseInt(C,16):C,M='string'==typeof M?parseInt(M,16):M,P='string'==typeof P?parseInt(P,16):P,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
...
axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:1,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'kareta (treb)',icon:P,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',p('i18n')('done',i.loc.ale,'preset_creator')),t.notif('success',p('i18n')('deactivated',i.loc.ale,'preset_creator')),z.stop()},z.stop=function(){e.trigger(r.PRESET_CREATOR_STOPPED),s=!1},z.isRunning=function(){return s},z.isInitialized=function(){return a},z})),define('two/presetCreator/events',[],(function(){angular.extend(r,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),
define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Wojewoda',60,p('i18n')('description',i.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'preset_creator'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'preset_creator')))})),n.register(r.PRESET_CREATOR_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(r.PRESET_CREATOR_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(r.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,i,a,n){const o='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){
a.get(o,!1,!0)&&t.start(),n.register(r.PRESET_CREATOR_STARTED,(function(){a.set(o,!0)})),n.register(r.PRESET_CREATOR_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=n.getSelectedCharacter(),i=t.data.character_id,a=t.data.character_name,s=!1,c=!1,d=[],u=[],g=[];function p(e){var t=new Date(1e3*e);return t.toLocaleString()}var _=function(){o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,i=0;i<t.length;i++)d.includes(t[i].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[i].id),o.emit(l.REPORT_GET,{id:t[i].id},m))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,i=0;i<t.length;i++)u.includes(t[i].id)?console.log('Raport wsparcia już wysłany'):(u.push(t[i].id),o.emit(l.REPORT_GET,{id:t[i].id},E))})),o.emit(l.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',
types:['attack']},(function(e){for(var t=e.reports,i=0;i<t.length;i++)g.includes(t[i].id)?console.log('Raport ataku już wysłany'):(g.push(t[i].id),o.emit(l.REPORT_GET,{id:t[i].id},f))})),setTimeout(_,3e4)},m=function(e){var t,n,r,s,c,d=[],u=e.result,g=e.token,_=e.time_created,m=p(_),E=e.ReportScouting,f=E.attCharacterId,b=E.attCharacterName,T=E.attScouts,h=E.attLosses,w=E.attVillageId,v=E.attVillageName,A=E.defCharacterId,S=E.defCharacterName,y=E.defLosses,I=E.defScouts,R=E.defVillageId,k=E.defVillageName,L=E.commandType,O='',N='',C='',M='',P=Date.now(),z=g.split('.').join('_');2==u?O=' [color=d96a19]Częściowy sukces[/color]':1==u?O=' [color=0a8028]Sukces[/color]':3==u&&(O=' [color=e21f1f]Porażka[/color]'),N='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==I?'nieznana':I,r=null==T?'nieznana':T,s=null==y?'nieznana':y,c=null==h?'nieznana':h,M=null==b&&null==f?'Brak danych':'[player='+f+']'+b+'[/player]',C=null==v&&null==w?'Brak danych':'[village='+w+']'+v+'[/village]',
t=Math.floor(P/1e3-_),d.push('[size=XL][b]Raport szpiegowski: [report]'+z+'[/report][br]'+O+' --- Typ: '+N+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+m+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+R+']'+k+'[/village][b] Gracz cel: [/b][player='+A+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+s+'[/color][/b][br]Wioska pochodzenia: [/b]'+C+'[b] Gracz szpiegujący: [/b]'+M+'[br]Liczba szpiegów: [b]'+r+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var x=d.join();A!=i?t<10800&&('Hajduk Split'==a||'halfsack'==a||'Black Rider'==a?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:x}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:x}),d=[]):t<10800&&('Hajduk Split'==a||'halfsack'==a||'Black Rider'==a?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:x}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:x}),d=[])},E=function(e){
var t,i=[],n=e.result,r=e.token,s=e.time_created,c=p(s),d=e.ReportAttack,u=d.attCharacterId,g=d.attCharacterName,_=d.attVillageId,m=d.attVillageName,E=d.attEffects,f=d.defEffects,b=d.attUnits;if(b.spear+b.sword+b.axe+b.archer+b.light_cavalry+b.mounted_archer+b.ram+b.catapult+b.heavy_cavalry+b.trebuchet+b.knight+b.snob+b.doppelsoldner>30){var T=[],h=[];E.forEach((function(e){var t=e.type,i=0,a=0,n=0,o=0,l=0,r=0,s=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(i=(100*(e.factor-1)).toFixed([0]),T.push(' Wagony '+i+'%')),'base_wall_levels'==t&&(a=e.min_level,T.push(' Żelazny mur '+a)),'modify_attack_factor'==t&&(n=100*e.bonus,T.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,T.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,T.push(' Klinika '+l)),'increase_spy_defense'==t&&(r=e.increased_by,T.push(' Agent wewnętrzny '+r+'%')),'increase_member_limit'==t&&(s=e.increased_by,T.push(' Siła w liczbach '+s)),
'recruit_speed_boost'==t&&(c=e.factor,T.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,T.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,T.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,T.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,T.push(' Zjednoczenie '+p+'%'))}));var w=T.join();f.forEach((function(e){var t=e.type,i=0,a=0,n=0,o=0,l=0,r=0,s=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(i=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+i+'%')),'base_wall_levels'==t&&(a=e.min_level,h.push(' Żelazny mur '+a)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(r=e.increased_by,h.push(' Agent wewnętrzny '+r+'%')),'increase_member_limit'==t&&(s=e.increased_by,
h.push(' Siła w liczbach '+s)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,h.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,h.push(' Zjednoczenie '+p+'%'))}));var v=h.join(),A=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),R=d.defCharacterId,k=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),C=Math.round(100*d.defModifier).toFixed([0]),M=(100*d.wallBonus).toFixed([0]),P=d.night,z=d.loyaltyAfter,x=d.loyaltyBefore,D=d.wallAfter,G=d.wallBefore,U=d.officers,V=d.leader,q='',B='',W='',j='',F='',Y='',H='',K='',Q='',Z=Date.now(),X=r.split('.').join('_')
;null!=x&&(Y='Lojalność przed atakiem: '+Math.floor(x)+' '),null!=z&&(H='Lojalność po ataku: '+Math.floor(z)+' '),null!=G&&(K='Mury przed ataku: '+G+' '),null!=D&&(Q='Mury po ataku: '+D+' '),null==U&&1==V?F='Brak':null==U&&1.1==V&&(F=' Wielki Mistrz '),j=0==P?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),W=null==g&&null==u?'Brak danych':'[player='+u+']'+g+'[/player]',B=null==m&&null==_?'Brak danych':'[village='+_+']'+m+'[/village]',t=Math.floor(Z/1e3-s),
i.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+R+']'+k+'[/player][br]Modyfikator obrony: [b]'+C+'[/b] Bonus za mury: [b]'+M+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+Y+H+'[br]'+K+Q+'[/size]');var J=i.join();t<10800&&('Hajduk Split'==a||'halfsack'==a||'Black Rider'==a?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),i=[])}},f=function(e){
var t,i=[],n=e.result,r=e.token,s=e.time_created,c=p(s),d=e.ReportAttack,u=d.attCharacterId,g=d.attCharacterName,_=d.attVillageId,m=d.attVillageName,E=d.attEffects,f=d.defEffects,b=d.attUnits;if(b.spear+b.sword+b.axe+b.archer+b.light_cavalry+b.mounted_archer+b.ram+b.catapult+b.heavy_cavalry+b.trebuchet+b.knight+b.snob+b.doppelsoldner>30){var T=[],h=[];E.forEach((function(e){var t=e.type,i=0,a=0,n=0,o=0,l=0,r=0,s=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(i=(100*(e.factor-1)).toFixed([0]),T.push(' Wagony '+i+'%')),'base_wall_levels'==t&&(a=e.min_level,T.push(' Żelazny mur '+a)),'modify_attack_factor'==t&&(n=100*e.bonus,T.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,T.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,T.push(' Klinika '+l)),'increase_spy_defense'==t&&(r=e.increased_by,T.push(' Agent wewnętrzny '+r+'%')),'increase_member_limit'==t&&(s=e.increased_by,T.push(' Siła w liczbach '+s)),
'recruit_speed_boost'==t&&(c=e.factor,T.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,T.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,T.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,T.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,T.push(' Zjednoczenie '+p+'%'))}));var w=T.join();f.forEach((function(e){var t=e.type,i=0,a=0,n=0,o=0,l=0,r=0,s=0,c=0,d=0,u=0,g=0,p=0;'increased_carrying_capacity'==t&&(i=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+i+'%')),'base_wall_levels'==t&&(a=e.min_level,h.push(' Żelazny mur '+a)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(r=e.increased_by,h.push(' Agent wewnętrzny '+r+'%')),'increase_member_limit'==t&&(s=e.increased_by,
h.push(' Siła w liczbach '+s)),'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(g=e.factor,h.push(' Drogi najazdów(depozyt) '+g+'%')),'faster_tribe_support'==t&&(p=e.factor,h.push(' Zjednoczenie '+p+'%'))}));var v,A=h.join(),S=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),I=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,L=d.defCharacterName,O=d.defVillageId,N=d.defVillageName,C=(100*d.defFaith).toFixed([0]),M=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),z=d.night,x=d.loyaltyAfter,D=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,V=d.officers,q='',B='',W='',j='',F='',Y='',H='',K='',Q=[],Z=Date.now(),X=r.split('.').join('_')
;if(null!=D&&(F='Lojalność przed atakiem: '+Math.floor(D)+' '),null!=x&&(Y='Lojalność po ataku: '+Math.floor(x)+' '),null!=U&&(H='Mury przed ataku: '+U+' '),null!=G&&(K='Mury po ataku: '+G+' '),null==V)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ie=d.officers.loot_master,ae=d.officers.supporter;0==J&&0==$&&0==ee&&0==ie&&0==te&&0==ae?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ie?Q.push(' Mistrz Łupu '):Q.push(''),1==ae?Q.push(' Taktyk '):Q.push(''))}if(j=0==z?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),W=null==g&&null==u?'Brak danych':'[player='+u+']'+g+'[/player]',B=null==m&&null==_?'Brak danych':'[village='+_+']'+m+'[/village]',t=Math.floor(Z/1e3-s),v=Q.join(),null!=L){
i.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+N+'[/village][b] Gracz cel: [/b][player='+k+']'+L+'[/player][br]Modyfikator obrony: [b]'+M+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+C+'[/b] Bonus nocny: [b]'+j+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+I+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+v+'[/b][br]'+F+Y+'[br]'+H+K+'[/size]');var ne=i.join();t<10800&&('Hajduk Split'==a||'halfsack'==a||'Black Rider'==a?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),i=[])}}},b={init:function(){s=!0},start:function(){e.trigger(r.REPORT_SENDER_STARTED),c=!0,_()},stop:function(){e.trigger(r.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return s}};return b})),define('two/reportSender/events',[],(function(){angular.extend(r,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,a,n){let o;return function(){return o=e.addMenuButton('Goniec',110,p('i18n')('description',i.loc.ale,'report_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),a.notif('success',p('i18n')('deactivated',i.loc.ale,'report_sender'))):(t.start(),a.notif('success',p('i18n')('activated',i.loc.ale,'report_sender')))})),n.register(r.REPORT_SENDER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),n.register(r.REPORT_SENDER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(r.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,i,a,n){const o='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){a.get(o,!1,!0)&&t.start(),n.register(r.REPORT_SENDER_STARTED,(function(){a.set(o,!0)})),n.register(r.REPORT_SENDER_STOPPED,(function(){a.set(o,!1)}))}),['initial_village'])}))}))}(this);