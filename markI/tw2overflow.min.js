 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),_=injector.get('reportService'),E=function(){},b=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||E,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
n.register(s.AUTO_HEALER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c,d,u,p,g,m,_,E){let b,f,T=!1,h=!1,v=[];const w='battle_calculator_settings',A={[l.NONE]:'',[l.TEUTONIC_ORDER]:'teutonic',[l.TEMPLAR_ORDER]:'templar'},S={[c.NO_CHURCH]:50,[c.LEVEL_1]:100,[c.LEVEL_2]:105,[c.LEVEL_3]:110},y={[r.NO_WALL]:0,[r.LEVEL_1]:5,[r.LEVEL_2]:10,[r.LEVEL_3]:15,[r.LEVEL_4]:20,[r.LEVEL_5]:25,[r.LEVEL_6]:30,
[r.LEVEL_7]:35,[r.LEVEL_8]:40,[r.LEVEL_9]:45,[r.LEVEL_10]:50,[r.LEVEL_11]:55,[r.LEVEL_12]:60,[r.LEVEL_13]:65,[r.LEVEL_14]:70,[r.LEVEL_15]:75,[r.LEVEL_16]:80,[r.LEVEL_17]:85,[r.LEVEL_18]:90,[r.LEVEL_19]:95,[r.LEVEL_20]:100},I={[d.NO_SKILL]:0,[d.LEVEL_1]:2,[d.LEVEL_2]:4,[d.LEVEL_3]:6,[d.LEVEL_4]:8,[d.LEVEL_5]:10},R={[u.NO_SKILL]:0,[u.LEVEL_1]:1,[u.LEVEL_2]:2,[u.LEVEL_3]:3,[u.LEVEL_4]:4,[u.LEVEL_5]:5},k={[p.NO_SKILL]:0,[p.LEVEL_1]:100,[p.LEVEL_2]:200,[p.LEVEL_3]:300,[p.LEVEL_4]:400,[p.LEVEL_5]:500,[p.LEVEL_6]:600,[p.LEVEL_7]:700,[p.LEVEL_8]:800,[p.LEVEL_9]:900,[p.LEVEL_10]:1e3},L={[g.NO_HOSPITAL]:0,[g.LEVEL_1]:100,[g.LEVEL_2]:129,[g.LEVEL_3]:167,[g.LEVEL_4]:215,[g.LEVEL_5]:278,[g.LEVEL_6]:359,[g.LEVEL_7]:464,[g.LEVEL_8]:599,[g.LEVEL_9]:774,[g.LEVEL_10]:1e3},x={[m.NO_SKILL]:0,[m.LEVEL_1]:4,[m.LEVEL_2]:8,[m.LEVEL_3]:12,[m.LEVEL_4]:16,[m.LEVEL_5]:20};console.log(A,x,L,k,R,I,y,S);const O=function(){v=[];const e=n.getPresetList().getPresets();f[t.PRESETS].forEach((function(t){v.push(e[t])})),
console.log('selectedPresets',v)},N={init:function(){T=!0,b=new e({settingsMap:i,storageKey:w}),b.onChange((function(e,t){f=b.getAll(),t[o.PRESETS]&&O()})),f=b.getAll(),console.log('all settings',f),_((function(){O()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,O),a.$on(s.ARMY_PRESET_DELETED,O)},start:function(){h=!0,console.log('selectedPresets',v),E.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){h=!1,console.log('example module stop'),E.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return b},isInitialized:function(){return T},isRunning:function(){return h}};return N})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,l,r,d,u,p,g,m,_,E,b,f){let T,h,v,w=n.getPresetList();const A={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},S=function(e){T.selectedTab=e},y=function(){h.setAll(h.decode(T.settings)),f.notif('success','Settings saved')},I=function(){t.isRunning()?t.stop():t.start()},R=function(){T.presets=E.encodeList(w.getPresets(),{disabled:!1,type:'presets'})},k=function(){T.running=!0,v.classList.remove('btn-orange'),v.classList.add('btn-red'),f.notif('success','Example module started')
},L=function(){T.running=!1,v.classList.remove('btn-red'),v.classList.add('btn-orange'),f.notif('success','Example module stopped')},x=function(){T=a.$new(),T.SETTINGS=i,T.TAB_TYPES=A,T.running=t.isRunning(),T.selectedTab=A.BATTLE,T.settingsMap=o,T.order=E.encodeList(l,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(r,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(d,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(u,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(p,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(g,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(m,{textObject:'battleCalculator',disabled:!0}),T.order=E.encodeList(_,{textObject:'battleCalculator',disabled:!0}),h.injectScope(T),R(),T.selectTab=S,T.saveSettings=y,T.switchState=I;let e=new b('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}))
...
clearInterval(h),E.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return I},F.isInitialized=function(){return y},F.getSettings=function(){return O},F.getLogs=function(){return x},F.clearLogs=function(){x=[],b.set(P,x),E.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),E.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,x=b.get(P,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),I&&t[d.ANALYSE]&&z(),a.quiet||E.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)R[m[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,v=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(R);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!I)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);V(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,E,f,T,h,v,w){let A,S,y,I,R=n.getGroupList(),k={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let P,M={},z={},D=!1,G=!1;const V=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},U=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
...
E.set(d.QUEUE_COMMANDS,R)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return b.call(e,'x')&&b.call(e,'y')&&D(e.x)&&D(e.y)};let V={initialized:!1};return V.init=function(){I=t.getTimeOffset(),V.initialized=!0,L=E.get(d.QUEUE_SENT,[],!0),x=E.get(d.QUEUE_EXPIRED,[],!0),function(){const e=E.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?V.expireCommand(e,i.TIME_LIMIT):(P(e),M(e))}))}(),setInterval((function(){R.length&&R.some((function(e){if(!C(e.sendTime))return!0;O?V.sendCommand(e):V.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&R.length&&(e.returnValue=!0)}))},V.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return V.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){L.push(e)}(e),E.set(d.QUEUE_SENT,L),V.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},V.expireCommand=function(e,t){!function(e){x.push(e)}(e),E.set(d.QUEUE_EXPIRED,x),V.removeCommand(e,t)},V.addCommand=function(e,i,o,l,s,r,d,p){let m={},E={};return new Promise((function(b,I){if(!G(e))return I(u.INVALID_ORIGIN);if(!G(i))return I(u.INVALID_TARGET);if(!t.isValidDateTime(o))return I(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return I(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return I(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(E[t]=!0)})))return I(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&E[T.SUPPORTER]&&delete E[T.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[h.CATAPULT])&&(p||f.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return I(u.INVALID_ORIGIN);if(!i)return I(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,E,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(C(c))return I(u.ALREADY_SENT);const f={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:E,type:d,catapultTarget:p,countdown:c-g.gameTime()};P(f),M(f),R=R.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),b(f)})):I(u.INVALID_DATE_TYPE)):I(u.INVALID_CATAPULT_TARGET)):I(u.RELOCATE_DISABLED):I(u.INVALID_COMMAND_TYPE)}))},V.removeCommand=function(e,t){delete k[e.id];const a=R.some((function(t,a){if(t.id==e.id)return R.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},V.clearRegisters=function(){E.set(d.QUEUE_EXPIRED,[]),E.set(d.QUEUE_SENT,[]),x=[],L=[]},V.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},V.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},V.isRunning=function(){return O},V.getWaitingCommands=function(){return R},V.getWaitingCommandsObject=function(){return k},V.getSentCommands=function(){return L},
V.getExpiredCommands=function(){return x},V.filterCommands=function(e,t,a){const i=N[e];return(a||R).filter((function(e){return i(e,t)}))},V})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,E,b,f,T,h){let v,w,A,S,y,I=n.getGameData(),R=I.getOrderedUnitNames(),k=I.getOrderedOfficerNames(),L=n.getPresetList(),x=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,P,M,z=[],D={},G={};const V={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},U=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){x=t.data},q=function(){x=!1},W=function(e){
const t=new Date(e||f.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=f.zerofill(a-a%100,3),n=f.zerofill(t.getSeconds(),2),l=f.zerofill(t.getMinutes(),2);return f.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+f.zerofill(t.getDate(),2)+'/'+f.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},j=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},F=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(V,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);v.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),v.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&v.isValidDate?f.gameTime()+C<e?'valid':'invalid':'neutral'},H=function(){y.dateType=v.selectedDateType.value,h.set(m.LAST_DATE_TYPE,v.selectedDateType.value),F()},K=function(){
...
t&&(v.filtersData[u.ALLOWED_TYPES][e]=!v.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){v.activeFilters[u.TEXT_MATCH]=v.filtersData[u.TEXT_MATCH].length>0,ee()},be={updatePresets:function(){v.presets=o.obj2selectOptions(L.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},v.searchQuery[i]=''},removeCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){f.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(v.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){v.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{f.timer.remove(e.updateCountdown)})}},fe=function(){const e=h.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;v=a.$new(),v.selectedTab=N,v.inventory=n.getInventory(),v.presets=o.obj2selectOptions(L.getPresets()),v.travelTimes={},o.each(p,(function(e){v.travelTimes[e]={},o.each(V,(function(t,a){v.travelTimes[e][a]={
...
},ke=function(e){Te(),P.length?W>=P.length?(W=0,U=!1,Z=h.gameTime()+ve(),v.trigger(s.FARM_OVERFLOW_CYCLE_END)):U=P[W]:U=!1,U?(U.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,ke())})),"cycle_begin"===e&&(Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),U.start()):j=setTimeout((function(){j=null,W=0,Z=null,v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),ke()}),ve())},Le=function(e){for(let t=0;t<P.length;t++){let a=P[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){P.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=I.get(X,[]),L=I.get($,{}),x=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),R=new e({settingsMap:c,storageKey:J}),R.onChange((function(e,t,a){k=R.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(Ie(),ye()),t[p.LOGS]&&be(),t[p.INTERVAL_TIMERS]&&C&&(F?(he(),
U.targetStep({delay:!0})):j&&(he(),v.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,ke())))})),k=R.getAll(),se("ignore_update"),ne(),ye(),f((function(){ce()}),'presets'),f((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(V.length?(C=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){ke("cycle_begin")})),Te(),function(){let e=ve(),t=e+e/2+we();Q=setInterval((function(){h.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),v.trigger(s.FARM_OVERFLOW_START),void Ee(g.FARM_START)):(C=!1,!1)):(v.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){U?(U.stop(e),
...
},Te=function(){if(!ie)return!1;const e=Q.village[x][O];ve(e?Q.character[e]:[[x,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===L.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(j&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(j.isAlly(e.tribe_id))return W.ally;if(j.isEnemy(e.tribe_id))return W.enemy;if(j.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||we(i);if(!n)continue;const o=i.x*y+(i.y%2?R:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],R=Math.round(S/2),y=S+1,I=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,P.width=1e3*y,P.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Ie=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[x,O,e]),3===e.which&&(a=x,i=O,E.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,E,b,f,T,h,v){let w,A,S,y,I,R,k,L,x,O,N,C={},P=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){w.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},V=function(){Object.keys(w.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},U=function(e,t){return String(e)+String(t)},B=function(e,t){if(!x)return;let a=U(t.x,t.y);var i,n;O=a,C[a]=!0,P=!0,(i=t.x,n=t.y,new Promise((function(e){let t=T.getTownAt(i,n);if(t)return e(t);T.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[U(e.x,e.y)])return;if(!P)return;k.appendChild(x),x.classList.remove('ng-hide'),R.tt.name=e.name,R.tt.x=e.x,R.tt.y=e.y,R.tt.province_name=e.province_name,R.tt.points=e.points,R.tt.character_name=e.character_name||'-',R.tt.character_points=e.character_points||0,R.tt.tribe_name=e.tribe_name||'-',R.tt.tribe_tag=e.tribe_tag||'-',R.tt.tribe_points=e.tribe_points||0,R.tt.morale=e.morale||0,R.tt.position={},R.tt.position.x=t.event.pageX+50,R.tt.position.y=t.event.pageY+50,R.tt.visible=!0
;const a=x.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=R.tt.position.y+o>i.top+i.height,s=R.tt.position.x+n>i.width;l&&(R.tt.position.y-=50),x.classList.toggle('left',s),x.classList.toggle('top',l)}))},q=function(e,t){if(!x)return;let a=t?U(t):O;C[a]=!1,P=!1,R.tt.visible=!1,x.classList.add('ng-hide'),L.appendChild(x)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=v.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},j=function(){n.addHighlight(w.selectedHighlight,w.addHighlightColor)},F=function(){N.setAll(N.decode(w.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(w.highlights.character).length+Object.keys(w.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){w.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){V()},highlightAddErrorExists:function(){_.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+h.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){w=a.$new(),w.SETTINGS=p,w.TAB_TYPES=z,w.selectedTab=D,w.selectedHighlight=!1,w.addHighlightColor='#000000',w.highlights=n.getHighlights(),w.highlightNames=M,w.mapSizes=b.encodeList(u,{textObject:'minimap',disabled:!1}),w.actionTypes=b.encodeList(d,{textObject:'minimap',disabled:!1}),w.autoComplete={
...
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},b))})),setTimeout(m,3e4)},_=function(e){var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,_=g(m),E=e.ReportScouting,b=E.attCharacterId,f=E.attCharacterName,T=E.attScouts,h=E.attLosses,v=E.attVillageId,w=E.attVillageName,A=E.defCharacterId,S=E.defCharacterName,y=E.defLosses,I=E.defScouts,R=E.defVillageId,k=E.defVillageName,L=E.commandType,x='',O='',N='',C='',P=Date.now(),M=p.split('.').join('_');2==u?x=' [color=d96a19]Częściowy sukces[/color]':1==u?x=' [color=0a8028]Sukces[/color]':3==u&&(x=' [color=e21f1f]Porażka[/color]'),O='units'==L?'Jednostki':'buildings'==L?'Budynki':'Sabotaż',n=null==I?'nieznana':I,s=null==T?'nieznana':T,r=null==y?'nieznana':y,c=null==h?'nieznana':h,C=null==f&&null==b?'Brak danych':'[player='+b+']'+f+'[/player]',N=null==w&&null==v?'Brak danych':'[village='+v+']'+w+'[/village]',
