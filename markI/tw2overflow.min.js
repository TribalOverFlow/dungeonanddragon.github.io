 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),o=injector.get('socketService'),s=injector.get('routeProvider'),l=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),b=injector.get('reportService'),T=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||T,this.listeners=[];const i=a.$on(l.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
...
})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,i){let n,o,s,r,c={},d={},u=!1,p=document.querySelector('head'),g=injector.get('httpService'),m=injector.get('templateManagerService'),b=injector.get('$templateCache');return m.load=function(i,n,o){let s;const l=function(e,t,i,o){b.put(s.substr(1),e),angular.isFunction(n)&&n(e,t,i,o),a.$$phase||a.$apply()},r=function(e,t,a,i){angular.isFunction(o)&&o(e,t,a,i)};s=0!==i.indexOf('!')?e.TEMPLATE_PATH_EXT.join(i):i.substr(1),b.get(s.substr(1))?l(b.get(s.substr(1)),304):t.versionMap[s]?g.get(s,l,r):l(d[s],304)},c.init=function(){if(u)return!1;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div'),l=document.createElement('div'),d=document.createElement('div'),p=document.createElement('div'),g=document.createElement('div'),m=document.createElement('div'),b=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-menu-container2',
e.appendChild(a),l.className='two-menu-container3',e.appendChild(l),d.className='two-menu-container4',e.appendChild(d),p.className='two-main-button',p.style.display='none',g.className='two-economy-button',g.style.display='none',m.className='two-intrigue-button',m.style.display='none',b.className='two-other-button',b.style.display='none',t.appendChild(p),a.appendChild(g),l.appendChild(m),d.appendChild(b),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),o=document.createElement('div'),o.className='two-menu2',a.appendChild(o),s=document.createElement('div'),s.className='two-menu3',l.appendChild(s),r=document.createElement('div'),r.className='two-menu4',d.appendChild(r),u=!0,
...
MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,b,T,E){let f,_,w=!1,h=injector.get('overviewService'),v=[],A=!1,S={},y={},R={reverse:!1,column:i.TIME_COMPLETED};const k='attack_view_filters',I={},L={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),
S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},N=function(){B.loadCommands()},x=function(e,t){E.trigger(l.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<v.length;e++)v[e].command_id===t.command_id&&v.splice(e,1);E.trigger(l.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},C=function(e,t){for(let e=0;e<v.length;e++)v[e].target_village_id===t.village_id?(v[e].target_village_name=t.name,v[e].targetVillage.name=t.name):v[e].origin_village_id===t.village_id&&(v[e].origin_village_name=t.name,v[e].originVillage.name=t.name);E.trigger(l.ATTACK_VIEW_VILLAGE_RENAMED,[t])},z=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],B.loadCommands())},G=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{
unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},M=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},U=function(e,t){let a=0;if(T.hasTownDataInChunk(e.x,e.y)){const a=T.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let s,l=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=M(r,e);else if(c.length)s=M(c,e);else{if(!i)return t(!1);{const a=l.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);s=M(a,e)}}return t(s[0])}const i=b.scaledGridCoordinates(e.x,e.y,25,25,25);T.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&U(e,t)}))},D=function(e){v=e.commands;for(let e=0;e<v.length;e++)h.formatCommand(v[e]),
v[e].slowestUnit=G(v[e]);v=v.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[v])};let B={loadCommands:function(){const e=f.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:R.column,reverse:R.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},D)},getCommands:function(){return v},getFilters:function(){return S},getSortings:function(){return R},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),g.set(k,S),B.loadCommands()},toggleSorting:function(e){e===R.column?R.reverse=!R.reverse:(R.column=e,R.reverse=!1),B.loadCommands()},setCommander:function(e,a){U(e.targetVillage,(function(i){const n=e.targetVillage,o=i,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){l[e]='*'})),A.addCommand(n,o,a,_.OUT,l,{},s,p.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){
return w},init:function(){for(let e=0;e<d.length;e++)I[d[e]]=!0;for(let e in r)L[r[e]]=!0;try{A=require('two/commandQueue'),_=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(L),[c.INCOMING_UNITS]:angular.copy(I),[c.VILLAGE]:!1};w=!0,f=n.getSelectedCharacter().getGlobalInfo(),S=g.get(k,t,!0),e((function(){O(),a.$on(l.COMMAND_INCOMING,N),a.$on(l.COMMAND_CANCELLED,x),a.$on(l.MAP_SELECTED_VILLAGE,z),a.$on(l.VILLAGE_NAME_CHANGED,C),a.$on(l.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(l,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,s,d,u,b,T,E,f,_){let w,h;const v=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=_('#two-attack-view').parent(),t=_('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=w.pagination.offset,t=w.pagination.limit
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);R()},I=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},L=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},O=function(){w.commands=t.getCommands()},N=function(){w.selectedVillageId=n.getSelectedVillage().getId()},x=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=T,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=b,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=v,w.copyTimeModal=A,w.removeTroops=S,w.switchWindowSize=y,
...
[u.LEVEL_4]:8,[u.LEVEL_5]:10},O={[p.LEVEL_1]:1,[p.LEVEL_2]:2,[p.LEVEL_3]:3,[p.LEVEL_4]:4,[p.LEVEL_5]:5},N={[g.LEVEL_1]:100,[g.LEVEL_2]:200,[g.LEVEL_3]:300,[g.LEVEL_4]:400,[g.LEVEL_5]:500,[g.LEVEL_6]:600,[g.LEVEL_7]:700,[g.LEVEL_8]:800,[g.LEVEL_9]:900,[g.LEVEL_10]:1e3},x={[m.LEVEL_1]:100,[m.LEVEL_2]:129,[m.LEVEL_3]:167,[m.LEVEL_4]:215,[m.LEVEL_5]:278,[m.LEVEL_6]:359,[m.LEVEL_7]:464,[m.LEVEL_8]:599,[m.LEVEL_9]:774,[m.LEVEL_10]:1e3},P={[b.LEVEL_1]:4,[b.LEVEL_2]:8,[b.LEVEL_3]:12,[b.LEVEL_4]:16,[b.LEVEL_5]:20};console.log(R,P,x,N,O,L,I,k,A,S,y);const C={init:function(){w=!0,f=new e({settingsMap:a,storageKey:v}),_=f.getAll(),console.log('all settings',_)},start:function(){h=!0,E.trigger(l.BATTLE_CALCULATOR_START)},stop:function(){h=!1,console.log('example module stop'),E.trigger(l.BATTLE_CALCULATOR_STOP)},getSettings:function(){return f},isInitialized:function(){return w},isRunning:function(){return h}};return C})),define('two/battleCalculator/events',[],(function(){angular.extend(l,{
BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u,p,g,m,b,T,E,f,_,w){let h,v,A;const S={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},y=function(e){h.selectedTab=e},R=function(){v.setAll(v.decode(h.settings)),w.notif('success','Settings saved')},k=function(){t.isRunning()?t.stop():t.start()},I=function(){
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,b,T,E,f){let _,w,h,v=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,R=!1;const k={};let I,L,O,N,x,P=!0;const C='builder_queue_log',z='builder_queue_settings',G=function(){const e=U();if(!P)return Y.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},M=function(){U().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&A.instantBuild(a,b.MASS_SCREEN,!0,e)}))}}))},U=function(){const e=x[r.GROUP_VILLAGES];let a=[];return e?(a=I.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(k);const n=x[r.BUILDING_SEQUENCES][x[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return v.compute(e),B(e,a,(function(t,a){t&&a.job&&(T.trigger(l.BUILDER_QUEUE_JOB_STARTED,a.job),F(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&x[r.PRIORIZE_FARM]){const t=h[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:b.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-x[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-x[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-x[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},F=function(e,t){let a={time:f.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),E.set(C,O),!0};let Y={};return Y.start=function(){if(!P)return T.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,_=setInterval(G,6e4),w=setInterval(M,6e3),e((function(){U().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),G(),M()}),['all_villages_ready']),T.trigger(l.BUILDER_QUEUE_START)},Y.stop=function(){R=!1,clearInterval(_),
clearInterval(w),T.trigger(l.BUILDER_QUEUE_STOP)},Y.isRunning=function(){return R},Y.isInitialized=function(){return y},Y.getSettings=function(){return N},Y.getLogs=function(){return O},Y.clearLogs=function(){O=[],E.set(C,O),T.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},Y.addBuildingSequence=function(e,t){let a=x[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},Y.updateBuildingSequence=function(e,t){let a=x[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},Y.removeSequence=function(e){let t=x[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),T.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},Y.init=function(){y=!0,O=E.get(C,[],!0),L=n.getSelectedCharacter(),I=n.getGroupList(),N=new i({settingsMap:c,storageKey:z}),N.onChange((function(e,t,a){x=N.getAll(),R&&t[d.ANALYSE]&&G(),a.quiet||T.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),x=N.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(x[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=x[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(x[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);D(e)}),1e3)}))},Y})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,b,T,f,_,w,h,v){let A,S,y,R,k=n.getGroupList(),I={},L=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},x={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,z={},G={},M=!1,U=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case f.SEQUENCE_SAVED:return!0;case f.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case f.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};N.generateSequences=function(){const e=R.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(N.sequencesAvail=t,!t)return!1;N.generateBuildingSequence(),N.generateBuildingSequenceFinal(),N.updateVisibleBuildingSequence()},N.generateBuildingSequence=function(){const e=A.settings[b.ACTIVE_SEQUENCE].value,t=A.settings[b.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(N.sequencesAvail=!!t,!N.sequencesAvail)return!1;for(let e in _)i[_[e]]=0;N.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],s='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(s='progress'):s='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:I[e][t-1],state:s}}))},N.generateBuildingSequenceFinal=function(e){const t=A.settings[b.ACTIVE_SEQUENCE].value,a=A.settings[b.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=I[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});N.buildingSequenceFinal=n},
N.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=D(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(M=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
B(e,a,a+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(M=!0)},O.addBuilding=function(e,t,a=1){const i=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),M=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),M=!0},O.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},O.generateBuildingSequence=function(){const e=R.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const a=e[O.selectedSequence.value];let i={};for(let e in _)i[_[e]]=0;O.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
...
A.pagination.logs.count=x.logs.length,x.visibleLogs.forEach((function(e){e.villageId&&function(e){if(z[e])return z[e];z[e]=!0,G[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){z[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},G[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},x.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[_.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,t)&&(A.settings[b.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[b.BUILDING_SEQUENCES][e.name]=t,F(),N.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},N.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},F=function(){R.setAll(R.decode(A.settings)),M=!1},Y=function(){i.isRunning()?i.stop():i.start()},j=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){M?j((function(){C()})):C()},K={updateGroups:function(){A.groups=p.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(b.BUILDING_SEQUENCES);A.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){N.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
...
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=R.get(b.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=P.SETTINGS,A.TAB_TYPES=P,A.SETTINGS=b,A.running=L,A.pagination={},A.settingsMap=R.settingsMap,A.villagesLabel=G,A.villagesInfo=z,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=_.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=N,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=x,A.logsView.logs=i.getLogs(),A.selectTab=W,A.switchBuilder=Y,A.saveSettings=F,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,R.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
...
h.activeFilters=C,h.filtersData=z,h.running=t.isRunning(),h.waitingCommands=t.getWaitingCommands(),h.visibleWaitingCommands=t.getWaitingCommands(),h.sentCommands=t.getSentCommands(),h.expiredCommands=t.getExpiredCommands(),h.EVENT_CODES=d,h.FILTER_TYPES=u,h.TAB_TYPES=N,h.COMMAND_TYPES=p,h.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),h.onUnitInputFocus=te,h.onUnitInputBlur=ae,h.catapultTargetVisibility=ie,h.selectTab=ne,h.addSelected=oe,h.addMapSelected=se,h.addCurrentDate=le,h.incrementDate=re,h.reduceDate=ce,h.cleanUnitInputs=de,h.addCommand=ue,h.clearRegisters=pe,h.switchCommandQueue=ge,h.removeCommand=t.removeCommand,h.openVillageInfo=r.openVillageInfo,h.toggleFilter=be,h.$watch('commandData.origin',Y),h.$watch('commandData.target',Y),h.$watch('commandData.date',Y),h.$watch('commandData.officers',Y),h.$watch('selectedDateType.value',H),h.$watch('selectedInsertPreset.value',Q),h.$watch('catapultTarget.value',K),h.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Te),
h.$watch('selectedTab',(function(){h.selectedTab===N.ADD?b=setInterval((function(){Y()}),2500):clearInterval(b)})),h.waitingCommands.forEach(e=>{X(e)});let T=new i('twoverflow_queue_window',(function(){clearInterval(b),Ee.clearCountdownUpdates()}));T.register(l.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),T.register(l.ARMY_PRESET_DELETED,Ee.updatePresets,!0),T.register(l.SELECT_SELECTED,Ee.autoCompleteSelected,!0),T.register(l.COMMAND_QUEUE_REMOVE,Ee.removeCommand),T.register(l.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),T.register(l.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),T.register(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),T.register(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),T.register(l.COMMAND_QUEUE_SEND,Ee.sendCommand),T.register(l.COMMAND_QUEUE_START,Ee.start),T.register(l.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',h)};return function(){A=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=R.getAttackableBuildings();for(let e in t)G.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){M[e]=0})),I.forEach((function(e){U[e]=!1})),y={origin:!1,target:!1,date:'',dateType:s.OUT,units:angular.copy(M),officers:angular.copy(U),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},z={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},v=e.addMenuButton('Generał',10),v.addEventListener('click',fe),T.register(l.COMMAND_QUEUE_START,(function(){v.classList.remove('btn-orange'),v.classList.add('btn-red')})),T.register(l.COMMAND_QUEUE_STOP,(function(){v.classList.remove('btn-red'),v.classList.add('btn-orange')})),a.$on(l.SHOW_CONTEXT_MENU,V),a.$on(l.DESTROY_CONTEXT_MENU,q),
...
n.register(l.FAITH_CHECKER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&n.trigger(l.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,i,n){const o='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.FAITH_CHECKER_STARTED,(function(){i.set(o,!0)})),n.register(l.FAITH_CHECKER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/datetype','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c,d){let u,p,g=!1,m=!1,b=[],T=[],E=[];const f='fake_sender_settings',_={[r.SPEAR]:'spear',[r.SWORD]:'sword',[r.AXE]:'axe',[r.ARCHER]:'archer',
[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},w={[s.ARRIVE]:'arrive',[s.OUT]:'out'};console.log(_,w);const h=function(){b=[],T=[],E=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP0],i=p[t.GROUP1],o=p[t.GROUP2];a.forEach((function(t){b.push(e[t])})),i.forEach((function(t){T.push(e[t])})),o.forEach((function(t){E.push(e[t])}))},v={init:function(){g=!0,u=new e({settingsMap:i,storageKey:f}),u.onChange((function(e,t){p=u.getAll(),t[o.GROUPS]&&h()})),p=u.getAll(),console.log('all settings',p),a.$on(l.GROUPS_CREATED,h),a.$on(l.GROUPS_DESTROYED,h),a.$on(l.GROUPS_UPDATED,h)},start:function(){m=!0,d.trigger(l.FAKE_SENDER_START)},stop:function(){m=!1,d.trigger(l.FAKE_SENDER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return v})),
define('two/fakeSender/events',[],(function(){angular.extend(l,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/datetype','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p){let g,m,b,T=n.getGroupList();const E={FAKE:'fake',LOGS:'logs'},f=function(e){g.selectedTab=e},_=function(){m.setAll(m.decode(g.settings)),p.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},h=function(){g.groups=d.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){g.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red')},A=function(){g.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange')},S=function(){g=a.$new(),g.SETTINGS=i,g.TAB_TYPES=E,g.running=t.isRunning(),g.selectedTab=E.FAKE,g.settingsMap=o,
g.datetype=d.encodeList(s,{textObject:'fake_sender',disabled:!0}),g.units=d.encodeList(r,{textObject:'fake_sender',disabled:!0}),m.injectScope(g),h(),g.selectTab=f,g.saveSettings=_,g.switchState=w;let e=new u('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.FAKE_SENDER_START,v),e.register(l.FAKE_SENDER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',g)};return function(){m=t.getSettings(),e.addDivisor(21),b=e.addMenuButton('Watażka',20),b.addEventListener('click',S),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,b,f,_,w,h,v,A,S,y,R){let k,I,L,O,N,x=!1,P=!1,C=[],z=[],G=[],M=[],U=[],D=[],B=!1,V=!1,q=!1,W=0,F=null,Y=null,j=null,H={},K=w.gameTime(),Q=null,X=null;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!G.includes(e.id)},ignored:function(e){return M.includes(e.id)},points:function(e){
return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=I[r.GROUP_INCLUDE];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);G=G.concat(t)})),G=ie(G)}(),function(){const e=I[r.GROUP_IGNORE];M=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];U=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),U=U.concat(t)})),U=ie(U)}(),function(){const e=M.concat(G);let t=!1;e.forEach((function(e){E.call(L,e)||(L[e]={time:w.gameTime(),report:!1},t=!0)})),b.each(L,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete L[i],t=!0)})),t&&(R.set($,L),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),h.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id&&(o?(ke(t.village_id),s=!0):(Oe(t.village_id),Te(g.IGNORED_VILLAGE,{villageId:t.village_id}),be(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),Te(g.INCLUDED_VILLAGE,{villageId:t.village_id}),be(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}else Ne(),Te(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),Te(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(ke(t.village_id),s=!0),s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){
const t=n.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],s=E.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),l=i.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));k.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ne(),Re(),Ne(),ye()},ce=function(){D=[];const e=n.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),D.push(a)})),D=D.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),D.length||(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&xe.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===v.TYPES.ATTACK&&1!==t.result&&Le(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){B&&q&&t.origin.id===B.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&q&&t.cause===s.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return b.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},be=function(e){L[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],R.set($,L),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Te=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,z.unshift(t),Ee(),!0)},Ee=function(){const e=I[r.LOGS_LIMIT];z.length>e&&z.splice(z.length-e,z.length),R.set(Z,z),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},fe=function(e,t,a){const i=I[r.TARGET_MULTIPLE_FARMERS],n=I[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},_e=function(){K=w.gameTime()},we=function(){clearTimeout(F),clearTimeout(Y),clearTimeout(j),F=null,Y=null,j=null
},he=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=T,this.status=i.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{h.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return _e(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,h.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,h.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=T},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;_e();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const T=()=>new Promise((t,a)=>{e.delay?Y=setTimeout(()=>{if(Y=null,!this.running)return a(i.USER_STOP);t()},b.randomSeconds(ve())):t()}),f=()=>new Promise((e,a)=>{const n=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),R=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),k=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(s.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||G.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),L=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(D.forEach((function(e){E.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)E.call(a,e)&&i.push(e);o.emit(s.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*I[r.MAX_TRAVEL_TIME],s=this.village.getPosition(),l=_.actualDistance(s,a);b.each(D,s=>{
if(!!Object.entries(s.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(s,{barbarian:!a.character_id,officers:!1});return o>r*l?(g=s,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),x=()=>new Promise((e,n)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),fe(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(w.gameTime()/1e3),s=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],l=this.village.getPosition(),m=_.actualDistance(l,a),b=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),T=d.getTravelTimeForDistance(g,b,m,v.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+T-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),s=n.some(e=>e.start_village_id===this.villageId);if(fe(s,o,!0))return t(i.BUSY_TARGET);e()})});let z=new Promise((e,t)=>{T().then(f).then(S).then(R).then(k).then(L).then(N).then(x).then(P).then(C).then(e).catch(t)}),M=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([z,M]).then(()=>{if(!this.running)return!1
...
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){V=!1,q=!1,we(),Te(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){V=!1,q=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=_.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!U.includes(e))return!1;if(M.includes(e))return!1;let a=xe.getFarmer(e);return a||(a=new Ae(e),C.push(a)),a},ye=function(){b.each(O.getVillages(),(function(e,t){Se(t)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=I[r.GROUP_ONLY];let t=[];C.forEach((function(a){let i=a.getId();e.length&&!U.includes(i)?t.push(i):M.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){ke(e)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<C.length;a++)if(C[a].getId()===e)return C[a].stop(t.KILL_FARMER),C.splice(a,a+1),!0;return!1
},Ie=function(e){_e(),C.length?W>=C.length?(W=0,B=!1,X=w.gameTime()+he(),h.trigger(l.FARM_OVERFLOW_CYCLE_END)):B=C[W]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,Ie())})),"cycle_begin"===e&&(X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):F=setTimeout((function(){F=null,W=0,X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),Ie()}),he())},Le=function(e){for(let t=0;t<C.length;t++){let a=C[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){C.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){C.forEach((function(e){e.loadTargets()}))}),!0)};let xe={};return xe.init=function(){x=!0,z=R.get(Z,[]),L=R.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){I=k.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Ne(),t[p.VILLAGES]&&(Re(),ye()),t[p.LOGS]&&Ee(),t[p.INTERVAL_TIMERS]&&P&&(Y?(we(),
B.targetStep({delay:!0})):F&&(we(),h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),W=0,Ie())))})),I=k.getAll(),le("ignore_update"),ne(),ye(),f((function(){ce()}),'presets'),f((function(){C.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(l.ARMY_PRESET_UPDATE,de),a.$on(l.ARMY_PRESET_DELETED,de),a.$on(l.GROUPS_VILLAGE_LINKED,oe),a.$on(l.GROUPS_VILLAGE_UNLINKED,se),a.$on(l.GROUPS_DESTROYED,re),a.$on(l.COMMAND_SENT,pe),a.$on(l.MESSAGE_ERROR,ge),a.$on(l.REPORT_NEW,ue)},xe.start=function(){let e;return!P&&(D.length?(P=!0,e=[],C.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Ie("cycle_begin")})),_e(),function(){let e=he(),t=e+e/2+ve();Q=setInterval((function(){w.gameTime()-K>t&&(xe.stop(),setTimeout(xe.start,5e3))}),3e4)}(),h.trigger(l.FARM_OVERFLOW_START),void Te(g.FARM_START)):(P=!1,!1)):(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},xe.stop=function(e=i.USER_STOP){B?(B.stop(e),
e!==i.USER_STOP&&(X=w.gameTime()+he()),h.trigger(l.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,we(),h.trigger(l.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&Te(g.FARM_STOP)},xe.getFarmer=function(e){return C.find((function(t){return t.getId()===e}))},xe.getFarmers=function(){return C},xe.getSettings=function(){return k},xe.getExceptionVillages=function(){return{included:G,ignored:M}},xe.getExceptionLogs=function(){return L},xe.isInitialized=function(){return x},xe.isRunning=function(){return P},xe.getLogs=function(){return z},xe.clearLogs=function(){return z=[],R.set(Z,z),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED),z},xe.getNextCycleDate=function(){return X},xe.getCycleInterval=he,xe})),define('two/farmOverflow/events',[],(function(){angular.extend(l,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,T,E,f,_,w,h){let v,A,S,y=n.getPresetList(),R=n.getGroupList(),k={},I={},L=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleLogs=v.logs.slice(e,e+t),v.pagination.count=v.logs.length,v.visibleLogs.forEach((function(e){e.villageId&&x(e.villageId),e.targetId&&x(e.targetId)}))},x=function(e){if(k[e])return k[e];k[e]=!0,I[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
v.exceptionVillages.included.forEach((function(e){x(e)})),v.exceptionVillages.ignored.forEach((function(e){x(e)}))},C=function(){t.isRunning()?t.stop():t.start()},z=function(e){v.selectedTab=e},G=function(){A.setAll(A.decode(v.settings)),v.saveButtonColor='orange',_.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},M=function(e){const t=A.get(T.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},U=function(e){A.get(T.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){v.presets=E.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){v.groups=E.encodeList(R.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=E.encodeList(R.getGroups(),{disabled:!0,type:'groups'})},V=function(){v.running=!0,
_.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:_.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:_.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){v.logs=angular.copy(t.getLogs()),N(),v.logs.length||_.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},F=function(){v.farmers=t.getFarmers()},Y=function(){v.exceptionVillages=t.getExceptionVillages(),P()},j=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=a.$new(),v.SETTINGS=T,v.TAB_TYPES=O,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=O.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=I,v.villagesInfo=k,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=A.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},A.injectScope(v),D(),B(),N(),P(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-h.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=C,v.selectTab=z,v.saveSettings=G,v.clearLogs=t.clearLogs,v.jumpToVillage=p.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=b.showReport,v.removeIgnored=M,v.removeIncluded=U;let i=new f('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(l.ARMY_PRESET_UPDATE,D,!0),i.register(l.ARMY_PRESET_DELETED,D,!0),i.register(l.GROUPS_UPDATED,B,!0),i.register(l.GROUPS_CREATED,B,!0),i.register(l.GROUPS_DESTROYED,B,!0),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,b,T,f,_,w,h,v,A){let S,y,R,k,I,L,O,N,x,P,C,z,G,M,U,D,B,V,q,W,F,Y,j,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,be=function(e){let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/y)%2&&(t+=k),t-=t%y,a-=a%y,{x:Math.ceil((t-x.width/2)/y),y:Math.ceil((a-x.height/2)/y)}},Te=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},Ee=function(){Ae(I)},fe=function(){if(H){const e={x:ee.x-x.width/2,y:ee.y-x.height/2};P.clearRect(0,0,x.width,x.height),M.clearRect(0,0,G.width,G.height),function(e){P.drawImage(C,-e.x,-e.y)}(e),j[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;M.fillStyle=j[o.COLOR_VIEW_REFERENCE],M.fillRect(a,0,1,R),M.fillRect(0,i,R,1);const n=D.getBoundingClientRect(),s=n.width/v.TILESIZE.x/A.view.z*y,l=n.height/v.TILESIZE.y/A.view.z*y,r=a-s/2,c=i-l/2;M.clearRect(r,c,s,l),M.beginPath(),M.lineWidth=1,M.strokeStyle=j[o.COLOR_VIEW_REFERENCE],M.rect(r,c,s,l),M.stroke()}(e)}e.requestAnimationFrame(fe)
},_e=function(){if(!ie)return!1;const e=Q.village[O][N];he(e?Q.character[e]:[[O,N]]),ie=!1,m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,j[o.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},ve=function(e){if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!j[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===L.getId()&&j[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(j[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&j[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(F&&j[o.HIGHLIGHT_DIPLOMACY]){
if(F.isAlly(e.tribe_id))return W.ally;if(F.isEnemy(e.tribe_id))return W.enemy;if(F.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||ve(i);if(!n)continue;const o=i.x*y+(i.y%2?k:0),s=i.y*y;z.fillStyle=n,z.fillRect(o,s,S,S)}},Se=function(){S=oe[j[o.MAP_SIZE]],k=Math.round(S/2),y=S+1,R=1e3*y,J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y,C.width=1e3*y,C.height=1e3*y,z.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;x.width=686,x.height=e,G.width=686,G.height=e,P.imageSmoothingEnabled=!1,M.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,T.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(j[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,pe=be(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!j[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;_e()}ie=!0,O=e.x,N=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=Q.village[O][N];we(a?Q.character[a]:[[O,N]])}(pe,e)}_e()},Le=function(){ie&&_e(),
m.trigger(l.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=be(e);p.jumpToVillage(t.x,t.y)},Ne=function(e){return e.preventDefault(),!1},xe=function(){K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=B.getSelectedVillage(),Ae([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){x=e,x.style.background=j[o.COLOR_BACKGROUND],P=x.getContext('2d')},setViewportRef:function(e){G=e,M=G.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!U.width||!U.height)return!1;let e=T.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Te(e[0]*t,e[1]*t),i=Te(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,U.width/2,U.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return Y},Ce.drawMinimap=function(){ge&&(ge=!1),x.style.background=j[o.COLOR_BACKGROUND],z.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=_.getPath(v.getMapPath()),t=j[o.SHOW_CONTINENT_DEMARCATIONS],a=j[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){z.fillStyle=j[o.COLOR_CONTINENT],z.fillRect(e*y+k-1,t*y+k-1,3,1),z.fillRect(e*y+k,t*y+k-2,1,3)},n=function(e,t){z.fillStyle=j[o.COLOR_PROVINCE],z.fillRect(e*y+k,t*y+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=f.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*y,c=l.a*y,d=(s.b-s.a)*y,u=(l.b-l.a)*y;z.beginPath(),z.lineWidth=2,z.strokeStyle="#2B4700",z.rect(r,c,d,u),z.stroke()}))}(),Ee()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),z=C.getContext('2d'),re=le.make('hover'),Y=new u({settingsMap:s,storageKey:ne}),Y.onChange((function(e,t){
j=Y.getAll(),Se(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),j=Y.getAll(),K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Se()},Ce.run=function(){d((function(){D=document.getElementById('map'),U=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),F=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),W=B.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),L=B.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),G.addEventListener('mousedown',Re),G.addEventListener('mouseup',ke),G.addEventListener('mousemove',Ie),G.addEventListener('mouseleave',Le),G.addEventListener('click',Oe),G.addEventListener('contextmenu',Ne),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y}(),fe(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,Ee),a.$on(l.GROUPS_VILLAGES_CHANGED,xe)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,b,T,E,f,_,w,h){let v,A,S,y,R,k,I,L,O,N,x,P={},C=!1,z={character:{},tribe:{}};const G={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},M=G.MINIMAP,U=function(e){v.selectedTab=e,e===G.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(v.highlights.character).forEach((function(e){e in z.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
z.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in z.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){z.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!O)return;let a=B(t.x,t.y);var i,n;N=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=_.getTownAt(i,n);if(t)return e(t);_.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!C)return;I.appendChild(O),O.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=O.getBoundingClientRect(),i=I.getBoundingClientRect(),n=a.width+50,o=a.height+50,s=k.tt.position.y+o>i.top+i.height,l=k.tt.position.x+n>i.width;s&&(k.tt.position.y-=50),O.classList.toggle('left',l),O.classList.toggle('top',s)}))},q=function(e,t){if(!O)return;let a=t?B(t):N;P[a]=!1,C=!1,k.tt.visible=!1,O.classList.add('ng-hide'),L.appendChild(O)},W=function(e,t,i){let o,s,l=a.$new(),r=!0;l.colorPalettes=h.palette,'setting'===e?(s=t,o=x.get(s),r=!1,l.submit=function(){v.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){v.settings[s]=x.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,l.submit=function(){v.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][i],l.submit=function(){n.addHighlight({id:i,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
c.getModal('modal_color_palette',l)},F=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},Y=function(){x.setAll(x.decode(v.settings)),b.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},j=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){x.resetAll(),b.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){D()},highlightAddErrorExists:function(){b.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){b.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){b.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},X=function(){v=a.$new(),v.SETTINGS=p,v.TAB_TYPES=G,v.selectedTab=M,v.selectedHighlight=!1,v.addHighlightColor='#000000',v.highlights=n.getHighlights(),v.highlightNames=z,v.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),v.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),v.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=U,v.openColorPalette=W,v.addCustomHighlight=F,v.removeHighlight=n.removeHighlight,v.saveSettings=Y,v.resetSettings=j,v.highlightsCount=H,v.openProfile=K,x.injectScope(v,{textObject:'minimap'});let e=new T('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,q),e.register(l.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',v),D(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(S),R.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){x=n.getSettings(),k=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),I=document.querySelector('#wrapper'),L=document.querySelector('#map'),A=t.addMenuButton4('Minimapa',20),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(l.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const b='prank_helper_settings',T=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={
init:function(){u=!0,c=new e({settingsMap:i,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&T(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('all settings',d),s((function(){T()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,T),a.$on(l.ARMY_PRESET_DELETED,T),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.PRANK_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.PRANK_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/prankHelper/events',[],(function(){angular.extend(l,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),
define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),b=n.getGroupList();const T={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.SETTINGS,u.settingsMap=o,p.injectScope(u),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',b='060502',T='060501',E='060503',f='05020a',_='05030a',w='04080a',h='040a0a',v='070e04',A='070e05',S='070e0f',y='070e06',R='070e02',k='070e01',I='070e03',L='070e07',O='070e0b',N='070e0e',x='030d07',P='030d0b',C='030d0e';var z={init:function(){i=!0}};return z.start=function(){e.trigger(l.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,b='string'==typeof b?parseInt(b,16):b,T='string'==typeof T?parseInt(T,16):T,E='string'==typeof E?parseInt(E,16):E,f='string'==typeof f?parseInt(f,16):f,
_='string'==typeof _?parseInt(_,16):_,w='string'==typeof w?parseInt(w,16):w,h='string'==typeof h?parseInt(h,16):h,v='string'==typeof v?parseInt(v,16):v,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,I='string'==typeof I?parseInt(I,16):I,L='string'==typeof L?parseInt(L,16):L,O='string'==typeof O?parseInt(O,16):O,N='string'==typeof N?parseInt(N,16):N,x='string'==typeof x?parseInt(x,16):x,P='string'==typeof P?parseInt(P,16):P,C='string'==typeof C?parseInt(C,16):C,o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,medic:!1,scout:!1,supporter:!1,bastard:!1},units:{spear:20,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:0,doppelsoldner:0,snob:0,knight:0}}),o.emit(s.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (miecz)',
...
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),z.stop()},z.stop=function(){e.trigger(l.PRESET_CREATOR_STOPPED),r=!1},z.isRunning=function(){return r},z.isInitialized=function(){return i},z})),define('two/presetCreator/events',[],(function(){angular.extend(l,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(101),o=e.addMenuButton('Wojewoda',100,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
...
define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],b=[],T=[],E=[],f=[],_=[],w=[],h=[],v=[],A=[],S=[],y=[],R=[],k=[],I=[],L=[],O=[],N=[],x=[],P=[],C=[],z=[],G=[],M=[],U=[],D=[],B=[],V=[],q=[],W=[],F=[],Y=[];const j='recruit_queue_settings',H={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],b=[],T=[],E=[],f=[],_=[],w=[],h=[]
;const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],s=u[t.PRESET4],l=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){b.push(e[t])})),o.forEach((function(t){T.push(e[t])})),s.forEach((function(t){E.push(e[t])})),l.forEach((function(t){f.push(e[t])})),r.forEach((function(t){_.push(e[t])})),c.forEach((function(t){w.push(e[t])})),d.forEach((function(t){h.push(e[t])}))},Q=function(){v=[],A=[],S=[],y=[],R=[],k=[],I=[],L=[],O=[],N=[],x=[],P=[],C=[],z=[],G=[],M=[],U=[],D=[],B=[],V=[],q=[],W=[],F=[],Y=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4],l=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],b=u[t.GROUP12],T=u[t.GROUP13],E=u[t.GROUP14],f=u[t.GROUP15],_=u[t.GROUP16],w=u[t.GROUP17],h=u[t.GROUP18],j=u[t.GROUP19],H=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){v.push(e[t])})),i.forEach((function(t){A.push(e[t])})),o.forEach((function(t){S.push(e[t])})),s.forEach((function(t){y.push(e[t])})),l.forEach((function(t){R.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){L.push(e[t])})),p.forEach((function(t){O.push(e[t])})),g.forEach((function(t){N.push(e[t])})),m.forEach((function(t){x.push(e[t])})),b.forEach((function(t){P.push(e[t])})),T.forEach((function(t){C.push(e[t])})),E.forEach((function(t){z.push(e[t])})),f.forEach((function(t){G.push(e[t])})),_.forEach((function(t){
M.push(e[t])})),w.forEach((function(t){U.push(e[t])})),h.forEach((function(t){D.push(e[t])})),j.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),K.forEach((function(t){q.push(e[t])})),Q.forEach((function(t){W.push(e[t])})),X.forEach((function(t){F.push(e[t])})),Z.forEach((function(t){Y.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:i,storageKey:j}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('all settings',u),r((function(){K()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,K),a.$on(l.ARMY_PRESET_DELETED,K),a.$on(l.GROUPS_CREATED,Q),a.$on(l.GROUPS_DESTROYED,Q),a.$on(l.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(l.recruit_queue_START)},stop:function(){g=!1,c.trigger(l.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(l,{
RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u){let p,g,m,b=n.getPresetList(),T=n.getGroupList();const E={PRESETS:'presets',OWN:'own',LOGS:'logs'},f=function(e){p.selectedTab=e},_=function(){g.setAll(g.decode(p.settings)),u.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},h=function(){p.presets=r.encodeList(b.getPresets(),{disabled:!1,type:'presets'})},v=function(){p.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),u.notif('success','Example module started')},S=function(){p.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),u.notif('success','Example module stopped')
},y=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=E,p.running=t.isRunning(),p.selectedTab=E.PRESETS,p.settingsMap=o,p.units=r.encodeList(s,{textObject:'recruit_queue',disabled:!0}),g.injectScope(p),h(),v(),p.selectTab=f,p.saveSettings=_,p.switchState=w;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,h,!0),e.register(l.ARMY_PRESET_DELETED,h,!0),e.register(l.GROUPS_CREATED,v,!0),e.register(l.GROUPS_DESTROYED,v,!0),e.register(l.GROUPS_UPDATED,v,!0),e.register(l.recruit_queue_START,A),e.register(l.recruit_queue_STOP,S),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',p)};return function(){g=t.getSettings(),e.addDivisor(81),m=e.addMenuButton('Kapitan',80),m.addEventListener('click',y),
...
default:!1,disabledOption:!0,inputType:'select'},[e.UNIT18]:{default:!1,disabledOption:!0,inputType:'select'},[e.UNIT19]:{default:!1,disabledOption:!0,inputType:'select'},[e.UNIT20]:{default:!1,disabledOption:!0,inputType:'select'}}})),define('two/recruitQueue/types/units',[],(function(){return{SPEAR:'spear',SWORD:'sword',AXE:'axe',ARCHER:'archer',LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/recruitQueue','two/recruitQueue/ui','two/recruitQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const b='report_helper_settings',T=function(){g=[]
;const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},f={init:function(){u=!0,c=new e({settingsMap:i,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&T(),t[o.GROUPS]&&E()})),d=c.getAll(),console.log('all settings',d),s((function(){T()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,T),a.$on(l.ARMY_PRESET_DELETED,T),a.$on(l.GROUPS_CREATED,E),a.$on(l.GROUPS_DESTROYED,E),a.$on(l.GROUPS_UPDATED,E)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.REPORT_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.REPORT_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return f})),define('two/reportHelper/events',[],(function(){
angular.extend(l,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),b=n.getGroupList();const T={SETTINGS:'settings',SOME_VIEW:'some_view'},E=function(e){u.selectedTab=e},f=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),
u.SETTINGS=i,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=E,u.saveSettings=f,u.switchState=_;let e=new r('twoverflow_report_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.REPORT_HELPER_START,v),e.register(l.REPORT_HELPER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Skryba',70),g.addEventListener('click',S),
...
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,w.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}));var v=w.join(),A=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),R=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,I=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),x=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),C=d.night,z=d.loyaltyAfter,G=d.loyaltyBefore,M=d.wallAfter,U=d.wallBefore,D=d.officers,B=d.leader,V='',q='',W='',F='',Y='',j='',H='',K='',Q='',X=Date.now(),Z=l.split('.').join('_')
;null!=G&&(j='Lojalność przed atakiem: '+Math.floor(G)+' '),null!=z&&(H='Lojalność po ataku: '+Math.floor(z)+' '),null!=U&&(K='Mury przed ataku: '+U+' '),null!=M&&(Q='Mury po ataku: '+M+' '),null==D&&1==B?Y='Brak':null==D&&1.1==B&&(Y=' Wielki Mistrz '),F=0==C?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(X/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+k+']'+I+'[/player][br]Modyfikator obrony: [b]'+x+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+Y+'[/b][br]'+j+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(s.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},E=function(e){
var t,a=[],n=e.result,l=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,f=d.attUnits;if(f.spear+f.sword+f.axe+f.archer+f.light_cavalry+f.mounted_archer+f.ram+f.catapult+f.heavy_cavalry+f.trebuchet+f.knight+f.snob+f.doppelsoldner>30){var _=[],w=[];T.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),_.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,_.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,_.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,_.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,_.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,_.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,_.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,_.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,_.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,_.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,_.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,_.push(' Zjednoczenie '+g+'%'))}));var h=_.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,w.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,w.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,w.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,w.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}));var v,A=w.join(),S=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,L=d.defCharacterName,O=d.defVillageId,N=d.defVillageName,x=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),z=d.night,G=d.loyaltyAfter,M=d.loyaltyBefore,U=d.wallAfter,D=d.wallBefore,B=d.officers,V='',q='',W='',F='',Y='',j='',H='',K='',Q=[],X=Date.now(),Z=l.split('.').join('_')
;if(null!=M&&(Y='Lojalność przed atakiem: '+Math.floor(M)+' '),null!=G&&(j='Lojalność po ataku: '+Math.floor(G)+' '),null!=D&&(H='Mury przed ataku: '+D+' '),null!=U&&(K='Mury po ataku: '+U+' '),null==B)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(F=0==z?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),W=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',q=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(X/1e3-r),v=Q.join(),null!=L){
a.push('[size=XL][b]Raport z ataku: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+O+']'+N+'[/village][b] Gracz cel: [/b][player='+I+']'+L+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+x+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+v+'[/b][br]'+Y+j+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(s.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},f={init:function(){r=!0},start:function(){e.trigger(l.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(l.REPORT_SENDER_STOPPED),c=!1},
...
[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(_,E,T,f);const w={init:function(){g=!0,u=new e({settingsMap:a,storageKey:b}),p=u.getAll(),console.log('all settings',p)},start:function(){m=!0,d.trigger(l.SPY_MASTER_START)},stop:function(){m=!1,d.trigger(l.SPY_MASTER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return w})),define('two/spyMaster/events',[],(function(){angular.extend(l,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/spyMaster/types/dummies','two/spyMaster/types/replacement','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u,p,m){let b,T,E;const f={SPY:'spy',COUNTERMEASURES:'countermeasures',
LOGS:'logs'},_=function(e){b.selectedTab=e},w=function(){T.setAll(T.decode(b.settings)),m.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},v=function(){b.running=!0,E.classList.remove('btn-orange'),E.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},A=function(){b.running=!1,E.classList.remove('btn-red'),E.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},S=function(){b=a.$new(),b.SETTINGS=i,b.TAB_TYPES=f,b.running=t.isRunning(),b.selectedTab=f.SPY,b.settingsMap=n,b.building=u.encodeList(o,{textObject:'spy_master',disabled:!0}),b.unit=u.encodeList(s,{textObject:'spy_master',disabled:!0}),b.dummies=u.encodeList(r,{textObject:'spy_master',disabled:!0}),b.replacement=u.encodeList(d,{textObject:'spy_master',disabled:!0}),T.injectScope(b),b.selectTab=_,b.saveSettings=w,b.switchState=h;let e=new p('twoverflow_spy_master_window',(function(){
console.log('spyMaster window closed')}));e.register(l.SPY_MASTER_START,v),e.register(l.SPY_MASTER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',b)};return function(){T=t.getSettings(),E=e.addMenuButton3('Zwiadowca',10),E.addEventListener('click',S),
