...
[u.LEVEL_15]:75,[u.LEVEL_16]:80,[u.LEVEL_17]:85,[u.LEVEL_18]:90,[u.LEVEL_19]:95,[u.LEVEL_20]:100},N={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},C={[_.LEVEL_1]:100,[_.LEVEL_2]:200,[_.LEVEL_3]:300,[_.LEVEL_4]:400,[_.LEVEL_5]:500,[_.LEVEL_6]:600,[_.LEVEL_7]:700,[_.LEVEL_8]:800,[_.LEVEL_9]:900,[_.LEVEL_10]:1e3},M={[b.LEVEL_1]:100,[b.LEVEL_2]:129,[b.LEVEL_3]:167,[b.LEVEL_4]:215,[b.LEVEL_5]:278,[b.LEVEL_6]:359,[b.LEVEL_7]:464,[b.LEVEL_8]:599,[b.LEVEL_9]:774,[b.LEVEL_10]:1e3},z={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(L,z,M,C,P,N,O,x,R,I,k);const U=function(){A=[];const e=n.getPresetList().getPresets();w[t.PRESETS].forEach((function(t){A.push(e[t])})),console.log('selectedPresets',A)},G={init:function(){v=!0,h=new e({settingsMap:i,storageKey:y}),w=h.getAll(),console.log('all settings',w),T((function(){U()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,U),a.$on(s.ARMY_PRESET_DELETED,U)},start:function(){S=!0,console.log('selectedPresets',A),f.trigger(s.BATTLE_CALCULATOR_START)},stop:function(){S=!1,console.log('example module stop'),f.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return h},isInitialized:function(){return v},isRunning:function(){return S}};return G})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,E,T){let f,h,w,v=injector.get('buildingService'),S=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const I={};let k,L,x,O,N,P=!0;const C='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!P)return Y.stop(),!1;e.forEach((function(e){const t=L.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},U=function(){G().forEach((function(e){const t=L.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
A.canBeFinishedForFree(a,t)&&S.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=k.getGroupVillageIds(e),a=a.filter((function(e){return L.getVillage(e)}))):t.each(L.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),j(t))return!1;n.some((function(a){if(++i[a]>t[a])return v.compute(e),B(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),W(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=w[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},j=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},W=function(e,t){let a={time:T.gameTime(),villageId:e,building:t.building,level:t.level};return x.unshift(a),x.length>500&&x.splice(x.length-500,x.length),E.set(C,x),!0};let Y={};return Y.start=function(){if(!P)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,f=setInterval(z,6e4),h=setInterval(U,6e3),e((function(){G().forEach((function(e){const t=L.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),U()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},Y.stop=function(){R=!1,clearInterval(f),
clearInterval(h),b.trigger(s.BUILDER_QUEUE_STOP)},Y.isRunning=function(){return R},Y.isInitialized=function(){return y},Y.getSettings=function(){return O},Y.getLogs=function(){return x},Y.clearLogs=function(){x=[],E.set(C,x),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},Y.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},Y.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},Y.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},Y.init=function(){y=!0,x=E.get(C,[],!0),L=n.getSelectedCharacter(),k=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),R&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)I[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,w=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=L.getVillage(t.village_id);D(e)}),1e3)}))},Y})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,T,f,h,w,v){let S,A,y,R,I=n.getGroupList(),k={},L=!1,x={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},U=!1,G=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case T.SEQUENCE_SAVED:return!0;case T.SEQUENCE_EXISTS:
...
O.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequence.offset,t=S.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),S.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,k[a]=[];for(let e=1;e<=i.max_level;e++){let n=D(i.points,i.points_factor,e)-t;t+=n,k[a].push(n)}}},x.moveUp=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(U=!0)},x.moveDown=function(){let e=angular.copy(x.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
B(e,a,a+1))))}x.buildingSequence=e,x.updateVisibleBuildingSequence(),t&&(U=!0)},x.addBuilding=function(e,t,a=1){const i=t-1;let n=x.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return x.buildingSequence=x.updateLevels(n,e),x.updateVisibleBuildingSequence(),U=!0,!0},x.removeBuilding=function(e){const t=x.buildingSequence[e].building;x.buildingSequence.splice(e,1),x.buildingSequence=x.updateLevels(x.buildingSequence,t),x.updateVisibleBuildingSequence(),U=!0},x.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},x.generateBuildingSequence=function(){const e=R.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(x.sequencesAvail=t,!t)return!1;const a=e[x.selectedSequence.value];let i={};for(let e in f)i[f[e]]=0;x.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
x.updateVisibleBuildingSequence()},x.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;x.visibleBuildingSequence=x.buildingSequence.slice(e,e+t),S.pagination.buildingSequenceEditor.count=x.buildingSequence.length},x.updateBuildingSequence=function(){const e=x.selectedSequence.value,t=x.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case T.SEQUENCE_SAVED:U=!1;break;case T.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case T.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},x.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(x.selectedSequence.value),U=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},x.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=x.lastAddedIndex,e.indexLimit=x.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(x.lastAddedBuilding,a.loc.ale,'building_names'),value:x.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),l=y[t].max_level;x.lastAddedBuilding=t,x.lastAddedIndex=i,x.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,l))},
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,E,T,f,h){let w,v,S,A,y,R=n.getGameData(),I=R.getOrderedUnitNames(),k=R.getOrderedOfficerNames(),L=n.getPresetList(),x=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let P,C,M,z=[],U={},G={};const D={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){x=t.data},q=function(){x=!1},j=function(e){
const t=new Date(e||T.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=T.zerofill(a-a%100,3),n=T.zerofill(t.getSeconds(),2),l=T.zerofill(t.getMinutes(),2);return T.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+T.zerofill(t.getDate(),2)+'/'+T.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},W=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),j(e+=t)):''},Y=function(){if(w.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!w.isValidDate&&o.getTimeFromString(y.date),t=w.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(D,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);w.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),w.travelTimes[a][n].status=e?F(t?e-l:e):'neutral'}))}))},F=function(e){return e&&w.isValidDate?T.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=w.selectedDateType.value,h.set(m.LAST_DATE_TYPE,w.selectedDateType.value),Y()},K=function(){
...
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,_,m,v.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===v.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(Te(l,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{b().then(T).then(A).then(R).then(I).then(L).then(O).then(N).then(P).then(C).then(e).catch(t)}),U=new Promise((e,t)=>{F=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,U]).then(()=>{if(!this.running)return!1
...
v.exceptionVillages.included.forEach((function(e){N(e)})),v.exceptionVillages.ignored.forEach((function(e){N(e)}))},C=function(){t.isRunning()?t.stop():t.start()},M=function(e){v.selectedTab=e},z=function(){S.setAll(S.decode(v.settings)),v.saveButtonColor='orange',f.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},U=function(e){const t=S.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){S.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){v.presets=E.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){v.groups=E.encodeList(R.getGroups(),{disabled:!1,type:'groups'}),v.groupsWithDisabled=E.encodeList(R.getGroups(),{disabled:!0,type:'groups'})},V=function(){v.running=!0,
f.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(v.running=!1,v.showCycleTimer=!1,clearInterval(L),t.reason){case d.NO_PRESETS:f.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:f.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},j=function(){v.logs=angular.copy(t.getLogs()),O(),v.logs.length||f.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},W=function(){v.farmers=t.getFarmers()},Y=function(){v.exceptionVillages=t.getExceptionVillages(),P()},F=function(){v.exceptionLogs=t.getExceptionLogs()},H=function(){v.showCycleTimer=!1,clearInterval(L)},K=function(e,a){a!==i.USER_STOP&&(v.showCycleTimer=!0,v.nextCycleCountdown=t.getCycleInterval(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;v=a.$new(),v.SETTINGS=b,v.TAB_TYPES=x,v.LOG_TYPES=u,v.running=t.isRunning(),v.selectedTab=x.SETTINGS,v.farmers=t.getFarmers(),
v.villagesLabel=k,v.villagesInfo=I,v.exceptionVillages=t.getExceptionVillages(),v.exceptionLogs=t.getExceptionLogs(),v.logs=t.getLogs(),v.visibleLogs=[],v.showCycleTimer=!1,v.nextCycleCountdown=0,v.saveButtonColor='orange',v.settingsMap=S.settingsMap,v.pagination={count:v.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},S.injectScope(v),D(),B(),O(),P(),function(){let e=t.getNextCycleDate();e&&(v.showCycleTimer=!0,v.nextCycleCountdown=e-w.gameTime(),L=setInterval((function(){v.nextCycleCountdown-=1e3}),1e3))}(),v.switchFarm=C,v.selectTab=M,v.saveSettings=z,v.clearLogs=t.clearLogs,v.jumpToVillage=p.jumpToVillage,v.openVillageInfo=r.openVillageInfo,v.showReport=_.showReport,v.removeIgnored=U,v.removeIncluded=G;let i=new T('twoverflow_farm_overflow_window',(function(){clearInterval(L)}));i.register(s.ARMY_PRESET_UPDATE,D,!0),i.register(s.ARMY_PRESET_DELETED,D,!0),i.register(s.GROUPS_UPDATED,B,!0),i.register(s.GROUPS_CREATED,B,!0),i.register(s.GROUPS_DESTROYED,B,!0),
i.register(s.FARM_OVERFLOW_START,V),i.register(s.FARM_OVERFLOW_STOP,q),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,j),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,W),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,Y),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,F),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',v),v.$watch('settings',(function(){e||(v.saveButtonColor='red'),e=!1}),!0)};return function(){S=t.getSettings(),A=e.addMenuButton('Farmer',10),A.addEventListener('click',(function(){Q()})),h.register(s.FARM_OVERFLOW_START,(function(){A.classList.remove('btn-orange'),A.classList.add('btn-red')})),h.register(s.FARM_OVERFLOW_STOP,(function(){A.classList.remove('btn-red'),A.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,T,f,h,w,v,S){let A,y,R,I,k,L,x,O,N,P,C,M,z,U,G,D,B,V,q,j,W,Y,F,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/y)%2&&(t+=I),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},be=function(e,t){return{x:e/v.TILESIZE.x,y:t/v.TILESIZE.y/v.TILESIZE.off}},Ee=function(){Se(k)},Te=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),U.clearRect(0,0,z.width,z.height),function(e){P.drawImage(C,-e.x,-e.y)}(e),F[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;U.fillStyle=F[o.COLOR_VIEW_REFERENCE],U.fillRect(a,0,1,R),U.fillRect(0,i,R,1);const n=D.getBoundingClientRect(),l=n.width/v.TILESIZE.x/S.view.z*y,s=n.height/v.TILESIZE.y/S.view.z*y,r=a-l/2,c=i-s/2;U.clearRect(r,c,l,s),U.beginPath(),U.lineWidth=1,U.strokeStyle=F[o.COLOR_VIEW_REFERENCE],U.rect(r,c,l,s),U.stroke()}(e)}e.requestAnimationFrame(Te)
},fe=function(){if(!ie)return!1;const e=Q.village[x][O];we(e?Q.character[e]:[[x,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:x,y:O})},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t,F[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Se(t)},ve=function(e){if(F[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!F[o.SHOW_BARBARIANS]&&j.barbarian;if(e.character_id===V){if(e.id===L.getId()&&F[o.HIGHLIGHT_SELECTED])return j.selected;if(e.character_id in K.character)return K.character[e.character_id];if(F[o.HIGHLIGHT_OWN])return j.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&F[o.HIGHLIGHT_DIPLOMACY])return j.tribe;if(W&&F[o.HIGHLIGHT_DIPLOMACY]){
if(W.isAlly(e.tribe_id))return j.ally;if(W.isEnemy(e.tribe_id))return j.enemy;if(W.isNAP(e.tribe_id))return j.friendly}}return j.ugly},Se=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||ve(i);if(!n)continue;const o=i.x*y+(i.y%2?I:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,A,A)}},Ae=function(){A=oe[F[o.MAP_SIZE]],I=Math.round(A/2),y=A+1,R=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,C.width=1e3*y,C.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,U.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[x,O,e]),3===e.which&&(a=x,i=O,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(F[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
},h.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},h.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Ie=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},ke=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!F[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(F[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(x===e.x&&O===e.y)return!1;fe()}ie=!0,x=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:x,y:O,event:t});const a=Q.village[x][O];he(a?Q.character[a]:[[x,O]])}(pe,e)}fe()},Le=function(){ie&&fe(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},xe=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:L.getId(),x:L.getX(),y:L.getY()};L=B.getSelectedVillage(),Se([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:L.getId(),x:L.getX(),y:L.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=F[o.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,U=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return Y},Ce.drawMinimap=function(){ge&&(ge=!1),N.style.background=F[o.COLOR_BACKGROUND],M.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=f.getPath(v.getMapPath()),t=F[o.SHOW_CONTINENT_DEMARCATIONS],a=F[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=F[o.COLOR_CONTINENT],M.fillRect(e*y+I-1,t*y+I-1,3,1),M.fillRect(e*y+I,t*y+I-2,1,3)},n=function(e,t){M.fillStyle=F[o.COLOR_PROVINCE],M.fillRect(e*y+I,t*y+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=T.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),Ee()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),M=C.getContext('2d'),re=se.make('hover'),Y=new u({settingsMap:l,storageKey:ne}),Y.onChange((function(e,t){
F=Y.getAll(),Ae(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),F=Y.getAll(),K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Ae()},Ce.run=function(){d((function(){D=document.getElementById('map'),G=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),W=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),j=B.getVillagesColors(),re.alpha=0,S.graph.layers.effects.push(re),ye(),L=B.getSelectedVillage(),te.x=L.getX(),te.y=L.getY(),ee.x=L.getX()*y,ee.y=L.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Re),z.addEventListener('mouseup',Ie),z.addEventListener('mousemove',ke),z.addEventListener('mouseleave',Le),z.addEventListener('click',xe),z.addEventListener('contextmenu',Oe),g.load((function(){k=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,E,T,f,h,w){let v,S,A,y,R,I,k,L,x,O,N,P={},C=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},U=z.MINIMAP,G=function(e){v.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(v.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(v.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!x)return;let a=B(t.x,t.y);var i,n;O=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=f.getTownAt(i,n);if(t)return e(t);f.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!C)return;k.appendChild(x),x.classList.remove('ng-hide'),I.tt.name=e.name,I.tt.x=e.x,I.tt.y=e.y,I.tt.province_name=e.province_name,I.tt.points=e.points,I.tt.character_name=e.character_name||'-',I.tt.character_points=e.character_points||0,I.tt.tribe_name=e.tribe_name||'-',I.tt.tribe_tag=e.tribe_tag||'-',I.tt.tribe_points=e.tribe_points||0,I.tt.morale=e.morale||0,I.tt.position={},I.tt.position.x=t.event.pageX+50,I.tt.position.y=t.event.pageY+50,I.tt.visible=!0
;const a=x.getBoundingClientRect(),i=k.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=I.tt.position.y+o>i.top+i.height,s=I.tt.position.x+n>i.width;l&&(I.tt.position.y-=50),x.classList.toggle('left',s),x.classList.toggle('top',l)}))},q=function(e,t){if(!x)return;let a=t?B(t):O;P[a]=!1,C=!1,I.tt.visible=!1,x.classList.add('ng-hide'),L.appendChild(x)},j=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){v.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){v.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=v.addHighlightColor,s.submit=function(){v.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=v.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},W=function(){n.addHighlight(v.selectedHighlight,v.addHighlightColor)},Y=function(){N.setAll(N.decode(v.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},F=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(v.highlights.character).length+Object.keys(v.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){v.selectedHighlight={id:e.id,type:e.type,name:e.name}},
...
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},v.selectTab=G,v.openColorPalette=j,v.addCustomHighlight=W,v.removeHighlight=n.removeHighlight,v.saveSettings=Y,v.resetSettings=F,v.highlightsCount=H,v.openProfile=K,N.injectScope(v,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
...
i.get(o,!1,!0)&&t.start(),n.register(s.PRESET_CREATOR_STARTED,(function(){i.set(o,!0)})),n.register(s.PRESET_CREATOR_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,l,r,c){let d,u,p=!1,g=!1,m=[],_=[],b=[],E=[],T=[],f=[],h=[],w=[],v=[],S=[],A=[],y=[],R=[],I=[],k=[],L=[],x=[],O=[],N=[],P=[],C=[],M=[],z=[],U=[],G=[],D=[],B=[],V=[],q=[],j=[],W=[],Y=[];const F='recruit_queue_settings',H={[l.SPEAR]:'spear',[l.SWORD]:'sword',[l.AXE]:'axe',[l.ARCHER]:'archer',[l.LIGHT_CAVALRY]:'light_cavalry',[l.MOUNTED_ARCHER]:'mounted_archer',[l.HEAVT_CAVALRY]:'heavy_cavalry',[l.RAM]:'ram',[l.CATAPULT]:'catapult',[l.TREBUCHET]:'trebuchet',[l.DOPPELSOLDNER]:'doppelsoldner',[l.SNOB]:'snob',[l.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],_=[],b=[],E=[],T=[],f=[],h=[],
w=[];const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],l=u[t.PRESET4],s=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){_.push(e[t])})),o.forEach((function(t){b.push(e[t])})),l.forEach((function(t){E.push(e[t])})),s.forEach((function(t){T.push(e[t])})),r.forEach((function(t){f.push(e[t])})),c.forEach((function(t){h.push(e[t])})),d.forEach((function(t){w.push(e[t])}))},Q=function(){v=[],S=[],A=[],y=[],R=[],I=[],k=[],L=[],x=[],O=[],N=[],P=[],C=[],M=[],z=[],U=[],G=[],D=[],B=[],V=[],q=[],j=[],W=[],Y=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],l=u[t.GROUP4],s=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],_=u[t.GROUP12],b=u[t.GROUP13],E=u[t.GROUP14],T=u[t.GROUP15],f=u[t.GROUP16],h=u[t.GROUP17],w=u[t.GROUP18],F=u[t.GROUP19],H=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],Z=u[t.GROUP23],X=u[t.GROUP24];a.forEach((function(t){v.push(e[t])})),i.forEach((function(t){S.push(e[t])})),o.forEach((function(t){A.push(e[t])})),l.forEach((function(t){y.push(e[t])})),s.forEach((function(t){R.push(e[t])})),r.forEach((function(t){I.push(e[t])})),c.forEach((function(t){k.push(e[t])})),d.forEach((function(t){L.push(e[t])})),p.forEach((function(t){x.push(e[t])})),g.forEach((function(t){O.push(e[t])})),m.forEach((function(t){N.push(e[t])})),_.forEach((function(t){P.push(e[t])})),b.forEach((function(t){C.push(e[t])})),E.forEach((function(t){M.push(e[t])})),T.forEach((function(t){z.push(e[t])})),f.forEach((function(t){
U.push(e[t])})),h.forEach((function(t){G.push(e[t])})),w.forEach((function(t){D.push(e[t])})),F.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),K.forEach((function(t){q.push(e[t])})),Q.forEach((function(t){j.push(e[t])})),Z.forEach((function(t){W.push(e[t])})),X.forEach((function(t){Y.push(e[t])}))},Z={init:function(){p=!0,d=new e({settingsMap:i,storageKey:F}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('all settings',u),r((function(){K()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,K),a.$on(s.ARMY_PRESET_DELETED,K),a.$on(s.GROUPS_CREATED,Q),a.$on(s.GROUPS_DESTROYED,Q),a.$on(s.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(s.recruit_queue_START)},stop:function(){g=!1,c.trigger(s.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return Z})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{
