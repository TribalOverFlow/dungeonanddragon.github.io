...
(void 0).target=e}))},Xa=function(e){d.selectedTab=e},Ja=function(){const e=i.getSelectedVillage().data;(void 0).origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:(void 0).getId()}};const $a={autoCompleteSelected:function(e,t,a,n){if('battleCalculator_village_search'!==t)return!1;(void 0)[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},d.searchQuery[n]=''},onAutoCompleteOrigin:function(e){(void 0).origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){(void 0).target={id:e.id,x:e.x,y:e.y,name:e.name}},start:function(){Ha(),r.notif('success',g('i18n')('calculated',a.loc.ale,'battle_calculator'))}},en=function(){d=a.$new(),d.selectedTab=m.BATTLE,d.TAB_TYPES=m,d.selectTab=Xa,d.addSelected=Ja,d.addMapSelected=Za,d.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'battle_calculator'),onEnter:$a.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'battle_calculator'),dropDown:!0},d.searchQuery={target:''},
(void 0).register(s.SELECT_SELECTED,$a.autoCompleteSelected,!0),(void 0).register(s.BATTLE_CALCULATOR_START,$a.start),(void 0).register(s.BATTLE_CALCULATOR_STOP,$a.stop),(void 0).register(s.COMMAND_QUEUE_START,$a.start),c.getScreenWithInjectedScope('!twoverflow_queue_window',d)};return function(){u=e.addMenuButton('Kalkulator',170),u.addEventListener('click',en),o.register(s.BATTLE_CALCULATOR_START,(function(){u.classList.remove('btn-orange'),u.classList.add('btn-red')})),o.register(s.BATTLE_CALCULATOR_STOP,(function(){u.classList.remove('btn-red'),u.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,Qa),a.$on(s.DESTROY_CONTEXT_MENU,Ka),
