...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,_,b,f){let E,h,v=!1,T=injector.get('overviewService'),w=[],A=!1,S={},y={},R={reverse:!1,column:i.TIME_COMPLETED};const k='attack_view_filters',I={},x={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},L=function(){V.loadCommands()},N=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){
...
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=_.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},U=function(e){w=e.commands;for(let e=0;e<w.length;e++)T.formatCommand(w[e]),w[e].slowestUnit=z(w[e]);w=w.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[w])};let V={loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:R.column,reverse:R.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return w},getFilters:function(){return S},getSortings:function(){return R},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],O(),g.set(k,S),V.loadCommands()},toggleSorting:function(e){e===R.column?R.reverse=!R.reverse:(R.column=e,R.reverse=!1),V.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,h.OUT,s,{},l,p.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return v},init:function(){for(let e=0;e<d.length;e++)I[d[e]]=!0;for(let e in r)x[r[e]]=!0;try{A=require('two/commandQueue'),h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(x),
[c.INCOMING_UNITS]:angular.copy(I),[c.VILLAGE]:!1};v=!0,E=n.getSelectedCharacter().getGlobalInfo(),S=g.get(k,t,!0),e((function(){O(),a.$on(s.COMMAND_INCOMING,L),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,M),a.$on(s.VILLAGE_NAME_CHANGED,C),a.$on(s.COMMAND_IGNORED,P),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,_,b,f,E,h){let v,T;const w=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,i)},y=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleCommands=v.commands.slice(e,e+t),
v.pagination.count=v.commands.length},k=function(){const e=Date.now();for(let t=0;t<v.commands.length;t++)100===v.commands[t].model.percent(e)&&v.commands.splice(t,1);R()},I=function(e,a){t.toggleFilter(e,a),v.filters=t.getFilters()},x=function(e){t.toggleSorting(e),v.sorting=t.getSortings()},O=function(){v.commands=t.getCommands()},L=function(){v.selectedVillageId=n.getSelectedVillage().getId()},N=function(){v=a.$new(),v.commandQueueEnabled=t.commandQueueEnabled(),v.commands=t.getCommands(),v.selectedVillageId=n.getSelectedVillage().getId(),v.filters=t.getFilters(),v.sorting=t.getSortings(),v.UNIT_TYPES=b,v.FILTER_TYPES=u,v.COMMAND_TYPES=d,v.UNIT_SPEED_ORDER=_,v.COLUMN_TYPES=l,v.pagination={count:v.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},v.openCharacterProfile=r.openCharacterProfile,v.openVillageInfo=r.openVillageInfo,v.jumpToVillage=p.jumpToVillage,v.now=w,v.copyTimeModal=A,v.removeTroops=S,v.switchWindowSize=y,v.toggleFilter=I,v.toggleSorting=x,R()
;let e=new i('twoverflow_queue_window',(function(){E.timer.remove(k)}));e.register(s.MAP_SELECTED_VILLAGE,L,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',v),E.timer.add(k)};return function(){T=e.addMenuButton('Strażnik',40),T.addEventListener('click',N),
...
},h=function(){t.isRunning()?t.stop():t.start()},v=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},T=function(){u.groups=l.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},w=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.BATTLE,u.settingsMap=o,p.injectScope(u),v(),T(),u.selectTab=f,u.saveSettings=E,u.switchState=h;let e=new r('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,v,!0),e.register(s.ARMY_PRESET_DELETED,v,!0),e.register(s.GROUPS_CREATED,T,!0),e.register(s.GROUPS_DESTROYED,T,!0),e.register(s.GROUPS_UPDATED,T,!0),e.register(s.BATTLE_CALCULATOR_START,w),
...
a()}),['map','world_config'])})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,f,E){let h,v,T,w=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,R=!1;const k={};let I,x,O,L,N,P=!0;const C='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!P)return j.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=I.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(k);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return w.compute(e),V(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),F(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)B(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=T[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&B(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<T[t])return!1;return!0},F=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),f.set(C,O),!0};let j={};return j.start=function(){if(!P)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,h=setInterval(z,6e4),v=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){R=!1,clearInterval(h),
clearInterval(v),b.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return R},j.isInitialized=function(){return y},j.getSettings=function(){return L},j.getLogs=function(){return O},j.clearLogs=function(){O=[],f.set(C,O),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,L.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,L.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],L.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,O=f.get(C,[],!0),x=n.getSelectedCharacter(),I=n.getGroupList(),L=new i({settingsMap:c,storageKey:M}),L.onChange((function(e,t,a){N=L.getAll(),R&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=L.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,T=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,h,v,T,w){let A,S,y,R,k=n.getGroupList(),I={},x=!1,O={sequencesAvail:!0,modal:{}},L={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case E.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};L.generateSequences=function(){const e=R.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(L.sequencesAvail=t,!t)return!1;L.generateBuildingSequence(),L.generateBuildingSequenceFinal(),L.updateVisibleBuildingSequence()},L.generateBuildingSequence=function(){const e=A.settings[_.ACTIVE_SEQUENCE].value,t=A.settings[_.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(L.sequencesAvail=!!t,!L.sequencesAvail)return!1;for(let e in h)i[h[e]]=0;L.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:w.readableSeconds(o.build_time),levelPoints:I[e][t-1],state:l}}))},L.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,a=A.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=I[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});L.buildingSequenceFinal=n},
L.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;L.visibleBuildingSequence=L.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=L.buildingSequence.length},L.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(D=!0)},O.addBuilding=function(e,t,a=1){const i=t-1;let n=O.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return O.buildingSequence=O.updateLevels(n,e),O.updateVisibleBuildingSequence(),D=!0,!0},O.removeBuilding=function(e){const t=O.buildingSequence[e].building;O.buildingSequence.splice(e,1),O.buildingSequence=O.updateLevels(O.buildingSequence,t),O.updateVisibleBuildingSequence(),D=!0},O.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},O.generateBuildingSequence=function(){const e=R.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;const a=e[O.selectedSequence.value];let i={};for(let e in h)i[h[e]]=0;O.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
O.updateVisibleBuildingSequence()},O.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequenceEditor.offset,t=A.pagination.buildingSequenceEditor.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),A.pagination.buildingSequenceEditor.count=O.buildingSequence.length},O.updateBuildingSequence=function(){const e=O.selectedSequence.value,t=O.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:D=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},O.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(O.selectedSequence.value),D=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},O.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=O.lastAddedIndex,e.indexLimit=O.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(O.lastAddedBuilding,a.loc.ale,'building_names'),value:O.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),l=y[t].max_level;O.lastAddedBuilding=t,O.lastAddedIndex=i,O.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,l))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},O.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=O.selectedSequence.name,i=A.settings[_.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(D){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},N.updateVisibleLogs=function(){const e=A.pagination.logs.offset,t=A.pagination.logs.limit;N.visibleLogs=N.logs.slice(e,e+t),
A.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[h.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(A.settings[_.ACTIVE_SEQUENCE]={name:e.name,value:e.name},A.settings[_.BUILDING_SEQUENCES][e.name]=t,F(),L.selectedSequence={name:e.name,value:e.name},O.selectedSequence={name:e.name,value:e.name},L.generateSequences(),O.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){A.selectedTab=e},F=function(){R.setAll(R.decode(A.settings)),D=!1},j=function(){i.isRunning()?i.stop():i.start()},Y=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){D?Y((function(){C()})):C()},K={updateGroups:function(){A.groups=p.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(_.BUILDING_SEQUENCES);A.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){L.generateSequences()},generateBuildingSequencesEditor:function(){O.generateBuildingSequence()},
updateLogs:function(){A.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=R.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=i[t],A.settings[_.ACTIVE_SEQUENCE].value===t&&L.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=R.get(_.BUILDING_SEQUENCES);A.settings[_.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete A.settings[_.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(A.settings[_.BUILDING_SEQUENCES]);O.selectedSequence={name:i,value:i},K.updateSequences(),O.generateBuildingSequence(),R.get(_.ACTIVE_SEQUENCE)===t&&(R.set(_.ACTIVE_SEQUENCE,i,{quiet:!0}),L.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},Q=function(){const e=R.get(_.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=P.SETTINGS,A.TAB_TYPES=P,A.SETTINGS=_,A.running=x,A.pagination={},A.settingsMap=R.settingsMap,A.villagesLabel=z,A.villagesInfo=M,A.editorView=O,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=h.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=L,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=N,A.logsView.logs=i.getLogs(),A.selectTab=W,A.switchBuilder=j,A.saveSettings=F,A.createSequence=q,A.openVillageInfo=r.openVillageInfo,R.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
count:L.buildingSequence.length,offset:0,loader:L.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.buildingSequenceEditor={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},A.pagination.logs={count:N.logs.length,offset:0,loader:N.updateVisibleLogs,limit:m.getPaginationLimit()},N.updateVisibleLogs(),L.generateSequences(),O.generateBuildingSequence();let t=new v('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
...
L.generateBuildingsLevelPoints(),R=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),T.register(s.BUILDER_QUEUE_START,(function(){x=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),T.register(s.BUILDER_QUEUE_STOP,(function(){x=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const T=Object.values(c),w=Object.values(a),A=Object.values(v),S=Object.values(h),y=Object.values(E);let R,k=[],I={},x=[],O=[],L=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+R},C=function(e){k.push(e)},M=function(e){I[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,k)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){R=t.getTimeOffset(),U.initialized=!0,x=b.get(d.QUEUE_SENT,[],!0),O=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(C(e),M(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!P(e.sendTime))return!0;L?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){L&&k.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),b.set(d.QUEUE_SENT,x),U.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){O.push(e)}(e),b.set(d.QUEUE_EXPIRED,O),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(f,R){if(!G(e))return R(u.INVALID_ORIGIN);if(!G(i))return R(u.INVALID_TARGET);if(!t.isValidDateTime(o))return R(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return R(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return R(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(b[t]=!0)})))return R(u.INVALID_OFFICER_TYPE)}return T.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[h.SUPPORTER]&&delete b[h.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[v.CATAPULT])&&(p||E.HEADQUARTER),w.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return R(u.INVALID_ORIGIN);if(!i)return R(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(P(c))return R(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};C(E),M(E),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):R(u.INVALID_DATE_TYPE)):R(u.INVALID_CATAPULT_TARGET)):R(u.RELOCATE_DISABLED):R(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete I[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),O=[],x=[]},U.start=function(e){L=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){L=!1,p.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return L},U.getWaitingCommands=function(){return k},U.getWaitingCommandsObject=function(){return I},U.getSentCommands=function(){return x},
U.getExpiredCommands=function(){return O},U.filterCommands=function(e,t,a){const i=N[e];return(a||k).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,f,E,h,v){let T,w,A,S,y,R=n.getGameData(),k=R.getOrderedUnitNames(),I=R.getOrderedOfficerNames(),x=n.getPresetList(),O=!1;const L={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=L.ADD;let P,C,M,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){O=t.data},q=function(){O=!1},W=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),l=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},F=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},j=function(){if(T.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!T.isValidDate&&o.getTimeFromString(y.date),t=T.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);T.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),T.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&T.isValidDate?E.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=T.selectedDateType.value,v.set(m.LAST_DATE_TYPE,T.selectedDateType.value),j()},K=function(){
y.catapultTarget=T.catapultTarget.value},Q=function(){const e=T.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];T.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,T.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},T.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=E.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),E.timer.add(e.updateCountdown)},X=function(){T.waitingCommands=t.getWaitingCommands()},J=function(){T.sentCommands=t.getSentCommands()},$=function(){T.expiredCommands=t.getExpiredCommands()},ee=function(){let e=T.waitingCommands;V.forEach((function(a){T.activeFilters[a]&&(e=t.filterCommands(a,T.filtersData,e))})),
T.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){T.showCatapultSelect=!!y.units.catapult},ne=function(e){T.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!O)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));f.loadTownDataAsync(O.x,O.y,1,1,(function(e){y.target=e}))},se=function(){y.date=W()},re=function(){if(!y.date)return!1;y.date=F(y.date,100)},ce=function(){if(!y.date)return!1;y.date=F(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",T.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},T.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case _.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case _.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case _.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case _.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case _.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case _.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},_e=function(e,t){T.activeFilters[e]=!T.activeFilters[e],
t&&(T.filtersData[u.ALLOWED_TYPES][e]=!T.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){T.activeFilters[u.TEXT_MATCH]=T.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){T.presets=o.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},T.searchQuery[i]=''},removeCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(T.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){T.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{E.timer.remove(e.updateCountdown)})}},Ee=function(){const e=v.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;T=a.$new(),T.selectedTab=N,T.inventory=n.getInventory(),T.presets=o.obj2selectOptions(x.getPresets()),T.travelTimes={},o.each(p,(function(e){T.travelTimes[e]={},o.each(U,(function(t,a){T.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),T.unitOrder=S,T.officers=R.getOrderedOfficerNames(),T.searchQuery={origin:'',target:''},T.isValidDate=!1,T.dateTypes=h.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),T.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},T.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},T.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},T.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},T.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},T.showCatapultSelect=!!y.units.catapult,T.attackableBuildings=z,T.commandData=y,
T.activeFilters=C,T.filtersData=M,T.running=t.isRunning(),T.waitingCommands=t.getWaitingCommands(),T.visibleWaitingCommands=t.getWaitingCommands(),T.sentCommands=t.getSentCommands(),T.expiredCommands=t.getExpiredCommands(),T.EVENT_CODES=d,T.FILTER_TYPES=u,T.TAB_TYPES=L,T.COMMAND_TYPES=p,T.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),T.onUnitInputFocus=te,T.onUnitInputBlur=ae,T.catapultTargetVisibility=ie,T.selectTab=ne,T.addSelected=oe,T.addMapSelected=le,T.addCurrentDate=se,T.incrementDate=re,T.reduceDate=ce,T.cleanUnitInputs=de,T.addCommand=ue,T.clearRegisters=pe,T.switchCommandQueue=ge,T.removeCommand=t.removeCommand,T.openVillageInfo=r.openVillageInfo,T.toggleFilter=_e,T.$watch('commandData.origin',j),T.$watch('commandData.target',j),T.$watch('commandData.date',j),T.$watch('commandData.officers',j),T.$watch('selectedDateType.value',H),T.$watch('selectedInsertPreset.value',Q),T.$watch('catapultTarget.value',K),T.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',be),
T.$watch('selectedTab',(function(){T.selectedTab===L.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),T.waitingCommands.forEach(e=>{Z(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),b.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),b.register(s.COMMAND_QUEUE_START,fe.start),b.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',T)};return function(){A=n.getSelectedCharacter(),P=o.getTimeOffset()
;const t=R.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){D[e]=0})),I.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},w=e.addMenuButton('Generał',20),w.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){w.classList.remove('btn-orange'),w.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){w.classList.remove('btn-red'),w.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let u,p,m,_,b,f=!1,E=!1,h=0;u=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},p=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let v={init:function(){f=!0}};return v.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,v=c.clay,T=c.iron,w=f.currentStock,A=E.currentStock,S=v.currentStock,y=T.currentStock,R=[0,5e3],k=[160,16e3],I=[200,2e4],x=[50,5e3];1==s&&(h=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=h?'chapel'==i&&'church'==i||1!=h||(A>=k[1]&&S>=I[1]&&y>=x[1]&&w>=R[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):A>=k[0]&&S>=I[0]&&y>=x[0]&&w>=R[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==h?A>=k[1]&&S>=I[1]&&y>=x[1]&&w>=R[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):A>=k[0]&&S>=I[0]&&y>=x[0]&&w>=R[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},v.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),E=!1},v.isRunning=function(){return E},v.isInitialized=function(){return f},v})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Kapelan',80,g('i18n')('description',a.loc.ale,'faith_checker')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,_,E,h,v,T,w,A,S,y,R){let k,I,x,O,L,N=!1,P=!1,C=[],M=[],z=[],D=[],G=[],U=[],V=!1,B=!1,q=!1,W=0,F=null,j=null,Y=null,H={},K=v.gameTime(),Q=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=I[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=I[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){f.call(x,e)||(x[e]={time:v.gameTime(),report:!1},t=!0)})),_.each(x,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete x[i],t=!0)})),t&&(R.set($,x),T.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),T.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(ke(t.village_id),l=!0):(Oe(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),a.includes(t.group_id)&&!o&&(Le(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),n.includes(t.group_id)&&o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}l&&T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=O.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),l=!0}else Le(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Le(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(ke(t.village_id),l=!0),l&&T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],l=f.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=i.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));k.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),Re(),Le(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(T.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===w.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){V&&q&&t.origin.id===V.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===w.TYPES.ATTACK&&V.commandSent(t)},ge=function(e,t){V&&B&&q&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,a){e&&(t+=L[a].load*e)})),t},_e=function(e){x[e]={time:v.gameTime(),report:H[e]||!1},delete H[e],R.set($,x),T.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=v.gameTime(),t.type=e,M.unshift(t),fe(),!0)},fe=function(){const e=I[r.LOGS_LIMIT];M.length>e&&M.splice(M.length-e,M.length),R.set(X,M),T.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const i=I[r.TARGET_MULTIPLE_FARMERS],n=I[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=v.gameTime()},ve=function(){clearTimeout(F),clearTimeout(j),clearTimeout(Y),F=null,j=null,Y=null
},Te=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},we=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},Ae=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};Ae.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{T.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ae.prototype.start=function(){return he(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,T.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(T.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(T.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,T.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),ve(),this.onCycleEndFn(e),this.onCycleEndFn=b},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return a(i.USER_STOP);t()},_.randomSeconds(we())):t()}),E=()=>new Promise((e,a)=>{const n=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),R=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),k=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),x=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(U.forEach((function(e){f.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)f.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),L=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*I[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,a);_.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),Ee(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(v.gameTime()/1e3),l=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),_=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,_,m,w.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),C=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===w.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(Ee(l,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{b().then(E).then(S).then(R).then(k).then(x).then(L).then(N).then(P).then(C).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,D]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),B=!0,q=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:w.TYPES.ATTACK})}).catch(t=>{switch(ve(),T.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Oe(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},Ae.prototype.setStatus=function(e){this.status=e},
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){B=!1,q=!1,ve(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){B=!1,q=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=h.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),C.push(a)),a},ye=function(){_.each(O.getVillages(),(function(e,t){Se(t)})),T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=I[r.GROUP_ONLY];let t=[];C.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){ke(e)})),T.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<C.length;a++)if(C[a].getId()===e)return C[a].stop(t.KILL_FARMER),C.splice(a,a+1),!0;return!1
},Ie=function(e){he(),C.length?W>=C.length?(W=0,V=!1,Z=v.gameTime()+Te(),T.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=C[W]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,Ie())})),"cycle_begin"===e&&(Z=null,T.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):F=setTimeout((function(){F=null,W=0,Z=null,T.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Ie()}),Te())},xe=function(e){for(let t=0;t<C.length;t++){let a=C[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){C.forEach((function(t){t.removeTarget(e)}))},Le=function(){m.load((function(){C.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=R.get(X,[]),x=R.get($,{}),O=n.getSelectedCharacter(),L=n.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){I=k.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Le(),t[p.VILLAGES]&&(Re(),ye()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&P&&(j?(ve(),
V.targetStep({delay:!0})):F&&(ve(),T.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),W=0,Ie())))})),I=k.getAll(),se("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){C.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!P&&(U.length?(P=!0,e=[],C.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Ie("cycle_begin")})),he(),function(){let e=Te(),t=e+e/2+we();Q=setInterval((function(){v.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),T.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(T.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=v.gameTime()+Te()),T.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,P=!1,ve(),T.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Ne.getFarmer=function(e){return C.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return C},Ne.getSettings=function(){return k},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return x},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return P},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],R.set(X,M),T.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=Te,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,E,h,v,T,w,A){let S,y,R,k,I,x,O,L,N,P,C,M,z,D,G,U,V,B,q,W,F,j,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/y)%2&&(t+=k),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},be=function(e,t){return{x:e/w.TILESIZE.x,y:t/w.TILESIZE.y/w.TILESIZE.off}},fe=function(){Ae(I)},Ee=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){P.drawImage(C,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,R),D.fillRect(0,i,R,1);const n=U.getBoundingClientRect(),l=n.width/w.TILESIZE.x/A.view.z*y,s=n.height/w.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)
},he=function(){if(!ie)return!1;const e=Q.village[O][L];Te(e?Q.character[e]:[[O,L]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:O,y:L})},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},Te=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},we=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===B){if(e.id===x.getId()&&Y[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(F&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(F.isAlly(e.tribe_id))return W.ally;if(F.isEnemy(e.tribe_id))return W.enemy;if(F.isNAP(e.tribe_id))return W.friendly}}return W.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||we(i);if(!n)continue;const o=i.x*y+(i.y%2?k:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],k=Math.round(S/2),y=S+1,R=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,C.width=1e3*y,C.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[O,L,e]),3===e.which&&(a=O,i=L,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id
},v.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},v.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&L===e.y)return!1;he()}ie=!0,O=e.x,L=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:O,y:L,event:t});const a=Q.village[O][L];ve(a?Q.character[a]:[[O,L]])}(pe,e)}he()},xe=function(){ie&&he(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Le=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(T.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(T.PLAYER_COLORS)||{},fe()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?T.PLAYER_COLORS:T.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?T.PLAYER_COLORS:T.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return j},Ce.drawMinimap=function(){ge&&(ge=!1),N.style.background=Y[o.COLOR_BACKGROUND],M.clearRect(0,0,C.width,C.height),d((function(){
!function(){const e=h.getPath(w.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*y+k-1,t*y+k-1,3,1),M.fillRect(e*y+k,t*y+k-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*y+k,t*y+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=E.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Ce.enableRendering=function(){H=!0},Ce.disableRendering=function(){H=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,C=document.createElement('canvas'),M=C.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),Se(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),Y=j.getAll(),K.tribe=le.getCustomColorsByGroup(T.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(T.PLAYER_COLORS)||{},Se()},Ce.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),F=V.getTribeRelations(),B=V.getId(),q=V.getTribeId(),W=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),x=V.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*y,ee.y=x.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Re),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Le),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(I),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),Ee(),a.$on(s.VILLAGE_SELECTED_CHANGED,Pe),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,f,E,h,v,T){let w,A,S,y,R,k,I,x,O,L,N,P={},C=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){w.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(w.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(w.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},B=function(e,t){if(!O)return;let a=V(t.x,t.y);var i,n;L=a,P[a]=!0,C=!0,(i=t.x,n=t.y,new Promise((function(e){let t=h.getTownAt(i,n);if(t)return e(t);h.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[V(e.x,e.y)])return;if(!C)return;I.appendChild(O),O.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=O.getBoundingClientRect(),i=I.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=k.tt.position.y+o>i.top+i.height,s=k.tt.position.x+n>i.width;l&&(k.tt.position.y-=50),O.classList.toggle('left',s),O.classList.toggle('top',l)}))},q=function(e,t){if(!O)return;let a=t?V(t):L;P[a]=!1,C=!1,k.tt.visible=!1,O.classList.add('ng-hide'),x.appendChild(O)},W=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=T.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){w.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){w.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=w.addHighlightColor,s.submit=function(){w.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=w.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
...
c.getScreenWithInjectedScope('!twoverflow_minimap_window',w),U(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(S),R.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),k=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),I=document.querySelector('#wrapper'),x=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/presetCreator',['queues/EventQueue','two/utils'],(function(e,t){var i=!1,r=!1,c=n.getSelectedCharacter().getVillageList(),d='060504',u='060505',p='06050f',m='060506',_='060502',b='060501',f='060503',E='05020a',h='05030a',v='04080a',T='040a0a',w='070e04',A='070e05',S='070e0f',y='070e06',R='070e02',k='070e01',I='070e03',x='070e07',O='070e0b',L='070e0e',N='030d07',P='030d0b',C='030d0e';var M={init:function(){i=!0}};return M.start=function(){e.trigger(s.PRESET_CREATOR_STARTED),r=!0,d='string'==typeof d?parseInt(d,16):d,
u='string'==typeof u?parseInt(u,16):u,p='string'==typeof p?parseInt(p,16):p,m='string'==typeof m?parseInt(m,16):m,_='string'==typeof _?parseInt(_,16):_,b='string'==typeof b?parseInt(b,16):b,f='string'==typeof f?parseInt(f,16):f,E='string'==typeof E?parseInt(E,16):E,h='string'==typeof h?parseInt(h,16):h,v='string'==typeof v?parseInt(v,16):v,T='string'==typeof T?parseInt(T,16):T,w='string'==typeof w?parseInt(w,16):w,A='string'==typeof A?parseInt(A,16):A,S='string'==typeof S?parseInt(S,16):S,y='string'==typeof y?parseInt(y,16):y,R='string'==typeof R?parseInt(R,16):R,k='string'==typeof k?parseInt(k,16):k,I='string'==typeof I?parseInt(I,16):I,x='string'==typeof x?parseInt(x,16):x,O='string'==typeof O?parseInt(O,16):O,L='string'==typeof L?parseInt(L,16):L,N='string'==typeof N?parseInt(N,16):N,P='string'==typeof P?parseInt(P,16):P,C='string'==typeof C?parseInt(C,16):C,o.emit(l.SAVE_NEW_PRESET,{village_id:c[0].data.villageId,name:'Farma (pik)',icon:d,officers:{leader:!1,loot_master:!1,
