...
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],t=[4,5,1,5,5,6,23,4,12,40,200,25,10],a=[25,55,10,10,30,40,200,20,100,250,100,200,100],n=[45,5,5,30,40,30,160,50,50,400,50,250,100],i=[10,30,10,60,30,50,180,20,100,150,100,200,50],o=parseInt(document.getElementById('archerA').value),l=parseInt(document.getElementById('archerD').value),s=[10,25,45,25,130,150,150,2,100,150,30,30,300],r=parseInt(document.getElementById('axeA').value),c=parseInt(document.getElementById('axeD').value),d=parseInt(document.getElementById('berserkerA').value),u=parseInt(document.getElementById('berserkerD').value),p=parseInt(document.getElementById('catapultA').value),g=parseInt(document.getElementById('catapultD').value),m=parseInt(document.getElementById('buildingLevel').value),kt=[1,1,1,1,4,5,6,5,8,1,100,10,6],xt=parseInt(document.getElementById('hcA').value),Rt=parseInt(document.getElementById('hcD').value),Mt=parseInt(document.getElementById('knightA').value),Lt=parseInt(document.getElementById('knightD').value),Ot=parseInt(document.getElementById('lcA').value),Nt=parseInt(document.getElementById('lcD').value),Ct=parseInt(document.getElementById('luck').value),Dt=parseInt(document.getElementById('maA').value),Pt=parseInt(document.getElementById('maD').value),zt=parseInt(document.getElementById('morale').value),Gt=parseInt(document.getElementById('ramA').value),Bt=parseInt(document.getElementById('ramD').value),Ut=parseInt(document.getElementById('snobA').value),Vt=parseInt(document.getElementById('snobD').value),qt=parseInt(document.getElementById('spearA').value),Ft=parseInt(document.getElementById('spearD').value),Wt=parseInt(document.getElementById('swordA').value),jt=parseInt(document.getElementById('swordD').value),Yt=parseInt(document.getElementById('trebuchetA').value),Ht=parseInt(document.getElementById('trebuchetD').value),Qt=parseInt(document.getElementById('wall').value),Kt=0,Zt=0,Xt=0,Jt=0,$t=0,ya=0,Sa=0,Ia=0,ka=0,xa=0,Ra=0,Ma=0,La=0,Oa=0,Na=0,Ca=0,Da=0,Pa=0,za=0,Ga=0,Ba=0,Ua=0,Va=0,qa=0,Fa=0,Wa=0,ja=0,Ya=0,Ha=0,Qa=0,Ka=0,Za=0,Xa=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,_n=0,fn=0,hn=0,bn=0,vn=0,En=0,wn=0,Tn=0,An=0,yn=0,Sn=0,In=0,kn=0,xn=0,Rn=0,Mn=0,Ln=0,On=0,Nn=0,Cn=0,Dn=0,Pn=0,zn=0,Gn=0,Bn=0,Un=0,Vn=0,qn=0,Fn=0,Wn=0,jn=0,Yn=0,Hn=0,Qn=0,Kn=0,Zn=0,Xn=0,Jn=0,$n=0,ei=0,ti=0,ai=0,ni=0,ii=0,oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,_i=0,fi=0,hi=0,bi=[1,1],vi=[1,1],Ei=[1,1],wi=[1,1],Ti=[1,1],Ai=[1,1],yi=[1,1],Si=[1,1],Ii=[1,1],ki=[1,1],xi=[1,1],Ri=[1,1],Mi=[1,1],Li=[1,1],Oi=[1,1],Ni=[1,1],Ci=[1,1],Di=[1,1],Pi=[1,1],zi=[1,1],Gi=[1,1],Bi=[1,1],Ui=[1,1],Vi=[1,1],qi=[1,1],Fi=[1,1],Wi=[1,1],ji=[1,1],Yi=[1,1],Hi=[1,1],Qi=[1,1],Ki=[1,1],Zi=[1,1],Xi=[1,1],Ji=[1,1],$i=[1,1],eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,_o=0,fo=0,ho=0,bo=0,vo=0,Eo=0,wo=0,To=0,Ao=0,yo=0,So=0,Io=0,ko=0,xo=0,Ro=0,Mo=0,Lo=0,Oo=0,No=0,Co=0,Do=0,Po=0,zo=[1,1],Go=0,Bo=0,Uo=0,Vo=0,qo=0,Fo=0,Wo=0,jo=0,Yo=0,Ho=0,Qo=0,Ko=0,Zo=0,Xo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,_l=0,fl=0,hl=0,bl=0,vl=0,El=0,wl=0,Tl=0,Al=0,yl=0,Sl=0,Il=0,kl=[1,1],xl=[1,1],Rl=[1,1],Ml=[1,1],Ll=[1,1],Ol=[1,1],Nl=[1,1],Cl=[1,1],Dl=[1,1],Pl=0,zl=0,Gl=0,Bl=0,Ul=0,Vl=0,ql=0,Fl=0,Wl=0,jl=0,Yl=0,Hl=0,Ql=0,Kl=0,Zl=0,Xl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,_s=0,fs=0,hs=0,bs=0,vs=0,Es=0,ws=0,Ts=0,As=0,ys=0,Ss=0,Is=0,ks=0,xs=0,Rs=0,Ms=0,Ls=0,Os=0,Ns=0,Cs=0,Ds=0,Ps=0,zs=0,Gs=0,Bs=0,Us=0,Vs=0,qs=0,Fs=0,Ws=0,js=0,Ys=0,Hs=0,Qs=0,Ks=0,Zs=0,Xs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,_r=0,fr=0,hr=0,br=1,vr=0,Er=0,wr=0,Tr=0,Ar=0,yr=0,Sr=0,Ir=0,kr=0,xr=0,Rr=0,Mr=0,Lr=0,Or=0,Nr=0,Cr=0,Dr=0,Pr=0,zr=0,Gr=0,Br=0,Ur=0,Vr=0,qr=0,Fr=0,Wr=0,jr=0,Yr=0,Hr=0,Qr=0,Kr=0,Zr=0,Xr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,_c=0,fc=0,hc=0,bc=0,vc=0,Ec=0,wc=0,Tc=0,Ac=0,yc=0,Sc=0,Ic=0,kc=0,xc=0,Rc=0,Mc=0,Lc=0,Oc=0,Nc=0,Cc=0,Dc=0,Pc=0,zc=0,Gc=0,Bc=0,Uc=0,Vc=0,qc=0,Fc=0,Wc=0,jc=0,Yc=0,Hc=0,Qc=0,Kc=0,Zc=0,Xc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,_d=0,fd=0,hd=0,bd=0,vd=0,Ed=0,wd=0,Td=0,Ad=0,yd=0,Sd=0,Id=0,kd=0,xd=0,Rd=0,Md=0,Ld=0,Od=0,Nd=0,Cd=0,Dd=0,Pd=0,zd=0,Gd=0,Bd=0,Ud=0,Vd=0,qd=0,Fd=0,Wd=0,jd=0,Yd=0,Hd=0,Qd=0,Kd=0,Zd=0,Xd=0,Jd=0,$d=0,eu=0,tu=0,au=0,nu=0,iu=0,ou=0,lu=0,su=0,ru=0,cu=0,du=0,uu=0,pu=0,gu=0,mu=0,_u=0,fu=0,hu=0,bu=0,vu=0,Eu=0,wu=0,Tu=0,Au=0,yu=0,Su=0,Iu=0,ku=0,xu=0,Ru=0,Mu=0,Lu=0,Ou=0,Nu=0,Cu=0,Du=0,Pu=0,zu=0,Gu=0,Bu=0,Uu=0,Vu=0,qu=0,Fu=0,Wu=0,ju=0,Yu=0,Hu=0,Qu=0,Ku=0,Zu=0,Xu=0,Ju=0,$u=0,ep=0,tp=0,ap=0,np=0,ip=0,op=0,lp=0,sp=0,rp=0,cp=0,dp=0,up=0,pp=0,gp=0,mp=0,_p=0,fp=0,hp=0,bp=0,vp=0,Ep=0,wp=0,Tp=0,Ap=0,yp=0,Sp=0,Ip=0,kp=0,xp=0,Rp=0,Mp=0,Lp=0,Op=0,Np=0,Cp=0,Dp=0,Pp=0,zp=0,Gp=0,Bp=0,Up=0,Vp=0,qp=0,Fp=0,Wp=0,jp=0,Yp=0,Hp=0
;to=parseInt(ea[0].dataset.value),ao=parseInt(ta[0].dataset.value),br=document.getElementById('settings-nightBonus').checked?2:1,ys=document.getElementById('settings-officerLeader').checked?.1:0,fr=document.getElementById('settings-officerMedic').checked?.1:0,Mc=document.getElementById('settings-skillMedic').checked?.1:0,xc=parseInt(aa[0].dataset.value),Lc=parseInt(na[0].dataset.value),Rc=parseInt(ia[0].dataset.value),Oo=parseInt(oa[0].dataset.value),_i=la[0].dataset.value,Ip=la[0].dataset.name,No=sa[0].dataset.value,Co=ra[0].dataset.value,Do=ca[0].dataset.value,Po=da[0].dataset.value,Ss=parseInt(ua[0].dataset.value),Is=parseInt(pa[0].dataset.value),ks=parseInt(ga[0].dataset.value),xs=parseInt(ma[0].dataset.value),Ai='axe'==No&1==Ss?[1.05,1.1]:'axe'==No&2==Ss?[1.1,1.2]:'axe'==No&3==Ss?[1.2,1.3]:[1,1],Bi='ma'==No&1==Ss?[1.05,1.1]:'ma'==No&2==Ss?[1.1,1.2]:'ma'==No&3==Ss?[1.2,1.3]:[1,1],Hi='spear'==No&1==Ss?[1.1,1.05]:'spear'==No&2==Ss?[1.2,1.1]:'spear'==No&3==Ss?[1.3,1.2]:[1,1],
Xi='sword'==No&1==Ss?[1.1,1.05]:'sword'==No&2==Ss?[1.2,1.1]:'sword'==No&3==Ss?[1.3,1.2]:[1,1],vi='archer'==No&1==Ss?[1.1,1.05]:'archer'==No&2==Ss?[1.2,1.1]:'archer'==No&3==Ss?[1.3,1.2]:[1,1],Li='hc'==No&1==Ss?[1.1,1.1]:'hc'==No&2==Ss?[1.2,1.2]:'hc'==No&3==Ss?[1.3,1.3]:[1,1],Fi='ram'==No&1==Ss?[1.05,1.25]:'ram'==No&2==Ss?[1.1,1.5]:'ram'==No&3==Ss?[1.2,2]:[1,1],ki='catapult'==No&1==Ss?[1.05,1.25]:'catapult'==No&2==Ss?[1.1,1.5]:'catapult'==No&3==Ss?[1.2,2]:[1,1],yi='axe'==Co&1==Is?[1.05,1.1]:'axe'==Co&2==Is?[1.1,1.2]:'axe'==Co&3==Is?[1.2,1.3]:[1,1],Ui='ma'==Co&1==Is?[1.05,1.1]:'ma'==Co&2==Is?[1.1,1.2]:'ma'==Co&3==Is?[1.2,1.3]:[1,1],Qi='spear'==Co&1==Is?[1.1,1.05]:'spear'==Co&2==Is?[1.2,1.1]:'spear'==Co&3==Is?[1.3,1.2]:[1,1],Ji='sword'==Co&1==Is?[1.1,1.05]:'sword'==Co&2==Is?[1.2,1.1]:'sword'==Co&3==Is?[1.3,1.2]:[1,1],Ei='archer'==Co&1==Is?[1.1,1.05]:'archer'==Co&2==Is?[1.2,1.1]:'archer'==Co&3==Is?[1.3,1.2]:[1,1],
Oi='hc'==Co&1==Is?[1.1,1.1]:'hc'==Co&2==Is?[1.2,1.2]:'hc'==Co&3==Is?[1.3,1.3]:[1,1],Wi='ram'==Co&1==Is?[1.05,1.25]:'ram'==Co&2==Is?[1.1,1.5]:'ram'==Co&3==Is?[1.2,2]:[1,1],xi='catapult'==Co&1==Is?[1.05,1.25]:'catapult'==Co&2==Is?[1.1,1.5]:'catapult'==Co&3==Is?[1.2,2]:[1,1],zi='lc'==Do&1==ks?[1.05,1.1]:'lc'==Do&2==ks?[1.1,1.2]:'lc'==Do&3==ks?[1.2,1.3]:[1,1],Si='axe'==Do&1==ks?[1.05,1.1]:'axe'==Do&2==ks?[1.1,1.2]:'axe'==Do&3==ks?[1.2,1.3]:[1,1],Vi='ma'==Do&1==ks?[1.05,1.1]:'ma'==Do&2==ks?[1.1,1.2]:'ma'==Do&3==ks?[1.2,1.3]:[1,1],Ki='spear'==Do&1==ks?[1.1,1.05]:'spear'==Do&2==ks?[1.2,1.1]:'spear'==Do&3==ks?[1.3,1.2]:[1,1],$i='sword'==Do&1==ks?[1.1,1.05]:'sword'==Do&2==ks?[1.2,1.1]:'sword'==Do&3==ks?[1.3,1.2]:[1,1],wi='archer'==Do&1==ks?[1.1,1.05]:'archer'==Do&2==ks?[1.2,1.1]:'archer'==Do&3==ks?[1.3,1.2]:[1,1],Ni='hc'==Do&1==ks?[1.1,1.1]:'hc'==Do&2==ks?[1.2,1.2]:'hc'==Do&3==ks?[1.3,1.3]:[1,1],ji='ram'==Do&1==ks?[1.05,1.25]:'ram'==Do&2==ks?[1.1,1.5]:'ram'==Do&3==ks?[1.2,2]:[1,1],
Ri='catapult'==Do&1==ks?[1.05,1.25]:'catapult'==Do&2==ks?[1.1,1.5]:'catapult'==Do&3==ks?[1.2,2]:[1,1],Ci=(Di='lc'==No&1==Ss?[1.05,1.1]:'lc'==No&2==Ss?[1.1,1.2]:'lc'==No&3==Ss?[1.2,1.3]:[1,1])[0]>=(Pi='lc'==Co&1==Is?[1.05,1.1]:'lc'==Co&2==Is?[1.1,1.2]:'lc'==Co&3==Is?[1.2,1.3]:[1,1])[0]&&Di[0]>=zi[0]?Di:Pi[0]>=Di[0]&&Pi[0]>=zi[0]?Pi:zi[0]>=Di[0]&&zi[0]>=Pi[0]?zi:[1,1],Ti=Ai[0]>=yi[0]&&Ai[0]>=Si[0]?Ai:yi[0]>=Ai[0]&&yi[0]>=Si[0]?yi:Si[0]>=Ai[0]&&Si[0]>=yi[0]?Si:[1,1],Gi=Bi[0]>=Ui[0]&&Bi[0]>=Vi[0]?Bi:Ui[0]>=Bi[0]&&Ui[0]>=Vi[0]?Ui:Vi[0]>=Bi[0]&&Vi[0]>=Ui[0]?Vi:[1,1],Mi=Li[0]>=Oi[0]&&Li[0]>=Ni[0]?Li:Oi[0]>=Li[0]&&Oi[0]>=Ni[0]?Oi:Ni[0]>=Li[0]&&Ni[0]>=Oi[0]?Ni:[1,1],qi=Fi[0]>=Wi[0]&&Fi[0]>=ji[0]?Fi:Wi[0]>=Fi[0]&&Wi[0]>=ji[0]?Wi:ji[0]>=Fi[0]&&ji[0]>=Wi[0]?ji:[1,1],Ii=ki[0]>=xi[0]&&ki[0]>=Ri[0]?ki:xi[0]>=ki[0]&&xi[0]>=Ri[0]?xi:Ri[0]>=ki[0]&&Ri[0]>=xi[0]?Ri:[1,1],Yi=Hi[0]>=Qi[0]&&Hi[0]>=Ki[0]?Hi:Qi[0]>=Hi[0]&&Qi[0]>=Ki[0]?Qi:Ki[0]>=Hi[0]&&Ki[0]>=Qi[0]?Ki:[1,1],
Zi=Xi[0]>=Ji[0]&&Xi[0]>=$i[0]?Xi:Ji[0]>=Xi[0]&&Ji[0]>=$i[0]?Ji:$i[0]>=Xi[0]&&$i[0]>=Ji[0]?$i:[1,1],bi=vi[0]>=Ei[0]&&vi[0]>=wi[0]?vi:Ei[0]>=vi[0]&&Ei[0]>=wi[0]?Ei:wi[0]>=vi[0]&&wi[0]>=Ei[0]?wi:[1,1],Ll='lc'==Po&1==xs?[1.05,1.1]:'lc'==Po&2==xs?[1.1,1.2]:'lc'==Po&3==xs?[1.2,1.3]:[1,1],xl='axe'==Po&1==xs?[1.05,1.1]:'axe'==Po&2==xs?[1.1,1.2]:'axe'==Po&3==xs?[1.2,1.3]:[1,1],Ol='ma'==Po&1==xs?[1.05,1.1]:'ma'==Po&2==xs?[1.1,1.2]:'ma'==Po&3==xs?[1.2,1.3]:[1,1],Cl='spear'==Po&1==xs?[1.1,1.05]:'spear'==Po&2==xs?[1.2,1.1]:'spear'==Po&3==xs?[1.3,1.2]:[1,1],Dl='sword'==Po&1==xs?[1.1,1.05]:'sword'==Po&2==xs?[1.2,1.1]:'sword'==Po&3==xs?[1.3,1.2]:[1,1],kl='archer'==Po&1==xs?[1.1,1.05]:'archer'==Po&2==xs?[1.2,1.1]:'archer'==Po&3==xs?[1.3,1.2]:[1,1],Ml='hc'==Po&1==xs?[1.1,1.1]:'hc'==Po&2==xs?[1.2,1.2]:'hc'==Po&3==xs?[1.3,1.3]:[1,1],Nl='ram'==Po&1==xs?[1.05,1.25]:'ram'==Po&2==xs?[1.1,1.5]:'ram'==Po&3==xs?[1.2,2]:[1,1],
Rl='catapult'==Po&1==xs?[1.05,1.25]:'catapult'==Po&2==xs?[1.1,1.5]:'catapult'==Po&3==xs?[1.2,2]:[1,1],ja=qt*kt[0]+Wt*kt[1]+r*kt[2]+o*kt[3]+Ot*kt[4]+Dt*kt[5]+xt*kt[6]+Gt*kt[7]+p*kt[8]+Mt*kt[9]+Ut*kt[10]+Yt*kt[11]+d*kt[12],fi=Ft*kt[0]+jt*kt[1]+c*kt[2]+l*kt[3]+Nt*kt[4]+Pt*kt[5]+Rt*kt[6]+Bt*kt[7]+g*kt[8]+Lt*kt[9]+Vt*kt[10]+Ht*kt[11]+u*kt[12],eo=2*ja<=fi?2:1,vr=ja-5*Gt,Tr=0==Qt?0:Math.round(20*Math.pow(1.2515,Qt-1)),hi=fi+(Tr+100*Vt),Hr=0==vr||0==hi?0:vr/hi>1?1:vr/hi,hr=zt/100,Ys=Ct/100,wr=Math.round(1e3*(to/100*hr*(1+Ys)+xc/100+ys))/1e3,hp=p/(fp=Gt+p),bp=Gt/fp,Qu=Math.round(Ht*hp),up=Math.round(Ht*bp),vc=(wc=Gt-(0==Gt?0:Gt<up?Gt:up))*Hr*wr*(zo='ram'==Po?1==xs?[1.05,1.25]:2==xs?[1.1,1.5]:3==xs?[1.2,2]:[1,1]:[1,1])[1],Mo=20==Qt?18:19==Qt?17:18==Qt?15:17==Qt?14:16==Qt?13:15==Qt?11:14==Qt?10:13==Qt||12==Qt?9:11==Qt?8:10==Qt?7:9==Qt||8==Qt?6:7==Qt||6==Qt?5:5==Qt||4==Qt||3==Qt?4:2==Qt||1==Qt?3:0,mp=0==Qt?0:2*Mo,pp=0==Qt?0:vc/mp,_p=Qt<=Lc?Qt:Qt-Lc<pp?Qt<Lc?Qt:Lc:Qt-pp,bn=Math.round(_p),
hn=Math.round(.05*bn*1e3)/1e3,Er=Math.round(ao/100*(1+hn)*br*1e3)/1e3,mi=p-(0==p?0:p<Qu?p:Qu),fn=0==(gp=Math.round(_p))?0:Math.round(20*Math.pow(1.2515,gp-1)),es=qt+Wt+r+d>Ot+xt&&qt+Wt+r+d>o+Dt?'inf':Ot+xt>qt+Wt+r+d&&Ot+xt>o+Dt?'cav':'arc',Or=qt*kt[0]+Wt*kt[1]+r*kt[2]+o*kt[3]+Ot*kt[4]+Dt*kt[5]+xt*kt[6]+wc*kt[7]+mi*kt[8]+Mt*kt[9]+Ut*kt[10]+Yt*kt[11]+d*kt[12],Wr=Ft*kt[0]+jt*kt[1]+c*kt[2]+l*kt[3]+Nt*kt[4]+Pt*kt[5]+Rt*kt[6]+Bt*kt[7]+g*kt[8]+Lt*kt[9]+Vt*kt[10]+Ht*kt[11]+u*kt[12],console.log('provisionDefenderRound1Total'+Wr),Ac=wc*kt[7]+mi*kt[8]+Yt*kt[11]+Mt*kt[9]+Ut*kt[10],'cav'==es?(Ir=Ot*kt[4]+xt*kt[6]+Ac,Rr=qt*kt[0]+Wt*kt[1]+r*kt[2]+d*kt[12],Ar=o*kt[3]+Dt*kt[5]):'inf'==es?(Rr=qt*kt[0]+Wt*kt[1]+r*kt[2]+d*kt[12]+Ac,Ir=Ot*kt[4]+xt*kt[6],Ar=o*kt[3]+Dt*kt[5]):'arc'==es?(Rr=qt*kt[0]+Wt*kt[1]+r*kt[2]+d*kt[12],Ir=Ot*kt[4]+xt*kt[6],Ar=o*kt[3]+Dt*kt[5]+Ac):(Rr=qt*kt[0]+Wt*kt[1]+r*kt[2]+d*kt[12],Ir=Ot*kt[4]+xt*kt[6],Ar=o*kt[3]+Dt*kt[5]),zs=0==Rr?0:Math.round(Rr/Or*1e4)/1e4,
Ps=0==Ir?0:Math.round(Ir/Or*1e4)/1e4,0==Ar?(Ds=0,console.log('lossesPercentRound1Arc'+Ds)):(Ds=Math.round(Ar/Or*1e4)/1e4,console.log('lossesPercentRound1Arc'+Ds)),_d=Math.round(Ft*zs),md=Math.round(Ft*Ps),gd=Ft-md-_d,Ou=Math.round(jt*zs),Lu=Math.round(jt*Ps),Mu=jt-Lu-Ou,sn=Math.round(c*zs),ln=Math.round(c*Ps),on=c-ln-sn,Da=Math.round(l*zs),Ca=Math.round(l*Ps),Na=l-Ca-Da,_s=Math.round(Nt*zs),ms=Math.round(Nt*Ps),gs=Nt-ms-_s,sr=Math.round(Pt*zs),lr=Math.round(Pt*Ps),or=Pt-lr-sr,Eo=Math.round(Rt*zs),vo=Math.round(Rt*Ps),bo=Rt-vo-Eo,rc=Math.round(Bt*zs),sc=Math.round(Bt*Ps),lc=Bt-sc-rc,ai=Math.round(g*zs),ti=Math.round(g*Ps),ei=g-ti-ai,Yc=Math.round(Vt*zs),jc=Math.round(Vt*Ps),Wc=Vt-jc-Yc,ap=Math.round(Ht*zs),tp=Math.round(Ht*Ps),ep=Ht-tp-ap,Nn=Math.round(u*zs),On=Math.round(u*Ps),Ln=u-On-Nn,bl=Math.round(Lt*zs),hl=Math.round(Lt*Ps),fl=Lt-hl-bl,Vr=_d*kt[0]+Ou*kt[1]+sn*kt[2]+Nn*kt[12]+Yc*kt[10]+_s*kt[4]+Eo*kt[6]+Da*kt[3]+sr*kt[5]+rc*kt[7]+ai*kt[8]+ap*kt[11]+bl*kt[9],
console.log('provisionDefenderInfRound1'+Vr),Gr=md*kt[0]+Lu*kt[1]+ln*kt[2]+On*kt[12]+jc*kt[10]+ms*kt[4]+vo*kt[6]+Ca*kt[3]+lr*kt[5]+sc*kt[7]+ti*kt[8]+tp*kt[11]+hl*kt[9],console.log('provisionDefenderCavRound1'+Gr),Dr=gd*kt[0]+Mu*kt[1]+on*kt[2]+Ln*kt[12]+Wc*kt[10]+gs*kt[4]+bo*kt[6]+Na*kt[3]+or*kt[5]+lc*kt[7]+ei*kt[8]+ep*kt[11]+fl*kt[9],console.log('provisionDefenderArcRound1'+Dr),Xd=_d*a[0]*Yi[0]+Ou*a[1]*Zi[0]+sn*a[2]*Ti[0]+Nn*a[12]+Yc*a[10]+_s*a[4]*Ci[0]+Eo*a[6]*Mi[0]+Da*a[3]*bi[0]+sr*a[5]*Gi[0]+rc*a[7]*qi[0]+ai*a[8]*Ii[0]+ap*a[11]+bl*a[9],Qd=md*n[0]*Yi[0]+Lu*n[1]*Zi[0]+ln*n[2]*Ti[0]+On*n[12]+jc*n[10]+ms*n[4]*Ci[0]+vo*n[6]*Mi[0]+Ca*n[3]*bi[0]+lr*n[5]*Gi[0]+sc*n[7]*qi[0]+ti*n[8]*Ii[0]+tp*n[11]+hl*n[9],jd=gd*i[0]*Yi[0]+Mu*i[1]*Zi[0]+on*i[2]*Ti[0]+Ln*i[12]+Wc*i[10]+gs*i[4]*Ci[0]+bo*i[6]*Mi[0]+Na*i[3]*bi[0]+or*i[5]*Gi[0]+lc*i[7]*qi[0]+ei*i[8]*Ii[0]+ep*i[11]+fl*i[9],Ic=wc*s[7]*Nl[1]+mi*s[8]*Rl[1]+Yt*s[11]+Mt*s[9]+Ut*s[10],'cav'==es?(Bd=Ot*s[4]*Ll[1]+xt*s[6]*Ml[1]+Ic,
qd=qt*s[0]*Cl[1]+Wt*s[1]*Dl[1]+r*s[2]*xl[1]+d*s[12]*eo,Pd=o*s[3]*kl[1]+Dt*s[5]*Ol[1]):'inf'==es?(qd=qt*s[0]*Cl[1]+Wt*s[1]*Dl[1]+r*s[2]*xl[1]+d*s[12]*eo+Ic,Bd=Ot*s[4]*Ll[1]+xt*s[6]*Ml[1],Pd=o*s[3]*kl[1]+Dt*s[5]*Ol[1]):'arc'==es?(qd=qt*s[0]*Cl[1]+Wt*s[1]*Dl[1]+r*s[2]*xl[1]+d*s[12]*eo,Bd=Ot*s[4]*Ll[1]+xt*s[6]*Ml[1],Pd=o*s[3]*kl[1]+Dt*s[5]*Ol[1]+Ic):(qd=qt*s[0]*Cl[1]+Wt*s[1]*Dl[1]+r*s[2]*xl[1]+d*s[12]*eo,Bd=Ot*s[4]*Ll[1]+xt*s[6]*Ml[1],Pd=o*s[3]*kl[1]+Dt*s[5]*Ol[1]),Nd=(Md=qd*wr)+(kd=Bd*wr)+(yd=Pd*wr),cu=(lu=Xd*Er+fn)+(nu=Qd*Er+fn)+(eu=jd*Er+fn),$l=0==Md||0==lu?0:lu<=Md?1:Math.pow(Md/lu,.5)/(lu/Md),Jl=0==kd||0==nu?0:nu<=kd?1:Math.pow(kd/nu,.5)/(nu/kd),Xl=0==yd||0==eu?0:eu<=yd?1:Math.pow(yd/eu,.5)/(eu/yd),Zl=0==Md||0==lu?0:Md<=lu?1:Math.pow(lu/Md,.5)/(Md/lu),Kl=0==kd||0==nu?0:kd<=nu?1:Math.pow(nu/kd,.5)/(kd/nu),Ql=0==yd||0==eu?0:yd<=eu?1:Math.pow(eu/yd,.5)/(yd/eu),Uo=Math.round(1e6*Zl)/1e6,Bo=Math.round(1e6*Kl)/1e6,Go=Math.round(1e6*Ql)/1e6,Fo=Math.round(1e6*$l)/1e6,
qo=Math.round(1e6*Jl)/1e6,Vo=Math.round(1e6*Xl)/1e6,cd=Math.round(-_d*Fo+1e-6)+Math.round(-md*qo+1e-6)+Math.round(-gd*Vo+1e-6),Iu=Math.round(-Ou*Fo+1e-6)+Math.round(-Lu*qo+1e-6)+Math.round(-Mu*Vo+1e-6),en=Math.round(-sn*Fo+1e-6)+Math.round(-ln*qo+1e-6)+Math.round(-on*Vo+1e-6),Ra=Math.round(-Da*Fo+1e-6)+Math.round(-Ca*qo+1e-6)+Math.round(-Na*Vo+1e-6),cs=Math.round(-_s*Fo+1e-6)+Math.round(-ms*qo+1e-6)+Math.round(-gs*Vo+1e-6),tr=Math.round(-sr*Fo+1e-6)+Math.round(-lr*qo+1e-6)+Math.round(-or*Vo+1e-6),mo=Math.round(-Eo*Fo+1e-6)+Math.round(-vo*qo+1e-6)+Math.round(-bo*Vo+1e-6),ac=Math.round(-rc*Fo+1e-6)+Math.round(-sc*qo+1e-6)+Math.round(-lc*Vo+1e-6),Zn=Math.round(-ai*Fo+1e-6)+Math.round(-ti*qo+1e-6)+Math.round(-ei*Vo+1e-6),Zu=Math.round(-ap*Fo+1e-6)+Math.round(-tp*qo+1e-6)+Math.round(-ep*Vo+1e-6),kn=Math.round(-Nn*Fo+1e-6)+Math.round(-On*qo+1e-6)+Math.round(-Ln*Vo+1e-6),pl=Math.round(-bl*Fo+1e-6)+Math.round(-hl*qo+1e-6)+Math.round(-fl*Vo+1e-6),
Uc=Math.round(-Yc*Fo+1e-6)+Math.round(-jc*qo+1e-6)+Math.round(-Wc*Vo+1e-6),ad=Math.round(-qt*Uo+1e-6),vu=Math.round(-Wt*Uo+1e-6),Ha=Math.round(-r*Uo+1e-6),En=Math.round(-d*Uo+1e-6),Jt=Math.round(-o*Go+1e-6),Qs=Math.round(-Dt*Go+1e-6),as=Math.round(-Ot*Bo+1e-6),lo=Math.round(-xt*Bo+1e-6),'cav'==es?(Kr=Math.round(-wc*Bo+1e-6),Fn=Math.round(-mi*Bo+1e-6),qu=Math.round(-Yt*Bo+1e-6),ol=Math.round(-Mt*Bo+1e-6),Nc=Math.round(-Ut*Bo+1e-6)):'inf'==es?(Kr=Math.round(-wc*Uo+1e-6),Fn=Math.round(-mi*Uo+1e-6),qu=Math.round(-Yt*Uo+1e-6),ol=Math.round(-Mt*Uo+1e-6),Nc=Math.round(-Ut*Uo+1e-6)):'arc'==es&&(Kr=Math.round(-wc*Go+1e-6),Fn=Math.round(-mi*Go+1e-6),qu=Math.round(-Yt*Go+1e-6),ol=Math.round(-Mt*Go+1e-6),Nc=Math.round(-Ut*Go+1e-6)),od=qt+ad,Tu=Wt+vu,Za=r+Ha,Sa=o+Jt,os=Ot+as,Xs=Dt+Qs,co=xt+lo,Jr=wc+Kr,Yn=mi+Fn,ju=Yt+qu,An=d+En,Pc=Ut+Nc,rl=Mt+ol,pd=Ft+cd,Ru=jt+Iu,nn=c+en,Oa=l+Ra,ps=Nt+cs,ir=Pt+tr,ho=Rt+mo,oc=Bt+ac,$n=g+Zn,$u=Ht+Zu,Mn=u+kn,Fc=Vt+Uc,_l=Lt+pl,
Rs=ad*kt[0]+vu*kt[1]+Ha*kt[2]+Jt*kt[3]+as*kt[4]+Qs*kt[5]+lo*kt[6]+Kr*kt[7]+Fn*kt[8]+ol*kt[9]+Nc*kt[10]+qu*kt[11]+En*kt[12],console.log('lossesAttackerRound1Total'+Rs),Os=cd*kt[0]+Iu*kt[1]+en*kt[2]+Ra*kt[3]+cs*kt[4]+tr*kt[5]+mo*kt[6]+ac*kt[7]+Zn*kt[8]+pl*kt[9]+Uc*kt[10]+Zu*kt[11]+kn*kt[12],console.log('lossesDefenderRound1Total'+Os),pu=od*kt[0]+Tu*kt[1]+Za*kt[2]+Sa*kt[3]+os*kt[4]+Xs*kt[5]+co*kt[6]+Jr*kt[7]+Yn*kt[8]+ju*kt[11]+An*kt[12]+Pc*kt[10]+rl*kt[9],console.log('survivorsAttackerRound1Total'+pu),_u=pd*kt[0]+Ru*kt[1]+nn*kt[2]+Oa*kt[3]+ps*kt[4]+ir*kt[5]+ho*kt[6]+oc*kt[7]+$n*kt[8]+$u*kt[11]+Mn*kt[12]+Fc*kt[10]+_l*kt[9],console.log('survivorsDefenderRound1Total'+_u),0==Nd||0==cu?(Wa=0,console.log('armyLossesPercentEachRound'+Wa)):cu<=Nd?(Wa=1,console.log('armyLossesPercentEachRound'+Wa)):(Wa=Math.pow(Nd/cu,.5/(cu/Nd)),console.log('armyLossesPercentEachRound'+Wa)),Nr=od*kt[0]+Tu*kt[1]+Za*kt[2]+Sa*kt[3]+os*kt[4]+Xs*kt[5]+co*kt[6]+Jr*kt[7]+Yn*kt[8]+rl*kt[9]+Pc*kt[10]+ju*kt[11]+An*kt[12],
jr=pd*kt[0]+Ru*kt[1]+nn*kt[2]+Oa*kt[3]+ps*kt[4]+ir*kt[5]+ho*kt[6]+oc*kt[7]+$n*kt[8]+_l*kt[9]+Fc*kt[10]+$u*kt[11]+Mn*kt[12],console.log('provisionDefenderRound2Total'+jr),yc=Jr*kt[7]+Yn*kt[8]+ju*kt[11]+rl*kt[9],'cav'==es?(kr=os*kt[4]+co*kt[6]+yc,Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10],yr=Sa*kt[3]+Xs*kt[5]):'inf'==es?(Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10]+yc,kr=os*kt[4]+co*kt[6],yr=Sa*kt[3]+Xs*kt[5]):'arc'==es?(Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10],kr=os*kt[4]+co*kt[6],yr=Sa*kt[3]+Xs*kt[5]+yc):(Mr=od*kt[0]+Tu*kt[1]+Za*kt[2]+An*kt[12]+Pc*kt[10],kr=os*kt[4]+co*kt[6],yr=Sa*kt[3]+Xs*kt[5]),Us=0==Mr?0:Math.round(Mr/Nr*1e4)/1e4,Bs=0==kr?0:Math.round(kr/Nr*1e4)/1e4,0==yr?(Gs=0,console.log('lossesPercentRound2Arc'+Gs)):(Gs=Math.round(yr/Nr*1e4)/1e4,console.log('lossesPercentRound2Arc'+Gs)),vd=Math.round(pd*Us),bd=Math.round(pd*Bs),hd=pd-bd-vd,Pu=Math.round(Ru*Us),Du=Math.round(Ru*Bs),Cu=Ru-Du-Pu,un=Math.round(nn*Us),dn=Math.round(nn*Bs),cn=nn-dn-un,
Ba=Math.round(Oa*Us),Ga=Math.round(Oa*Bs),za=Oa-Ga-Ba,vs=Math.round(ps*Us),bs=Math.round(ps*Bs),hs=ps-bs-vs,ur=Math.round(ir*Us),dr=Math.round(ir*Bs),cr=ir-dr-ur,yo=Math.round(ho*Us),Ao=Math.round(ho*Bs),To=ho-Ao-yo,pc=Math.round(oc*Us),uc=Math.round(oc*Bs),dc=oc-uc-pc,li=Math.round($n*Us),oi=Math.round($n*Bs),ii=$n-oi-li,Zc=Math.round(Fc*Us),Kc=Math.round(Fc*Bs),Qc=Fc-Kc-Zc,lp=Math.round($u*Us),op=Math.round($u*Bs),ip=$u-op-lp,zn=Math.round(Mn*Us),Pn=Math.round(Mn*Bs),Dn=Mn-Pn-zn,Tl=Math.round(_l*Us),wl=Math.round(_l*Bs),El=_l-wl-Tl,qr=vd*kt[0]+Pu*kt[1]+un*kt[2]+zn*kt[12]+Zc*kt[10]+vs*kt[4]+yo*kt[6]+Ba*kt[3]+ur*kt[5]+pc*kt[7]+li*kt[8]+lp*kt[11]+Tl*kt[9],console.log('provisionDefenderInfRound2'+qr),Br=bd*kt[0]+Du*kt[1]+dn*kt[2]+Pn*kt[12]+Kc*kt[10]+bs*kt[4]+Ao*kt[6]+Ga*kt[3]+dr*kt[5]+uc*kt[7]+oi*kt[8]+op*kt[11]+wl*kt[9],console.log('provisionDefenderCavRound2'+Br),Pr=hd*kt[0]+Cu*kt[1]+cn*kt[2]+Dn*kt[12]+Qc*kt[10]+hs*kt[4]+To*kt[6]+za*kt[3]+cr*kt[5]+dc*kt[7]+ii*kt[8]+ip*kt[11]+El*kt[9],
console.log('provisionDefenderArcRound2'+Pr),Jd=vd*a[0]*Yi[0]+Pu*a[1]*Zi[0]+un*a[2]*Ti[0]+zn*a[12]+Zc*a[10]+vs*a[4]*Ci[0]+yo*a[6]*Mi[0]+Ba*a[3]*bi[0]+ur*a[5]*Gi[0]+pc*a[7]*qi[0]+li*a[8]*Ii[0]+lp*a[11]+Tl*a[9],Kd=bd*n[0]*Yi[0]+Du*n[1]*Zi[0]+dn*n[2]*Ti[0]+Pn*n[12]+Kc*n[10]+bs*n[4]*Ci[0]+Ao*n[6]*Mi[0]+Ga*n[3]*bi[0]+dr*n[5]*Gi[0]+uc*n[7]*qi[0]+oi*n[8]*Ii[0]+op*n[11]+wl*n[9],Yd=hd*i[0]*Yi[0]+Cu*i[1]*Zi[0]+cn*i[2]*Ti[0]+Dn*i[12]+Qc*i[10]+hs*i[4]*Ci[0]+To*i[6]*Mi[0]+za*i[3]*bi[0]+cr*i[5]*Gi[0]+dc*i[7]*qi[0]+ii*i[8]*Ii[0]+ip*i[11]+El*i[9],kc=Jr*s[7]*Nl[1]+Yn*s[8]*Rl[1]+ju*s[11]+rl*s[9],'cav'==es?(Ud=os*s[4]*Ll[1]+co*s[6]*Ml[1]+kc,Fd=od*s[0]*Cl[1]+Tu*s[1]*Dl[1]+Za*s[2]*xl[1]+An*s[12]*eo+Pc*s[10],zd=Sa*s[3]*kl[1]+Xs*s[5]*Ol[1]):'inf'==es?(Fd=od*s[0]*Cl[1]+Tu*s[1]*Dl[1]+Za*s[2]*xl[1]+An*s[12]*eo+Pc*s[10]+kc,Ud=os*s[4]*Ll[1]+co*s[6]*Ml[1],zd=Sa*s[3]*kl[1]+Xs*s[5]*Ol[1]):'arc'==es?(Fd=od*s[0]*Cl[1]+Tu*s[1]*Dl[1]+Za*s[2]*xl[1]+An*s[12]*eo+Pc*s[10],Ud=os*s[4]*Ll[1]+co*s[6]*Ml[1],
zd=Sa*s[3]*kl[1]+Xs*s[5]*Ol[1]+kc):(Fd=od*s[0]*Cl[1]+Tu*s[1]*Dl[1]+Za*s[2]*xl[1]+An*s[12]*eo+Pc*s[10],Ud=os*s[4]*Ll[1]+co*s[6]*Ml[1],zd=Sa*s[3]*kl[1]+Xs*s[5]*Ol[1]),su=Jd*Er,iu=Kd*Er,tu=Yd*Er,Cd=(Ld=Fd*wr)+(xd=Ud*wr)+(Sd=zd*wr),console.log('strengthAttackerRound2'+Cd),du=su+iu+tu,console.log('strengthDefenderRound2'+du),Vl=0==Ld||0==su?0:su<=Ld?1:Math.pow(Ld/su,.5)/(su/Ld),Ul=0==xd||0==iu?0:iu<=xd?1:Math.pow(xd/iu,.5)/(iu/xd),Bl=0==Sd||0==tu?0:tu<=Sd?1:Math.pow(Sd/tu,.5)/(tu/Sd),Gl=0==Ld||0==su?0:Ld<=su?1:Math.pow(su/Ld,.5)/(Ld/su),zl=0==xd||0==iu?0:xd<=iu?1:Math.pow(iu/xd,.5)/(xd/iu),Pl=0==Sd||0==tu?0:Sd<=tu?1:Math.pow(tu/Sd,.5)/(Sd/tu),Yo=Math.round(1e6*Gl)/1e6,jo=Math.round(1e6*zl)/1e6,Wo=Math.round(1e6*Pl)/1e6,Ko=Math.round(1e6*Vl)/1e6,Qo=Math.round(1e6*Ul)/1e6,Ho=Math.round(1e6*Bl)/1e6,dd=Math.round(-vd*Ko+1e-6)+Math.round(-bd*Qo+1e-6)+Math.round(-hd*Ho+1e-6),ku=Math.round(-Pu*Ko+1e-6)+Math.round(-Du*Qo+1e-6)+Math.round(-Cu*Ho+1e-6),
tn=Math.round(-un*Ko+1e-6)+Math.round(-dn*Qo+1e-6)+Math.round(-cn*Ho+1e-6),Ma=Math.round(-Ba*Ko+1e-6)+Math.round(-Ga*Qo+1e-6)+Math.round(-za*Ho+1e-6),ds=Math.round(-vs*Ko+1e-6)+Math.round(-bs*Qo+1e-6)+Math.round(-hs*Ho+1e-6),ar=Math.round(-ur*Ko+1e-6)+Math.round(-dr*Qo+1e-6)+Math.round(-cr*Ho+1e-6),_o=Math.round(-yo*Ko+1e-6)+Math.round(-Ao*Qo+1e-6)+Math.round(-To*Ho+1e-6),nc=Math.round(-pc*Ko+1e-6)+Math.round(-uc*Qo+1e-6)+Math.round(-dc*Ho+1e-6),Xn=Math.round(-li*Ko+1e-6)+Math.round(-oi*Qo+1e-6)+Math.round(-ii*Ho+1e-6),Xu=Math.round(-lp*Ko+1e-6)+Math.round(-op*Qo+1e-6)+Math.round(-ip*Ho+1e-6),xn=Math.round(-zn*Ko+1e-6)+Math.round(-Pn*Qo+1e-6)+Math.round(-Dn*Ho+1e-6),gl=Math.round(-Tl*Ko+1e-6)+Math.round(-wl*Qo+1e-6)+Math.round(-El*Ho+1e-6),Vc=Math.round(-Zc*Ko+1e-6)+Math.round(-Kc*Qo+1e-6)+Math.round(-Qc*Ho+1e-6),nd=Math.round(-od*Yo+1e-6),Eu=Math.round(-Tu*Yo+1e-6),Qa=Math.round(-Za*Yo+1e-6),wn=Math.round(-An*Yo+1e-6),$t=Math.round(-Sa*Wo+1e-6),Ks=Math.round(-Xs*Wo+1e-6),
ns=Math.round(-os*jo+1e-6),so=Math.round(-co*jo+1e-6),'cav'==es?(Zr=Math.round(-Jr*jo+1e-6),Wn=Math.round(-Yn*jo+1e-6),Fu=Math.round(-ju*jo+1e-6),ll=Math.round(-rl*jo+1e-6)):'inf'==es?(Zr=Math.round(-Jr*Yo+1e-6),Wn=Math.round(-Yn*Yo+1e-6),Fu=Math.round(-ju*Yo+1e-6),ll=Math.round(-rl*Yo+1e-6)):'arc'==es&&(Zr=Math.round(-Jr*Wo+1e-6),Wn=Math.round(-Yn*Wo+1e-6),Fu=Math.round(-ju*Wo+1e-6),ll=Math.round(-rl*Wo+1e-6)),Cc=100*Pc==Mr?0:Math.round(-Pc*Yo+1e-6),ld=od+nd,Au=Tu+Eu,Xa=Za+Qa,Ia=Sa+$t,ls=os+ns,Js=Xs+Ks,uo=co+so,$r=Jr+Zr,Hn=Yn+Wn,Yu=ju+Fu,yn=An+wn,zc=Pc+Cc,cl=rl+ll,fd=pd+dd,Nu=Ru+ku,rn=nn+tn,Pa=Oa+Ma,fs=ps+ds,rr=ir+ar,wo=ho+_o,cc=oc+nc,ni=$n+Xn,np=$u+Xu,Cn=Mn+xn,Hc=Fc+Vc,vl=_l+gl,Ms=nd*kt[0]+Eu*kt[1]+Qa*kt[2]+$t*kt[3]+ns*kt[4]+Ks*kt[5]+so*kt[6]+Zr*kt[7]+Wn*kt[8]+ll*kt[9]+Cc*kt[10]+Fu*kt[11]+wn*kt[12],console.log('lossesAttackerRound2Total'+Ms),Ns=dd*kt[0]+ku*kt[1]+tn*kt[2]+Ma*kt[3]+ds*kt[4]+ar*kt[5]+_o*kt[6]+nc*kt[7]+Xn*kt[8]+gl*kt[9]+Vc*kt[10]+Xu*kt[11]+xn*kt[12],
console.log('lossesDefenderRound2Total'+Ns),gu=ld*kt[0]+Au*kt[1]+Xa*kt[2]+Ia*kt[3]+ls*kt[4]+Js*kt[5]+uo*kt[6]+$r*kt[7]+Hn*kt[8]+Yu*kt[11]+yn*kt[12]+zc*kt[10]+cl*kt[9],console.log('survivorsAttackerRound2Total'+gu),fu=fd*kt[0]+Nu*kt[1]+rn*kt[2]+Pa*kt[3]+fs*kt[4]+rr*kt[5]+wo*kt[6]+cc*kt[7]+ni*kt[8]+np*kt[11]+Cn*kt[12]+Hc*kt[10]+vl*kt[9],console.log('survivorsDefenderRound2Total'+fu),Cr=ld*kt[0]+Au*kt[1]+Xa*kt[2]+Ia*kt[3]+ls*kt[4]+Js*kt[5]+uo*kt[6]+$r*kt[7]+Hn*kt[8]+cl*kt[9]+zc*kt[10]+Yu*kt[11]+yn*kt[12],Yr=fd*kt[0]+Nu*kt[1]+rn*kt[2]+Pa*kt[3]+fs*kt[4]+rr*kt[5]+wo*kt[6]+cc*kt[7]+ni*kt[8]+vl*kt[9]+Hc*kt[10]+np*kt[11]+Cn*kt[12],console.log('provisionDefenderRound3Total'+Yr),Tc=$r*kt[7]+Hn*kt[8]+Yu*kt[11]+cl*kt[9],'cav'==es?(xr=ls*kt[4]+uo*kt[6]+Tc,Lr=ld*kt[0]+Au*kt[1]+Xa*kt[2]+yn*kt[12]+zc*kt[10],Sr=Ia*kt[3]+Js*kt[5]):'inf'==es?(Lr=ld*kt[0]+Au*kt[1]+Xa*kt[2]+yn*kt[12]+zc*kt[10]+Tc,xr=ls*kt[4]+uo*kt[6],Sr=Ia*kt[3]+Js*kt[5]):'arc'==es?(Lr=ld*kt[0]+Au*kt[1]+Xa*kt[2]+yn*kt[12]+zc*kt[10],
xr=ls*kt[4]+uo*kt[6],Sr=Ia*kt[3]+Js*kt[5]+Tc):(Lr=ld*kt[0]+Au*kt[1]+Xa*kt[2]+yn*kt[12]+zc*kt[10],xr=ls*kt[4]+uo*kt[6],Sr=Ia*kt[3]+Js*kt[5]),Fs=0==Lr?0:Math.round(Lr/Cr*1e4)/1e4,qs=0==xr?0:Math.round(xr/Cr*1e4)/1e4,0==Sr?(Vs=0,console.log('lossesPercentRound3Arc'+Vs)):(Vs=Math.round(Sr/Cr*1e4)/1e4,console.log('lossesPercentRound3Arc'+Vs)),Ad=Math.round(fd*Fs),Td=Math.round(fd*qs),wd=fd-Td-Ad,Uu=Math.round(Nu*Fs),Bu=Math.round(Nu*qs),Gu=Nu-Bu-Uu,_n=Math.round(rn*Fs),mn=Math.round(rn*qs),gn=rn-mn-_n,Fa=Math.round(Pa*Fs),qa=Math.round(Pa*qs),Va=Pa-qa-Fa,As=Math.round(fs*Fs),Ts=Math.round(fs*qs),ws=fs-Ts-As,_r=Math.round(rr*Fs),mr=Math.round(rr*qs),gr=rr-mr-_r,xo=Math.round(wo*Fs),ko=Math.round(wo*qs),Io=wo-ko-xo,fc=Math.round(cc*Fs),_c=Math.round(cc*qs),mc=cc-_c-fc,di=Math.round(ni*Fs),ci=Math.round(ni*qs),ri=ni-ci-di,ed=Math.round(Hc*Fs),$c=Math.round(Hc*qs),Jc=Hc-$c-ed,dp=Math.round(np*Fs),cp=Math.round(np*qs),rp=np-cp-dp,Vn=Math.round(Cn*Fs),Un=Math.round(Cn*qs),Bn=Cn-Un-Vn,
Il=Math.round(vl*Fs),Sl=Math.round(vl*qs),yl=vl-Sl-Il,Fr=Ad*kt[0]+Uu*kt[1]+_n*kt[2]+Vn*kt[12]+ed*kt[10]+As*kt[4]+xo*kt[6]+Fa*kt[3]+_r*kt[5]+fc*kt[7]+di*kt[8]+dp*kt[11]+Il*kt[9],console.log('provisionDefenderInfRound3'+Fr),Ur=Td*kt[0]+Bu*kt[1]+mn*kt[2]+Un*kt[12]+$c*kt[10]+Ts*kt[4]+ko*kt[6]+qa*kt[3]+mr*kt[5]+_c*kt[7]+ci*kt[8]+cp*kt[11]+Sl*kt[9],console.log('provisionDefenderCavRound3'+Ur),zr=wd*kt[0]+Gu*kt[1]+gn*kt[2]+Bn*kt[12]+Jc*kt[10]+ws*kt[4]+Io*kt[6]+Va*kt[3]+gr*kt[5]+mc*kt[7]+ri*kt[8]+rp*kt[11]+yl*kt[9],console.log('provisionDefenderArcRound3'+zr),$d=Ad*a[0]*Yi[0]+Uu*a[1]*Zi[0]+_n*a[2]*Ti[0]+Vn*a[12]+ed*a[10]+As*a[4]*Ci[0]+xo*a[6]*Mi[0]+Fa*a[3]*bi[0]+_r*a[5]*Gi[0]+fc*a[7]*qi[0]+di*a[8]*Ii[0]+dp*a[11]+Il*a[9],Zd=Td*n[0]*Yi[0]+Bu*n[1]*Zi[0]+mn*n[2]*Ti[0]+Un*n[12]+$c*n[10]+Ts*n[4]*Ci[0]+ko*n[6]*Mi[0]+qa*n[3]*bi[0]+mr*n[5]*Gi[0]+_c*n[7]*qi[0]+ci*n[8]*Ii[0]+cp*n[11]+Sl*n[9],
Hd=wd*i[0]*Yi[0]+Gu*i[1]*Zi[0]+gn*i[2]*Ti[0]+Bn*i[12]+Jc*i[10]+ws*i[4]*Ci[0]+Io*i[6]*Mi[0]+Va*i[3]*bi[0]+gr*i[5]*Gi[0]+mc*i[7]*qi[0]+ri*i[8]*Ii[0]+rp*i[11]+yl*i[9],Sc=$r*s[7]*Nl[1]+Hn*s[8]*Rl[1]+Yu*s[11]+cl*s[9],'cav'==es?(Vd=ls*s[4]*Ll[1]+uo*s[6]*Ml[1]+Sc,Wd=ld*s[0]*Cl[1]+Au*s[1]*Dl[1]+Xa*s[2]*xl[1]+yn*s[12]*eo+zc*s[10],Gd=Ia*s[3]*kl[1]+Js*s[5]*Ol[1]):'inf'==es?(Wd=ld*s[0]*Cl[1]+Au*s[1]*Dl[1]+Xa*s[2]*xl[1]+yn*s[12]*eo+zc*s[10]+Sc,Vd=ls*s[4]*Ll[1]+uo*s[6]*Ml[1],Gd=Ia*s[3]*kl[1]+Js*s[5]*Ol[1]):'arc'==es?(Wd=ld*s[0]*Cl[1]+Au*s[1]*Dl[1]+Xa*s[2]*xl[1]+yn*s[12]*eo+zc*s[10],Vd=ls*s[4]*Ll[1]+uo*s[6]*Ml[1],Gd=Ia*s[3]*kl[1]+Js*s[5]*Ol[1]+Sc):(Wd=ld*s[0]*Cl[1]+Au*s[1]*Dl[1]+Xa*s[2]*xl[1]+yn*s[12]*eo+zc*s[10],Vd=ls*s[4]*Ll[1]+uo*s[6]*Ml[1],Gd=Ia*s[3]*kl[1]+Js*s[5]*Ol[1]),ru=$d*Er,ou=Zd*Er,au=Hd*Er,Dd=(Od=Wd*wr)+(Rd=Vd*wr)+(Id=Gd*wr),console.log('strengthAttackerRound3'+Dd),uu=ru+ou+au,console.log('strengthDefenderRound3'+uu),Hl=0==Od||0==ru?0:ru<=Od?1:Math.pow(Od/ru,.5)/(ru/Od),
Yl=0==Rd||0==ou?0:ou<=Rd?1:Math.pow(Rd/ou,.5)/(ou/Rd),jl=0==Id||0==au?0:au<=Id?1:Math.pow(Id/au,.5)/(au/Id),Wl=0==Od||0==ru?0:Od<=ru?1:Math.pow(ru/Od,.5)/(Od/ru),Fl=0==Rd||0==ou?0:Rd<=ou?1:Math.pow(ou/Rd,.5)/(Rd/ou),ql=0==Id||0==au?0:Id<=au?1:Math.pow(au/Id,.5)/(Id/au),Jo=Math.round(1e6*Wl)/1e6,Xo=Math.round(1e6*Fl)/1e6,Zo=Math.round(1e6*ql)/1e6,tl=Math.round(1e6*Hl)/1e6,el=Math.round(1e6*Yl)/1e6,$o=Math.round(1e6*jl)/1e6,ud=Math.round(-Ad*tl+1e-6)+Math.round(-Td*el+1e-6)+Math.round(-wd*$o+1e-6),xu=Math.round(-Uu*tl+1e-6)+Math.round(-Bu*el+1e-6)+Math.round(-Gu*$o+1e-6),an=Math.round(-_n*tl+1e-6)+Math.round(-mn*el+1e-6)+Math.round(-gn*$o+1e-6),La=Math.round(-Fa*tl+1e-6)+Math.round(-qa*el+1e-6)+Math.round(-Va*$o+1e-6),us=Math.round(-As*tl+1e-6)+Math.round(-Ts*el+1e-6)+Math.round(-ws*$o+1e-6),nr=Math.round(-_r*tl+1e-6)+Math.round(-mr*el+1e-6)+Math.round(-gr*$o+1e-6),fo=Math.round(-xo*tl+1e-6)+Math.round(-ko*el+1e-6)+Math.round(-Io*$o+1e-6),
ic=Math.round(-fc*tl+1e-6)+Math.round(-_c*el+1e-6)+Math.round(-mc*$o+1e-6),Jn=Math.round(-di*tl+1e-6)+Math.round(-ci*el+1e-6)+Math.round(-ri*$o+1e-6),Ju=Math.round(-dp*tl+1e-6)+Math.round(-cp*el+1e-6)+Math.round(-rp*$o+1e-6),Rn=Math.round(-Vn*tl+1e-6)+Math.round(-Un*el+1e-6)+Math.round(-Bn*$o+1e-6),ml=Math.round(-Il*tl+1e-6)+Math.round(-Sl*el+1e-6)+Math.round(-yl*$o+1e-6),qc=Math.round(-ed*tl+1e-6)+Math.round(-$c*el+1e-6)+Math.round(-Jc*$o+1e-6),id=Math.round(-ld*Jo+1e-6),wu=Math.round(-Au*Jo+1e-6),Ka=Math.round(-Xa*Jo+1e-6),Tn=Math.round(-yn*Jo+1e-6),ya=Math.round(-Ia*Zo+1e-6),Zs=Math.round(-Js*Zo+1e-6),is=Math.round(-ls*Xo+1e-6),ro=Math.round(-uo*Xo+1e-6),'cav'==es?(Xr=Math.round(-$r*Xo+1e-6),jn=Math.round(-Hn*Xo+1e-6),Wu=Math.round(-Yu*Xo+1e-6),sl=Math.round(-cl*Xo+1e-6)):'inf'==es?(Xr=Math.round(-$r*Jo+1e-6),jn=Math.round(-Hn*Jo+1e-6),Wu=Math.round(-Yu*Jo+1e-6),sl=Math.round(-cl*Jo+1e-6)):'arc'==es&&(Xr=Math.round(-$r*Zo+1e-6),jn=Math.round(-Hn*Zo+1e-6),Wu=Math.round(-Yu*Zo+1e-6),
sl=Math.round(-cl*Zo+1e-6)),Dc=100*zc==Lr?0:Math.round(-zc*Jo+1e-6),sd=ld+id,yu=Au+wu,Ja=Xa+Ka,ka=Ia+ya,ss=ls+is,$s=Js+Zs,po=uo+ro,ec=$r+Xr,Qn=Hn+jn,Hu=Yu+Wu,Sn=yn+Tn,Gc=zc+Dc,dl=cl+sl,Ed=fd+ud,zu=Nu+xu,pn=rn+an,Ua=Pa+La,Es=fs+us,pr=rr+nr,So=wo+fo,gc=cc+ic,si=ni+Jn,sp=np+Ju,Gn=Cn+Rn,Xc=Hc+qc,Al=vl+ml,Ls=id*kt[0]+wu*kt[1]+Ka*kt[2]+ya*kt[3]+is*kt[4]+Zs*kt[5]+ro*kt[6]+Xr*kt[7]+jn*kt[8]+sl*kt[9]+Dc*kt[10]+Wu*kt[11]+Tn*kt[12],console.log('lossesAttackerRound3Total'+Ls),Cs=ud*kt[0]+xu*kt[1]+an*kt[2]+La*kt[3]+us*kt[4]+nr*kt[5]+fo*kt[6]+ic*kt[7]+Jn*kt[8]+ml*kt[9]+qc*kt[10]+Ju*kt[11]+Rn*kt[12],console.log('lossesDefenderRound3Total'+Cs),mu=sd*kt[0]+yu*kt[1]+Ja*kt[2]+ka*kt[3]+ss*kt[4]+$s*kt[5]+po*kt[6]+ec*kt[7]+Qn*kt[8]+Hu*kt[11]+Sn*kt[12]+Gc*kt[10]+dl*kt[9],console.log('survivorsAttackerRound3Total'+mu),hu=Ed*kt[0]+zu*kt[1]+pn*kt[2]+Ua*kt[3]+Es*kt[4]+pr*kt[5]+So*kt[6]+gc*kt[7]+si*kt[8]+sp*kt[11]+Gn*kt[12]+Xc*kt[10]+Al*kt[9],console.log('survivorsDefenderRound3Total'+hu),td=-qt+sd,bu=-Wt+yu,
Ya=-r+Ja,Xt=-o+ka,ts=-Ot+ss,Hs=-Dt+$s,oo=-xt+po,Qr=-Gt+ec,qn=-p+Qn,Vu=-Yt+Hu,vn=-d+Sn,Oc=-Ut+Gc,il=-Mt+dl,rd=-Ft+Ed,Su=-jt+zu,$a=-c+pn,xa=-l+Ua,rs=-Nt+Es,er=-Pt+pr,go=-Rt+So,tc=-Bt+gc,Kn=-g+si,Ku=-Ht+sp,In=-u+Gn,Bc=-Vt+Xc,ul=-Lt+Al,Ec=0==ec?0:ec*wr*zo[1],Lo=20==gp?18:19==gp?17:18==gp?15:17==gp?14:16==gp?13:15==gp?11:14==gp?10:13==gp||12==gp?9:11==gp?8:10==gp?7:9==gp||8==gp?6:7==gp||6==gp?5:5==gp||4==gp||3==gp?4:2==gp||1==gp?3:0,hc=0==hn?0:2*Lo,bc=0==Ec||0==hc?0:-Ec/hc,io=gp<=Lc?gp:gp-Lc<-bc?gp<Lc?gp:Lc:gp+bc,Zt=Math.round(io),m='wall'==_i?Zt:parseInt(document.getElementById('buildingLevel').value),gi=0==Qn||0==m?0:Qn*wr*Rl[1],
Ro='headquarter'==_i?30==m?72:29==m?65:28==m?59:27==m?54:26==m?50:25==m?45:24==m?41:23==m?36:22==m?33:21==m?30:20==m?27:19==m?26:18==m?23:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'wall'==_i?20==Zt?18:19==Zt?17:18==Zt?15:17==Zt?14:16==Zt?13:15==Zt?11:14==Zt?10:13==Zt||12==Zt?9:11==Zt?8:10==Zt?7:9==Zt||8==Zt?6:7==Zt||6==Zt?5:5==Zt||4==Zt||3==Zt?4:2==Zt||1==Zt?3:0:'tavern'==_i?15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'hospital'==_i?10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'satue'==_i?5==m||4==m||3==m?4:2==m||1==m?3:0:'rally_point'==_i?5==m||4==m||3==m?4:2==m||1==m?3:0:'church'==_i?3==m||2==m||1==m?800:0:'academy'==_i?1==m?500:0:'preceptory'==_i?10==m?71:9==m?43:8==m?39:7==m?35:6==m?32:5==m?29:4==m?27:3==m?24:2==m?22:1==m?20:0:'barracks'==_i?25==m?30:24==m?27:23==m?24:22==m?22:21==m?20:20==m?18:19==m?17:18==m?15:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'market'==_i?25==m?30:24==m?27:23==m?24:22==m?22:21==m?20:20==m?18:19==m?17:18==m?15:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'warehouse'==_i?30==m?48:29==m?43:28==m?39:27==m?36:26==m?33:25==m?30:24==m?27:23==m?24:22==m?22:21==m?20:20==m?18:19==m?17:18==m?15:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'timber_camp'==_i?30==m?48:29==m?43:28==m?39:27==m?36:26==m?33:25==m?30:24==m?27:23==m?24:22==m?22:21==m?20:20==m?18:19==m?17:18==m?15:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'clay_pit'==_i?30==m?48:29==m?43:28==m?39:27==m?36:26==m?33:25==m?30:24==m?27:23==m?24:22==m?22:21==m?20:20==m?18:19==m?17:18==m?15:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'iron_mine'==_i?30==m?48:29==m?43:28==m?39:27==m?36:26==m?33:25==m?30:24==m?27:23==m?24:22==m?22:21==m?20:20==m?18:19==m?17:18==m?15:17==m?14:16==m?13:15==m?11:14==m?10:13==m||12==m?9:11==m?8:10==m?7:9==m||8==m?6:7==m||6==m?5:5==m||4==m||3==m?4:2==m||1==m?3:0:'farm'==_i?30==m?79:29==m?72:28==m?66:27==m?60:26==m?54:25==m?49:24==m?45:23==m?41:22==m?37:21==m?34:20==m?31:19==m?28:18==m?25:17==m?23:16==m?21:15==m?19:14==m?17:13==m?16:12==m?14:11==m?13:10==m?12:9==m?11:8==m?10:7==m?9:6==m?8:5==m||4==m?7:2==m||3==m?6:1==m?5:0:0,
ui=0==m?0:Ro*Er,pi=0==gi||0==ui?0:-gi/ui,no='wall'==_i?io<=Lc?io:io-Lc<-pi?io<Lc?io:Lc:io+pi:pi+m<=0?0:pi+m,Kt=Math.round(no),Ws=td*kt[0]+bu*kt[1]+Ya*kt[2]+Xt*kt[3]+ts*kt[4]+Hs*kt[5]+oo*kt[6]+Qr*kt[7]+qn*kt[8]+il*kt[9]+Oc*kt[10]+Vu*kt[11]+vn*kt[12],js=rd*kt[0]+Su*kt[1]+$a*kt[2]+xa*kt[3]+rs*kt[4]+er*kt[5]+go*kt[6]+tc*kt[7]+Kn*kt[8]+ul*kt[9]+Bc*kt[10]+Ku*kt[11]+In*kt[12],vp=rd*t[0]+Su*t[1]+$a*t[2]+xa*t[3]+rs*t[4]+er*t[5]+go*t[6]+tc*t[7]+Kn*t[8]+ul*t[9]+Bc*t[10]+Ku*t[11]+In*t[12],Ep=td*e[0]+bu*e[1]+Ya*e[2]+Xt*e[3]+ts*e[4]+Hs*e[5]+oo*e[6]+Qr*e[7]+qn*e[8]+il*e[9]+Oc*e[10]+Vu*e[11]+vn*e[12],al=0==ja||0==Ws?0:Math.round(-Ws/ja*1e3)/1e3,yp='inf'==es?'piechota':'cav'==es?'kawaleria':'łucznicy',Sp='inf'==(wp=Ft+jt+c+u>Nt+Rt&&Ft+jt+c+u>l+Pt?'inf':Nt+Rt>Ft+jt+c+u&&Nt+Rt>l+Pt?'cav':'arc')?'piechota':'cav'==wp?'kawaleria':'łucznicy',nl=0==fi||0==js?0:Math.round(-js/fi*1e3)/1e3,Cp=Math.round(td*(fr+Mc)),Dp=Math.round(bu*(fr+Mc)),Pp=Math.round(Ya*(fr+Mc)),zp=Math.round(Xt*(fr+Mc)),
Gp=Math.round(ts*(fr+Mc)),Bp=Math.round(Hs*(fr+Mc)),Up=Math.round(oo*(fr+Mc)),Vp=Math.round(Qr*(fr+Mc)),qp=Math.round(qn*(fr+Mc)),Fp=Math.round(Oc*(fr+Mc)),Wp=Math.round(il*(fr+Mc)),jp=Math.round(Vu*(fr+Mc)),Yp=Math.round(vn*(fr+Mc)),Hp=Oo+Rc,0==Oo?(kp=0,xp=0,Rp=0,Mp=0,Lp=0,Op=0,Np=0):Oo<1e3?Hp<=(xa+rd+Su+$a)/2?(kp=Math.round(rd/2),xp=Math.round(Su/2),Rp=Math.round($a/2),Mp=Math.round(xa/2),Lp=0,Op=0,Np=0):(kp=Math.round(rd*Hp/(xa+rd+Su+$a)),xp=Math.round(Su*Hp/(xa+rd+Su+$a)),Rp=Math.round($a*Hp/(xa+rd+Su+$a)),Mp=Math.round(xa*Hp/(xa+rd+Su+$a)),Lp=0,Op=0,Np=0):Hp<=(xa+rd+Su+$a+4*rs+5*er+6*go)/2?(kp=Math.round(rd/2),xp=Math.round(Su/2),Rp=Math.round($a/2),Mp=Math.round(xa/2),Lp=Math.round(rs/2),Op=Math.round(er/2),Np=Math.round(go/2)):(kp=Math.round(rd*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),xp=Math.round(Su*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Rp=Math.round($a*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Mp=Math.round(xa*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Lp=Math.round(rs*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),
Op=Math.round(er*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go)),Np=Math.round(go*Hp/(xa+rd+Su+$a+4*rs+5*er+6*go))),Tp=ja+Ws,Ap=fi+js,L.html(qt),O.html(-td),N.html(-Cp),C.html(sd),D.html(Wt),P.html(-bu),z.html(-Dp),G.html(yu),B.html(r),U.html(-Ya),V.html(-Pp),q.html(Ja),F.html(o),W.html(-Xt),j.html(-zp),Y.html(ka),H.html(Ot),Q.html(-ts),K.html(-Gp),Z.html(ss),X.html(Dt),J.html(-Hs),$.html(-Bp),ee.html($s),te.html(xt),ae.html(-oo),ne.html(-Up),ie.html(po),oe.html(Gt),le.html(-Qr),se.html(-Vp),re.html(ec),ce.html(p),de.html(-qn),ue.html(-qp),pe.html(Qn),ge.html(Ut),me.html(-Oc),_e.html(-Fp),fe.html(Gc),he.html(Mt),be.html(-il),ve.html(-Wp),Ee.html(dl),we.html(Yt),Te.html(-Vu),Ae.html(-jp),ye.html(Hu),Se.html(d),Ie.html(-vn),ke.html(-Yp),xe.html(Sn),Re.html(Ft),Me.html(-rd),Le.html(kp),Oe.html(Ed),Ne.html(jt),Ce.html(-Su),De.html(xp),Pe.html(zu),ze.html(c),Ge.html(-$a),Be.html(Rp),Ue.html(pn),Ve.html(l),qe.html(-xa),Fe.html(Mp),We.html(Ua),je.html(Nt),Ye.html(-rs),He.html(Lp),Qe.html(Es),Ke.html(Pt),
Ze.html(-er),Xe.html(Op),Je.html(pr),$e.html(Rt),et.html(-go),tt.html(Np),at.html(So),nt.html(Bt),it.html(-tc),ot.html(0),lt.html(gc),st.html(g),rt.html(-Kn),ct.html(0),dt.html(si),ut.html(Vt),pt.html(-Bc),gt.html(0),mt.html(Xc),_t.html(Lt),ft.html(-ul),ht.html(0),bt.html(Al),vt.html(Ht),Et.html(-Ku),wt.html(0),Tt.html(sp),At.html(u),yt.html(-In),St.html(0),It.html(Gn),_.html(100*wr),f.html(ja),fa.html(-Ws),ha.html(Tp),ba.html(-js),va.html(Ap),Ea.html(eo),wa.html(Hp),Ta.html(yp),Aa.html(Sp),h.html(-vp),b.html(100*al),v.html(Nd),E.html(100*Er),w.html(fi),T.html(-Ep),A.html(100*nl),y.html(cu),S.html(Qt),I.html(gp),k.html(gp),x.html(Zt),_a.html(Ip),R.html(m),M.html(Kt)})),xt.on('click',(function(){document.getElementById('spearA').value=parseInt(document.getElementById('spearA-survived').innerHTML),document.getElementById('swordA').value=parseInt(document.getElementById('swordA-survived').innerHTML),
...
(void 0).target=e}))},sn=function(e){d.selectedTab=e},rn=function(){const e=i.getSelectedVillage().data;(void 0).origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:(void 0).getId()}};const cn={autoCompleteSelected:function(e,t,a,n){if('battleCalculator_village_search'!==t)return!1;(void 0)[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},d.searchQuery[n]=''},onAutoCompleteOrigin:function(e){(void 0).origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){(void 0).target={id:e.id,x:e.x,y:e.y,name:e.name}},start:function(e,t){if(d.running=n.isRunning(),t.disableNotif)return!1;an(),r.notif('success',g('i18n')('calculated',a.loc.ale,'battle_calculator'))}},dn=function(){d=a.$new(),d.selectedTab=m.BATTLE,d.TAB_TYPES=m,d.running=n.isRunning(),d.selectTab=sn,d.addSelected=rn,d.addMapSelected=ln,d.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'battle_calculator'),onEnter:cn.onAutoCompleteTarget,
tooltip:g('i18n')('add_target',a.loc.ale,'battle_calculator'),dropDown:!0},d.searchQuery={target:''},kt=(void 0).find('.item-simulate span'),xt=(void 0).find('.item-insert span'),Rt=(void 0).find('.item-insertV span'),Mt=(void 0).find('.item-insertP span'),Lt=(void 0).find('.item-insertVD span'),Ot=(void 0).find('.item-insertPD span'),Nt=(void 0).find('.item-check span'),Ct=(void 0).find('.points-att'),Dt=(void 0).find('.points-def'),Pt=(void 0).find('.item-check-T span'),zt=(void 0).find('.wood'),Gt=(void 0).find('.clay'),Bt=(void 0).find('.iron'),Ut=(void 0).find('.food'),Vt=(void 0).find('.attack'),qt=(void 0).find('.attackinf'),Ft=(void 0).find('.attackcav'),Wt=(void 0).find('.attackarc'),jt=(void 0).find('.definf'),Yt=(void 0).find('.defcav'),Ht=(void 0).find('.defarc'),Qt=(void 0).find('.speed'),Kt=(void 0).find('.load'),Zt=(void 0).find('.discipline'),Xt=(void 0).find('.buildtime'),Jt=(void 0).find('.dataTraining'),$t=(void 0).find('.dataOrder'),
ea=(void 0).find('.beliefAttacker'),ta=(void 0).find('.beliefDefender'),aa=(void 0).find('.dataMaster'),na=(void 0).find('.dataWalls'),ia=(void 0).find('.dataClinique'),oa=(void 0).find('.dataHospital'),la=(void 0).find('.catapultTarget'),sa=(void 0).find('.dataEquip1'),ra=(void 0).find('.dataEquip2'),ca=(void 0).find('.dataEquip3'),da=(void 0).find('.dataEquip4'),ua=(void 0).find('.dataLevel1'),pa=(void 0).find('.dataLevel2'),ga=(void 0).find('.dataLevel3'),ma=(void 0).find('.dataLevel4'),L=(void 0).find('.spearA-amount'),O=(void 0).find('.spearA-losses'),N=(void 0).find('.spearA-revived'),C=(void 0).find('.spearA-survived'),D=(void 0).find('.swordA-amount'),P=(void 0).find('.swordA-losses'),z=(void 0).find('.swordA-revived'),G=(void 0).find('.swordA-survived'),B=(void 0).find('.axeA-amount'),U=(void 0).find('.axeA-losses'),V=(void 0).find('.axeA-revived'),q=(void 0).find('.axeA-survived'),F=(void 0).find('.archerA-amount'),W=(void 0).find('.archerA-losses'),
j=(void 0).find('.archerA-revived'),Y=(void 0).find('.archerA-survived'),H=(void 0).find('.lcA-amount'),Q=(void 0).find('.lcA-losses'),K=(void 0).find('.lcA-revived'),Z=(void 0).find('.lcA-survived'),X=(void 0).find('.maA-amount'),J=(void 0).find('.maA-losses'),$=(void 0).find('.maA-revived'),ee=(void 0).find('.maA-survived'),te=(void 0).find('.hcA-amount'),ae=(void 0).find('.hcA-losses'),ne=(void 0).find('.hcA-revived'),ie=(void 0).find('.hcA-survived'),oe=(void 0).find('.ramA-amount'),le=(void 0).find('.ramA-losses'),se=(void 0).find('.ramA-revived'),re=(void 0).find('.ramA-survived'),ce=(void 0).find('.catapultA-amount'),de=(void 0).find('.catapultA-losses'),ue=(void 0).find('.catapultA-revived'),pe=(void 0).find('.catapultA-survived'),ge=(void 0).find('.snobA-amount'),me=(void 0).find('.snobA-losses'),_e=(void 0).find('.snobA-revived'),fe=(void 0).find('.snobA-survived'),he=(void 0).find('.knightA-amount'),be=(void 0).find('.knightA-losses'),ve=(void 0).find('.knightA-revived'),
Ee=(void 0).find('.knightA-survived'),we=(void 0).find('.trebuchetA-amount'),Te=(void 0).find('.trebuchetA-losses'),Ae=(void 0).find('.trebuchetA-revived'),ye=(void 0).find('.trebuchetA-survived'),Se=(void 0).find('.berserkerA-amount'),Ie=(void 0).find('.berserkerA-losses'),ke=(void 0).find('.berserkerA-revived'),xe=(void 0).find('.berserkerA-survived'),Re=(void 0).find('.spearD-amount'),Me=(void 0).find('.spearD-losses'),Le=(void 0).find('.spearD-revived'),Oe=(void 0).find('.spearD-survived'),Ne=(void 0).find('.swordD-amount'),Ce=(void 0).find('.swordD-losses'),De=(void 0).find('.swordD-revived'),Pe=(void 0).find('.swordD-survived'),ze=(void 0).find('.axeD-amount'),Ge=(void 0).find('.axeD-losses'),Be=(void 0).find('.axeD-revived'),Ue=(void 0).find('.axeD-survived'),Ve=(void 0).find('.archerD-amount'),qe=(void 0).find('.archerD-losses'),Fe=(void 0).find('.archerD-revived'),We=(void 0).find('.archerD-survived'),je=(void 0).find('.lcD-amount'),Ye=(void 0).find('.lcD-losses'),
He=(void 0).find('.lcD-revived'),Qe=(void 0).find('.lcD-survived'),Ke=(void 0).find('.maD-amount'),Ze=(void 0).find('.maD-losses'),Xe=(void 0).find('.maD-revived'),Je=(void 0).find('.maD-survived'),$e=(void 0).find('.hcD-amount'),et=(void 0).find('.hcD-losses'),tt=(void 0).find('.hcD-revived'),at=(void 0).find('.hcD-survived'),nt=(void 0).find('.ramD-amount'),it=(void 0).find('.ramD-losses'),ot=(void 0).find('.ramD-revived'),lt=(void 0).find('.ramD-survived'),st=(void 0).find('.catapultD-amount'),rt=(void 0).find('.catapultD-losses'),ct=(void 0).find('.catapultD-revived'),dt=(void 0).find('.catapultD-survived'),ut=(void 0).find('.snobD-amount'),pt=(void 0).find('.snobD-losses'),gt=(void 0).find('.snobD-revived'),mt=(void 0).find('.snobD-survived'),_t=(void 0).find('.knightD-amount'),ft=(void 0).find('.knightD-losses'),ht=(void 0).find('.knightD-revived'),bt=(void 0).find('.knightD-survived'),vt=(void 0).find('.trebuchetD-amount'),Et=(void 0).find('.trebuchetD-losses'),
wt=(void 0).find('.trebuchetD-revived'),Tt=(void 0).find('.trebuchetD-survived'),At=(void 0).find('.berserkerD-amount'),yt=(void 0).find('.berserkerD-losses'),St=(void 0).find('.berserkerD-revived'),It=(void 0).find('.berserkerD-survived'),_=(void 0).find('.attackModifier'),f=(void 0).find('.attackProvisions'),h=(void 0).find('.attackBashpoint'),b=(void 0).find('.killrateA'),v=(void 0).find('.strentghAttack'),E=(void 0).find('.defenceModifier'),w=(void 0).find('.defenceProvisions'),T=(void 0).find('.defenceBashpoint'),A=(void 0).find('.killrateD'),y=(void 0).find('.strentghDefend'),S=(void 0).find('.wallfrompre'),I=(void 0).find('.walltopre'),k=(void 0).find('.wallfrom'),x=(void 0).find('.wallto'),_a=(void 0).find('.target'),R=(void 0).find('.buildingfrom'),M=(void 0).find('.buildingto'),fa=(void 0).find('.attackKilledProvisions'),ha=(void 0).find('.attackSurvivedProvisions'),ba=(void 0).find('.defenceKilledProvisions'),va=(void 0).find('.defenceSurvivedProvisions'),
Ea=(void 0).find('.doubleStrength'),wa=(void 0).find('.availableBeds'),Ta=(void 0).find('.strongestTypeOff'),Aa=(void 0).find('.strongestTypeDef'),(void 0).register(s.SELECT_SELECTED,cn.autoCompleteSelected,!0),(void 0).register(s.BATTLE_CALCULATOR_START,cn.start),(void 0).register(s.BATTLE_CALCULATOR_STOP,cn.stop),(void 0).register(s.COMMAND_QUEUE_START,cn.start),c.getScreenWithInjectedScope('!twoverflow_queue_window',d)};return function(){u=e.addMenuButton('Kalkulator',170),u.addEventListener('click',dn),o.register(s.BATTLE_CALCULATOR_START,(function(){u.classList.remove('btn-orange'),u.classList.add('btn-red')})),o.register(s.BATTLE_CALCULATOR_STOP,(function(){u.classList.remove('btn-red'),u.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,nn),a.$on(s.DESTROY_CONTEXT_MENU,on),
