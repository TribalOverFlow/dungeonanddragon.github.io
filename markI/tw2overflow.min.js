...
doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz"},spy_recruiter:{title:"Szpieg",description:"Automatycznie rekrutuje szpiegów jesli brak na wioskach.",activated:"Szpieg aktywowany",deactivated:"Szpieg skończył działanie",revived:"Szpiedzy dodani do kolejki rekrutacji"},support_sender:{title:"Chorąży",support:"Wsparcia","support.merge":"Ustwienia działają oddzielnie jak również razem: prowincja+grupa, grupa+dystans","support.all":"Jeśli nie wybrałeś grupy, prowincji oraz dystansu nastąpi wysyłanie z wszystkich wiosek w których znajdują się wskazane jednostki","support.byprovince":"Wyślij wsparcia tylko z wybranej prowincji","support.bygroup":"Wyślij wsparcia tylko z wybranej grupy wiosek","support.bydistance":"Wyślij wsparcia tylko z pobliskich wiosek","support.add_village":"Wybierz wioskę...","support.no_village":"Nie wybrano wioski","support.add_map_selected":"Wybrana wioska z mapy","support.selected":"Wybierz","support.group":"Grupa/y",
"support.preset":"Szablon","support.textpreset":"Lub wybierz szablon z którego zostaną pobrane ilości jednostek defensywnych","support.distance":"Dystans do wspieranej wioski","support.spear":"Pikinierzy","support.sword":"Miecznicy","support.archer":"Łucznicy","support.heavycavalry":"Ciężka Kawaleria","support.trebuchet":"Trebusze","support.start":"Start","support.pause":"Pauza","support.clear":"Wyczyść",logs:"Logi","logs.origin":"Wioska Źródłowa","logs.target":"Wioska Cel","logs.unit":"Jednostka","logs.amount":"Ilość","logs.date":"Data","logs.noSupports":"Nie wysłano żadnych wsparć.","logs.clear":"Wyczyść logi"},common:{start:"Start",started:"Uruchomiony",pause:"Pauza",paused:"Wstrzymany",stop:"Zatrzymany",stopped:"Zatrzymany",status:"Status",none:"Żaden",info:"Informacje",settings:"Ustawienia",others:"Inne",village:"Wioska",villages:"Wioski",building:"Budynek",buildings:"Budynki",level:"Poziom",registers:"Rejestry",filters:"Filtry",add:"Dodaj",waiting:"Oczekujące",attack:"Atak",
support:"Wsparcie",relocate:"Przeniesienie",activate:"Aktywuj",deactivate:"Wyłącz",units:"Jednostki",officers:"Oficerowie",origin:"Źródło",target:["Cel","Cele"],save:"Zapisz",logs:"Logi","no-results":"Brak wyników...",selected:"Wybrana",now:"Teraz",costs:"Koszty",duration:"Czas",points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",
axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}},pl_pl:{about:{contact:"Kontakt",version:"Tw2Master v3.00(baza tw2overflow v2.0.0)",email:"Email",edit:"Od Edytora",editor:"Edytował",edit_autor:"DirtyPrank/Dr Doom/NewPope",text:"Życzę miłej zabawy z Tribal Wars 2 :)",close:"Zamknij",links:"Linki projektów",autor:"Autor",source_autor:"Relaxeaza",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia",donate:"Jeśli wesprzesz mnie donacją $, mogę stworzyć indywidualne skrypty dla ciebie."},activity_tool:{title:"Kwatermistrz"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},army_helper:{
title:"Administrator",presets:"Szablony","presets.asign":"Przypisz","presets.all":"Wszystkie szablony","presets.textall":"Przypisz wszystkie szablony do wszystkich wiosek.","presets.name":"Szablony z nazwą","presets.textname":"Przypisz szablony zawierające wskazaną frazę do wszystkich wiosek.","presets.or":"Lub wybierz z listy","presets.group":"Szablony do grupy","presets.textgroup":"Przypisz wszystkie szablony do wybranej grupy wiosek.","presets.name-group":"Szablony - zaawansowane przypisywanie","presets.textname-group":"Przypisz szablony zawierające wskazaną fraze do wybranej grupy wiosek.","presets.name-placeholder":"Wpisz frazę",army:"Wojsko","army.header":"Sprawdź ilość jednostek w wioskach","army.check":"Zlicz","army.troops":"Wojsko","army.unit":"Jednostka","army.available":"Dostępne","army.own":"Posiadane","army.in-town":"W wioskach","army.support":"Wsparcie","army.recruiting":"Rekrutacja","army.total":"Wszystko","army.deffensive":"Defensywne jednostki",
...
"commands.tooltip.bunker":"Zabunkruj wioske z wojsk znajdujących się na najbliższych twoich wioskach które zdążą przed atakiem. Uwaga! robisz to na własną odpowiedzialność.","commands.tooltip.spy":"Szpieguj wioske źródłową.","commands.tooltip.withdraw":"Wycofaj wszystkie wsparcia sekundę przed wejsciem tego ataku."},auto_collector:{title:"Kolekcjoner",description:"Automatyczny kolekcjoner depozytu/drugiej wioski.",activated:"Kolekcjoner aktywowany",deactivated:"Kolekcjoner deaktywowany"},auto_foundator:{title:"Fundator",description:"Automatycznie wykonuje darowizny na plemie co jedną godzinę 2% z wszystkich wiosek.",activated:"Fundator aktywowany",deactivated:"Fundator skończył działanie"},auto_healer:{title:"Medyk",description:"Automatycznie przywraca uzdrowione jednostki ze szpitala.",activated:"Medyk aktywowany",deactivated:"Medyk skończył działanie"},auto_withdraw:{title:"Dezerter",
description:"Automatycznie wycofuje wojska przed nadchodzącymi atakami jeśli to nie szlachcic lub trebuchet.",activated:"Dezerter aktywowany",deactivated:"Dezerter skończył działanie"},battle_calculator:{title:"Kalkulator",battle:"Bitwa","battle.simulate":"Symuluj","battle.predamage":"Uszkodzenia wstępne","battle.bonuses":"Modyfikatory bitewne","battle.options":"Szybkie opcje","battle.header":"Kalkulator bitewny","battle.id":"Wioska","battle.killrateA":"Procent strat","battle.attackBashpoint":"Ofensywne punkty bojowe","battle.strentghAttack":"Siła bojowa off","battle.killrateD":"Procent strat","battle.defenceBashpoint":"Defensywne punkty bojowe","battle.strentghDefend":"Siła bojowa deff","battle.attackModifier":"Modyfikator ataku","battle.defenceModifier":"Modyfikator obrony","battle.provisions":"Całkowity prowiant","battle.killedprovisions":"Prowiant stracony","battle.doublestrength":"Szał berków?","battle.strongesttype":"Najwięcej wojsk typu",
"battle.beds":"Liczba łóżek - uratowanych jednostek","battle.survivedprovisions":"Prowiant ocalały","battle.attacker":"Atakujący","battle.unit":"Jednostka","battle.amount":"Ilość","battle.loses":"Straty","battle.revived":"Uleczone","battle.survivors":"Ocalałe","battle.survivorsA":"Ocalałe(z uratowanymi)","battle.survivorsD":"Ocalałe(bez uratowanych)","battle.defender":"Obrońca","battle.damage":"Uszkodzenia taranów","battle.damageCatapult":"Uszkodzenia katapult","battle.downgrade":"Mur uszkodzony z poziomu ","battle.downgradeCatapult":" uszkodzony/a z poziomu ","battle.to":" do ","battle.insert":"Wstaw ocalałe jednostki","battle.insertvillage":"Wstaw z wioski","battle.insertpreset":"Wstaw z szablonu","battle.insertV":"Wstaw jednostki z wioski - atakujący","battle.insertP":"Wstaw jednostki z szablonu - atakujący","battle.insertVD":"Wstaw jednostki z wioski - broniący","battle.insertPD":"Wstaw jednostki z szablonu - broniący","battle.faith":"Wiara","battle.morale":"Morale",
"battle.luck":"Szczęście","battle.wall":"Mury","battle.nightbonus":"Bonus nocny","battle.leader":"Wielki mistrz","battle.medic":"Medyk","battle.doctor":"Doktor","battle.attack-bonus":"Mistrzostwo broni","battle.iron-walls":"Żelazny mur","battle.clinique":"Klinika","battle.hospital":"Szpital","battle.equip":"Przedmioty rycerza","battle.halberd":"Halabarda Guan Yu","battle.longsword":"Długi miecz Paracelsusa","battle.battleaxe":"Bojowy topór Thorgarda","battle.longbow":"Łuk Nimroda","battle.lance":"Lanca Mieszka","battle.compositebow":"Kompozytowy łuk Nimroda","battle.banner":"Chorągiew Baptystów","battle.star":"Gwiazda poranna Karola","battle.bonfire":"Pochodnia Alethei","battle.scepter":"Berło Vasca","battle.target":"Cel katapult","battle.target-level":"Poziom budynku",bunker:"Bunkier","bunker.header":"Kalkulator optymalnego offa na bunkier",troops:"Koszt jednostek","troops.calculate":"Policz","troops.header":"Kalkulator kosztów produkcji jednostek","troops.th":"Koszty produkcji",
"troops.units":"Jednostki","troops.building":"Budynki","troops.barracks":"Koszary","troops.preceptory":"Komturia","troops.effects":"Efekty","troops.domination":"Dominacja","troops.training":"Intensywny trening","troops.order":"Zakon","troops.templars":"Zakon Templariuszy","troops.teutonic":"Zakon Krzyżacki","troops.none":"Brak","troops.wood":"Drewno","troops.iron":"Żelazo","troops.clay":"Glina","troops.food":"Prowiant","troops.attack":"Siła ataku","troops.load":"Ładowność","troops.buildtime":"Czas rekrutacji","troops.defarc":"Obrona przeciw łucznikom","troops.definf":"obrona przeciw piechocie","troops.defcav":"Obrona przeciw kawaleri","troops.attackarc":"Siła ataku łuczników","troops.attackinf":"Siła ataku piechoty","troops.attackcav":"Siła ataku kawaleri","troops.discipline":"Dyscyplina","troops.speed":"Prędkość",bashpoints:"Punkty Bojowe","bashpoints.calculate":"Policz","bashpoints.header":"Kalkulator punktów bojowych","bashpoints.th":"Punkty bojowe",
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,T,b,f){let E,_,w=!1,h=injector.get('overviewService'),S=[],v=!1,A={},y={},R={reverse:!1,column:i.TIME_COMPLETED};const k='attack_view_filters',x={},I={},O=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in A[e[t]])if(a[e[t]]||(a[e[t]]=[]),A[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=A[c.VILLAGE]?[t]:[]},N=function(){B.loadCommands()},L=function(e,t){f.trigger(l.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){
for(let e=0;e<S.length;e++)S[e].command_id===t.command_id&&S.splice(e,1);f.trigger(l.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},G=function(e,t){for(let e=0;e<S.length;e++)S[e].target_village_id===t.village_id?(S[e].target_village_name=t.name,S[e].targetVillage.name=t.name):S[e].origin_village_id===t.village_id&&(S[e].origin_village_name=t.name,S[e].originVillage.name=t.name);f.trigger(l.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],B.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},C=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},D=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let s,l=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])}));const r=l.filter((function(e){return null===e.character_id&&e.id>0})),c=l.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)s=C(r,e);else if(c.length)s=C(c,e);else{if(!i)return t(!1);{const a=l.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);s=C(a,e)}}return t(s[0])}const i=T.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&D(e,t)}))},U=function(e){S=e.commands;for(let e=0;e<S.length;e++)h.formatCommand(S[e]),S[e].slowestUnit=z(S[e]);S=S.filter((function(e){return A[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(l.ATTACK_VIEW_COMMANDS_LOADED,[S])};let B={loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:R.column,reverse:R.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return S},getFilters:function(){return A},getSortings:function(){return R},toggleFilter:function(e,t){t?A[e][t]=!A[e][t]:A[e]=!A[e],O(),g.set(k,A),B.loadCommands()},toggleSorting:function(e){e===R.column?R.reverse=!R.reverse:(R.column=e,R.reverse=!1),B.loadCommands()},setCommander:function(e,a){D(e.targetVillage,(function(i){const n=e.targetVillage,o=i,s=o.character_id?r.SUPPORT:r.ATTACK;let l={};t.each(u,(function(e){l[e]='*'})),v.addCommand(n,o,a,_.OUT,l,{},s,p.WALL),v.isRunning()||v.start()}))},commandQueueEnabled:function(){return!!v},isInitialized:function(){return w},init:function(){for(let e=0;e<d.length;e++)x[d[e]]=!0;for(let e in r)I[r[e]]=!0;try{v=require('two/commandQueue'),_=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(I),
[c.INCOMING_UNITS]:angular.copy(x),[c.VILLAGE]:!1};w=!0,E=n.getSelectedCharacter().getGlobalInfo(),A=g.get(k,t,!0),e((function(){O(),a.$on(l.COMMAND_INCOMING,N),a.$on(l.COMMAND_CANCELLED,L),a.$on(l.MAP_SELECTED_VILLAGE,M),a.$on(l.VILLAGE_NAME_CHANGED,G),a.$on(l.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(l,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,s,d,u,T,b,f,E,_){let w,h;const S=function(){return Date.now()/1e3},v=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},A=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},y=function(){let e=_('#two-attack-view').parent(),t=_('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},R=function(){const e=w.pagination.offset,t=w.pagination.limit
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);R()},x=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},I=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},O=function(){w.commands=t.getCommands()},N=function(){w.selectedVillageId=n.getSelectedVillage().getId()},L=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=b,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=T,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=S,w.copyTimeModal=v,w.removeTroops=A,w.switchWindowSize=y,
w.toggleFilter=x,w.toggleSorting=I,R();let e=new i('twoverflow_queue_window',(function(){E.timer.remove(k)}));e.register(l.MAP_SELECTED_VILLAGE,N,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,O),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,O),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,O),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,O),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),E.timer.add(k)};return function(){h=e.addMenuButton('Strażnik',30),h.addEventListener('click',L),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,b,f,E){let _,w,h,S=injector.get('buildingService'),v=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const k={};let x,I,O,N,L,P=!0;const G='builder_queue_log',M='builder_queue_settings',z=function(){const e=D();if(!P)return j.stop(),!1;e.forEach((function(e){const t=I.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},C=function(){D().forEach((function(e){const t=I.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
A.canBeFinishedForFree(a,t)&&v.instantBuild(a,T.MASS_SCREEN,!0,e)}))}}))},D=function(){const e=L[r.GROUP_VILLAGES];let a=[];return e?(a=x.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(k);const n=L[r.BUILDING_SEQUENCES][L[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),W(t))return!1;n.some((function(a){if(++i[a]>t[a])return S.compute(e),B(e,a,(function(t,a){t&&a.job&&(b.trigger(l.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&L[r.PRIORIZE_FARM]){const t=h[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-L[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-L[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-L[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},Y=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return O.unshift(a),O.length>500&&O.splice(O.length-500,O.length),f.set(G,O),!0};let j={};return j.start=function(){if(!P)return b.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,_=setInterval(z,6e4),w=setInterval(C,6e3),e((function(){D().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),C()}),['all_villages_ready']),b.trigger(l.BUILDER_QUEUE_START)},j.stop=function(){R=!1,clearInterval(_),
clearInterval(w),b.trigger(l.BUILDER_QUEUE_STOP)},j.isRunning=function(){return R},j.isInitialized=function(){return y},j.getSettings=function(){return N},j.getLogs=function(){return O},j.clearLogs=function(){O=[],f.set(G,O),b.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=L[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,N.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=L[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],N.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,O=f.get(G,[],!0),I=n.getSelectedCharacter(),x=n.getGroupList(),N=new i({settingsMap:c,storageKey:M}),N.onChange((function(e,t,a){L=N.getAll(),R&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),L=N.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(L[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=L[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(L[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=I.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,b,E,_,w,h,S){let v,A,y,R,k=n.getGroupList(),x={},I=!1,O={sequencesAvail:!0,modal:{}},N={sequencesAvail:!0},L={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let G,M={},z={},C=!1,D=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(s='progress'):s='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:S.readableSeconds(o.build_time),levelPoints:x[e][t-1],state:s}}))},N.generateBuildingSequenceFinal=function(e){const t=v.settings[T.ACTIVE_SEQUENCE].value,a=v.settings[T.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=x[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});N.buildingSequenceFinal=n},
N.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequence.offset,t=v.pagination.buildingSequence.limit;N.visibleBuildingSequence=N.buildingSequence.slice(e,e+t),v.pagination.buildingSequence.count=N.buildingSequence.length},N.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,x[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,x[a].push(n)}}},O.moveUp=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}O.buildingSequence=e,O.updateVisibleBuildingSequence(),t&&(C=!0)},O.moveDown=function(){let e=angular.copy(O.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
...
const h=Object.values(c),S=Object.values(a),v=Object.values(w),A=Object.values(_),y=Object.values(E);let R,k=[],x={},I=[],O=[],N=!1;const L={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+R},G=function(e){k.push(e)},M=function(e){x[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,k)},C=function(e){return!isNaN(e)&&e>0&&e<1e3},D=function(e){return f.call(e,'x')&&f.call(e,'y')&&C(e.x)&&C(e.y)};let U={initialized:!1};return U.init=function(){R=t.getTimeOffset(),U.initialized=!0,I=b.get(d.QUEUE_SENT,[],!0),O=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(G(e),M(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!P(e.sendTime))return!0;N?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){N&&k.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let s={},l=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return l=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return l=i.NOT_ENOUGH_UNITS,!1;s[t]=e})),angular.equals({},s)&&(l=i.NOT_ENOUGH_UNITS),l||s}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(s.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){I.push(e)}(e),b.set(d.QUEUE_SENT,I),U.removeCommand(e,i.COMMAND_SENT),p.trigger(l.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){O.push(e)}(e),b.set(d.QUEUE_EXPIRED,O),U.removeCommand(e,t)},U.addCommand=function(e,i,o,s,l,r,d,p){let m={},b={};return new Promise((function(f,R){if(!D(e))return R(u.INVALID_ORIGIN);if(!D(i))return R(u.INVALID_TARGET);if(!t.isValidDateTime(o))return R(u.INVALID_DATE);if(angular.isObject(l)){if(!t.each(l,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return R(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return R(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!A.includes(t))return!1;r[t]&&(b[t]=!0)})))return R(u.INVALID_OFFICER_TYPE)}return h.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[_.SUPPORTER]&&delete b[_.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[w.CATAPULT])&&(p||E.HEADQUARTER),S.includes(s)?void Promise.all([new Promise(t=>T.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>T.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return R(u.INVALID_ORIGIN);if(!i)return R(u.INVALID_TARGET);const l=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=s===a.ARRIVE?l-r:l,T=s===a.ARRIVE?l:l+r;if(P(c))return R(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:T,sendTime:c,origin:e,target:i,date:o,dateType:s,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};G(E),M(E),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):R(u.INVALID_DATE_TYPE)):R(u.INVALID_CATAPULT_TARGET)):R(u.RELOCATE_DISABLED):R(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete x[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(l.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(l.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(l.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(l.COMMAND_QUEUE_REMOVE,e)}else p.trigger(l.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),O=[],I=[]},U.start=function(e){N=!0,p.trigger(l.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){N=!1,p.trigger(l.COMMAND_QUEUE_STOP)},U.isRunning=function(){return N},U.getWaitingCommands=function(){return k},U.getWaitingCommandsObject=function(){return x},U.getSentCommands=function(){return I},
U.getExpiredCommands=function(){return O},U.filterCommands=function(e,t,a){const i=L[e];return(a||k).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(l,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,s,d,u,p,m,T,b,f,E,_,w){let h,S,v,A,y,R=n.getGameData(),k=R.getOrderedUnitNames(),x=R.getOrderedOfficerNames(),I=n.getPresetList(),O=!1;const N={ADD:'add',WAITING:'waiting',LOGS:'logs'},L=N.ADD;let P,G,M,z=[],C={},D={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){O=t.data},q=function(){O=!1},W=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),s=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+s+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),W(e+=t)):''},j=function(){if(h.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!h.isValidDate&&o.getTimeFromString(y.date),t=h.selectedDateType.value===s.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const s=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);h.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(s),h.travelTimes[a][n].status=e?F(t?e-s:e):'neutral'}))}))},F=function(e){return e&&h.isValidDate?E.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){y.dateType=h.selectedDateType.value,w.set(m.LAST_DATE_TYPE,h.selectedDateType.value),j()},K=function(){
...
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(s.VILLAGES_IN_PROVINCE,{village_id:e},t)};let w={init:function(){f=!0}};return w.start=function(){i.trigger(l.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,l=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,w=c.clay,h=c.iron,S=f.currentStock,v=E.currentStock,A=w.currentStock,y=h.currentStock,R=[0,5e3],k=[160,16e3],x=[200,2e4],I=[50,5e3];1==l&&(_=1),m(n,(function(i){T=u(i.villages),b=p(T,1===l),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=_?'chapel'==i&&'church'==i||1!=_||(v>=k[1]&&A>=x[1]&&y>=I[1]&&S>=R[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):v>=k[0]&&A>=x[0]&&y>=I[0]&&S>=R[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==_?v>=k[1]&&A>=x[1]&&y>=I[1]&&S>=R[1]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):v>=k[0]&&A>=x[0]&&y>=I[0]&&S>=R[0]?(o.emit(s.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
...
[r.LIGHT_CAVALRY]:'light_cavalry',[r.MOUNTED_ARCHER]:'mounted_archer',[r.HEAVT_CAVALRY]:'heavy_cavalry',[r.RAM]:'ram',[r.CATAPULT]:'catapult',[r.TREBUCHET]:'trebuchet',[r.DOPPELSOLDNER]:'doppelsoldner',[r.SNOB]:'snob',[r.KNIGHT]:'knight'},S={[s.ATTACK]:'attack',[s.SUPPORT]:'support',[s.QUATTRO]:'four',[s.FULL]:'full'};console.log(h,S);const v=function(){T=[],b=[],f=[],E=[],_=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP],i=p[t.GROUPP],o=p[t.GROUPT],s=p[t.GROUPG],l=p[t.GROUP_TARGET];a.forEach((function(t){T.push(e[t])})),i.forEach((function(t){b.push(e[t])})),o.forEach((function(t){f.push(e[t])})),s.forEach((function(t){E.push(e[t])})),l.forEach((function(t){_.push(e[t])}))},A={init:function(){g=!0,u=new e({settingsMap:i,storageKey:w}),u.onChange((function(e,t){p=u.getAll(),t[o.GROUPS]&&v()})),p=u.getAll(),console.log('fakeSender settings',p),a.$on(l.GROUPS_CREATED,v),a.$on(l.GROUPS_DESTROYED,v),a.$on(l.GROUPS_UPDATED,v)},start:function(){m=!0,d.trigger(l.FAKE_SENDER_START)},
stop:function(){m=!1,d.trigger(l.FAKE_SENDER_STOP)},getSettings:function(){return u},isInitialized:function(){return g},isRunning:function(){return m}};return A})),define('two/fakeSender/events',[],(function(){angular.extend(l,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p){let m,T,b,f=n.getGroupList();const E={FAKE:'fake',LOGS:'logs'},_=function(e){m.selectedTab=e},w=function(){T.setAll(T.decode(m.settings)),p.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},h=function(){t.isRunning()?t.stop():t.start()},S=function(){m.groups=d.encodeList(f.getGroups(),{disabled:!1,type:'groups'})},v=function(){m.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),
...
LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/fakeSender','two/fakeSender/ui','two/fakeSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,T,E,_,w,h,S,v,A,y,R){let k,x,I,O,N,L=!1,P=!1,G=[],M=[],z=[],C=[],D=[],U=[],B=!1,V=!1,q=!1,W=0,Y=null,j=null,F=null,H={},K=w.gameTime(),Q=null,X=null
;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[A.WOOD,A.CLAY,A.IRON],te={distance:function(e){return!e.distance.between(x[r.MIN_DISTANCE],x[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return C.includes(e.id)},points:function(e){return!e.between(x[r.MIN_POINTS],x[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=x[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=x[r.GROUP_IGNORE];C=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=x[r.GROUP_ONLY];D=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),D=D.concat(t)})),D=ie(D)}(),
function(){const e=C.concat(z);let t=!1;e.forEach((function(e){f.call(I,e)||(I[e]={time:w.gameTime(),report:!1},t=!0)})),T.each(I,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete I[i],t=!0)})),t&&(R.set($,I),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),h.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){const a=x[r.GROUP_INCLUDE],i=x[r.GROUP_IGNORE],n=x[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id&&(o?(ke(t.village_id),s=!0):(Oe(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(Ne(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),n.includes(t.group_id)&&o){let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const a=x[r.GROUP_INCLUDE],i=x[r.GROUP_IGNORE],n=x[r.GROUP_ONLY],o=O.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id)if(o){
let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}else Ne(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Ne(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(ke(t.village_id),s=!0),s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){const t=n.getGroupList().getGroups(),a=x[r.GROUP_IGNORE],i=x[r.GROUP_ONLY],o=x[r.GROUP_INCLUDE],s=f.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),l=i.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));k.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ne(),Re(),Ne(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();x[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),
U.length||(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Le.stop())},ue=function(e,t){x[r.IGNORE_ON_LOSS]&&x[r.GROUP_IGNORE]&&P&&t.type===S.TYPES.ATTACK&&1!==t.result&&Ie(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=x[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},pe=function(e,t){B&&q&&t.origin.id===B.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===S.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&q&&t.cause===s.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=N[a].load*e)})),t},Te=function(e){I[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],R.set($,I),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,M.unshift(t),fe(),!0)},fe=function(){const e=x[r.LOGS_LIMIT]
;M.length>e&&M.splice(M.length-e,M.length),R.set(Z,M),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const i=x[r.TARGET_MULTIPLE_FARMERS],n=x[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},_e=function(){K=w.gameTime()},we=function(){clearTimeout(Y),clearTimeout(j),clearTimeout(F),Y=null,j=null,F=null},he=function(){return Math.max(1,60*x[r.FARMER_CYCLE_INTERVAL]*1e3)},Se=function(){return Math.max(0,1e3*x[r.ATTACK_INTERVAL])},ve=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};ve.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e()
;this.loadTargets(()=>{h.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},ve.prototype.start=function(){return _e(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,h.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),!0):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,h.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=b},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;_e();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,
!this.running)return a(i.USER_STOP);t()},T.randomSeconds(Se())):t()}),E=()=>new Promise((e,a)=>{const n=50-x[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),A=()=>new Promise((e,t)=>{if(x[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()}),R=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),k=()=>new Promise((e,t)=>{y.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(s.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),I=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[]
;if(U.forEach((function(e){f.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)f.call(a,e)&&i.push(e);o.emit(s.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),N=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*x[r.MAX_TRAVEL_TIME],s=this.village.getPosition(),l=_.actualDistance(s,a);T.each(U,s=>{if(!!Object.entries(s.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(s,{barbarian:!a.character_id,officers:!1});return o>r*l?(g=s,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),L=()=>new Promise((e,n)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),
Ee(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*x[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(x[r.TARGET_SINGLE_ATTACK]&&!x[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(w.gameTime()/1e3),s=x[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],l=this.village.getPosition(),m=_.actualDistance(l,a),T=d.calculateTravelTime(g,{barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,T,m,S.TYPES.ATTACK);if(s.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),G=()=>new Promise((e,t)=>{if(m)return e();o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP)
;const n=a.commands.own.filter(e=>e.type===S.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),s=n.some(e=>e.start_village_id===this.villageId);if(Ee(s,o,!0))return t(i.BUSY_TARGET);e()})});let M=new Promise((e,t)=>{b().then(E).then(A).then(R).then(k).then(I).then(N).then(L).then(P).then(G).then(e).catch(t)}),C=new Promise((e,t)=>{F=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([M,C]).then(()=>{if(!this.running)return!1;this.setStatus(i.ATTACKING),V=!0,q=a,this.index++,o.emit(s.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:S.TYPES.ATTACK})}).catch(t=>{switch(we(),h.trigger(l.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,
...
this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,x[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},ve.prototype.getTargets=function(){return this.targets},ve.prototype.getIndex=function(){return this.index},ve.prototype.getVillage=function(){return this.village},ve.prototype.isRunning=function(){return this.running},ve.prototype.isInitialized=function(){return this.initialized},ve.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},ve.prototype.getId=function(){return this.villageId};const Ae=function(e){const t=x[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!D.includes(e))return!1;if(C.includes(e))return!1;let a=Le.getFarmer(e);return a||(a=new ve(e),G.push(a)),a
},ye=function(){T.each(O.getVillages(),(function(e,t){Ae(t)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Re=function(){const e=x[r.GROUP_ONLY];let t=[];G.forEach((function(a){let i=a.getId();e.length&&!D.includes(i)?t.push(i):C.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){ke(e)})),h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<G.length;a++)if(G[a].getId()===e)return G[a].stop(t.KILL_FARMER),G.splice(a,a+1),!0;return!1},xe=function(e){_e(),G.length?W>=G.length?(W=0,B=!1,X=w.gameTime()+he(),h.trigger(l.FARM_OVERFLOW_CYCLE_END)):B=G[W]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(W++,xe())})),"cycle_begin"===e&&(X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,W=0,X=null,h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),xe()}),he())},Ie=function(e){for(let t=0;t<G.length;t++){let a=G[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Oe=function(e){
G.forEach((function(t){t.removeTarget(e)}))},Ne=function(){m.load((function(){G.forEach((function(e){e.loadTargets()}))}),!0)};let Le={};return Le.init=function(){L=!0,M=R.get(Z,[]),I=R.get($,{}),O=n.getSelectedCharacter(),N=n.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){x=k.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Ne(),t[p.VILLAGES]&&(Re(),ye()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&P&&(j?(we(),B.targetStep({delay:!0})):Y&&(we(),h.trigger(l.FARM_OVERFLOW_CYCLE_BEGIN),W=0,xe())))})),x=k.getAll(),le("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){G.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(l.ARMY_PRESET_UPDATE,de),a.$on(l.ARMY_PRESET_DELETED,de),a.$on(l.GROUPS_VILLAGE_LINKED,oe),a.$on(l.GROUPS_VILLAGE_UNLINKED,se),a.$on(l.GROUPS_DESTROYED,re),a.$on(l.COMMAND_SENT,pe),a.$on(l.MESSAGE_ERROR,ge),a.$on(l.REPORT_NEW,ue)},Le.start=function(){let e
;return!P&&(U.length?(P=!0,e=[],G.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){xe("cycle_begin")})),_e(),function(){let e=he(),t=e+e/2+Se();Q=setInterval((function(){w.gameTime()-K>t&&(Le.stop(),setTimeout(Le.start,5e3))}),3e4)}(),h.trigger(l.FARM_OVERFLOW_START),void be(g.FARM_START)):(P=!1,!1)):(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Le.stop=function(e=i.USER_STOP){B?(B.stop(e),e!==i.USER_STOP&&(X=w.gameTime()+he()),h.trigger(l.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,we(),h.trigger(l.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Le.getFarmer=function(e){return G.find((function(t){return t.getId()===e}))},Le.getFarmers=function(){return G},Le.getSettings=function(){return k},Le.getExceptionVillages=function(){return{included:z,ignored:C}},Le.getExceptionLogs=function(){return I},Le.isInitialized=function(){return L},Le.isRunning=function(){return P},
Le.getLogs=function(){return M},Le.clearLogs=function(){return M=[],R.set(Z,M),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED),M},Le.getNextCycleDate=function(){return X},Le.getCycleInterval=he,Le})),define('two/farmOverflow/events',[],(function(){angular.extend(l,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',FARM_OVERFLOW_INSTANCE_STOP:'farm_overflow_instance_stop',FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS:'farm_overflow_instance_error_no_targets',FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY:'farm_overflow_instance_error_not_ready',FARM_OVERFLOW_INSTANCE_STEP_STATUS:'farm_overflow_instance_command_status',FARM_OVERFLOW_PRESETS_LOADED:'farm_overflow_presets_loaded',FARM_OVERFLOW_LOGS_UPDATED:'farm_overflow_log_updated',FARM_OVERFLOW_COMMAND_SENT:'farm_overflow_command_sent',FARM_OVERFLOW_IGNORED_TARGET:'farm_overflow_ignored_target',
FARM_OVERFLOW_VILLAGE_IGNORED:'farm_overflow_village_ignored',FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED:'farm_overflow_exception_villages_updated',FARM_OVERFLOW_FARMER_VILLAGES_UPDATED:'farm_overflow_farmer_villages_updated',FARM_OVERFLOW_REPORTS_UPDATED:'farm_overflow_reports_updated',FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED:'farm_overflow_exception_logs_updated',FARM_OVERFLOW_CYCLE_BEGIN:'farm_overflow_cycle_begin',FARM_OVERFLOW_CYCLE_END:'farm_overflow_cycle_end'})})),define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,_,w,h){let S,v,A,y=n.getPresetList(),R=n.getGroupList(),k={},x={},I=null;const O={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},N=function(){const e=S.pagination.offset,t=S.pagination.limit;S.visibleLogs=S.logs.slice(e,e+t),
S.pagination.count=S.logs.length,S.visibleLogs.forEach((function(e){e.villageId&&L(e.villageId),e.targetId&&L(e.targetId)}))},L=function(e){if(k[e])return k[e];k[e]=!0,x[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},x[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){S.exceptionVillages.included.forEach((function(e){L(e)})),S.exceptionVillages.ignored.forEach((function(e){L(e)}))},G=function(){t.isRunning()?t.stop():t.start()},M=function(e){S.selectedTab=e},z=function(){v.setAll(v.decode(S.settings)),S.saveButtonColor='orange',_.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},C=function(e){const t=v.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},D=function(e){
v.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(s.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){S.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},B=function(){S.groups=f.encodeList(R.getGroups(),{disabled:!1,type:'groups'}),S.groupsWithDisabled=f.encodeList(R.getGroups(),{disabled:!0,type:'groups'})},V=function(){S.running=!0,_.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(S.running=!1,S.showCycleTimer=!1,clearInterval(I),t.reason){case d.NO_PRESETS:_.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:_.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},W=function(){S.logs=angular.copy(t.getLogs()),N(),S.logs.length||_.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){S.farmers=t.getFarmers()},j=function(){S.exceptionVillages=t.getExceptionVillages(),P()
},F=function(){S.exceptionLogs=t.getExceptionLogs()},H=function(){S.showCycleTimer=!1,clearInterval(I)},K=function(e,a){a!==i.USER_STOP&&(S.showCycleTimer=!0,S.nextCycleCountdown=t.getCycleInterval(),I=setInterval((function(){S.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;S=a.$new(),S.SETTINGS=b,S.TAB_TYPES=O,S.LOG_TYPES=u,S.running=t.isRunning(),S.selectedTab=O.SETTINGS,S.farmers=t.getFarmers(),S.villagesLabel=x,S.villagesInfo=k,S.exceptionVillages=t.getExceptionVillages(),S.exceptionLogs=t.getExceptionLogs(),S.logs=t.getLogs(),S.visibleLogs=[],S.showCycleTimer=!1,S.nextCycleCountdown=0,S.saveButtonColor='orange',S.settingsMap=v.settingsMap,S.pagination={count:S.logs.length,offset:0,loader:N,limit:m.getPaginationLimit()},v.injectScope(S),U(),B(),N(),P(),function(){let e=t.getNextCycleDate();e&&(S.showCycleTimer=!0,S.nextCycleCountdown=e-h.gameTime(),I=setInterval((function(){S.nextCycleCountdown-=1e3}),1e3))}(),S.switchFarm=G,S.selectTab=M,S.saveSettings=z,
S.clearLogs=t.clearLogs,S.jumpToVillage=p.jumpToVillage,S.openVillageInfo=r.openVillageInfo,S.showReport=T.showReport,S.removeIgnored=C,S.removeIncluded=D;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(I)}));i.register(l.ARMY_PRESET_UPDATE,U,!0),i.register(l.ARMY_PRESET_DELETED,U,!0),i.register(l.GROUPS_UPDATED,B,!0),i.register(l.GROUPS_CREATED,B,!0),i.register(l.GROUPS_DESTROYED,B,!0),i.register(l.FARM_OVERFLOW_START,V),i.register(l.FARM_OVERFLOW_STOP,q),i.register(l.FARM_OVERFLOW_LOGS_UPDATED,W),i.register(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,Y),i.register(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),i.register(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,F),i.register(l.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(l.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',S),S.$watch('settings',(function(){e||(S.saveButtonColor='red'),e=!1}),!0)};return function(){v=t.getSettings(),A=e.addMenuButton2('Farmer',10),
...
c.getScreenWithInjectedScope('!twoverflow_king_tool_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Marszałek',50),g.addEventListener('click',A),
...
u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','marketHelper started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','marketHelper stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_market_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.MARKET_HELPER_START,S),e.register(l.MARKET_HELPER_STOP,v),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,s,r,c,d,u,g,m,T,b,E,_,w,h,S,v){let A,y,R,k,x,I,O,N,L,P,G,M,z,C,D,U,B,V,q,W,Y,j,F,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},se=injector.get('colorService'),le=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Te=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/y)%2&&(t+=k),t-=t%y,a-=a%y,{x:Math.ceil((t-L.width/2)/y),y:Math.ceil((a-L.height/2)/y)}},be=function(e,t){return{x:e/S.TILESIZE.x,y:t/S.TILESIZE.y/S.TILESIZE.off}},fe=function(){ve(x)},Ee=function(){if(H){const e={x:ee.x-L.width/2,y:ee.y-L.height/2};P.clearRect(0,0,L.width,L.height),C.clearRect(0,0,z.width,z.height),function(e){P.drawImage(G,-e.x,-e.y)}(e),F[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ge.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;C.fillStyle=F[o.COLOR_VIEW_REFERENCE],C.fillRect(a,0,1,R),C.fillRect(0,i,R,1);const n=U.getBoundingClientRect(),s=n.width/S.TILESIZE.x/v.view.z*y,l=n.height/S.TILESIZE.y/v.view.z*y,r=a-s/2,c=i-l/2;C.clearRect(r,c,s,l),C.beginPath(),C.lineWidth=1,C.strokeStyle=F[o.COLOR_VIEW_REFERENCE],C.rect(r,c,s,l),C.stroke()}(e)}e.requestAnimationFrame(Ee)},_e=function(){if(!ie)return!1;const e=Q.village[O][N];he(e?Q.character[e]:[[O,N]]),ie=!1,
m.trigger(l.MINIMAP_VILLAGE_BLUR,{x:O,y:N})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t,F[o.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t)},Se=function(e){if(F[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!F[o.SHOW_BARBARIANS]&&W.barbarian;if(e.character_id===V){if(e.id===I.getId()&&F[o.HIGHLIGHT_SELECTED])return W.selected;if(e.character_id in K.character)return K.character[e.character_id];if(F[o.HIGHLIGHT_OWN])return W.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&F[o.HIGHLIGHT_DIPLOMACY])return W.tribe;if(Y&&F[o.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return W.ally;if(Y.isEnemy(e.tribe_id))return W.enemy
;if(Y.isNAP(e.tribe_id))return W.friendly}}return W.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Se(i);if(!n)continue;const o=i.x*y+(i.y%2?k:0),s=i.y*y;M.fillStyle=n,M.fillRect(o,s,A,A)}},Ae=function(){A=oe[F[o.MAP_SIZE]],k=Math.round(A/2),y=A+1,R=1e3*y,J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y,G.width=1e3*y,G.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;L.width=686,L.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,C.imageSmoothingEnabled=!1},Re=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(l.MINIMAP_VILLAGE_CLICK,[O,N,e]),3===e.which&&(a=O,i=N,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(F[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Ge.addHighlight({type:'character',id:e.character_id},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ge.addHighlight({
type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(l.MINIMAP_START_MOVE)},ke=function(){de=!1,ue={},ce||m.trigger(l.MINIMAP_STOP_MOVE)},xe=function(e){if(ce=!1,pe=Te(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!F[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(F[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(O===e.x&&N===e.y)return!1;_e()}ie=!0,O=e.x,N=e.y,m.trigger(l.MINIMAP_VILLAGE_HOVER,{x:O,y:N,event:t});const a=Q.village[O][N];we(a?Q.character[a]:[[O,N]])}(pe,e)}_e()},Ie=function(){ie&&_e(),m.trigger(l.MINIMAP_MOUSE_LEAVE)},Oe=function(e){if(!ce)return!1;const t=Te(e);p.jumpToVillage(t.x,t.y)
},Ne=function(e){return e.preventDefault(),!1},Le=function(){K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},fe()},Pe=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Ge={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(l.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t];const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return se.setCustomColorsByGroup(i,K[e]),
a.$broadcast(l.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){L=e,L.style.background=F[o.COLOR_BACKGROUND],P=L.getContext('2d')},setViewportRef:function(e){z=e,C=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ge.getMapPosition=function(){if(!D.width||!D.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,D.width/2,D.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ge.getSettings=function(){return j},Ge.drawMinimap=function(){ge&&(ge=!1),L.style.background=F[o.COLOR_BACKGROUND],M.clearRect(0,0,G.width,G.height),d((function(){!function(){
const e=_.getPath(S.getMapPath()),t=F[o.SHOW_CONTINENT_DEMARCATIONS],a=F[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=F[o.COLOR_CONTINENT],M.fillRect(e*y+k-1,t*y+k-1,3,1),M.fillRect(e*y+k,t*y+k-2,1,3)},n=function(e,t){M.fillStyle=F[o.COLOR_PROVINCE],M.fillRect(e*y+k,t*y+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),s={a:X.a-10,b:X.b+10},l={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=s.a;e<s.b;e++)for(let s=l.a;s<l.b;s++){const l=E.toTile(o,e,s);l.key.b&&(l.key.c&&t?i(e,s):a&&n(e,s))}const r=s.a*y,c=l.a*y,d=(s.b-s.a)*y,u=(l.b-l.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Ge.enableRendering=function(){H=!0},Ge.disableRendering=function(){H=!1},Ge.isFirstDraw=function(){return!!ge},Ge.init=function(){Ge.initialized=!0,G=document.createElement('canvas'),M=G.getContext('2d'),re=le.make('hover'),j=new u({settingsMap:s,storageKey:ne}),j.onChange((function(e,t){F=j.getAll(),
Ae(),t[r.MAP_POSITION]&&Ge.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ge.drawMinimap()})),F=j.getAll(),K.tribe=se.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=se.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ae()},Ge.run=function(){d((function(){U=document.getElementById('map'),D=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),q=B.getTribeId(),W=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),ye(),I=B.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*y,ee.y=I.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',Re),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',xe),z.addEventListener('mouseleave',Ie),z.addEventListener('click',Oe),z.addEventListener('contextmenu',Ne),g.load((function(){x=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(x),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}X.a=Math.min(...e),X.b=Math.max(...e),Z.a=Math.min(...t),Z.b=Math.max(...t),J.a=X.a*y,J.b=X.b*y,$.a=Z.a*y,$.b=Z.b*y}(),Ee(),a.$on(l.VILLAGE_SELECTED_CHANGED,Pe),a.$on(l.TRIBE_RELATION_CHANGED,fe),a.$on(l.GROUPS_VILLAGES_CHANGED,Le)}))}),['initial_village','tribe_relations'])},Ge})),define('two/minimap/events',[],(function(){angular.extend(l,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,T,b,f,E,_,w,h){let S,v,A,y,R,k,x,I,O,N,L,P={},G=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},C=z.MINIMAP,D=function(e){S.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(S.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(s.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(S.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(s.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!O)return;let a=B(t.x,t.y);var i,n;N=a,P[a]=!0,G=!0,(i=t.x,n=t.y,new Promise((function(e){let t=_.getTownAt(i,n);if(t)return e(t);_.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!G)return;x.appendChild(O),O.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=O.getBoundingClientRect(),i=x.getBoundingClientRect(),n=a.width+50,o=a.height+50,s=k.tt.position.y+o>i.top+i.height,l=k.tt.position.x+n>i.width;s&&(k.tt.position.y-=50),O.classList.toggle('left',l),O.classList.toggle('top',s)}))},q=function(e,t){if(!O)return;let a=t?B(t):N;P[a]=!1,G=!1,k.tt.visible=!1,O.classList.add('ng-hide'),I.appendChild(O)},W=function(e,t,i){let o,s,l=a.$new(),r=!0;l.colorPalettes=h.palette,'setting'===e?(s=t,o=L.get(s),r=!1,l.submit=function(){S.settings[s]='#'+l.selectedColor,l.closeWindow()},l.reset=function(){S.settings[s]=L.getDefault(s),l.closeWindow()}):'add_custom_highlight'===e?(o=S.addHighlightColor,l.submit=function(){S.addHighlightColor='#'+l.selectedColor,l.closeWindow()}):'edit_custom_highlight'===e&&(o=S.highlights[t][i],l.submit=function(){n.addHighlight({id:i,type:t},l.selectedColor),l.closeWindow()}),l.selectedColor=o.replace('#',''),l.hasCustomColors=!0,l.hideReset=r,l.finishAction=function(e,t){l.selectedColor=t},
c.getModal('modal_color_palette',l)},Y=function(){n.addHighlight(S.selectedHighlight,S.addHighlightColor)},j=function(){L.setAll(L.decode(S.settings)),T.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},F=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){L.resetAll(),T.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(S.highlights.character).length+Object.keys(S.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){S.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){T.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){T.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){T.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},X=function(){S=a.$new(),S.SETTINGS=p,S.TAB_TYPES=z,S.selectedTab=C,S.selectedHighlight=!1,S.addHighlightColor='#000000',S.highlights=n.getHighlights(),S.highlightNames=M,S.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),S.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),S.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},S.selectTab=D,S.openColorPalette=W,S.addCustomHighlight=Y,S.removeHighlight=n.removeHighlight,S.saveSettings=j,S.resetSettings=F,S.highlightsCount=H,S.openProfile=K,L.injectScope(S,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(l.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(l.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(l.MINIMAP_VILLAGE_HOVER,V),e.register(l.MINIMAP_VILLAGE_BLUR,q),e.register(l.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(l.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(l.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',S),U(),R=document.querySelector('#two-minimap .minimap-container'),R.appendChild(A),R.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){L=n.getSettings(),k=i.getSharedData('MapController'),A=document.createElement('canvas'),A.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(A),n.setViewportRef(y),O=document.querySelector('#map-tooltip'),x=document.querySelector('#wrapper'),I=document.querySelector('#map'),v=t.addMenuButton4('Minimapa',30),v.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
...
w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_power_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.POWER_HELPER_START,S),e.register(l.POWER_HELPER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton4('Bunkry',20),g.addEventListener('click',A),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='preset_asigner_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('all settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),
a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.PRESET_ASIGNER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/presetAsigner/events',[],(function(){angular.extend(l,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){
t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.PRESET_ASIGNER_START,S),e.register(l.PRESET_ASIGNER_STOP,v),
c.getScreenWithInjectedScope('!twoverflow_preset_asigner_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Administrator',30),g.addEventListener('click',A),
...
bastard:!1},units:{spear:0,sword:0,axe:0,archer:0,light_cavalry:0,mounted_archer:0,heavy_cavalry:0,ram:0,catapult:0,trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),M.stop()},M.stop=function(){e.trigger(l.PRESET_CREATOR_STOPPED),r=!1},M.isRunning=function(){return r},M.isInitialized=function(){return i},M})),define('two/presetCreator/events',[],(function(){angular.extend(l,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return e.addDivisor(41),o=e.addMenuButton3('Wojewoda',40,g('i18n')('description',a.loc.ale,'preset_creator')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),
...
define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r,c){let d,u,p=!1,g=!1,m=[],T=[],b=[],f=[],E=[],_=[],w=[],h=[],S=[],v=[],A=[],y=[],R=[],k=[],x=[],I=[],O=[],N=[],L=[],P=[],G=[],M=[],z=[],C=[],D=[],U=[],B=[],V=[],q=[],W=[],Y=[],j=[];const F='recruit_queue_settings',H={[s.SPEAR]:'spear',[s.SWORD]:'sword',[s.AXE]:'axe',[s.ARCHER]:'archer',[s.LIGHT_CAVALRY]:'light_cavalry',[s.MOUNTED_ARCHER]:'mounted_archer',[s.HEAVT_CAVALRY]:'heavy_cavalry',[s.RAM]:'ram',[s.CATAPULT]:'catapult',[s.TREBUCHET]:'trebuchet',[s.DOPPELSOLDNER]:'doppelsoldner',[s.SNOB]:'snob',[s.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],T=[],b=[],f=[],E=[],_=[],w=[],h=[]
;const e=n.getPresetList().getPresets(),a=u[t.PRESET1],i=u[t.PRESET2],o=u[t.PRESET3],s=u[t.PRESET4],l=u[t.PRESET1_FINAL],r=u[t.PRESET2_FINAL],c=u[t.PRESET3_FINAL],d=u[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){T.push(e[t])})),o.forEach((function(t){b.push(e[t])})),s.forEach((function(t){f.push(e[t])})),l.forEach((function(t){E.push(e[t])})),r.forEach((function(t){_.push(e[t])})),c.forEach((function(t){w.push(e[t])})),d.forEach((function(t){h.push(e[t])}))},Q=function(){S=[],v=[],A=[],y=[],R=[],k=[],x=[],I=[],O=[],N=[],L=[],P=[],G=[],M=[],z=[],C=[],D=[],U=[],B=[],V=[],q=[],W=[],Y=[],j=[]
;const e=n.getGroupList().getGroups(),a=u[t.GROUP1],i=u[t.GROUP2],o=u[t.GROUP3],s=u[t.GROUP4],l=u[t.GROUP5],r=u[t.GROUP6],c=u[t.GROUP7],d=u[t.GROUP8],p=u[t.GROUP9],g=u[t.GROUP10],m=u[t.GROUP11],T=u[t.GROUP12],b=u[t.GROUP13],f=u[t.GROUP14],E=u[t.GROUP15],_=u[t.GROUP16],w=u[t.GROUP17],h=u[t.GROUP18],F=u[t.GROUP19],H=u[t.GROUP20],K=u[t.GROUP21],Q=u[t.GROUP22],X=u[t.GROUP23],Z=u[t.GROUP24];a.forEach((function(t){S.push(e[t])})),i.forEach((function(t){v.push(e[t])})),o.forEach((function(t){A.push(e[t])})),s.forEach((function(t){y.push(e[t])})),l.forEach((function(t){R.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){x.push(e[t])})),d.forEach((function(t){I.push(e[t])})),p.forEach((function(t){O.push(e[t])})),g.forEach((function(t){N.push(e[t])})),m.forEach((function(t){L.push(e[t])})),T.forEach((function(t){P.push(e[t])})),b.forEach((function(t){G.push(e[t])})),f.forEach((function(t){M.push(e[t])})),E.forEach((function(t){z.push(e[t])})),_.forEach((function(t){
C.push(e[t])})),w.forEach((function(t){D.push(e[t])})),h.forEach((function(t){U.push(e[t])})),F.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),K.forEach((function(t){q.push(e[t])})),Q.forEach((function(t){W.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){j.push(e[t])}))},X={init:function(){p=!0,d=new e({settingsMap:i,storageKey:F}),d.onChange((function(e,t){u=d.getAll(),t[o.PRESETS]&&K(),t[o.GROUPS]&&Q()})),u=d.getAll(),console.log('recruitQueue settings',u),r((function(){K()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,K),a.$on(l.ARMY_PRESET_DELETED,K),a.$on(l.GROUPS_CREATED,Q),a.$on(l.GROUPS_DESTROYED,Q),a.$on(l.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(l.recruit_queue_START)},stop:function(){g=!1,c.trigger(l.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return p},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(l,{
...
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='support_sender_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('supportSender settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.SUPPORT_SENDER_START)},stop:function(){p=!1,
r.trigger(l.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/supportSender/events',[],(function(){angular.extend(l,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SUPPORT:'support',LOGS:'logs'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SUPPORT,u.settingsMap=o,p.injectScope(u),w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.SUPPORT_SENDER_START,S),e.register(l.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',A),
