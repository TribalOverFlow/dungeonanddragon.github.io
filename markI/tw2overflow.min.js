...
define('two/fakeSender/events',[],(function(){angular.extend(l,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/datetype','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d,u,p){let g,m,T,b=n.getGroupList();const E={FAKE:'fake',LOGS:'logs'},f=function(e){g.selectedTab=e},_=function(){m.setAll(m.decode(g.settings)),p.notif('success','Settings saved')},w=function(){t.isRunning()?t.stop():t.start()},h=function(){g.groups=d.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},S=function(){g.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),p.notif('success','Example module started')},v=function(){g.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),p.notif('success','Example module stopped')},A=function(){g=a.$new(),g.SETTINGS=i,
