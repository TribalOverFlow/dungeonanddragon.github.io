...
started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',o={en_dk:'en_us',pt_pt:'pt_br'};function s(t){t=f.call(o,t)?o[t]:t,e.setJSON(i[t]||i[n])}let l={init:function(){if(t)return!1;t=!0,s(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&s(a.loc.ale)}))}};return l})),
define('two/Settings',['two/utils','Lockr'],(function(e,i){const o=function(e,t){let a={};for(let i in e)f.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a},s=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},l=function(e,t){let a={};for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||b},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return f.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},
r.prototype.set=function(e,t,a){if(!f.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),f.call(i,'min')&&(t=Math.max(i.min,t)),f.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const s=angular.copy(this.settings),r=o(n,s);if(!r)return!1;const c=l(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(f.call(this.settingsMap,t)){const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),f.call(a,'min')&&(i=Math.max(a.min,i)),f.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=o(a,i);if(!n)return!1;const s=l(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,s,t||{}),!0},r.prototype.reset=function(e,t){
return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){if(!f.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(i){e.multiSelect?i.length||(t.settings[a]=[s()]):i||(t.settings[a]=s())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const i=n.getPresetList().getPresets(),o=n.getGroupList().getGroups();return e=e||{},
...
o.emit(s.TRIBE_GET_MEMBERLIST,{tribe:T},(function(e){for(var t=e.members,a=0;a<t.length;a++)h.push(t[a].id)})),b.forEach((function(e){f.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(s.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:f},A),setTimeout(S,6e4)},A=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),h.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(w.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{w.push(i[n].command_id),i[n].slowestUnit=y(i[n]);var l=i[n].time_completed,d=(t=void 0,t=new Date(1e3*l),r=t.toLocaleString(),r),u='',p='';'sword'==i[n].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',
...
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);R()},I=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},x=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},L=function(){w.commands=t.getCommands()},O=function(){w.selectedVillageId=n.getSelectedVillage().getId()},N=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=b,w.FILTER_TYPES=u,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=T,w.COLUMN_TYPES=s,w.pagination={count:w.commands.length,offset:0,loader:R,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.now=v,w.copyTimeModal=S,w.removeTroops=A,w.switchWindowSize=y,
w.toggleFilter=I,w.toggleSorting=x,R();let e=new i('twoverflow_queue_window',(function(){E.timer.remove(k)}));e.register(l.MAP_SELECTED_VILLAGE,O,!0),e.register(l.ATTACK_VIEW_COMMANDS_LOADED,L),e.register(l.ATTACK_VIEW_COMMAND_CANCELLED,L),e.register(l.ATTACK_VIEW_COMMAND_IGNORED,L),e.register(l.ATTACK_VIEW_VILLAGE_RENAMED,L),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),E.timer.add(k)};return function(){h=e.addMenuButton('Strażnik',30),h.addEventListener('click',N),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,T,b,f,E){let _,w,h,v=injector.get('buildingService'),S=injector.get('premiumActionService'),A=injector.get('buildingQueueService'),y=!1,R=!1;const k={};let I,x,L,O,N,P=!0;const C='builder_queue_log',M='builder_queue_settings',z=function(){const e=D();if(!P)return Y.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},G=function(){D().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
...
village_id:e.getId(),location:T.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},W=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},F=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),f.set(C,L),!0};let Y={};return Y.start=function(){if(!P)return b.trigger(l.BUILDER_QUEUE_NO_SEQUENCES),!1;R=!0,_=setInterval(z,6e4),w=setInterval(G,6e3),e((function(){D().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),G()}),['all_villages_ready']),b.trigger(l.BUILDER_QUEUE_START)},Y.stop=function(){R=!1,clearInterval(_),
clearInterval(w),b.trigger(l.BUILDER_QUEUE_STOP)},Y.isRunning=function(){return R},Y.isInitialized=function(){return y},Y.getSettings=function(){return O},Y.getLogs=function(){return L},Y.clearLogs=function(){L=[],f.set(C,L),b.trigger(l.BUILDER_QUEUE_CLEAR_LOGS)},Y.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},Y.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},Y.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(l.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},Y.init=function(){y=!0,L=f.get(C,[],!0),x=n.getSelectedCharacter(),I=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),R&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(l.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(l.BUILDING_LEVEL_CHANGED,(function(e,t){if(!R)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);U(e)}),1e3)}))},Y})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,T,b,E,_,w,h,v){let S,A,y,R,k=n.getGroupList(),I={},x=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let C,M={},z={},G=!1,D=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},B=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case E.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}};O.generateSequences=function(){const e=R.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=S.settings[T.ACTIVE_SEQUENCE].value,t=S.settings[T.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in _)i[_[e]]=0;O.buildingSequence=t.map((function(e){let t=++i[e],o=a[e].individual_level_costs[t],s='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(s='progress'):s='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:I[e][t-1],state:s}}))},O.generateBuildingSequenceFinal=function(e){const t=S.settings[T.ACTIVE_SEQUENCE].value,a=S.settings[T.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in y)i[e]={level:0,order:y[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=y[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=I[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
O.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequence.offset,t=S.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),S.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},L.moveUp=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(G=!0)},L.moveDown=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(G=!0)},L.addBuilding=function(e,t,a=1){const i=t-1;let n=L.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return L.buildingSequence=L.updateLevels(n,e),L.updateVisibleBuildingSequence(),G=!0,!0},L.removeBuilding=function(e){const t=L.buildingSequence[e].building;L.buildingSequence.splice(e,1),L.buildingSequence=L.updateLevels(L.buildingSequence,t),L.updateVisibleBuildingSequence(),G=!0},L.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<y[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},L.generateBuildingSequence=function(){const e=R.get(T.BUILDING_SEQUENCES),t=Object.keys(e).length;if(L.sequencesAvail=t,!t)return!1;const a=e[L.selectedSequence.value];let i={};for(let e in _)i[_[e]]=0;L.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
L.updateVisibleBuildingSequence()},L.updateVisibleBuildingSequence=function(){const e=S.pagination.buildingSequenceEditor.offset,t=S.pagination.buildingSequenceEditor.limit;L.visibleBuildingSequence=L.buildingSequence.slice(e,e+t),S.pagination.buildingSequenceEditor.count=L.buildingSequence.length},L.updateBuildingSequence=function(){const e=L.selectedSequence.value,t=L.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case E.SEQUENCE_SAVED:G=!1;break;case E.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case E.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},L.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),
e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(L.selectedSequence.value),G=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},L.modal.addBuilding=function(){let e=a.$new();e.buildings=[],e.position=L.lastAddedIndex,e.indexLimit=L.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(L.lastAddedBuilding,a.loc.ale,'building_names'),value:L.lastAddedBuilding};for(let t in y)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,o=g('i18n')(t,a.loc.ale,'building_names'),s=y[t].max_level;L.lastAddedBuilding=t,L.lastAddedIndex=i,L.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',o,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',o,s))},
c.getModal('!twoverflow_builder_queue_add_building_modal',e)},L.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=L.selectedSequence.name,i=S.settings[T.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(G){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},N.updateVisibleLogs=function(){const e=S.pagination.logs.offset,t=S.pagination.logs.limit;N.visibleLogs=N.logs.slice(e,e+t),
S.pagination.logs.count=N.logs.length,N.visibleLogs.forEach((function(e){e.villageId&&function(e){if(M[e])return M[e];M[e]=!0,z[e]='LOADING...',o.emit(s.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){M[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const q=function(){let e=a.$new();const t=[_.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;B(e.name,t)&&(S.settings[T.ACTIVE_SEQUENCE]={name:e.name,value:e.name},S.settings[T.BUILDING_SEQUENCES][e.name]=t,F(),O.selectedSequence={name:e.name,value:e.name},L.selectedSequence={name:e.name,value:e.name},O.generateSequences(),L.generateBuildingSequence(),e.closeWindow(),W(P.SEQUENCES))},
c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){S.selectedTab=e},F=function(){R.setAll(R.decode(S.settings)),G=!1},Y=function(){i.isRunning()?i.stop():i.start()},j=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){G?j((function(){C()})):C()},K={updateGroups:function(){S.groups=p.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=R.get(T.BUILDING_SEQUENCES);S.sequences=p.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){L.generateBuildingSequence()},
updateLogs:function(){S.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=R.get(T.BUILDING_SEQUENCES);S.settings[T.BUILDING_SEQUENCES][t]=i[t],S.settings[T.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=R.get(T.BUILDING_SEQUENCES);S.settings[T.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete S.settings[T.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(f.call(e,t))return t;return!1}(S.settings[T.BUILDING_SEQUENCES]);L.selectedSequence={name:i,value:i},K.updateSequences(),L.generateBuildingSequence(),R.get(T.ACTIVE_SEQUENCE)===t&&(R.set(T.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){S.running=!0},stopped:function(){S.running=!1}},Q=function(){const e=R.get(T.ACTIVE_SEQUENCE);S=a.$new(),S.selectedTab=P.SETTINGS,S.TAB_TYPES=P,S.SETTINGS=T,S.running=x,S.pagination={},S.settingsMap=R.settingsMap,S.villagesLabel=z,S.villagesInfo=M,S.editorView=L,S.editorView.buildingSequence={},S.editorView.visibleBuildingSequence=[],S.editorView.selectedSequence={name:e,value:e},S.editorView.lastAddedBuilding=_.HEADQUARTER,S.editorView.lastAddedIndex=1,S.settingsView=O,S.settingsView.buildingSequence={},S.settingsView.buildingSequenceFinal={},S.logsView=N,S.logsView.logs=i.getLogs(),S.selectTab=W,S.switchBuilder=Y,S.saveSettings=F,S.createSequence=q,S.openVillageInfo=r.openVillageInfo,R.injectScope(S),K.updateGroups(),K.updateSequences(),S.pagination.buildingSequence={
count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.buildingSequenceEditor={count:L.buildingSequence.length,offset:0,loader:L.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},S.pagination.logs={count:N.logs.length,offset:0,loader:N.updateVisibleLogs,limit:m.getPaginationLimit()},N.updateVisibleLogs(),O.generateSequences(),L.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(l.GROUPS_UPDATED,K.updateGroups,!0),t.register(l.GROUPS_CREATED,K.updateGroups,!0),t.register(l.GROUPS_DESTROYED,K.updateGroups,!0),t.register(l.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(l.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(l.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(l.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),
...
LIGHT_CAVALRY:'light_cavalry',MOUNTED_ARCHER:'mounted_archer',HEAVY_CAVALRY:'heavy_cavalry',RAM:'ram',CATAPULT:'catapult',TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner',SNOB:'snob',KNIGHT:'knight'}})),require(['two/ready','two/fakeSender','two/fakeSender/ui','two/fakeSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,T,E,_,w,h,v,S,A,y,R){let k,I,x,L,O,N=!1,P=!1,C=[],M=[],z=[],G=[],D=[],U=[],V=!1,B=!1,q=!1,W=0,F=null,Y=null,j=null,H={},K=w.gameTime(),Q=null,X=null
;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[A.WOOD,A.CLAY,A.IRON],te={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===L.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return G.includes(e.id)},points:function(e){return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=I[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=I[r.GROUP_IGNORE];G=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];D=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!L.getVillage(e)})),D=D.concat(t)})),D=ie(D)}(),
function(){const e=G.concat(z);let t=!1;e.forEach((function(e){f.call(x,e)||(x[e]={time:w.gameTime(),report:!1},t=!0)})),T.each(x,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete x[i],t=!0)})),t&&(R.set($,x),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),h.trigger(l.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=L.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id&&(o?(ke(t.village_id),s=!0):(Le(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),Te(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),Te(t.village_id)),n.includes(t.group_id)&&o){let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=L.getVillage(t.village_id);let s=!1;if(ne(),i===t.group_id)if(o){
let e=Ae(t.village_id);e.init().then((function(){P&&e.start()})),s=!0}else Oe(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(ke(t.village_id),s=!0),s&&h.trigger(l.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e){const t=n.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],s=f.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),l=i.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));k.setAll({[r.GROUP_IGNORE]:s,[r.GROUP_ONLY]:l,[r.GROUP_INCLUDE]:c},e)},re=function(){le(),ne(),Re(),Oe(),ye()},ce=function(){U=[];const e=n.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),
U.length||(h.trigger(l.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},ue=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===v.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(s.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},pe=function(e,t){V&&q&&t.origin.id===V.getId()&&t.target.id===q.id&&'forward'===t.direction&&t.type===v.TYPES.ATTACK&&V.commandSent(t)},ge=function(e,t){V&&B&&q&&t.cause===s.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},Te=function(e){x[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],R.set($,x),h.trigger(l.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,M.unshift(t),fe(),!0)},fe=function(){const e=I[r.LOGS_LIMIT]
;M.length>e&&M.splice(M.length-e,M.length),R.set(Z,M),h.trigger(l.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const i=I[r.TARGET_MULTIPLE_FARMERS],n=I[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},_e=function(){K=w.gameTime()},we=function(){clearTimeout(F),clearTimeout(Y),clearTimeout(j),F=null,Y=null,j=null},he=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},ve=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},Se=function(e){if(this.villageId=e,this.village=L.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=b,this.status=i.WAITING_CYCLE};Se.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e()
;this.loadTargets(()=>{h.trigger(l.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Se.prototype.start=function(){return _e(),!this.running&&(this.initialized?this.targets.length?(V=this,this.running=!0,h.trigger(l.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),!0):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(h.trigger(l.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Se.prototype.stop=function(e){this.running=!1,h.trigger(l.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=b},Se.prototype.targetStep=async function(e={}){if(!this.running)return!1;_e();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?Y=setTimeout(()=>{if(Y=null,
...
t.isRunning()&&n.trigger(l.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const o='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(o,!1,!0)&&t.start(),n.register(l.AUTO_HELPER_STARTED,(function(){i.set(o,!0)})),n.register(l.AUTO_HELPER_STOPPED,(function(){i.set(o,!1)}))}),['initial_village'])}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,o,s,r){let c,d,u=!1,p=!1,g=[],m=[];const T='prank_helper_settings',b=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={
init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('all settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.PRANK_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.PRANK_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/prankHelper/events',[],(function(){angular.extend(l,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),
define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.SETTINGS,u.settingsMap=o,p.injectScope(u),
w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.PRANK_HELPER_START,v),e.register(l.PRANK_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',u)};return function(){p=t.getSettings(),e.addDivisor3(51),g=e.addMenuButton3('Błazen',60),g.addEventListener('click',A),
...
},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(s.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},T=function(e){var t,n,l,r,c,d=[],u=e.result,p=e.token,m=e.time_created,T=g(m),b=e.ReportScouting,f=b.attCharacterId,E=b.attCharacterName,_=b.attScouts,w=b.attLosses,h=b.attVillageId,v=b.attVillageName,S=b.defCharacterId,A=b.defCharacterName,y=b.defLosses,R=b.defScouts,k=b.defVillageId,I=b.defVillageName,x=b.commandType,L='',O='',N='',P='',C=Date.now(),M=p.split('.').join('_');2==u?L=' [color=d96a19]Częściowy sukces[/color]':1==u?L=' [color=0a8028]Sukces[/color]':3==u&&(L=' [color=e21f1f]Porażka[/color]'),O='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',n=null==R?'nieznana':R,l=null==_?'nieznana':_,r=null==y?'nieznana':y,c=null==w?'nieznana':w,P=null==E&&null==f?'Brak danych':'[player='+f+']'+E+'[/player]',N=null==v&&null==h?'Brak danych':'[village='+h+']'+v+'[/village]',
t=Math.floor(C/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+T+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+I+'[/village][b] Gracz cel: [/b][player='+S+']'+A+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+l+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();S!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(s.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(s.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){
...
a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+L+'[/village][b] Gracz cel: [/b][player='+k+']'+I+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+A+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+R+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+Y+'[/b][br]'+j+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(s.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},f=function(e){
var t,a=[],n=e.result,l=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,T=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var _=[],w=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),_.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,_.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,_.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,_.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,_.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,_.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,_.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,_.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,_.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,_.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,_.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,_.push(' Zjednoczenie '+g+'%'))}));var h=_.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,s=0,l=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,w.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(s=e.beds,w.push(' Klinika '+s)),'increase_spy_defense'==t&&(l=e.increased_by,w.push(' Agent wewnętrzny '+l+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,w.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,w.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}));var v,S=w.join(),A=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,x=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),M=d.night,z=d.loyaltyAfter,G=d.loyaltyBefore,D=d.wallAfter,U=d.wallBefore,V=d.officers,B='',q='',W='',F='',Y='',j='',H='',K='',Q=[],X=Date.now(),Z=l.split('.').join('_')
...
a.push('[size=XL][b]Raport z ataku: [report]'+Z+'[/report][br]'+B+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+I+']'+x+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+F+'[/b][br]Pozostałe bonusy: [b]'+S+'[/b][br][b]Wioska pochodzenia: [/b]'+q+'[b] Gracz atakujący: [/b]'+W+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+v+'[/b][br]'+Y+j+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(s.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(s.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},E={init:function(){r=!0},start:function(){e.trigger(l.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(l.REPORT_SENDER_STOPPED),c=!1},
...
[i.CHAPEL]:'chapel',[i.CHURCH]:'church',[i.MARKET]:'market',[i.ACADEMY]:'academy'},m={[n.SPEAR]:'spear',[n.SWORD]:'sword',[n.AXE]:'axe',[n.ARCHER]:'archer',[n.LIGHT_CAVALRY]:'light_cavalry',[n.MOUNTED_ARCHER]:'mounted_archer',[n.HEAVT_CAVALRY]:'heavy_cavalry',[n.RAM]:'ram',[n.CATAPULT]:'catapult',[n.TREBUCHET]:'trebuchet',[n.DOPPELSOLDNER]:'doppelsoldner',[n.SNOB]:'snob',[n.KNIGHT]:'knight'};console.log(m,g);const T={init:function(){d=!0,r=new e({settingsMap:a,storageKey:p}),c=r.getAll(),console.log('spyMaster settings',c)},start:function(){u=!0,s.trigger(l.SPY_MASTER_START)},stop:function(){u=!1,s.trigger(l.SPY_MASTER_STOP)},getSettings:function(){return r},isInitialized:function(){return d},isRunning:function(){return u}};return T})),define('two/spyMaster/events',[],(function(){angular.extend(l,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),
define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,o,s,r,d,u){let p,m,T;const b={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},f=function(e){p.selectedTab=e},E=function(){m.setAll(m.decode(p.settings)),u.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){p.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),u.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},h=function(){p.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),u.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},v=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=b,p.running=t.isRunning(),p.selectedTab=b.SPY,p.settingsMap=n,p.building=r.encodeList(o,{textObject:'spy_master',disabled:!0}),p.unit=r.encodeList(s,{
