 ...
 */
!function(e,t){const a=injector.get('$rootScope'),i=injector.get('transferredSharedDataService'),n=injector.get('modelDataService'),l=injector.get('socketService'),o=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),p=injector.get('villageService'),u=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),b=injector.get('reportService'),T=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||T,this.listeners=[];const i=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),i())})};return t.prototype.register=function(t,i,n){n?this.listeners.push(a.$on(t,i)):(e.register(t,i),this.listeners.push((function(){
e.unregister(t,i)})))},t.prototype.destroy=function(){this.listeners.forEach(e=>{e()}),this.onDestroy()},t})),define('two/utils',['helper/time','helper/math'],(function(e,t){let i={randomSeconds:function(e){if(!e)return 0;const t=(e=parseInt(e,10))+e/2,a=e-e/2;return Math.round(Math.random()*(t-a)+a)},time2seconds:function(e){return(e=e.split(':'))[0]=60*parseInt(e[0],10)*60,e[1]=60*parseInt(e[1],10),e[2]=parseInt(e[2],10),e.reduce((function(e,t){return e+t}))},notif:function(e,t){a.$broadcast(s.NOTIFICATION_DISABLE),a.$broadcast(s.NOTIFICATION_ENABLE);const i='success'===e?s.MESSAGE_SUCCESS:s.MESSAGE_ERROR;a.$broadcast(i,{message:t})},genVillageLabel:function(e){return e.name+' ('+e.x+'|'+e.y+')'},isValidCoords:function(e){return/\s*\d{2,3}\|\d{2,3}\s*/.test(e)},isValidDateTime:function(e){return/^\s*([01][0-9]|2[0-3]):[0-5]\d:[0-5]\d(:\d{1,3})? (0[1-9]|[12][0-9]|3[0-1])\/(0[1-9]|1[0-2])\/\d{4}\s*$/.test(e)},fixDate:function(e){const t=e.trim().split(' '),a=t[0],i=t[1].split('/')
;return a+' '+i[1]+'/'+i[0]+'/'+i[2]},guid:function(){return Math.floor(16777216*Math.random()).toString(16)},getTimeFromString:function(e,t){const a=i.fixDate(e).split(' '),n=a[0].split(':'),l=a[1].split('/'),o=n[0],s=n[1],r=n[2],c=n[3]||null,d=parseInt(l[0],10)-1,p=l[1],u=l[2];return new Date(u,d,p,o,s,r,c).getTime()+(t||0)},formatDate:function(e,t){return g('readableDateFilter')(e,null,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,t||'HH:mm:ss dd/MM/yyyy')},getTimeOffset:function(){return 1e3*e.gameDate().getTimezoneOffset()*60+a.GAME_TIME_OFFSET},xhrGet:function(e,t="text"){return new Promise((function(a,i){if(!e)return i();let n=new XMLHttpRequest;n.open('GET',e,!0),n.responseType=t,n.addEventListener('load',(function(){a(n)}),!1),n.send()}))},obj2selectOptions:function(e,t){let a=[];for(let i in e){let n={name:e[i].name,value:e[i].id};t&&(n.leftIcon=e[i].icon),a.push(n)}return a},getTravelTime:function(e,a,i,l,o,s){
const r=!a.character_id,c=a.character_id&&a.tribe_id&&a.tribe_id===n.getSelectedCharacter().getTribeId();!1!==s&&('attack'===l?('supporter'in o&&delete o.supporter,r&&(s=!0)):'support'===l&&(c&&(s=!0),'supporter'in o&&(s=!0)));const p={units:i,officers:angular.copy(o)},u=d.calculateTravelTime(p,{barbarian:r,ownTribe:c,officers:o,effects:s},l),g=t.actualDistance(e,a);return 1e3*d.getTravelTimeForDistance(p,u,g,l)},each:function(e,t){if('function'!=typeof t&&(t=T),Array.isArray(e)){for(let a=0,i=e.length;a<i;a++)if(!1===t(e[a],a))return!1}else if(angular.isObject(e))for(let a in e)if(E.call(e,a)&&!1===t(e[a],a))return!1;return!0}};return i})),define('two/ready',['conf/gameStates','two/mapData'],(function(e,t){let r={};const c=function(d,p){'string'==typeof(p=p||['map'])&&(p=[p]);const u=function(e){(p=p.filter((function(t){return t!==e}))).length||d()},g={map:function(){if(i.getSharedData('MapController').isInitialized)return u('map');a.$on(s.MAP_INITIALIZED,(function(){u('map')}))},
tribe_relations:function(){const e=n.getSelectedCharacter();if(e){const t=e.getTribeRelations();if(!e.getTribeId()||t)return u('tribe_relations')}const t=a.$on(s.TRIBE_RELATION_LIST,(function(){t(),u('tribe_relations')}))},initial_village:function(){if(n.getGameState().getGameState(e.INITIAL_VILLAGE_READY))return u('initial_village');a.$on(s.GAME_STATE_INITIAL_VILLAGE_READY,(function(){u('initial_village')}))},all_villages_ready:function(){if(n.getGameState().getGameState(e.ALL_VILLAGES_READY))return u('all_villages_ready');a.$on(s.GAME_STATE_ALL_VILLAGES_READY,(function(){u('all_villages_ready')}))},minimap_data:function(){if(t.isLoaded())return u('minimap_data');t.load((function(){u('minimap_data')}))},presets:function(){if(n.getPresetList().isLoaded())return u('presets');r.presets=r.presets||new Promise((function(e){l.emit(o.GET_PRESETS,{},e)})),r.presets.then((function(){u('presets')}))},world_config:function(){if(n.getWorldConfig&&n.getWorldConfig())return u('world_config')
;setTimeout(g.world_config,100)}};if(!i.getSharedData('MapController'))return setTimeout((function(){c(d,p)}),100);p.forEach((function(e){g[e]()}))};return c})),require(['two/ready','Lockr'],(function(e,t){e((function(){let e=n.getSelectedCharacter();t.prefix=e.getId()+'_twOverflow_'+e.getWorldId()+'-'}))})),define('two/language',['helper/i18n'],(function(e){let t=!1;const i={en_us:{about:{contact:"Kontakt",version:"Tw2Master v3.00(baza tw2overflow v2.0.0)",email:"Email",edit:"Od Edytora",editor:"Edytował",edit_autor:"DirtyPrank/Dr Doom/NewPope",text:"Życzymy miłej zabawy z Tribal Wars 2 :)",close:"Zamknij",links:"Linki projektów",autor:"Autor",credits:"Z asystą",assisters:"luckyduckk",source_autor:"Relaxeaza",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia",donate:"Jeśli wesprzesz mnie donacją $, mogę stworzyć indywidualne skrypty dla ciebie."},activity_tool:{title:"Statystyki",data:"Dane","data.attention":"Ważne informacje",
"data.description":"Narzędzie to tworzy pliki które można wczytać w programie Tw2-Statistics (by DirtyPrank). Po wykonaniu zrzutów umieść je w folderze Dane. Uwaga! Akcje te wymagają dobrej jakości komputera w innym wypadku potrwa to bardzo długo.","data.dump":"Wybierz opcje wykonania zrzutu danych na twój komputer","data.players":"Gracze","data.tribes":"Plemiona","data.achievements":"Osiągnięcia","data.save":"Zapisz","data.reset":"Resetuj",logs:"Logi","logs.type":"Co?","logs.date":"Data","logs.noDumps":"Nie wykonano żadnych zrzutów danych","logs.clear":"Wyczyść logi","general.start":"Start","general.pause":"Pauza"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},army_helper:{title:"Hetman",army:"Wojsko","army.header":"Sprawdź ilość jednostek w wioskach","army.check":"Zlicz","army.troops":"Wojsko","army.unit":"Jednostka",
...
points:"Punkty",player:"Gracz",players:"Gracze",next_features:"Następne funkcje",misc:"Różne",colors:"Kolory",reset:"Resetuj",here:"tutaj",disabled:"— Wyłączony —",cancel:"Anuluj",actions:"Akcje",remove:"Usuń",started_at:"Uruchomiony",arrive:"Dotarcie",settings_saved:"Ustawienia zapisane",discard:"Odrzuć",new_version:"Nowa wersja",check_changes:"Sprawdź zmiany",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}},pl_pl:{about:{
contact:"Kontakt",version:"Tw2Master v3.00(baza tw2overflow v2.0.0)",email:"Email",edit:"Od Edytora",editor:"Edytował",edit_autor:"DirtyPrank/Dr Doom/NewPope",text:"Życzymy miłej zabawy z Tribal Wars 2 :)",close:"Zamknij",links:"Linki projektów",autor:"Autor",credits:"Z asystą",assisters:"luckyduckk",source_autor:"Relaxeaza",source_code:"Kod źródłowy",issues_suggestions:"Błędy/sugestie",translations:"Tłumaczenia",donate:"Jeśli wesprzesz mnie donacją $, mogę stworzyć indywidualne skrypty dla ciebie."},activity_tool:{title:"Kwatermistrz",data:"Dane","data.attention":"Ważne informacje","data.description":"Narzędzie to tworzy pliki które można wczytać w programie Tw2-Statistics (by DirtyPrank). Po wykonaniu zrzutów umieść je w folderze Dane. Uwaga! Akcje te wymagają dobrej jakości komputera w innym wypadku potrwa to bardzo długo.","data.dump":"Wybierz opcje wykonania zrzutu danych na twój komputer","data.players":"Gracze","data.tribes":"Plemiona","data.achievements":"Osiągnięcia",
"data.save":"Zapisz","data.reset":"Resetuj",logs:"Logi","logs.type":"Co?","logs.date":"Data","logs.noDumps":"Nie wykonano żadnych zrzutów danych","logs.clear":"Wyczyść logi","general.start":"Start","general.pause":"Pauza"},alert_sender:{title:"Wartownik",description:"Automatycznie wysyła informacje o nadchodzacych atakach do pw z 'Attacks' w nazwie.",activated:"Wartownik aktywowany",deactivated:"Wartownik skończył działanie"},army_helper:{title:"Hetman",army:"Wojsko","army.header":"Sprawdź ilość jednostek w wioskach","army.check":"Zlicz","army.troops":"Wojsko","army.unit":"Jednostka","army.available":"Dostępne","army.own":"Posiadane","army.in-town":"W wioskach","army.support":"Wsparcie","army.recruiting":"Rekrutacja","army.total":"Wszystko","army.deffensive":"Defensywne jednostki","army.offensive":"Ofensywne jednostki","army.special-troops":"Specjalne jednostki",balancer:"Balanser","balancer.balance":"Balansuj","balancer.all":"Wszystkie typy wojsk",
"balancer.textall":"Zbalansuj po równo całe swoje wojsko.","balancer.unit":"Jednostka","balancer.one-province":"Wybierz prowincję w której chcesz zbalansować wojska(opcjonalnie)","balancer.add_village":"Wybierz wioskę...","balancer.no_village":"Nie wybrano wioski","balancer.add_map_selected":"Wybrana wioska z mapy","balancer.selected":"Wybierz","balancer.additional":"Dodatkowe ustawienia","balancer.textunit":"Zbalansuj po równo wojska danego typu.","balancer.group":"Grupa","balancer.textgroup":"Zbalansuj po równo wojska w danej grupie wiosek.","balancer.unit-group":"Grupa/Jednostka","balancer.textunit-group":"Zbalansuj po równo wojska w danej grupie wiosek dany typ jednostki.(np miecznik w grupie Deff)",logs:"Logi","logs.origin":"Wioska źródłowa","logs.target":"Wioska cel","logs.unit":"Jednostka","logs.group":"Grupa","logs.date":"Data","logs.noBalances":"Nie przesłano żadnych wojsk","logs.clear":"Wyczyść logi",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",
light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz"},attack_view:{title:"Strażnik",filter_types:"Rodzaj",filter_show_attacks_tooltip:"Pokaż ataki",filter_show_supports_tooltip:"Pokaż wsparcia",filter_show_relocations_tooltip:"Pokaż przeniesienia",filter_incoming_units:"Nadchodzące jednostki",commands_copy_arrival_tooltip:"Kopiuj czas dotarcia.",commands_copy_backtime_tooltip:"Kopiuj czas powrotu.",commands_set_remove_tooltip:"Wstaw rozkaz wycofania wojsk przed dotarciem ataku do Kolejki rozkazów.",command_type_tooltip:"Rodzaj",slowest_unit_tooltip:"Najwolniejsza jednostka",command_type:"Rodzaj",slowest_unit:"Co?",actions:"Dostępne akcje",no_incoming:"Brak nadchodzących wojsk.",copy:"Kopiuj",current_only_tooltip:"Tylko aktywna wioska",arrive:"Dotrze",arrivetime:"Czas dotarcia skopiowany!",backtime:"Czas powrotu skopiowany!",
...
description:"Automatycznie przywraca uzdrowione jednostki ze szpitala.",activated:"Medyk aktywowany",deactivated:"Medyk skończył działanie"},auto_withdraw:{title:"Dezerter",description:"Automatycznie wycofuje wojska przed nadchodzącymi atakami jeśli to nie szlachcic lub trebuchet.",activated:"Dezerter aktywowany",deactivated:"Dezerter skończył działanie"},battle_calculator:{title:"Kalkulator",battle:"Bitwa","battle.simulate":"Symuluj","battle.predamage":"Uszkodzenia wstępne","battle.bonuses":"Modyfikatory bitewne","battle.options":"Szybkie opcje","battle.header":"Kalkulator bitewny","battle.id":"Wioska","battle.killrateA":"Procent strat","battle.attackBashpoint":"Ofensywne punkty bojowe","battle.strentghAttack":"Siła bojowa off","battle.killrateD":"Procent strat","battle.defenceBashpoint":"Defensywne punkty bojowe","battle.strentghDefend":"Siła bojowa deff","battle.attackModifier":"Modyfikator ataku","battle.defenceModifier":"Modyfikator obrony",
"battle.provisions":"Całkowity prowiant","battle.killedprovisions":"Prowiant stracony","battle.doublestrength":"Szał berków?","battle.no_village":"Nie wybrano wioski","battle.add_map_selected":"Wybrana wioska z mapy","battle.selected":"Wybierz","battle.strongesttype":"Najwięcej wojsk typu","battle.beds":"Liczba łóżek - uratowanych jednostek","battle.survivedprovisions":"Prowiant ocalały","battle.attacker":"Atakujący","battle.unit":"Jednostka","battle.amount":"Ilość","battle.loses":"Straty","battle.revived":"Uleczone","battle.survivors":"Ocalałe","battle.survivorsA":"Ocalałe(z uratowanymi)","battle.survivorsD":"Ocalałe(bez uratowanych)","battle.defender":"Obrońca","battle.damage":"Uszkodzenia taranów","battle.damageCatapult":"Uszkodzenia katapult","battle.downgrade":"Mur uszkodzony z poziomu ","battle.downgradeCatapult":" uszkodzony/a z poziomu ","battle.to":" do ","battle.insert":"Wstaw ocalałe jednostki","battle.insertvillage":"Wstaw z wioski","battle.insertpreset":"Wstaw z szablonu",
"battle.insertV":"Wstaw jednostki z wioski - atakujący","battle.insertP":"Wstaw jednostki z szablonu - atakujący","battle.insertVD":"Wstaw jednostki z wioski - broniący","battle.insertPD":"Wstaw jednostki z szablonu - broniący","battle.faith":"Wiara","battle.morale":"Morale","battle.luck":"Szczęście","battle.wall":"Mury","battle.nightbonus":"Bonus nocny","battle.leader":"Wielki mistrz","battle.medic":"Medyk","battle.doctor":"Doktor","battle.attack-bonus":"Mistrzostwo broni","battle.iron-walls":"Żelazny mur","battle.clinique":"Klinika","battle.hospital":"Szpital","battle.equip":"Przedmioty rycerza","battle.halberd":"Halabarda Guan Yu","battle.longsword":"Długi miecz Paracelsusa","battle.battleaxe":"Bojowy topór Thorgarda","battle.longbow":"Łuk Nimroda","battle.lance":"Lanca Mieszka","battle.compositebow":"Kompozytowy łuk Nimroda","battle.banner":"Chorągiew Baptystów","battle.star":"Gwiazda poranna Karola","battle.bonfire":"Pochodnia Alethei","battle.scepter":"Berło Vasca",
"battle.target":"Cel katapult","battle.target-level":"Poziom budynku",bunker:"Bunkier","bunker.header":"Kalkulator optymalnego offa na bunkier",troops:"Koszt jednostek","troops.calculate":"Policz","troops.header":"Kalkulator kosztów produkcji jednostek","troops.th":"Koszty produkcji","troops.units":"Jednostki","troops.building":"Budynki","troops.barracks":"Koszary","troops.preceptory":"Komturia","troops.effects":"Efekty","troops.domination":"Dominacja","troops.training":"Intensywny trening","troops.order":"Zakon","troops.templars":"Zakon Templariuszy","troops.teutonic":"Zakon Krzyżacki","troops.none":"Brak","troops.wood":"Drewno","troops.iron":"Żelazo","troops.clay":"Glina","troops.food":"Prowiant","troops.attack":"Siła ataku","troops.load":"Ładowność","troops.buildtime":"Czas rekrutacji","troops.defarc":"Obrona przeciw łucznikom","troops.definf":"obrona przeciw piechocie","troops.defcav":"Obrona przeciw kawaleri","troops.attackarc":"Siła ataku łuczników",
"troops.attackinf":"Siła ataku piechoty","troops.attackcav":"Siła ataku kawaleri","troops.discipline":"Dyscyplina","troops.speed":"Prędkość",bashpoints:"Punkty Bojowe","bashpoints.calculate":"Policz","bashpoints.header":"Kalkulator punktów bojowych","bashpoints.th":"Punkty bojowe","bashpoints.attacker":"Jako atakujący","bashpoints.defender":"Jako obrońca","bashpoints.killed":"Zniszczone jednostki",headquarter:"Ratusz",barracks:"Koszary",tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",none:"Brak",without:"Brak",level_1:"1",level_2:"2",level_3:"3",level_4:"4",level_5:"5",level_6:"6",level_7:"7",level_8:"8",level_9:"9",level_10:"10",level_11:"11",level_12:"12",level_13:"13",level_14:"14",level_15:"15",level_16:"16",level_17:"17",level_18:"18",level_19:"19",
level_20:"20"},builder_queue:{title:"Budowniczy",started:"Budowniczy Uruchomiony",stopped:"Budowniczy Zatrzymany",settings:"Ustawienia",settings_village_groups:"Buduj w wioskach z grupy",settings_building_sequence:"Szablon kolejki budowy",settings_building_sequence_final:"Finalne poziomy budynków",settings_priorize_farm:"Priorytet farmy, jeżeli brakuje prowiantu",settings_saved:"Ustawienia zapisane!",logs_no_builds:"Nie rozpoczęto żadnej rozbudowy",logs_clear:"Wyczyść logi",sequences:"Szablony",sequences_move_up:"Przesuń w górę",sequences_move_down:"Przesuń w dół",sequences_add_building:"Dodaj budynek",sequences_select_edit:"Wybierz szablon do edytowania",sequences_edit_sequence:"Edytuj szablon",select_group:"Wybierz grupę",add_building_success:"%d dodany na pozycji %d",add_building_limit_exceeded:"%d osiągnął/eła maksymalny poziom (%d)",position:"Pozycja",remove_building:"Usuń budynek z listy",clone:"Klonuj",remove_sequence:"Usuń szablon",
...
builder_queue_name_sequence_modal:{title:"Nazwa szablonu"},builder_queue_remove_sequence_modal:{title:"Usuń szablon",text:"Jesteś pewny, że chcesz usunąć ten szablon? Jeśli ten szablon jest teraz aktywny, inny szablon zostanie wybrany i Budowniczy zatrzyma się."},command_queue:{title:"Generał",attack:"Atak",support:"Wsparcie",relocate:"Przeniesienie",sent:"wysłany/e",activated:"włączony",deactivated:"wyłączony",expired:"przedawniony/e",removed:"usunięty/e",added:"dodany/e",general_clear:"Wyczyść logi",general_next_command:"Następny rozkaz",add_basics:"Podstawowe informacje",add_origin:"Źródło",add_selected:"Aktywna wioska",add_target:"Cel",add_map_selected:"Wybrana wioska na mapie",date_type_arrive:"Czas dotarcia na cel",date_type_out:"Czas wyjścia z  twojej wioski",add_current_date:"Obecny czas",add_current_date_plus:"Zwiększ czas o 100 milisekund.",add_current_date_minus:"Zmniejsz czas o 100 milisekund.",add_travel_times:"Czas podróży jednostek",add_date:"Czas/Data",
add_no_village:"Wybierz wioskę...",add_village_search:"Znajdź wioskę...",add_clear:"Wyczyść pola",add_insert_preset:"Wybierz szablon",queue_waiting:"Rozkazy",queue_none_added:"Brak dodanych rozkazów.",queue_sent:"Rozkazy wysłane",queue_none_sent:"Brak wysłanych rozkazów.",queue_expired:"Przedawnione rozkazy",queue_none_expired:"Brak przedawnionych rozkazów.",queue_remove:"Usuń rozkaz z listy",queue_filters:"Filtruj rozkazy",filters_selected_village:"Pokaż tylko rozkazy z aktywnej wioski",filters_barbarian_target:"Pokaż tylko rozkazy na wioski barbarzyńskie",filters_attack:"Pokaż ataki",filters_support:"Pokaż wsparcia",filters_relocate:"Pokaż przeniesienia",filters_text_match:"Filtruj za pomocą tekstu...",command_out:"Czas wyjścia",command_time_left:"Pozostały czas",command_arrive:"Czas dotarcia",error_no_units_enough:"Brak wystarczającej liczby jednostek do wysłania rozkazu!",error_not_own_village:"Wioska źródłowa nie należy do ciebie!",error_origin:"Nieprawidłowa wioska źródłowa!",
...
settings_show_only_custom_highlights:"Pokaż tylko własne podświetlenia",settings_highlight_own:"Podświetl własne wioski",settings_highlight_selected:"Podświetl wybraną wioskę",settings_highlight_diplomacy:"Automatycznie podświetl plemienną dyplomację",settings_colors_background:"Tło minimapy",settings_colors_province:"Granica prowincji",settings_colors_continent:"Granica królestwa",settings_colors_quick_highlight:"Szybkie podświetlenie",settings_colors_tribe:"Własne plemie",settings_colors_player:"Własne wioski",settings_colors_selected:"Wybrana wioska",settings_colors_ghost:"Niezaładowana wioska",settings_colors_ally:"Sojusznik",settings_colors_pna:"PON",settings_colors_enemy:"Wróg",settings_colors_other:"Pozostałe wioski graczy",settings_colors_barbarian:"Wioski barbarzyńskie",settings_colors_view_reference:"Wskaźnik obecnej pozycji",settings_reset:"Ustawienia zresetowane",tooltip_village:"Wioska",tooltip_village_points:"Punkty wioski",tooltip_player:"Nazwa gracza",
tooltip_player_points:"Punkty gracza",tooltip_tribe:"Plemię",tooltip_tribe_points:"Punkty plemienia",tooltip_province:"Prowincja",no_highlights:"Brak utworzonych podświetleń",reset_confirm_title:"Resetuj ustawienia",reset_confirm_text:"Wszystkie ustawienia zostaną przywrócone do domyślnych.",reset_confirm_highlights_text:"Jak również wszystkie podświetlenia zostaną usunięte.",default_village_colors_info:"Informacje o domyślnych kolorach wiosek","entry/id":"Wioska/gracz/plemie","tooltip.village-id":"Id wioski","tooltip.player-id":"Id gracza","tooltip.tribe-id":"Id plemienia"},mint_helper:{title:"Mincerz",description:"Automatycznie wybija monety gdy włączony.",activated:"Mincerz aktywowany",deactivated:"Mincerz deaktywowany"},power_helper:{title:"Bunkry",powers:"Siły jednostek",bunker:"Postaw Bunkier",beatbunker:"Rozwal Bunkier","power-troops":"Procent skuteczności w obronie-ataku","power-deff":"Całkowita skuteczność obronna - średnia ważona",all:"Wszystkie jednostki",
"offensive-units":"Ofensywne jednostki","power-off":"Całkowita skuteczność w ataku - średnia ważona","defensive-units":"Defensywne jednostki",deffense:"Obrona","battle.defender":"Jednostki broniące - najlepsza kombinacja","battle.unit":"Jednostka","battle.amount":"Ilość","unit-types":"Czym dysponujesz?",wall:"Mury","fullfarm.set":"Pełna zagroda?(zalecane - minimalizuje straty)",fullfarm:"Jeśli włączona kalkuluje na podstawie pełnej zagrody 21480 prowiantu. Jeśli nie to oblicza minimalny potrzebny deff do obrony.(Nie przyjęto wartości takich jak morale wroga na nas oraz szczęście/pech)",level:"Poziom","battle.off":"Jednostki atakujące",offense:"Atak","check.btn":"Kalkuluj","battle.iron-walls":"Żelazny Mur","battle.attacker":"Jednostki atakujące - najlepsza kombinacja","battle.deff":"Jednostki broniące",provisions:"Prowiant",without:"Brak",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",
heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",level_1:"1",level_2:"2",level_3:"3",level_4:"4",level_5:"5",level_6:"6",level_7:"7",level_8:"8",level_9:"9",level_10:"10",level_11:"11",level_12:"12",level_13:"13",level_14:"14",level_15:"15",level_16:"16",level_17:"17",level_18:"18",level_19:"19",level_20:"20"},prank_helper:{title:"Błazen",rename:"Nazwy wiosek","rename.all":"Zmień nazwy wszystkich wiosek","rename.type":"Typ","rename.prologue":"Prefix/Przedrostek","rename.center":"Nazwa właściwa","rename.epilogue":"Sufix/Przyrostek","rename.name":"Wpisz tekst...","rename.from":"Od (liczba lub litera startowa)","rename.to":"Do (liczba lub litera końcowa)","rename.char":"Wpisz znak...","rename.tip":"Litera lub liczba","rename.clear":"Wyczyść","rename.start":"Zmień","rename.province":"Zmień nazwy wiosek w wybranej prowincji","rename.add_village":"Wybierz wioskę...",
"rename.no_village":"Nie wybrano wioski","rename.add_map_selected":"Wybrana wioska z mapy","rename.selected":"Wybierz","rename.group":"Zmień nazwy wiosek w wybranej grupie","rename.groups":"Grupa/y",logs:"Logi","logs.village":"Wioska","logs.old":"Stara nazwa","logs.new":"Nowa nazwa","logs.date":"Data","logs.noRenames":"Nie zmieniono żadnych nazw wiosek","logs.clear":"Wyczyść logi",decrease:"Malejąco/Z-A",increase:"Rosnąco/A-Z",random:"Domyślnie"},preset_asigner:{title:"Administrator",presets:"Szablony","presets.asign":"Przypisz","presets.all":"Wszystkie szablony","presets.textall":"Przypisz wszystkie szablony do wszystkich wiosek.","presets.name":"Szablony z nazwą","presets.textname":"Przypisz szablony zawierające wskazaną frazę do wszystkich wiosek.","presets.or":"Lub wybierz z listy","presets.group":"Szablony do grupy","presets.textgroup":"Przypisz wszystkie szablony do wybranej grupy wiosek.","presets.name-group":"Szablony - zaawansowane przypisywanie",
...
tavern:"Tawerna",hospital:"Szpital",preceptory:"Komturia",chapel:"Kaplica",church:"Kościół",academy:"Akademia",rally_point:"Plac",statue:"Piedestał",market:"Rynek",timber_camp:"Tartak",clay_pit:"Kopalnia gliny",iron_mine:"Huta żelaza",farm:"Farma",warehouse:"Magazyn",wall:"Mur",spear:"Pikinier",sword:"Miecznik",axe:"Topornik",archer:"Łucznik",light_cavalry:"Lekki kawalerzysta",mounted_archer:"Łucznik konny",heavy_cavalry:"Ciężki kawalerzysta",ram:"Taran",catapult:"Katapulta",doppelsoldner:"Berserker",trebuchet:"Trebusz",snob:"Szlachcic",knight:"Rycerz",firefox_shill:""}}},n='en_us',l={en_dk:'en_us',pt_pt:'pt_br'};function o(t){t=E.call(l,t)?l[t]:t,e.setJSON(i[t]||i[n])}let s={init:function(){if(t)return!1;t=!0,o(a.loc.ale),a.$watch('loc.ale',(function(e,t){e!==t&&o(a.loc.ale)}))}};return s})),define('two/Settings',['two/utils','Lockr'],(function(e,i){const l=function(e,t){let a={};for(let i in e)E.call(t,i)?angular.equals(e[i],t[i])||(a[i]=t[i]):a[i]=e[i];return!angular.equals({},a)&&a
},o=function(){return{name:g('i18n')('disabled',a.loc.ale,'common'),value:!1}},s=function(e,t){let a={};for(let i in t)(e[i].updates||[]).forEach((function(e){a[e]=!0}));return!angular.equals(a,{})&&a};let r=function(e){this.settingsMap=e.settingsMap,this.storageKey=e.storageKey,this.defaults=function(e){let t={};for(let a in e)t[a]=e[a].default;return t}(this.settingsMap),this.settings=angular.merge({},this.defaults,i.get(this.storageKey,{})),this.events={settingsChange:e.onChange||T},this.injected=!1};return r.prototype.get=function(e){return angular.copy(this.settings[e])},r.prototype.getAll=function(){return angular.copy(this.settings)},r.prototype.getDefault=function(e){return E.call(this.defaults,e)?this.defaults[e]:t},r.prototype.store=function(){i.set(this.storageKey,this.settings)},r.prototype.set=function(e,t,a){if(!E.call(this.settingsMap,e))return!1;const i=this.settingsMap[e];'number'===i.inputType&&(t=parseInt(t,10),E.call(i,'min')&&(t=Math.max(i.min,t)),
E.call(i,'max')&&(t=Math.min(i.max,t)));const n=angular.copy(this.settings);this.settings[e]=t;const o=angular.copy(this.settings),r=l(n,o);if(!r)return!1;const c=s(this.settingsMap,r);return this.store(),this.updateScope(),this.events.settingsChange.call(this,r,c,a||{}),!0},r.prototype.setAll=function(e,t){const a=angular.copy(this.settings);for(let t in e)if(E.call(this.settingsMap,t)){const a=this.settingsMap[t];let i=e[t];'number'===a.inputType&&(i=parseInt(i,10),E.call(a,'min')&&(i=Math.max(a.min,i)),E.call(a,'max')&&(i=Math.min(a.max,i))),this.settings[t]=i}const i=angular.copy(this.settings),n=l(a,i);if(!n)return!1;const o=s(this.settingsMap,n);return this.store(),this.updateScope(),this.events.settingsChange.call(this,n,o,t||{}),!0},r.prototype.reset=function(e,t){return this.set(e,this.defaults[e],t),!0},r.prototype.resetAll=function(e){return this.setAll(angular.copy(this.defaults),e),!0},r.prototype.each=function(e){for(let t in this.settings){
if(!E.call(this.settingsMap,t))continue;let a=this.settingsMap[t];'checkbox'===a.inputType?e.call(this,t,!!this.settings[t],a):e.call(this,t,this.settings[t],a)}},r.prototype.onChange=function(e){'function'==typeof e&&(this.events.settingsChange=e)},r.prototype.injectScope=function(t,a){this.injected={$scope:t,opt:a},t.settings=this.encode(a),e.each(this.settingsMap,(function(e,a){'select'===e.inputType&&t.$watch((function(){return t.settings[a]}),(function(i){e.multiSelect?i.length||(t.settings[a]=[o()]):i||(t.settings[a]=o())}),!0)}))},r.prototype.updateScope=function(){if(!this.injected)return!1;this.injected.$scope.settings=this.encode(this.injected.opt)},r.prototype.encode=function(e){let t={};const i=n.getPresetList().getPresets(),l=n.getGroupList().getGroups();return e=e||{},this.each((function(n,s,r){if('select'===r.inputType){if(!s&&r.disabledOption)return void(t[n]=r.multiSelect?[o()]:o());switch(r.type){case'presets':if(r.multiSelect){let e=[];s.forEach((function(t){
i[t]&&e.push({name:i[t].name,value:t})})),t[n]=e.length?e:[o()]}else{if(!i[s]&&r.disabledOption)return void(t[n]=o());t[n]={name:i[s].name,value:s}}break;case'groups':if(r.multiSelect){let e=[];s.forEach((function(t){l[t]&&e.push({name:l[t].name,value:t,leftIcon:l[t].icon})})),t[n]=e.length?e:[o()]}else{if(!l[s]&&r.disabledOption)return void(t[n]=o());t[n]={name:l[s].name,value:s}}break;default:t[n]={name:e.textObject?g('i18n')(s,a.loc.ale,e.textObject):s,value:s},e.multiSelect&&(t[n]=[t[n]])}}else t[n]=s})),t},r.prototype.decode=function(e){let t={};for(let a in e){let i=this.settingsMap[a];if('select'===i.inputType)if(i.multiSelect)if(1===e[a].length&&!1===e[a][0].value)t[a]=[];else{let i=[];e[a].forEach((function(e){i.push(e.value)})),t[a]=i}else t[a]=e[a].value;else t[a]=e[a]}return t},r.encodeList=function(e,t){let i=[];switch((t=t||{}).disabled&&i.push(o()),t.type){case'keys':for(let t in e)i.push({name:t,value:t});break;case'groups':for(let t in e){let a=e[t];i.push({
name:a.name,value:a.id,leftIcon:a.icon})}break;case'presets':for(let t in e){let a=e[t];i.push({name:a.name,value:a.id})}break;case'values':default:for(let n in e){let l=e[n];i.push({name:t.textObject?g('i18n')(l,a.loc.ale,t.textObject):l,value:l})}}return i},r.disabledOption=o,r})),define('two/mapData',['conf/conf'],(function(e){let t=[],i=[],n=!1,r=!1,c=[];angular.extend(s,{MAP_DATA_LOADED:'map_data_loaded'});let d={load:function(e=T,d){if(d)r=!1;else{if(n)return c.push(e);if(r)return e(t)}c.push(e),n=!0;let p=[];for(let e=0;e<i.length;e++)for(let t=0;t<i[e].length;t++)p.push(i[e][t]);let u=[];return p.forEach((function(e){let a=new Promise((function(a,i){l.emit(o.MAP_GET_MINIMAP_VILLAGES,e,(function(e){if(e.message)return i(e.message);e.villages.length&&(t=t.concat(e.villages)),a()}))}));u.push(a)})),Promise.all(u).then((function(){n=!1,r=!0,a.$broadcast(s.MAP_DATA_LOADED),c.forEach((function(e){e(t)})),c=[]})).catch((function(e){console.error(e.message)}))},getVillages:function(){
return t},isLoaded:function(){return r}};return function(){const t=Math.ceil(e.MAP_SIZE/306),a=Math.ceil(e.MAP_SIZE/306);for(let n=0;n<t;n++){i.push([]);let t=306*n,l=306..bound(0,t+306).bound(0,e.MAP_SIZE-t);t=t.bound(0,e.MAP_SIZE);for(let o=0;o<a;o++){let a=306*o,s=306..bound(0,a+306).bound(0,e.MAP_SIZE-a);a=a.bound(0,e.MAP_SIZE),i[n].push({x:t,y:a,width:l,height:s})}}}(),d})),define('two/ui',['conf/conf','conf/cdn','two/ready'],(function(e,t,i){let n,l,o,r,c={},d={},p=!1,u=document.querySelector('head'),g=injector.get('httpService'),m=injector.get('templateManagerService'),b=injector.get('$templateCache');return m.load=function(i,n,l){let o;const s=function(e,t,i,l){b.put(o.substr(1),e),angular.isFunction(n)&&n(e,t,i,l),a.$$phase||a.$apply()},r=function(e,t,a,i){angular.isFunction(l)&&l(e,t,a,i)};o=0!==i.indexOf('!')?e.TEMPLATE_PATH_EXT.join(i):i.substr(1),b.get(o.substr(1))?s(b.get(o.substr(1)),304):t.versionMap[o]?g.get(o,s,r):s(d[o],304)},c.init=function(){if(p)return!1
;let e=document.querySelector('#wrapper'),t=document.createElement('div'),a=document.createElement('div'),s=document.createElement('div'),d=document.createElement('div'),u=document.createElement('div'),g=document.createElement('div'),m=document.createElement('div'),b=document.createElement('div');t.className='two-menu-container',e.appendChild(t),a.className='two-menu-container2',e.appendChild(a),s.className='two-menu-container3',e.appendChild(s),d.className='two-menu-container4',e.appendChild(d),u.className='two-main-button',u.style.display='none',g.className='two-economy-button',g.style.display='none',m.className='two-intrigue-button',m.style.display='none',b.className='two-other-button',b.style.display='none',t.appendChild(u),a.appendChild(g),s.appendChild(m),d.appendChild(b),n=document.createElement('div'),n.className='two-menu',t.appendChild(n),l=document.createElement('div'),l.className='two-menu2',a.appendChild(l),o=document.createElement('div'),o.className='two-menu3',
s.appendChild(o),r=document.createElement('div'),r.className='two-menu4',d.appendChild(r),p=!0,
...
i((function(){u.style.display='block',g.style.display='block',m.style.display='block',b.style.display='block'}),['map'])},c.addTemplate=function(e,t){d[e]=t},c.addStyle=function(e){let t=document.createElement('style');t.type='text/css',t.appendChild(document.createTextNode(e)),u.appendChild(t)},c.addMenuButton=function(e,t,i){let l=document.createElement('div');return l.className='btn-border btn-orange button',l.innerHTML=e,l.style.order=t,n.appendChild(l),'string'==typeof i&&(l.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),l.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),n.appendChild(l)},c.addMenuButton2=function(e,t,i){let n=document.createElement('div');return n.className='btn-border btn-orange button',n.innerHTML=e,n.style.order=t,l.appendChild(n),'string'==typeof i&&(n.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),
n.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),l.appendChild(n)},c.addMenuButton3=function(e,t,i){let n=document.createElement('div');return n.className='btn-border btn-orange button',n.innerHTML=e,n.style.order=t,o.appendChild(n),'string'==typeof i&&(n.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),n.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),o.appendChild(n)},c.addMenuButton4=function(e,t,i){let n=document.createElement('div');return n.className='btn-border btn-orange button',n.innerHTML=e,n.style.order=t,r.appendChild(n),'string'==typeof i&&(n.addEventListener('mouseenter',(function(e){a.$broadcast(s.TOOLTIP_SHOW,'twoverflow-tooltip',i,!0,e)})),n.addEventListener('mouseleave',(function(){a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip')}))),r.appendChild(n)},c.addDivisor=function(e){let t=document.createElement('div')
;t.className='divisor',t.style.order=e,n.appendChild(t)},c.addDivisor2=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,l.appendChild(t)},c.addDivisor3=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,o.appendChild(t)},c.addDivisor4=function(e){let t=document.createElement('div');t.className='divisor',t.style.order=e,r.appendChild(t)},c.isInitialized=function(){return p},c})),require(['two/ui'],(function(e){if(e.isInitialized())return!1;e.init()})),require(['two/language','two/ready','Lockr'],(function(e,t,i){t((function(){e.init(),function(){const e=i.get('twoverflow_version','1.0.0');if("2.0.0".endsWith('dev'))return!1;const t=function(e){if(/\d+\.\d+\.\d+/.test(e))return parseInt(e.split('.').reduce((e,t)=>e+t),10)};if(t("2.0.0")>t(e)){
const e='https://gitlab.com/relaxeaza/twoverflow/blob/master/CHANGELOG.md',t=g('i18n')('check_changes',a.loc.ale,'common'),n=g('i18n')('firefox_shill',a.loc.ale,'common'),l=g('i18n')('new_version',a.loc.ale,'common',"2.0.0");a.$broadcast(s.NOTIFICATION_NEW,{message:`[b]${l}[/b]\n[url=${e}]${t}[/url]\n\n${n}`}),i.set('twoverflow_version',"2.0.0")}}()}))})),define('Lockr',(function(e,t){'use strict';return t.prefix='',t._getPrefixedKey=function(e,t){return(t=t||{}).noPrefix?e:this.prefix+e},t.set=function(e,t,a){const i=this._getPrefixedKey(e,a);try{localStorage.setItem(i,JSON.stringify({data:t}))}catch(e){}},t.get=function(e,t,a){const i=this._getPrefixedKey(e,a);let n;try{n=JSON.parse(localStorage.getItem(i))}catch(e){n=localStorage[i]?{data:localStorage.getItem(i)}:null}return null===n?t:'object'==typeof n&&void 0!==n.data?n.data:t},t})),define('two/about',[],(function(){let e=!1,t={isInitialized:function(){return e},init:function(){e=!0}};return t})),
define('two/about/ui',['two/ui'],(function(e){let t;const i=function(e){t.selectedTab=e},n=function(){t=a.$new(),t.selectTab=i,c.getModal('!twoverflow_about_window',t)};return function(){e.addDivisor4(189),e.addMenuButton4('O mnie',190).addEventListener('click',(function(){n()})),
...
e.addStyle('#two-about{padding:42px 0 0px 0;position:relative;height:100%}#two-about .box-paper a{font-weight:bold;color:#3f2615;text-decoration:none}#two-about .box-paper a:hover{text-shadow:0 1px 0 #000;color:#fff}#two-about .logo{text-align:center;margin-bottom:8px}#two-about table td{padding:0 10px}#two-about table td:first-child{text-align:right;width:20%}')}})),require(['two/ready','two/about','two/about/ui'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map'])})),define('two/activityTool',['two/Settings','two/activityTool/settings','two/activityTool/settings/map','two/ready','queues/EventQueue'],(function(e,t,a,i,n){let l,o,r=!1,c=!1;const d='activity_tool_settings',p={init:function(){r=!0,l=new e({settingsMap:a,storageKey:d}),l.onChange((function(){o=l.getAll()})),o=l.getAll(),console.log('activityTool settings',o)},start:function(){c=!0,n.trigger(s.ACTIVITY_TOOL_START)},stop:function(){c=!1,n.trigger(s.ACTIVITY_TOOL_STOP)},
getSettings:function(){return l},isInitialized:function(){return r},isRunning:function(){return c}};return p})),define('two/activityTool/events',[],(function(){angular.extend(s,{ACTIVITY_TOOL_START:'activity_tool_start',ACTIVITY_TOOL_STOP:'activity_tool_stop'})})),define('two/activityTool/ui',['two/ui','two/activityTool','two/activityTool/settings','two/activityTool/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,l,o,r){let d,p,u;const g={DATA:'data',LOGS:'logs'},m=function(e){d.selectedTab=e},b=function(){p.setAll(p.decode(d.settings)),r.notif('success','Settings saved')},T=function(){t.isRunning()?t.stop():t.start()},E=function(){d.running=!0,u.classList.remove('btn-orange'),u.classList.add('btn-red'),r.notif('success','Example module started')},_=function(){d.running=!1,u.classList.remove('btn-red'),u.classList.add('btn-orange'),r.notif('success','Example module stopped')},f=function(){d=a.$new(),d.SETTINGS=i,d.TAB_TYPES=g,d.running=t.isRunning(),
d.selectedTab=g.DATA,d.settingsMap=n,p.injectScope(d),d.selectTab=m,d.saveSettings=b,d.switchState=T;let e=new o('twoverflow_activity_tool_window',(function(){console.log('activityTool closed')}));e.register(s.ACTIVITY_TOOL_START,E),e.register(s.ACTIVITY_TOOL_STOP,_),c.getScreenWithInjectedScope('!twoverflow_activity_tool_window',d)};return function(){p=t.getSettings(),u=e.addMenuButton4('Statystyki',40),u.addEventListener('click',f),
...
e.addStyle('#two-activity-tool div[select]{float:right}#two-activity-tool div[select] .select-handler{line-height:28px}#two-activity-tool .range-container{width:250px}#two-activity-tool .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-activity-tool .textfield-border.fit{width:100%}#two-activity-tool th{text-align:center}#two-activity-tool .activityLog td{text-align:center}#two-activity-tool .activityLog .origin:hover{color:#fff;text-shadow:0 1px 0 #000}#two-activity-tool .activityLog .target:hover{color:#fff;text-shadow:0 1px 0 #000}#two-activity-tool .noDumps td{height:26px;text-align:center}#two-activity-tool .force-26to20{transform:scale(.8);width:20px;height:20px}')}})),define('two/activityTool/settings',[],(function(){return{PLAYERS:'players',TRIBES:'tribes',ACHIEVEMENTS:'achievements'}})),define('two/activityTool/settings/updates',(function(){return{}})),define('two/activityTool/settings/map',['two/activityTool/settings'],(function(e){return{
[e.PLAYERS]:{default:!1,inputType:'checkbox'},[e.TRIBES]:{default:!1,inputType:'checkbox'},[e.ACHIEVEMENTS]:{default:!1,inputType:'checkbox'}}})),require(['two/ready','two/activityTool','two/activityTool/ui','two/activityTool/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/alertSender',['queues/EventQueue','two/commandQueue','models/CommandModel','conf/unitTypes'],(function(e,t,a,i){let r;var c=injector.get('overviewService'),d=!1,p=!1,u=n.getSelectedCharacter().getGlobalInfo(),g={reverse:!1,column:'command_progress'},m=n.getSelectedCharacter(),b=m.tribeById[0],T=m.getVillageList(),E=[],_=m.data.character_id,f=m.data.character_name,w=[],h=[],A=[i.LIGHT_CAVALRY,i.HEAVY_CAVALRY,i.AXE,i.SWORD,i.RAM,i.SNOB,i.TREBUCHET];var v=function(){l.emit(o.TRIBE_GET_MEMBERLIST,{tribe:b},(function(e){for(var t=e.members,a=0;a<t.length;a++)h.push(t[a].id)})),T.forEach((function(e){E.push(e.getId())}))
;var e=u.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;l.emit(o.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:E},S),setTimeout(v,6e4)},S=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),h.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(w.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{w.push(i[n].command_id),i[n].slowestUnit=R(i[n]);var s=i[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),p='',u='';'sword'==i[n].slowestUnit?(u=' [color=03709d]MIECZNIK[/color]',p='sword'):'axe'==i[n].slowestUnit?(u=' [color=e21f1f]TOPORNIK[/color]',p='axe'):'ram'==i[n].slowestUnit?(u=' [color=730202]TARAN[/color]',p='ram'):'snob'==i[n].slowestUnit?(u=' [color=ffee00]SZLACHCIC[/color]',
p='snob'):'trebuchet'==i[n].slowestUnit?(u=' [color=494500]TREBUSZ[/color]',p='trebuchet'):'light_cavalry'==i[n].slowestUnit?(u=' [color=d96a19]LEKKA KAWALERIA[/color]',p='light_cavalry'):'heavy_cavalry'==i[n].slowestUnit&&(u=' [color=0111af]CIĘŻKA KAWALERIA[/color]',p='heavy_cavalry'),a.push('[size=large][b]Nadchodzący atak [/b]--- [/size][unit]'+p+'[/unit] [size=large][b]'+u+'[/b][/size][br][b][size=XL] Czas dotarcia: '+d+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+i[n].target_village_id+']'+i[n].target_village_name+'[/village][b] Gracz cel: [/b][player='+_+']'+f+'[/player][b] [br]Wioska pochodzenia: [/b][village='+i[n].origin_village_id+']'+i[n].origin_village_name+'[/village][b] Gracz atakujący: [/b][player='+i[n].origin_character_id+']'+i[n].origin_character_name+'[/player][/size]');var g=a.join();'snob'==p||'trebuchet'==p?('Hajduk Split'==f||'halfsack'==f||'Black Rider'==f?l.emit(o.MESSAGE_REPLY,{message_id:14378,message:g}):l.emit(o.MESSAGE_REPLY,{
message_id:4646,message:g}),a=[]):('Hajduk Split'==f||'halfsack'==f||'Black Rider'==f?l.emit(o.MESSAGE_REPLY,{message_id:14379,message:g}):l.emit(o.MESSAGE_REPLY,{message_id:4648,message:g}),a=[])}},R=function(e){var a=e.model.duration,i={},n={x:e.origin_x,y:e.origin_y},l={x:e.target_x,y:e.target_y},o=[];return A.forEach((function(a){i[a]=1,o.push({unit:a,duration:t.getTravelTime(n,l,i,e.command_type,{})})})),(o=o.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},y={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),p=!0,v()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),p=!1},isRunning:function(){return p},isInitialized:function(){return d}};return y})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),
define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton('Wartownik',60,g('i18n')('description',a.loc.ale,'alert_sender')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'alert_sender')))})),n.register(s.ALERT_SENDER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.ALERT_SENDER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.ALERT_SENDER_STARTED),opener}})),require(['two/ready','two/alertSender','two/alertSender/ui','Lockr','queues/EventQueue','two/alertSender/events'],(function(e,t,a,i,n){const l='alert_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),
n.register(s.ALERT_SENDER_STARTED,(function(){i.set(l,!0)})),n.register(s.ALERT_SENDER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/armyHelper',['two/Settings','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/settings/updates','two/armyHelper/types/unit','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c){let d,p,u=!1,g=!1,m=[],b=[];const T='army_helper_settings',E={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(E);const _=function(){m=[],b=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP3],i=p[t.GROUP4];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){b.push(e[t])}))},f={init:function(){u=!0,d=new e({settingsMap:i,storageKey:T}),
d.onChange((function(e,t){p=d.getAll(),t[l.GROUPS]&&_()})),p=d.getAll(),console.log('armyHelper settings',p),a.$on(s.GROUPS_CREATED,_),a.$on(s.GROUPS_DESTROYED,_),a.$on(s.GROUPS_UPDATED,_)},start:function(){g=!0,c.trigger(s.ARMY_HELPER_START)},stop:function(){g=!1,c.trigger(s.ARMY_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return f})),define('two/armyHelper/events',[],(function(){angular.extend(s,{ARMY_HELPER_START:'army_helper_start',ARMY_HELPER_STOP:'army_helper_stop'})})),define('two/armyHelper/ui',['two/ui','two/armyHelper','two/armyHelper/settings','two/armyHelper/settings/map','two/armyHelper/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p){let u,m,b,T=n.getGroupList();const E={ARMY:'army',BALANCER:'balancer',LOGS:'logs'},_=function(e){u.selectedTab=e},f=function(){m.setAll(m.decode(u.settings)),p.notif('success','Settings saved')},w=function(){
t.isRunning()?t.stop():t.start()},h=function(){u.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},A=function(){u.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},v=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'army_helper'))},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.ARMY,u.settingsMap=l,u.unit=r.encodeList(o,{textObject:'army_helper',disabled:!0}),m.injectScope(u),h(),u.selectTab=_,u.saveSettings=f,u.switchState=w;let e=new d('twoverflow_army_helper_window',(function(){console.log('armyHelper window closed')}));e.register(s.GROUPS_CREATED,h,!0),e.register(s.GROUPS_DESTROYED,h,!0),e.register(s.GROUPS_UPDATED,h,!0),e.register(s.ARMY_HELPER_START,A),e.register(s.ARMY_HELPER_STOP,v),
c.getScreenWithInjectedScope('!twoverflow_army_helper_window',u)};return function(){m=t.getSettings(),b=e.addMenuButton('Hetman',90),b.addEventListener('click',S),
...
KNIGHT:'knight'}})),require(['two/ready','two/armyHelper','two/armyHelper/ui','two/armyHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,p,u,g,m,b,T,E){let _,f,w=!1,h=injector.get('overviewService'),A=[],v=!1,S={},R={},y={reverse:!1,column:i.TIME_COMPLETED};const k='attack_view_filters',I={},x={},L=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}R=a,
R.village=S[c.VILLAGE]?[t]:[]},O=function(){B.loadCommands()},N=function(e,t){E.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},P=function(e,t){for(let e=0;e<A.length;e++)A[e].command_id===t.command_id&&A.splice(e,1);E.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<A.length;e++)A[e].target_village_id===t.village_id?(A[e].target_village_name=t.name,A[e].targetVillage.name=t.name):A[e].origin_village_id===t.village_id&&(A[e].origin_village_name=t.name,A[e].originVillage.name=t.name);E.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},C=function(e,t){R[c.VILLAGE].length&&(R[c.VILLAGE]=[t],B.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const l=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(l-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},U=function(e,t){return e.sort((function(e,a){
return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(T.hasTownDataInChunk(e.x,e.y)){const a=T.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),l=n.getSelectedCharacter().getId();let o,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===l&&e.id!==t.id}));if(r.length)o=U(r,e);else if(c.length)o=U(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);o=U(a,e)}}return t(o[0])}const i=b.scaledGridCoordinates(e.x,e.y,25,25,25);T.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},D=function(e){A=e.commands;for(let e=0;e<A.length;e++)h.formatCommand(A[e]),A[e].slowestUnit=z(A[e]);A=A.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[A])};let B={
loadCommands:function(){const e=_.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;l.emit(o.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:y.column,reverse:y.reverse?1:0,groups:[],command_types:R[c.COMMAND_TYPES],villages:R[c.VILLAGE]},D)},getCommands:function(){return A},getFilters:function(){return S},getSortings:function(){return y},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],L(),g.set(k,S),B.loadCommands()},toggleSorting:function(e){e===y.column?y.reverse=!y.reverse:(y.column=e,y.reverse=!1),B.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,l=i,o=l.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(p,(function(e){s[e]='*'})),v.addCommand(n,l,a,f.OUT,s,{},o,u.WALL),v.isRunning()||v.start()}))},commandQueueEnabled:function(){return!!v},isInitialized:function(){return w},init:function(){for(let e=0;e<d.length;e++)I[d[e]]=!0;for(let e in r)x[r[e]]=!0;try{v=require('two/commandQueue'),
f=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(x),[c.INCOMING_UNITS]:angular.copy(I),[c.VILLAGE]:!1};w=!0,_=n.getSelectedCharacter().getGlobalInfo(),S=g.get(k,t,!0),e((function(){L(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,C),a.$on(s.VILLAGE_NAME_CHANGED,M),a.$on(s.COMMAND_IGNORED,P),B.loadCommands()}),['initial_village'])}};return B})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,l,o,d,p,b,T,E,_,f){let w,h;const A=function(){return Date.now()/1e3},v=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');console.log(i),t.setCommander(e,i)},R=function(){let e=f('#two-attack-view').parent(),t=f('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},y=function(){const e=w.pagination.offset,t=w.pagination.limit
;w.visibleCommands=w.commands.slice(e,e+t),w.pagination.count=w.commands.length},k=function(){const e=Date.now();for(let t=0;t<w.commands.length;t++)100===w.commands[t].model.percent(e)&&w.commands.splice(t,1);y()},I=function(e,a){t.toggleFilter(e,a),w.filters=t.getFilters()},x=function(e){t.toggleSorting(e),w.sorting=t.getSortings()},L=function(){w.commands=t.getCommands()},O=function(){w.selectedVillageId=n.getSelectedVillage().getId()},N=function(){w=a.$new(),w.commandQueueEnabled=t.commandQueueEnabled(),w.commands=t.getCommands(),w.selectedVillageId=n.getSelectedVillage().getId(),w.filters=t.getFilters(),w.sorting=t.getSortings(),w.UNIT_TYPES=T,w.FILTER_TYPES=p,w.COMMAND_TYPES=d,w.UNIT_SPEED_ORDER=b,w.COLUMN_TYPES=o,w.pagination={count:w.commands.length,offset:0,loader:y,limit:m.getPaginationLimit()},w.openCharacterProfile=r.openCharacterProfile,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=u.jumpToVillage,w.now=A,w.copyTimeModal=v,w.removeTroops=S,w.switchWindowSize=R,
w.toggleFilter=I,w.toggleSorting=x,y();let e=new i('twoverflow_queue_window',(function(){_.timer.remove(k)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,L),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,L),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,L),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,L),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',w),_.timer.add(k)};return function(){h=e.addMenuButton('Strażnik',30),h.addEventListener('click',N),
...
}})),define('two/attackView/types/columns',[],(function(){return{ORIGIN_VILLAGE:'origin_village_name',COMMAND_TYPE:'command_type',TARGET_VILLAGE:'target_village_name',TIME_COMPLETED:'time_completed',ORIGIN_CHARACTER:'origin_character_name'}})),define('two/attackView/types/commands',[],(function(){return{ATTACK:'attack',SUPPORT:'support',RELOCATE:'relocate'}})),define('two/attackView/types/filters',[],(function(){return{COMMAND_TYPES:'command_types',VILLAGE:'village',INCOMING_UNITS:'incoming_units'}})),define('two/attackView/unitSpeedOrder',['conf/unitTypes'],(function(e){return[e.LIGHT_CAVALRY,e.HEAVY_CAVALRY,e.AXE,e.SWORD,e.RAM,e.SNOB,e.TREBUCHET]})),require(['two/ready','two/attackView','two/attackView/ui','two/attackView/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/autoCollector',['queues/EventQueue'],(function(e){let t=!1,i=!1,r=!0,c=0;const d=function(){l.emit(o.RESOURCE_DEPOSIT_GET_INFO,{})},p=function(){if(!i)return!1
;let e=n.getSelectedCharacter().getResourceDeposit();if(!e)return!1;if(e.getCurrentJob())return!1;let t=e.getCollectibleJobs();if(t)return a=t.shift(),void l.emit(o.RESOURCE_DEPOSIT_COLLECT,{job_id:a.id,village_id:n.getSelectedVillage().getId()});var a;let s=e.getReadyJobs();return s?function(e){l.emit(o.RESOURCE_DEPOSIT_START_JOB,{job_id:e.id})}(u(s)):void 0},u=function(e){return e.sort((function(e,t){return e.duration-t.duration}))[0]};let g={};return g.init=function(){t=!0,a.$on(s.RESOURCE_DEPOSIT_JOB_COLLECTIBLE,(function(){if(!r||!i)return!1;r=!1,setTimeout((function(){r=!0,p()}),1500)})),a.$on(s.RESOURCE_DEPOSIT_JOBS_REROLLED,p),a.$on(s.RESOURCE_DEPOSIT_JOB_COLLECTED,p),a.$on(s.RESOURCE_DEPOSIT_INFO,(function(e,t){p(),function(e){const t=1e3*e.time_next_reset-Date.now()+1e3;clearTimeout(c),c=setTimeout(d,t)}(t)}))},g.start=function(){e.trigger(s.AUTO_COLLECTOR_STARTED),i=!0,p()},g.stop=function(){e.trigger(s.AUTO_COLLECTOR_STOPPED),i=!1},g.isRunning=function(){return i},
g.isInitialized=function(){return t},g})),define('two/autoCollector/events',[],(function(){angular.extend(s,{AUTO_COLLECTOR_STARTED:'auto_collector_started',AUTO_COLLECTOR_STOPPED:'auto_collector_stopped',AUTO_COLLECTOR_SECONDVILLAGE_STARTED:'auto_collector_secondvillage_started',AUTO_COLLECTOR_SECONDVILLAGE_STOPPED:'auto_collector_secondvillage_stopped'})})),define('two/autoCollector/ui',['two/ui','two/autoCollector','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton2('Kolekcjoner',40,g('i18n')('description',a.loc.ale,'auto_collector')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),t.secondVillage.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_collector'))):(t.start(),t.secondVillage.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_collector')))})),n.register(s.AUTO_COLLECTOR_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),
n.register(s.AUTO_COLLECTOR_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_COLLECTOR_STARTED),opener}})),define('two/autoCollector/secondVillage',['two/autoCollector','two/utils','queues/EventQueue','helper/time','models/SecondVillageModel'],(function(e,t,i,r,c){let d=!1,p=!1,u=!1,g=injector.get('secondVillageService');const m=function(){var e;e=b,l.emit(o.SECOND_VILLAGE_GET_INFO,{},(function(t){if(g.hasFinishedLastJob(t.jobs))u=!0,l.emit(o.SECOND_VILLAGE_FINISH_VILLAGE),T.stop();else{let a=new c(t);n.getSelectedCharacter().setSecondVillage(a),e()}}))},b=function(){let e=n.getSelectedCharacter().getSecondVillage();if(!p||!e||!e.isAvailable())return!1;const a=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t<r.server2ClientTime(e[a].time_completed))return e[a];return!1}(e.data.jobs);if(a){const e=r.server2ClientTime(a.time_completed)-Date.now()+1e3;return setTimeout(m,e),!1}
const i=function(e){const t=Date.now();for(let a in e)if(e[a].time_started&&e[a].time_completed&&t>=r.server2ClientTime(e[a].time_completed)&&!e[a].collected)return a;return!1}(e.data.jobs);if(i)return s=i,void l.emit(o.SECOND_VILLAGE_COLLECT_JOB_REWARD,{village_id:n.getSelectedVillage().getId(),job_id:s});var s;const c=g.getCurrentDayJobs(e.data.jobs,e.data.day),d=g.getCollectedJobs(e.data.jobs),u=n.getSelectedVillage().getResources().getResources(),b=g.getAvailableJobs(c,d,u,[]);if(b){const e=function(e){let a=!1;return t.each(e,(function(e){return a=e,!1})),a}(b);!function(e,t){l.emit(o.SECOND_VILLAGE_START_JOB,{village_id:n.getSelectedVillage().getId(),job_id:e.id},t)}(e,(function(){const t=b[e];t?setTimeout(m,1e3*t.duration+1e3):setTimeout(m,6e4)}))}};let T={start:function(){if(!d||u)return!1;i.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STARTED),p=!0,m()},stop:function(){if(!d)return!1;i.trigger(s.AUTO_COLLECTOR_SECONDVILLAGE_STOPPED),p=!1},isRunning:function(){return p},
isInitialized:function(){return d},init:function(){if(!g.isFeatureActive())return!1;d=!0,l.emit(o.SECOND_VILLAGE_GET_INFO,{},(function(e){g.hasFinishedLastJob(e.jobs)?(u=!0,l.emit(o.SECOND_VILLAGE_FINISH_VILLAGE)):(a.$on(s.SECOND_VILLAGE_VILLAGE_CREATED,m),a.$on(s.SECOND_VILLAGE_JOB_COLLECTED,m))}))}};e.secondVillage=T})),require(['two/ready','two/autoCollector','two/autoCollector/ui','Lockr','queues/EventQueue','two/autoCollector/secondVillage','two/autoCollector/events'],(function(e,t,a,i,n){const l='auto_collector_active';if(t.isInitialized())return!1;e((function(){t.init(),t.secondVillage.init(),a(),e((function(){i.get(l,!1,!0)&&(t.start(),t.secondVillage.start()),n.register(s.AUTO_COLLECTOR_STARTED,(function(){i.set(l,!0)})),n.register(s.AUTO_COLLECTOR_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/autoFoundator',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,i=!1;const r=function(){if(!i)return!1;console.log('Fundator uruchomiony'),
n.getSelectedCharacter().getVillageList().forEach((function(e,t){var a=e.getResources().getComputed(),i=a.wood,n=a.clay,s=a.iron,r=i.currentStock,c=n.currentStock,d=s.currentStock,p=Math.round(.02*r)+1,u=Math.round(.02*d)+1,g=Math.round(.02*c)+1;setTimeout((function(){l.emit(o.TRIBE_SKILL_DONATE,{village_id:e.getId(),crowns:0,resources:{wood:p,clay:g,iron:u}})}),t*Math.random()*3e3),console.log('Wykonano darowizne na plemię: '+e.getName()+' drewno: '+p+', glina: '+g+', żelazo: '+u)})),setTimeout(c,1e3)};function c(){setTimeout(r,36e5)}let d={init:function(){a=!0},start:function(){t.trigger(s.AUTO_FOUNDATOR_STARTED),i=!0,r()},stop:function(){t.trigger(s.AUTO_FOUNDATOR_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return a}};return d})),define('two/autoFoundator/events',[],(function(){angular.extend(s,{AUTO_FOUNDATOR_STARTED:'auto_foundator_started',AUTO_FOUNDATOR_STOPPED:'auto_foundator_stopped'})})),
define('two/autoFoundator/ui',['two/ui','two/autoFoundator','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return e.addDivisor3(71),l=e.addMenuButton3('Fundator',70,g('i18n')('description',a.loc.ale,'auto_foundator')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_foundator'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_foundator')))})),n.register(s.AUTO_FOUNDATOR_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.AUTO_FOUNDATOR_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_FOUNDATOR_STARTED),opener}})),require(['two/ready','two/autoFoundator','two/autoFoundator/ui','Lockr','queues/EventQueue','two/autoFoundator/events'],(function(e,t,a,i,n){const l='auto_foundator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){
i.get(l,!1,!0)&&t.start(),n.register(s.AUTO_FOUNDATOR_STARTED,(function(){i.set(l,!0)})),n.register(s.AUTO_FOUNDATOR_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/autoHealer',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,i=!1;let r={init:function(){a=!0}};return r.start=function(){t.trigger(s.AUTO_HEALER_STARTED),i=!0,function(){if(!i)return!1;console.log('Medyk uruchomiony'),n.getSelectedCharacter().getVillageList().forEach((function(e,t){let a=e.hospital.patients.healed,i=a.units;0==a.length?console.log('W wiosce '+e.getName()+' brak jednostek do wyleczenia'):setTimeout((function(){a.forEach((function(t,a){setTimeout((function(){l.emit(o.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),3e3*a),console.log('W wiosce: '+e.getName()+' wyleczono: '+i)}))}),5e3*t)})),console.log('Medyk zatrzymany'),r.stop()}()},r.stop=function(){t.trigger(s.AUTO_HEALER_STOPPED),i=!1},r.isRunning=function(){return i},r.isInitialized=function(){
return a},r})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton('Medyk',120,g('i18n')('description',a.loc.ale,'auto_healer')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_healer'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_healer')))})),n.register(s.AUTO_HEALER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.AUTO_HEALER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_HEALER_STARTED),opener}})),
require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue','two/autoHealer/events'],(function(e,t,a,i,n){const l='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.AUTO_HEALER_STARTED,(function(){i.set(l,!0)})),n.register(s.AUTO_HEALER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/autoWithdraw',['two/utils','queues/EventQueue'],(function(e,t){let a=!1,i=!1,n={init:function(){a=!0},start:function(){t.trigger(s.AUTO_WITHDRAW_STARTED),i=!0},stop:function(){t.trigger(s.AUTO_WITHDRAW_STOPPED),i=!1},isRunning:function(){return i},isInitialized:function(){return a}};return n})),define('two/autoWithdraw/events',[],(function(){angular.extend(s,{AUTO_WITHDRAW_STARTED:'auto_withdraw_started',AUTO_WITHDRAW_STOPPED:'auto_withdraw_stopped'})})),define('two/autoWithdraw/ui',['two/ui','two/autoWithdraw','two/utils','queues/EventQueue'],(function(e,t,i,n){let l
;return function(){return l=e.addMenuButton('Dezerter',40,g('i18n')('description',a.loc.ale,'auto_withdraw')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'auto_withdraw'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'auto_withdraw')))})),n.register(s.AUTO_WITHDRAW_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.AUTO_WITHDRAW_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.AUTO_WITHDRAW_STARTED),opener}})),require(['two/ready','two/autoWithdraw','two/autoWithdraw/ui','Lockr','queues/EventQueue','two/autoWithdraw/events'],(function(e,t,a,i,n){const l='auto_withdraw_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.AUTO_WITHDRAW_STARTED,(function(){i.set(l,!0)})),n.register(s.AUTO_WITHDRAW_STOPPED,(function(){i.set(l,!1)}))
}),['initial_village'])}))})),define('two/battleCalculator',['two/Settings','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/settings/updates','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c,d,p,u,g,m,b,T,E,_,f){let w,h,A=!1,v=!1,S=[];const R='battle_calculator_settings',y={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3},k={[o.HALBERD_OF_GUAN_YU]:'spear',[o.PARACELSUS_LONGSWORD]:'sword',[o.THORGARDS_BATTLE_AXE]:'axe',[o.NIMRODS_LONGBOW]:'archer',[o.MIESZKOS_LANCE]:'lc',[o.NIMRODS_COMPOSITE_BOW]:'ma',[o.BAPTISTES_BANNER]:'hc',
[o.CAROLS_MORNING_STAR]:'ram',[o.ALETHEIAS_BONFIRE]:'catapult',[o.VASCOS_SCEPTER]:'snob'},I={[c.HEADQUARTER]:'headquarter',[c.WAREHOUSE]:'warehouse',[c.FARM]:'farm',[c.RALLY_POINT]:'rally_point',[c.STATUE]:'statue',[c.WALL]:'wall',[c.TAVERN]:'tavern',[c.BARRACKS]:'barracks',[c.PRECEPTORY]:'preceptory',[c.HOSPITAL]:'hospital',[c.CLAY_PIT]:'clay_pit',[c.IRON_MINE]:'iron_mine',[c.TIMBER_CAMP]:'timber_camp',[c.CHAPEL]:'chapel',[c.CHURCH]:'church',[c.MARKET]:'market',[c.ACADEMY]:'academy'},x={[d.TEUTONIC_ORDER]:'teutonic',[d.TEMPLAR_ORDER]:'templar'},L={[u.NO_CHURCH]:50,[u.LEVEL_1]:100,[u.LEVEL_2]:105,[u.LEVEL_3]:110},O={[p.NO_WALL]:0,[p.LEVEL_1]:5,[p.LEVEL_2]:10,[p.LEVEL_3]:15,[p.LEVEL_4]:20,[p.LEVEL_5]:25,[p.LEVEL_6]:30,[p.LEVEL_7]:35,[p.LEVEL_8]:40,[p.LEVEL_9]:45,[p.LEVEL_10]:50,[p.LEVEL_11]:55,[p.LEVEL_12]:60,[p.LEVEL_13]:65,[p.LEVEL_14]:70,[p.LEVEL_15]:75,[p.LEVEL_16]:80,[p.LEVEL_17]:85,[p.LEVEL_18]:90,[p.LEVEL_19]:95,[p.LEVEL_20]:100},N={[g.LEVEL_1]:2,[g.LEVEL_2]:4,[g.LEVEL_3]:6,
[g.LEVEL_4]:8,[g.LEVEL_5]:10},P={[m.LEVEL_1]:1,[m.LEVEL_2]:2,[m.LEVEL_3]:3,[m.LEVEL_4]:4,[m.LEVEL_5]:5},M={[b.LEVEL_1]:100,[b.LEVEL_2]:200,[b.LEVEL_3]:300,[b.LEVEL_4]:400,[b.LEVEL_5]:500,[b.LEVEL_6]:600,[b.LEVEL_7]:700,[b.LEVEL_8]:800,[b.LEVEL_9]:900,[b.LEVEL_10]:1e3},C={[T.LEVEL_1]:100,[T.LEVEL_2]:129,[T.LEVEL_3]:167,[T.LEVEL_4]:215,[T.LEVEL_5]:278,[T.LEVEL_6]:359,[T.LEVEL_7]:464,[T.LEVEL_8]:599,[T.LEVEL_9]:774,[T.LEVEL_10]:1e3},z={[E.LEVEL_1]:4,[E.LEVEL_2]:8,[E.LEVEL_3]:12,[E.LEVEL_4]:16,[E.LEVEL_5]:20};console.log(x,z,C,M,P,N,O,L,y,k,I);const U=function(){S=[];const e=n.getPresetList().getPresets();h[t.PRESET].forEach((function(t){S.push(e[t])}))},G={init:function(){A=!0,w=new e({settingsMap:i,storageKey:R}),w.onChange((function(e,t){h=w.getAll(),t[l.PRESETS]&&U()})),h=w.getAll(),console.log('battleCalculator settings',h),_((function(){U()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,U),a.$on(s.ARMY_PRESET_DELETED,U)},start:function(){v=!0,f.trigger(s.BATTLE_CALCULATOR_START)},
stop:function(){v=!1,console.log('battleCalculator stop'),f.trigger(s.BATTLE_CALCULATOR_STOP)},getSettings:function(){return w},isInitialized:function(){return A},isRunning:function(){return v}};return G})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),
define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p,u,g,m,b,T,E,_,f,w,h){let A,v,S,R=n.getPresetList();const y={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},k=function(e){A.selectedTab=e},I=function(){v.setAll(v.decode(A.settings)),h.notif('success','Settings saved')},x=function(){t.isRunning()?t.stop():t.start()},L=function(){A.presets=f.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},O=function(){
A.running=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),h.notif('success','battleCalculator started')},N=function(){A.running=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),h.notif('success','battleCalculator stopped')},P=function(){A=a.$new(),A.SETTINGS=i,A.TAB_TYPES=y,A.running=t.isRunning(),A.selectedTab=y.BATTLE,A.settingsMap=l,A.catapulttarget=f.encodeList(d,{textObject:'battle_calculator',disabled:!0}),A.knightitem=f.encodeList(o,{textObject:'battle_calculator',disabled:!0}),A.itemlevel=f.encodeList(r,{textObject:'battle_calculator',disabled:!0}),A.order=f.encodeList(p,{textObject:'battle_calculator',disabled:!0}),A.wall=f.encodeList(u,{textObject:'battle_calculator',disabled:!0}),A.church=f.encodeList(g,{textObject:'battle_calculator',disabled:!0}),A.weaponmaster=f.encodeList(m,{textObject:'battle_calculator',disabled:!0}),A.ironwalls=f.encodeList(b,{textObject:'battle_calculator',disabled:!0}),A.clinique=f.encodeList(T,{
textObject:'battle_calculator',disabled:!0}),A.hospital=f.encodeList(E,{textObject:'battle_calculator',disabled:!0}),A.training=f.encodeList(_,{textObject:'battle_calculator',disabled:!0}),v.injectScope(A),L(),A.selectTab=k,A.saveSettings=I,A.switchState=x;let e=new w('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.ARMY_PRESET_UPDATE,L,!0),e.register(s.ARMY_PRESET_DELETED,L,!0),e.register(s.BATTLE_CALCULATOR_START,O),e.register(s.BATTLE_CALCULATOR_STOP,N),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',A)};return function(){v=t.getSettings(),S=e.addMenuButton4('Kalkulator',10),S.addEventListener('click',P),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,u,g,m,b,T,E,_){let f,w,h,A=injector.get('buildingService'),v=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),R=!1,y=!1;const k={};let I,x,L,O,N,P=!0;const M='builder_queue_log',C='builder_queue_settings',z=function(){const e=G();if(!P)return F.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void D(t))}))},U=function(){G().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
S.canBeFinishedForFree(a,t)&&v.instantBuild(a,b.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=I.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},D=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(k);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),q(t))return!1;n.some((function(a){if(++i[a]>t[a])return A.compute(e),B(e,a,(function(t,a){t&&a.job&&(T.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),Y(e.getId(),a.job))})),!0}))},B=function(e,t,a){const i=W(e,t);if(i===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=h[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:b.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},q=function(e){for(let t in e)if(e[t]<h[t])return!1;return!0},Y=function(e,t){let a={time:_.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),E.set(M,L),!0};let F={};return F.start=function(){if(!P)return T.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;y=!0,f=setInterval(z,6e4),w=setInterval(U,6e3),e((function(){G().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||p.initializeVillage(t)})),z(),U()}),['all_villages_ready']),T.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){y=!1,clearInterval(f),
clearInterval(w),T.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return y},F.isInitialized=function(){return R},F.getSettings=function(){return O},F.getLogs=function(){return L},F.clearLogs=function(){L=[],E.set(M,L),T.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?u.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),u.SEQUENCE_SAVED):u.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),u.SEQUENCE_SAVED):u.SEQUENCE_INVALID:u.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return u.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),T.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){R=!0,L=E.get(M,[],!0),x=n.getSelectedCharacter(),I=n.getGroupList(),O=new i({settingsMap:c,storageKey:C}),O.onChange((function(e,t,a){N=O.getAll(),y&&t[d.ANALYSE]&&z(),a.quiet||T.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)k[m[e]]=0;P=Object.keys(N[r.BUILDING_SEQUENCES]).length,h=!!P&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(k);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!y)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);D(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
function(e){let t={};for(let i in e)E.call(e,i)&&(t[i]=a(e[i]));return t}(t)})),define('two/builderQueue/events',[],(function(){angular.extend(s,{BUILDER_QUEUE_JOB_STARTED:'builder_queue_job_started',BUILDER_QUEUE_START:'builder_queue_start',BUILDER_QUEUE_STOP:'builder_queue_stop',BUILDER_QUEUE_UNKNOWN_SETTING:'builder_queue_settings_unknown_setting',BUILDER_QUEUE_CLEAR_LOGS:'builder_queue_clear_logs',BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED:'builder_queue_building_orders_updated',BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED:'builder_queue_building_orders_added',BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED:'builder_queue_building_orders_removed',BUILDER_QUEUE_SETTINGS_CHANGE:'builder_queue_settings_change',BUILDER_QUEUE_NO_SEQUENCES:'builder_queue_no_sequences',COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),
define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,p,u,b,T,_,f,w,h,A){let v,S,R,y,k=n.getGroupList(),I={},x=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const P={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,C={},z={},U=!1,G=!1;const D=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},B=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},V=function(e,t){switch(i.addBuildingSequence(e,t)){case _.SEQUENCE_SAVED:return!0;case _.SEQUENCE_EXISTS:return d.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case _.SEQUENCE_INVALID:return d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}}
;O.generateSequences=function(){const e=y.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(O.sequencesAvail=t,!t)return!1;O.generateBuildingSequence(),O.generateBuildingSequenceFinal(),O.updateVisibleBuildingSequence()},O.generateBuildingSequence=function(){const e=v.settings[b.ACTIVE_SEQUENCE].value,t=v.settings[b.BUILDING_SEQUENCES][e],a=n.getGameData().getBuildings();let i={};if(O.sequencesAvail=!!t,!O.sequencesAvail)return!1;for(let e in f)i[f[e]]=0;O.buildingSequence=t.map((function(e){let t=++i[e],l=a[e].individual_level_costs[t],o='not-reached';return!function(e,t){return n.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=n.getSelectedVillage().getBuildingQueue().getQueue();let i=!1;return a.some((function(a){if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(o='progress'):o='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:A.readableSeconds(l.build_time),levelPoints:I[e][t-1],state:o}}))},
O.generateBuildingSequenceFinal=function(e){const t=v.settings[b.ACTIVE_SEQUENCE].value,a=v.settings[b.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in R)i[e]={level:0,order:R[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=R[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=I[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},O.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequence.offset,t=v.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),v.pagination.buildingSequence.count=O.buildingSequence.length},
O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,I[a]=[];for(let e=1;e<=i.max_level;e++){let n=D(i.points,i.points_factor,e)-t;t+=n,I[a].push(n)}}},L.moveUp=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),B(e,a,a-1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(U=!0)},L.moveDown=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),B(e,a,a+1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(U=!0)},L.addBuilding=function(e,t,a=1){const i=t-1;let n=L.buildingSequence.slice(),l={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,l)
;return L.buildingSequence=L.updateLevels(n,e),L.updateVisibleBuildingSequence(),U=!0,!0},L.removeBuilding=function(e){const t=L.buildingSequence[e].building;L.buildingSequence.splice(e,1),L.buildingSequence=L.updateLevels(L.buildingSequence,t),L.updateVisibleBuildingSequence(),U=!0},L.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let l=e[n];l.building===t?a<R[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(l)}return i},L.generateBuildingSequence=function(){const e=y.get(b.BUILDING_SEQUENCES),t=Object.keys(e).length;if(L.sequencesAvail=t,!t)return!1;const a=e[L.selectedSequence.value];let i={};for(let e in f)i[f[e]]=0;L.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),L.updateVisibleBuildingSequence()},L.updateVisibleBuildingSequence=function(){const e=v.pagination.buildingSequenceEditor.offset,t=v.pagination.buildingSequenceEditor.limit;L.visibleBuildingSequence=L.buildingSequence.slice(e,e+t),
v.pagination.buildingSequenceEditor.count=L.buildingSequence.length},L.updateBuildingSequence=function(){const e=L.selectedSequence.value,t=L.buildingSequence.map((function(e){return e.building}));switch(i.updateBuildingSequence(e,t)){case _.SEQUENCE_SAVED:U=!1;break;case _.SEQUENCE_NO_EXISTS:d.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case _.SEQUENCE_INVALID:d.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},L.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),i.removeSequence(L.selectedSequence.value),U=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},L.modal.addBuilding=function(){
let e=a.$new();e.buildings=[],e.position=L.lastAddedIndex,e.indexLimit=L.buildingSequence.length+1,e.buildingsData=n.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(L.lastAddedBuilding,a.loc.ale,'building_names'),value:L.lastAddedBuilding};for(let t in R)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,n=e.amount,l=g('i18n')(t,a.loc.ale,'building_names'),o=R[t].max_level;L.lastAddedBuilding=t,L.lastAddedIndex=i,L.addBuilding(t,i,n)?(e.closeWindow(),d.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',l,i))):d.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',l,o))},c.getModal('!twoverflow_builder_queue_add_building_modal',e)},L.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=L.selectedSequence.name,i=v.settings[b.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){
...
},(function(t){C[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},z[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},N.clearLogs=function(){i.clearLogs()};const W=function(){let e=a.$new();const t=[f.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return d.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;V(e.name,t)&&(v.settings[b.ACTIVE_SEQUENCE]={name:e.name,value:e.name},v.settings[b.BUILDING_SEQUENCES][e.name]=t,Y(),O.selectedSequence={name:e.name,value:e.name},L.selectedSequence={name:e.name,value:e.name},O.generateSequences(),L.generateBuildingSequence(),e.closeWindow(),q(P.SEQUENCES))},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},q=function(e){v.selectedTab=e},Y=function(){y.setAll(y.decode(v.settings)),U=!1},F=function(){i.isRunning()?i.stop():i.start()},j=function(e,t){let i=a.$new();i.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),
i.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),i.submitText=g('i18n')('discard',a.loc.ale,'common'),i.cancelText=g('i18n')('cancel',a.loc.ale,'common'),i.switchColors=!0,i.submit=function(){i.closeWindow(),e&&e()},i.cancel=function(){i.closeWindow(),t&&t()},c.getModal('modal_attention',i)},H=function(){U?j((function(){M()})):M()},K={updateGroups:function(){v.groups=u.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=y.get(b.BUILDING_SEQUENCES);v.sequences=u.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){O.generateSequences()},generateBuildingSequencesEditor:function(){L.generateBuildingSequence()},updateLogs:function(){v.logs=i.getLogs(),N.updateVisibleLogs()},clearLogs:function(){d.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),K.updateLogs()},buildingSequenceUpdate:function(e,t){const i=y.get(b.BUILDING_SEQUENCES);v.settings[b.BUILDING_SEQUENCES][t]=i[t],
v.settings[b.ACTIVE_SEQUENCE].value===t&&O.generateSequences(),d.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=y.get(b.BUILDING_SEQUENCES);v.settings[b.BUILDING_SEQUENCES][t]=i[t],K.updateSequences(),d.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete v.settings[b.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(E.call(e,t))return t;return!1}(v.settings[b.BUILDING_SEQUENCES]);L.selectedSequence={name:i,value:i},K.updateSequences(),L.generateBuildingSequence(),y.get(b.ACTIVE_SEQUENCE)===t&&(y.set(b.ACTIVE_SEQUENCE,i,{quiet:!0}),O.generateSequences()),d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){v.running=!0},stopped:function(){v.running=!1}},Q=function(){const e=y.get(b.ACTIVE_SEQUENCE)
;v=a.$new(),v.selectedTab=P.SETTINGS,v.TAB_TYPES=P,v.SETTINGS=b,v.running=x,v.pagination={},v.settingsMap=y.settingsMap,v.villagesLabel=z,v.villagesInfo=C,v.editorView=L,v.editorView.buildingSequence={},v.editorView.visibleBuildingSequence=[],v.editorView.selectedSequence={name:e,value:e},v.editorView.lastAddedBuilding=f.HEADQUARTER,v.editorView.lastAddedIndex=1,v.settingsView=O,v.settingsView.buildingSequence={},v.settingsView.buildingSequenceFinal={},v.logsView=N,v.logsView.logs=i.getLogs(),v.selectTab=q,v.switchBuilder=F,v.saveSettings=Y,v.createSequence=W,v.openVillageInfo=r.openVillageInfo,y.injectScope(v),K.updateGroups(),K.updateSequences(),v.pagination.buildingSequence={count:O.buildingSequence.length,offset:0,loader:O.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},v.pagination.buildingSequenceEditor={count:L.buildingSequence.length,offset:0,loader:L.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},v.pagination.logs={count:N.logs.length,offset:0,
loader:N.updateVisibleLogs,limit:m.getPaginationLimit()},N.updateVisibleLogs(),O.generateSequences(),L.generateBuildingSequence();let t=new w('twoverflow_builder_queue_window');t.register(s.GROUPS_UPDATED,K.updateGroups,!0),t.register(s.GROUPS_CREATED,K.updateGroups,!0),t.register(s.GROUPS_DESTROYED,K.updateGroups,!0),t.register(s.VILLAGE_SELECTED_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_UPGRADING,K.generateBuildingSequences,!0),t.register(s.BUILDING_LEVEL_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDING_TEARING_DOWN,K.generateBuildingSequences,!0),t.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,K.generateBuildingSequences,!0),t.register(s.BUILDER_QUEUE_JOB_STARTED,K.updateLogs),t.register(s.BUILDER_QUEUE_CLEAR_LOGS,K.clearLogs),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,K.buildingSequenceUpdate),t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,K.buildingSequenceAdd),
t.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,K.buildingSequenceRemoved),t.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,K.saveSettings),t.register(s.BUILDER_QUEUE_START,K.started),t.register(s.BUILDER_QUEUE_STOP,K.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',v),M=v.closeWindow,v.closeWindow=H,v.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&K.generateBuildingSequences()})),v.$watch('editorView.selectedSequence.value',(function(e,t){G?G=!1:e!==t&&(U?j((function(){K.generateBuildingSequencesEditor(),U=!1}),(function(){v.editorView.selectedSequence={name:t,value:t},G=!0})):K.generateBuildingSequencesEditor())}))};return function(){R=n.getGameData().getBuildings(),O.generateBuildingsLevelPoints(),y=i.getSettings(),S=e.addMenuButton2('Budowniczy',20),S.addEventListener('click',Q),h.register(s.BUILDER_QUEUE_START,(function(){x=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),
d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),h.register(s.BUILDER_QUEUE_STOP,(function(){x=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
updates:[a.ANALYSE],inputType:'number',min:0,max:6e5},[t.PRIORIZE_FARM]:{default:!0,inputType:'checkbox',updates:[a.ANALYSE]}}})),define('two/builderQueue/sequenceStatus',[],(function(){return{SEQUENCE_NO_EXISTS:'sequence_no_exists',SEQUENCE_EXISTS:'sequence_exists',SEQUENCE_INVALID:'sequence_invalid',SEQUENCE_SAVED:'sequence_saved'}})),require(['two/ready','two/builderQueue','two/builderQueue/ui','two/builderQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/commandQueue',['two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','helper/time','helper/math','struct/MapData','Lockr','conf/buildingTypes','conf/officerTypes','conf/unitTypes'],(function(t,a,i,r,c,d,p,u,g,m,b,T,_,f,w){
const h=Object.values(c),A=Object.values(a),v=Object.values(w),S=Object.values(f),R=Object.values(_);let y,k=[],I={},x=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},P=function(e){return e<g.gameTime()+y},M=function(e){k.push(e)},C=function(e){I[e.id]=e},z=function(){
T.set(d.QUEUE_COMMANDS,k)},U=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return E.call(e,'x')&&E.call(e,'y')&&U(e.x)&&U(e.y)};let D={initialized:!1};return D.init=function(){y=t.getTimeOffset(),D.initialized=!0,x=T.get(d.QUEUE_SENT,[],!0),L=T.get(d.QUEUE_EXPIRED,[],!0),function(){const e=T.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?D.expireCommand(e,i.TIME_LIMIT):(M(e),C(e))}))}(),setInterval((function(){k.length&&k.some((function(e){if(!P(e.sendTime))return!0;O?D.sendCommand(e):D.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&k.length&&(e.returnValue=!0)}))},D.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const l=a.unitInfo.units;let o={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=l[t].available))return}else if(e<0){if((e=l[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>l[t].available)return s=i.NOT_ENOUGH_UNITS,!1;o[t]=e})),angular.equals({},o)&&(s=i.NOT_ENOUGH_UNITS),s||o}(e);if('string'==typeof a)return D.expireCommand(e,a);e.units=a,l.emit(o.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),T.set(d.QUEUE_SENT,x),D.removeCommand(e,i.COMMAND_SENT),u.trigger(s.COMMAND_QUEUE_SEND,e)},D.expireCommand=function(e,t){!function(e){L.push(e)}(e),T.set(d.QUEUE_EXPIRED,L),D.removeCommand(e,t)},D.addCommand=function(e,i,l,o,s,r,d,u){let m={},T={};return new Promise((function(E,y){if(!G(e))return y(p.INVALID_ORIGIN);if(!G(i))return y(p.INVALID_TARGET);if(!t.isValidDateTime(l))return y(p.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!v.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return y(p.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return y(p.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(T[t]=!0)})))return y(p.INVALID_OFFICER_TYPE)}return h.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&T[f.SUPPORTER]&&delete T[f.SUPPORTER],'string'!=typeof u||R.includes(u)?(u=!(d!==c.ATTACK||!m[w.CATAPULT])&&(u||_.HEADQUARTER),A.includes(o)?void Promise.all([new Promise(t=>b.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>b.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return y(p.INVALID_ORIGIN);if(!i)return y(p.INVALID_TARGET);const s=t.getTimeFromString(l),r=t.getTravelTime(e,i,m,d,T,!0),c=o===a.ARRIVE?s-r:s,b=o===a.ARRIVE?s:s+r;if(P(c))return y(p.ALREADY_SENT);const _={id:t.guid(),travelTime:r,arriveTime:b,sendTime:c,origin:e,target:i,date:l,dateType:o,units:m,officers:T,type:d,catapultTarget:u,countdown:c-g.gameTime()};M(_),C(_),k=k.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),E(_)})):y(p.INVALID_DATE_TYPE)):y(p.INVALID_CATAPULT_TARGET)):y(p.RELOCATE_DISABLED):y(p.INVALID_COMMAND_TYPE)}))},D.removeCommand=function(e,t){delete I[e.id];const a=k.some((function(t,a){if(t.id==e.id)return k.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:u.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:u.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:u.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:u.trigger(s.COMMAND_QUEUE_REMOVE,e)}else u.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},D.clearRegisters=function(){T.set(d.QUEUE_EXPIRED,[]),T.set(d.QUEUE_SENT,[]),L=[],x=[]},D.start=function(e){O=!0,u.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},D.stop=function(){O=!1,u.trigger(s.COMMAND_QUEUE_STOP)},D.isRunning=function(){return O},D.getWaitingCommands=function(){return k},D.getWaitingCommandsObject=function(){return I},D.getSentCommands=function(){return x},
D.getExpiredCommands=function(){return L},D.filterCommands=function(e,t,a){const i=N[e];return(a||k).filter((function(e){return i(e,t)}))},D})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,l,o,d,p,u,m,b,T,E,_,f,w){let h,A,v,S,R,y=n.getGameData(),k=y.getOrderedUnitNames(),I=y.getOrderedOfficerNames(),x=n.getPresetList(),L=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let P,M,C,z=[],U={},G={};const D={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},B=[p.SELECTED_VILLAGE,p.BARBARIAN_TARGET,p.ALLOWED_TYPES,p.TEXT_MATCH],V=function(e,t){L=t.data},W=function(){L=!1},q=function(e){
const t=new Date(e||_.gameTime()+l.getTimeOffset()),a=t.getMilliseconds(),i=_.zerofill(a-a%100,3),n=_.zerofill(t.getSeconds(),2),o=_.zerofill(t.getMinutes(),2);return _.zerofill(t.getHours(),2)+':'+o+':'+n+':'+i+' '+_.zerofill(t.getDate(),2)+'/'+_.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},Y=function(e,t){return l.isValidDateTime(e)?(e=l.getTimeFromString(e),q(e+=t)):''},F=function(){if(h.isValidDate=l.isValidDateTime(R.date),!R.origin||!R.target)return;const e=!!h.isValidDate&&l.getTimeFromString(R.date),t=h.selectedDateType.value===o.ARRIVE;l.each(u,(function(a){l.each(D,(function(i,n){const o=l.getTravelTime(R.origin,R.target,i,a,R.officers,!0);h.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(o),h.travelTimes[a][n].status=e?j(t?e-o:e):'neutral'}))}))},j=function(e){return e&&h.isValidDate?_.gameTime()+P<e?'valid':'invalid':'neutral'},H=function(){R.dateType=h.selectedDateType.value,w.set(m.LAST_DATE_TYPE,h.selectedDateType.value),F()},K=function(){
R.catapultTarget=h.catapultTarget.value},Q=function(){const e=h.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];h.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},R.units=angular.copy(t.units),R.officers=angular.copy(t.officers),t.catapult_target&&(R.catapultTarget=t.catapult_target,h.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},h.showCatapultSelect=!0)},X=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=_.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),_.timer.add(e.updateCountdown)},Z=function(){h.waitingCommands=t.getWaitingCommands()},J=function(){h.sentCommands=t.getSentCommands()},$=function(){h.expiredCommands=t.getExpiredCommands()},ee=function(){let e=h.waitingCommands;B.forEach((function(a){h.activeFilters[a]&&(e=t.filterCommands(a,h.filtersData,e))})),
h.visibleWaitingCommands=e},te=function(e){0===R.units[e]&&(R.units[e]='')},ae=function(e){''===R.units[e]&&(R.units[e]=0)},ie=function(){h.showCatapultSelect=!!R.units.catapult},ne=function(e){h.selectedTab=e},le=function(){const e=n.getSelectedVillage().data;R.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:v.getId()}},oe=function(){if(!L)return l.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(L.x,L.y,1,1,(function(e){R.target=e}))},se=function(){R.date=q()},re=function(){if(!R.date)return!1;R.date=Y(R.date,100)},ce=function(){if(!R.date)return!1;R.date=Y(R.date,-100)},de=function(){R.units=angular.copy(U),R.officers=angular.copy(G),R.catapultTarget="wall",h.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},h.showCatapultSelect=!1},pe=function(e){t.addCommand(R.origin,R.target,R.date,R.dateType,R.units,R.officers,e,R.catapultTarget).then((function(e){Z(),ee(),X(e),
l.notif('success',me(e.type,'added'))})).catch((function(t){switch(t){case b.INVALID_ORIGIN:l.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case b.INVALID_TARGET:l.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case b.INVALID_DATE:l.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case b.NO_UNITS:l.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case b.RELOCATE_DISABLED:l.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case b.ALREADY_SENT:l.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},ue=function(){t.clearRegisters(),J(),$()},ge=function(){t.isRunning()?t.stop():t.start()},me=function(e,t,i){return i&&(e=i+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},be=function(e,t){h.activeFilters[e]=!h.activeFilters[e],
t&&(h.filtersData[p.ALLOWED_TYPES][e]=!h.filtersData[p.ALLOWED_TYPES][e]),ee()},Te=function(){h.activeFilters[p.TEXT_MATCH]=h.filtersData[p.TEXT_MATCH].length>0,ee()},Ee={updatePresets:function(){h.presets=l.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;R[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},h.searchQuery[i]=''},removeCommand:function(e,t){_.timer.remove(t.updateCountdown)||l.notif('error','Error stopping command countdown. Command still removed.'),Z(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),l.notif('success',me(t.type,'removed'))},removeError:function(){l.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),Z(),ee(),l.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),Z(),ee(),l.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),Z(),ee(),
l.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){_.timer.remove(t.updateCountdown)||l.notif('error','Error stopping command countdown. Command still sent.'),J(),Z(),ee(),l.notif('success',me(t.type,'sent'))},start:function(e,a){if(h.running=t.isRunning(),a.disableNotif)return!1;l.notif('success',me('title','activated'))},stop:function(){h.running=t.isRunning(),l.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){R.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){R.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{_.timer.remove(e.updateCountdown)})}},_e=function(){const e=w.get(m.LAST_DATE_TYPE,o.OUT,!0);let b;h=a.$new(),h.selectedTab=N,h.inventory=n.getInventory(),h.presets=l.obj2selectOptions(x.getPresets()),h.travelTimes={},l.each(u,(function(e){h.travelTimes[e]={},l.each(D,(function(t,a){h.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),h.unitOrder=S,h.officers=y.getOrderedOfficerNames(),h.searchQuery={origin:'',target:''},h.isValidDate=!1,h.dateTypes=f.toActionList(o,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),h.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},h.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},h.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},h.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},h.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Ee.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},h.showCatapultSelect=!!R.units.catapult,h.attackableBuildings=z,h.commandData=R,
h.activeFilters=M,h.filtersData=C,h.running=t.isRunning(),h.waitingCommands=t.getWaitingCommands(),h.visibleWaitingCommands=t.getWaitingCommands(),h.sentCommands=t.getSentCommands(),h.expiredCommands=t.getExpiredCommands(),h.EVENT_CODES=d,h.FILTER_TYPES=p,h.TAB_TYPES=O,h.COMMAND_TYPES=u,h.relocateEnabled=n.getWorldConfig().isRelocateUnitsEnabled(),h.onUnitInputFocus=te,h.onUnitInputBlur=ae,h.catapultTargetVisibility=ie,h.selectTab=ne,h.addSelected=le,h.addMapSelected=oe,h.addCurrentDate=se,h.incrementDate=re,h.reduceDate=ce,h.cleanUnitInputs=de,h.addCommand=pe,h.clearRegisters=ue,h.switchCommandQueue=ge,h.removeCommand=t.removeCommand,h.openVillageInfo=r.openVillageInfo,h.toggleFilter=be,h.$watch('commandData.origin',F),h.$watch('commandData.target',F),h.$watch('commandData.date',F),h.$watch('commandData.officers',F),h.$watch('selectedDateType.value',H),h.$watch('selectedInsertPreset.value',Q),h.$watch('catapultTarget.value',K),h.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Te),
h.$watch('selectedTab',(function(){h.selectedTab===O.ADD?b=setInterval((function(){F()}),2500):clearInterval(b)})),h.waitingCommands.forEach(e=>{X(e)});let T=new i('twoverflow_queue_window',(function(){clearInterval(b),Ee.clearCountdownUpdates()}));T.register(s.ARMY_PRESET_UPDATE,Ee.updatePresets,!0),T.register(s.ARMY_PRESET_DELETED,Ee.updatePresets,!0),T.register(s.SELECT_SELECTED,Ee.autoCompleteSelected,!0),T.register(s.COMMAND_QUEUE_REMOVE,Ee.removeCommand),T.register(s.COMMAND_QUEUE_REMOVE_ERROR,Ee.removeError),T.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Ee.sendTimeLimit),T.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Ee.sendNotOwnVillage),T.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Ee.sendNoUnitsEnough),T.register(s.COMMAND_QUEUE_SEND,Ee.sendCommand),T.register(s.COMMAND_QUEUE_START,Ee.start),T.register(s.COMMAND_QUEUE_STOP,Ee.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',h)};return function(){v=n.getSelectedCharacter(),P=l.getTimeOffset()
;const t=y.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(k),S.splice(S.indexOf('catapult'),1),k.forEach((function(e){U[e]=0})),I.forEach((function(e){G[e]=!1})),R={origin:!1,target:!1,date:'',dateType:o.OUT,units:angular.copy(U),officers:angular.copy(G),catapultTarget:"wall",type:null},M={[p.SELECTED_VILLAGE]:!1,[p.BARBARIAN_TARGET]:!1,[p.ALLOWED_TYPES]:!0,[p.ATTACK]:!0,[p.SUPPORT]:!0,[p.RELOCATE]:!0,[p.TEXT_MATCH]:!1},C={[p.ALLOWED_TYPES]:{[p.ATTACK]:!0,[p.SUPPORT]:!0,[p.RELOCATE]:!0},[p.TEXT_MATCH]:''},A=e.addMenuButton('Generał',10),A.addEventListener('click',_e),T.register(s.COMMAND_QUEUE_START,(function(){A.classList.remove('btn-orange'),A.classList.add('btn-red')})),T.register(s.COMMAND_QUEUE_STOP,(function(){A.classList.remove('btn-red'),A.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),a.$on(s.DESTROY_CONTEXT_MENU,W),
...
INVALID_ORIGIN:'invalid_origin',INVALID_TARGET:'invalid_target',INVALID_DATE:'invalid_date',NO_UNITS:'no_units',ALREADY_SENT:'already_sent',RELOCATE_DISABLED:'relocate_disabled',INVALID_DATE_TYPE:'invalid_date_type',INVALID_OFFICER:'invalid_officer',INVALID_COMMAND_TYPE:'invalid_command_type',INVALID_CATAPULT_TARGET:'invalid_catapult_target',INVALID_UNIT_TYPE:'invalid_unit_type',INVALID_OFFICER_TYPE:'invalid_officer_type'}})),require(['two/ready','two/commandQueue','two/commandQueue/ui','two/commandQueue/events'],(function(e,t,a){if(t.initialized)return!1;e((function(){t.init(),a(),t.getWaitingCommands().length>0&&t.start(!0)}),['map','world_config'])})),define('two/faithChecker',['two/utils','queues/EventQueue','Lockr','conf/buildingTypes','conf/locationTypes'],(function(e,i,r,c,d){let p,u,m,b,T,E=!1,_=!1,f=0;p=function(e){let t,a,i=0;for(t=0;t<e.length;t++)a=e[t].chapel||e[t].church,a&&a>i&&(i=a);return i},u=function(e,t){let a=n.getWorldConfig().getChurchBonus(),i=0
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){l.emit(o.VILLAGES_IN_PROVINCE,{village_id:e},t)};let w={init:function(){E=!0}};return w.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),_=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),E=c.food,_=c.wood,w=c.clay,h=c.iron,A=E.currentStock,v=_.currentStock,S=w.currentStock,R=h.currentStock,y=[0,5e3],k=[160,16e3],I=[200,2e4],x=[50,5e3];1==s&&(f=1),m(n,(function(i){b=p(i.villages),T=u(b,1===s),console.log(T),50!=T||r!==t&&0!=r.length?50==T&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=f?'chapel'==i&&'church'==i||1!=f||(v>=k[1]&&S>=I[1]&&R>=x[1]&&A>=y[1]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):v>=k[0]&&S>=I[0]&&R>=x[0]&&A>=y[0]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==f?v>=k[1]&&S>=I[1]&&R>=x[1]&&A>=y[1]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):v>=k[0]&&S>=I[0]&&R>=x[0]&&A>=y[0]?(l.emit(o.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))}))}))},w.stop=function(){i.trigger(s.FAITH_CHECKER_STOPPED),_=!1},w.isRunning=function(){return _},w.isInitialized=function(){return E},w})),define('two/faithChecker/events',[],(function(){angular.extend(s,{FAITH_CHECKER_STARTED:'faith_checker_started',FAITH_CHECKER_STOPPED:'faith_checker_stopped'})})),define('two/faithChecker/ui',['two/ui','two/faithChecker','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton('Kapelan',110,g('i18n')('description',a.loc.ale,'faith_checker')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'faith_checker'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'faith_checker')))})),n.register(s.FAITH_CHECKER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),
n.register(s.FAITH_CHECKER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.FAITH_CHECKER_STARTED),opener}})),require(['two/ready','two/faithChecker','two/faithChecker/ui','Lockr','queues/EventQueue','two/faithChecker/events'],(function(e,t,a,i,n){const l='faith_checker_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.FAITH_CHECKER_STARTED,(function(){i.set(l,!0)})),n.register(s.FAITH_CHECKER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/fakeSender',['two/Settings','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/settings/updates','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c,d,p){let u,g,m=!1,b=!1,T=[],E=[],_=[],f=[],w=[];const h='fake_sender_settings',A={[c.SPEAR]:'spear',[c.SWORD]:'sword',[c.AXE]:'axe',
[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},v={[r.ATTACK]:'attack',[r.SUPPORT]:'support',[r.QUATTRO]:'four',[r.FULL]:'full'},S={[o.ARRIVE]:'date_type_arrive',[o.OUT]:'date_type_out'};console.log(A,v,S);const R=function(){T=[],E=[],_=[],f=[],w=[];const e=n.getGroupList().getGroups(),a=g[t.GROUP],i=g[t.GROUPP],l=g[t.GROUPT],o=g[t.GROUPG],s=g[t.GROUP_TARGET];a.forEach((function(t){T.push(e[t])})),i.forEach((function(t){E.push(e[t])})),l.forEach((function(t){_.push(e[t])})),o.forEach((function(t){f.push(e[t])})),s.forEach((function(t){w.push(e[t])}))},y={init:function(){m=!0,u=new e({settingsMap:i,storageKey:h}),u.onChange((function(e,t){g=u.getAll(),t[l.GROUPS]&&R()})),g=u.getAll(),console.log('fakeSender settings',g),a.$on(s.GROUPS_CREATED,R),a.$on(s.GROUPS_DESTROYED,R),
a.$on(s.GROUPS_UPDATED,R)},start:function(){b=!0,p.trigger(s.FAKE_SENDER_START)},stop:function(){b=!1,p.trigger(s.FAKE_SENDER_STOP)},getSettings:function(){return u},isInitialized:function(){return m},isRunning:function(){return b}};return y})),define('two/fakeSender/events',[],(function(){angular.extend(s,{FAKE_SENDER_START:'fake_sender_start',FAKE_SENDER_STOP:'fake_sender_stop'})})),define('two/fakeSender/ui',['two/ui','two/fakeSender','two/fakeSender/settings','two/fakeSender/settings/map','two/fakeSender/types/dates','two/fakeSender/types/type','two/fakeSender/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p,u,m){let b,T,E,_=n.getGroupList();const f={FAKE:'fake',LOGS:'logs'},w=function(e){b.selectedTab=e},h=function(){T.setAll(T.decode(b.settings)),m.notif('success',g('i18n')('general.saved',a.loc.ale,'fake_sender'))},A=function(){t.isRunning()?t.stop():t.start()},v=function(){b.groups=p.encodeList(_.getGroups(),{disabled:!1,type:'groups'})
},S=function(){b.running=!0,E.classList.remove('btn-orange'),E.classList.add('btn-red'),m.notif('success',g('i18n')('general.started',a.loc.ale,'fake_sender'))},R=function(){b.running=!1,E.classList.remove('btn-red'),E.classList.add('btn-orange'),m.notif('success',g('i18n')('general.stopped',a.loc.ale,'fake_sender'))},y=function(){b=a.$new(),b.SETTINGS=i,b.TAB_TYPES=f,b.running=t.isRunning(),b.selectedTab=f.FAKE,b.settingsMap=l,b.datetype=p.encodeList(o,{textObject:'fake_sender',disabled:!0}),b.type=p.encodeList(r,{textObject:'fake_sender',disabled:!0}),b.units=p.encodeList(d,{textObject:'fake_sender',disabled:!0}),T.injectScope(b),v(),b.selectTab=w,b.saveSettings=h,b.switchState=A;let e=new u('twoverflow_fake_sender_window',(function(){console.log('fakeSender closed')}));e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.FAKE_SENDER_START,S),e.register(s.FAKE_SENDER_STOP,R),
c.getScreenWithInjectedScope('!twoverflow_fake_sender_window',b)};return function(){T=t.getSettings(),e.addDivisor(21),E=e.addMenuButton('Watażka',20),E.addEventListener('click',y),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,u,g,m,b,_,f,w,h,A,v,S,R,y){let k,I,x,L,O,N=!1,P=!1,M=[],C=[],z=[],U=[],G=[],D=[],B=!1,V=!1,W=!1,q=0,Y=null,F=null,j=null,H={},K=w.gameTime(),Q=null,X=null;const Z='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[S.WOOD,S.CLAY,S.IRON],te={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===L.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return U.includes(e.id)},points:function(e){
return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=I[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=I[r.GROUP_IGNORE];U=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!L.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=U.concat(z);let t=!1;e.forEach((function(e){E.call(x,e)||(x[e]={time:w.gameTime(),report:!1},t=!0)})),b.each(x,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete x[i],t=!0)})),t&&(y.set($,x),h.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),h.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},le=function(e,t){
const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],l=L.getVillage(t.village_id);let o=!1;if(ne(),i===t.group_id&&(l?(ke(t.village_id),o=!0):(Le(t.village_id),Te(g.IGNORED_VILLAGE,{villageId:t.village_id}),be(t.village_id))),a.includes(t.group_id)&&!l&&(Oe(),Te(g.INCLUDED_VILLAGE,{villageId:t.village_id}),be(t.village_id)),n.includes(t.group_id)&&l){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),o=!0}o&&h.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},oe=function(e,t){const a=I[r.GROUP_INCLUDE],i=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],l=L.getVillage(t.village_id);let o=!1;if(ne(),i===t.group_id)if(l){let e=Se(t.village_id);e.init().then((function(){P&&e.start()})),o=!0}else Oe(),Te(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!l&&(Oe(),Te(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&l&&(ke(t.village_id),o=!0),o&&h.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],i=I[r.GROUP_ONLY],l=I[r.GROUP_INCLUDE],o=E.call(t,a)?a:k.getDefault(r.GROUP_IGNORE),s=i.filter(e=>E.call(t,e)),c=l.filter(e=>E.call(t,e));k.setAll({[r.GROUP_IGNORE]:o,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),ye(),Oe(),Re()},ce=function(){D=[];const e=n.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),D.push(a)})),D=D.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),D.length||(h.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),P&&Ne.stop())},pe=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&P&&t.type===A.TYPES.ATTACK&&1!==t.result&&xe(t.target_village_id)&&(H[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&l.emit(o.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},ue=function(e,t){B&&W&&t.origin.id===B.getId()&&t.target.id===W.id&&'forward'===t.direction&&t.type===A.TYPES.ATTACK&&B.commandSent(t)},ge=function(e,t){B&&V&&W&&t.cause===o.SEND_PRESET.type&&B.commandError(t)},me=function(e){let t=0;return b.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},be=function(e){x[e]={time:w.gameTime(),report:H[e]||!1},delete H[e],y.set($,x),h.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},Te=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=w.gameTime(),t.type=e,C.unshift(t),Ee(),!0)},Ee=function(){const e=I[r.LOGS_LIMIT];C.length>e&&C.splice(C.length-e,C.length),y.set(Z,C),h.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},_e=function(e,t,a){const i=I[r.TARGET_MULTIPLE_FARMERS],n=I[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},fe=function(){K=w.gameTime()},we=function(){clearTimeout(Y),clearTimeout(F),clearTimeout(j),Y=null,F=null,j=null
},he=function(){return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},Ae=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},ve=function(e){if(this.villageId=e,this.village=L.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=T,this.status=i.WAITING_CYCLE};ve.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();p.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{h.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},ve.prototype.start=function(){return fe(),!this.running&&(this.initialized?this.targets.length?(B=this,this.running=!0,h.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(h.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(h.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},ve.prototype.stop=function(e){this.running=!1,h.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),we(),this.onCycleEndFn(e),this.onCycleEndFn=T},ve.prototype.targetStep=async function(e={}){if(!this.running)return!1;fe();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,p,u,g=!1,m=!1;const T=()=>new Promise((t,a)=>{e.delay?F=setTimeout(()=>{if(F=null,!this.running)return a(i.USER_STOP);t()},b.randomSeconds(Ae())):t()}),_=()=>new Promise((e,a)=>{const n=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),S=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),k=()=>new Promise((e,t)=>{R.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);l.emit(o.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),x=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(D.forEach((function(e){E.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)E.call(a,e)&&i.push(e);l.emit(o.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),O=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),l=60*I[r.MAX_TRAVEL_TIME],o=this.village.getPosition(),s=f.actualDistance(o,a);b.each(D,o=>{
if(!!Object.entries(o.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(o,{barbarian:!a.character_id,officers:!1});return l>r*s?(g=o,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,u=L.getVillageList();const l=u.every(e=>e.isInitialized(v.READY_STATES.OWN_COMMANDS));if(l&&(c=u.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),p=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),_e(p,c,l))return n(i.BUSY_TARGET);l&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!p&&!c)return e();const n=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const l=Math.round(w.gameTime()/1e3),o=I[r.TARGET_MULTIPLE_FARMERS]?u:[this.village],s=this.village.getPosition(),m=f.actualDistance(s,a),b=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),T=d.getTravelTimeForDistance(g,b,m,A.TYPES.ATTACK);if(o.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(l+T-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();l.emit(o.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===A.TYPES.ATTACK&&'forward'===e.direction),l=n.some(e=>e.start_village_id!==this.villageId),o=n.some(e=>e.start_village_id===this.villageId);if(_e(o,l,!0))return t(i.BUSY_TARGET);e()})});let C=new Promise((e,t)=>{T().then(_).then(S).then(y).then(k).then(x).then(O).then(N).then(P).then(M).then(e).catch(t)}),U=new Promise((e,t)=>{j=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([C,U]).then(()=>{if(!this.running)return!1
;this.setStatus(i.ATTACKING),V=!0,W=a,this.index++,l.emit(o.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:A.TYPES.ATTACK})}).catch(t=>{switch(we(),h.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case i.TIME_LIMIT:case i.BUSY_TARGET:case i.ABANDONED_CONQUERED:case i.PROTECTED_VILLAGE:this.index++,this.setStatus(t),this.targetStep(e);break;case i.USER_STOP:this.setStatus(t);break;case i.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),Le(a.id),this.targetStep(e);break;case i.NO_UNITS:case i.NO_TARGETS:case i.FULL_STORAGE:case i.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t);break;case i.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t);break;case i.EXPIRED_STEP:this.setStatus(t),this.targetStep();break;default:console.error('Unknown status:',t),this.index++,this.setStatus(i.UNKNOWN),this.stop(i.UNKNOWN)}})},ve.prototype.setStatus=function(e){this.status=e},
ve.prototype.getStatus=function(){return this.status||i.UNKNOWN},ve.prototype.commandSent=function(e){V=!1,W=!1,we(),Te(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},ve.prototype.commandError=function(){V=!1,W=!1,this.stop(i.COMMAND_ERROR)},ve.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},ve.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=f.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},ve.prototype.getTargets=function(){return this.targets},ve.prototype.getIndex=function(){return this.index},ve.prototype.getVillage=function(){return this.village},
ve.prototype.isRunning=function(){return this.running},ve.prototype.isInitialized=function(){return this.initialized},ve.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},ve.prototype.getId=function(){return this.villageId};const Se=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(U.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new ve(e),M.push(a)),a},Re=function(){b.each(L.getVillages(),(function(e,t){Se(t)})),h.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ye=function(){const e=I[r.GROUP_ONLY];let t=[];M.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):U.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){ke(e)})),h.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},ke=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1
},Ie=function(e){fe(),M.length?q>=M.length?(q=0,B=!1,X=w.gameTime()+he(),h.trigger(s.FARM_OVERFLOW_CYCLE_END)):B=M[q]:B=!1,B?(B.onCycleEnd((function(e){e!==t.USER_STOP&&(q++,Ie())})),"cycle_begin"===e&&(X=null,h.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),B.start()):Y=setTimeout((function(){Y=null,q=0,X=null,h.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Ie()}),he())},xe=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Le=function(e){M.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,C=y.get(Z,[]),x=y.get($,{}),L=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),k=new e({settingsMap:c,storageKey:J}),k.onChange((function(e,t,a){I=k.getAll(),"ignore_update"!==a&&(t[u.PRESET]&&ce(),t[u.GROUPS]&&ne(),t[u.TARGETS]&&Oe(),t[u.VILLAGES]&&(ye(),Re()),t[u.LOGS]&&Ee(),t[u.INTERVAL_TIMERS]&&P&&(F?(we(),
B.targetStep({delay:!0})):Y&&(we(),h.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),q=0,Ie())))})),I=k.getAll(),se("ignore_update"),ne(),Re(),_((function(){ce()}),'presets'),_((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,le),a.$on(s.GROUPS_VILLAGE_UNLINKED,oe),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,ue),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,pe)},Ne.start=function(){let e;return!P&&(D.length?(P=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Ie("cycle_begin")})),fe(),function(){let e=he(),t=e+e/2+Ae();Q=setInterval((function(){w.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),h.trigger(s.FARM_OVERFLOW_START),void Te(g.FARM_START)):(P=!1,!1)):(h.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){B?(B.stop(e),
e!==i.USER_STOP&&(X=w.gameTime()+he()),h.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):X=null,P=!1,we(),h.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&Te(g.FARM_STOP)},Ne.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return M},Ne.getSettings=function(){return k},Ne.getExceptionVillages=function(){return{included:z,ignored:U}},Ne.getExceptionLogs=function(){return x},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return P},Ne.getLogs=function(){return C},Ne.clearLogs=function(){return C=[],y.set(Z,C),h.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),C},Ne.getNextCycleDate=function(){return X},Ne.getCycleInterval=he,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,p,T,E,_,f,w,h){let A,v,S,R=n.getPresetList(),y=n.getGroupList(),k={},I={},x=null;const L={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=A.pagination.offset,t=A.pagination.limit;A.visibleLogs=A.logs.slice(e,e+t),A.pagination.count=A.logs.length,A.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(k[e])return k[e];k[e]=!0,I[e]='LOADING...',l.emit(o.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){k[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},I[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},P=function(){
A.exceptionVillages.included.forEach((function(e){N(e)})),A.exceptionVillages.ignored.forEach((function(e){N(e)}))},M=function(){t.isRunning()?t.stop():t.start()},C=function(e){A.selectedTab=e},z=function(){v.setAll(v.decode(A.settings)),A.saveButtonColor='orange',f.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},U=function(e){const t=v.get(T.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;l.emit(o.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){v.get(T.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&l.emit(o.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},D=function(){A.presets=E.encodeList(R.getPresets(),{disabled:!1,type:'presets'})},B=function(){A.groups=E.encodeList(y.getGroups(),{disabled:!1,type:'groups'}),A.groupsWithDisabled=E.encodeList(y.getGroups(),{disabled:!0,type:'groups'})},V=function(){A.running=!0,
f.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},W=function(e,t){switch(A.running=!1,A.showCycleTimer=!1,clearInterval(x),t.reason){case d.NO_PRESETS:f.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:f.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},q=function(){A.logs=angular.copy(t.getLogs()),O(),A.logs.length||f.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},Y=function(){A.farmers=t.getFarmers()},F=function(){A.exceptionVillages=t.getExceptionVillages(),P()},j=function(){A.exceptionLogs=t.getExceptionLogs()},H=function(){A.showCycleTimer=!1,clearInterval(x)},K=function(e,a){a!==i.USER_STOP&&(A.showCycleTimer=!0,A.nextCycleCountdown=t.getCycleInterval(),x=setInterval((function(){A.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;A=a.$new(),A.SETTINGS=T,A.TAB_TYPES=L,A.LOG_TYPES=p,A.running=t.isRunning(),A.selectedTab=L.SETTINGS,A.farmers=t.getFarmers(),
A.villagesLabel=I,A.villagesInfo=k,A.exceptionVillages=t.getExceptionVillages(),A.exceptionLogs=t.getExceptionLogs(),A.logs=t.getLogs(),A.visibleLogs=[],A.showCycleTimer=!1,A.nextCycleCountdown=0,A.saveButtonColor='orange',A.settingsMap=v.settingsMap,A.pagination={count:A.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},v.injectScope(A),D(),B(),O(),P(),function(){let e=t.getNextCycleDate();e&&(A.showCycleTimer=!0,A.nextCycleCountdown=e-h.gameTime(),x=setInterval((function(){A.nextCycleCountdown-=1e3}),1e3))}(),A.switchFarm=M,A.selectTab=C,A.saveSettings=z,A.clearLogs=t.clearLogs,A.jumpToVillage=u.jumpToVillage,A.openVillageInfo=r.openVillageInfo,A.showReport=b.showReport,A.removeIgnored=U,A.removeIncluded=G;let i=new _('twoverflow_farm_overflow_window',(function(){clearInterval(x)}));i.register(s.ARMY_PRESET_UPDATE,D,!0),i.register(s.ARMY_PRESET_DELETED,D,!0),i.register(s.GROUPS_UPDATED,B,!0),i.register(s.GROUPS_CREATED,B,!0),i.register(s.GROUPS_DESTROYED,B,!0),
i.register(s.FARM_OVERFLOW_START,V),i.register(s.FARM_OVERFLOW_STOP,W),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,q),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,Y),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,j),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',A),A.$watch('settings',(function(){e||(A.saveButtonColor='red'),e=!1}),!0)};return function(){v=t.getSettings(),S=e.addMenuButton2('Farmer',10),S.addEventListener('click',(function(){Q()})),w.register(s.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),w.register(s.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/kingTool',['two/Settings','two/kingTool/settings','two/kingTool/settings/map','two/kingTool/types/sequence','two/kingTool/types/aplication','two/ready','queues/EventQueue'],(function(e,t,a,i,n,l,o){let r,c,d=!1,p=!1;const u='king_tool_settings',g={[i.LOOT]:'loot',[i.NUMBERS]:'numbers',[i.WAR]:'war',[i.BALANCED]:'balanced'},m={[n.ANYONE]:'anyone',[n.APLICATION]:'aplication',[n.CLOSED]:'closed'};console.log(m,g);const b={init:function(){d=!0,r=new e({settingsMap:a,storageKey:u}),r.onChange((function(){c=r.getAll()})),c=r.getAll(),console.log('kingTool settings',c)},start:function(){p=!0,o.trigger(s.EXAMPLE_MODULE_START)},stop:function(){p=!1,console.log('kingTool stop'),o.trigger(s.EXAMPLE_MODULE_STOP)
},getSettings:function(){return r},isInitialized:function(){return d},isRunning:function(){return p}};return b})),define('two/kingTool/events',[],(function(){angular.extend(s,{KING_TOOL_START:'king_tool_start',KING_TOOL_STOP:'king_tool_stop'})})),define('two/kingTool/ui',['two/ui','two/kingTool','two/kingTool/settings','two/kingTool/settings/map','two/kingTool/types/sequence','two/kingTool/types/aplication','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,l,o,r,d,p){let u,g,m;const b={TRIBE:'tribe',SKILLS:'skills',FORUM:'forum'},T=function(e){u.selectedTab=e},E=function(){g.setAll(g.decode(u.settings)),p.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},f=function(){u.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),p.notif('success','Example module started')},w=function(){u.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),p.notif('success','Example module stopped')},h=function(){u=a.$new(),
u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.TRIBE,u.settingsMap=n,u.sequence=r.encodeList(l,{textObject:'king_tool',disabled:!0}),u.aplication=r.encodeList(o,{textObject:'king_tool',disabled:!0}),g.injectScope(u),u.selectTab=T,u.saveSettings=E,u.switchState=_;let e=new d('twoverflow_king_tool_window',(function(){console.log('kingTool closed')}));e.register(s.KING_TOOL_START,f),e.register(s.KING_TOOL_STOP,w),c.getScreenWithInjectedScope('!twoverflow_king_tool_window',u)};return function(){g=t.getSettings(),m=e.addMenuButton3('Marszałek',50),m.addEventListener('click',h),
...
define('two/marketHelper',['two/Settings','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/settings/updates','two/marketHelper/types/buildings','two/marketHelper/types/level','two/marketHelper/types/units','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c,d,p){let u,g,m=!1,b=!1,T=[];const E='market_helper_settings',_={[c.SPEAR]:'spear',[c.SWORD]:'sword',[c.AXE]:'axe',[c.ARCHER]:'archer',[c.LIGHT_CAVALRY]:'light_cavalry',[c.MOUNTED_ARCHER]:'mounted_archer',[c.HEAVT_CAVALRY]:'heavy_cavalry',[c.RAM]:'ram',[c.CATAPULT]:'catapult',[c.TREBUCHET]:'trebuchet',[c.DOPPELSOLDNER]:'doppelsoldner',[c.SNOB]:'snob',[c.KNIGHT]:'knight'},f={[o.HEADQUARTER]:'headquarter',[o.WAREHOUSE]:'warehouse',[o.FARM]:'farm',[o.RALLY_POINT]:'rally_point',[o.STATUE]:'statue',[o.WALL]:'wall',[o.TAVERN]:'tavern',[o.BARRACKS]:'barracks',[o.PRECEPTORY]:'preceptory',[o.HOSPITAL]:'hospital',[o.CLAY_PIT]:'clay_pit',[o.IRON_MINE]:'iron_mine',[o.TIMBER_CAMP]:'timber_camp',
[o.CHAPEL]:'chapel',[o.CHURCH]:'church',[o.MARKET]:'market',[o.ACADEMY]:'academy'},w={[r.LEVEL_1]:1,[r.LEVEL_2]:2,[r.LEVEL_3]:3,[r.LEVEL_4]:4,[r.LEVEL_5]:5,[r.LEVEL_6]:6,[r.LEVEL_7]:7,[r.LEVEL_8]:8,[r.LEVEL_9]:9,[r.LEVEL_10]:10,[r.LEVEL_11]:11,[r.LEVEL_12]:12,[r.LEVEL_13]:13,[r.LEVEL_14]:14,[r.LEVEL_15]:15,[r.LEVEL_16]:16,[r.LEVEL_17]:17,[r.LEVEL_18]:18,[r.LEVEL_19]:19,[r.LEVEL_20]:20,[r.LEVEL_21]:21,[r.LEVEL_22]:22,[r.LEVEL_23]:23,[r.LEVEL_24]:24,[r.LEVEL_25]:25,[r.LEVEL_26]:26,[r.LEVEL_27]:27,[r.LEVEL_28]:28,[r.LEVEL_29]:29,[r.LEVEL_30]:30};console.log(w,f,_);const h=function(){T=[];const e=n.getGroupList().getGroups();g[t.GROUPS].forEach((function(t){T.push(e[t])})),console.log('selectedGroups',T)},A={init:function(){m=!0,u=new e({settingsMap:i,storageKey:E}),u.onChange((function(e,t){g=u.getAll(),t[l.GROUPS]&&h()})),g=u.getAll(),console.log('marketHelper settings',g),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},start:function(){b=!0,
console.log('selectedGroups',T),p.trigger(s.MARKET_HELPER_START)},stop:function(){b=!1,console.log('marketHelper stop'),p.trigger(s.MARKET_HELPER_STOP)},getSettings:function(){return u},isInitialized:function(){return m},isRunning:function(){return b}};return A})),define('two/marketHelper/events',[],(function(){angular.extend(s,{MARKET_HELPER_START:'market_helper_start',MARKET_HELPER_STOP:'market_helper_stop'})})),define('two/marketHelper/ui',['two/ui','two/marketHelper','two/marketHelper/settings','two/marketHelper/settings/map','two/marketHelper/types/buildings','two/marketHelper/types/level','two/marketHelper/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p,u,g){let m,b,T,E=n.getGroupList();const _={TRADE:'trade',INSTANT_TRADE:'instant_trade',LOGS:'logs'},f=function(e){m.selectedTab=e},w=function(){b.setAll(b.decode(m.settings)),g.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){
t.isRunning()?t.stop():t.start()},v=function(){m.groups=p.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},S=function(){m.running=!0,T.classList.remove('btn-orange'),T.classList.add('btn-red'),g.notif('success','marketHelper started')},R=function(){m.running=!1,T.classList.remove('btn-red'),T.classList.add('btn-orange'),g.notif('success','marketHelper stopped')},y=function(){m=a.$new(),m.SETTINGS=i,m.TAB_TYPES=_,m.running=t.isRunning(),m.selectedTab=_.TRADE,m.settingsMap=l,m.level=p.encodeList(r,{textObject:'market_helper',disabled:!0}),m.units=p.encodeList(d,{textObject:'market_helper',disabled:!0}),m.buildings=p.encodeList(o,{textObject:'market_helper',disabled:!0}),b.injectScope(m),v(),m.selectTab=f,m.saveSettings=w,m.switchState=h,m.switchStateI=A;let e=new u('twoverflow_market_helper_window',(function(){console.log('marketHelper closed')}));e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),
...
require(['two/ready','two/marketHelper','two/marketHelper/ui','two/marketHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,l,o,r,c,d,p,g,m,b,T,_,f,w,h,A,v){let S,R,y,k,I,x,L,O,N,P,M,C,z,U,G,D,B,V,W,q,Y,F,j,H=!1,K={},Q={village:{},character:{},tribe:{}},X={a:0,b:0},Z={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',le={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},oe=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,pe={},ue={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,be=function(e){
let t=Math.ceil(ee.x+e.offsetX)-k,a=Math.ceil(ee.y+e.offsetY)+k;return Math.floor(a/R)%2&&(t+=k),t-=t%R,a-=a%R,{x:Math.ceil((t-N.width/2)/R),y:Math.ceil((a-N.height/2)/R)}},Te=function(e,t){return{x:e/A.TILESIZE.x,y:t/A.TILESIZE.y/A.TILESIZE.off}},Ee=function(){ve(I)},_e=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};P.clearRect(0,0,N.width,N.height),U.clearRect(0,0,z.width,z.height),function(e){P.drawImage(M,-e.x,-e.y)}(e),j[l.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*R-e.x,i=(t.y-2)*R-e.y;U.fillStyle=j[l.COLOR_VIEW_REFERENCE],U.fillRect(a,0,1,y),U.fillRect(0,i,y,1);const n=D.getBoundingClientRect(),o=n.width/A.TILESIZE.x/v.view.z*R,s=n.height/A.TILESIZE.y/v.view.z*R,r=a-o/2,c=i-s/2;U.clearRect(r,c,o,s),U.beginPath(),U.lineWidth=1,U.strokeStyle=j[l.COLOR_VIEW_REFERENCE],U.rect(r,c,o,s),U.stroke()}(e)}e.requestAnimationFrame(_e)},fe=function(){if(!ie)return!1;const e=Q.village[L][O];he(e?Q.character[e]:[[L,O]]),ie=!1,
m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:L,y:O})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t,j[l.COLOR_QUICK_HIGHLIGHT])},he=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}ve(t)},Ae=function(e){if(j[l.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!j[l.SHOW_BARBARIANS]&&q.barbarian;if(e.character_id===V){if(e.id===x.getId()&&j[l.HIGHLIGHT_SELECTED])return q.selected;if(e.character_id in K.character)return K.character[e.character_id];if(j[l.HIGHLIGHT_OWN])return q.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(W&&W===e.tribe_id&&j[l.HIGHLIGHT_DIPLOMACY])return q.tribe;if(Y&&j[l.HIGHLIGHT_DIPLOMACY]){if(Y.isAlly(e.tribe_id))return q.ally;if(Y.isEnemy(e.tribe_id))return q.enemy
;if(Y.isNAP(e.tribe_id))return q.friendly}}return q.ugly},ve=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Ae(i);if(!n)continue;const l=i.x*R+(i.y%2?k:0),o=i.y*R;C.fillStyle=n,C.fillRect(l,o,S,S)}},Se=function(){S=le[j[l.MAP_SIZE]],k=Math.round(S/2),R=S+1,y=1e3*R,J.a=X.a*R,J.b=X.b*R,$.a=Z.a*R,$.b=Z.b*R,M.width=1e3*R,M.height=1e3*R,C.imageSmoothingEnabled=!1},Re=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,P.imageSmoothingEnabled=!1,U.imageSmoothingEnabled=!1},ye=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,pe.x=ee.x+e.pageX,pe.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,i=O,T.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(j[l.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({
type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},ke=function(){de=!1,pe={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Ie=function(e){if(ce=!1,ue=be(e),de)return ee.x=(pe.x-e.pageX).bound(J.a,J.b),ee.y=(pe.y-e.pageY).bound($.a,$.b),te.x=ue.x,te.y=ue.y,!1;if(te.x===ue.x&&te.y===ue.y||(re.alpha=0,function(e,t){let a=u.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(ue.x,ue.y)),ue.x in ae&&ue.y in ae[ue.x]){let t=ae[ue.x][ue.y];if(!j[l.SHOW_BARBARIANS]&&!t.character_id)return!1;if(j[l.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(L===e.x&&O===e.y)return!1;fe()}ie=!0,L=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:L,y:O,event:t});const a=Q.village[L][O];we(a?Q.character[a]:[[L,O]])}(ue,e)}fe()},xe=function(){ie&&fe(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=be(e);u.jumpToVillage(t.x,t.y)
},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=oe.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=oe.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Ee()},Pe=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=B.getSelectedVillage(),ve([{character_id:B.getId(),id:e.id,x:e.x,y:e.y},{character_id:B.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?h.PLAYER_COLORS:h.TRIBE_COLORS;return oe.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t];const i='character'===e?h.PLAYER_COLORS:h.TRIBE_COLORS;return oe.setCustomColorsByGroup(i,K[e]),
a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=j[l.COLOR_BACKGROUND],P=N.getContext('2d')},setViewportRef:function(e){z=e,U=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*R,ee.y=t*R,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=T.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=Te(e[0]*t,e[1]*t),i=Te(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return F},Me.drawMinimap=function(){ge&&(ge=!1),N.style.background=j[l.COLOR_BACKGROUND],C.clearRect(0,0,M.width,M.height),d((function(){!function(){
const e=f.getPath(A.getMapPath()),t=j[l.SHOW_CONTINENT_DEMARCATIONS],a=j[l.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){C.fillStyle=j[l.COLOR_CONTINENT],C.fillRect(e*R+k-1,t*R+k-1,3,1),C.fillRect(e*R+k,t*R+k-2,1,3)},n=function(e,t){C.fillStyle=j[l.COLOR_PROVINCE],C.fillRect(e*R+k,t*R+k-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const l=new DataView(e.response),o={a:X.a-10,b:X.b+10},s={a:Z.a-10,b:Z.b+10};if(t||a)for(let e=o.a;e<o.b;e++)for(let o=s.a;o<s.b;o++){const s=_.toTile(l,e,o);s.key.b&&(s.key.c&&t?i(e,o):a&&n(e,o))}const r=o.a*R,c=s.a*R,d=(o.b-o.a)*R,p=(s.b-s.a)*R;C.beginPath(),C.lineWidth=2,C.strokeStyle="#2B4700",C.rect(r,c,d,p),C.stroke()}))}(),Ee()}),'minimap_data')},Me.enableRendering=function(){H=!0},Me.disableRendering=function(){H=!1},Me.isFirstDraw=function(){return!!ge},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),C=M.getContext('2d'),re=se.make('hover'),F=new p({settingsMap:o,storageKey:ne}),F.onChange((function(e,t){j=F.getAll(),
Se(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),j=F.getAll(),K.tribe=oe.getCustomColorsByGroup(h.TRIBE_COLORS)||{},K.character=oe.getCustomColorsByGroup(h.PLAYER_COLORS)||{},Se()},Me.run=function(){d((function(){D=document.getElementById('map'),G=document.getElementById('main-canvas'),B=n.getSelectedCharacter(),Y=B.getTribeRelations(),V=B.getId(),W=B.getTribeId(),q=B.getVillagesColors(),re.alpha=0,v.graph.layers.effects.push(re),Re(),x=B.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*R,ee.y=x.getY()*R,e.addEventListener('resize',Re,!1),z.addEventListener('mousedown',ye),z.addEventListener('mouseup',ke),z.addEventListener('mousemove',Ie),z.addEventListener('mouseleave',xe),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){I=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
...
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,p,u,m,b,T,E,_,f,w,h){let A,v,S,R,y,k,I,x,L,O,N,P={},M=!1,C={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},U=z.MINIMAP,G=function(e){A.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},D=function(){Object.keys(A.highlights.character).forEach((function(e){e in C.character||function(e,t){l.emit(o.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
C.character[e]=t.character_name}))})),Object.keys(A.highlights.tribe).forEach((function(e){e in C.tribe||function(e,t){l.emit(o.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){C.tribe[e]=t.name}))}))},B=function(e,t){return String(e)+String(t)},V=function(e,t){if(!L)return;let a=B(t.x,t.y);var i,n;O=a,P[a]=!0,M=!0,(i=t.x,n=t.y,new Promise((function(e){let t=f.getTownAt(i,n);if(t)return e(t);f.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!P[B(e.x,e.y)])return;if(!M)return;I.appendChild(L),L.classList.remove('ng-hide'),k.tt.name=e.name,k.tt.x=e.x,k.tt.y=e.y,k.tt.province_name=e.province_name,k.tt.points=e.points,k.tt.character_name=e.character_name||'-',k.tt.character_points=e.character_points||0,k.tt.tribe_name=e.tribe_name||'-',k.tt.tribe_tag=e.tribe_tag||'-',k.tt.tribe_points=e.tribe_points||0,k.tt.morale=e.morale||0,k.tt.position={},k.tt.position.x=t.event.pageX+50,k.tt.position.y=t.event.pageY+50,k.tt.visible=!0
;const a=L.getBoundingClientRect(),i=I.getBoundingClientRect(),n=a.width+50,l=a.height+50,o=k.tt.position.y+l>i.top+i.height,s=k.tt.position.x+n>i.width;o&&(k.tt.position.y-=50),L.classList.toggle('left',s),L.classList.toggle('top',o)}))},W=function(e,t){if(!L)return;let a=t?B(t):O;P[a]=!1,M=!1,k.tt.visible=!1,L.classList.add('ng-hide'),x.appendChild(L)},q=function(e,t,i){let l,o,s=a.$new(),r=!0;s.colorPalettes=h.palette,'setting'===e?(o=t,l=N.get(o),r=!1,s.submit=function(){A.settings[o]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){A.settings[o]=N.getDefault(o),s.closeWindow()}):'add_custom_highlight'===e?(l=A.addHighlightColor,s.submit=function(){A.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(l=A.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=l.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},Y=function(){n.addHighlight(A.selectedHighlight,A.addHighlightColor)},F=function(){N.setAll(N.decode(A.settings)),b.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},j=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),b.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(A.highlights.character).length+Object.keys(A.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){A.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){D()},highlightAddErrorExists:function(){b.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){b.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){b.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),R.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),R.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){R.style.cursor=''}},X=function(){A=a.$new(),A.SETTINGS=u,A.TAB_TYPES=z,A.selectedTab=U,A.selectedHighlight=!1,A.addHighlightColor='#000000',A.highlights=n.getHighlights(),A.highlightNames=C,A.mapSizes=E.encodeList(p,{textObject:'minimap',disabled:!1}),A.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),A.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},A.selectTab=G,A.openColorPalette=q,A.addCustomHighlight=Y,A.removeHighlight=n.removeHighlight,A.saveSettings=F,A.resetSettings=j,A.highlightsCount=H,A.openProfile=K,N.injectScope(A,{textObject:'minimap'});let e=new T('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',A),D(),y=document.querySelector('#two-minimap .minimap-container'),y.appendChild(S),y.appendChild(R),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),k=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',R=document.createElement('canvas'),R.className='cross',n.setViewport(S),n.setViewportRef(R),L=document.querySelector('#map-tooltip'),I=document.querySelector('#wrapper'),x=document.querySelector('#map'),v=t.addMenuButton4('Minimapa',30),v.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;X(),n.setCurrentPosition(e.x,e.y)})),
...
define('two/mintHelper',['queues/EventQueue'],(function(e){let t=!1,a=!1,i=3e3;function r(){n.getSelectedCharacter().getVillageList().forEach((function(e){let t=0,a=0,n=0,s=e.data.buildings.academy.level,r=e.getResources().getComputed(),c=r.wood,d=r.clay,p=r.iron,u=c.currentStock,g=d.currentStock,m=p.currentStock;setTimeout((function(){s>0?u>=28e3&&g>=3e4&&m>=25e3?(t=Math.floor(u/28e3),a=Math.floor(g/3e4),n=Math.floor(m/25e3),t<=n&&t<=a?(l.emit(o.MINT_COINS,{village_id:e.getId(),amount:t}),console.log('W wiosce '+e.getName()+' wybito '+t+' monet.')):a<=n&&a<=t?(l.emit(o.MINT_COINS,{village_id:e.getId(),amount:a}),console.log('W wiosce '+e.getName()+' wybito '+a+' monet.')):(l.emit(o.MINT_COINS,{village_id:e.getId(),amount:n}),console.log('W wiosce '+e.getName()+' wybito '+n+' monet.'))):console.log('Za mało surowców żeby wybić monety w wiosce'+e.getName()):console.log('W wiosce '+e.getName()+' brak akademi')}),i)})),setTimeout(r,3e4)}let c={init:function(){t=!0},start:function(){
e.trigger(s.MINT_HELPER_STARTED),a=!0,r()},stop:function(){e.trigger(s.MINT_HELPER_STOPPED),a=!1},isRunning:function(){return a},isInitialized:function(){return t}};return c})),define('two/mintHelper/events',[],(function(){angular.extend(s,{MINT_HELPER_STARTED:'mint_helper_started',MINT_HELPER_STOPPED:'mint_helper_stopped'})})),define('two/mintHelper/ui',['two/ui','two/mintHelper','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton2('Mincerz',50,g('i18n')('description',a.loc.ale,'mint_helper')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'mint_helper'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'mint_helper')))})),n.register(s.MINT_HELPER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.MINT_HELPER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),
t.isRunning()&&n.trigger(s.MINT_HELPER_STARTED),opener}})),require(['two/ready','two/mintHelper','two/mintHelper/ui','Lockr','queues/EventQueue','two/mintHelper/events'],(function(e,t,a,i,n){const l='mint_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.AUTO_HELPER_STARTED,(function(){i.set(l,!0)})),n.register(s.AUTO_HELPER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/powerHelper',['two/Settings','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/settings/updates','two/powerHelper/types/ironwalls','two/powerHelper/types/wall','two/ready','queues/EventQueue'],(function(e,t,a,i,n,l,o,r){let c,d,p=!1,u=!1;const g='power_helper_settings',m={[n.LEVEL_1]:1,[n.LEVEL_2]:2,[n.LEVEL_3]:3,[n.LEVEL_4]:4,[n.LEVEL_5]:5},b={[l.NO_WALL]:0,[l.LEVEL_1]:5,[l.LEVEL_2]:10,[l.LEVEL_3]:15,[l.LEVEL_4]:20,[l.LEVEL_5]:25,[l.LEVEL_6]:30,[l.LEVEL_7]:35,[l.LEVEL_8]:40,[l.LEVEL_9]:45,
[l.LEVEL_10]:50,[l.LEVEL_11]:55,[l.LEVEL_12]:60,[l.LEVEL_13]:65,[l.LEVEL_14]:70,[l.LEVEL_15]:75,[l.LEVEL_16]:80,[l.LEVEL_17]:85,[l.LEVEL_18]:90,[l.LEVEL_19]:95,[l.LEVEL_20]:100};console.log(m,b);const T={init:function(){p=!0,c=new e({settingsMap:a,storageKey:g}),c.onChange((function(){d=c.getAll()})),d=c.getAll(),console.log('powerHelper settings',d)},start:function(){u=!0,r.trigger(s.POWER_HELPER_START)},stop:function(){u=!1,console.log('powerHelper stop'),r.trigger(s.POWER_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return T})),define('two/powerHelper/events',[],(function(){angular.extend(s,{POWER_HELPER_START:'power_helper_start',POWER_HELPER_STOP:'power_helper_stop'})})),
define('two/powerHelper/ui',['two/ui','two/powerHelper','two/powerHelper/settings','two/powerHelper/settings/map','two/powerHelper/types/ironwalls','two/powerHelper/types/wall','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,l,o,r,d,p){let u,g,m;const b={POWERS:'powers',BUNKER:'bunker',BEATBUNKER:'beatbunker'},T=function(e){u.selectedTab=e},E=function(){g.setAll(g.decode(u.settings)),p.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},f=function(){u.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),p.notif('success','Example module started')},w=function(){u.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),p.notif('success','Example module stopped')},h=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.POWERS,u.settingsMap=n,u.wall=r.encodeList(o,{textObject:'battle_calculator',disabled:!0}),u.ironwalls=r.encodeList(l,{textObject:'battle_calculator',disabled:!0
}),g.injectScope(u),u.selectTab=T,u.saveSettings=E,u.switchState=_;let e=new d('twoverflow_power_helper_window',(function(){console.log('powerHelper closed')}));e.register(s.POWER_HELPER_START,f),e.register(s.POWER_HELPER_STOP,w),c.getScreenWithInjectedScope('!twoverflow_power_helper_window',u)};return function(){g=t.getSettings(),m=e.addMenuButton4('Bunkry',20),m.addEventListener('click',h),
...
require(['two/ready','two/powerHelper','two/powerHelper/ui','two/powerHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c){let d,p,u=!1,g=!1,m=[];const b='prank_helper_settings',T={[o.INCREASE]:'increase',[o.DECREASE]:'decrease',[o.RANDOM]:'random'};console.log(T);const E=function(){m=[];const e=n.getGroupList().getGroups();p[t.GROUPS].forEach((function(t){m.push(e[t])}))},_={init:function(){u=!0,d=new e({settingsMap:i,storageKey:b}),d.onChange((function(e,t){p=d.getAll(),t[l.GROUPS]&&E()})),p=d.getAll(),console.log('all settings',p),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){g=!0,c.trigger(s.PRANK_HELPER_START)},stop:function(){g=!1,c.trigger(s.PRANK_HELPER_STOP)},
getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return _})),define('two/prankHelper/events',[],(function(){angular.extend(s,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p){let u,g,m,b=n.getGroupList();const T={RENAME:'rename',LOGS:'logs'},E=function(e){u.selectedTab=e},_=function(){g.setAll(g.decode(u.settings)),p.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},w=function(){u.groups=r.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},h=function(){u.running=!0,m.classList.remove('btn-orange'),m.classList.add('btn-red'),p.notif('success','Example module started')},A=function(){u.running=!1,m.classList.remove('btn-red'),m.classList.add('btn-orange'),
p.notif('success','Example module stopped')},v=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.RENAME,u.settingsMap=l,u.type=r.encodeList(o,{textObject:'prank_helper',disabled:!0}),g.injectScope(u),w(),u.selectTab=E,u.saveSettings=_,u.switchState=f;let e=new d('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.PRANK_HELPER_START,h),e.register(s.PRANK_HELPER_STOP,A),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',u)};return function(){g=t.getSettings(),m=e.addMenuButton3('Błazen',80),m.addEventListener('click',v),
...
require(['two/ready','two/prankHelper','two/prankHelper/ui','two/prankHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/presetAsigner',['two/Settings','two/presetAsigner/settings','two/presetAsigner/settings/map','two/presetAsigner/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r){let c,d,p=!1,u=!1,g=[],m=[],b=[],T=[];const E='preset_asigner_settings',_=function(){g=[],m=[];const e=n.getPresetList().getPresets(),a=d[t.PRESETS1],i=d[t.PRESETS2];a.forEach((function(t){g.push(e[t])})),i.forEach((function(t){m.push(e[t])}))},f=function(){b=[],T=[];const e=n.getGroupList().getGroups(),a=d[t.GROUP1],i=d[t.GROUP2];a.forEach((function(t){b.push(e[t])})),i.forEach((function(t){T.push(e[t])}))},w={init:function(){p=!0,c=new e({settingsMap:i,storageKey:E}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&_(),t[l.GROUPS]&&f()})),d=c.getAll(),console.log('presetAsigner settings',d),o((function(){_()}),'presets'),
a.$on(s.ARMY_PRESET_UPDATE,_),a.$on(s.ARMY_PRESET_DELETED,_),a.$on(s.GROUPS_CREATED,f),a.$on(s.GROUPS_DESTROYED,f),a.$on(s.GROUPS_UPDATED,f)},start:function(){u=!0,r.trigger(s.PRESET_ASIGNER_START)},stop:function(){u=!1,console.log('presetAsigner stop'),r.trigger(s.PRESET_ASIGNER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return w})),define('two/presetAsigner/events',[],(function(){angular.extend(s,{PRESET_ASIGNER_START:'preset_asigner_start',PRESET_ASIGNER_STOP:'preset_asigner_stop'})})),define('two/presetAsigner/ui',['two/ui','two/presetAsigner','two/presetAsigner/settings','two/presetAsigner/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d){let p,u,g,m=n.getPresetList(),b=n.getGroupList();const T={PRESETS:'presets',LOGS:'logs'},E=function(e){p.selectedTab=e},_=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()
},w=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},v=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.PRESETS,p.settingsMap=l,u.injectScope(p),w(),h(),p.selectTab=E,p.saveSettings=_,p.switchState=f;let e=new r('twoverflow_preset_asigner_window',(function(){console.log('presetAsigner closed')}));e.register(s.ARMY_PRESET_UPDATE,w,!0),e.register(s.ARMY_PRESET_DELETED,w,!0),e.register(s.GROUPS_CREATED,h,!0),e.register(s.GROUPS_DESTROYED,h,!0),e.register(s.GROUPS_UPDATED,h,!0),e.register(s.PRESET_ASIGNER_START,A),e.register(s.PRESET_ASIGNER_STOP,v),
c.getScreenWithInjectedScope('!twoverflow_preset_asigner_window',p)};return function(){u=t.getSettings(),g=e.addMenuButton3('Administrator',30),g.addEventListener('click',S),
...
trebuchet:1,doppelsoldner:0,snob:0,knight:0}}),t.notif('success',g('i18n')('done',a.loc.ale,'preset_creator')),t.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator')),C.stop()},C.stop=function(){e.trigger(s.PRESET_CREATOR_STOPPED),r=!1},C.isRunning=function(){return r},C.isInitialized=function(){return i},C})),define('two/presetCreator/events',[],(function(){angular.extend(s,{PRESET_CREATOR_STARTED:'preset_creator_started',PRESET_CREATOR_STOPPED:'preset_creator_stopped'})})),define('two/presetCreator/ui',['two/ui','two/presetCreator','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return e.addDivisor(41),l=e.addMenuButton3('Wojewoda',40,g('i18n')('description',a.loc.ale,'preset_creator')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'preset_creator'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'preset_creator')))})),
n.register(s.PRESET_CREATOR_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.PRESET_CREATOR_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.PRESET_CREATOR_STARTED),opener}})),require(['two/ready','two/presetCreator','two/presetCreator/ui','Lockr','queues/EventQueue','two/presetCreator/events'],(function(e,t,a,i,n){const l='preset_creator_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.PRESET_CREATOR_STARTED,(function(){i.set(l,!0)})),n.register(s.PRESET_CREATOR_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/recruitQueue',['two/Settings','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/settings/updates','two/recruitQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c){
let d,p,u=!1,g=!1,m=[],b=[],T=[],E=[],_=[],f=[],w=[],h=[],A=[],v=[],S=[],R=[],y=[],k=[],I=[],x=[],L=[],O=[],N=[],P=[],M=[],C=[],z=[],U=[],G=[],D=[],B=[],V=[],W=[],q=[],Y=[],F=[];const j='recruit_queue_settings',H={[o.SPEAR]:'spear',[o.SWORD]:'sword',[o.AXE]:'axe',[o.ARCHER]:'archer',[o.LIGHT_CAVALRY]:'light_cavalry',[o.MOUNTED_ARCHER]:'mounted_archer',[o.HEAVT_CAVALRY]:'heavy_cavalry',[o.RAM]:'ram',[o.CATAPULT]:'catapult',[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner',[o.SNOB]:'snob',[o.KNIGHT]:'knight'};console.log(H);const K=function(){m=[],b=[],T=[],E=[],_=[],f=[],w=[],h=[];const e=n.getPresetList().getPresets(),a=p[t.PRESET1],i=p[t.PRESET2],l=p[t.PRESET3],o=p[t.PRESET4],s=p[t.PRESET1_FINAL],r=p[t.PRESET2_FINAL],c=p[t.PRESET3_FINAL],d=p[t.PRESET4_FINAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){b.push(e[t])})),l.forEach((function(t){T.push(e[t])})),o.forEach((function(t){E.push(e[t])})),s.forEach((function(t){_.push(e[t])})),r.forEach((function(t){
f.push(e[t])})),c.forEach((function(t){w.push(e[t])})),d.forEach((function(t){h.push(e[t])}))},Q=function(){A=[],v=[],S=[],R=[],y=[],k=[],I=[],x=[],L=[],O=[],N=[],P=[],M=[],C=[],z=[],U=[],G=[],D=[],B=[],V=[],W=[],q=[],Y=[],F=[];const e=n.getGroupList().getGroups(),a=p[t.GROUP1],i=p[t.GROUP2],l=p[t.GROUP3],o=p[t.GROUP4],s=p[t.GROUP5],r=p[t.GROUP6],c=p[t.GROUP7],d=p[t.GROUP8],u=p[t.GROUP9],g=p[t.GROUP10],m=p[t.GROUP11],b=p[t.GROUP12],T=p[t.GROUP13],E=p[t.GROUP14],_=p[t.GROUP15],f=p[t.GROUP16],w=p[t.GROUP17],h=p[t.GROUP18],j=p[t.GROUP19],H=p[t.GROUP20],K=p[t.GROUP21],Q=p[t.GROUP22],X=p[t.GROUP23],Z=p[t.GROUP24];a.forEach((function(t){A.push(e[t])})),i.forEach((function(t){v.push(e[t])})),l.forEach((function(t){S.push(e[t])})),o.forEach((function(t){R.push(e[t])})),s.forEach((function(t){y.push(e[t])})),r.forEach((function(t){k.push(e[t])})),c.forEach((function(t){I.push(e[t])})),d.forEach((function(t){x.push(e[t])})),u.forEach((function(t){L.push(e[t])})),g.forEach((function(t){
O.push(e[t])})),m.forEach((function(t){N.push(e[t])})),b.forEach((function(t){P.push(e[t])})),T.forEach((function(t){M.push(e[t])})),E.forEach((function(t){C.push(e[t])})),_.forEach((function(t){z.push(e[t])})),f.forEach((function(t){U.push(e[t])})),w.forEach((function(t){G.push(e[t])})),h.forEach((function(t){D.push(e[t])})),j.forEach((function(t){B.push(e[t])})),H.forEach((function(t){V.push(e[t])})),K.forEach((function(t){W.push(e[t])})),Q.forEach((function(t){q.push(e[t])})),X.forEach((function(t){Y.push(e[t])})),Z.forEach((function(t){F.push(e[t])}))},X={init:function(){u=!0,d=new e({settingsMap:i,storageKey:j}),d.onChange((function(e,t){p=d.getAll(),t[l.PRESETS]&&K(),t[l.GROUPS]&&Q()})),p=d.getAll(),console.log('recruitQueue settings',p),r((function(){K()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,K),a.$on(s.ARMY_PRESET_DELETED,K),a.$on(s.GROUPS_CREATED,Q),a.$on(s.GROUPS_DESTROYED,Q),a.$on(s.GROUPS_UPDATED,Q)},start:function(){g=!0,c.trigger(s.recruit_queue_START)},stop:function(){
g=!1,c.trigger(s.recruit_queue_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return X})),define('two/recruitQueue/events',[],(function(){angular.extend(s,{RECRUIT_QUEUE_START:'recruit_queue_start',RECRUIT_QUEUE_STOP:'recruit_queue_stop'})})),define('two/recruitQueue/ui',['two/ui','two/recruitQueue','two/recruitQueue/settings','two/recruitQueue/settings/map','two/recruitQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p){let u,m,b,T=n.getPresetList(),E=n.getGroupList();const _={PRESETS:'presets',OWN:'own',LOGS:'logs'},f=function(e){u.selectedTab=e},w=function(){m.setAll(m.decode(u.settings)),p.notif('success','Settings saved')},h=function(){t.isRunning()?t.stop():t.start()},A=function(){u.presets=r.encodeList(T.getPresets(),{disabled:!1,type:'presets'})},v=function(){u.groups=r.encodeList(E.getGroups(),{disabled:!1,type:'groups'})},S=function(){u.running=!0,
b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},R=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'recruit_queue'))},y=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=_,u.running=t.isRunning(),u.selectedTab=_.PRESETS,u.settingsMap=l,u.units=r.encodeList(o,{textObject:'recruit_queue',disabled:!0}),m.injectScope(u),A(),v(),u.selectTab=f,u.saveSettings=w,u.switchState=h;let e=new d('twoverflow_recruit_queue_window',(function(){console.log('recruitQueue window closed')}));e.register(s.ARMY_PRESET_UPDATE,A,!0),e.register(s.ARMY_PRESET_DELETED,A,!0),e.register(s.GROUPS_CREATED,v,!0),e.register(s.GROUPS_DESTROYED,v,!0),e.register(s.GROUPS_UPDATED,v,!0),e.register(s.recruit_queue_START,S),e.register(s.recruit_queue_STOP,R),c.getScreenWithInjectedScope('!twoverflow_recruit_queue_window',u)};return function(){
...
if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportHelper',['two/Settings','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/settings/updates','two/reportHelper/types/type','two/reportHelper/types/result','two/reportHelper/types/sort','two/ready','queues/EventQueue'],(function(e,t,a,i,n,l,o,r,c){let d,p,u=!1,g=!1;const m='report_helper_settings',b={[n.ATTACK]:'attack',[n.DEFENSE]:'defense',[n.SUPPORT_IN]:'support_in',[n.SUPPORT_OUT]:'support_out',[n.TRADE]:'trade',[n.SPY_IN]:'spy_in',[n.SPY_OUT]:'spy_out',[n.ACHIEVEMENTS]:'achievements',[n.SYSTEM]:'system'},T={[l.WIN]:'win',[l.LOSSES]:'losses',[l.DEFEAT]:'defeat'},E={[o.ALL]:'all',[o.FARM]:'farm',[o.FAKE]:'fake',[o.FAVOURITE]:'favourite',[o.WITHOUT_FAVOURITE]:'without_favourite',[o.FARM_FAKE]:'farm_fake'};console.log(T,E,b);const _={init:function(){u=!0,d=new e({settingsMap:a,storageKey:m}),d.onChange((function(){p=d.getAll()})),p=d.getAll(),
console.log('reportHelper settings',p)},start:function(){g=!0,c.trigger(s.REPORT_HELPER_START)},stop:function(){g=!1,console.log('reportHelper stop'),c.trigger(s.REPORT_HELPER_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return _})),define('two/reportHelper/events',[],(function(){angular.extend(s,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/reportHelper/types/type','two/reportHelper/types/result','two/reportHelper/types/sort','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,l,o,r,d,p,u){let g,m,b;const T={REPORTS:'reports',LOGS:'logs'},E=function(e){g.selectedTab=e},_=function(){m.setAll(m.decode(g.settings)),u.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},w=function(){g.running=!0,
b.classList.remove('btn-orange'),b.classList.add('btn-red'),u.notif('success','Example module started')},h=function(){g.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),u.notif('success','Example module stopped')},A=function(){g=a.$new(),g.SETTINGS=i,g.TAB_TYPES=T,g.running=t.isRunning(),g.selectedTab=T.REPORTS,g.settingsMap=n,g.type=d.encodeList(l,{textObject:'report_helper',disabled:!0}),g.result=d.encodeList(o,{textObject:'report_helper',disabled:!0}),g.sort=d.encodeList(r,{textObject:'report_helper',disabled:!0}),m.injectScope(g),g.selectTab=E,g.saveSettings=_,g.switchState=f;let e=new p('twoverflow_report_helper_window',(function(){console.log('reportHelper window closed')}));e.register(s.REPORT_HELPER_START,w),e.register(s.REPORT_HELPER_STOP,h),c.getScreenWithInjectedScope('!twoverflow_report_helper_window',g)};return function(){m=t.getSettings(),b=e.addMenuButton3('Skryba',90),b.addEventListener('click',A),
...
define('two/reportHelper/types/result',[],(function(){return{WIN:'win',LOSSES:'losses',DEFEAT:'defeat'}})),define('two/reportHelper/types/sort',[],(function(){return{ALL:'all',FARM:'farm',FAKE:'fake',FAVOURITE:'favourite',WITHOUT_FAVOURITE:'without_favourite',FARM_AND_FAKE:'farm_and_fake'}})),require(['two/ready','two/reportHelper','two/reportHelper/ui','two/reportHelper/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/reportSender',['queues/EventQueue'],(function(e){var t=n.getSelectedCharacter(),a=t.data.character_id,i=t.data.character_name,r=!1,c=!1,d=[],p=[],u=[];function g(e){var t=new Date(1e3*e);return t.toLocaleString()}var m=function(){l.emit(o.REPORT_GET_LIST_REVERSE,{offset:0,count:50,query:'',types:['scouting']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)d.includes(t[a].id)?console.log('Raport zwiadowczy już wysłany'):(d.push(t[a].id),l.emit(o.REPORT_GET,{id:t[a].id},b))})),l.emit(o.REPORT_GET_LIST_REVERSE,{
offset:0,count:100,query:'',types:['defense']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport wsparcia już wysłany'):(p.push(t[a].id),l.emit(o.REPORT_GET,{id:t[a].id},T))})),l.emit(o.REPORT_GET_LIST_REVERSE,{offset:0,count:100,query:'',types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)u.includes(t[a].id)?console.log('Raport ataku już wysłany'):(u.push(t[a].id),l.emit(o.REPORT_GET,{id:t[a].id},E))})),setTimeout(m,3e4)},b=function(e){var t,n,s,r,c,d=[],p=e.result,u=e.token,m=e.time_created,b=g(m),T=e.ReportScouting,E=T.attCharacterId,_=T.attCharacterName,f=T.attScouts,w=T.attLosses,h=T.attVillageId,A=T.attVillageName,v=T.defCharacterId,S=T.defCharacterName,R=T.defLosses,y=T.defScouts,k=T.defVillageId,I=T.defVillageName,x=T.commandType,L='',O='',N='',P='',M=Date.now(),C=u.split('.').join('_');2==p?L=' [color=d96a19]Częściowy sukces[/color]':1==p?L=' [color=0a8028]Sukces[/color]':3==p&&(L=' [color=e21f1f]Porażka[/color]'),
O='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',n=null==y?'nieznana':y,s=null==f?'nieznana':f,r=null==R?'nieznana':R,c=null==w?'nieznana':w,P=null==_&&null==E?'Brak danych':'[player='+E+']'+_+'[/player]',N=null==A&&null==h?'Brak danych':'[village='+h+']'+A+'[/village]',t=Math.floor(M/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+C+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+b+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+k+']'+I+'[/village][b] Gracz cel: [/b][player='+v+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+P+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();v!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?l.emit(o.MESSAGE_REPLY,{message_id:14383,message:z}):l.emit(o.MESSAGE_REPLY,{message_id:6467,message:z}),
d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?l.emit(o.MESSAGE_REPLY,{message_id:14382,message:z}):l.emit(o.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},T=function(e){var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,p=d.attCharacterId,u=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var f=[],w=[];T.forEach((function(e){var t=e.type,a=0,i=0,n=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,f.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,f.push(' Klinika '+o)),
'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,f.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,f.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var h=f.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,w.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,
w.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,w.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,w.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,w.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}))
;var A=w.join(),v=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),R=Math.round(100*d.morale).toFixed([0]),y=(100*(d.luck-1)).toFixed([0]),k=d.defCharacterId,I=d.defCharacterName,x=d.defVillageId,L=d.defVillageName,O=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),P=(100*d.wallBonus).toFixed([0]),M=d.night,C=d.loyaltyAfter,z=d.loyaltyBefore,U=d.wallAfter,G=d.wallBefore,D=d.officers,B=d.leader,V='',W='',q='',Y='',F='',j='',H='',K='',Q='',X=Date.now(),Z=s.split('.').join('_');null!=z&&(j='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=C&&(H='Lojalność po ataku: '+Math.floor(C)+' '),null!=G&&(K='Mury przed ataku: '+G+' '),null!=U&&(Q='Mury po ataku: '+U+' '),null==D&&1==B?F='Brak':null==D&&1.1==B&&(F=' Wielki Mistrz '),Y=0==M?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),q=null==u&&null==p?'Brak danych':'[player='+p+']'+u+'[/player]',
W=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(X/1e3-r),a.push('[size=XL][b]Raport obronny: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+x+']'+L+'[/village][b] Gracz cel: [/b][player='+k+']'+I+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+P+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+R+'[/b][br]Wiara: [b]'+v+'[/b] Szczęście: [b]'+y+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+F+'[/b][br]'+j+H+'[br]'+K+Q+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?l.emit(o.MESSAGE_REPLY,{message_id:14381,message:J}):l.emit(o.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},E=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,p=d.attCharacterId,u=d.attCharacterName,m=d.attVillageId,b=d.attVillageName,T=d.attEffects,E=d.defEffects,_=d.attUnits;if(_.spear+_.sword+_.axe+_.archer+_.light_cavalry+_.mounted_archer+_.ram+_.catapult+_.heavy_cavalry+_.trebuchet+_.knight+_.snob+_.doppelsoldner>30){var f=[],w=[];T.forEach((function(e){var t=e.type,a=0,i=0,n=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),f.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,f.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,f.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,f.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,f.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,f.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,f.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,f.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,f.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,f.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,f.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,f.push(' Zjednoczenie '+g+'%'))}));var h=f.join();E.forEach((function(e){var t=e.type,a=0,i=0,n=0,l=0,o=0,s=0,r=0,c=0,d=0,p=0,u=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),w.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,w.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,w.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(l=100*e.ratio,w.push(' Doktor '+l+'%')),'extra_hospital_beds'==t&&(o=e.beds,w.push(' Klinika '+o)),'increase_spy_defense'==t&&(s=e.increased_by,w.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
w.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,w.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,w.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(p=e.factor,w.push(' Wagony(depozyt) '+p+'%')),'resource_deposit_job_duration'==t&&(u=e.factor,w.push(' Drogi najazdów(depozyt) '+u+'%')),'faster_tribe_support'==t&&(g=e.factor,w.push(' Zjednoczenie '+g+'%'))}));var A,v=w.join(),S=(100*d.attFaith).toFixed([0]),R=Math.round(100*d.attModifier).toFixed([0]),y=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,x=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),P=Math.round(100*d.defModifier).toFixed([0]),M=(100*d.wallBonus).toFixed([0]),C=d.night,z=d.loyaltyAfter,U=d.loyaltyBefore,G=d.wallAfter,D=d.wallBefore,B=d.officers,V='',W='',q='',Y='',F='',j='',H='',K='',Q=[],X=Date.now(),Z=s.split('.').join('_')
;if(null!=U&&(F='Lojalność przed atakiem: '+Math.floor(U)+' '),null!=z&&(j='Lojalność po ataku: '+Math.floor(z)+' '),null!=D&&(H='Mury przed ataku: '+D+' '),null!=G&&(K='Mury po ataku: '+G+' '),null==B)Q.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?Q.push('Brak'):(1==J?Q.push(' Oszust '):Q.push(''),1==$?Q.push(' Wielki Mistrz '):Q.push(''),1==ee?Q.push(' Medyk '):Q.push(''),1==te?Q.push(' Łowczy '):Q.push(''),1==ae?Q.push(' Mistrz Łupu '):Q.push(''),1==ie?Q.push(' Taktyk '):Q.push(''))}if(Y=0==C?'Nie':'Tak',2==n?V=' [color=d96a19]Częściowy sukces[/color]':1==n?V=' [color=0a8028]Sukces[/color]':3==n&&(V=' [color=e21f1f]Porażka[/color]'),q=null==u&&null==p?'Brak danych':'[player='+p+']'+u+'[/player]',W=null==b&&null==m?'Brak danych':'[village='+m+']'+b+'[/village]',t=Math.floor(X/1e3-r),A=Q.join(),null!=x){
a.push('[size=XL][b]Raport z ataku: [report]'+Z+'[/report][br]'+V+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+I+']'+x+'[/player][br]Modyfikator obrony: [b]'+P+'[/b] Bonus za mury: [b]'+M+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+Y+'[/b][br]Pozostałe bonusy: [b]'+v+'[/b][br][b]Wioska pochodzenia: [/b]'+W+'[b] Gracz atakujący: [/b]'+q+'[br]Modyfikator ataku: [b]'+R+'[/b] Morale: [b]'+y+'[/b][br]Wiara: [b]'+S+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+h+'[/b][br]Oficerowie: [b]'+A+'[/b][br]'+F+j+'[br]'+H+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?l.emit(o.MESSAGE_REPLY,{message_id:14380,message:ne}):l.emit(o.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},_={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
isRunning:function(){return c},isInitialized:function(){return r}};return _})),define('two/reportSender/events',[],(function(){angular.extend(s,{REPORT_SENDER_STARTED:'report_sender_started',REPORT_SENDER_STOPPED:'report_sender_stopped'})})),define('two/reportSender/ui',['two/ui','two/reportSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return e.addDivisor(71),l=e.addMenuButton('Goniec',70,g('i18n')('description',a.loc.ale,'report_sender')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'report_sender'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'report_sender')))})),n.register(s.REPORT_SENDER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.REPORT_SENDER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.REPORT_SENDER_STARTED),opener}})),
require(['two/ready','two/reportSender','two/reportSender/ui','Lockr','queues/EventQueue','two/reportSender/events'],(function(e,t,a,i,n){const l='report_sender_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.REPORT_SENDER_STARTED,(function(){i.set(l,!0)})),n.register(s.REPORT_SENDER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),define('two/specialQueue',['two/Settings','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/settings/updates','two/specialQueue/types/units','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r,c){let d,p,u=!1,g=!1,m=[],b=[];const T='special_queue_settings',E={[o.TREBUCHET]:'trebuchet',[o.DOPPELSOLDNER]:'doppelsoldner'};console.log(E);const _=function(){m=[],b=[];const e=n.getGroupList().getGroups(),a=p[t.GROUPNOBLE],i=p[t.GROUPSPECIAL];a.forEach((function(t){m.push(e[t])})),i.forEach((function(t){b.push(e[t])}))},f={init:function(){u=!0,
d=new e({settingsMap:i,storageKey:T}),d.onChange((function(e,t){p=d.getAll(),t[l.GROUPS]&&_()})),p=d.getAll(),console.log('specialQueue settings',p),a.$on(s.GROUPS_CREATED,_),a.$on(s.GROUPS_DESTROYED,_),a.$on(s.GROUPS_UPDATED,_)},start:function(){g=!0,c.trigger(s.SPECIAL_QUEUE_START)},stop:function(){g=!1,c.trigger(s.SPECIAL_QUEUE_STOP)},getSettings:function(){return d},isInitialized:function(){return u},isRunning:function(){return g}};return f})),define('two/specialQueue/events',[],(function(){angular.extend(s,{SPECIAL_QUEUE_START:'special_queue_start',SPECIAL_QUEUE_STOP:'special_queue_stop'})})),define('two/specialQueue/ui',['two/ui','two/specialQueue','two/specialQueue/settings','two/specialQueue/settings/map','two/specialQueue/types/units','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d,p){let u,m,b,T=n.getGroupList();const E={NOBLE:'noble',SPECIAL:'special',LOGS:'logs'},_=function(e){u.selectedTab=e},f=function(){m.setAll(m.decode(u.settings)),
p.notif('success',g('i18n')('general.saved',a.loc.ale,'special_queue'))},w=function(){t.isRunning()?t.stop():t.start()},h=function(){u.groups=r.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},A=function(){u.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.started',a.loc.ale,'special_queue'))},v=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'special_queue'))},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=E,u.running=t.isRunning(),u.selectedTab=E.NOBLE,u.settingsMap=l,u.units=r.encodeList(o,{textObject:'special_queue',disabled:!0}),m.injectScope(u),h(),u.selectTab=_,u.saveSettings=f,u.switchState=w;let e=new d('twoverflow_special_queue_window',(function(){console.log('specialQueue closed')}));e.register(s.GROUPS_CREATED,h,!0),e.register(s.GROUPS_DESTROYED,h,!0),e.register(s.GROUPS_UPDATED,h,!0),
e.register(s.SPECIAL_QUEUE_START,A),e.register(s.SPECIAL_QUEUE_STOP,v),c.getScreenWithInjectedScope('!twoverflow_special_queue_window',u)};return function(){m=t.getSettings(),e.addDivisor(86),b=e.addMenuButton('Weteran',85),b.addEventListener('click',S),
...
[e.AMOUNT5]:{default:0,inputType:'number',min:0,max:1e5},[e.AMOUNT6]:{default:0,inputType:'number',min:0,max:4e3},[e.AMOUNT7]:{default:0,inputType:'number',min:0,max:4e3},[e.AMOUNT8]:{default:0,inputType:'number',min:0,max:4e3},[e.UNIT1]:{default:!1,multiSelect:!0,inputType:'select'},[e.UNIT2]:{default:!1,multiSelect:!0,inputType:'select'},[e.UNIT3]:{default:!1,multiSelect:!0,inputType:'select'}}})),define('two/specialQueue/types/units',[],(function(){return{TREBUCHET:'trebuchet',DOPPELSOLDNER:'doppelsoldner'}})),require(['two/ready','two/specialQueue','two/specialQueue/ui','two/specialQueue/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/spyMaster',['two/Settings','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/ready','queues/EventQueue'],(function(e,t,a,i,n,l,o){let r,c,d=!1,p=!1;const u='spy_master_settings',g={[i.HEADQUARTER]:'headquarter',
[i.WAREHOUSE]:'warehouse',[i.FARM]:'farm',[i.RALLY_POINT]:'rally_point',[i.STATUE]:'statue',[i.WALL]:'wall',[i.TAVERN]:'tavern',[i.BARRACKS]:'barracks',[i.PRECEPTORY]:'preceptory',[i.HOSPITAL]:'hospital',[i.CLAY_PIT]:'clay_pit',[i.IRON_MINE]:'iron_mine',[i.TIMBER_CAMP]:'timber_camp',[i.CHAPEL]:'chapel',[i.CHURCH]:'church',[i.MARKET]:'market',[i.ACADEMY]:'academy'},m={[n.SPEAR]:'spear',[n.SWORD]:'sword',[n.AXE]:'axe',[n.ARCHER]:'archer',[n.LIGHT_CAVALRY]:'light_cavalry',[n.MOUNTED_ARCHER]:'mounted_archer',[n.HEAVT_CAVALRY]:'heavy_cavalry',[n.RAM]:'ram',[n.CATAPULT]:'catapult',[n.TREBUCHET]:'trebuchet',[n.DOPPELSOLDNER]:'doppelsoldner',[n.SNOB]:'snob',[n.KNIGHT]:'knight'};console.log(m,g);const b={init:function(){d=!0,r=new e({settingsMap:a,storageKey:u}),c=r.getAll(),console.log('spyMaster settings',c)},start:function(){p=!0,o.trigger(s.SPY_MASTER_START)},stop:function(){p=!1,o.trigger(s.SPY_MASTER_STOP)},getSettings:function(){return r},isInitialized:function(){return d},
isRunning:function(){return p}};return b})),define('two/spyMaster/events',[],(function(){angular.extend(s,{SPY_MASTER_START:'spy_master_start',SPY_MASTER_STOP:'spy_master_stop'})})),define('two/spyMaster/ui',['two/ui','two/spyMaster','two/spyMaster/settings','two/spyMaster/settings/map','two/spyMaster/types/building','two/spyMaster/types/unit','two/Settings','two/EventScope','two/utils'],(function(e,t,i,n,l,o,r,d,p){let u,m,b;const T={SPY:'spy',COUNTERMEASURES:'countermeasures',LOGS:'logs'},E=function(e){u.selectedTab=e},_=function(){m.setAll(m.decode(u.settings)),p.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},w=function(){u.running=!0,b.classList.remove('btn-orange'),b.classList.add('btn-red'),p.notif('success',g('i18n')('general.started',a.loc.ale,'spy_master'))},h=function(){u.running=!1,b.classList.remove('btn-red'),b.classList.add('btn-orange'),p.notif('success',g('i18n')('general.stopped',a.loc.ale,'spy_master'))},A=function(){u=a.$new(),
u.SETTINGS=i,u.TAB_TYPES=T,u.running=t.isRunning(),u.selectedTab=T.SPY,u.settingsMap=n,u.building=r.encodeList(l,{textObject:'spy_master',disabled:!0}),u.unit=r.encodeList(o,{textObject:'spy_master',disabled:!0}),m.injectScope(u),u.selectTab=E,u.saveSettings=_,u.switchState=f;let e=new d('twoverflow_spy_master_window',(function(){console.log('spyMaster window closed')}));e.register(s.SPY_MASTER_START,w),e.register(s.SPY_MASTER_STOP,h),c.getScreenWithInjectedScope('!twoverflow_spy_master_window',u)};return function(){m=t.getSettings(),b=e.addMenuButton3('Zwiadowca',10),b.addEventListener('click',A),
...
console.log('Dodano do rekrutacji szpiega (slot 4) w wiosce:'+e.getName())):5==t.id&&1!=t.active&&1!=t.recruitingInProgress&&c>=u[5]&&d>=g[5]&&p>=m[5]&&(l.emit(o.SCOUTING_RECRUIT,{village_id:e.getId(),slot:5}),console.log('Dodano do rekrutacji szpiega (slot 5) w wiosce:'+e.getName()))}))})),e.notif('success',g('i18n')('revived',a.loc.ale,'spy_recruiter'))}),12e4)},c.stop=function(){t.trigger(s.SPY_RECRUITER_STOPPED),r=!1},c.isRunning=function(){return r},c.isInitialized=function(){return i},c})),define('two/spyRecruiter/events',[],(function(){angular.extend(s,{SPY_RECRUITER_STARTED:'spy_recruiter_started',SPY_RECRUITER_STOPPED:'spy_recruiter_stopped'})})),define('two/spyRecruiter/ui',['two/ui','two/spyRecruiter','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return e.addDivisor3(21),l=e.addMenuButton3('Szpieg',20,g('i18n')('description',a.loc.ale,'spy_recruiter')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),
i.notif('success',g('i18n')('deactivated',a.loc.ale,'spy_recruiter'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'spy_recruiter')))})),n.register(s.SPY_RECRUITER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.SPY_RECRUITER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.SPY_RECRUITER_STARTED),opener}})),require(['two/ready','two/spyRecruiter','two/spyRecruiter/ui','Lockr','queues/EventQueue','two/spyRecruiter/events'],(function(e,t,a,i,n){const l='spy_recruiter_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.SPY_RECRUITER_STARTED,(function(){i.set(l,!0)})),n.register(s.SPY_RECRUITER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))})),
define('two/supportSender',['two/Settings','two/supportSender/settings','two/supportSender/settings/map','two/supportSender/settings/updates','two/ready','queues/EventQueue'],(function(e,t,i,l,o,r){let c,d,p=!1,u=!1,g=[],m=[];const b='support_sender_settings',T=function(){g=[];const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])}))},E=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])}))},_={init:function(){p=!0,c=new e({settingsMap:i,storageKey:b}),c.onChange((function(e,t){d=c.getAll(),t[l.PRESETS]&&T(),t[l.GROUPS]&&E()})),d=c.getAll(),console.log('supportSender settings',d),o((function(){T()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,T),a.$on(s.ARMY_PRESET_DELETED,T),a.$on(s.GROUPS_CREATED,E),a.$on(s.GROUPS_DESTROYED,E),a.$on(s.GROUPS_UPDATED,E)},start:function(){u=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(s.SUPPORT_SENDER_START)},stop:function(){u=!1,
r.trigger(s.SUPPORT_SENDER_STOP)},getSettings:function(){return c},isInitialized:function(){return p},isRunning:function(){return u}};return _})),define('two/supportSender/events',[],(function(){angular.extend(s,{SUPPORT_SENDER_START:'support_sender_start',SUPPORT_SENDER_STOP:'support_sender_stop'})})),define('two/supportSender/ui',['two/ui','two/supportSender','two/supportSender/settings','two/supportSender/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,l,o,r,d){let p,u,g,m=n.getPresetList(),b=n.getGroupList();const T={SUPPORT:'support',LOGS:'logs'},E=function(e){p.selectedTab=e},_=function(){u.setAll(u.decode(p.settings)),d.notif('success','Settings saved')},f=function(){t.isRunning()?t.stop():t.start()},w=function(){p.presets=o.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){p.groups=o.encodeList(b.getGroups(),{disabled:!1,type:'groups'})},A=function(){p.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),
d.notif('success','Example module started')},v=function(){p.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){p=a.$new(),p.SETTINGS=i,p.TAB_TYPES=T,p.running=t.isRunning(),p.selectedTab=T.SUPPORT,p.settingsMap=l,u.injectScope(p),w(),h(),p.selectTab=E,p.saveSettings=_,p.switchState=f;let e=new r('twoverflow_support_sender_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,w,!0),e.register(s.ARMY_PRESET_DELETED,w,!0),e.register(s.GROUPS_CREATED,h,!0),e.register(s.GROUPS_DESTROYED,h,!0),e.register(s.GROUPS_UPDATED,h,!0),e.register(s.SUPPORT_SENDER_START,A),e.register(s.SUPPORT_SENDER_STOP,v),c.getScreenWithInjectedScope('!twoverflow_support_sender_window',p)};return function(){u=t.getSettings(),g=e.addMenuButton('Chorąży',50),g.addEventListener('click',S),
...
})),require(['two/ready','two/supportSender','two/supportSender/ui','two/supportSender/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}))})),define('two/tutorialHelper',['queues/EventQueue'],(function(e){let t=!1,a=!1,i={init:function(){t=!0},start:function(){e.trigger(s.TUTORIAL_HELPER_STARTED),a=!0},stop:function(){e.trigger(s.TUTORIAL_HELPER_STOPPED),a=!1},isRunning:function(){return a},isInitialized:function(){return t}};return i})),define('two/tutorialHelper/events',[],(function(){angular.extend(s,{TUTORIAL_HELPER_STARTED:'tutorial_helper_started',TUTORIAL_HELPER_STOPPED:'tutorial_helper_stopped'})})),define('two/tutorialHelper/ui',['two/ui','two/tutorialHelper','two/utils','queues/EventQueue'],(function(e,t,i,n){let l;return function(){return l=e.addMenuButton2('Giermek',60,g('i18n')('description',a.loc.ale,'tutorial_helper')),l.addEventListener('click',(function(){t.isRunning()?(t.stop(),
i.notif('success',g('i18n')('deactivated',a.loc.ale,'tutorial_helper'))):(t.start(),i.notif('success',g('i18n')('activated',a.loc.ale,'tutorial_helper')))})),n.register(s.TUTORIAL_HELPER_STARTED,(function(){l.classList.remove('btn-orange'),l.classList.add('btn-red')})),n.register(s.TUTORIAL_HELPER_STOPPED,(function(){l.classList.remove('btn-red'),l.classList.add('btn-orange')})),t.isRunning()&&n.trigger(s.TUTORIAL_HELPER_STARTED),opener}})),require(['two/ready','two/tutorialHelper','two/tutorialHelper/ui','Lockr','queues/EventQueue','two/tutorialHelper/events'],(function(e,t,a,i,n){const l='tutorial_helper_active';if(t.isInitialized())return!1;e((function(){t.init(),a(),e((function(){i.get(l,!1,!0)&&t.start(),n.register(s.TUTORIAL_HELPER_STARTED,(function(){i.set(l,!0)})),n.register(s.TUTORIAL_HELPER_STOPPED,(function(){i.set(l,!1)}))}),['initial_village'])}))}))}(this);