...
},l=[];return T.forEach((function(a){i[a]=1,l.push({unit:a,duration:t.getTravelTime(n,o,i,e.command_type,{})})})),(l=l.map((function(e){return e.duration=Math.abs(e.duration-a),e})).sort((function(e,t){return e.duration-t.duration})))[0].unit},k={init:function(){d=!0},start:function(){e.trigger(s.ALERT_SENDER_STARTED),u=!0,A()},stop:function(){e.trigger(s.ALERT_SENDER_STOPPED),u=!1},isRunning:function(){return u},isInitialized:function(){return d}};return k})),define('two/alertSender/events',[],(function(){angular.extend(s,{ALERT_SENDER_STARTED:'alert_sender_started',ALERT_SENDER_STOPPED:'alert_sender_stopped'})})),define('two/alertSender/ui',['two/ui','two/alertSender','two/utils','queues/EventQueue'],(function(e,t,i,n){let o;return function(){return o=e.addMenuButton('Wartownik',100,g('i18n')('description',a.loc.ale,'alert_sender')),o.addEventListener('click',(function(){t.isRunning()?(t.stop(),i.notif('success',g('i18n')('deactivated',a.loc.ale,'alert_sender'))):(t.start(),
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,_,b,f){let E,h,v=!1,w=injector.get('overviewService'),T=[],A=!1,S={},y={},k={reverse:!1,column:i.TIME_COMPLETED};const I='attack_view_filters',R={},x={},L=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in S[e[t]])if(a[e[t]]||(a[e[t]]=[]),S[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}y=a,y.village=S[c.VILLAGE]?[t]:[]},O=function(){V.loadCommands()},N=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){
for(let e=0;e<T.length;e++)T[e].command_id===t.command_id&&T.splice(e,1);f.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},P=function(e,t){for(let e=0;e<T.length;e++)T[e].target_village_id===t.village_id?(T[e].target_village_name=t.name,T[e].targetVillage.name=t.name):T[e].origin_village_id===t.village_id&&(T[e].origin_village_name=t.name,T[e].originVillage.name=t.name);f.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},M=function(e,t){y[c.VILLAGE].length&&(y[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=_.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},U=function(e){T=e.commands;for(let e=0;e<T.length;e++)w.formatCommand(T[e]),T[e].slowestUnit=z(T[e]);T=T.filter((function(e){return S[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[T])};let V={loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:k.column,reverse:k.reverse?1:0,groups:[],command_types:y[c.COMMAND_TYPES],villages:y[c.VILLAGE]},U)},getCommands:function(){return T},getFilters:function(){return S},getSortings:function(){return k},toggleFilter:function(e,t){t?S[e][t]=!S[e][t]:S[e]=!S[e],L(),g.set(I,S),V.loadCommands()},toggleSorting:function(e){e===k.column?k.reverse=!k.reverse:(k.column=e,k.reverse=!1),V.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,h.OUT,s,{},l,p.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return v},init:function(){for(let e=0;e<d.length;e++)R[d[e]]=!0;for(let e in r)x[r[e]]=!0;try{A=require('two/commandQueue'),h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(x),
[c.INCOMING_UNITS]:angular.copy(R),[c.VILLAGE]:!1};v=!0,E=n.getSelectedCharacter().getGlobalInfo(),S=g.get(I,t,!0),e((function(){L(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,M),a.$on(s.VILLAGE_NAME_CHANGED,P),a.$on(s.COMMAND_IGNORED,C),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,_,b,f,E,h){let v,w;const T=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},S=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,i)},y=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},k=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleCommands=v.commands.slice(e,e+t),
v.pagination.count=v.commands.length},I=function(){const e=Date.now();for(let t=0;t<v.commands.length;t++)100===v.commands[t].model.percent(e)&&v.commands.splice(t,1);k()},R=function(e,a){t.toggleFilter(e,a),v.filters=t.getFilters()},x=function(e){t.toggleSorting(e),v.sorting=t.getSortings()},L=function(){v.commands=t.getCommands()},O=function(){v.selectedVillageId=n.getSelectedVillage().getId()},N=function(){v=a.$new(),v.commandQueueEnabled=t.commandQueueEnabled(),v.commands=t.getCommands(),v.selectedVillageId=n.getSelectedVillage().getId(),v.filters=t.getFilters(),v.sorting=t.getSortings(),v.UNIT_TYPES=b,v.FILTER_TYPES=u,v.COMMAND_TYPES=d,v.UNIT_SPEED_ORDER=_,v.COLUMN_TYPES=l,v.pagination={count:v.commands.length,offset:0,loader:k,limit:m.getPaginationLimit()},v.openCharacterProfile=r.openCharacterProfile,v.openVillageInfo=r.openVillageInfo,v.jumpToVillage=p.jumpToVillage,v.now=T,v.copyTimeModal=A,v.removeTroops=S,v.switchWindowSize=y,v.toggleFilter=R,v.toggleSorting=x,k()
;let e=new i('twoverflow_queue_window',(function(){E.timer.remove(I)}));e.register(s.MAP_SELECTED_VILLAGE,O,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,L),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,L),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,L),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,L),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',v),E.timer.add(I)};return function(){w=e.addMenuButton('Strażnik',40),w.addEventListener('click',N),
...
},h=function(){t.isRunning()?t.stop():t.start()},v=function(){u.presets=l.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},w=function(){u.groups=l.encodeList(_.getGroups(),{disabled:!1,type:'groups'})},T=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},A=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},S=function(){u=a.$new(),u.SETTINGS=i,u.TAB_TYPES=b,u.running=t.isRunning(),u.selectedTab=b.BATTLE,u.settingsMap=o,p.injectScope(u),v(),w(),u.selectTab=f,u.saveSettings=E,u.switchState=h;let e=new r('twoverflow_battle_calculator_window',(function(){console.log('example window closed')}));e.register(s.ARMY_PRESET_UPDATE,v,!0),e.register(s.ARMY_PRESET_DELETED,v,!0),e.register(s.GROUPS_CREATED,w,!0),e.register(s.GROUPS_DESTROYED,w,!0),e.register(s.GROUPS_UPDATED,w,!0),e.register(s.BATTLE_CALCULATOR_START,T),
...
}})),define('two/battleCalculator/settings',[],(function(){return{TROOPS_BARRACKS:'troops_barracks',TROOPS_PRECEPTORY:'troops_preceptory',TROOPS_ORDER:'troops_order',TROOPS_DOMINATION:'troops_domination',TROOPS_TRAINING:'troops_training',BASHPOINTS_SPEAR:'bashpoints_spear',BASHPOINTS_SWORD:'bashpoints_sword',BASHPOINTS_AXE:'bashpoints_axe',BASHPOINTS_ARCHER:'bashpoints_archer',BASHPOINTS_LC:'bashpoints_lc',BASHPOINTS_MA:'bashpoints_ma',BASHPOINTS_RAM:'bashpoints_ram',BASHPOINTS_CATAPULT:'bashpoints_catapult',BASHPOINTS_KNIGHT:'bashpoints_knight',BASHPOINTS_SNOB:'bashpoints_snob',BASHPOINTS_DOPPELSOLDNER:'bashpoints_doppelsoldner',BASHPOINTS_TREBUCHET:'bashpoints_trebuchet'}})),define('two/battleCalculator/settings/updates',(function(){return{TROOPS_BARRACKS:'troops_barracks',TROOPS_PRECEPTORY:'troops_preceptory',TROOPS_ORDER:'troops_order',TROOPS_DOMINATION:'troops_domination',TROOPS_TRAINING:'troops_training',BASHPOINTS_SPEAR:'bashpoints_spear',BASHPOINTS_SWORD:'bashpoints_sword',
BASHPOINTS_AXE:'bashpoints_axe',BASHPOINTS_ARCHER:'bashpoints_archer',BASHPOINTS_LC:'bashpoints_lc',BASHPOINTS_MA:'bashpoints_ma',BASHPOINTS_RAM:'bashpoints_ram',BASHPOINTS_CATAPULT:'bashpoints_catapult',BASHPOINTS_KNIGHT:'bashpoints_knight',BASHPOINTS_SNOB:'bashpoints_snob',BASHPOINTS_DOPPELSOLDNER:'bashpoints_doppelsoldner',BASHPOINTS_TREBUCHET:'bashpoints_trebuchet'}})),define('two/battleCalculator/settings/map',['two/battleCalculator/settings','two/battleCalculator/settings/updates'],(function(e,t){return{[e.TROOPS_BARRACKS]:{default:25,updates:[t.TROOPS_BARRACKS],inputType:'number',min:1,max:25},[e.TROOPS_PRECEPTORY]:{default:10,updates:[t.TROOPS_PRECEPTORY],inputType:'number',min:0,max:10},[e.TROOPS_ORDER]:{default:[],updates:[t.TROOPS_ORDER],disabledOption:!0,inputType:'select',multiSelect:!1,type:'orders'},[e.TROOPS_DOMINATION]:{default:!1,updates:[t.TROOPS_DOMINATION],inputType:'checkbox'},[e.TROOPS_TRAINING]:{default:0,updates:[t.TROOPS_TRAINING],inputType:'number',min:0,
max:5}}})),require(['two/ready','two/battleCalculator','two/battleCalculator/ui','two/battleCalculator/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','world_config'])})),define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,f,E){let h,v,w,T=injector.get('buildingService'),A=injector.get('premiumActionService'),S=injector.get('buildingQueueService'),y=!1,k=!1;const I={};let R,x,L,O,N,C=!0;const P='builder_queue_log',M='builder_queue_settings',z=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=x.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue
;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=x.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){S.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=R.getGroupVillageIds(e),a=a.filter((function(e){return x.getVillage(e)}))):t.each(x.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),F(t))return!1;n.some((function(a){if(++i[a]>t[a])return T.compute(e),V(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),W(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=q(e,t);if(i===g.POSSIBLE)B(e,t,(function(e){a(!0,e)
}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=w[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&B(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},B=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},q=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},F=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},W=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),f.set(P,L),!0};let j={};return j.start=function(){if(!C)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;k=!0,h=setInterval(z,6e4),
v=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=x.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){k=!1,clearInterval(h),clearInterval(v),b.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return k},j.isInitialized=function(){return y},j.getSettings=function(){return O},j.getLogs=function(){return L},j.clearLogs=function(){L=[],f.set(P,L),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0
}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES];if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){y=!0,L=f.get(P,[],!0),x=n.getSelectedCharacter(),R=n.getGroupList(),O=new i({settingsMap:c,storageKey:M}),O.onChange((function(e,t,a){N=O.getAll(),k&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)I[m[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,w=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!k)return!1;setTimeout((function(){let e=x.getVillage(t.village_id);U(e)}),1e3)}))},j})),
...
O.generateBuildingsLevelPoints(),k=i.getSettings(),S=e.addMenuButton('Budowniczy',30),S.addEventListener('click',Q),w.register(s.BUILDER_QUEUE_START,(function(){x=!0,S.classList.remove('btn-orange'),S.classList.add('btn-red'),d.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),w.register(s.BUILDER_QUEUE_STOP,(function(){x=!1,S.classList.remove('btn-red'),S.classList.add('btn-orange'),d.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const w=Object.values(c),T=Object.values(a),A=Object.values(v),S=Object.values(h),y=Object.values(E);let k,I=[],R={},x=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<g.gameTime()+k},P=function(e){I.push(e)},M=function(e){R[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,I)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){k=t.getTimeOffset(),U.initialized=!0,x=b.get(d.QUEUE_SENT,[],!0),L=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(P(e),M(e))}))}(),setInterval((function(){I.length&&I.some((function(e){if(!C(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&I.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){x.push(e)}(e),b.set(d.QUEUE_SENT,x),U.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){L.push(e)}(e),b.set(d.QUEUE_EXPIRED,L),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(f,k){if(!G(e))return k(u.INVALID_ORIGIN);if(!G(i))return k(u.INVALID_TARGET);if(!t.isValidDateTime(o))return k(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return k(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return k(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!S.includes(t))return!1;r[t]&&(b[t]=!0)})))return k(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[h.SUPPORTER]&&delete b[h.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[v.CATAPULT])&&(p||E.HEADQUARTER),T.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return k(u.INVALID_ORIGIN);if(!i)return k(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(C(c))return k(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};P(E),M(E),I=I.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):k(u.INVALID_DATE_TYPE)):k(u.INVALID_CATAPULT_TARGET)):k(u.RELOCATE_DISABLED):k(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete R[e.id];const a=I.some((function(t,a){if(t.id==e.id)return I.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),L=[],x=[]},U.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return O},U.getWaitingCommands=function(){return I},U.getWaitingCommandsObject=function(){return R},U.getSentCommands=function(){return x},
U.getExpiredCommands=function(){return L},U.filterCommands=function(e,t,a){const i=N[e];return(a||I).filter((function(e){return i(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,f,E,h,v){let w,T,A,S,y,k=n.getGameData(),I=k.getOrderedUnitNames(),R=k.getOrderedOfficerNames(),x=n.getPresetList(),L=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,P,M,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],B=function(e,t){L=t.data},q=function(){L=!1},F=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),l=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},W=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),F(e+=t)):''},j=function(){if(w.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!w.isValidDate&&o.getTimeFromString(y.date),t=w.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(y.origin,y.target,i,a,y.officers,!0);w.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),w.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&w.isValidDate?E.gameTime()+C<e?'valid':'invalid':'neutral'},H=function(){y.dateType=w.selectedDateType.value,v.set(m.LAST_DATE_TYPE,w.selectedDateType.value),j()},K=function(){
y.catapultTarget=w.catapultTarget.value},Q=function(){const e=w.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,w.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},w.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=E.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),E.timer.add(e.updateCountdown)},X=function(){w.waitingCommands=t.getWaitingCommands()},J=function(){w.sentCommands=t.getSentCommands()},$=function(){w.expiredCommands=t.getExpiredCommands()},ee=function(){let e=w.waitingCommands;V.forEach((function(a){w.activeFilters[a]&&(e=t.filterCommands(a,w.filtersData,e))})),
w.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ie=function(){w.showCatapultSelect=!!y.units.catapult},ne=function(e){w.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!L)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));f.loadTownDataAsync(L.x,L.y,1,1,(function(e){y.target=e}))},se=function(){y.date=F()},re=function(){if(!y.date)return!1;y.date=W(y.date,100)},ce=function(){if(!y.date)return!1;y.date=W(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(G),y.catapultTarget="wall",w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
...
t&&(w.filtersData[u.ALLOWED_TYPES][e]=!w.filtersData[u.ALLOWED_TYPES][e]),ee()},be=function(){w.activeFilters[u.TEXT_MATCH]=w.filtersData[u.TEXT_MATCH].length>0,ee()},fe={updatePresets:function(){w.presets=o.obj2selectOptions(x.getPresets())},autoCompleteSelected:function(e,t,a,i){if('commandqueue_village_search'!==t)return!1;y[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},w.searchQuery[i]=''},removeCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',me(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',me(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){E.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',me(t.type,'sent'))},start:function(e,a){if(w.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',me('title','activated'))},stop:function(){w.running=t.isRunning(),o.notif('success',me('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{E.timer.remove(e.updateCountdown)})}},Ee=function(){const e=v.get(m.LAST_DATE_TYPE,l.OUT,!0);let _;w=a.$new(),w.selectedTab=N,w.inventory=n.getInventory(),w.presets=o.obj2selectOptions(x.getPresets()),w.travelTimes={},o.each(p,(function(e){w.travelTimes[e]={},o.each(U,(function(t,a){w.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),w.unitOrder=S,w.officers=k.getOrderedOfficerNames(),w.searchQuery={origin:'',target:''},w.isValidDate=!1,w.dateTypes=h.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),w.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},w.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:fe.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},w.showCatapultSelect=!!y.units.catapult,w.attackableBuildings=z,w.commandData=y,
...
w.$watch('selectedTab',(function(){w.selectedTab===O.ADD?_=setInterval((function(){j()}),2500):clearInterval(_)})),w.waitingCommands.forEach(e=>{Z(e)});let b=new i('twoverflow_queue_window',(function(){clearInterval(_),fe.clearCountdownUpdates()}));b.register(s.ARMY_PRESET_UPDATE,fe.updatePresets,!0),b.register(s.ARMY_PRESET_DELETED,fe.updatePresets,!0),b.register(s.SELECT_SELECTED,fe.autoCompleteSelected,!0),b.register(s.COMMAND_QUEUE_REMOVE,fe.removeCommand),b.register(s.COMMAND_QUEUE_REMOVE_ERROR,fe.removeError),b.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,fe.sendTimeLimit),b.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,fe.sendNotOwnVillage),b.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,fe.sendNoUnitsEnough),b.register(s.COMMAND_QUEUE_SEND,fe.sendCommand),b.register(s.COMMAND_QUEUE_START,fe.start),b.register(s.COMMAND_QUEUE_STOP,fe.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',w)};return function(){A=n.getSelectedCharacter(),C=o.getTimeOffset()
;const t=k.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});S=angular.copy(I),S.splice(S.indexOf('catapult'),1),I.forEach((function(e){D[e]=0})),R.forEach((function(e){G[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},P={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},M={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},T=e.addMenuButton('Generał',20),T.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){T.classList.remove('btn-orange'),T.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){T.classList.remove('btn-red'),T.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,B),a.$on(s.DESTROY_CONTEXT_MENU,q),
...
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let v={init:function(){f=!0}};return v.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,v=c.clay,w=c.iron,T=f.currentStock,A=E.currentStock,S=v.currentStock,y=w.currentStock,k=[0,5e3],I=[160,16e3],R=[200,2e4],x=[50,5e3];1==s&&(h=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=h?'chapel'==i&&'church'==i||1!=h||(A>=I[1]&&S>=R[1]&&y>=x[1]&&T>=k[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):A>=I[0]&&S>=R[0]&&y>=x[0]&&T>=k[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==h?A>=I[1]&&S>=R[1]&&y>=x[1]&&T>=k[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):A>=I[0]&&S>=R[0]&&y>=x[0]&&T>=k[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
...
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const Se=function(e){const t=R[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),P.push(a)),a},ye=function(){_.each(L.getVillages(),(function(e,t){Se(t)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ke=function(){const e=R[r.GROUP_ONLY];let t=[];P.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Ie(e)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Ie=function(e){for(let a=0;a<P.length;a++)if(P[a].getId()===e)return P[a].stop(t.KILL_FARMER),P.splice(a,a+1),!0;return!1
},Re=function(e){he(),P.length?F>=P.length?(F=0,V=!1,Z=v.gameTime()+we(),w.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=P[F]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(F++,Re())})),"cycle_begin"===e&&(Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):W=setTimeout((function(){W=null,F=0,Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Re()}),we())},xe=function(e){for(let t=0;t<P.length;t++){let a=P[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Le=function(e){P.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){P.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,M=k.get(X,[]),x=k.get($,{}),L=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),I=new e({settingsMap:c,storageKey:J}),I.onChange((function(e,t,a){R=I.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(ke(),ye()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&C&&(j?(ve(),
V.targetStep({delay:!0})):W&&(ve(),w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),F=0,Re())))})),R=I.getAll(),se("ignore_update"),ne(),ye(),E((function(){ce()}),'presets'),E((function(){P.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(U.length?(C=!0,e=[],P.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){Re("cycle_begin")})),he(),function(){let e=we(),t=e+e/2+Te();Q=setInterval((function(){v.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),w.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(C=!1,!1)):(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=v.gameTime()+we()),w.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,ve(),w.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(Q),e===i.USER_STOP&&be(g.FARM_STOP)},Ne.getFarmer=function(e){return P.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return P},Ne.getSettings=function(){return I},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return x},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return C},Ne.getLogs=function(){return M},Ne.clearLogs=function(){return M=[],k.set(X,M),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),M},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=we,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,h,v,w){let T,A,S,y=n.getPresetList(),k=n.getGroupList(),I={},R={},x=null;const L={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=T.pagination.offset,t=T.pagination.limit;T.visibleLogs=T.logs.slice(e,e+t),T.pagination.count=T.logs.length,T.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(I[e])return I[e];I[e]=!0,R[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){I[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},R[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
T.exceptionVillages.included.forEach((function(e){N(e)})),T.exceptionVillages.ignored.forEach((function(e){N(e)}))},P=function(){t.isRunning()?t.stop():t.start()},M=function(e){T.selectedTab=e},z=function(){A.setAll(A.decode(T.settings)),T.saveButtonColor='orange',h.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){T.presets=f.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},V=function(){T.groups=f.encodeList(k.getGroups(),{disabled:!1,type:'groups'}),T.groupsWithDisabled=f.encodeList(k.getGroups(),{disabled:!0,type:'groups'})},B=function(){T.running=!0,
h.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},q=function(e,t){switch(T.running=!1,T.showCycleTimer=!1,clearInterval(x),t.reason){case d.NO_PRESETS:h.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},F=function(){T.logs=angular.copy(t.getLogs()),O(),T.logs.length||h.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},W=function(){T.farmers=t.getFarmers()},j=function(){T.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){T.exceptionLogs=t.getExceptionLogs()},H=function(){T.showCycleTimer=!1,clearInterval(x)},K=function(e,a){a!==i.USER_STOP&&(T.showCycleTimer=!0,T.nextCycleCountdown=t.getCycleInterval(),x=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;T=a.$new(),T.SETTINGS=b,T.TAB_TYPES=L,T.LOG_TYPES=u,T.running=t.isRunning(),T.selectedTab=L.SETTINGS,T.farmers=t.getFarmers(),
T.villagesLabel=R,T.villagesInfo=I,T.exceptionVillages=t.getExceptionVillages(),T.exceptionLogs=t.getExceptionLogs(),T.logs=t.getLogs(),T.visibleLogs=[],T.showCycleTimer=!1,T.nextCycleCountdown=0,T.saveButtonColor='orange',T.settingsMap=A.settingsMap,T.pagination={count:T.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(T),U(),V(),O(),C(),function(){let e=t.getNextCycleDate();e&&(T.showCycleTimer=!0,T.nextCycleCountdown=e-w.gameTime(),x=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))}(),T.switchFarm=P,T.selectTab=M,T.saveSettings=z,T.clearLogs=t.clearLogs,T.jumpToVillage=p.jumpToVillage,T.openVillageInfo=r.openVillageInfo,T.showReport=_.showReport,T.removeIgnored=D,T.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(x)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
i.register(s.FARM_OVERFLOW_START,B),i.register(s.FARM_OVERFLOW_STOP,q),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,F),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,W),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,H),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',T),T.$watch('settings',(function(){e||(T.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),S=e.addMenuButton('Farmer',10),S.addEventListener('click',(function(){Q()})),v.register(s.FARM_OVERFLOW_START,(function(){S.classList.remove('btn-orange'),S.classList.add('btn-red')})),v.register(s.FARM_OVERFLOW_STOP,(function(){S.classList.remove('btn-red'),S.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,E,h,v,w,T,A){let S,y,k,I,R,x,L,O,N,C,P,M,z,D,G,U,V,B,q,F,W,j,Y,H=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/y)%2&&(t+=I),t-=t%y,a-=a%y,{x:Math.ceil((t-N.width/2)/y),y:Math.ceil((a-N.height/2)/y)}},be=function(e,t){return{x:e/T.TILESIZE.x,y:t/T.TILESIZE.y/T.TILESIZE.off}},fe=function(){Ae(R)},Ee=function(){if(H){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};C.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(P,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Pe.getMapPosition(),a=(t.x-2)*y-e.x,i=(t.y-2)*y-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,k),D.fillRect(0,i,k,1);const n=U.getBoundingClientRect(),l=n.width/T.TILESIZE.x/A.view.z*y,s=n.height/T.TILESIZE.y/A.view.z*y,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)
},he=function(){if(!ie)return!1;const e=Q.village[L][O];we(e?Q.character[e]:[[L,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:L,y:O})},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},Te=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&F.barbarian;if(e.character_id===B){if(e.id===x.getId()&&Y[o.HIGHLIGHT_SELECTED])return F.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return F.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(q&&q===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return F.tribe;if(W&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(W.isAlly(e.tribe_id))return F.ally;if(W.isEnemy(e.tribe_id))return F.enemy;if(W.isNAP(e.tribe_id))return F.friendly}}return F.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Te(i);if(!n)continue;const o=i.x*y+(i.y%2?I:0),l=i.y*y;M.fillStyle=n,M.fillRect(o,l,S,S)}},Se=function(){S=oe[Y[o.MAP_SIZE]],I=Math.round(S/2),y=S+1,k=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,P.width=1e3*y,P.height=1e3*y,M.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ke=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,i=O,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Pe.addHighlight({type:'character',id:e.character_id
},v.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Pe.addHighlight({type:'tribe',id:e.tribe_id},v.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Ie=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Re=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(L===e.x&&O===e.y)return!1;he()}ie=!0,L=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:L,y:O,event:t});const a=Q.village[L][O];ve(a?Q.character[a]:[[L,O]])}(pe,e)}he()},xe=function(){ie&&he(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},fe()},Ce=function(){const e={id:x.getId(),x:x.getX(),y:x.getY()};x=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:x.getId(),x:x.getX(),y:x.getY()}])};let Pe={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
...
!function(){const e=h.getPath(T.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){M.fillStyle=Y[o.COLOR_CONTINENT],M.fillRect(e*y+I-1,t*y+I-1,3,1),M.fillRect(e*y+I,t*y+I-2,1,3)},n=function(e,t){M.fillStyle=Y[o.COLOR_PROVINCE],M.fillRect(e*y+I,t*y+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=E.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;M.beginPath(),M.lineWidth=2,M.strokeStyle="#2B4700",M.rect(r,c,d,u),M.stroke()}))}(),fe()}),'minimap_data')},Pe.enableRendering=function(){H=!0},Pe.disableRendering=function(){H=!1},Pe.isFirstDraw=function(){return!!ge},Pe.init=function(){Pe.initialized=!0,P=document.createElement('canvas'),M=P.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),Se(),t[r.MAP_POSITION]&&Pe.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Pe.drawMinimap()})),Y=j.getAll(),K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},Se()},Pe.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),W=V.getTribeRelations(),B=V.getId(),q=V.getTribeId(),F=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),ye(),x=V.getSelectedVillage(),te.x=x.getX(),te.y=x.getY(),ee.x=x.getX()*y,ee.y=x.getY()*y,e.addEventListener('resize',ye,!1),z.addEventListener('mousedown',ke),z.addEventListener('mouseup',Ie),z.addEventListener('mousemove',Re),z.addEventListener('mouseleave',xe),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){R=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(R),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),Ee(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ce),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Pe})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,f,E,h,v,w){let T,A,S,y,k,I,R,x,L,O,N,C={},P=!1,M={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){T.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(T.highlights.character).forEach((function(e){e in M.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
M.character[e]=t.character_name}))})),Object.keys(T.highlights.tribe).forEach((function(e){e in M.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){M.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},B=function(e,t){if(!L)return;let a=V(t.x,t.y);var i,n;O=a,C[a]=!0,P=!0,(i=t.x,n=t.y,new Promise((function(e){let t=h.getTownAt(i,n);if(t)return e(t);h.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[V(e.x,e.y)])return;if(!P)return;R.appendChild(L),L.classList.remove('ng-hide'),I.tt.name=e.name,I.tt.x=e.x,I.tt.y=e.y,I.tt.province_name=e.province_name,I.tt.points=e.points,I.tt.character_name=e.character_name||'-',I.tt.character_points=e.character_points||0,I.tt.tribe_name=e.tribe_name||'-',I.tt.tribe_tag=e.tribe_tag||'-',I.tt.tribe_points=e.tribe_points||0,I.tt.morale=e.morale||0,I.tt.position={},I.tt.position.x=t.event.pageX+50,I.tt.position.y=t.event.pageY+50,I.tt.visible=!0
;const a=L.getBoundingClientRect(),i=R.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=I.tt.position.y+o>i.top+i.height,s=I.tt.position.x+n>i.width;l&&(I.tt.position.y-=50),L.classList.toggle('left',s),L.classList.toggle('top',l)}))},q=function(e,t){if(!L)return;let a=t?V(t):O;C[a]=!1,P=!1,I.tt.visible=!1,L.classList.add('ng-hide'),x.appendChild(L)},F=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){T.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){T.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=T.addHighlightColor,s.submit=function(){T.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=T.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},W=function(){n.addHighlight(T.selectedHighlight,T.addHighlightColor)},j=function(){N.setAll(N.decode(T.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},H=function(){return Object.keys(T.highlights.character).length+Object.keys(T.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){T.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){q(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){q(),y.style.cursor='url('+v.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){T=a.$new(),T.SETTINGS=p,T.TAB_TYPES=z,T.selectedTab=D,T.selectedHighlight=!1,T.addHighlightColor='#000000',T.highlights=n.getHighlights(),T.highlightNames=M,T.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),T.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),T.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},T.selectTab=G,T.openColorPalette=F,T.addCustomHighlight=W,T.removeHighlight=n.removeHighlight,T.saveSettings=j,T.resetSettings=Y,T.highlightsCount=H,T.openProfile=K,N.injectScope(T,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,B),e.register(s.MINIMAP_VILLAGE_BLUR,q),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',T),U(),k=document.querySelector('#two-minimap .minimap-container'),k.appendChild(S),k.appendChild(y),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),I=i.getSharedData('MapController'),S=document.createElement('canvas'),S.className='minimap',y=document.createElement('canvas'),y.className='cross',n.setViewport(S),n.setViewportRef(y),L=document.querySelector('#map-tooltip'),R=document.querySelector('#wrapper'),x=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},_=function(e){var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,_=g(m),b=e.ReportScouting,f=b.attCharacterId,E=b.attCharacterName,h=b.attScouts,v=b.attLosses,w=b.attVillageId,T=b.attVillageName,A=b.defCharacterId,S=b.defCharacterName,y=b.defLosses,k=b.defScouts,I=b.defVillageId,R=b.defVillageName,x=b.commandType,L='',O='',N='',C='',P=Date.now(),M=p.split('.').join('_');2==u?L=' [color=d96a19]Częściowy sukces[/color]':1==u?L=' [color=0a8028]Sukces[/color]':3==u&&(L=' [color=e21f1f]Porażka[/color]'),O='units'==x?'Jednostki':'buildings'==x?'Budynki':'Sabotaż',n=null==k?'nieznana':k,s=null==h?'nieznana':h,r=null==y?'nieznana':y,c=null==v?'nieznana':v,C=null==E&&null==f?'Brak danych':'[player='+f+']'+E+'[/player]',N=null==T&&null==w?'Brak danych':'[village='+w+']'+T+'[/village]',
t=Math.floor(P/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+M+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+_+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+R+'[/village][b] Gracz cel: [/b][player='+A+']'+S+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+C+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();A!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){
