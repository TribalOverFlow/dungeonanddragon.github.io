...
w(),h(),u.selectTab=f,u.saveSettings=E,u.switchState=_;let e=new r('twoverflow_prank_helper_window',(function(){console.log('example window closed')}));e.register(l.ARMY_PRESET_UPDATE,w,!0),e.register(l.ARMY_PRESET_DELETED,w,!0),e.register(l.GROUPS_CREATED,h,!0),e.register(l.GROUPS_DESTROYED,h,!0),e.register(l.GROUPS_UPDATED,h,!0),e.register(l.PRANK_HELPER_START,v),e.register(l.PRANK_HELPER_STOP,S),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',u)};return function(){p=t.getSettings(),g=e.addMenuButton3('Błazen',60),g.addEventListener('click',A),
...
;const e=n.getPresetList().getPresets();d[t.PRESETS].forEach((function(t){g.push(e[t])})),console.log('selectedPresets',g)},f=function(){m=[];const e=n.getGroupList().getGroups();d[t.GROUPS].forEach((function(t){m.push(e[t])})),console.log('selectedGroups',m)},E={init:function(){u=!0,c=new e({settingsMap:i,storageKey:T}),c.onChange((function(e,t){d=c.getAll(),t[o.PRESETS]&&b(),t[o.GROUPS]&&f()})),d=c.getAll(),console.log('all settings',d),s((function(){b()}),'presets'),a.$on(l.ARMY_PRESET_UPDATE,b),a.$on(l.ARMY_PRESET_DELETED,b),a.$on(l.GROUPS_CREATED,f),a.$on(l.GROUPS_DESTROYED,f),a.$on(l.GROUPS_UPDATED,f)},start:function(){p=!0,console.log('selectedPresets',g),console.log('selectedGroups',m),r.trigger(l.REPORT_HELPER_START)},stop:function(){p=!1,console.log('example module stop'),r.trigger(l.REPORT_HELPER_STOP)},getSettings:function(){return c},isInitialized:function(){return u},isRunning:function(){return p}};return E})),define('two/reportHelper/events',[],(function(){
angular.extend(l,{REPORT_HELPER_START:'report_helper_start',REPORT_HELPER_STOP:'report_helper_stop'})})),define('two/reportHelper/ui',['two/ui','two/reportHelper','two/reportHelper/settings','two/reportHelper/settings/map','two/Settings','two/EventScope','two/utils'],(function(e,t,i,o,s,r,d){let u,p,g,m=n.getPresetList(),T=n.getGroupList();const b={SETTINGS:'settings',SOME_VIEW:'some_view'},f=function(e){u.selectedTab=e},E=function(){p.setAll(p.decode(u.settings)),d.notif('success','Settings saved')},_=function(){t.isRunning()?t.stop():t.start()},w=function(){u.presets=s.encodeList(m.getPresets(),{disabled:!1,type:'presets'})},h=function(){u.groups=s.encodeList(T.getGroups(),{disabled:!1,type:'groups'})},v=function(){u.running=!0,g.classList.remove('btn-orange'),g.classList.add('btn-red'),d.notif('success','Example module started')},S=function(){u.running=!1,g.classList.remove('btn-red'),g.classList.add('btn-orange'),d.notif('success','Example module stopped')},A=function(){u=a.$new(),
