...
e.trigger(s.AUTO_HEALER_STARTED),r=!0,a.getSelectedCharacter().getVillageList().forEach((function(e,n){let a=e.hospital.patients.healed;0==a.length?t.notif('success',m('i18n')('no-patients',i.loc.ale,'auto_healer')):setTimeout((function(){a.forEach((function(t,i){setTimeout((function(){o.emit(l.HOSPITAL_RELEASE_PATIENT,{village_id:e.getId(),patient_id:t.id})}),i*d)}))}),n*c)})),t.notif('success',m('i18n')('deactivated',i.loc.ale,'auto_healer')),u.stop()},u.stop=function(){e.trigger(s.AUTO_HEALER_STOPPED),r=!1},u.isRunning=function(){return r},u.isInitialized=function(){return n},u})),define('two/autoHealer/events',[],(function(){angular.extend(s,{AUTO_HEALER_STARTED:'auto_healer_started',AUTO_HEALER_STOPPED:'auto_healer_stopped'})})),define('two/autoHealer/ui',['two/ui','two/autoHealer','two/utils','queues/EventQueue'],(function(e,t,n,a){let o;return function(){return o=e.addMenuButton('Medyk',50,m('i18n')('description',i.loc.ale,'auto_healer')),o.addEventListener('click',(function(){
t.isRunning()?(t.stop(),n.notif('success',m('i18n')('deactivated',i.loc.ale,'auto_healer'))):(t.start(),n.notif('success',m('i18n')('activated',i.loc.ale,'auto_healer')))})),a.register(s.AUTO_HEALER_STARTED,(function(){o.classList.remove('btn-orange'),o.classList.add('btn-red')})),a.register(s.AUTO_HEALER_STOPPED,(function(){o.classList.remove('btn-red'),o.classList.add('btn-orange')})),t.isRunning()&&a.trigger(s.AUTO_HEALER_STARTED),opener}})),require(['two/ready','two/autoHealer','two/autoHealer/ui','Lockr','queues/EventQueue'],(function(e,t,i,n,a){const o='auto_healer_active';if(t.isInitialized())return!1;e((function(){t.init(),i(),e((function(){n.get(o,!1,!0)&&t.start(),a.register(s.AUTO_HEALER_STARTED,(function(){n.set(o,!0)})),a.register(s.AUTO_HEALER_STOPPED,(function(){n.set(o,!1)}))}),['initial_village'])}))})),
