...
o.emit(l.TRIBE_GET_MEMBERLIST,{tribe:_},(function(e){for(var t=e.members,a=0;a<t.length;a++)w.push(t[a].id)})),b.forEach((function(e){f.push(e.getId())}));var e=p.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:g.column,reverse:g.reverse?1:0,groups:[],command_types:['attack'],villages:f},y),setTimeout(A,6e4)},y=function(e){for(var t,a=[],i=e.commands,n=0;n<i.length;n++)if(c.formatCommand(i[n]),w.includes(i[n].origin_character_id))console.log('Nadchodzące ruchy wojsk pochodzą od współplemieńca '+i[n].origin_character_id+' Rodzaj '+i[n].command_type);else if('attack'==i[n].command_type)if(v.includes(i[n].command_id))console.log('Już wysłano powiadomienie');else{v.push(i[n].command_id),i[n].slowestUnit=S(i[n]);var s=i[n].time_completed,d=(t=void 0,t=new Date(1e3*s),r=t.toLocaleString(),r),u='',p='';'sword'==i[n].slowestUnit?(p=' [color=03709d]MIECZNIK[/color]',
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,i,r,c,d,u,p,g,m,_,b,f){let E,h,v=!1,w=injector.get('overviewService'),T=[],A=!1,y={},S={},k={reverse:!1,column:i.TIME_COMPLETED};const I='attack_view_filters',x={},R={},L=function(){const e=[c.COMMAND_TYPES],t=n.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let i in y[e[t]])if(a[e[t]]||(a[e[t]]=[]),y[e[t]][i])switch(e[t]){case c.COMMAND_TYPES:i===r.ATTACK?a[e[t]].push(r.ATTACK):i===r.SUPPORT?a[e[t]].push(r.SUPPORT):i===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}S=a,S.village=y[c.VILLAGE]?[t]:[]},O=function(){V.loadCommands()},N=function(e,t){f.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){
for(let e=0;e<T.length;e++)T[e].command_id===t.command_id&&T.splice(e,1);f.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},M=function(e,t){for(let e=0;e<T.length;e++)T[e].target_village_id===t.village_id?(T[e].target_village_name=t.name,T[e].targetVillage.name=t.name):T[e].origin_village_id===t.village_id&&(T[e].origin_village_name=t.name,T[e].originVillage.name=t.name);f.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},P=function(e,t){S[c.VILLAGE].length&&(S[c.VILLAGE]=[t],V.loadCommands())},z=function(e){const a={x:e.origin_x,y:e.origin_y},i={x:e.target_x,y:e.target_y};return d.map((function(n){const o=t.getTravelTime(a,i,{[n]:1},e.command_type,{},!1);return{unit:n,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},D=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},G=function(e,t){let a=0;if(b.hasTownDataInChunk(e.x,e.y)){
const a=b.loadTownData(e.x,e.y,25,25,25),i=n.getSelectedCharacter().getTribeId(),o=n.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=D(r,e);else if(c.length)l=D(c,e);else{if(!i)return t(!1);{const a=s.filter((function(e){return e.tribe_id===i}));if(!a.length)return t(!1);l=D(a,e)}}return t(l[0])}const i=_.scaledGridCoordinates(e.x,e.y,25,25,25);b.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===i.length&&G(e,t)}))},U=function(e){T=e.commands;for(let e=0;e<T.length;e++)w.formatCommand(T[e]),T[e].slowestUnit=z(T[e]);T=T.filter((function(e){return y[c.INCOMING_UNITS][e.slowestUnit]})),f.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[T])};let V={loadCommands:function(){const e=E.getCommandListModel().getIncomingCommands().length,t=e>25?e:25
;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:k.column,reverse:k.reverse?1:0,groups:[],command_types:S[c.COMMAND_TYPES],villages:S[c.VILLAGE]},U)},getCommands:function(){return T},getFilters:function(){return y},getSortings:function(){return k},toggleFilter:function(e,t){t?y[e][t]=!y[e][t]:y[e]=!y[e],L(),g.set(I,y),V.loadCommands()},toggleSorting:function(e){e===k.column?k.reverse=!k.reverse:(k.column=e,k.reverse=!1),V.loadCommands()},setCommander:function(e,a){G(e.targetVillage,(function(i){const n=e.targetVillage,o=i,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),A.addCommand(n,o,a,h.OUT,s,{},l,p.WALL),A.isRunning()||A.start()}))},commandQueueEnabled:function(){return!!A},isInitialized:function(){return v},init:function(){for(let e=0;e<d.length;e++)x[d[e]]=!0;for(let e in r)R[r[e]]=!0;try{A=require('two/commandQueue'),h=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(R),
[c.INCOMING_UNITS]:angular.copy(x),[c.VILLAGE]:!1};v=!0,E=n.getSelectedCharacter().getGlobalInfo(),y=g.get(I,t,!0),e((function(){L(),a.$on(s.COMMAND_INCOMING,O),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,P),a.$on(s.VILLAGE_NAME_CHANGED,M),a.$on(s.COMMAND_IGNORED,C),V.loadCommands()}),['initial_village'])}};return V})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,i,o,l,d,u,_,b,f,E,h){let v,w;const T=function(){return Date.now()/1e3},A=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},y=function(e){const i=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'H:mm:ss:sss dd/MM/yyyy');t.setCommander(e,i)},S=function(){let e=h('#two-attack-view').parent(),t=h('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},k=function(){const e=v.pagination.offset,t=v.pagination.limit;v.visibleCommands=v.commands.slice(e,e+t),
v.pagination.count=v.commands.length},I=function(){const e=Date.now();for(let t=0;t<v.commands.length;t++)100===v.commands[t].model.percent(e)&&v.commands.splice(t,1);k()},x=function(e,a){t.toggleFilter(e,a),v.filters=t.getFilters()},R=function(e){t.toggleSorting(e),v.sorting=t.getSortings()},L=function(){v.commands=t.getCommands()},O=function(){v.selectedVillageId=n.getSelectedVillage().getId()},N=function(){v=a.$new(),v.commandQueueEnabled=t.commandQueueEnabled(),v.commands=t.getCommands(),v.selectedVillageId=n.getSelectedVillage().getId(),v.filters=t.getFilters(),v.sorting=t.getSortings(),v.UNIT_TYPES=b,v.FILTER_TYPES=u,v.COMMAND_TYPES=d,v.UNIT_SPEED_ORDER=_,v.COLUMN_TYPES=l,v.pagination={count:v.commands.length,offset:0,loader:k,limit:m.getPaginationLimit()},v.openCharacterProfile=r.openCharacterProfile,v.openVillageInfo=r.openVillageInfo,v.jumpToVillage=p.jumpToVillage,v.now=T,v.copyTimeModal=A,v.removeTroops=y,v.switchWindowSize=S,v.toggleFilter=x,v.toggleSorting=R,k()
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,i,r,c,d,p,g,m,_,b,f,E){let h,v,w,T=injector.get('buildingService'),A=injector.get('premiumActionService'),y=injector.get('buildingQueueService'),S=!1,k=!1;const I={};let x,R,L,O,N,C=!0;const M='builder_queue_log',P='builder_queue_settings',z=function(){const e=G();if(!C)return j.stop(),!1;e.forEach((function(e){const t=R.getVillage(e),a=t.checkReadyState(),i=t.buildingQueue;return i.getAmountJobs()!==i.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){G().forEach((function(e){const t=R.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
y.canBeFinishedForFree(a,t)&&A.instantBuild(a,_.MASS_SCREEN,!0,e)}))}}))},G=function(){const e=N[r.GROUP_VILLAGES];let a=[];return e?(a=x.getGroupVillageIds(e),a=a.filter((function(e){return R.getVillage(e)}))):t.each(R.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let i=angular.copy(I);const n=N[r.BUILDING_SEQUENCES][N[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),F(t))return!1;n.some((function(a){if(++i[a]>t[a])return T.compute(e),V(e,a,(function(t,a){t&&a.job&&(b.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),W(e.getId(),a.job))})),!0}))},V=function(e,t,a){const i=B(e,t);if(i===g.POSSIBLE)q(e,t,(function(e){a(!0,e)}));else if(i===g.NOT_ENOUGH_FOOD&&N[r.PRIORIZE_FARM]){const t=w[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&q(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},q=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:_.MASS_SCREEN,premium:!1},a)},B=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,i=e.getResources().getComputed();if(i.clay.currentStock-N[r.PRESERVE_CLAY]<t.clay||i.iron.currentStock-N[r.PRESERVE_IRON]<t.iron||i.wood.currentStock-N[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},F=function(e){for(let t in e)if(e[t]<w[t])return!1;return!0},W=function(e,t){let a={time:E.gameTime(),villageId:e,building:t.building,level:t.level};return L.unshift(a),L.length>500&&L.splice(L.length-500,L.length),f.set(M,L),!0};let j={};return j.start=function(){if(!C)return b.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;k=!0,h=setInterval(z,6e4),v=setInterval(D,6e3),e((function(){G().forEach((function(e){const t=R.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),z(),D()}),['all_villages_ready']),b.trigger(s.BUILDER_QUEUE_START)},j.stop=function(){k=!1,clearInterval(h),
clearInterval(v),b.trigger(s.BUILDER_QUEUE_STOP)},j.isRunning=function(){return k},j.isInitialized=function(){return S},j.getSettings=function(){return O},j.getLogs=function(){return L},j.clearLogs=function(){L=[],f.set(M,L),b.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},j.addBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},j.updateBuildingSequence=function(e,t){let a=N[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=n.getGameData().getBuildings();for(let a=0;a<e.length;a++){let i=e[a];if(++e[i]>t[i].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},j.removeSequence=function(e){let t=N[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),b.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},j.init=function(){S=!0,L=f.get(M,[],!0),R=n.getSelectedCharacter(),x=n.getGroupList(),O=new i({settingsMap:c,storageKey:P}),O.onChange((function(e,t,a){N=O.getAll(),k&&t[d.ANALYSE]&&z(),a.quiet||b.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),N=O.getAll();for(let e in m)I[m[e]]=0;C=Object.keys(N[r.BUILDING_SEQUENCES]).length,w=!!C&&function(e){const t=N[r.BUILDING_SEQUENCES][e];let a=angular.copy(I);return t.forEach((function(e){a[e]++})),a}(N[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!k)return!1;setTimeout((function(){let e=R.getVillage(t.village_id);U(e)}),1e3)}))},j})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a];Array.isArray(i)?(i.sort(()=>Math.random()-.5),t=t.concat(i)):t.push(i)}return t}
...
COMMAND_QUEUE_ADD_INVALID_OFFICER:'command_queue_add_invalid_officer',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled'})})),define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,i,d,u,p,_,b,E,h,v,w,T){let A,y,S,k,I=n.getGroupList(),x={},R=!1,L={sequencesAvail:!0,modal:{}},O={sequencesAvail:!0},N={};const C={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let M,P={},z={},D=!1,G=!1;const U=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},V=function(e,a,i){if(i>=e.length){let a=i-e.length+1;for(;a--;)e.push(t)}e.splice(i,0,e.splice(a,1)[0])},q=function(e,t){switch(i.addBuildingSequence(e,t)){case E.SEQUENCE_SAVED:return!0;case E.SEQUENCE_EXISTS:
...
if(a.building===e&&a.level===t)return i=!0})),i}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:T.readableSeconds(o.build_time),levelPoints:x[e][t-1],state:l}}))},O.generateBuildingSequenceFinal=function(e){const t=A.settings[_.ACTIVE_SEQUENCE].value,a=A.settings[_.BUILDING_SEQUENCES][e||t];let i={},n=[];for(let e in S)i[e]={level:0,order:S[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++i[e].level,a=S[e].individual_level_costs[t];i[e].resources.wood+=parseInt(a.wood,10),i[e].resources.clay+=parseInt(a.clay,10),i[e].resources.iron+=parseInt(a.iron,10),i[e].resources.food+=parseInt(a.food,10),i[e].build_time+=parseInt(a.build_time,10),i[e].points+=x[e][t-1]}));for(let e in i)0!==i[e].level&&n.push({building:e,level:i[e].level,order:i[e].order,resources:i[e].resources,points:i[e].points,build_time:i[e].build_time});O.buildingSequenceFinal=n},
O.updateVisibleBuildingSequence=function(){const e=A.pagination.buildingSequence.offset,t=A.pagination.buildingSequence.limit;O.visibleBuildingSequence=O.buildingSequence.slice(e,e+t),A.pagination.buildingSequence.count=O.buildingSequence.length},O.generateBuildingsLevelPoints=function(){const e=n.getGameData();let t;for(let a in e.data.buildings){let i=e.getBuildingDataForBuilding(a);t=0,x[a]=[];for(let e=1;e<=i.max_level;e++){let n=U(i.points,i.points_factor,e)-t;t+=n,x[a].push(n)}}},L.moveUp=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let i=e[a];i.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===i.building&&(e[a-1].level++,i.level--,t=!0),V(e,a,a-1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(D=!0)},L.moveDown=function(){let e=angular.copy(L.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let i=e[a];i.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===i.building&&(e[a+1].level--,i.level++,t=!0),
V(e,a,a+1))))}L.buildingSequence=e,L.updateVisibleBuildingSequence(),t&&(D=!0)},L.addBuilding=function(e,t,a=1){const i=t-1;let n=L.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)n.splice(i,0,o);return L.buildingSequence=L.updateLevels(n,e),L.updateVisibleBuildingSequence(),D=!0,!0},L.removeBuilding=function(e){const t=L.buildingSequence[e].building;L.buildingSequence.splice(e,1),L.buildingSequence=L.updateLevels(L.buildingSequence,t),L.updateVisibleBuildingSequence(),D=!0},L.updateLevels=function(e,t){let a=0,i=[];for(let n=0;n<e.length;n++){let o=e[n];o.building===t?a<S[t].max_level&&i.push({level:++a,building:t,checked:!1}):i.push(o)}return i},L.generateBuildingSequence=function(){const e=k.get(_.BUILDING_SEQUENCES),t=Object.keys(e).length;if(L.sequencesAvail=t,!t)return!1;const a=e[L.selectedSequence.value];let i={};for(let e in h)i[h[e]]=0;L.buildingSequence=a.map((function(e){return{level:++i[e],building:e,checked:!1}})),
...
d.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){d.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){A.running=!0},stopped:function(){A.running=!1}},H=function(){const e=k.get(_.ACTIVE_SEQUENCE);A=a.$new(),A.selectedTab=C.SETTINGS,A.TAB_TYPES=C,A.SETTINGS=_,A.running=R,A.pagination={},A.settingsMap=k.settingsMap,A.villagesLabel=z,A.villagesInfo=P,A.editorView=L,A.editorView.buildingSequence={},A.editorView.visibleBuildingSequence=[],A.editorView.selectedSequence={name:e,value:e},A.editorView.lastAddedBuilding=h.HEADQUARTER,A.editorView.lastAddedIndex=1,A.settingsView=O,A.settingsView.buildingSequence={},A.settingsView.buildingSequenceFinal={},A.logsView=N,A.logsView.logs=i.getLogs(),A.selectTab=F,A.switchBuilder=j,A.saveSettings=W,A.createSequence=B,A.openVillageInfo=r.openVillageInfo,k.injectScope(A),K.updateGroups(),K.updateSequences(),A.pagination.buildingSequence={
...
const w=Object.values(c),T=Object.values(a),A=Object.values(v),y=Object.values(h),S=Object.values(E);let k,I=[],x={},R=[],L=[],O=!1;const N={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===n.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const i=t[r.TEXT_MATCH].toLowerCase().split(/\W/),n=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return i.some((function(e){if(e.length&&!n.includes(e))return a=!1,!0})),a}},C=function(e){return e<g.gameTime()+k},M=function(e){I.push(e)},P=function(e){x[e.id]=e},z=function(){
b.set(d.QUEUE_COMMANDS,I)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},G=function(e){return f.call(e,'x')&&f.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){k=t.getTimeOffset(),U.initialized=!0,R=b.get(d.QUEUE_SENT,[],!0),L=b.get(d.QUEUE_EXPIRED,[],!0),function(){const e=b.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,i.TIME_LIMIT):(M(e),P(e))}))}(),setInterval((function(){I.length&&I.some((function(e){if(!C(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,i.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&I.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=n.getVillages()[e.origin.id];if(!a)return i.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=i.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=i.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=i.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){R.push(e)}(e),b.set(d.QUEUE_SENT,R),U.removeCommand(e,i.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){L.push(e)}(e),b.set(d.QUEUE_EXPIRED,L),U.removeCommand(e,t)},U.addCommand=function(e,i,o,l,s,r,d,p){let m={},b={};return new Promise((function(f,k){if(!G(e))return k(u.INVALID_ORIGIN);if(!G(i))return k(u.INVALID_TARGET);if(!t.isValidDateTime(o))return k(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!A.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return k(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return k(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!y.includes(t))return!1;r[t]&&(b[t]=!0)})))return k(u.INVALID_OFFICER_TYPE)}return w.includes(d)?d!==c.RELOCATE||n.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&b[h.SUPPORTER]&&delete b[h.SUPPORTER],'string'!=typeof p||S.includes(p)?(p=!(d!==c.ATTACK||!m[v.CATAPULT])&&(p||E.HEADQUARTER),T.includes(l)?void Promise.all([new Promise(t=>_.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>_.loadTownDataAsync(i.x,i.y,1,1,e))]).then((function(n){if(e=n[0],i=n[1],!e)return k(u.INVALID_ORIGIN);if(!i)return k(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,i,m,d,b,!0),c=l===a.ARRIVE?s-r:s,_=l===a.ARRIVE?s:s+r;if(C(c))return k(u.ALREADY_SENT);const E={id:t.guid(),travelTime:r,arriveTime:_,sendTime:c,origin:e,target:i,date:o,dateType:l,units:m,officers:b,type:d,catapultTarget:p,countdown:c-g.gameTime()};M(E),P(E),I=I.sort((function(e,t){return e.sendTime-t.sendTime})),
z(),f(E)})):k(u.INVALID_DATE_TYPE)):k(u.INVALID_CATAPULT_TARGET)):k(u.RELOCATE_DISABLED):k(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete x[e.id];const a=I.some((function(t,a){if(t.id==e.id)return I.splice(a,1),z(),!0}));if(a)switch(t){case i.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case i.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case i.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case i.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearRegisters=function(){b.set(d.QUEUE_EXPIRED,[]),b.set(d.QUEUE_SENT,[]),L=[],R=[]},U.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return O},U.getWaitingCommands=function(){return I},U.getWaitingCommandsObject=function(){return x},U.getSentCommands=function(){return R},
...
COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,i,o,l,d,u,p,m,_,b,f,E,h,v){let w,T,A,y,S,k=n.getGameData(),I=k.getOrderedUnitNames(),x=k.getOrderedOfficerNames(),R=n.getPresetList(),L=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},N=O.ADD;let C,M,P,z=[],D={},G={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},V=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],q=function(e,t){L=t.data},B=function(){L=!1},F=function(e){
const t=new Date(e||E.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),i=E.zerofill(a-a%100,3),n=E.zerofill(t.getSeconds(),2),l=E.zerofill(t.getMinutes(),2);return E.zerofill(t.getHours(),2)+':'+l+':'+n+':'+i+' '+E.zerofill(t.getDate(),2)+'/'+E.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},W=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),F(e+=t)):''},j=function(){if(w.isValidDate=o.isValidDateTime(S.date),!S.origin||!S.target)return;const e=!!w.isValidDate&&o.getTimeFromString(S.date),t=w.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(i,n){const l=o.getTravelTime(S.origin,S.target,i,a,S.officers,!0);w.travelTimes[a][n].travelTime=g('readableMillisecondsFilter')(l),w.travelTimes[a][n].status=e?Y(t?e-l:e):'neutral'}))}))},Y=function(e){return e&&w.isValidDate?E.gameTime()+C<e?'valid':'invalid':'neutral'},Q=function(){S.dateType=w.selectedDateType.value,v.set(m.LAST_DATE_TYPE,w.selectedDateType.value),j()},K=function(){
S.catapultTarget=w.catapultTarget.value},H=function(){const e=w.selectedInsertPreset.value;if(!e)return!1;const t=n.getPresetList().getPresets()[e];w.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},S.units=angular.copy(t.units),S.officers=angular.copy(t.officers),t.catapult_target&&(S.catapultTarget=t.catapult_target,w.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},w.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=E.serverTime()+a.GAME_TIME_OFFSET,i=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=i-t}),E.timer.add(e.updateCountdown)},X=function(){w.waitingCommands=t.getWaitingCommands()},J=function(){w.sentCommands=t.getSentCommands()},$=function(){w.expiredCommands=t.getExpiredCommands()},ee=function(){let e=w.waitingCommands;V.forEach((function(a){w.activeFilters[a]&&(e=t.filterCommands(a,w.filtersData,e))})),
w.visibleWaitingCommands=e},te=function(e){0===S.units[e]&&(S.units[e]='')},ae=function(e){''===S.units[e]&&(S.units[e]=0)},ie=function(){w.showCatapultSelect=!!S.units.catapult},ne=function(e){w.selectedTab=e},oe=function(){const e=n.getSelectedVillage().data;S.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:A.getId()}},le=function(){if(!L)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));f.loadTownDataAsync(L.x,L.y,1,1,(function(e){S.target=e}))},se=function(){S.date=F()},re=function(){if(!S.date)return!1;S.date=W(S.date,100)},ce=function(){if(!S.date)return!1;S.date=W(S.date,-100)},de=function(){S.units=angular.copy(D),S.officers=angular.copy(G),S.catapultTarget="wall",w.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},w.showCatapultSelect=!1},ue=function(e){t.addCommand(S.origin,S.target,S.date,S.dateType,S.units,S.officers,e,S.catapultTarget).then((function(e){X(),ee(),Z(e),
...
;const t=k.getAttackableBuildings();for(let e in t)z.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});y=angular.copy(I),y.splice(y.indexOf('catapult'),1),I.forEach((function(e){D[e]=0})),x.forEach((function(e){G[e]=!1})),S={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(G),catapultTarget:"wall",type:null},M={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},T=e.addMenuButton('Generał',20),T.addEventListener('click',Ee),b.register(s.COMMAND_QUEUE_START,(function(){T.classList.remove('btn-orange'),T.classList.add('btn-red')})),b.register(s.COMMAND_QUEUE_STOP,(function(){T.classList.remove('btn-red'),T.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,q),a.$on(s.DESTROY_CONTEXT_MENU,B),
...
;return e<0||!t&&e>a.length-1?0:(i=t?n.getWorldConfig().getChapelBonus():a[e],Math.floor(100*i))},m=function(e,t){o.emit(l.VILLAGES_IN_PROVINCE,{village_id:e},t)};let v={init:function(){f=!0}};return v.start=function(){i.trigger(s.FAITH_CHECKER_STARTED),E=!0,n.getSelectedCharacter().getVillageList().forEach((function(i){let n=i.data.villageId,s=i.data.buildings.chapel.level,r=i.buildingQueue.data.queue,c=i.getResources().getComputed(),f=c.food,E=c.wood,v=c.clay,w=c.iron,T=f.currentStock,A=E.currentStock,y=v.currentStock,S=w.currentStock,k=[0,5e3],I=[160,16e3],x=[200,2e4],R=[50,5e3];1==s&&(h=1),m(n,(function(i){_=u(i.villages),b=p(_,1===s),console.log(b),50!=b||r!==t&&0!=r.length?50==b&&r?r.forEach((function(t){let i=t.building;'chapel'==i&&'church'==i||0!=h?'chapel'==i&&'church'==i||1!=h||(A>=I[1]&&y>=x[1]&&S>=R[1]&&T>=k[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),
e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))):A>=I[0]&&y>=x[0]&&S>=R[0]&&T>=k[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('chapel',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker'))})):e.notif('success',g('i18n')('full',a.loc.ale,'faith_checker')):1==h?A>=I[1]&&y>=x[1]&&S>=R[1]&&T>=k[1]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'church',village_id:n,location:d.MASS_SCREEN,premium:!1}),e.notif('success',g('i18n')('church',a.loc.ale,'faith_checker'))):e.notif('error',g('i18n')('resources',a.loc.ale,'faith_checker')):A>=I[0]&&y>=x[0]&&S>=R[0]&&T>=k[0]?(o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:'chapel',village_id:n,location:d.MASS_SCREEN,premium:!1}),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,i,r,c,p,g,m,_,E,h,v,w,T,A,y,S,k){let I,x,R,L,O,N=!1,C=!1,M=[],P=[],z=[],D=[],G=[],U=[],V=!1,q=!1,B=!1,F=0,W=null,j=null,Y=null,Q={},K=v.gameTime(),H=null,Z=null;const X='farm_overflow_logs',J='farm_overflow_settings',$='farm_overflow_exception_logs',ee=[y.WOOD,y.CLAY,y.IRON],te={distance:function(e){return!e.distance.between(x[r.MIN_DISTANCE],x[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===L.getId()},included:function(e){return e.character_id&&!z.includes(e.id)},ignored:function(e){return D.includes(e.id)},points:function(e){
return!e.between(x[r.MIN_POINTS],x[r.MAX_POINTS])}},ae=[te.distance,te.ownPlayer,te.included,te.ignored],ie=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},ne=function(){!function(){const e=x[r.GROUP_INCLUDE];z=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);z=z.concat(t)})),z=ie(z)}(),function(){const e=x[r.GROUP_IGNORE];D=n.getGroupList().getGroupVillageIds(e)}(),function(){const e=x[r.GROUP_ONLY];G=[],e.forEach((function(e){let t=n.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!L.getVillage(e)})),G=G.concat(t)})),G=ie(G)}(),function(){const e=D.concat(z);let t=!1;e.forEach((function(e){f.call(R,e)||(R[e]={time:v.gameTime(),report:!1},t=!0)})),_.each(R,(function(a,i){i=parseInt(i,10),e.includes(i)||(delete R[i],t=!0)})),t&&(k.set($,R),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),w.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},oe=function(e,t){
const a=x[r.GROUP_INCLUDE],i=x[r.GROUP_IGNORE],n=x[r.GROUP_ONLY],o=L.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id&&(o?(Ie(t.village_id),l=!0):(Le(t.village_id),be(g.IGNORED_VILLAGE,{villageId:t.village_id}),_e(t.village_id))),a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE,{villageId:t.village_id}),_e(t.village_id)),n.includes(t.group_id)&&o){let e=ye(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}l&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},le=function(e,t){const a=x[r.GROUP_INCLUDE],i=x[r.GROUP_IGNORE],n=x[r.GROUP_ONLY],o=L.getVillage(t.village_id);let l=!1;if(ne(),i===t.group_id)if(o){let e=ye(t.village_id);e.init().then((function(){C&&e.start()})),l=!0}else Oe(),be(g.IGNORED_VILLAGE_REMOVED,{villageId:t.village_id});a.includes(t.group_id)&&!o&&(Oe(),be(g.INCLUDED_VILLAGE_REMOVED,{villageId:t.village_id})),n.includes(t.group_id)&&o&&(Ie(t.village_id),l=!0),l&&w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},se=function(e){
const t=n.getGroupList().getGroups(),a=x[r.GROUP_IGNORE],i=x[r.GROUP_ONLY],o=x[r.GROUP_INCLUDE],l=f.call(t,a)?a:I.getDefault(r.GROUP_IGNORE),s=i.filter(e=>f.call(t,e)),c=o.filter(e=>f.call(t,e));I.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},re=function(){se(),ne(),ke(),Oe(),Se()},ce=function(){U=[];const e=n.getPresetList().getPresets();x[r.PRESETS].forEach((function(t){if(!f.call(e,t))return;let a=e[t];a.load=me(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),U.push(a)})),U=U.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},de=function(){ce(),U.length||(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),C&&Ne.stop())},ue=function(e,t){x[r.IGNORE_ON_LOSS]&&x[r.GROUP_IGNORE]&&C&&t.type===T.TYPES.ATTACK&&1!==t.result&&Re(t.target_village_id)&&(Q[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=x[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})
}(t.target_village_id))},pe=function(e,t){V&&B&&t.origin.id===V.getId()&&t.target.id===B.id&&'forward'===t.direction&&t.type===T.TYPES.ATTACK&&V.commandSent(t)},ge=function(e,t){V&&q&&B&&t.cause===l.SEND_PRESET.type&&V.commandError(t)},me=function(e){let t=0;return _.each(e.units,(function(e,a){e&&(t+=O[a].load*e)})),t},_e=function(e){R[e]={time:v.gameTime(),report:Q[e]||!1},delete Q[e],k.set($,R),w.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},be=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=v.gameTime(),t.type=e,P.unshift(t),fe(),!0)},fe=function(){const e=x[r.LOGS_LIMIT];P.length>e&&P.splice(P.length-e,P.length),k.set(X,P),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},Ee=function(e,t,a){const i=x[r.TARGET_MULTIPLE_FARMERS],n=x[r.TARGET_SINGLE_ATTACK];if(i&&a){if(n&&e)return!0}else if(n){if(e||t)return!0}else if(t)return!0;return!1},he=function(){K=v.gameTime()},ve=function(){clearTimeout(W),clearTimeout(j),clearTimeout(Y),W=null,j=null,Y=null
...
!0):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(w.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ae.prototype.stop=function(e){this.running=!1,w.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&this.setStatus(i.USER_STOP),ve(),this.onCycleEndFn(e),this.onCycleEndFn=b},Ae.prototype.targetStep=async function(e={}){if(!this.running)return!1;he();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const b=()=>new Promise((t,a)=>{e.delay?j=setTimeout(()=>{if(j=null,!this.running)return a(i.USER_STOP);t()},_.randomSeconds(Te())):t()}),E=()=>new Promise((e,a)=>{const n=50-x[r.PRESERVE_COMMAND_SLOTS];t.length>=n?a(i.COMMAND_LIMIT):e()}),y=()=>new Promise((e,t)=>{if(x[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),n=e.getMaxStorage();if(ee.every(e=>a[e].currentStock===n))return t(i.FULL_STORAGE)}e()
}),k=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?t(i.TARGET_CYCLE_END):(a=this.targets[this.index],void e()):t(i.NO_TARGETS)),I=()=>new Promise((e,t)=>{S.getTownAtAsync(a.x,a.y,n=>{if(te.points(n.points))return t(i.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},n=>{this.running?null!==a.character_id||null===n.owner_id||z.includes(a.id)?a.attack_protection?t(i.PROTECTED_VILLAGE):e():t(i.ABANDONED_CONQUERED):t(i.USER_STOP)})})}),R=()=>new Promise((e,t)=>{!function(e,t){const a=n.getPresetList().getPresetsByVillageId(e);let i=[];if(U.forEach((function(e){f.call(a,e.id)||i.push(e.id)})),i.length){for(let e in a)f.call(a,e)&&i.push(e);o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:i},t)}else t()}(this.villageId,()=>{this.running?e():t(i.USER_STOP)})}),O=()=>new Promise((e,t)=>{const n=this.village.getUnitInfo().getUnits(),o=60*x[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=h.actualDistance(l,a);_.each(U,l=>{
if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return n[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):t(i.TIME_LIMIT),!1}),g||t(i.NO_UNITS)}),N=()=>new Promise((e,n)=>{c=!1,p=L.getVillageList();const o=p.every(e=>e.isInitialized(A.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),Ee(u,c,o))return n(i.BUSY_TARGET);o&&(m=!0),e()}),C=()=>new Promise((e,t)=>{if(!u&&!c)return e();const n=60*x[r.MULTIPLE_ATTACKS_INTERVAL];if(!n)return e();if(x[r.TARGET_SINGLE_ATTACK]&&!x[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(v.gameTime()/1e3),l=x[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=h.actualDistance(s,a),_=d.calculateTravelTime(g,{
barbarian:!a.character_id,officers:!0,effects:!0}),b=d.getTravelTimeForDistance(g,_,m,T.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+b-e.time_completed)<n)}))return t(i.BUSY_TARGET);e()}),M=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return t(i.USER_STOP);const n=a.commands.own.filter(e=>e.type===T.TYPES.ATTACK&&'forward'===e.direction),o=n.some(e=>e.start_village_id!==this.villageId),l=n.some(e=>e.start_village_id===this.villageId);if(Ee(l,o,!0))return t(i.BUSY_TARGET);e()})});let P=new Promise((e,t)=>{b().then(E).then(y).then(k).then(I).then(R).then(O).then(N).then(C).then(M).then(e).catch(t)}),D=new Promise((e,t)=>{Y=setTimeout(()=>{this.running&&t(i.EXPIRED_STEP)},3e4)});Promise.race([P,D]).then(()=>{if(!this.running)return!1
...
Ae.prototype.getStatus=function(){return this.status||i.UNKNOWN},Ae.prototype.commandSent=function(e){q=!1,B=!1,ve(),be(g.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},Ae.prototype.commandError=function(){q=!1,B=!1,this.stop(i.COMMAND_ERROR)},Ae.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ae.prototype.loadTargets=function(e){const t=this.village.getPosition();m.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=h.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return ae.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,x[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ae.prototype.getTargets=function(){return this.targets},Ae.prototype.getIndex=function(){return this.index},Ae.prototype.getVillage=function(){return this.village},
Ae.prototype.isRunning=function(){return this.running},Ae.prototype.isInitialized=function(){return this.initialized},Ae.prototype.removeTarget=function(e){return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ae.prototype.getId=function(){return this.villageId};const ye=function(e){const t=x[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!G.includes(e))return!1;if(D.includes(e))return!1;let a=Ne.getFarmer(e);return a||(a=new Ae(e),M.push(a)),a},Se=function(){_.each(L.getVillages(),(function(e,t){ye(t)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},ke=function(){const e=x[r.GROUP_ONLY];let t=[];M.forEach((function(a){let i=a.getId();e.length&&!G.includes(i)?t.push(i):D.includes(i)&&t.push(i)})),t.length&&(t.forEach((function(e){Ie(e)})),w.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Ie=function(e){for(let a=0;a<M.length;a++)if(M[a].getId()===e)return M[a].stop(t.KILL_FARMER),M.splice(a,a+1),!0;return!1
},xe=function(e){he(),M.length?F>=M.length?(F=0,V=!1,Z=v.gameTime()+we(),w.trigger(s.FARM_OVERFLOW_CYCLE_END)):V=M[F]:V=!1,V?(V.onCycleEnd((function(e){e!==t.USER_STOP&&(F++,xe())})),"cycle_begin"===e&&(Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),V.start()):W=setTimeout((function(){W=null,F=0,Z=null,w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),xe()}),we())},Re=function(e){for(let t=0;t<M.length;t++){let a=M[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},Le=function(e){M.forEach((function(t){t.removeTarget(e)}))},Oe=function(){m.load((function(){M.forEach((function(e){e.loadTargets()}))}),!0)};let Ne={};return Ne.init=function(){N=!0,P=k.get(X,[]),R=k.get($,{}),L=n.getSelectedCharacter(),O=n.getGameData().getUnitsObject(),I=new e({settingsMap:c,storageKey:J}),I.onChange((function(e,t,a){x=I.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ce(),t[p.GROUPS]&&ne(),t[p.TARGETS]&&Oe(),t[p.VILLAGES]&&(ke(),Se()),t[p.LOGS]&&fe(),t[p.INTERVAL_TIMERS]&&C&&(j?(ve(),
V.targetStep({delay:!0})):W&&(ve(),w.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),F=0,xe())))})),x=I.getAll(),se("ignore_update"),ne(),Se(),E((function(){ce()}),'presets'),E((function(){M.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,de),a.$on(s.ARMY_PRESET_DELETED,de),a.$on(s.GROUPS_VILLAGE_LINKED,oe),a.$on(s.GROUPS_VILLAGE_UNLINKED,le),a.$on(s.GROUPS_DESTROYED,re),a.$on(s.COMMAND_SENT,pe),a.$on(s.MESSAGE_ERROR,ge),a.$on(s.REPORT_NEW,ue)},Ne.start=function(){let e;return!C&&(U.length?(C=!0,e=[],M.forEach((function(t){e.push(new Promise((function(e){t.init().then(e)})))})),e.length?(Promise.all(e).then((function(){xe("cycle_begin")})),he(),function(){let e=we(),t=e+e/2+Te();H=setInterval((function(){v.gameTime()-K>t&&(Ne.stop(),setTimeout(Ne.start,5e3))}),3e4)}(),w.trigger(s.FARM_OVERFLOW_START),void be(g.FARM_START)):(C=!1,!1)):(w.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),!1))},Ne.stop=function(e=i.USER_STOP){V?(V.stop(e),
e!==i.USER_STOP&&(Z=v.gameTime()+we()),w.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):Z=null,C=!1,ve(),w.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(H),e===i.USER_STOP&&be(g.FARM_STOP)},Ne.getFarmer=function(e){return M.find((function(t){return t.getId()===e}))},Ne.getFarmers=function(){return M},Ne.getSettings=function(){return I},Ne.getExceptionVillages=function(){return{included:z,ignored:D}},Ne.getExceptionLogs=function(){return R},Ne.isInitialized=function(){return N},Ne.isRunning=function(){return C},Ne.getLogs=function(){return P},Ne.clearLogs=function(){return P=[],k.set(X,P),w.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),P},Ne.getNextCycleDate=function(){return Z},Ne.getCycleInterval=we,Ne})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',
...
define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,i,d,u,b,f,E,h,v,w){let T,A,y,S=n.getPresetList(),k=n.getGroupList(),I={},x={},R=null;const L={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){const e=T.pagination.offset,t=T.pagination.limit;T.visibleLogs=T.logs.slice(e,e+t),T.pagination.count=T.logs.length,T.visibleLogs.forEach((function(e){e.villageId&&N(e.villageId),e.targetId&&N(e.targetId)}))},N=function(e){if(I[e])return I[e];I[e]=!0,x[e]='LOADING...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:n.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){I[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},x[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},C=function(){
T.exceptionVillages.included.forEach((function(e){N(e)})),T.exceptionVillages.ignored.forEach((function(e){N(e)}))},M=function(){t.isRunning()?t.stop():t.start()},P=function(e){T.selectedTab=e},z=function(){A.setAll(A.decode(T.settings)),T.saveButtonColor='orange',h.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=A.get(b.GROUP_IGNORE);if(!n.getGroupList().getGroupVillageIds(t).includes(e))return!1;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},G=function(e){A.get(b.GROUP_INCLUDE).forEach((function(t){n.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){T.presets=f.encodeList(S.getPresets(),{disabled:!1,type:'presets'})},V=function(){T.groups=f.encodeList(k.getGroups(),{disabled:!1,type:'groups'}),T.groupsWithDisabled=f.encodeList(k.getGroups(),{disabled:!0,type:'groups'})},q=function(){T.running=!0,
h.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},B=function(e,t){switch(T.running=!1,T.showCycleTimer=!1,clearInterval(R),t.reason){case d.NO_PRESETS:h.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:h.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},F=function(){T.logs=angular.copy(t.getLogs()),O(),T.logs.length||h.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},W=function(){T.farmers=t.getFarmers()},j=function(){T.exceptionVillages=t.getExceptionVillages(),C()},Y=function(){T.exceptionLogs=t.getExceptionLogs()},Q=function(){T.showCycleTimer=!1,clearInterval(R)},K=function(e,a){a!==i.USER_STOP&&(T.showCycleTimer=!0,T.nextCycleCountdown=t.getCycleInterval(),R=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))},H=function(){let e=!0;T=a.$new(),T.SETTINGS=b,T.TAB_TYPES=L,T.LOG_TYPES=u,T.running=t.isRunning(),T.selectedTab=L.SETTINGS,T.farmers=t.getFarmers(),
T.villagesLabel=x,T.villagesInfo=I,T.exceptionVillages=t.getExceptionVillages(),T.exceptionLogs=t.getExceptionLogs(),T.logs=t.getLogs(),T.visibleLogs=[],T.showCycleTimer=!1,T.nextCycleCountdown=0,T.saveButtonColor='orange',T.settingsMap=A.settingsMap,T.pagination={count:T.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},A.injectScope(T),U(),V(),O(),C(),function(){let e=t.getNextCycleDate();e&&(T.showCycleTimer=!0,T.nextCycleCountdown=e-w.gameTime(),R=setInterval((function(){T.nextCycleCountdown-=1e3}),1e3))}(),T.switchFarm=M,T.selectTab=P,T.saveSettings=z,T.clearLogs=t.clearLogs,T.jumpToVillage=p.jumpToVillage,T.openVillageInfo=r.openVillageInfo,T.showReport=_.showReport,T.removeIgnored=D,T.removeIncluded=G;let i=new E('twoverflow_farm_overflow_window',(function(){clearInterval(R)}));i.register(s.ARMY_PRESET_UPDATE,U,!0),i.register(s.ARMY_PRESET_DELETED,U,!0),i.register(s.GROUPS_UPDATED,V,!0),i.register(s.GROUPS_CREATED,V,!0),i.register(s.GROUPS_DESTROYED,V,!0),
i.register(s.FARM_OVERFLOW_START,q),i.register(s.FARM_OVERFLOW_STOP,B),i.register(s.FARM_OVERFLOW_LOGS_UPDATED,F),i.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,W),i.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,j),i.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,Y),i.register(s.FARM_OVERFLOW_CYCLE_BEGIN,Q),i.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',T),T.$watch('settings',(function(){e||(T.saveButtonColor='red'),e=!1}),!0)};return function(){A=t.getSettings(),y=e.addMenuButton('Farmer',10),y.addEventListener('click',(function(){H()})),v.register(s.FARM_OVERFLOW_START,(function(){y.classList.remove('btn-orange'),y.classList.add('btn-red')})),v.register(s.FARM_OVERFLOW_STOP,(function(){y.classList.remove('btn-red'),y.classList.add('btn-orange')})),
...
INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,i,o,l,r,c,d,u,g,m,_,b,E,h,v,w,T,A){let y,S,k,I,x,R,L,O,N,C,M,P,z,D,G,U,V,q,B,F,W,j,Y,Q=!1,K={},H={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ie=!1;const ne='minimap_settings',oe={[i.VERY_SMALL]:2,[i.SMALL]:3,[i.BIG]:5,[i.VERY_BIG]:7},le=injector.get('colorService'),se=injector.get('spriteFactory')
;let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,_e=function(e){let t=Math.ceil(ee.x+e.offsetX)-I,a=Math.ceil(ee.y+e.offsetY)+I;return Math.floor(a/S)%2&&(t+=I),t-=t%S,a-=a%S,{x:Math.ceil((t-N.width/2)/S),y:Math.ceil((a-N.height/2)/S)}},be=function(e,t){return{x:e/T.TILESIZE.x,y:t/T.TILESIZE.y/T.TILESIZE.off}},fe=function(){Ae(x)},Ee=function(){if(Q){const e={x:ee.x-N.width/2,y:ee.y-N.height/2};C.clearRect(0,0,N.width,N.height),D.clearRect(0,0,z.width,z.height),function(e){C.drawImage(M,-e.x,-e.y)}(e),Y[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Me.getMapPosition(),a=(t.x-2)*S-e.x,i=(t.y-2)*S-e.y;D.fillStyle=Y[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,k),D.fillRect(0,i,k,1);const n=U.getBoundingClientRect(),l=n.width/T.TILESIZE.x/A.view.z*S,s=n.height/T.TILESIZE.y/A.view.z*S,r=a-l/2,c=i-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=Y[o.COLOR_VIEW_REFERENCE],D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Ee)
},he=function(){if(!ie)return!1;const e=H.village[L][O];we(e?H.character[e]:[[L,O]]),ie=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:L,y:O})},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t,Y[o.COLOR_QUICK_HIGHLIGHT])},we=function(e){let t=[];for(let a=0;a<e.length;a++){let i=e[a][0],n=e[a][1];t.push(ae[i][n])}Ae(t)},Te=function(e){if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!Y[o.SHOW_BARBARIANS]&&F.barbarian;if(e.character_id===q){if(e.id===R.getId()&&Y[o.HIGHLIGHT_SELECTED])return F.selected;if(e.character_id in K.character)return K.character[e.character_id];if(Y[o.HIGHLIGHT_OWN])return F.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id];if(B&&B===e.tribe_id&&Y[o.HIGHLIGHT_DIPLOMACY])return F.tribe;if(W&&Y[o.HIGHLIGHT_DIPLOMACY]){
if(W.isAlly(e.tribe_id))return F.ally;if(W.isEnemy(e.tribe_id))return F.enemy;if(W.isNAP(e.tribe_id))return F.friendly}}return F.ugly},Ae=function(e,t){for(let a=0;a<e.length;a++){const i=e[a];if(i.id<0)continue;const n=t||Te(i);if(!n)continue;const o=i.x*S+(i.y%2?I:0),l=i.y*S;P.fillStyle=n,P.fillRect(o,l,y,y)}},ye=function(){y=oe[Y[o.MAP_SIZE]],I=Math.round(y/2),S=y+1,k=1e3*S,J.a=Z.a*S,J.b=Z.b*S,$.a=X.a*S,$.b=X.b*S,M.width=1e3*S,M.height=1e3*S,P.imageSmoothingEnabled=!1},Se=function(){const e=document.body.clientHeight-265;N.width=686,N.height=e,z.width=686,z.height=e,C.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ke=function(e){var a,i;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ie&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[L,O,e]),3===e.which&&(a=L,i=O,b.getTownAtAsync(a,i,(function(e){if(!e)return!1;switch(Y[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:if(!e.character_id)return!1;Me.addHighlight({type:'character',id:e.character_id
},v.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Me.addHighlight({type:'tribe',id:e.tribe_id},v.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Ie=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},xe=function(e){if(ce=!1,pe=_e(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!Y[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(Y[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ie){if(L===e.x&&O===e.y)return!1;he()}ie=!0,L=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:L,y:O,event:t});const a=H.village[L][O];ve(a?H.character[a]:[[L,O]])}(pe,e)}he()},Re=function(){ie&&he(),
m.trigger(s.MINIMAP_MOUSE_LEAVE)},Le=function(e){if(!ce)return!1;const t=_e(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Ne=function(){K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},fe()},Ce=function(){const e={id:R.getId(),x:R.getX(),y:R.getY()};R=V.getSelectedVillage(),Ae([{character_id:V.getId(),id:e.id,x:e.x,y:e.y},{character_id:V.getId(),id:R.getId(),x:R.getX(),y:R.getY()}])};let Me={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&f.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const i='character'===e.type?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},removeHighlight:function(e,t){if(void 0===t||!f.call(K,e))return!1;if(!f.call(K[e],t))return!1;delete K[e][t]
;const i='character'===e?w.PLAYER_COLORS:w.TRIBE_COLORS;return le.setCustomColorsByGroup(i,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),fe(),!0},getHighlight:function(e,t){return!!f.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){N=e,N.style.background=Y[o.COLOR_BACKGROUND],C=N.getContext('2d')},setViewportRef:function(e){z=e,D=z.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*S,ee.y=t*S,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Me.getMapPosition=function(){if(!G.width||!G.height)return!1;let e=b.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=be(e[0]*t,e[1]*t),i=be(e[2]*t,e[3]*t);return[a.x-1,a.y-1,i.x+3||1,i.y+3||1]}([-e.x,-e.y,G.width/2,G.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Me.getSettings=function(){return j},Me.drawMinimap=function(){ge&&(ge=!1),N.style.background=Y[o.COLOR_BACKGROUND],P.clearRect(0,0,M.width,M.height),d((function(){
!function(){const e=h.getPath(T.getMapPath()),t=Y[o.SHOW_CONTINENT_DEMARCATIONS],a=Y[o.SHOW_PROVINCE_DEMARCATIONS],i=function(e,t){P.fillStyle=Y[o.COLOR_CONTINENT],P.fillRect(e*S+I-1,t*S+I-1,3,1),P.fillRect(e*S+I,t*S+I-2,1,3)},n=function(e,t){P.fillStyle=Y[o.COLOR_PROVINCE],P.fillRect(e*S+I,t*S+I-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=E.toTile(o,e,l);s.key.b&&(s.key.c&&t?i(e,l):a&&n(e,l))}const r=l.a*S,c=s.a*S,d=(l.b-l.a)*S,u=(s.b-s.a)*S;P.beginPath(),P.lineWidth=2,P.strokeStyle="#2B4700",P.rect(r,c,d,u),P.stroke()}))}(),fe()}),'minimap_data')},Me.enableRendering=function(){Q=!0},Me.disableRendering=function(){Q=!1},Me.isFirstDraw=function(){return!!ge},Me.init=function(){Me.initialized=!0,M=document.createElement('canvas'),P=M.getContext('2d'),re=se.make('hover'),j=new u({settingsMap:l,storageKey:ne}),j.onChange((function(e,t){
Y=j.getAll(),ye(),t[r.MAP_POSITION]&&Me.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Me.drawMinimap()})),Y=j.getAll(),K.tribe=le.getCustomColorsByGroup(w.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(w.PLAYER_COLORS)||{},ye()},Me.run=function(){d((function(){U=document.getElementById('map'),G=document.getElementById('main-canvas'),V=n.getSelectedCharacter(),W=V.getTribeRelations(),q=V.getId(),B=V.getTribeId(),F=V.getVillagesColors(),re.alpha=0,A.graph.layers.effects.push(re),Se(),R=V.getSelectedVillage(),te.x=R.getX(),te.y=R.getY(),ee.x=R.getX()*S,ee.y=R.getY()*S,e.addEventListener('resize',Se,!1),z.addEventListener('mousedown',ke),z.addEventListener('mouseup',Ie),z.addEventListener('mousemove',xe),z.addEventListener('mouseleave',Re),z.addEventListener('click',Le),z.addEventListener('contextmenu',Oe),g.load((function(){x=g.getVillages(),function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in H.village||(H.village[a.x]={}),a.x in ae||(ae[a.x]=[]),
H.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in H.character?H.character[a.character_id].push([a.x,a.y]):H.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in H.tribe?H.tribe[a.tribe_id].push(a.character_id):H.tribe[a.tribe_id]=[a.character_id])))}}(x),function(){let e=[],t=[];for(let a in H.village){e.push(a);for(let e in H.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*S,J.b=Z.b*S,$.a=X.a*S,$.b=X.b*S}(),Ee(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ce),a.$on(s.TRIBE_RELATION_CHANGED,fe),a.$on(s.GROUPS_VILLAGES_CHANGED,Ne)}))}),['initial_village','tribe_relations'])},Me})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',
MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,n,d,u,p,m,_,b,f,E,h,v,w){let T,A,y,S,k,I,x,R,L,O,N,C={},M=!1,P={character:{},tribe:{}};const z={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=z.MINIMAP,G=function(e){T.selectedTab=e,e===z.MINIMAP?n.enableRendering():n.disableRendering()},U=function(){Object.keys(T.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){
P.character[e]=t.character_name}))})),Object.keys(T.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},V=function(e,t){return String(e)+String(t)},q=function(e,t){if(!L)return;let a=V(t.x,t.y);var i,n;O=a,C[a]=!0,M=!0,(i=t.x,n=t.y,new Promise((function(e){let t=h.getTownAt(i,n);if(t)return e(t);h.loadTownDataAsync(i,n,1,1,(function(t){e(t)}))}))).then((function(e){if(!C[V(e.x,e.y)])return;if(!M)return;x.appendChild(L),L.classList.remove('ng-hide'),I.tt.name=e.name,I.tt.x=e.x,I.tt.y=e.y,I.tt.province_name=e.province_name,I.tt.points=e.points,I.tt.character_name=e.character_name||'-',I.tt.character_points=e.character_points||0,I.tt.tribe_name=e.tribe_name||'-',I.tt.tribe_tag=e.tribe_tag||'-',I.tt.tribe_points=e.tribe_points||0,I.tt.morale=e.morale||0,I.tt.position={},I.tt.position.x=t.event.pageX+50,I.tt.position.y=t.event.pageY+50,I.tt.visible=!0
;const a=L.getBoundingClientRect(),i=x.getBoundingClientRect(),n=a.width+50,o=a.height+50,l=I.tt.position.y+o>i.top+i.height,s=I.tt.position.x+n>i.width;l&&(I.tt.position.y-=50),L.classList.toggle('left',s),L.classList.toggle('top',l)}))},B=function(e,t){if(!L)return;let a=t?V(t):O;C[a]=!1,M=!1,I.tt.visible=!1,L.classList.add('ng-hide'),R.appendChild(L)},F=function(e,t,i){let o,l,s=a.$new(),r=!0;s.colorPalettes=w.palette,'setting'===e?(l=t,o=N.get(l),r=!1,s.submit=function(){T.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){T.settings[l]=N.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=T.addHighlightColor,s.submit=function(){T.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=T.highlights[t][i],s.submit=function(){n.addHighlight({id:i,type:t},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},
c.getModal('modal_color_palette',s)},W=function(){n.addHighlight(T.selectedHighlight,T.addHighlightColor)},j=function(){N.setAll(N.decode(T.settings)),_.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},Y=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){N.resetAll(),_.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},Q=function(){return Object.keys(T.highlights.character).length+Object.keys(T.highlights.tribe).length},K=function(e,t){('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},H={addHighlightAutoCompleteSelect:function(e){T.selectedHighlight={id:e.id,type:e.type,name:e.name}},
highlightUpdate:function(){U()},highlightAddErrorExists:function(){_.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){_.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){_.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){B(),S.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){B(),S.style.cursor='url('+v.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){S.style.cursor=''}},Z=function(){T=a.$new(),T.SETTINGS=p,T.TAB_TYPES=z,T.selectedTab=D,T.selectedHighlight=!1,T.addHighlightColor='#000000',T.highlights=n.getHighlights(),T.highlightNames=P,T.mapSizes=f.encodeList(u,{textObject:'minimap',disabled:!1}),T.actionTypes=f.encodeList(d,{textObject:'minimap',disabled:!1}),T.autoComplete={
type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:H.addHighlightAutoCompleteSelect},T.selectTab=G,T.openColorPalette=F,T.addCustomHighlight=W,T.removeHighlight=n.removeHighlight,T.saveSettings=j,T.resetSettings=Y,T.highlightsCount=Q,T.openProfile=K,N.injectScope(T,{textObject:'minimap'});let e=new b('twoverflow_minimap_window',(function(){n.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,H.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,H.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,H.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,H.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,q),e.register(s.MINIMAP_VILLAGE_BLUR,B),e.register(s.MINIMAP_MOUSE_LEAVE,H.onMouseLeaveMinimap),e.register(s.MINIMAP_START_MOVE,H.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,H.onMouseStopMoveMinimap),
c.getScreenWithInjectedScope('!twoverflow_minimap_window',T),U(),k=document.querySelector('#two-minimap .minimap-container'),k.appendChild(y),k.appendChild(S),n.enableRendering(),n.isFirstDraw()&&n.drawMinimap()};return function(){N=n.getSettings(),I=i.getSharedData('MapController'),y=document.createElement('canvas'),y.className='minimap',S=document.createElement('canvas'),S.className='cross',n.setViewport(y),n.setViewportRef(S),L=document.querySelector('#map-tooltip'),x=document.querySelector('#wrapper'),R=document.querySelector('#map'),A=t.addMenuButton('Minimapa',180),A.addEventListener('click',(function(){const e=n.getMapPosition();if(!e)return!1;Z(),n.setCurrentPosition(e.x,e.y)})),
...
types:['attack']},(function(e){for(var t=e.reports,a=0;a<t.length;a++)p.includes(t[a].id)?console.log('Raport ataku już wysłany'):(p.push(t[a].id),o.emit(l.REPORT_GET,{id:t[a].id},f))})),setTimeout(m,3e4)},_=function(e){var t,n,s,r,c,d=[],u=e.result,p=e.token,m=e.time_created,_=g(m),b=e.ReportScouting,f=b.attCharacterId,E=b.attCharacterName,h=b.attScouts,v=b.attLosses,w=b.attVillageId,T=b.attVillageName,A=b.defCharacterId,y=b.defCharacterName,S=b.defLosses,k=b.defScouts,I=b.defVillageId,x=b.defVillageName,R=b.commandType,L='',O='',N='',C='',M=Date.now(),P=p.split('.').join('_');2==u?L=' [color=d96a19]Częściowy sukces[/color]':1==u?L=' [color=0a8028]Sukces[/color]':3==u&&(L=' [color=e21f1f]Porażka[/color]'),O='units'==R?'Jednostki':'buildings'==R?'Budynki':'Sabotaż',n=null==k?'nieznana':k,s=null==h?'nieznana':h,r=null==S?'nieznana':S,c=null==v?'nieznana':v,C=null==E&&null==f?'Brak danych':'[player='+f+']'+E+'[/player]',N=null==T&&null==w?'Brak danych':'[village='+w+']'+T+'[/village]',
t=Math.floor(M/1e3-m),d.push('[size=XL][b]Raport szpiegowski: [report]'+P+'[/report][br]'+L+' --- Typ: '+O+'[/b][/size][br][b][size=large] Czas wejścia szpiegów: '+_+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+I+']'+x+'[/village][b] Gracz cel: [/b][player='+A+']'+y+'[/player][br]Liczba szpiegów: [b]'+n+'[/b] Stracone: [b][color=e21f1f]'+r+'[/color][/b][br]Wioska pochodzenia: [/b]'+N+'[b] Gracz szpiegujący: [/b]'+C+'[br]Liczba szpiegów: [b]'+s+'[/b] Stracone: [b][color=e21f1f]'+c+'[/color][/b][/size]');var z=d.join();A!=a?t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14383,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6467,message:z}),d=[]):t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14382,message:z}):o.emit(l.MESSAGE_REPLY,{message_id:6466,message:z}),d=[])},b=function(e){
...
v.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,v.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,v.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,v.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,v.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,v.push(' Zjednoczenie '+g+'%'))}));var T=v.join(),A=(100*d.attFaith).toFixed([0]),y=Math.round(100*d.attModifier).toFixed([0]),S=Math.round(100*d.morale).toFixed([0]),k=(100*(d.luck-1)).toFixed([0]),I=d.defCharacterId,x=d.defCharacterName,R=d.defVillageId,L=d.defVillageName,O=(100*d.defFaith).toFixed([0]),N=Math.round(100*d.defModifier).toFixed([0]),C=(100*d.wallBonus).toFixed([0]),M=d.night,P=d.loyaltyAfter,z=d.loyaltyBefore,D=d.wallAfter,G=d.wallBefore,U=d.officers,V=d.leader,q='',B='',F='',W='',j='',Y='',Q='',K='',H='',Z=Date.now(),X=s.split('.').join('_')
;null!=z&&(Y='Lojalność przed atakiem: '+Math.floor(z)+' '),null!=P&&(Q='Lojalność po ataku: '+Math.floor(P)+' '),null!=G&&(K='Mury przed ataku: '+G+' '),null!=D&&(H='Mury po ataku: '+D+' '),null==U&&1==V?j='Brak':null==U&&1.1==V&&(j=' Wielki Mistrz '),W=0==M?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),F=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',B=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),
a.push('[size=XL][b]Raport obronny: [report]'+X+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+R+']'+L+'[/village][b] Gracz cel: [/b][player='+I+']'+x+'[/player][br]Modyfikator obrony: [b]'+N+'[/b] Bonus za mury: [b]'+C+'[/b][br]Wiara: [b]'+O+'[/b] Bonus nocny: [b]'+W+'[/b][br]Pozostałe bonusy: [b]'+T+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+F+'[br]Modyfikator ataku: [b]'+y+'[/b] Morale: [b]'+S+'[/b][br]Wiara: [b]'+A+'[/b] Szczęście: [b]'+k+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+j+'[/b][br]'+Y+Q+'[br]'+K+H+'[/size]');var J=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14381,message:J}):o.emit(l.MESSAGE_REPLY,{message_id:6982,message:J}),a=[])}},f=function(e){
var t,a=[],n=e.result,s=e.token,r=e.time_created,c=g(r),d=e.ReportAttack,u=d.attCharacterId,p=d.attCharacterName,m=d.attVillageId,_=d.attVillageName,b=d.attEffects,f=d.defEffects,E=d.attUnits;if(E.spear+E.sword+E.axe+E.archer+E.light_cavalry+E.mounted_archer+E.ram+E.catapult+E.heavy_cavalry+E.trebuchet+E.knight+E.snob+E.doppelsoldner>30){var h=[],v=[];b.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),h.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,h.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,h.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,h.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,h.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,h.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,h.push(' Siła w liczbach '+r)),
'recruit_speed_boost'==t&&(c=e.factor,h.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,h.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,h.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,h.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,h.push(' Zjednoczenie '+g+'%'))}));var w=h.join();f.forEach((function(e){var t=e.type,a=0,i=0,n=0,o=0,l=0,s=0,r=0,c=0,d=0,u=0,p=0,g=0;'increased_carrying_capacity'==t&&(a=(100*(e.factor-1)).toFixed([0]),v.push(' Wagony '+a+'%')),'base_wall_levels'==t&&(i=e.min_level,v.push(' Żelazny mur '+i)),'modify_attack_factor'==t&&(n=100*e.bonus,v.push(' Mistrzostwo broni '+n+'%')),'revive_attacker_losses'==t&&(o=100*e.ratio,v.push(' Doktor '+o+'%')),'extra_hospital_beds'==t&&(l=e.beds,v.push(' Klinika '+l)),'increase_spy_defense'==t&&(s=e.increased_by,v.push(' Agent wewnętrzny '+s+'%')),'increase_member_limit'==t&&(r=e.increased_by,
v.push(' Siła w liczbach '+r)),'recruit_speed_boost'==t&&(c=e.factor,v.push(' Intensywny trening '+c+'%')),'farm_speed_increase'==t&&(d=e.factor,v.push(' Drogi najazdów '+d+'%')),'resource_deposit_job_amount'==t&&(u=e.factor,v.push(' Wagony(depozyt) '+u+'%')),'resource_deposit_job_duration'==t&&(p=e.factor,v.push(' Drogi najazdów(depozyt) '+p+'%')),'faster_tribe_support'==t&&(g=e.factor,v.push(' Zjednoczenie '+g+'%'))}));var T,A=v.join(),y=(100*d.attFaith).toFixed([0]),S=Math.round(100*d.attModifier).toFixed([0]),k=Math.round(100*d.morale).toFixed([0]),I=(100*(d.luck-1)).toFixed([0]),x=d.defCharacterId,R=d.defCharacterName,L=d.defVillageId,O=d.defVillageName,N=(100*d.defFaith).toFixed([0]),C=Math.round(100*d.defModifier).toFixed([0]),M=(100*d.wallBonus).toFixed([0]),P=d.night,z=d.loyaltyAfter,D=d.loyaltyBefore,G=d.wallAfter,U=d.wallBefore,V=d.officers,q='',B='',F='',W='',j='',Y='',Q='',K='',H=[],Z=Date.now(),X=s.split('.').join('_')
;if(null!=D&&(j='Lojalność przed atakiem: '+Math.floor(D)+' '),null!=z&&(Y='Lojalność po ataku: '+Math.floor(z)+' '),null!=U&&(Q='Mury przed ataku: '+U+' '),null!=G&&(K='Mury po ataku: '+G+' '),null==V)H.push('Brak');else{var J=d.officers.bastard,$=d.officers.leader,ee=d.officers.medic,te=d.officers.scout,ae=d.officers.loot_master,ie=d.officers.supporter;0==J&&0==$&&0==ee&&0==ae&&0==te&&0==ie?H.push('Brak'):(1==J?H.push(' Oszust '):H.push(''),1==$?H.push(' Wielki Mistrz '):H.push(''),1==ee?H.push(' Medyk '):H.push(''),1==te?H.push(' Łowczy '):H.push(''),1==ae?H.push(' Mistrz Łupu '):H.push(''),1==ie?H.push(' Taktyk '):H.push(''))}if(W=0==P?'Nie':'Tak',2==n?q=' [color=d96a19]Częściowy sukces[/color]':1==n?q=' [color=0a8028]Sukces[/color]':3==n&&(q=' [color=e21f1f]Porażka[/color]'),F=null==p&&null==u?'Brak danych':'[player='+u+']'+p+'[/player]',B=null==_&&null==m?'Brak danych':'[village='+m+']'+_+'[/village]',t=Math.floor(Z/1e3-r),T=H.join(),null!=R){
a.push('[size=XL][b]Raport z ataku: [report]'+X+'[/report][br]'+q+'[/b][/size][br][b][size=large] Czas wejścia ataku: '+c+'[/size][/b][br][size=medium][b] Wioska cel: [/b][village='+L+']'+O+'[/village][b] Gracz cel: [/b][player='+x+']'+R+'[/player][br]Modyfikator obrony: [b]'+C+'[/b] Bonus za mury: [b]'+M+'[/b][br]Wiara: [b]'+N+'[/b] Bonus nocny: [b]'+W+'[/b][br]Pozostałe bonusy: [b]'+A+'[/b][br][b]Wioska pochodzenia: [/b]'+B+'[b] Gracz atakujący: [/b]'+F+'[br]Modyfikator ataku: [b]'+S+'[/b] Morale: [b]'+k+'[/b][br]Wiara: [b]'+y+'[/b] Szczęście: [b]'+I+'[/b][br]Pozostałe bonusy: [b]'+w+'[/b][br]Oficerowie: [b]'+T+'[/b][br]'+j+Y+'[br]'+Q+K+'[/size]');var ne=a.join();t<10800&&('Hajduk Split'==i||'halfsack'==i||'Black Rider'==i?o.emit(l.MESSAGE_REPLY,{message_id:14380,message:ne}):o.emit(l.MESSAGE_REPLY,{message_id:6983,message:ne}),a=[])}}},E={init:function(){r=!0},start:function(){e.trigger(s.REPORT_SENDER_STARTED),c=!0,m()},stop:function(){e.trigger(s.REPORT_SENDER_STOPPED),c=!1},
