...
define('two/fakeSender/ui', [
    ...
    const init = function () {
        ...
        interfaceOverflow.addStyle('#two-fake-sender div[select]{float:right}#two-fake-sender div[select] .select-handler{line-height:28px}#two-fake-sender .range-container{width:250px}#two-fake-sender .textfield-border{width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-fake-sender .textfield-border.fit{width:100%}#two-fake-sender .addForm input{width:100%}#two-fake-sender .addForm td{text-align:left}#two-fake-sender .addForm span{height:26px;line-height:26px;padding:0 10px}#two-fake-sender .addForm .item-send{text-align:center}#two-fake-sender .addForm .item-send span{text-align:center;width:145px}#two-fake-sender .actions{text-align:center;user-select:none}#two-fake-sender .fakerLog td{text-align:center}#two-fake-sender .fakerLog .origin:hover{color:#fff;text-shadow:0 1px 0 #000}#two-fake-sender .fakerLog .target:hover{color:#fff;text-shadow:0 1px 0 #000}#two-fake-sender .noFakes td{height:26px;text-align:center}#two-fake-sender .force-26to20{transform:scale(.8);width:20px;height:20px}')
    }
