...
define('two/armyHelper/ui', [
    ...
    const init = function () {
        ...
        interfaceOverflow.addStyle('#two-army-helper div[select] .select-wrapper{height:34px}#two-army-helper div[select] .select-wrapper .select-button{height:28px;margin-top:1px}#two-army-helper div[select] .select-wrapper .select-handler{-webkit-box-shadow:none;box-shadow:none;height:28px;line-height:28px;margin-top:1px;width:217px}#two-army-helper .textfield-border{text-align:center;width:219px;height:34px;margin-bottom:2px;padding-top:2px}#two-army-helper .textfield-border.fit{width:33%}#two-army-helper .addForm1 .item-check{text-align:center}#two-army-helper .addForm1 .item-check span{height:28px;text-align:center;width:115px}#two-army-helper .addForm1 td{text-align:center;height:34px;line-height:34px}#two-army-helper .addForm1 th{text-align:center;padding:0px}#two-army-helper .addForm1 span{height:34px;line-height:34px}#two-army-helper .addForm1 .item-name{text-align:left}#two-army-helper .addForm .item-asign{text-align:center}#two-army-helper .addForm .item-asign span{height:28px;text-align:center;width:115px}#two-army-helper .addForm .item-balance{text-align:center}#two-army-helper .addForm .item-balance span{height:28px;text-align:center;width:115px}#two-army-helper .addForm td{text-align:left}#two-army-helper .addForm td .sel{text-align:center}#two-army-helper .addForm td.center{text-align:center}#two-army-helper .addForm th{text-align:center;padding:0px}#two-army-helper .addForm span{height:26px;line-height:26px}#two-army-helper .addForm span.btn{height:26px;line-height:26px;text-align:center}')
    }
