...
define('two/language', [
    ...
    "en_us": {
        ...
        "farm_overflow": {
            ...
            "multiple_attacks_interval": "Format odstępu między cyklami powinien mieć postać hh:mm:ss.",
            "next_cycle_in": "Odstęp między cyklami",
            "target_limit_per_village": "Limit poleceń na wioskę musi być wartością między %{min} and %{max}.",
