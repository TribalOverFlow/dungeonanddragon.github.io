...
define('two/about/ui', [
    ...
    const init = function () {
        ...
        const $button = interfaceOverflow.addMenuButton2('O mnie', 190)
...
define('two/alertSender/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Wartownik', 50, $filter('i18n')('description', $rootScope.loc.ale, 'alert_sender'))
...
define('two/armyHelper/ui', [
    ...
    const init = function () {
        ...
        $button = interfaceOverflow.addMenuButton('Administrator', 140)
...
define('two/autoCollector/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Kolekcjoner', 80, $filter('i18n')('description', $rootScope.loc.ale, 'auto_collector'))
...
define('two/autoHealer/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Medyk', 40, $filter('i18n')('description', $rootScope.loc.ale, 'auto_healer'))
...
define('two/battleCalculator/ui', [
    ...
    const init = function () {
        ...
        $button = interfaceOverflow.addMenuButton('Kalkulator', 180)
        $button.addEventListener('click', buildWindow)
...
define('two/faithChecker/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Kapelan', 30, $filter('i18n')('description', $rootScope.loc.ale, 'faith_checker'))
...
define('two/mintHelper/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Mincerz', 10, $filter('i18n')('description', $rootScope.loc.ale, 'mint_helper'))
...
define('two/presetCreator/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Wojewoda', 70, $filter('i18n')('description', $rootScope.loc.ale, 'preset_creator'))
...
define('two/recruitQueue/ui', [
    ...
    const init = function () {
        ...
        $button = interfaceOverflow.addMenuButton('Kapitan', 150)
        $button.addEventListener('click', buildWindow)
...
define('two/reportSender/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Goniec', 60, $filter('i18n')('description', $rootScope.loc.ale, 'report_sender'))
...
define('two/spyMaster/ui', [
    ...
    const init = function() {
        ...
        $button = interfaceOverflow.addMenuButton('Zwiadowca', 130)
        $button.addEventListener('click', buildWindow)
...
define('two/spyRecruiter/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Szpieg', 20, $filter('i18n')('description', $rootScope.loc.ale, 'spy_recruiter'))
        $button.addEventListener('click', function () {
