...
define('two/ui', [
    ...
    interfaceOverflow.init = function () {
        ...
        $container.appendChild($mainButton2)
...
define('two/spyRecruiter/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton2('Szpieg', 10, $filter('i18n')('description', $rootScope.loc.ale, 'spy_recruiter'))
        $button.addEventListener('click', function () {
