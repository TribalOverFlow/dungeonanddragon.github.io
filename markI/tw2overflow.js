...
define('two/alertSender/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton('Wartownik', 50, $filter('i18n')('description', $rootScope.loc.ale, 'alert_sender'))
...
define('two/armyHelper/ui', [
    ...
    const init = function () {
        ...
        $button = interfaceOverflow.addMenuButton('Administrator', 70)
...
define('two/attackView/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton('Strażnik', 20)
        $button.addEventListener('click', buildWindow)
...
define('two/autoHealer/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton('Medyk', 90, $filter('i18n')('description', $rootScope.loc.ale, 'auto_healer'))
...
define('two/presetCreator/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton3('Wojewoda', 30, $filter('i18n')('description', $rootScope.loc.ale, 'preset_creator'))
...
define('two/recruitQueue/ui', [
    ...
    const init = function () {
        ...
        $button = interfaceOverflow.addMenuButton('Kapitan', 30)
        $button.addEventListener('click', buildWindow)
...
define('two/reportSender/ui', [
    ...
    const init = function () {
        $button = interfaceOverflow.addMenuButton('Goniec', 60, $filter('i18n')('description', $rootScope.loc.ale, 'report_sender'))
