...
define('two/language', [
    ...
    "en_us": {
        ...
        "army_helper": {
            ...
            "presets.name-placeholder": "Wpisz frazę",
            "army": "Wojsko",
            "army.header": "Sprawdź ilość jednostek w wioskach",
            "army.check": "Zlicz",
            "army.troops": "Wojsko",
            "army.unit": "Jednostka",
            "army.available": "Dostępne",
            "army.own": "Posiadane",
            "army.in-town": "W wioskach",
            ...
            "balancer.textunit": "Zbalansuj po równo wojska danego typu.",
            "balancer.group": "Grupa",
            "balancer.textgroup": "Zbalansuj po równo wojska w danej grupie wiosek.",
            "balancer.unit-group": "Grupa/Jednostka",
            "balancer.textunit-group": "Zbalansuj po równo wojska w danej grupie wiosek dany typ jednostki.(np miecznik w grupie Deff)",
            "spear": "Pikinier",
            "sword": "Miecznik",
            "axe": "Topornik",
            "archer": "Łucznik",
        ...
        "fake_sender": {
            ...
            "unit": "Jednostka/i",
            "type": "Rodzaj fejków",
            "own_limit": "Limit fejków z własnej wioski",
...
define('two/armyHelper', [
    ...
    let selectedPresets1 = []
    let selectedPresets2 = []
    let selectedGroups1 = []
    let selectedGroups2 = []
    let selectedGroups3 = []
    let selectedGroups4 = []
    ...
    const updatePresets = function () {
        ...
        presetsSelectedByTheUser1.forEach(function (presetId) {
            selectedPresets1.push(allPresets[presetId])
        })
        presetsSelectedByTheUser2.forEach(function (presetId) {
            selectedPresets2.push(allPresets[presetId])
        })
    }
