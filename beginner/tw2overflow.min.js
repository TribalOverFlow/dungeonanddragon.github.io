 ...
 */
!function(e,t){const a=injector.get('$rootScope'),n=injector.get('transferredSharedDataService'),i=injector.get('modelDataService'),o=injector.get('socketService'),l=injector.get('routeProvider'),s=injector.get('eventTypeProvider'),r=injector.get('windowDisplayService'),c=injector.get('windowManagerService'),d=(injector.get('hotkeys'),injector.get('armyService')),u=injector.get('villageService'),p=injector.get('mapService'),g=injector.get('$filter'),m=(injector.get('$timeout'),injector.get('storageService')),A=injector.get('reportService'),_=function(){},E=Object.prototype.hasOwnProperty;define('two/EventScope',['queues/EventQueue'],(function(e){const t=function(e,t){if(void 0===e)throw new Error('EventScope: no windowId');this.windowId=e,this.onDestroy=t||_,this.listeners=[];const n=a.$on(s.WINDOW_CLOSED,(e,t)=>{t==='!'+this.windowId&&(this.destroy(),n())})};return t.prototype.register=function(t,n,i){i?this.listeners.push(a.$on(t,n)):(e.register(t,n),this.listeners.push((function(){
...
define('two/attackView',['two/ready','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','conf/buildingTypes','Lockr','helper/math','helper/mapconvert','struct/MapData','queues/EventQueue'],(function(e,t,n,r,c,d,u,p,g,m,A,_,E){let T,b,w=!1,v=injector.get('overviewService'),f=[],h=2e3,R=!1,y={},k={},S={reverse:!1,column:n.TIME_COMPLETED};const L='attack_view_filters',I={},z={},O=function(){const e=[c.COMMAND_TYPES],t=i.getSelectedVillage().getId();let a={};for(let t=0;t<e.length;t++)for(let n in y[e[t]])if(a[e[t]]||(a[e[t]]=[]),y[e[t]][n])switch(e[t]){case c.COMMAND_TYPES:n===r.ATTACK?a[e[t]].push(r.ATTACK):n===r.SUPPORT?a[e[t]].push(r.SUPPORT):n===r.RELOCATE&&a[e[t]].push(r.RELOCATE)}k=a,k.village=y[c.VILLAGE]?[t]:[]},M=function(){W.loadCommands()},N=function(e,t){E.trigger(s.ATTACK_VIEW_COMMAND_CANCELLED,[t.id||t.command_id])},C=function(e,t){
for(let e=0;e<f.length;e++)f[e].command_id===t.command_id&&f.splice(e,1);E.trigger(s.ATTACK_VIEW_COMMAND_IGNORED,[t.command_id])},P=function(e,t){for(let e=0;e<f.length;e++)f[e].target_village_id===t.village_id?(f[e].target_village_name=t.name,f[e].targetVillage.name=t.name):f[e].origin_village_id===t.village_id&&(f[e].origin_village_name=t.name,f[e].originVillage.name=t.name);E.trigger(s.ATTACK_VIEW_VILLAGE_RENAMED,[t])},x=function(e,t){k[c.VILLAGE].length&&(k[c.VILLAGE]=[t],W.loadCommands())},D=function(e){const a={x:e.origin_x,y:e.origin_y},n={x:e.target_x,y:e.target_y};return d.map((function(i){const o=t.getTravelTime(a,n,{[i]:1},e.command_type,{},!1);return{unit:i,diff:Math.abs(o-e.model.duration)}})).sort((function(e,t){return e.diff-t.diff}))[0].unit},B=function(e,t){return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)}))},U=function(e,t){let a=0;if(_.hasTownDataInChunk(e.x,e.y)){
const a=_.loadTownData(e.x,e.y,25,25,25),n=i.getSelectedCharacter().getTribeId(),o=i.getSelectedCharacter().getId();let l,s=[];a.forEach((function(e){for(let t in e.data)for(let a in e.data[t])s.push(e.data[t][a])}));const r=s.filter((function(e){return null===e.character_id&&e.id>0})),c=s.filter((function(t){return t.character_id===o&&e.id!==t.id}));if(r.length)l=B(r,e);else if(c.length)l=B(c,e);else{if(!n)return t(!1);{const a=s.filter((function(e){return e.tribe_id===n}));if(!a.length)return t(!1);l=B(a,e)}}return t(l[0])}const n=A.scaledGridCoordinates(e.x,e.y,25,25,25);_.loadTownDataAsync(e.x,e.y,25,25,(function(){++a===n.length&&U(e,t)}))},G=function(e,t){if(_.hasTownDataInChunk(e.x,e.y)){var a,n,o=_.loadTownData(e.x,e.y,40,40,40),l=[],s=i.getSelectedCharacter().getId();return o.forEach((function(e){for(let t in e.data)for(let a in e.data[t])l.push(e.data[t][a])})),(n=l.filter((function(t){return t.character_id===s&&e.id!==t.id}))).length?(a=function(e,t){
return e.sort((function(e,a){return m.actualDistance(t,e)-m.actualDistance(t,a)})).reverse()}(n,e),t(a)):t(!1)}var r=A.scaledGridCoordinates(e.x,e.y,40,40,40),c=0;_.loadTownDataAsync(e.x,e.y,40,40,(function(){++c===r.length&&G(e,t)}))},V=function(e){f=e.commands;for(let e=0;e<f.length;e++)v.formatCommand(f[e]),f[e].slowestUnit=D(f[e]);f=f.filter((function(e){return y[c.INCOMING_UNITS][e.slowestUnit]})),E.trigger(s.ATTACK_VIEW_COMMANDS_LOADED,[f])};let W={loadCommands:function(){const e=T.getCommandListModel().getIncomingCommands().length,t=e>25?e:25;o.emit(l.OVERVIEW_GET_INCOMING,{count:t,offset:0,sorting:S.column,reverse:S.reverse?1:0,groups:[],command_types:k[c.COMMAND_TYPES],villages:k[c.VILLAGE]},V)},getCommands:function(){return f},getFilters:function(){return y},getSortings:function(){return S},toggleFilter:function(e,t){t?y[e][t]=!y[e][t]:y[e]=!y[e],O(),g.set(L,y),W.loadCommands()},toggleSorting:function(e){e===S.column?S.reverse=!S.reverse:(S.column=e,S.reverse=!1),
W.loadCommands()},setCommander:function(e,a){U(e.targetVillage,(function(n){const i=e.targetVillage,o=n,l=o.character_id?r.SUPPORT:r.ATTACK;let s={};t.each(u,(function(e){s[e]='*'})),console.log(s),R.addCommand(i,o,a,b.OUT,s,{},l,p.WALL),R.isRunning()||R.start()}))},setQueueBunkerCommand:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0;const g=r.SUPPORT;let m={};console.log(n,i),n.forEach((function(e,a){setTimeout((function(){o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id},(function(e){s=e.available_units.archer.total,c=e.available_units.heavy_cavalry.total,d=e.available_units.spear.total,u=e.available_units.sword.total,p=e.available_units.trebuchet.total})),c>=38&&(m={heavy_cavalry:'-38'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()),d>=500&&s>=500?(m={archer:'-500',spear:'-500'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()):d>=500&&s<500?(m={archer:'*',spear:'-500'},
R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()):d<500&&s>=500?(m={archer:'-500',spear:'*'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()):0==d&&s>=500?(m={archer:'-500'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()):d>=500&&0==s&&(m={spear:'-500'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()),u>=500&&(m={sword:'-500'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start()),p>=100&&(m={trebuchet:'*'},R.addCommand(n[a],i,t,b.ARRIVE,m,{},g,!1),R.isRunning()||R.start())}),a*h)}))}))},setQueueSupportCommand:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0;const _=r.SUPPORT;let E={};n.forEach((function(e,a){setTimeout((function(){if(o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id},(function(e){s=e.available_units.archer.total,c=e.available_units.heavy_cavalry.total,d=e.available_units.spear.total,u=e.available_units.sword.total})),
c>=30||d>=100||u>=100||s>=100){var r=c/30,T=0,w=d/100,v=0,f=u/100,h=0,y=s/100,k=0;if(v=w>=10?10:Math.floor(w),h=f>=10?10:Math.floor(f),k=y>=10?10:Math.floor(y),(T=r>=10?10:Math.floor(r))>0)for(let e=0;e<T;e++)E={heavy_cavalry:'30'},A<1800&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),A+=30);if(v>0)for(let e=0;e<v;e++)E={spear:'100'},p<6e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),p+=100);if(h>0)for(let e=0;e<h;e++)E={sword:'100'},g<6e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),g+=100);if(k>0)for(let e=0;e<k;e++)E={archer:'100'},m<6e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),m+=100)}R.isRunning()||R.start()}),a*h)}))}))},setQueueBunkerCommand5:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0;const _=r.SUPPORT;let E={};n.forEach((function(e,a){setTimeout((function(){if(o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id},(function(e){s=e.available_units.archer.total,c=e.available_units.heavy_cavalry.total,d=e.available_units.spear.total,
u=e.available_units.sword.total})),c>=300||d>=1e3||u>=1e3||s>=1e3){var r=c/300,T=0,w=d/1e3,v=0,f=u/1e3,h=0,y=s/1e3,k=0;if(v=w>=10?10:Math.floor(w),h=f>=10?10:Math.floor(f),k=y>=10?10:Math.floor(y),(T=r>=10?10:Math.floor(r))>0)for(let e=0;e<T;e++)E={heavy_cavalry:'300'},A<1500&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),A+=300);if(v>0)for(let e=0;e<v;e++)E={spear:'1000'},p<5e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),p+=1e3);if(h>0)for(let e=0;e<h;e++)E={sword:'1000'},g<5e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),g+=1e3);if(k>0)for(let e=0;e<k;e++)E={archer:'1000'},m<5e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),m+=1e3)}R.isRunning()||R.start()}),a*h)}))}))},setQueueBunkerCommand10:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0;const _=r.SUPPORT;let E={};n.forEach((function(e,a){setTimeout((function(){if(o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id},(function(e){s=e.available_units.archer.total,
c=e.available_units.heavy_cavalry.total,d=e.available_units.spear.total,u=e.available_units.sword.total})),c>=300||d>=1e3||u>=1e3||s>=1e3){var r=c/300,T=0,w=d/1e3,v=0,f=u/1e3,h=0,y=s/1e3,k=0;if(v=w>=10?10:Math.floor(w),h=f>=10?10:Math.floor(f),k=y>=10?10:Math.floor(y),(T=r>=10?10:Math.floor(r))>0)for(let e=0;e<T;e++)E={heavy_cavalry:'300'},A<3e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),A+=300);if(v>0)for(let e=0;e<v;e++)E={spear:'1000'},p<1e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),p+=1e3);if(h>0)for(let e=0;e<h;e++)E={sword:'1000'},g<1e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),g+=1e3);if(k>0)for(let e=0;e<k;e++)E={archer:'1000'},m<1e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),m+=1e3)}R.isRunning()||R.start()}),a*h)}))}))},setQueueBunkerCommand20:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0;const _=r.SUPPORT;let E={};n.forEach((function(e,a){setTimeout((function(){if(o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id
},(function(e){s=e.available_units.archer.total,c=e.available_units.heavy_cavalry.total,d=e.available_units.spear.total,u=e.available_units.sword.total})),c>=300||d>=1e3||u>=1e3||s>=1e3){var r=c/300,T=0,w=d/1e3,v=0,f=u/1e3,h=0,y=s/1e3,k=0;if(v=w>=10?10:Math.floor(w),h=f>=10?10:Math.floor(f),k=y>=10?10:Math.floor(y),(T=r>=10?10:Math.floor(r))>0)for(let e=0;e<T;e++)E={heavy_cavalry:'300'},A<6e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),A+=300);if(v>0)for(let e=0;e<v;e++)E={spear:'1000'},p<2e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),p+=1e3);if(h>0)for(let e=0;e<h;e++)E={sword:'1000'},g<2e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),g+=1e3);if(k>0)for(let e=0;e<k;e++)E={archer:'1000'},m<2e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),m+=1e3)}R.isRunning()||R.start()}),a*h)}))}))},setQueueSupportBigCommand:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0;const _=r.SUPPORT;let E={};n.forEach((function(e,a){setTimeout((function(){
if(o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id},(function(e){s=e.available_units.archer.total,c=e.available_units.heavy_cavalry.total,d=e.available_units.spear.total,u=e.available_units.sword.total})),c>=150||d>=500||u>=500||s>=500){var r=c/150,T=0,w=d/500,v=0,f=u/500,h=0,y=s/500,k=0;if(v=w>=10?10:Math.floor(w),h=f>=10?10:Math.floor(f),k=y>=10?10:Math.floor(y),(T=r>=10?10:Math.floor(r))>0)for(let e=0;e<T;e++)E={heavy_cavalry:'150'},A<9e3&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),A+=150);if(v>0)for(let e=0;e<v;e++)E={spear:'500'},p<3e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),p+=500);if(h>0)for(let e=0;e<h;e++)E={sword:'500'},g<3e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),g+=500);if(k>0)for(let e=0;e<k;e++)E={archer:'500'},m<3e4&&(R.addCommand(n[a],i,t,b.ARRIVE,E,{},_,!1),m+=500)}R.isRunning()||R.start()}),a*h)}))}))},setQueueConquerBack:function(e,t){G(e.targetVillage,(function(a){var n=a,i=e.targetVillage,s=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0,_=0,E=0;const T=r.ATTACK;let w={}
;n.forEach((function(e,a){setTimeout((function(){o.emit(l.VILLAGE_UNIT_INFO,{village_id:e.id},(function(e){p=e.available_units.archer.total,c=e.available_units.snob.total,u=e.available_units.heavy_cavalry.total,m=e.available_units.spear.total,A=e.available_units.sword.total,g=e.available_units.axe.total,s=e.available_units.light_cavalry.total,d=e.available_units.mounted_archer.total,_=e.available_units.doppelsoldner.total})),c>0&&(m>=500||A>=300||g>=100||p>=300||s>=50||d>=50||u>=50||_>=30)&&(w={archer:'*',axe:'*',doppelsoldner:'*',heavy_cavalry:'*',light_cavalry:'*',mounted_archer:'*',snob:'1',spear:'*',sword:'*'},E<3&&(c>=2&&0==E?(R.addCommand(n[a],i,t,b.ARRIVE,w,{},T,!1),R.addCommand(n[a],i,t,b.ARRIVE,w,{},T,!1),E+=2):(R.addCommand(n[a],i,t,b.ARRIVE,w,{},T,!1),E+=1))),R.isRunning()||R.start()}),a*h)}))}))},commandQueueEnabled:function(){return!!R},isInitialized:function(){return w},init:function(){for(let e=0;e<d.length;e++)I[d[e]]=!0;for(let e in r)z[r[e]]=!0;try{
R=require('two/commandQueue'),b=require('two/commandQueue/types/dates')}catch(e){}const t={[c.COMMAND_TYPES]:angular.copy(z),[c.INCOMING_UNITS]:angular.copy(I),[c.VILLAGE]:!1};w=!0,T=i.getSelectedCharacter().getGlobalInfo(),y=g.get(L,t,!0),e((function(){O(),a.$on(s.COMMAND_INCOMING,M),a.$on(s.COMMAND_CANCELLED,N),a.$on(s.MAP_SELECTED_VILLAGE,x),a.$on(s.VILLAGE_NAME_CHANGED,P),a.$on(s.COMMAND_IGNORED,C),W.loadCommands()}),['initial_village'])}};return W})),define('two/attackView/events',[],(function(){angular.extend(s,{ATTACK_VIEW_FILTERS_CHANGED:'attack_view_filters_changed',ATTACK_VIEW_SORTING_CHANGED:'attack_view_sorting_changed',ATTACK_VIEW_COMMAND_CANCELLED:'attack_view_command_cancelled',ATTACK_VIEW_COMMAND_IGNORED:'attack_view_command_ignored',ATTACK_VIEW_VILLAGE_RENAMED:'attack_view_village_renamed',ATTACK_VIEW_COMMANDS_LOADED:'attack_view_commands_loaded'})})),
define('two/attackView/ui',['two/ui','two/attackView','two/EventScope','two/utils','two/attackView/types/columns','two/attackView/types/commands','two/attackView/types/filters','two/attackView/unitSpeedOrder','conf/unitTypes','queues/EventQueue','helper/time','battlecat'],(function(e,t,n,d,u,A,_,E,T,b,w,v){let f,h;const R=function(){return Date.now()/1e3},y=function(e){let t=a.$new();t.text=g('readableDateFilter')(1e3*e,a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy'),t.title=g('i18n')('copy',a.loc.ale,'attack_view'),c.getModal('!twoverflow_attack_view_show_text_modal',t)},k=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setCommander(e,n)},S=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-1),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueSupportCommand(e,n)},L=function(e){
const n=g('readableDateFilter')(1e3*(e.time_completed-1),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueSupportBigCommand(e,n)},I=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-20),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueBunkerCommand(e,n)},z=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-20),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueBunkerCommand5(e,n)},O=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-20),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueBunkerCommand10(e,n)},M=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-20),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueBunkerCommand20(e,n)},N=function(e){
const n=g('readableDateFilter')(1e3*(e.time_completed+2),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.setQueueConquerBack(e,n)},C=function(e){var t=e.originVillage.id,a=e.originVillage.name,n=i.getSelectedCharacter().getVillageList(),s=0;n.forEach((function(e,n){var i=e.scoutingInfo.spies;setTimeout((function(){i.forEach((function(n,i){1==n.type&&(s+=1)<=7&&(setTimeout((function(){o.emit(l.SCOUTING_SEND_COMMAND,{startVillage:e.getId(),targetVillage:t,spys:1,type:'units'})}),5e3*i*Math.random()),d.emitNotif('success','Szpieg nr '+s+' wysłany na '+a))}))}),7e3*n*Math.random())}))},P=function(e){const n=g('readableDateFilter')(1e3*(e.time_completed-10),a.loc.ale,a.GAME_TIMEZONE,a.GAME_TIME_OFFSET,'HH:mm:ss:sss dd/MM/yyyy');console.log(n),t.withdrawArmy(e,n)},x=function(){let e=v('#two-attack-view').parent(),t=v('#wrapper');e.toggleClass('fullsize'),t.toggleClass('window-fullsize')},D=function(){const e=f.pagination.offset,t=f.pagination.limit
;f.visibleCommands=f.commands.slice(e,e+t),f.pagination.count=f.commands.length},B=function(){const e=Date.now();for(let t=0;t<f.commands.length;t++)100===f.commands[t].model.percent(e)&&f.commands.splice(t,1);D()},U=function(e,a){t.toggleFilter(e,a),f.filters=t.getFilters()},G=function(e){t.toggleSorting(e),f.sorting=t.getSortings()},V=function(){f.commands=t.getCommands()},W=function(){f.selectedVillageId=i.getSelectedVillage().getId()},j=function(){f=a.$new(),f.commandQueueEnabled=t.commandQueueEnabled(),f.commands=t.getCommands(),f.selectedVillageId=i.getSelectedVillage().getId(),f.filters=t.getFilters(),f.sorting=t.getSortings(),f.UNIT_TYPES=T,f.FILTER_TYPES=_,f.COMMAND_TYPES=A,f.UNIT_SPEED_ORDER=E,f.COLUMN_TYPES=u,f.pagination={count:f.commands.length,offset:0,loader:D,limit:m.getPaginationLimit()},f.openCharacterProfile=r.openCharacterProfile,f.openVillageInfo=r.openVillageInfo,f.jumpToVillage=p.jumpToVillage,f.now=R,f.copyTimeModal=y,f.removeTroops=k,f.conquerBack=N,
f.killNobleman=S,f.killNoblemanBig=L,f.bunkerVillage=I,f.bunkerVillage5k=z,f.bunkerVillage10k=O,f.bunkerVillage20k=M,f.withdrawArmy=P,f.spyVillage=C,f.switchWindowSize=x,f.toggleFilter=U,f.toggleSorting=G,D();let e=new n('twoverflow_queue_window',(function(){w.timer.remove(B)}));e.register(s.MAP_SELECTED_VILLAGE,W,!0),e.register(s.ATTACK_VIEW_COMMANDS_LOADED,V),e.register(s.ATTACK_VIEW_COMMAND_CANCELLED,V),e.register(s.ATTACK_VIEW_COMMAND_IGNORED,V),e.register(s.ATTACK_VIEW_VILLAGE_RENAMED,V),c.getScreenWithInjectedScope('!twoverflow_attack_view_main',f),w.timer.add(B)};return function(){h=e.addMenuButton('Strażnik',30,g('i18n')('description',a.loc.ale,'attack_view')),h.addEventListener('click',j),
...
let f,h,R=!1,y=!1,k=[],S=null,L=null,I=null,z=null,O=null,M=null,N=null,C=null,P=null,x=null,D=null,B=null,U=null,G=null,V=null,W=null,j=null,q=null,F=null,H=null,Y=null,K=null,Q=null,Z=null,X=null,J=null,$=null,ee=null,te=null,ae=null,ne=null,ie=null,oe=null,le=null,se=null,re=null,ce=null,de=null,ue=null,pe=null,ge=null,me=null,Ae=null,_e=null,Ee=null,Te=null,be=null,we=null,ve=null,fe=null,he=null,Re=null,ye=null,ke=null,Se=null,Le=null,Ie=null,ze=null,Oe=null,Me=null,Ne=null,Ce=null,Pe=null,xe=null,De=null,Be=null,Ue=null,Ge=null,Ve=null,We=null,je=null,qe=null,Fe=null,He=null,Ye=null,Ke=null,Qe=null,Ze=null,Xe=null,Je=null,$e=null,et=null,tt=null,at=null,nt=null,it=null,ot=null,lt=null,st=null,rt=null,ct=null,dt=null,ut=null,pt=null,gt=null,mt=null,At=null,_t=null,Et=null,Tt=null,bt=null,wt=null,vt=null,ft=null,ht=null,Rt=null,yt=null,kt=null,St=null,Lt=null,It=null,zt=null,Ot=null,Mt=null,Nt=null,Ct=null,Pt=null,xt=null,Dt=null,Bt=null,Ut=null,Gt=null,Vt=null,Wt=null,jt=null,qt=null,Ft=null,Ht=null,Yt=null,Kt=null,Qt=null,Zt=null,Xt=null,Jt=null,$t=null,ea=null,ta=null,aa=null,na=null,ia=null,oa=null,la=null,sa=null,ra=null,ca=null,da=null,ua=null,pa=null,ga=null,ma=null,Aa=null,_a=null,Ea=null,Ta=null,ba=null,wa=null,va=null,fa=null,ha=null,Ra=null,ya=null,ka=null,Sa=null,La=null,Ia=null,za=null,Oa=null,Ma=null
...
[m.LEVEL_3]:'level_3'},Ba={[g.NO_WALL]:'without',[g.LEVEL_1]:'level_1',[g.LEVEL_2]:'level_2',[g.LEVEL_3]:'level_3',[g.LEVEL_4]:'level_4',[g.LEVEL_5]:'level_5',[g.LEVEL_6]:'level_6',[g.LEVEL_7]:'level_7',[g.LEVEL_8]:'level_8',[g.LEVEL_9]:'level_9',[g.LEVEL_10]:'level_10',[g.LEVEL_11]:'level_11',[g.LEVEL_12]:'level_12',[g.LEVEL_13]:'level_13',[g.LEVEL_14]:'level_14',[g.LEVEL_15]:'level_15',[g.LEVEL_16]:'level_16',[g.LEVEL_17]:'level_17',[g.LEVEL_18]:'level_18',[g.LEVEL_19]:'level_19',[g.LEVEL_20]:'level_20'},Ua={[A.LEVEL_1]:'level_1',[A.LEVEL_2]:'level_2',[A.LEVEL_3]:'level_3',[A.LEVEL_4]:'level_4',[A.LEVEL_5]:'level_5'},Ga={[_.LEVEL_1]:'level_1',[_.LEVEL_2]:'level_2',[_.LEVEL_3]:'level_3',[_.LEVEL_4]:'level_4',[_.LEVEL_5]:'level_5'},Va={[E.LEVEL_1]:'level_1',[E.LEVEL_2]:'level_2',[E.LEVEL_3]:'level_3',[E.LEVEL_4]:'level_4',[E.LEVEL_5]:'level_5',[E.LEVEL_6]:'level_6',[E.LEVEL_7]:'level_7',[E.LEVEL_8]:'level_8',[E.LEVEL_9]:'level_9',[E.LEVEL_10]:'level_10'},Wa={[T.LEVEL_1]:'level_1',
[T.LEVEL_2]:'level_2',[T.LEVEL_3]:'level_3',[T.LEVEL_4]:'level_4',[T.LEVEL_5]:'level_5',[T.LEVEL_6]:'level_6',[T.LEVEL_7]:'level_7',[T.LEVEL_8]:'level_8',[T.LEVEL_9]:'level_9',[T.LEVEL_10]:'level_10'};console.log(Wa,Va,Ga,Ua,Ba,Da,Ca,Pa,xa);const ja=function(){k=[];const e=i.getPresetList().getPresets(),a=h[t.PRESET];k.push(e[a])},qa={init:function(){R=!0,f=new e({settingsMap:n,storageKey:Na}),f.onChange((function(e,t){h=f.getAll(),t[r.PRESETS]&&ja()})),h=f.getAll(),console.log('battleCalculator settings',h),w((function(){ja()}),'presets'),a.$on(s.ARMY_PRESET_UPDATE,ja),a.$on(s.ARMY_PRESET_DELETED,ja)},getPresetUnits:function(){S=h[t.PRESET],o.emit(l.GET_PRESETS,{},(function(e){for(Ma=0;Ma<e.presets.length;Ma++)e.presets[Ma].id==S&&(oa=e.presets[Ma].units.spear,la=e.presets[Ma].units.sword,sa=e.presets[Ma].units.axe,ra=e.presets[Ma].units.archer,ca=e.presets[Ma].units.light_cavalry,da=e.presets[Ma].units.mounted_archer,ua=e.presets[Ma].units.heavy_cavalry,pa=e.presets[Ma].units.ram,
ga=e.presets[Ma].units.catapult,ma=e.presets[Ma].units.snob,Aa=e.presets[Ma].units.knight,_a=e.presets[Ma].units.trebuchet,Ea=e.presets[Ma].units.doppelsoldner)}))},getVillageUnits:function(){Oa=h[t.BATTLE_VILLAGE_ID],o.emit(l.VILLAGE_UNIT_INFO,{village_id:Oa},(function(e){ba=e.available_units.axe.total,Ta=e.available_units.archer.total,wa=e.available_units.catapult.total,va=e.available_units.doppelsoldner.total,fa=e.available_units.heavy_cavalry.total,ha=e.available_units.knight.total,Ra=e.available_units.light_cavalry.total,ya=e.available_units.mounted_archer.total,ka=e.available_units.ram.total,Sa=e.available_units.snob.total,La=e.available_units.spear.total,Ia=e.available_units.sword.total,za=e.available_units.trebuchet.total}))},calculateB:function(){
const e=h[t.BASHPOINTS_SPEAR],a=h[t.BASHPOINTS_SWORD],n=h[t.BASHPOINTS_AXE],i=h[t.BASHPOINTS_ARCHER],o=h[t.BASHPOINTS_LC],l=h[t.BASHPOINTS_MA],s=h[t.BASHPOINTS_HC],r=h[t.BASHPOINTS_RAM],c=h[t.BASHPOINTS_CATAPULT],d=h[t.BASHPOINTS_DOPPELSOLDNER],u=h[t.BASHPOINTS_TREBUCHET],p=h[t.BASHPOINTS_SNOB],g=h[t.BASHPOINTS_KNIGHT];var m=[1,2,4,2,13,12,15,8,10,20,200,0,25],A=[4,5,1,5,5,6,23,4,12,40,200,25,10];L=e*m[0]+a*m[1]+n*m[2]+i*m[3]+o*m[4]+l*m[5]+s*m[6]+r*m[7]+c*m[8]+g*m[9]+p*m[10]+u*m[11]+d*m[12],I=e*A[0]+a*A[1]+n*A[2]+i*A[3]+o*A[4]+l*A[5]+s*A[6]+r*A[7]+c*A[8]+g*A[9]+p*A[10]+u*A[11]+d*A[12]}};return qa.simulate=function(){
var e=[1,2,4,2,13,12,15,8,10,20,200,0,25],a=[4,5,1,5,5,6,23,4,12,40,200,25,10],n=[25,55,10,10,30,40,200,20,100,250,100,200,100],i=[45,5,5,30,40,30,160,50,50,400,50,250,100],o=[10,30,10,60,30,50,180,20,100,150,100,200,50],l=[10,25,45,25,130,150,150,2,100,150,30,30,300],s=[1,1,1,1,4,5,6,5,8,1,100,10,6],r=0,c=0,d=0,u=0,p=0,g=0,m=0,A=0,_=0,E=0,T=0,b=0,w=0,v=0,f=0,R=0,y=0,k=0,S=0,L=0,I=0,z=0,O=0,M=0,N=0,C=0,P=0,x=0,D=0,B=0,U=0,G=0,V=0,W=0,j=0,q=0,oa=0,la=0,sa=0,ra=0,ca=0,da=0,ua=0,pa=0,ga=0,ma=0,Aa=0,_a=0,Ea=0,Ta=0,ba=0,wa=0,va=0,fa=0,ha=0,Ra=0,ya=0,ka=0,Sa=0,La=0,Ia=0,za=0,Oa=0,Ma=0,Na=0,Ca=0,Pa=0,xa=0,Da=0,Ba=0,Ua=0,Ga=0,Va=0,Wa=0,ja=0,qa=0,Fa=0,Ha=0,Ya=0,Ka=0,Qa=0,Za=0,Xa=0,Ja=0,$a=0,en=0,tn=0,an=0,nn=0,on=0,ln=0,sn=0,rn=0,cn=0,dn=0,un=0,pn=0,gn=0,mn=0,An=0,_n=0,En=0,Tn=0,bn=0,wn=0,vn=0,fn=0,hn=[1,1],Rn=[1,1],yn=[1,1],kn=[1,1],Sn=[1,1],Ln=[1,1],In=[1,1],zn=[1,1],On=[1,1],Mn=[1,1],Nn=[1,1],Cn=[1,1],Pn=[1,1],xn=[1,1],Dn=[1,1],Bn=[1,1],Un=[1,1],Gn=[1,1],Vn=[1,1],Wn=[1,1],jn=[1,1],qn=[1,1],Fn=[1,1],Hn=[1,1],Yn=[1,1],Kn=[1,1],Qn=[1,1],Zn=[1,1],Xn=[1,1],Jn=[1,1],$n=[1,1],ei=[1,1],ti=[1,1],ai=[1,1],ni=[1,1],ii=[1,1],oi=0,li=0,si=0,ri=0,ci=0,di=0,ui=0,pi=0,gi=0,mi=0,Ai=0,_i=0,Ei=0,Ti=0,bi=0,wi=0,vi=0,fi=0,hi=0,Ri=0,yi=0,ki=0,Si=0,Li=0,Ii=0,zi=[1,1],Oi=0,Mi=0,Ni=0,Ci=0,Pi=0,xi=0,Di=0,Bi=0,Ui=0,Gi=0,Vi=0,Wi=0,ji=0,qi=0,Fi=0,Hi=0,Yi=0,Ki=0,Qi=0,Zi=0,Xi=0,Ji=0,$i=0,eo=0,to=0,ao=0,no=0,io=0,oo=0,lo=0,so=0,ro=0,co=0,uo=0,po=0,go=0,mo=0,Ao=[1,1],_o=[1,1],Eo=[1,1],To=[1,1],bo=[1,1],wo=[1,1],vo=[1,1],fo=[1,1],ho=[1,1],Ro=0,yo=0,ko=0,So=0,Lo=0,Io=0,zo=0,Oo=0,Mo=0,No=0,Co=0,Po=0,xo=0,Do=0,Bo=0,Uo=0,Go=0,Vo=0,Wo=0,jo=0,qo=0,Fo=0,Ho=0,Yo=0,Ko=0,Qo=0,Zo=0,Xo=0,Jo=0,$o=0,el=0,tl=0,al=0,nl=0,il=0,ol=0,ll=0,sl=0,rl=0,cl=0,dl=0,ul=0,pl=0,gl=0,ml=0,Al=0,_l=0,El=0,Tl=0,bl=0,wl=0,vl=0,fl=0,hl=0,Rl=0,yl=0,kl=0,Sl=0,Ll=0,Il=0,zl=0,Ol=0,Ml=0,Nl=0,Cl=0,Pl=0,xl=0,Dl=0,Bl=0,Ul=0,Gl=0,Vl=0,Wl=0,jl=0,ql=0,Fl=0,Hl=1,Yl=0,Kl=0,Ql=0,Zl=0,Xl=0,Jl=0,$l=0,es=0,ts=0,as=0,ns=0,is=0,os=0,ls=0,ss=0,rs=0,cs=0,ds=0,us=0,ps=0,gs=0,ms=0,As=0,_s=0,Es=0,Ts=0,bs=0,ws=0,vs=0,fs=0,hs=0,Rs=0,ys=0,ks=0,Ss=0,Ls=0,Is=0,zs=0,Os=0,Ms=0,Ns=0,Cs=0,Ps=0,xs=0,Ds=0,Bs=0,Us=0,Gs=0,Vs=0,Ws=0,js=0,qs=0,Fs=0,Hs=0,Ys=0,Ks=0,Qs=0,Zs=0,Xs=0,Js=0,$s=0,er=0,tr=0,ar=0,nr=0,ir=0,or=0,lr=0,sr=0,rr=0,cr=0,dr=0,ur=0,pr=0,gr=0,mr=0,Ar=0,_r=0,Er=0,Tr=0,br=0,wr=0,vr=0,fr=0,hr=0,Rr=0,yr=0,kr=0,Sr=0,Lr=0,Ir=0,zr=0,Or=0,Mr=0,Nr=0,Cr=0,Pr=0,xr=0,Dr=0,Br=0,Ur=0,Gr=0,Vr=0,Wr=0,jr=0,qr=0,Fr=0,Hr=0,Yr=0,Kr=0,Qr=0,Zr=0,Xr=0,Jr=0,$r=0,ec=0,tc=0,ac=0,nc=0,ic=0,oc=0,lc=0,sc=0,rc=0,cc=0,dc=0,uc=0,pc=0,gc=0,mc=0,Ac=0,_c=0,Ec=0,Tc=0,bc=0,wc=0,vc=0,fc=0,hc=0,Rc=0,yc=0,kc=0,Sc=0,Lc=0,Ic=0,zc=0,Oc=0,Mc=0,Nc=0,Cc=0,Pc=0,xc=0,Dc=0,Bc=0,Uc=0,Gc=0,Vc=0,Wc=0,jc=0,qc=0,Fc=0,Hc=0,Yc=0,Kc=0,Qc=0,Zc=0,Xc=0,Jc=0,$c=0,ed=0,td=0,ad=0,nd=0,id=0,od=0,ld=0,sd=0,rd=0,cd=0,dd=0,ud=0,pd=0,gd=0,md=0,Ad=0,_d=0,Ed=0,Td=0,bd=0,wd=0,vd=0,fd=0,hd=0,Rd=0
;console.log(na,Kt),r=h[t.BATTLE_CHURCH_A],c=h[t.BATTLE_CHURCH_D],d=h[t.BATTLE_NIGHT_BONUS],u=h[t.BATTLE_OFFICER_LEADER],p=h[t.BATTLE_OFFICER_MEDIC],g=h[t.BATTLE_SKILL_MEDIC],m=h[t.BATTLE_SKILL_WEAPON_MASTER],A=h[t.BATTLE_WALL],_=h[t.BATTLE_SKILL_IRON_WALLS],E=h[t.BATTLE_SKILL_CLINIQUE],T=h[t.BATTLE_HOSPITAL],Pt=h[t.BATTLE_CATAPULT_TARGET],b=h[t.BATTLE_CATAPULT_TARGET],w=h[t.BATTLE_KNIGHT_ITEM_D1],v=h[t.BATTLE_KNIGHT_ITEM_D2],f=h[t.BATTLE_KNIGHT_ITEM_D3],R=h[t.BATTLE_KNIGHT_ITEM_A],y=h[t.BATTLE_ITEM_LEVEL_D1],k=h[t.BATTLE_ITEM_LEVEL_D2],S=h[t.BATTLE_ITEM_LEVEL_D3],L=h[t.BATTLE_ITEM_LEVEL_A],Ge=h[t.BATTLE_ARCHER_A],K=h[t.BATTLE_ARCHER_D],Ue=h[t.BATTLE_AXE_A],Y=h[t.BATTLE_AXE_D],Qe=h[t.BATTLE_DOPPELSOLDNER_A],ne=h[t.BATTLE_DOPPELSOLDNER_D],qe=h[t.BATTLE_CATAPULT_A],J=h[t.BATTLE_CATAPULT_D],Ke=h[t.BATTLE_HC_A],ae=h[t.BATTLE_HC_D],We=h[t.BATTLE_KNIGHT_A],Z=h[t.BATTLE_KNIGHT_D],He=h[t.BATTLE_LC_A],ee=h[t.BATTLE_LC_D],Ye=h[t.BATTLE_MA_A],te=h[t.BATTLE_MA_D],je=h[t.BATTLE_RAM_A],
X=h[t.BATTLE_RAM_D],Ve=h[t.BATTLE_SNOB_A],Q=h[t.BATTLE_SNOB_D],De=h[t.BATTLE_SPEAR_A],F=h[t.BATTLE_SPEAR_D],Be=h[t.BATTLE_SWORD_A],H=h[t.BATTLE_SWORD_D],Fe=h[t.BATTLE_TREBUCHET_A],$=h[t.BATTLE_TREBUCHET_D],I=h[t.BATTLE_MORALE],z=h[t.BATTLE_LUCK],console.log(Pt),hd='level_1'==r?100:'level_2'==r?105:'level_3'==r?110:50,console.log(hd),Rd='level_1'==c?100:'level_2'==c?105:'level_3'==c?110:50,console.log(Rd),Hl=d?2:1,console.log(Hl),rl=u?.1:0,console.log(rl),ql=p?.1:0,console.log(ql),Js=g?.1:0,console.log(Js),Zs='level_1'==m?2:'level_2'==m?4:'level_3'==m?6:'level_4'==m?8:'level_5'==m?10:0,console.log(Zs),$s='level_1'==_?1:'level_2'==_?2:'level_3'==_?3:'level_4'==_?4:'level_5'==_?5:0,console.log($s),Xs='level_1'==E?100:'level_2'==E?200:'level_3'==E?300:'level_4'==E?400:'level_5'==E?500:'level_6'==E?600:'level_7'==E?700:'level_8'==E?800:'level_9'==E?900:'level_10'==E?1e3:0,console.log(Xs),
Ii='level_1'==T?100:'level_2'==T?129:'level_3'==T?167:'level_4'==T?215:'level_5'==T?278:'level_6'==T?359:'level_7'==T?464:'level_8'==T?599:'level_9'==T?774:'level_10'==T?1e3:0,console.log(Ii),Gt='level_1'==A?1:'level_2'==A?2:'level_3'==A?3:'level_4'==A?4:'level_5'==A?5:'level_6'==A?6:'level_7'==A?7:'level_8'==A?8:'level_9'==A?9:'level_10'==A?10:'level_11'==A?11:'level_12'==A?12:'level_13'==A?13:'level_14'==A?14:'level_15'==A?15:'level_16'==A?16:'level_17'==A?17:'level_18'==A?18:'level_19'==A?19:'level_20'==A?20:0,console.log(Gt),Gn='battle.lance'==w&'level_1'==y?[1.05,1.1]:'battle.lance'==w&'level_2'==y?[1.1,1.2]:'battle.lance'==w&'level_3'==y?[1.2,1.3]:[1,1],console.log(Gn),Ln='battle.battleaxe'==w&'level_1'==y?[1.05,1.1]:'battle.battleaxe'==w&'level_2'==y?[1.1,1.2]:'battle.battleaxe'==w&'level_3'==y?[1.2,1.3]:[1,1],console.log(Ln),qn='battle.compositebow'==w&'level_1'==y?[1.05,1.1]:'battle.compositebow'==w&'level_2'==y?[1.1,1.2]:'battle.compositebow'==w&'level_3'==y?[1.2,1.3]:[1,1],
console.log(qn),Jn='battle.halberd'==w&'level_1'==y?[1.1,1.05]:'battle.halberd'==w&'level_2'==y?[1.2,1.1]:'battle.halberd'==w&'level_3'==y?[1.3,1.2]:[1,1],console.log(Jn),ai='battle.longsword'==w&'level_1'==y?[1.1,1.05]:'battle.longsword'==w&'level_2'==y?[1.2,1.1]:'battle.longsword'==w&'level_3'==y?[1.3,1.2]:[1,1],Rn='battle.longbow'==w&'level_1'==y?[1.1,1.05]:'battle.longbow'==w&'level_2'==y?[1.2,1.1]:'battle.longbow'==w&'level_3'==y?[1.3,1.2]:[1,1],xn='battle.banner'==w&'level_1'==y?[1.1,1.1]:'battle.banner'==w&'level_2'==y?[1.2,1.2]:'battle.banner'==w&'level_3'==y?[1.3,1.3]:[1,1],Kn='battle.star'==w&'level_1'==y?[1.05,1.25]:'battle.star'==w&'level_2'==y?[1.1,1.5]:'battle.star'==w&'level_3'==y?[1.2,2]:[1,1],Mn='battle.bonfire'==w&'level_1'==y?[1.05,1.25]:'battle.bonfire'==w&'level_2'==y?[1.1,1.5]:'battle.bonfire'==w&'level_3'==y?[1.2,2]:[1,1],Vn='battle.lance'==v&'level_1'==k?[1.05,1.1]:'battle.lance'==v&'level_2'==k?[1.1,1.2]:'battle.lance'==v&'level_3'==k?[1.2,1.3]:[1,1],
In='battle.battleaxe'==v&'level_1'==k?[1.05,1.1]:'battle.battleaxe'==v&'level_2'==k?[1.1,1.2]:'battle.battleaxe'==v&'level_3'==k?[1.2,1.3]:[1,1],Fn='battle.compositebow'==v&'level_1'==k?[1.05,1.1]:'battle.compositebow'==v&'level_2'==k?[1.1,1.2]:'battle.compositebow'==v&'level_3'==k?[1.2,1.3]:[1,1],$n='battle.halberd'==v&'level_1'==k?[1.1,1.05]:'battle.halberd'==v&'level_2'==k?[1.2,1.1]:'battle.halberd'==v&'level_3'==k?[1.3,1.2]:[1,1],ni='battle.longsword'==v&'level_1'==k?[1.1,1.05]:'battle.longsword'==v&'level_2'==k?[1.2,1.1]:'battle.longsword'==v&'level_3'==k?[1.3,1.2]:[1,1],yn='battle.longbow'==v&'level_1'==k?[1.1,1.05]:'battle.longbow'==v&'level_2'==k?[1.2,1.1]:'battle.longbow'==v&'level_3'==k?[1.3,1.2]:[1,1],Dn='battle.banner'==v&'level_1'==k?[1.1,1.1]:'battle.banner'==v&'level_2'==k?[1.2,1.2]:'battle.banner'==v&'level_3'==k?[1.3,1.3]:[1,1],Qn='battle.star'==v&'level_1'==k?[1.05,1.25]:'battle.star'==v&'level_2'==k?[1.1,1.5]:'battle.star'==v&'level_3'==k?[1.2,2]:[1,1],
Nn='battle.bonfire'==v&'level_1'==k?[1.05,1.25]:'battle.bonfire'==v&'level_2'==k?[1.1,1.5]:'battle.bonfire'==v&'level_3'==k?[1.2,2]:[1,1],Wn='battle.lance'==f&'level_1'==S?[1.05,1.1]:'battle.lance'==f&'level_2'==S?[1.1,1.2]:'battle.lance'==f&'level_3'==S?[1.2,1.3]:[1,1],zn='battle.battleaxe'==f&'level_1'==S?[1.05,1.1]:'battle.battleaxe'==f&'level_2'==S?[1.1,1.2]:'battle.battleaxe'==f&'level_3'==S?[1.2,1.3]:[1,1],Hn='battle.compositebow'==f&'level_1'==S?[1.05,1.1]:'battle.compositebow'==f&'level_2'==S?[1.1,1.2]:'battle.compositebow'==f&'level_3'==S?[1.2,1.3]:[1,1],ei='battle.halberd'==f&'level_1'==S?[1.1,1.05]:'battle.halberd'==f&'level_2'==S?[1.2,1.1]:'battle.halberd'==f&'level_3'==S?[1.3,1.2]:[1,1],ii='battle.longsword'==f&'level_1'==S?[1.1,1.05]:'battle.longsword'==f&'level_2'==S?[1.2,1.1]:'battle.longsword'==f&'level_3'==S?[1.3,1.2]:[1,1],kn='battle.longbow'==f&'level_1'==S?[1.1,1.05]:'battle.longbow'==f&'level_2'==S?[1.2,1.1]:'battle.longbow'==f&'level_3'==S?[1.3,1.2]:[1,1],
Bn='battle.banner'==f&'level_1'==S?[1.1,1.1]:'battle.banner'==f&'level_2'==S?[1.2,1.2]:'battle.banner'==f&'level_3'==S?[1.3,1.3]:[1,1],Zn='battle.star'==f&'level_1'==S?[1.05,1.25]:'battle.star'==f&'level_2'==S?[1.1,1.5]:'battle.star'==f&'level_3'==S?[1.2,2]:[1,1],Cn='battle.bonfire'==f&'level_1'==S?[1.05,1.25]:'battle.bonfire'==f&'level_2'==S?[1.1,1.5]:'battle.bonfire'==f&'level_3'==S?[1.2,2]:[1,1],Un=Gn[0]>=Vn[0]&&Gn[0]>=Wn[0]?Gn:Vn[0]>=Gn[0]&&Vn[0]>=Wn[0]?Vn:Wn[0]>=Gn[0]&&Wn[0]>=Vn[0]?Wn:[1,1],Sn=Ln[0]>=In[0]&&Ln[0]>=zn[0]?Ln:In[0]>=Ln[0]&&In[0]>=zn[0]?In:zn[0]>=Ln[0]&&zn[0]>=In[0]?zn:[1,1],jn=qn[0]>=Fn[0]&&qn[0]>=Hn[0]?qn:Fn[0]>=qn[0]&&Fn[0]>=Hn[0]?Fn:Hn[0]>=qn[0]&&Hn[0]>=Fn[0]?Hn:[1,1],Pn=xn[0]>=Dn[0]&&xn[0]>=Bn[0]?xn:Dn[0]>=xn[0]&&Dn[0]>=Bn[0]?Dn:Bn[0]>=xn[0]&&Bn[0]>=Dn[0]?Bn:[1,1],Yn=Kn[0]>=Qn[0]&&Kn[0]>=Zn[0]?Kn:Qn[0]>=Kn[0]&&Qn[0]>=Zn[0]?Qn:Zn[0]>=Kn[0]&&Zn[0]>=Qn[0]?Zn:[1,1],On=Mn[0]>=Nn[0]&&Mn[0]>=Cn[0]?Mn:Nn[0]>=Mn[0]&&Nn[0]>=Cn[0]?Nn:Cn[0]>=Mn[0]&&Cn[0]>=Nn[0]?Cn:[1,1],
Xn=Jn[0]>=$n[0]&&Jn[0]>=ei[0]?Jn:$n[0]>=Jn[0]&&$n[0]>=ei[0]?$n:ei[0]>=Jn[0]&&ei[0]>=$n[0]?ei:[1,1],ti=ai[0]>=ni[0]&&ai[0]>=ii[0]?ai:ni[0]>=ai[0]&&ni[0]>=ii[0]?ni:ii[0]>=ai[0]&&ii[0]>=ni[0]?ii:[1,1],hn=Rn[0]>=yn[0]&&Rn[0]>=kn[0]?Rn:yn[0]>=Rn[0]&&yn[0]>=kn[0]?yn:kn[0]>=Rn[0]&&kn[0]>=yn[0]?kn:[1,1],bo='battle.lance'==R&'level_1'==L?[1.05,1.1]:'battle.lance'==R&'level_2'==L?[1.1,1.2]:'battle.lance'==R&'level_3'==L?[1.2,1.3]:[1,1],_o='battle.battleaxe'==R&'level_1'==L?[1.05,1.1]:'battle.battleaxe'==R&'level_2'==L?[1.1,1.2]:'battle.battleaxe'==R&'level_3'==L?[1.2,1.3]:[1,1],wo='battle.compositebow'==R&'level_1'==L?[1.05,1.1]:'battle.compositebow'==R&'level_2'==L?[1.1,1.2]:'battle.compositebow'==R&'level_3'==L?[1.2,1.3]:[1,1],fo='battle.halberd'==R&'level_1'==L?[1.1,1.05]:'battle.halberd'==R&'level_2'==L?[1.2,1.1]:'battle.halberd'==R&'level_3'==L?[1.3,1.2]:[1,1],
ho='battle.longsword'==R&'level_1'==L?[1.1,1.05]:'battle.longsword'==R&'level_2'==L?[1.2,1.1]:'battle.longsword'==R&'level_3'==L?[1.3,1.2]:[1,1],Ao='battle.longbow'==R&'level_1'==L?[1.1,1.05]:'battle.longbow'==R&'level_2'==L?[1.2,1.1]:'battle.longbow'==R&'level_3'==L?[1.3,1.2]:[1,1],To='battle.banner'==R&'level_1'==L?[1.1,1.1]:'battle.banner'==R&'level_2'==L?[1.2,1.2]:'battle.banner'==R&'level_3'==L?[1.3,1.3]:[1,1],vo='battle.star'==R&'level_1'==L?[1.05,1.25]:'battle.star'==R&'level_2'==L?[1.1,1.5]:'battle.star'==R&'level_3'==L?[1.2,2]:[1,1],Eo='battle.bonfire'==R&'level_1'==L?[1.05,1.25]:'battle.bonfire'==R&'level_2'==L?[1.1,1.5]:'battle.bonfire'==R&'level_3'==L?[1.2,2]:[1,1],Xt=De*s[0]+Be*s[1]+Ue*s[2]+Ge*s[3]+He*s[4]+Ye*s[5]+Ke*s[6]+je*s[7]+qe*s[8]+We*s[9]+Ve*s[10]+Fe*s[11]+Qe*s[12],Wt=F*s[0]+H*s[1]+Y*s[2]+K*s[3]+ee*s[4]+te*s[5]+ae*s[6]+X*s[7]+J*s[8]+Z*s[9]+Q*s[10]+$*s[11]+ne*s[12],console.log('Prowiant:'+Xt,Wt),ia=2*Xt<=Wt?2:1,Yl=Xt-5*je,
Kl=0==Gt?0:Math.round(20*Math.pow(1.2515,Gt-1)),fn=Wt+(Kl+100*Q),bs=0==Yl||0==fn?0:Yl/fn>1?1:Yl/fn,console.log(bs),Fl=I/100,Rl=z/100,Zt=Math.round(1e3*(hd/100*Fl*(1+Rl)+Zs/100+rl))/1e3,wd=qe/(bd=je+qe),vd=je/bd,ed=Math.round($*wd),Ad=Math.round($*vd),Vs=(js=je-(0==je?0:je<Ad?je:Ad))*bs*Zt*(zi='battle.star'==R?'level_1'==L?[1.05,1.25]:'level_2'==L?[1.1,1.5]:'level_3'==L?[1.2,2]:[1,1]:[1,1])[1],Si=20==Gt?18:19==Gt?17:18==Gt?15:17==Gt?14:16==Gt?13:15==Gt?11:14==Gt?10:13==Gt||12==Gt?9:11==Gt?8:10==Gt?7:9==Gt||8==Gt?6:7==Gt||6==Gt?5:5==Gt||4==Gt||3==Gt?4:2==Gt||1==Gt?3:0,Ed=0==Gt?0:2*Si,_d=0==Gt?0:Vs/Ed,Td=Gt<=$s?Gt:Gt-$s<_d?Gt<$s?Gt:$s:Gt-_d,Ma=Math.round(Td),Oa=Math.round(.05*Ma*1e3)/1e3,Vt=Math.round(Rd/100*(1+Oa)*Hl*1e3)/1e3,vn=qe-(0==qe?0:qe<ed?qe:ed),Bt=Math.round(Td),za=0==Bt?0:Math.round(20*Math.pow(1.2515,Bt-1)),Wo=De+Be+Ue+Qe>He+Ke&&De+Be+Ue+Qe>Ge+Ye?'inf':He+Ke>De+Be+Ue+Qe&&He+Ke>Ge+Ye?'cav':'arc',
is=De*s[0]+Be*s[1]+Ue*s[2]+Ge*s[3]+He*s[4]+Ye*s[5]+Ke*s[6]+js*s[7]+vn*s[8]+We*s[9]+Ve*s[10]+Fe*s[11]+Qe*s[12],_s=F*s[0]+H*s[1]+Y*s[2]+K*s[3]+ee*s[4]+te*s[5]+ae*s[6]+X*s[7]+J*s[8]+Z*s[9]+Q*s[10]+$*s[11]+ne*s[12],console.log(is,_s),Fs=js*s[7]+vn*s[8]+Fe*s[11]+We*s[9]+Ve*s[10],'cav'==Wo?(Jl=He*s[4]+Ke*s[6]+Fs,ts=De*s[0]+Be*s[1]+Ue*s[2]+Qe*s[12],Ql=Ge*s[3]+Ye*s[5]):'inf'==Wo?(ts=De*s[0]+Be*s[1]+Ue*s[2]+Qe*s[12]+Fs,Jl=He*s[4]+Ke*s[6],Ql=Ge*s[3]+Ye*s[5]):'arc'==Wo?(ts=De*s[0]+Be*s[1]+Ue*s[2]+Qe*s[12],Jl=He*s[4]+Ke*s[6],Ql=Ge*s[3]+Ye*s[5]+Fs):(ts=De*s[0]+Be*s[1]+Ue*s[2]+Qe*s[12],Jl=He*s[4]+Ke*s[6],Ql=Ge*s[3]+Ye*s[5]),El=0==ts?0:Math.round(ts/is*1e4)/1e4,_l=0==Jl?0:Math.round(Jl/is*1e4)/1e4,Al=0==Ql?0:Math.round(Ql/is*1e4)/1e4,console.log(Al),zr=Math.round(F*El),Ir=Math.round(F*_l),Lr=F-Ir-zr,Vc=Math.round(H*El),Gc=Math.round(H*_l),Uc=H-Gc-Vc,fa=Math.round(Y*El),va=Math.round(Y*_l),wa=Y-va-fa,W=Math.round(K*El),V=Math.round(K*_l),G=K-V-W,el=Math.round(ee*El),$o=Math.round(ee*_l),Jo=ee-$o-el,
xl=Math.round(te*El),Pl=Math.round(te*_l),Cl=te-Pl-xl,Ti=Math.round(ae*El),Ei=Math.round(ae*_l),_i=ae-Ei-Ti,Os=Math.round(X*El),zs=Math.round(X*_l),Is=X-zs-Os,dn=Math.round(J*El),cn=Math.round(J*_l),rn=J-cn-dn,ur=Math.round(Q*El),dr=Math.round(Q*_l),cr=Q-dr-ur,sd=Math.round($*El),ld=Math.round($*_l),od=$-ld-sd,qa=Math.round(ne*El),ja=Math.round(ne*_l),Wa=ne-ja-qa,lo=Math.round(Z*El),oo=Math.round(Z*_l),io=Z-oo-lo,gs=zr*s[0]+Vc*s[1]+fa*s[2]+qa*s[12]+ur*s[10]+el*s[4]+Ti*s[6]+W*s[3]+xl*s[5]+Os*s[7]+dn*s[8]+sd*s[11]+lo*s[9],ds=Ir*s[0]+Gc*s[1]+va*s[2]+ja*s[12]+dr*s[10]+$o*s[4]+Ei*s[6]+V*s[3]+Pl*s[5]+zs*s[7]+cn*s[8]+ld*s[11]+oo*s[9],ss=Lr*s[0]+Uc*s[1]+wa*s[2]+Wa*s[12]+cr*s[10]+Jo*s[4]+_i*s[6]+G*s[3]+Cl*s[5]+Is*s[7]+rn*s[8]+od*s[11]+io*s[9],console.log(ss,ds,gs),dc=zr*n[0]*Xn[0]+Vc*n[1]*ti[0]+fa*n[2]*Sn[0]+qa*n[12]+ur*n[10]+el*n[4]*Un[0]+Ti*n[6]*Pn[0]+W*n[3]*hn[0]+xl*n[5]*jn[0]+Os*n[7]*Yn[0]+dn*n[8]*On[0]+sd*n[11]+lo*n[9],
sc=Ir*i[0]*Xn[0]+Gc*i[1]*ti[0]+va*i[2]*Sn[0]+ja*i[12]+dr*i[10]+$o*i[4]*Un[0]+Ei*i[6]*Pn[0]+V*i[3]*hn[0]+Pl*i[5]*jn[0]+zs*i[7]*Yn[0]+cn*i[8]*On[0]+ld*i[11]+oo*i[9],ic=Lr*o[0]*Xn[0]+Uc*o[1]*ti[0]+wa*o[2]*Sn[0]+Wa*o[12]+cr*o[10]+Jo*o[4]*Un[0]+_i*o[6]*Pn[0]+G*o[3]*hn[0]+Cl*o[5]*jn[0]+Is*o[7]*Yn[0]+rn*o[8]*On[0]+od*o[11]+io*o[9],Ks=js*l[7]*vo[1]+vn*l[8]*Eo[1]+Fe*l[11]+We*l[9]+Ve*l[10],'cav'==Wo?(Jr=He*l[4]*bo[1]+Ke*l[6]*To[1]+Ks,tc=De*l[0]*fo[1]+Be*l[1]*ho[1]+Ue*l[2]*_o[1]+Qe*l[12]*ia,Qr=Ge*l[3]*Ao[1]+Ye*l[5]*wo[1]):'inf'==Wo?(tc=De*l[0]*fo[1]+Be*l[1]*ho[1]+Ue*l[2]*_o[1]+Qe*l[12]*ia+Ks,Jr=He*l[4]*bo[1]+Ke*l[6]*To[1],Qr=Ge*l[3]*Ao[1]+Ye*l[5]*wo[1]):'arc'==Wo?(tc=De*l[0]*fo[1]+Be*l[1]*ho[1]+Ue*l[2]*_o[1]+Qe*l[12]*ia,Jr=He*l[4]*bo[1]+Ke*l[6]*To[1],Qr=Ge*l[3]*Ao[1]+Ye*l[5]*wo[1]+Ks):(tc=De*l[0]*fo[1]+Be*l[1]*ho[1]+Ue*l[2]*_o[1]+Qe*l[12]*ia,Jr=He*l[4]*bo[1]+Ke*l[6]*To[1],Qr=Ge*l[3]*Ao[1]+Ye*l[5]*wo[1]),Jt=(qr=tc*Zt)+(Vr=Jr*Zt)+(Br=Qr*Zt),jt=(bc=dc*Vt+za)+(_c=sc*Vt+za)+(gc=ic*Vt+za),
console.log(Jt,jt),Go=0==qr||0==bc?0:bc<=qr?1:Math.pow(qr/bc,.5)/(bc/qr),Do=0==Vr||0==_c?0:_c<=Vr?1:Math.pow(Vr/_c,.5)/(_c/Vr),Co=0==Br||0==gc?0:gc<=Br?1:Math.pow(Br/gc,.5)/(gc/Br),Oo=0==qr||0==bc?0:qr<=bc?1:Math.pow(bc/qr,.5)/(qr/bc),Lo=0==Vr||0==_c?0:Vr<=_c?1:Math.pow(_c/Vr,.5)/(Vr/_c),yo=0==Br||0==gc?0:Br<=gc?1:Math.pow(gc/Br,.5)/(Br/gc),Ni=Math.round(1e6*Oo)/1e6,Mi=Math.round(1e6*Lo)/1e6,Oi=Math.round(1e6*yo)/1e6,xi=Math.round(1e6*Go)/1e6,Pi=Math.round(1e6*Do)/1e6,Ci=Math.round(1e6*Co)/1e6,Rr=Math.round(-zr*xi+1e-6)+Math.round(-Ir*Pi+1e-6)+Math.round(-Lr*Ci+1e-6),Pc=Math.round(-Vc*xi+1e-6)+Math.round(-Gc*Pi+1e-6)+Math.round(-Uc*Ci+1e-6),_a=Math.round(-fa*xi+1e-6)+Math.round(-va*Pi+1e-6)+Math.round(-wa*Ci+1e-6),x=Math.round(-W*xi+1e-6)+Math.round(-V*Pi+1e-6)+Math.round(-G*Ci+1e-6),Ko=Math.round(-el*xi+1e-6)+Math.round(-$o*Pi+1e-6)+Math.round(-Jo*Ci+1e-6),zl=Math.round(-xl*xi+1e-6)+Math.round(-Pl*Pi+1e-6)+Math.round(-Cl*Ci+1e-6),
pi=Math.round(-Ti*xi+1e-6)+Math.round(-Ei*Pi+1e-6)+Math.round(-_i*Ci+1e-6),ys=Math.round(-Os*xi+1e-6)+Math.round(-zs*Pi+1e-6)+Math.round(-Is*Ci+1e-6),nn=Math.round(-dn*xi+1e-6)+Math.round(-cn*Pi+1e-6)+Math.round(-rn*Ci+1e-6),td=Math.round(-sd*xi+1e-6)+Math.round(-ld*Pi+1e-6)+Math.round(-od*Ci+1e-6),Ba=Math.round(-qa*xi+1e-6)+Math.round(-ja*Pi+1e-6)+Math.round(-Wa*Ci+1e-6),eo=Math.round(-lo*xi+1e-6)+Math.round(-oo*Pi+1e-6)+Math.round(-io*Ci+1e-6),or=Math.round(-ur*xi+1e-6)+Math.round(-dr*Pi+1e-6)+Math.round(-cr*Ci+1e-6),br=Math.round(-De*Ni+1e-6),zc=Math.round(-Be*Ni+1e-6),ua=Math.round(-Ue*Ni+1e-6),Na=Math.round(-Qe*Ni+1e-6),O=Math.round(-Ge*Oi+1e-6),yl=Math.round(-Ye*Oi+1e-6),jo=Math.round(-He*Mi+1e-6),si=Math.round(-Ke*Mi+1e-6),'cav'==Wo?(ws=Math.round(-js*Mi+1e-6),Ja=Math.round(-vn*Mi+1e-6),Qc=Math.round(-Fe*Mi+1e-6),Qi=Math.round(-We*Mi+1e-6),er=Math.round(-Ve*Mi+1e-6)):'inf'==Wo?(ws=Math.round(-js*Ni+1e-6),Ja=Math.round(-vn*Ni+1e-6),Qc=Math.round(-Fe*Ni+1e-6),
Qi=Math.round(-We*Ni+1e-6),er=Math.round(-Ve*Ni+1e-6)):'arc'==Wo&&(ws=Math.round(-js*Oi+1e-6),Ja=Math.round(-vn*Oi+1e-6),Qc=Math.round(-Fe*Oi+1e-6),Qi=Math.round(-We*Oi+1e-6),er=Math.round(-Ve*Oi+1e-6)),fr=De+br,Nc=Be+zc,ma=Ue+ua,C=Ge+O,Ho=He+jo,Ll=Ye+yl,di=Ke+si,hs=js+ws,tn=vn+Ja,Jc=Fe+Qc,xa=Qe+Na,nr=Ve+er,Ji=We+Qi,Sr=F+Rr,Bc=H+Pc,ba=Y+_a,U=K+x,Xo=ee+Ko,Nl=te+zl,Ai=ae+pi,Ls=X+ys,sn=J+nn,id=$+td,Va=ne+Ba,rr=Q+or,no=Z+eo,cl=br*s[0]+zc*s[1]+ua*s[2]+O*s[3]+jo*s[4]+yl*s[5]+si*s[6]+ws*s[7]+Ja*s[8]+Qi*s[9]+er*s[10]+Qc*s[11]+Na*s[12],pl=Rr*s[0]+Pc*s[1]+_a*s[2]+x*s[3]+Ko*s[4]+zl*s[5]+pi*s[6]+ys*s[7]+nn*s[8]+eo*s[9]+or*s[10]+td*s[11]+Ba*s[12],console.log(cl,pl),Rc=fr*s[0]+Nc*s[1]+ma*s[2]+C*s[3]+Ho*s[4]+Ll*s[5]+di*s[6]+hs*s[7]+tn*s[8]+Jc*s[11]+xa*s[12]+nr*s[10]+Ji*s[9],Sc=Sr*s[0]+Bc*s[1]+ba*s[2]+U*s[3]+Xo*s[4]+Nl*s[5]+Ai*s[6]+Ls*s[7]+sn*s[8]+id*s[11]+Va*s[12]+rr*s[10]+no*s[9],console.log(Sc,Rc),da=0==Jt||0==jt?0:jt<=Jt?1:Math.pow(Jt/jt,.5/(jt/Jt)),console.log(da),
os=fr*s[0]+Nc*s[1]+ma*s[2]+C*s[3]+Ho*s[4]+Ll*s[5]+di*s[6]+hs*s[7]+tn*s[8]+Ji*s[9]+nr*s[10]+Jc*s[11]+xa*s[12],Es=Sr*s[0]+Bc*s[1]+ba*s[2]+U*s[3]+Xo*s[4]+Nl*s[5]+Ai*s[6]+Ls*s[7]+sn*s[8]+no*s[9]+rr*s[10]+id*s[11]+Va*s[12],console.log(os,Es),Hs=hs*s[7]+tn*s[8]+Jc*s[11]+Ji*s[9],'cav'==Wo?($l=Ho*s[4]+di*s[6]+Hs,as=fr*s[0]+Nc*s[1]+ma*s[2]+xa*s[12]+nr*s[10],Zl=C*s[3]+Ll*s[5]):'inf'==Wo?(as=fr*s[0]+Nc*s[1]+ma*s[2]+xa*s[12]+nr*s[10]+Hs,$l=Ho*s[4]+di*s[6],Zl=C*s[3]+Ll*s[5]):'arc'==Wo?(as=fr*s[0]+Nc*s[1]+ma*s[2]+xa*s[12]+nr*s[10],$l=Ho*s[4]+di*s[6],Zl=C*s[3]+Ll*s[5]+Hs):(as=fr*s[0]+Nc*s[1]+ma*s[2]+xa*s[12]+nr*s[10],$l=Ho*s[4]+di*s[6],Zl=C*s[3]+Ll*s[5]),wl=0==as?0:Math.round(as/os*1e4)/1e4,bl=0==$l?0:Math.round($l/os*1e4)/1e4,Tl=0==Zl?0:Math.round(Zl/os*1e4)/1e4,console.log(Tl),Cr=Math.round(Sr*wl),Nr=Math.round(Sr*bl),Mr=Sr-Nr-Cr,Fc=Math.round(Bc*wl),qc=Math.round(Bc*bl),jc=Bc-qc-Fc,ka=Math.round(ba*wl),ya=Math.round(ba*bl),Ra=ba-ya-ka,la=Math.round(U*wl),oa=Math.round(U*bl),q=U-oa-la,
il=Math.round(Xo*wl),nl=Math.round(Xo*bl),al=Xo-nl-il,Gl=Math.round(Nl*wl),Ul=Math.round(Nl*bl),Bl=Nl-Ul-Gl,fi=Math.round(Ai*wl),vi=Math.round(Ai*bl),wi=Ai-vi-fi,Ps=Math.round(Ls*wl),Cs=Math.round(Ls*bl),Ns=Ls-Cs-Ps,mn=Math.round(sn*wl),gn=Math.round(sn*bl),pn=sn-gn-mn,Ar=Math.round(rr*wl),mr=Math.round(rr*bl),gr=rr-mr-Ar,ud=Math.round(id*wl),dd=Math.round(id*bl),cd=id-dd-ud,Ka=Math.round(Va*wl),Ya=Math.round(Va*bl),Ha=Va-Ya-Ka,uo=Math.round(no*wl),co=Math.round(no*bl),ro=no-co-uo,ms=Cr*s[0]+Fc*s[1]+ka*s[2]+Ka*s[12]+Ar*s[10]+il*s[4]+fi*s[6]+la*s[3]+Gl*s[5]+Ps*s[7]+mn*s[8]+ud*s[11]+uo*s[9],us=Nr*s[0]+qc*s[1]+ya*s[2]+Ya*s[12]+mr*s[10]+nl*s[4]+vi*s[6]+oa*s[3]+Ul*s[5]+Cs*s[7]+gn*s[8]+dd*s[11]+co*s[9],rs=Mr*s[0]+jc*s[1]+Ra*s[2]+Ha*s[12]+gr*s[10]+al*s[4]+wi*s[6]+q*s[3]+Bl*s[5]+Ns*s[7]+pn*s[8]+cd*s[11]+ro*s[9],console.log(rs,us,ms),
uc=Cr*n[0]*Xn[0]+Fc*n[1]*ti[0]+ka*n[2]*Sn[0]+Ka*n[12]+Ar*n[10]+il*n[4]*Un[0]+fi*n[6]*Pn[0]+la*n[3]*hn[0]+Gl*n[5]*jn[0]+Ps*n[7]*Yn[0]+mn*n[8]*On[0]+ud*n[11]+uo*n[9],rc=Nr*i[0]*Xn[0]+qc*i[1]*ti[0]+ya*i[2]*Sn[0]+Ya*i[12]+mr*i[10]+nl*i[4]*Un[0]+vi*i[6]*Pn[0]+oa*i[3]*hn[0]+Ul*i[5]*jn[0]+Cs*i[7]*Yn[0]+gn*i[8]*On[0]+dd*i[11]+co*i[9],oc=Mr*o[0]*Xn[0]+jc*o[1]*ti[0]+Ra*o[2]*Sn[0]+Ha*o[12]+gr*o[10]+al*o[4]*Un[0]+wi*o[6]*Pn[0]+q*o[3]*hn[0]+Bl*o[5]*jn[0]+Ns*o[7]*Yn[0]+pn*o[8]*On[0]+cd*o[11]+ro*o[9],Qs=hs*l[7]*vo[1]+tn*l[8]*Eo[1]+Jc*l[11]+Ji*l[9],'cav'==Wo?($r=Ho*l[4]*bo[1]+di*l[6]*To[1]+Qs,ac=fr*l[0]*fo[1]+Nc*l[1]*ho[1]+ma*l[2]*_o[1]+xa*l[12]*ia+nr*l[10],Zr=C*l[3]*Ao[1]+Ll*l[5]*wo[1]):'inf'==Wo?(ac=fr*l[0]*fo[1]+Nc*l[1]*ho[1]+ma*l[2]*_o[1]+xa*l[12]*ia+nr*l[10]+Qs,$r=Ho*l[4]*bo[1]+di*l[6]*To[1],Zr=C*l[3]*Ao[1]+Ll*l[5]*wo[1]):'arc'==Wo?(ac=fr*l[0]*fo[1]+Nc*l[1]*ho[1]+ma*l[2]*_o[1]+xa*l[12]*ia+nr*l[10],$r=Ho*l[4]*bo[1]+di*l[6]*To[1],
Zr=C*l[3]*Ao[1]+Ll*l[5]*wo[1]+Qs):(ac=fr*l[0]*fo[1]+Nc*l[1]*ho[1]+ma*l[2]*_o[1]+xa*l[12]*ia+nr*l[10],$r=Ho*l[4]*bo[1]+di*l[6]*To[1],Zr=C*l[3]*Ao[1]+Ll*l[5]*wo[1]),Yr=(Fr=ac*Zt)+(Wr=$r*Zt)+(Ur=Zr*Zt),fc=(wc=uc*Vt)+(Ec=rc*Vt)+(mc=oc*Vt),console.log(Yr,fc),Vo=0==Fr||0==wc?0:wc<=Fr?1:Math.pow(Fr/wc,.5)/(wc/Fr),Bo=0==Wr||0==Ec?0:Ec<=Wr?1:Math.pow(Wr/Ec,.5)/(Ec/Wr),Po=0==Ur||0==mc?0:mc<=Ur?1:Math.pow(Ur/mc,.5)/(mc/Ur),Mo=0==Fr||0==wc?0:Fr<=wc?1:Math.pow(wc/Fr,.5)/(Fr/wc),Io=0==Wr||0==Ec?0:Wr<=Ec?1:Math.pow(Ec/Wr,.5)/(Wr/Ec),ko=0==Ur||0==mc?0:Ur<=mc?1:Math.pow(mc/Ur,.5)/(Ur/mc),Ui=Math.round(1e6*Mo)/1e6,Bi=Math.round(1e6*Io)/1e6,Di=Math.round(1e6*ko)/1e6,Wi=Math.round(1e6*Vo)/1e6,Vi=Math.round(1e6*Bo)/1e6,Gi=Math.round(1e6*Po)/1e6,yr=Math.round(-Cr*Wi+1e-6)+Math.round(-Nr*Vi+1e-6)+Math.round(-Mr*Gi+1e-6),xc=Math.round(-Fc*Wi+1e-6)+Math.round(-qc*Vi+1e-6)+Math.round(-jc*Gi+1e-6),Ea=Math.round(-ka*Wi+1e-6)+Math.round(-ya*Vi+1e-6)+Math.round(-Ra*Gi+1e-6),
D=Math.round(-la*Wi+1e-6)+Math.round(-oa*Vi+1e-6)+Math.round(-q*Gi+1e-6),Qo=Math.round(-il*Wi+1e-6)+Math.round(-nl*Vi+1e-6)+Math.round(-al*Gi+1e-6),Ol=Math.round(-Gl*Wi+1e-6)+Math.round(-Ul*Vi+1e-6)+Math.round(-Bl*Gi+1e-6),gi=Math.round(-fi*Wi+1e-6)+Math.round(-vi*Vi+1e-6)+Math.round(-wi*Gi+1e-6),ks=Math.round(-Ps*Wi+1e-6)+Math.round(-Cs*Vi+1e-6)+Math.round(-Ns*Gi+1e-6),on=Math.round(-mn*Wi+1e-6)+Math.round(-gn*Vi+1e-6)+Math.round(-pn*Gi+1e-6),ad=Math.round(-ud*Wi+1e-6)+Math.round(-dd*Vi+1e-6)+Math.round(-cd*Gi+1e-6),Ua=Math.round(-Ka*Wi+1e-6)+Math.round(-Ya*Vi+1e-6)+Math.round(-Ha*Gi+1e-6),to=Math.round(-uo*Wi+1e-6)+Math.round(-co*Vi+1e-6)+Math.round(-ro*Gi+1e-6),lr=Math.round(-Ar*Wi+1e-6)+Math.round(-mr*Vi+1e-6)+Math.round(-gr*Gi+1e-6),wr=Math.round(-fr*Ui+1e-6),Oc=Math.round(-Nc*Ui+1e-6),pa=Math.round(-ma*Ui+1e-6),Ca=Math.round(-xa*Ui+1e-6),M=Math.round(-C*Di+1e-6),kl=Math.round(-Ll*Di+1e-6),qo=Math.round(-Ho*Bi+1e-6),ri=Math.round(-di*Bi+1e-6),'cav'==Wo?(vs=Math.round(-hs*Bi+1e-6),
$a=Math.round(-tn*Bi+1e-6),Zc=Math.round(-Jc*Bi+1e-6),Zi=Math.round(-Ji*Bi+1e-6)):'inf'==Wo?(vs=Math.round(-hs*Ui+1e-6),$a=Math.round(-tn*Ui+1e-6),Zc=Math.round(-Jc*Ui+1e-6),Zi=Math.round(-Ji*Ui+1e-6)):'arc'==Wo&&(vs=Math.round(-hs*Di+1e-6),$a=Math.round(-tn*Di+1e-6),Zc=Math.round(-Jc*Di+1e-6),Zi=Math.round(-Ji*Di+1e-6)),tr=100*nr==as?0:Math.round(-nr*Ui+1e-6),hr=fr+wr,Cc=Nc+Oc,Aa=ma+pa,P=C+M,Yo=Ho+qo,Il=Ll+kl,ui=di+ri,Rs=hs+vs,an=tn+$a,$c=Jc+Zc,Da=xa+Ca,ir=nr+tr,$i=Ji+Zi,Or=Sr+yr,Wc=Bc+xc,ha=ba+Ea,j=U+D,tl=Xo+Qo,Dl=Nl+Ol,bi=Ai+gi,Ms=Ls+ks,un=sn+on,rd=id+ad,Fa=Va+Ua,pr=rr+lr,so=no+to,dl=wr*s[0]+Oc*s[1]+pa*s[2]+M*s[3]+qo*s[4]+kl*s[5]+ri*s[6]+vs*s[7]+$a*s[8]+Zi*s[9]+tr*s[10]+Zc*s[11]+Ca*s[12],gl=yr*s[0]+xc*s[1]+Ea*s[2]+D*s[3]+Qo*s[4]+Ol*s[5]+gi*s[6]+ks*s[7]+on*s[8]+to*s[9]+lr*s[10]+ad*s[11]+Ua*s[12],console.log(dl,gl),yc=hr*s[0]+Cc*s[1]+Aa*s[2]+P*s[3]+Yo*s[4]+Il*s[5]+ui*s[6]+Rs*s[7]+an*s[8]+$c*s[11]+Da*s[12]+ir*s[10]+$i*s[9],
Lc=Or*s[0]+Wc*s[1]+ha*s[2]+j*s[3]+tl*s[4]+Dl*s[5]+bi*s[6]+Ms*s[7]+un*s[8]+rd*s[11]+Fa*s[12]+pr*s[10]+so*s[9],console.log(Lc,yc),ls=hr*s[0]+Cc*s[1]+Aa*s[2]+P*s[3]+Yo*s[4]+Il*s[5]+ui*s[6]+Rs*s[7]+an*s[8]+$i*s[9]+ir*s[10]+$c*s[11]+Da*s[12],Ts=Or*s[0]+Wc*s[1]+ha*s[2]+j*s[3]+tl*s[4]+Dl*s[5]+bi*s[6]+Ms*s[7]+un*s[8]+so*s[9]+pr*s[10]+rd*s[11]+Fa*s[12],console.log(ls,Ts),qs=Rs*s[7]+an*s[8]+$c*s[11]+$i*s[9],'cav'==Wo?(es=Yo*s[4]+ui*s[6]+qs,ns=hr*s[0]+Cc*s[1]+Aa*s[2]+Da*s[12]+ir*s[10],Xl=P*s[3]+Il*s[5]):'inf'==Wo?(ns=hr*s[0]+Cc*s[1]+Aa*s[2]+Da*s[12]+ir*s[10]+qs,es=Yo*s[4]+ui*s[6],Xl=P*s[3]+Il*s[5]):'arc'==Wo?(ns=hr*s[0]+Cc*s[1]+Aa*s[2]+Da*s[12]+ir*s[10],es=Yo*s[4]+ui*s[6],Xl=P*s[3]+Il*s[5]+qs):(ns=hr*s[0]+Cc*s[1]+Aa*s[2]+Da*s[12]+ir*s[10],es=Yo*s[4]+ui*s[6],Xl=P*s[3]+Il*s[5]),hl=0==ns?0:Math.round(ns/ls*1e4)/1e4,fl=0==es?0:Math.round(es/ls*1e4)/1e4,vl=0==Xl?0:Math.round(Xl/ls*1e4)/1e4,console.log(vl),Dr=Math.round(Or*hl),xr=Math.round(Or*fl),Pr=Or-xr-Dr,Kc=Math.round(Wc*hl),Yc=Math.round(Wc*fl),
Hc=Wc-Yc-Kc,Ia=Math.round(ha*hl),La=Math.round(ha*fl),Sa=ha-La-Ia,ca=Math.round(j*hl),ra=Math.round(j*fl),sa=j-ra-ca,sl=Math.round(tl*hl),ll=Math.round(tl*fl),ol=tl-ll-sl,jl=Math.round(Dl*hl),Wl=Math.round(Dl*fl),Vl=Dl-Wl-jl,yi=Math.round(bi*hl),Ri=Math.round(bi*fl),hi=bi-Ri-yi,Bs=Math.round(Ms*hl),Ds=Math.round(Ms*fl),xs=Ms-Ds-Bs,En=Math.round(un*hl),_n=Math.round(un*fl),An=un-_n-En,Tr=Math.round(pr*hl),Er=Math.round(pr*fl),_r=pr-Er-Tr,md=Math.round(rd*hl),gd=Math.round(rd*fl),pd=rd-gd-md,Xa=Math.round(Fa*hl),Za=Math.round(Fa*fl),Qa=Fa-Za-Xa,mo=Math.round(so*hl),go=Math.round(so*fl),po=so-go-mo,As=Dr*s[0]+Kc*s[1]+Ia*s[2]+Xa*s[12]+Tr*s[10]+sl*s[4]+yi*s[6]+ca*s[3]+jl*s[5]+Bs*s[7]+En*s[8]+md*s[11]+mo*s[9],ps=xr*s[0]+Yc*s[1]+La*s[2]+Za*s[12]+Er*s[10]+ll*s[4]+Ri*s[6]+ra*s[3]+Wl*s[5]+Ds*s[7]+_n*s[8]+gd*s[11]+go*s[9],cs=Pr*s[0]+Hc*s[1]+Sa*s[2]+Qa*s[12]+_r*s[10]+ol*s[4]+hi*s[6]+sa*s[3]+Vl*s[5]+xs*s[7]+An*s[8]+pd*s[11]+po*s[9],console.log(cs,ps,As),
pc=Dr*n[0]*Xn[0]+Kc*n[1]*ti[0]+Ia*n[2]*Sn[0]+Xa*n[12]+Tr*n[10]+sl*n[4]*Un[0]+yi*n[6]*Pn[0]+ca*n[3]*hn[0]+jl*n[5]*jn[0]+Bs*n[7]*Yn[0]+En*n[8]*On[0]+md*n[11]+mo*n[9],cc=xr*i[0]*Xn[0]+Yc*i[1]*ti[0]+La*i[2]*Sn[0]+Za*i[12]+Er*i[10]+ll*i[4]*Un[0]+Ri*i[6]*Pn[0]+ra*i[3]*hn[0]+Wl*i[5]*jn[0]+Ds*i[7]*Yn[0]+_n*i[8]*On[0]+gd*i[11]+go*i[9],lc=Pr*o[0]*Xn[0]+Hc*o[1]*ti[0]+Sa*o[2]*Sn[0]+Qa*o[12]+_r*o[10]+ol*o[4]*Un[0]+hi*o[6]*Pn[0]+sa*o[3]*hn[0]+Vl*o[5]*jn[0]+xs*o[7]*Yn[0]+An*o[8]*On[0]+pd*o[11]+po*o[9],Ys=Rs*l[7]*vo[1]+an*l[8]*Eo[1]+$c*l[11]+$i*l[9],'cav'==Wo?(ec=Yo*l[4]*bo[1]+ui*l[6]*To[1]+Ys,nc=hr*l[0]*fo[1]+Cc*l[1]*ho[1]+Aa*l[2]*_o[1]+Da*l[12]*ia+ir*l[10],Xr=P*l[3]*Ao[1]+Il*l[5]*wo[1]):'inf'==Wo?(nc=hr*l[0]*fo[1]+Cc*l[1]*ho[1]+Aa*l[2]*_o[1]+Da*l[12]*ia+ir*l[10]+Ys,ec=Yo*l[4]*bo[1]+ui*l[6]*To[1],Xr=P*l[3]*Ao[1]+Il*l[5]*wo[1]):'arc'==Wo?(nc=hr*l[0]*fo[1]+Cc*l[1]*ho[1]+Aa*l[2]*_o[1]+Da*l[12]*ia+ir*l[10],ec=Yo*l[4]*bo[1]+ui*l[6]*To[1],
Xr=P*l[3]*Ao[1]+Il*l[5]*wo[1]+Ys):(nc=hr*l[0]*fo[1]+Cc*l[1]*ho[1]+Aa*l[2]*_o[1]+Da*l[12]*ia+ir*l[10],ec=Yo*l[4]*bo[1]+ui*l[6]*To[1],Xr=P*l[3]*Ao[1]+Il*l[5]*wo[1]),Kr=(Hr=nc*Zt)+(jr=ec*Zt)+(Gr=Xr*Zt),hc=(vc=pc*Vt)+(Tc=cc*Vt)+(Ac=lc*Vt),console.log(Kr,hc),Uo=0==Hr||0==vc?0:vc<=Hr?1:Math.pow(Hr/vc,.5)/(vc/Hr),xo=0==jr||0==Tc?0:Tc<=jr?1:Math.pow(jr/Tc,.5)/(Tc/jr),No=0==Gr||0==Ac?0:Ac<=Gr?1:Math.pow(Gr/Ac,.5)/(Ac/Gr),zo=0==Hr||0==vc?0:Hr<=vc?1:Math.pow(vc/Hr,.5)/(Hr/vc),So=0==jr||0==Tc?0:jr<=Tc?1:Math.pow(Tc/jr,.5)/(jr/Tc),Ro=0==Gr||0==Ac?0:Gr<=Ac?1:Math.pow(Ac/Gr,.5)/(Gr/Ac),Fi=Math.round(1e6*zo)/1e6,qi=Math.round(1e6*So)/1e6,ji=Math.round(1e6*Ro)/1e6,Ki=Math.round(1e6*Uo)/1e6,Yi=Math.round(1e6*xo)/1e6,Hi=Math.round(1e6*No)/1e6,kr=Math.round(-Dr*Ki+1e-6)+Math.round(-xr*Yi+1e-6)+Math.round(-Pr*Hi+1e-6),Dc=Math.round(-Kc*Ki+1e-6)+Math.round(-Yc*Yi+1e-6)+Math.round(-Hc*Hi+1e-6),Ta=Math.round(-Ia*Ki+1e-6)+Math.round(-La*Yi+1e-6)+Math.round(-Sa*Hi+1e-6),
B=Math.round(-ca*Ki+1e-6)+Math.round(-ra*Yi+1e-6)+Math.round(-sa*Hi+1e-6),Zo=Math.round(-sl*Ki+1e-6)+Math.round(-ll*Yi+1e-6)+Math.round(-ol*Hi+1e-6),Ml=Math.round(-jl*Ki+1e-6)+Math.round(-Wl*Yi+1e-6)+Math.round(-Vl*Hi+1e-6),mi=Math.round(-yi*Ki+1e-6)+Math.round(-Ri*Yi+1e-6)+Math.round(-hi*Hi+1e-6),Ss=Math.round(-Bs*Ki+1e-6)+Math.round(-Ds*Yi+1e-6)+Math.round(-xs*Hi+1e-6),ln=Math.round(-En*Ki+1e-6)+Math.round(-_n*Yi+1e-6)+Math.round(-An*Hi+1e-6),nd=Math.round(-md*Ki+1e-6)+Math.round(-gd*Yi+1e-6)+Math.round(-pd*Hi+1e-6),Ga=Math.round(-Xa*Ki+1e-6)+Math.round(-Za*Yi+1e-6)+Math.round(-Qa*Hi+1e-6),ao=Math.round(-mo*Ki+1e-6)+Math.round(-go*Yi+1e-6)+Math.round(-po*Hi+1e-6),sr=Math.round(-Tr*Ki+1e-6)+Math.round(-Er*Yi+1e-6)+Math.round(-_r*Hi+1e-6),vr=Math.round(-hr*Fi+1e-6),Mc=Math.round(-Cc*Fi+1e-6),ga=Math.round(-Aa*Fi+1e-6),Pa=Math.round(-Da*Fi+1e-6),N=Math.round(-P*ji+1e-6),Sl=Math.round(-Il*ji+1e-6),Fo=Math.round(-Yo*qi+1e-6),ci=Math.round(-ui*qi+1e-6),
'cav'==Wo?(fs=Math.round(-Rs*qi+1e-6),en=Math.round(-an*qi+1e-6),Xc=Math.round(-$c*qi+1e-6),Xi=Math.round(-$i*qi+1e-6)):'inf'==Wo?(fs=Math.round(-Rs*Fi+1e-6),en=Math.round(-an*Fi+1e-6),Xc=Math.round(-$c*Fi+1e-6),Xi=Math.round(-$i*Fi+1e-6)):'arc'==Wo&&(fs=Math.round(-Rs*ji+1e-6),en=Math.round(-an*ji+1e-6),Xc=Math.round(-$c*ji+1e-6),Xi=Math.round(-$i*ji+1e-6)),ar=100*ir==ns?0:Math.round(-ir*Fi+1e-6),ft=hr+vr,ht=Cc+Mc,Rt=Aa+ga,yt=P+N,Ot=Yo+Fo,Mt=Il+Sl,Nt=ui+ci,Lt=Rs+fs,It=an+en,zt=$c+Xc,Ct=Da+Pa,kt=ir+ar,St=$i+Xi,Re=Or+kr,ye=Wc+Dc,ke=ha+Ta,Se=j+B,Ne=tl+Zo,Ce=Dl+Ml,Pe=bi+mi,ze=Ms+Ss,Oe=un+ln,Me=rd+nd,xe=Fa+Ga,Le=pr+sr,Ie=so+ao,ul=vr*s[0]+Mc*s[1]+ga*s[2]+N*s[3]+Fo*s[4]+Sl*s[5]+ci*s[6]+fs*s[7]+en*s[8]+Xi*s[9]+ar*s[10]+Xc*s[11]+Pa*s[12],ml=kr*s[0]+Dc*s[1]+Ta*s[2]+B*s[3]+Zo*s[4]+Ml*s[5]+mi*s[6]+Ss*s[7]+ln*s[8]+ao*s[9]+sr*s[10]+nd*s[11]+Ga*s[12],console.log(ul,ml),kc=ft*s[0]+ht*s[1]+Rt*s[2]+yt*s[3]+Ot*s[4]+Mt*s[5]+Nt*s[6]+Lt*s[7]+It*s[8]+zt*s[11]+Ct*s[12]+kt*s[10]+St*s[9],
Ic=Re*s[0]+ye*s[1]+ke*s[2]+Se*s[3]+Ne*s[4]+Ce*s[5]+Pe*s[6]+ze*s[7]+Oe*s[8]+Me*s[11]+xe*s[12]+Le*s[10]+Ie*s[9],console.log(Ic,kc),Ze=-De+ft,Xe=-Be+ht,Je=-Ue+Rt,$e=-Ge+yt,ot=-He+Ot,lt=-Ye+Mt,st=-Ke+Nt,at=-je+Lt,nt=-qe+It,it=-Fe+zt,rt=-Qe+Ct,et=-Ve+kt,tt=-We+St,ie=-F+Re,oe=-H+ye,le=-Y+ke,se=-K+Se,ge=-ee+Ne,me=-te+Ce,Ae=-ae+Pe,de=-X+ze,ue=-J+Oe,pe=-$+Me,_e=-ne+xe,re=-Q+Le,ce=-Z+Ie,Ws=0==Lt?0:Lt*Zt*zi[1],Li=20==Bt?18:19==Bt?17:18==Bt?15:17==Bt?14:16==Bt?13:15==Bt?11:14==Bt?10:13==Bt||12==Bt?9:11==Bt?8:10==Bt?7:9==Bt||8==Bt?6:7==Bt||6==Bt?5:5==Bt||4==Bt||3==Bt?4:2==Bt||1==Bt?3:0,Us=0==Oa?0:2*Li,Gs=0==Ws||0==Us?0:-Ws/Us,li=Bt<=$s?Bt:Bt-$s<-Gs?Bt<$s?Bt:$s:Bt+Gs,Ut=Math.round(li),xt='wall'==b?Ut:h[t.BATTLE_TARGET_LEVEL],wn=0==It||0==xt?0:It*Zt*Eo[1],
ki='headquarter'==b?30==xt?72:29==xt?65:28==xt?59:27==xt?54:26==xt?50:25==xt?45:24==xt?41:23==xt?36:22==xt?33:21==xt?30:20==xt?27:19==xt?26:18==xt?23:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'wall'==b?20==Ut?18:19==Ut?17:18==Ut?15:17==Ut?14:16==Ut?13:15==Ut?11:14==Ut?10:13==Ut||12==Ut?9:11==Ut?8:10==Ut?7:9==Ut||8==Ut?6:7==Ut||6==Ut?5:5==Ut||4==Ut||3==Ut?4:2==Ut||1==Ut?3:0:'tavern'==b?15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'hospital'==b?10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'satue'==b?5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'rally_point'==b?5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'church'==b?3==xt||2==xt||1==xt?800:0:'academy'==b?1==xt?500:0:'preceptory'==b?10==xt?71:9==xt?43:8==xt?39:7==xt?35:6==xt?32:5==xt?29:4==xt?27:3==xt?24:2==xt?22:1==xt?20:0:'barracks'==b?25==xt?30:24==xt?27:23==xt?24:22==xt?22:21==xt?20:20==xt?18:19==xt?17:18==xt?15:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'market'==b?25==xt?30:24==xt?27:23==xt?24:22==xt?22:21==xt?20:20==xt?18:19==xt?17:18==xt?15:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'warehouse'==b?30==xt?48:29==xt?43:28==xt?39:27==xt?36:26==xt?33:25==xt?30:24==xt?27:23==xt?24:22==xt?22:21==xt?20:20==xt?18:19==xt?17:18==xt?15:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'timber_camp'==b?30==xt?48:29==xt?43:28==xt?39:27==xt?36:26==xt?33:25==xt?30:24==xt?27:23==xt?24:22==xt?22:21==xt?20:20==xt?18:19==xt?17:18==xt?15:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'clay_pit'==b?30==xt?48:29==xt?43:28==xt?39:27==xt?36:26==xt?33:25==xt?30:24==xt?27:23==xt?24:22==xt?22:21==xt?20:20==xt?18:19==xt?17:18==xt?15:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'iron_mine'==b?30==xt?48:29==xt?43:28==xt?39:27==xt?36:26==xt?33:25==xt?30:24==xt?27:23==xt?24:22==xt?22:21==xt?20:20==xt?18:19==xt?17:18==xt?15:17==xt?14:16==xt?13:15==xt?11:14==xt?10:13==xt||12==xt?9:11==xt?8:10==xt?7:9==xt||8==xt?6:7==xt||6==xt?5:5==xt||4==xt||3==xt?4:2==xt||1==xt?3:0:'farm'==b?30==xt?79:29==xt?72:28==xt?66:27==xt?60:26==xt?54:25==xt?49:24==xt?45:23==xt?41:22==xt?37:21==xt?34:20==xt?31:19==xt?28:18==xt?25:17==xt?23:16==xt?21:15==xt?19:14==xt?17:13==xt?16:12==xt?14:11==xt?13:10==xt?12:9==xt?11:8==xt?10:7==xt?9:6==xt?8:5==xt||4==xt?7:2==xt||3==xt?6:1==xt?5:0:0,
Tn=0==xt?0:ki*Vt,bn=0==wn||0==Tn?0:-wn/Tn,oi='wall'==b?li<=$s?li:li-$s<-bn?li<$s?li:$s:li+bn:bn+xt<=0?0:bn+xt,Dt=Math.round(oi),console.log(Dt),ea=Ze*s[0]+Xe*s[1]+Je*s[2]+$e*s[3]+ot*s[4]+lt*s[5]+st*s[6]+at*s[7]+nt*s[8]+tt*s[9]+et*s[10]+it*s[11]+rt*s[12],Ft=ie*s[0]+oe*s[1]+le*s[2]+se*s[3]+ge*s[4]+me*s[5]+Ae*s[6]+de*s[7]+ue*s[8]+ce*s[9]+re*s[10]+pe*s[11]+_e*s[12],$t=ie*a[0]+oe*a[1]+le*a[2]+se*a[3]+ge*a[4]+me*a[5]+Ae*a[6]+de*a[7]+ue*a[8]+ce*a[9]+re*a[10]+pe*a[11]+_e*a[12],qt=Ze*e[0]+Xe*e[1]+Je*e[2]+$e*e[3]+ot*e[4]+lt*e[5]+st*e[6]+at*e[7]+nt*e[8]+tt*e[9]+et*e[10]+it*e[11]+rt*e[12],console.log($t,qt),aa=0==Xt||0==ea?0:Math.round(-ea/Xt*1e3)/1e3,console.log(aa),fd=F+H+Y+ne>ee+ae&&F+H+Y+ne>K+te?'inf':ee+ae>F+H+Y+ne&&ee+ae>K+te?'cav':'arc',ta='inf'==Wo?'piechota':'cav'==Wo?'kawaleria':'łucznicy',console.log(ta),Ht='inf'==fd?'piechota':'cav'==fd?'kawaleria':'łucznicy',console.log(Ht),Yt=0==Wt||0==Ft?0:Math.round(-Ft/Wt*1e3)/1e3,console.log(Yt),ct=Math.round(Ze*(ql+Js)),
dt=Math.round(Xe*(ql+Js)),ut=Math.round(Je*(ql+Js)),pt=Math.round($e*(ql+Js)),Tt=Math.round(ot*(ql+Js)),bt=Math.round(lt*(ql+Js)),wt=Math.round(st*(ql+Js)),At=Math.round(at*(ql+Js)),_t=Math.round(nt*(ql+Js)),gt=Math.round(et*(ql+Js)),mt=Math.round(tt*(ql+Js)),Et=Math.round(it*(ql+Js)),vt=Math.round(rt*(ql+Js)),console.log(ct,dt,ut,pt,Tt,bt,wt,At,_t,gt,mt,Et,vt),Qt=Ii+Xs,0==Ii?(Ee=0,Te=0,be=0,we=0,ve=0,fe=0,he=0):Ii<1e3?Qt<=(se+ie+oe+le)/2?(Ee=Math.round(ie/2),Te=Math.round(oe/2),be=Math.round(le/2),we=Math.round(se/2),ve=0,fe=0,he=0):(Ee=Math.round(ie*Qt/(se+ie+oe+le)),Te=Math.round(oe*Qt/(se+ie+oe+le)),be=Math.round(le*Qt/(se+ie+oe+le)),we=Math.round(se*Qt/(se+ie+oe+le)),ve=0,fe=0,he=0):Qt<=(se+ie+oe+le+4*ge+5*me+6*Ae)/2?(Ee=Math.round(ie/2),Te=Math.round(oe/2),be=Math.round(le/2),we=Math.round(se/2),ve=Math.round(ge/2),fe=Math.round(me/2),he=Math.round(Ae/2)):(Ee=Math.round(ie*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae)),Te=Math.round(oe*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae)),
be=Math.round(le*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae)),we=Math.round(se*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae)),ve=Math.round(ge*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae)),fe=Math.round(me*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae)),he=Math.round(Ae*Qt/(se+ie+oe+le+4*ge+5*me+6*Ae))),console.log(Ee,Te,be,we,ve,fe,he),na=Xt+ea,Kt=Wt+Ft},qa.calculateT=function(){const e=h[t.TROOPS_SPEAR],a=h[t.TROOPS_SWORD],n=h[t.TROOPS_AXE],i=h[t.TROOPS_ARCHER],o=h[t.TROOPS_LC],l=h[t.TROOPS_MA],s=h[t.TROOPS_HC],r=h[t.TROOPS_RAM],c=h[t.TROOPS_CATAPULT],d=h[t.TROOPS_DOPPELSOLDNER],u=h[t.TROOPS_TREBUCHET],p=h[t.TROOPS_SNOB],g=h[t.TROOPS_KNIGHT],m=h[t.TROOPS_BARRACKS],A=h[t.TROOPS_PRECEPTORY],_=h[t.TROOPS_ORDER],E=h[t.TROOPS_TRAINING]
;var T=[50,30,60,80,125,250,200,300,320,0,4e4,4e3,1200],b=[30,30,30,30,100,100,150,200,400,0,5e4,2e3,1200],w=[20,70,40,60,250,150,600,200,100,0,5e4,2e3,2400],v=[1,1,1,1,4,5,6,5,8,1,100,10,6],f=[90,120,150,180,360,450,600,480,450,21600,10800,1200,1200],R=[10,25,45,25,130,150,150,2,100,150,30,30,300],y=[25,55,10,10,30,40,200,20,100,250,100,200,100],k=[45,5,5,30,40,30,160,50,50,400,50,250,100],S=[10,30,10,60,30,50,180,20,100,150,100,200,50],L=[8,9,14,18,24,35,50,0],I=[25,15,10,10,80,50,50,0,0,100,0,0,10],F=[0,33,66,99];let H=0,Y=1,K=1,Q=1,Z=1,X=1,J=1,$=1,ee=1,te=0;var ae,ne,ie,oe;K=m>=10&&m<20?1.05:m>=20&&m<25?1.15:m>=25?1.3:1,te='level_1'==E?1.04:'level_2'==E?1.08:'level_3'==E?1.12:'level_4'==E?1.16:'level_5'==E?1.2:1,Z=1==A?1.01:2==A?1.02:3==A?1.03:4==A?1.04:5==A?1.05:6==A?1.06:7==A?1.07:8==A?1.08:9==A?1.09:10==A?1.1:1,Q=h[t.TROOPS_DOMINATION]?1.1:1,
j=u>0?L[6]+' minut':p>0?L[5]+' minut':r>0||c>0?L[4]+' minuty':a>0?L[3]+' minut':e>0||n>0||i>0||d>0?L[2]+' minut':s>0?L[1]+' minut':o>0||l>0||g>0?L[0]+' minut':L[7]+' minut',W=m>=7&&m<14?F[1]:m>=14&&m<23?F[2]:m>=23?F[3]:F[0],J=Y/(Q*te),X=J/K,$=X/Z,ee=Y/Z,H='troops.teutonic'==_?$*(e*f[0]+a*f[1]+i*f[3]+s*f[6])+ee*(u*f[11])+X*(n*f[2]+o*f[4]+l*f[5]+r*f[7]+c*f[8])+d*f[12]+g*f[9]+p*f[10]:'troops.templars'==_?X*(e*f[0]+a*f[1]+i*f[3]+s*f[6])+u*f[11]+$*(n*f[2]+o*f[4]+l*f[5]+r*f[7]+c*f[8])+ee*(d*f[12])+g*f[9]+p*f[10]:X*(e*f[0]+a*f[1]+i*f[3]+s*f[6])+u*f[11]+X*(n*f[2]+o*f[4]+l*f[5]+r*f[7]+c*f[8])+d*f[12]+g*f[9]+p*f[10],z=e*T[0]+a*T[1]+n*T[2]+i*T[3]+o*T[4]+l*T[5]+s*T[6]+r*T[7]+c*T[8]+g*T[9]+p*T[10]+u*T[11]+d*T[12],O=e*b[0]+a*b[1]+n*b[2]+i*b[3]+o*b[4]+l*b[5]+s*b[6]+r*b[7]+c*b[8]+g*b[9]+p*b[10]+u*b[11]+d*b[12],M=e*w[0]+a*w[1]+n*w[2]+i*w[3]+o*w[4]+l*w[5]+s*w[6]+r*w[7]+c*w[8]+g*w[9]+p*w[10]+u*w[11]+d*w[12],N=e*v[0]+a*v[1]+n*v[2]+i*v[3]+o*v[4]+l*v[5]+s*v[6]+r*v[7]+c*v[8]+g*v[9]+p*v[10]+u*v[11]+d*v[12],
V=e*R[0]+a*R[1]+n*R[2]+i*R[3]+o*R[4]+l*R[5]+s*R[6]+r*R[7]+c*R[8]+g*R[9]+p*R[10]+u*R[11]+d*R[12],B=e*y[0]+a*y[1]+n*y[2]+i*y[3]+o*y[4]+l*y[5]+s*y[6]+r*y[7]+c*y[8]+g*y[9]+p*y[10]+u*y[11]+d*y[12],U=e*k[0]+a*k[1]+n*k[2]+i*k[3]+o*k[4]+l*k[5]+s*k[6]+r*k[7]+c*k[8]+g*k[9]+p*k[10]+u*k[11]+d*k[12],G=e*S[0]+a*S[1]+n*S[2]+i*S[3]+o*S[4]+l*S[5]+s*S[6]+r*S[7]+c*S[8]+g*S[9]+p*S[10]+u*S[11]+d*S[12],C=e*I[0]+a*I[1]+n*I[2]+i*I[3]+o*I[4]+l*I[5]+s*I[6]+r*I[7]+c*I[8]+g*I[9]+p*I[10]+u*I[11]+d*I[12],ae=H,ne='',ie=new Date(1e3*ae).toISOString().substr(11,8),(oe=Math.floor(ae/86400))>1?ne=oe+' dni i ':oe>0&&(ne='1 dzień i '),q=ne+=ie,P=e*R[0]+a*R[1]+n*R[2]+r*R[7]+c*R[8]+u*R[11]+d*R[12],x=o*R[4]+s*R[6]+g*R[9],D=i*R[3]+l*R[5]},qa.start=function(){y=!0,v.trigger(s.BATTLE_CALCULATOR_START)},qa.stop=function(){y=!1,v.trigger(s.BATTLE_CALCULATOR_STOP)},qa.getSettings=function(){return f},qa.isInitialized=function(){return R},qa.isRunning=function(){return y},qa.getBashpointsAtt=function(){return I},
qa.getBashpointsDef=function(){return L},qa.getWoodAmount=function(){return z},qa.getClayAmount=function(){return O},qa.getIronAmount=function(){return M},qa.getLoadAmount=function(){return C},qa.getFoodAmount=function(){return N},qa.getDefInf=function(){return B},qa.getDefCav=function(){return U},qa.getDefArc=function(){return G},qa.getAttInf=function(){return P},qa.getAttCav=function(){return x},qa.getAttArc=function(){return D},qa.getSpeed=function(){return j},qa.getBuildTime=function(){return q},qa.getDiscipline=function(){return W},qa.getPower=function(){return V},qa.getTarget=function(){return Pt},qa.getBuildingfrom=function(){return xt},qa.getBuildingto=function(){return Dt},qa.getWallfrom=function(){return Bt},qa.getWallto=function(){return Ut},qa.getWallfrompre=function(){return Gt},qa.getWalltopre=function(){return Bt},qa.getDefencemodifier=function(){return Vt},qa.getDefenceprovisions=function(){return Wt},qa.getStrentghdefend=function(){return jt},
qa.getDefencebashpoint=function(){return qt},qa.getDefencekilledprovisions=function(){return Ft},qa.getStrongesttypedef=function(){return Ht},qa.getKillrated=function(){return Yt},qa.getDefencesurvivedprovisions=function(){return Kt},qa.getAvailablebeds=function(){return Qt},qa.getAttackmodifier=function(){return Zt},qa.getAttackprovisions=function(){return Xt},qa.getStrentghattack=function(){return Jt},qa.getAttackbashpoint=function(){return $t},qa.getAttackkilledprovisions=function(){return ea},qa.getStrongesttypeoff=function(){return ta},qa.getKillratea=function(){return aa},qa.getAttacksurvivedprovisions=function(){return na},qa.getDoublestrength=function(){return ia},qa.getSpeardAmount=function(){return F},qa.getSpeardLosses=function(){return ie},qa.getSpeardRevived=function(){return Ee},qa.getSpeardSurvived=function(){return Re},qa.getSworddAmount=function(){return H},qa.getSworddLosses=function(){return oe},qa.getSworddRevived=function(){return Te},
qa.getSworddSurvived=function(){return ye},qa.getAxedAmount=function(){return Y},qa.getAxedLosses=function(){return le},qa.getAxedRevived=function(){return be},qa.getAxedSurvived=function(){return ke},qa.getArcherdAmount=function(){return K},qa.getArcherdLosses=function(){return se},qa.getArcherdRevived=function(){return we},qa.getArcherdSurvived=function(){return Se},qa.getSnobdAmount=function(){return Q},qa.getSnobdLosses=function(){return re},qa.getSnobdSurvived=function(){return Le},qa.getKnightdAmount=function(){return Z},qa.getKnightdLosses=function(){return ce},qa.getKnightdSurvived=function(){return Ie},qa.getRamdAmount=function(){return X},qa.getRamdLosses=function(){return de},qa.getRamdSurvived=function(){return ze},qa.getCatapultdAmount=function(){return J},qa.getCatapultdLosses=function(){return ue},qa.getCatapultdSurvived=function(){return Oe},qa.getTrebuchetdAmount=function(){return $},qa.getTrebuchetdLosses=function(){return pe},qa.getTrebuchetdSurvived=function(){
return Me},qa.getLcdAmount=function(){return ee},qa.getLcdLosses=function(){return ge},qa.getLcdRevived=function(){return ve},qa.getLcdSurvived=function(){return Ne},qa.getMadAmount=function(){return te},qa.getMadLosses=function(){return me},qa.getMadRevived=function(){return fe},qa.getMadSurvived=function(){return Ce},qa.getHcdAmount=function(){return ae},qa.getHcdLosses=function(){return Ae},qa.getHcdRevived=function(){return he},qa.getHcdSurvived=function(){return Pe},qa.getBerserkerdAmount=function(){return ne},qa.getBerserkerdLosses=function(){return _e},qa.getBerserkerdSurvived=function(){return xe},qa.getSpearaAmount=function(){return De},qa.getSpearaLosses=function(){return Ze},qa.getSpearaRevived=function(){return ct},qa.getSpearaSurvived=function(){return ft},qa.getSwordaAmount=function(){return Be},qa.getSwordaLosses=function(){return Xe},qa.getSwordaRevived=function(){return dt},qa.getSwordaSurvived=function(){return ht},qa.getAxeaAmount=function(){return Ue},
qa.getAxeaLosses=function(){return Je},qa.getAxeaRevived=function(){return ut},qa.getAxeaSurvived=function(){return Rt},qa.getArcheraAmount=function(){return Ge},qa.getArcheraLosses=function(){return $e},qa.getArcheraRevived=function(){return pt},qa.getArcheraSurvived=function(){return yt},qa.getSnobaAmount=function(){return Ve},qa.getSnobaLosses=function(){return et},qa.getSnobaRevived=function(){return gt},qa.getSnobaSurvived=function(){return kt},qa.getKnightaAmount=function(){return We},qa.getKnightaLosses=function(){return tt},qa.getKnightaRevived=function(){return mt},qa.getKnightaSurvived=function(){return St},qa.getRamaAmount=function(){return je},qa.getRamaLosses=function(){return at},qa.getRamaRevived=function(){return At},qa.getRamaSurvived=function(){return Lt},qa.getCatapultaAmount=function(){return qe},qa.getCatapultaLosses=function(){return nt},qa.getCatapultaRevived=function(){return _t},qa.getCatapultaSurvived=function(){return It},qa.getTrebuchetaAmount=function(){
return Fe},qa.getTrebuchetaLosses=function(){return it},qa.getTrebuchetaRevived=function(){return Et},qa.getTrebuchetaSurvived=function(){return zt},qa.getLcaAmount=function(){return He},qa.getLcaLosses=function(){return ot},qa.getLcaRevived=function(){return Tt},qa.getLcaSurvived=function(){return Ot},qa.getMaaAmount=function(){return Ye},qa.getMaaLosses=function(){return lt},qa.getMaaRevived=function(){return bt},qa.getMaaSurvived=function(){return Mt},qa.getHcaAmount=function(){return Ke},qa.getHcaLosses=function(){return st},qa.getHcaRevived=function(){return wt},qa.getHcaSurvived=function(){return Nt},qa.getBerserkeraAmount=function(){return Qe},qa.getBerserkeraLosses=function(){return rt},qa.getBerserkeraRevived=function(){return vt},qa.getBerserkeraSurvived=function(){return Ct},qa.getPresetBerserker=function(){return Ea},qa.getPresetAxe=function(){return sa},qa.getPresetArcher=function(){return ra},qa.getPresetSnob=function(){return ma},qa.getPresetKnight=function(){return Aa},
qa.getPresetHc=function(){return ua},qa.getPresetLc=function(){return ca},qa.getPresetMa=function(){return da},qa.getPresetRam=function(){return pa},qa.getPresetCatapult=function(){return ga},qa.getPresetSpear=function(){return oa},qa.getPresetSword=function(){return la},qa.getPresetTrebuchet=function(){return _a},qa.getVillageBerserker=function(){return va},qa.getVillageAxe=function(){return ba},qa.getVillageArcher=function(){return Ta},qa.getVillageSnob=function(){return Sa},qa.getVillageKnight=function(){return ha},qa.getVillageHc=function(){return fa},qa.getVillageLc=function(){return Ra},qa.getVillageMa=function(){return ya},qa.getVillageRam=function(){return ka},qa.getVillageCatapult=function(){return wa},qa.getVillageSpear=function(){return La},qa.getVillageSword=function(){return Ia},qa.getVillageTrebuchet=function(){return za},qa})),define('two/battleCalculator/events',[],(function(){angular.extend(s,{BATTLE_CALCULATOR_START:'battle_calculator_start',
BATTLE_CALCULATOR_STOP:'battle_calculator_stop'})})),define('two/battleCalculator/ui',['two/ui','two/battleCalculator','two/battleCalculator/settings','two/battleCalculator/settings/map','two/battleCalculator/types/item','two/battleCalculator/types/level','two/battleCalculator/types/catapult-target','two/battleCalculator/types/order','two/battleCalculator/types/wall','two/battleCalculator/types/church','two/battleCalculator/types/weapon-master','two/battleCalculator/types/iron-walls','two/battleCalculator/types/clinique','two/battleCalculator/types/hospital','two/battleCalculator/types/training','two/Settings','two/EventScope','struct/MapData','two/utils'],(function(e,t,n,o,l,r,d,u,p,m,A,_,E,T,b,w,v,f,h){let R,y,k,S,L=i.getPresetList(),I=!1;const z={BATTLE:'battle',TROOPS:'troops',BASHPOINTS:'bashpoints'},O=function(e,t){I=t.data},M=function(){I=!1},N=function(e){R.selectedTab=e},C=function(){t.isRunning()?t.stop():t.start()},P=function(){
if(!I)return h.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'battle_calculator'));f.loadTownDataAsync(I.x,I.y,1,1,(function(e){S.origin=e})),R.settings[n.BATTLE_VILLAGE_ID]=I.id},x=function(){R.spearDsurvived>0||R.swordDsurvived>0||R.axeDsurvived>0||R.archerDsurvived>0||R.lcDsurvived>0||R.maDsurvived>0||R.hcDsurvived>0||R.ramDsurvived>0||R.catapultDsurvived>0||R.snobDsurvived>0||R.knightDsurvived>0||R.trebuchetDsurvived>0||R.berserkerDsurvived>0?(R.settings[n.BATTLE_SPEAR_D]=t.getSpeardSurvived(),R.settings[n.BATTLE_SWORD_D]=t.getSworddSurvived(),R.settings[n.BATTLE_AXE_D]=t.getAxedSurvived(),R.settings[n.BATTLE_ARCHER_D]=t.getArcherdSurvived(),R.settings[n.BATTLE_RAM_D]=t.getRamdSurvived(),R.settings[n.BATTLE_CATAPULT_D]=t.getCatapultdSurvived(),R.settings[n.BATTLE_SNOB_D]=t.getSnobdSurvived(),R.settings[n.BATTLE_KNIGHT_D]=t.getKnightdSurvived(),R.settings[n.BATTLE_TREBUCHET_D]=t.getTrebuchetdSurvived(),
R.settings[n.BATTLE_DOPPELSOLDNER_D]=t.getBerserkerdSurvived(),R.settings[n.BATTLE_LC_D]=t.getLcdSurvived(),R.settings[n.BATTLE_MA_D]=t.getMadSurvived(),R.settings[n.BATTLE_HC_D]=t.getHcdSurvived(),y.setAll(y.decode(R.settings))):R.spearAsurvived>0||R.swordAsurvived>0||R.axeAsurvived>0||R.archerAsurvived>0||R.lcAsurvived>0||R.maAsurvived>0||R.hcAsurvived>0||R.ramAsurvived>0||R.catapultAsurvived>0||R.snobAsurvived>0||R.knightAsurvived>0||R.trebuchetAsurvived>0||R.berserkerAsurvived>0?(R.settings[n.BATTLE_SPEAR_A]=t.getSpearaSurvived(),R.settings[n.BATTLE_SWORD_A]=t.getSwordaSurvived(),R.settings[n.BATTLE_AXE_A]=t.getAxeaSurvived(),R.settings[n.BATTLE_ARCHER_A]=t.getArcheraSurvived(),R.settings[n.BATTLE_RAM_A]=t.getRamaSurvived(),R.settings[n.BATTLE_CATAPULT_A]=t.getCatapultaSurvived(),R.settings[n.BATTLE_SNOB_A]=t.getSnobaSurvived(),R.settings[n.BATTLE_KNIGHT_A]=t.getKnightaSurvived(),R.settings[n.BATTLE_TREBUCHET_A]=t.getTrebuchetaSurvived(),
R.settings[n.BATTLE_DOPPELSOLDNER_A]=t.getBerserkeraSurvived(),R.settings[n.BATTLE_LC_A]=t.getLcaSurvived(),R.settings[n.BATTLE_MA_A]=t.getMaaSurvived(),R.settings[n.BATTLE_HC_A]=t.getHcaSurvived(),y.setAll(y.decode(R.settings))):(R.settings[n.BATTLE_SPEAR_A]=0,R.settings[n.BATTLE_SWORD_A]=0,R.settings[n.BATTLE_AXE_A]=0,R.settings[n.BATTLE_ARCHER_A]=0,R.settings[n.BATTLE_RAM_A]=0,R.settings[n.BATTLE_CATAPULT_A]=0,R.settings[n.BATTLE_SNOB_A]=0,R.settings[n.BATTLE_KNIGHT_A]=0,R.settings[n.BATTLE_TREBUCHET_A]=0,R.settings[n.BATTLE_DOPPELSOLDNER_A]=0,R.settings[n.BATTLE_LC_A]=0,R.settings[n.BATTLE_MA_A]=0,R.settings[n.BATTLE_HC_A]=0,R.settings[n.BATTLE_SPEAR_D]=0,R.settings[n.BATTLE_SWORD_D]=0,R.settings[n.BATTLE_AXE_D]=0,R.settings[n.BATTLE_ARCHER_D]=0,R.settings[n.BATTLE_RAM_D]=0,R.settings[n.BATTLE_CATAPULT_D]=0,R.settings[n.BATTLE_SNOB_D]=0,R.settings[n.BATTLE_KNIGHT_D]=0,R.settings[n.BATTLE_TREBUCHET_D]=0,R.settings[n.BATTLE_DOPPELSOLDNER_D]=0,R.settings[n.BATTLE_LC_D]=0,
R.settings[n.BATTLE_MA_D]=0,R.settings[n.BATTLE_HC_D]=0,y.setAll(y.decode(R.settings)))},D=function(){t.getPresetUnits(),R.settings[n.BATTLE_SPEAR_A]=t.getPresetSpear(),R.settings[n.BATTLE_SWORD_A]=t.getPresetSword(),R.settings[n.BATTLE_AXE_A]=t.getPresetAxe(),R.settings[n.BATTLE_ARCHER_A]=t.getPresetArcher(),R.settings[n.BATTLE_RAM_A]=t.getPresetRam(),R.settings[n.BATTLE_CATAPULT_A]=t.getPresetCatapult(),R.settings[n.BATTLE_SNOB_A]=t.getPresetSnob(),R.settings[n.BATTLE_KNIGHT_A]=t.getPresetKnight(),R.settings[n.BATTLE_TREBUCHET_A]=t.getPresetTrebuchet(),R.settings[n.BATTLE_DOPPELSOLDNER_A]=t.getPresetBerserker(),R.settings[n.BATTLE_LC_A]=t.getPresetLc(),R.settings[n.BATTLE_MA_A]=t.getPresetMa(),R.settings[n.BATTLE_HC_A]=t.getPresetHc(),y.setAll(y.decode(R.settings))},B=function(){t.getPresetUnits(),y.setAll(y.decode(R.settings)),R.settings[n.BATTLE_SPEAR_D]=t.getPresetSpear(),R.settings[n.BATTLE_SWORD_D]=t.getPresetSword(),R.settings[n.BATTLE_AXE_D]=t.getPresetAxe(),
R.settings[n.BATTLE_ARCHER_D]=t.getPresetArcher(),R.settings[n.BATTLE_RAM_D]=t.getPresetRam(),R.settings[n.BATTLE_CATAPULT_D]=t.getPresetCatapult(),R.settings[n.BATTLE_SNOB_D]=t.getPresetSnob(),R.settings[n.BATTLE_KNIGHT_D]=t.getPresetKnight(),R.settings[n.BATTLE_TREBUCHET_D]=t.getPresetTrebuchet(),R.settings[n.BATTLE_DOPPELSOLDNER_D]=t.getPresetBerserker(),R.settings[n.BATTLE_LC_D]=t.getPresetLc(),R.settings[n.BATTLE_MA_D]=t.getPresetMa(),R.settings[n.BATTLE_HC_D]=t.getPresetHc(),y.setAll(y.decode(R.settings))},U=function(){t.getVillageUnits(),y.setAll(y.decode(R.settings));let e=t.getVillageSpear(),a=t.getVillageSword(),i=t.getVillageAxe(),o=t.getVillageArcher(),l=t.getVillageRam(),s=t.getVillageCatapult(),r=t.getVillageSnob(),c=t.getVillageKnight(),d=t.getVillageTrebuchet(),u=t.getVillageBerserker(),p=t.getVillageLc(),g=t.getVillageMa(),m=t.getVillageHc();R.settings[n.BATTLE_SPEAR_A]=e,R.settings[n.BATTLE_SWORD_A]=a,R.settings[n.BATTLE_AXE_A]=i,R.settings[n.BATTLE_ARCHER_A]=o,
R.settings[n.BATTLE_RAM_A]=l,R.settings[n.BATTLE_CATAPULT_A]=s,R.settings[n.BATTLE_SNOB_A]=r,R.settings[n.BATTLE_KNIGHT_A]=c,R.settings[n.BATTLE_TREBUCHET_A]=d,R.settings[n.BATTLE_DOPPELSOLDNER_A]=u,R.settings[n.BATTLE_LC_A]=p,R.settings[n.BATTLE_MA_A]=g,R.settings[n.BATTLE_HC_A]=m,y.setAll(y.decode(R.settings))},G=function(){t.getVillageUnits(),y.setAll(y.decode(R.settings));let e=t.getVillageSpear(),a=t.getVillageSword(),i=t.getVillageAxe(),o=t.getVillageArcher(),l=t.getVillageRam(),s=t.getVillageCatapult(),r=t.getVillageSnob(),c=t.getVillageKnight(),d=t.getVillageTrebuchet(),u=t.getVillageBerserker(),p=t.getVillageLc(),g=t.getVillageMa(),m=t.getVillageHc();R.settings[n.BATTLE_SPEAR_D]=e,R.settings[n.BATTLE_SWORD_D]=a,R.settings[n.BATTLE_AXE_D]=i,R.settings[n.BATTLE_ARCHER_D]=o,R.settings[n.BATTLE_RAM_D]=l,R.settings[n.BATTLE_CATAPULT_D]=s,R.settings[n.BATTLE_SNOB_D]=r,R.settings[n.BATTLE_KNIGHT_D]=c,R.settings[n.BATTLE_TREBUCHET_D]=d,R.settings[n.BATTLE_DOPPELSOLDNER_D]=u,
R.settings[n.BATTLE_LC_D]=p,R.settings[n.BATTLE_MA_D]=g,R.settings[n.BATTLE_HC_D]=m,y.setAll(y.decode(R.settings))},V=function(){y.setAll(y.decode(R.settings)),t.calculateB();let e=t.getBashpointsAtt(),a=t.getBashpointsDef();e&&(R.totalAtt=a),a&&(R.totalDef=e)},W=function(){R.totalAtt=0,R.totalDef=0,R.settings[n.BASHPOINTS_SPEAR]=0,R.settings[n.BASHPOINTS_SWORD]=0,R.settings[n.BASHPOINTS_AXE]=0,R.settings[n.BASHPOINTS_ARCHER]=0,R.settings[n.BASHPOINTS_RAM]=0,R.settings[n.BASHPOINTS_CATAPULT]=0,R.settings[n.BASHPOINTS_SNOB]=0,R.settings[n.BASHPOINTS_KNIGHT]=0,R.settings[n.BASHPOINTS_TREBUCHET]=0,R.settings[n.BASHPOINTS_DOPPELSOLDNER]=0,R.settings[n.BASHPOINTS_LC]=0,R.settings[n.BASHPOINTS_MA]=0,R.settings[n.BASHPOINTS_HC]=0,y.setAll(y.decode(R.settings))},j=function(){R.spearDamount=0,R.spearDlosses=0,R.spearDrevived=0,R.spearDsurvived=0,R.swordDamount=0,R.swordDlosses=0,R.swordDrevived=0,R.swordDsurvived=0,R.axeDamount=0,R.axeDlosses=0,R.axeDrevived=0,R.axeDsurvived=0,
...
R.archerAlosses=0,R.archerArevived=0,R.archerAsurvived=0,R.snobAamount=0,R.snobAlosses=0,R.snobArevived=0,R.snobAsurvived=0,R.knightAamount=0,R.knightAlosses=0,R.knightArevived=0,R.knightAsurvived=0,R.ramAamount=0,R.ramAlosses=0,R.ramArevived=0,R.ramAsurvived=0,R.catapultAamount=0,R.catapultAlosses=0,R.catapultArevived=0,R.catapultAsurvived=0,R.trebuchetAamount=0,R.trebuchetAlosses=0,R.trebuchetArevived=0,R.trebuchetAsurvived=0,R.lcAamount=0,R.lcAlosses=0,R.lcArevived=0,R.lcAsurvived=0,R.maAamount=0,R.maAlosses=0,R.maArevived=0,R.maAsurvived=0,R.hcAamount=0,R.hcAlosses=0,R.hcArevived=0,R.hcAsurvived=0,R.berserkerAamount=0,R.berserkerAlosses=0,R.berserkerArevived=0,R.berserkerAsurvived=0,R.switchState=C,R.addMapSelected=P;let e=new v('twoverflow_battle_calculator_window',(function(){console.log('battleCalculator window closed')}));e.register(s.SELECT_SELECTED,Y.autoCompleteSelected,!0),e.register(s.ARMY_PRESET_UPDATE,Y.updatePresets,!0),
e.register(s.ARMY_PRESET_DELETED,Y.updatePresets,!0),e.register(s.BATTLE_CALCULATOR_START,Y.start),e.register(s.BATTLE_CALCULATOR_STOP,Y.stop),c.getScreenWithInjectedScope('!twoverflow_battle_calculator_window',R)};return function(){y=t.getSettings(),S={origin:!1},k=e.addMenuButton4('Kalkulator',10,g('i18n')('description',a.loc.ale,'battle_calculator')),k.addEventListener('click',K),a.$on(s.SHOW_CONTEXT_MENU,O),a.$on(s.DESTROY_CONTEXT_MENU,M),
...
define('two/builderQueue',['two/ready','two/utils','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/settings/updates','two/builderQueue/sequenceStatus','conf/upgradeabilityStates','conf/buildingTypes','conf/locationTypes','queues/EventQueue','Lockr','helper/time'],(function(e,t,n,r,c,d,p,g,m,A,_,E,T){let b,w,v,f=injector.get('buildingService'),h=injector.get('premiumActionService'),R=injector.get('buildingQueueService'),y=!1,k=!1;const S={};let L,I,z,O,M,N=!0;const C='builder_queue_log',P='builder_queue_settings',x=function(){const e=B();if(!N)return F.stop(),!1;e.forEach((function(e){const t=I.getVillage(e),a=t.checkReadyState(),n=t.buildingQueue;return n.getAmountJobs()!==n.getUnlockedSlots()&&(!(!a.buildingQueue||!a.buildings)&&void U(t))}))},D=function(){B().forEach((function(e){const t=I.getVillage(e),a=t.buildingQueue;if(a.getAmountJobs()){a.getQueue().forEach((function(a){
R.canBeFinishedForFree(a,t)&&h.instantBuild(a,A.MASS_SCREEN,!0,e)}))}}))},B=function(){const e=M[r.GROUP_VILLAGES];let a=[];return e?(a=L.getGroupVillageIds(e),a=a.filter((function(e){return I.getVillage(e)}))):t.each(I.getVillages(),(function(e){a.push(e.getId())})),a},U=function(e){let t=angular.copy(e.buildingData.getBuildingLevels());const a=e.buildingQueue.getQueue();let n=angular.copy(S);const i=M[r.BUILDING_SEQUENCES][M[r.ACTIVE_SEQUENCE]];if(a.forEach((function(e){t[e.building]++})),j(t))return!1;i.some((function(a){if(++n[a]>t[a])return f.compute(e),G(e,a,(function(t,a){t&&a.job&&(_.trigger(s.BUILDER_QUEUE_JOB_STARTED,a.job),q(e.getId(),a.job))})),!0}))},G=function(e,t,a){const n=W(e,t);if(n===g.POSSIBLE)V(e,t,(function(e){a(!0,e)}));else if(n===g.NOT_ENOUGH_FOOD&&M[r.PRIORIZE_FARM]){const t=v[m.FARM];e.getBuildingData().getDataForBuilding(m.FARM).level<t&&V(e,m.FARM,(function(e){a(!0,e)}))}a(!1)},V=function(e,t,a){o.emit(l.VILLAGE_UPGRADE_BUILDING,{building:t,
village_id:e.getId(),location:A.MASS_SCREEN,premium:!1},a)},W=function(e,t){const a=e.getBuildingData().getDataForBuilding(t);if(a.upgradeability===g.POSSIBLE){const t=a.nextLevelCosts,n=e.getResources().getComputed();if(n.clay.currentStock-M[r.PRESERVE_CLAY]<t.clay||n.iron.currentStock-M[r.PRESERVE_IRON]<t.iron||n.wood.currentStock-M[r.PRESERVE_WOOD]<t.wood)return g.NOT_ENOUGH_RESOURCES}return a.upgradeability},j=function(e){for(let t in e)if(e[t]<v[t])return!1;return!0},q=function(e,t){let a={time:T.gameTime(),villageId:e,building:t.building,level:t.level};return z.unshift(a),z.length>500&&z.splice(z.length-500,z.length),E.set(C,z),!0};let F={};return F.start=function(){if(!N)return _.trigger(s.BUILDER_QUEUE_NO_SEQUENCES),!1;k=!0,b=setInterval(x,6e4),w=setInterval(D,6e3),e((function(){B().forEach((function(e){const t=I.getVillage(e);t.isInitialized()||u.initializeVillage(t)})),x(),D()}),['all_villages_ready']),_.trigger(s.BUILDER_QUEUE_START)},F.stop=function(){k=!1,clearInterval(b),
clearInterval(w),_.trigger(s.BUILDER_QUEUE_STOP)},F.isRunning=function(){return k},F.isInitialized=function(){return y},F.getSettings=function(){return O},F.getLogs=function(){return z},F.clearLogs=function(){z=[],E.set(C,z),_.trigger(s.BUILDER_QUEUE_CLEAR_LOGS)},F.addBuildingSequence=function(e,t){let a=M[r.BUILDING_SEQUENCES];return e in a?p.SEQUENCE_EXISTS:Array.isArray(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID},F.updateBuildingSequence=function(e,t){let a=M[r.BUILDING_SEQUENCES];return e in a?Array.isArray(t)&&function(e){const t=i.getGameData().getBuildings();for(let a=0;a<e.length;a++){let n=e[a];if(++e[n]>t[n].max_level)return!1}return!0}(t)?(a[e]=t,O.set(r.BUILDING_SEQUENCES,a,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,e),p.SEQUENCE_SAVED):p.SEQUENCE_INVALID:p.SEQUENCE_NO_EXISTS},F.removeSequence=function(e){let t=M[r.BUILDING_SEQUENCES]
;if(!(e in t))return p.SEQUENCE_NO_EXISTS;delete t[e],O.set(r.BUILDING_SEQUENCES,t,{quiet:!0}),_.trigger(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,e)},F.init=function(){y=!0,z=E.get(C,[],!0),I=i.getSelectedCharacter(),L=i.getGroupList(),O=new n({settingsMap:c,storageKey:P}),O.onChange((function(e,t,a){M=O.getAll(),k&&t[d.ANALYSE]&&x(),a.quiet||_.trigger(s.BUILDER_QUEUE_SETTINGS_CHANGE)})),M=O.getAll();for(let e in m)S[m[e]]=0;N=Object.keys(M[r.BUILDING_SEQUENCES]).length,v=!!N&&function(e){const t=M[r.BUILDING_SEQUENCES][e];let a=angular.copy(S);return t.forEach((function(e){a[e]++})),a}(M[r.ACTIVE_SEQUENCE]),a.$on(s.BUILDING_LEVEL_CHANGED,(function(e,t){if(!k)return!1;setTimeout((function(){let e=I.getVillage(t.village_id);U(e)}),1e3)}))},F})),define('two/builderQueue/defaultOrders',['conf/buildingTypes'],(function(e){let t={};const a=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a];Array.isArray(n)?(n.sort(()=>Math.random()-.5),t=t.concat(n)):t.push(n)}return t}
...
define('two/builderQueue/ui',['two/ui','two/builderQueue','two/utils','two/ready','two/Settings','two/builderQueue/settings','two/builderQueue/settings/map','two/builderQueue/sequenceStatus','conf/buildingTypes','two/EventScope','queues/EventQueue','helper/time'],(function(e,t,n,d,u,p,A,_,T,b,w,v){let f,h,R,y,k=i.getGroupList(),S={},L=!1,I={sequencesAvail:!0,modal:{}},z={sequencesAvail:!0},O={};const M={SETTINGS:'settings',SEQUENCES:'sequences',LOGS:'logs'};let N,C={},P={},x=!1,D=!1;const B=function(e,t,a){return a?parseInt(Math.round(e*Math.pow(t,a-1)),10):0},U=function(e,t,a){if(a>=e.length){let t=a-e.length+1;for(;t--;)e.push(void 0)}e.splice(a,0,e.splice(t,1)[0])},G=function(e,i){switch(t.addBuildingSequence(e,i)){case _.SEQUENCE_SAVED:return!0;case _.SEQUENCE_EXISTS:return n.notif('error',g('i18n')('error_sequence_exists',a.loc.ale,'builder_queue')),!1;case _.SEQUENCE_INVALID:return n.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue')),!1}}
;z.generateSequences=function(){const e=y.get(p.BUILDING_SEQUENCES),t=Object.keys(e).length;if(z.sequencesAvail=t,!t)return!1;z.generateBuildingSequence(),z.generateBuildingSequenceFinal(),z.updateVisibleBuildingSequence()},z.generateBuildingSequence=function(){const e=f.settings[p.ACTIVE_SEQUENCE].value,t=f.settings[p.BUILDING_SEQUENCES][e],a=i.getGameData().getBuildings();let n={};if(z.sequencesAvail=!!t,!z.sequencesAvail)return!1;for(let e in T)n[T[e]]=0;z.buildingSequence=t.map((function(e){let t=++n[e],o=a[e].individual_level_costs[t],l='not-reached';return!function(e,t){return i.getSelectedVillage().getBuildingData().getBuildingLevel(e)>=t}(e,t)?function(e,t){const a=i.getSelectedVillage().getBuildingQueue().getQueue();let n=!1;return a.some((function(a){if(a.building===e&&a.level===t)return n=!0})),n}(e,t)&&(l='progress'):l='reached',{level:t,price:a[e].individual_level_costs[t],building:e,duration:v.readableSeconds(o.build_time),levelPoints:S[e][t-1],state:l}}))},
z.generateBuildingSequenceFinal=function(e){const t=f.settings[p.ACTIVE_SEQUENCE].value,a=f.settings[p.BUILDING_SEQUENCES][e||t];let n={},i=[];for(let e in R)n[e]={level:0,order:R[e].order,resources:{wood:0,clay:0,iron:0,food:0},points:0,build_time:0};a.forEach((function(e){let t=++n[e].level,a=R[e].individual_level_costs[t];n[e].resources.wood+=parseInt(a.wood,10),n[e].resources.clay+=parseInt(a.clay,10),n[e].resources.iron+=parseInt(a.iron,10),n[e].resources.food+=parseInt(a.food,10),n[e].build_time+=parseInt(a.build_time,10),n[e].points+=S[e][t-1]}));for(let e in n)0!==n[e].level&&i.push({building:e,level:n[e].level,order:n[e].order,resources:n[e].resources,points:n[e].points,build_time:n[e].build_time});z.buildingSequenceFinal=i},z.updateVisibleBuildingSequence=function(){const e=f.pagination.buildingSequence.offset,t=f.pagination.buildingSequence.limit;z.visibleBuildingSequence=z.buildingSequence.slice(e,e+t),f.pagination.buildingSequence.count=z.buildingSequence.length},
z.generateBuildingsLevelPoints=function(){const e=i.getGameData();let t;for(let a in e.data.buildings){let n=e.getBuildingDataForBuilding(a);t=0,S[a]=[];for(let e=1;e<=n.max_level;e++){let i=B(n.points,n.points_factor,e)-t;t+=i,S[a].push(i)}}},I.moveUp=function(){let e=angular.copy(I.buildingSequence),t=!1;for(let a=0;a<e.length;a++){let n=e[a];n.checked&&(0!==a&&(e[a-1].checked||(e[a-1].building===n.building&&(e[a-1].level++,n.level--,t=!0),U(e,a,a-1))))}I.buildingSequence=e,I.updateVisibleBuildingSequence(),t&&(x=!0)},I.moveDown=function(){let e=angular.copy(I.buildingSequence),t=!1;for(let a=e.length-1;a>=0;a--){let n=e[a];n.checked&&(a!==e.length-1&&(e[a+1].checked||(e[a+1].building===n.building&&(e[a+1].level--,n.level++,t=!0),U(e,a,a+1))))}I.buildingSequence=e,I.updateVisibleBuildingSequence(),t&&(x=!0)},I.addBuilding=function(e,t,a=1){const n=t-1;let i=I.buildingSequence.slice(),o={level:null,building:e,checked:!1};for(let e=0;e<a;e++)i.splice(n,0,o)
;return I.buildingSequence=I.updateLevels(i,e),I.updateVisibleBuildingSequence(),x=!0,!0},I.removeBuilding=function(e){const t=I.buildingSequence[e].building;I.buildingSequence.splice(e,1),I.buildingSequence=I.updateLevels(I.buildingSequence,t),I.updateVisibleBuildingSequence(),x=!0},I.updateLevels=function(e,t){let a=0,n=[];for(let i=0;i<e.length;i++){let o=e[i];o.building===t?a<R[t].max_level&&n.push({level:++a,building:t,checked:!1}):n.push(o)}return n},I.generateBuildingSequence=function(){const e=y.get(p.BUILDING_SEQUENCES),t=Object.keys(e).length;if(I.sequencesAvail=t,!t)return!1;const a=e[I.selectedSequence.value];let n={};for(let e in T)n[T[e]]=0;I.buildingSequence=a.map((function(e){return{level:++n[e],building:e,checked:!1}})),I.updateVisibleBuildingSequence()},I.updateVisibleBuildingSequence=function(){const e=f.pagination.buildingSequenceEditor.offset,t=f.pagination.buildingSequenceEditor.limit;I.visibleBuildingSequence=I.buildingSequence.slice(e,e+t),
f.pagination.buildingSequenceEditor.count=I.buildingSequence.length},I.updateBuildingSequence=function(){const e=I.selectedSequence.value,i=I.buildingSequence.map((function(e){return e.building}));switch(t.updateBuildingSequence(e,i)){case _.SEQUENCE_SAVED:x=!1;break;case _.SEQUENCE_NO_EXISTS:n.notif('error',g('i18n')('error_sequence_no_exits',a.loc.ale,'builder_queue'));break;case _.SEQUENCE_INVALID:n.notif('error',g('i18n')('error_sequence_invalid',a.loc.ale,'builder_queue'))}},I.modal.removeSequence=function(){let e=a.$new();e.title=g('i18n')('title',a.loc.ale,'builder_queue_remove_sequence_modal'),e.text=g('i18n')('text',a.loc.ale,'builder_queue_remove_sequence_modal'),e.submitText=g('i18n')('remove',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.switchColors=!0,e.submit=function(){e.closeWindow(),t.removeSequence(I.selectedSequence.value),x=!1},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},I.modal.addBuilding=function(){
let e=a.$new();e.buildings=[],e.position=I.lastAddedIndex,e.indexLimit=I.buildingSequence.length+1,e.buildingsData=i.getGameData().getBuildings(),e.amount=1,e.selectedBuilding={name:g('i18n')(I.lastAddedBuilding,a.loc.ale,'building_names'),value:I.lastAddedBuilding};for(let t in R)e.buildings.push({name:g('i18n')(t,a.loc.ale,'building_names'),value:t});e.add=function(){const t=e.selectedBuilding.value,i=e.position,o=e.amount,l=g('i18n')(t,a.loc.ale,'building_names'),s=R[t].max_level;I.lastAddedBuilding=t,I.lastAddedIndex=i,I.addBuilding(t,i,o)?(e.closeWindow(),n.notif('success',g('i18n')('add_building_success',a.loc.ale,'builder_queue',l,i))):n.notif('error',g('i18n')('add_building_limit_exceeded',a.loc.ale,'builder_queue',l,s))},c.getModal('!twoverflow_builder_queue_add_building_modal',e)},I.modal.nameSequence=function(){const e=function(){let e=a.$new();const t=I.selectedSequence.name,i=f.settings[p.BUILDING_SEQUENCES][t];e.name=t,e.submit=function(){
if(e.name.length<3)return n.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;G(e.name,i)&&e.closeWindow()},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)};if(x){let t=a.$new();t.title=g('i18n')('clone_warn_changed_sequence_title',a.loc.ale,'builder_queue'),t.text=g('i18n')('clone_warn_changed_sequence_text',a.loc.ale,'builder_queue'),t.submitText=g('i18n')('clone',a.loc.ale,'builder_queue'),t.cancelText=g('i18n')('cancel',a.loc.ale,'common'),t.submit=function(){t.closeWindow(),e()},t.cancel=function(){t.closeWindow()},c.getModal('modal_attention',t)}else e()},O.updateVisibleLogs=function(){const e=f.pagination.logs.offset,t=f.pagination.logs.limit;O.visibleLogs=O.logs.slice(e,e+t),f.pagination.logs.count=O.logs.length,O.visibleLogs.forEach((function(e){e.villageId&&function(e){if(C[e])return C[e];C[e]=!0,P[e]='ŁADOWANIE...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1
},(function(t){C[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},P[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},O.clearLogs=function(){t.clearLogs()};const V=function(){let e=a.$new();const t=[T.HEADQUARTER];e.name='',e.submit=function(){if(e.name.length<3)return n.notif('error',g('i18n')('name_sequence_min_lenght',a.loc.ale,'builder_queue')),!1;G(e.name,t)&&(f.settings[p.ACTIVE_SEQUENCE]={name:e.name,value:e.name},f.settings[p.BUILDING_SEQUENCES][e.name]=t,j(),z.selectedSequence={name:e.name,value:e.name},I.selectedSequence={name:e.name,value:e.name},z.generateSequences(),I.generateBuildingSequence(),e.closeWindow(),W(M.SEQUENCES))},c.getModal('!twoverflow_builder_queue_name_sequence_modal',e)},W=function(e){f.selectedTab=e},j=function(){y.setAll(y.decode(f.settings)),x=!1},q=function(){t.isRunning()?t.stop():t.start()},F=function(e,t){let n=a.$new();n.title=g('i18n')('discard_changes_title',a.loc.ale,'builder_queue'),
n.text=g('i18n')('discard_changes_text',a.loc.ale,'builder_queue'),n.submitText=g('i18n')('discard',a.loc.ale,'common'),n.cancelText=g('i18n')('cancel',a.loc.ale,'common'),n.switchColors=!0,n.submit=function(){n.closeWindow(),e&&e()},n.cancel=function(){n.closeWindow(),t&&t()},c.getModal('modal_attention',n)},H=function(){x?F((function(){N()})):N()},Y={updateGroups:function(){f.groups=u.encodeList(k.getGroups(),{type:'groups',disabled:!0})},updateSequences:function(){const e=y.get(p.BUILDING_SEQUENCES);f.sequences=u.encodeList(e,{type:'keys',disabled:!1})},generateBuildingSequences:function(){z.generateSequences()},generateBuildingSequencesEditor:function(){I.generateBuildingSequence()},updateLogs:function(){f.logs=t.getLogs(),O.updateVisibleLogs()},clearLogs:function(){n.notif('success',g('i18n')('logs_cleared',a.loc.ale,'builder_queue')),Y.updateLogs()},buildingSequenceUpdate:function(e,t){const i=y.get(p.BUILDING_SEQUENCES);f.settings[p.BUILDING_SEQUENCES][t]=i[t],
f.settings[p.ACTIVE_SEQUENCE].value===t&&z.generateSequences(),n.notif('success',g('i18n')('sequence_updated',a.loc.ale,'builder_queue',t))},buildingSequenceAdd:function(e,t){const i=y.get(p.BUILDING_SEQUENCES);f.settings[p.BUILDING_SEQUENCES][t]=i[t],Y.updateSequences(),n.notif('success',g('i18n')('sequence_created',a.loc.ale,'builder_queue',t))},buildingSequenceRemoved:function(e,t){delete f.settings[p.BUILDING_SEQUENCES][t];const i=function(e){for(let t in e)if(E.call(e,t))return t;return!1}(f.settings[p.BUILDING_SEQUENCES]);I.selectedSequence={name:i,value:i},Y.updateSequences(),I.generateBuildingSequence(),y.get(p.ACTIVE_SEQUENCE)===t&&(y.set(p.ACTIVE_SEQUENCE,i,{quiet:!0}),z.generateSequences()),n.notif('success',g('i18n')('sequence_removed',a.loc.ale,'builder_queue',t))},saveSettings:function(){n.notif('success',g('i18n')('settings_saved',a.loc.ale,'builder_queue'))},started:function(){f.running=!0},stopped:function(){f.running=!1}},K=function(){const e=y.get(p.ACTIVE_SEQUENCE)
;f=a.$new(),f.selectedTab=M.SETTINGS,f.TAB_TYPES=M,f.SETTINGS=p,f.running=L,f.pagination={},f.settingsMap=y.settingsMap,f.villagesLabel=P,f.villagesInfo=C,f.editorView=I,f.editorView.buildingSequence={},f.editorView.visibleBuildingSequence=[],f.editorView.selectedSequence={name:e,value:e},f.editorView.lastAddedBuilding=T.HEADQUARTER,f.editorView.lastAddedIndex=1,f.settingsView=z,f.settingsView.buildingSequence={},f.settingsView.buildingSequenceFinal={},f.logsView=O,f.logsView.logs=t.getLogs(),f.selectTab=W,f.switchBuilder=q,f.saveSettings=j,f.createSequence=V,f.openVillageInfo=r.openVillageInfo,y.injectScope(f),Y.updateGroups(),Y.updateSequences(),f.pagination.buildingSequence={count:z.buildingSequence.length,offset:0,loader:z.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},f.pagination.buildingSequenceEditor={count:I.buildingSequence.length,offset:0,loader:I.updateVisibleBuildingSequence,limit:m.getPaginationLimit()},f.pagination.logs={count:O.logs.length,offset:0,
loader:O.updateVisibleLogs,limit:m.getPaginationLimit()},O.updateVisibleLogs(),z.generateSequences(),I.generateBuildingSequence();let n=new b('twoverflow_builder_queue_window');n.register(s.GROUPS_UPDATED,Y.updateGroups,!0),n.register(s.GROUPS_CREATED,Y.updateGroups,!0),n.register(s.GROUPS_DESTROYED,Y.updateGroups,!0),n.register(s.VILLAGE_SELECTED_CHANGED,Y.generateBuildingSequences,!0),n.register(s.BUILDING_UPGRADING,Y.generateBuildingSequences,!0),n.register(s.BUILDING_LEVEL_CHANGED,Y.generateBuildingSequences,!0),n.register(s.BUILDING_TEARING_DOWN,Y.generateBuildingSequences,!0),n.register(s.VILLAGE_BUILDING_QUEUE_CHANGED,Y.generateBuildingSequences,!0),n.register(s.BUILDER_QUEUE_JOB_STARTED,Y.updateLogs),n.register(s.BUILDER_QUEUE_CLEAR_LOGS,Y.clearLogs),n.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_UPDATED,Y.buildingSequenceUpdate),n.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_ADDED,Y.buildingSequenceAdd),
n.register(s.BUILDER_QUEUE_BUILDING_SEQUENCES_REMOVED,Y.buildingSequenceRemoved),n.register(s.BUILDER_QUEUE_SETTINGS_CHANGE,Y.saveSettings),n.register(s.BUILDER_QUEUE_START,Y.started),n.register(s.BUILDER_QUEUE_STOP,Y.stopped),c.getScreenWithInjectedScope('!twoverflow_builder_queue_window',f),N=f.closeWindow,f.closeWindow=H,f.$watch('settings[SETTINGS.ACTIVE_SEQUENCE].value',(function(e,t){e!==t&&Y.generateBuildingSequences()})),f.$watch('editorView.selectedSequence.value',(function(e,t){D?D=!1:e!==t&&(x?F((function(){Y.generateBuildingSequencesEditor(),x=!1}),(function(){f.editorView.selectedSequence={name:t,value:t},D=!0})):Y.generateBuildingSequencesEditor())}))};return function(){R=i.getGameData().getBuildings(),z.generateBuildingsLevelPoints(),y=t.getSettings(),h=e.addMenuButton2('Budowniczy',20,g('i18n')('general.description',a.loc.ale,'builder_queue')),h.addEventListener('click',K),w.register(s.BUILDER_QUEUE_START,(function(){L=!0,h.classList.remove('btn-orange'),
h.classList.add('btn-red'),n.notif('success',g('i18n')('started',a.loc.ale,'builder_queue'))})),w.register(s.BUILDER_QUEUE_STOP,(function(){L=!1,h.classList.remove('btn-red'),h.classList.add('btn-orange'),n.notif('success',g('i18n')('stopped',a.loc.ale,'builder_queue'))})),
...
const v=Object.values(c),f=Object.values(a),h=Object.values(w),R=Object.values(b),y=Object.values(T);let k,S=[],L={},I=[],z=[],O=!1;const M={[r.SELECTED_VILLAGE]:function(e){return e.origin.id===i.getSelectedVillage().getId()},[r.BARBARIAN_TARGET]:function(e){return!e.target.character_id},[r.ALLOWED_TYPES]:function(e,t){return t[r.ALLOWED_TYPES][e.type]},[r.ATTACK]:function(e){return e.type!==c.ATTACK},[r.SUPPORT]:function(e){return e.type!==c.SUPPORT},[r.RELOCATE]:function(e){return e.type!==c.RELOCATE},[r.TEXT_MATCH]:function(e,t){let a=!0;const n=t[r.TEXT_MATCH].toLowerCase().split(/\W/),i=[e.origin.name,e.origin.x+'|'+e.origin.y,e.origin.character_name||'',e.target.name,e.target.x+'|'+e.target.y,e.target.character_name||'',e.target.tribe_name||'',e.target.tribe_tag||''].join('').toLowerCase();return n.some((function(e){if(e.length&&!i.includes(e))return a=!1,!0})),a}},N=function(e){return e<g.gameTime()+k},C=function(e){S.push(e)},P=function(e){L[e.id]=e},x=function(){
_.set(d.QUEUE_COMMANDS,S)},D=function(e){return!isNaN(e)&&e>0&&e<1e3},B=function(e){return E.call(e,'x')&&E.call(e,'y')&&D(e.x)&&D(e.y)};let U={initialized:!1};return U.init=function(){k=t.getTimeOffset(),U.initialized=!0,I=_.get(d.QUEUE_SENT,[],!0),z=_.get(d.QUEUE_EXPIRED,[],!0),function(){const e=_.get(d.QUEUE_COMMANDS,[],!0);t.each(e,(function(e){g.gameTime()>e.sendTime?U.expireCommand(e,n.TIME_LIMIT):(C(e),P(e))}))}(),setInterval((function(){S.length&&S.some((function(e){if(!N(e.sendTime))return!0;O?U.sendCommand(e):U.expireCommand(e,n.TIME_LIMIT)}))}),100),e.addEventListener('beforeunload',(function(e){O&&S.length&&(e.returnValue=!0)}))},U.sendCommand=function(e){const a=function(e){const a=i.getVillages()[e.origin.id];if(!a)return n.NOT_OWN_VILLAGE;const o=a.unitInfo.units;let l={},s=!1;return t.each(e.units,(function(e,t){if('*'===e){if(0===(e=o[t].available))return}else if(e<0){if((e=o[t].available-Math.abs(e))<0)return s=n.NOT_ENOUGH_UNITS,!1
}else if(e>0&&e>o[t].available)return s=n.NOT_ENOUGH_UNITS,!1;l[t]=e})),angular.equals({},l)&&(s=n.NOT_ENOUGH_UNITS),s||l}(e);if('string'==typeof a)return U.expireCommand(e,a);e.units=a,o.emit(l.SEND_CUSTOM_ARMY,{start_village:e.origin.id,target_village:e.target.id,type:e.type,units:e.units,icon:0,officers:e.officers,catapult_target:e.catapultTarget}),function(e){I.push(e)}(e),_.set(d.QUEUE_SENT,I),U.removeCommand(e,n.COMMAND_SENT),p.trigger(s.COMMAND_QUEUE_SEND,e)},U.expireCommand=function(e,t){!function(e){z.push(e)}(e),_.set(d.QUEUE_EXPIRED,z),U.removeCommand(e,t)},U.addCommand=function(e,n,o,l,s,r,d,p){let m={},_={};return new Promise((function(E,k){if(!B(e))return k(u.INVALID_ORIGIN);if(!B(n))return k(u.INVALID_TARGET);if(!t.isValidDateTime(o))return k(u.INVALID_DATE);if(angular.isObject(s)){if(!t.each(s,(function(e,t){if(!h.includes(t))return!1;('*'===(e=isNaN(e)?e:parseInt(e,10))||'number'==typeof e&&0!==e)&&(m[t]=e)})))return k(u.INVALID_UNIT_TYPE)}
if(angular.equals(m,{}))return k(u.NO_UNITS);if(angular.isObject(r)){if(!t.each(r,(function(e,t){if(!R.includes(t))return!1;r[t]&&(_[t]=!0)})))return k(u.INVALID_OFFICER_TYPE)}return v.includes(d)?d!==c.RELOCATE||i.getWorldConfig().isRelocateUnitsEnabled()?(d===c.ATTACK&&_[b.SUPPORTER]&&delete _[b.SUPPORTER],'string'!=typeof p||y.includes(p)?(p=!(d!==c.ATTACK||!m[w.CATAPULT])&&(p||T.HEADQUARTER),f.includes(l)?void Promise.all([new Promise(t=>A.loadTownDataAsync(e.x,e.y,1,1,t)),new Promise(e=>A.loadTownDataAsync(n.x,n.y,1,1,e))]).then((function(i){if(e=i[0],n=i[1],!e)return k(u.INVALID_ORIGIN);if(!n)return k(u.INVALID_TARGET);const s=t.getTimeFromString(o),r=t.getTravelTime(e,n,m,d,_,!0),c=l===a.ARRIVE?s-r:s,A=l===a.ARRIVE?s:s+r;if(N(c))return k(u.ALREADY_SENT);const T={id:t.guid(),travelTime:r,arriveTime:A,sendTime:c,origin:e,target:n,date:o,dateType:l,units:m,officers:_,type:d,catapultTarget:p,countdown:c-g.gameTime()};C(T),P(T),S=S.sort((function(e,t){return e.sendTime-t.sendTime})),
x(),E(T)})):k(u.INVALID_DATE_TYPE)):k(u.INVALID_CATAPULT_TARGET)):k(u.RELOCATE_DISABLED):k(u.INVALID_COMMAND_TYPE)}))},U.removeCommand=function(e,t){delete L[e.id];const a=S.some((function(t,a){if(t.id==e.id)return S.splice(a,1),x(),!0}));if(a)switch(t){case n.TIME_LIMIT:p.trigger(s.COMMAND_QUEUE_SEND_TIME_LIMIT,e);break;case n.NOT_OWN_VILLAGE:p.trigger(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,e);break;case n.NOT_ENOUGH_UNITS:p.trigger(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,e);break;case n.COMMAND_REMOVED:p.trigger(s.COMMAND_QUEUE_REMOVE,e)}else p.trigger(s.COMMAND_QUEUE_REMOVE_ERROR,e);return a},U.clearWaitings=function(){_.set(d.QUEUE_COMMANDS,[]),S=[],L={}},U.clearRegisters=function(){_.set(d.QUEUE_EXPIRED,[]),_.set(d.QUEUE_SENT,[]),z=[],I=[]},U.start=function(e){O=!0,p.trigger(s.COMMAND_QUEUE_START,{disableNotif:!!e})},U.stop=function(){O=!1,p.trigger(s.COMMAND_QUEUE_STOP)},U.isRunning=function(){return O},U.getWaitingCommands=function(){return S},U.getWaitingCommandsObject=function(){
return L},U.getSentCommands=function(){return I},U.getExpiredCommands=function(){return z},U.filterCommands=function(e,t,a){const n=M[e];return(a||S).filter((function(e){return n(e,t)}))},U})),define('two/commandQueue/events',[],(function(){angular.extend(s,{COMMAND_QUEUE_SEND:'commandqueue_send',COMMAND_QUEUE_SEND_TIME_LIMIT:'commandqueue_send_time_limit',COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE:'commandqueue_send_not_own_village',COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH:'commandqueue_send_no_units_enough',COMMAND_QUEUE_ADD:'commandqueue_add',COMMAND_QUEUE_ADD_INVALID_ORIGIN:'commandqueue_add_invalid_origin',COMMAND_QUEUE_ADD_INVALID_TARGET:'commandqueue_add_invalid_target',COMMAND_QUEUE_ADD_INVALID_DATE:'commandqueue_add_invalid_date',COMMAND_QUEUE_ADD_NO_UNITS:'commandqueue_add_no_units',COMMAND_QUEUE_ADD_ALREADY_SENT:'commandqueue_add_already_sent',COMMAND_QUEUE_ADD_RELOCATE_DISABLED:'command_queue_add_relocate_disabled',COMMAND_QUEUE_REMOVE:'commandqueue_remove',
COMMAND_QUEUE_REMOVE_ERROR:'commandqueue_remove_error',COMMAND_QUEUE_START:'commandqueue_start',COMMAND_QUEUE_STOP:'commandqueue_stop'})})),define('two/commandQueue/ui',['two/ui','two/commandQueue','two/EventScope','two/utils','two/commandQueue/types/dates','two/commandQueue/types/events','two/commandQueue/types/filters','two/commandQueue/types/commands','two/commandQueue/storageKeys','two/commandQueue/errorCodes','queues/EventQueue','struct/MapData','helper/time','helper/util','Lockr'],(function(e,t,n,o,l,d,u,p,m,A,_,E,T,b,w){let v,f,h,R,y,k=i.getGameData(),S=k.getOrderedUnitNames(),L=k.getOrderedOfficerNames(),I=i.getPresetList(),z=!1;const O={ADD:'add',WAITING:'waiting',LOGS:'logs'},M=O.ADD;let N,C,P,x=[],D={},B={};const U={light_cavalry:{light_cavalry:1},heavy_cavalry:{heavy_cavalry:1},archer:{archer:1},sword:{sword:1},ram:{ram:1},snob:{snob:1},trebuchet:{trebuchet:1}},G=[u.SELECTED_VILLAGE,u.BARBARIAN_TARGET,u.ALLOWED_TYPES,u.TEXT_MATCH],V=function(e,t){z=t.data},W=function(){z=!1
},j=function(e){const t=new Date(e||T.gameTime()+o.getTimeOffset()),a=t.getMilliseconds(),n=T.zerofill(a-a%100,3),i=T.zerofill(t.getSeconds(),2),l=T.zerofill(t.getMinutes(),2);return T.zerofill(t.getHours(),2)+':'+l+':'+i+':'+n+' '+T.zerofill(t.getDate(),2)+'/'+T.zerofill(t.getMonth()+1,2)+'/'+t.getFullYear()},q=function(e,t){return o.isValidDateTime(e)?(e=o.getTimeFromString(e),j(e+=t)):''},F=function(){if(v.isValidDate=o.isValidDateTime(y.date),!y.origin||!y.target)return;const e=!!v.isValidDate&&o.getTimeFromString(y.date),t=v.selectedDateType.value===l.ARRIVE;o.each(p,(function(a){o.each(U,(function(n,i){const l=o.getTravelTime(y.origin,y.target,n,a,y.officers,!0);v.travelTimes[a][i].travelTime=g('readableMillisecondsFilter')(l),v.travelTimes[a][i].status=e?H(t?e-l:e):'neutral'}))}))},H=function(e){return e&&v.isValidDate?T.gameTime()+N<e?'valid':'invalid':'neutral'},Y=function(){y.dateType=v.selectedDateType.value,w.set(m.LAST_DATE_TYPE,v.selectedDateType.value),F()},K=function(){
y.catapultTarget=v.catapultTarget.value},Q=function(){const e=v.selectedInsertPreset.value;if(!e)return!1;const t=i.getPresetList().getPresets()[e];v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},y.units=angular.copy(t.units),y.officers=angular.copy(t.officers),t.catapult_target&&(y.catapultTarget=t.catapult_target,v.catapultTarget={name:g('i18n')(t.catapult_target,a.loc.ale,'building_names'),value:t.catapult_target},v.showCatapultSelect=!0)},Z=function(e){e.updateCountdown||(e.updateCountdown=function(){const t=T.serverTime()+a.GAME_TIME_OFFSET,n=e.sendTime-60*(new Date).getTimezoneOffset()*1e3;e.countdown=n-t}),T.timer.add(e.updateCountdown)},X=function(){v.waitingCommands=t.getWaitingCommands()},J=function(){v.sentCommands=t.getSentCommands()},$=function(){v.expiredCommands=t.getExpiredCommands()},ee=function(){let e=v.waitingCommands;G.forEach((function(a){v.activeFilters[a]&&(e=t.filterCommands(a,v.filtersData,e))})),
v.visibleWaitingCommands=e},te=function(e){0===y.units[e]&&(y.units[e]='')},ae=function(e){''===y.units[e]&&(y.units[e]=0)},ne=function(){v.showCatapultSelect=!!y.units.catapult},ie=function(e){v.selectedTab=e},oe=function(){const e=i.getSelectedVillage().data;y.origin={id:e.villageId,x:e.x,y:e.y,name:e.name,character_id:h.getId()}},le=function(){if(!z)return o.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'command_queue'));E.loadTownDataAsync(z.x,z.y,1,1,(function(e){y.target=e}))},se=function(){y.date=j()},re=function(){if(!y.date)return!1;y.date=q(y.date,100)},ce=function(){if(!y.date)return!1;y.date=q(y.date,-100)},de=function(){y.units=angular.copy(D),y.officers=angular.copy(B),y.catapultTarget="wall",v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.showCatapultSelect=!1},ue=function(e){t.addCommand(y.origin,y.target,y.date,y.dateType,y.units,y.officers,e,y.catapultTarget).then((function(e){X(),ee(),Z(e),
o.notif('success',Ae(e.type,'added'))})).catch((function(t){switch(t){case A.INVALID_ORIGIN:o.notif('error',g('i18n')('error_origin',a.loc.ale,'command_queue'));break;case A.INVALID_TARGET:o.notif('error',g('i18n')('error_target',a.loc.ale,'command_queue'));break;case A.INVALID_DATE:o.notif('error',g('i18n')('error_invalid_date',a.loc.ale,'command_queue'));break;case A.NO_UNITS:o.notif('error',g('i18n')('error_no_units',a.loc.ale,'command_queue'));break;case A.RELOCATE_DISABLED:o.notif('error',g('i18n')('error_relocate_disabled',a.loc.ale,'command_queue'));break;case A.ALREADY_SENT:o.notif('error',g('i18n')('error_already_sent_'+e,a.loc.ale,'command_queue'))}}))},pe=function(){t.clearRegisters(),J(),$()},ge=function(){t.clearWaitings(),X()},me=function(){t.isRunning()?t.stop():t.start()},Ae=function(e,t,n){return n&&(e=n+'.'+e),g('i18n')(e,a.loc.ale,'command_queue')+' '+g('i18n')(t,a.loc.ale,'command_queue')},_e=function(e,t){v.activeFilters[e]=!v.activeFilters[e],
t&&(v.filtersData[u.ALLOWED_TYPES][e]=!v.filtersData[u.ALLOWED_TYPES][e]),ee()},Ee=function(){v.activeFilters[u.TEXT_MATCH]=v.filtersData[u.TEXT_MATCH].length>0,ee()},Te={updatePresets:function(){v.presets=o.obj2selectOptions(I.getPresets())},autoCompleteSelected:function(e,t,a,n){if('commandqueue_village_search'!==t)return!1;y[n]={id:a.raw.id,x:a.raw.x,y:a.raw.y,name:a.raw.name},v.searchQuery[n]=''},removeCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still removed.'),X(),ee(),a.$broadcast(s.TOOLTIP_HIDE,'twoverflow-tooltip'),o.notif('success',Ae(t.type,'removed'))},removeError:function(){o.notif('error',g('i18n')('error_remove_error',a.loc.ale,'command_queue'))},sendTimeLimit:function(e,t){J(),$(),X(),ee(),o.notif('error',Ae(t.type,'expired'))},sendNotOwnVillage:function(){J(),$(),X(),ee(),o.notif('error',g('i18n')('error_not_own_village',a.loc.ale,'command_queue'))},sendNoUnitsEnough:function(){J(),$(),X(),ee(),
o.notif('error',g('i18n')('error_no_units_enough',a.loc.ale,'command_queue'))},sendCommand:function(e,t){T.timer.remove(t.updateCountdown)||o.notif('error','Error stopping command countdown. Command still sent.'),J(),X(),ee(),o.notif('success',Ae(t.type,'sent'))},start:function(e,a){if(v.running=t.isRunning(),a.disableNotif)return!1;o.notif('success',Ae('title','activated'))},stop:function(){v.running=t.isRunning(),o.notif('success',Ae('title','deactivated'))},onAutoCompleteOrigin:function(e){y.origin={id:e.id,x:e.x,y:e.y,name:e.name}},onAutoCompleteTarget:function(e){y.target={id:e.id,x:e.x,y:e.y,name:e.name}},clearCountdownUpdates:function(){t.getWaitingCommands().forEach(e=>{T.timer.remove(e.updateCountdown)})}},be=function(){const e=w.get(m.LAST_DATE_TYPE,l.OUT,!0);let A;v=a.$new(),v.selectedTab=M,v.inventory=i.getInventory(),v.presets=o.obj2selectOptions(I.getPresets()),v.travelTimes={},o.each(p,(function(e){v.travelTimes[e]={},o.each(U,(function(t,a){v.travelTimes[e][a]={
travelTime:0,status:'neutral'}}))})),v.unitOrder=R,v.officers=k.getOrderedOfficerNames(),v.searchQuery={origin:'',target:''},v.isValidDate=!1,v.dateTypes=b.toActionList(l,(function(e){return g('i18n')(e,a.loc.ale,'command_queue')})),v.selectedDateType={name:g('i18n')(e,a.loc.ale,'command_queue'),value:e},v.selectedInsertPreset={name:g('i18n')('add_insert_preset',a.loc.ale,'command_queue'),value:null},v.catapultTarget={name:g('i18n')("wall",a.loc.ale,'building_names'),value:"wall"},v.autoCompleteOrigin={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Te.onAutoCompleteOrigin,tooltip:g('i18n')('add_origin',a.loc.ale,'command_queue'),dropDown:!0},v.autoCompleteTarget={type:['village'],placeholder:g('i18n')('add_village_search',a.loc.ale,'command_queue'),onEnter:Te.onAutoCompleteTarget,tooltip:g('i18n')('add_target',a.loc.ale,'command_queue'),dropDown:!0},v.showCatapultSelect=!!y.units.catapult,v.attackableBuildings=x,v.commandData=y,
v.activeFilters=C,v.filtersData=P,v.running=t.isRunning(),v.waitingCommands=t.getWaitingCommands(),v.visibleWaitingCommands=t.getWaitingCommands(),v.sentCommands=t.getSentCommands(),v.expiredCommands=t.getExpiredCommands(),v.EVENT_CODES=d,v.FILTER_TYPES=u,v.TAB_TYPES=O,v.COMMAND_TYPES=p,v.relocateEnabled=i.getWorldConfig().isRelocateUnitsEnabled(),v.onUnitInputFocus=te,v.onUnitInputBlur=ae,v.catapultTargetVisibility=ne,v.selectTab=ie,v.addSelected=oe,v.addMapSelected=le,v.addCurrentDate=se,v.incrementDate=re,v.reduceDate=ce,v.cleanUnitInputs=de,v.addCommand=ue,v.clearWaitings=ge,v.clearRegisters=pe,v.switchCommandQueue=me,v.removeCommand=t.removeCommand,v.openVillageInfo=r.openVillageInfo,v.toggleFilter=_e,v.$watch('commandData.origin',F),v.$watch('commandData.target',F),v.$watch('commandData.date',F),v.$watch('commandData.officers',F),v.$watch('selectedDateType.value',Y),v.$watch('selectedInsertPreset.value',Q),v.$watch('catapultTarget.value',K),
v.$watch('filtersData[FILTER_TYPES.TEXT_MATCH]',Ee),v.$watch('selectedTab',(function(){v.selectedTab===O.ADD?A=setInterval((function(){F()}),2500):clearInterval(A)})),v.waitingCommands.forEach(e=>{Z(e)});let _=new n('twoverflow_queue_window',(function(){clearInterval(A),Te.clearCountdownUpdates()}));_.register(s.ARMY_PRESET_UPDATE,Te.updatePresets,!0),_.register(s.ARMY_PRESET_DELETED,Te.updatePresets,!0),_.register(s.SELECT_SELECTED,Te.autoCompleteSelected,!0),_.register(s.COMMAND_QUEUE_REMOVE,Te.removeCommand),_.register(s.COMMAND_QUEUE_REMOVE_ERROR,Te.removeError),_.register(s.COMMAND_QUEUE_SEND_TIME_LIMIT,Te.sendTimeLimit),_.register(s.COMMAND_QUEUE_SEND_NOT_OWN_VILLAGE,Te.sendNotOwnVillage),_.register(s.COMMAND_QUEUE_SEND_NO_UNITS_ENOUGH,Te.sendNoUnitsEnough),_.register(s.COMMAND_QUEUE_SEND,Te.sendCommand),_.register(s.COMMAND_QUEUE_START,Te.start),_.register(s.COMMAND_QUEUE_STOP,Te.stop),c.getScreenWithInjectedScope('!twoverflow_queue_window',v)};return function(){
h=i.getSelectedCharacter(),N=o.getTimeOffset();const t=k.getAttackableBuildings();for(let e in t)x.push({name:g('i18n')(e,a.loc.ale,'building_names'),value:e});R=angular.copy(S),R.splice(R.indexOf('catapult'),1),S.forEach((function(e){D[e]=0})),L.forEach((function(e){B[e]=!1})),y={origin:!1,target:!1,date:'',dateType:l.OUT,units:angular.copy(D),officers:angular.copy(B),catapultTarget:"wall",type:null},C={[u.SELECTED_VILLAGE]:!1,[u.BARBARIAN_TARGET]:!1,[u.ALLOWED_TYPES]:!0,[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0,[u.TEXT_MATCH]:!1},P={[u.ALLOWED_TYPES]:{[u.ATTACK]:!0,[u.SUPPORT]:!0,[u.RELOCATE]:!0},[u.TEXT_MATCH]:''},f=e.addMenuButton('Generał',10,g('i18n')('description',a.loc.ale,'command_queue')),f.addEventListener('click',be),_.register(s.COMMAND_QUEUE_START,(function(){f.classList.remove('btn-orange'),f.classList.add('btn-red')})),_.register(s.COMMAND_QUEUE_STOP,(function(){f.classList.remove('btn-red'),f.classList.add('btn-orange')})),a.$on(s.SHOW_CONTEXT_MENU,V),
...
define('two/farmOverflow',['two/Settings','two/farmOverflow/types/errors','two/farmOverflow/types/status','two/farmOverflow/settings','two/farmOverflow/settings/map','two/farmOverflow/settings/updates','two/farmOverflow/types/logs','two/mapData','two/utils','two/ready','helper/math','helper/time','queues/EventQueue','conf/commandTypes','conf/village','conf/resourceTypes','struct/MapData','Lockr'],(function(e,t,n,r,c,p,m,A,T,b,w,v,f,h,R,y,k,S){let L,I,z,O,M,N,C,P=!1,x=!1,D=[],B=[],U=[],G=[],V=[],W=[],j=!1,q=!1,F=!1,H=0,Y=null,K=null,Q=null,Z={},X=v.gameTime(),J=null,$=null,ee='paused';const te='farm_overflow_logs',ae='farm_overflow_settings',ne='farm_overflow_exception_logs',ie=[y.WOOD,y.CLAY,y.IRON],oe={distance:function(e){return!e.distance.between(I[r.MIN_DISTANCE],I[r.MAX_DISTANCE])},ownPlayer:function(e){return e.character_id===O.getId()},included:function(e){return e.character_id&&!U.includes(e.id)},ignored:function(e){return G.includes(e.id)},points:function(e){
return!e.between(I[r.MIN_POINTS],I[r.MAX_POINTS])}},le=[oe.distance,oe.ownPlayer,oe.included,oe.ignored],se=function(e){return e.sort().filter((function(e,t,a){return!t||e!=a[t-1]}))},re=function(){!function(){const e=I[r.GROUP_INCLUDE];U=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);U=U.concat(t)})),U=se(U)}(),function(){const e=I[r.GROUP_IGNORE];G=i.getGroupList().getGroupVillageIds(e)}(),function(){const e=I[r.GROUP_ONLY];V=[],e.forEach((function(e){let t=i.getGroupList().getGroupVillageIds(e);t=t.filter((function(e){return!!O.getVillage(e)})),V=V.concat(t)})),V=se(V)}(),function(){const e=G.concat(U);let t=!1;e.forEach((function(e){E.call(z,e)||(z[e]={time:v.gameTime(),report:!1},t=!0)})),T.each(z,(function(a,n){n=parseInt(n,10),e.includes(n)||(delete z[n],t=!0)})),t&&(S.set(ne,z),f.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED))}(),f.trigger(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED)},ce=function(e,t){
...
const t=i.getGroupList().getGroups(),a=I[r.GROUP_IGNORE],n=I[r.GROUP_ONLY],o=I[r.GROUP_INCLUDE],l=E.call(t,a)?a:L.getDefault(r.GROUP_IGNORE),s=n.filter(e=>E.call(t,e)),c=o.filter(e=>E.call(t,e));L.setAll({[r.GROUP_IGNORE]:l,[r.GROUP_ONLY]:s,[r.GROUP_INCLUDE]:c},e)},pe=function(){ue(),re(),Me(),De(),Oe()},ge=function(){W=[];const e=i.getPresetList().getPresets();I[r.PRESETS].forEach((function(t){if(!E.call(e,t))return;let a=e[t];a.load=we(a),a.travelTime=d.calculateTravelTime(a,{barbarian:!1,officers:!1}),W.push(a)})),W=W.sort((function(e,t){return e.travelTime-t.travelTime||t.load-e.load}))},me=function(e,t){o.emit(l.MESSAGE_REPLY,{message_id:e,message:t})};var Ae=function(){var e=g('i18n')('status',a.loc.ale,'common'),t=g('i18n')('selected_village',a.loc.ale,'farm_overflow'),n=g('i18n')('last_attack',a.loc.ale,'farm_overflow');console.log(C);var i=T.genVillageLabel(C.village.data),o=T.formatDate(N),l=C.villageId,s=[],r=g('i18n')(ee,a.loc.ale,'farm_overflow')
;if('step_cycle_next'===ee){var c=v.gameTime()+Se(),d=T.formatDate(c),u=g('i18n')('next_cycle_in',a.loc.ale,'farm_overflow');s.push('[b]',e,':[/b] ',r,'[br]'),s.push('[b]',u,':[/b] ',d,'[br]'),s.push('[b]',t,':[/b] '),s.push('[village=',l,']',i,'[/village][br]'),s.push('[b]',n,':[/b] ',o)}else s.push('[b]',e,':[/b] ',r,'[br]'),s.push('[b]',t,':[/b] '),s.push('[village=',l,']',i,'[/village][br]'),s.push('[b]',n,':[/b] ',o);return s.join('')};const _e=function(){ge(),W.length||(f.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),ee='no_preset',x&&Be.stop())},Ee=function(e,t){I[r.IGNORE_ON_LOSS]&&I[r.GROUP_IGNORE]&&x&&t.type===h.TYPES.ATTACK&&1!==t.result&&Pe(t.target_village_id)&&(Z[t.target_village_id]={haul:t.haul,id:t.id,result:t.result,title:t.title},function(e){const t=I[r.GROUP_IGNORE];!!t&&o.emit(l.GROUPS_LINK_VILLAGE,{group_id:t,village_id:e})}(t.target_village_id))},Te=function(e,t){
j&&F&&t.origin.id===j.getId()&&t.target.id===F.id&&'forward'===t.direction&&t.type===h.TYPES.ATTACK&&j.commandSent(t)},be=function(e,t){j&&q&&F&&t.cause===l.SEND_PRESET.type&&j.commandError(t)},we=function(e){let t=0;return T.each(e.units,(function(e,a){e&&(t+=M[a].load*e)})),t},ve=function(e){z[e]={time:v.gameTime(),report:Z[e]||!1},delete Z[e],S.set(ne,z),f.trigger(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED)},fe=function(e,t={}){return'string'==typeof e&&(angular.isObject(t)||(t={}),t.time=v.gameTime(),t.type=e,B.unshift(t),he(),!0)},he=function(){const e=I[r.LOGS_LIMIT];B.length>e&&B.splice(B.length-e,B.length),S.set(te,B),f.trigger(s.FARM_OVERFLOW_LOGS_UPDATED)},Re=function(e,t,a){const n=I[r.TARGET_MULTIPLE_FARMERS],i=I[r.TARGET_SINGLE_ATTACK];if(n&&a){if(i&&e)return!0}else if(i){if(e||t)return!0}else if(t)return!0;return!1},ye=function(){X=v.gameTime()},ke=function(){clearTimeout(Y),clearTimeout(K),clearTimeout(Q),Y=null,K=null,Q=null},Se=function(){
return Math.max(1,60*I[r.FARMER_CYCLE_INTERVAL]*1e3)},Le=function(){return Math.max(0,1e3*I[r.ATTACK_INTERVAL])},Ie=function(e){if(this.villageId=e,this.village=O.getVillage(e),!this.village)throw new Error(`new Farmer -> Village ${e} doesn't exist.`);this.index=0,this.running=!1,this.initialized=!1,this.targets=!1,this.onCycleEndFn=_,this.status=n.WAITING_CYCLE,ee='status_waiting_cycle'};Ie.prototype.init=function(){let e=[];return this.isInitialized()||(e.push(new Promise(e=>{if(this.isInitialized())return e();u.ensureVillageDataLoaded(this.villageId,e)})),e.push(new Promise(e=>{if(this.isInitialized())return e();this.loadTargets(()=>{f.trigger(s.FARM_OVERFLOW_INSTANCE_READY,{villageId:this.villageId}),e()})}))),Promise.all(e).then(()=>{this.initialized=!0})},Ie.prototype.start=function(){return ye(),!this.running&&(this.initialized?this.targets.length?(j=this,this.running=!0,f.trigger(s.FARM_OVERFLOW_INSTANCE_START,{villageId:this.villageId}),this.targetStep({delay:!1}),
!0):(f.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS,{villageId:this.villageId}),!1):(f.trigger(s.FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY,{villageId:this.villageId}),!1))},Ie.prototype.stop=function(e){this.running=!1,f.trigger(s.FARM_OVERFLOW_INSTANCE_STOP,{villageId:this.villageId,reason:e}),e===t.USER_STOP&&(this.setStatus(n.USER_STOP),ee='status_user_stop'),ke(),this.onCycleEndFn(e),this.onCycleEndFn=_},Ie.prototype.targetStep=async function(e={}){if(!this.running)return!1;ye();const t=this.village.getCommandListModel().getOutgoingCommands(!0,!0);let a,c,u,p,g=!1,m=!1;const A=()=>new Promise((t,a)=>{e.delay?K=setTimeout(()=>{if(K=null,!this.running)return ee='status_user_stop',a(n.USER_STOP);t()},T.randomSeconds(Le())):t()}),_=()=>new Promise((e,a)=>{const i=50-I[r.PRESERVE_COMMAND_SLOTS];t.length>=i?(a(n.COMMAND_LIMIT),ee='status_command_limit'):e()}),b=()=>new Promise((e,t)=>{if(I[r.IGNORE_FULL_STORAGE]){const e=this.village.getResources(),a=e.getComputed(),i=e.getMaxStorage()
;if(ie.every(e=>a[e].currentStock===i))return ee='status_full_storage',t(n.FULL_STORAGE)}e()}),y=()=>new Promise((e,t)=>this.targets.length?this.index>this.targets.length||!this.targets[this.index]?(ee='status_target_cycle_end',t(n.TARGET_CYCLE_END)):(a=this.targets[this.index],void e()):(ee='status_no_targets',t(n.NO_TARGETS))),L=()=>new Promise((e,t)=>{k.getTownAtAsync(a.x,a.y,i=>{if(oe.points(i.points))return ee='status_not_allowed_points',t(n.NOT_ALLOWED_POINTS);o.emit(l.GET_ATTACKING_FACTOR,{target_id:a.id},i=>{this.running?null!==a.character_id||null===i.owner_id||U.includes(a.id)?a.attack_protection?(t(n.PROTECTED_VILLAGE),ee='status_protected_village'):e():(t(n.ABANDONED_CONQUERED),ee='status_abandoned_conquered'):(t(n.USER_STOP),ee='status_user_stop')})})}),z=()=>new Promise((e,t)=>{!function(e,t){const a=i.getPresetList().getPresetsByVillageId(e);let n=[];if(W.forEach((function(e){E.call(a,e.id)||n.push(e.id)})),n.length){for(let e in a)E.call(a,e)&&n.push(e)
;o.emit(l.ASSIGN_PRESETS,{village_id:e,preset_ids:n},t)}else t()}(this.villageId,()=>{this.running?e():(t(n.USER_STOP),ee='status_user_stop')})}),M=()=>new Promise((e,t)=>{const i=this.village.getUnitInfo().getUnits(),o=60*I[r.MAX_TRAVEL_TIME],l=this.village.getPosition(),s=w.actualDistance(l,a);T.each(W,l=>{if(!!Object.entries(l.units).some(e=>{const t=e[0],a=e[1];return i[t].in_town<a}))return;const r=d.calculateTravelTime(l,{barbarian:!a.character_id,officers:!1});return o>r*s?(g=l,e()):(t(n.TIME_LIMIT),ee='status_time_limit'),!1}),g||(t(n.NO_UNITS),ee='status_no_units')}),C=()=>new Promise((e,i)=>{c=!1,p=O.getVillageList();const o=p.every(e=>e.isInitialized(R.READY_STATES.OWN_COMMANDS));if(o&&(c=p.some(e=>{if(e.getId()===this.villageId)return!1;return e.getCommandListModel().getOutgoingCommands(!0,!0).some(e=>e.targetVillageId===a.id&&'forward'===e.data.direction)})),u=t.some(e=>e.data.target.id===a.id&&'forward'===e.data.direction),Re(u,c,o))return ee='status_busy_target',
i(n.BUSY_TARGET);o&&(m=!0),e()}),P=()=>new Promise((e,t)=>{if(!u&&!c)return e();const i=60*I[r.MULTIPLE_ATTACKS_INTERVAL];if(!i)return e();if(I[r.TARGET_SINGLE_ATTACK]&&!I[r.TARGET_MULTIPLE_FARMERS])return e();const o=Math.round(v.gameTime()/1e3),l=I[r.TARGET_MULTIPLE_FARMERS]?p:[this.village],s=this.village.getPosition(),m=w.actualDistance(s,a),A=d.calculateTravelTime(g,{barbarian:!a.character_id,officers:!0,effects:!0}),_=d.getTravelTimeForDistance(g,A,m,h.TYPES.ATTACK);if(l.some(e=>{const t=e.getCommandListModel().getOutgoingCommands(!0,!0).filter(e=>e.targetVillageId===a.id&&'forward'===e.data.direction);if(t.length)return t.some(e=>Math.abs(o+_-e.time_completed)<i)}))return ee='status_busy_target',t(n.BUSY_TARGET);e()}),x=()=>new Promise((e,t)=>{if(m)return e();o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:this.villageId,village_id:a.id,num_reports:0},a=>{if(!this.running)return ee='status_user_stop',t(n.USER_STOP)
;const i=a.commands.own.filter(e=>e.type===h.TYPES.ATTACK&&'forward'===e.direction),o=i.some(e=>e.start_village_id!==this.villageId),l=i.some(e=>e.start_village_id===this.villageId);if(Re(l,o,!0))return ee='status_busy_target',t(n.BUSY_TARGET);e()})});let D=new Promise((e,t)=>{A().then(_).then(b).then(y).then(L).then(z).then(M).then(C).then(P).then(x).then(e).catch(t)}),B=new Promise((e,t)=>{Q=setTimeout(()=>{this.running&&(t(n.EXPIRED_STEP),ee='status_expired_step')},3e4)});Promise.race([D,B]).then(()=>{if(!this.running)return!1;this.setStatus(n.ATTACKING),ee='status_attacking',N=v.gameTime(),S.set('farm-lastAttack',N),q=!0,F=a,this.index++,o.emit(l.SEND_PRESET,{start_village:this.villageId,target_village:a.id,army_preset_id:g.id,type:h.TYPES.ATTACK})}).catch(t=>{switch(ke(),f.trigger(s.FARM_OVERFLOW_INSTANCE_STEP_STATUS,{villageId:this.villageId,error:t}),t){case n.TIME_LIMIT:case n.BUSY_TARGET:case n.ABANDONED_CONQUERED:case n.PROTECTED_VILLAGE:this.index++,this.setStatus(t),
this.targetStep(e),ee='status_protected_village';break;case n.USER_STOP:this.setStatus(t),ee='status_user_stop';break;case n.NOT_ALLOWED_POINTS:this.index++,this.setStatus(t),xe(a.id),this.targetStep(e),ee='status_not_allowed_points';break;case n.NO_UNITS:case n.NO_TARGETS:case n.FULL_STORAGE:case n.COMMAND_LIMIT:this.index++,this.setStatus(t),this.stop(t),ee='status_command_limit';break;case n.TARGET_CYCLE_END:this.index=0,this.setStatus(t),this.stop(t),ee='status_target_cycle_end';break;case n.EXPIRED_STEP:this.setStatus(t),this.targetStep(),ee='status_expired_step';break;default:console.error('Unknown status:',t),this.index++,this.setStatus(n.UNKNOWN),this.stop(n.UNKNOWN),ee='status_unknown'}})},Ie.prototype.setStatus=function(e){this.status=e},Ie.prototype.getStatus=function(){return ee='status_unknown',this.status||n.UNKNOWN},Ie.prototype.commandSent=function(e){q=!1,F=!1,ke(),fe(m.ATTACKED_VILLAGE,{targetId:e.target.id}),this.targetStep({delay:!0})},
Ie.prototype.commandError=function(){q=!1,F=!1,this.stop(n.COMMAND_ERROR),ee='status_command_error'},Ie.prototype.onCycleEnd=function(e){this.onCycleEndFn=e},Ie.prototype.loadTargets=function(e){const t=this.village.getPosition();A.load(a=>{this.targets=function(e,t){return e.map((function(e){return e.distance=w.actualDistance(t,e),e}))}(a,t),this.targets=function(e){return e.filter((function(e){return le.every((function(t){return!t(e)}))}))}(this.targets),this.targets=function(e){return e.sort((function(e,t){return e.distance-t.distance}))}(this.targets),this.targets=this.targets.slice(0,I[r.TARGET_LIMIT_PER_VILLAGE]),'function'==typeof e&&e(this.targets)})},Ie.prototype.getTargets=function(){return this.targets},Ie.prototype.getIndex=function(){return this.index},Ie.prototype.getVillage=function(){return this.village},Ie.prototype.isRunning=function(){return this.running},Ie.prototype.isInitialized=function(){return this.initialized},Ie.prototype.removeTarget=function(e){
return!('number'!=typeof e||!this.targets)&&(this.targets=this.targets.filter((function(t){return t.id!==e})),!0)},Ie.prototype.getId=function(){return this.villageId};const ze=function(e){const t=I[r.GROUP_ONLY];if(e=parseInt(e,10),t.length&&!V.includes(e))return!1;if(G.includes(e))return!1;let a=Be.getFarmer(e);return a||(a=new Ie(e),D.push(a)),a},Oe=function(){T.each(O.getVillages(),(function(e,t){ze(t)})),f.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED)},Me=function(){const e=I[r.GROUP_ONLY];let t=[];D.forEach((function(a){let n=a.getId();e.length&&!V.includes(n)?t.push(n):G.includes(n)&&t.push(n)})),t.length&&(t.forEach((function(e){Ne(e)})),f.trigger(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED))},Ne=function(e){for(let a=0;a<D.length;a++)if(D[a].getId()===e)return D[a].stop(t.KILL_FARMER),D.splice(a,a+1),!0;return!1},Ce=function(e){ye(),D.length?H>=D.length?(H=0,j=!1,$=v.gameTime()+Se(),f.trigger(s.FARM_OVERFLOW_CYCLE_END),ee='step_cycle_next'):j=D[H]:j=!1,
j?(j.onCycleEnd((function(e){e!==t.USER_STOP&&(H++,Ce())})),"cycle_begin"===e&&($=null,f.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN)),j.start()):Y=setTimeout((function(){Y=null,H=0,$=null,f.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),Ce()}),Se())},Pe=function(e){for(let t=0;t<D.length;t++){let a=D[t].getTargets();for(let t=0;t<a.length;t++){if(a[t].id===e)return!0}}return!1},xe=function(e){D.forEach((function(t){t.removeTarget(e)}))},De=function(){A.load((function(){D.forEach((function(e){e.loadTargets()}))}),!0)};let Be={};return Be.init=function(){P=!0,B=S.get(te,[]),N=S.get('farm-lastAttack',-1,!0),z=S.get(ne,{}),O=i.getSelectedCharacter(),M=i.getGameData().getUnitsObject(),L=new e({settingsMap:c,storageKey:ae}),L.onChange((function(e,t,a){I=L.getAll(),"ignore_update"!==a&&(t[p.PRESET]&&ge(),t[p.GROUPS]&&re(),t[p.TARGETS]&&De(),t[p.VILLAGES]&&(Me(),Oe()),t[p.LOGS]&&he(),t[p.INTERVAL_TIMERS]&&x&&(K?(ke(),j.targetStep({delay:!0})):Y&&(ke(),f.trigger(s.FARM_OVERFLOW_CYCLE_BEGIN),H=0,Ce())))})),
I=L.getAll(),ue("ignore_update"),re(),Oe(),a.$on(s.MESSAGE_SENT,(function(e,t){var a=I[r.REMOTE];if(1!==t.participants.length||t.title!==a)return!1;switch(t.message.content.trim().toLowerCase()){case'dawaj':case'lecimy':case'kurwa':case'farmie':case'ciasne leginsy':case'obiwan':Be.start(),me(t.message_id,Ae()),f.trigger('Farm/remoteCommand',['on']);break;case'bierz':case'spadamy':case'chuj':case'karmie':case'luźne dresy':case'padawan':Be.stop(),me(t.message_id,Ae()),f.trigger('Farm/remoteCommand',['off']);break;case'stan':case'jak idzie':case'info':me(t.message_id,Ae()),f.trigger('Farm/remoteCommand',['status'])}return!1})),b((function(){ge()}),'presets'),b((function(){D.forEach((function(e){e.loadTargets()}))}),'minimap_data'),a.$on(s.ARMY_PRESET_UPDATE,_e),a.$on(s.ARMY_PRESET_DELETED,_e),a.$on(s.GROUPS_VILLAGE_LINKED,ce),a.$on(s.GROUPS_VILLAGE_UNLINKED,de),a.$on(s.GROUPS_DESTROYED,pe),a.$on(s.COMMAND_SENT,Te),a.$on(s.MESSAGE_ERROR,be),a.$on(s.REPORT_NEW,Ee)},Be.start=function(){let e
;return!x&&(W.length?(x=!0,e=[],D.forEach((function(t){e.push(new Promise((function(e){t.init().then(e),C=t})))})),e.length?(Promise.all(e).then((function(){Ce("cycle_begin")})),ye(),function(){let e=Se(),t=e+e/2+Le();J=setInterval((function(){v.gameTime()-X>t&&(Be.stop(),setTimeout(Be.start,5e3))}),3e4)}(),f.trigger(s.FARM_OVERFLOW_START),void fe(m.FARM_START)):(x=!1,!1)):(f.trigger(s.FARM_OVERFLOW_STOP,{reason:t.NO_PRESETS}),ee='no_preset',!1))},Be.stop=function(e=n.USER_STOP){j?(j.stop(e),e!==n.USER_STOP&&($=v.gameTime()+Se(),ee='step_cycle_next'),f.trigger(s.FARM_OVERFLOW_CYCLE_END,e)):$=null,x=!1,ke(),f.trigger(s.FARM_OVERFLOW_STOP,{reason:e}),clearInterval(J),e===n.USER_STOP&&fe(m.FARM_STOP)},Be.getFarmer=function(e){return D.find((function(t){return t.getId()===e}))},Be.getFarmers=function(){return D},Be.getSettings=function(){return L},Be.getExceptionVillages=function(){return{included:U,ignored:G}},Be.getExceptionLogs=function(){return z},Be.isInitialized=function(){return P},
Be.isRunning=function(){return x},Be.getLogs=function(){return B},Be.clearLogs=function(){return B=[],S.set(te,B),f.trigger(s.FARM_OVERFLOW_LOGS_UPDATED),B},Be.getNextCycleDate=function(){return $},Be.getCycleInterval=Se,Be})),define('two/farmOverflow/events',[],(function(){angular.extend(s,{FARM_OVERFLOW_START:'farm_overflow_start',FARM_OVERFLOW_STOP:'farm_overflow_stop',FARM_OVERFLOW_INSTANCE_READY:'farm_overflow_instance_ready',FARM_OVERFLOW_INSTANCE_START:'farm_overflow_instance_start',FARM_OVERFLOW_INSTANCE_STOP:'farm_overflow_instance_stop',FARM_OVERFLOW_INSTANCE_ERROR_NO_TARGETS:'farm_overflow_instance_error_no_targets',FARM_OVERFLOW_INSTANCE_ERROR_NOT_READY:'farm_overflow_instance_error_not_ready',FARM_OVERFLOW_INSTANCE_STEP_STATUS:'farm_overflow_instance_command_status',FARM_OVERFLOW_PRESETS_LOADED:'farm_overflow_presets_loaded',FARM_OVERFLOW_LOGS_UPDATED:'farm_overflow_log_updated',FARM_OVERFLOW_COMMAND_SENT:'farm_overflow_command_sent',
FARM_OVERFLOW_IGNORED_TARGET:'farm_overflow_ignored_target',FARM_OVERFLOW_VILLAGE_IGNORED:'farm_overflow_village_ignored',FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED:'farm_overflow_exception_villages_updated',FARM_OVERFLOW_FARMER_VILLAGES_UPDATED:'farm_overflow_farmer_villages_updated',FARM_OVERFLOW_REPORTS_UPDATED:'farm_overflow_reports_updated',FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED:'farm_overflow_exception_logs_updated',FARM_OVERFLOW_CYCLE_BEGIN:'farm_overflow_cycle_begin',FARM_OVERFLOW_CYCLE_END:'farm_overflow_cycle_end'})})),define('two/farmOverflow/ui',['two/ui','two/farmOverflow','two/farmOverflow/types/status','two/farmOverflow/types/errors','two/farmOverflow/types/logs','two/farmOverflow/settings','two/Settings','two/EventScope','two/utils','queues/EventQueue','helper/time'],(function(e,t,n,d,u,_,E,T,b,w,v){let f,h,R,y=i.getPresetList(),k=i.getGroupList(),S={},L={},I=null;const z={SETTINGS:'settings',VILLAGES:'villages',LOGS:'logs'},O=function(){
const e=f.pagination.offset,t=f.pagination.limit;f.visibleLogs=f.logs.slice(e,e+t),f.pagination.count=f.logs.length,f.visibleLogs.forEach((function(e){e.villageId&&M(e.villageId),e.targetId&&M(e.targetId)}))},M=function(e){if(S[e])return S[e];S[e]=!0,L[e]='ŁADOWANIE...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){S[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},L[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))},N=function(){f.exceptionVillages.included.forEach((function(e){M(e)})),f.exceptionVillages.ignored.forEach((function(e){M(e)}))},C=function(){t.isRunning()?t.stop():t.start()},P=function(e){f.selectedTab=e},x=function(){h.setAll(h.decode(f.settings)),f.saveButtonColor='orange',b.notif('success',g('i18n')('settings_saved',a.loc.ale,'farm_overflow'))},D=function(e){const t=h.get(_.GROUP_IGNORE);if(!i.getGroupList().getGroupVillageIds(t).includes(e))return!1
;o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})},B=function(e){h.get(_.GROUP_INCLUDE).forEach((function(t){i.getGroupList().getGroupVillageIds(t).includes(e)&&o.emit(l.GROUPS_UNLINK_VILLAGE,{group_id:t,village_id:e})}))},U=function(){f.presets=E.encodeList(y.getPresets(),{disabled:!1,type:'presets'})},G=function(){f.groups=E.encodeList(k.getGroups(),{disabled:!1,type:'groups'}),f.groupsWithDisabled=E.encodeList(k.getGroups(),{disabled:!0,type:'groups'})},V=function(){f.running=!0,b.notif('success',g('i18n')('farm_started',a.loc.ale,'farm_overflow'))},W=function(e,t){switch(f.running=!1,f.showCycleTimer=!1,clearInterval(I),t.reason){case d.NO_PRESETS:b.notif('success',g('i18n')('no_preset',a.loc.ale,'farm_overflow'));break;case d.USER_STOP:b.notif('success',g('i18n')('farm_stopped',a.loc.ale,'farm_overflow'))}},j=function(){f.logs=angular.copy(t.getLogs()),O(),f.logs.length||b.notif('success',g('i18n')('reseted_logs',a.loc.ale,'farm_overflow'))},q=function(){
f.farmers=t.getFarmers()},F=function(){f.exceptionVillages=t.getExceptionVillages(),N()},H=function(){f.exceptionLogs=t.getExceptionLogs()},Y=function(){f.showCycleTimer=!1,clearInterval(I)},K=function(e,a){a!==n.USER_STOP&&(f.showCycleTimer=!0,f.nextCycleCountdown=t.getCycleInterval(),I=setInterval((function(){f.nextCycleCountdown-=1e3}),1e3))},Q=function(){let e=!0;f=a.$new(),f.SETTINGS=_,f.TAB_TYPES=z,f.LOG_TYPES=u,f.running=t.isRunning(),f.selectedTab=z.SETTINGS,f.farmers=t.getFarmers(),f.villagesLabel=L,f.villagesInfo=S,f.exceptionVillages=t.getExceptionVillages(),f.exceptionLogs=t.getExceptionLogs(),f.logs=t.getLogs(),f.visibleLogs=[],f.showCycleTimer=!1,f.nextCycleCountdown=0,f.saveButtonColor='orange',f.settingsMap=h.settingsMap,f.pagination={count:f.logs.length,offset:0,loader:O,limit:m.getPaginationLimit()},h.injectScope(f),U(),G(),O(),N(),function(){let e=t.getNextCycleDate();e&&(f.showCycleTimer=!0,f.nextCycleCountdown=e-v.gameTime(),I=setInterval((function(){
f.nextCycleCountdown-=1e3}),1e3))}(),f.switchFarm=C,f.selectTab=P,f.saveSettings=x,f.clearLogs=t.clearLogs,f.jumpToVillage=p.jumpToVillage,f.openVillageInfo=r.openVillageInfo,f.showReport=A.showReport,f.removeIgnored=D,f.removeIncluded=B;let n=new T('twoverflow_farm_overflow_window',(function(){clearInterval(I)}));n.register(s.ARMY_PRESET_UPDATE,U,!0),n.register(s.ARMY_PRESET_DELETED,U,!0),n.register(s.GROUPS_UPDATED,G,!0),n.register(s.GROUPS_CREATED,G,!0),n.register(s.GROUPS_DESTROYED,G,!0),n.register(s.FARM_OVERFLOW_START,V),n.register(s.FARM_OVERFLOW_STOP,W),n.register(s.FARM_OVERFLOW_LOGS_UPDATED,j),n.register(s.FARM_OVERFLOW_FARMER_VILLAGES_UPDATED,q),n.register(s.FARM_OVERFLOW_EXCEPTION_VILLAGES_UPDATED,F),n.register(s.FARM_OVERFLOW_EXCEPTION_LOGS_UPDATED,H),n.register(s.FARM_OVERFLOW_CYCLE_BEGIN,Y),n.register(s.FARM_OVERFLOW_CYCLE_END,K),c.getScreenWithInjectedScope('!twoverflow_farm_overflow_window',f),f.$watch('settings',(function(){e||(f.saveButtonColor='red'),e=!1}),!0)}
;return function(){h=t.getSettings(),R=e.addMenuButton2('Farmer',10,g('i18n')('description',a.loc.ale,'farm_overflow')),R.addEventListener('click',(function(){Q()})),w.register(s.FARM_OVERFLOW_START,(function(){R.classList.remove('btn-orange'),R.classList.add('btn-red')})),w.register(s.FARM_OVERFLOW_STOP,(function(){R.classList.remove('btn-red'),R.classList.add('btn-orange')})),
...
IGNORED_VILLAGE_REMOVED:'ignored_village_removed',INCLUDED_VILLAGE_REMOVED:'included_village_removed',ATTACKED_VILLAGE:'attacked_village'}})),require(['two/ready','two/farmOverflow','two/farmOverflow/ui','two/farmOverflow/events'],(function(e,t,a){if(t.isInitialized())return!1;e((function(){t.init(),a()}),['map','presets'])})),define('two/minimap',['two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/minimap/settings/updates','two/utils','two/ready','two/Settings','two/mapData','queues/EventQueue','Lockr','struct/MapData','helper/mapconvert','cdn','conf/colors','conf/colorGroups','conf/conf','states/MapState'],(function(t,n,o,l,r,c,d,u,g,m,A,_,T,b,w,v,f,h){let R,y,k,S,L,I,z,O,M,N,C,P,x,D,B,U,G,V,W,j,q,F,H,Y=!1,K={},Q={village:{},character:{},tribe:{}},Z={a:0,b:0},X={a:0,b:0},J={a:0,b:0},$={a:0,b:0},ee={},te={},ae={},ne=!1;const ie='minimap_settings',oe={[n.VERY_SMALL]:2,[n.SMALL]:3,[n.BIG]:5,[n.VERY_BIG]:7
},le=injector.get('colorService'),se=injector.get('spriteFactory');let re,ce=!0,de=!1,ue={},pe={x:0,y:0},ge=!0;const me=/^#?([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/,Ae=function(e){let t=Math.ceil(ee.x+e.offsetX)-S,a=Math.ceil(ee.y+e.offsetY)+S;return Math.floor(a/y)%2&&(t+=S),t-=t%y,a-=a%y,{x:Math.ceil((t-M.width/2)/y),y:Math.ceil((a-M.height/2)/y)}},_e=function(e,t){return{x:e/f.TILESIZE.x,y:t/f.TILESIZE.y/f.TILESIZE.off}},Ee=function(){he(L)},Te=function(){if(Y){const e={x:ee.x-M.width/2,y:ee.y-M.height/2};N.clearRect(0,0,M.width,M.height),D.clearRect(0,0,x.width,x.height),function(e){N.drawImage(C,-e.x,-e.y)}(e),H[o.SHOW_VIEW_REFERENCE]&&function(e){const t=Ce.getMapPosition(),a=(t.x-2)*y-e.x,n=(t.y-2)*y-e.y;D.fillStyle=H[o.COLOR_VIEW_REFERENCE],D.fillRect(a,0,1,k),D.fillRect(0,n,k,1);const i=U.getBoundingClientRect(),l=i.width/f.TILESIZE.x/h.view.z*y,s=i.height/f.TILESIZE.y/h.view.z*y,r=a-l/2,c=n-s/2;D.clearRect(r,c,l,s),D.beginPath(),D.lineWidth=1,D.strokeStyle=H[o.COLOR_VIEW_REFERENCE],
D.rect(r,c,l,s),D.stroke()}(e)}e.requestAnimationFrame(Te)},be=function(){if(!ne)return!1;const e=Q.village[z][O];ve(e?Q.character[e]:[[z,O]]),ne=!1,m.trigger(s.MINIMAP_VILLAGE_BLUR,{x:z,y:O})},we=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}he(t,H[o.COLOR_QUICK_HIGHLIGHT])},ve=function(e){let t=[];for(let a=0;a<e.length;a++){let n=e[a][0],i=e[a][1];t.push(ae[n][i])}he(t)},fe=function(e){if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS])return e.character_id in K.character?K.character[e.character_id]:e.tribe_id in K.tribe&&K.tribe[e.tribe_id];if(!e.character_id)return!!H[o.SHOW_BARBARIANS]&&j.barbarian;if(e.character_id===V){if(e.id===I.getId()&&H[o.HIGHLIGHT_SELECTED])return j.selected;if(e.character_id in K.character)return K.character[e.character_id];if(H[o.HIGHLIGHT_OWN])return j.player}else{if(e.character_id in K.character)return K.character[e.character_id];if(e.tribe_id in K.tribe)return K.tribe[e.tribe_id]
;if(W&&W===e.tribe_id&&H[o.HIGHLIGHT_DIPLOMACY])return j.tribe;if(q&&H[o.HIGHLIGHT_DIPLOMACY]){if(q.isAlly(e.tribe_id))return j.ally;if(q.isEnemy(e.tribe_id))return j.enemy;if(q.isNAP(e.tribe_id))return j.friendly}}return j.ugly},he=function(e,t){for(let a=0;a<e.length;a++){const n=e[a];if(n.id<0)continue;const i=t||fe(n);if(!i)continue;const o=n.x*y+(n.y%2?S:0),l=n.y*y;P.fillStyle=i,P.fillRect(o,l,R,R)}},Re=function(){R=oe[H[o.MAP_SIZE]],S=Math.round(R/2),y=R+1,k=1e3*y,J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y,C.width=1e3*y,C.height=1e3*y,P.imageSmoothingEnabled=!1},ye=function(){const e=document.body.clientHeight-265;M.width=686,M.height=e,x.width=686,x.height=e,N.imageSmoothingEnabled=!1,D.imageSmoothingEnabled=!1},ke=function(e){var a,n;e.preventDefault(),ce=!0,de=!0,ue.x=ee.x+e.pageX,ue.y=ee.y+e.pageY,ne&&(m.trigger(s.MINIMAP_VILLAGE_CLICK,[z,O,e]),3===e.which&&(a=z,n=O,_.getTownAtAsync(a,n,(function(e){if(!e)return!1;switch(H[o.RIGHT_CLICK_ACTION]){case t.HIGHLIGHT_PLAYER:
if(!e.character_id)return!1;Ce.addHighlight({type:'character',id:e.character_id},w.palette.flat().random());break;case t.HIGHLIGHT_TRIBE:if(!e.tribe_id)return!1;Ce.addHighlight({type:'tribe',id:e.tribe_id},w.palette.flat().random())}})))),m.trigger(s.MINIMAP_START_MOVE)},Se=function(){de=!1,ue={},ce||m.trigger(s.MINIMAP_STOP_MOVE)},Le=function(e){if(ce=!1,pe=Ae(e),de)return ee.x=(ue.x-e.pageX).bound(J.a,J.b),ee.y=(ue.y-e.pageY).bound($.a,$.b),te.x=pe.x,te.y=pe.y,!1;if(te.x===pe.x&&te.y===pe.y||(re.alpha=0,function(e,t){let a=p.tileCoordinate2Pixel(e,t);re.setTranslation(a[0]-25,a[1]+2),re.alpha=1}(pe.x,pe.y)),pe.x in ae&&pe.y in ae[pe.x]){let t=ae[pe.x][pe.y];if(!H[o.SHOW_BARBARIANS]&&!t.character_id)return!1;if(H[o.SHOW_ONLY_CUSTOM_HIGHLIGHTS]){let e=!1;if(t.character_id in K.character?e=!0:t.tribe_id in K.tribe&&(e=!0),!e)return!1}return function(e,t){if(ne){if(z===e.x&&O===e.y)return!1;be()}ne=!0,z=e.x,O=e.y,m.trigger(s.MINIMAP_VILLAGE_HOVER,{x:z,y:O,event:t})
;const a=Q.village[z][O];we(a?Q.character[a]:[[z,O]])}(pe,e)}be()},Ie=function(){ne&&be(),m.trigger(s.MINIMAP_MOUSE_LEAVE)},ze=function(e){if(!ce)return!1;const t=Ae(e);p.jumpToVillage(t.x,t.y)},Oe=function(e){return e.preventDefault(),!1},Me=function(){K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Ee()},Ne=function(){const e={id:I.getId(),x:I.getX(),y:I.getY()};I=G.getSelectedVillage(),he([{character_id:G.getId(),id:e.id,x:e.x,y:e.y},{character_id:G.getId(),id:I.getId(),x:I.getX(),y:I.getY()}])};let Ce={addHighlight:function(e,t){if(!(e&&e.type&&e.id&&E.call(K,e.type)))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY),!1;if(!me.test(t))return m.trigger(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR),!1;K[e.type][e.id]='#'!==t[0]?'#'+t:t;const n='character'===e.type?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e.type]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},
removeHighlight:function(e,t){if(void 0===t||!E.call(K,e))return!1;if(!E.call(K[e],t))return!1;delete K[e][t];const n='character'===e?v.PLAYER_COLORS:v.TRIBE_COLORS;return le.setCustomColorsByGroup(n,K[e]),a.$broadcast(s.GROUPS_VILLAGES_CHANGED),Ee(),!0},getHighlight:function(e,t){return!!E.call(K[e],t)&&K[e][t]},getHighlights:function(){return K},eachHighlight:function(e){for(let t in K)for(let a in K[t])e(t,a,K[t][a])},setViewport:function(e){M=e,M.style.background=H[o.COLOR_BACKGROUND],N=M.getContext('2d')},setViewportRef:function(e){x=e,D=x.getContext('2d')},setCurrentPosition:function(e,t){ee.x=e*y,ee.y=t*y,te.x=Math.ceil(e),te.y=Math.ceil(t)}};return Ce.getMapPosition=function(){if(!B.width||!B.height)return!1;let e=_.getMap().engine.getView(),t=function(e,t){t=1/(t||1);const a=_e(e[0]*t,e[1]*t),n=_e(e[2]*t,e[3]*t);return[a.x-1,a.y-1,n.x+3||1,n.y+3||1]}([-e.x,-e.y,B.width/2,B.height/2],e.z);return{x:t[0]+t[2],y:t[1]+t[3]}},Ce.getSettings=function(){return F},
Ce.drawMinimap=function(){ge&&(ge=!1),M.style.background=H[o.COLOR_BACKGROUND],P.clearRect(0,0,C.width,C.height),d((function(){!function(){const e=b.getPath(f.getMapPath()),t=H[o.SHOW_CONTINENT_DEMARCATIONS],a=H[o.SHOW_PROVINCE_DEMARCATIONS],n=function(e,t){P.fillStyle=H[o.COLOR_CONTINENT],P.fillRect(e*y+S-1,t*y+S-1,3,1),P.fillRect(e*y+S,t*y+S-2,1,3)},i=function(e,t){P.fillStyle=H[o.COLOR_PROVINCE],P.fillRect(e*y+S,t*y+S-1,1,1)};c.xhrGet(e,'arraybuffer').then((function(e){const o=new DataView(e.response),l={a:Z.a-10,b:Z.b+10},s={a:X.a-10,b:X.b+10};if(t||a)for(let e=l.a;e<l.b;e++)for(let l=s.a;l<s.b;l++){const s=T.toTile(o,e,l);s.key.b&&(s.key.c&&t?n(e,l):a&&i(e,l))}const r=l.a*y,c=s.a*y,d=(l.b-l.a)*y,u=(s.b-s.a)*y;P.beginPath(),P.lineWidth=2,P.strokeStyle="#2B4700",P.rect(r,c,d,u),P.stroke()}))}(),Ee()}),'minimap_data')},Ce.enableRendering=function(){Y=!0},Ce.disableRendering=function(){Y=!1},Ce.isFirstDraw=function(){return!!ge},Ce.init=function(){Ce.initialized=!0,
C=document.createElement('canvas'),P=C.getContext('2d'),re=se.make('hover'),F=new u({settingsMap:l,storageKey:ie}),F.onChange((function(e,t){H=F.getAll(),Re(),t[r.MAP_POSITION]&&Ce.setCurrentPosition(te.x,te.y),t[r.MINIMAP]&&Ce.drawMinimap()})),H=F.getAll(),K.tribe=le.getCustomColorsByGroup(v.TRIBE_COLORS)||{},K.character=le.getCustomColorsByGroup(v.PLAYER_COLORS)||{},Re()},Ce.run=function(){d((function(){U=document.getElementById('map'),B=document.getElementById('main-canvas'),G=i.getSelectedCharacter(),q=G.getTribeRelations(),V=G.getId(),W=G.getTribeId(),j=G.getVillagesColors(),re.alpha=0,h.graph.layers.effects.push(re),ye(),I=G.getSelectedVillage(),te.x=I.getX(),te.y=I.getY(),ee.x=I.getX()*y,ee.y=I.getY()*y,e.addEventListener('resize',ye,!1),x.addEventListener('mousedown',ke),x.addEventListener('mouseup',Se),x.addEventListener('mousemove',Le),x.addEventListener('mouseleave',Ie),x.addEventListener('click',ze),x.addEventListener('contextmenu',Oe),g.load((function(){L=g.getVillages(),
function(e){for(let t=0,a=e.length;t<a;t++){let a=e[t];a.id<0||(a.x in Q.village||(Q.village[a.x]={}),a.x in ae||(ae[a.x]=[]),Q.village[a.x][a.y]=a.character_id||0,ae[a.x][a.y]=a,a.character_id&&(a.character_id in Q.character?Q.character[a.character_id].push([a.x,a.y]):Q.character[a.character_id]=[[a.x,a.y]],a.tribe_id&&(a.tribe_id in Q.tribe?Q.tribe[a.tribe_id].push(a.character_id):Q.tribe[a.tribe_id]=[a.character_id])))}}(L),function(){let e=[],t=[];for(let a in Q.village){e.push(a);for(let e in Q.village[a])t.push(e)}Z.a=Math.min(...e),Z.b=Math.max(...e),X.a=Math.min(...t),X.b=Math.max(...t),J.a=Z.a*y,J.b=Z.b*y,$.a=X.a*y,$.b=X.b*y}(),Te(),a.$on(s.VILLAGE_SELECTED_CHANGED,Ne),a.$on(s.TRIBE_RELATION_CHANGED,Ee),a.$on(s.GROUPS_VILLAGES_CHANGED,Me)}))}),['initial_village','tribe_relations'])},Ce})),define('two/minimap/events',[],(function(){angular.extend(s,{MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS:'minimap_highlight_add_error_exists',
MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY:'minimap_highlight_add_error_no_entry',MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR:'minimap_highlight_add_error_invalid_color',MINIMAP_VILLAGE_CLICK:'minimap_village_click',MINIMAP_VILLAGE_HOVER:'minimap_village_hover',MINIMAP_VILLAGE_BLUR:'minimap_village_blur',MINIMAP_MOUSE_LEAVE:'minimap_mouse_leave',MINIMAP_START_MOVE:'minimap_start_move',MINIMAP_STOP_MOVE:'minimap_stop_move',MINIMAP_AREA_LOADED:'minimap_area_loaded'})})),define('two/minimap/ui',['two/ui','two/minimap','two/minimap/types/actions','two/minimap/types/mapSizes','two/minimap/settings','two/minimap/settings/map','two/utils','two/EventScope','two/Settings','helper/util','struct/MapData','cdn','conf/colors'],(function(t,i,d,u,p,m,A,_,E,T,b,w,v){let f,h,R,y,k,S,L,I,z,O,M,N={},C=!1,P={character:{},tribe:{}};const x={MINIMAP:'minimap',HIGHLIGHTS:'highlights',SETTINGS:'settings'},D=x.MINIMAP,B=function(e){f.selectedTab=e,e===x.MINIMAP?i.enableRendering():i.disableRendering()},U=function(){
Object.keys(f.highlights.character).forEach((function(e){e in P.character||function(e,t){o.emit(l.CHAR_GET_PROFILE,{character_id:e.id},t)}({id:e},(function(t){P.character[e]=t.character_name}))})),Object.keys(f.highlights.tribe).forEach((function(e){e in P.tribe||function(e,t){o.emit(l.TRIBE_GET_PROFILE,{tribe_id:e.id},t)}({id:e},(function(t){P.tribe[e]=t.name}))}))},G=function(e,t){return String(e)+String(t)},V=function(e,t){if(!z)return;let a=G(t.x,t.y);var n,i;O=a,N[a]=!0,C=!0,(n=t.x,i=t.y,new Promise((function(e){let t=b.getTownAt(n,i);if(t)return e(t);b.loadTownDataAsync(n,i,1,1,(function(t){e(t)}))}))).then((function(e){if(!N[G(e.x,e.y)])return;if(!C)return;L.appendChild(z),z.classList.remove('ng-hide'),S.tt.name=e.name,S.tt.x=e.x,S.tt.y=e.y,S.tt.province_name=e.province_name,S.tt.points=e.points,S.tt.character_name=e.character_name||'-',S.tt.character_points=e.character_points||0,S.tt.tribe_name=e.tribe_name||'-',S.tt.tribe_tag=e.tribe_tag||'-',
S.tt.tribe_points=e.tribe_points||0,S.tt.morale=e.morale||0,S.tt.position={},S.tt.position.x=t.event.pageX+50,S.tt.position.y=t.event.pageY+50,S.tt.visible=!0;const a=z.getBoundingClientRect(),n=L.getBoundingClientRect(),i=a.width+50,o=a.height+50,l=S.tt.position.y+o>n.top+n.height,s=S.tt.position.x+i>n.width;l&&(S.tt.position.y-=50),z.classList.toggle('left',s),z.classList.toggle('top',l)}))},W=function(e,t){if(!z)return;let a=t?G(t):O;N[a]=!1,C=!1,S.tt.visible=!1,z.classList.add('ng-hide'),I.appendChild(z)},j=function(e,t,n){let o,l,s=a.$new(),r=!0;s.colorPalettes=v.palette,'setting'===e?(l=t,o=M.get(l),r=!1,s.submit=function(){f.settings[l]='#'+s.selectedColor,s.closeWindow()},s.reset=function(){f.settings[l]=M.getDefault(l),s.closeWindow()}):'add_custom_highlight'===e?(o=f.addHighlightColor,s.submit=function(){f.addHighlightColor='#'+s.selectedColor,s.closeWindow()}):'edit_custom_highlight'===e&&(o=f.highlights[t][n],s.submit=function(){i.addHighlight({id:n,type:t
},s.selectedColor),s.closeWindow()}),s.selectedColor=o.replace('#',''),s.hasCustomColors=!0,s.hideReset=r,s.finishAction=function(e,t){s.selectedColor=t},c.getModal('modal_color_palette',s)},q=function(){i.addHighlight(f.selectedHighlight,f.addHighlightColor)},F=function(){M.setAll(M.decode(f.settings)),A.notif('success',g('i18n')('settings_saved',a.loc.ale,'minimap'))},H=function(){let e=a.$new();e.title=g('i18n')('reset_confirm_title',a.loc.ale,'minimap'),e.text=g('i18n')('reset_confirm_text',a.loc.ale,'minimap'),e.submitText=g('i18n')('reset',a.loc.ale,'common'),e.cancelText=g('i18n')('cancel',a.loc.ale,'common'),e.showQuestionMarkIcon=!0,e.switchColors=!0,e.submit=function(){M.resetAll(),A.notif('success',g('i18n')('settings_reset',a.loc.ale,'minimap')),e.closeWindow()},e.cancel=function(){e.closeWindow()},c.getModal('modal_attention',e)},Y=function(){return Object.keys(f.highlights.character).length+Object.keys(f.highlights.tribe).length},K=function(e,t){
('character'===e?r.openCharacterProfile:r.openTribeProfile)(t)},Q={addHighlightAutoCompleteSelect:function(e){f.selectedHighlight={id:e.id,type:e.type,name:e.name}},highlightUpdate:function(){U()},highlightAddErrorExists:function(){A.notif('error',g('i18n')('highlight_add_error_exists',a.loc.ale,'minimap'))},highlightAddErrorNoEntry:function(){A.notif('error',g('i18n')('highlight_add_error_no_entry',a.loc.ale,'minimap'))},highlightAddErrorInvalidColor:function(){A.notif('error',g('i18n')('highlight_add_error_invalid_color',a.loc.ale,'minimap'))},onMouseLeaveMinimap:function(){W(),y.dispatchEvent(new MouseEvent('mouseup',{view:e,bubbles:!0,cancelable:!0}))},onMouseMoveMinimap:function(){W(),y.style.cursor='url('+w.getPath('/img/cursor/grab_pushed.png')+'), move'},onMouseStopMoveMinimap:function(){y.style.cursor=''}},Z=function(){f=a.$new(),f.SETTINGS=p,f.TAB_TYPES=x,f.selectedTab=D,f.selectedHighlight=!1,f.addHighlightColor='#000000',f.highlights=i.getHighlights(),f.highlightNames=P,
f.mapSizes=E.encodeList(u,{textObject:'minimap',disabled:!1}),f.actionTypes=E.encodeList(d,{textObject:'minimap',disabled:!1}),f.autoComplete={type:['character','tribe'],placeholder:g('i18n')('placeholder_search',a.loc.ale,'minimap'),onEnter:Q.addHighlightAutoCompleteSelect},f.selectTab=B,f.openColorPalette=j,f.addCustomHighlight=q,f.removeHighlight=i.removeHighlight,f.saveSettings=F,f.resetSettings=H,f.highlightsCount=Y,f.openProfile=K,M.injectScope(f,{textObject:'minimap'});let e=new _('twoverflow_minimap_window',(function(){i.disableRendering()}));e.register(s.GROUPS_VILLAGES_CHANGED,Q.highlightUpdate,!0),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_EXISTS,Q.highlightAddErrorExists),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_NO_ENTRY,Q.highlightAddErrorNoEntry),e.register(s.MINIMAP_HIGHLIGHT_ADD_ERROR_INVALID_COLOR,Q.highlightAddErrorInvalidColor),e.register(s.MINIMAP_VILLAGE_HOVER,V),e.register(s.MINIMAP_VILLAGE_BLUR,W),e.register(s.MINIMAP_MOUSE_LEAVE,Q.onMouseLeaveMinimap),
e.register(s.MINIMAP_START_MOVE,Q.onMouseMoveMinimap),e.register(s.MINIMAP_STOP_MOVE,Q.onMouseStopMoveMinimap),c.getScreenWithInjectedScope('!twoverflow_minimap_window',f),U(),k=document.querySelector('#two-minimap .minimap-container'),k.appendChild(R),k.appendChild(y),i.enableRendering(),i.isFirstDraw()&&i.drawMinimap()};return function(){M=i.getSettings(),S=n.getSharedData('MapController'),R=document.createElement('canvas'),R.className='minimap',y=document.createElement('canvas'),y.className='cross',i.setViewport(R),i.setViewportRef(y),z=document.querySelector('#map-tooltip'),L=document.querySelector('#wrapper'),I=document.querySelector('#map'),h=t.addMenuButton4('Minimapa',30,g('i18n')('general.description',a.loc.ale,'minimap')),h.addEventListener('click',(function(){const e=i.getMapPosition();if(!e)return!1;Z(),i.setCurrentPosition(e.x,e.y)})),
...
define('two/prankHelper',['two/Settings','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/settings/updates','two/prankHelper/types/type','two/ready','helper/time','queues/EventQueue','Lockr'],(function(e,t,n,r,c,d,u,p,g){let m=!1,A=!1;let _,E,T,b=[];const w='prank_helper_settings',v='prank_helper_log',f={[c.INCREASE]:'increase',[c.DECREASE]:'decrease',[c.RANDOM]:'random'};console.log(f);const h=function(){b=[];const e=i.getGroupList().getGroups(),a=E[t.GROUPS];b.push(e[a])},R=function(e,t,a){let n={time:u.gameTime(),villageId:e,oldname:a,newname:t};return T.unshift(n),T.length>500&&T.splice(T.length-500,T.length),g.set(v,T),!0},y={init:function(){m=!0,T=g.get(v,[],!0),_=new e({settingsMap:n,storageKey:w}),_.onChange((function(e,t){E=_.getAll(),t[r.GROUPS]&&h()})),E=_.getAll(),console.log('prankHelper settings',E),a.$on(s.GROUPS_CREATED,h),a.$on(s.GROUPS_DESTROYED,h),a.$on(s.GROUPS_UPDATED,h)},renameGroup:function(){
var e=i.getSelectedCharacter().getVillageList(),a=E[t.CENTER3],n=E[t.PROLOGUE3],s=E[t.EPILOGUE3],r=E[t.TYPE3],c=E[t.FROM3],d=E[t.TO3],u=E[t.GROUPS];var p,g=i.getGroupList().getGroupVillageIds(u),m=0,A=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'],_=null,T=[],b=0,w=A.indexOf(c),v=A.indexOf(d);if('increase'==r)if(isNaN(c)&&isNaN(d))for(b=w;b<=v;b++)p=n+a+s+' '+A[b],T.push(p);else for(b=c;b<=d;b++)p=n+a+s+' '+b,T.push(p);else if('decrease'==r)if(isNaN(c)&&isNaN(d))for(b=v;b>=w;b--)p=n+a+s+' '+A[b],T.push(p);else for(b=d;b>=c;b--)p=n+a+s+' '+b,T.push(p);else p=n+a+s,e.forEach((function(e){g.forEach((function(t,a){e.data.villageId==t&&setTimeout((function(){m=e.getId(),_=e.getName(),o.emit(l.VILLAGE_CHANGE_NAME,{village_id:e.getId(),name:p}),R(m,p,_)}),4e3*a)}))}));e.forEach((function(e){g.forEach((function(t,a){e.data.villageId==t&&setTimeout((function(){m=e.getId(),_=e.getName(),o.emit(l.VILLAGE_CHANGE_NAME,{village_id:e.getId(),
name:T[a]}),R(m,T[a],_)}),4e3*a)}))})),y.stop()}};return y.renameProvince=function(){var e,a,n,i=E[t.VILLAGE_ID],s=[],r=E[t.CENTER2],c=E[t.PROLOGUE2],d=E[t.EPILOGUE2],u=E[t.TYPE2],p=E[t.FROM2],g=E[t.TO2],m=0,A=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'],_=null,T=[],b=0,w=A.indexOf(p),v=A.indexOf(g);a=i,n=function(t){if(s=t.villages,'increase'==u)if(isNaN(p)&&isNaN(g))for(b=w;b<=v;b++)e=c+r+d+' '+A[b],T.push(e);else for(b=p;b<=g;b++)e=c+r+d+' '+b,T.push(e);else if('decrease'==u)if(isNaN(p)&&isNaN(g))for(b=v;b>=w;b--)e=c+r+d+' '+A[b],T.push(e);else for(b=g;b>=p;b--)e=c+r+d+' '+b,T.push(e);else e=c+r+d,s.forEach((function(t,a){setTimeout((function(){m=t.id,_=t.name,o.emit(l.VILLAGE_CHANGE_NAME,{village_id:t.id,name:e}),R(m,e,_)}),4e3*a)}));s.forEach((function(e,t){setTimeout((function(){m=e.id,_=e.name,o.emit(l.VILLAGE_CHANGE_NAME,{village_id:e.id,name:T[t]}),R(m,T[t],_)}),4e3*t)}))},o.emit(l.VILLAGES_IN_PROVINCE,{village_id:a
},n),y.stop()},y.renameAll=function(){var e,a=i.getSelectedCharacter().getVillageList(),n=E[t.CENTER1],s=E[t.PROLOGUE1],r=E[t.EPILOGUE1],c=E[t.TYPE1],d=E[t.FROM1],u=E[t.TO1],p=0,g=['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'],m=null,A=[],_=0,T=g.indexOf(d),b=g.indexOf(u);if('increase'==c)if(isNaN(d)&&isNaN(u))for(_=T;_<=b;_++)e=s+n+r+' '+g[_],A.push(e);else for(_=d;_<=u;_++)e=s+n+r+' '+_,A.push(e);else if('decrease'==c)if(isNaN(d)&&isNaN(u))for(_=b;_>=T;_--)e=s+n+r+' '+g[_],A.push(e);else for(_=u;_>=d;_--)e=s+n+r+' '+_,A.push(e);else e=s+n+r,a.forEach((function(t,a){setTimeout((function(){p=t.getId(),m=t.getName(),o.emit(l.VILLAGE_CHANGE_NAME,{village_id:t.getId(),name:e}),R(p,e,m)}),4e3*a)}));a.forEach((function(e,t){setTimeout((function(){p=e.getId(),m=e.getName(),o.emit(l.VILLAGE_CHANGE_NAME,{village_id:e.getId(),name:A[t]}),R(p,A[t],m)}),4e3*t)})),y.stop()},y.getLogs=function(){return T},y.clearLogs=function(){return T=[],
g.set(v,T),p.trigger(s.PRANK_HELPER_CLEAR_LOGS),T},y.start=function(){A=!0,p.trigger(s.PRANK_HELPER_START),R('','Rozpoczęto przemianowanie','')},y.stop=function(){A=!1,p.trigger(s.PRANK_HELPER_STOP),R('','Zatrzymano przemianowanie','')},y.getSettings=function(){return _},y.isInitialized=function(){return m},y.isRunning=function(){return A},y})),define('two/prankHelper/events',[],(function(){angular.extend(s,{PRANK_HELPER_START:'prank_helper_start',PRANK_HELPER_STOP:'prank_helper_stop',PRANK_HELPER_CLEAR_LOGS:'prank_helper_clear_logs'})})),define('two/prankHelper/ui',['two/ui','two/prankHelper','two/prankHelper/settings','two/prankHelper/settings/map','two/prankHelper/types/type','two/Settings','queues/EventQueue','two/EventScope','two/utils','struct/MapData'],(function(e,t,n,d,u,A,_,E,T,b){let w,v,f,h,R=i.getGroupList(),y=!1,k={},S={},L={},I=!1;const z={RENAME:'rename',LOGS:'logs'},O=function(e){w.selectedTab=e},M=function(){t.isRunning()?(t.stop(),y=!1):(t.start(),
v.setAll(v.decode(w.settings)),t.renameAll())},N=function(){t.isRunning()?(t.stop(),y=!1):(t.start(),v.setAll(v.decode(w.settings)),t.renameProvince())},C=function(){t.isRunning()?(t.stop(),y=!1):(t.start(),v.setAll(v.decode(w.settings)),t.renameGroup())},P=function(){w.settings[n.GROUPS]=!1,w.settings[n.TYPE1]=!1,w.settings[n.TYPE2]=!1,w.settings[n.TYPE3]=!1,w.settings[n.CENTER1]='',w.settings[n.CENTER2]='',w.settings[n.CENTER3]='',w.settings[n.PROLOGUE1]='',w.settings[n.PROLOGUE2]='',w.settings[n.PROLOGUE3]='',w.settings[n.EPILOGUE1]='',w.settings[n.EPILOGUE2]='',w.settings[n.EPILOGUE3]='',w.settings[n.FROM1]='',w.settings[n.FROM2]='',w.settings[n.FROM3]='',w.settings[n.TO1]='',w.settings[n.TO2]='',w.settings[n.TO3]='',v.setAll(v.decode(w.settings))},x=function(e,t){I=t.data},D=function(){I=!1},B=function(){if(!I)return T.notif('error',g('i18n')('error_no_map_selected_village',a.loc.ale,'prank_helper'));b.loadTownDataAsync(I.x,I.y,1,1,(function(e){h.origin=e})),
w.settings[n.VILLAGE_ID]=I.id};k.updateVisibleLogs=function(){const e=w.pagination.logs.offset,t=w.pagination.logs.limit;k.visibleLogs=k.logs.slice(e,e+t),w.pagination.logs.count=k.logs.length,k.visibleLogs.forEach((function(e){e.villageId&&function(e){if(S[e])return S[e];S[e]=!0,L[e]='ŁADOWANIE...',o.emit(l.MAP_GET_VILLAGE_DETAILS,{my_village_id:i.getSelectedVillage().getId(),village_id:e,num_reports:1},(function(t){S[e]={x:t.village_x,y:t.village_y,name:t.village_name,last_report:t.last_reports[0]},L[e]=`${t.village_name} (${t.village_x}|${t.village_y})`}))}(e.villageId)}))},k.clearLogs=function(){t.clearLogs()};const U={updateGroups:function(){w.groups=A.encodeList(R.getGroups(),{disabled:!1,type:'groups'})},updateLogs:function(){w.logs=t.getLogs(),k.updateVisibleLogs(),w.logs.length||T.notif('success',g('i18n')('reseted_logs',a.loc.ale,'prank_helper'))},autoCompleteSelected:function(e,t,a,i){if('prankhelper_village_search'!==t)return!1;h[i]={id:a.raw.id,x:a.raw.x,y:a.raw.y,
name:a.raw.name},w.searchQuery[i]='',w.settings[n.VILLAGE_ID]=h.id,v.setAll(v.decode(w.settings))},onAutoCompleteVillage:function(e){h.origin={id:e.id,x:e.x,y:e.y,name:e.name},w.settings[n.VILLAGE_ID]=e.id,v.setAll(v.decode(w.settings))},clearLogs:function(){T.notif('success',g('i18n')('logs_cleared',a.loc.ale,'prank_helper')),U.updateLogs()},start:function(){w.running=!0},stop:function(){w.running=!1}},G=function(){w=a.$new(),w.SETTINGS=n,w.TAB_TYPES=z,w.running=y,w.selectedTab=z.RENAME,w.settingsMap=d,w.pagination={},w.prankVillage=h,w.clear=P,w.autoCompleteVillage={type:['village'],placeholder:g('i18n')('rename.add_village_search',a.loc.ale,'prank_helper'),onEnter:U.onAutoCompleteVillage,tooltip:g('i18n')('rename.add_origin',a.loc.ale,'prank_helper'),dropDown:!0},w.type=A.encodeList(u,{textObject:'prank_helper',disabled:!0}),v.injectScope(w),U.updateGroups(),w.selectTab=O,w.addMapSelected=B,w.renameAll=M,w.renameProvince=N,w.renameGroup=C,w.logsView=k,w.logsView.logs=t.getLogs(),
w.villagesInfo=S,w.villagesLabel=L,w.openVillageInfo=r.openVillageInfo,w.jumpToVillage=p.jumpToVillage,w.pagination.logs={count:k.logs.length,offset:0,loader:k.updateVisibleLogs,limit:m.getPaginationLimit()},k.updateVisibleLogs();let e=new E('twoverflow_prank_helper_window',(function(){console.log('prankHelper window closed')}));e.register(s.SELECT_SELECTED,U.autoCompleteSelected,!0),e.register(s.GROUPS_CREATED,U.updateGroups,!0),e.register(s.GROUPS_DESTROYED,U.updateGroups,!0),e.register(s.GROUPS_UPDATED,U.updateGroups,!0),e.register(s.PRANK_HELPER_CLEAR_LOGS,U.clearLogs),e.register(s.PRANK_HELPER_START,U.start),e.register(s.PRANK_HELPER_STOP,U.stop),c.getScreenWithInjectedScope('!twoverflow_prank_helper_window',w)};return function(){v=t.getSettings(),h={origin:!1},f=e.addMenuButton3('Błazen',80,g('i18n')('description',a.loc.ale,'prank_helper')),f.addEventListener('click',G),_.register(s.PRANK_HELPER_START,(function(){y=!0,f.classList.remove('btn-orange'),f.classList.add('btn-red'),
T.notif('success',g('i18n')('rename_started',a.loc.ale,'recruit_queue'))})),_.register(s.PRANK_HELPER_STOP,(function(){y=!1,f.classList.remove('btn-red'),f.classList.add('btn-orange'),T.notif('success',g('i18n')('rename_stopped',a.loc.ale,'recruit_queue'))})),a.$on(s.SHOW_CONTEXT_MENU,x),a.$on(s.DESTROY_CONTEXT_MENU,D),
